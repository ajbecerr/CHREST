...
species(
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.254677,0.0880159,-9.10735e-05,5.86337e-08,-1.64103e-11,31394.9,33.4352], Tmin=(100,'K'), Tmax=(844.323,'K')), NASAPolynomial(coeffs=[8.44512,0.0492132,-2.21374e-05,4.20239e-09,-2.93325e-13,30011.9,-4.69294], Tmin=(844.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(259.952,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCsJOOH) + radical(RCCJ)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.374709,0.0705197,-4.89617e-05,1.74833e-08,-2.54273e-12,32752.8,33.571], Tmin=(100,'K'), Tmax=(1597.42,'K')), NASAPolynomial(coeffs=[16.008,0.0313734,-1.22028e-05,2.14233e-09,-1.41842e-13,27758.2,-49.1732], Tmin=(1597.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(271.174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO) + radical(RCCJ)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.175006,0.088821,-9.36241e-05,5.72474e-08,-1.47421e-11,61789.6,33.4096], Tmin=(100,'K'), Tmax=(924.685,'K')), NASAPolynomial(coeffs=[10.7654,0.0430091,-1.93091e-05,3.66885e-09,-2.56522e-13,59831.1,-16.8537], Tmin=(924.685,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(512.636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH2]CCC1OOC1C(7637)',
    structure = SMILES('[CH2]CCC1OOC1C'),
    E0 = (69.1284,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.400873,0.0739158,-4.79722e-05,1.56433e-08,-2.09415e-12,8447.58,27.3869], Tmin=(100,'K'), Tmax=(1684.55,'K')), NASAPolynomial(coeffs=[15.7591,0.0374476,-1.54994e-05,2.79221e-09,-1.86958e-13,3273.22,-54.7169], Tmin=(1684.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(69.1284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CCC1OC1C(7638)',
    structure = SMILES('[CH2]CCC1OC1C'),
    E0 = (17.8322,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.802275,0.0592246,-4.71067e-06,-4.02671e-08,2.23793e-11,2270.3,25.7208], Tmin=(100,'K'), Tmax=(893.333,'K')), NASAPolynomial(coeffs=[14.1096,0.0305471,-8.45514e-06,1.25637e-09,-7.94721e-14,-1340.56,-43.881], Tmin=(893.333,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(17.8322,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CCC=C(C)OO(7639)',
    structure = SMILES('[CH2]CCC=C(C)OO'),
    E0 = (38.855,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.5717,0.0798038,-6.56763e-05,3.04964e-08,-6.16186e-12,4792.87,32.3282], Tmin=(100,'K'), Tmax=(1126.14,'K')), NASAPolynomial(coeffs=[10.0295,0.0462106,-2.09314e-05,4.00818e-09,-2.8165e-13,2662.67,-14.4241], Tmin=(1126.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(38.855,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(RCCJ)"""),
)

species(
    label = 'CCC=CC(C)O[O](7640)',
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0935759,0.0772042,-5.51709e-05,2.01979e-08,-3.01046e-12,-2797.8,33.6191], Tmin=(100,'K'), Tmax=(1560.04,'K')), NASAPolynomial(coeffs=[16.9601,0.0339571,-1.35874e-05,2.42735e-09,-1.62626e-13,-8060.18,-55.2523], Tmin=(1560.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-24.4899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = 'C=CCCC(C)O[O](7641)',
    structure = SMILES('C=CCCC(C)O[O]'),
    E0 = (-13.043,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.378844,0.0788908,-6.07393e-05,2.52874e-08,-4.4375e-12,-1437.99,31.4413], Tmin=(100,'K'), Tmax=(1307.76,'K')), NASAPolynomial(coeffs=[12.7046,0.0411901,-1.74965e-05,3.24309e-09,-2.23338e-13,-4661.82,-31.3307], Tmin=(1307.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-13.043,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]CC=CC(C)OO(7642)',
    structure = SMILES('[CH2]CC=CC(C)OO'),
    E0 = (28.7518,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.143172,0.0816138,-6.10353e-05,2.30138e-08,-3.50073e-12,3614.89,35.4985], Tmin=(100,'K'), Tmax=(1541.83,'K')), NASAPolynomial(coeffs=[18.7057,0.0327138,-1.34621e-05,2.44384e-09,-1.65408e-13,-2197.48,-63.5977], Tmin=(1541.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(28.7518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ)"""),
)

species(
    label = 'CCCC=C(C)O[O](7405)',
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.752706,0.075973,-6.15081e-05,2.94935e-08,-6.30919e-12,-1617.22,30.6544], Tmin=(100,'K'), Tmax=(1056.97,'K')), NASAPolynomial(coeffs=[8.2774,0.0474961,-2.10946e-05,4.00301e-09,-2.79957e-13,-3207.87,-6.06465], Tmin=(1056.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-14.3867,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]CCC=C(C)O[O](7643)',
    structure = SMILES('[CH2]CCC=C(C)O[O]'),
    E0 = (190.86,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,231.33,4000],'cm^-1')),
        HinderedRotor(inertia=(0.221618,'amu*angstrom^2'), symmetry=1, barrier=(8.41706,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221632,'amu*angstrom^2'), symmetry=1, barrier=(8.41707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221606,'amu*angstrom^2'), symmetry=1, barrier=(8.41701,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0031492,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221622,'amu*angstrom^2'), symmetry=1, barrier=(8.41711,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.714776,0.07748,-7.41872e-05,4.40943e-08,-1.15736e-11,23068.9,32.5849], Tmin=(100,'K'), Tmax=(888.394,'K')), NASAPolynomial(coeffs=[7.75181,0.0457961,-2.06916e-05,3.95081e-09,-2.7711e-13,21818.6,-0.53209], Tmin=(888.394,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(190.86,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(ROOJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC=CC(C)O[O](7644)',
    structure = SMILES('[CH2]CC=CC(C)O[O]'),
    E0 = (180.756,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,180,454.127],'cm^-1')),
        HinderedRotor(inertia=(0.441614,'amu*angstrom^2'), symmetry=1, barrier=(10.1536,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0175611,'amu*angstrom^2'), symmetry=1, barrier=(2.57308,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.069328,'amu*angstrom^2'), symmetry=1, barrier=(10.1552,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0694505,'amu*angstrom^2'), symmetry=1, barrier=(10.1543,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0693865,'amu*angstrom^2'), symmetry=1, barrier=(10.1542,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.363375,0.0753686,-5.74048e-05,2.28002e-08,-3.72442e-12,21874.4,34.4256], Tmin=(100,'K'), Tmax=(1422.2,'K')), NASAPolynomial(coeffs=[14.864,0.0345853,-1.43908e-05,2.63717e-09,-1.80107e-13,17749.9,-40.6386], Tmin=(1422.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CCC=CO[O](801)',
    structure = SMILES('[CH2]CCC=CO[O]'),
    E0 = (232.651,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,251.151,251.154],'cm^-1')),
        HinderedRotor(inertia=(0.00267254,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170322,'amu*angstrom^2'), symmetry=1, barrier=(7.62394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170325,'amu*angstrom^2'), symmetry=1, barrier=(7.62393,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170325,'amu*angstrom^2'), symmetry=1, barrier=(7.62393,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.939014,0.063741,-5.34085e-05,2.40726e-08,-4.44906e-12,28094.6,29.7569], Tmin=(100,'K'), Tmax=(1280.1,'K')), NASAPolynomial(coeffs=[12.5244,0.0275395,-1.09884e-05,1.98069e-09,-1.34588e-13,25128.5,-28.997], Tmin=(1280.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(232.651,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CC[CH][CH]O[O](804)',
    structure = SMILES('[CH2]CC[CH][CH]O[O]'),
    E0 = (489.842,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.652369,0.0811459,-0.000116388,1.0137e-07,-3.56165e-11,59027.6,32.3288], Tmin=(100,'K'), Tmax=(826.192,'K')), NASAPolynomial(coeffs=[6.37767,0.0404077,-1.87877e-05,3.54241e-09,-2.42953e-13,58526,8.48977], Tmin=(826.192,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(489.842,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(RCCJ) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2]CC[CH][C](C)O[O](7645)',
    structure = SMILES('[CH2]CC[CH][C](C)O[O]'),
    E0 = (451.735,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.118062,0.0937673,-0.000128477,1.11135e-07,-3.94776e-11,54462.9,36.2909], Tmin=(100,'K'), Tmax=(810.35,'K')), NASAPolynomial(coeffs=[6.22004,0.0503329,-2.34322e-05,4.44031e-09,-3.06187e-13,53911.1,10.8328], Tmin=(810.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(451.735,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOOH) + radical(CCJCOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C[CH][CH]C(C)O[O](7646)',
    structure = SMILES('[CH2]C[CH][CH]C(C)O[O]'),
    E0 = (459.294,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,209.716,277.834,2979.77],'cm^-1')),
        HinderedRotor(inertia=(0.0821069,'amu*angstrom^2'), symmetry=1, barrier=(2.06935,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0821069,'amu*angstrom^2'), symmetry=1, barrier=(2.06935,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0821069,'amu*angstrom^2'), symmetry=1, barrier=(2.06935,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0821069,'amu*angstrom^2'), symmetry=1, barrier=(2.06935,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0821069,'amu*angstrom^2'), symmetry=1, barrier=(2.06935,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.237715,0.091691,-0.000127248,1.1229e-07,-4.02886e-11,55367.2,38.1311], Tmin=(100,'K'), Tmax=(824.648,'K')), NASAPolynomial(coeffs=[5.24527,0.0510512,-2.35855e-05,4.44369e-09,-3.04951e-13,55097.2,18.3088], Tmin=(824.648,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(459.294,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(RCCJCC) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CC[CH]C([CH2])O[O](7648)',
    structure = SMILES('[CH2]CC[CH]C([CH2])O[O]'),
    E0 = (478.799,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0916603,0.0916495,-0.000107223,7.47265e-08,-2.18736e-11,57721.8,38.1025], Tmin=(100,'K'), Tmax=(820.773,'K')), NASAPolynomial(coeffs=[9.90413,0.0438345,-1.98492e-05,3.76609e-09,-2.62225e-13,56110.8,-7.30004], Tmin=(820.773,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(478.799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(RCCJ) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]CCC[C](C)O[O](7649)',
    structure = SMILES('[CH2]CCC[C](C)O[O]'),
    E0 = (251.32,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01705,0.0773491,-3.89063e-05,-5.85491e-08,7.421e-11,30322.4,30.9471], Tmin=(100,'K'), Tmax=(491.035,'K')), NASAPolynomial(coeffs=[6.54028,0.0524286,-2.40959e-05,4.59041e-09,-3.19753e-13,29538,5.76497], Tmin=(491.035,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(251.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOOH) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CC[CH][C](C)OO(7651)',
    structure = SMILES('[CH2]CC[CH][C](C)OO'),
    E0 = (299.73,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.646516,0.0853608,-6.46771e-05,-1.34132e-08,4.1747e-11,36158.6,33.7804], Tmin=(100,'K'), Tmax=(519.075,'K')), NASAPolynomial(coeffs=[7.25985,0.0530252,-2.50622e-05,4.8399e-09,-3.40003e-13,35221.1,3.79408], Tmin=(519.075,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CCJCOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CCCC([CH2])O[O](7652)',
    structure = SMILES('[CH2]CCCC([CH2])O[O]'),
    E0 = (278.384,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.176176,0.0883431,-8.68741e-05,4.97493e-08,-1.21085e-11,33616,35.4935], Tmin=(100,'K'), Tmax=(970.243,'K')), NASAPolynomial(coeffs=[10.6732,0.0450678,-1.99713e-05,3.78019e-09,-2.63988e-13,31579,-14.8318], Tmin=(970.243,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(278.384,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CJCOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]CCC(C)O[O](7653)',
    structure = SMILES('[CH2][CH]CCC(C)O[O]'),
    E0 = (258.867,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.980065,0.0769329,-4.53021e-05,-3.50621e-08,5.20936e-11,31232.9,33.4842], Tmin=(100,'K'), Tmax=(513.599,'K')), NASAPolynomial(coeffs=[6.57511,0.0513502,-2.31344e-05,4.37309e-09,-3.03593e-13,30420.8,7.90916], Tmin=(513.599,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(258.867,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = 'CC[CH][CH]C(C)O[O](7654)',
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.233222,0.0905544,-0.000115327,9.80989e-08,-3.50426e-11,30683.1,36.3621], Tmin=(100,'K'), Tmax=(803.384,'K')), NASAPolynomial(coeffs=[5.30761,0.0536004,-2.45053e-05,4.62281e-09,-3.18637e-13,30245,15.3396], Tmin=(803.384,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.048,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]CC[CH]C([CH2])OO(7655)',
    structure = SMILES('[CH2]CC[CH]C([CH2])OO'),
    E0 = (326.794,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00159784,0.0931915,-9.51463e-05,5.54696e-08,-1.36485e-11,39444,37.681], Tmin=(100,'K'), Tmax=(962.588,'K')), NASAPolynomial(coeffs=[11.474,0.0455049,-2.0836e-05,4.00395e-09,-2.81991e-13,37234.7,-17.2447], Tmin=(962.588,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(326.794,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CJCOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C[CH][CH]C(C)OO(7656)',
    structure = SMILES('[CH2]C[CH][CH]C(C)OO'),
    E0 = (307.29,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11528,0.0769346,-2.44845e-05,-1.08237e-07,1.2188e-10,37048.2,34.4809], Tmin=(100,'K'), Tmax=(461.263,'K')), NASAPolynomial(coeffs=[6.62411,0.0530995,-2.48142e-05,4.74305e-09,-3.30104e-13,36285.4,9.40637], Tmin=(461.263,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(307.29,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJCC) + radical(RCCJ)"""),
)

species(
    label = 'CCC[CH][C](C)O[O](7657)',
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29396,0.073159,-9.19463e-06,-1.42069e-07,1.50844e-10,29728.8,30.5761], Tmin=(100,'K'), Tmax=(448.087,'K')), NASAPolynomial(coeffs=[6.38064,0.0527026,-2.42431e-05,4.59277e-09,-3.176e-13,29022.5,7.32406], Tmin=(448.087,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(246.489,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOOH) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2][CH]C[CH]C(C)OO(7658)',
    structure = SMILES('[CH2][CH]C[CH]C(C)OO'),
    E0 = (307.278,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.611265,0.0848297,-6.98017e-05,5.5597e-09,2.4503e-11,37069.1,36.3157], Tmin=(100,'K'), Tmax=(544.653,'K')), NASAPolynomial(coeffs=[7.31802,0.0518995,-2.40699e-05,4.61467e-09,-3.23145e-13,36096.3,5.81163], Tmin=(544.653,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(307.278,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C([CH]CCC)O[O](7659)',
    structure = SMILES('[CH2]C([CH]CCC)O[O]'),
    E0 = (273.552,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.150253,0.0897548,-9.25483e-05,5.67047e-08,-1.48133e-11,33035,36.108], Tmin=(100,'K'), Tmax=(907.486,'K')), NASAPolynomial(coeffs=[10.0105,0.0462929,-2.07095e-05,3.92984e-09,-2.7455e-13,31245.4,-10.505], Tmin=(907.486,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(273.552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC[CH]C(C)O[O](7402)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]CCC(C)[CH]O[O](7633)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]CC[CH]C(C)O[O](7402)'],
    products = ['O2(S)(666)', '[CH2]CCC=CC(243)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction6',
    reactants = ['O(4)', '[CH2]CC[CH]C(C)[O](7634)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C[CH]O[O](57)', '[CH]CC[CH2](63)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]C(C)O[O](668)', '[CH2]C[CH2](29)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH2]CC[C]C(C)O[O](7635)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH]CC[CH]C(C)O[O](7636)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CC[CH]C(C)O[O](7402)'],
    products = ['O(4)', '[CH2]CCC1OC1C(7638)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC[CH]C(C)O[O](7402)'],
    products = ['HO2(9)', '[CH2]C=CCC[CH2](651)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH2]CCC=C(C)O[O](7643)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2]CC=CC(C)O[O](7644)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C=CC[CH]C(C)O[O](7476)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH3(17)', '[CH2]CCC=CO[O](801)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O2(2)', '[CH2]CC[CH][CH]C(246)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH3(17)', '[CH2]CC[CH][CH]O[O](804)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', '[CH2]CC[CH][C](C)O[O](7645)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', '[CH2]C[CH][CH]C(C)O[O](7646)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', '[CH2][CH]C[CH]C(C)O[O](7647)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', '[CH2]CC[CH]C([CH2])O[O](7648)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]CC[CH]C(C)O[O](7402)'],
    products = ['C[CH]C[CH]C(C)O[O](7650)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH2]CC[CH][C](C)OO(7651)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]CCCC([CH2])O[O](7652)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]CC[CH]C(C)O[O](7402)'],
    products = ['[CH2][CH]CCC(C)O[O](7653)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2]CC[CH]C(C)O[O](7402)'],
    products = ['CC[CH][CH]C(C)O[O](7654)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2]CC[CH]C(C)O[O](7402)'],
    products = ['[CH2]CC[CH]C([CH2])OO(7655)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]C[CH][CH]C(C)OO(7656)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2][CH]C[CH]C(C)OO(7658)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2]C([CH]CCC)O[O](7659)'],
    products = ['[CH2]CC[CH]C(C)O[O](7402)'],
