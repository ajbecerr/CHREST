...
species(
    label = '[CH2]CC[C][O](1550)',
    structure = SMILES('[CH2]CC[C][O]'),
    E0 = (587.808,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,308.057,308.53,308.565,1780.55],'cm^-1')),
        HinderedRotor(inertia=(0.00177101,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0843067,'amu*angstrom^2'), symmetry=1, barrier=(5.69613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0843205,'amu*angstrom^2'), symmetry=1, barrier=(5.6961,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92445,0.0503352,-6.73091e-05,5.92688e-08,-2.18789e-11,70767.2,21.1363], Tmin=(100,'K'), Tmax=(778.76,'K')), NASAPolynomial(coeffs=[4.69542,0.0294177,-1.41431e-05,2.73281e-09,-1.91048e-13,70538.4,9.76235], Tmin=(778.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(587.808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJ) + radical(CH2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02269,0.0290976,2.96193e-05,-6.35319e-08,2.76952e-11,-10000.7,18.4444], Tmin=(100,'K'), Tmax=(944.29,'K')), NASAPolynomial(coeffs=[14.1517,0.0139262,-3.79538e-06,6.63757e-10,-5.06702e-14,-13905.6,-47.9231], Tmin=(944.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-83.8518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ)"""),
)
...
species(
    label = '[CH2]CC=C[O](1555)',
    structure = SMILES('[CH2]CC=C[O]'),
    E0 = (121.395,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,439.317,440.119],'cm^-1')),
        HinderedRotor(inertia=(0.132299,'amu*angstrom^2'), symmetry=1, barrier=(18.3164,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132437,'amu*angstrom^2'), symmetry=1, barrier=(18.285,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06392,0.0297838,1.93326e-05,-5.14893e-08,2.33453e-11,14681.8,20.083], Tmin=(100,'K'), Tmax=(942.939,'K')), NASAPolynomial(coeffs=[13.9169,0.0116798,-3.05432e-06,5.27557e-10,-4.05894e-14,11016,-43.9895], Tmin=(942.939,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(121.395,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C[CH][CH][O](1557)',
    structure = SMILES('[CH2]C[CH][CH][O]'),
    E0 = (507.02,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,180,1439,1443.39],'cm^-1')),
        HinderedRotor(inertia=(0.00258358,'amu*angstrom^2'), symmetry=1, barrier=(3.82023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16664,'amu*angstrom^2'), symmetry=1, barrier=(3.83138,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166549,'amu*angstrom^2'), symmetry=1, barrier=(3.82929,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04847,0.0480807,-6.52857e-05,5.93852e-08,-2.21009e-11,61045.7,24.0045], Tmin=(100,'K'), Tmax=(817.575,'K')), NASAPolynomial(coeffs=[3.66568,0.0301692,-1.40779e-05,2.66998e-09,-1.84104e-13,61115.4,18.5719], Tmin=(817.575,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(507.02,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO) + radical(RCCJ) + radical(CCsJOH)"""),
)
...
species(
    ...
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04969,0.0468722,-5.30966e-05,4.48397e-08,-1.67115e-11,36361.4,22.2152], Tmin=(100,'K'), Tmax=(776.172,'K')), NASAPolynomial(coeffs=[3.7015,0.0327662,-1.50264e-05,2.85613e-09,-1.98387e-13,36273.4,15.7501], Tmin=(776.172,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.774,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C[CH][CH]O(1563)',
    structure = SMILES('[CH2]C[CH][CH]O'),
    E0 = (281.315,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80072,0.0494005,-4.75588e-05,2.64143e-08,-6.1489e-12,33912.7,24.0379], Tmin=(100,'K'), Tmax=(1020.63,'K')), NASAPolynomial(coeffs=[8.33776,0.0237815,-9.90812e-06,1.82179e-09,-1.25207e-13,32578.3,-7.63319], Tmin=(1020.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(281.315,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCsJOH) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH][O](1548)', '[CH2]C[CH2](29)'],
    products = ['[CH2]CC[CH][O](1410)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]C[CH][CH][O](1557)'],
    products = ['[CH2]CC[CH][O](1410)'],
