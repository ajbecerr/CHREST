...
reaction(
    label = 'reaction4',
    reactants = ['[CH][CH2](502)', '[CH2]C[CH2](29)'],
    products = ['[CH2][CH]CC[CH2](125)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH2][C]CC[CH2](503)'],
    products = ['[CH2][CH]CC[CH2](125)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]CC[CH][CH2](504)'],
    products = ['[CH2][CH]CC[CH2](125)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH][CH]CC[CH2](505)'],
    products = ['[CH2][CH]CC[CH2](125)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2][CH][CH]C[CH2](509)'],
    products = ['[CH2][CH]CC[CH2](125)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2][CH]C[CH][CH2](510)'],
    products = ['[CH2][CH]CC[CH2](125)'],
