...
species(
    label = '[CH]C(C=C)C[O](29119)',
    structure = SMILES('[CH]C(C=C)C[O]'),
    E0 = (465.819,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,348.419,349.015,349.908,1535.67,2227.32,2927.65],'cm^-1')),
        HinderedRotor(inertia=(0.00143097,'amu*angstrom^2'), symmetry=1, barrier=(0.122714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195181,'amu*angstrom^2'), symmetry=1, barrier=(16.8059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.531122,'amu*angstrom^2'), symmetry=1, barrier=(45.5785,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96284,0.0480517,-3.36351e-05,1.30514e-08,-2.26243e-12,56095.5,23.9566], Tmin=(100,'K'), Tmax=(1247.11,'K')), NASAPolynomial(coeffs=[6.97983,0.0319603,-1.42808e-05,2.70525e-09,-1.88436e-13,54844.1,-1.35535], Tmin=(1247.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(465.819,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25696,0.0518781,-2.53189e-05,-5.59107e-09,6.40817e-12,-11536.7,22.1956], Tmin=(100,'K'), Tmax=(988.696,'K')), NASAPolynomial(coeffs=[13.1466,0.0220885,-7.90686e-06,1.40207e-09,-9.7124e-14,-14782.8,-39.5564], Tmin=(988.696,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-96.8052,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CC(C)C=O(3641)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7551,0.0474855,-2.7726e-05,7.94157e-09,-9.30243e-13,-15553.2,21.6078], Tmin=(100,'K'), Tmax=(1874.43,'K')), NASAPolynomial(coeffs=[11.6821,0.0263012,-1.07732e-05,1.91205e-09,-1.26057e-13,-19274.7,-32.5215], Tmin=(1874.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.997,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]C([CH]O)C=C(29129)',
    structure = SMILES('[CH2]C([CH]O)C=C'),
    E0 = (177.279,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,574.914,2631.19],'cm^-1')),
        HinderedRotor(inertia=(0.502247,'amu*angstrom^2'), symmetry=1, barrier=(11.5477,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0783355,'amu*angstrom^2'), symmetry=1, barrier=(11.5484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.50224,'amu*angstrom^2'), symmetry=1, barrier=(11.5475,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.326363,'amu*angstrom^2'), symmetry=1, barrier=(76.5686,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04616,0.0623618,-6.0308e-05,3.25978e-08,-7.15048e-12,21430.3,26.7134], Tmin=(100,'K'), Tmax=(1101.88,'K')), NASAPolynomial(coeffs=[11.4386,0.0246348,-8.94887e-06,1.52348e-09,-1.00054e-13,19140.1,-24.4323], Tmin=(1101.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(177.279,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOH) + radical(Isobutyl)"""),
)
...
species(
    label = 'C=[C]C(C)C[O](29130)',
    structure = SMILES('C=[C]C(C)C[O]'),
    E0 = (255.446,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,256.337,256.976,1691.27],'cm^-1')),
        HinderedRotor(inertia=(0.00254204,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166658,'amu*angstrom^2'), symmetry=1, barrier=(7.86224,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168066,'amu*angstrom^2'), symmetry=1, barrier=(7.84796,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35794,0.042816,2.08267e-07,-6.41227e-08,5.82515e-11,30775.3,22.1369], Tmin=(100,'K'), Tmax=(465.458,'K')), NASAPolynomial(coeffs=[3.77534,0.0395797,-1.81867e-05,3.50883e-09,-2.48012e-13,30546.5,15.3419], Tmin=(465.458,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(255.446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2]C([C]=C)CO(29132)',
    structure = SMILES('[CH2]C([C]=C)CO'),
    E0 = (234.823,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,293.726,3029.68],'cm^-1')),
        HinderedRotor(inertia=(0.184227,'amu*angstrom^2'), symmetry=1, barrier=(11.2742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184284,'amu*angstrom^2'), symmetry=1, barrier=(11.2748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00195475,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25595,'amu*angstrom^2'), symmetry=1, barrier=(76.8507,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32165,0.0577502,-5.22055e-05,2.736e-08,-5.97476e-12,28340.1,26.6501], Tmin=(100,'K'), Tmax=(1090.75,'K')), NASAPolynomial(coeffs=[9.60621,0.0273687,-1.04242e-05,1.82291e-09,-1.21579e-13,26532.8,-14.0377], Tmin=(1090.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.823,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CC(C)C[O](29133)',
    structure = SMILES('[CH]=CC(C)C[O]'),
    E0 = (264.7,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,313.835,315.683],'cm^-1')),
        HinderedRotor(inertia=(0.0997684,'amu*angstrom^2'), symmetry=1, barrier=(6.88031,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0987797,'amu*angstrom^2'), symmetry=1, barrier=(6.90058,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00896778,'amu*angstrom^2'), symmetry=1, barrier=(6.88875,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99461,0.0480248,-2.95021e-05,9.4912e-09,-1.34578e-12,31904.3,23.2306], Tmin=(100,'K'), Tmax=(1453.99,'K')), NASAPolynomial(coeffs=[7.15674,0.0338236,-1.48515e-05,2.77382e-09,-1.90793e-13,30403.2,-3.60597], Tmin=(1453.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(264.7,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC([CH2])CO(28753)',
...
reaction(
    label = 'reaction5',
    reactants = ['O(4)', '[CH2]C([CH2])C=C(496)'],
    products = ['[CH2]C(C=C)C[O](5953)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]C(C=C)C[O](29119)'],
    products = ['[CH2]C(C=C)C[O](5953)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C[C]([CH2])C[O](29121)'],
    products = ['[CH2]C(C=C)C[O](5953)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]CC([CH2])[CH][O](29122)'],
    products = ['[CH2]C(C=C)C[O](5953)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C([CH]C)[CH][O](4436)'],
    products = ['[CH2]C(C=C)C[O](5953)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C=CC(=C)C[O](29125)'],
    products = ['[CH2]C(C=C)C[O](5953)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2]C(C=C)C=O(4917)'],
    products = ['[CH2]C(C=C)C[O](5953)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C2H3(60)', 'allyloxy(656)'],
    products = ['[CH2]C(C=C)C[O](5953)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(450.719,'m^3/(mol*s)'), n=0.996465, Ea=(67.2493,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO-HH_O;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 62.5 to 67.2 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction23',
    reactants = ['C2H3(60)', '[CH2][CH]C[O](1367)'],
    products = ['[CH2]C(C=C)C[O](5953)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2]C([C]=C)C[O](29127)'],
    products = ['[CH2]C(C=C)C[O](5953)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH]=CC([CH2])C[O](14695)'],
    products = ['[CH2]C(C=C)C[O](5953)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C([CH]O)C=C(29129)'],
    products = ['[CH2]C(C=C)C[O](5953)'],
