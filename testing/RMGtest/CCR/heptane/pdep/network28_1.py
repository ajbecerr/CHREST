...
species(
    label = '[CH]C(C[CH2])CCC(105)',
    structure = SMILES('[CH]C(C[CH2])CCC'),
    E0 = (435.47,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0722221,0.0773274,-5.17809e-05,1.78606e-08,-2.52538e-12,52523.6,32.9622], Tmin=(100,'K'), Tmax=(1625.48,'K')), NASAPolynomial(coeffs=[16.5359,0.0368134,-1.43944e-05,2.527e-09,-1.67067e-13,47171.4,-54.4635], Tmin=(1625.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(435.47,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]CC([CH2])CCC(106)',
...
species(
    label = '[CH2]CC(=C)CCC(110)',
    structure = SMILES('[CH2]CC(=C)CCC'),
    E0 = (103.244,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.34226,0.0699573,-3.36885e-05,1.23225e-09,2.68133e-12,12557.7,30.9164], Tmin=(100,'K'), Tmax=(1165.46,'K')), NASAPolynomial(coeffs=[13.5972,0.0404012,-1.61594e-05,2.93784e-09,-2.01246e-13,8385.77,-39.704], Tmin=(1165.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(103.244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C(C=C)CCC(111)',
...
species(
    label = '[CH2]C[C]([CH2])CCC(112)',
    structure = SMILES('[CH2]C[C]([CH2])CCC'),
    E0 = (377.759,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,239.738,433.341,3144.37],'cm^-1')),
        HinderedRotor(inertia=(0.0615286,'amu*angstrom^2'), symmetry=1, barrier=(2.45178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0615286,'amu*angstrom^2'), symmetry=1, barrier=(2.45178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0615286,'amu*angstrom^2'), symmetry=1, barrier=(2.45178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0615286,'amu*angstrom^2'), symmetry=1, barrier=(2.45178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0615286,'amu*angstrom^2'), symmetry=1, barrier=(2.45178,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56814,0.0638095,2.74767e-06,-1.13431e-07,1.05786e-10,45510.9,29.7065], Tmin=(100,'K'), Tmax=(466.322,'K')), NASAPolynomial(coeffs=[4.66865,0.054621,-2.36881e-05,4.41029e-09,-3.0403e-13,45032.4,15.0843], Tmin=(466.322,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(377.759,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(RCCJ) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]CC([CH2])[CH]CC(113)',
    structure = SMILES('[CH2]CC([CH2])[CH]CC'),
    E0 = (386.879,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CCC([CH2])C[CH2](117)',
    structure = SMILES('[CH2]CCC([CH2])C[CH2]'),
    E0 = (397.583,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,208.747,815.828,1669.98],'cm^-1')),
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.316758,0.0752799,-5.11879e-05,1.88921e-08,-2.93262e-12,47955.3,34.6346], Tmin=(100,'K'), Tmax=(1468.54,'K')), NASAPolynomial(coeffs=[13.1141,0.0404226,-1.55837e-05,2.729e-09,-1.81056e-13,44196.6,-32.0228], Tmin=(1468.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(397.583,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C[C](C)CCC(118)',
    structure = SMILES('[CH2]C[C](C)CCC'),
    E0 = (172.677,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00035,0.0723935,-4.68406e-05,1.88651e-08,-3.85763e-12,20870.8,29.7643], Tmin=(100,'K'), Tmax=(988.323,'K')), NASAPolynomial(coeffs=[4.34691,0.058849,-2.62836e-05,4.99834e-09,-3.49941e-13,20209.4,13.6584], Tmin=(988.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CCC(C)C[CH2](126)',
    structure = SMILES('[CH2]CCC(C)C[CH2]'),
    E0 = (192.501,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0164299,0.0764602,-4.67346e-05,1.4359e-08,-1.7928e-12,23305.3,33.9641], Tmin=(100,'K'), Tmax=(1826.71,'K')), NASAPolynomial(coeffs=[18.2664,0.0364982,-1.39203e-05,2.38348e-09,-1.53874e-13,16637.7,-65.0778], Tmin=(1826.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(192.501,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(15)', '[CH2]C([CH2])CCC(104)'],
    products = ['[CH2]CC([CH2])CCC(77)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(9)', '[CH]C(C[CH2])CCC(105)'],
    products = ['[CH2]CC([CH2])CCC(77)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(9)', '[CH]CC([CH2])CCC(106)'],
    products = ['[CH2]CC([CH2])CCC(77)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction12',
    reactants = ['H(9)', '[CH2]CC(=C)CCC(110)'],
    products = ['[CH2]CC([CH2])CCC(77)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(9)', '[CH2]C(C=C)CCC(111)'],
    products = ['[CH2]CC([CH2])CCC(77)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CC(5)', '[CH2]CC=C(54)'],
    products = ['[CH2]CC([CH2])CCC(77)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CC(5)', '[CH2][CH]C[CH2](85)'],
    products = ['[CH2]CC([CH2])CCC(77)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(9)', '[CH2]C[C]([CH2])CCC(112)'],
    products = ['[CH2]CC([CH2])CCC(77)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C[CH2](7)', '[CH2]CC([CH2])[CH2](96)'],
    products = ['[CH2]CC([CH2])CCC(77)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(9)', '[CH2]CC([CH2])[CH]CC(113)'],
    products = ['[CH2]CC([CH2])CCC(77)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH3](12)', '[CH2]CC([CH2])C[CH2](114)'],
    products = ['[CH2]CC([CH2])CCC(77)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(9)', '[CH2][CH]C([CH2])CCC(116)'],
    products = ['[CH2]CC([CH2])CCC(77)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(9)', '[CH2]CCC([CH2])C[CH2](117)'],
    products = ['[CH2]CC([CH2])CCC(77)'],
