...
species(
    label = '[C]=C(O)O[O](13208)',
    structure = SMILES('[C]=C(O)O[O]'),
    E0 = (510.822,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,492.5,1135,1000,350,440,435,1725],'cm^-1')),
        HinderedRotor(inertia=(0.449721,'amu*angstrom^2'), symmetry=1, barrier=(10.34,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.450576,'amu*angstrom^2'), symmetry=1, barrier=(10.3596,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (73.0275,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9382,0.0526357,-0.000105913,9.62424e-08,-3.19747e-11,61505.1,17.5858], Tmin=(100,'K'), Tmax=(916.542,'K')), NASAPolynomial(coeffs=[7.86789,0.00864356,-4.27116e-06,7.48878e-10,-4.59948e-14,61178.9,-6.35431], Tmin=(916.542,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(510.822,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(CdCdJ2_triplet)"""),
)

species(
    label = 'OC1=COO1(13209)',
    ...
    molecularWeight = (74.0355,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.4055,0.0239621,8.62849e-06,-3.78843e-08,1.87332e-11,-1522.81,13.7982], Tmin=(100,'K'), Tmax=(934.984,'K')), NASAPolynomial(coeffs=[14.5472,0.000307345,1.19301e-06,-2.22143e-10,1.02491e-14,-5029.8,-50.575], Tmin=(934.984,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-13.2237,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclobutene)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C(O)O[O](3060)'],
    products = ['O2(S)(666)', 'ethynol(3079)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(4)', '[CH]=C([O])O(9567)'],
    products = ['[CH]=C(O)O[O](3060)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['O2(2)', 'ethynol(3079)'],
    products = ['[CH]=C(O)O[O](3060)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(3943.23,'m^3/(mol*s)'), n=0.9344, Ea=(129.216,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Ct_Ct;OJ] for rate rule [Ct-O_Ct;O2b]
Euclidian distance = 1.4142135623730951
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 126.1 to 129.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction9',
    reactants = ['OH(5)', '[CH]=[C]O[O](9590)'],
    products = ['[CH]=C(O)O[O](3060)'],
    transitionState = 'TS9',
