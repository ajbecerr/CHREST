species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.964344,'amu*angstrom^2'), symmetry=1, barrier=(22.1722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.960569,'amu*angstrom^2'), symmetry=1, barrier=(22.0854,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.961608,'amu*angstrom^2'), symmetry=1, barrier=(22.1093,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.113,0.050484,-2.03586e-05,-2.5817e-08,1.8298e-11,30847.6,18.9239], Tmin=(100,'K'), Tmax=(914.461,'K')), NASAPolynomial(coeffs=[20.0082,0.00246914,1.58717e-06,-3.97486e-10,2.54198e-14,25943.6,-78.4634], Tmin=(914.461,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(255.517,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]OC=[CH](15217)',
    structure = SMILES('[CH]OC=[CH]'),
    E0 = (560.125,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3120,650,792.5,1650,426.853,426.855,426.857,426.861],'cm^-1')),
        HinderedRotor(inertia=(0.121334,'amu*angstrom^2'), symmetry=1, barrier=(15.6882,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121333,'amu*angstrom^2'), symmetry=1, barrier=(15.6883,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (55.0553,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11843,0.0296184,-1.41627e-06,-3.48738e-08,1.99746e-11,67446.3,13.8421], Tmin=(100,'K'), Tmax=(907.677,'K')), NASAPolynomial(coeffs=[17.2748,-0.00558302,4.55135e-06,-9.13368e-10,6.00659e-14,63393.6,-64.9788], Tmin=(907.677,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(560.125,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CH2_triplet)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.01658,'amu*angstrom^2'), symmetry=1, barrier=(23.3733,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01535,'amu*angstrom^2'), symmetry=1, barrier=(23.345,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.01522,'amu*angstrom^2'), symmetry=1, barrier=(23.3419,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27834,0.0469076,-1.81938e-05,-2.57739e-08,1.77307e-11,62961.6,17.5886], Tmin=(100,'K'), Tmax=(921.465,'K')), NASAPolynomial(coeffs=[19.7358,0.000668779,1.91897e-06,-4.20107e-10,2.55316e-14,58121.5,-77.7538], Tmin=(921.465,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(522.578,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CH2_triplet) + radical(Cds_P)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.955064,'amu*angstrom^2'), symmetry=1, barrier=(21.9588,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.955435,'amu*angstrom^2'), symmetry=1, barrier=(21.9673,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.955681,'amu*angstrom^2'), symmetry=1, barrier=(21.973,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32633,0.0463047,-1.3377e-05,-2.90103e-08,1.83915e-11,32963.6,19.3179], Tmin=(100,'K'), Tmax=(919.597,'K')), NASAPolynomial(coeffs=[18.3171,0.00517228,2.58927e-07,-1.41678e-10,7.70761e-15,28453,-68.7628], Tmin=(919.597,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(273.178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_P)"""),
)
...
species(
    ...
    E0 = (301.333,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,285.181,287.025],'cm^-1')),
        HinderedRotor(inertia=(0.277896,'amu*angstrom^2'), symmetry=1, barrier=(16.334,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.284174,'amu*angstrom^2'), symmetry=1, barrier=(16.3312,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.278548,'amu*angstrom^2'), symmetry=1, barrier=(16.3343,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68084,0.0429725,-2.09066e-05,-8.78097e-09,8.01912e-12,36332.8,20.5397], Tmin=(100,'K'), Tmax=(952.508,'K')), NASAPolynomial(coeffs=[13.413,0.0129935,-4.07313e-06,6.98372e-10,-4.91935e-14,33222.8,-40.084], Tmin=(952.508,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.333,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CO[CH]C(15049)'],
    products = ['C2H2(1342)', 'CH3CHO(1381)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['ketene(T)(1373)', 'CHCH3(T)(21)'],
    products = ['[CH]=CO[CH]C(15049)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3(17)', '[CH]OC=[CH](15217)'],
    products = ['[CH]=CO[CH]C(15049)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['C2H2(T)(1343)', 'CH3CHO(1381)'],
    products = ['[CH]=CO[CH]C(15049)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C2H2(T)(1343)', 'C[CH][O](1382)'],
    products = ['[CH]=CO[CH]C(15049)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH]=[C]O[CH]C(9652)'],
    products = ['[CH]=CO[CH]C(15049)'],
