...
species(
    label = 'C=[C]C[CH]C[CH]C(16069)',
    structure = SMILES('C=[C]C[CH]C[CH]C'),
    E0 = (538.884,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,2950,3100,1380,975,1025,1650,1685,370,207.858,400.988,1097.46,3443.65],'cm^-1')),
        HinderedRotor(inertia=(0.0582839,'amu*angstrom^2'), symmetry=1, barrier=(1.58962,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction5',
    reactants = ['[CH][CH]C(3874)', '[CH2]C[C]=C(2373)'],
    products = ['C=[C]CC[CH][CH]C(15526)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2CC(T)(1341)', '[CH2]C[CH][CH]C(123)'],
    products = ['C=[C]CC[CH][CH]C(15526)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', '[CH][CH]CC[C]=C(15395)'],
    products = ['C=[C]CC[CH][CH]C(15526)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'C=[C]CC[CH][C]C(16063)'],
    products = ['C=[C]CC[CH][CH]C(15526)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'C=[C]CC[C][CH]C(16064)'],
    products = ['C=[C]CC[CH][CH]C(15526)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'C=[C]C[CH]C=CC(15879)'],
    products = ['C=[C]CC[CH][CH]C(15526)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'C=[C]CC[CH]C=C(15535)'],
    products = ['C=[C]CC[CH][CH]C(15526)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', 'C=[C]C[CH][CH][CH]C(16066)'],
    products = ['C=[C]CC[CH][CH]C(15526)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=[C]C[CH]C[CH]C(16069)'],
    products = ['C=[C]CC[CH][CH]C(15526)'],
