...
species(
    label = '[CH][C]OC([CH])=C(18785)',
    structure = SMILES('[CH][C]OC([CH])=C'),
    E0 = (1052.59,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.355702,0.0687557,-7.23198e-05,3.65819e-08,-7.06926e-12,126738,24.6187], Tmin=(100,'K'), Tmax=(1344.89,'K')), NASAPolynomial(coeffs=[19.1308,0.00974891,-2.97701e-06,4.58269e-10,-2.89551e-14,121974,-70.4593], Tmin=(1344.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1052.59,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(CH2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C]1CC([CH])O1(18786)',
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21921,0.0523294,-5.10167e-05,2.74357e-08,-5.63819e-12,109311,23.1969], Tmin=(100,'K'), Tmax=(1400.49,'K')), NASAPolynomial(coeffs=[10.9632,0.015977,-2.95389e-06,2.11788e-10,-2.87487e-15,107418,-24.1106], Tmin=(1400.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(907.968,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOCs) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][CH]OC([CH])=[CH](18788)',
    structure = SMILES('[CH][CH]OC([CH])=[CH]'),
    E0 = (1032.62,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3025,407.5,1350,352.5,3120,650,792.5,1650,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.440616,0.0721334,-7.86192e-05,3.84317e-08,-6.15398e-12,124330,24.76], Tmin=(100,'K'), Tmax=(956.128,'K')), NASAPolynomial(coeffs=[18.1824,0.0111217,-3.62916e-06,5.96402e-10,-3.99145e-14,120333,-63.1959], Tmin=(956.128,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1032.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(AllylJ2_triplet) + radical(Cds_P) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]COC([CH])=[CH](18789)',
    structure = SMILES('[CH]COC([CH])=[CH]'),
    E0 = (838.697,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3120,650,792.5,1650,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.787701,0.0629745,-5.25637e-05,1.68423e-08,-1.66283e-13,100994,24.0406], Tmin=(100,'K'), Tmax=(990.886,'K')), NASAPolynomial(coeffs=[15.8274,0.0173536,-6.3478e-06,1.11839e-09,-7.69808e-14,97273.1,-52.1178], Tmin=(990.886,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(838.697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(AllylJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    label = '[C]=C([CH2])O[CH][CH](18790)',
    structure = SMILES('[C]C(=C)O[CH][CH]'),
    E0 = (1084.32,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.216772,0.0737045,-9.26687e-05,5.32151e-08,-1.13996e-11,130558,23.1962], Tmin=(100,'K'), Tmax=(1244.58,'K')), NASAPolynomial(coeffs=[21.0788,0.00140602,7.9399e-07,-2.37565e-10,1.8258e-14,125772,-80.3822], Tmin=(1244.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1084.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(CCJ2_triplet) + radical(CJ3)"""),
)

species(
    label = '[CH][CH]OC1=CC1(18791)',
    structure = SMILES('[CH]=CO[C]1[CH]C1'),
    E0 = (587.88,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48138,0.0366431,2.26015e-05,-7.13661e-08,3.43741e-11,70813.7,23.5747], Tmin=(100,'K'), Tmax=(926.261,'K')), NASAPolynomial(coeffs=[21.0218,0.000649326,2.52683e-06,-5.1615e-10,2.8631e-14,65118,-80.405], Tmin=(926.261,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(587.88,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C2CsJOC(O)) + radical(CCJCO) + radical(Cds_P)"""),
)

species(
    label = '[CH]C1CC(=[CH])O1(18792)',
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6258,0.0335061,3.41254e-05,-8.62663e-08,4.14898e-11,72705.6,17.44], Tmin=(100,'K'), Tmax=(895.321,'K')), NASAPolynomial(coeffs=[20.3093,0.000627113,4.44842e-06,-1.05395e-09,7.25965e-14,67332.3,-81.9553], Tmin=(895.321,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(603.651,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    label = '[C]=CO[C]([CH])[CH2](18793)',
    structure = SMILES('[C][CH]OC([CH])=C'),
    E0 = (1006.79,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0838137,0.0726715,-7.96889e-05,4.13324e-08,-8.06718e-12,121242,23.7834], Tmin=(100,'K'), Tmax=(1389.35,'K')), NASAPolynomial(coeffs=[20.5432,0.0068665,-1.19195e-06,9.10648e-11,-2.87287e-15,116223,-79.2521], Tmin=(1389.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1006.79,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(AllylJ2_triplet) + radical(CJ3)"""),
)

species(
    label = '[CH]C1([CH2])C=CO1(18794)',
    structure = SMILES('[CH]C1([CH2])C=CO1'),
    E0 = (572.408,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04838,0.0430431,2.27036e-05,-8.44185e-08,4.27019e-11,68971.6,19.6575], Tmin=(100,'K'), Tmax=(905.457,'K')), NASAPolynomial(coeffs=[25.3648,-0.00589426,6.88803e-06,-1.43882e-09,9.50393e-14,62170.7,-108.479], Tmin=(905.457,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(572.408,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(CJC(C)OC) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][C](C)O[C]=[CH](18795)',
    structure = SMILES('[CH][C](C)O[C]=[CH]'),
    E0 = (913.341,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,1685,370,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.92605,0.0665539,-8.20447e-05,5.03617e-08,-1.20202e-11,109961,26.9598], Tmin=(100,'K'), Tmax=(1031.99,'K')), NASAPolynomial(coeffs=[14.4776,0.0140268,-5.69471e-06,1.03846e-09,-7.13831e-14,107164,-38.845], Tmin=(1031.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(913.341,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C2CsJOC(O)) + radical(CCJ2_triplet) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH][CH](6981)', '[CH]=C([CH2])[O](9653)'],
    products = ['[CH][CH]OC([CH])=C(16574)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH][C]OC([CH])=C(18785)'],
    products = ['[CH][CH]OC([CH])=C(16574)'],
    transitionState = 'TS3',
...
reaction(
    ...
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.17979e+10,'s^-1'), n=0.520585, Ea=(139.794,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH][CH]OC([CH])=[CH](18788)'],
    products = ['[CH][CH]OC([CH])=C(16574)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CH2(T)(20)', '[CH][CH]O[C]=[CH](13316)'],
    products = ['[CH][CH]OC([CH])=C(16574)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[C]=C([CH2])O[CH][CH](18790)'],
    products = ['[CH][CH]OC([CH])=C(16574)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(T)(20)', '[CH][CH]OC#C(13320)'],
    products = ['[CH][CH]OC([CH])=C(16574)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH][CH]OC([CH])=C(16574)'],
    products = ['C2H2(1342)', '[CH]=C([CH2])[O](9653)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[C]=CO[C]([CH])[CH2](18793)'],
    products = ['[CH][CH]OC([CH])=C(16574)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH][CH]OC([CH])=C(16574)'],
    products = ['[CH]C1([CH2])C=CO1(18794)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C2H2(T)(1343)', '[CH]=C([CH2])[O](9653)'],
    products = ['[CH][CH]OC([CH])=C(16574)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C2H2(T)(1343)', '[CH][C]([CH2])[O](13252)'],
    products = ['[CH][CH]OC([CH])=C(16574)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]C([CH2])O[C]=[CH](9836)'],
    products = ['[CH][CH]OC([CH])=C(16574)'],
