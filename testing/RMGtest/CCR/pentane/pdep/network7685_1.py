...
species(
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(4203.53,'J/mol'), sigma=(7.04092,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=656.58 K, Pc=27.33 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.26285,0.092597,-0.000136775,1.25095e-07,-4.56522e-11,17487.5,32.9184], Tmin=(100,'K'), Tmax=(830.578,'K')), NASAPolynomial(coeffs=[4.58766,0.0509984,-2.41379e-05,4.57821e-09,-3.14628e-13,17485.5,17.1694], Tmin=(830.578,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(144.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(ROOJ) + radical(CCsJOOH)"""),
)
...
species(
    ...
    E0 = (13.3303,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,304.77,304.78,2253.46],'cm^-1')),
        HinderedRotor(inertia=(0.121493,'amu*angstrom^2'), symmetry=1, barrier=(8.00785,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121503,'amu*angstrom^2'), symmetry=1, barrier=(8.00771,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121521,'amu*angstrom^2'), symmetry=1, barrier=(8.00808,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31296,0.0451672,-2.11346e-05,4.09792e-09,-2.77547e-13,1655.89,21.4808], Tmin=(100,'K'), Tmax=(2471.4,'K')), NASAPolynomial(coeffs=[23.6483,0.0160869,-6.7931e-06,1.12179e-09,-6.67736e-14,-10554.5,-104.122], Tmin=(2471.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(13.3303,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCOJ)"""),
)
...
species(
    label = 'CC([C]CC[O])O[O](29578)',
    structure = SMILES('CC([C]CC[O])O[O]'),
    E0 = (397.048,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.167634,0.0935379,-0.000139581,1.23758e-07,-4.38977e-11,47882.9,32.9517], Tmin=(100,'K'), Tmax=(824.404,'K')), NASAPolynomial(coeffs=[6.78075,0.0450344,-2.14586e-05,4.0818e-09,-2.81029e-13,47350.4,5.70766], Tmin=(824.404,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(397.048,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(ROOJ) + radical(CCJ2_triplet)"""),
)

species(
    label = 'CC1OOC1CC[O](29579)',
    structure = SMILES('CC1OOC1CC[O]'),
    E0 = (-46.46,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10916,0.0697251,-6.07795e-05,3.66266e-08,-1.07572e-11,-5489.21,24.3955], Tmin=(100,'K'), Tmax=(765.627,'K')), NASAPolynomial(coeffs=[4.69219,0.0510075,-2.41121e-05,4.70176e-09,-3.33827e-13,-6037.92,8.06599], Tmin=(765.627,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(CCOJ)"""),
)
...
species(
    label = 'CC1OC1CC[O](29580)',
    structure = SMILES('CC1OC1CC[O]'),
    E0 = (-97.7563,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1255,0.0597494,-3.45004e-05,2.80244e-09,4.49431e-12,-11650.5,24.0954], Tmin=(100,'K'), Tmax=(865.276,'K')), NASAPolynomial(coeffs=[9.51441,0.0336515,-1.12439e-05,1.82328e-09,-1.16931e-13,-13577,-17.9058], Tmin=(865.276,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-97.7563,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCOJ)"""),
)
...
species(
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.47517,0.0854554,-0.000114551,1.00771e-07,-3.71612e-11,-9109.63,32.1996], Tmin=(100,'K'), Tmax=(777.798,'K')), NASAPolynomial(coeffs=[5.27003,0.0496276,-2.39161e-05,4.62431e-09,-3.23386e-13,-9517.66,12.4439], Tmin=(777.798,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-76.7334,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(CCOJ)"""),
)

species(
    label = 'CC(C=CCO)O[O](29582)',
    structure = SMILES('CC(C=CCO)O[O]'),
    E0 = (-154.98,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.123,'amu'),
...
species(
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.851976,0.0775756,-7.23268e-05,2.62855e-08,6.12494e-12,-23930.2,29.1307], Tmin=(100,'K'), Tmax=(575.417,'K')), NASAPolynomial(coeffs=[7.18983,0.0457541,-2.12712e-05,4.08847e-09,-2.8692e-13,-24862.2,0.296757], Tmin=(575.417,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.844,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(ROOJ)"""),
)

species(
    label = 'CC(C=CC[O])OO(29584)',
    structure = SMILES('CC(C=CC[O])OO'),
    E0 = (-81.2797,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03651,0.0718962,-6.00517e-05,2.94793e-08,-6.56519e-12,-9674.6,31.1853], Tmin=(100,'K'), Tmax=(1004.42,'K')), NASAPolynomial(coeffs=[7.40392,0.0465387,-2.2183e-05,4.34473e-09,-3.09217e-13,-10953.7,0.438155], Tmin=(1004.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-81.2797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCOJ)"""),
)

species(
    label = 'CC(=CCCO)O[O](28880)',
    structure = SMILES('CC(=CCCO)O[O]'),
    E0 = (-150.434,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.439853,0.0837467,-0.000103248,7.88691e-08,-2.5441e-11,-17969.9,32.2319], Tmin=(100,'K'), Tmax=(754.715,'K')), NASAPolynomial(coeffs=[8.29366,0.0416968,-1.88298e-05,3.55427e-09,-2.4601e-13,-19143.3,-3.3679], Tmin=(754.715,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-150.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = 'CC(=CCC[O])O[O](29585)',
    structure = SMILES('CC(=CCC[O])O[O]'),
    E0 = (75.2712,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,180,180,4000],'cm^-1')),
        HinderedRotor(inertia=(0.223573,'amu*angstrom^2'), symmetry=1, barrier=(5.14039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.223792,'amu*angstrom^2'), symmetry=1, barrier=(5.14541,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.223118,'amu*angstrom^2'), symmetry=1, barrier=(5.12993,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.223091,'amu*angstrom^2'), symmetry=1, barrier=(5.12931,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.687482,0.0824848,-0.00012141,1.12636e-07,-4.17779e-11,9162.99,32.195], Tmin=(100,'K'), Tmax=(824.588,'K')), NASAPolynomial(coeffs=[3.87981,0.0476143,-2.27148e-05,4.33271e-09,-2.98963e-13,9295.55,21.4057], Tmin=(824.588,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(75.2712,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(CCOJ) + radical(ROOJ)"""),
)

species(
    label = 'CC(C=CC[O])O[O](29586)',
    structure = SMILES('CC(C=CC[O])O[O]'),
    E0 = (70.725,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,304.089,304.322,2212.12],'cm^-1')),
        HinderedRotor(inertia=(0.123899,'amu*angstrom^2'), symmetry=1, barrier=(8.14391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124201,'amu*angstrom^2'), symmetry=1, barrier=(8.14649,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124655,'amu*angstrom^2'), symmetry=1, barrier=(8.14514,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124072,'amu*angstrom^2'), symmetry=1, barrier=(8.14544,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.979365,0.0721877,-7.89199e-05,5.83672e-08,-1.94242e-11,8609.71,32.143], Tmin=(100,'K'), Tmax=(708.893,'K')), NASAPolynomial(coeffs=[5.80857,0.0449346,-2.1245e-05,4.12034e-09,-2.90695e-13,7925.13,10.5071], Tmin=(708.893,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(70.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCOJ) + radical(ROOJ)"""),
)
...
species(
    label = 'C[C]([CH]CC[O])O[O](29587)',
    structure = SMILES('C[C]([CH]CC[O])O[O]'),
    E0 = (336.147,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,200,800,1200,1726.42],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.352512,0.0954032,-0.00016244,1.59984e-07,-5.99632e-11,40545.8,34.9796], Tmin=(100,'K'), Tmax=(852.561,'K')), NASAPolynomial(coeffs=[1.93261,0.0528932,-2.58984e-05,4.92946e-09,-3.37098e-13,41551.9,35.089], Tmin=(852.561,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(336.147,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(ROOJ) + radical(C2CsJOOH) + radical(CCJCOOH)"""),
)

species(
    label = 'CC([CH][CH]C[O])O[O](29588)',
    structure = SMILES('CC([CH][CH]C[O])O[O]'),
    E0 = (349.15,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.431876,0.0873932,-0.00012772,1.143e-07,-4.11522e-11,42112.9,36.8989], Tmin=(100,'K'), Tmax=(821.039,'K')), NASAPolynomial(coeffs=[5.70097,0.0455211,-2.16219e-05,4.11621e-09,-2.83825e-13,41793.7,15.8432], Tmin=(821.039,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(349.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(ROOJ) + radical(CCJCOOH) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C([CH]CC[O])O[O](29589)',
    structure = SMILES('[CH2]C([CH]CC[O])O[O]'),
    E0 = (363.21,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.152789,0.095554,-0.000150285,1.37301e-07,-4.92105e-11,43812.1,37.399], Tmin=(100,'K'), Tmax=(840.27,'K')), NASAPolynomial(coeffs=[5.97182,0.0457521,-2.19282e-05,4.16083e-09,-2.85119e-13,43614.4,14.981], Tmin=(840.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(363.21,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(ROOJ) + radical(CCJCOOH) + radical(CJCOOH)"""),
)
...
species(
    label = 'C[C](CCC[O])O[O](29590)',
    structure = SMILES('C[C](CCC[O])O[O]'),
    E0 = (135.732,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.344871,0.0931687,-0.000145816,1.39952e-07,-5.24366e-11,16444,32.7023], Tmin=(100,'K'), Tmax=(839.434,'K')), NASAPolynomial(coeffs=[2.58118,0.0543624,-2.61704e-05,4.9815e-09,-3.42174e-13,17060.4,28.2123], Tmin=(839.434,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(135.732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(ROOJ) + radical(C2CsJOOH)"""),
)
...
species(
    label = 'CC([CH]C[CH]O)O[O](29591)',
    structure = SMILES('CC([CH]C[CH]O)O[O]'),
    E0 = (103.84,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.345237,0.103482,-0.000152912,1.27541e-07,-4.2361e-11,12638,35.8822], Tmin=(100,'K'), Tmax=(838.03,'K')), NASAPolynomial(coeffs=[10.3671,0.0403393,-1.83933e-05,3.4258e-09,-2.32841e-13,11264.3,-11.3892], Tmin=(838.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(103.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CCsJOH)"""),
)

species(
    label = 'C[C]([CH]CC[O])OO(29592)',
    structure = SMILES('C[C]([CH]CC[O])OO'),
    E0 = (184.142,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.10351,0.0988311,-0.00015727,1.50366e-07,-5.62787e-11,22274.8,35.114], Tmin=(100,'K'), Tmax=(830.249,'K')), NASAPolynomial(coeffs=[3.48095,0.0546237,-2.69306e-05,5.18005e-09,-3.58053e-13,22676.7,25.2464], Tmin=(830.249,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOOH) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C(CCC[O])O[O](29593)',
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.160239,0.0931294,-0.000132943,1.16271e-07,-4.12372e-11,19709.6,35.0685], Tmin=(100,'K'), Tmax=(816.241,'K')), NASAPolynomial(coeffs=[6.56621,0.0473178,-2.22577e-05,4.2268e-09,-2.91372e-13,19144.2,8.4064], Tmin=(816.241,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.795,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(ROOJ) + radical(CJCOOH)"""),
)

species(
    label = 'CC(CC[CH][O])O[O](29594)',
    structure = SMILES('CC(CC[CH][O])O[O]'),
    E0 = (129.131,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0212952,0.0988893,-0.000150083,1.3477e-07,-4.79859e-11,15665.5,33.2735], Tmin=(100,'K'), Tmax=(834.93,'K')), NASAPolynomial(coeffs=[6.38227,0.0481232,-2.27896e-05,4.31466e-09,-2.95829e-13,15296.4,7.72824], Tmin=(834.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(129.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(ROOJ) + radical(CCsJOH)"""),
)

species(
    label = 'CC([CH][CH]CO)O[O](29595)',
    structure = SMILES('CC([CH][CH]CO)O[O]'),
    E0 = (123.445,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.235875,0.0879767,-0.000106813,7.63285e-08,-2.26694e-11,14977.8,36.7549], Tmin=(100,'K'), Tmax=(813.066,'K')), NASAPolynomial(coeffs=[10.0417,0.039736,-1.78167e-05,3.35721e-09,-2.32522e-13,13383.2,-8.52333], Tmin=(813.066,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.445,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CCJCO)"""),
)

species(
    label = '[CH2]C([CH]CC[O])OO(29596)',
    structure = SMILES('[CH2]C([CH]CC[O])OO'),
    E0 = (211.205,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0728392,0.0986884,-0.000144014,1.26174e-07,-4.48647e-11,25540,37.4508], Tmin=(100,'K'), Tmax=(801.869,'K')), NASAPolynomial(coeffs=[7.43082,0.047642,-2.30556e-05,4.43447e-09,-3.08021e-13,24774.4,5.63639], Tmin=(801.869,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(211.205,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCOOH) + radical(CJCOOH)"""),
)

species(
    label = 'CC([CH][CH]C[O])OO(29597)',
    structure = SMILES('CC([CH][CH]C[O])OO'),
    E0 = (197.145,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15897,0.0751997,-3.96816e-05,-7.18628e-08,9.30807e-11,23800.2,33.748], Tmin=(100,'K'), Tmax=(471.907,'K')), NASAPolynomial(coeffs=[7.03616,0.047652,-2.29019e-05,4.42839e-09,-3.10085e-13,22997.6,7.1804], Tmin=(471.907,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(197.145,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCOOH) + radical(CCJCO)"""),
)

species(
    label = 'C[C]([CH]CCO)O[O](29598)',
    structure = SMILES('C[C]([CH]CCO)O[O]'),
    E0 = (110.442,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0202566,0.0977702,-0.000148684,1.32783e-07,-4.68437e-11,13416.5,35.3133], Tmin=(100,'K'), Tmax=(843.017,'K')), NASAPolynomial(coeffs=[6.56624,0.046578,-2.17737e-05,4.09256e-09,-2.79179e-13,13028.2,9.09355], Tmin=(843.017,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(110.442,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOOH) + radical(CCJCOOH)"""),
)

species(
    label = 'CC([CH]C[CH][O])OO(29599)',
    structure = SMILES('CC([CH]C[CH][O])OO'),
    E0 = (177.541,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.258552,0.104499,-0.000161335,1.44897e-07,-5.16944e-11,21496.1,35.6707], Tmin=(100,'K'), Tmax=(823.123,'K')), NASAPolynomial(coeffs=[7.26935,0.0484072,-2.35634e-05,4.5165e-09,-3.11985e-13,20917.8,4.83303], Tmin=(823.123,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(177.541,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCOOH) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C([CH]CCO)O[O](29600)',
    structure = SMILES('[CH2]C([CH]CCO)O[O]'),
    E0 = (137.505,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.333738,0.0903576,-0.000100717,4.38111e-08,5.68182e-12,16660.8,35.9752], Tmin=(100,'K'), Tmax=(582.133,'K')), NASAPolynomial(coeffs=[10.3432,0.0399414,-1.81203e-05,3.40341e-09,-2.34093e-13,15184.3,-9.57116], Tmin=(582.133,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(137.505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CC([CH]O[O])CC[O](29576)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CC([CH]CC[O])O[O](8773)'],
    products = ['O2(S)(666)', 'CC=CCC[O](1610)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction6',
    reactants = ['O(4)', 'CC([O])[CH]CC[O](29577)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C[CH]O[O](57)', '[CH]CC[O](28985)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C[O](1358)', '[CH]C(C)O[O](668)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['O(4)', '[CH2]C[CH]C(C)O[O](7603)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'CC([C]CC[O])O[O](29578)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CC([CH]CC[O])O[O](8773)'],
    products = ['HO2(9)', '[CH2]C=CCC[O](1846)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', 'CC(=CCC[O])O[O](29585)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', 'CC(C=CC[O])O[O](29586)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', 'CC([CH]CC=O)O[O](7532)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH3(17)', '[O]CCC=CO[O](29439)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O2(2)', 'C[CH][CH]CC[O](1619)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH3(17)', '[O]CC[CH][CH]O[O](29441)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', 'C[C]([CH]CC[O])O[O](29587)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', 'CC([CH][CH]C[O])O[O](29588)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', '[CH2]C([CH]CC[O])O[O](29589)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', 'CC([CH]C[CH][O])O[O](8515)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
...
reaction(
    label = 'reaction36',
    reactants = ['CC([CH]C[CH]O)O[O](29591)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
...
reaction(
    label = 'reaction37',
    reactants = ['C[C]([CH]CC[O])OO(29592)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH2]C(CCC[O])O[O](29593)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
...
reaction(
    label = 'reaction40',
    reactants = ['CC([CH]CC[O])O[O](8773)'],
    products = ['CC([CH][CH]CO)O[O](29595)'],
...
reaction(
    label = 'reaction41',
    reactants = ['CC([CH]CC[O])O[O](8773)'],
    products = ['[CH2]C([CH]CC[O])OO(29596)'],
...
reaction(
    label = 'reaction42',
    reactants = ['CC([CH][CH]C[O])OO(29597)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
...
reaction(
    label = 'reaction44',
    reactants = ['CC([CH]C[CH][O])OO(29599)'],
    products = ['CC([CH]CC[O])O[O](8773)'],
...
reaction(
    label = 'reaction45',
    reactants = ['CC([CH]CC[O])O[O](8773)'],
    products = ['[CH2]C([CH]CCO)O[O](29600)'],
