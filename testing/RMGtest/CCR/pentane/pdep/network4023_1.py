...
species(
    label = '[CH2][C]C([CH][CH2])C=C(18717)',
    structure = SMILES('[CH2][C]C([CH][CH2])C=C'),
    E0 = (957.416,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03321,0.0640425,-4.72387e-05,1.83346e-08,-2.97965e-12,115258,33.247], Tmin=(100,'K'), Tmax=(1402.02,'K')), NASAPolynomial(coeffs=[11.8435,0.0332004,-1.42413e-05,2.64418e-09,-1.81827e-13,112227,-22.5595], Tmin=(1402.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(957.416,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(RCCJ) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.498055,0.0724629,-6.86172e-05,3.48598e-08,-7.12237e-12,145771,32.5148], Tmin=(100,'K'), Tmax=(1182.51,'K')), NASAPolynomial(coeffs=[14.201,0.0261107,-9.81964e-06,1.71124e-09,-1.14233e-13,142530,-35.8909], Tmin=(1182.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1210.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(RCCJ) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([CH][C][CH2])C=C(18719)',
    structure = SMILES('[CH]C([CH][C][CH2])C=C'),
    E0 = (1200.38,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.961339,0.0661334,-5.54805e-05,2.48051e-08,-4.60276e-12,144483,32.7251], Tmin=(100,'K'), Tmax=(1258.27,'K')), NASAPolynomial(coeffs=[12.0603,0.0308505,-1.34196e-05,2.52032e-09,-1.75124e-13,141690,-23.3708], Tmin=(1258.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1200.38,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(RCCJ) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C][CH]C([CH2])C=C(18720)',
    structure = SMILES('[CH][C][CH]C([CH2])C=C'),
    E0 = (1200.22,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.828288,0.0684123,-6.21565e-05,3.11191e-08,-6.42488e-12,144468,33.1993], Tmin=(100,'K'), Tmax=(1151.58,'K')), NASAPolynomial(coeffs=[11.8601,0.0300934,-1.22435e-05,2.22364e-09,-1.51836e-13,141928,-21.5796], Tmin=(1151.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1200.22,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Isobutyl) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH2][C][CH][C]([CH2])C[CH2](18721)',
    structure = SMILES('[CH2][C][CH][C]([CH2])C[CH2]'),
    E0 = (1225.76,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3025,407.5,1350,352.5,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,256.346,469.059,2004.88,3685.76],'cm^-1')),
        HinderedRotor(inertia=(0.0263818,'amu*angstrom^2'), symmetry=1, barrier=(3.31573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0263818,'amu*angstrom^2'), symmetry=1, barrier=(3.31573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0263818,'amu*angstrom^2'), symmetry=1, barrier=(3.31573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0263818,'amu*angstrom^2'), symmetry=1, barrier=(3.31573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0263818,'amu*angstrom^2'), symmetry=1, barrier=(3.31573,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.682427,0.0829653,-0.000124195,1.14151e-07,-4.11963e-11,147535,36.9159], Tmin=(100,'K'), Tmax=(855.878,'K')), NASAPolynomial(coeffs=[3.90786,0.0459973,-2.10345e-05,3.9089e-09,-2.6467e-13,147785,26.5416], Tmin=(855.878,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1225.76,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Cs_S) + radical(RCCJ) + radical(Isobutyl) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH2][C][CH]C1[CH]CC1(18722)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4647,0.0451789,3.01046e-06,-2.73015e-08,1.10429e-11,116684,31.3282], Tmin=(100,'K'), Tmax=(1098.32,'K')), NASAPolynomial(coeffs=[10.6354,0.0350242,-1.48663e-05,2.81833e-09,-1.98942e-13,113267,-20.1576], Tmin=(1098.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(969.333,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(Cs_S) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2]C1[CH][C]CC[CH]1(18723)',
    structure = SMILES('[CH2]C1[CH][C]CC[CH]1'),
    E0 = (867.692,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81992,0.0340573,3.95573e-05,-6.24629e-08,2.22046e-11,104450,25.5261], Tmin=(100,'K'), Tmax=(1070.99,'K')), NASAPolynomial(coeffs=[9.4986,0.0401267,-1.76106e-05,3.41712e-09,-2.45267e-13,100812,-21.3494], Tmin=(1070.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(867.692,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclohexane) + radical(Cs_S) + radical(Cs_S) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][C]C1C([CH2])C1[CH2](18724)',
    structure = SMILES('[CH2][C]C1C([CH2])C1[CH2]'),
    E0 = (983.453,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00509,0.0518052,5.85872e-06,-5.08362e-08,2.57452e-11,118403,29.671], Tmin=(100,'K'), Tmax=(919.753,'K')), NASAPolynomial(coeffs=[16.1496,0.0224865,-5.92617e-06,9.05828e-10,-6.11946e-14,114071,-50.5289], Tmin=(919.753,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(983.453,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Isobutyl) + radical(Isobutyl) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][C][CH]C1CC1[CH2](18725)',
    structure = SMILES('[CH2][C][CH]C1CC1[CH2]'),
    E0 = (981.955,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0969,0.0522581,-6.20721e-06,-2.8416e-08,1.45453e-11,118217,31.0878], Tmin=(100,'K'), Tmax=(984.192,'K')), NASAPolynomial(coeffs=[13.5536,0.0282771,-1.02693e-05,1.84472e-09,-1.29124e-13,114474,-35.3665], Tmin=(984.192,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(981.955,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Cs_S) + radical(Isobutyl) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2]C1[CH][C]CC1[CH2](18726)',
    structure = SMILES('[CH2]C1[CH][C]CC1[CH2]'),
    E0 = (895.605,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74954,0.0325264,5.21809e-05,-9.1394e-08,3.81825e-11,107813,28.9475], Tmin=(100,'K'), Tmax=(930.923,'K')), NASAPolynomial(coeffs=[13.2447,0.0263556,-7.51965e-06,1.23376e-09,-8.64723e-14,103800,-35.7463], Tmin=(930.923,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(895.605,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopentane) + radical(Cs_S) + radical(Isobutyl) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH2][C][CH][CH][CH2](18727)',
    structure = SMILES('[CH2][C][CH][CH][CH2]'),
    E0 = (1079.53,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3050,390,425,1340,1360,335,370,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1268.02,1268.03,1268.03],'cm^-1')),
        HinderedRotor(inertia=(0.00405642,'amu*angstrom^2'), symmetry=1, barrier=(4.62841,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201481,'amu*angstrom^2'), symmetry=1, barrier=(4.63245,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00405401,'amu*angstrom^2'), symmetry=1, barrier=(4.62389,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.201293,'amu*angstrom^2'), symmetry=1, barrier=(4.62812,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 7,
    opticalIsomers = 1,
    molecularWeight = (66.1011,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23309,0.0473558,-7.42451e-05,7.56078e-08,-2.91761e-11,129893,26.9676], Tmin=(100,'K'), Tmax=(866.128,'K')), NASAPolynomial(coeffs=[0.520857,0.0344586,-1.58787e-05,2.94963e-09,-1.99159e-13,130970,39.4869], Tmin=(866.128,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1079.53,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJCC) + radical(RCCJ) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][C][CH][C]([CH2])C=C(18728)',
    structure = SMILES('[CH2][C][CH]C([CH2])=C[CH2]'),
    E0 = (982.19,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.568195,0.065693,-4.30067e-05,7.60914e-09,2.02723e-12,118262,29.0449], Tmin=(100,'K'), Tmax=(1061.28,'K')), NASAPolynomial(coeffs=[15.6487,0.0256422,-1.01276e-05,1.86094e-09,-1.29934e-13,114116,-49.061], Tmin=(1061.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(982.19,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Allyl_P) + radical(Allyl_P) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][C][CH]C([CH2])[C]=C(18729)',
    structure = SMILES('[CH2][C][CH]C([CH2])[C]=C'),
    E0 = (1195.09,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.990576,0.0693172,-7.25551e-05,4.54707e-08,-1.20614e-11,143842,33.8824], Tmin=(100,'K'), Tmax=(899.136,'K')), NASAPolynomial(coeffs=[8.74801,0.0348061,-1.49807e-05,2.78143e-09,-1.91684e-13,142447,-2.71787], Tmin=(899.136,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1195.09,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Isobutyl) + radical(RCCJ) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]=CC([CH2])[CH][C][CH2](18730)',
    structure = SMILES('[CH]=CC([CH2])[CH][C][CH2]'),
    E0 = (1204.35,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.922269,0.0686398,-6.61401e-05,3.61779e-08,-8.24376e-12,144960,34.0517], Tmin=(100,'K'), Tmax=(1044.29,'K')), NASAPolynomial(coeffs=[10.5265,0.0318518,-1.32983e-05,2.44388e-09,-1.679e-13,142954,-12.6996], Tmin=(1044.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1204.35,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Isobutyl) + radical(RCCJ) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C]C[C]([CH2])C=C(16637)',
    structure = SMILES('[CH2][C]CC([CH2])=C[CH2]'),
    E0 = (841.077,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.312698,0.0715537,-5.39777e-05,1.83794e-08,-1.76243e-12,101299,30.3777], Tmin=(100,'K'), Tmax=(1130.16,'K')), NASAPolynomial(coeffs=[16.0705,0.0273726,-1.07227e-05,1.93876e-09,-1.33094e-13,96997,-50.8478], Tmin=(1130.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(841.077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Allyl_P) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.696824,0.0718681,-6.6321e-05,3.45542e-08,-7.46594e-12,120458,32.3719], Tmin=(100,'K'), Tmax=(1101.72,'K')), NASAPolynomial(coeffs=[11.4596,0.0327912,-1.31165e-05,2.35869e-09,-1.60066e-13,118087,-20.5945], Tmin=(1101.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1000.55,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(RCCJ) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH2][C]([CH][C]C)C=C(18731)',
    structure = SMILES('[CH2]C=C([CH2])[CH][C]C'),
    E0 = (776.944,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.544632,0.0648105,-3.20987e-05,-5.12911e-09,6.6196e-12,93578.8,26.649], Tmin=(100,'K'), Tmax=(1032.66,'K')), NASAPolynomial(coeffs=[15.7311,0.0281388,-1.10094e-05,2.02977e-09,-1.42683e-13,89261.1,-52.8241], Tmin=(1032.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(776.944,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Allyl_P) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2]C([C]=C)[CH][C]C(18732)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.985624,0.068256,-6.11818e-05,3.22737e-08,-7.30098e-12,119158,32.11], Tmin=(100,'K'), Tmax=(1034.7,'K')), NASAPolynomial(coeffs=[9.12729,0.036782,-1.55548e-05,2.87622e-09,-1.98202e-13,117473,-7.44668], Tmin=(1034.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(989.847,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Isobutyl) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]=CC([CH2])[CH][C]C(18733)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.823892,0.0686848,-5.86248e-05,2.79301e-08,-5.56147e-12,120279,32.6136], Tmin=(100,'K'), Tmax=(1180.87,'K')), NASAPolynomial(coeffs=[11.3129,0.0331548,-1.34927e-05,2.45042e-09,-1.67193e-13,117802,-19.7338], Tmin=(1180.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(999.101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Isobutyl) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C][CH]C([CH2])C=C(16638)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2][C]C([CH][CH2])C=C(18717)'],
    products = ['[CH2][C][CH]C([CH2])C=C(16638)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', '[CH2][C]=C[CH][CH][CH2](17120)'],
    products = ['[CH2][C][CH]C([CH2])C=C(16638)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH2][C][C]C([CH2])C=C(18718)'],
    products = ['[CH2][C][CH]C([CH2])C=C(16638)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C([CH][C][CH2])C=C(18719)'],
    products = ['[CH2][C][CH]C([CH2])C=C(16638)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH][C][CH]C([CH2])C=C(18720)'],
    products = ['[CH2][C][CH]C([CH2])C=C(16638)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C][CH][C]([CH2])C[CH2](18721)'],
    products = ['[CH2][C][CH]C([CH2])C=C(16638)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][C][CH]C([CH2])C=C(16638)'],
    products = ['[CH2][C][CH]C1[CH]CC1(18722)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C][CH]C([CH2])C=C(16638)'],
    products = ['[CH2]C1[CH][C]CC[CH]1(18723)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][C][CH]C([CH2])C=C(16638)'],
    products = ['[CH2][C]C1C([CH2])C1[CH2](18724)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][C][CH]C([CH2])C=C(16638)'],
    products = ['[CH2][C][CH]C1CC1[CH2](18725)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][C][CH]C([CH2])C=C(16638)'],
    products = ['[CH2]C1[CH][C]CC1[CH2](18726)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(8.22e+08,'cm^3/(mol*s)'), n=1.533, Ea=(135.728,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 192 used for Cd_R;HJ
Exact match found for rate rule [Cd_R;HJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 131.4 to 135.7 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(9.2456e+13,'m^3/(mol*s)'), n=-2.73375, Ea=(79.0164,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CH2_triplet] + [Cd_R;Y_1centerbirad] for rate rule [Cd_R;CH2_triplet]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 74.2 to 79.0 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction23',
    reactants = ['C2H3(60)', '[CH2][C][CH][CH][CH2](18727)'],
    products = ['[CH2][C][CH]C([CH2])C=C(16638)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH2][C][CH][C]([CH2])C=C(18728)'],
    products = ['[CH2][C][CH]C([CH2])C=C(16638)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2][C][CH]C([CH2])[C]=C(18729)'],
    products = ['[CH2][C][CH]C([CH2])C=C(16638)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH]=CC([CH2])[CH][C][CH2](18730)'],
    products = ['[CH2][C][CH]C([CH2])C=C(16638)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2][C][CH]C([CH2])C=C(16638)'],
    products = ['[CH2][C]C[C]([CH2])C=C(16637)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2][C][CH]C([CH2])C=C(16638)'],
    products = ['[CH2][C]=C[C](C)[CH][CH2](17661)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2][C]CC([CH2])[C]=C(16639)'],
    products = ['[CH2][C][CH]C([CH2])C=C(16638)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2][C][CH]C([CH2])C=C(16638)'],
    products = ['[CH2][C]C(C)C=[C][CH2](17656)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]=CC([CH2])C[C][CH2](14036)'],
    products = ['[CH2][C][CH]C([CH2])C=C(16638)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2][C][CH]C([CH2])C=C(16638)'],
    products = ['[CH][CH]C(C)C=[C][CH2](17657)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2][C][CH]C([CH2])C=C(16638)'],
    products = ['[CH2][C]([CH][C]C)C=C(18731)'],
    transitionState = 'TS33',
    kinetics = Arrhenius(A=(434.916,'s^-1'), n=2.67444, Ea=(131.125,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4Hall;C_rad_out_2H;XH_out]
Euclidian distance = 0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C([C]=C)[CH][C]C(18732)'],
    products = ['[CH2][C][CH]C([CH2])C=C(16638)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]=CC([CH2])[CH][C]C(18733)'],
    products = ['[CH2][C][CH]C([CH2])C=C(16638)'],
