...
species(
    label = '[CH2][C]OO[CH][CH2](1956)',
    structure = SMILES('[CH2][C]OO[CH][CH2]'),
    E0 = (852.665,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,224.73,1802.99],'cm^-1')),
        HinderedRotor(inertia=(0.0034523,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.376784,'amu*angstrom^2'), symmetry=1, barrier=(13.8798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.992376,'amu*angstrom^2'), symmetry=1, barrier=(34.5188,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00429,'amu*angstrom^2'), symmetry=1, barrier=(34.6318,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.984305,'amu*angstrom^2'), symmetry=1, barrier=(34.5149,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.843411,0.0748182,-0.000110304,8.66511e-08,-2.72936e-11,102661,27.0219], Tmin=(100,'K'), Tmax=(776.673,'K')), NASAPolynomial(coeffs=[10.7125,0.0239891,-1.2134e-05,2.38271e-09,-1.679e-13,101128,-18.0961], Tmin=(776.673,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(852.665,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CJCOOH) + radical(CJCOOH) + radical(CH2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49561,0.0494159,-3.75607e-05,1.4655e-08,-2.31542e-12,40911.3,20.4789], Tmin=(100,'K'), Tmax=(1488.87,'K')), NASAPolynomial(coeffs=[12.3943,0.0201351,-8.06058e-06,1.44567e-09,-9.73754e-14,37666,-36.4386], Tmin=(1488.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(339.368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(CJCOOH) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][CH]OO[CH][CH2](1532)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH][CH2](502)', '[CH2][CH]O[O](674)'],
    products = ['[CH2][CH]OO[CH][CH2](1532)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2][C]OO[CH][CH2](1956)'],
    products = ['[CH2][CH]OO[CH][CH2](1532)'],
    transitionState = 'TS4',
