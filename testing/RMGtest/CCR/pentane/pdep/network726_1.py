...
species(
    label = '[CH2][C]OO[C]=C(2800)',
    structure = SMILES('[CH2][C]OO[C]=C'),
    E0 = (834.923,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,325.705,329.608],'cm^-1')),
        HinderedRotor(inertia=(0.100678,'amu*angstrom^2'), symmetry=1, barrier=(7.53456,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.301059,'amu*angstrom^2'), symmetry=1, barrier=(22.4662,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.387753,'amu*angstrom^2'), symmetry=1, barrier=(28.6455,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101288,'amu*angstrom^2'), symmetry=1, barrier=(7.52989,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38368,0.062047,-8.66178e-05,6.46088e-08,-1.94234e-11,100508,26.6054], Tmin=(100,'K'), Tmax=(810.812,'K')), NASAPolynomial(coeffs=[9.71613,0.0209427,-1.05794e-05,2.09205e-09,-1.48578e-13,99156.9,-11.8469], Tmin=(810.812,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(834.923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJCOOH) + radical(CH2_triplet) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['C=[C]O[O](1354)', '[CH][CH2](502)'],
...
reaction(
    label = 'reaction4',
    reactants = ['H2CC(T)(1341)', '[CH2][CH]O[O](674)'],
    products = ['[CH2][CH]OO[C]=C(2324)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(15399.6,'m^3/(mol*s)'), n=0.932885, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2][C]OO[C]=C(2800)'],
    products = ['[CH2][CH]OO[C]=C(2324)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH][CH]OO[C]=C(2801)'],
    products = ['[CH2][CH]OO[C]=C(2324)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    ...
    products = ['[CH2][CH]OO[C]=C(2324)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(6.16957e+06,'m^3/(mol*s)'), n=-1.87134e-07, Ea=(31.4896,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=1.52051667475e-07, var=0.241111252513, Tref=1000.0, N=4, correlation='Root_N-1R->H_N-1CNOS->N_1COS->O_Ext-1O-R_Ext-2R-R_Ext-2R-R_N-4R!H->O',), comment="""BM rule fitted to 2 training reactions at node Root_N-1R->H_N-1CNOS->N_1COS->O_Ext-1O-R_Ext-2R-R_Ext-2R-R_N-4R!H->O
    Total Standard Deviation in ln(k): 0.984387063055
Exact match found for rate rule [Root_N-1R->H_N-1CNOS->N_1COS->O_Ext-1O-R_Ext-2R-R_Ext-2R-R_N-4R!H->O]
Euclidian distance = 0
family: R_Recombination
Ea raised from 29.4 to 31.5 kJ/mol to match endothermicity of reaction."""),
)
