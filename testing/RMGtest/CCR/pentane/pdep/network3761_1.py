...
species(
    label = '[CH]C([CH2])[C]([CH2])C(16986)',
    structure = SMILES('[CH]C([CH2])[C]([CH2])C'),
    E0 = (840.549,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,282.729,436.308,2236.54,3759.73],'cm^-1')),
        HinderedRotor(inertia=(0.0247355,'amu*angstrom^2'), symmetry=1, barrier=(3.59149,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0247355,'amu*angstrom^2'), symmetry=1, barrier=(3.59149,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0247355,'amu*angstrom^2'), symmetry=1, barrier=(3.59149,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0247355,'amu*angstrom^2'), symmetry=1, barrier=(3.59149,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0247355,'amu*angstrom^2'), symmetry=1, barrier=(3.59149,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13272,0.0665732,-7.8159e-05,5.94805e-08,-1.86931e-11,101195,29.5282], Tmin=(100,'K'), Tmax=(894.06,'K')), NASAPolynomial(coeffs=[6.3731,0.0357437,-1.40464e-05,2.43632e-09,-1.59154e-13,100553,6.48375], Tmin=(894.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(840.549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Isobutyl) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13272,0.0665732,-7.8159e-05,5.94805e-08,-1.86931e-11,101195,28.8351], Tmin=(100,'K'), Tmax=(894.06,'K')), NASAPolynomial(coeffs=[6.3731,0.0357437,-1.40464e-05,2.43632e-09,-1.59154e-13,100553,5.7906], Tmin=(894.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(840.549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Isobutyl) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C]1CCC1C(16988)',
...
species(
    label = '[CH]C(=[CH])C(C)C(16992)',
    structure = SMILES('[CH]C(=[CH])C(C)C'),
    E0 = (534.636,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,3120,650,792.5,1650,406.314,406.319,406.322],'cm^-1')),
        HinderedRotor(inertia=(0.441991,'amu*angstrom^2'), symmetry=1, barrier=(51.7833,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.442002,'amu*angstrom^2'), symmetry=1, barrier=(51.7833,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.442018,'amu*angstrom^2'), symmetry=1, barrier=(51.7831,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.442007,'amu*angstrom^2'), symmetry=1, barrier=(51.7833,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00943,0.0567299,-2.1605e-05,-7.46868e-09,5.71727e-12,64417.2,23.6957], Tmin=(100,'K'), Tmax=(1061.17,'K')), NASAPolynomial(coeffs=[11.6024,0.0338106,-1.32519e-05,2.38927e-09,-1.63896e-13,61211.3,-32.5507], Tmin=(1061.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(534.636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    label = '[C]=C([CH2])C([CH2])C(16993)',
    structure = SMILES('[C]C(=C)C([CH2])C'),
    E0 = (791.415,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,346.077,346.118],'cm^-1')),
        HinderedRotor(inertia=(0.00140731,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135612,'amu*angstrom^2'), symmetry=1, barrier=(11.528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.275257,'amu*angstrom^2'), symmetry=1, barrier=(23.3943,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11241,0.0563712,-3.56755e-05,3.92006e-09,3.49371e-12,95295.6,23.4329], Tmin=(100,'K'), Tmax=(971.396,'K')), NASAPolynomial(coeffs=[13.0404,0.0228198,-7.90227e-06,1.3552e-09,-9.15784e-14,92243.8,-37.5469], Tmin=(971.396,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(791.415,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(Isobutyl) + radical(CJ3)"""),
)

species(
    label = '[CH2]C(C)C1=CC1(16994)',
    ...
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47591,0.0430024,1.10798e-05,-4.65185e-08,2.17113e-11,46561.1,23.2641], Tmin=(100,'K'), Tmax=(946.047,'K')), NASAPolynomial(coeffs=[13.3875,0.0236891,-7.52982e-06,1.28842e-09,-8.99677e-14,42917.8,-40.8856], Tmin=(946.047,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(386.281,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Isobutyl)"""),
)

species(
    label = '[CH]=C1CCC1C(16995)',
    ...
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93721,0.0311225,3.82538e-05,-6.61138e-08,2.57824e-11,39940,20.0725], Tmin=(100,'K'), Tmax=(995.946,'K')), NASAPolynomial(coeffs=[11.0762,0.0292158,-1.1284e-05,2.12785e-09,-1.53627e-13,36393.8,-32.6451], Tmin=(995.946,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(331.358,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH]C(=C)C[CH2](15610)'],
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', '[CH]C(=C)[CH]C(16940)'],
    products = ['[CH]C(=C)C([CH2])C(15630)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]C(=C)C([CH])C(16985)'],
    products = ['[CH]C(=C)C([CH2])C(15630)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]C([CH2])[C]([CH2])C(16986)'],
    products = ['[CH]C(=C)C([CH2])C(15630)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]C([CH2])C([CH2])[CH2](632)'],
    products = ['[CH]C(=C)C([CH2])C(15630)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH][C](C)C([CH2])[CH2](16987)'],
    products = ['[CH]C(=C)C([CH2])C(15630)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]=C([CH2])C(=C)C(16087)'],
    products = ['[CH]C(=C)C([CH2])C(15630)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(17)', '[CH]=C([CH2])C=C(15994)'],
    products = ['[CH]C(=C)C([CH2])C(15630)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(17)', '[CH]C(=C)[CH][CH2](16938)'],
    products = ['[CH]C(=C)C([CH2])C(15630)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH]=C([CH2])[C]([CH2])C(16083)'],
    products = ['[CH]C(=C)C([CH2])C(15630)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH]C(=C)C([CH2])[CH2](15717)'],
    products = ['[CH]C(=C)C([CH2])C(15630)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH]C(=[CH])C([CH2])C(16990)'],
    products = ['[CH]C(=C)C([CH2])C(15630)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(T)(20)', '[CH]=[C]C([CH2])C(9702)'],
    products = ['[CH]C(=C)C([CH2])C(15630)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[C]=C([CH2])C([CH2])C(16993)'],
    products = ['[CH]C(=C)C([CH2])C(15630)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH2(T)(20)', 'C#CC([CH2])C(9709)'],
    products = ['[CH]C(=C)C([CH2])C(15630)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]C(=C)C([CH2])C(15630)'],
    products = ['[CH2][C](C)C([CH2])=C(15637)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]=C(C)C([CH2])[CH2](15724)'],
    products = ['[CH]C(=C)C([CH2])C(15630)'],
