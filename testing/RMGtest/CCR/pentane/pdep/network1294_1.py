...
species(
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19287,0.0236791,5.77741e-05,-9.83403e-08,4.26406e-11,5367.32,18.0957], Tmin=(100,'K'), Tmax=(892.268,'K')), NASAPolynomial(coeffs=[13.3652,0.0164071,-1.97452e-06,7.73375e-11,-1.75568e-15,1669.3,-44.0812], Tmin=(892.268,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(43.9595,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(12dioxane) + radical(CCJCOOH)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.119296,'amu*angstrom^2'), symmetry=1, barrier=(2.74285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119256,'amu*angstrom^2'), symmetry=1, barrier=(2.74193,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.907578,'amu*angstrom^2'), symmetry=1, barrier=(20.867,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73254,0.0533975,-5.70896e-05,3.82227e-08,-1.11033e-11,28431.8,22.6013], Tmin=(100,'K'), Tmax=(816.332,'K')), NASAPolynomial(coeffs=[6.58375,0.0296261,-1.34084e-05,2.54893e-09,-1.77913e-13,27639.8,0.18164], Tmin=(816.332,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.743,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCsJOOH)"""),
)

species(
    label = 'C=[C]CCO[O](6724)',
    structure = SMILES('C=[C]CCO[O]'),
    E0 = (285.002,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,1685,370,230.308,230.396],'cm^-1')),
        HinderedRotor(inertia=(0.193485,'amu*angstrom^2'), symmetry=1, barrier=(7.28811,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193068,'amu*angstrom^2'), symmetry=1, barrier=(7.28812,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.193419,'amu*angstrom^2'), symmetry=1, barrier=(7.28821,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60866,0.0564132,-6.97463e-05,5.47044e-08,-1.8208e-11,34360.3,23.3623], Tmin=(100,'K'), Tmax=(769.91,'K')), NASAPolynomial(coeffs=[6.41487,0.0294553,-1.33526e-05,2.51984e-09,-1.74227e-13,33679.2,1.81445], Tmin=(769.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(285.002,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CCCO[O](6725)',
    structure = SMILES('[CH]=CCCO[O]'),
    E0 = (294.257,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,189.774],'cm^-1')),
        HinderedRotor(inertia=(0.379837,'amu*angstrom^2'), symmetry=1, barrier=(9.39885,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.366312,'amu*angstrom^2'), symmetry=1, barrier=(9.41182,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.346854,'amu*angstrom^2'), symmetry=1, barrier=(9.39739,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68391,0.0538551,-5.58307e-05,3.42548e-08,-8.92904e-12,35471.8,23.0288], Tmin=(100,'K'), Tmax=(911.009,'K')), NASAPolynomial(coeffs=[7.72316,0.0273379,-1.21687e-05,2.30285e-09,-1.60621e-13,34371.5,-5.5441], Tmin=(911.009,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(294.257,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_P)"""),
)

species(
    label = 'C=CC[CH]OO(6726)',
...
species(
    ...
    E0 = (132.998,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,1685,370,242.723,242.73],'cm^-1')),
        HinderedRotor(inertia=(0.00286087,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.323072,'amu*angstrom^2'), symmetry=1, barrier=(13.5075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.323026,'amu*angstrom^2'), symmetry=1, barrier=(13.5075,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08383,'amu*angstrom^2'), symmetry=1, barrier=(45.3194,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
...
species(
    ...
    E0 = (142.252,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,262.71],'cm^-1')),
        HinderedRotor(inertia=(0.260033,'amu*angstrom^2'), symmetry=1, barrier=(12.7353,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.393681,'amu*angstrom^2'), symmetry=1, barrier=(19.285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151104,'amu*angstrom^2'), symmetry=1, barrier=(7.40112,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.788807,'amu*angstrom^2'), symmetry=1, barrier=(38.6411,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46538,0.0570099,-4.997e-05,2.37905e-08,-4.75105e-12,17199.1,23.0468], Tmin=(100,'K'), Tmax=(1167.92,'K')), NASAPolynomial(coeffs=[9.99584,0.0277941,-1.24472e-05,2.37197e-09,-1.66303e-13,15206.5,-19.4319], Tmin=(1167.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.252,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(4)', 'C=CCC[O](1554)'],
    products = ['C=CCCO[O](4861)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'C=CC[CH]O[O](6723)'],
    products = ['C=CCCO[O](4861)'],
