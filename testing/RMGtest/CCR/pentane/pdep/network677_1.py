...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.409587,0.0686607,-7.02273e-05,3.56555e-08,-6.97054e-12,51810.7,28.2074], Tmin=(100,'K'), Tmax=(1312.14,'K')), NASAPolynomial(coeffs=[17.9843,0.0128139,-3.78861e-06,5.80524e-10,-3.64188e-14,47394.1,-60.6096], Tmin=(1312.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(429.631,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(RCCJ) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H2CC(T)(1341)', '[CH2][CH]C[O](1367)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH][CH2](502)', '[CH2]O[C]=C(2363)'],
    products = ['[CH2][CH]CO[C]=C(2284)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH][CH]CO[C]=C(2620)'],
    products = ['[CH2][CH]CO[C]=C(2284)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH2]C=CO[C]=C(2622)'],
    products = ['[CH2][CH]CO[C]=C(2284)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2][CH][CH]O[C]=C(2624)'],
    products = ['[CH2][CH]CO[C]=C(2284)'],
