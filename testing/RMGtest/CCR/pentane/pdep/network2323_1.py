...
species(
    label = '[C]=[C]OC[CH][CH2](9858)',
    structure = SMILES('[C]=[C]OC[CH][CH2]'),
    E0 = (993.707,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1685,370,180.075,283.036,1051.86,2992.55],'cm^-1')),
        HinderedRotor(inertia=(0.0232781,'amu*angstrom^2'), symmetry=1, barrier=(18.3455,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0231467,'amu*angstrom^2'), symmetry=1, barrier=(18.3383,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.798331,'amu*angstrom^2'), symmetry=1, barrier=(18.3589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.796529,'amu*angstrom^2'), symmetry=1, barrier=(18.3155,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2245,0.0570618,-6.0382e-05,3.23265e-08,-6.77773e-12,119619,28.6805], Tmin=(100,'K'), Tmax=(1168.1,'K')), NASAPolynomial(coeffs=[13.7216,0.0142676,-5.42904e-06,9.63799e-10,-6.54669e-14,116699,-33.5529], Tmin=(1168.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(993.707,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(RCCJ) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=[CH](9646)', '[CH2][CH]C[O](1367)'],
    products = ['[CH]=[C]OC[CH][CH2](2625)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH][CH2](502)', '[CH]=[C]O[CH2](9647)'],
    products = ['[CH]=[C]OC[CH][CH2](2625)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH][CH]CO[C]=[CH](9857)'],
    products = ['[CH]=[C]OC[CH][CH2](2625)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[C]=[C]OC[CH][CH2](9858)'],
    products = ['[CH]=[C]OC[CH][CH2](2625)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]=[C]OC=C[CH2](9859)'],
    products = ['[CH]=[C]OC[CH][CH2](2625)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.82396,'m^3/(mol*s)'), n=2.03228, Ea=(32.6922,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 31.4 to 32.7 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH]=[C]O[CH][CH][CH2](9860)'],
    products = ['[CH]=[C]OC[CH][CH2](2625)'],
