...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.683978,0.0765789,-8.1e-05,3.92791e-08,-6.94912e-12,69000.3,28.0838], Tmin=(100,'K'), Tmax=(1647.17,'K')), NASAPolynomial(coeffs=[22.895,0.00240828,1.94412e-06,-5.24324e-10,3.81031e-14,63526.7,-90.4744], Tmin=(1647.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(572.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(CCsJOC(O)) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]=COC([CH2])[C][CH2](7144)',
    structure = SMILES('[CH]=COC([CH2])[C][CH2]'),
    E0 = (865.357,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.690818,0.0910876,-0.000105213,5.81169e-08,-1.21468e-11,104258,31.5102], Tmin=(100,'K'), Tmax=(1260.66,'K')), NASAPolynomial(coeffs=[23.3888,0.0094671,-1.88856e-06,1.93403e-10,-8.98032e-15,98601.1,-88.5931], Tmin=(1260.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(865.357,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(RCCJ) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[CH]C([CH][CH2])OC=[CH](7145)',
    structure = SMILES('[CH]C([CH][CH2])OC=[CH]'),
    E0 = (854.749,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.212088,0.0688984,-3.83484e-05,-1.52154e-08,1.52173e-11,102952,32.1137], Tmin=(100,'K'), Tmax=(935.317,'K')), NASAPolynomial(coeffs=[22.5417,0.009745,-1.76498e-06,2.51391e-10,-2.05931e-14,97185.5,-82.6185], Tmin=(935.317,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(854.749,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(RCCJ) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    label = '[C]=COC([CH2])[CH][CH2](7147)',
    structure = SMILES('[C]=COC([CH2])[CH][CH2]'),
    E0 = (928.05,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3010,987.5,1337.5,450,1655,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.35382,0.0850283,-9.52502e-05,5.17751e-08,-1.07397e-11,111785,32.8679], Tmin=(100,'K'), Tmax=(1236.68,'K')), NASAPolynomial(coeffs=[21.5572,0.0116143,-3.1192e-06,4.46098e-10,-2.70637e-14,106560,-76.708], Tmin=(1236.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(928.05,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(CJC(C)OC) + radical(RCCJ) + radical(CdCdJ2_triplet)"""),
)

species(
    label = '[CH]=COC1CC1[CH2](7148)',
    structure = SMILES('[CH]=COC1CC1[CH2]'),
    E0 = (360.023,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.737979,0.0476875,3.72757e-05,-1.0115e-07,4.79239e-11,43440.6,25.3029], Tmin=(100,'K'), Tmax=(916.314,'K')), NASAPolynomial(coeffs=[24.6071,0.00638764,1.92223e-06,-5.18749e-10,3.07605e-14,36425.8,-102.174], Tmin=(916.314,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(360.023,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Isobutyl) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C1C=COC1[CH2](7149)',
    structure = SMILES('[CH2]C1C=COC1[CH2]'),
    E0 = (218.893,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12609,0.0422525,4.24613e-05,-1.03908e-07,4.98116e-11,26450.1,20.7059], Tmin=(100,'K'), Tmax=(886.055,'K')), NASAPolynomial(coeffs=[21.4704,0.00797457,3.04036e-06,-9.26581e-10,6.78955e-14,20585.3,-87.7334], Tmin=(886.055,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(218.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(2,3-Dihydrofuran) + radical(Isobutyl) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][CH]C1CC=CO1(7150)',
    structure = SMILES('[CH2][CH]C1CC=CO1'),
    E0 = (216.421,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63519,0.0267175,8.25432e-05,-1.39709e-07,6.0165e-11,26138.2,22.5623], Tmin=(100,'K'), Tmax=(910.347,'K')), NASAPolynomial(coeffs=[20.4842,0.00997102,1.2641e-06,-4.56854e-10,2.80235e-14,19968.5,-81.6404], Tmin=(910.347,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(2,3-Dihydrofuran) + radical(CCJCO) + radical(RCCJ)"""),
)

species(
    label = '[CH]=COC(=C)C[CH2](7151)',
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.625947,0.0653908,-4.81067e-05,1.36236e-08,1.84407e-14,43152.7,30.2577], Tmin=(100,'K'), Tmax=(1061.36,'K')), NASAPolynomial(coeffs=[15.4524,0.0236413,-9.06935e-06,1.64463e-09,-1.14032e-13,39209.7,-45.9032], Tmin=(1061.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(357.719,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=COC(C)=C[CH2](7152)',
    structure = SMILES('[CH]=COC(C)=C[CH2]'),
    E0 = (290.592,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.592649,0.0658456,-4.71643e-05,1.19127e-08,7.36595e-13,35080.7,27.7647], Tmin=(100,'K'), Tmax=(1051.8,'K')), NASAPolynomial(coeffs=[15.6442,0.0239068,-9.17721e-06,1.6672e-09,-1.15866e-13,31068,-49.6341], Tmin=(1051.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(290.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=COC=C[CH2](7154)',
    structure = SMILES('[CH]=CO[CH]C=C'),
    E0 = (282.087,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,3120,650,792.5,1650,309.257,309.685,309.696],'cm^-1')),
        HinderedRotor(inertia=(0.394057,'amu*angstrom^2'), symmetry=1, barrier=(26.7763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.393911,'amu*angstrom^2'), symmetry=1, barrier=(26.7943,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.393565,'amu*angstrom^2'), symmetry=1, barrier=(26.7777,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.442611,0.0852843,-8.87923e-05,4.52922e-08,-8.88038e-12,72026.5,31.815], Tmin=(100,'K'), Tmax=(1289.38,'K')), NASAPolynomial(coeffs=[21.8593,0.0144578,-4.48846e-06,7.16962e-10,-4.63416e-14,66411.7,-80.9184], Tmin=(1289.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(597.445,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJ) + radical(CCsJOC(O)) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]=CO[C](C)[CH][CH2](7158)',
    structure = SMILES('[CH][CH]OC(C)=C[CH2]'),
    E0 = (530.318,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.510226,0.0861278,-8.91344e-05,4.51403e-08,-8.78118e-12,63956,29.4462], Tmin=(100,'K'), Tmax=(1308.85,'K')), NASAPolynomial(coeffs=[22.2093,0.0144655,-4.45222e-06,7.06288e-10,-4.5468e-14,58199.6,-85.5483], Tmin=(1308.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(530.318,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(CCsJOC(O)) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]=[C]OC([CH2])C[CH2](7160)',
    structure = SMILES('[CH]=[C]OC([CH2])C[CH2]'),
    E0 = (656.886,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1685,370,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0181327,0.0849254,-9.54488e-05,5.48215e-08,-1.23406e-11,79152.9,32.3214], Tmin=(100,'K'), Tmax=(1089.95,'K')), NASAPolynomial(coeffs=[17.2616,0.0215114,-8.17875e-06,1.44338e-09,-9.74608e-14,75386,-52.5316], Tmin=(1089.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(656.886,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(RCCJ) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=COC([CH2])[CH][CH2](5568)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH][CH2](502)', '[CH][CH]OC=C(6927)'],
    products = ['[CH]=COC([CH2])[CH][CH2](5568)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[CH]=CO[CH][CH][CH2](7143)'],
    products = ['[CH]=COC([CH2])[CH][CH2](5568)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]=COC([CH2])[C][CH2](7144)'],
    products = ['[CH]=COC([CH2])[CH][CH2](5568)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]C([CH][CH2])OC=[CH](7145)'],
    products = ['[CH]=COC([CH2])[CH][CH2](5568)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[C]=COC([CH2])[CH][CH2](7147)'],
    products = ['[CH]=COC([CH2])[CH][CH2](5568)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=COC([CH2])[CH][CH2](5568)'],
    products = ['[CH2]C1C=COC1[CH2](7149)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH]=COC([CH2])=C[CH2](7153)'],
    products = ['[CH]=COC([CH2])[CH][CH2](5568)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(T)(20)', '[CH]=COC=C[CH2](7154)'],
    products = ['[CH]=COC([CH2])[CH][CH2](5568)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH][CH2](502)', '[CH]=COC=C(6926)'],
    products = ['[CH]=COC([CH2])[CH][CH2](5568)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.6e+11,'cm^3/(mol*s)'), n=0, Ea=(191.658,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using an average for rate rule [Cd_R;O_rad/OneDe]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 189.0 to 191.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction20',
    reactants = ['C2H2(1342)', '[CH2][CH]C([CH2])[O](1582)'],
    products = ['[CH]=COC([CH2])[CH][CH2](5568)'],
...
reaction(
    label = 'reaction21',
    reactants = ['ketene(T)(1373)', '[CH2][CH][CH][CH2](5531)'],
    products = ['[CH]=COC([CH2])[CH][CH2](5568)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C2H2(T)(1343)', '[CH2][CH]C([CH2])[O](1582)'],
    products = ['[CH]=COC([CH2])[CH][CH2](5568)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH]=CO[C]([CH2])[CH][CH2](7155)'],
    products = ['[CH]=COC([CH2])[CH][CH2](5568)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH]=[C]OC([CH2])[CH][CH2](7156)'],
    products = ['[CH]=COC([CH2])[CH][CH2](5568)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=COC([CH2])[CH][CH2](5568)'],
    products = ['[CH]=CO[C]([CH2])C[CH2](7157)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]=COC([CH2])[CH][CH2](5568)'],
    products = ['[CH]=CO[C](C)[CH][CH2](7158)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]=COC([CH2])[CH][CH2](5568)'],
    products = ['[CH2][CH]C([CH2])O[C]=C(4193)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]=COC([CH2])[CH][CH2](5568)'],
    products = ['[CH]=CO[C]([CH2])[CH]C(7159)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]=[C]OC([CH2])C[CH2](7160)'],
    products = ['[CH]=COC([CH2])[CH][CH2](5568)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]=[C]OC(C)[CH][CH2](4194)'],
    products = ['[CH]=COC([CH2])[CH][CH2](5568)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]=COC([CH2])[CH][CH2](5568)'],
    products = ['[CH2][CH][C]([CH2])OC=C(5567)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]=[C]OC([CH2])[CH]C(4268)'],
    products = ['[CH]=COC([CH2])[CH][CH2](5568)'],
...
network(
    label = 'PDepNetwork #1725',
    isomers = [
        '[CH]=COC([CH2])[CH][CH2](5568)',
    ],
    reactants = [
