...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.5946,0.0641917,-3.18112e-05,-2.83057e-09,5.11205e-12,22331.4,30.8348], Tmin=(100,'K'), Tmax=(1066.09,'K')), NASAPolynomial(coeffs=[14.8757,0.030388,-1.20788e-05,2.23289e-09,-1.56323e-13,18162.4,-44.2489], Tmin=(1066.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.578,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(RCCJ)"""),
)
...
species(
    ...
    E0 = (621.123,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,795.253,1009.69,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0837394,'amu*angstrom^2'), symmetry=1, barrier=(2.13368,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0837394,'amu*angstrom^2'), symmetry=1, barrier=(2.13368,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0837394,'amu*angstrom^2'), symmetry=1, barrier=(2.13368,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0837394,'amu*angstrom^2'), symmetry=1, barrier=(2.13368,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0837394,'amu*angstrom^2'), symmetry=1, barrier=(2.13368,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.941847,0.0751118,-6.73107e-05,1.49791e-08,1.44875e-11,49993.6,32.7787], Tmin=(100,'K'), Tmax=(577.42,'K')), NASAPolynomial(coeffs=[8.10824,0.0407103,-1.75407e-05,3.23365e-09,-2.20855e-13,48911.9,-0.0597046], Tmin=(577.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(414.817,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(Cs_S) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.965288,0.0659316,-4.93905e-05,2.07742e-08,-3.74192e-12,47107.7,33.3818], Tmin=(100,'K'), Tmax=(1268.39,'K')), NASAPolynomial(coeffs=[10.168,0.036909,-1.50672e-05,2.73332e-09,-1.85941e-13,44773.2,-13.2036], Tmin=(1268.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(390.763,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(Cs_S) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', '[CH2][CH]C([CH2])C[O](9361)'],
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(20)', '[CH2][CH][CH]C(C)[O](1913)'],
    products = ['[CH2][CH]C([CH2])C(C)[O](4413)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH2][C]C([CH2])C(C)[O](9362)'],
    products = ['[CH2][CH]C([CH2])C(C)[O](4413)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH]C([CH][CH2])C(C)[O](9363)'],
    products = ['[CH2][CH]C([CH2])C(C)[O](4413)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH][CH]C([CH2])C(C)[O](9364)'],
    products = ['[CH2][CH]C([CH2])C(C)[O](4413)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][CH]C([CH2])C(C)[O](4413)'],
    products = ['[CH2]CC([CH2])C(C)=O(2520)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH][CH2](502)', 'C=CC(C)[O](1578)'],
    products = ['[CH2][CH]C([CH2])C(C)[O](4413)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.270985,'m^3/(mol*s)'), n=1.98996, Ea=(37.466,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_R;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH2][CH][C]([CH2])C(C)[O](9340)'],
    products = ['[CH2][CH]C([CH2])C(C)[O](4413)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH3(17)', '[CH2][CH]C([CH2])[CH][O](9332)'],
    products = ['[CH2][CH]C([CH2])C(C)[O](4413)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', '[CH2][CH]C([CH2])[C](C)[O](4208)'],
    products = ['[CH2][CH]C([CH2])C(C)[O](4413)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2][CH]C([CH2])C(C)[O](4413)'],
    products = ['[CH2]C[C]([CH2])C(C)[O](5957)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2][CH]C([CH2])C(C)[O](4413)'],
    products = ['[CH2][CH]C([CH2])[C](C)O(9366)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2][CH]C([CH2])C(C)[O](4413)'],
    products = ['[CH2]CC([CH2])[C](C)[O](2497)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2][CH]C([CH2])C(C)[O](4413)'],
    products = ['[CH2][CH][C]([CH2])C(C)O(9367)'],
