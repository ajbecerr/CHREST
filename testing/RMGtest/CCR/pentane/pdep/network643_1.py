...
species(
    ...
    molecularWeight = (75.0434,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.86802,0.0276788,-1.9827e-05,7.59271e-09,-1.29037e-12,-1248.13,13.6822], Tmin=(100,'K'), Tmax=(1262.08,'K')), NASAPolynomial(coeffs=[5.84178,0.0182539,-8.62539e-06,1.67572e-09,-1.183e-13,-1998.76,-1.35661], Tmin=(1262.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-10.6958,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(12dioxetane) + radical(Cs_P)"""),
)

species(
    label = '[CH2]C1(O)OO1(3059)',
...
reaction(
    label = 'reaction2',
    reactants = ['O(4)', 'CH2COOH(2279)'],
    products = ['C=C(O)O[O](2223)'],
    transitionState = 'TS2',
