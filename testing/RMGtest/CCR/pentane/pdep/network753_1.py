...
species(
    label = '[C]1=CC[CH]OO1(2877)',
    structure = SMILES('[C]1=CC[CH]OO1'),
    E0 = (388.404,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.57325,0.0239359,1.54065e-05,-3.55675e-08,1.5388e-11,46772.4,17.5859], Tmin=(100,'K'), Tmax=(936.605,'K')), NASAPolynomial(coeffs=[8.20274,0.018604,-6.01918e-06,1.01181e-09,-6.88336e-14,44897.2,-13.5855], Tmin=(936.605,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(388.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(34dihydro12dioxin) + radical(CCsJOOC) + radical(C=CJO)"""),
)

species(
    label = '[C]#COOC[CH2](2878)',
    structure = SMILES('[C]#COOC[CH2]'),
    E0 = (702.851,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2175,525,223.324],'cm^-1')),
        HinderedRotor(inertia=(1.39019,'amu*angstrom^2'), symmetry=1, barrier=(47.6808,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.39897,'amu*angstrom^2'), symmetry=1, barrier=(47.7038,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.263076,'amu*angstrom^2'), symmetry=1, barrier=(8.69415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.58146,'amu*angstrom^2'), symmetry=1, barrier=(89.8734,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19365,0.0668206,-0.000102903,8.60762e-08,-2.84874e-11,84629.6,23.7669], Tmin=(100,'K'), Tmax=(830.922,'K')), NASAPolynomial(coeffs=[8.85828,0.0228854,-1.08843e-05,2.0536e-09,-1.40346e-13,83598.8,-10.3289], Tmin=(830.922,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(702.851,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CJCOOH) + radical(Acetyl)"""),
)

species(
    label = '[C]#COO[CH]C(2879)',
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.281819,'amu*angstrom^2'), symmetry=1, barrier=(57.684,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.51095,'amu*angstrom^2'), symmetry=1, barrier=(57.7318,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.652892,'amu*angstrom^2'), symmetry=1, barrier=(15.0113,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.51112,'amu*angstrom^2'), symmetry=1, barrier=(57.7356,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29135,0.0656654,-0.000102957,8.96412e-08,-3.07714e-11,81315,21.7155], Tmin=(100,'K'), Tmax=(836.465,'K')), NASAPolynomial(coeffs=[7.42113,0.025766,-1.24223e-05,2.35421e-09,-1.6113e-13,80659.9,-4.54877], Tmin=(836.465,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(675.329,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCsJOOC) + radical(Acetyl)"""),
)
...
species(
    label = 'C#CO[O+]=[C-]C(2884)',
    structure = SMILES('C#CO[O+]=[C-]C'),
    E0 = (407.272,'kJ/mol'),
    modes = [
        ...
        HinderedRotor(inertia=(2.26155,'amu*angstrom^2'), symmetry=1, barrier=(51.9974,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0321749,'amu*angstrom^2'), symmetry=1, barrier=(51.9909,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.439466,'amu*angstrom^2'), symmetry=1, barrier=(52.0087,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38919,0.0678923,-0.000120774,1.17461e-07,-4.33174e-11,49067.5,29.9837], Tmin=(100,'K'), Tmax=(852.503,'K')), NASAPolynomial(coeffs=[3.92426,0.0322663,-1.63333e-05,3.13369e-09,-2.14709e-13,49497.6,23.2157], Tmin=(852.503,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.272,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)

species(
    label = '[CH]COOC#C(2885)',
    structure = SMILES('[CH]COOC#C'),
    E0 = (602.844,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,2175,525,750,770,3400,2100,288.235,288.304,2081.33],'cm^-1')),
        HinderedRotor(inertia=(0.121542,'amu*angstrom^2'), symmetry=1, barrier=(7.16657,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.600987,'amu*angstrom^2'), symmetry=1, barrier=(35.4498,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.600743,'amu*angstrom^2'), symmetry=1, barrier=(35.4509,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.600986,'amu*angstrom^2'), symmetry=1, barrier=(35.4519,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21944,0.0670695,-0.000104808,9.11592e-08,-3.19448e-11,72599.9,21.0769], Tmin=(100,'K'), Tmax=(773.162,'K')), NASAPolynomial(coeffs=[8.07961,0.0257731,-1.34274e-05,2.65457e-09,-1.87078e-13,71712.6,-9.13249], Tmin=(773.162,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(602.844,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-CsOsHH) + group(CsJ2_singlet-CsH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.752242,'amu*angstrom^2'), symmetry=1, barrier=(17.2955,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.752381,'amu*angstrom^2'), symmetry=1, barrier=(17.2987,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.750896,'amu*angstrom^2'), symmetry=1, barrier=(17.2646,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44132,0.0612325,-9.26391e-05,7.85575e-08,-2.68755e-11,54101.9,21.7625], Tmin=(100,'K'), Tmax=(781.855,'K')), NASAPolynomial(coeffs=[7.94785,0.023498,-1.17134e-05,2.27976e-09,-1.59392e-13,53220.4,-7.15732], Tmin=(781.855,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(449.102,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    ...
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(3.29914e+17,'s^-1'), n=-1.73308, Ea=(40.2267,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.16692063000437535, var=8.814681701569807, Tref=1000.0, N=65, correlation='Root',), comment="""BM rule fitted to 2 training reactions at node Root
...
reaction(
    label = 'reaction2',
    reactants = ['[C]1=CC[CH]OO1(2877)'],
    products = ['C#COOC=C(2350)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['HC2(2881)', 'CH2CHOO(673)'],
    products = ['C#COOC=C(2350)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(106477,'m^3/(mol*s)'), n=0.348287, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.0108230153501, var=2.70964383578, Tref=1000.0, N=19, correlation='Root_N-1R->H_N-1CNOS->N_1COS->O_Ext-1O-R_Ext-2R-R',), comment="""BM rule fitted to 2 training reactions at node Root_N-1R->H_N-1CNOS->N_1COS->O_Ext-1O-R_Ext-2R-R
    Total Standard Deviation in ln(k): 3.32718707999
