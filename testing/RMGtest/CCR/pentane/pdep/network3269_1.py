...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.193313,0.0850936,-6.21374e-05,2.45526e-08,-4.04486e-12,107728,36.1876], Tmin=(100,'K'), Tmax=(1406.14,'K')), NASAPolynomial(coeffs=[14.8731,0.0422349,-1.64181e-05,2.87663e-09,-1.91056e-13,103491,-41.6344], Tmin=(1406.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(894.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(CCJ2_triplet) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=CCC([CH])[CH]C(14600)',
    structure = SMILES('[CH]C=CCC([CH])[CH]C'),
    E0 = (883.859,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]C=CCC1CC1C(14601)',
    structure = SMILES('[CH]C=CCC1CC1C'),
    E0 = (391.31,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.54583,0.0559232,3.64056e-05,-8.20141e-08,3.39156e-11,47205.9,30.4254], Tmin=(100,'K'), Tmax=(985.658,'K')), NASAPolynomial(coeffs=[15.8341,0.0420683,-1.58429e-05,2.92536e-09,-2.08783e-13,41851.3,-54.9847], Tmin=(985.658,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(391.31,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C=CCC(C)=CC(14406)',
    structure = SMILES('[CH]C=CCC(C)=CC'),
    E0 = (348.328,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH][CH]C[CH]C([CH2])[CH]C(14602)',
    structure = SMILES('[CH][CH]C[CH]C([CH2])[CH]C'),
    E0 = (995.056,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,3000,3100,440,815,1455,1000,201.43,1182.38,1340.14,1478.1,1580.82,1689.26,2284.17],'cm^-1')),
        HinderedRotor(inertia=(0.120337,'amu*angstrom^2'), symmetry=1, barrier=(2.8647,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120337,'amu*angstrom^2'), symmetry=1, barrier=(2.8647,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120337,'amu*angstrom^2'), symmetry=1, barrier=(2.8647,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120337,'amu*angstrom^2'), symmetry=1, barrier=(2.8647,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120337,'amu*angstrom^2'), symmetry=1, barrier=(2.8647,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.337197,0.086967,-9.79776e-05,7.86356e-08,-2.76903e-11,119803,42.0861], Tmin=(100,'K'), Tmax=(786.876,'K')), NASAPolynomial(coeffs=[4.88023,0.0563135,-2.51332e-05,4.71057e-09,-3.24494e-13,119322,22.7445], Tmin=(786.876,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(995.056,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Cs_S) + radical(RCCJC) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]CC[C]([CH2])[CH]C(14603)',
    structure = SMILES('[CH][CH]CC[C]([CH2])[CH]C'),
    E0 = (985.936,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,186.778,418.09,456.543,1608.42,2734.28,3999.99,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0759822,'amu*angstrom^2'), symmetry=1, barrier=(1.76298,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0759822,'amu*angstrom^2'), symmetry=1, barrier=(1.76298,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0759822,'amu*angstrom^2'), symmetry=1, barrier=(1.76298,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0759822,'amu*angstrom^2'), symmetry=1, barrier=(1.76298,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0759822,'amu*angstrom^2'), symmetry=1, barrier=(1.76298,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.15093,0.0966276,-0.000137281,1.27649e-07,-4.70801e-11,118708,41.3289], Tmin=(100,'K'), Tmax=(851.807,'K')), NASAPolynomial(coeffs=[2.06296,0.061011,-2.76532e-05,5.13574e-09,-3.48318e-13,119348,38.0837], Tmin=(851.807,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(985.936,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Cs_S) + radical(RCCJC) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C[CH]C[C]([CH2])[CH]C(14604)',
    structure = SMILES('[CH]C[CH]C[C]([CH2])[CH]C'),
    E0 = (985.948,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,186.124,455.935,587.423,1623.2,2720.15,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0792145,'amu*angstrom^2'), symmetry=1, barrier=(1.83593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0792145,'amu*angstrom^2'), symmetry=1, barrier=(1.83593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0792145,'amu*angstrom^2'), symmetry=1, barrier=(1.83593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0792145,'amu*angstrom^2'), symmetry=1, barrier=(1.83593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0792145,'amu*angstrom^2'), symmetry=1, barrier=(1.83593,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.191511,0.0970627,-0.000142324,1.35832e-07,-5.0833e-11,118707,41.0114], Tmin=(100,'K'), Tmax=(853.323,'K')), NASAPolynomial(coeffs=[0.972453,0.0629588,-2.8861e-05,5.37944e-09,-3.65216e-13,119682,43.8622], Tmin=(853.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(985.948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(RCCJCC) + radical(Cs_S) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1[CH]CC([CH2])C1C(14605)',
    structure = SMILES('[CH]C1[CH]CC([CH2])C1C'),
    E0 = (657.7,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
...
species(
    label = '[CH]C1[CH]CC([CH]C)C1(14606)',
    structure = SMILES('[CH]C1[CH]CC([CH]C)C1'),
    E0 = (656.202,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
...
species(
    label = '[CH][CH]C1CC([CH2])C1C(14607)',
    structure = SMILES('[CH][CH]C1CC([CH2])C1C'),
    E0 = (739.467,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
...
species(
    label = '[CH][CH]C1CC([CH]C)C1(14608)',
    structure = SMILES('[CH][CH]C1CC([CH]C)C1'),
    E0 = (737.968,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
...
species(
    label = '[CH]C=CC[C]([CH2])[CH]C(14610)',
    structure = SMILES('[CH]C=CC[C]([CH2])[CH]C'),
    E0 = (826.149,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.436879,0.0847416,-8.92299e-05,7.14961e-08,-2.58236e-11,99485,37.7121], Tmin=(100,'K'), Tmax=(787.884,'K')), NASAPolynomial(coeffs=[3.47526,0.060713,-2.71049e-05,5.07041e-09,-3.48905e-13,99273.2,25.4725], Tmin=(787.884,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(826.149,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Tertalkyl) + radical(Cs_S) + radical(Isobutyl) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[C]=C[CH]CC([CH2])[CH]C(14611)',
    structure = SMILES('[C]C=CCC([CH2])[CH]C'),
    E0 = (939.52,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.297584,0.0795365,-6.26996e-05,2.71048e-08,-4.92071e-12,113133,34.417], Tmin=(100,'K'), Tmax=(1276.93,'K')), NASAPolynomial(coeffs=[12.8299,0.0402787,-1.65838e-05,3.02839e-09,-2.06975e-13,109932,-29.1079], Tmin=(1276.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(939.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_S) + radical(Isobutyl) + radical(CJ3)"""),
)

species(
    label = '[CH2]C([CH]C)CC1C=C1(14612)',
    structure = SMILES('[CH2]C([CH]C)CC1C=C1'),
    E0 = (543.238,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.281218,0.0790224,-5.68064e-05,2.22967e-08,-3.70501e-12,65472.3,32.0293], Tmin=(100,'K'), Tmax=(1371.48,'K')), NASAPolynomial(coeffs=[12.6392,0.0429797,-1.73864e-05,3.13502e-09,-2.12147e-13,62082.5,-31.4949], Tmin=(1371.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(543.238,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH]=CC1CC([CH]C)C1(14613)',
    structure = SMILES('[CH]=CC1CC([CH]C)C1'),
    E0 = (471.159,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.265776,0.0827073,-5.92447e-05,2.17813e-08,-3.24865e-12,46733.9,33.618], Tmin=(100,'K'), Tmax=(1567.92,'K')), NASAPolynomial(coeffs=[18.3995,0.0350894,-1.36894e-05,2.41152e-09,-1.60198e-13,40880.8,-64.8256], Tmin=(1567.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(387.215,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=CC=CC(C)[CH]C(14414)',
    structure = SMILES('[CH]=CC=CC(C)[CH]C'),
    E0 = (421.356,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3120,650,792.5,1650,442.663,442.886],'cm^-1')),
        HinderedRotor(inertia=(0.0862008,'amu*angstrom^2'), symmetry=1, barrier=(11.9891,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0858414,'amu*angstrom^2'), symmetry=1, barrier=(11.9887,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0859904,'amu*angstrom^2'), symmetry=1, barrier=(11.989,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0862717,'amu*angstrom^2'), symmetry=1, barrier=(11.9881,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0862705,'amu*angstrom^2'), symmetry=1, barrier=(11.9868,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0115015,0.0761839,-3.91846e-05,-7.68461e-10,4.98812e-12,50832.1,34.3183], Tmin=(100,'K'), Tmax=(1071.76,'K')), NASAPolynomial(coeffs=[16.2337,0.0370804,-1.45849e-05,2.67052e-09,-1.85586e-13,46113.6,-50.9492], Tmin=(1071.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(421.356,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cs_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=CC=CC([CH2])[CH]C(14615)',
    structure = SMILES('[CH]=CC=CC([CH2])[CH]C'),
    E0 = (626.438,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3100,440,815,1455,1000,3120,650,792.5,1650,180,321.001],'cm^-1')),
        HinderedRotor(inertia=(0.75505,'amu*angstrom^2'), symmetry=1, barrier=(17.3601,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.347627,'amu*angstrom^2'), symmetry=1, barrier=(95.8367,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00152872,'amu*angstrom^2'), symmetry=1, barrier=(17.3571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.755054,'amu*angstrom^2'), symmetry=1, barrier=(17.3602,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118986,'amu*angstrom^2'), symmetry=1, barrier=(2.73571,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0148141,0.0778161,-5.17226e-05,1.21095e-08,1.06737e-12,75495.1,36.0027], Tmin=(100,'K'), Tmax=(1047.09,'K')), NASAPolynomial(coeffs=[15.7364,0.0341736,-1.27191e-05,2.24893e-09,-1.53098e-13,71302.8,-44.8657], Tmin=(1047.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(626.438,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cs_S) + radical(Isobutyl) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C=CCC([CH2])[CH]C(14616)',
    structure = SMILES('C#C[CH]CC([CH2])[CH]C'),
    E0 = (597.948,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.136427,0.0832091,-7.63788e-05,4.17343e-08,-9.52946e-12,72057.2,34.6627], Tmin=(100,'K'), Tmax=(1046.89,'K')), NASAPolynomial(coeffs=[11.3842,0.0402327,-1.48008e-05,2.52045e-09,-1.64968e-13,69702.2,-20.1163], Tmin=(1046.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(597.948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cs_S) + radical(Sec_Propargyl) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.392094,0.0828763,-7.03446e-05,3.57762e-08,-7.99042e-12,92805.4,36.9517], Tmin=(100,'K'), Tmax=(1031.42,'K')), NASAPolynomial(coeffs=[9.12726,0.0490006,-2.10799e-05,3.93414e-09,-2.72541e-13,91003.5,-5.46085], Tmin=(1031.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(770.573,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Isobutyl) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=CCC[C]([CH2])[CH]C(14618)',
    structure = SMILES('[CH]=CCC[C]([CH2])[CH]C'),
    E0 = (718.153,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,217.946,421.179,3080.46],'cm^-1')),
        HinderedRotor(inertia=(0.0683088,'amu*angstrom^2'), symmetry=1, barrier=(2.45108,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0683088,'amu*angstrom^2'), symmetry=1, barrier=(2.45108,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0683088,'amu*angstrom^2'), symmetry=1, barrier=(2.45108,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0683088,'amu*angstrom^2'), symmetry=1, barrier=(2.45108,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0683088,'amu*angstrom^2'), symmetry=1, barrier=(2.45108,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.278051,0.0885815,-0.000103326,8.42162e-08,-2.968e-11,86501.5,38.014], Tmin=(100,'K'), Tmax=(794.183,'K')), NASAPolynomial(coeffs=[5.08777,0.0557067,-2.48966e-05,4.66503e-09,-3.21044e-13,86010.3,17.6357], Tmin=(794.183,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(718.153,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Tertalkyl) + radical(Cs_S) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['CHCH3(T)(21)', '[CH]C=CC[CH][CH2](13799)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', '[CH]C=CC[CH][CH]C(13885)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', '[CH]C=CCC([CH])[CH2](14015)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C=CCC([CH2])[C]C(14599)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]C=CCC([CH])[CH]C(14600)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction13',
    reactants = ['[CH][CH]C[CH]C([CH2])[CH]C(14602)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH][CH]CC[C]([CH2])[CH]C(14603)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]C[CH]C[C]([CH2])[CH]C(14604)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    products = ['[CH]C1[CH]CC([CH2])C1C(14605)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    products = ['[CH]C1[CH]CC([CH]C)C1(14606)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    products = ['[CH][CH]C1CC([CH2])C1C(14607)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(4.73e+06,'s^-1'), n=1.31, Ea=(98.7406,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra;radadd_intra_csHNd]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 95.2 to 98.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction19',
    reactants = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    products = ['[CH][CH]C1CC([CH]C)C1(14608)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH]C=CCC([CH2])=CC(14609)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(T)(20)', '[CH]C=CCC=CC(13884)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CHCH3(T)(21)', '[CH]=C[CH]CC=C(13694)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH]C=CC[C]([CH2])[CH]C(14610)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH]C=C[CH]C([CH2])[CH]C(14251)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', '[CH]C=[C]CC([CH2])[CH]C(14256)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', '[CH][C]=CCC([CH2])[CH]C(14260)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    products = ['[CH]C=CC[C]([CH2])CC(13934)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    products = ['[CH]C=C[CH]C([CH2])CC(13935)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH]C=[C]CC([CH2])CC(13936)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH][C]=CCC([CH2])CC(13937)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
...
reaction(
    label = 'reaction42',
    reactants = ['C2H2(T)(1343)', '[CH]CC([CH2])[CH]C(3863)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
...
reaction(
    label = 'reaction43',
    reactants = ['H(3)', '[C]=C[CH]CC([CH2])[CH]C(14611)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    products = ['[CH2]C([CH]C)CC1C=C1(14612)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    products = ['[CH]=CC1CC([CH]C)C1(14613)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    products = ['[CH2]C([CH]C)CC=C=C(5851)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    products = ['[CH]=CC=CC([CH2])CC(13947)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    products = ['[CH]=CC=CC(C)[CH]C(14414)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    products = ['[CH2]C([CH]C)C=CC=C(5858)'],
...
reaction(
    label = 'reaction53',
    reactants = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    products = ['[CH]=C=CCC([CH2])CC(13718)'],
...
reaction(
    label = 'reaction54',
    reactants = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    products = ['[CH]=C=CCC(C)[CH]C(13508)'],
...
reaction(
    label = 'reaction55',
    reactants = ['H(3)', '[CH]=CC=CC([CH2])[CH]C(14615)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
...
reaction(
    label = 'reaction56',
    reactants = ['H(3)', '[CH]=C=CCC([CH2])[CH]C(14616)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
...
reaction(
    label = 'reaction57',
    reactants = ['C2H2(1342)', '[CH]CC([CH2])[CH]C(3863)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
...
reaction(
    label = 'reaction60',
    reactants = ['[CH]=[C]CCC([CH2])[CH]C(14617)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
...
reaction(
    label = 'reaction62',
    reactants = ['[CH]=CCC[C]([CH2])[CH]C(14618)'],
    products = ['[CH]C=CCC([CH2])[CH]C(5840)'],
...
reaction(
    label = 'reaction63',
    reactants = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    products = ['[CH2]C=C[CH]C([CH2])[CH]C(5672)'],
...
reaction(
    label = 'reaction65',
    reactants = ['[CH]C=CCC([CH2])[CH]C(5840)'],
    products = ['[CH2]C=CC[C]([CH2])[CH]C(5852)'],
