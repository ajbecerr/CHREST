...
species(
    label = '[CH]=[C]CO[C][CH2](17623)',
    structure = SMILES('[CH]=[C]CO[C][CH2]'),
    E0 = (993.701,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,294.684,297.4,298.133,303.082],'cm^-1')),
        HinderedRotor(inertia=(0.0813844,'amu*angstrom^2'), symmetry=1, barrier=(5.25891,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00191009,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.183503,'amu*angstrom^2'), symmetry=1, barrier=(11.3594,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245617,'amu*angstrom^2'), symmetry=1, barrier=(15.9618,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.964106,0.0730893,-0.000117931,1.01376e-07,-3.41268e-11,119618,25.2273], Tmin=(100,'K'), Tmax=(834.588,'K')), NASAPolynomial(coeffs=[9.15435,0.0238987,-1.1662e-05,2.223e-09,-1.52485e-13,118597,-10.7317], Tmin=(834.588,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(993.701,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_S) + radical(CH2_triplet) + radical(Cds_P)"""),
)
...
species(
    label = '[C]=[C]CO[CH][CH2](17624)',
    structure = SMILES('[C]=[C]CO[CH][CH2]'),
    E0 = (1024.17,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1685,370,239.951,241.01,245.837,2374.47],'cm^-1')),
        HinderedRotor(inertia=(0.320536,'amu*angstrom^2'), symmetry=1, barrier=(13.2626,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.330026,'amu*angstrom^2'), symmetry=1, barrier=(13.2388,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.313871,'amu*angstrom^2'), symmetry=1, barrier=(13.2649,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00780881,'amu*angstrom^2'), symmetry=1, barrier=(31.0843,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.871431,0.0775075,-0.000134214,1.20082e-07,-4.09249e-11,123284,26.248], Tmin=(100,'K'), Tmax=(872.822,'K')), NASAPolynomial(coeffs=[8.23487,0.025086,-1.20284e-05,2.24068e-09,-1.50216e-13,122710,-4.19949], Tmin=(872.822,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1024.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOCs) + radical(CJCO) + radical(Cds_S) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.16848,0.0703379,-7.33299e-05,3.63405e-08,-6.62343e-12,38792.4,25.7759], Tmin=(100,'K'), Tmax=(1593.03,'K')), NASAPolynomial(coeffs=[19.6827,0.00605515,7.93566e-07,-3.68713e-10,3.03209e-14,34299.6,-73.488], Tmin=(1593.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(321.138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CJCO) + radical(C=C=CJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH][CH2](502)', '[CH]=[C]C[O](16850)'],
    products = ['[CH]=[C]CO[CH][CH2](15939)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=[CH](9646)', '[CH2][CH]O[CH2](1565)'],
    products = ['[CH]=[C]CO[CH][CH2](15939)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]=[C]CO[C][CH2](17623)'],
    products = ['[CH]=[C]CO[CH][CH2](15939)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[C]=[C]CO[CH][CH2](17624)'],
    products = ['[CH]=[C]CO[CH][CH2](15939)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.41198,'m^3/(mol*s)'), n=2.03228, Ea=(92.1449,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 90.3 to 92.1 kJ/mol to match endothermicity of reaction."""),
)
...
network(
    label = 'PDepNetwork #3870',
    isomers = [
        '[CH]=[C]CO[CH][CH2](15939)',
    ],
    reactants = [
