...
species(
    label = '[CH]=[C]CO[C]([CH2])[C][O](28333)',
    structure = SMILES('[CH]=[C]CO[C]([CH2])[C][O]'),
    E0 = (1204.87,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.45055,0.122247,-0.000257645,2.56751e-07,-9.28759e-11,145050,34.8311], Tmin=(100,'K'), Tmax=(885.253,'K')), NASAPolynomial(coeffs=[4.12317,0.0425121,-2.24517e-05,4.25719e-09,-2.84389e-13,146555,26.3957], Tmin=(885.253,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1204.87,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(Cds_S) + radical(CH2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[CH][C]([CH][O])OC[C]=[CH](28334)',
    structure = SMILES('[CH][C]([CH][O])OC[C]=[CH]'),
    E0 = (1161.89,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,180,180,180,750.298,1101.84,1600,2933.33,3200],'cm^-1')),
        HinderedRotor(inertia=(0.133159,'amu*angstrom^2'), symmetry=1, barrier=(3.06158,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133159,'amu*angstrom^2'), symmetry=1, barrier=(3.06158,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133159,'amu*angstrom^2'), symmetry=1, barrier=(3.06158,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133159,'amu*angstrom^2'), symmetry=1, barrier=(3.06158,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133159,'amu*angstrom^2'), symmetry=1, barrier=(3.06158,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.103,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.171316,0.114905,-0.000238249,2.389e-07,-8.70913e-11,139871,35.8979], Tmin=(100,'K'), Tmax=(883.275,'K')), NASAPolynomial(coeffs=[2.94855,0.0444949,-2.30984e-05,4.37164e-09,-2.92668e-13,141515,33.6616], Tmin=(883.275,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1161.89,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C2CsJOCs) + radical(CCsJOH) + radical(Cds_S) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[C]=[C]CO[C]([CH2])[CH][O](28335)',
    structure = SMILES('[C]=[C]CO[C]([CH2])[CH][O]'),
    E0 = (1235.19,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,1685,370,180,180,180,1600,2238.31,3200],'cm^-1')),
        HinderedRotor(inertia=(0.126405,'amu*angstrom^2'), symmetry=1, barrier=(2.9063,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126405,'amu*angstrom^2'), symmetry=1, barrier=(2.9063,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126405,'amu*angstrom^2'), symmetry=1, barrier=(2.9063,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126405,'amu*angstrom^2'), symmetry=1, barrier=(2.9063,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126405,'amu*angstrom^2'), symmetry=1, barrier=(2.9063,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.103,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.449764,0.127661,-0.00028345,2.90902e-07,-1.06747e-10,148691,35.6201], Tmin=(100,'K'), Tmax=(890.468,'K')), NASAPolynomial(coeffs=[0.799309,0.0483067,-2.55572e-05,4.82451e-09,-3.20379e-13,151392,46.1554], Tmin=(890.468,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1235.19,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CCsJOH) + radical(Cds_S) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.607909,0.103951,-0.000145523,9.89367e-08,-2.4996e-11,63885.2,31.486], Tmin=(100,'K'), Tmax=(789.604,'K')), NASAPolynomial(coeffs=[18.4402,0.0193129,-7.26044e-06,1.21782e-09,-7.77994e-14,60507.5,-58.2509], Tmin=(789.604,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(529.811,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CCOJ) + radical(CJC(C)OC) + radical(CCsJOH) + radical(C=C=CJ)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (110.111,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(4015.64,'J/mol'), sigma=(6.84957,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=627.23 K, Pc=28.35 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=[C]CO[C]([CH2])[CH][O](25988)'],
    products = ['[CH]=[C]COC([CH2])=C[O](25980)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2][C][CH][O](17607)', '[CH]=[C]C[O](16850)'],
    products = ['[CH]=[C]CO[C]([CH2])[CH][O](25988)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=[CH](9646)', '[CH2]O[C]([CH2])[CH][O](26247)'],
    products = ['[CH]=[C]CO[C]([CH2])[CH][O](25988)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]=[C]CO[C]([CH2])[C][O](28333)'],
    products = ['[CH]=[C]CO[C]([CH2])[CH][O](25988)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH][C]([CH][O])OC[C]=[CH](28334)'],
    products = ['[CH]=[C]CO[C]([CH2])[CH][O](25988)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[C]=[C]CO[C]([CH2])[CH][O](28335)'],
    products = ['[CH]=[C]CO[C]([CH2])[CH][O](25988)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=[C]CO[C]([CH2])[CH][O](25988)'],
    products = ['[CH]=C=COC([CH2])[CH][O](28337)'],
    transitionState = 'TS9',
...
reaction(
    ...
    kinetics = Arrhenius(A=(197.535,'m^3/(mol*s)'), n=1.6075, Ea=(142.666,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cds_Cdd;HJ]
Euclidian distance = 0
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.41198,'m^3/(mol*s)'), n=2.03228, Ea=(288.863,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=[C]CO[C]([CH2])[CH][O](25988)'],
    products = ['[CH]=[C][CH]OC([CH2])[CH][O](28181)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=[C]CO[C]([CH2])[CH][O](25988)'],
    products = ['[CH]=[C][CH]O[C](C)[CH][O](28182)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=[C]CO[C]([CH2])[CH][O](25988)'],
    products = ['[CH]=[C][CH]O[C]([CH2])C[O](28183)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=[C]CO[C]([CH2])[CH][O](25988)'],
    products = ['[CH]=[C][CH]O[C]([CH2])[CH]O(28184)'],
...
network(
    label = 'PDepNetwork #6692',
    isomers = [
        '[CH]=[C]CO[C]([CH2])[CH][O](25988)',
    ],
    reactants = [
