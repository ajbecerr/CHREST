...
species(
    label = '[CH2]C([O])C[CH]C[O](2187)',
    structure = SMILES('[CH2]C([O])C[CH]C[O]'),
    E0 = (367.175,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01127,0.0708499,-8.03298e-05,5.74268e-08,-1.77657e-11,44263.9,31.4499], Tmin=(100,'K'), Tmax=(770.119,'K')), NASAPolynomial(coeffs=[7.17272,0.0388441,-1.7984e-05,3.45055e-09,-2.41846e-13,43315,3.33456], Tmin=(770.119,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(367.175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCOJ) + radical(CCJCO) + radical(CJCO)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.145926,0.0969637,-0.000138963,1.09352e-07,-3.45281e-11,73905.9,33.6626], Tmin=(100,'K'), Tmax=(797.895,'K')), NASAPolynomial(coeffs=[12.2086,0.0330721,-1.5173e-05,2.8481e-09,-1.95225e-13,71996.6,-22.7611], Tmin=(797.895,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(613.293,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(ROOJ) + radical(CJCO) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([O])C[CH]CO[O](2189)',
    structure = SMILES('[CH]C([O])C[CH]CO[O]'),
    E0 = (602.118,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.488909,0.0869602,-0.000102104,4.69058e-08,4.6479e-12,72535.2,34.2338], Tmin=(100,'K'), Tmax=(576.655,'K')), NASAPolynomial(coeffs=[10.4899,0.0358639,-1.67321e-05,3.16972e-09,-2.18636e-13,71077.9,-11.1444], Tmin=(576.655,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(602.118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(ROOJ) + radical(CCJCOOH) + radical(CCJ2_triplet)"""),
)

species(
    label = '[O]OC[CH]CC1CO1(2190)',
    structure = SMILES('[O]OC[CH]CC1CO1'),
    E0 = (113.106,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.594147,0.0770274,-7.16767e-05,2.69783e-08,2.12744e-12,13724.6,30.0339], Tmin=(100,'K'), Tmax=(714.924,'K')), NASAPolynomial(coeffs=[11.597,0.0316712,-1.0513e-05,1.64746e-09,-1.01326e-13,11737.2,-22.2523], Tmin=(714.924,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(ROOJ) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C([O])CC1COO1(2191)',
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.713017,0.074489,-6.65066e-05,3.26656e-08,-6.75576e-12,20536.9,26.0715], Tmin=(100,'K'), Tmax=(1129.31,'K')), NASAPolynomial(coeffs=[11.3427,0.036839,-1.64983e-05,3.14429e-09,-2.20524e-13,18136,-26.5032], Tmin=(1129.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(169.785,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0436838,0.0724287,-6.73205e-05,3.36672e-08,-6.46825e-12,14405.8,28.2442], Tmin=(100,'K'), Tmax=(1466.54,'K')), NASAPolynomial(coeffs=[15.3633,0.0207416,-4.32539e-06,4.26226e-10,-1.67636e-14,10977.3,-47.8993], Tmin=(1466.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.488,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)OJ) + radical(CJCO)"""),
)

species(
    label = 'C=C(O)C[CH]CO[O](2193)',
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00644795,0.087489,-9.75995e-05,5.74223e-08,-1.34712e-11,1255.09,33.2477], Tmin=(100,'K'), Tmax=(1037.74,'K')), NASAPolynomial(coeffs=[15.461,0.0279182,-1.14922e-05,2.10464e-09,-1.44624e-13,-1952.46,-41.8842], Tmin=(1037.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(9.23657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.414248,0.0806582,-8.61282e-05,5.11584e-08,-1.24418e-11,-6291.71,30.9834], Tmin=(100,'K'), Tmax=(990.097,'K')), NASAPolynomial(coeffs=[12.1994,0.0330467,-1.39975e-05,2.59097e-09,-1.78701e-13,-8625.44,-25.7561], Tmin=(990.097,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-53.3736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C([O])CC=COO(2198)',
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0595589,0.0851157,-8.56685e-05,4.42305e-08,-9.0705e-12,17574.7,33.5968], Tmin=(100,'K'), Tmax=(1182.33,'K')), NASAPolynomial(coeffs=[17.3965,0.0260587,-1.07431e-05,1.98269e-09,-1.37231e-13,13447,-53.5419], Tmin=(1182.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(144.88,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CC(C)OJ) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(O)CC=CO[O](1503)',
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.128028,0.08448,-9.26335e-05,5.39464e-08,-1.25512e-11,8141.01,33.8765], Tmin=(100,'K'), Tmax=(1045.51,'K')), NASAPolynomial(coeffs=[14.9587,0.02774,-1.12292e-05,2.03971e-09,-1.39514e-13,5039.85,-38.3334], Tmin=(1045.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(66.5235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.401203,0.0794132,-7.5116e-05,3.73723e-08,-7.60116e-12,16361.9,33.0302], Tmin=(100,'K'), Tmax=(1167.67,'K')), NASAPolynomial(coeffs=[14.1668,0.0322573,-1.4539e-05,2.78644e-09,-1.96256e-13,13147.2,-35.5144], Tmin=(1167.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.965,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
species(
    label = '[CH2][C]([O])C[CH]CO[O](2205)',
    structure = SMILES('[CH2][C]([O])C[CH]CO[O]'),
    E0 = (542.12,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,360,370,350,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.29255,0.105563,-0.000175858,1.56019e-07,-5.32913e-11,65345.9,36.0082], Tmin=(100,'K'), Tmax=(864.279,'K')), NASAPolynomial(coeffs=[9.4601,0.0374499,-1.77688e-05,3.31754e-09,-2.23681e-13,64518.2,-4.65572], Tmin=(864.279,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(542.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(ROOJ) + radical(CCJCOOH) + radical(C2CsJOH) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.454089,0.109537,-0.000181666,1.60868e-07,-5.47817e-11,37645.3,36.7802], Tmin=(100,'K'), Tmax=(869.066,'K')), NASAPolynomial(coeffs=[9.54702,0.0392051,-1.83326e-05,3.39978e-09,-2.28227e-13,36824.7,-4.78627], Tmin=(869.066,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(311.759,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(C2CsJOH) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.404497,0.0892092,-0.000100127,4.07928e-08,9.01391e-12,42655.2,32.0196], Tmin=(100,'K'), Tmax=(571.397,'K')), NASAPolynomial(coeffs=[10.3425,0.038757,-1.78687e-05,3.3723e-09,-2.32292e-13,41207.4,-13.0942], Tmin=(571.397,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(353.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(ROOJ) + radical(CCsJOOH) + radical(CJCO)"""),
)

species(
    label = '[CH2]C([O])C[CH][CH]OO(2210)',
    structure = SMILES('[CH2]C([O])C[CH][CH]OO'),
    E0 = (402.07,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0872871,0.0961493,-0.000118668,6.66413e-08,-6.14888e-12,48489.2,34.6835], Tmin=(100,'K'), Tmax=(594.376,'K')), NASAPolynomial(coeffs=[11.1156,0.0392475,-1.8767e-05,3.60454e-09,-2.51033e-13,46872.3,-15.3575], Tmin=(594.376,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(402.07,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCOOH) + radical(CCsJOOH) + radical(CJCO)"""),
)

species(
    label = '[CH2][C]([O])CCCO[O](2211)',
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.295873,0.103269,-0.000158981,1.35573e-07,-4.55386e-11,41243.9,33.716], Tmin=(100,'K'), Tmax=(846.243,'K')), NASAPolynomial(coeffs=[10.1119,0.0389139,-1.80379e-05,3.36895e-09,-2.28706e-13,40025.2,-11.5509], Tmin=(846.243,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(341.705,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(ROOJ) + radical(C2CsJOH) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(O)[CH][CH]CO[O](2212)',
    structure = SMILES('[CH2]C(O)[CH][CH]CO[O]'),
    E0 = (335.034,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.055954,0.0949556,-0.000133536,1.05632e-07,-3.36841e-11,40435.8,38.4266], Tmin=(100,'K'), Tmax=(810.98,'K')), NASAPolynomial(coeffs=[11.261,0.035233,-1.58517e-05,2.953e-09,-2.01576e-13,38728.7,-13.0085], Tmin=(810.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(335.034,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCO) + radical(CCJCOOH) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]C(O)C[CH][CH]O[O](2214)',
    structure = SMILES('[CH2]C(O)C[CH][CH]O[O]'),
    E0 = (323.714,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.291352,0.103474,-0.000161162,1.38199e-07,-4.64804e-11,39079.6,36.9217], Tmin=(100,'K'), Tmax=(851.653,'K')), NASAPolynomial(coeffs=[10.0181,0.0385855,-1.78727e-05,3.3302e-09,-2.25488e-13,37920.8,-7.65413], Tmin=(851.653,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(323.714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CJCO) + radical(CCsJOOH)"""),
)
...
species(
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0705012,0.0916583,-0.000111752,7.51735e-08,-2.06568e-11,49856.2,37.036], Tmin=(100,'K'), Tmax=(880.493,'K')), NASAPolynomial(coeffs=[12.35,0.0358735,-1.67172e-05,3.21751e-09,-2.26106e-13,47693.9,-20.6426], Tmin=(880.493,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(413.39,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO) + radical(CCJCOOH) + radical(CJCO)"""),
)

species(
    label = '[CH2][C]([O])C[CH]COO(2217)',
    structure = SMILES('[CH2][C]([O])C[CH]COO'),
    E0 = (390.115,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,360,370,350,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (116.115,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.530033,0.108837,-0.000170052,1.45401e-07,-4.90833e-11,47074.3,36.1024], Tmin=(100,'K'), Tmax=(830.769,'K')), NASAPolynomial(coeffs=[11.0006,0.0391954,-1.88104e-05,3.57049e-09,-2.44839e-13,45645.9,-14.455], Tmin=(830.769,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(390.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCOOH) + radical(C2CsJOH) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C([O])C[CH]CO[O](1491)'],
    products = ['O2(S)(666)', '[CH2]C([O])CC=C(1485)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction5',
    reactants = ['O(4)', '[CH2]C([O])C[CH]C[O](2187)'],
    products = ['[CH2]C([O])C[CH]CO[O](1491)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]CO[O](790)', '[CH2]C([CH2])[O](1366)'],
    products = ['[CH2]C([O])C[CH]CO[O](1491)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O(4)', '[CH2][CH]C[CH]CO[O](803)'],
    products = ['[CH2]C([O])C[CH]CO[O](1491)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]O[O](46)', '[CH]CC([CH2])[O](1572)'],
    products = ['[CH2]C([O])C[CH]CO[O](1491)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH2]C([O])C[C]CO[O](2188)'],
    products = ['[CH2]C([O])C[CH]CO[O](1491)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH]C([O])C[CH]CO[O](2189)'],
    products = ['[CH2]C([O])C[CH]CO[O](1491)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([O])C[CH]CO[O](1491)'],
    products = ['O(4)', '[CH2]C([O])CC1CO1(2192)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2]C([O])C=CCO[O](2200)'],
    products = ['[CH2]C([O])C[CH]CO[O](1491)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH2]C(=O)C[CH]CO[O](2201)'],
    products = ['[CH2]C([O])C[CH]CO[O](1491)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH2]C([O])CC=CO[O](2202)'],
    products = ['[CH2]C([O])C[CH]CO[O](1491)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH2(T)(20)', '[O]OC[CH]CC=O(2203)'],
    products = ['[CH2]C([O])C[CH]CO[O](1491)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O(4)', 'C=CC[CH]CO[O](800)'],
    products = ['[CH2]C([O])C[CH]CO[O](1491)'],
...
reaction(
    label = 'reaction33',
    reactants = ['O2(2)', '[CH2]C([O])CC=C(1485)'],
    products = ['[CH2]C([O])C[CH]CO[O](1491)'],
...
reaction(
    label = 'reaction34',
    reactants = ['O2(2)', '[CH2][CH]CC([CH2])[O](1476)'],
    products = ['[CH2]C([O])C[CH]CO[O](1491)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', '[CH2]C([O])[CH][CH]CO[O](2204)'],
    products = ['[CH2]C([O])C[CH]CO[O](1491)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(3)', '[CH2][C]([O])C[CH]CO[O](2205)'],
    products = ['[CH2]C([O])C[CH]CO[O](1491)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(3)', '[CH2]C([O])C[CH][CH]O[O](2206)'],
    products = ['[CH2]C([O])C[CH]CO[O](1491)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]C([O])[CH]CCO[O](2129)'],
    products = ['[CH2]C([O])C[CH]CO[O](1491)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]C([O])C[CH]CO[O](1491)'],
    products = ['[CH2][C](O)C[CH]CO[O](2207)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2]C([O])C[CH]CO[O](1491)'],
    products = ['[CH2]C([O])CC[CH]O[O](2209)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]C([O])C[CH][CH]OO(2210)'],
    products = ['[CH2]C([O])C[CH]CO[O](1491)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2]C([O])C[CH]CO[O](1491)'],
    products = ['[CH2]C(O)[CH][CH]CO[O](2212)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH2]C([O])C[CH]CO[O](1491)'],
    products = ['[CH2]C(O)C[CH][CH]O[O](2214)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]C([O])C[CH]CO[O](1491)'],
    products = ['CC([O])C[CH][CH]O[O](2215)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH2]C([O])[CH][CH]COO(2216)'],
    products = ['[CH2]C([O])C[CH]CO[O](1491)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[CH2][C]([O])C[CH]COO(2217)'],
    products = ['[CH2]C([O])C[CH]CO[O](1491)'],
