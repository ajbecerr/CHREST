...
species(
    label = 'C[C]1O[C]=CO1(7277)',
    structure = SMILES('C[C]1O[C]=CO1'),
    E0 = (115.395,'kJ/mol'),
    modes = [
...
species(
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67606,0.0568103,-8.64939e-05,7.78119e-08,-2.8246e-11,4394.45,18.3272], Tmin=(100,'K'), Tmax=(793.628,'K')), NASAPolynomial(coeffs=[5.84913,0.0270094,-1.35968e-05,2.6558e-09,-1.85949e-13,4008.2,0.898708], Tmin=(793.628,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.8876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['HCCO(2227)', 'acetyl(1377)'],
    products = ['C#COC(C)=O(2353)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['HC2(2881)', 'acetyloxy(3061)'],
    products = ['C#COC(C)=O(2353)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', 'C#CO[C]=O(7278)'],
    products = ['C#COC(C)=O(2353)'],
    transitionState = 'TS8',
