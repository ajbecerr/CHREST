...
species(
    label = '[CH]=C(C[CH2])C[O](19528)',
    structure = SMILES('[CH]=C(C[CH2])C[O]'),
    E0 = (469.335,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,440,435,1725,3000,3100,440,815,1455,1000,3120,650,792.5,1650,1498.96,1499.53],'cm^-1')),
        HinderedRotor(inertia=(0.231591,'amu*angstrom^2'), symmetry=1, barrier=(5.32473,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.23204,'amu*angstrom^2'), symmetry=1, barrier=(5.33505,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.232341,'amu*angstrom^2'), symmetry=1, barrier=(5.34197,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72609,0.0546606,-6.41077e-05,5.42793e-08,-2.0132e-11,56525.4,25.8031], Tmin=(100,'K'), Tmax=(768.351,'K')), NASAPolynomial(coeffs=[4.06047,0.0365169,-1.6991e-05,3.25001e-09,-2.26543e-13,56343.5,16.307], Tmin=(768.351,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(469.335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ) + radical(RCCJ) + radical(Cds_P)"""),
)
...
species(
    label = '[C]=C(C[CH2])CO[O](19531)',
    structure = SMILES('[C]=C(C[CH2])CO[O]'),
    E0 = (778.145,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,440,435,1725,3000,3100,440,815,1455,1000,225.436,1416.65],'cm^-1')),
        HinderedRotor(inertia=(0.169512,'amu*angstrom^2'), symmetry=1, barrier=(6.12745,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145458,'amu*angstrom^2'), symmetry=1, barrier=(6.17696,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.15953,'amu*angstrom^2'), symmetry=1, barrier=(6.17252,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168082,'amu*angstrom^2'), symmetry=1, barrier=(6.14095,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.93065,0.0743102,-0.000110764,9.62295e-08,-3.33843e-11,93693.3,29.2914], Tmin=(100,'K'), Tmax=(829.519,'K')), NASAPolynomial(coeffs=[7.03829,0.0332817,-1.56381e-05,2.95464e-09,-2.02561e-13,93078.3,3.36803], Tmin=(829.519,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(778.145,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(RCCJ) + radical(CdCdJ2_triplet)"""),
)
...
species(
    label = '[CH]=C1CCOOC1(19533)',
    structure = SMILES('[CH]=C1CCOOC1'),
    E0 = (174.806,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58011,0.0356276,3.70956e-05,-6.83303e-08,2.6062e-11,21126.6,20.0854], Tmin=(100,'K'), Tmax=(1048.01,'K')), NASAPolynomial(coeffs=[14.8376,0.0279127,-1.3244e-05,2.73852e-09,-2.05692e-13,15992.6,-55.7324], Tmin=(1048.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(174.806,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclohexanone) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C1CCOC1(19535)',
    structure = SMILES('[CH]=C1CCOC1'),
    E0 = (145.553,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.47697,0.0175593,6.23297e-05,-9.02878e-08,3.49293e-11,17575.1,19.5912], Tmin=(100,'K'), Tmax=(963.042,'K')), NASAPolynomial(coeffs=[10.9647,0.0224113,-7.69479e-06,1.42968e-09,-1.05666e-13,14080.5,-30.6932], Tmin=(963.042,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(145.553,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(4)', '[CH]=C(C[CH2])C[O](19528)'],
    products = ['[CH]=C(C[CH2])CO[O](19240)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(20)', '[CH]=C([CH2])CO[O](19529)'],
    products = ['[CH]=C(C[CH2])CO[O](19240)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]CC(=[CH])CO[O](19530)'],
    products = ['[CH]=C(C[CH2])CO[O](19240)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[C]=C(C[CH2])CO[O](19531)'],
    products = ['[CH]=C(C[CH2])CO[O](19240)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH]=C(C=C)CO[O](19302)'],
    products = ['[CH]=C(C[CH2])CO[O](19240)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]O[O](46)', 'C#CC[CH2](9659)'],
    products = ['[CH]=C(C[CH2])CO[O](19240)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH]=C([CH][CH2])CO[O](19537)'],
    products = ['[CH]=C(C[CH2])CO[O](19240)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]O[O](46)', '[CH]=[C]C[CH2](9654)'],
    products = ['[CH]=C(C[CH2])CO[O](19240)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=C([CH]C)CO[O](19539)'],
    products = ['[CH]=C(C[CH2])CO[O](19240)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=C(C[CH2])CO[O](19240)'],
    products = ['[CH]=C([CH]OO)C[CH2](19540)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]=C(C[CH2])CO[O](19240)'],
    products = ['[CH]=C([CH][CH2])COO(19543)'],
...
network(
    label = 'PDepNetwork #4236',
    isomers = [
        '[CH]=C(C[CH2])CO[O](19240)',
    ],
    reactants = [
