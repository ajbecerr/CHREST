...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57364,0.0384374,2.15297e-05,-5.79586e-08,2.56203e-11,30764.3,22.6305], Tmin=(100,'K'), Tmax=(961.244,'K')), NASAPolynomial(coeffs=[14.8827,0.019734,-6.52136e-06,1.19269e-09,-8.79638e-14,26511,-49.8664], Tmin=(961.244,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.95,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)OJ) + radical(CJCO)"""),
)

species(
    label = '[CH2]C([CH2])C1CO1(1871)',
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14496,0.059665,-4.96911e-05,1.84051e-08,-7.94381e-13,51591.7,27.8764], Tmin=(100,'K'), Tmax=(878.446,'K')), NASAPolynomial(coeffs=[11.4991,0.0238197,-7.78248e-06,1.2465e-09,-7.94875e-14,49336.6,-23.2167], Tmin=(878.446,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(428.079,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(CJCO) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
reaction(
    ...
    products = ['[CH2]C([CH2])C([CH2])[O](1478)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(20)', '[CH2]C([CH2])[CH][O](1867)'],
    products = ['[CH2]C([CH2])C([CH2])[O](1478)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]C([CH2])C([CH2])[O](1869)'],
    products = ['[CH2]C([CH2])C([CH2])[O](1478)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(T)(20)', '[CH2]C([CH2])C=O(1878)'],
    products = ['[CH2]C([CH2])C([CH2])[O](1478)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH2][C]([CH2])C([CH2])[O](1879)'],
    products = ['[CH2]C([CH2])C([CH2])[O](1478)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH2][C]([O])C([CH2])[CH2](1880)'],
    products = ['[CH2]C([CH2])C([CH2])[O](1478)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C([CH2])C([CH2])[O](1478)'],
    products = ['[CH2][C](O)C([CH2])[CH2](1881)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C([CH2])C([CH2])[O](1478)'],
    products = ['[CH2][C]([CH2])C([CH2])O(1883)'],
