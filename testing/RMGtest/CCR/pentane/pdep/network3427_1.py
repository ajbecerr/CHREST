...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC[CH][CH2](15036)'],
    products = ['C2H2(1342)', 'allyl(82)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH][CH2](502)', '[CH]C=C(3739)'],
    products = ['[CH]=CC[CH][CH2](15036)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]=CC[C][CH2](15110)'],
    products = ['[CH]=CC[CH][CH2](15036)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH][CH]CC=[CH](15111)'],
    products = ['[CH]=CC[CH][CH2](15036)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[C]=CC[CH][CH2](15112)'],
    products = ['[CH]=CC[CH][CH2](15036)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]=CC=C[CH2](15114)'],
    products = ['[CH]=CC[CH][CH2](15036)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C2H2(T)(1343)', 'allyl(82)'],
    products = ['[CH]=CC[CH][CH2](15036)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C2H2(1342)', '[CH2][CH][CH2](497)'],
    products = ['[CH]=CC[CH][CH2](15036)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C2H2(T)(1343)', '[CH2][CH][CH2](497)'],
    products = ['[CH]=CC[CH][CH2](15036)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH]=C[CH][CH][CH2](15115)'],
    products = ['[CH]=CC[CH][CH2](15036)'],
