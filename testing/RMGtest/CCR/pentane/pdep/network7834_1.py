...
species(
    label = 'C1OCO1(28983)',
    structure = SMILES('C1OCO1'),
    E0 = (-233.427,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.95174,-0.0183985,0.000183532,-2.55043e-07,1.05038e-10,-27998.3,9.76035], Tmin=(100,'K'), Tmax=(910.358,'K')), NASAPolynomial(coeffs=[29.0324,-0.0252591,1.73212e-05,-3.3283e-09,2.13468e-13,-37211.1,-138.134], Tmin=(910.358,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-233.427,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-OsOsHH) + group(Cs-OsOsHH) + ring(Cyclobutane)"""),
)

species(
    label = 'methyl_formate(28675)',
    ...
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.28123,0.0113181,1.84478e-05,-2.41945e-08,7.75136e-12,-44672.6,12.0364], Tmin=(100,'K'), Tmax=(1141.77,'K')), NASAPolynomial(coeffs=[4.90989,0.018753,-8.58329e-06,1.66847e-09,-1.18612e-13,-45901,0.212196], Tmin=(1141.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-371.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), label="""methyl_formate""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
species(
    ...
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.198,0.0396779,-5.03099e-05,3.31155e-08,-8.53808e-12,-1547.15,16.2847], Tmin=(100,'K'), Tmax=(955.281,'K')), NASAPolynomial(coeffs=[9.27221,0.0100563,-3.79755e-06,6.55633e-10,-4.32053e-14,-2898.72,-17.5206], Tmin=(955.281,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-13.4029,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-OsHHH) + radical(OCJO) + radical(CsJOCH3)"""),
)

species(
    label = 'CO[CH][O](29264)',
    structure = SMILES('CO[CH][O]'),
    E0 = (26.1241,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,1584.74,1586.78],'cm^-1')),
        HinderedRotor(inertia=(0.178719,'amu*angstrom^2'), symmetry=1, barrier=(4.1091,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.178405,'amu*angstrom^2'), symmetry=1, barrier=(4.10188,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.85387,0.0354439,-7.02799e-05,8.23525e-08,-3.43427e-11,3173.35,13.6114], Tmin=(100,'K'), Tmax=(849.208,'K')), NASAPolynomial(coeffs=[-1.87205,0.0312397,-1.61082e-05,3.12774e-09,-2.16047e-13,4930.26,41.2573], Tmin=(849.208,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.1241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cs-OsHHH) + radical(OCOJ) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC[O](28981)'],
    products = ['CH2O(3111)', 'CH2O(3111)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(20)', '[O]C[O](28827)'],
    products = ['[CH2]OC[O](28981)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(4)', '[CH2]O[CH2](3113)'],
    products = ['[CH2]OC[O](28981)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.15242e+13,'m^3/(mol*s)'), n=-4.75325, Ea=(276.349,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Y_rad;O_birad] for rate rule [C_rad/H2/O;O_birad]
...
reaction(
    label = 'reaction8',
    reactants = ['CH2O(3111)', '[CH2][O](3109)'],
    products = ['[CH2]OC[O](28981)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][O](3109)', '[CH2][O](3109)'],
    products = ['[CH2]OC[O](28981)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH2]O[CH][O](29182)'],
    products = ['[CH2]OC[O](28981)'],
