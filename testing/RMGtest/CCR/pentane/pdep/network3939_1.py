...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16033,0.0465169,2.35881e-05,-6.26225e-08,2.7068e-11,31194,25.163], Tmin=(100,'K'), Tmax=(970.337,'K')), NASAPolynomial(coeffs=[14.5417,0.0300013,-1.06227e-05,1.927e-09,-1.37629e-13,26777.8,-48.3664], Tmin=(970.337,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(258.393,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + radical(Allyl_S) + radical(C=CC=CCJ)"""),
)
...
species(
    label = '[CH2][C]=[C]C[CH][CH]C(17723)',
    structure = SMILES('[CH2][C]=[C]C[CH][CH]C'),
    E0 = (915.979,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,1670,1700,300,440,181.935,701.643,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00511057,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00511057,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00511057,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00511057,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00511057,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13228,0.0724633,-0.000101135,9.59418e-08,-3.62933e-11,110261,33.1925], Tmin=(100,'K'), Tmax=(842.3,'K')), NASAPolynomial(coeffs=[1.55872,0.0494295,-2.2703e-05,4.25199e-09,-2.90173e-13,110934,35.6322], Tmin=(842.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(915.979,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(RCCJC) + radical(Allyl_P) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C]=C[CH]C[CH]C(17724)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3053,0.0599408,-3.55531e-05,1.0694e-08,-1.35762e-12,75240.6,28.4157], Tmin=(100,'K'), Tmax=(1681.72,'K')), NASAPolynomial(coeffs=[10.639,0.0377407,-1.5752e-05,2.84463e-09,-1.90762e-13,72101.3,-21.466], Tmin=(1681.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(624.792,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(Allyl_S) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51302,0.0625646,-3.19975e-05,-2.55862e-08,3.45225e-11,86860.9,29.3699], Tmin=(100,'K'), Tmax=(525.322,'K')), NASAPolynomial(coeffs=[5.17698,0.0466857,-2.0978e-05,3.98499e-09,-2.78473e-13,86310.1,12.4735], Tmin=(525.322,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(721.521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(Allyl_P) + radical(Cds_S) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2]C=C[CH][CH][CH]C(17727)',
    structure = SMILES('[CH2]C=C[CH][CH][CH]C'),
    E0 = (581.409,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82582,0.0531044,-2.53098e-05,5.34854e-09,-4.3222e-13,69999.9,28.6329], Tmin=(100,'K'), Tmax=(2818.94,'K')), NASAPolynomial(coeffs=[27.6448,0.0172919,-6.69181e-06,1.04915e-09,-6.01188e-14,55116.1,-123.267], Tmin=(2818.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(581.409,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(RCCJCC) + radical(Allyl_S) + radical(Allyl_P)"""),
)

species(
    label = 'C[C]=[C]C[CH][CH]C(17728)',
    structure = SMILES('C[C]=[C]C[CH][CH]C'),
    E0 = (764.48,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,1670,1700,300,440,327.074,482.804,3314.98],'cm^-1')),
        HinderedRotor(inertia=(0.0284914,'amu*angstrom^2'), symmetry=1, barrier=(3.01751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0284914,'amu*angstrom^2'), symmetry=1, barrier=(3.01751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0284914,'amu*angstrom^2'), symmetry=1, barrier=(3.01751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0284914,'amu*angstrom^2'), symmetry=1, barrier=(3.01751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0284914,'amu*angstrom^2'), symmetry=1, barrier=(3.01751,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.98204,0.0449748,-1.76055e-05,2.18983e-09,-2.1081e-14,91898.6,22.3849], Tmin=(100,'K'), Tmax=(2887.97,'K')), NASAPolynomial(coeffs=[57.326,-0.0120577,3.26414e-06,-6.07245e-10,4.61424e-14,54059.9,-303.71], Tmin=(2887.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(764.48,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(RCCJC) + radical(Cds_S) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.900477,0.0568578,-1.344e-05,-1.80207e-08,9.43515e-12,76069.2,25.8622], Tmin=(100,'K'), Tmax=(1064.63,'K')), NASAPolynomial(coeffs=[13.1054,0.0340692,-1.38333e-05,2.57765e-09,-1.81026e-13,72163.2,-39.9235], Tmin=(1064.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(631.467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Allyl_S) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    E0 = (406.629,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,1685,370,238.165,1792.89,1793.01],'cm^-1')),
        HinderedRotor(inertia=(0.300918,'amu*angstrom^2'), symmetry=1, barrier=(12.1182,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.553636,'amu*angstrom^2'), symmetry=1, barrier=(22.2869,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.301017,'amu*angstrom^2'), symmetry=1, barrier=(12.1175,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.552269,'amu*angstrom^2'), symmetry=1, barrier=(22.2854,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['C=[C][CH]C[CH][CH]C(16067)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH][CH]C(3874)', '[CH2][C]=C[CH2](8994)'],
    products = ['C=[C][CH]C[CH][CH]C(16067)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH][CH]CC=[C][CH2](15387)'],
    products = ['C=[C][CH]C[CH][CH]C(16067)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH2][C]=CC[CH][C]C(17717)'],
    products = ['C=[C][CH]C[CH][CH]C(16067)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH2][C]=CC[C][CH]C(17718)'],
    products = ['C=[C][CH]C[CH][CH]C(16067)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['C=[C][CH]C[CH][CH]C(16067)'],
    products = ['[CH2]C=CC=C[CH]C(17721)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2][C]=C[CH]C=CC(17321)'],
    products = ['C=[C][CH]C[CH][CH]C(16067)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2][C]=[C]CC=CC(17323)'],
    products = ['C=[C][CH]C[CH][CH]C(16067)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2][C]=C[CH][CH][CH]C(17722)'],
    products = ['C=[C][CH]C[CH][CH]C(16067)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH2][C]=[C]C[CH][CH]C(17723)'],
    products = ['C=[C][CH]C[CH][CH]C(16067)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C=[C][CH]C[CH][CH]C(16067)'],
    products = ['[CH2][C]=C[CH]C[CH]C(17724)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C=[C]C[CH][CH]C(17725)'],
    products = ['C=[C][CH]C[CH][CH]C(16067)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2][C]=[C]CC[CH]C(17726)'],
    products = ['C=[C][CH]C[CH][CH]C(16067)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=[C][CH]C[CH][CH]C(16067)'],
    products = ['[CH2][C]=C[CH][CH]CC(17039)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C=[C][CH]C[CH][CH]C(16067)'],
    products = ['[CH2]C=C[CH][CH][CH]C(17727)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C[C]=[C]C[CH][CH]C(17728)'],
    products = ['C=[C][CH]C[CH][CH]C(16067)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2][C]=[C]C[CH]CC(17040)'],
    products = ['C=[C][CH]C[CH][CH]C(16067)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C=[C][CH]C[CH][CH]C(16067)'],
    products = ['C[C]=C[CH][CH][CH]C(17729)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C=CC[CH][C]C(16605)'],
    products = ['C=[C][CH]C[CH][CH]C(16067)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH][CH]C(3874)', 'CH2CHCCH2(4848)'],
    products = ['C=[C][CH]C[CH][CH]C(16067)'],
