...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44066,0.0445829,2.9806e-06,-3.40249e-08,1.57212e-11,28817.9,27.9003], Tmin=(100,'K'), Tmax=(995.647,'K')), NASAPolynomial(coeffs=[12.8087,0.0259726,-9.75044e-06,1.79742e-09,-1.27839e-13,25212.9,-33.6301], Tmin=(995.647,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(238.754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclopropane) + radical(CCJCC=O) + radical(CCCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82585,0.0293275,5.30577e-05,-8.41199e-08,3.17679e-11,834.101,22.3649], Tmin=(100,'K'), Tmax=(1021.37,'K')), NASAPolynomial(coeffs=[13.8439,0.0280777,-1.2394e-05,2.52138e-09,-1.89458e-13,-4010.64,-47.5681], Tmin=(1021.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.15006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-OdCsH) + ring(Cyclobutene)"""),
)

species(
    label = 'O=C=CC1CCC1(6398)',
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69072,0.0348562,3.65996e-05,-6.95897e-08,2.81088e-11,39.529,22.7512], Tmin=(100,'K'), Tmax=(986.3,'K')), NASAPolynomial(coeffs=[13.2809,0.0267065,-1.00981e-05,1.91641e-09,-1.40247e-13,-4136.64,-42.5856], Tmin=(986.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-0.480456,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + ring(Cyclobutane)"""),
)

species(
    label = 'O=CCC1C=CC1(6220)',
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72569,0.0364607,2.55857e-05,-5.42967e-08,2.17973e-11,831.749,23.0476], Tmin=(100,'K'), Tmax=(1006.96,'K')), NASAPolynomial(coeffs=[11.7921,0.0288851,-1.14108e-05,2.16224e-09,-1.55876e-13,-2838.77,-33.7462], Tmin=(1006.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.13577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + ring(Cyclobutene)"""),
)
...
species(
    label = '[CH2]CC=CC[C]=O(6399)',
    structure = SMILES('[CH2]CC=CC[C]=O'),
    E0 = (213.397,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,1855,455,950,690.781,4000],'cm^-1')),
        HinderedRotor(inertia=(0.784844,'amu*angstrom^2'), symmetry=1, barrier=(18.0451,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.784061,'amu*angstrom^2'), symmetry=1, barrier=(18.0271,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.78449,'amu*angstrom^2'), symmetry=1, barrier=(18.037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0172219,'amu*angstrom^2'), symmetry=1, barrier=(18.0374,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17379,0.0528901,-2.34567e-05,-2.2779e-09,2.90835e-12,25775,29.1518], Tmin=(100,'K'), Tmax=(1235.72,'K')), NASAPolynomial(coeffs=[13.742,0.028199,-1.28969e-05,2.4978e-09,-1.76558e-13,21447.9,-39.0831], Tmin=(1235.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(213.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(RCCJ) + radical(CCCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62994,0.0476387,-2.22851e-05,3.73652e-09,-7.65007e-15,26531.5,25.9035], Tmin=(100,'K'), Tmax=(1674.44,'K')), NASAPolynomial(coeffs=[12.4258,0.0288995,-1.18142e-05,2.08231e-09,-1.36124e-13,21927.7,-34.697], Tmin=(1674.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(219.855,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(CCCJ=O)"""),
)

species(
    label = 'O=[C]CC1C[CH]C1(6408)',
    structure = SMILES('O=[C]CC1C[CH]C1'),
    E0 = (222.271,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2850,1437.5,1250,1305,750,350,1855,455,950,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'O=[C][CH]C1CCC1(6410)',
    structure = SMILES('O=[C][CH]C1CCC1'),
    E0 = (201.962,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72017,0.034173,3.88042e-05,-7.34677e-08,3.02293e-11,24386.8,24.1748], Tmin=(100,'K'), Tmax=(966.303,'K')), NASAPolynomial(coeffs=[13.3422,0.0254729,-8.86566e-06,1.62605e-09,-1.18137e-13,20300.9,-41.0166], Tmin=(966.303,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.962,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-OdCsH) + ring(Cyclobutane) + radical(CCJCHO) + radical(CCCJ=O)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(2355)', '[CH2]C1[CH]CC1(6246)'],
    products = ['O=[C]CC1[CH]CC1(5301)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'O=[C]CC1[C]CC1(6396)'],
    products = ['O=[C]CC1[CH]CC1(5301)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['CO(2039)', '[CH2]C1[CH]CC1(6246)'],
    products = ['O=[C]CC1[CH]CC1(5301)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'O=[C]CC1=CCC1(6400)'],
    products = ['O=[C]CC1[CH]CC1(5301)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'O=[C]CC1C=CC1(6401)'],
    products = ['O=[C]CC1[CH]CC1(5301)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', 'O=C=CC1[CH]CC1(6402)'],
    products = ['O=[C]CC1[CH]CC1(5301)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', 'O=[C]C[C]1[CH]CC1(6403)'],
    products = ['O=[C]CC1[CH]CC1(5301)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', 'O=[C]CC1[CH]C[CH]1(6404)'],
    products = ['O=[C]CC1[CH]CC1(5301)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', 'O=[C]CC1[CH][CH]C1(6405)'],
    products = ['O=[C]CC1[CH]CC1(5301)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'O=[C][CH]C1[CH]CC1(6406)'],
    products = ['O=[C]CC1[CH]CC1(5301)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O=[C]CC1[CH]CC1(5301)'],
    products = ['O=C[CH]C1[CH]CC1(6409)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O=CC[C]1[CH]CC1(6411)'],
    products = ['O=[C]CC1[CH]CC1(5301)'],
...
reaction(
    label = 'reaction29',
    reactants = ['O=CCC1[CH]C[CH]1(6412)'],
    products = ['O=[C]CC1[CH]CC1(5301)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O=CCC1[CH][CH]C1(6413)'],
    products = ['O=[C]CC1[CH]CC1(5301)'],
