...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.645292,0.0581569,-5.52015e-05,2.77883e-08,-5.24331e-12,17245.2,23.8408], Tmin=(100,'K'), Tmax=(1559.33,'K')), NASAPolynomial(coeffs=[12.8983,0.0146525,-1.73876e-06,-3.40137e-11,1.33579e-14,14891.7,-36.0099], Tmin=(1559.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.269,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['O(4)', '[CH2][CH]C([CH2])[O](1582)'],
    products = ['[CH2]C([O])C([CH2])[O](1530)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[CH2]C([O])[CH][O](1973)'],
    products = ['[CH2]C([O])C([CH2])[O](1530)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(T)(20)', '[CH2]C([O])C=O(1981)'],
    products = ['[CH2]C([O])C([CH2])[O](1530)'],
...
reaction(
    label = 'reaction16',
    reactants = ['O(4)', '[CH2]C([O])C=C(1523)'],
    products = ['[CH2]C([O])C([CH2])[O](1530)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH2][C]([O])C([CH2])[O](1982)'],
    products = ['[CH2]C([O])C([CH2])[O](1530)'],
