...
species(
    label = '[CH2][CH][C]CO[CH2](29756)',
    structure = SMILES('[CH2][CH][C]CO[CH2]'),
    E0 = (752.294,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41553,0.0618181,-8.14702e-05,6.81588e-08,-2.34116e-11,90568.3,29.0388], Tmin=(100,'K'), Tmax=(833.828,'K')), NASAPolynomial(coeffs=[5.67548,0.0330255,-1.46406e-05,2.70707e-09,-1.83912e-13,90148.4,11.0032], Tmin=(833.828,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(752.294,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(RCCJC) + radical(RCCJ) + radical(CsJOCC) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][C][CH]CO[CH2](29757)',
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47788,0.0555764,-5.02351e-05,2.52872e-08,-5.30671e-12,91226.9,28.5775], Tmin=(100,'K'), Tmax=(1125.56,'K')), NASAPolynomial(coeffs=[9.77074,0.0261048,-1.09585e-05,2.02339e-09,-1.39453e-13,89360.1,-12.4115], Tmin=(1125.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(757.749,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCJCO) + radical(CsJOCC) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH][CH]CO[CH2](29758)',
    structure = SMILES('[CH][CH][CH]CO[CH2]'),
    E0 = (746.949,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,218.298,1113.07,1197.7,1306.31,1492.93,1797.93,1811.01],'cm^-1')),
        HinderedRotor(inertia=(0.0979544,'amu*angstrom^2'), symmetry=1, barrier=(3.06377,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0979544,'amu*angstrom^2'), symmetry=1, barrier=(3.06377,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0979544,'amu*angstrom^2'), symmetry=1, barrier=(3.06377,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0979544,'amu*angstrom^2'), symmetry=1, barrier=(3.06377,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0979544,'amu*angstrom^2'), symmetry=1, barrier=(3.06377,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6382,0.0550091,-5.89187e-05,4.11794e-08,-1.25329e-11,89919.5,30.054], Tmin=(100,'K'), Tmax=(782.104,'K')), NASAPolynomial(coeffs=[6.2631,0.0313555,-1.35534e-05,2.51e-09,-1.722e-13,89196,8.87819], Tmin=(782.104,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(746.949,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCJCO) + radical(RCCJC) + radical(CsJOCC) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH2][CH][CH][CH]O[CH2](29759)',
    structure = SMILES('[CH2][CH][CH][CH]O[CH2]'),
    E0 = (684.437,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,221.635,996.527,1713.47,3133.01],'cm^-1')),
        HinderedRotor(inertia=(0.0518352,'amu*angstrom^2'), symmetry=1, barrier=(2.27339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0518352,'amu*angstrom^2'), symmetry=1, barrier=(2.27339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0518352,'amu*angstrom^2'), symmetry=1, barrier=(2.27339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0518352,'amu*angstrom^2'), symmetry=1, barrier=(2.27339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0518352,'amu*angstrom^2'), symmetry=1, barrier=(2.27339,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36433,0.0604844,-7.19466e-05,5.14811e-08,-1.5258e-11,82411.3,31.2619], Tmin=(100,'K'), Tmax=(817.74,'K')), NASAPolynomial(coeffs=[8.11788,0.0274394,-1.13133e-05,2.03485e-09,-1.36778e-13,81307.1,0.0408692], Tmin=(817.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(684.437,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCJCO) + radical(RCCJC) + radical(CCsJOCs) + radical(RCCJ) + radical(CsJOCC)"""),
)
...
species(
    label = '[CH2][CH][CH][CH]OC(29760)',
    structure = SMILES('[CH2][CH][CH][CH]OC'),
    E0 = (496.665,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32076,0.063561,-7.99363e-05,6.50932e-08,-2.21357e-11,59827,29.7266], Tmin=(100,'K'), Tmax=(819.919,'K')), NASAPolynomial(coeffs=[5.88847,0.0347533,-1.52989e-05,2.83284e-09,-1.93099e-13,59297.3,9.93423], Tmin=(819.919,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(496.665,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCJCO) + radical(RCCJC) + radical(CCsJOCs) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C[CH][CH]O[CH2](29761)',
    structure = SMILES('[CH2]C[CH][CH]O[CH2]'),
    E0 = (489.99,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06413,0.0615127,-5.69189e-05,2.85916e-08,-5.82528e-12,59040.5,29.6003], Tmin=(100,'K'), Tmax=(1179.24,'K')), NASAPolynomial(coeffs=[12.1162,0.0240239,-9.23266e-06,1.63269e-09,-1.09936e-13,56433.9,-25.5414], Tmin=(1179.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(489.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCJCO) + radical(CCsJOCs) + radical(RCCJ) + radical(CsJOCC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][CH][CH]CO[CH2](28882)'],
...
reaction(
    ...
    products = ['[CH2][CH][CH]CO[CH2](28882)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]O[CH2](3113)', '[CH][CH][CH2](5537)'],
    products = ['[CH2][CH][CH]CO[CH2](28882)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2][CH][C]CO[CH2](29756)'],
    products = ['[CH2][CH][CH]CO[CH2](28882)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2][C][CH]CO[CH2](29757)'],
    products = ['[CH2][CH][CH]CO[CH2](28882)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH][CH][CH]CO[CH2](29758)'],
    products = ['[CH2][CH][CH]CO[CH2](28882)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]OC[CH][CH][CH2](9341)'],
    products = ['[CH2][CH][CH]CO[CH2](28882)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2][CH][CH][CH]O[CH2](29759)'],
    products = ['[CH2][CH][CH]CO[CH2](28882)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][CH][CH]CO[CH2](28882)'],
    products = ['[CH2][CH]C[CH]O[CH2](29147)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH][CH]CO[CH2](28882)'],
    products = ['[CH2][CH][CH][CH]OC(29760)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][CH][CH]CO[CH2](28882)'],
    products = ['[CH2]C[CH][CH]O[CH2](29761)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][CH][CH]CO[CH2](28882)'],
    products = ['[CH2]O[CH][CH][CH]C(29251)'],
...
network(
    label = 'PDepNetwork #7700',
    isomers = [
        '[CH2][CH][CH]CO[CH2](28882)',
    ],
    reactants = [
