...
species(
    label = 'C[C]CC[CH]C(156)',
    structure = SMILES('C[C]CC[CH]C'),
    E0 = (450.797,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5245,0.0572408,-3.33593e-05,1.01396e-08,-1.34167e-12,54304.3,25.6028], Tmin=(100,'K'), Tmax=(1561.37,'K')), NASAPolynomial(coeffs=[8.2754,0.0399461,-1.67445e-05,3.04556e-09,-2.05815e-13,52196.1,-9.97443], Tmin=(1561.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(450.797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', '[CH]CC[CH]C(119)'],
    products = ['C[CH]CC[CH]C(96)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'C[CH][CH]C[CH]C(160)'],
    products = ['C[CH]CC[CH]C(96)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH2][CH]CC[CH]C(161)'],
    products = ['C[CH]CC[CH]C(96)'],
