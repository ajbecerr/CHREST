...
species(
    label = '[CH]OC[C]=[CH](17798)',
    structure = SMILES('[CH]OC[C]=[CH]'),
    E0 = (819.66,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1685,370,3120,650,792.5,1650,315.771,316.354,1800.95,1801.24,4000],'cm^-1')),
        HinderedRotor(inertia=(0.143166,'amu*angstrom^2'), symmetry=1, barrier=(10.1681,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.324585,'amu*angstrom^2'), symmetry=1, barrier=(23.0088,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143278,'amu*angstrom^2'), symmetry=1, barrier=(10.1707,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93918,0.0508343,-8.22842e-05,7.44216e-08,-2.63672e-11,98651.2,20.3613], Tmin=(100,'K'), Tmax=(832.415,'K')), NASAPolynomial(coeffs=[5.92191,0.0213526,-1.05195e-05,2.01899e-09,-1.39191e-13,98346.5,4.02995], Tmin=(832.415,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(819.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CH2_triplet) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]CO[C]C(17799)',
    structure = SMILES('[CH]=[C]CO[C]C'),
    E0 = (782.112,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,438.397,438.397,438.398,438.399],'cm^-1')),
        HinderedRotor(inertia=(0.074416,'amu*angstrom^2'), symmetry=1, barrier=(10.1491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.441419,'amu*angstrom^2'), symmetry=1, barrier=(10.1491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0744157,'amu*angstrom^2'), symmetry=1, barrier=(10.1491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.441419,'amu*angstrom^2'), symmetry=1, barrier=(10.1491,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17267,0.0672109,-9.56853e-05,7.89523e-08,-2.66217e-11,94163.4,23.8471], Tmin=(100,'K'), Tmax=(777.388,'K')), NASAPolynomial(coeffs=[8.07753,0.0281422,-1.347e-05,2.58879e-09,-1.80163e-13,93196.8,-7.03816], Tmin=(777.388,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(782.112,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CH2_triplet) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[C]=[C]CO[CH]C(17800)',
    structure = SMILES('[C]=[C]CO[CH]C'),
    E0 = (812.586,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1685,370,334.734,334.735,334.737,334.739],'cm^-1')),
        HinderedRotor(inertia=(0.0015045,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100015,'amu*angstrom^2'), symmetry=1, barrier=(7.95237,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100016,'amu*angstrom^2'), symmetry=1, barrier=(7.95238,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100015,'amu*angstrom^2'), symmetry=1, barrier=(7.95237,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04675,0.0720477,-0.000113545,9.98256e-08,-3.43729e-11,97831,24.9851], Tmin=(100,'K'), Tmax=(848.187,'K')), NASAPolynomial(coeffs=[7.29225,0.02909,-1.36934e-05,2.57183e-09,-1.74965e-13,97257.3,-1.25389], Tmin=(848.187,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(812.586,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOCs) + radical(Cds_S) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.944192,0.053961,-1.49573e-05,-3.24453e-08,2.06028e-11,13298,21.1394], Tmin=(100,'K'), Tmax=(911.354,'K')), NASAPolynomial(coeffs=[18.9941,0.0101417,-1.10475e-06,4.65539e-11,-3.0778e-15,8537.84,-72.3315], Tmin=(911.354,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(109.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ)"""),
)

species(
    label = '[CH]=CCOC=C(16854)',
...
reaction(
    label = 'reaction2',
    reactants = ['CHCH3(T)(21)', '[CH]=[C]C[O](16850)'],
    products = ['[CH]=[C]CO[CH]C(15944)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=[CH](9646)', '[CH2]O[CH]C(3213)'],
    products = ['[CH]=[C]CO[CH]C(15944)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', '[CH]OC[C]=[CH](17798)'],
    products = ['[CH]=[C]CO[CH]C(15944)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]=[C]CO[C]C(17799)'],
    products = ['[CH]=[C]CO[CH]C(15944)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[C]=[C]CO[CH]C(17800)'],
    products = ['[CH]=[C]CO[CH]C(15944)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    ...
    kinetics = Arrhenius(A=(4e+09,'cm^3/(mol*s)'), n=1.39, Ea=(64.921,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Od_CO-CsH;YJ] for rate rule [Od_CO-CsH;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 62.4 to 64.9 kJ/mol to match endothermicity of reaction."""),
)
