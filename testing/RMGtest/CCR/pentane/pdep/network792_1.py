species(
    ...
    E0 = (60.4842,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
...
species(
    label = 'CC[CH]CC[O](3308)',
    structure = SMILES('CC[CH]CC[O]'),
    E0 = (92.2517,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,1869.07,1869.26,1870.46],'cm^-1')),
        HinderedRotor(inertia=(0.20491,'amu*angstrom^2'), symmetry=1, barrier=(4.71129,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205186,'amu*angstrom^2'), symmetry=1, barrier=(4.71763,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205286,'amu*angstrom^2'), symmetry=1, barrier=(4.71993,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205069,'amu*angstrom^2'), symmetry=1, barrier=(4.71493,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66112,0.059509,-7.18808e-05,7.16501e-08,-2.95442e-11,11171.7,26.3695], Tmin=(100,'K'), Tmax=(813.59,'K')), NASAPolynomial(coeffs=[-0.660772,0.0523325,-2.4372e-05,4.63313e-09,-3.20425e-13,12164.8,40.8738], Tmin=(813.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.2517,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0767894,0.0753319,-5.37829e-05,2.05281e-08,-3.20861e-12,8017.83,31.8569], Tmin=(100,'K'), Tmax=(1501.78,'K')), NASAPolynomial(coeffs=[15.7192,0.0336677,-1.21678e-05,2.05424e-09,-1.33259e-13,3319.57,-49.9698], Tmin=(1501.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.4139,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(Isobutyl)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.374919,0.0749182,-5.66072e-05,2.25343e-08,-3.70191e-12,37928.7,29.1776], Tmin=(100,'K'), Tmax=(1413.36,'K')), NASAPolynomial(coeffs=[14.44,0.035112,-1.43608e-05,2.60708e-09,-1.7711e-13,33952.9,-43.5443], Tmin=(1413.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(314.241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20141,0.0650496,-3.73283e-05,1.05626e-08,-1.25018e-12,-36677.4,25.4925], Tmin=(100,'K'), Tmax=(1769.07,'K')), NASAPolynomial(coeffs=[11.2938,0.0422298,-1.79793e-05,3.27095e-09,-2.19742e-13,-40248.2,-28.9548], Tmin=(1769.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-305.754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs)"""),
)

species(
    label = 'CCC=CC(C)O(3312)',
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.3615,0.0710869,-4.67606e-05,1.57814e-08,-2.17843e-12,-29785.2,29.5648], Tmin=(100,'K'), Tmax=(1664.01,'K')), NASAPolynomial(coeffs=[15.9124,0.033705,-1.3063e-05,2.28084e-09,-1.50109e-13,-34960.6,-53.3785], Tmin=(1664.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-248.798,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CC[CH]CC(C)=O(1806)',
    structure = SMILES('CC[CH]CC(C)=O'),
    E0 = (-105.852,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,375,552.5,462.5,1710,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17061,0.0623114,-3.66779e-05,1.07041e-08,-1.29541e-12,-12630.4,28.1137], Tmin=(100,'K'), Tmax=(1782.27,'K')), NASAPolynomial(coeffs=[12.3524,0.0372157,-1.55567e-05,2.80356e-09,-1.87196e-13,-16616.1,-32.2937], Tmin=(1782.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-105.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CCJCC=O)"""),
)

species(
    label = 'CCC=CC(C)[O](1808)',
    structure = SMILES('CCC=CC(C)[O]'),
    E0 = (-17.6388,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,369.14,369.142,369.142],'cm^-1')),
        HinderedRotor(inertia=(0.00123714,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121814,'amu*angstrom^2'), symmetry=1, barrier=(11.779,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121814,'amu*angstrom^2'), symmetry=1, barrier=(11.7789,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12181,'amu*angstrom^2'), symmetry=1, barrier=(11.7789,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.74136,0.0591971,-1.20105e-05,-2.27928e-08,1.17568e-11,-1993.38,29.5703], Tmin=(100,'K'), Tmax=(1040.73,'K')), NASAPolynomial(coeffs=[14.224,0.0337839,-1.34428e-05,2.50544e-09,-1.76945e-13,-6229.8,-42.8843], Tmin=(1040.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-17.6388,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.493362,0.0835814,-9.93077e-05,8.15963e-08,-2.87766e-11,932.051,31.0281], Tmin=(100,'K'), Tmax=(797.691,'K')), NASAPolynomial(coeffs=[5.11629,0.0517403,-2.31491e-05,4.33806e-09,-2.98429e-13,470.026,11.4969], Tmin=(797.691,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(6.7512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(RCCJCC)"""),
)
...
species(
    ...
    E0 = (65.9279,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.994912,0.0679008,-4.26836e-05,1.43149e-08,-2.08733e-12,7379.1,29.7692], Tmin=(100,'K'), Tmax=(1468.63,'K')), NASAPolynomial(coeffs=[9.62401,0.0443985,-1.86794e-05,3.41854e-09,-2.32478e-13,4844.5,-15.1777], Tmin=(1468.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.4721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJC)"""),
)

species(
    label = 'CC[CH][CH]C(C)O(3315)',
    structure = SMILES('CC[CH][CH]C(C)O'),
    E0 = (30.0254,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.70113,0.0773681,-7.14253e-05,4.27274e-08,-1.15042e-11,5131.44,31.507], Tmin=(100,'K'), Tmax=(861.976,'K')), NASAPolynomial(coeffs=[6.89697,0.0486159,-2.13903e-05,4.02882e-09,-2.80269e-13,4063.32,2.53604], Tmin=(861.976,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(41.7125,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CJCO)"""),
)

species(
    label = 'CCCC[C](C)[O](3317)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.64793,0.0762035,-5.89814e-05,2.58289e-08,-4.92059e-12,5248.53,27.7168], Tmin=(100,'K'), Tmax=(1188.43,'K')), NASAPolynomial(coeffs=[9.96062,0.0448592,-1.94199e-05,3.63646e-09,-2.52173e-13,3035.02,-18.8193], Tmin=(1188.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.6537,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]CCCC(C)[O](3318)',
    structure = SMILES('[CH2]CCCC(C)[O]'),
    E0 = (71.2722,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.391625,0.0733777,-4.9881e-05,1.75531e-08,-2.55091e-12,8706.55,31.0034], Tmin=(100,'K'), Tmax=(1570.6,'K')), NASAPolynomial(coeffs=[14.8389,0.0365835,-1.47408e-05,2.63729e-09,-1.76688e-13,4168.38,-45.2186], Tmin=(1570.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.2722,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C([O])CCCC(1398)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.267247,0.0771446,-5.71599e-05,2.24098e-08,-3.63719e-12,9473.12,30.2922], Tmin=(100,'K'), Tmax=(1425.41,'K')), NASAPolynomial(coeffs=[14.52,0.037148,-1.50701e-05,2.72424e-09,-1.84549e-13,5409.94,-43.5211], Tmin=(1425.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(77.6149,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CJCO)"""),
)

species(
    label = 'C[CH][CH]CC(C)O(3319)',
    structure = SMILES('C[CH][CH]CC(C)O'),
    E0 = (24.5697,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.877951,0.0746842,-8.0442e-05,6.63937e-08,-2.43231e-11,3061.67,32.9587], Tmin=(100,'K'), Tmax=(796.988,'K')), NASAPolynomial(coeffs=[3.15819,0.0539433,-2.39087e-05,4.46852e-09,-3.0727e-13,2993.46,24.3276], Tmin=(796.988,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.5697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C[CH]CC(C)O(3320)',
    structure = SMILES('[CH2]C[CH]CC(C)O'),
    E0 = (35.3697,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.934754,0.0723704,-6.0129e-05,3.30814e-08,-8.54962e-12,4360.09,31.8228], Tmin=(100,'K'), Tmax=(874.141,'K')), NASAPolynomial(coeffs=[5.75533,0.0503122,-2.22787e-05,4.21534e-09,-2.94235e-13,3517.3,9.21464], Tmin=(874.141,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.3697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'CC[CH]CC[O](3308)'],
...
reaction(
    label = 'reaction6',
    reactants = ['O(4)', 'C[CH]C[CH]CC(137)'],
    products = ['CC[CH]CC(C)[O](3142)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]CC(26)', '[CH2]C(C)[O](667)'],
    products = ['CC[CH]CC(C)[O](3142)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H5(14)', '[CH]CC(C)[O](3219)'],
    products = ['CC[CH]CC(C)[O](3142)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'CC[C]CC(C)[O](3310)'],
    products = ['CC[CH]CC(C)[O](3142)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'CC[CH]CC(C)=O(1806)'],
    products = ['CC[CH]CC(C)[O](3142)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH3(17)', 'CC[CH]CC=O(1813)'],
    products = ['CC[CH]CC(C)[O](3142)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH3(17)', 'C=CCC(C)[O](1432)'],
    products = ['CC[CH]CC(C)[O](3142)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH3(17)', 'CC[CH]C[CH][O](1589)'],
    products = ['CC[CH]CC(C)[O](3142)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'CC[CH]C[C](C)[O](1820)'],
    products = ['CC[CH]CC(C)[O](3142)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', 'CC[CH][CH]C(C)[O](1824)'],
    products = ['CC[CH]CC(C)[O](3142)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH3(17)', '[CH2][CH]CC(C)[O](1690)'],
    products = ['CC[CH]CC(C)[O](3142)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', 'C[CH][CH]CC(C)[O](1826)'],
    products = ['CC[CH]CC(C)[O](3142)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH2]C([O])C[CH]CC(1446)'],
    products = ['CC[CH]CC(C)[O](3142)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH2]C[CH]CC(C)[O](1828)'],
    products = ['CC[CH]CC(C)[O](3142)'],
