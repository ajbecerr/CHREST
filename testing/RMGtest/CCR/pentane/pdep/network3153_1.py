...
species(
    label = '[CH]C=CCCC([CH2])C(13972)',
    structure = SMILES('[CH]C=CCCC([CH2])C'),
    E0 = (446.184,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]C=CCC[C]CC(13973)',
    structure = SMILES('[CH]C=CCC[C]CC'),
    E0 = (695.011,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.144476,0.0849402,-5.59151e-05,1.88981e-08,-2.65054e-12,83744.4,34.5132], Tmin=(100,'K'), Tmax=(1607.93,'K')), NASAPolynomial(coeffs=[16.1251,0.0444661,-1.81572e-05,3.24299e-09,-2.16452e-13,78512.4,-51.7051], Tmin=(1607.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(695.011,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCJ2_triplet) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH][CH]C[CH]C[CH]CC(13974)',
    structure = SMILES('[CH][CH]C[CH]C[CH]CC'),
    E0 = (792.153,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,220.448,1278.78,1330.5,1349.26,1496.81,1597.13,1777.78,1844.12],'cm^-1')),
        HinderedRotor(inertia=(0.0761017,'amu*angstrom^2'), symmetry=1, barrier=(2.89963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0761017,'amu*angstrom^2'), symmetry=1, barrier=(2.89963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0761017,'amu*angstrom^2'), symmetry=1, barrier=(2.89963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0761017,'amu*angstrom^2'), symmetry=1, barrier=(2.89963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0761017,'amu*angstrom^2'), symmetry=1, barrier=(2.89963,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.374293,0.0919499,-0.000123656,1.1881e-07,-4.58446e-11,95392.7,40.4616], Tmin=(100,'K'), Tmax=(838.167,'K')), NASAPolynomial(coeffs=[-0.393694,0.0679393,-3.1157e-05,5.84298e-09,-3.99502e-13,96493.6,49.8303], Tmin=(838.167,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(792.153,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC) + radical(RCCJC) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]CC[CH][CH]CC(13975)',
    structure = SMILES('[CH][CH]CC[CH][CH]CC'),
    E0 = (792.153,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,220.448,1278.78,1330.5,1349.26,1496.81,1597.13,1777.78,1844.12],'cm^-1')),
        HinderedRotor(inertia=(0.0761017,'amu*angstrom^2'), symmetry=1, barrier=(2.89963,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]C[CH]C[CH][CH]CC(13976)',
    structure = SMILES('[CH]C[CH]C[CH][CH]CC'),
    E0 = (792.165,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,186.717,474.405,606.321,661.788,2442.75,2522.15,3830.48,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0515436,'amu*angstrom^2'), symmetry=1, barrier=(1.81413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0515436,'amu*angstrom^2'), symmetry=1, barrier=(1.81413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0515436,'amu*angstrom^2'), symmetry=1, barrier=(1.81413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0515436,'amu*angstrom^2'), symmetry=1, barrier=(1.81413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0515436,'amu*angstrom^2'), symmetry=1, barrier=(1.81413,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.62976,0.0583698,-2.33473e-05,3.10724e-09,-6.1457e-14,95235.4,28.2825], Tmin=(100,'K'), Tmax=(2844.58,'K')), NASAPolynomial(coeffs=[64.5667,-0.0080161,1.48058e-06,-3.26007e-10,3.06243e-14,52757.9,-343.134], Tmin=(2844.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(792.165,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC) + radical(RCCJCC) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1[CH]CCC1CC(13977)',
    structure = SMILES('[CH]C1[CH]CCC1CC'),
    E0 = (461.66,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
...
species(
    label = '[CH][CH]C1CCC1CC(13978)',
    structure = SMILES('[CH][CH]C1CCC1CC'),
    E0 = (543.426,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
...
species(
    label = '[CH]C=CCC=CCC(13979)',
    structure = SMILES('[CH]C=CCC=CCC'),
    E0 = (364.738,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.146405,0.0726155,-2.41642e-05,-1.09778e-08,6.8957e-12,44016.6,34.2969], Tmin=(100,'K'), Tmax=(1120.44,'K')), NASAPolynomial(coeffs=[13.5364,0.046801,-1.9042e-05,3.48983e-09,-2.40606e-13,39635.9,-37.984], Tmin=(1120.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(364.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]=C[CH]CCC=C(13680)',
    structure = SMILES('[CH]C=CCCC=C'),
    E0 = (398.359,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2950,3100,1380,975,1025,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.484117,0.0779177,-4.22129e-05,1.10641e-08,-1.18947e-12,53193.7,35.064], Tmin=(100,'K'), Tmax=(1974.28,'K')), NASAPolynomial(coeffs=[15.1424,0.0482195,-1.96493e-05,3.44493e-09,-2.24683e-13,47405.7,-45.6246], Tmin=(1974.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(441.243,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=C[CH]CCCC(13984)',
    structure = SMILES('[CH]C=C[CH]CCCC'),
    E0 = (387.909,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.143802,0.0794343,-3.6482e-05,1.70342e-09,2.28881e-12,46813.4,33.5119], Tmin=(100,'K'), Tmax=(1245.17,'K')), NASAPolynomial(coeffs=[14.3794,0.0493421,-2.01829e-05,3.65894e-09,-2.48502e-13,41912.7,-44.8942], Tmin=(1245.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(387.909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=CCCCC[CH2](13985)',
    structure = SMILES('[CH]C=CCCCC[CH2]'),
    E0 = (452.043,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.184398,0.0839393,-5.05788e-05,1.51777e-08,-1.86495e-12,54525.1,36.5521], Tmin=(100,'K'), Tmax=(1820.35,'K')), NASAPolynomial(coeffs=[18.1061,0.0437475,-1.74595e-05,3.04823e-09,-1.99108e-13,47866.2,-62.6454], Tmin=(1820.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(452.043,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=[C]CCCCC(13986)',
    structure = SMILES('[CH]C=[C]CCCCC'),
    E0 = (484.638,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.168477,0.0832342,-5.06203e-05,1.56419e-08,-2.03345e-12,58426.2,33.9419], Tmin=(100,'K'), Tmax=(1666.09,'K')), NASAPolynomial(coeffs=[13.8905,0.0502897,-2.09599e-05,3.77352e-09,-2.52567e-13,53853.8,-39.2638], Tmin=(1666.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(484.638,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH][C]=CCCCCC(13987)',
    structure = SMILES('[CH][C]=CCCCCC'),
    E0 = (484.638,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[C]=C[CH]CC[CH]CC(13988)',
    structure = SMILES('[C]C=CCC[CH]CC'),
    E0 = (740.048,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.695905,0.077673,-5.71637e-05,2.42956e-08,-4.65821e-12,89121.9,31.5003], Tmin=(100,'K'), Tmax=(1146.13,'K')), NASAPolynomial(coeffs=[8.21359,0.0514363,-2.28263e-05,4.32268e-09,-3.01601e-13,87398.6,-5.79354], Tmin=(1146.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(740.048,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(CJ3)"""),
)

species(
    label = 'CC[CH]CCC1C=C1(13989)',
    structure = SMILES('CC[CH]CCC1C=C1'),
    E0 = (340.419,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.762503,0.0763457,-4.90771e-05,1.73553e-08,-2.76344e-12,41054.7,28.8022], Tmin=(100,'K'), Tmax=(1318.87,'K')), NASAPolynomial(coeffs=[8.21166,0.0537529,-2.33812e-05,4.36628e-09,-3.01264e-13,39089.8,-9.19731], Tmin=(1318.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(340.419,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(RCCJCC)"""),
)

species(
    label = '[CH]=CC1CCC1CC(13905)',
    structure = SMILES('[CH]=CC1CCC1CC'),
    E0 = (276.617,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
...
species(
    label = 'C=C=CCC[CH]CC(5175)',
    structure = SMILES('C=C=CCC[CH]CC'),
    E0 = (247.174,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,540,610,2055,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.859342,0.074668,-4.53278e-05,1.44425e-08,-2.02678e-12,29835.6,31.4888], Tmin=(100,'K'), Tmax=(1468.52,'K')), NASAPolynomial(coeffs=[8.93167,0.0526805,-2.2869e-05,4.24696e-09,-2.91105e-13,27464.8,-10.5574], Tmin=(1468.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(247.174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(RCCJCC)"""),
)

species(
    label = '[CH]=CCCC=CCC(13990)',
    structure = SMILES('[CH]=CCCC=CCC'),
    E0 = (252.125,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0122905,0.0765337,-3.8508e-05,1.98997e-09,2.98012e-12,30477.8,34.5736], Tmin=(100,'K'), Tmax=(1152.53,'K')), NASAPolynomial(coeffs=[15.212,0.0417932,-1.6847e-05,3.08443e-09,-2.12488e-13,25766.5,-46.2506], Tmin=(1152.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.125,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC=CCCCC(13991)',
    structure = SMILES('[CH]=CC=CCCCC'),
    E0 = (234.786,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.244061,0.0805726,-4.07851e-05,-2.34133e-09,6.08834e-12,28402,32.8409], Tmin=(100,'K'), Tmax=(1053.55,'K')), NASAPolynomial(coeffs=[17.0221,0.0387495,-1.50261e-05,2.73839e-09,-1.90206e-13,23446.8,-57.6094], Tmin=(1053.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = 'C=CC=CC[CH]CC(5191)',
    structure = SMILES('C=CC=CC[CH]CC'),
    E0 = (182.148,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2950,3100,1380,975,1025,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0213036,0.0784226,-4.95892e-05,1.60331e-08,-2.12341e-12,22060.3,34.2239], Tmin=(100,'K'), Tmax=(1721.77,'K')), NASAPolynomial(coeffs=[17.1705,0.0384829,-1.4794e-05,2.56045e-09,-1.6719e-13,16140.2,-58.0577], Tmin=(1721.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(182.148,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(RCCJCC)"""),
)

species(
    label = '[CH]=CCCCC=CC(13665)',
    structure = SMILES('[CH]=CCCCC=CC'),
    E0 = (250.99,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0978921,0.0802795,-5.19102e-05,1.6934e-08,-2.24959e-12,30342.7,34.2274], Tmin=(100,'K'), Tmax=(1722.7,'K')), NASAPolynomial(coeffs=[18.194,0.0378078,-1.49297e-05,2.62324e-09,-1.7284e-13,24040.3,-63.9694], Tmin=(1722.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(250.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C=CCCCCC(13667)',
    structure = SMILES('C#C[CH]CCCCC'),
    E0 = (200.671,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.205614,0.0866939,-6.75395e-05,2.9731e-08,-5.47489e-12,24291.3,31.8313], Tmin=(100,'K'), Tmax=(1274,'K')), NASAPolynomial(coeffs=[13.7368,0.0429186,-1.59986e-05,2.76023e-09,-1.82346e-13,20738.8,-38.809], Tmin=(1274,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.671,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Sec_Propargyl)"""),
)

species(
    label = '[CH]=CC=CC[CH]CC(13992)',
    structure = SMILES('[CH]=CC=CC[CH]CC'),
    E0 = (429.244,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.245224,0.078269,-5.48314e-05,2.04284e-08,-3.18398e-12,51764.5,33.6468], Tmin=(100,'K'), Tmax=(1462.45,'K')), NASAPolynomial(coeffs=[13.8916,0.0409444,-1.65487e-05,2.9771e-09,-2.00769e-13,47773,-37.3766], Tmin=(1462.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(429.244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(RCCJCC) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C=CCC[CH]CC(13993)',
    structure = SMILES('C#C[CH]CC[CH]CC'),
    E0 = (395.129,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,2175,525,750,770,3400,2100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.331598,0.0836949,-7.88131e-05,4.89022e-08,-1.3376e-11,47652.4,32.4772], Tmin=(100,'K'), Tmax=(861.567,'K')), NASAPolynomial(coeffs=[7.56761,0.050102,-2.03305e-05,3.65162e-09,-2.46395e-13,46405.5,-1.35456], Tmin=(861.567,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(395.129,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJCC) + radical(Sec_Propargyl)"""),
)
...
species(
    label = '[CH]=[C]CCC[CH]CC(13994)',
    structure = SMILES('[CH]=[C]CCC[CH]CC'),
    E0 = (567.753,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.376659,0.0858656,-8.17011e-05,5.49928e-08,-1.73216e-11,68409.8,35.5206], Tmin=(100,'K'), Tmax=(735.552,'K')), NASAPolynomial(coeffs=[5.34384,0.0588545,-2.66193e-05,5.07106e-09,-3.54668e-13,67679.1,13.0823], Tmin=(735.552,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(567.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C]=CCC[CH]CC(5180)',
    structure = SMILES('[CH2][C]=CCC[CH]CC'),
    E0 = (459.911,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.773203,0.0770324,-5.12762e-05,1.95089e-08,-3.43625e-12,55425.4,33.5201], Tmin=(100,'K'), Tmax=(1192.67,'K')), NASAPolynomial(coeffs=[7.07067,0.0559122,-2.47141e-05,4.66175e-09,-3.24141e-13,53923.2,2.02882], Tmin=(1192.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(459.911,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CCC[CH][CH]CC(13995)',
    structure = SMILES('[CH]=CCC[CH][CH]CC'),
    E0 = (524.37,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180,400,1044.22,3200],'cm^-1')),
        HinderedRotor(inertia=(0.0364047,'amu*angstrom^2'), symmetry=1, barrier=(3.34806,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0364047,'amu*angstrom^2'), symmetry=1, barrier=(3.34806,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0364047,'amu*angstrom^2'), symmetry=1, barrier=(3.34806,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0364047,'amu*angstrom^2'), symmetry=1, barrier=(3.34806,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0364047,'amu*angstrom^2'), symmetry=1, barrier=(3.34806,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C=C[CH]C[CH]CC(5177)',
    structure = SMILES('[CH2]C=C[CH]C[CH]CC'),
    E0 = (363.182,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.338359,0.0747392,-4.22957e-05,1.15891e-08,-1.28243e-12,43816.9,33.5196], Tmin=(100,'K'), Tmax=(2008.18,'K')), NASAPolynomial(coeffs=[18.386,0.0387908,-1.54442e-05,2.67499e-09,-1.72704e-13,36568.3,-66.133], Tmin=(2008.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(363.182,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(Allyl_S) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=CCCC[CH][CH]C(5909)',
    structure = SMILES('[CH]=CCCC[CH][CH]C'),
    E0 = (524.358,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,248.497,860.524,1251.74,1858.24],'cm^-1')),
        HinderedRotor(inertia=(0.115173,'amu*angstrom^2'), symmetry=1, barrier=(3.42674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115173,'amu*angstrom^2'), symmetry=1, barrier=(3.42674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115173,'amu*angstrom^2'), symmetry=1, barrier=(3.42674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115173,'amu*angstrom^2'), symmetry=1, barrier=(3.42674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115173,'amu*angstrom^2'), symmetry=1, barrier=(3.42674,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.510787,0.0828276,-8.21775e-05,6.36721e-08,-2.30819e-11,63185.6,37.2885], Tmin=(100,'K'), Tmax=(754.63,'K')), NASAPolynomial(coeffs=[3.54245,0.0610106,-2.73872e-05,5.17596e-09,-3.59352e-13,62891.7,24.6002], Tmin=(754.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(524.358,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJC) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C=CC[CH][CH]CC(5176)',
    structure = SMILES('[CH2]C=CC[CH][CH]CC'),
    E0 = (416.528,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,247.663,889.367,1257.57,1981.3],'cm^-1')),
        HinderedRotor(inertia=(0.0985091,'amu*angstrom^2'), symmetry=1, barrier=(3.47307,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0985091,'amu*angstrom^2'), symmetry=1, barrier=(3.47307,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0985091,'amu*angstrom^2'), symmetry=1, barrier=(3.47307,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0985091,'amu*angstrom^2'), symmetry=1, barrier=(3.47307,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0985091,'amu*angstrom^2'), symmetry=1, barrier=(3.47307,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09098,0.0536173,6.89645e-05,-2.67459e-07,2.42301e-10,50153,31.2533], Tmin=(100,'K'), Tmax=(391.839,'K')), NASAPolynomial(coeffs=[2.83877,0.0624921,-2.82053e-05,5.38426e-09,-3.77761e-13,49967.7,26.729], Tmin=(391.839,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(416.528,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(RCCJCC) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=CCCC[CH]C[CH2](13996)',
    structure = SMILES('[CH]=CCCC[CH]C[CH2]'),
    E0 = (535.158,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.661148,0.0795065,-5.87018e-05,2.65e-08,-5.61945e-12,64479.8,35.81], Tmin=(100,'K'), Tmax=(1026.35,'K')), NASAPolynomial(coeffs=[6.52306,0.056661,-2.53134e-05,4.81263e-09,-3.36838e-13,63276.5,7.37716], Tmin=(1026.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(535.158,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH2]C=CCC[CH]C[CH2](5178)',
    structure = SMILES('[CH2]C=CCC[CH]C[CH2]'),
    E0 = (427.316,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.66686,0.0754645,-4.5615e-05,1.41058e-08,-1.85687e-12,51511.3,35.1944], Tmin=(100,'K'), Tmax=(1615.35,'K')), NASAPolynomial(coeffs=[11.5854,0.0484271,-2.0508e-05,3.7438e-09,-2.53175e-13,47983.8,-22.7172], Tmin=(1615.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(427.316,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(RCCJ) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH]C=CCC[CH]C(5053)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]C=CCCC([CH2])C(13972)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]CC(26)', '[CH]=C[CH]C[CH2](13774)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(14)', '[CH]C=CCC[CH](13792)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C=CCC[C]CC(13973)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH][CH]C[CH]C[CH]CC(13974)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH][CH]CC[CH][CH]CC(13975)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]C[CH]C[CH][CH]CC(13976)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]C=CCC[CH]CC(5167)'],
    products = ['[CH]C1[CH]CCC1CC(13977)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]C=CCC[CH]CC(5167)'],
    products = ['[CH][CH]C1CCC1CC(13978)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(4.73e+06,'s^-1'), n=1.31, Ea=(102.172,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra;radadd_intra_csHNd]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 98.5 to 102.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH]C=CCC=CCC(13979)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH]=C[CH]CCC=CC(5751)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(17)', '[CH]=C[CH]CCC=C(13680)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH]C=CC[CH][CH]CC(13980)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]C=[CH](13797)', '[CH2]C[CH]CC(101)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH]C=C[CH]C[CH]CC(13981)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH3(17)', '[CH]C=CCC[CH][CH2](5270)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH]C=CCC[CH][CH]C(5885)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH]=C[CH]CC[CH]C[CH2](9197)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH]C=[C]CC[CH]CC(13982)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH][C]=CCC[CH]CC(13983)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]C=CCC[CH]CC(5167)'],
    products = ['[CH]=C[CH]CCC[CH]C(5910)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]C=CCCCC[CH2](13985)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction33',
    reactants = ['C2H2(T)(1343)', '[CH]CC[CH]CC(240)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', '[C]=C[CH]CC[CH]CC(13988)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction43',
    reactants = ['H(3)', '[CH]=CC=CC[CH]CC(13992)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction44',
    reactants = ['H(3)', '[CH]=C=CCC[CH]CC(13993)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction45',
    reactants = ['C2H2(1342)', '[CH]CC[CH]CC(240)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH]=[C]CCC[CH]CC(13994)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH2][C]=CCC[CH]CC(5180)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[CH]=CCC[CH][CH]CC(13995)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH]C=CCC[CH]CC(5167)'],
    products = ['[CH2]C=C[CH]C[CH]CC(5177)'],
...
reaction(
    label = 'reaction52',
    reactants = ['[CH]=CCCC[CH][CH]C(5909)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
    transitionState = 'TS52',
    kinetics = Arrhenius(A=(0.0756983,'s^-1'), n=3.26, Ea=(26.8822,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5Hall;C_rad_out_H/NonDeC;Cs_H_out_1H] for rate rule [R5HJ_1;C_rad_out_H/NonDeC;Cs_H_out_H/OneDe]
Euclidian distance = 1.4142135623730951
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction53',
    reactants = ['[CH]C=CCC[CH]CC(5167)'],
    products = ['[CH2]C=CC[CH][CH]CC(5176)'],
...
reaction(
    label = 'reaction54',
    reactants = ['[CH]=CCCC[CH]C[CH2](13996)'],
    products = ['[CH]C=CCC[CH]CC(5167)'],
    transitionState = 'TS54',
    kinetics = Arrhenius(A=(54838.5,'s^-1'), n=1.94766, Ea=(82.2091,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6Hall;C_rad_out_2H;Cs_H_out_H/OneDe] for rate rule [R6HJ_2;C_rad_out_2H;Cs_H_out_H/OneDe]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.846e+10,'s^-1'), n=0.74, Ea=(145.185,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [RnH;Cd_rad_out_singleH;Cs_H_out_H/NonDeC] for rate rule [R7Hall;Cd_rad_out_singleH;Cs_H_out_H/NonDeC]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction56',
    reactants = ['[CH]C=CCC[CH]CC(5167)'],
    products = ['[CH2]C=CCC[CH]C[CH2](5178)'],
