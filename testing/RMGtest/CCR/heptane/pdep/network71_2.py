...
species(
    ...
    E0 = (50.1423,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,1961.76],'cm^-1')),
        HinderedRotor(inertia=(0.181075,'amu*angstrom^2'), symmetry=1, barrier=(4.16327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181073,'amu*angstrom^2'), symmetry=1, barrier=(4.16323,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.181032,'amu*angstrom^2'), symmetry=1, barrier=(4.16228,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (57.1143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.5176,0.0284119,2.01463e-06,-1.19581e-08,4.04544e-12,6087.4,17.669], Tmin=(100,'K'), Tmax=(1230.09,'K')), NASAPolynomial(coeffs=[5.03043,0.0300839,-1.20274e-05,2.15739e-09,-1.45456e-13,4724.49,1.99865], Tmin=(1230.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.1423,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0910532,'amu*angstrom^2'), symmetry=1, barrier=(15.4111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.358241,'amu*angstrom^2'), symmetry=1, barrier=(8.23667,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0112012,'amu*angstrom^2'), symmetry=1, barrier=(80.9009,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (57.1143,'amu'),
...
species(
    ...
    E0 = (303.911,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,180,976.092],'cm^-1')),
        HinderedRotor(inertia=(0.727831,'amu*angstrom^2'), symmetry=1, barrier=(16.7343,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220838,'amu*angstrom^2'), symmetry=1, barrier=(5.07749,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.726244,'amu*angstrom^2'), symmetry=1, barrier=(16.6978,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.1063,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26091,0.0314422,7.49137e-07,-1.84878e-08,8.06302e-12,36620.5,15.7527], Tmin=(100,'K'), Tmax=(1038.41,'K')), NASAPolynomial(coeffs=[8.22226,0.0233777,-9.1232e-06,1.6675e-09,-1.15987e-13,34579.2,-17.0998], Tmin=(1038.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.911,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
