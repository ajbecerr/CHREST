...
species(
    label = '[C]=[C]OO[CH2](29366)',
    structure = SMILES('[C]=[C]OO[CH2]'),
    E0 = (949.219,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3100,440,815,1455,1000,1685,370],'cm^-1')),
        HinderedRotor(inertia=(0.42094,'amu*angstrom^2'), symmetry=1, barrier=(9.67824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0136464,'amu*angstrom^2'), symmetry=1, barrier=(45.1059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.96168,'amu*angstrom^2'), symmetry=1, barrier=(45.1029,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (70.0468,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.22141,0.045265,-8.04048e-05,7.65081e-08,-2.79238e-11,114223,21.1023], Tmin=(100,'K'), Tmax=(836.098,'K')), NASAPolynomial(coeffs=[5.06515,0.018819,-9.92165e-06,1.93876e-09,-1.34419e-13,114196,10.5761], Tmin=(836.098,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(949.219,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CsJOOC) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(20)', '[CH]=[C]O[O](9590)'],
    products = ['[CH]=[C]OO[CH2](28886)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]O[O](46)', '[C]=[CH](9646)'],
    products = ['[CH]=[C]OO[CH2](28886)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(15399.6,'m^3/(mol*s)'), n=0.932885, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]OO[C]=[CH](10388)'],
    products = ['[CH]=[C]OO[CH2](28886)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[C]=[C]OO[CH2](29366)'],
    products = ['[CH]=[C]OO[CH2](28886)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
