...
species(
    label = 'C=[C]CC[CH]C[O](16278)',
    structure = SMILES('C=[C]CC[CH]C[O]'),
    E0 = (439.539,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04058,0.0522383,2.65767e-06,-9.98361e-08,9.59449e-11,52925.4,28.3262], Tmin=(100,'K'), Tmax=(447.475,'K')), NASAPolynomial(coeffs=[4.30257,0.0456958,-2.12602e-05,4.10581e-09,-2.89497e-13,52586,17.7023], Tmin=(447.475,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(439.539,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCJCO) + radical(Cds_S)"""),
)
...
species(
    label = 'C=[C]CC[C]CO[O](16279)',
    structure = SMILES('C=[C]CC[C]CO[O]'),
    E0 = (685.657,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3100,1380,975,1025,1650,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.595295,0.0838726,-9.12089e-05,4.08525e-08,3.40636e-12,82579.5,31.4659], Tmin=(100,'K'), Tmax=(582.421,'K')), NASAPolynomial(coeffs=[9.22899,0.0401226,-1.85688e-05,3.53248e-09,-2.45343e-13,81310.2,-7.78312], Tmin=(582.421,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(685.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJ2_triplet) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]CCC1COO1(16280)',
    structure = SMILES('C=[C]CCC1COO1'),
    E0 = (242.149,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10123,0.0669866,-4.66633e-05,1.7323e-08,-2.78763e-12,29225,25.0578], Tmin=(100,'K'), Tmax=(1358.94,'K')), NASAPolynomial(coeffs=[9.78369,0.0414302,-1.84545e-05,3.48448e-09,-2.4182e-13,26865.1,-19.4931], Tmin=(1358.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(242.149,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(12dioxetane) + radical(Cds_S)"""),
)
...
species(
    label = 'C=[C]CCC1CO1(16281)',
    structure = SMILES('C=[C]CCC1CO1'),
    E0 = (190.853,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.262162,0.0666042,-5.20748e-05,2.28816e-08,-3.97958e-12,23102.2,27.8643], Tmin=(100,'K'), Tmax=(1587.31,'K')), NASAPolynomial(coeffs=[13.3884,0.0260688,-6.72175e-06,8.73555e-10,-4.71605e-14,19874.6,-38.5675], Tmin=(1587.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(190.853,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_S)"""),
)
...
species(
    label = 'C=C=CCCCO[O](16283)',
    structure = SMILES('C=C=CCCCO[O]'),
    E0 = (163.959,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.617541,0.0789335,-7.74685e-05,4.47808e-08,-1.11078e-11,19837.7,29.563], Tmin=(100,'K'), Tmax=(948.284,'K')), NASAPolynomial(coeffs=[9.39617,0.0419049,-1.88982e-05,3.6056e-09,-2.52876e-13,18172.7,-12.3229], Tmin=(948.284,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(163.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(ROOJ)"""),
)

species(
    label = 'C=[C]CCC=COO(16284)',
    structure = SMILES('C=[C]CCC=COO'),
    E0 = (217.244,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.258711,0.0782804,-6.75581e-05,3.0509e-08,-5.60186e-12,26266.3,32.8464], Tmin=(100,'K'), Tmax=(1291.59,'K')), NASAPolynomial(coeffs=[15.3805,0.0314488,-1.31697e-05,2.43574e-09,-1.68e-13,22360.1,-43.9766], Tmin=(1291.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(217.244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
species(
    label = 'C=[C]CC=CCOO(16285)',
    structure = SMILES('C=[C]CC=CCOO'),
    E0 = (208.935,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.817615,0.0738978,-6.25053e-05,2.95753e-08,-6.03866e-12,25240.4,31.0499], Tmin=(100,'K'), Tmax=(1122.16,'K')), NASAPolynomial(coeffs=[9.98875,0.0412058,-1.88043e-05,3.61209e-09,-2.54275e-13,23182.1,-14.2522], Tmin=(1122.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.935,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
species(
    label = 'C=C=CC[CH]CO[O](16287)',
    structure = SMILES('C=C=CC[CH]CO[O]'),
    E0 = (364.374,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,540,610,2055,180,180,3512.27],'cm^-1')),
        HinderedRotor(inertia=(0.534903,'amu*angstrom^2'), symmetry=1, barrier=(12.2985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.535058,'amu*angstrom^2'), symmetry=1, barrier=(12.302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.82894,'amu*angstrom^2'), symmetry=1, barrier=(42.0509,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.535015,'amu*angstrom^2'), symmetry=1, barrier=(12.301,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.490521,0.082801,-0.000100077,7.31531e-08,-2.2552e-11,43945.3,32.3207], Tmin=(100,'K'), Tmax=(780.042,'K')), NASAPolynomial(coeffs=[8.74916,0.0404528,-1.86452e-05,3.55973e-09,-2.48424e-13,42656.8,-5.47129], Tmin=(780.042,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(364.374,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(ROOJ) + radical(CCJCOOH)"""),
)
...
species(
    label = 'C#CCC[CH]CO[O](16289)',
    structure = SMILES('C#CCC[CH]CO[O]'),
    E0 = (366.118,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,2175,525,750,770,3400,2100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.207508,0.0886179,-0.00011863,9.3257e-08,-2.97169e-11,44165.4,32.5532], Tmin=(100,'K'), Tmax=(844.758,'K')), NASAPolynomial(coeffs=[9.56521,0.0375896,-1.60909e-05,2.92042e-09,-1.96163e-13,42824.2,-9.59466], Tmin=(844.758,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(366.118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsOsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(ROOJ) + radical(CCJCOOH)"""),
)
...
species(
    label = 'C=[C]CCC[CH]O[O](16294)',
    structure = SMILES('C=[C]CCC[CH]O[O]'),
    E0 = (426.024,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.213808,0.0900229,-0.000119218,9.80264e-08,-3.35335e-11,51368.8,33.0061], Tmin=(100,'K'), Tmax=(790.767,'K')), NASAPolynomial(coeffs=[7.7196,0.0451007,-2.08124e-05,3.94182e-09,-2.72362e-13,50399.1,-0.0681105], Tmin=(790.767,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(426.024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCsJOOH) + radical(Cds_S)"""),
)
...
species(
    label = 'C=[C]CC[CH][CH]OO(16295)',
    structure = SMILES('C=[C]CC[CH][CH]OO'),
    E0 = (474.434,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,2950,3100,1380,975,1025,1650,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00601076,0.0954084,-0.000129599,1.0691e-07,-3.66717e-11,57198.6,35.342], Tmin=(100,'K'), Tmax=(769.362,'K')), NASAPolynomial(coeffs=[8.54527,0.0454959,-2.16533e-05,4.16e-09,-2.89907e-13,56044.2,-2.62203], Tmin=(769.362,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(474.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJCOOH) + radical(CCsJOOH) + radical(Cds_S)"""),
)

species(
    label = 'C=[C][CH]CCCO[O](16296)',
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.504519,0.0818509,-8.61555e-05,5.41006e-08,-1.4498e-11,45427.6,31.6706], Tmin=(100,'K'), Tmax=(885.645,'K')), NASAPolynomial(coeffs=[9.26742,0.0422736,-1.91244e-05,3.64336e-09,-2.54968e-13,43875.4,-9.54117], Tmin=(885.645,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(376.696,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]=[C]CCCCO[O](16297)',
    structure = SMILES('[CH]=[C]CCCCO[O]'),
    E0 = (484.538,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,1685,370,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.168805,0.090386,-0.000117376,9.29361e-08,-3.07163e-11,58408.6,33.4238], Tmin=(100,'K'), Tmax=(773.053,'K')), NASAPolynomial(coeffs=[8.74796,0.0430214,-1.9702e-05,3.72787e-09,-2.57839e-13,57171,-5.18265], Tmin=(773.053,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(484.538,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = 'C=[C]C[CH][CH]COO(16298)',
    structure = SMILES('C=[C]C[CH][CH]COO'),
    E0 = (480.31,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,2950,3100,1380,975,1025,1650,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.201275,0.0937088,-0.00013894,1.26265e-07,-4.59296e-11,57894.9,37.0081], Tmin=(100,'K'), Tmax=(823.575,'K')), NASAPolynomial(coeffs=[5.23502,0.049891,-2.38558e-05,4.54923e-09,-3.13772e-13,57722.7,17.6883], Tmin=(823.575,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(480.31,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(CCJCOOH) + radical(Cds_S)"""),
)

species(
    label = 'C=[C][CH]C[CH]COO(16299)',
    structure = SMILES('[CH2][C]=CC[CH]COO'),
    E0 = (425.106,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.321482,0.0867603,-9.46358e-05,6.00864e-08,-1.61508e-11,51255.8,33.8771], Tmin=(100,'K'), Tmax=(885.176,'K')), NASAPolynomial(coeffs=[10.0698,0.0427094,-1.99891e-05,3.86723e-09,-2.72987e-13,49530,-11.964], Tmin=(885.176,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(425.106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCJCOOH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH]=[C]CC[CH]COO(16300)',
    structure = SMILES('[CH]=[C]CC[CH]COO'),
    E0 = (532.948,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.318947,0.0903172,-0.000102003,5.45278e-08,-4.42042e-12,64222.6,34.4931], Tmin=(100,'K'), Tmax=(593.354,'K')), NASAPolynomial(coeffs=[9.33093,0.043888,-2.08407e-05,4.02114e-09,-2.81916e-13,62901,-6.40535], Tmin=(593.354,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(532.948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJCOOH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['C=[C]CC[CH]CO[O](15491)'],
    products = ['O2(S)(666)', 'C=[C]CCC=C(15487)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction5',
    reactants = ['O(4)', 'C=[C]CC[CH]C[O](16278)'],
    products = ['C=[C]CC[CH]CO[O](15491)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]CO[O](790)', '[CH2]C[C]=C(2373)'],
    products = ['C=[C]CC[CH]CO[O](15491)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H2CC(T)(1341)', '[CH2]C[CH]CO[O](762)'],
    products = ['C=[C]CC[CH]CO[O](15491)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]O[O](46)', '[CH]CC[C]=C(15604)'],
    products = ['C=[C]CC[CH]CO[O](15491)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'C=[C]CC[C]CO[O](16279)'],
    products = ['C=[C]CC[CH]CO[O](15491)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['C=[C]CC[CH]CO[O](15491)'],
    products = ['O(4)', 'C=[C]CCC1CO1(16281)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'C=[C]CC=CCO[O](16286)'],
    products = ['C=[C]CC[CH]CO[O](15491)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'C=C=CC[CH]CO[O](16287)'],
    products = ['C=[C]CC[CH]CO[O](15491)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', 'C=[C]CCC=CO[O](16288)'],
    products = ['C=[C]CC[CH]CO[O](15491)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', 'C#CCC[CH]CO[O](16289)'],
    products = ['C=[C]CC[CH]CO[O](15491)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O2(2)', 'C=[C]CCC=C(15487)'],
    products = ['C=[C]CC[CH]CO[O](15491)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O2(2)', '[CH2][CH]CC[C]=C(15485)'],
    products = ['C=[C]CC[CH]CO[O](15491)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', 'C=[C]C[CH][CH]CO[O](16290)'],
    products = ['C=[C]CC[CH]CO[O](15491)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', 'C=[C][CH]C[CH]CO[O](16291)'],
    products = ['C=[C]CC[CH]CO[O](15491)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', 'C=[C]CC[CH][CH]O[O](16292)'],
    products = ['C=[C]CC[CH]CO[O](15491)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', '[CH]=[C]CC[CH]CO[O](16293)'],
    products = ['C=[C]CC[CH]CO[O](15491)'],
...
reaction(
    label = 'reaction32',
    reactants = ['C=[C]CC[CH]CO[O](15491)'],
    products = ['[CH2]C=CC[CH]CO[O](1145)'],
...
reaction(
    label = 'reaction35',
    reactants = ['C=[C]CC[CH][CH]OO(16295)'],
    products = ['C=[C]CC[CH]CO[O](15491)'],
...
reaction(
    label = 'reaction40',
    reactants = ['C=[C]C[CH][CH]COO(16298)'],
    products = ['C=[C]CC[CH]CO[O](15491)'],
...
reaction(
    label = 'reaction41',
    reactants = ['C=[C]CC[CH]CO[O](15491)'],
    products = ['C=[C][CH]C[CH]COO(16299)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH]=[C]CC[CH]COO(16300)'],
    products = ['C=[C]CC[CH]CO[O](15491)'],
...
network(
    label = 'PDepNetwork #3548',
    isomers = [
        'C=[C]CC[CH]CO[O](15491)',
    ],
    reactants = [
