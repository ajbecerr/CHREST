...
species(
    label = '[CH]=C([CH]C(C)C)CO[O](20138)',
    structure = SMILES('[CH]C(=CC(C)C)CO[O]'),
    E0 = (317.704,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00397969,0.0905378,-7.05986e-05,3.13305e-08,-6.06408e-12,38352.9,34.7056], Tmin=(100,'K'), Tmax=(1171.94,'K')), NASAPolynomial(coeffs=[10.876,0.0534029,-2.30687e-05,4.29279e-09,-2.96375e-13,35802.8,-19.5102], Tmin=(1171.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(317.704,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(ROOJ) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]=C(C[O])C(C)[CH]C(20139)',
    structure = SMILES('[CH]=C(C[O])C(C)[CH]C'),
    E0 = (407.282,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3025,407.5,1350,352.5,3120,650,792.5,1650,252.28,898.025,1809.12],'cm^-1')),
        HinderedRotor(inertia=(0.0925279,'amu*angstrom^2'), symmetry=1, barrier=(3.38497,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0925279,'amu*angstrom^2'), symmetry=1, barrier=(3.38497,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0925279,'amu*angstrom^2'), symmetry=1, barrier=(3.38497,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0925279,'amu*angstrom^2'), symmetry=1, barrier=(3.38497,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0925279,'amu*angstrom^2'), symmetry=1, barrier=(3.38497,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30336,0.0687475,-2.81157e-05,-4.18873e-08,4.78465e-11,49072.6,32.4687], Tmin=(100,'K'), Tmax=(502.249,'K')), NASAPolynomial(coeffs=[4.56366,0.05538,-2.58183e-05,5.00555e-09,-3.54398e-13,48586.2,17.403], Tmin=(502.249,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.282,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cs_S) + radical(Cds_P)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.363385,0.0832996,-9.20394e-05,5.72283e-08,-1.46635e-11,82218.8,32.5818], Tmin=(100,'K'), Tmax=(938.874,'K')), NASAPolynomial(coeffs=[11.5989,0.0354312,-1.5561e-05,2.92251e-09,-2.02945e-13,80109.1,-20.9141], Tmin=(938.874,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(682.54,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(CO[O])C(C)[C]C(20140)',
    structure = SMILES('[CH]=C(CO[O])C(C)[C]C'),
    E0 = (658.76,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.255743,0.0977352,-0.000104577,6.35083e-08,-1.60207e-11,79380.3,35.9529], Tmin=(100,'K'), Tmax=(949.131,'K')), NASAPolynomial(coeffs=[12.539,0.043813,-1.93584e-05,3.65096e-09,-2.54266e-13,76951.5,-25.1064], Tmin=(949.131,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(658.76,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[C]=C(CO[O])C(C)[CH]C(20141)',
    structure = SMILES('[C]=C(CO[O])C(C)[CH]C'),
    E0 = (716.093,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3025,407.5,1350,352.5,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.576877,0.0872465,-6.83832e-05,-1.40131e-08,4.4982e-11,86237.5,35.7271], Tmin=(100,'K'), Tmax=(519.31,'K')), NASAPolynomial(coeffs=[7.85208,0.0515633,-2.41064e-05,4.62108e-09,-3.2275e-13,85207.4,2.75299], Tmin=(519.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(716.093,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cs_S) + radical(CdCdJ2_triplet)"""),
)
...
species(
    label = '[CH]=C1COOC(C)C1C(20143)',
    structure = SMILES('[CH]=C1COOC(C)C1C'),
    E0 = (106.63,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.153756,0.0619365,2.57343e-05,-7.31721e-08,2.99827e-11,12982.8,27.7169], Tmin=(100,'K'), Tmax=(1039.26,'K')), NASAPolynomial(coeffs=[19.9553,0.0387191,-1.72471e-05,3.46798e-09,-2.57183e-13,6005,-82.3459], Tmin=(1039.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.63,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclohexanone) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C1COC(C)C1C(20145)',
    structure = SMILES('[CH]=C1COC(C)C1C'),
    E0 = (77.3773,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06709,0.0436694,5.16813e-05,-9.60731e-08,3.92579e-11,9430.65,27.1639], Tmin=(100,'K'), Tmax=(969.639,'K')), NASAPolynomial(coeffs=[16.0304,0.0333076,-1.17505e-05,2.17167e-09,-1.58203e-13,4114.14,-57.0158], Tmin=(969.639,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(77.3773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.517939,0.10226,-0.00010374,5.80201e-08,-1.34021e-11,17982.2,32.1503], Tmin=(100,'K'), Tmax=(1033.16,'K')), NASAPolynomial(coeffs=[14.4576,0.044281,-1.95632e-05,3.70382e-09,-2.58965e-13,14887.8,-40.5867], Tmin=(1033.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.18,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(COO)C(C)C=C(20148)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.306107,0.100844,-0.000106672,6.56419e-08,-1.7098e-11,21990.1,33.5645], Tmin=(100,'K'), Tmax=(912.036,'K')), NASAPolynomial(coeffs=[11.3119,0.049892,-2.28748e-05,4.3905e-09,-3.08737e-13,19870.8,-21.416], Tmin=(912.036,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(181.59,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(COO)[C](C)[CH]C(20155)',
    structure = SMILES('[CH]C(COO)=C(C)[CH]C'),
    E0 = (299.509,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0765934,0.0944491,-7.6191e-05,3.49113e-08,-7.01826e-12,36165.3,32.557], Tmin=(100,'K'), Tmax=(1126,'K')), NASAPolynomial(coeffs=[10.6651,0.0562909,-2.53592e-05,4.81603e-09,-3.36455e-13,33746.2,-20.5404], Tmin=(1126,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(Allyl_S) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]=C(COO)C(C)[CH][CH2](20156)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0634532,0.0956184,-9.4183e-05,5.39741e-08,-1.32836e-11,55265.3,38.9479], Tmin=(100,'K'), Tmax=(953.417,'K')), NASAPolynomial(coeffs=[10.6479,0.0506798,-2.34818e-05,4.53711e-09,-3.205e-13,53222.8,-12.2171], Tmin=(953.417,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(458.329,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(Cs_S) + radical(RCCJ) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]=C([CH]C(C)C)CO[O](20138)'],
    products = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(4)', '[CH]=C(C[O])C(C)[CH]C(20139)'],
    products = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHCH3(T)(21)', '[CH]=C([CH]C)CO[O](19539)'],
    products = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', '[CH]C(C)C(=[CH])CO[O](19565)'],
    products = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]=C(CO[O])C(C)[C]C(20140)'],
    products = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[C]=C(CO[O])C(C)[CH]C(20141)'],
    products = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
    products = ['[CH]=C1COOC(C)C1C(20143)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
    products = ['O(4)', '[CH]=C1COC(C)C1C(20145)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
    products = ['[CH]=C(COO)C(C)=CC(20147)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
    products = ['[CH]=C(COO)C(C)C=C(20148)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH]=C(CO[O])C(C)=CC(20149)'],
    products = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH]=C(CO[O])C(C)C=C(19362)'],
    products = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH3(17)', '[CH]=C(C=CC)CO[O](19611)'],
    products = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]O[O](46)', 'C#CC(C)[CH]C(10170)'],
    products = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH3(17)', '[CH]=C([CH][CH]C)CO[O](19612)'],
    products = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH]=C(CO[O])[C](C)[CH]C(20150)'],
    products = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]O[O](46)', '[CH]=[C]C(C)[CH]C(10164)'],
    products = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', '[CH]=C(CO[O])C(C)[CH][CH2](19367)'],
    products = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
    products = ['[CH]=C([CH]OO)C(C)[CH]C(20152)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
    products = ['[CH]=C(COO)[C](C)[CH]C(20155)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH]=C(COO)C(C)[CH][CH2](20156)'],
    products = ['[CH]=C(CO[O])C(C)[CH]C(19300)'],
