...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.288811,0.0818763,-4.45265e-05,3.29409e-09,3.53854e-12,56708.7,35.0216], Tmin=(100,'K'), Tmax=(1101.62,'K')), NASAPolynomial(coeffs=[16.7061,0.0405984,-1.61403e-05,2.95076e-09,-2.04062e-13,51724.6,-54.2406], Tmin=(1101.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(470.132,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0528572,0.0771187,-3.44312e-05,-2.04723e-09,4.16191e-12,-923.73,32.8557], Tmin=(100,'K'), Tmax=(1148.82,'K')), NASAPolynomial(coeffs=[14.7461,0.0451305,-1.81768e-05,3.32507e-09,-2.289e-13,-5613.41,-46.2059], Tmin=(1148.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-8.97633,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.332084,0.0663223,-1.36174e-06,-3.84273e-08,1.77424e-11,41371.2,34.8706], Tmin=(100,'K'), Tmax=(1012.24,'K')), NASAPolynomial(coeffs=[13.8361,0.0449239,-1.70197e-05,3.08167e-09,-2.14259e-13,36999.8,-38.5319], Tmin=(1012.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(342.778,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(cyclopropane) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.103938,0.0835474,-5.71852e-05,2.15275e-08,-3.4732e-12,37827.9,34.5728], Tmin=(100,'K'), Tmax=(1391.05,'K')), NASAPolynomial(coeffs=[12.2181,0.0487128,-1.96221e-05,3.52518e-09,-2.37816e-13,34457.6,-27.8694], Tmin=(1391.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(313.342,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0778476,0.0768074,-2.98833e-05,-8.91834e-09,7.00181e-12,398.132,33.3531], Tmin=(100,'K'), Tmax=(1096.95,'K')), NASAPolynomial(coeffs=[15.2289,0.0444879,-1.78178e-05,3.27506e-09,-2.27202e-13,-4373.66,-48.3529], Tmin=(1096.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.99948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]C(CC)CC[C]=C(5134)',
    structure = SMILES('[CH2]C(CC)CC[C]=C'),
    E0 = (328.934,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.121073,0.0853527,-5.93168e-05,2.2361e-08,-3.54813e-12,39714.1,35.8234], Tmin=(100,'K'), Tmax=(1437.47,'K')), NASAPolynomial(coeffs=[14.1192,0.045727,-1.79675e-05,3.1841e-09,-2.12955e-13,35620.1,-38.045], Tmin=(1437.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(328.934,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.446239,0.0874639,-6.16365e-05,2.31592e-08,-3.58704e-12,40843.2,36.9315], Tmin=(100,'K'), Tmax=(1500.81,'K')), NASAPolynomial(coeffs=[16.8558,0.0413502,-1.55478e-05,2.68644e-09,-1.76756e-13,35649.8,-53.5656], Tmin=(1500.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(338.189,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.4133,0.0854971,-5.78864e-05,2.06842e-08,-3.04001e-12,35809.7,38.2035], Tmin=(100,'K'), Tmax=(1575.56,'K')), NASAPolynomial(coeffs=[17.2762,0.0405864,-1.51286e-05,2.59175e-09,-1.69158e-13,30235.7,-55.1797], Tmin=(1575.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(296.339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]C(C)C[CH]C=C(3936)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(20)', '[CH]=CCC([CH2])CC(5103)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C(CC)CC=C[CH2](5104)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]C=CCC([CH2])CC(5105)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]CC[C]([CH2])CC(5108)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C[CH]C[C]([CH2])CC(5109)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(CC)C[CH]C=C(4034)'],
    products = ['[CH2]C(CC)CC1[CH]C1(5112)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2]C=CCC(=C)CC(5115)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH2]C(CC)CC=C=C(4932)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C2H5(14)', 'C=C[CH]CC=C(4889)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH3(17)', '[CH2]C([CH2])C[CH]C=C(4133)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]C=C(3739)', '[CH2]C([CH2])CC(117)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', '[CH2]C=CCC([CH2])C[CH2](5118)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', '[CH2]C=[C]CC([CH2])CC(5119)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(3)', '[CH2][C]=CCC([CH2])CC(5120)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2]C(CC)C[C]=CC(5124)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2]C=CCC(C)C[CH2](5125)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
...
reaction(
    label = 'reaction46',
    reactants = ['C=C(CC)C[CH][CH]C(4032)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]CC([CH2])CC=CC(5128)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
...
reaction(
    label = 'reaction50',
    reactants = ['C2H3(60)', '[CH]CC([CH2])CC(223)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
...
reaction(
    label = 'reaction55',
    reactants = ['H(3)', '[CH2]C(C=CC=C)CC(5133)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
...
reaction(
    label = 'reaction57',
    reactants = ['[CH2]C([CH]CC=C)CC(5075)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
...
reaction(
    label = 'reaction58',
    reactants = ['[CH2]C(CC)CC[C]=C(5134)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
...
reaction(
    label = 'reaction62',
    reactants = ['[CH2]CC([CH2])CCC=C(5138)'],
    products = ['[CH2]C(CC)C[CH]C=C(4034)'],
