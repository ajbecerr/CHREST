...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05481,0.0618982,-5.13653e-05,2.39326e-08,-4.64066e-12,104695,29.6441], Tmin=(100,'K'), Tmax=(1217.06,'K')), NASAPolynomial(coeffs=[10.9444,0.0293947,-1.13053e-05,1.98888e-09,-1.33119e-13,102287,-20.0104], Tmin=(1217.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(869.579,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJ) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([CH][CH2])C[CH2](9035)',
    structure = SMILES('[CH]C([CH][CH2])C[CH2]'),
    E0 = (859.038,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,223.127,1290.93,1427.47,1660.76,1735.46],'cm^-1')),
        HinderedRotor(inertia=(0.0911125,'amu*angstrom^2'), symmetry=1, barrier=(3.06831,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0911125,'amu*angstrom^2'), symmetry=1, barrier=(3.06831,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0911125,'amu*angstrom^2'), symmetry=1, barrier=(3.06831,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0911125,'amu*angstrom^2'), symmetry=1, barrier=(3.06831,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0911125,'amu*angstrom^2'), symmetry=1, barrier=(3.06831,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53282,0.0554645,-3.81e-05,1.39124e-08,-2.1806e-12,103406,29.7957], Tmin=(100,'K'), Tmax=(1406.56,'K')), NASAPolynomial(coeffs=[9.34592,0.0332456,-1.44052e-05,2.6819e-09,-1.84507e-13,101208,-10.5635], Tmin=(1406.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(859.038,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(RCCJ) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14191,0.0545827,-2.58653e-05,-1.57467e-11,2.56687e-12,40072.7,26.8916], Tmin=(100,'K'), Tmax=(1139.96,'K')), NASAPolynomial(coeffs=[11.5603,0.0311972,-1.24257e-05,2.26048e-09,-1.55207e-13,36841.5,-28.4899], Tmin=(1139.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJ) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH][C]([CH2])C[CH2](9039)',
    structure = SMILES('[CH2][CH][C]([CH2])C[CH2]'),
    E0 = (801.328,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3025,407.5,1350,352.5,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,180,2090.14],'cm^-1')),
        HinderedRotor(inertia=(0.000991041,'amu*angstrom^2'), symmetry=1, barrier=(3.07239,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000991222,'amu*angstrom^2'), symmetry=1, barrier=(3.07276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133693,'amu*angstrom^2'), symmetry=1, barrier=(3.07387,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0196108,'amu*angstrom^2'), symmetry=1, barrier=(60.7959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133632,'amu*angstrom^2'), symmetry=1, barrier=(3.07246,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44295,0.0643808,-8.81083e-05,8.26591e-08,-3.09639e-11,96461.7,32.0364], Tmin=(100,'K'), Tmax=(849.711,'K')), NASAPolynomial(coeffs=[1.86216,0.0440577,-1.98392e-05,3.68187e-09,-2.49899e-13,97052.9,33.9802], Tmin=(849.711,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(801.328,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Cs_S) + radical(RCCJ) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH][C](C)C[CH2](3857)',
    structure = SMILES('[CH2][CH][C](C)C[CH2]'),
    E0 = (596.246,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1937.85,1937.85],'cm^-1')),
        HinderedRotor(inertia=(0.00198727,'amu*angstrom^2'), symmetry=1, barrier=(5.2957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0728918,'amu*angstrom^2'), symmetry=1, barrier=(5.2957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0728917,'amu*angstrom^2'), symmetry=1, barrier=(5.2957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00198727,'amu*angstrom^2'), symmetry=1, barrier=(5.2957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.31881,'amu*angstrom^2'), symmetry=1, barrier=(23.162,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.06596,0.0450915,-2.00355e-05,3.47717e-09,-1.9806e-13,71719.5,24.2835], Tmin=(100,'K'), Tmax=(2819.6,'K')), NASAPolynomial(coeffs=[39.5427,0.00208832,-1.81002e-06,2.67806e-10,-1.10206e-14,47673.7,-195.671], Tmin=(2819.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(596.246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Cs_S) + radical(RCCJ) + radical(RCCJ)"""),
)
...
reaction(
    ...
    products = ['C2H4(22)', '[CH2][CH]C=C(3743)'],
    transitionState = 'TS1',
...
reaction(
    ...
    products = ['[CH2][CH]C([CH2])C[CH2](3859)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', '[CH2][CH][CH]C[CH2](509)'],
    products = ['[CH2][CH]C([CH2])C[CH2](3859)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(20)', '[CH2][CH]C([CH2])[CH2](499)'],
    products = ['[CH2][CH]C([CH2])C[CH2](3859)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH2][C]C([CH2])C[CH2](9034)'],
    products = ['[CH2][CH]C([CH2])C[CH2](3859)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]C([CH][CH2])C[CH2](9035)'],
    products = ['[CH2][CH]C([CH2])C[CH2](3859)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH]CC([CH2])[CH][CH2](9036)'],
    products = ['[CH2][CH]C([CH2])C[CH2](3859)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH][CH]C([CH2])C[CH2](9037)'],
    products = ['[CH2][CH]C([CH2])C[CH2](3859)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH][CH2](502)', 'buten3yl1(65)'],
    products = ['[CH2][CH]C([CH2])C[CH2](3859)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C2H4(22)', '[CH2][CH][CH][CH2](5531)'],
    products = ['[CH2][CH]C([CH2])C[CH2](3859)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C2H4(T)(23)', '[CH2][CH][CH][CH2](5531)'],
    products = ['[CH2][CH]C([CH2])C[CH2](3859)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2][CH][C]([CH2])C[CH2](9039)'],
    products = ['[CH2][CH]C([CH2])C[CH2](3859)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2][CH]C([CH2])[CH][CH2](9040)'],
    products = ['[CH2][CH]C([CH2])C[CH2](3859)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2][CH]C([CH2])C[CH2](3859)'],
    products = ['[CH2]C[C]([CH2])C[CH2](4944)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2][CH]C([CH2])C[CH2](3859)'],
    products = ['[CH2][CH][C](C)C[CH2](3857)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2][CH]C([CH2])C[CH2](3859)'],
    products = ['[CH2][CH]C([CH2])[CH]C(3871)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2][CH]C([CH2])C[CH2](3859)'],
    products = ['[CH2][CH]C(C)[CH][CH2](3858)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2][CH]C([CH2])C[CH2](3859)'],
    products = ['[CH2]C[C]([CH2])[CH]C(3870)'],
...
network(
    label = 'PDepNetwork #1995',
    isomers = [
        '[CH2][CH]C([CH2])C[CH2](3859)',
    ],
    reactants = [
        ('C2H4(22)', '[CH2][CH]C=C(3743)'),
    ],
    bathGas = {
        'Ar': 0.333333,
        'Ne': 0.333333,
