...
species(
    label = '[CH2][C]OO[CH2](29177)',
    structure = SMILES('[CH2][C]OO[CH2]'),
    E0 = (683.406,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,199.044],'cm^-1')),
        HinderedRotor(inertia=(0.904703,'amu*angstrom^2'), symmetry=1, barrier=(25.3229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.477555,'amu*angstrom^2'), symmetry=1, barrier=(13.4049,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0212272,'amu*angstrom^2'), symmetry=1, barrier=(37.7485,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34501,'amu*angstrom^2'), symmetry=1, barrier=(37.7426,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76949,0.0522996,-6.45128e-05,4.16224e-08,-1.08534e-11,82272.3,19.277], Tmin=(100,'K'), Tmax=(928.061,'K')), NASAPolynomial(coeffs=[9.72366,0.0180161,-9.10067e-06,1.81687e-09,-1.30473e-13,80796,-18.5034], Tmin=(928.061,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(683.406,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOOC) + radical(CJCOOH) + radical(CH2_triplet)"""),
)

species(
    label = '[CH][CH]OO[CH2](28870)',
    structure = SMILES('[CH][CH]OO[CH2]'),
    E0 = (643.111,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,442.145,442.151,442.154],'cm^-1')),
        HinderedRotor(inertia=(0.000862287,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000862258,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000862278,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.376399,'amu*angstrom^2'), symmetry=1, barrier=(52.2195,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93474,0.0493703,-6.29774e-05,4.71779e-08,-1.48516e-11,77419.1,19.2538], Tmin=(100,'K'), Tmax=(764.607,'K')), NASAPolynomial(coeffs=[6.95332,0.023112,-1.14563e-05,2.24949e-09,-1.59354e-13,76651.8,-3.6102], Tmin=(764.607,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(643.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCsJOOC) + radical(CsJOOC) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]O[O](46)', '[CH][CH2](502)'],
    products = ['[CH2][CH]OO[CH2](28829)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[CH2][CH]O[O](674)'],
    products = ['[CH2][CH]OO[CH2](28829)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(15399.6,'m^3/(mol*s)'), n=0.932885, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2][C]OO[CH2](29177)'],
    products = ['[CH2][CH]OO[CH2](28829)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH][CH]OO[CH2](28870)'],
    products = ['[CH2][CH]OO[CH2](28829)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]OO[CH][CH2](3439)'],
    products = ['[CH2][CH]OO[CH2](28829)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
