...
species(
    label = '[CH2]C(C[C]=C)C(C)[O](16437)',
    structure = SMILES('[CH2]C(C[C]=C)C(C)[O]'),
    E0 = (407.258,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0921074,0.0826046,-6.88124e-05,3.16266e-08,-6.03101e-12,49125.2,34.9796], Tmin=(100,'K'), Tmax=(1235.42,'K')), NASAPolynomial(coeffs=[13.7091,0.038516,-1.52819e-05,2.74019e-09,-1.85558e-13,45760.6,-33.5935], Tmin=(1235.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.258,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(Isobutyl) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]C(C[C]=C)C(C)O[O](16438)',
    structure = SMILES('[CH]C(C[C]=C)C(C)O[O]'),
    E0 = (643.539,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.229265,0.0972843,-0.000102705,6.13074e-08,-1.52305e-11,77548.6,37.084], Tmin=(100,'K'), Tmax=(961.584,'K')), NASAPolynomial(coeffs=[12.5701,0.0440422,-1.96515e-05,3.72719e-09,-2.60512e-13,75087.1,-24.164], Tmin=(961.584,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(643.539,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'C=[C]CC1COOC1C(16440)',
    structure = SMILES('C=[C]CC1COOC1C'),
    E0 = (124.398,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.196474,0.0668748,5.93968e-06,-6.16656e-08,3.13792e-11,15114.2,30.5191], Tmin=(100,'K'), Tmax=(916.12,'K')), NASAPolynomial(coeffs=[18.2418,0.0319782,-8.7912e-06,1.35326e-09,-8.99464e-14,9965.89,-65.011], Tmin=(916.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(124.398,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(12dioxolane) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C1CC(=C)OOC1C(16441)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.307305,0.0585898,3.19425e-05,-7.9325e-08,3.2449e-11,8618.52,28.8855], Tmin=(100,'K'), Tmax=(1022.67,'K')), NASAPolynomial(coeffs=[19.2888,0.0378674,-1.61647e-05,3.21035e-09,-2.37699e-13,1937.46,-76.7982], Tmin=(1022.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(70.3889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclohexanone) + radical(Isobutyl)"""),
)

species(
    label = 'C=[C]CC1COC1C(16442)',
    structure = SMILES('C=[C]CC1COC1C'),
    E0 = (152.499,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.780868,0.0571546,1.0975e-05,-5.70622e-08,2.7894e-11,18470,27.6357], Tmin=(100,'K'), Tmax=(910.71,'K')), NASAPolynomial(coeffs=[14.2963,0.0337778,-9.79256e-06,1.52816e-09,-1.00198e-13,14516,-44.4977], Tmin=(910.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C1CC(=C)OC1C(16443)',
    structure = SMILES('[CH2]C1CC(=C)OC1C'),
    E0 = (-13.9159,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.892486,0.0388682,8.7967e-05,-1.51932e-07,6.41852e-11,-1534.65,26.5297], Tmin=(100,'K'), Tmax=(931.535,'K')), NASAPolynomial(coeffs=[22.7135,0.0205171,-3.81247e-06,5.81946e-10,-4.897e-14,-8869.26,-94.7441], Tmin=(931.535,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-13.9159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.451875,0.0887066,-6.99436e-05,2.84171e-08,-4.66984e-12,9519.19,37.2688], Tmin=(100,'K'), Tmax=(1437.68,'K')), NASAPolynomial(coeffs=[18.7574,0.0352612,-1.41813e-05,2.55951e-09,-1.73433e-13,3995.82,-62.3786], Tmin=(1437.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(77.7523,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = 'C=C=CC(C)C(C)O[O](16445)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.190215,0.0909678,-7.74409e-05,3.57048e-08,-6.83845e-12,14531.9,34.101], Tmin=(100,'K'), Tmax=(1224.37,'K')), NASAPolynomial(coeffs=[14.6572,0.0424611,-1.8014e-05,3.3468e-09,-2.31341e-13,10896.2,-40.5347], Tmin=(1224.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(119.564,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cdd-Cd)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(ROOJ)"""),
)

species(
    label = 'C=[C]CC(=C)C(C)OO(16446)',
    structure = SMILES('C=[C]CC(=C)C(C)OO'),
    E0 = (163.589,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.450231,0.0934924,-7.86141e-05,3.42055e-08,-6.06234e-12,19838.9,36.9701], Tmin=(100,'K'), Tmax=(1329.88,'K')), NASAPolynomial(coeffs=[17.8385,0.0384829,-1.6567e-05,3.10099e-09,-2.15026e-13,14974.6,-56.4764], Tmin=(1329.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(163.589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(C=C=C)C(C)OO(16447)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.54395,0.0974952,-8.95302e-05,4.43758e-08,-8.99756e-12,20929.6,36.3948], Tmin=(100,'K'), Tmax=(1175.47,'K')), NASAPolynomial(coeffs=[16.233,0.0404051,-1.66786e-05,3.05823e-09,-2.10117e-13,16985.4,-47.2567], Tmin=(1175.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.641,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cdd-Cd)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C=C=C)C(C)O[O](16449)',
    structure = SMILES('[CH2]C(C=C=C)C(C)O[O]'),
    E0 = (324.646,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,540,610,2055,220.696,220.698],'cm^-1')),
        HinderedRotor(inertia=(0.316565,'amu*angstrom^2'), symmetry=1, barrier=(10.9413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.316561,'amu*angstrom^2'), symmetry=1, barrier=(10.9413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.316563,'amu*angstrom^2'), symmetry=1, barrier=(10.9413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00346114,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.49846,'amu*angstrom^2'), symmetry=1, barrier=(86.3537,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.22454,0.0932106,-9.17079e-05,5.03995e-08,-1.14052e-11,39197.8,36.0109], Tmin=(100,'K'), Tmax=(1057.8,'K')), NASAPolynomial(coeffs=[13.7964,0.0401911,-1.6524e-05,3.01558e-09,-2.06452e-13,36231.6,-32.42], Tmin=(1057.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(324.646,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cdd-Cd)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(ROOJ) + radical(Isobutyl)"""),
)

species(
    label = 'C#CCC([CH2])C(C)O[O](16450)',
    structure = SMILES('C#CCC([CH2])C(C)O[O]'),
    E0 = (328.668,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2175,525,750,770,3400,2100,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.461492,0.0986306,-0.000108799,6.81406e-08,-1.73321e-11,39689.8,36.0528], Tmin=(100,'K'), Tmax=(954.921,'K')), NASAPolynomial(coeffs=[13.8085,0.0388568,-1.49068e-05,2.59157e-09,-1.71466e-13,36964.5,-32.1335], Tmin=(954.921,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(328.668,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(ROOJ) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.45985,0.080569,-6.00381e-05,2.46319e-08,-4.37945e-12,46578.2,38.4337], Tmin=(100,'K'), Tmax=(1260.22,'K')), NASAPolynomial(coeffs=[10.8176,0.0476929,-2.09068e-05,3.93114e-09,-2.72872e-13,43967.6,-13.9322], Tmin=(1260.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(386.235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(C2CJCOOH) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2]C(C[C]=C)[C](C)OO(16457)',
    structure = SMILES('[CH2]C(C[C]=C)[C](C)OO'),
    E0 = (435.301,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.424114,0.103644,-0.000121642,8.68399e-08,-2.6177e-11,52508.1,38.0961], Tmin=(100,'K'), Tmax=(797.158,'K')), NASAPolynomial(coeffs=[10.0235,0.0512177,-2.29874e-05,4.33144e-09,-3.00035e-13,50842.5,-9.93864], Tmin=(797.158,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(435.301,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C2CsJOOH) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]CC(C)[C](C)O[O](16458)',
    structure = SMILES('C=[C]CC(C)[C](C)O[O]'),
    E0 = (382.223,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.150839,0.0980733,-0.000113021,8.30466e-08,-2.63646e-11,46114.1,36.0913], Tmin=(100,'K'), Tmax=(752.384,'K')), NASAPolynomial(coeffs=[8.19445,0.0537079,-2.45754e-05,4.68015e-09,-3.26281e-13,44858.2,-1.79596], Tmin=(752.384,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(382.223,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(C2CsJOOH) + radical(Cds_S)"""),
)

species(
    label = 'C=[C][CH]C(C)C(C)O[O](16459)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.206723,0.0927424,-8.2144e-05,3.99161e-08,-8.08289e-12,40117.8,35.8633], Tmin=(100,'K'), Tmax=(1161.56,'K')), NASAPolynomial(coeffs=[14.0681,0.0435853,-1.86644e-05,3.48275e-09,-2.41448e-13,36801.5,-35.1421], Tmin=(1161.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.3,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2]C(CC=C)[C](C)O[O](16460)',
    structure = SMILES('[CH2]C(CC=C)[C](C)O[O]'),
    E0 = (349.464,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0992409,0.0951128,-0.000100292,6.50315e-08,-1.80408e-11,42174,37.2158], Tmin=(100,'K'), Tmax=(858.18,'K')), NASAPolynomial(coeffs=[9.53584,0.0502056,-2.1803e-05,4.06137e-09,-2.80194e-13,40520.2,-7.79471], Tmin=(858.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(349.464,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(C2CsJOOH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][C](C[C]=C)C(C)OO(16461)',
    structure = SMILES('[CH2][C](C[C]=C)C(C)OO'),
    E0 = (439.313,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0885222,0.0872583,-7.25217e-05,3.36398e-08,-6.63102e-12,52976.8,40.7942], Tmin=(100,'K'), Tmax=(1174.57,'K')), NASAPolynomial(coeffs=[12.2248,0.0459287,-1.9742e-05,3.68328e-09,-2.55052e-13,50125.8,-19.7094], Tmin=(1174.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(439.313,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C2CJCOOH) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(C[C]=C)C([CH2])OO(16462)',
    structure = SMILES('[CH2]C(C[C]=C)C([CH2])OO'),
    E0 = (462.364,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.593226,0.103516,-0.000108856,6.36987e-08,-1.53183e-11,55773,40.4001], Tmin=(100,'K'), Tmax=(998.63,'K')), NASAPolynomial(coeffs=[14.4018,0.0434526,-1.86364e-05,3.46906e-09,-2.40036e-13,52778.1,-31.9216], Tmin=(998.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(462.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(CJCOOH) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(O[O])C(C)C[C]=C(16463)',
    structure = SMILES('[CH2]C(O[O])C(C)C[C]=C'),
    E0 = (409.287,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.23996,0.0969519,-9.64859e-05,5.45259e-08,-1.29137e-11,49375.4,38.1114], Tmin=(100,'K'), Tmax=(1002.19,'K')), NASAPolynomial(coeffs=[12.5174,0.0460336,-2.0275e-05,3.82939e-09,-2.67222e-13,46818.4,-23.4635], Tmin=(1002.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(409.287,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CJCOOH) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(CC=C)C([CH2])O[O](16464)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.402814,0.0966713,-9.388e-05,5.0861e-08,-1.13433e-11,45444.5,39.9954], Tmin=(100,'K'), Tmax=(1072.72,'K')), NASAPolynomial(coeffs=[14.3368,0.0417092,-1.7025e-05,3.09726e-09,-2.11702e-13,42282.2,-32.1491], Tmin=(1072.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(376.527,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Isobutyl) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C([CH][C]=C)C(C)OO(16465)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.56535,0.0993341,-9.44751e-05,4.89027e-08,-1.03706e-11,46515.6,38.174], Tmin=(100,'K'), Tmax=(1126.2,'K')), NASAPolynomial(coeffs=[15.7662,0.0413279,-1.72155e-05,3.16779e-09,-2.18063e-13,42837.1,-42.5573], Tmin=(1126.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(385.378,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH]=[C]CC(C)C(C)O[O](16466)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.226949,0.0974642,-9.88015e-05,5.75966e-08,-1.4137e-11,53359.3,36.4754], Tmin=(100,'K'), Tmax=(967.148,'K')), NASAPolynomial(coeffs=[11.8986,0.0473148,-2.10225e-05,3.98275e-09,-2.78258e-13,51013.9,-21.6182], Tmin=(967.148,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(442.42,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]CC([CH2])C(C)OO(16467)',
    structure = SMILES('[CH]=[C]CC([CH2])C(C)OO'),
    E0 = (495.498,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.574756,0.103972,-0.000111007,6.65938e-08,-1.64795e-11,59756.6,38.744], Tmin=(100,'K'), Tmax=(970.107,'K')), NASAPolynomial(coeffs=[13.8004,0.0447008,-1.93633e-05,3.61729e-09,-2.50628e-13,56967.4,-30.1718], Tmin=(970.107,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(495.498,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]C(C[C]=C)CO[O](15492)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['O(4)', '[CH2]C(C[C]=C)C(C)[O](16437)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['H2CC(T)(1341)', '[CH2]C([CH2])C(C)O[O](7604)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH]C(C[C]=C)C(C)O[O](16438)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    products = ['[CH2]C1CC(=C)OOC1C(16441)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    products = ['O(4)', 'C=[C]CC1COC1C(16442)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    products = ['O(4)', '[CH2]C1CC(=C)OC1C(16443)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(3.63066e+10,'s^-1'), n=0, Ea=(54.8104,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4OO_SSS;Y_rad_intra;OO] for rate rule [R4OO_SSS;Cd_rad_out;OOJ]
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    products = ['HO2(9)', '[CH2]C(=CC)C[C]=C(16045)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    products = ['HO2(9)', '[CH2]C(C=C)C[C]=C(15536)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    products = ['C=CCC(=C)C(C)O[O](16444)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    products = ['C=C=CC(C)C(C)O[O](16445)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    products = ['C=[C]CC(=C)C(C)OO(16446)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    products = ['[CH2]C(C=C=C)C(C)OO(16447)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', 'C=[C]CC(=C)C(C)O[O](16448)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2]C(C=C=C)C(C)O[O](16449)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C#CCC([CH2])C(C)O[O](16450)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C[CH]O[O](57)', 'C=[C]CC=C(15500)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O2(2)', '[CH2]C([CH]C)C[C]=C(15527)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C[CH]O[O](57)', '[CH2][CH]C[C]=C(2629)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', '[CH2][C](C[C]=C)C(C)O[O](16451)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CH3(17)', '[CH2]C([CH]O[O])C[C]=C(16237)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', '[CH2]C(C[C]=C)[C](C)O[O](16452)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', '[CH2]C([CH][C]=C)C(C)O[O](16453)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', '[CH2]C(C[C]=C)C([CH2])O[O](16454)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(3)', '[CH]=[C]CC([CH2])C(C)O[O](16455)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    products = ['C=[C]C[C](C)C(C)O[O](16456)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    products = ['[CH2]C=CC([CH2])C(C)O[O](8196)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH]=CCC([CH2])C(C)O[O](8342)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    products = ['[CH2]C(C[C]=C)[C](C)OO(16457)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    products = ['C=[C]CC(C)[C](C)O[O](16458)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    products = ['C=[C][CH]C(C)C(C)O[O](16459)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    products = ['[CH2][CH]CC(=C)C(C)O[O](8195)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    products = ['[CH2]C(CC=C)[C](C)O[O](16460)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH2][C](C[C]=C)C(C)OO(16461)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    products = ['[CH2]C(C[C]=C)C([CH2])OO(16462)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2]C(O[O])C(C)C[C]=C(16463)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    products = ['[CH2]C(CC=C)C([CH2])O[O](16464)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
    products = ['[CH2]C([CH][C]=C)C(C)OO(16465)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH]=[C]CC(C)C(C)O[O](16466)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[CH]=[C]CC([CH2])C(C)OO(16467)'],
    products = ['[CH2]C(C[C]=C)C(C)O[O](15552)'],
