...
species(
    label = '[CH2]C(C=C)C([CH2])C[O](5994)',
    structure = SMILES('[CH2]C(C=C)C([CH2])C[O]'),
    E0 = (374.514,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.506431,0.0784439,-6.7043e-05,3.52595e-08,-8.09528e-12,45168,35.9607], Tmin=(100,'K'), Tmax=(1014.35,'K')), NASAPolynomial(coeffs=[8.83746,0.0455915,-1.84619e-05,3.33052e-09,-2.26009e-13,43477.9,-4.35053], Tmin=(1014.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.514,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH]CO[O])C=C(5995)',
    structure = SMILES('[CH2]C([CH]CO[O])C=C'),
    E0 = (397.125,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.408621,0.0821458,-8.84702e-05,5.64331e-08,-1.50586e-11,47889.7,35.5337], Tmin=(100,'K'), Tmax=(899.19,'K')), NASAPolynomial(coeffs=[10.1179,0.0389539,-1.64181e-05,3.01251e-09,-2.06047e-13,46143.6,-10.2764], Tmin=(899.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(397.125,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJCOOH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH]C(CO[O])C([CH2])C=C(5996)',
    structure = SMILES('[CH]C(CO[O])C([CH2])C=C'),
    E0 = (615.451,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.340261,0.0959521,-9.79803e-05,5.58297e-08,-1.30339e-11,74177.6,38.8809], Tmin=(100,'K'), Tmax=(1030.07,'K')), NASAPolynomial(coeffs=[14.1066,0.0398517,-1.62867e-05,2.95739e-09,-2.0176e-13,71201.3,-31.2451], Tmin=(1030.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(615.451,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(C=C)C([CH2])CO[O](5997)',
...
species(
    label = '[CH2]C(C=C)C1COOC1(5999)',
    structure = SMILES('[CH2]C(C=C)C1COOC1'),
    E0 = (96.3097,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.312453,0.062685,2.15175e-05,-8.24782e-08,4.06953e-11,11733.5,32.2068], Tmin=(100,'K'), Tmax=(895.029,'K')), NASAPolynomial(coeffs=[19.0654,0.0290389,-6.16422e-06,7.60637e-10,-4.60706e-14,6367.36,-67.4102], Tmin=(895.029,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(96.3097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(12dioxolane) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C1COOCC1C=C(6000)',
    structure = SMILES('[CH2]C1COOCC1C=C'),
    E0 = (88.0549,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.441386,0.0562272,4.49895e-05,-1.09496e-07,5.08779e-11,10739.4,29.1557], Tmin=(100,'K'), Tmax=(898.977,'K')), NASAPolynomial(coeffs=[20.2634,0.0270649,-4.85623e-06,5.18035e-10,-3.11238e-14,4789.98,-77.6309], Tmin=(898.977,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(88.0549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(12dioxane) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C=C)C1COC1(6001)',
    structure = SMILES('[CH2]C(C=C)C1COC1'),
    E0 = (124.411,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.899575,0.052924,2.67424e-05,-7.82062e-08,3.73986e-11,15089.2,28.621], Tmin=(100,'K'), Tmax=(886.282,'K')), NASAPolynomial(coeffs=[15.1345,0.0308146,-7.15221e-06,9.32445e-10,-5.60693e-14,10911.1,-47.6721], Tmin=(886.282,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(124.411,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C1COCC1C=C(6002)',
    structure = SMILES('[CH2]C1COCC1C=C'),
    E0 = (45.9484,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23547,0.0413008,6.12267e-05,-1.14021e-07,4.99831e-11,5644.18,25.2141], Tmin=(100,'K'), Tmax=(896.419,'K')), NASAPolynomial(coeffs=[15.4538,0.0297569,-6.30342e-06,7.89507e-10,-4.88417e-14,1009.78,-53.4574], Tmin=(896.419,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(45.9484,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Tetrahydrofuran) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.701472,0.0952355,-8.3603e-05,3.86189e-08,-7.18096e-12,8067.73,34.6089], Tmin=(100,'K'), Tmax=(1289.92,'K')), NASAPolynomial(coeffs=[18.7301,0.034979,-1.35331e-05,2.40488e-09,-1.6233e-13,3054.68,-64.084], Tmin=(1289.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.6152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C(C=C)C(=C)COO(6005)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.351721,0.100688,-0.000108658,6.90423e-08,-1.84442e-11,16939.6,35.1021], Tmin=(100,'K'), Tmax=(895.085,'K')), NASAPolynomial(coeffs=[11.3077,0.0485824,-2.1335e-05,4.0012e-09,-2.77355e-13,14852.4,-19.855], Tmin=(895.085,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(139.577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(COO)C(=C)C=C(6006)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.03386,0.101541,-9.50397e-05,4.65957e-08,-9.09941e-12,14464.4,36.824], Tmin=(100,'K'), Tmax=(1241.04,'K')), NASAPolynomial(coeffs=[20.2138,0.0330571,-1.2266e-05,2.13089e-09,-1.42221e-13,9190.58,-70.2719], Tmin=(1241.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.693,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C[C]([CH2])C([CH2])CO[O](6007)',
    structure = SMILES('[CH2]C[C]([CH2])C([CH2])CO[O]'),
    E0 = (640.83,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,200.29,423.049,3222.46],'cm^-1')),
        HinderedRotor(inertia=(0.0384362,'amu*angstrom^2'), symmetry=1, barrier=(3.63747,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0384362,'amu*angstrom^2'), symmetry=1, barrier=(3.63747,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0384362,'amu*angstrom^2'), symmetry=1, barrier=(3.63747,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0384362,'amu*angstrom^2'), symmetry=1, barrier=(3.63747,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0384362,'amu*angstrom^2'), symmetry=1, barrier=(3.63747,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.616851,0.112802,-0.000166806,1.45065e-07,-4.93288e-11,77229.5,43.0585], Tmin=(100,'K'), Tmax=(883.007,'K')), NASAPolynomial(coeffs=[6.95493,0.0533021,-2.29244e-05,4.11517e-09,-2.72161e-13,76874.7,13.034], Tmin=(883.007,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(640.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Tertalkyl) + radical(Isobutyl) + radical(RCCJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CC([CH2])[C]([CH2])CO[O](6008)',
    structure = SMILES('[CH2]CC([CH2])[C]([CH2])CO[O]'),
    E0 = (646.318,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,293.88,1108.76,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0588799,'amu*angstrom^2'), symmetry=1, barrier=(1.72177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0588799,'amu*angstrom^2'), symmetry=1, barrier=(1.72177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0588799,'amu*angstrom^2'), symmetry=1, barrier=(1.72177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0588799,'amu*angstrom^2'), symmetry=1, barrier=(1.72177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0588799,'amu*angstrom^2'), symmetry=1, barrier=(1.72177,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0222455,0.0903103,-9.02782e-05,5.56896e-08,-1.46453e-11,77874.8,44.4836], Tmin=(100,'K'), Tmax=(905.678,'K')), NASAPolynomial(coeffs=[9.71649,0.0474944,-1.93649e-05,3.49e-09,-2.36142e-13,76118.9,-1.32497], Tmin=(905.678,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(646.318,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CJCOOH) + radical(Isobutyl) + radical(RCCJ) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]CC([CH2])C([CH2])[CH]O[O](6009)',
    structure = SMILES('[CH2]CC([CH2])C([CH2])[CH]O[O]'),
    E0 = (643.99,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.690425,0.107974,-0.000136018,1.01695e-07,-3.103e-11,77618.4,42.3397], Tmin=(100,'K'), Tmax=(857.301,'K')), NASAPolynomial(coeffs=[11.339,0.0464678,-1.89918e-05,3.37307e-09,-2.2402e-13,75753.4,-12.6906], Tmin=(857.301,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(643.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCsJOOH) + radical(Isobutyl) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C1[CH]COOCC1[CH2](6012)',
    structure = SMILES('[CH2]C1[CH]COOCC1[CH2]'),
    E0 = (378.632,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.121576,0.0358306,0.000159805,-2.72236e-07,1.19721e-10,45725,36.5035], Tmin=(100,'K'), Tmax=(900.588,'K')), NASAPolynomial(coeffs=[39.381,-0.00765143,1.42193e-05,-3.08226e-09,2.05711e-13,33345.7,-178.259], Tmin=(900.588,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(378.632,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(CCJCOOH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CO[O])C1CC1[CH2](6013)',
    structure = SMILES('[CH2]C(CO[O])C1CC1[CH2]'),
    E0 = (393.674,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.186706,0.0819484,-4.85437e-05,2.60551e-09,6.09724e-12,47507.9,37.1721], Tmin=(100,'K'), Tmax=(962.837,'K')), NASAPolynomial(coeffs=[16.3406,0.0360216,-1.24117e-05,2.11048e-09,-1.41538e-13,43271.5,-47.4088], Tmin=(962.837,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(393.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(ROOJ) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C1COOC([CH2])C1[CH2](6015)',
    structure = SMILES('[CH2]C1COOC([CH2])C1[CH2]'),
    E0 = (365.605,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.100163,0.0662534,2.05402e-05,-8.98663e-08,4.61656e-11,44131.2,32.6147], Tmin=(100,'K'), Tmax=(877.477,'K')), NASAPolynomial(coeffs=[21.4477,0.0244546,-2.90612e-06,4.72412e-11,6.68013e-15,38247.5,-79.7629], Tmin=(877.477,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(365.605,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxane) + radical(Isobutyl) + radical(Isobutyl) + radical(CJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.63983,0.0964601,-9.47951e-05,4.99253e-08,-1.0524e-11,32729.2,36.1664], Tmin=(100,'K'), Tmax=(1151.11,'K')), NASAPolynomial(coeffs=[17.5899,0.0331126,-1.22467e-05,2.11668e-09,-1.40696e-13,28532.4,-54.3468], Tmin=(1151.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2][C](C=C)C([CH2])CO[O](6019)',
    structure = SMILES('[CH2]C=C([CH2])C([CH2])CO[O]'),
    E0 = (452.592,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.48683,0.0963255,-9.44656e-05,5.05223e-08,-1.09708e-11,54597.9,37.3137], Tmin=(100,'K'), Tmax=(1108.89,'K')), NASAPolynomial(coeffs=[15.8282,0.0374737,-1.48563e-05,2.66082e-09,-1.8034e-13,50979.6,-43.083], Tmin=(1108.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(452.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Isobutyl) + radical(Allyl_P) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH2]C([C]=C)C([CH2])CO[O](6021)',
    structure = SMILES('[CH2]C([C]=C)C([CH2])CO[O]'),
    E0 = (610.16,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.178054,0.0972124,-0.000106051,6.00829e-08,-1.05224e-11,73531,39.5791], Tmin=(100,'K'), Tmax=(695.352,'K')), NASAPolynomial(coeffs=[11.7739,0.0421771,-1.69221e-05,3.00231e-09,-2.00542e-13,71537.2,-16.1241], Tmin=(695.352,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(610.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Isobutyl) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CC([CH2])C([CH2])CO[O](6022)',
    structure = SMILES('[CH]=CC([CH2])C([CH2])CO[O]'),
    E0 = (619.414,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3120,650,792.5,1650,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.467576,0.0995743,-0.000112795,7.27784e-08,-1.90752e-11,74658,40.5177], Tmin=(100,'K'), Tmax=(927.516,'K')), NASAPolynomial(coeffs=[13.5173,0.0392615,-1.52529e-05,2.66625e-09,-1.76779e-13,72063.9,-25.8983], Tmin=(927.516,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(619.414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Isobutyl) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.201736,0.0808301,-6.02744e-05,2.48344e-08,-4.33017e-12,43213.8,40.7682], Tmin=(100,'K'), Tmax=(1317.72,'K')), NASAPolynomial(coeffs=[12.6189,0.0431369,-1.73666e-05,3.12609e-09,-2.11585e-13,39941.4,-22.5631], Tmin=(1317.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(358.147,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(C2CJCOOH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH]OO)C([CH2])C=C(6024)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.574175,0.10141,-0.000104702,6.11879e-08,-1.46882e-11,49342.9,39.8896], Tmin=(100,'K'), Tmax=(1002.75,'K')), NASAPolynomial(coeffs=[14.0599,0.0430316,-1.7372e-05,3.12504e-09,-2.11768e-13,46408.1,-30.7512], Tmin=(1002.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(408.896,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOOH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][C](C=C)C(C)CO[O](6025)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.503759,0.0946342,-8.18954e-05,3.77342e-08,-7.10587e-12,29934.3,35.5913], Tmin=(100,'K'), Tmax=(1259.25,'K')), NASAPolynomial(coeffs=[16.8538,0.0394986,-1.62194e-05,2.9646e-09,-2.0311e-13,25562.8,-52.1502], Tmin=(1259.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(247.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Allyl_P) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C(C=C)C(C)[CH]O[O](6026)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.220847,0.0948454,-9.23324e-05,5.20168e-08,-1.22849e-11,42945.4,37.6006], Tmin=(100,'K'), Tmax=(1007.21,'K')), NASAPolynomial(coeffs=[12.1768,0.0456103,-1.90092e-05,3.48503e-09,-2.38925e-13,40447.9,-22.3001], Tmin=(1007.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(355.818,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCsJOOH) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.248634,0.0965667,-9.96637e-05,6.03536e-08,-1.53075e-11,48869.9,38.0273], Tmin=(100,'K'), Tmax=(942.684,'K')), NASAPolynomial(coeffs=[11.647,0.0460903,-1.93446e-05,3.55122e-09,-2.43324e-13,46627.2,-18.6602], Tmin=(942.684,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(405.078,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C([CH]O[O])C(C)C=C(6028)',
...
species(
    label = '[CH2][C](COO)C([CH2])C=C(6030)',
    structure = SMILES('[CH2][C](COO)C([CH2])C=C'),
    E0 = (411.224,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,360,370,350,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.142355,0.0872418,-7.19673e-05,3.30277e-08,-6.30759e-12,49611.1,43.0278], Tmin=(100,'K'), Tmax=(1232.73,'K')), NASAPolynomial(coeffs=[13.9757,0.0414312,-1.62244e-05,2.88171e-09,-1.93937e-13,46130.4,-28.0376], Tmin=(1232.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(411.224,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C2CJCOOH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH]=CC(C)C([CH2])CO[O](6031)',
    structure = SMILES('[CH]=CC(C)C([CH2])CO[O]'),
    E0 = (414.332,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.339811,0.0961585,-9.41881e-05,5.22824e-08,-1.20163e-11,49988.3,38.2786], Tmin=(100,'K'), Tmax=(1039.97,'K')), NASAPolynomial(coeffs=[13.4601,0.0430807,-1.76319e-05,3.20679e-09,-2.18988e-13,47118,-28.839], Tmin=(1039.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(414.332,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Isobutyl) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC([CH2])C(C)CO[O](6032)',
...
species(
    label = '[CH2][C](C=C)C([CH2])COO(6033)',
    structure = SMILES('[CH2]C=C([CH2])C([CH2])COO'),
    E0 = (300.588,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.847229,0.101053,-9.36589e-05,4.60511e-08,-9.13976e-12,36331.5,37.8474], Tmin=(100,'K'), Tmax=(1210.37,'K')), NASAPolynomial(coeffs=[18.377,0.0375215,-1.49252e-05,2.68503e-09,-1.82588e-13,31677.8,-58.5687], Tmin=(1210.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(300.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Allyl_P) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C([C]=C)C([CH2])COO(6034)',
    structure = SMILES('[CH2]C([C]=C)C([CH2])COO'),
    E0 = (458.155,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.592824,0.103034,-0.000111741,6.9199e-08,-1.75897e-11,55267,40.2827], Tmin=(100,'K'), Tmax=(949.907,'K')), NASAPolynomial(coeffs=[13.5526,0.0434684,-1.76802e-05,3.1844e-09,-2.15574e-13,52579.7,-27.2335], Tmin=(949.907,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(458.155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CC([CH2])C([CH2])COO(6035)',
    structure = SMILES('[CH]=CC([CH2])C([CH2])COO'),
    E0 = (467.41,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3120,650,792.5,1650,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.695209,0.102741,-0.000106597,6.1477e-08,-1.44208e-11,56386,40.5754], Tmin=(100,'K'), Tmax=(1030.06,'K')), NASAPolynomial(coeffs=[15.3228,0.0405389,-1.60169e-05,2.85222e-09,-1.92292e-13,53086.1,-37.1768], Tmin=(1030.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(467.41,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
    products = ['[CH2]C([CH]CC=C)CO[O](5993)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(6.55606e+10,'s^-1'), n=0.64, Ea=(159.935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [cCs(-HC)CJ;CsJ;C] for rate rule [cCs(-HC)CJ;CsJ-HH;C]
Euclidian distance = 1.0
family: 1,2_shiftC"""),
...
reaction(
    label = 'reaction6',
    reactants = ['O(4)', '[CH2]C(C=C)C([CH2])C[O](5994)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(T)(20)', '[CH2]C([CH]CO[O])C=C(5995)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(T)(20)', '[CH2]C=CC([CH2])CO[O](1121)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH]C(CO[O])C([CH2])C=C(5996)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]C(C=C)C([CH2])CO[O](5997)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
    products = ['[CH2]C(C=C)C1COOC1(5999)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
    products = ['O(4)', '[CH2]C(C=C)C1COC1(6001)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
    products = ['O(4)', '[CH2]C1COCC1C=C(6002)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
    products = ['[CH2]C(C=C)C(=C)COO(6005)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
    products = ['[CH2]C(COO)C(=C)C=C(6006)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C[C]([CH2])C([CH2])CO[O](6007)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CC([CH2])[C]([CH2])CO[O](6008)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]CC([CH2])C([CH2])[CH]O[O](6009)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
    products = ['[CH2]C1[CH]COOCC1[CH2](6012)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
    products = ['[CH2]C(CO[O])C1CC1[CH2](6013)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
    products = ['[CH2]C1COOC([CH2])C1[CH2](6015)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', '[CH2]C(C=C)C(=C)CO[O](6016)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', '[CH2]C(CO[O])C(=C)C=C(6017)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.08019,'m^3/(mol*s)'), n=2.05449, Ea=(25.9493,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Cds-CsH_Cds-HH;CJ] + [Cds-Cs\O2s/H_Cds-HH;YJ] for rate rule [Cds-Cs\O2s/H_Cds-HH;CJ]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 22.6 to 25.9 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction35',
    reactants = ['[CH2]O[O](46)', '[CH2]C(C=C)C=C(4888)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction37',
    reactants = ['C2H3(60)', '[CH2]C(C=C)CO[O](776)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction38',
    reactants = ['O2(2)', '[CH2]C([CH2])C([CH2])C=C(4122)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]O[O](46)', '[CH2][CH]C([CH2])C=C(4950)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction41',
    reactants = ['H(3)', '[CH2][C](CO[O])C([CH2])C=C(6018)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction42',
    reactants = ['C2H3(60)', '[CH2][CH]C([CH2])CO[O](778)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction43',
    reactants = ['H(3)', '[CH2][C](C=C)C([CH2])CO[O](6019)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction44',
    reactants = ['H(3)', '[CH2]C([CH]O[O])C([CH2])C=C(6020)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction45',
    reactants = ['H(3)', '[CH2]C([C]=C)C([CH2])CO[O](6021)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction46',
    reactants = ['H(3)', '[CH]=CC([CH2])C([CH2])CO[O](6022)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
    products = ['[CH2]C(C=C)[C](C)CO[O](6023)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH2]C=C(C)C([CH2])CO[O](4677)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
    products = ['[CH2]C([CH]OO)C([CH2])C=C(6024)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
    products = ['[CH2][C](C=C)C(C)CO[O](6025)'],
...
reaction(
    label = 'reaction52',
    reactants = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
    products = ['[CH2]C(C=C)C(C)[CH]O[O](6026)'],
...
reaction(
    label = 'reaction53',
    reactants = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
    products = ['[CH2][CH]C(C)C(=C)CO[O](4678)'],
...
reaction(
    label = 'reaction54',
    reactants = ['[CH2]C(CO[O])C(C)[C]=C(6027)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction55',
    reactants = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
    products = ['[CH2]C([CH]O[O])C(C)C=C(6028)'],
...
reaction(
    label = 'reaction56',
    reactants = ['[CH2]C([C]=C)C(C)CO[O](6029)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction57',
    reactants = ['[CH2][C](COO)C([CH2])C=C(6030)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction58',
    reactants = ['[CH]=CC(C)C([CH2])CO[O](6031)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction59',
    reactants = ['[CH]=CC([CH2])C(C)CO[O](6032)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction60',
    reactants = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
    products = ['[CH2][C](C=C)C([CH2])COO(6033)'],
...
reaction(
    label = 'reaction61',
    reactants = ['[CH2]C([C]=C)C([CH2])COO(6034)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
...
reaction(
    label = 'reaction62',
    reactants = ['[CH]=CC([CH2])C([CH2])COO(6035)'],
    products = ['[CH2]C(C=C)C([CH2])CO[O](4743)'],
