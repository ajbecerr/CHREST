...
species(
    label = '[C]=CC([O])[C]=O(15457)',
    structure = SMILES('[C]=CC([O])[C]=O'),
    E0 = (691.458,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,1855,455,950,357.662,4000],'cm^-1')),
        HinderedRotor(inertia=(0.144229,'amu*angstrom^2'), symmetry=1, barrier=(12.912,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143333,'amu*angstrom^2'), symmetry=1, barrier=(12.9215,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.0575,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13605,0.0433517,-5.77466e-05,4.08324e-08,-1.15523e-11,83228.3,24.9296], Tmin=(100,'K'), Tmax=(863.125,'K')), NASAPolynomial(coeffs=[8.49922,0.013863,-6.49953e-06,1.25022e-09,-8.76226e-14,82129.8,-4.8325], Tmin=(863.125,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(691.458,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(C=OCOJ) + radical(CCCJ=O) + radical(CdCdJ2_triplet)"""),
)

species(
    label = '[CH]=CC1OC1=O(15458)',
    structure = SMILES('[CH]=CC1OC1=O'),
    E0 = (113.448,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.34658,0.0334992,-2.14931e-05,6.6392e-09,-8.26e-13,13706.3,18.6718], Tmin=(100,'K'), Tmax=(1822.95,'K')), NASAPolynomial(coeffs=[10.5827,0.0154267,-6.62199e-06,1.20058e-09,-8.01275e-14,10703.6,-26.0079], Tmin=(1822.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsOsH) + group(Cds-CdsCsH) + group(Cds-OdCsOs) + group(Cds-CdsHH) + ring(2(co)oxirane) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83948,0.0478927,-5.79281e-05,3.57906e-08,-8.71437e-12,45126.8,25.7097], Tmin=(100,'K'), Tmax=(1005.37,'K')), NASAPolynomial(coeffs=[10.6697,0.0127614,-5.51392e-06,1.03528e-09,-7.216e-14,43351.3,-16.9384], Tmin=(1005.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.561,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CCCJ=O) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(2355)', '[CH]=C[CH][O](15182)'],
    products = ['[CH]=CC([O])[C]=O(15070)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[C]=CC([O])[C]=O(15457)'],
    products = ['[CH]=CC([O])[C]=O(15070)'],
    transitionState = 'TS5',
...
reaction(
    ...
    kinetics = Arrhenius(A=(1099.39,'m^3/(mol*s)'), n=0.635039, Ea=(154.477,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [COm;Y_rad]
Euclidian distance = 0
family: R_Addition_COm
Ea raised from 148.4 to 154.5 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C#CC([O])[C]=O(13206)'],
    products = ['[CH]=CC([O])[C]=O(15070)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[C]=O(2355)', 'CHCHCHO(3667)'],
    products = ['[CH]=CC([O])[C]=O(15070)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH]=[C]C([O])[C]=O(13202)'],
    products = ['[CH]=CC([O])[C]=O(15070)'],
