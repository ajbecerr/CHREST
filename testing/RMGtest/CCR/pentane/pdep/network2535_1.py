...
species(
    label = '[CH]=[C]OC[C][CH][CH2](13239)',
    structure = SMILES('[CH]=[C]OC[C][CH][CH2]'),
    E0 = (1101.68,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.656299,0.0754764,-9.41181e-05,6.2685e-08,-1.66401e-11,132620,33.1404], Tmin=(100,'K'), Tmax=(921.15,'K')), NASAPolynomial(coeffs=[12.5466,0.0238435,-1.00386e-05,1.83351e-09,-1.2491e-13,130430,-23.247], Tmin=(921.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1101.68,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(RCCJ) + radical(CCJ2_triplet) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]OC[CH][C][CH2](13240)',
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.325621,0.0739848,-8.00884e-05,4.31191e-08,-8.99844e-12,133296,34.0816], Tmin=(100,'K'), Tmax=(1180.61,'K')), NASAPolynomial(coeffs=[17.6898,0.0151537,-5.34185e-06,9.11176e-10,-6.07214e-14,129196,-52.5734], Tmin=(1180.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1107.14,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(RCCJ) + radical(CCJ2_triplet) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH][CH][CH]CO[C]=[CH](13241)',
    structure = SMILES('[CH][CH][CH]CO[C]=[CH]'),
    E0 = (1096.34,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.734149,0.0705317,-7.88334e-05,4.62205e-08,-1.07463e-11,131978,34.6648], Tmin=(100,'K'), Tmax=(1050.39,'K')), NASAPolynomial(coeffs=[13.6921,0.021186,-8.36507e-06,1.49497e-09,-1.01275e-13,129255,-28.4868], Tmin=(1050.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1096.34,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(RCCJC) + radical(C=CJO) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[C]=[C]OC[CH][CH][CH2](13242)',
    structure = SMILES('[C]=[C]OC[CH][CH][CH2]'),
    E0 = (1164.37,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.957827,0.0698292,-8.55828e-05,5.82122e-08,-1.60531e-11,140149,34.6258], Tmin=(100,'K'), Tmax=(881.594,'K')), NASAPolynomial(coeffs=[10.5656,0.0262353,-1.14071e-05,2.11829e-09,-1.45629e-13,138455,-10.5149], Tmin=(881.594,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1164.37,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(RCCJC) + radical(RCCJ) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)
...
species(
    label = '[CH]=[C]O[CH][CH][CH][CH2](13243)',
    structure = SMILES('[CH][C]O[CH]C=C[CH2]'),
    E0 = (971.802,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07003,0.0693359,-7.71383e-05,4.80582e-08,-1.25295e-11,116982,27.3807], Tmin=(100,'K'), Tmax=(914.289,'K')), NASAPolynomial(coeffs=[9.67582,0.0316867,-1.53721e-05,3.02177e-09,-2.15275e-13,115409,-13.3663], Tmin=(914.289,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(971.802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CCJ(O)C) + radical(Allyl_P) + radical(CH2_triplet) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]=[C]O[CH][CH]C[CH2](13244)',
    structure = SMILES('[CH]=[C]O[CH][CH]C[CH2]'),
    E0 = (852.849,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0450915,0.0809898,-8.97968e-05,4.91514e-08,-1.03679e-11,102726,34.9798], Tmin=(100,'K'), Tmax=(1172.23,'K')), NASAPolynomial(coeffs=[19.4361,0.0145138,-4.73292e-06,7.73954e-10,-5.05099e-14,98159.2,-62.1013], Tmin=(1172.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(852.849,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(CCsJOC(O)) + radical(RCCJ) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH2][CH][CH][CH]O[C]=C(9133)',
    structure = SMILES('[CH2][C]O[CH]C=C[CH2]'),
    E0 = (735.176,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.977295,0.0713867,-7.70885e-05,4.71791e-08,-1.21567e-11,88526,28.0364], Tmin=(100,'K'), Tmax=(922.133,'K')), NASAPolynomial(coeffs=[9.60443,0.0339641,-1.62143e-05,3.16924e-09,-2.25163e-13,86934.9,-12.8852], Tmin=(922.133,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(735.176,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CCJ(O)C) + radical(Allyl_P) + radical(CJCO) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=[C]OC[CH][CH][CH2](7192)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=[CH](9646)', '[CH2][CH][CH]C[O](5580)'],
    products = ['[CH]=[C]OC[CH][CH][CH2](7192)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]=[C]O[CH2](9647)', '[CH][CH][CH2](5537)'],
    products = ['[CH]=[C]OC[CH][CH][CH2](7192)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]=[C]OC[C][CH][CH2](13239)'],
    products = ['[CH]=[C]OC[CH][CH][CH2](7192)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]=[C]OC[CH][C][CH2](13240)'],
    products = ['[CH]=[C]OC[CH][CH][CH2](7192)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH][CH][CH]CO[C]=[CH](13241)'],
    products = ['[CH]=[C]OC[CH][CH][CH2](7192)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[C]=[C]OC[CH][CH][CH2](13242)'],
    products = ['[CH]=[C]OC[CH][CH][CH2](7192)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.82396,'m^3/(mol*s)'), n=2.03228, Ea=(32.8229,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH]=[C]O[CH][CH][CH][CH2](13243)'],
    products = ['[CH]=[C]OC[CH][CH][CH2](7192)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=[C]OC[CH][CH][CH2](7192)'],
    products = ['[CH]=[C]O[CH]C[CH][CH2](10106)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=[C]OC[CH][CH][CH2](7192)'],
    products = ['[CH]=CO[CH][CH][CH][CH2](7191)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=[C]O[CH][CH]C[CH2](13244)'],
    products = ['[CH]=[C]OC[CH][CH][CH2](7192)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=[C]OC[CH][CH][CH2](7192)'],
    products = ['[CH2][CH][CH][CH]O[C]=C(9133)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=[C]OC[CH][CH][CH2](7192)'],
    products = ['[CH]=[C]O[CH][CH][CH]C(10354)'],
