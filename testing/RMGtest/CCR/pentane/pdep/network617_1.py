...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CO[C]=C(2240)'],
    products = ['ketene(1375)', 'C2H4(22)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction9',
    reactants = ['ketene(1375)', 'C2H4(T)(23)'],
    products = ['[CH2]CO[C]=C(2240)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C]=O(1376)', 'C2H4(T)(23)'],
    products = ['[CH2]CO[C]=C(2240)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2][CH]O[C]=C(2367)'],
    products = ['[CH2]CO[C]=C(2240)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]=[C]OC[CH2](2368)'],
    products = ['[CH2]CO[C]=C(2240)'],
