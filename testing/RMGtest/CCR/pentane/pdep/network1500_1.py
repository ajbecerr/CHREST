...
species(
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.548809,0.0624667,-3.71209e-06,-2.96563e-08,1.2903e-11,61006.9,36.8695], Tmin=(100,'K'), Tmax=(1087.48,'K')), NASAPolynomial(coeffs=[13.1076,0.0447283,-1.84952e-05,3.46845e-09,-2.43685e-13,56592.9,-32.5091], Tmin=(1087.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(506.113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Cs_S) + radical(Cs_S) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C(C)[CH]C1[CH]CC1(6634)',
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.812359,0.0560205,1.39546e-05,-4.69281e-08,1.89687e-11,59238.1,35.7196], Tmin=(100,'K'), Tmax=(1039.92,'K')), NASAPolynomial(coeffs=[11.5936,0.0465191,-1.84516e-05,3.40733e-09,-2.38525e-13,55267.3,-25.0267], Tmin=(1039.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(491.479,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Cs_S) + radical(cyclobutane) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2][CH]C(C)C1[C]CC1(6635)',
    structure = SMILES('[CH2][CH]C(C)C1[C]CC1'),
    E0 = (752.02,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.630497,0.0573618,1.52817e-05,-5.43893e-08,2.28768e-11,90583,33.9347], Tmin=(100,'K'), Tmax=(1021.88,'K')), NASAPolynomial(coeffs=[14.9061,0.040095,-1.60514e-05,3.02865e-09,-2.16499e-13,85649.3,-45.1101], Tmin=(1021.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(752.02,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Cs_S) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][C]C(C)C1[CH]CC1(6636)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.59948,0.0592215,8.24588e-06,-4.6039e-08,1.97482e-11,89776.7,33.8373], Tmin=(100,'K'), Tmax=(1030.18,'K')), NASAPolynomial(coeffs=[14.3666,0.04096,-1.64079e-05,3.07655e-09,-2.18402e-13,85072.7,-42.0541], Tmin=(1030.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(745.316,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]C(C)C1[CH]CC1(6637)',
    structure = SMILES('[CH][CH]C(C)C1[CH]CC1'),
    E0 = (734.612,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CC(C)C1=CCC1(6639)',
    structure = SMILES('[CH2]CC(C)C1=CCC1'),
    E0 = (232.481,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.518124,0.0576285,2.5399e-05,-7.00567e-08,2.97049e-11,28103.1,31.4977], Tmin=(100,'K'), Tmax=(991.701,'K')), NASAPolynomial(coeffs=[16.2823,0.0391032,-1.47347e-05,2.73947e-09,-1.96421e-13,22760.8,-55.5954], Tmin=(991.701,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(232.481,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C=C(C)C1CCC1(6640)',
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05744,0.041163,7.35807e-05,-1.19267e-07,4.69767e-11,19551.2,26.9137], Tmin=(100,'K'), Tmax=(973.21,'K')), NASAPolynomial(coeffs=[15.606,0.0397964,-1.43699e-05,2.67153e-09,-1.94312e-13,13952.4,-57.0955], Tmin=(973.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.502,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Allyl_T)"""),
)

species(
    label = '[CH2]CC(C)C1C=CC1(6237)',
    structure = SMILES('[CH2]CC(C)C1C=CC1'),
    E0 = (240.927,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.624479,0.0540758,3.61428e-05,-8.15269e-08,3.38457e-11,29116.2,30.9626], Tmin=(100,'K'), Tmax=(985.839,'K')), NASAPolynomial(coeffs=[16.3936,0.0387026,-1.44275e-05,2.68661e-09,-1.93637e-13,23645,-56.8695], Tmin=(985.839,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(240.927,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH]C(C)C=CC[CH2](6641)',
    structure = SMILES('[CH2][CH]C(C)C=CC[CH2]'),
    E0 = (474.31,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0957702,0.077228,-4.73797e-05,1.43928e-08,-1.77398e-12,57193.8,39.2093], Tmin=(100,'K'), Tmax=(1836.99,'K')), NASAPolynomial(coeffs=[18.347,0.0374865,-1.49287e-05,2.61589e-09,-1.71234e-13,50488.3,-59.9413], Tmin=(1836.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(474.31,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_S) + radical(RCCJ) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH]C(C)[C]1CCC1(6647)',
    structure = SMILES('[CH2][CH]C(C)[C]1CCC1'),
    E0 = (489.227,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.714779,0.0620848,-1.19377e-05,-1.43861e-08,6.19503e-12,58966.9,34.8794], Tmin=(100,'K'), Tmax=(1227.94,'K')), NASAPolynomial(coeffs=[11.0861,0.0487005,-2.05079e-05,3.79607e-09,-2.6118e-13,54881.8,-23.5485], Tmin=(1227.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(489.227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C[C](C)C1[CH]CC1(6648)',
    structure = SMILES('[CH2]C[C](C)C1[CH]CC1'),
    E0 = (482.524,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.682595,0.0638786,-1.83925e-05,-7.24401e-09,3.7534e-12,58160.9,34.7918], Tmin=(100,'K'), Tmax=(1308.8,'K')), NASAPolynomial(coeffs=[11.418,0.0482487,-2.01691e-05,3.69033e-09,-2.50981e-13,53879.3,-25.5108], Tmin=(1308.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(482.524,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(cyclobutane) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]C(C)C1C[CH]C1(6649)',
    structure = SMILES('[CH2][CH]C(C)C1C[CH]C1'),
    E0 = (491.643,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC(C)[C]1[CH]CC1(6651)',
    structure = SMILES('[CH2]CC(C)[C]1[CH]CC1'),
    E0 = (482.524,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.682595,0.0638786,-1.83925e-05,-7.24401e-09,3.7534e-12,58160.9,35.485], Tmin=(100,'K'), Tmax=(1308.8,'K')), NASAPolynomial(coeffs=[11.418,0.0482487,-2.01691e-05,3.69033e-09,-2.50981e-13,53879.3,-24.8177], Tmin=(1308.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(482.524,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(cyclobutane) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CC(C)C1[CH]C[CH]1(6652)',
    structure = SMILES('[CH2]CC(C)C1[CH]C[CH]1'),
    E0 = (484.939,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.798384,0.056887,9.44536e-06,-3.99416e-08,1.57156e-11,58451.4,35.5703], Tmin=(100,'K'), Tmax=(1084.89,'K')), NASAPolynomial(coeffs=[11.4497,0.0478334,-1.98171e-05,3.71433e-09,-2.60717e-13,54362,-24.8799], Tmin=(1084.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(484.939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(cyclobutane) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CC(C)C1[CH][CH]C1(6654)',
    structure = SMILES('[CH2]CC(C)C1[CH][CH]C1'),
    E0 = (484.939,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', '[CH2][CH]CC1[CH]CC1(5252)'],
    products = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2][CH]C(C)[CH]C1CC1(6633)'],
    products = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
    products = ['[CH2]C(C)[CH]C1[CH]CC1(6634)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][CH]C(C)C1CC1[CH2](5768)'],
    products = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH][CH2](502)', 'C[CH]C1[CH]CC1(6260)'],
    products = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH2][CH]C(C)C1[C]CC1(6635)'],
    products = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH2][C]C(C)C1[CH]CC1(6636)'],
    products = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH][CH]C(C)C1[CH]CC1(6637)'],
    products = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
    products = ['[CH2]CC(C)C1=CCC1(6639)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
    products = ['[CH2]C=C(C)C1CCC1(6640)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
    products = ['[CH2]CC(C)C1C=CC1(6237)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][CH]C(C)C=CC[CH2](6641)'],
    products = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'C=CC(C)[C]1[CH]CC1(6499)'],
    products = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'C=C[C](C)C1[CH]CC1(6496)'],
    products = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', 'C=CC(C)C1[CH][CH]C1(6504)'],
    products = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH3(17)', '[CH2]C=CC1[CH]CC1(6382)'],
    products = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2][CH]C(C)[C]1[CH]CC1(6642)'],
    products = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH3(17)', '[CH2][CH][CH]C1[CH]CC1(6386)'],
    products = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH2][CH][C](C)C1[CH]CC1(6643)'],
    products = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH2][CH]C(C)C1[CH]C[CH]1(6644)'],
    products = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', '[CH2][CH]C(C)C1[CH][CH]C1(6645)'],
    products = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
    products = ['[CH2][CH]C(C)[C]1CCC1(6647)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
    products = ['[CH2]C[C](C)C1[CH]CC1(6648)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2][CH]C(C)C1C[CH]C1(6649)'],
    products = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
    products = ['[CH2][CH][C](C)C1CCC1(6650)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
    products = ['[CH2]CC(C)[C]1[CH]CC1(6651)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
    products = ['[CH2]CC(C)C1[CH]C[CH]1(6652)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2][CH]C(C)C1[CH]CC1(5765)'],
    products = ['[CH2]CC(C)C1[CH][CH]C1(6654)'],
