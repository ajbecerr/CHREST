species(
    label = 'C=[C]OO[CH]C(3197)',
    structure = SMILES('C=[C]OO[CH]C'),
    E0 = (346.413,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,260.439],'cm^-1')),
        HinderedRotor(inertia=(0.207349,'amu*angstrom^2'), symmetry=1, barrier=(9.98023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.207349,'amu*angstrom^2'), symmetry=1, barrier=(9.98023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0142422,'amu*angstrom^2'), symmetry=1, barrier=(43.5753,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.90532,'amu*angstrom^2'), symmetry=1, barrier=(43.5753,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71902,0.0546224,-6.02801e-05,4.32502e-08,-1.37785e-11,41741.9,24.9714], Tmin=(100,'K'), Tmax=(741.248,'K')), NASAPolynomial(coeffs=[5.81453,0.0325226,-1.55603e-05,3.03139e-09,-2.14437e-13,41134.7,6.43905], Tmin=(741.248,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(346.413,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOOC) + radical(C=CJO)"""),
)
...
species(
    label = '[CH]OO[C]=C(3363)',
    structure = SMILES('[CH]OO[C]=C'),
    E0 = (658.508,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2950,3100,1380,975,1025,1650,1685,370,180,791.746,796.089],'cm^-1')),
        HinderedRotor(inertia=(0.142775,'amu*angstrom^2'), symmetry=1, barrier=(3.28268,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145063,'amu*angstrom^2'), symmetry=1, barrier=(3.33528,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=[C]OO[C]C(3364)',
    structure = SMILES('C=[C]OO[C]C'),
    E0 = (620.96,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,281.086,281.167],'cm^-1')),
        HinderedRotor(inertia=(0.508058,'amu*angstrom^2'), symmetry=1, barrier=(28.507,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.338886,'amu*angstrom^2'), symmetry=1, barrier=(18.9931,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177763,'amu*angstrom^2'), symmetry=1, barrier=(9.96554,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17766,'amu*angstrom^2'), symmetry=1, barrier=(9.96588,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56719,0.0578712,-6.80608e-05,4.45592e-08,-1.21253e-11,74768.2,23.9559], Tmin=(100,'K'), Tmax=(880.687,'K')), NASAPolynomial(coeffs=[8.75555,0.0252225,-1.24532e-05,2.46535e-09,-1.76196e-13,73502,-9.81048], Tmin=(880.687,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(620.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CH2_triplet) + radical(C=CJO)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.442018,'amu*angstrom^2'), symmetry=1, barrier=(10.1629,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.940039,'amu*angstrom^2'), symmetry=1, barrier=(21.6133,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170533,'amu*angstrom^2'), symmetry=1, barrier=(21.5875,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61701,0.0472731,-3.89653e-05,1.6305e-08,-2.73503e-12,36519.2,25.7161], Tmin=(100,'K'), Tmax=(1419.42,'K')), NASAPolynomial(coeffs=[12.3675,0.0169774,-6.94949e-06,1.26784e-09,-8.65495e-14,33467.3,-29.9142], Tmin=(1419.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(302.89,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.474755,'amu*angstrom^2'), symmetry=1, barrier=(24.9852,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.427889,'amu*angstrom^2'), symmetry=1, barrier=(9.83802,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.08694,'amu*angstrom^2'), symmetry=1, barrier=(24.9909,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.78588,'amu*angstrom^2'), symmetry=1, barrier=(87.0448,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3992,0.0569617,-5.2617e-05,2.56103e-08,-5.10507e-12,42641.9,23.3828], Tmin=(100,'K'), Tmax=(1188.89,'K')), NASAPolynomial(coeffs=[11.3176,0.0235909,-1.05129e-05,2.00015e-09,-1.40221e-13,40283.6,-26.1835], Tmin=(1188.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(353.765,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOOC) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]OOCC(3368)',
    structure = SMILES('[CH]=[C]OOCC'),
    E0 = (407.068,'kJ/mol'),
    modes = [
        ...
        HinderedRotor(inertia=(0.458007,'amu*angstrom^2'), symmetry=1, barrier=(13.5073,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.237721,'amu*angstrom^2'), symmetry=1, barrier=(7.01338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.237847,'amu*angstrom^2'), symmetry=1, barrier=(7.01335,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.59874,'amu*angstrom^2'), symmetry=1, barrier=(47.1593,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64901,0.0561347,-6.20531e-05,4.211e-08,-1.23872e-11,49039.7,25.3327], Tmin=(100,'K'), Tmax=(805.424,'K')), NASAPolynomial(coeffs=[6.78047,0.0306544,-1.4607e-05,2.84426e-09,-2.0129e-13,48213,1.68593], Tmin=(805.424,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.068,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['C=[C]O[O](1354)', 'CHCH3(T)(21)'],
    products = ['C=[C]OO[CH]C(3197)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2CC(T)(1341)', 'C[CH]O[O](57)'],
    products = ['C=[C]OO[CH]C(3197)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(15399.6,'m^3/(mol*s)'), n=0.932885, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', '[CH]OO[C]=C(3363)'],
    products = ['C=[C]OO[CH]C(3197)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2][CH]OO[C]=C(2324)'],
    products = ['C=[C]OO[CH]C(3197)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]=[C]OO[CH]C(2806)'],
    products = ['C=[C]OO[CH]C(3197)'],
