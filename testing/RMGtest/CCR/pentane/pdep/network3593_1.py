species(
    label = 'C=[C]CC(C)[O](15518)',
    structure = SMILES('C=[C]CC(C)[O]'),
    E0 = (255.43,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,362.395,362.467,362.63],'cm^-1')),
        HinderedRotor(inertia=(0.00128244,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123102,'amu*angstrom^2'), symmetry=1, barrier=(11.4797,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123109,'amu*angstrom^2'), symmetry=1, barrier=(11.4802,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3389,0.0539577,-3.84707e-05,1.42831e-08,-2.18306e-12,30820.5,24.5181], Tmin=(100,'K'), Tmax=(1509.73,'K')), NASAPolynomial(coeffs=[12.0326,0.025625,-1.03206e-05,1.85265e-09,-1.24664e-13,27591.6,-31.478], Tmin=(1509.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(255.43,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27232,0.063671,-7.07609e-05,4.78536e-08,-1.37275e-11,24353.5,24.3799], Tmin=(100,'K'), Tmax=(834.068,'K')), NASAPolynomial(coeffs=[7.82444,0.0322465,-1.42432e-05,2.67651e-09,-1.85503e-13,23260.6,-6.04109], Tmin=(834.068,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C2CsJOH) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]=[C]CC(C)O(16108)',
    structure = SMILES('[CH]=[C]CC(C)O'),
    E0 = (272.166,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,243.969],'cm^-1')),
        HinderedRotor(inertia=(0.00281052,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.252263,'amu*angstrom^2'), symmetry=1, barrier=(10.7372,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.250434,'amu*angstrom^2'), symmetry=1, barrier=(10.7344,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.256021,'amu*angstrom^2'), symmetry=1, barrier=(10.7374,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33542,0.0587798,-5.19558e-05,2.5552e-08,-5.25382e-12,32829.7,25.1236], Tmin=(100,'K'), Tmax=(1144.31,'K')), NASAPolynomial(coeffs=[10.083,0.0282018,-1.18727e-05,2.19959e-09,-1.5192e-13,30827.8,-18.2575], Tmin=(1144.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(272.166,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'C=[C]CC[O](16103)'],
    products = ['C=[C]CC(C)[O](15518)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'C=[C]CC(C)=O(15956)'],
    products = ['C=[C]CC(C)[O](15518)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'C=C=CC(C)[O](15958)'],
    products = ['C=[C]CC(C)[O](15518)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(17)', 'C=[C]CC=O(15522)'],
    products = ['C=[C]CC(C)[O](15518)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C[CH][O](1382)', 'allene(458)'],
    products = ['C=[C]CC(C)[O](15518)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(17)', 'C=[C]C[CH][O](2773)'],
    products = ['C=[C]CC(C)[O](15518)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C=[C]C[C](C)[O](15963)'],
    products = ['C=[C]CC(C)[O](15518)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'C=[C][CH]C(C)[O](15965)'],
    products = ['C=[C]CC(C)[O](15518)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH2]C([O])C[C]=C(15502)'],
    products = ['C=[C]CC(C)[O](15518)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH]=[C]CC(C)[O](15967)'],
    products = ['C=[C]CC(C)[O](15518)'],
