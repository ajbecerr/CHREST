...
species(
    label = '[CH]=C([CH2])O[C]([CH2])[CH2](27725)',
    structure = SMILES('[CH]C(=C)O[C]([CH2])[CH2]'),
    E0 = (728.199,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.434822,0.101725,-0.000142271,1.0497e-07,-3.06468e-11,87737.9,30.6229], Tmin=(100,'K'), Tmax=(841.737,'K')), NASAPolynomial(coeffs=[14.8702,0.0289923,-1.26562e-05,2.31081e-09,-1.55902e-13,85161.4,-40.5776], Tmin=(841.737,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(728.199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C2CsJOC(O)) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C(=C[O])O[C]([CH2])[CH2](27726)',
    structure = SMILES('[CH]C(=C[O])O[C]([CH2])[CH2]'),
    E0 = (660.869,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3010,987.5,1337.5,450,1655,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.1502,0.111633,-0.000147532,9.57198e-08,-2.39405e-11,79671.1,34.4558], Tmin=(100,'K'), Tmax=(990.008,'K')), NASAPolynomial(coeffs=[21.766,0.0190395,-7.23518e-06,1.24115e-09,-8.15929e-14,75133.8,-75.8705], Tmin=(990.008,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(660.869,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C2CsJOC(O)) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2]C1([CH2])CC(=C[O])O1(27727)',
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.29461,0.102113,-0.000112999,5.78417e-08,-1.06618e-11,26749.8,30.8983], Tmin=(100,'K'), Tmax=(1621.49,'K')), NASAPolynomial(coeffs=[26.7315,0.00254392,4.98023e-06,-1.30141e-09,9.67593e-14,21013.1,-111.829], Tmin=(1621.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(220.266,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(2methyleneoxetane) + radical(C=COJ) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][C]([CH2])OC1=COC1(27728)',
    structure = SMILES('[CH2]C(=C)O[C]1[CH]OC1'),
    E0 = (300.071,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.96167,0.0882728,-9.48169e-05,5.0382e-08,-9.88652e-12,36286.8,31.4405], Tmin=(100,'K'), Tmax=(1485.06,'K')), NASAPolynomial(coeffs=[20.7276,0.0119273,4.02387e-07,-4.91346e-10,4.59572e-14,31821.5,-75.1198], Tmin=(1485.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(300.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Oxetane) + radical(C2CsJOC(O)) + radical(CCsJOCs) + radical(C=C(O)CJ)"""),
)
...
species(
    label = '[CH2][C]([CH2])OC(C)=C=O(27729)',
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0406051,0.0794275,-7.34035e-05,2.83361e-08,-2.44838e-12,21220.8,33.1973], Tmin=(100,'K'), Tmax=(998.516,'K')), NASAPolynomial(coeffs=[20.0471,0.0167105,-5.8575e-06,1.04445e-09,-7.34158e-14,16324.2,-68.1159], Tmin=(998.516,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(175.161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(C2CsJOC(O)) + radical(C=C(O)CJ) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2]C(=C=O)OC([CH2])[CH2](27730)',
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.09267,0.117163,-0.000173217,1.26389e-07,-3.58582e-11,28858.8,29.0952], Tmin=(100,'K'), Tmax=(869.947,'K')), NASAPolynomial(coeffs=[19.3617,0.0231156,-1.10576e-05,2.1236e-09,-1.47919e-13,25299.9,-66.7357], Tmin=(869.947,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(238.459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-O2d)O2s) + group(Cds-CdsHH) + group(Cds-O2d(Cds-Cds)H) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(C=CCJ=O)"""),
)

species(
    label = '[CH2][C]([CH2])O[C]1CC1[O](27731)',
    structure = SMILES('[CH2][C]([CH2])O[C]1CC1[O]'),
    E0 = (658.787,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.574168,0.114044,-0.00020043,1.80284e-07,-6.13525e-11,79385.8,31.6257], Tmin=(100,'K'), Tmax=(882.175,'K')), NASAPolynomial(coeffs=[9.93117,0.0363426,-1.71845e-05,3.16826e-09,-2.10474e-13,78702.2,-11.1083], Tmin=(882.175,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(658.787,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)OJ) + radical(C2CsJOCs) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][C]([CH2])OC1([CH2])[CH]O1(27732)',
...
species(
    label = '[CH2][C]1CC([O])[C]([CH2])O1(27734)',
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0219744,0.0951775,-0.000143101,1.15482e-07,-3.53018e-11,68562.7,27.3119], Tmin=(100,'K'), Tmax=(971.579,'K')), NASAPolynomial(coeffs=[10.297,0.0310226,-1.05954e-05,1.60323e-09,-9.20084e-14,67580.4,-16.9101], Tmin=(971.579,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(568.91,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CC(C)OJ) + radical(C2CsJOCs) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2][C]1CC([CH2])([CH][O])O1(27736)',
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.556555,0.112719,-0.000193027,1.66903e-07,-5.34071e-11,76762.3,30.2004], Tmin=(100,'K'), Tmax=(956.232,'K')), NASAPolynomial(coeffs=[10.077,0.032753,-1.19224e-05,1.83236e-09,-1.04289e-13,76351.1,-12.1412], Tmin=(956.232,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(636.97,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCOJ) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CCsJOH) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][C]([CH2])OC([CH2])=C=O(27737)',
    structure = SMILES('[CH2]C(=C)OC([CH2])=[C][O]'),
    E0 = (376.478,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([325,375,415,465,420,450,1700,1750,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,1685,370,180,886.909,886.914,3566.21],'cm^-1')),
        HinderedRotor(inertia=(0.692744,'amu*angstrom^2'), symmetry=1, barrier=(15.9276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289321,'amu*angstrom^2'), symmetry=1, barrier=(15.9273,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.692747,'amu*angstrom^2'), symmetry=1, barrier=(15.9276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148316,'amu*angstrom^2'), symmetry=1, barrier=(82.807,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.329267,0.0780824,-8.69121e-05,5.02183e-08,-1.14365e-11,45414.4,33.3085], Tmin=(100,'K'), Tmax=(1075.2,'K')), NASAPolynomial(coeffs=[15.4836,0.0217047,-8.26046e-06,1.4513e-09,-9.75045e-14,42155.6,-40.9014], Tmin=(1075.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(376.478,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=COJ) + radical(C=C(O)CJ) + radical(C=C(O)CJ) + radical(C=CJO)"""),
)
...
species(
    label = '[CH2][C]([CH2])OC([CH2])=[C][O](27738)',
    structure = SMILES('[CH2][C]([CH2])OC([CH2])=[C][O]'),
    E0 = (688.845,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.811201,0.111659,-0.000167516,1.16419e-07,-2.847e-11,83017,35.9725], Tmin=(100,'K'), Tmax=(719.883,'K')), NASAPolynomial(coeffs=[19.3019,0.0172475,-6.93692e-06,1.18321e-09,-7.51884e-14,79671.7,-57.5731], Tmin=(719.883,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(688.845,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C2CsJOC(O)) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(C=C(O)CJ) + radical(C=CJO)"""),
)

species(
    label = '[CH2][C]([CH2])OC([CH2])=[C]O(27739)',
    structure = SMILES('[CH2][C]([CH2])OC([CH2])=[C]O'),
    E0 = (547.382,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2][C]([CH2])OC(C)=[C][O](27740)',
    structure = SMILES('[CH2][C]([CH2])O[C](C)[C]=O'),
    E0 = (518.051,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,363.333,366.667,370,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1855,455,950,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.70436,0.121772,-0.000231593,2.1735e-07,-7.5601e-11,62459.2,37.0653], Tmin=(100,'K'), Tmax=(890.836,'K')), NASAPolynomial(coeffs=[8.08063,0.0389034,-1.89437e-05,3.49578e-09,-2.30576e-13,62616.9,5.36882], Tmin=(890.836,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(518.051,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(C2CsJOCs) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2]C(=[C][O])OC([CH2])[CH2](27741)',
    structure = SMILES('[CH2]C(=[C][O])OC([CH2])[CH2]'),
    E0 = (488.629,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,350,440,435,1725,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.00003,0.107022,-0.000142701,9.28453e-08,-2.31283e-11,58951.2,34.4321], Tmin=(100,'K'), Tmax=(997.337,'K')), NASAPolynomial(coeffs=[21.8389,0.015425,-4.94144e-06,7.62782e-10,-4.67627e-14,54395.4,-75.6921], Tmin=(997.337,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(488.629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(C=C(O)CJ) + radical(C=CJO)"""),
)

species(
    label = '[CH2][C](C)OC([CH2])=[C][O](27742)',
    structure = SMILES('[CH2][C](C)OC([CH2])=[C][O]'),
    E0 = (478.335,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.592664,0.100849,-0.000133041,8.75325e-08,-2.23135e-11,57696,35.4135], Tmin=(100,'K'), Tmax=(969.385,'K')), NASAPolynomial(coeffs=[19.0321,0.0198716,-7.74107e-06,1.36264e-09,-9.10825e-14,53891.1,-58.6549], Tmin=(969.385,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(478.335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C2CsJOC(O)) + radical(CJC(C)OC) + radical(C=C(O)CJ) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C(=C)OC([CH2])=C[O](25960)',
    structure = SMILES('[CH2]C(=C)OC([CH2])=C[O]'),
    E0 = (136.734,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.471692,0.0832129,-8.37497e-05,4.17037e-08,-7.93583e-12,16619.2,33.0593], Tmin=(100,'K'), Tmax=(1402.94,'K')), NASAPolynomial(coeffs=[21.4076,0.0145938,-3.71399e-06,5.02118e-10,-2.90737e-14,11094,-77.7154], Tmin=(1402.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(136.734,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=COJ) + radical(C=C(O)CJ) + radical(C=C(O)CJ)"""),
)
...
species(
    label = '[CH2]C1([CH2])OC(=C)C1[O](27743)',
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.67299,0.0977925,-0.000108058,5.6162e-08,-1.06675e-11,41739.4,29.0763], Tmin=(100,'K'), Tmax=(1534.45,'K')), NASAPolynomial(coeffs=[25.7467,0.00540849,2.6885e-06,-8.32984e-10,6.50976e-14,35785.8,-106.928], Tmin=(1534.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(345.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(CC(C)OJ) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2][C]([CH2])O[C]1[CH]OC1(27744)',
    structure = SMILES('[CH2][C]([CH2])O[C]1[CH]OC1'),
    E0 = (642.961,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.7923,0.120682,-0.000217573,1.92098e-07,-6.21234e-11,77488.9,30.9391], Tmin=(100,'K'), Tmax=(955.773,'K')), NASAPolynomial(coeffs=[10.0824,0.0323957,-1.18842e-05,1.80236e-09,-9.99711e-14,77363.9,-10.8122], Tmin=(955.773,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(642.961,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOCs) + radical(C2CsJOCs) + radical(CCsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][C]1CC[C]([CH][O])O1(27745)',
    structure = SMILES('[CH2][C]1CC[C]([CH][O])O1'),
    E0 = (546.685,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.346259,0.0935402,-0.00015606,1.42378e-07,-4.83153e-11,65870.3,27.1876], Tmin=(100,'K'), Tmax=(931.181,'K')), NASAPolynomial(coeffs=[4.47073,0.0413811,-1.65587e-05,2.78239e-09,-1.73152e-13,66595.4,15.6014], Tmin=(931.181,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(546.685,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CCOJ) + radical(C2CsJOCs) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CCsJOH)"""),
)

species(
    label = '[CH]=C(C[O])O[C]([CH2])[CH2](27746)',
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.122286,0.096093,-0.000133082,9.91955e-08,-2.95983e-11,73449.8,32.7635], Tmin=(100,'K'), Tmax=(819.875,'K')), NASAPolynomial(coeffs=[13.1709,0.0312446,-1.44501e-05,2.74134e-09,-1.89852e-13,71269.9,-28.7295], Tmin=(819.875,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(609.503,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCOJ) + radical(C2CsJOC(O)) + radical(C=C(O)CJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]=C([CH][O])OC([CH2])[CH2](27747)',
    structure = SMILES('[CH]C(=C[O])OC([CH2])[CH2]'),
    E0 = (460.653,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3010,987.5,1337.5,450,1655,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.13637,0.10419,-0.000110561,5.2031e-08,-7.47369e-12,55596.7,32.2128], Tmin=(100,'K'), Tmax=(942.38,'K')), NASAPolynomial(coeffs=[24.1327,0.017541,-5.44152e-06,8.71062e-10,-5.75138e-14,49919,-93.0513], Tmin=(942.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(460.653,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C([CH]O)O[C]([CH2])[CH2](27748)',
...
species(
    label = '[CH]=C([CH][O])O[C]([CH2])C(27749)',
    structure = SMILES('[CH]C(=C[O])O[C]([CH2])C'),
    E0 = (450.358,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,350,440,435,1725,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.997778,0.101243,-0.000112406,6.18582e-08,-1.31801e-11,54353,34.1539], Tmin=(100,'K'), Tmax=(1157.61,'K')), NASAPolynomial(coeffs=[22.5275,0.0199531,-7.0714e-06,1.19518e-09,-7.89976e-14,48906.4,-82.7848], Tmin=(1157.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(450.358,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C2CsJOC(O)) + radical(CJC(C)OC) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH2][C]([CH][O])O[C]1CC1(27751)',
    structure = SMILES('[CH2][C]([CH][O])O[C]1CC1'),
    E0 = (636.562,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.247656,0.112957,-0.000215627,2.10617e-07,-7.61145e-11,76695.1,32.3406], Tmin=(100,'K'), Tmax=(878.793,'K')), NASAPolynomial(coeffs=[4.07436,0.0467444,-2.31692e-05,4.35188e-09,-2.9195e-13,77732.6,22.2727], Tmin=(878.793,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(636.562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCOJ) + radical(C2CsJOCs) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CCsJOH)"""),
)

species(
    label = '[CH2][C]1[CH]OC[C]([CH2])O1(27752)',
    structure = SMILES('[CH2][C]1[CH]OC[C]([CH2])O1'),
    E0 = (551.053,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
...
species(
    label = '[CH]=C(C)O[C]([CH2])[CH][O](27753)',
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.12937,0.0967784,-0.00010808,5.73176e-08,-1.14498e-11,57483.5,34.7678], Tmin=(100,'K'), Tmax=(1343.9,'K')), NASAPolynomial(coeffs=[25.7179,0.0090643,-1.46577e-06,1.07682e-10,-3.33484e-15,50972.4,-100.068], Tmin=(1343.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(476.296,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C2CsJOC(O)) + radical(C=C(O)CJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]=C([CH2])OC([CH2])[CH][O](27754)',
    structure = SMILES('[CH]C(=C)OC([CH2])[CH][O]'),
    E0 = (563.648,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,350,440,435,1725,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.523392,0.105062,-0.000142608,1.06273e-07,-3.19024e-11,67949,32.8076], Tmin=(100,'K'), Tmax=(813.807,'K')), NASAPolynomial(coeffs=[13.3755,0.0367468,-1.66893e-05,3.12033e-09,-2.13986e-13,65686.8,-31.383], Tmin=(813.807,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(563.648,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCOJ) + radical(CJC(C)OC) + radical(CCsJOH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C([CH2])O[C](C)[CH][O](27755)',
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.936698,0.103049,-0.000127776,7.64555e-08,-1.75256e-11,63673,33.83], Tmin=(100,'K'), Tmax=(1081.7,'K')), NASAPolynomial(coeffs=[22.9749,0.014626,-5.15732e-06,8.82869e-10,-5.91883e-14,58500,-83.4073], Tmin=(1081.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(527.889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C2CsJOC(O)) + radical(CJC(C)OC) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]=C([CH2])O[C]([CH2])C[O](27756)',
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.468584,0.106297,-0.000158075,1.31635e-07,-4.38415e-11,70340,34.5513], Tmin=(100,'K'), Tmax=(822.555,'K')), NASAPolynomial(coeffs=[10.9142,0.0405203,-1.91166e-05,3.60571e-09,-2.46934e-13,68820.1,-15.9968], Tmin=(822.555,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(583.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCOJ) + radical(C2CsJOC(O)) + radical(CJC(C)OC) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C([CH2])O[C]([CH2])[CH]O(27757)',
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.07582,0.117473,-0.000175737,1.36857e-07,-4.18495e-11,64902.8,35.4206], Tmin=(100,'K'), Tmax=(846.354,'K')), NASAPolynomial(coeffs=[16.2119,0.0309251,-1.37633e-05,2.51025e-09,-1.68093e-13,62150,-44.0738], Tmin=(846.354,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(538.159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C2CsJOC(O)) + radical(CCsJOH) + radical(CJC(C)OC) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH2][C]O[C]([CH2])[CH2](27758)',
    structure = SMILES('[CH2][C]O[C]([CH2])[CH2]'),
    E0 = (966.597,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.201842,0.108854,-0.000215098,2.00633e-07,-6.8817e-11,116391,26.0899], Tmin=(100,'K'), Tmax=(899.403,'K')), NASAPolynomial(coeffs=[9.16243,0.0276699,-1.37626e-05,2.52052e-09,-1.63734e-13,116305,-9.20455], Tmin=(899.403,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(966.597,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CJCO) + radical(CH2_triplet)"""),
)

species(
    label = '[CH2]C1([CH2])OC1([CH2])C=O(27759)',
    structure = SMILES('[CH2]C1([CH2])OC1([CH2])C=O'),
    E0 = (335.794,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.782596,0.110668,-0.000143498,6.69729e-08,2.59937e-12,40554.2,26.188], Tmin=(100,'K'), Tmax=(672.002,'K')), NASAPolynomial(coeffs=[21.2239,0.0131978,-7.53581e-07,-4.10861e-10,5.32759e-14,36839.7,-76.8645], Tmin=(672.002,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(335.794,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-(Cds-O2d)CsCsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2][C]([CH2])OC([CH2])[C]=O(27760)',
    structure = SMILES('[CH2][C]([CH2])OC([CH2])[C]=O'),
    E0 = (547.857,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,360,370,350,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,1855,455,950,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.978119,0.124059,-0.000225121,2.01378e-07,-6.759e-11,66057.4,36.4684], Tmin=(100,'K'), Tmax=(891.851,'K')), NASAPolynomial(coeffs=[11.9191,0.0328617,-1.56417e-05,2.85866e-09,-1.8752e-13,65083.4,-16.8405], Tmin=(891.851,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(547.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CCCJ=O)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    products = ['CH2CCHO(16849)', '[CH2]C(=C)[O](2372)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    ...
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[CH2][C]([CH2])O[C]=C[O](12275)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(4)', '[CH]=C([CH2])O[C]([CH2])[CH2](27725)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]=C([CH2])O[C]([CH2])[CH][O](25987)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C(=C[O])O[C]([CH2])[CH2](27726)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    products = ['[CH2]C1([CH2])CC(=C[O])O1(27727)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    products = ['[CH2][C]([CH2])OC1=COC1(27728)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    products = ['[CH2][C]([CH2])OC(C)=C=O(27729)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    products = ['[CH2]C(=C=O)OC([CH2])[CH2](27730)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    products = ['[CH2][C]([CH2])O[C]1CC1[O](27731)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    products = ['[CH2][C]([CH2])OC1([CH2])[CH]O1(27732)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    products = ['[CH2][C]1CC([O])[C]([CH2])O1(27734)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(8.98918e+10,'s^-1'), n=0.314867, Ea=(119.809,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R5_linear;doublebond_intra;radadd_intra_cs2H]
Euclidian distance = 0
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    products = ['[CH2][C]1CC([CH2])([CH][O])O1(27736)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(2.60037e+08,'s^-1'), n=1.00802, Ea=(187.869,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R5;doublebond_intra;radadd_intra_cs2H]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Exocyclic
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH2][C]([CH2])OC([CH2])=C=O(27737)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][C]=C[O](16852)', '[CH2]C(=C)[O](2372)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2][C]=C[O](16852)', '[CH2][C]([CH2])[O](15953)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2][C]([CH2])OC([CH2])=[C][O](27738)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2][C]([CH2])OC([CH2])=[C]O(27739)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2][C]([CH2])OC(C)=[C][O](27740)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(=[C][O])OC([CH2])[CH2](27741)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2][C](C)OC([CH2])=[C][O](27742)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    products = ['[CH2]C(=C)OC([CH2])=C[O](25960)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH][O](1548)', '[CH2][C]([CH2])O[C]=C(2589)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    products = ['[CH2]C1([CH2])OC(=C)C1[O](27743)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(8.33681e+07,'s^-1'), n=1.1093, Ea=(187.869,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra;radadd_intra_cs]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic
Ea raised from 187.3 to 187.9 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    products = ['[CH2][C]([CH2])O[C]1[CH]OC1(27744)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    products = ['[CH2][C]1CC[C]([CH][O])O1(27745)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]=C(C[O])O[C]([CH2])[CH2](27746)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]=C([CH][O])OC([CH2])[CH2](27747)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]=C([CH]O)O[C]([CH2])[CH2](27748)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH]=C([CH][O])O[C]([CH2])C(27749)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2][C][CH][O](17607)', '[CH2]C(=C)[O](2372)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction38',
    reactants = ['CH2(T)(20)', '[CH2][C]([CH][O])O[C]=C(26952)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    products = ['[CH2][C]([CH][O])O[C]1CC1(27751)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    products = ['[CH2][C]1[CH]OC[C]([CH2])O1(27752)'],
    transitionState = 'TS41',
    kinetics = Arrhenius(A=(4.9903e+10,'s^-1'), n=0.243684, Ea=(101.953,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6_linear;doublebond_intra;radadd_intra] for rate rule [R6_linear;doublebond_intra;radadd_intra_O]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Endocyclic
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.41198,'m^3/(mol*s)'), n=2.03228, Ea=(33.2043,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction45',
    reactants = ['[CH]=C(C)O[C]([CH2])[CH][O](27753)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH]=C([CH2])OC([CH2])[CH][O](27754)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH]=C([CH2])O[C](C)[CH][O](27755)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH]=C([CH2])O[C]([CH2])C[O](27756)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH]=C([CH2])O[C]([CH2])[CH]O(27757)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction50',
    reactants = ['HCO(1372)', '[CH2][C]O[C]([CH2])[CH2](27758)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
    products = ['[CH2]C1([CH2])OC1([CH2])C=O(27759)'],
...
reaction(
    label = 'reaction53',
    reactants = ['[CH2][C]([CH2])OC([CH2])[C]=O(27760)'],
    products = ['[CH2][C]([CH][O])OC([CH2])=C(25964)'],
...
network(
    label = 'PDepNetwork #6660',
    isomers = [
        '[CH2][C]([CH][O])OC([CH2])=C(25964)',
    ],
    reactants = [
