...
species(
    ...
    molecularWeight = (61.0599,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.64579,0.0291919,-1.96295e-05,6.94667e-09,-1.03311e-12,1372.92,15.2463], Tmin=(100,'K'), Tmax=(1505.34,'K')), NASAPolynomial(coeffs=[7.52066,0.0162384,-6.72204e-06,1.23043e-09,-8.37886e-14,-94.7621,-10.2661], Tmin=(1505.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.0077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCsJOOH)"""),
)
...
species(
    ...
    molecularWeight = (61.0599,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.44847,0.0313149,-2.37472e-05,9.50341e-09,-1.55883e-12,4191.03,17.4641], Tmin=(100,'K'), Tmax=(1426.95,'K')), NASAPolynomial(coeffs=[8.63689,0.0139676,-5.51186e-06,9.83891e-10,-6.62177e-14,2424.92,-14.5917], Tmin=(1426.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(34.3631,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), label="""CH2CH2OOH""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CH3CH2OO(25)'],
    products = ['O2(2)', 'C2H5(14)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'CH3OO(44)'],
    products = ['CH3CH2OO(25)'],
    transitionState = 'TS2',
