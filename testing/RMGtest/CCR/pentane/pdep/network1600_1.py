...
species(
    label = '[CH][CH]OC[C][CH2](7241)',
    structure = SMILES('[CH][CH]OC[C][CH2]'),
    E0 = (984.98,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.707057,0.0761664,-0.000106959,8.00379e-08,-2.38104e-11,118581,27.197], Tmin=(100,'K'), Tmax=(824.76,'K')), NASAPolynomial(coeffs=[11.6652,0.0230221,-1.03077e-05,1.91565e-09,-1.30777e-13,116773,-23.5589], Tmin=(824.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(984.98,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(RCCJ) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20601,0.0648005,-7.72402e-05,4.98759e-08,-1.30997e-11,122439,27.2899], Tmin=(100,'K'), Tmax=(920.703,'K')), NASAPolynomial(coeffs=[10.508,0.0243886,-1.14026e-05,2.20453e-09,-1.55561e-13,120726,-16.8182], Tmin=(920.703,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1017.2,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJ) + radical(CH2_triplet) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.839892,0.0538908,-9.07934e-06,-4.00225e-08,2.29999e-11,45612.9,23.1172], Tmin=(100,'K'), Tmax=(932.758,'K')), NASAPolynomial(coeffs=[20.4686,0.0094394,-1.47619e-06,2.00526e-10,-1.79059e-14,40223.1,-79.4765], Tmin=(932.758,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(378.182,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][CH]O[CH]C[CH2](7246)',
    structure = SMILES('[CH][CH]O[CH]C[CH2]'),
    E0 = (717.22,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.448351,0.0802474,-0.000107018,7.452e-08,-2.04391e-11,86387.7,27.6654], Tmin=(100,'K'), Tmax=(896.492,'K')), NASAPolynomial(coeffs=[13.5776,0.0216641,-8.99286e-06,1.621e-09,-1.09159e-13,84033.7,-34.2404], Tmin=(896.492,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(717.22,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(RCCJ) + radical(CCsJOCs) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]CO[CH][CH][CH2](7247)',
    structure = SMILES('[CH]CO[CH][CH][CH2]'),
    E0 = (736.666,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02694,0.0670141,-7.55995e-05,4.64485e-08,-1.15575e-11,88706.2,28.6414], Tmin=(100,'K'), Tmax=(973.262,'K')), NASAPolynomial(coeffs=[11.2741,0.0248999,-1.06935e-05,1.98958e-09,-1.37556e-13,86711.6,-20.5176], Tmin=(973.262,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(736.666,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CCsJOCs) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH][CH]OC[CH][CH2](1887)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH][CH](6981)', '[CH2][CH]C[O](1367)'],
    products = ['[CH][CH]OC[CH][CH2](1887)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH][CH2](502)', '[CH][CH]O[CH2](6982)'],
    products = ['[CH][CH]OC[CH][CH2](1887)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH][CH]OC[C][CH2](7241)'],
    products = ['[CH][CH]OC[CH][CH2](1887)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH][CH]CO[CH][CH](7242)'],
    products = ['[CH][CH]OC[CH][CH2](1887)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH][C]OC[CH][CH2](7243)'],
    products = ['[CH][CH]OC[CH][CH2](1887)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]=CO[CH][CH][CH2](7143)'],
    products = ['[CH][CH]OC[CH][CH2](1887)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.82396,'m^3/(mol*s)'), n=2.03228, Ea=(101.175,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 98.4 to 101.2 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH][CH]O[CH][CH][CH2](7245)'],
    products = ['[CH][CH]OC[CH][CH2](1887)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH][CH]OC[CH][CH2](1887)'],
    products = ['[CH][CH]O[CH]C[CH2](7246)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]CO[CH][CH][CH2](7247)'],
    products = ['[CH][CH]OC[CH][CH2](1887)'],
