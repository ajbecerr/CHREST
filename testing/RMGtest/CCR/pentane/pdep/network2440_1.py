...
species(
    label = '[CH]C([CH2])O[C]=[CH](9836)',
    structure = SMILES('[CH]C([CH2])O[C]=[CH]'),
    E0 = (923.635,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.540997,0.0724418,-9.06096e-05,5.41412e-08,-1.2141e-11,111215,27.2863], Tmin=(100,'K'), Tmax=(958.738,'K')), NASAPolynomial(coeffs=[17.1375,0.0098367,-3.04588e-06,4.74739e-10,-3.00948e-14,107728,-53.674], Tmin=(958.738,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(923.635,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(CCJ2_triplet) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]OC([CH2])[C]C(10327)',
    structure = SMILES('[CH]=[C]OC([CH2])[C]C'),
    E0 = (899.855,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.123521,0.0874372,-0.000105206,6.32057e-08,-1.47243e-11,108379,30.8184], Tmin=(100,'K'), Tmax=(1059.19,'K')), NASAPolynomial(coeffs=[18.3127,0.0178138,-6.60772e-06,1.14714e-09,-7.67425e-14,104473,-59.1861], Tmin=(1059.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(899.855,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(CCJ2_triplet) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH]C([CH]C)O[C]=[CH](10328)',
    structure = SMILES('[CH]C([CH]C)O[C]=[CH]'),
    E0 = (889.247,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.365441,0.070154,-5.56048e-05,1.24076e-08,2.95873e-12,107091,32.905], Tmin=(100,'K'), Tmax=(967.719,'K')), NASAPolynomial(coeffs=[18.733,0.0159532,-5.25851e-06,9.1703e-10,-6.4552e-14,102519,-60.3597], Tmin=(967.719,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(889.247,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(CCJ2_triplet) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[C]=[C]OC([CH2])[CH]C(10329)',
    structure = SMILES('[C]=[C]OC([CH2])[CH]C'),
    E0 = (962.548,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.221101,0.0812861,-9.49242e-05,5.64735e-08,-1.3167e-11,115905,32.1489], Tmin=(100,'K'), Tmax=(1052.7,'K')), NASAPolynomial(coeffs=[16.2705,0.0203026,-8.02905e-06,1.44385e-09,-9.8414e-14,112526,-46.1047], Tmin=(1052.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(962.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(CJC(C)OC) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)

species(
    label = '[CH]=[C]OC1CC1C(10330)',
    structure = SMILES('[CH]=[C]OC1CC1C'),
    E0 = (394.685,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.924591,0.0478494,2.24138e-05,-7.39045e-08,3.47092e-11,47598.5,25.9786], Tmin=(100,'K'), Tmax=(940.81,'K')), NASAPolynomial(coeffs=[20.624,0.0139724,-3.0982e-06,5.25429e-10,-4.32172e-14,41684.4,-79.5894], Tmin=(940.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(394.685,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]O[C](C)[CH]C(10162)',
    structure = SMILES('[CH]=[C]O[C](C)[CH]C'),
    E0 = (641.248,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.367516,0.0749721,-7.45097e-05,3.81012e-08,-7.71815e-12,77259.2,32.6998], Tmin=(100,'K'), Tmax=(1199.5,'K')), NASAPolynomial(coeffs=[16.1192,0.0224441,-8.82186e-06,1.59247e-09,-1.08953e-13,73480.4,-46.1584], Tmin=(1199.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(641.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C2CsJOC(O)) + radical(CCJCO) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=[CH](9646)', '[CH2]C([O])[CH]C(1585)'],
    products = ['[CH]=[C]OC([CH2])[CH]C(4268)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHCH3(T)(21)', '[CH]=[C]O[CH][CH2](9651)'],
    products = ['[CH]=[C]OC([CH2])[CH]C(4268)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[CH]=[C]O[CH][CH]C(9719)'],
    products = ['[CH]=[C]OC([CH2])[CH]C(4268)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH]C([CH2])O[C]=[CH](9836)'],
    products = ['[CH]=[C]OC([CH2])[CH]C(4268)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]=[C]OC([CH2])[C]C(10327)'],
    products = ['[CH]=[C]OC([CH2])[CH]C(4268)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C([CH]C)O[C]=[CH](10328)'],
    products = ['[CH]=[C]OC([CH2])[CH]C(4268)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[C]=[C]OC([CH2])[CH]C(10329)'],
    products = ['[CH]=[C]OC([CH2])[CH]C(4268)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH]=[C]OC([CH2])=CC(10333)'],
    products = ['[CH]=[C]OC([CH2])[CH]C(4268)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(20)', 'C#CO[CH][CH]C(7377)'],
    products = ['[CH]=[C]OC([CH2])[CH]C(4268)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CHCH3(T)(21)', 'C#CO[CH][CH2](3100)'],
    products = ['[CH]=[C]OC([CH2])[CH]C(4268)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.41198,'m^3/(mol*s)'), n=2.03228, Ea=(36.2402,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH]=[C]O[C]([CH2])[CH]C(10334)'],
    products = ['[CH]=[C]OC([CH2])[CH]C(4268)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=[C]O[C]([CH2])CC(9770)'],
    products = ['[CH]=[C]OC([CH2])[CH]C(4268)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]=[C]OC([CH2])[CH]C(4268)'],
    products = ['[CH]=[C]O[C](C)[CH]C(10162)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]=[C]OC([CH2])[CH]C(4268)'],
    products = ['[CH2][C]([CH]C)O[C]=C(4267)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=[C]OC([CH2])[CH]C(4268)'],
    products = ['[CH]=[C]OC(C)[CH][CH2](4194)'],
