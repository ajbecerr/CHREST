...
species(
    label = '[CH]C([CH]C)OC=[C][O](12947)',
    structure = SMILES('[CH]C([CH]C)OC=[C][O]'),
    E0 = (574.821,'kJ/mol'),
    modes = [
...
species(
    label = 'CC1CC1OC=[C][O](12948)',
    structure = SMILES('CC1CC1OC=[C][O]'),
    E0 = (80.2587,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
...
species(
    label = '[CH2]C(=CC)OC=[C][O](12949)',
    structure = SMILES('[CH2]C(=CC)O[CH][C]=O'),
    E0 = (177.602,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,1855,455,950,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.493045,0.0886994,-9.58413e-05,5.07034e-08,-1.03303e-11,21531,31.6735], Tmin=(100,'K'), Tmax=(1212.75,'K')), NASAPolynomial(coeffs=[21.7263,0.0154127,-5.19505e-06,8.7325e-10,-5.80855e-14,16141.7,-79.8077], Tmin=(1212.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(177.602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(C=C(O)CJ) + radical(CCsJOC(O)) + radical(CsCJ=O)"""),
)
...
species(
    label = '[CH2][C]([CH]C)OC=[C][O](12950)',
    structure = SMILES('[CH2][C]([CH]C)O[CH][C]=O'),
    E0 = (528.17,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,1855,455,950,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.40811,0.1061,-0.000172313,1.47207e-07,-4.8769e-11,63674.1,36.1733], Tmin=(100,'K'), Tmax=(859.568,'K')), NASAPolynomial(coeffs=[11.6996,0.0329932,-1.54828e-05,2.88325e-09,-1.94396e-13,62212,-16.8046], Tmin=(859.568,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(528.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(C2CsJOCs) + radical(CCJCO) + radical(CJC(C)OC) + radical(CCsJOCs) + radical(CsCJ=O)"""),
)

species(
    label = '[CH2][CH]C([CH2])O[CH][C]=O(11350)',
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.0139,0.106955,-0.000135401,8.38976e-08,-2.00115e-11,47171.6,32.0901], Tmin=(100,'K'), Tmax=(1037.85,'K')), NASAPolynomial(coeffs=[22.1143,0.0178158,-6.56637e-06,1.13971e-09,-7.6357e-14,42370.9,-80.3489], Tmin=(1037.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(390.681,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(O)CJ) + radical(CCsJOC(O)) + radical(CH2_triplet)"""),
)
...
species(
    label = '[CH2][CH]C([CH2])OC=[C]O(12826)',
    structure = SMILES('[CH2][CH]C([CH2])OC=[C]O'),
    E0 = (400.9,'kJ/mol'),
    modes = [
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0100445,0.0777239,-6.35635e-05,2.12691e-08,-1.10465e-12,-1811.14,30.3932], Tmin=(100,'K'), Tmax=(1037.73,'K')), NASAPolynomial(coeffs=[18.561,0.0229822,-8.66876e-06,1.57081e-09,-1.09542e-13,-6563.98,-64.1408], Tmin=(1037.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-16.3255,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(C=C(O)CJ) + radical(CsCJ=O)"""),
)

species(
    label = '[CH2]C(C=C)OC[C]=O(11237)',
    structure = SMILES('[CH2]C(C=C)OC[C]=O'),
    E0 = (92.4617,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.461842,0.0788741,-7.55801e-05,3.82778e-08,-7.94529e-12,11247.1,31.8574], Tmin=(100,'K'), Tmax=(1143.73,'K')), NASAPolynomial(coeffs=[13.7123,0.032532,-1.48016e-05,2.85013e-09,-2.01282e-13,8216.14,-33.8479], Tmin=(1143.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.4617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(CsCJ=O)"""),
)

species(
    label = '[CH2][C]([CH]C)OC[C]=O(12953)',
    structure = SMILES('[CH2][C]([CH]C)OC[C]=O'),
    E0 = (347.714,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1855,455,950,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0734599,0.0987039,-0.000151948,1.32278e-07,-4.55941e-11,41958.2,34.8329], Tmin=(100,'K'), Tmax=(833.014,'K')), NASAPolynomial(coeffs=[8.77477,0.0406278,-1.93011e-05,3.65551e-09,-2.50556e-13,41024.9,-2.99179], Tmin=(833.014,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(347.714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(C2CsJOCs) + radical(CCJCO) + radical(CJC(C)OC) + radical(CsCJ=O)"""),
)

species(
    label = '[CH2][CH]C([CH2])OC[C]=O(12829)',
    structure = SMILES('[CH2][CH]C([CH2])OC[C]=O'),
    E0 = (372.256,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1855,455,950,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.353168,0.0850353,-9.74301e-05,6.23468e-08,-1.64708e-11,44899.3,35.1594], Tmin=(100,'K'), Tmax=(909.898,'K')), NASAPolynomial(coeffs=[11.4873,0.0360888,-1.67402e-05,3.2269e-09,-2.27347e-13,42873.1,-17.5051], Tmin=(909.898,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(372.256,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(CJC(C)OC) + radical(RCCJ) + radical(CsCJ=O)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CHCH3(T)(21)', '[CH2][CH]O[CH][C]=O(2797)'],
    products = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', 'C[CH][CH]OC=[C][O](11604)'],
    products = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH]C([CH2])OC=[C][O](12361)'],
    products = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH2]C([C]C)OC=[C][O](12946)'],
    products = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C([CH]C)OC=[C][O](12947)'],
    products = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]C(=CC)OC=[C][O](12949)'],
    products = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2]C(C=C)O[CH][C]=O(11252)'],
    products = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(20)', 'CC=COC=[C][O](11603)'],
    products = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CHCH3(T)(21)', 'C=CO[CH][C]=O(2661)'],
    products = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
...
reaction(
    label = 'reaction22',
    reactants = ['HCCO(2227)', '[CH2]C([O])[CH]C(1585)'],
    products = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=[C][O](6861)', '[CH2]C([O])[CH]C(1585)'],
    products = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2][C]([CH]C)OC=[C][O](12950)'],
    products = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2][CH]C([CH2])O[CH][C]=O(11350)'],
    products = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
    products = ['[CH2][C](CC)OC=[C][O](11758)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
    products = ['C[CH][C](C)OC=[C][O](12443)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]CC([CH2])OC=[C][O](11759)'],
    products = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
    products = ['[CH2][CH]C(C)O[CH][C]=O(11234)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2][C]([CH]C)OC=[C]O(12951)'],
    products = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2][CH]C([CH2])OC=[C]O(12826)'],
    products = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
    products = ['[CH2]C(=CC)OC[C]=O(12952)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
    products = ['[CH2]C(C=C)OC[C]=O(11237)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2][C]([CH]C)OC[C]=O(12953)'],
    products = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2][CH]C([CH2])OC[C]=O(12829)'],
    products = ['[CH2]C([CH]C)O[CH][C]=O(11212)'],
