species(
    label = '[CH]C([O])C[C]=C(15547)',
    structure = SMILES('[CH]C([O])C[C]=C'),
    E0 = (703.645,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2950,3100,1380,975,1025,1650,1685,370,180,771.676,771.724,771.866,771.966,1973.29],'cm^-1')),
        HinderedRotor(inertia=(0.188366,'amu*angstrom^2'), symmetry=1, barrier=(4.33091,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.597797,'amu*angstrom^2'), symmetry=1, barrier=(13.7445,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0697558,'amu*angstrom^2'), symmetry=1, barrier=(13.7425,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47996,0.0547954,-5.06126e-05,2.50682e-08,-5.08959e-12,84720.2,25.0131], Tmin=(100,'K'), Tmax=(1170.56,'K')), NASAPolynomial(coeffs=[10.7977,0.022956,-9.81352e-06,1.83262e-09,-1.27222e-13,82538.8,-21.407], Tmin=(1170.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(703.645,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22791,0.0538671,-4.357e-05,1.53762e-08,-1.38068e-12,48150.5,25.1604], Tmin=(100,'K'), Tmax=(1083.51,'K')), NASAPolynomial(coeffs=[13.8755,0.0172004,-6.6871e-06,1.22171e-09,-8.50284e-14,44821.2,-39.587], Tmin=(1083.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(399.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C([O])C=C=C(16584)',
    structure = SMILES('[CH]C([O])C=C=C'),
    E0 = (629.826,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,540,610,2055,180,479.215,773.144,773.17,773.175],'cm^-1')),
        HinderedRotor(inertia=(0.033507,'amu*angstrom^2'), symmetry=1, barrier=(14.1973,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.617505,'amu*angstrom^2'), symmetry=1, barrier=(14.1977,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40739,0.0496822,-3.70264e-05,9.56826e-09,5.27578e-13,75850.2,24.3241], Tmin=(100,'K'), Tmax=(1058.97,'K')), NASAPolynomial(coeffs=[13.6934,0.0156007,-6.21039e-06,1.15962e-09,-8.21255e-14,72557,-38.9162], Tmin=(1058.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(629.826,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CC(C)OJ) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C([O])CC#C(16585)',
    structure = SMILES('[CH]C([O])CC#C'),
    E0 = (631.907,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2175,525,750,770,3400,2100,180,507.403,507.405,507.409,507.41],'cm^-1')),
        HinderedRotor(inertia=(0.013315,'amu*angstrom^2'), symmetry=1, barrier=(2.43259,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0133197,'amu*angstrom^2'), symmetry=1, barrier=(2.43377,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.337126,'amu*angstrom^2'), symmetry=1, barrier=(61.5952,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25722,0.0564575,-5.95794e-05,3.32119e-08,-7.29858e-12,76102.9,23.1787], Tmin=(100,'K'), Tmax=(1115.85,'K')), NASAPolynomial(coeffs=[12.4836,0.0162133,-5.47956e-06,8.89331e-10,-5.67652e-14,73597.5,-32.2128], Tmin=(1115.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(631.907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CC(C)OJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.078,0.0685372,-9.72845e-05,7.76503e-08,-2.49145e-11,78267.6,26.0724], Tmin=(100,'K'), Tmax=(820.787,'K')), NASAPolynomial(coeffs=[9.1141,0.0254684,-1.14375e-05,2.12523e-09,-1.44704e-13,77079.9,-10.3086], Tmin=(820.787,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(649.912,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C2CsJOH) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07721,0.062988,-6.50806e-05,3.49683e-08,-7.51859e-12,71091.2,23.8505], Tmin=(100,'K'), Tmax=(1124.93,'K')), NASAPolynomial(coeffs=[12.9334,0.02083,-8.86649e-06,1.65413e-09,-1.14986e-13,68423.7,-34.7445], Tmin=(1124.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(590.201,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CCJCO) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(O)C[C]=[CH](16589)',
    structure = SMILES('[CH]C(O)C[C]=[CH]'),
    E0 = (720.381,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,1685,370,3120,650,792.5,1650,180,564.081,564.351,1947.59],'cm^-1')),
        HinderedRotor(inertia=(0.0137708,'amu*angstrom^2'), symmetry=1, barrier=(3.10792,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0488181,'amu*angstrom^2'), symmetry=1, barrier=(11.0169,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0488156,'amu*angstrom^2'), symmetry=1, barrier=(11.0166,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.479127,'amu*angstrom^2'), symmetry=1, barrier=(11.0161,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27049,0.061914,-7.14793e-05,4.49764e-08,-1.14554e-11,86738.5,26.366], Tmin=(100,'K'), Tmax=(951.8,'K')), NASAPolynomial(coeffs=[10.5667,0.0228462,-9.90989e-06,1.85147e-09,-1.2823e-13,84968.9,-18.0236], Tmin=(951.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(720.381,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H2CC(T)(1341)', '[CH]C([CH2])[O](6989)'],
    products = ['[CH]C([O])C[C]=C(15547)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(4)', '[CH]=CC[C][CH2](15110)'],
    products = ['[CH]C([O])C[C]=C(15547)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]C([O])C=C=C(16584)'],
    products = ['[CH]C([O])C[C]=C(15547)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH]=C([O])C[C]=C(15562)'],
    products = ['[CH]C([O])C[C]=C(15547)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]C([O])CC#C(16585)'],
    products = ['[CH]C([O])C[C]=C(15547)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH](6993)', 'C=[C]CC=O(15522)'],
    products = ['[CH]C([O])C[C]=C(15547)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH][CH][O](6986)', 'allene(458)'],
    products = ['[CH]C([O])C[C]=C(15547)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(4679.9,'m^3/(mol*s)'), n=0.573452, Ea=(157.662,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 153.5 to 157.7 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH]=C([O])C[C][CH2](9863)'],
    products = ['[CH]C([O])C[C]=C(15547)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH]C([O])C[C]=[CH](16586)'],
    products = ['[CH]C([O])C[C]=C(15547)'],
