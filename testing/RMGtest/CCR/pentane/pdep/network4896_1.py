...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.307295,0.0857352,-0.000131369,1.01366e-07,-3.05711e-11,83649.4,24.6634], Tmin=(100,'K'), Tmax=(817.973,'K')), NASAPolynomial(coeffs=[13.9404,0.0190681,-9.11605e-06,1.72737e-09,-1.18593e-13,81419.1,-38.3693], Tmin=(817.973,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(694.43,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCOJ) + radical(CCsJOH) + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'C#COC[C][C]O[O](23343)',
    structure = SMILES('C#COC[C][C]O[O]'),
    E0 = (972.925,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,2175,525,750,770,3400,2100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.423572,0.0991783,-0.000149377,1.05471e-07,-2.84332e-11,117174,27.13], Tmin=(100,'K'), Tmax=(921.301,'K')), NASAPolynomial(coeffs=[20.017,0.0104333,-4.89067e-06,9.20587e-10,-6.33158e-14,113407,-69.8087], Tmin=(921.301,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(972.925,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(ROOJ) + radical(CCJ2_triplet) + radical(CH2_triplet)"""),
)

species(
    label = 'C#COC[C]C1OO1(23344)',
    ...
    molecularWeight = (112.083,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.14652,0.0850701,-9.32862e-05,4.65747e-08,-8.45123e-12,58229.7,30.1913], Tmin=(100,'K'), Tmax=(1610.88,'K')), NASAPolynomial(coeffs=[24.9046,0.00099383,3.0569e-06,-7.68804e-10,5.58103e-14,52352.2,-100.103], Tmin=(1610.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(482.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Ct-CtOs) + group(Ct-CtH) + ring(dioxirane) + radical(CCJ2_triplet)"""),
)

species(
    label = '[O]OC1[C]CO[C]=C1(23345)',
    structure = SMILES('[O]OC1[C]CO[C]=C1'),
    E0 = (584.276,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.083,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32988,0.0461809,-3.82556e-06,-3.70904e-08,2.04845e-11,70379.9,24.906], Tmin=(100,'K'), Tmax=(922.58,'K')), NASAPolynomial(coeffs=[16.4721,0.0130501,-2.83388e-06,4.00908e-10,-2.83588e-14,66201.9,-54.4268], Tmin=(922.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(584.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(3,4-Dihydro-2H-pyran) + radical(ROOJ) + radical(CCJ2_triplet) + radical(C=CJO)"""),
)

species(
    label = '[C]1[CH]OOC=[C]OC1(23346)',
    structure = SMILES('[C]1[CH]OOC=[C]OC1'),
    E0 = (686.548,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.083,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45635,0.0352535,4.19217e-05,-8.68738e-08,3.72739e-11,82683,23.6823], Tmin=(100,'K'), Tmax=(960.33,'K')), NASAPolynomial(coeffs=[19.0564,0.0133455,-4.14446e-06,8.40307e-10,-6.97136e-14,76932.5,-72.8557], Tmin=(960.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(686.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + ring(Cyclooctane) + radical(CCsJOOC) + radical(CCJ2_triplet) + radical(C=CJO)"""),
)

species(
    label = '[CH]=C1OC[C]C1O[O](23347)',
    ...
    molecularWeight = (112.083,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01939,0.0456406,1.63824e-05,-6.94275e-08,3.40577e-11,71839.3,26.911], Tmin=(100,'K'), Tmax=(934.633,'K')), NASAPolynomial(coeffs=[22.4125,0.00477726,6.05093e-07,-1.40846e-10,1.74251e-15,65626.2,-86.6973], Tmin=(934.633,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(596.261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(ROOJ) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C1OC[C][CH]OO1(23348)',
    structure = SMILES('[CH]=C1OC[C][CH]OO1'),
    E0 = (729.925,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.083,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.698084,0.0275695,0.000125909,-2.29015e-07,1.03488e-10,87951,26.0701], Tmin=(100,'K'), Tmax=(901.263,'K')), NASAPolynomial(coeffs=[40.3914,-0.0289983,2.10024e-05,-4.17547e-09,2.76732e-13,75938.8,-188.249], Tmin=(901.263,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(729.925,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cycloheptane) + radical(CCsJOOC) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = 'C#COC[C]C=O(23349)',
    structure = SMILES('C#COC[C]=C[O]'),
    E0 = (303.89,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,1685,370,2175,525,750,770,3400,2100,180,180,180,180],'cm^-1')),
        ...
        HinderedRotor(inertia=(1.28463,'amu*angstrom^2'), symmetry=1, barrier=(29.5361,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.0841,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.239455,0.0726597,-7.89703e-05,3.92648e-08,-7.17418e-12,36719.9,26.2153], Tmin=(100,'K'), Tmax=(1560.93,'K')), NASAPolynomial(coeffs=[22.3151,0.00191624,1.45196e-06,-3.96329e-10,2.89525e-14,31255.7,-87.5889], Tmin=(1560.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.89,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Ct-CtOs) + group(Ct-CtH) + radical(C=COJ) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (111.076,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.310995,0.101091,-0.000169546,1.37373e-07,-4.23163e-11,124951,28.8801], Tmin=(100,'K'), Tmax=(901.62,'K')), NASAPolynomial(coeffs=[15.683,0.0169192,-7.52692e-06,1.3186e-09,-8.39839e-14,122604,-43.6468], Tmin=(901.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1037.66,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(ROOJ) + radical(CCsJOOH) + radical(CCJ2_triplet) + radical(Acetyl)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (112.083,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3930.09,'J/mol'), sigma=(6.59135,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=613.87 K, Pc=31.14 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    ...
    molecularWeight = (112.083,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.422682,0.102663,-0.000156585,1.15315e-07,-3.20103e-11,106674,28.5359], Tmin=(100,'K'), Tmax=(744.498,'K')), NASAPolynomial(coeffs=[17.0964,0.0189041,-8.71659e-06,1.60828e-09,-1.08301e-13,103779,-52.7441], Tmin=(744.498,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(885.658,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCsJOOH) + radical(CCJ2_triplet) + radical(Acetyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(4)', 'C#COC[C][CH][O](23342)'],
    products = ['C#COC[C][CH]O[O](20836)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O2(2)', '[CH]=[C]CO[C]=[CH](16182)'],
    products = ['C#COC[C][CH]O[O](20836)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C#COC[C][C]O[O](23343)'],
    products = ['C#COC[C][CH]O[O](20836)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['C#COC[C][CH]O[O](20836)'],
    products = ['[O]OC1[C]CO[C]=C1(23345)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C#COC[C][CH]O[O](20836)'],
    products = ['[C]1[CH]OOC=[C]OC1(23346)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C#COC[C][CH]O[O](20836)'],
    products = ['[CH]=C1OC[C]C1O[O](23347)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C#COC[C][CH]O[O](20836)'],
    products = ['[CH]=C1OC[C][CH]OO1(23348)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['O(4)', 'C#COC[C]C=O(23349)'],
    products = ['C#COC[C][CH]O[O](20836)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HC2(2881)', '[O]C[C][CH]O[O](22784)'],
    products = ['C#COC[C][CH]O[O](20836)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[C]#COC[C][CH]O[O](23350)'],
    products = ['C#COC[C][CH]O[O](20836)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1098,'s^-1'), n=2.21, Ea=(60.1659,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6Hall;Y_rad_out;Cs_H_out_H/NonDeO] for rate rule [R6Hall;Ct_rad_out;Cs_H_out_H/NonDeO]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
network(
    label = 'PDepNetwork #4896',
    isomers = [
        'C#COC[C][CH]O[O](20836)',
    ],
    reactants = [
