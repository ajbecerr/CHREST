...
species(
    label = '[C]=C([O])O[C]=C(9940)',
    structure = SMILES('[C]C(=O)O[C]=C'),
    E0 = (559.153,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2950,3100,1380,975,1025,1650,1685,370,180,180,180,427.524,874.829,874.829,874.829,874.83],'cm^-1')),
        HinderedRotor(inertia=(0.0249875,'amu*angstrom^2'), symmetry=1, barrier=(13.5705,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23475,'amu*angstrom^2'), symmetry=1, barrier=(28.3894,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.0575,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00481,0.0425635,-4.46302e-05,2.31692e-08,-4.75135e-12,67323.5,20.1832], Tmin=(100,'K'), Tmax=(1182.2,'K')), NASAPolynomial(coeffs=[11.1377,0.011662,-5.42126e-06,1.05827e-09,-7.55115e-14,65164.2,-25.4061], Tmin=(1182.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(559.153,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CJ3)"""),
)

species(
    label = 'C=[C]OC1=CO1(9941)',
    structure = SMILES('C=[C]OC1=CO1'),
    E0 = (374.78,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94297,0.0457154,-5.05509e-05,2.95145e-08,-6.91999e-12,45149.3,21.0941], Tmin=(100,'K'), Tmax=(1033.55,'K')), NASAPolynomial(coeffs=[9.7388,0.0155449,-6.76489e-06,1.27193e-09,-8.86651e-14,43537.8,-16.7737], Tmin=(1033.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.78,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=C([O])[O](9591)', 'H2CC(T)(1341)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[C]=C([O])O[C]=C(9940)'],
    products = ['[CH]C(=O)O[C]=C(2687)'],
