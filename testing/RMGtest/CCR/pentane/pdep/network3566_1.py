...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84807,0.0317585,3.29631e-05,-6.77629e-08,2.87482e-11,49105.4,21.8407], Tmin=(100,'K'), Tmax=(960.137,'K')), NASAPolynomial(coeffs=[14.4015,0.0180531,-5.91841e-06,1.09863e-09,-8.25241e-14,44915.9,-47.4754], Tmin=(960.137,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.524,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)OJ) + radical(CCJ(C)CO) + radical(CJCO)"""),
)

species(
    label = '[CH2][C]1COC1[CH2](15971)',
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91067,0.0363212,1.82832e-05,-5.93395e-08,3.06478e-11,48506.5,20.576], Tmin=(100,'K'), Tmax=(837.36,'K')), NASAPolynomial(coeffs=[12.3179,0.0170173,-1.6132e-06,-1.27564e-10,2.08225e-14,45697.4,-34.152], Tmin=(837.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(402.602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCJ(C)CO) + radical(CJC(C)OC) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][C]1CCC1[O](15972)',
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31419,0.0191291,6.69165e-05,-1.00907e-07,4.02527e-11,47776.8,21.33], Tmin=(100,'K'), Tmax=(946.28,'K')), NASAPolynomial(coeffs=[12.9486,0.0195886,-5.79677e-06,1.03487e-09,-7.7886e-14,43731,-40.1305], Tmin=(946.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(396.598,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CC(C)OJ) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['O(4)', '[CH2][C]([CH2])C=C(15109)'],
    products = ['[CH2]C(=C)C([CH2])[O](1876)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', '[CH2]C(=C)[CH][O](15968)'],
    products = ['[CH2]C(=C)C([CH2])[O](1876)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(20)', '[CH2]C([O])[C]=C(2851)'],
    products = ['[CH2]C(=C)C([CH2])[O](1876)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C]([O])C([CH2])[CH2](1880)'],
    products = ['[CH2]C(=C)C([CH2])[O](1876)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(=C)C([CH2])[O](1876)'],
    products = ['[CH2][C]1COC1[CH2](15971)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(3.24059e+09,'s^-1'), n=0.736667, Ea=(76.2317,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(T)(20)', '[CH2]C(=C)C=O(3654)'],
    products = ['[CH2]C(=C)C([CH2])[O](1876)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O(4)', '[CH2]C(=C)C=C(15106)'],
    products = ['[CH2]C(=C)C([CH2])[O](1876)'],
