species(
    ...
    E0 = (-168.084,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,330.027,330.696],'cm^-1')),
        HinderedRotor(inertia=(0.00155136,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0979119,'amu*angstrom^2'), symmetry=1, barrier=(7.60622,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0979232,'amu*angstrom^2'), symmetry=1, barrier=(7.60059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0983472,'amu*angstrom^2'), symmetry=1, barrier=(7.62087,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.1488,'amu'),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5622,0.0443733,2.36728e-06,-2.50991e-08,1.02874e-11,-20120.3,19.9091], Tmin=(100,'K'), Tmax=(1075.14,'K')), NASAPolynomial(coeffs=[9.02392,0.0365682,-1.45851e-05,2.67663e-09,-1.85597e-13,-22878.2,-21.9938], Tmin=(1075.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-168.084,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.222423,'amu*angstrom^2'), symmetry=1, barrier=(5.11395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.222107,'amu*angstrom^2'), symmetry=1, barrier=(5.10668,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.222343,'amu*angstrom^2'), symmetry=1, barrier=(5.1121,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (58.1222,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16918,0.0343905,-1.61589e-06,-1.30724e-08,5.17339e-12,-17250.5,14.6547], Tmin=(100,'K'), Tmax=(1147.61,'K')), NASAPolynomial(coeffs=[6.78908,0.0303597,-1.21262e-05,2.19944e-09,-1.50288e-13,-19105.8,-11.7332], Tmin=(1147.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-144.017,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), label="""nbutane""", comment="""Thermo library: DFT_QCI_thermo"""),
)
