...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00789347,0.100213,-0.000172438,1.58528e-07,-5.60499e-11,112605,33.311], Tmin=(100,'K'), Tmax=(847.623,'K')), NASAPolynomial(coeffs=[7.88244,0.0383072,-1.92265e-05,3.68653e-09,-2.52758e-13,112153,1.77709], Tmin=(847.623,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(935.144,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CCOJ) + radical(C2CsJOH) + radical(Cds_S) + radical(CH2_triplet)"""),
)
...
species(
    label = 'C=[C]C[CH]C([O])[CH][O](27632)',
    structure = SMILES('C=[C]C[CH]C([O])[CH][O]'),
    E0 = (677.727,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,2950,3100,1380,975,1025,1650,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.33391,0.0884485,-0.000130581,1.12856e-07,-3.92557e-11,81636.3,35.9754], Tmin=(100,'K'), Tmax=(814.368,'K')), NASAPolynomial(coeffs=[7.87308,0.0396081,-1.88687e-05,3.59721e-09,-2.48297e-13,80799.9,3.55566], Tmin=(814.368,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(677.727,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CCOJ) + radical(CCJCO) + radical(CCsJOH) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0260731,0.101695,-0.000175365,1.62397e-07,-5.73377e-11,75181.6,36.8825], Tmin=(100,'K'), Tmax=(864.363,'K')), NASAPolynomial(coeffs=[6.84489,0.0409828,-1.98259e-05,3.73034e-09,-2.52423e-13,75074,10.984], Tmin=(864.363,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(623.995,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCJCO) + radical(C2CsJOH) + radical(CCsJOH) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]C[CH][C]([O])C[O](27634)',
    structure = SMILES('C=[C]C[CH][C]([O])C[O]'),
    E0 = (674.057,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,360,370,350,2950,3100,1380,975,1025,1650,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.396646,0.0890887,-0.000138822,1.2611e-07,-4.5185e-11,81190.6,35.6237], Tmin=(100,'K'), Tmax=(833.411,'K')), NASAPolynomial(coeffs=[6.13362,0.0424365,-2.04484e-05,3.89638e-09,-2.67929e-13,80898.3,12.9747], Tmin=(833.411,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(674.057,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CC(C)OJ) + radical(CCJCO) + radical(C2CsJOH) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.200978,0.100141,-0.000156003,1.30633e-07,-4.28596e-11,75753,36.4592], Tmin=(100,'K'), Tmax=(851.929,'K')), NASAPolynomial(coeffs=[11.4046,0.0328892,-1.51237e-05,2.80788e-09,-1.89676e-13,74238.7,-14.9536], Tmin=(851.929,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(628.65,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CCJCO) + radical(C2CsJOH) + radical(CCsJOH) + radical(Cds_S)"""),
)

species(
    label = '[CH]=[C]CCC([O])[CH][O](27636)',
    structure = SMILES('[CH]=[C]CCC([O])[CH][O]'),
    E0 = (724.922,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.045981,0.0974273,-0.000156747,1.40879e-07,-4.94852e-11,87320.2,34.9145], Tmin=(100,'K'), Tmax=(841.698,'K')), NASAPolynomial(coeffs=[7.69165,0.0408214,-1.97433e-05,3.75166e-09,-2.56938e-13,86751.2,3.61181], Tmin=(841.698,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(724.922,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CCOJ) + radical(CCsJOH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = 'C=[C][CH]C[C]([O])[CH]O(27637)',
    structure = SMILES('[CH2][C]=CC[C]([O])[CH]O'),
    E0 = (568.002,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.32604,0.102806,-0.00015969,1.32855e-07,-4.33545e-11,68463.3,34.254], Tmin=(100,'K'), Tmax=(849.432,'K')), NASAPolynomial(coeffs=[11.9546,0.0329785,-1.51973e-05,2.82394e-09,-1.9091e-13,66809.8,-20.4411], Tmin=(849.432,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(568.002,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CCsJOH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH]=[C]CC[C](O)[CH][O](27638)',
    structure = SMILES('[CH]=[C]CC[C](O)[CH][O]'),
    E0 = (671.189,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.293517,0.110421,-0.000200607,1.892e-07,-6.70572e-11,80864.7,35.7491], Tmin=(100,'K'), Tmax=(873.237,'K')), NASAPolynomial(coeffs=[6.57195,0.042358,-2.07966e-05,3.90796e-09,-2.63016e-13,81061.7,11.5511], Tmin=(873.237,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(671.189,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C2CsJOH) + radical(CCsJOH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]CC[C]([O])C[O](27639)',
    structure = SMILES('[CH]=[C]CC[C]([O])C[O]'),
    E0 = (721.252,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,360,370,350,1685,370,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.119725,0.0979289,-0.000164465,1.5341e-07,-5.50919e-11,86874.1,34.524], Tmin=(100,'K'), Tmax=(851.072,'K')), NASAPolynomial(coeffs=[5.91165,0.0437222,-2.13661e-05,4.06127e-09,-2.77453e-13,86865.6,13.2569], Tmin=(851.072,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(721.252,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]CC[C]([O])[CH]O(27640)',
    structure = SMILES('[CH]=[C]CC[C]([O])[CH]O'),
    E0 = (675.844,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,200,800,1200,1600],'cm^-1')),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.477608,0.108983,-0.000181687,1.58063e-07,-5.28703e-11,81436.5,35.3581], Tmin=(100,'K'), Tmax=(869.395,'K')), NASAPolynomial(coeffs=[11.1598,0.0342146,-1.60647e-05,2.97836e-09,-1.99668e-13,80215.2,-14.5437], Tmin=(869.395,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(675.844,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CCsJOH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[O][C][CH][O](10223)', '[CH2]C[C]=C(2373)'],
    products = ['C=[C]CC[C]([O])[CH][O](25975)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2CC(T)(1341)', '[CH2]C[C]([O])[CH][O](26258)'],
    products = ['C=[C]CC[C]([O])[CH][O](25975)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', 'C=[C]CC[C]([O])[C][O](27628)'],
    products = ['C=[C]CC[C]([O])[CH][O](25975)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['C=[C]CC[C]([O])[CH][O](25975)'],
    products = ['[CH2][C]=CCC([O])C=O(12175)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C=[C]CC=C([O])[CH][O](27630)'],
    products = ['C=[C]CC[C]([O])[CH][O](25975)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.23e+08,'cm^3/(mol*s)'), n=1.64, Ea=(144.68,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 2566 used for Cds-CsH_Ca;HJ
Exact match found for rate rule [Cds-CsH_Ca;HJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 142.6 to 144.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH]=[C]CCC([O])=C[O](25142)'],
    products = ['C=[C]CC[C]([O])[CH][O](25975)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(1.255e+11,'cm^3/(mol*s)'), n=1.005, Ea=(38.107,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 138 used for Ct-H_Ct-Cs;HJ
Exact match found for rate rule [Ct-H_Ct-Cs;HJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 35.4 to 38.1 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.270985,'m^3/(mol*s)'), n=1.98996, Ea=(238.187,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_R;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 236.5 to 238.2 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C=[C]C[CH][C]([O])[CH][O](27631)'],
    products = ['C=[C]CC[C]([O])[CH][O](25975)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2][C]=CC[C]([O])[CH][O](26007)'],
    products = ['C=[C]CC[C]([O])[CH][O](25975)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH]=[C]CC[C]([O])[CH][O](25998)'],
    products = ['C=[C]CC[C]([O])[CH][O](25975)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C=[C]C[CH]C([O])[CH][O](27632)'],
    products = ['C=[C]CC[C]([O])[CH][O](25975)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C=[C]CC[C]([O])[CH][O](25975)'],
    products = ['[CH2][CH][CH]CC([O])=C[O](11358)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=CCC[C]([O])[CH][O](27269)'],
    products = ['C=[C]CC[C]([O])[CH][O](25975)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C=[C]CC[C]([O])[CH][O](25975)'],
    products = ['[CH2][C]=CCC([O])[CH][O](12119)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=[C]CC[C]([O])[CH][O](25975)'],
    products = ['[CH2][CH]C[CH]C([O])=C[O](12115)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C=[C]CC[C]([O])[CH][O](25975)'],
    products = ['C=[C]C[CH][C](O)[CH][O](27633)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C=[C]C[CH][C]([O])C[O](27634)'],
    products = ['C=[C]CC[C]([O])[CH][O](25975)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C=[C]CC[C]([O])[CH][O](25975)'],
    products = ['[CH2][C]=CC[C](O)[CH][O](12162)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C=[C]CC[C]([O])[CH][O](25975)'],
    products = ['[CH2][C]=CC[C]([O])C[O](12121)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C=[C]CC[C]([O])[CH][O](25975)'],
    products = ['C=[C]C[CH][C]([O])[CH]O(27635)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]=[C]CCC([O])[CH][O](27636)'],
    products = ['C=[C]CC[C]([O])[CH][O](25975)'],
...
reaction(
    label = 'reaction31',
    reactants = ['C=[C]CC[C]([O])[CH][O](25975)'],
    products = ['C=[C][CH]C[C]([O])[CH]O(27637)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]=[C]CC[C](O)[CH][O](27638)'],
    products = ['C=[C]CC[C]([O])[CH][O](25975)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]=[C]CC[C]([O])C[O](27639)'],
    products = ['C=[C]CC[C]([O])[CH][O](25975)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]=[C]CC[C]([O])[CH]O(27640)'],
    products = ['C=[C]CC[C]([O])[CH][O](25975)'],
...
network(
    label = 'PDepNetwork #6673',
    isomers = [
        'C=[C]CC[C]([O])[CH][O](25975)',
    ],
    reactants = [
