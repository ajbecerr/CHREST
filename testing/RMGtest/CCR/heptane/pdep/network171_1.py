...
species(
    label = '[C]=C(C)C=[CH](723)',
    structure = SMILES('[C]=C(C)C=[CH]'),
    E0 = (861.529,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(0.845358,'amu*angstrom^2'), symmetry=1, barrier=(19.4364,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.845682,'amu*angstrom^2'), symmetry=1, barrier=(19.4439,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (65.0932,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75248,0.0465353,-4.59273e-05,2.36645e-08,-4.85063e-12,103701,17.4443], Tmin=(100,'K'), Tmax=(1184.25,'K')), NASAPolynomial(coeffs=[11.1571,0.0147689,-5.69026e-06,1.01278e-09,-6.86528e-14,101474,-29.5179], Tmin=(1184.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(861.529,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (65.0932,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03965,0.0391876,-3.16957e-05,1.37228e-08,-2.41838e-12,57485.5,15.904], Tmin=(100,'K'), Tmax=(1348.28,'K')), NASAPolynomial(coeffs=[9.79813,0.0161702,-6.08804e-06,1.06091e-09,-7.0585e-14,55393.4,-23.8446], Tmin=(1348.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(477.348,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCtCs) + group(Cds-CdsHH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]C(=[CH])C(727)',
    structure = SMILES('[CH]C(C)=C=[CH]'),
    E0 = (632.809,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,540,610,2055,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(2.17533,'amu*angstrom^2'), symmetry=1, barrier=(50.0151,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.17466,'amu*angstrom^2'), symmetry=1, barrier=(49.9996,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (65.0932,'amu'),
...
species(
    ...
    molecularWeight = (66.1011,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8367,0.0435275,-2.55539e-05,7.50897e-09,-9.10131e-13,57611,17.6646], Tmin=(100,'K'), Tmax=(1826.11,'K')), NASAPolynomial(coeffs=[10.7772,0.0239437,-9.4673e-06,1.63615e-09,-1.06121e-13,54345.8,-30.852], Tmin=(1826.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(478.332,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(2)', '[CH]=CC=[CH](333)'],
    products = ['[CH]=CC(=[CH])C(625)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH3](12)', '[CH]=CC#C(494)'],
    products = ['[CH]=CC(=[CH])C(625)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(0.128459,'m^3/(mol*s)'), n=2.436, Ea=(40.0172,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Ct-De_Ct-H;CsJ-HHH]
Euclidian distance = 0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['[CH3](12)', '[CH]=[C]C=[CH](495)'],
    products = ['[CH]=CC(=[CH])C(625)'],
