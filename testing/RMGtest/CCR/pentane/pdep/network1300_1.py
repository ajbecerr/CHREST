...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.149631,0.0807585,-3.96873e-05,-2.81867e-09,6.64223e-12,34418.8,36.9875], Tmin=(100,'K'), Tmax=(996.011,'K')), NASAPolynomial(coeffs=[14.551,0.0432224,-1.55395e-05,2.69267e-09,-1.81419e-13,30423.9,-39.2296], Tmin=(996.011,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(284.856,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C=C)C[C]CC(5142)',
    structure = SMILES('[CH2]C(C=C)C[C]CC'),
    E0 = (533.683,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.463212,0.0871784,-6.46838e-05,2.55768e-08,-4.13604e-12,64357,36.5288], Tmin=(100,'K'), Tmax=(1454.82,'K')), NASAPolynomial(coeffs=[17.3454,0.0382141,-1.41991e-05,2.44235e-09,-1.60573e-13,59175.3,-56.0637], Tmin=(1454.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(533.683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(C=C)C[CH]CC(5143)',
    structure = SMILES('[CH]C(C=C)C[CH]CC'),
    E0 = (523.059,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.438503,0.0783905,-5.06603e-05,1.72659e-08,-2.51421e-12,63036.8,35.1525], Tmin=(100,'K'), Tmax=(1502.3,'K')), NASAPolynomial(coeffs=[11.9864,0.0476435,-1.99606e-05,3.64257e-09,-2.47144e-13,59567.1,-25.2594], Tmin=(1502.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(523.059,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C=CC1CC(CC)C1(5129)',
...
species(
    label = 'C=CC(=C)CCCC(5144)',
    structure = SMILES('C=CC(=C)CCCC'),
    E0 = (-13.8754,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.324322,0.0809805,-3.24431e-05,-1.3153e-08,1.0184e-11,-1500.9,31.5197], Tmin=(100,'K'), Tmax=(1031.59,'K')), NASAPolynomial(coeffs=[17.3698,0.0409231,-1.57129e-05,2.86473e-09,-1.99758e-13,-6670.72,-61.7577], Tmin=(1031.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-13.8754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CC(C)C=CCC(5145)',
    structure = SMILES('C=CC(C)C=CCC'),
    E0 = (-3.49104,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.242713,0.0823548,-5.14234e-05,1.61673e-08,-2.06867e-12,-258.104,32.3879], Tmin=(100,'K'), Tmax=(1782.69,'K')), NASAPolynomial(coeffs=[18.908,0.0393844,-1.52668e-05,2.64592e-09,-1.72453e-13,-7086.02,-71.0745], Tmin=(1782.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-3.49104,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.113648,0.0815702,-5.14753e-05,1.6841e-08,-2.27803e-12,33832.6,37.9298], Tmin=(100,'K'), Tmax=(1674.44,'K')), NASAPolynomial(coeffs=[16.3408,0.0422629,-1.6263e-05,2.82147e-09,-1.8486e-13,28322.2,-49.9352], Tmin=(1674.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(280.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.73845,0.0767895,-4.55763e-05,1.41516e-08,-1.9265e-12,37719.5,33.5335], Tmin=(100,'K'), Tmax=(1511.11,'K')), NASAPolynomial(coeffs=[9.26987,0.0542064,-2.31593e-05,4.26169e-09,-2.90311e-13,35141.1,-11.1478], Tmin=(1511.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(312.685,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2]CCCC([CH2])C=C(5159)',
    structure = SMILES('[CH2]CCCC([CH2])C=C'),
    E0 = (290.714,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.468756,0.0858388,-5.84405e-05,2.10064e-08,-3.09829e-12,35136,38.4395], Tmin=(100,'K'), Tmax=(1575.8,'K')), NASAPolynomial(coeffs=[17.6316,0.0398929,-1.47045e-05,2.50311e-09,-1.62738e-13,29431.6,-57.1154], Tmin=(1575.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(290.714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C([C]=C)CCCC(5160)',
    structure = SMILES('[CH2]C([C]=C)CCCC'),
    E0 = (323.309,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.172836,0.0856615,-5.97932e-05,2.26185e-08,-3.58897e-12,39040.1,36.0452], Tmin=(100,'K'), Tmax=(1443.24,'K')), NASAPolynomial(coeffs=[14.5053,0.0449808,-1.75127e-05,3.08821e-09,-2.05932e-13,34803.3,-40.1535], Tmin=(1443.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(323.309,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CC(C)C[CH]CC(5161)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.417864,0.0788749,-4.78879e-05,1.49925e-08,-1.99041e-12,38848.3,34.6225], Tmin=(100,'K'), Tmax=(1623.14,'K')), NASAPolynomial(coeffs=[12.5202,0.0490507,-2.03264e-05,3.6723e-09,-2.46855e-13,34919.5,-29.6261], Tmin=(1623.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(321.94,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC([CH2])CCCC(5162)',
    structure = SMILES('[CH]=CC([CH2])CCCC'),
    E0 = (332.564,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.500242,0.087793,-6.21614e-05,2.34579e-08,-3.6392e-12,40169.4,37.1618], Tmin=(100,'K'), Tmax=(1503.49,'K')), NASAPolynomial(coeffs=[17.2274,0.0406296,-1.51082e-05,2.5942e-09,-1.7004e-13,34838.7,-55.5933], Tmin=(1503.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.564,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.451306,0.076931,-4.42812e-05,1.27138e-08,-1.51506e-12,33814.6,35.8896], Tmin=(100,'K'), Tmax=(1809.22,'K')), NASAPolynomial(coeffs=[14.304,0.0463042,-1.88889e-05,3.35716e-09,-2.22158e-13,28802,-39.1549], Tmin=(1809.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(280.09,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(C)CC([CH2])C=C(5141)'],
    products = ['[CH2]C(C=C)C[CH]CC(4055)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]CC(26)', '[CH2]C([CH2])C=C(496)'],
    products = ['[CH2]C(C=C)C[CH]CC(4055)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H5(14)', '[CH]CC([CH2])C=C(4941)'],
    products = ['[CH2]C(C=C)C[CH]CC(4055)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH2]C(C=C)C[C]CC(5142)'],
    products = ['[CH2]C(C=C)C[CH]CC(4055)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH]C(C=C)C[CH]CC(5143)'],
    products = ['[CH2]C(C=C)C[CH]CC(4055)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C[C]([CH2])C[CH]CC(5146)'],
    products = ['[CH2]C(C=C)C[CH]CC(4055)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(C=C)C[CH]CC(4055)'],
    products = ['[CH2]C1[CH]CC(CC)C1(5113)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C=CC(=C)C[CH]CC(5150)'],
    products = ['[CH2]C(C=C)C[CH]CC(4055)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH2]C(C=C)C=CCC(5151)'],
    products = ['[CH2]C(C=C)C[CH]CC(4055)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2]C(C=C)CC=CC(4928)'],
    products = ['[CH2]C(C=C)C[CH]CC(4055)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C2H3(60)', 'C=CC[CH]CC(244)'],
    products = ['[CH2]C(C=C)C[CH]CC(4055)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.0344575,'m^3/(mol*s)'), n=2.32603, Ea=(21.6447,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cds-HH_Cds-CsH;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 17.1 to 21.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction29',
    reactants = ['CH3(17)', '[CH2]C(C=C)CC=C(4875)'],
    products = ['[CH2]C(C=C)C[CH]CC(4055)'],
...
reaction(
    label = 'reaction31',
    reactants = ['C2H3(60)', '[CH2][CH]C[CH]CC(247)'],
    products = ['[CH2]C(C=C)C[CH]CC(4055)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', '[CH2]C[CH]CC([CH2])C=C(5154)'],
    products = ['[CH2]C(C=C)C[CH]CC(4055)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(3)', '[CH2]C([C]=C)C[CH]CC(5155)'],
    products = ['[CH2]C(C=C)C[CH]CC(4055)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(3)', '[CH]=CC([CH2])C[CH]CC(5156)'],
    products = ['[CH2]C(C=C)C[CH]CC(4055)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]C=C(C)C[CH]CC(3997)'],
    products = ['[CH2]C(C=C)C[CH]CC(4055)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]C(C=C)C[CH]CC(4055)'],
    products = ['[CH2]C([CH]CCC)C=C(5074)'],
...
reaction(
    label = 'reaction43',
    reactants = ['C=[C]C(C)C[CH]CC(5157)'],
    products = ['[CH2]C(C=C)C[CH]CC(4055)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2]CCCC([CH2])C=C(5159)'],
    products = ['[CH2]C(C=C)C[CH]CC(4055)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH]=CC(C)C[CH]CC(5161)'],
    products = ['[CH2]C(C=C)C[CH]CC(4055)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[CH2]C[CH]CC(C)C=C(5163)'],
    products = ['[CH2]C(C=C)C[CH]CC(4055)'],
