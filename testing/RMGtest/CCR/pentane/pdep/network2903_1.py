...
species(
    label = '[CH2]C(C)[CH]OC=[C][O](12820)',
    structure = SMILES('[CH2]C(C)[CH]O[CH][C]=O'),
    E0 = (324.101,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.345388,0.0952441,-0.000115469,7.31443e-08,-1.82528e-11,39137.2,34.3564], Tmin=(100,'K'), Tmax=(983.764,'K')), NASAPolynomial(coeffs=[16.6388,0.0261862,-1.01733e-05,1.78875e-09,-1.19522e-13,35795.5,-47.3048], Tmin=(983.764,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(324.101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(Isobutyl) + radical(CCsJOCs) + radical(CsCJ=O)"""),
)
...
species(
    label = '[CH2][C]C(C)OC=[C][O](12821)',
    structure = SMILES('[CH2][C]C(C)OC=[C][O]'),
    E0 = (580.165,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH][CH]C(C)OC=[C][O](12822)',
    structure = SMILES('[CH][CH]C(C)OC=[C][O]'),
    E0 = (574.821,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2][CH][CH]OC=[C][O](12377)',
    structure = SMILES('[CH2][CH][CH]O[CH][C]=O'),
    E0 = (556.989,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,3000,3100,440,815,1455,1000,1855,455,950,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.583632,0.075831,-9.7471e-05,6.29888e-08,-1.58996e-11,67112.8,32.2532], Tmin=(100,'K'), Tmax=(974.71,'K')), NASAPolynomial(coeffs=[14.8496,0.0172864,-7.3755e-06,1.36662e-09,-9.43094e-14,64331.8,-36.2065], Tmin=(974.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(556.989,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(CCsJOCs) + radical(RCCJ) + radical(CCsJOCs) + radical(CsCJ=O)"""),
)

species(
    label = '[CH2][CH][C](C)OC=[C][O](12823)',
    structure = SMILES('[CH2][CH][C](C)O[CH][C]=O'),
    E0 = (522.906,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0497804,0.0932325,-0.000136257,1.10797e-07,-3.6193e-11,63027.3,36.5662], Tmin=(100,'K'), Tmax=(804.218,'K')), NASAPolynomial(coeffs=[10.9618,0.0338086,-1.58162e-05,2.99354e-09,-2.05976e-13,61438.7,-12.6652], Tmin=(804.218,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(522.906,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(C2CsJOCs) + radical(CCJCO) + radical(RCCJ) + radical(CCsJOCs) + radical(CsCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.139296,0.0983966,-0.000144796,1.20338e-07,-4.01542e-11,38990.4,34.0543], Tmin=(100,'K'), Tmax=(813.594,'K')), NASAPolynomial(coeffs=[10.3678,0.0381539,-1.78999e-05,3.38858e-09,-2.32982e-13,37564.8,-12.7226], Tmin=(813.594,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(323.004,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(C2CsJOCs) + radical(RCCJ) + radical(CCsJOCs) + radical(CsCJ=O)"""),
)
...
species(
    label = '[CH2][CH][C](C)OC=[C]O(12825)',
    structure = SMILES('[CH2]C=C(C)O[CH][C]O'),
    E0 = (383.263,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.999885,0.104172,-0.00012448,7.23054e-08,-1.61672e-11,46281,31.6303], Tmin=(100,'K'), Tmax=(1105.63,'K')), NASAPolynomial(coeffs=[23.0403,0.0171983,-6.4834e-06,1.1565e-09,-7.931e-14,40965.1,-86.7635], Tmin=(1105.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(383.263,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(CCsJOC(O)) + radical(Allyl_P) + radical(CH2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0793255,0.0742777,-5.02956e-05,6.6351e-09,4.01975e-12,-2704.03,29.7362], Tmin=(100,'K'), Tmax=(1025.11,'K')), NASAPolynomial(coeffs=[19.1431,0.0229457,-8.91937e-06,1.66616e-09,-1.18997e-13,-7823.89,-68.6167], Tmin=(1025.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-23.7429,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(Allyl_P) + radical(CsCJ=O)"""),
)

species(
    label = '[CH2][CH][C](C)OC[C]=O(12828)',
    structure = SMILES('[CH2][CH][C](C)OC[C]=O'),
    E0 = (342.45,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.407227,0.0855501,-0.000114828,9.4452e-08,-3.24345e-11,41310.4,35.1452], Tmin=(100,'K'), Tmax=(766.024,'K')), NASAPolynomial(coeffs=[7.92663,0.0416414,-1.97534e-05,3.79469e-09,-2.64584e-13,40294.6,1.76202], Tmin=(766.024,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(342.45,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(C2CsJOCs) + radical(CCJCO) + radical(RCCJ) + radical(CsCJ=O)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', '[CH2][CH]CO[CH][C]=O(11036)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2][CH]C(C)O[CH][C]=O(11234)'],
    products = ['[CH2]C(C)[CH]OC=[C][O](12820)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH][CH2](502)', 'C[CH]O[CH][C]=O(2799)'],
    products = ['[CH2][CH]C(C)O[CH][C]=O(11234)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH2][C]C(C)OC=[C][O](12821)'],
    products = ['[CH2][CH]C(C)O[CH][C]=O(11234)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH][CH]C(C)OC=[C][O](12822)'],
    products = ['[CH2][CH]C(C)O[CH][C]=O(11234)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'C=C[C](C)OC=[C][O](12192)'],
    products = ['[CH2][CH]C(C)O[CH][C]=O(11234)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(17)', 'C=C[CH]OC=[C][O](12182)'],
    products = ['[CH2][CH]C(C)O[CH][C]=O(11234)'],
...
reaction(
    label = 'reaction14',
    reactants = ['HCCO(2227)', '[CH2][CH]C(C)[O](1587)'],
    products = ['[CH2][CH]C(C)O[CH][C]=O(11234)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=[C][O](6861)', '[CH2][CH]C(C)[O](1587)'],
    products = ['[CH2][CH]C(C)O[CH][C]=O(11234)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(17)', '[CH2][CH][CH]OC=[C][O](12377)'],
    products = ['[CH2][CH]C(C)O[CH][C]=O(11234)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2][CH][C](C)OC=[C][O](12823)'],
    products = ['[CH2][CH]C(C)O[CH][C]=O(11234)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2][CH]C(C)O[CH][C]=O(11234)'],
    products = ['[CH2]C[C](C)OC=[C][O](12824)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.785e+09,'s^-1'), n=0.84206, Ea=(123.714,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4H_SSS_O(Cs)Cs;Y_rad_out;XH_out] for rate rule [R4H_SSS_O(Cs)Cs;Cd_rad_out;XH_out]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2][CH][C](C)OC=[C]O(12825)'],
    products = ['[CH2][CH]C(C)O[CH][C]=O(11234)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2][CH]C(C)O[CH][C]=O(11234)'],
    products = ['[CH2]C=C(C)OC[C]=O(12827)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2][CH][C](C)OC[C]=O(12828)'],
    products = ['[CH2][CH]C(C)O[CH][C]=O(11234)'],
