...
species(
    ...
    E0 = (454.126,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,1811.36,4000],'cm^-1')),
        HinderedRotor(inertia=(1.0973,'amu*angstrom^2'), symmetry=1, barrier=(25.2292,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09721,'amu*angstrom^2'), symmetry=1, barrier=(25.2269,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0879845,'amu*angstrom^2'), symmetry=1, barrier=(25.2292,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.41174,'amu*angstrom^2'), symmetry=1, barrier=(101.435,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.1357,'amu'),
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.308683,0.0714616,-5.34818e-05,2.07239e-08,-3.25117e-12,87876.7,31.1489], Tmin=(100,'K'), Tmax=(1503.27,'K')), NASAPolynomial(coeffs=[16.2489,0.0290466,-1.1159e-05,1.95462e-09,-1.29759e-13,83084.2,-52.2515], Tmin=(1503.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(729.476,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.785942,0.0559209,5.51972e-06,-4.66504e-08,2.19462e-11,13870.1,26.5639], Tmin=(100,'K'), Tmax=(971.825,'K')), NASAPolynomial(coeffs=[15.2386,0.031578,-1.11513e-05,1.9969e-09,-1.40714e-13,9401.49,-51.2873], Tmin=(971.825,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.251,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CC=CCJ)"""),
)
...
species(
    label = '[CH2]C#CC([CH2])CC(17017)',
    structure = SMILES('[CH2]C#CC([CH2])CC'),
    E0 = (412.204,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2100,2250,500,550,180,518.86],'cm^-1')),
        HinderedRotor(inertia=(0.0250027,'amu*angstrom^2'), symmetry=1, barrier=(14.8379,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.645177,'amu*angstrom^2'), symmetry=1, barrier=(14.8339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.015919,'amu*angstrom^2'), symmetry=1, barrier=(77.5994,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0159241,'amu*angstrom^2'), symmetry=1, barrier=(77.6066,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.37596,'amu*angstrom^2'), symmetry=1, barrier=(77.62,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.893767,0.0614525,-3.24327e-05,9.61154e-10,3.98383e-12,49694.6,29.537], Tmin=(100,'K'), Tmax=(978.348,'K')), NASAPolynomial(coeffs=[11.2117,0.0336709,-1.19215e-05,2.03245e-09,-1.352e-13,46986.4,-23.538], Tmin=(978.348,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(412.204,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Isobutyl) + radical(Propargyl)"""),
)
...
species(
    label = '[CH2]C=[C]C([CH2])CC(17021)',
    structure = SMILES('[CH2]C=[C]C([CH2])CC'),
    E0 = (486.344,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3010,987.5,1337.5,450,1655,1685,370,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.27957,'amu*angstrom^2'), symmetry=1, barrier=(85.4848,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02026,'amu*angstrom^2'), symmetry=1, barrier=(23.4578,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00159556,'amu*angstrom^2'), symmetry=1, barrier=(13.1085,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00285513,'amu*angstrom^2'), symmetry=1, barrier=(23.4573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.71823,'amu*angstrom^2'), symmetry=1, barrier=(85.4895,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.864513,0.0582527,-1.08258e-05,-2.39358e-08,1.2793e-11,45883.8,28.3904], Tmin=(100,'K'), Tmax=(985.29,'K')), NASAPolynomial(coeffs=[12.4166,0.0354636,-1.28354e-05,2.25831e-09,-1.5462e-13,42437.2,-33.1092], Tmin=(985.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(380.483,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_T) + radical(Isobutyl) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C([C]=[C]C)CC(17024)',
    structure = SMILES('[CH2]C([C]=[C]C)CC'),
    E0 = (572.686,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3100,440,815,1455,1000,1670,1700,300,440,327.177,327.196],'cm^-1')),
        HinderedRotor(inertia=(0.00157467,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0910127,'amu*angstrom^2'), symmetry=1, barrier=(6.91205,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.091057,'amu*angstrom^2'), symmetry=1, barrier=(6.91135,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0910469,'amu*angstrom^2'), symmetry=1, barrier=(6.91276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0910715,'amu*angstrom^2'), symmetry=1, barrier=(6.9114,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.882461,0.0709805,-5.87472e-05,2.99169e-08,-6.74976e-12,68988.4,30.0547], Tmin=(100,'K'), Tmax=(1019.66,'K')), NASAPolynomial(coeffs=[7.93297,0.043322,-1.80592e-05,3.31431e-09,-2.27308e-13,67550.6,-4.09715], Tmin=(1019.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(572.686,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Cds_S) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2]CC([CH2])C=[C]C(17027)',
    structure = SMILES('[CH2]CC([CH2])C=[C]C'),
    E0 = (540.091,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1685,370,180,561.145],'cm^-1')),
        HinderedRotor(inertia=(0.390597,'amu*angstrom^2'), symmetry=1, barrier=(8.9806,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0880393,'amu*angstrom^2'), symmetry=1, barrier=(2.0242,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0015517,'amu*angstrom^2'), symmetry=1, barrier=(8.97528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.349405,'amu*angstrom^2'), symmetry=1, barrier=(77.9612,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0400878,'amu*angstrom^2'), symmetry=1, barrier=(8.97013,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.832255,0.0686568,-5.02612e-05,2.09215e-08,-3.75418e-12,65072.6,31.5379], Tmin=(100,'K'), Tmax=(1268.1,'K')), NASAPolynomial(coeffs=[10.0397,0.0396136,-1.59069e-05,2.86086e-09,-1.93617e-13,62737.4,-15.0698], Tmin=(1268.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(540.091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(RCCJ) + radical(Cds_S)"""),
)

species(
    label = '[CH2][CH]C([C]=C)CC(17028)',
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08613,0.0640873,-3.9519e-05,1.23256e-08,-1.61039e-12,65267,31.8316], Tmin=(100,'K'), Tmax=(1662.84,'K')), NASAPolynomial(coeffs=[11.8895,0.0380999,-1.60768e-05,2.92731e-09,-1.9741e-13,61674.1,-25.7824], Tmin=(1662.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(541.796,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(RCCJ) + radical(Cds_S)"""),
)
...
species(
    label = 'C=C=C[CH]CC(9380)',
    structure = SMILES('C=[C]C=CCC'),
    E0 = (234.246,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,1685,370,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.858846,'amu*angstrom^2'), symmetry=1, barrier=(19.7466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.859218,'amu*angstrom^2'), symmetry=1, barrier=(19.7551,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24989,0.0516259,-1.72294e-05,-1.35784e-08,8.96031e-12,28280.1,22.1805], Tmin=(100,'K'), Tmax=(983.159,'K')), NASAPolynomial(coeffs=[12.1784,0.0269044,-9.63103e-06,1.69265e-09,-1.1616e-13,25177.1,-35.2097], Tmin=(983.159,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CJC=C)"""),
)
...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.531004,0.0666952,-2.647e-05,-6.08036e-09,5.55204e-12,56382.8,31.4711], Tmin=(100,'K'), Tmax=(1061.54,'K')), NASAPolynomial(coeffs=[11.7352,0.0419035,-1.60635e-05,2.84938e-09,-1.93158e-13,53022.2,-27.8768], Tmin=(1061.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(467.687,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]C(C)[CH][C]=C(15623)'],
    products = ['[CH2]C([CH][C]=C)CC(15663)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', '[CH2][C]=C[CH]CC(16946)'],
    products = ['[CH2]C([CH][C]=C)CC(15663)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]C(C=[C][CH2])CC(17012)'],
    products = ['[CH2]C([CH][C]=C)CC(15663)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH][C]=CC([CH2])CC(17013)'],
    products = ['[CH2]C([CH][C]=C)CC(15663)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH2][C]=CC(=C)CC(17016)'],
    products = ['[CH2]C([CH][C]=C)CC(15663)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2]C#CC([CH2])CC(17017)'],
    products = ['[CH2]C([CH][C]=C)CC(15663)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C2H5(14)', 'C=[C][CH]C=C(15984)'],
    products = ['[CH2]C([CH][C]=C)CC(15663)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C2H5(14)', '[CH2][C]=C[CH][CH2](16919)'],
    products = ['[CH2]C([CH][C]=C)CC(15663)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2][C]=C[C]([CH2])CC(17018)'],
    products = ['[CH2]C([CH][C]=C)CC(15663)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH3(17)', '[CH2]C([CH2])[CH][C]=C(15714)'],
    products = ['[CH2]C([CH][C]=C)CC(15663)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH2]CC([CH2])[CH][C]=C(15824)'],
    products = ['[CH2]C([CH][C]=C)CC(15663)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH2][C]=[C]C([CH2])CC(17019)'],
    products = ['[CH2]C([CH][C]=C)CC(15663)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C=[C]C([CH2])CC(17021)'],
    products = ['[CH2]C([CH][C]=C)CC(15663)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C([CH][C]=C)CC(15663)'],
    products = ['[CH2]C=C[C]([CH2])CC(17023)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C([C]=[C]C)CC(17024)'],
    products = ['[CH2]C([CH][C]=C)CC(15663)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]CC([CH2])C=[C]C(17027)'],
    products = ['[CH2]C([CH][C]=C)CC(15663)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2][CH]C([C]=C)CC(17028)'],
    products = ['[CH2]C([CH][C]=C)CC(15663)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(3)', 'C#C[CH]C([CH2])CC(17031)'],
    products = ['[CH2]C([CH][C]=C)CC(15663)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CH2(T)(20)', 'C=C=C[CH]CC(9380)'],
    products = ['[CH2]C([CH][C]=C)CC(15663)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2][C](CC)C[C]=C(15662)'],
    products = ['[CH2]C([CH][C]=C)CC(15663)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2]C([CH][C]=C)CC(15663)'],
    products = ['[CH]=C[CH]C([CH2])CC(13901)'],
