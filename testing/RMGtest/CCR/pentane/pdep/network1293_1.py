...
species(
    label = '[CH2]C([CH]C)O[O](3746)',
    structure = SMILES('[CH2]C([CH]C)O[O]'),
    E0 = (321.113,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,321.168],'cm^-1')),
        HinderedRotor(inertia=(0.001634,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0908665,'amu*angstrom^2'), symmetry=1, barrier=(6.65215,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0909047,'amu*angstrom^2'), symmetry=1, barrier=(6.65335,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0908882,'amu*angstrom^2'), symmetry=1, barrier=(6.65343,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37863,0.0610184,-6.80272e-05,4.49771e-08,-1.25031e-11,38712.4,27.2027], Tmin=(100,'K'), Tmax=(861.932,'K')), NASAPolynomial(coeffs=[8.18514,0.0294309,-1.30557e-05,2.45866e-09,-1.70698e-13,37539,-4.62342], Tmin=(861.932,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(321.113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CJCOOH)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.289487,'amu*angstrom^2'), symmetry=1, barrier=(6.65587,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289305,'amu*angstrom^2'), symmetry=1, barrier=(6.6517,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289679,'amu*angstrom^2'), symmetry=1, barrier=(6.66029,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88532,0.0487733,-4.36303e-05,2.28041e-08,-5.14978e-12,22148.8,21.7087], Tmin=(100,'K'), Tmax=(1029.3,'K')), NASAPolynomial(coeffs=[7.48954,0.0269945,-1.18917e-05,2.24724e-09,-1.56844e-13,20995.1,-5.49019], Tmin=(1029.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(183.538,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C(C=C)O[O](4654)',
    structure = SMILES('[CH2]C(C=C)O[O]'),
    E0 = (248.144,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,895.734],'cm^-1')),
        HinderedRotor(inertia=(0.518101,'amu*angstrom^2'), symmetry=1, barrier=(11.9122,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11521,'amu*angstrom^2'), symmetry=1, barrier=(11.9488,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.52262,'amu*angstrom^2'), symmetry=1, barrier=(12.0161,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39387,0.0517986,-4.37325e-05,1.90172e-08,-3.31563e-12,29943.2,26.2195], Tmin=(100,'K'), Tmax=(1371.78,'K')), NASAPolynomial(coeffs=[12.8203,0.0184804,-7.30062e-06,1.31203e-09,-8.89989e-14,26808.2,-32.5186], Tmin=(1371.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.144,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CJCOOH)"""),
)

species(
    label = 'C=[C]C(C)O[O](4655)',
    structure = SMILES('C=[C]C(C)O[O]'),
    E0 = (272.023,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,277.458],'cm^-1')),
        HinderedRotor(inertia=(0.199303,'amu*angstrom^2'), symmetry=1, barrier=(10.6639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197074,'amu*angstrom^2'), symmetry=1, barrier=(10.6754,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196702,'amu*angstrom^2'), symmetry=1, barrier=(10.658,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73912,0.0500477,-4.29564e-05,2.00638e-08,-3.91902e-12,32797.9,23.4558], Tmin=(100,'K'), Tmax=(1195.68,'K')), NASAPolynomial(coeffs=[9.46734,0.0241937,-1.05219e-05,1.97941e-09,-1.378e-13,30949.8,-15.2095], Tmin=(1195.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(272.023,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CC(C)O[O](4656)',
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.551632,'amu*angstrom^2'), symmetry=1, barrier=(12.6831,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.551822,'amu*angstrom^2'), symmetry=1, barrier=(12.6875,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.551869,'amu*angstrom^2'), symmetry=1, barrier=(12.6886,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48553,0.0514569,-4.33795e-05,1.90208e-08,-3.376e-12,33923.5,24.2961], Tmin=(100,'K'), Tmax=(1338.09,'K')), NASAPolynomial(coeffs=[11.9794,0.0200876,-8.21486e-06,1.50113e-09,-1.02771e-13,31115.1,-29.3869], Tmin=(1338.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(281.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_P)"""),
)

species(
    label = 'C=C[C](C)OO(4657)',
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56739,0.0530955,-4.17701e-05,1.73387e-08,-3.00435e-12,3880.3,22.0827], Tmin=(100,'K'), Tmax=(1328.79,'K')), NASAPolynomial(coeffs=[10.4643,0.0263138,-1.15379e-05,2.17101e-09,-1.5072e-13,1515.86,-23.3689], Tmin=(1328.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(31.5336,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C(C=C)OO(4658)',
    structure = SMILES('[CH2]C(C=C)OO'),
    E0 = (96.1391,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08094,0.055951,-4.09107e-05,1.20412e-08,-4.98698e-13,11674.9,26.5848], Tmin=(100,'K'), Tmax=(1131.74,'K')), NASAPolynomial(coeffs=[14.3737,0.0201489,-8.2763e-06,1.54582e-09,-1.08351e-13,7950.14,-42.3533], Tmin=(1131.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(96.1391,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJCOOH)"""),
)

species(
    label = 'C=[C]C(C)OO(4659)',
    structure = SMILES('C=[C]C(C)OO'),
    E0 = (120.018,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,280.434],'cm^-1')),
        HinderedRotor(inertia=(0.113941,'amu*angstrom^2'), symmetry=1, barrier=(6.43179,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.374734,'amu*angstrom^2'), symmetry=1, barrier=(21.2561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.371327,'amu*angstrom^2'), symmetry=1, barrier=(21.2544,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.376728,'amu*angstrom^2'), symmetry=1, barrier=(21.2555,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31842,0.0554466,-4.4286e-05,1.80341e-08,-2.98543e-12,14534.1,24.2081], Tmin=(100,'K'), Tmax=(1415.71,'K')), NASAPolynomial(coeffs=[12.7964,0.023016,-9.92422e-06,1.85286e-09,-1.27953e-13,11284.3,-35.1565], Tmin=(1415.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.018,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CC(C)OO(4660)',
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.99426,0.0575466,-4.65717e-05,1.87963e-08,-3.01233e-12,15663.2,25.3125], Tmin=(100,'K'), Tmax=(1492.58,'K')), NASAPolynomial(coeffs=[15.4862,0.0187094,-7.54144e-06,1.36334e-09,-9.2394e-14,11337.2,-50.4068], Tmin=(1492.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(129.273,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['C=CC(C)O[O](3748)'],
    products = ['HO2(9)', 'butadiene13(1350)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(17)', 'C=C[CH]O[O](660)'],
    products = ['C=CC(C)O[O](3748)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'C=C[C](C)O[O](4653)'],
    products = ['C=CC(C)O[O](3748)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH2]C(C=C)O[O](4654)'],
    products = ['C=CC(C)O[O](3748)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'C=[C]C(C)O[O](4655)'],
    products = ['C=CC(C)O[O](3748)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH]=CC(C)O[O](4656)'],
    products = ['C=CC(C)O[O](3748)'],
