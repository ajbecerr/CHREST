...
species(
    label = '[CH][C]OO[C]=[CH](13310)',
    structure = SMILES('[CH][C]OO[C]=[CH]'),
    E0 = (1316.27,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,1685,370,3120,650,792.5,1650,296.618,296.635,296.641,2333.7],'cm^-1')),
        HinderedRotor(inertia=(0.00191577,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191314,'amu*angstrom^2'), symmetry=1, barrier=(11.9447,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.516379,'amu*angstrom^2'), symmetry=1, barrier=(32.2413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.516377,'amu*angstrom^2'), symmetry=1, barrier=(32.2422,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 7,
    opticalIsomers = 1,
    molecularWeight = (82.0575,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16657,0.0679238,-0.000117562,1.00731e-07,-3.34606e-11,158408,26.7852], Tmin=(100,'K'), Tmax=(818.92,'K')), NASAPolynomial(coeffs=[10.5953,0.0150692,-8.29442e-06,1.63885e-09,-1.1412e-13,157091,-15.4274], Tmin=(818.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1316.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CH2_triplet) + radical(C=CJO) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[C]=[C]OO[CH][CH](13311)',
    structure = SMILES('[C]=[C]OO[CH][CH]'),
    E0 = (1352.73,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,1685,370,240.982,240.983,240.983,1496.13],'cm^-1')),
        HinderedRotor(inertia=(0.134204,'amu*angstrom^2'), symmetry=1, barrier=(5.53055,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26832,'amu*angstrom^2'), symmetry=1, barrier=(52.2644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0329032,'amu*angstrom^2'), symmetry=1, barrier=(52.2644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00348178,'amu*angstrom^2'), symmetry=1, barrier=(5.53056,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 7,
    opticalIsomers = 1,
    molecularWeight = (82.0575,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41022,0.0668643,-0.00012786,1.21964e-07,-4.36679e-11,162780,27.4472], Tmin=(100,'K'), Tmax=(858.247,'K')), NASAPolynomial(coeffs=[6.19943,0.0226206,-1.22178e-05,2.37367e-09,-1.62633e-13,162765,9.77792], Tmin=(858.247,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1352.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOOC) + radical(CCJ2_triplet) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=[C]O[O](9590)', '[CH][CH](6981)'],
    products = ['[CH][CH]OO[C]=[CH](7109)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=[CH](9646)', '[CH][CH]O[O](6930)'],
    products = ['[CH][CH]OO[C]=[CH](7109)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH][C]OO[C]=[CH](13310)'],
    products = ['[CH][CH]OO[C]=[CH](7109)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[C]=[C]OO[CH][CH](13311)'],
    products = ['[CH][CH]OO[C]=[CH](7109)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
