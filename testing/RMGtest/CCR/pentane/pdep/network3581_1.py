...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53923,0.013515,7.25375e-05,-1.0379e-07,4.03758e-11,8696.21,17.5914], Tmin=(100,'K'), Tmax=(961.95,'K')), NASAPolynomial(coeffs=[13.1362,0.0164817,-5.42605e-06,1.06734e-09,-8.43272e-14,4481.44,-44.4323], Tmin=(961.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.7271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)

species(
    label = 'C=C=CC(=C)O(15773)',
    structure = SMILES('C=C=CC(=C)O'),
    E0 = (20.607,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00844,0.0551584,-3.13458e-05,-1.05124e-08,1.15263e-11,2596,18.8356], Tmin=(100,'K'), Tmax=(926.322,'K')), NASAPolynomial(coeffs=[17.9643,0.00942016,-1.77964e-06,2.33978e-10,-1.70694e-14,-1724.3,-68.0326], Tmin=(926.322,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.607,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5201,0.0508945,-4.93327e-05,2.87977e-08,-6.67777e-12,47568.4,22.2022], Tmin=(100,'K'), Tmax=(1206.71,'K')), NASAPolynomial(coeffs=[8.58741,0.0216575,-5.76725e-06,7.39108e-10,-3.80598e-14,46285.8,-11.4686], Tmin=(1206.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(394.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C]1CC(=O)C1(15753)',
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.45947,0.0308429,-6.1998e-06,-4.08361e-09,1.57835e-12,29134.1,21.1912], Tmin=(100,'K'), Tmax=(1433.91,'K')), NASAPolynomial(coeffs=[6.28005,0.0278866,-1.11636e-05,1.96993e-09,-1.30135e-13,27246.7,-1.37864], Tmin=(1433.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(241.754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + ring(Cyclobutanone) + radical(Tertalkyl) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.7727,0.00416398,0.000102178,-1.28785e-07,4.60025e-11,133.117,14.3649], Tmin=(100,'K'), Tmax=(1020.17,'K')), NASAPolynomial(coeffs=[13.5468,0.0215288,-1.10012e-05,2.45291e-09,-1.94373e-13,-5167.05,-53.032], Tmin=(1020.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.573284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsCs) + group(Cds-OdCsCs) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)

species(
    label = 'C=C=CC(C)=O(15783)',
    structure = SMILES('C=C=CC(C)=O'),
    E0 = (14.085,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction3',
    reactants = ['H2CC(T)(1341)', '[CH2]C(=C)[O](2372)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C=C=CC(=C)[O](15777)'],
    products = ['C=[C]CC(=C)[O](15511)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(T)(20)', 'C=[C]C[C]=O(2668)'],
    products = ['C=[C]CC(=C)[O](15511)'],
