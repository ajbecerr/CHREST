...
species(
    label = '[C]=[C]CO[CH2](29307)',
    structure = SMILES('[C]=[C]CO[CH2]'),
    E0 = (857.449,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,275.56,1435.86,1435.89],'cm^-1')),
        HinderedRotor(inertia=(0.117883,'amu*angstrom^2'), symmetry=1, barrier=(6.35041,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117815,'amu*angstrom^2'), symmetry=1, barrier=(6.35023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117872,'amu*angstrom^2'), symmetry=1, barrier=(6.35063,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20936,0.044976,-7.09735e-05,6.56841e-08,-2.36325e-11,103186,21.2255], Tmin=(100,'K'), Tmax=(854.77,'K')), NASAPolynomial(coeffs=[4.35282,0.0227789,-1.06701e-05,1.99918e-09,-1.35769e-13,103264,13.8209], Tmin=(854.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(857.449,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsJOCC) + radical(Cds_S) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7855,0.0366524,1.91608e-06,-4.172e-08,2.29492e-11,17782.7,16.2901], Tmin=(100,'K'), Tmax=(897.362,'K')), NASAPolynomial(coeffs=[16.5448,0.00387038,1.53866e-06,-4.49272e-10,3.16667e-14,13804.8,-60.7217], Tmin=(897.362,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=[CH](9646)', '[CH2]O[CH2](3113)'],
    products = ['[CH]=[C]CO[CH2](28913)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]OC[C]=[CH](17798)'],
    products = ['[CH]=[C]CO[CH2](28913)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[C]=[C]CO[CH2](29307)'],
    products = ['[CH]=[C]CO[CH2](28913)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    ...
    products = ['[CH]=[C]CO[CH2](28913)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(2330,'cm^3/(mol*s)'), n=3.17, Ea=(51.2285,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [Od_CO-HH;YJ] for rate rule [Od_CO-HH;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 46.2 to 51.2 kJ/mol to match endothermicity of reaction."""),
)
