...
species(
    label = '[CH2]C=CC[CH]C(C)C(5493)',
    structure = SMILES('[CH2]C=CC[CH]C(C)C'),
    E0 = (216.459,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0834083,0.077896,-3.66884e-05,1.0662e-09,2.82546e-12,26190.8,35.1531], Tmin=(100,'K'), Tmax=(1202.06,'K')), NASAPolynomial(coeffs=[15.0069,0.0455493,-1.86212e-05,3.41191e-09,-2.34185e-13,21272,-45.7956], Tmin=(1202.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_S) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH]=CCC(C)[CH]C(5494)',
    structure = SMILES('[CH]=CCC(C)[CH]C'),
    E0 = (348.081,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,769.598,769.605],'cm^-1')),
        HinderedRotor(inertia=(0.20509,'amu*angstrom^2'), symmetry=1, barrier=(4.71542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205099,'amu*angstrom^2'), symmetry=1, barrier=(4.71563,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205083,'amu*angstrom^2'), symmetry=1, barrier=(4.71527,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.49601,'amu*angstrom^2'), symmetry=1, barrier=(11.4042,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0271342,'amu*angstrom^2'), symmetry=1, barrier=(11.4042,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.429889,0.0687596,-4.16568e-05,1.24459e-08,-1.49988e-12,42001.3,32.3413], Tmin=(100,'K'), Tmax=(1892.71,'K')), NASAPolynomial(coeffs=[17.9071,0.0318237,-1.23845e-05,2.13534e-09,-1.37998e-13,35385.4,-63.1267], Tmin=(1892.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(348.081,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH2]C=CCC(C)[C]C(5495)',
    structure = SMILES('[CH2]C=CCC(C)[C]C'),
    E0 = (470.132,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.288811,0.0818763,-4.45265e-05,3.29409e-09,3.53854e-12,56708.7,33.9229], Tmin=(100,'K'), Tmax=(1101.62,'K')), NASAPolynomial(coeffs=[16.7061,0.0405984,-1.61403e-05,2.95076e-09,-2.04062e-13,51724.6,-55.3392], Tmin=(1101.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(470.132,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'CC1CC=CCC1C(4886)',
    structure = SMILES('CC1CC=CCC1C'),
    E0 = (-86.9124,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02581,0.0393069,8.85434e-05,-1.36282e-07,5.28981e-11,-10322.7,23.7349], Tmin=(100,'K'), Tmax=(976.283,'K')), NASAPolynomial(coeffs=[16.265,0.0418992,-1.53537e-05,2.89294e-09,-2.12218e-13,-16397.3,-65.2913], Tmin=(976.283,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.9124,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclohexene)"""),
)

species(
    label = 'CC=CCC(C)=CC(5497)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.034465,0.0796339,-4.7491e-05,1.40397e-08,-1.69022e-12,-2540.2,31.4477], Tmin=(100,'K'), Tmax=(1862.1,'K')), NASAPolynomial(coeffs=[18.139,0.0407434,-1.61632e-05,2.82385e-09,-1.84419e-13,-9282.74,-67.1522], Tmin=(1862.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-22.3564,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'C=C=CCC(C)CC(4866)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.248013,0.0814533,-4.38093e-05,6.16861e-09,1.61116e-12,5818.24,32.6511], Tmin=(100,'K'), Tmax=(1189.51,'K')), NASAPolynomial(coeffs=[15.7059,0.0443,-1.77591e-05,3.22667e-09,-2.20685e-13,855.772,-51.9914], Tmin=(1189.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(47.0219,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C=CC(C)CC=CC(3844)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0870571,0.073066,-2.18559e-05,-1.55644e-08,8.97939e-12,-338.608,32.8969], Tmin=(100,'K'), Tmax=(1087.49,'K')), NASAPolynomial(coeffs=[14.4144,0.04539,-1.81961e-05,3.35024e-09,-2.32808e-13,-4934.44,-44.2291], Tmin=(1087.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.07776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'C[CH]C(C)CC1[CH]C1(5501)',
    structure = SMILES('C[CH]C(C)CC1[CH]C1'),
    E0 = (332.238,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.481147,0.0635951,-3.50532e-07,-3.3415e-08,1.41153e-11,40097.3,35.1165], Tmin=(100,'K'), Tmax=(1083.41,'K')), NASAPolynomial(coeffs=[12.7265,0.0479639,-1.9662e-05,3.6685e-09,-2.56967e-13,35708,-32.9526], Tmin=(1083.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.238,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(cyclopropane) + radical(Cs_S)"""),
)

species(
    label = '[CH2]C1[CH]CC(C)C1C(5483)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08948,0.040785,7.77202e-05,-1.24116e-07,4.91458e-11,25321,30.9002], Tmin=(100,'K'), Tmax=(960.527,'K')), NASAPolynomial(coeffs=[14.7945,0.0416959,-1.42526e-05,2.56627e-09,-1.83944e-13,20013.4,-48.5906], Tmin=(960.527,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.485,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(519.654,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopentane) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.489159,0.0789833,-4.73935e-05,1.44555e-08,-1.86612e-12,25060.8,32.3361], Tmin=(100,'K'), Tmax=(1651.49,'K')), NASAPolynomial(coeffs=[12.4467,0.0500217,-2.10888e-05,3.83696e-09,-2.58714e-13,21111.3,-31.3508], Tmin=(1651.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(207.339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Tertalkyl) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C=CCC(C)C[CH2](5125)',
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.569134,0.0773601,-4.49844e-05,1.28839e-08,-1.53156e-12,36539,33.6615], Tmin=(100,'K'), Tmax=(1794.49,'K')), NASAPolynomial(coeffs=[13.9264,0.0475861,-2.00966e-05,3.63791e-09,-2.43453e-13,31745.1,-38.59], Tmin=(1794.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(302.801,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_S) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2]C=[C]CC(C)CC(5126)',
    structure = SMILES('[CH2]C=[C]CC(C)CC'),
    E0 = (259.759,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.509531,0.0858256,-5.63001e-05,1.87604e-08,-2.53689e-12,31415.3,35.3127], Tmin=(100,'K'), Tmax=(1710.91,'K')), NASAPolynomial(coeffs=[19.8148,0.0383072,-1.46385e-05,2.52627e-09,-1.6468e-13,24460.8,-73.6549], Tmin=(1710.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(259.759,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.827263,0.0436252,7.96472e-05,-1.30769e-07,5.19916e-11,2600.83,27.8202], Tmin=(100,'K'), Tmax=(969.924,'K')), NASAPolynomial(coeffs=[17.6899,0.0390825,-1.38499e-05,2.5882e-09,-1.90365e-13,-3727.7,-68.7787], Tmin=(969.924,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.4794,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(519.654,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)

species(
    label = 'C=CCCC(C)=CC(5510)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.206849,0.0816482,-5.01453e-05,1.53604e-08,-1.90862e-12,-1208.32,32.7381], Tmin=(100,'K'), Tmax=(1832.36,'K')), NASAPolynomial(coeffs=[19.3903,0.038868,-1.51246e-05,2.61881e-09,-1.70207e-13,-8390.09,-73.6747], Tmin=(1832.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-11.3806,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CC=CC(C)CC(5131)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0827669,0.0733931,-9.7112e-06,-3.77318e-08,1.91776e-11,-2277.95,31.6116], Tmin=(100,'K'), Tmax=(999.328,'K')), NASAPolynomial(coeffs=[17.491,0.0399673,-1.49507e-05,2.72969e-09,-1.92364e-13,-7633.68,-62.3828], Tmin=(999.328,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-20.2822,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CCCC(C)C=C(4887)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0520914,0.0727359,-1.70122e-05,-2.30834e-08,1.21743e-11,1136.52,33.4586], Tmin=(100,'K'), Tmax=(1054.62,'K')), NASAPolynomial(coeffs=[15.2033,0.044182,-1.75213e-05,3.23294e-09,-2.26037e-13,-3667.09,-48.0659], Tmin=(1054.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(8.16759,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)

species(
    label = 'CC1C[CH][CH]CC1C(5511)',
    structure = SMILES('CC1C[CH][CH]CC1C'),
    E0 = (156.72,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32277,0.0450895,4.30879e-05,-6.48589e-08,2.15145e-11,18956.7,26.2267], Tmin=(100,'K'), Tmax=(1128.76,'K')), NASAPolynomial(coeffs=[7.33921,0.0605454,-2.63237e-05,5.00189e-09,-3.51584e-13,15255.6,-13.9058], Tmin=(1128.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(156.72,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclohexane) + radical(cyclohexane) + radical(cyclohexane)"""),
)
...
species(
    label = 'C=CC[CH]C(C)[CH]C(5475)',
    structure = SMILES('C=CC[CH]C(C)[CH]C'),
    E0 = (275.094,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.22801,0.076653,-4.25684e-05,1.11039e-08,-1.1472e-12,33227.1,37.466], Tmin=(100,'K'), Tmax=(2184.65,'K')), NASAPolynomial(coeffs=[22.8363,0.0352579,-1.4146e-05,2.43045e-09,-1.54658e-13,23348.9,-89.2734], Tmin=(2184.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(275.094,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Cs_S)"""),
)

species(
    label = 'C=[C]CCC(C)[CH]C(5513)',
    structure = SMILES('C=[C]CCC(C)[CH]C'),
    E0 = (318.394,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.303587,0.0795225,-4.79454e-05,1.4399e-08,-1.7885e-12,38427.4,35.0678], Tmin=(100,'K'), Tmax=(1760.75,'K')), NASAPolynomial(coeffs=[15.3118,0.0454281,-1.89007e-05,3.40215e-09,-2.27145e-13,33142.2,-45.8292], Tmin=(1760.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(318.394,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]=CCCC(C)[CH]C(5515)',
    structure = SMILES('[CH]=CCCC(C)[CH]C'),
    E0 = (327.648,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0668974,0.0820369,-5.1214e-05,1.59859e-08,-2.03932e-12,39559.1,36.3495], Tmin=(100,'K'), Tmax=(1766.57,'K')), NASAPolynomial(coeffs=[17.8924,0.0413727,-1.66864e-05,2.95611e-09,-1.95404e-13,33213.7,-60.5133], Tmin=(1766.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(327.648,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C([CH]C)CCC=C(5137)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0567874,0.0812169,-5.08971e-05,1.65016e-08,-2.21586e-12,34506.2,37.6883], Tmin=(100,'K'), Tmax=(1678.79,'K')), NASAPolynomial(coeffs=[16.0291,0.0428892,-1.66511e-05,2.90205e-09,-1.90638e-13,29105.3,-48.2504], Tmin=(1678.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(285.635,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH]=C[CH]CC(C)CC(5139)',
    structure = SMILES('[CH]C=CCC(C)CC'),
    E0 = (241.102,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.276785,0.0816164,-3.39871e-05,-3.33439e-09,4.41032e-12,29162.1,34.8089], Tmin=(100,'K'), Tmax=(1165.61,'K')), NASAPolynomial(coeffs=[14.3159,0.051451,-2.07923e-05,3.77484e-09,-2.5788e-13,24407.5,-43.6313], Tmin=(1165.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(241.102,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C[CH]CC(C)[CH]C(4499)'],
    products = ['butadiene13(1350)', 'butene2t(396)'],
    transitionState = 'TS1',
...
reaction(
    ...
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C=CC[CH]C(C)C(5493)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHCH3(T)(21)', '[CH2]C=CC[CH]C(554)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH]C(C)CC=C[CH2](5002)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(20)', '[CH]=CCC(C)[CH]C(5494)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH2]C=CCC(C)[C]C(5495)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]C=CCC(C)[CH]C(5496)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][CH]CC[C](C)[CH]C(5499)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C[CH]C[C](C)[CH]C(5500)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=C[CH]CC(C)[CH]C(4499)'],
    products = ['C[CH]C(C)CC1[CH]C1(5501)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C=C[CH]CC(C)[CH]C(4499)'],
    products = ['[CH2]C1[CH]CC(C)C1C(5483)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH2]C=CCC(C)=CC(5503)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', 'C=C[CH]CC(C)C=C(4924)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C=C=CCC(C)[CH]C(4925)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2][CH]C=C(3743)', 'butene2t(396)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH3(17)', '[CH2]C=CCC=CC(5057)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]C=C(3739)', '[CH2]C(C)[CH]C(114)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', '[CH2]C=[C]CC(C)[CH]C(5506)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', '[CH2][C]=CCC(C)[CH]C(5507)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction37',
    reactants = ['C=C[CH]CC(C)[CH]C(4499)'],
    products = ['[CH2]C=CCC(C)C[CH2](5125)'],
...
reaction(
    label = 'reaction41',
    reactants = ['C[CH]C(C)C[C]=CC(5509)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2]C=[C]CC(C)CC(5126)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction45',
    reactants = ['C[CH][CH]CC(C)=CC(4497)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2]C([CH]C)CC=CC(3841)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction47',
    reactants = ['C=CC(C)C[CH][CH]C(3837)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction49',
    reactants = ['C2H3(60)', '[CH]CC(C)[CH]C(1181)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction55',
    reactants = ['H(3)', 'C=CC=CC(C)[CH]C(5512)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction56',
    reactants = ['butadiene13(1350)', 'C[CH][CH]C(1186)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction57',
    reactants = ['C=CC[CH]C(C)[CH]C(5475)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction61',
    reactants = ['[CH2]C([CH]C)CCC=C(5137)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction62',
    reactants = ['[CH2][CH]C(C)CCC=C(5516)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
reaction(
    label = 'reaction63',
    reactants = ['[CH]=C[CH]CC(C)CC(5139)'],
    products = ['C=C[CH]CC(C)[CH]C(4499)'],
...
network(
    ...
    isomers = [
        'C=C[CH]CC(C)[CH]C(4499)',
    ],
    reactants = [
        ('butadiene13(1350)', 'butene2t(396)'),
    ],
    bathGas = {
        'Ar': 0.333333,
        'Ne': 0.333333,
