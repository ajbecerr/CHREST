...
species(
    label = '[CH2]C([CH]C1CC1)C=C(6468)',
    structure = SMILES('[CH2]C([CH]C1CC1)C=C'),
    E0 = (433.565,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.693315,0.0561404,1.75939e-05,-5.95308e-08,2.60053e-11,52279.6,34.2909], Tmin=(100,'K'), Tmax=(982.258,'K')), NASAPolynomial(coeffs=[15.0555,0.0370861,-1.35251e-05,2.45949e-09,-1.7411e-13,47555.9,-44.4244], Tmin=(982.258,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(433.565,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.755119,0.0511945,3.64213e-05,-8.46762e-08,3.64562e-11,82259.1,31.4321], Tmin=(100,'K'), Tmax=(959.942,'K')), NASAPolynomial(coeffs=[17.3836,0.0315978,-1.06066e-05,1.9107e-09,-1.38078e-13,76777.1,-60.0364], Tmin=(959.942,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(682.818,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(C=C)C1[CH]CC1(6471)',
    structure = SMILES('[CH]C(C=C)C1[CH]CC1'),
    E0 = (665.574,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.890612,0.0502065,3.03777e-05,-7.05788e-08,2.90458e-11,80178.1,32.6116], Tmin=(100,'K'), Tmax=(998.501,'K')), NASAPolynomial(coeffs=[15.168,0.0364167,-1.41126e-05,2.66183e-09,-1.92133e-13,75163.1,-47.0824], Tmin=(998.501,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(665.574,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.527339,0.0609026,4.15717e-06,-4.37699e-08,1.95964e-11,18716.8,27.7675], Tmin=(100,'K'), Tmax=(1016.49,'K')), NASAPolynomial(coeffs=[14.9922,0.0390046,-1.52105e-05,2.82796e-09,-2.00513e-13,13966.8,-51.1536], Tmin=(1016.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(154.469,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutene)"""),
)

species(
    label = 'C=CC(=C)C1CCC1(6474)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.712888,0.0466898,6.4064e-05,-1.18925e-07,4.94416e-11,16538.2,27.1176], Tmin=(100,'K'), Tmax=(958.684,'K')), NASAPolynomial(coeffs=[19.9681,0.0301172,-9.7796e-06,1.80828e-09,-1.35676e-13,9915.92,-80.2485], Tmin=(958.684,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(136.33,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)

species(
    label = 'C=CC(C)C1C=CC1(6241)',
...
species(
    label = '[CH2]CC=CC([CH2])C=C(6483)',
    structure = SMILES('[CH2]CC=CC([CH2])C=C'),
    E0 = (406.838,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.260542,0.0799744,-5.97518e-05,2.48133e-08,-4.37253e-12,49067.6,34.117], Tmin=(100,'K'), Tmax=(1302.85,'K')), NASAPolynomial(coeffs=[12.2479,0.0431713,-1.73799e-05,3.13186e-09,-2.12193e-13,45944,-26.8867], Tmin=(1302.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(406.838,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C(C=C)[C]1CCC1(6495)',
    structure = SMILES('[CH2]C(C=C)[C]1CCC1'),
    E0 = (420.026,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.859683,0.0559254,7.96995e-06,-4.12713e-08,1.75193e-11,50641.9,32.2881], Tmin=(100,'K'), Tmax=(1023.33,'K')), NASAPolynomial(coeffs=[11.7111,0.0431146,-1.6647e-05,3.03628e-09,-2.1149e-13,46870.8,-27.8878], Tmin=(1023.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(420.026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C=C)C1C[CH]C1(6497)',
    structure = SMILES('[CH2]C(C=C)C1C[CH]C1'),
    E0 = (422.442,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C=[C]C(C)C1[CH]CC1(6500)',
    structure = SMILES('C=[C]C(C)C1[CH]CC1'),
    E0 = (455.201,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.897283,0.0518795,2.47701e-05,-6.07424e-08,2.44473e-11,54874,32.0585], Tmin=(100,'K'), Tmax=(1020.57,'K')), NASAPolynomial(coeffs=[13.3077,0.0416219,-1.65681e-05,3.11218e-09,-2.2172e-13,50341.9,-37.8605], Tmin=(1020.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(455.201,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(Cds_S)"""),
)

species(
    label = 'C=CC(C)C1[CH]C[CH]1(6501)',
...
species(
    label = '[CH2]C([C]=C)C1CCC1(6502)',
    structure = SMILES('[CH2]C([C]=C)C1CCC1'),
    E0 = (472.445,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.766151,0.0528363,3.08149e-05,-7.46604e-08,3.16904e-11,56954.8,31.9608], Tmin=(100,'K'), Tmax=(972.522,'K')), NASAPolynomial(coeffs=[15.397,0.037009,-1.31774e-05,2.38768e-09,-1.69836e-13,52011.8,-48.9996], Tmin=(972.522,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(472.445,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CC(C)C1[CH]CC1(6503)',
    structure = SMILES('[CH]=CC(C)C1[CH]CC1'),
    E0 = (464.455,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.862638,0.0507462,3.30146e-05,-7.26431e-08,2.94375e-11,55990.1,32.1113], Tmin=(100,'K'), Tmax=(1002.65,'K')), NASAPolynomial(coeffs=[14.607,0.0395029,-1.53767e-05,2.89229e-09,-2.07805e-13,51042.9,-45.16], Tmin=(1002.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(464.455,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=CC([CH2])C1CCC1(6505)',
    structure = SMILES('[CH]=CC([CH2])C1CCC1'),
    E0 = (481.699,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.727847,0.0517303,3.9048e-05,-8.66871e-08,3.68048e-11,58071.1,32.0277], Tmin=(100,'K'), Tmax=(963.315,'K')), NASAPolynomial(coeffs=[16.797,0.034726,-1.18943e-05,2.1466e-09,-1.54193e-13,52668.2,-56.8699], Tmin=(963.315,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(481.699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C([CH]C1CC1)C=C(6468)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
    products = ['C=CC[CH]C1[CH]CC1(6469)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(6.55606e+10,'s^-1'), n=0.64, Ea=(159.935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [cCs(-HC)CJ;CsJ;C] for rate rule [cCs(-HC)CJ;CsJ-HH;C]
Euclidian distance = 1.0
family: 1,2_shiftC"""),
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(C=C)C1CC1[CH2](5650)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(6.55606e+10,'s^-1'), n=0.64, Ea=(159.935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [cCs(-HC)CJ;CsJ;C] for rate rule [cCs(-HC)CJ;CsJ-HH;C]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH2]C(C=C)C1[C]CC1(6470)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]C(C=C)C1[CH]CC1(6471)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C[C]([CH2])C1[CH]CC1(6475)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CC([CH2])[C]1[CH]CC1(6476)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C([CH]C)[C]1[CH]CC1(6477)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CC([CH2])C1[CH]C[CH]1(6478)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C([CH]C)C1[CH]C[CH]1(6479)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CC([CH2])C1[CH][CH]C1(6480)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C([CH]C)C1[CH][CH]C1(6481)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]CC=CC([CH2])C=C(6483)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2]C(C=C)C1=CCC1(6486)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', 'C=CC(=C)C1[CH]CC1(6487)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH2]C(C=C)C1C=CC1(6488)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction31',
    reactants = ['C2H3(60)', 'C=CC1[CH]CC1(6206)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction34',
    reactants = ['C2H3(60)', '[CH2][CH]C1[CH]CC1(6257)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', '[CH2]C(C=C)C1[CH]C[CH]1(6491)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(3)', '[CH2]C([C]=C)C1[CH]CC1(6493)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction39',
    reactants = ['H(3)', '[CH]=CC([CH2])C1[CH]CC1(6494)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
    products = ['[CH2]C(C=C)[C]1CCC1(6495)'],
...
reaction(
    label = 'reaction42',
    reactants = ['C=C[C](C)C1[CH]CC1(6496)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]C(C=C)C1C[CH]C1(6497)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction46',
    reactants = ['C=[C]C(C)C1[CH]CC1(6500)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
    products = ['C=CC(C)C1[CH]C[CH]1(6501)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]C([C]=C)C1CCC1(6502)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH]=CC(C)C1[CH]CC1(6503)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH]=CC([CH2])C1CCC1(6505)'],
    products = ['[CH2]C(C=C)C1[CH]CC1(5648)'],
    transitionState = 'TS51',
    kinetics = Arrhenius(A=(732351,'s^-1'), n=1.54456, Ea=(43.4053,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5H_RSSR;Y_rad_out;Cs_H_out_H/NonDeC] for rate rule [R5H_DSSS;Cd_rad_out_singleH;Cs_H_out_H/(NonDeC/Cs)]
