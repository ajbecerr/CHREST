...
species(
    label = '[CH]=C(CO[O])CC([CH2])C(19694)',
    structure = SMILES('[CH]=C(CO[O])CC([CH2])C'),
    E0 = (410.374,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.287679,0.0978807,-0.000103495,6.44061e-08,-1.67723e-11,49507.8,37.9068], Tmin=(100,'K'), Tmax=(919.779,'K')), NASAPolynomial(coeffs=[11.5408,0.0464419,-1.96093e-05,3.60682e-09,-2.47254e-13,47331.9,-18.1698], Tmin=(919.779,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(410.374,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(C[O])C[CH]CC(19695)',
    structure = SMILES('[CH]=C(C[O])C[CH]CC'),
    E0 = (410.987,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3025,407.5,1350,352.5,3120,650,792.5,1650,180,400,1064.5,3200],'cm^-1')),
        HinderedRotor(inertia=(0.0348269,'amu*angstrom^2'), symmetry=1, barrier=(3.20296,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0348269,'amu*angstrom^2'), symmetry=1, barrier=(3.20296,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0348269,'amu*angstrom^2'), symmetry=1, barrier=(3.20296,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0348269,'amu*angstrom^2'), symmetry=1, barrier=(3.20296,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0348269,'amu*angstrom^2'), symmetry=1, barrier=(3.20296,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.550793,0.0852099,-0.000110076,1.0133e-07,-3.87323e-11,49545.4,35.2854], Tmin=(100,'K'), Tmax=(809.599,'K')), NASAPolynomial(coeffs=[2.08399,0.0591677,-2.76104e-05,5.2495e-09,-3.63011e-13,49902.3,31.9502], Tmin=(809.599,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(410.987,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ) + radical(RCCJCC) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(C[C]CC)CO[O](19696)',
    structure = SMILES('[CH]=C(C[C]CC)CO[O]'),
    E0 = (662.548,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3120,650,792.5,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.326508,0.101188,-0.000118302,8.07876e-08,-2.3019e-11,79836.5,36.455], Tmin=(100,'K'), Tmax=(844.17,'K')), NASAPolynomial(coeffs=[11.2216,0.0464686,-2.10715e-05,4.00176e-09,-2.78915e-13,77886.8,-17.3017], Tmin=(844.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(662.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[C]=C(C[CH]CC)CO[O](19697)',
    structure = SMILES('[C]=C(C[CH]CC)CO[O]'),
    E0 = (719.797,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,350,440,435,1725,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.223152,0.104585,-0.000155678,1.41804e-07,-5.13224e-11,86712.3,38.6981], Tmin=(100,'K'), Tmax=(836.452,'K')), NASAPolynomial(coeffs=[4.98421,0.0560726,-2.63418e-05,4.97466e-09,-3.40772e-13,86667.1,19.4427], Tmin=(836.452,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(719.797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(RCCJCC) + radical(CdCdJ2_triplet)"""),
)

species(
    label = 'CCC1C=C(CO[O])C1(19671)',
    structure = SMILES('CCC1C=C(CO[O])C1'),
    E0 = (120.254,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
...
species(
    label = '[CH]=C1COOC(CC)C1(19698)',
    structure = SMILES('[CH]=C1COOC(CC)C1'),
    E0 = (114.602,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.102508,0.0651493,1.29432e-05,-5.73703e-08,2.37908e-11,13941.4,28.8424], Tmin=(100,'K'), Tmax=(1064.76,'K')), NASAPolynomial(coeffs=[19.1712,0.040469,-1.84372e-05,3.695e-09,-2.71544e-13,7218.97,-76.8486], Tmin=(1064.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclohexanone) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C1COC(CC)C1(19700)',
    structure = SMILES('[CH]=C1COC(CC)C1'),
    E0 = (85.3492,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01639,0.0469194,3.85361e-05,-7.94543e-08,3.25471e-11,10389.2,28.2847], Tmin=(100,'K'), Tmax=(983.772,'K')), NASAPolynomial(coeffs=[14.9865,0.0354743,-1.31708e-05,2.45135e-09,-1.76825e-13,5445.68,-50.0395], Tmin=(983.772,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(85.3492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(C=CCC)COO(19702)',
    structure = SMILES('[CH]=C(C=CCC)COO'),
    E0 = (163.125,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.602261,0.0975466,-8.80206e-05,4.18677e-08,-8.09364e-12,19788.1,34.7542], Tmin=(100,'K'), Tmax=(1232.18,'K')), NASAPolynomial(coeffs=[17.5772,0.0385312,-1.61781e-05,2.99763e-09,-2.07198e-13,15308,-56.7466], Tmin=(1232.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(163.125,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(CC=CC)COO(19703)',
    structure = SMILES('[CH]=C(CC=CC)COO'),
    E0 = (179.134,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00501911,0.0920586,-8.2101e-05,4.09018e-08,-8.67308e-12,21685.8,34.6914], Tmin=(100,'K'), Tmax=(1096.34,'K')), NASAPolynomial(coeffs=[12.1039,0.047879,-2.16549e-05,4.14537e-09,-2.91433e-13,19030.7,-24.841], Tmin=(1096.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(179.134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(CC=CC)CO[O](19368)',
    structure = SMILES('[CH]=C(CC=CC)CO[O]'),
    E0 = (331.139,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2995,3025,975,1000,1300,1375,400,500,1630,1680,3120,650,792.5,1650,258.578,258.578],'cm^-1')),
        HinderedRotor(inertia=(0.17905,'amu*angstrom^2'), symmetry=1, barrier=(8.49536,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.179049,'amu*angstrom^2'), symmetry=1, barrier=(8.49536,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17905,'amu*angstrom^2'), symmetry=1, barrier=(8.49536,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.179049,'amu*angstrom^2'), symmetry=1, barrier=(8.49536,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.179049,'amu*angstrom^2'), symmetry=1, barrier=(8.49536,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.177543,0.0893067,-8.92673e-05,5.29165e-08,-1.34551e-11,39960,34.8037], Tmin=(100,'K'), Tmax=(927.354,'K')), NASAPolynomial(coeffs=[9.91826,0.0472918,-2.13082e-05,4.06144e-09,-2.84606e-13,38153.4,-11.455], Tmin=(927.354,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(331.139,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(C=CCC)CO[O](19704)',
    structure = SMILES('[CH]=C(C=CCC)CO[O]'),
    E0 = (315.13,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2995,3025,975,1000,1300,1375,400,500,1630,1680,3120,650,792.5,1650,231.971,231.998],'cm^-1')),
        HinderedRotor(inertia=(0.309823,'amu*angstrom^2'), symmetry=1, barrier=(11.8338,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.309851,'amu*angstrom^2'), symmetry=1, barrier=(11.8336,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.309657,'amu*angstrom^2'), symmetry=1, barrier=(11.8332,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.309998,'amu*angstrom^2'), symmetry=1, barrier=(11.8346,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.309685,'amu*angstrom^2'), symmetry=1, barrier=(11.8328,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.244497,0.092831,-8.88003e-05,4.62429e-08,-9.86983e-12,38054.6,34.2314], Tmin=(100,'K'), Tmax=(1118.74,'K')), NASAPolynomial(coeffs=[14.8906,0.038716,-1.62427e-05,3.00491e-09,-2.0756e-13,34668.2,-40.4846], Tmin=(1118.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(315.13,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C([CH][CH]CC)CO[O](19705)',
    structure = SMILES('[CH]C(=C[CH]CC)CO[O]'),
    E0 = (466.788,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.244713,0.0872765,-6.99322e-05,3.27958e-08,-6.85187e-12,56272.9,33.6527], Tmin=(100,'K'), Tmax=(1079.91,'K')), NASAPolynomial(coeffs=[9.13037,0.0543642,-2.42171e-05,4.57454e-09,-3.18683e-13,54353.8,-9.89871], Tmin=(1079.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(466.788,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Allyl_S) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]=C(C[CH]C[CH2])CO[O](19707)',
    structure = SMILES('[CH]=C(C[CH]C[CH2])CO[O]'),
    E0 = (614.037,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,350,440,435,1725,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3120,650,792.5,1650,216.953,816.953,1646],'cm^-1')),
        HinderedRotor(inertia=(0.130884,'amu*angstrom^2'), symmetry=1, barrier=(3.54105,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130884,'amu*angstrom^2'), symmetry=1, barrier=(3.54105,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130884,'amu*angstrom^2'), symmetry=1, barrier=(3.54105,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130884,'amu*angstrom^2'), symmetry=1, barrier=(3.54105,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130884,'amu*angstrom^2'), symmetry=1, barrier=(3.54105,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.207914,0.102267,-0.000144801,1.26804e-07,-4.48839e-11,73993.8,40.4563], Tmin=(100,'K'), Tmax=(828.051,'K')), NASAPolynomial(coeffs=[6.2942,0.0534069,-2.46805e-05,4.64381e-09,-3.18189e-13,73515.2,13.9267], Tmin=(828.051,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(614.037,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(RCCJCC) + radical(RCCJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(CC[CH]C)CO[O](19708)',
    structure = SMILES('[CH]=C(CC[CH]C)CO[O]'),
    E0 = (408.779,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.235267,0.100465,-0.000126927,1.03087e-07,-3.5233e-11,49310.3,38.9425], Tmin=(100,'K'), Tmax=(795.415,'K')), NASAPolynomial(coeffs=[7.40147,0.0540904,-2.44419e-05,4.59124e-09,-3.15996e-13,48347.6,5.43265], Tmin=(795.415,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(408.779,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(RCCJC) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.188246,0.0982606,-0.000106971,7.02097e-08,-1.96396e-11,50609.1,37.842], Tmin=(100,'K'), Tmax=(851.58,'K')), NASAPolynomial(coeffs=[9.98117,0.050494,-2.28341e-05,4.34373e-09,-3.03457e-13,48877.1,-9.58584], Tmin=(851.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(419.579,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(RCCJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C([CH][CH]CC)COO(19714)',
    structure = SMILES('[CH]C(=C[CH]CC)COO'),
    E0 = (314.784,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0430876,0.0913299,-6.74604e-05,2.68739e-08,-4.61131e-12,38002.8,33.9117], Tmin=(100,'K'), Tmax=(1303.6,'K')), NASAPolynomial(coeffs=[12.3884,0.0531849,-2.35685e-05,4.42739e-09,-3.06595e-13,34761.7,-29.3588], Tmin=(1303.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(314.784,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]=C(C[CH][CH]C)COO(19716)',
    structure = SMILES('[CH]=C(C[CH][CH]C)COO'),
    E0 = (451.233,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3050,390,425,1340,1360,335,370,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.28007,0.104991,-0.00014802,1.32722e-07,-4.81697e-11,54414.4,40.9047], Tmin=(100,'K'), Tmax=(824.918,'K')), NASAPolynomial(coeffs=[4.86108,0.0594567,-2.77543e-05,5.24735e-09,-3.60615e-13,54267.3,21.3405], Tmin=(824.918,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(451.233,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJC) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(C[CH]C[CH2])COO(19717)',
    structure = SMILES('[CH]=C(C[CH]C[CH2])COO'),
    E0 = (462.033,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,350,440,435,1725,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.647593,0.088112,-4.70618e-05,-7.80977e-08,1.01509e-10,55675.6,36.8689], Tmin=(100,'K'), Tmax=(479.766,'K')), NASAPolynomial(coeffs=[7.66553,0.055476,-2.59249e-05,4.94758e-09,-3.43752e-13,54704.5,5.0622], Tmin=(479.766,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(462.033,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJ) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH]=C(C[CH]C)CO[O](19247)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]=C(CO[O])CC([CH2])C(19694)'],
    products = ['[CH]=C(C[CH]CC)CO[O](19261)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O(4)', '[CH]=C(C[O])C[CH]CC(19695)'],
    products = ['[CH]=C(C[CH]CC)CO[O](19261)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(14)', '[CH]CC(=[CH])CO[O](19530)'],
    products = ['[CH]=C(C[CH]CC)CO[O](19261)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]CC(26)', '[CH]=C([CH2])CO[O](19529)'],
    products = ['[CH]=C(C[CH]CC)CO[O](19261)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]=C(C[C]CC)CO[O](19696)'],
    products = ['[CH]=C(C[CH]CC)CO[O](19261)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[C]=C(C[CH]CC)CO[O](19697)'],
    products = ['[CH]=C(C[CH]CC)CO[O](19261)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=C(C[CH]CC)CO[O](19261)'],
    products = ['CCC1C=C(CO[O])C1(19671)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(C[CH]CC)CO[O](19261)'],
    products = ['[CH]=C1COOC(CC)C1(19698)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=C(C[CH]CC)CO[O](19261)'],
    products = ['O(4)', '[CH]=C1COC(CC)C1(19700)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH]=C(CC=CC)CO[O](19368)'],
    products = ['[CH]=C(C[CH]CC)CO[O](19261)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH]=C(C=CCC)CO[O](19704)'],
    products = ['[CH]=C(C[CH]CC)CO[O](19261)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH3(17)', '[CH]=C(CC=C)CO[O](19282)'],
    products = ['[CH]=C(C[CH]CC)CO[O](19261)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]O[O](46)', 'C#CC[CH]CC(9803)'],
    products = ['[CH]=C(C[CH]CC)CO[O](19261)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH3(17)', '[CH]=C(C[CH][CH2])CO[O](19278)'],
    products = ['[CH]=C(C[CH]CC)CO[O](19261)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH]=C(C[CH][CH]C)CO[O](19357)'],
    products = ['[CH]=C(C[CH]CC)CO[O](19261)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', '[CH]=C([CH][CH]CC)CO[O](19705)'],
    products = ['[CH]=C(C[CH]CC)CO[O](19261)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]O[O](46)', '[CH]=[C]C[CH]CC(9797)'],
    products = ['[CH]=C(C[CH]CC)CO[O](19261)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', '[CH]=C(C[CH]C[CH2])CO[O](19707)'],
    products = ['[CH]=C(C[CH]CC)CO[O](19261)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]=C(C[CH]CC)CO[O](19261)'],
    products = ['[CH]=C(CC[CH]C)CO[O](19708)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]=C(C[CH]CC)CO[O](19261)'],
    products = ['[CH]=C([CH]OO)C[CH]CC(19709)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH]=C(CCC[CH2])CO[O](19710)'],
    products = ['[CH]=C(C[CH]CC)CO[O](19261)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH]=C(C[CH]CC)CO[O](19261)'],
    products = ['[CH]=C([CH]O[O])CCCC(19713)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH]=C(C[CH]CC)CO[O](19261)'],
    products = ['C=C(C[CH][CH]C)CO[O](4767)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH]=C(C[CH]CC)CO[O](19261)'],
    products = ['[CH]=C([CH][CH]CC)COO(19714)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH]=C(C[CH]CC)CO[O](19261)'],
    products = ['[CH2]C[CH]CC(=C)CO[O](19715)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH]=C(C[CH][CH]C)COO(19716)'],
    products = ['[CH]=C(C[CH]CC)CO[O](19261)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH]=C(C[CH]C[CH2])COO(19717)'],
    products = ['[CH]=C(C[CH]CC)CO[O](19261)'],
...
network(
    label = 'PDepNetwork #4262',
    isomers = [
        '[CH]=C(C[CH]CC)CO[O](19261)',
    ],
    reactants = [
