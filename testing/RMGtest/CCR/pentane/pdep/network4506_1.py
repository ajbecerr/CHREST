...
species(
    label = '[CH]=CC(=[CH])C[O](20176)',
    structure = SMILES('[CH]=CC(=[CH])C[O]'),
    E0 = (623.092,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,3115,3125,620,680,785,800,1600,1700,187.708],'cm^-1')),
        HinderedRotor(inertia=(0.289718,'amu*angstrom^2'), symmetry=1, barrier=(7.33778,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.584981,'amu*angstrom^2'), symmetry=1, barrier=(14.8126,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70874,0.0532283,-5.99044e-05,3.89533e-08,-1.05514e-11,75020.7,22.2515], Tmin=(100,'K'), Tmax=(886.315,'K')), NASAPolynomial(coeffs=[8.13178,0.0242407,-1.08459e-05,2.05267e-09,-1.43004e-13,73882.2,-7.96079], Tmin=(886.315,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(623.092,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P) + radical(Cds_P)"""),
)
...
species(
    label = '[C]=C(C=[CH])CO[O](20177)',
    structure = SMILES('[C]=C(C=[CH])CO[O]'),
    E0 = (931.903,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.616253,'amu*angstrom^2'), symmetry=1, barrier=(14.1689,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.61627,'amu*angstrom^2'), symmetry=1, barrier=(14.1693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.616929,'amu*angstrom^2'), symmetry=1, barrier=(14.1844,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (96.0841,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.820984,0.0740737,-0.000111329,8.81455e-08,-2.74893e-11,112193,26.0645], Tmin=(100,'K'), Tmax=(836.732,'K')), NASAPolynomial(coeffs=[11.1895,0.0208637,-9.4089e-06,1.73702e-09,-1.17316e-13,110585,-21.3474], Tmin=(836.732,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(931.903,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_P) + radical(CdCdJ2_triplet)"""),
)

species(
    label = '[C]=CC(=[CH])CO[O](20178)',
...
species(
    label = '[CH]=C1C=COOC1(20180)',
    structure = SMILES('[CH]=C1C=COOC1'),
    E0 = (285.755,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83755,0.0260803,6.1827e-05,-1.00366e-07,3.97424e-11,34465.4,16.8418], Tmin=(100,'K'), Tmax=(984.4,'K')), NASAPolynomial(coeffs=[16.9225,0.0181369,-7.36654e-06,1.55119e-09,-1.231e-13,28910.4,-68.8275], Tmin=(984.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(285.755,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclohexane) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C1C=COC1(20182)',
    structure = SMILES('[CH]=C1C=COC1'),
    E0 = (206.434,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21841,0.00759863,0.000120205,-1.8214e-07,7.65849e-11,24921.9,15.7361], Tmin=(100,'K'), Tmax=(912.49,'K')), NASAPolynomial(coeffs=[24.1729,-0.00647455,8.26906e-06,-1.6775e-09,1.05884e-13,17494.5,-106.915], Tmin=(912.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(206.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (97.092,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.778463,0.0742397,-8.94939e-05,6.2834e-08,-1.8221e-11,66404.3,26.6049], Tmin=(100,'K'), Tmax=(834.78,'K')), NASAPolynomial(coeffs=[9.53955,0.0322571,-1.40521e-05,2.58188e-09,-1.75747e-13,64941.6,-14.0796], Tmin=(834.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(551.178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(AllylJ2_triplet) + radical(C=C=CJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(4)', '[CH]=CC(=[CH])C[O](20176)'],
    products = ['[CH]=CC(=[CH])CO[O](19485)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[C]=C(C=[CH])CO[O](20177)'],
    products = ['[CH]=CC(=[CH])CO[O](19485)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[C]=CC(=[CH])CO[O](20178)'],
    products = ['[CH]=CC(=[CH])CO[O](19485)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]=CC(=[CH])CO[O](19485)'],
    products = ['O(4)', '[CH]=C1C=COC1(20182)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]=C(C#C)CO[O](20183)'],
    products = ['[CH]=CC(=[CH])CO[O](19485)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]O[O](46)', 'HCCCHCH(15192)'],
    products = ['[CH]=CC(=[CH])CO[O](19485)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]O[O](46)', '[CH]=[C]C=[CH](15193)'],
    products = ['[CH]=CC(=[CH])CO[O](19485)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH]=[C]C(=[CH])CO[O](20185)'],
    products = ['[CH]=CC(=[CH])CO[O](19485)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=CC(=[CH])CO[O](19485)'],
    products = ['[CH]=C([CH]O[O])C=C(20189)'],
