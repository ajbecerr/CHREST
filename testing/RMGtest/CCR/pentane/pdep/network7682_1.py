...
species(
    label = '[CH][C]OO[CH2](29849)',
    structure = SMILES('[CH][C]OO[CH2]'),
    E0 = (917.659,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3100,440,815,1455,1000,180,499.127,499.149,499.232],'cm^-1')),
        HinderedRotor(inertia=(1.28551,'amu*angstrom^2'), symmetry=1, barrier=(29.5565,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0109898,'amu*angstrom^2'), symmetry=1, barrier=(1.94365,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0139814,'amu*angstrom^2'), symmetry=1, barrier=(43.2365,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.8805,'amu*angstrom^2'), symmetry=1, barrier=(43.2364,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (71.0547,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.76016,0.0528946,-7.17654e-05,4.98948e-08,-1.38672e-11,110446,18.3195], Tmin=(100,'K'), Tmax=(876.785,'K')), NASAPolynomial(coeffs=[9.88279,0.0158373,-8.3665e-06,1.68804e-09,-1.21525e-13,109022,-19.7992], Tmin=(876.785,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(917.659,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOOC) + radical(CH2_triplet) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]O[O](46)', '[CH][CH](6981)'],
    products = ['[CH][CH]OO[CH2](28870)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(20)', '[CH][CH]O[O](6930)'],
    products = ['[CH][CH]OO[CH2](28870)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH][C]OO[CH2](29849)'],
    products = ['[CH][CH]OO[CH2](28870)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH][CH]OO[CH](7335)'],
    products = ['[CH][CH]OO[CH2](28870)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
