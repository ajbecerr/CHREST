...
species(
    label = '[CH2]CC[CH]C[O](789)',
    structure = SMILES('[CH2]CC[CH]C[O]'),
    E0 = (302.942,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,364.775,2233.27,2233.73,2233.78],'cm^-1')),
        HinderedRotor(inertia=(0.00126665,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0722215,'amu*angstrom^2'), symmetry=1, barrier=(6.80634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.374274,'amu*angstrom^2'), symmetry=1, barrier=(35.4548,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0720941,'amu*angstrom^2'), symmetry=1, barrier=(6.82603,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.44173,0.0417393,1.81335e-05,-1.06951e-07,9.41425e-11,36483.8,25.4652], Tmin=(100,'K'), Tmax=(431.556,'K')), NASAPolynomial(coeffs=[3.36251,0.0429268,-1.97854e-05,3.82691e-09,-2.71023e-13,36313.8,20.7479], Tmin=(431.556,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(302.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CC[C]CO[O](791)',
    structure = SMILES('[CH2]CC[C]CO[O]'),
    E0 = (549.059,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.899032,0.0748499,-8.29453e-05,4.75347e-08,-7.54309e-12,66142.1,28.9365], Tmin=(100,'K'), Tmax=(625.536,'K')), NASAPolynomial(coeffs=[8.38351,0.0371638,-1.69714e-05,3.22224e-09,-2.24114e-13,65006.7,-5.25143], Tmin=(625.536,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(549.059,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH2]CCC1COO1(793)',
    structure = SMILES('[CH2]CCC1COO1'),
    E0 = (105.552,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30982,0.0584118,-3.55879e-05,1.07341e-08,-1.33793e-12,12791.5,22.9048], Tmin=(100,'K'), Tmax=(1753.16,'K')), NASAPolynomial(coeffs=[12.3334,0.0332608,-1.40689e-05,2.55126e-09,-1.71065e-13,8926.29,-36.4663], Tmin=(1753.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(105.552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CCC1CO1(794)',
    structure = SMILES('[CH2]CCC1CO1'),
    E0 = (54.2553,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54022,0.0455151,2.37136e-06,-3.9626e-08,2.13379e-11,6622.2,21.8682], Tmin=(100,'K'), Tmax=(868.518,'K')), NASAPolynomial(coeffs=[11.5345,0.0250053,-6.28073e-06,8.46108e-10,-4.99312e-14,3923.65,-30.4807], Tmin=(868.518,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(54.2553,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40651,0.0594969,-4.14944e-05,1.60054e-08,-2.71632e-12,2235.06,26.465], Tmin=(100,'K'), Tmax=(1291.38,'K')), NASAPolynomial(coeffs=[8.37126,0.0379239,-1.64364e-05,3.06944e-09,-2.12029e-13,436.227,-8.91691], Tmin=(1291.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(17.8265,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = 'C=CCCCO[O](796)',
    structure = SMILES('C=CCCCO[O]'),
    E0 = (23.3802,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17857,0.0644379,-5.11307e-05,2.30219e-08,-4.50652e-12,2911.5,26.6766], Tmin=(100,'K'), Tmax=(1161.29,'K')), NASAPolynomial(coeffs=[8.98447,0.0375509,-1.64017e-05,3.08496e-09,-2.14533e-13,1098.51,-12.1495], Tmin=(1161.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(23.3802,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]CCC=COO(797)',
    structure = SMILES('[CH2]CCC=COO'),
    E0 = (80.6465,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.476694,0.0695463,-5.58313e-05,2.31024e-08,-3.85113e-12,9832.9,30.665], Tmin=(100,'K'), Tmax=(1425.04,'K')), NASAPolynomial(coeffs=[15.8382,0.0264276,-1.04446e-05,1.86956e-09,-1.26185e-13,5454.72,-48.8867], Tmin=(1425.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(80.6465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJ)"""),
)

species(
    label = 'CCCC=CO[O](698)',
    structure = SMILES('CCCC=CO[O]'),
    E0 = (27.4049,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.71444,0.0651256,-4.99328e-05,2.02505e-08,-3.34904e-12,3420.17,28.782], Tmin=(100,'K'), Tmax=(1425.41,'K')), NASAPolynomial(coeffs=[14.0263,0.0277694,-1.06214e-05,1.86436e-09,-1.24287e-13,-374.761,-40.1583], Tmin=(1425.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(27.4049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]CC=CCOO(798)',
    ...
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18116,0.0638012,-4.70981e-05,1.85909e-08,-3.13992e-12,8647.15,28.3011], Tmin=(100,'K'), Tmax=(1326.49,'K')), NASAPolynomial(coeffs=[10.2449,0.0364699,-1.61919e-05,3.05815e-09,-2.12529e-13,6242.54,-17.9872], Tmin=(1326.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.0682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC=CCO[O](799)',
    structure = SMILES('[CH2]CC=CCO[O]'),
    E0 = (223.073,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,188.982,1817.99],'cm^-1')),
        HinderedRotor(inertia=(0.378035,'amu*angstrom^2'), symmetry=1, barrier=(9.6199,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.377632,'amu*angstrom^2'), symmetry=1, barrier=(9.62169,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379131,'amu*angstrom^2'), symmetry=1, barrier=(9.62399,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0046981,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44293,0.0600445,-5.05487e-05,2.5691e-08,-5.84328e-12,26918.4,28.1359], Tmin=(100,'K'), Tmax=(1001.07,'K')), NASAPolynomial(coeffs=[7.0874,0.037491,-1.67548e-05,3.18603e-09,-2.2308e-13,25788.2,0.898546], Tmin=(1001.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(223.073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C[CH][CH]CO[O](802)',
    structure = SMILES('[CH2]C[CH][CH]CO[O]'),
    E0 = (495.718,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,180,740.189,3129.18],'cm^-1')),
        HinderedRotor(inertia=(0.0260969,'amu*angstrom^2'), symmetry=1, barrier=(2.7339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0260969,'amu*angstrom^2'), symmetry=1, barrier=(2.7339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0260969,'amu*angstrom^2'), symmetry=1, barrier=(2.7339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0260969,'amu*angstrom^2'), symmetry=1, barrier=(2.7339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0260969,'amu*angstrom^2'), symmetry=1, barrier=(2.7339,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.116,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.907985,0.0788273,-0.000123338,1.17321e-07,-4.33071e-11,59722,33.8248], Tmin=(100,'K'), Tmax=(853.007,'K')), NASAPolynomial(coeffs=[2.90346,0.0450979,-2.11674e-05,3.97474e-09,-2.70472e-13,60268.2,29.7125], Tmin=(853.007,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(495.718,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(CCJCOOH) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CCC[CH]O[O](806)',
    structure = SMILES('[CH2]CCC[CH]O[O]'),
    E0 = (289.427,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35676,0.0678882,-4.38763e-05,-3.13077e-08,5.02013e-11,34895.4,27.6378], Tmin=(100,'K'), Tmax=(506.493,'K')), NASAPolynomial(coeffs=[6.77351,0.0423602,-1.93623e-05,3.67028e-09,-2.54598e-13,34125.4,3.00543], Tmin=(506.493,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(289.427,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCsJOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC[CH][CH]OO(807)',
    structure = SMILES('[CH2]CC[CH][CH]OO'),
    E0 = (337.837,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00241,0.0755722,-6.74029e-05,7.70634e-09,2.33862e-11,40731,30.4197], Tmin=(100,'K'), Tmax=(537.276,'K')), NASAPolynomial(coeffs=[7.50509,0.0429327,-2.03129e-05,3.91577e-09,-2.74496e-13,39804.6,0.96925], Tmin=(537.276,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(337.837,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(CCsJOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]CCCO[O](808)',
    structure = SMILES('[CH2][CH]CCCO[O]'),
    E0 = (295.291,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.87038,0.076022,-0.000101145,8.8348e-08,-3.16696e-11,35621,31.8276], Tmin=(100,'K'), Tmax=(827.174,'K')), NASAPolynomial(coeffs=[4.61245,0.0446731,-2.02638e-05,3.79086e-09,-2.59307e-13,35455.3,17.225], Tmin=(827.174,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(295.291,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = 'CC[CH][CH]CO[O](809)',
    structure = SMILES('CC[CH][CH]CO[O]'),
    E0 = (290.471,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.885305,0.0779203,-0.000112286,1.04338e-07,-3.86004e-11,35038.7,32.12], Tmin=(100,'K'), Tmax=(840.17,'K')), NASAPolynomial(coeffs=[3.0329,0.0475271,-2.20155e-05,4.13649e-09,-2.8269e-13,35389.6,26.3694], Tmin=(840.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(290.471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(CCJCOOH)"""),
)

species(
    label = 'CCC[CH][CH]O[O](810)',
    structure = SMILES('CCC[CH][CH]O[O]'),
    E0 = (284.595,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.650686,0.0799724,-0.000104317,8.69542e-08,-3.02583e-11,34343.5,30.5499], Tmin=(100,'K'), Tmax=(798.569,'K')), NASAPolynomial(coeffs=[6.4339,0.0429679,-1.97141e-05,3.72318e-09,-2.56779e-13,33676.1,5.5545], Tmin=(798.569,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(284.595,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2]C[CH][CH]COO(811)',
    structure = SMILES('[CH2]C[CH][CH]COO'),
    E0 = (343.713,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.668575,0.082133,-0.000117698,1.0703e-07,-3.93087e-11,41450.5,33.9254], Tmin=(100,'K'), Tmax=(820.08,'K')), NASAPolynomial(coeffs=[4.42298,0.0468799,-2.22304e-05,4.23279e-09,-2.92057e-13,41404.4,20.0305], Tmin=(820.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(343.713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCJCOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]C[CH]COO(812)',
    structure = SMILES('[CH2][CH]C[CH]COO'),
    E0 = (343.701,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.636947,0.0815838,-0.000112216,9.82243e-08,-3.5268e-11,41451.4,34.2113], Tmin=(100,'K'), Tmax=(811.044,'K')), NASAPolynomial(coeffs=[5.48488,0.0449833,-2.10533e-05,3.99651e-09,-2.75786e-13,41082.4,14.4114], Tmin=(811.044,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(343.701,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJC) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]CC[CH]CO[O](695)'],
    products = ['O2(S)(666)', '[CH2]CCC=C(122)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction4',
    reactants = ['O(4)', '[CH2]CC[CH]C[O](789)'],
    products = ['[CH2]CC[CH]CO[O](695)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]CO[O](790)', '[CH2]C[CH2](29)'],
    products = ['[CH2]CC[CH]CO[O](695)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]O[O](46)', '[CH]CC[CH2](63)'],
    products = ['[CH2]CC[CH]CO[O](695)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH2]CC[C]CO[O](791)'],
    products = ['[CH2]CC[CH]CO[O](695)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH]CC[CH]CO[O](792)'],
    products = ['[CH2]CC[CH]CO[O](695)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2]CC=CCO[O](799)'],
    products = ['[CH2]CC[CH]CO[O](695)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'C=CC[CH]CO[O](800)'],
    products = ['[CH2]CC[CH]CO[O](695)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH2]CCC=CO[O](801)'],
    products = ['[CH2]CC[CH]CO[O](695)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O2(2)', '[CH2][CH]CC[CH2](125)'],
    products = ['[CH2]CC[CH]CO[O](695)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2]C[CH][CH]CO[O](802)'],
    products = ['[CH2]CC[CH]CO[O](695)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH2][CH]C[CH]CO[O](803)'],
    products = ['[CH2]CC[CH]CO[O](695)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH2]CC[CH][CH]O[O](804)'],
    products = ['[CH2]CC[CH]CO[O](695)'],
