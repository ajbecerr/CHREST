...
species(
    label = '[CH2]OC1CC1(29059)',
    structure = SMILES('[CH2]OC1CC1'),
    E0 = (73.9329,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06359,0.0303215,2.01142e-05,-4.90534e-08,2.12496e-11,8972.85,16.976], Tmin=(100,'K'), Tmax=(965.585,'K')), NASAPolynomial(coeffs=[12.5668,0.0168895,-5.74514e-06,1.06112e-09,-7.8203e-14,5542.32,-40.5889], Tmin=(965.585,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(73.9329,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-OsHHH) + ring(Cyclopropane) + radical(CsJOCC2)"""),
)
...
species(
    ...
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72229,0.0396879,-3.16056e-06,-2.94396e-08,1.58076e-11,-3616.95,17.0295], Tmin=(100,'K'), Tmax=(939.833,'K')), NASAPolynomial(coeffs=[13.8381,0.0141755,-4.02441e-06,6.69418e-10,-4.76926e-14,-7044.96,-46.7921], Tmin=(939.833,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-30.8341,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(O)CJ)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.212788,'amu*angstrom^2'), symmetry=1, barrier=(4.89242,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212363,'amu*angstrom^2'), symmetry=1, barrier=(4.88264,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212787,'amu*angstrom^2'), symmetry=1, barrier=(4.89239,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21229,'amu*angstrom^2'), symmetry=1, barrier=(4.88096,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.661172,0.0874493,-0.000170952,1.6093e-07,-5.55211e-11,62065.6,21.2134], Tmin=(100,'K'), Tmax=(906.123,'K')), NASAPolynomial(coeffs=[6.74608,0.0261025,-1.23109e-05,2.21073e-09,-1.42097e-13,62378.6,0.26917], Tmin=(906.123,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(515.153,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CsJOCC2)"""),
)
...
species(
    ...
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.991771,0.0805832,-0.00015407,1.5019e-07,-5.37638e-11,39973,20.6092], Tmin=(100,'K'), Tmax=(893.35,'K')), NASAPolynomial(coeffs=[3.63214,0.0335218,-1.58815e-05,2.91093e-09,-1.91749e-13,40907.5,16.0389], Tmin=(893.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(331.568,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC([CH2])[CH2](28815)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(20)', '[CH2]C([CH2])[O](1366)'],
    products = ['[CH2]OC([CH2])[CH2](28815)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]C([CH2])O[CH2](29058)'],
    products = ['[CH2]OC([CH2])[CH2](28815)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]OC([CH2])[CH2](3321)'],
    products = ['[CH2]OC([CH2])[CH2](28815)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH2]OC([CH2])=C(28909)'],
    products = ['[CH2]OC([CH2])[CH2](28815)'],
...
reaction(
    label = 'reaction11',
    reactants = ['CH2(T)(20)', 'CH2OCHCH2(5571)'],
    products = ['[CH2]OC([CH2])[CH2](28815)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH2]O[C]([CH2])[CH2](29061)'],
    products = ['[CH2]OC([CH2])[CH2](28815)'],
...
network(
    label = 'PDepNetwork #7587',
    isomers = [
        '[CH2]OC([CH2])[CH2](28815)',
    ],
    reactants = [
        ('CH2O(3111)', 'allyl(82)'),
    ],
