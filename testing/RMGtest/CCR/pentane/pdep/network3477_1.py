...
species(
    label = '[CH]C1OC1=[CH](15294)',
    structure = SMILES('[CH]C1OC1=[CH]'),
    E0 = (677.28,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (67.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06716,0.0244044,3.23772e-05,-7.7104e-08,3.62746e-11,81544.4,15.5496], Tmin=(100,'K'), Tmax=(915.483,'K')), NASAPolynomial(coeffs=[20.0639,-0.00679262,5.77008e-06,-1.12948e-09,7.14915e-14,76261.5,-80.5419], Tmin=(915.483,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(677.28,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(methyleneoxirane) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    label = '[C]#CO[CH][CH](15295)',
    structure = SMILES('[C]#CO[CH][CH]'),
    E0 = (989.634,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,2175,525,438.236,438.48,438.528,438.601,438.963,439.06],'cm^-1')),
        HinderedRotor(inertia=(0.139397,'amu*angstrom^2'), symmetry=1, barrier=(19.0733,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.139132,'amu*angstrom^2'), symmetry=1, barrier=(19.0711,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.649832,'amu*angstrom^2'), symmetry=1, barrier=(88.7119,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (66.0581,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27926,0.0560857,-7.12111e-05,3.3543e-08,-2.79079e-12,119127,17.1036], Tmin=(100,'K'), Tmax=(842.199,'K')), NASAPolynomial(coeffs=[17.4852,-0.0033438,3.39574e-06,-7.85032e-10,5.85785e-14,115775,-61.9909], Tmin=(842.199,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(989.634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCsJOCs) + radical(CCJ2_triplet) + radical(Acetyl)"""),
)

species(
    label = '[C]#COC[CH](15296)',
    structure = SMILES('[C]#COC[CH]'),
    E0 = (809.178,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2175,525,217.394,553.763,553.805,554.43,555.089,557.092],'cm^-1')),
        HinderedRotor(inertia=(0.731463,'amu*angstrom^2'), symmetry=1, barrier=(16.8178,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.076349,'amu*angstrom^2'), symmetry=1, barrier=(16.7935,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.351231,'amu*angstrom^2'), symmetry=1, barrier=(76.9817,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (67.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30858,0.0524182,-6.45169e-05,3.73144e-08,-8.05644e-12,97424.4,17.5433], Tmin=(100,'K'), Tmax=(1266.6,'K')), NASAPolynomial(coeffs=[15.1356,0.00326791,1.84812e-07,-1.59182e-10,1.47385e-14,94361.7,-50.6954], Tmin=(1266.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(809.178,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCJ2_triplet) + radical(Acetyl)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH]=[C]O[C]=[CH](10470)'],
    products = ['[CH][CH]OC#C(13320)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['HC2(2881)', 'ketene(T)(1373)'],
    products = ['[CH][CH]OC#C(13320)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['HC2(2881)', '[CH][CH][O](6986)'],
    products = ['[CH][CH]OC#C(13320)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[C]#CO[CH][CH](15295)'],
    products = ['[CH][CH]OC#C(13320)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[C]=[CH](9646)', 'ketene(T)(1373)'],
    products = ['[CH][CH]OC#C(13320)'],
