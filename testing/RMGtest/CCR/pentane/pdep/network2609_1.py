...
species(
    label = '[CH2][CH]COC=[C]O(11607)',
    structure = SMILES('[CH2][CH]COC=[C]O'),
    E0 = (226.813,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.734962,0.0577347,-1.87183e-05,-2.59317e-08,1.64001e-11,-15920.1,25.0965], Tmin=(100,'K'), Tmax=(960.895,'K')), NASAPolynomial(coeffs=[19.0698,0.0150998,-4.75322e-06,8.66163e-10,-6.49288e-14,-20999,-70.7199], Tmin=(960.895,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-133.451,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CsCJ=O)"""),
)

species(
    label = 'C=CCOC[C]=O(10961)',
    structure = SMILES('C=CCOC[C]=O'),
    E0 = (-75.732,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60586,0.0544091,-3.86113e-05,1.41675e-08,-2.20384e-12,-9024.23,25.5627], Tmin=(100,'K'), Tmax=(1425.19,'K')), NASAPolynomial(coeffs=[9.93677,0.0310272,-1.4002e-05,2.65596e-09,-1.84537e-13,-11398.9,-17.5808], Tmin=(1425.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CsCJ=O)"""),
)

species(
    label = 'C[CH][CH]OC[C]=O(11609)',
    structure = SMILES('C[CH][CH]OC[C]=O'),
    E0 = (171.287,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,1855,455,950,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.922115,0.0672305,-6.49566e-05,3.32702e-08,-6.9336e-12,20712.3,29.1105], Tmin=(100,'K'), Tmax=(1146.81,'K')), NASAPolynomial(coeffs=[12.6539,0.0263101,-1.14328e-05,2.15502e-09,-1.50499e-13,18021.5,-29.0953], Tmin=(1146.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(171.287,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(CCsJOCs) + radical(CsCJ=O)"""),
)

species(
    label = '[CH2][CH]COC[C]=O(11610)',
    structure = SMILES('[CH2][CH]COC[C]=O'),
    E0 = (196.077,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4407,0.0588227,-4.8779e-05,2.20317e-08,-4.24705e-12,23672.6,29.5899], Tmin=(100,'K'), Tmax=(1187.79,'K')), NASAPolynomial(coeffs=[9.5042,0.0316679,-1.44864e-05,2.78434e-09,-1.95945e-13,21757,-10.6995], Tmin=(1187.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(196.077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(RCCJ) + radical(CsCJ=O)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CHCH3(T)(21)', '[CH2]OC=[C][O](11465)'],
    products = ['C[CH]CO[CH][C]=O(10954)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', '[CH]CO[CH][C]=O(7098)'],
    products = ['C[CH]CO[CH][C]=O(10954)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C[C]COC=[C][O](11602)'],
    products = ['C[CH]CO[CH][C]=O(10954)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'CC=COC=[C][O](11603)'],
    products = ['C[CH]CO[CH][C]=O(10954)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'C=CCO[CH][C]=O(11042)'],
    products = ['C[CH]CO[CH][C]=O(10954)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(791,'cm^3/(mol*s)'), n=2.78, Ea=(39.748,'kJ/mol'), T0=(1,'K'), Tmin=(400,'K'), Tmax=(1100,'K'), comment="""Estimated using template [Cds-HH_Cds-Cs\H3/H;OJ_sec] for rate rule [Cds-HH_Cds-Cs\H3/H;O_rad/OneDe]
Euclidian distance = 2.0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['HCCO(2227)', 'C[CH]C[O](1360)'],
    products = ['C[CH]CO[CH][C]=O(10954)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=[C][O](6861)', 'C[CH]C[O](1360)'],
    products = ['C[CH]CO[CH][C]=O(10954)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', 'C[CH][CH]OC=[C][O](11604)'],
    products = ['C[CH]CO[CH][C]=O(10954)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2][CH]CO[CH][C]=O(11036)'],
    products = ['C[CH]CO[CH][C]=O(10954)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C[CH][CH]OC=[C]O(11606)'],
    products = ['C[CH]CO[CH][C]=O(10954)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2][CH]COC=[C]O(11607)'],
    products = ['C[CH]CO[CH][C]=O(10954)'],
...
reaction(
    label = 'reaction32',
    reactants = ['C[CH][CH]OC[C]=O(11609)'],
    products = ['C[CH]CO[CH][C]=O(10954)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2][CH]COC[C]=O(11610)'],
    products = ['C[CH]CO[CH][C]=O(10954)'],
