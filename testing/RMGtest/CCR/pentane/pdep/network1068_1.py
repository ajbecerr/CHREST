species(
    label = '[CH2]CC(C)O[O](399)',
    structure = SMILES('[CH2]CC(C)O[O]'),
    E0 = (111.982,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,374.406],'cm^-1')),
        HinderedRotor(inertia=(0.0622142,'amu*angstrom^2'), symmetry=1, barrier=(6.20496,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.062477,'amu*angstrom^2'), symmetry=1, barrier=(6.19973,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0624115,'amu*angstrom^2'), symmetry=1, barrier=(6.20559,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0943133,'amu*angstrom^2'), symmetry=1, barrier=(9.37449,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53632,0.0561472,-4.67691e-05,2.24434e-08,-4.66319e-12,13555.3,24.1169], Tmin=(100,'K'), Tmax=(1107.32,'K')), NASAPolynomial(coeffs=[8.2773,0.0317965,-1.37829e-05,2.58384e-09,-1.79461e-13,12062.4,-9.09157], Tmin=(1107.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(111.982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CC(C)[O](3123)',
    structure = SMILES('[CH2]CC(C)[O]'),
    E0 = (118.833,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,791.192],'cm^-1')),
        HinderedRotor(inertia=(0.516501,'amu*angstrom^2'), symmetry=1, barrier=(11.8754,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00640368,'amu*angstrom^2'), symmetry=1, barrier=(2.87343,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124909,'amu*angstrom^2'), symmetry=1, barrier=(2.8719,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73481,0.0432475,-2.04575e-05,-3.21681e-10,2.22159e-12,14379.3,21.6911], Tmin=(100,'K'), Tmax=(1125.03,'K')), NASAPolynomial(coeffs=[10.0237,0.0244803,-9.70659e-06,1.76443e-09,-1.21235e-13,11836.9,-22.2852], Tmin=(1125.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.833,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJ)"""),
)
...
species(
    label = '[CH]CC(C)O[O](8984)',
    structure = SMILES('[CH]CC(C)O[O]'),
    E0 = (354.95,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,308.404,308.494,308.533,1587.18],'cm^-1')),
        HinderedRotor(inertia=(0.00177176,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13264,'amu*angstrom^2'), symmetry=1, barrier=(8.95661,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132614,'amu*angstrom^2'), symmetry=1, barrier=(8.95643,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00177158,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40681,0.0589062,-5.72367e-05,3.15742e-08,-7.30729e-12,42782.5,23.8018], Tmin=(100,'K'), Tmax=(1023.74,'K')), NASAPolynomial(coeffs=[9.25679,0.0282344,-1.2296e-05,2.30855e-09,-1.60549e-13,41175.2,-14.254], Tmin=(1023.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(354.95,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17611,0.0528898,-2.66053e-05,-1.95037e-09,3.95367e-12,-14061.4,24.2475], Tmin=(100,'K'), Tmax=(1089.72,'K')), NASAPolynomial(coeffs=[13.4929,0.024271,-1.00504e-05,1.89412e-09,-1.33806e-13,-17730.9,-40.7526], Tmin=(1089.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.823,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]C[C](C)O[O](4650)',
    structure = SMILES('[CH2]C[C](C)O[O]'),
    E0 = (298.881,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.0955073,'amu*angstrom^2'), symmetry=1, barrier=(2.1959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0954142,'amu*angstrom^2'), symmetry=1, barrier=(2.19376,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0954428,'amu*angstrom^2'), symmetry=1, barrier=(2.19442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0954607,'amu*angstrom^2'), symmetry=1, barrier=(2.19483,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47116,0.0611231,-8.08833e-05,6.99769e-08,-2.50735e-11,36032.8,24.6405], Tmin=(100,'K'), Tmax=(811.537,'K')), NASAPolynomial(coeffs=[4.88389,0.0352189,-1.62144e-05,3.0604e-09,-2.10696e-13,35778,10.7316], Tmin=(811.537,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(298.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOOH) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CC([CH2])O[O](4651)',
    structure = SMILES('[CH2]CC([CH2])O[O]'),
    E0 = (325.944,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3630.54],'cm^-1')),
        HinderedRotor(inertia=(0.0161176,'amu*angstrom^2'), symmetry=1, barrier=(5.0233,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.588302,'amu*angstrom^2'), symmetry=1, barrier=(13.5262,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.317945,'amu*angstrom^2'), symmetry=1, barrier=(7.31019,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.12815,'amu*angstrom^2'), symmetry=1, barrier=(48.9302,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41267,0.0594862,-6.18203e-05,3.71826e-08,-9.37934e-12,39293,26.5608], Tmin=(100,'K'), Tmax=(945.317,'K')), NASAPolynomial(coeffs=[8.77344,0.02834,-1.23983e-05,2.32866e-09,-1.61805e-13,37901.4,-8.53673], Tmin=(945.317,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(325.944,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CJCOOH) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]C(C)O[O](398)',
    structure = SMILES('C[CH]C(C)O[O]'),
    E0 = (107.15,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,268.725],'cm^-1')),
        HinderedRotor(inertia=(0.00233147,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154244,'amu*angstrom^2'), symmetry=1, barrier=(7.89397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153643,'amu*angstrom^2'), symmetry=1, barrier=(7.89725,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154221,'amu*angstrom^2'), symmetry=1, barrier=(7.8994,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54235,0.0571473,-5.08691e-05,2.72115e-08,-6.38679e-12,12973.1,24.6195], Tmin=(100,'K'), Tmax=(986.143,'K')), NASAPolynomial(coeffs=[7.3986,0.0333931,-1.47369e-05,2.78479e-09,-1.94296e-13,11818.1,-3.55181], Tmin=(986.143,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(107.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C[C](C)OO(8986)',
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38211,0.0624346,-6.71272e-05,4.73049e-08,-1.48501e-11,17755,24.2153], Tmin=(100,'K'), Tmax=(750.998,'K')), NASAPolynomial(coeffs=[6.02885,0.0376844,-1.76918e-05,3.41995e-09,-2.40929e-13,17057,3.12818], Tmin=(750.998,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(146.876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(RCCJ)"""),
)

species(
    label = 'CC[C](C)O[O](397)',
    structure = SMILES('CC[C](C)O[O]'),
    E0 = (93.6344,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,180],'cm^-1')),
        HinderedRotor(inertia=(0.205039,'amu*angstrom^2'), symmetry=1, barrier=(4.71425,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204946,'amu*angstrom^2'), symmetry=1, barrier=(4.71211,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204953,'amu*angstrom^2'), symmetry=1, barrier=(4.71228,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20502,'amu*angstrom^2'), symmetry=1, barrier=(4.71382,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48487,0.0597492,-6.80214e-05,5.44042e-08,-1.91667e-11,11348,22.8076], Tmin=(100,'K'), Tmax=(767.546,'K')), NASAPolynomial(coeffs=[4.89241,0.0378658,-1.71932e-05,3.25397e-09,-2.25612e-13,10946.4,8.06123], Tmin=(767.546,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(93.6344,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOOH)"""),
)

species(
    label = '[CH2][CH]C(C)OO(3763)',
    structure = SMILES('[CH2][CH]C(C)OO'),
    E0 = (160.392,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,258.845],'cm^-1')),
        HinderedRotor(inertia=(0.00835465,'amu*angstrom^2'), symmetry=1, barrier=(17.4959,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.782724,'amu*angstrom^2'), symmetry=1, barrier=(37.4253,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00288784,'amu*angstrom^2'), symmetry=1, barrier=(17.5101,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167227,'amu*angstrom^2'), symmetry=1, barrier=(8.01027,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.794982,'amu*angstrom^2'), symmetry=1, barrier=(37.4293,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36877,0.060874,-5.46161e-05,2.76196e-08,-5.97592e-12,19382.9,26.268], Tmin=(100,'K'), Tmax=(1073.2,'K')), NASAPolynomial(coeffs=[9.03309,0.0323078,-1.46893e-05,2.81727e-09,-1.98254e-13,17737.9,-11.2494], Tmin=(1073.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(160.392,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC([CH2])OO(7334)',
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16831,0.0629296,-5.69012e-05,2.7865e-08,-5.66745e-12,21021.5,26.6725], Tmin=(100,'K'), Tmax=(1157.53,'K')), NASAPolynomial(coeffs=[11.0409,0.028813,-1.269e-05,2.40153e-09,-1.67839e-13,18736,-22.4011], Tmin=(1157.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(173.939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C(CC)O[O](191)',
    structure = SMILES('[CH2]C(CC)O[O]'),
    E0 = (120.698,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,385.5],'cm^-1')),
        HinderedRotor(inertia=(0.0772198,'amu*angstrom^2'), symmetry=1, barrier=(8.14339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0772185,'amu*angstrom^2'), symmetry=1, barrier=(8.14339,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0772221,'amu*angstrom^2'), symmetry=1, barrier=(8.14337,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.077221,'amu*angstrom^2'), symmetry=1, barrier=(8.1434,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3658.62,'J/mol'), sigma=(6.37114,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=571.47 K, Pc=32.1 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37591,0.0588233,-5.19288e-05,2.6004e-08,-5.51217e-12,14610.1,24.9007], Tmin=(100,'K'), Tmax=(1104.39,'K')), NASAPolynomial(coeffs=[9.33095,0.0300112,-1.27961e-05,2.38168e-09,-1.64852e-13,12853,-14.2677], Tmin=(1104.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]CCO[O](52)'],
    products = ['[CH2]CC(C)O[O](399)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[CH2]C(C)O[O](87)'],
    products = ['[CH2]CC(C)O[O](399)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]CC(C)O[O](8984)'],
    products = ['[CH2]CC(C)O[O](399)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['C2H4(22)', 'C[CH]O[O](57)'],
    products = ['[CH2]CC(C)O[O](399)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.0437608,'m^3/(mol*s)'), n=2.11167, Ea=(26.3869,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cds-HH_Cds-HH;CsJ] for rate rule [Cds-HH_Cds-HH;CsJ-OsCsH]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['C2H4(T)(23)', 'C[CH]O[O](57)'],
    products = ['[CH2]CC(C)O[O](399)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(17)', '[CH2]C[CH]O[O](657)'],
    products = ['[CH2]CC(C)O[O](399)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2]C[C](C)O[O](4650)'],
    products = ['[CH2]CC(C)O[O](399)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2][CH]C(C)O[O](3749)'],
    products = ['[CH2]CC(C)O[O](399)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2]CC([CH2])O[O](4651)'],
    products = ['[CH2]CC(C)O[O](399)'],
