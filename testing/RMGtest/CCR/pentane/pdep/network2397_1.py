...
species(
    label = '[C]=[C]OC([CH2])=O(9945)',
    structure = SMILES('[C]=[C]OC([CH2])=O'),
    E0 = (659.366,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3100,440,815,1455,1000,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (82.0575,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79688,0.0529162,-8.50365e-05,7.30736e-08,-2.48767e-11,79378.5,24.1791], Tmin=(100,'K'), Tmax=(800.946,'K')), NASAPolynomial(coeffs=[7.88435,0.0173955,-8.92653e-06,1.74355e-09,-1.21623e-13,78567.6,-2.81322], Tmin=(800.946,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(659.366,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJCO) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)

species(
    label = '[CH]=C1CC(=O)O1(9930)',
    ...
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26121,0.0226623,3.60241e-05,-7.1325e-08,3.12339e-11,354.19,18.6104], Tmin=(100,'K'), Tmax=(934.73,'K')), NASAPolynomial(coeffs=[15.5359,0.00557237,-2.8635e-07,2.95174e-11,-8.28102e-15,-3862.54,-53.8176], Tmin=(934.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(2.30512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-OdCsOs) + group(Cds-CdsHH) + ring(4-Methylene-2-oxetanone) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]O[C]1CO1(9946)',
    ...
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.579123,0.0548847,-6.08247e-05,3.21896e-08,-6.08857e-12,59785.2,26.073], Tmin=(100,'K'), Tmax=(1617.32,'K')), NASAPolynomial(coeffs=[14.0538,0.00384945,2.933e-06,-8.61926e-10,6.6975e-14,57742.8,-38.2527], Tmin=(1617.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(495.912,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cs_P) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH][C]1OC(=C)O1(9937)',
    ...
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68856,0.0298494,3.59221e-05,-8.49488e-08,3.89867e-11,55101.6,17.4593], Tmin=(100,'K'), Tmax=(934.695,'K')), NASAPolynomial(coeffs=[22.0585,-0.00372245,3.77945e-06,-6.70578e-10,3.52701e-14,48952.3,-91.9635], Tmin=(934.695,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(457.288,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Cs_P) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][C]1O[C]=CO1(9947)',
    structure = SMILES('[CH2][C]1O[C]=CO1'),
    E0 = (326.984,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00242,0.0124714,0.000100732,-1.6678e-07,7.26499e-11,39428.5,20.7446], Tmin=(100,'K'), Tmax=(910.029,'K')), NASAPolynomial(coeffs=[27.255,-0.0161388,1.20929e-05,-2.36265e-09,1.52227e-13,31421,-117.447], Tmin=(910.029,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(326.984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + ring(Cyclopentane) + radical(Cs_P) + radical(CJCO) + radical(C=CJO)"""),
)

species(
    label = '[CH]=C1OC1([CH2])[O](9948)',
    ...
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.967572,0.0469191,-8.78668e-07,-6.27939e-08,3.66601e-11,55775,18.5506], Tmin=(100,'K'), Tmax=(890.594,'K')), NASAPolynomial(coeffs=[27.1096,-0.0153545,1.11358e-05,-2.26775e-09,1.54661e-13,48931.8,-116.817], Tmin=(890.594,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(462.675,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(methyleneoxirane) + radical(C=CC(C)(O)OJ) + radical(C=CC(O)2CJ) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.65917,0.0302421,-1.70342e-05,4.21346e-09,-4.01135e-13,37900.6,15.9377], Tmin=(100,'K'), Tmax=(2405.26,'K')), NASAPolynomial(coeffs=[14.085,0.0112401,-5.18363e-06,9.28743e-10,-5.97164e-14,32404.3,-49.2131], Tmin=(2405.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(314.731,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Cds_P)"""),
)

species(
    label = '[CH][C]1CC(=O)O1(9933)',
    ...
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.56875,0.0233918,1.50877e-05,-3.8987e-08,1.80103e-11,38010.1,20.3515], Tmin=(100,'K'), Tmax=(906.687,'K')), NASAPolynomial(coeffs=[9.7414,0.0131061,-3.22916e-06,4.60836e-10,-3.00358e-14,35831.6,-18.391], Tmin=(906.687,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(315.543,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone) + radical(C2CsJOC(O)) + radical(CCJ2_triplet)"""),
)

species(
    label = '[O][C]1CC=[C]O1(9949)',
    structure = SMILES('O=C1C[CH][C]O1'),
    E0 = (278.786,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.97702,0.00592578,7.37341e-05,-1.0558e-07,4.30733e-11,33582.5,18.301], Tmin=(100,'K'), Tmax=(911.623,'K')), NASAPolynomial(coeffs=[12.3471,0.0077158,1.93711e-07,-1.743e-10,9.49663e-15,30091.3,-35.8155], Tmin=(911.623,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(278.786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + ring(butyrolactone) + radical(CCJCO) + radical(CH2_triplet)"""),
)

species(
    label = '[CH]=[C]OC(=[CH])O(9943)',
    structure = SMILES('[CH][C](O)OC#C'),
    E0 = (477.05,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,360,370,350,2175,525,750,770,3400,2100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.632954,0.064661,-7.96473e-05,4.45106e-08,-9.27563e-12,57505.2,23.0768], Tmin=(100,'K'), Tmax=(1277.73,'K')), NASAPolynomial(coeffs=[19.5939,0.000764833,6.9115e-07,-1.86149e-10,1.3553e-14,53030.2,-71.5966], Tmin=(1277.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(477.05,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Cs_P) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[C]#COC([CH2])[O](9950)',
    structure = SMILES('[C]#COC([CH2])[O]'),
    E0 = (598.026,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2175,525,180,180,566.792,566.792],'cm^-1')),
        HinderedRotor(inertia=(0.0783139,'amu*angstrom^2'), symmetry=1, barrier=(17.8535,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.776512,'amu*angstrom^2'), symmetry=1, barrier=(17.8535,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.391976,'amu*angstrom^2'), symmetry=1, barrier=(89.3591,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25419,0.062379,-8.82768e-05,6.24155e-08,-1.71924e-11,72023.1,21.3975], Tmin=(100,'K'), Tmax=(895.541,'K')), NASAPolynomial(coeffs=[12.2617,0.0132111,-5.91868e-06,1.10302e-09,-7.56568e-14,70051.6,-30.4924], Tmin=(895.541,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(598.026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCOJ) + radical(CJCO) + radical(Acetyl)"""),
)

species(
    label = '[C]#CO[C]([CH2])O(9951)',
    structure = SMILES('[C]#CO[C]([CH2])O'),
    E0 = (577.568,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,360,370,350,3000,3100,440,815,1455,1000,2175,525,259.94,259.945,260],'cm^-1')),
        HinderedRotor(inertia=(0.483684,'amu*angstrom^2'), symmetry=1, barrier=(23.1926,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.483401,'amu*angstrom^2'), symmetry=1, barrier=(23.1923,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00249375,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.483689,'amu*angstrom^2'), symmetry=1, barrier=(23.193,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.747864,0.0681169,-9.49029e-05,6.14157e-08,-1.49664e-11,69585.4,23.7272], Tmin=(100,'K'), Tmax=(1054.21,'K')), NASAPolynomial(coeffs=[17.2476,0.00362324,-4.49492e-07,-1.46668e-11,4.46294e-15,66211.6,-56.2475], Tmin=(1054.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(577.568,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Cs_P) + radical(CJCO) + radical(Acetyl)"""),
)

species(
    label = '[C]#CO[C](C)[O](9952)',
    structure = SMILES('[C]=[C]OC(C)=O'),
    E0 = (447.777,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08152,0.0460157,-5.85572e-05,4.40488e-08,-1.39689e-11,53920.8,21.8403], Tmin=(100,'K'), Tmax=(758.097,'K')), NASAPolynomial(coeffs=[6.64468,0.0219387,-1.09173e-05,2.15429e-09,-1.53141e-13,53228.9,1.08944], Tmin=(758.097,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(447.777,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=[CH](9646)', 'C=C([O])[O](2321)'],
    products = ['[CH]=[C]OC([CH2])=O(2692)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(20)', '[CH]=[C]O[C]=O(9944)'],
    products = ['[CH]=[C]OC([CH2])=O(2692)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[C]=[C]OC([CH2])=O(9945)'],
    products = ['[CH]=[C]OC([CH2])=O(2692)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[C]OC([CH2])=O(2692)'],
    products = ['[CH]=C1OC1([CH2])[O](9948)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(1.1935e+10,'s^-1'), n=0.672833, Ea=(114.658,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra]
...
reaction(
    ...
    kinetics = Arrhenius(A=(5.41e+10,'s^-1'), n=0.21, Ea=(84.4776,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5;multiplebond_intra;radadd_intra_cdsingleH] for rate rule [R5;carbonylbond_intra;radadd_intra_cdsingleH]
Euclidian distance = 1.0
family: Intra_R_Add_Exocyclic
Ea raised from 84.5 to 84.5 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction23',
    reactants = ['HC2(2881)', 'C=C([O])[O](2321)'],
    products = ['[CH]=[C]OC([CH2])=O(2692)'],
...
reaction(
    label = 'reaction24',
    reactants = ['HC2(2881)', '[CH2][C]([O])[O](2822)'],
    products = ['[CH]=[C]OC([CH2])=O(2692)'],
