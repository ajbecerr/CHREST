...
species(
    label = 'C[CH]CC[CH]C[O](899)',
    structure = SMILES('C[CH]CC[CH]C[O]'),
    E0 = (268.361,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,202.312,442.874,934.214,1747.52,3472],'cm^-1')),
        HinderedRotor(inertia=(0.0733357,'amu*angstrom^2'), symmetry=1, barrier=(2.05147,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0733357,'amu*angstrom^2'), symmetry=1, barrier=(2.05147,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0733357,'amu*angstrom^2'), symmetry=1, barrier=(2.05147,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0733357,'amu*angstrom^2'), symmetry=1, barrier=(2.05147,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0733357,'amu*angstrom^2'), symmetry=1, barrier=(2.05147,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59292,0.0534857,-2.44504e-05,4.6399e-09,-3.19985e-13,32302.8,27.7991], Tmin=(100,'K'), Tmax=(2939.27,'K')), NASAPolynomial(coeffs=[43.5116,0.00397811,-2.33788e-06,3.39569e-10,-1.50427e-14,5580.03,-218.266], Tmin=(2939.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(268.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJC) + radical(CCJCO)"""),
)
...
species(
    label = 'C[CH]CC[C]CO[O](900)',
    structure = SMILES('C[CH]CC[C]CO[O]'),
    E0 = (514.479,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0963622,0.0935817,-0.000125721,1.0619e-07,-3.68789e-11,62010.7,34.97], Tmin=(100,'K'), Tmax=(818.443,'K')), NASAPolynomial(coeffs=[6.76202,0.0490878,-2.23346e-05,4.18632e-09,-2.8686e-13,61318.7,6.58585], Tmin=(818.443,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(514.479,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJC) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C[C]CC[CH]CO[O](901)',
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.372675,0.0888309,-9.15641e-05,4.1404e-08,1.61785e-12,62717.5,33.6194], Tmin=(100,'K'), Tmax=(590.98,'K')), NASAPolynomial(coeffs=[8.77368,0.0465773,-2.1395e-05,4.07382e-09,-2.83796e-13,61469.5,-4.65009], Tmin=(590.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(520.448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C[CH]CCC1COO1(902)',
    structure = SMILES('C[CH]CCC1COO1'),
    E0 = (70.9712,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24985,0.0676974,-4.14465e-05,1.3946e-08,-2.19844e-12,8628.46,26.3158], Tmin=(100,'K'), Tmax=(1255.82,'K')), NASAPolynomial(coeffs=[5.9462,0.0527386,-2.35792e-05,4.46091e-09,-3.10205e-13,7448.91,2.58883], Tmin=(1255.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(70.9712,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH]CCC1CO1(903)',
    structure = SMILES('C[CH]CCC1CO1'),
    E0 = (19.675,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04482,0.0599151,-2.11226e-05,-1.40528e-08,1.11662e-11,2477.65,26.84], Tmin=(100,'K'), Tmax=(862.155,'K')), NASAPolynomial(coeffs=[9.51857,0.0376636,-1.20951e-05,1.92177e-09,-1.22252e-13,382.361,-16.4619], Tmin=(862.155,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(19.675,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJC)"""),
)

species(
    label = 'CCCC=CCO[O](904)',
    structure = SMILES('CCCC=CCO[O]'),
    E0 = (-5.95373,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.797284,0.0738213,-5.36829e-05,2.1901e-08,-3.94058e-12,-603.823,30.899], Tmin=(100,'K'), Tmax=(1229.98,'K')), NASAPolynomial(coeffs=[9.21042,0.0464613,-2.03169e-05,3.81636e-09,-2.6481e-13,-2673.44,-11.4311], Tmin=(1229.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-5.95373,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = 'CC=CCCCO[O](905)',
    structure = SMILES('CC=CCCCO[O]'),
    E0 = (-12.6454,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.658468,0.0783794,-6.53957e-05,3.26152e-08,-7.25658e-12,-1404.67,30.3604], Tmin=(100,'K'), Tmax=(1022,'K')), NASAPolynomial(coeffs=[8.25859,0.0486328,-2.17355e-05,4.13449e-09,-2.8955e-13,-2958.1,-6.47106], Tmin=(1022,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-12.6454,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = 'C[CH]CCC=COO(906)',
    structure = SMILES('C[CH]CCC=COO'),
    E0 = (46.0662,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.431517,0.0787752,-6.18372e-05,2.67226e-08,-4.90656e-12,5668.52,34.012], Tmin=(100,'K'), Tmax=(1250,'K')), NASAPolynomial(coeffs=[11.8476,0.0422439,-1.79999e-05,3.34281e-09,-2.30644e-13,2814.47,-23.6117], Tmin=(1250,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(46.0662,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJC)"""),
)

species(
    label = 'CCCCC=CO[O](711)',
    structure = SMILES('CCCCC=CO[O]'),
    E0 = (3.62461,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.146846,0.079049,-6.1066e-05,2.515e-08,-4.26649e-12,579.197,33.0598], Tmin=(100,'K'), Tmax=(1378.7,'K')), NASAPolynomial(coeffs=[14.9313,0.0361553,-1.43987e-05,2.58421e-09,-1.74658e-13,-3497.51,-43.0149], Tmin=(1378.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(3.62461,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ)"""),
)

species(
    label = 'C=CCCCCO[O](709)',
    structure = SMILES('C=CCCCCO[O]'),
    E0 = (-0.400066,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.565497,0.078814,-6.3514e-05,2.9168e-08,-5.83066e-12,72.7317,31.1238], Tmin=(100,'K'), Tmax=(1139.17,'K')), NASAPolynomial(coeffs=[9.93868,0.0459026,-2.01791e-05,3.80819e-09,-2.65391e-13,-2062.85,-15.3179], Tmin=(1139.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-0.400066,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = 'C[CH]CC=CCOO(907)',
    structure = SMILES('C[CH]CC=CCOO'),
    E0 = (36.4879,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.78962,0.0766312,-6.3703e-05,3.36505e-08,-8.28596e-12,4498.96,32.926], Tmin=(100,'K'), Tmax=(912.22,'K')), NASAPolynomial(coeffs=[6.3028,0.0524558,-2.39497e-05,4.59741e-09,-3.23598e-13,3493.13,6.83472], Tmin=(912.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(36.4879,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC)"""),
)

species(
    label = 'C[CH]CC=CCO[O](908)',
    structure = SMILES('C[CH]CC=CCO[O]'),
    E0 = (188.493,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69394,0.0614892,3.14399e-07,-1.17896e-07,1.15865e-10,22742.2,30.6466], Tmin=(100,'K'), Tmax=(453.152,'K')), NASAPolynomial(coeffs=[5.01898,0.0502858,-2.26698e-05,4.28949e-09,-2.97972e-13,22254.5,15.1812], Tmin=(453.152,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(188.493,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH]C[CH][CH]CO[O](911)',
    structure = SMILES('C[CH]C[CH][CH]CO[O]'),
    E0 = (461.137,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,252.254,436.249,1223.76,3599.68],'cm^-1')),
        HinderedRotor(inertia=(0.0275383,'amu*angstrom^2'), symmetry=1, barrier=(0.910329,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0275383,'amu*angstrom^2'), symmetry=1, barrier=(0.910329,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0275383,'amu*angstrom^2'), symmetry=1, barrier=(0.910329,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0275383,'amu*angstrom^2'), symmetry=1, barrier=(0.910329,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0275383,'amu*angstrom^2'), symmetry=1, barrier=(0.910329,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.142,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.401637,0.0933666,-0.00014737,1.43671e-07,-5.38473e-11,55577.9,38.8352], Tmin=(100,'K'), Tmax=(858.577,'K')), NASAPolynomial(coeffs=[0.916145,0.0577052,-2.69515e-05,5.04308e-09,-3.42175e-13,56715.6,43.5715], Tmin=(858.577,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(461.137,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJC) + radical(RCCJCC) + radical(CCJCOOH)"""),
)
...
species(
    label = 'C[CH]CCC[CH]O[O](914)',
    structure = SMILES('C[CH]CCC[CH]O[O]'),
    E0 = (254.846,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.145264,0.0933619,-0.000123447,1.07175e-07,-3.83831e-11,30781.5,35.0377], Tmin=(100,'K'), Tmax=(820.348,'K')), NASAPolynomial(coeffs=[5.02184,0.0545149,-2.48623e-05,4.66729e-09,-3.20113e-13,30488.4,15.5672], Tmin=(820.348,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.846,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJC) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2]CCC[CH]CO[O](915)',
    structure = SMILES('[CH2]CCC[CH]CO[O]'),
    E0 = (277.479,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.56796,0.0849138,-7.46429e-05,1.8598e-08,1.3967e-11,33487.6,34.8185], Tmin=(100,'K'), Tmax=(565.642,'K')), NASAPolynomial(coeffs=[7.51764,0.0506383,-2.31824e-05,4.42242e-09,-3.08938e-13,32463.6,3.14747], Tmin=(565.642,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(277.479,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]CC[CH][CH]OO(916)',
    structure = SMILES('C[CH]CC[CH][CH]OO'),
    E0 = (303.257,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.087028,0.0989097,-0.000134467,1.16988e-07,-4.19578e-11,36611.8,37.4174], Tmin=(100,'K'), Tmax=(806.75,'K')), NASAPolynomial(coeffs=[5.88823,0.054836,-2.56583e-05,4.87451e-09,-3.36726e-13,36117.9,12.7872], Tmin=(806.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.257,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCJCOOH) + radical(CCsJOOH)"""),
)

species(
    label = 'C[CH][CH]CCCO[O](917)',
    structure = SMILES('C[CH][CH]CCCO[O]'),
    E0 = (260.722,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.15,'amu'),
...
species(
    label = 'CCC[CH][CH]CO[O](918)',
    structure = SMILES('CCC[CH][CH]CO[O]'),
    E0 = (266.691,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCCC[CH][CH]O[O](919)',
    structure = SMILES('CCCC[CH][CH]O[O]'),
    E0 = (260.815,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.849047,0.0814097,-4.89426e-05,-4.77138e-08,6.89818e-11,31470.1,32.2654], Tmin=(100,'K'), Tmax=(498.49,'K')), NASAPolynomial(coeffs=[7.21715,0.0516689,-2.37192e-05,4.505e-09,-3.12808e-13,30569.8,3.31451], Tmin=(498.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(260.815,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2][CH]CCCCO[O](920)',
    structure = SMILES('[CH2][CH]CCCCO[O]'),
    E0 = (271.51,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.205272,0.0910324,-0.000115883,9.78496e-08,-3.46181e-11,32784.5,36.4604], Tmin=(100,'K'), Tmax=(808.41,'K')), NASAPolynomial(coeffs=[5.55537,0.0530531,-2.40616e-05,4.51967e-09,-3.10676e-13,32295.5,14.1128], Tmin=(808.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(271.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]C[CH][CH]COO(921)',
    structure = SMILES('C[CH]C[CH][CH]COO'),
    E0 = (309.133,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.154352,0.0967685,-0.000142075,1.33819e-07,-5.00211e-11,37306.7,38.9638], Tmin=(100,'K'), Tmax=(836.106,'K')), NASAPolynomial(coeffs=[2.47451,0.0594184,-2.79737e-05,5.29128e-09,-3.6293e-13,37836.3,33.6727], Tmin=(836.106,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(309.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJCC) + radical(CCJCOOH)"""),
)

species(
    label = 'C[CH][CH]C[CH]COO(922)',
    structure = SMILES('C[CH][CH]C[CH]COO'),
    E0 = (309.133,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.154428,0.0967675,-0.000142071,1.33813e-07,-5.00181e-11,37306.7,38.9635], Tmin=(100,'K'), Tmax=(836.12,'K')), NASAPolynomial(coeffs=[2.47436,0.0594187,-2.79739e-05,5.29132e-09,-3.62933e-13,37836.4,33.6735], Tmin=(836.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(309.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJCC) + radical(RCCJC)"""),
)

species(
    label = '[CH2][CH]CC[CH]COO(923)',
    structure = SMILES('[CH2][CH]CC[CH]COO'),
    E0 = (319.921,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29931,0.0743006,-1.13534e-06,-1.80097e-07,1.91159e-10,38559,34.425], Tmin=(100,'K'), Tmax=(435.71,'K')), NASAPolynomial(coeffs=[6.72154,0.0528053,-2.45032e-05,4.63839e-09,-3.19637e-13,37818,9.68977], Tmin=(435.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.921,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJC) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['C[CH]CC[CH]CO[O](702)'],
    products = ['O2(S)(666)', 'C=CCC[CH]C(159)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction5',
    reactants = ['O(4)', 'C[CH]CC[CH]C[O](899)'],
    products = ['C[CH]CC[CH]CO[O](702)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]CO[O](790)', '[CH2]C[CH]C(36)'],
    products = ['C[CH]CC[CH]CO[O](702)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHCH3(T)(21)', '[CH2]C[CH]CO[O](762)'],
    products = ['C[CH]CC[CH]CO[O](702)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]O[O](46)', '[CH]CC[CH]C(119)'],
    products = ['C[CH]CC[CH]CO[O](702)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(17)', '[CH]CC[CH]CO[O](792)'],
    products = ['C[CH]CC[CH]CO[O](702)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'C[CH]CC[C]CO[O](900)'],
    products = ['C[CH]CC[CH]CO[O](702)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C[C]CC[CH]CO[O](901)'],
    products = ['C[CH]CC[CH]CO[O](702)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', 'C[CH]CC=CCO[O](908)'],
    products = ['C[CH]CC[CH]CO[O](702)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', 'CC=CC[CH]CO[O](909)'],
    products = ['C[CH]CC[CH]CO[O](702)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C[CH]CCC=CO[O](910)'],
    products = ['C[CH]CC[CH]CO[O](702)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', 'C=CCC[CH]CO[O](748)'],
    products = ['C[CH]CC[CH]CO[O](702)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O2(2)', '[CH2][CH]CC[CH]C(161)'],
    products = ['C[CH]CC[CH]CO[O](702)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', 'C[CH]C[CH][CH]CO[O](911)'],
    products = ['C[CH]CC[CH]CO[O](702)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', 'C[CH][CH]C[CH]CO[O](912)'],
    products = ['C[CH]CC[CH]CO[O](702)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', 'C[CH]CC[CH][CH]O[O](913)'],
    products = ['C[CH]CC[CH]CO[O](702)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', '[CH2][CH]CC[CH]CO[O](741)'],
    products = ['C[CH]CC[CH]CO[O](702)'],
...
reaction(
    label = 'reaction38',
    reactants = ['C[CH]CC[CH][CH]OO(916)'],
    products = ['C[CH]CC[CH]CO[O](702)'],
...
reaction(
    label = 'reaction43',
    reactants = ['C[CH]C[CH][CH]COO(921)'],
    products = ['C[CH]CC[CH]CO[O](702)'],
...
reaction(
    label = 'reaction44',
    reactants = ['C[CH][CH]C[CH]COO(922)'],
    products = ['C[CH]CC[CH]CO[O](702)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2][CH]CC[CH]COO(923)'],
    products = ['C[CH]CC[CH]CO[O](702)'],
