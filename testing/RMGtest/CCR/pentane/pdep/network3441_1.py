...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.14861,'amu*angstrom^2'), symmetry=1, barrier=(49.4007,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.14801,'amu*angstrom^2'), symmetry=1, barrier=(49.3869,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.45042,0.0332273,-1.49834e-05,1.57226e-09,2.41249e-13,30523.8,16.9403], Tmin=(100,'K'), Tmax=(1750.2,'K')), NASAPolynomial(coeffs=[11.9107,0.0188928,-8.94296e-06,1.65009e-09,-1.09646e-13,26096.4,-37.1832], Tmin=(1750.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(253.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]=C[CH][CH][O](15173)',
    structure = SMILES('[CH][CH]C=C[O]'),
    E0 = (505.476,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,429.981,430.004,430.009,430.015,430.027],'cm^-1')),
        HinderedRotor(inertia=(0.000911839,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000911604,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17827,0.0268097,1.94854e-05,-5.29173e-08,2.45476e-11,60872.5,17.7837], Tmin=(100,'K'), Tmax=(933.726,'K')), NASAPolynomial(coeffs=[15.0576,0.00541918,-4.22987e-07,4.61173e-11,-7.95711e-15,56994.7,-51.3543], Tmin=(933.726,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(505.476,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Allyl_S) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23174,0.0283361,1.91471e-05,-4.38029e-08,1.84291e-11,36749.2,20.7796], Tmin=(100,'K'), Tmax=(973.513,'K')), NASAPolynomial(coeffs=[10.4893,0.0199816,-7.38548e-06,1.35178e-09,-9.65054e-14,33929.5,-25.0611], Tmin=(973.513,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(304.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CCJO) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=[C]C[CH]O(15176)',
    structure = SMILES('[CH]=[C]C[CH]O'),
    E0 = (488.887,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,302.617],'cm^-1')),
        HinderedRotor(inertia=(0.135113,'amu*angstrom^2'), symmetry=1, barrier=(8.76206,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133468,'amu*angstrom^2'), symmetry=1, barrier=(8.76755,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135206,'amu*angstrom^2'), symmetry=1, barrier=(8.76034,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6493,0.0556992,-8.3093e-05,6.84045e-08,-2.21978e-11,58880.3,21.6454], Tmin=(100,'K'), Tmax=(859.526,'K')), NASAPolynomial(coeffs=[7.90058,0.0198526,-8.74744e-06,1.59746e-09,-1.07057e-13,58055.2,-6.11569], Tmin=(859.526,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(488.887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH][O](1548)', '[CH]C=C(3739)'],
    products = ['[CH]=CC[CH][O](15044)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH][CH]C[C]=O(7099)'],
    products = ['[CH]=CC[CH][O](15044)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH]=C[CH][CH][O](15173)'],
    products = ['[CH]=CC[CH][O](15044)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH]=[C]C[CH][O](10195)'],
    products = ['[CH]=CC[CH][O](15044)'],
