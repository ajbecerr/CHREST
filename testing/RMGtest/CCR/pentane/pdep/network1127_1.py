...
species(
    label = '[CH2]C([CH]C)[CH]CCO[O](4723)',
    structure = SMILES('[CH2]C([CH]C)[CH]CCO[O]'),
    E0 = (439.857,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.897176,0.0825721,-2.15249e-05,-1.24283e-07,1.3549e-10,52999.4,38.5954], Tmin=(100,'K'), Tmax=(463.555,'K')), NASAPolynomial(coeffs=[6.84487,0.05761,-2.60499e-05,4.89823e-09,-3.37427e-13,52164.7,11.4192], Tmin=(463.555,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(439.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH]C)C([CH2])C[O](4724)',
    structure = SMILES('[CH2]C([CH]C)C([CH2])C[O]'),
    E0 = (446.898,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,320.095,478.644,1274.36,3360.19],'cm^-1')),
        HinderedRotor(inertia=(0.0434482,'amu*angstrom^2'), symmetry=1, barrier=(2.71958,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0434482,'amu*angstrom^2'), symmetry=1, barrier=(2.71958,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0434482,'amu*angstrom^2'), symmetry=1, barrier=(2.71958,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0434482,'amu*angstrom^2'), symmetry=1, barrier=(2.71958,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0434482,'amu*angstrom^2'), symmetry=1, barrier=(2.71958,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.323803,0.0861105,-9.26971e-05,7.00782e-08,-2.33098e-11,53876.8,38.6616], Tmin=(100,'K'), Tmax=(802.586,'K')), NASAPolynomial(coeffs=[5.69557,0.0541307,-2.31955e-05,4.26234e-09,-2.90356e-13,53182.3,14.9721], Tmin=(802.586,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(446.898,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Cs_S) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH]C)[CH]CO[O](4725)',
    structure = SMILES('[CH2]C([CH]C)[CH]CO[O]'),
    E0 = (469.51,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,217.477,826.27,1739.81],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.189245,0.0903401,-0.000116406,9.48024e-08,-3.2036e-11,56600,38.3601], Tmin=(100,'K'), Tmax=(818.668,'K')), NASAPolynomial(coeffs=[7.2691,0.0469631,-2.08323e-05,3.86643e-09,-2.63774e-13,55735.2,7.4184], Tmin=(818.668,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(469.51,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH]C([CH2])C([CH2])CO[O](1065)',
    structure = SMILES('[CH]C([CH2])C([CH2])CO[O]'),
    E0 = (718.809,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.140706,0.089041,-9.87797e-05,5.60234e-08,-9.85625e-12,86588.1,36.2061], Tmin=(100,'K'), Tmax=(710.738,'K')), NASAPolynomial(coeffs=[11.9663,0.0356441,-1.38535e-05,2.40862e-09,-1.58768e-13,84574.8,-19.1453], Tmin=(710.738,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(718.809,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Isobutyl) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH2]C([C]C)C([CH2])CO[O](4726)',
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.729884,0.106874,-0.000125625,8.53434e-08,-2.36536e-11,84162.9,40.454], Tmin=(100,'K'), Tmax=(877.226,'K')), NASAPolynomial(coeffs=[13.1516,0.0435717,-1.7373e-05,3.06856e-09,-2.04226e-13,81727.7,-24.6966], Tmin=(877.226,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(698.376,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Isobutyl) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([CH]C)C([CH2])CO[O](4727)',
    structure = SMILES('[CH]C([CH]C)C([CH2])CO[O]'),
    E0 = (687.836,'kJ/mol'),
    modes = [
...
species(
    label = '[CH]C(CO[O])C([CH2])[CH]C(4728)',
...
species(
    label = '[CH2]C(CO[O])C1CC1C(4729)',
    structure = SMILES('[CH2]C(CO[O])C1CC1C'),
    E0 = (188.592,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.240325,0.0806762,-3.74516e-05,-8.11458e-09,8.96769e-12,22846,35.5832], Tmin=(100,'K'), Tmax=(1003.12,'K')), NASAPolynomial(coeffs=[16.7748,0.0390178,-1.43218e-05,2.5413e-09,-1.74715e-13,18114.7,-53.1261], Tmin=(1003.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(188.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(ROOJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C1C(C)CC1CO[O](4700)',
    structure = SMILES('[CH2]C1C(C)CC1CO[O]'),
    E0 = (184.172,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
...
species(
    label = '[CH2]C([CH]C)C1COOC1(4731)',
    structure = SMILES('[CH2]C([CH]C)C1COOC1'),
    E0 = (165.347,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.195164,0.0695696,-1.27906e-06,-5.17263e-08,2.74745e-11,20036.8,34.6736], Tmin=(100,'K'), Tmax=(904.523,'K')), NASAPolynomial(coeffs=[16.0827,0.0372874,-1.07212e-05,1.6491e-09,-1.06715e-13,15609.2,-48.9679], Tmin=(904.523,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(165.347,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxolane) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C1COOCC1[CH]C(4733)',
    structure = SMILES('[CH2]C1COOCC1[CH]C'),
    E0 = (153.745,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.325269,0.0630957,2.22621e-05,-7.88565e-08,3.77169e-11,18640.1,31.6184], Tmin=(100,'K'), Tmax=(907.592,'K')), NASAPolynomial(coeffs=[17.2824,0.0353107,-9.4118e-06,1.40618e-09,-9.17434e-14,13628.4,-59.1985], Tmin=(907.592,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(153.745,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxane) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH]C)C1COC1(4734)',
    structure = SMILES('[CH2]C([CH]C)C1COC1'),
    E0 = (193.448,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.785495,0.0597712,4.07176e-06,-4.76034e-08,2.42315e-11,23392.4,31.0762], Tmin=(100,'K'), Tmax=(894.06,'K')), NASAPolynomial(coeffs=[12.1333,0.0390949,-1.17277e-05,1.8253e-09,-1.1708e-13,20160.6,-29.126], Tmin=(894.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(193.448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C1COCC1[CH]C(4736)',
    structure = SMILES('[CH2]C1COCC1[CH]C'),
    E0 = (111.639,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11962,0.0481669,3.85034e-05,-8.33778e-08,3.6816e-11,13544.9,27.6758], Tmin=(100,'K'), Tmax=(905.714,'K')), NASAPolynomial(coeffs=[12.4689,0.0380092,-1.08627e-05,1.67853e-09,-1.09534e-13,9849.82,-35.0035], Tmin=(905.714,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(111.639,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(CO[O])C(=C)CC(939)',
    structure = SMILES('[CH2]C(CO[O])C(=C)CC'),
    E0 = (162.974,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.351084,0.0959612,-8.7574e-05,4.55587e-08,-9.92203e-12,19757.7,37.3744], Tmin=(100,'K'), Tmax=(1086.97,'K')), NASAPolynomial(coeffs=[13.1716,0.0461985,-1.89028e-05,3.44114e-09,-2.35163e-13,16818,-28.9926], Tmin=(1086.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.974,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(ROOJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CO[O])C(C)=CC(1302)',
    structure = SMILES('[CH2]C(CO[O])C(C)=CC'),
    E0 = (149.594,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.289333,0.0988233,-0.000102182,6.43275e-08,-1.72509e-11,18142.5,36.0566], Tmin=(100,'K'), Tmax=(887.856,'K')), NASAPolynomial(coeffs=[10.2572,0.0513086,-2.1907e-05,4.0514e-09,-2.78512e-13,16269.8,-13.5699], Tmin=(887.856,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.594,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CC)C(=C)CO[O](940)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.197828,0.0939626,-8.52524e-05,4.50682e-08,-1.01063e-11,20419.4,37.2105], Tmin=(100,'K'), Tmax=(1050.2,'K')), NASAPolynomial(coeffs=[11.7901,0.0483035,-2.0038e-05,3.67044e-09,-2.51609e-13,17901.4,-21.2115], Tmin=(1050.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(168.531,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(ROOJ) + radical(Isobutyl)"""),
)

species(
    label = 'C=C(CO[O])C(C)[CH]C(1303)',
    structure = SMILES('C=C(CO[O])C(C)[CH]C'),
    E0 = (157.991,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.248839,0.0877583,-7.22901e-05,3.49863e-08,-7.50822e-12,19132.6,36.3874], Tmin=(100,'K'), Tmax=(1057.74,'K')), NASAPolynomial(coeffs=[9.24698,0.0537312,-2.40368e-05,4.57417e-09,-3.2038e-13,17229,-7.52877], Tmin=(1057.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.991,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cs_S)"""),
)

species(
    label = '[CH2]C(=CC)C(C)CO[O](4737)',
    structure = SMILES('[CH2]C(=CC)C(C)CO[O]'),
    E0 = (96.0108,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.250638,0.0941399,-8.00201e-05,3.7692e-08,-7.47796e-12,11699.9,34.4041], Tmin=(100,'K'), Tmax=(1175.14,'K')), NASAPolynomial(coeffs=[13.5129,0.047291,-2.02202e-05,3.76713e-09,-2.60773e-13,8465.03,-34.2184], Tmin=(1175.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(96.0108,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Allyl_P)"""),
)
...
species(
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.115675,0.0944316,-8.49468e-05,4.44237e-08,-9.9908e-12,25530.6,38.7181], Tmin=(100,'K'), Tmax=(1036.32,'K')), NASAPolynomial(coeffs=[11.0667,0.0512687,-2.24702e-05,4.23153e-09,-2.94704e-13,23213,-15.6292], Tmin=(1036.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(211.068,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C=C)C(C)CO[O](3799)',
...
species(
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.610794,0.100743,-9.2368e-05,4.66776e-08,-9.7592e-12,18097.8,36.7207], Tmin=(100,'K'), Tmax=(1134.78,'K')), NASAPolynomial(coeffs=[15.1772,0.0450916,-1.8805e-05,3.46019e-09,-2.38055e-13,14514.6,-41.4434], Tmin=(1134.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.088,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C(C=C)C([CH2])COO(4740)',
    structure = SMILES('[CH2]C(C=C)C([CH2])COO'),
    E0 = (220.313,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.679838,0.0999502,-9.26588e-05,4.77658e-08,-1.01028e-11,26668.6,40.1136], Tmin=(100,'K'), Tmax=(1131.39,'K')), NASAPolynomial(coeffs=[15.5491,0.0425732,-1.65878e-05,2.94111e-09,-1.98015e-13,22996.4,-40.1848], Tmin=(1131.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(220.313,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(=CC)C([CH2])CO[O](4742)',
    structure = SMILES('[CH2]C(=CC)C([CH2])CO[O]'),
    E0 = (301.093,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.329818,0.0968916,-9.59614e-05,5.43969e-08,-1.28313e-11,36367.7,36.476], Tmin=(100,'K'), Tmax=(1012.15,'K')), NASAPolynomial(coeffs=[12.8927,0.044636,-1.85183e-05,3.38759e-09,-2.31985e-13,33691.1,-27.4746], Tmin=(1012.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.093,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Isobutyl) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH2][C]([CH]C)C([CH2])CO[O](4745)',
    structure = SMILES('[CH2][C]([CH]C)C([CH2])CO[O]'),
    E0 = (630.125,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,780.586,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0460511,'amu*angstrom^2'), symmetry=1, barrier=(1.05881,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0460511,'amu*angstrom^2'), symmetry=1, barrier=(1.05881,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0460511,'amu*angstrom^2'), symmetry=1, barrier=(1.05881,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0460511,'amu*angstrom^2'), symmetry=1, barrier=(1.05881,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0460511,'amu*angstrom^2'), symmetry=1, barrier=(1.05881,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.451352,0.110721,-0.000167385,1.50724e-07,-5.27921e-11,75934.6,43.2337], Tmin=(100,'K'), Tmax=(876.639,'K')), NASAPolynomial(coeffs=[5.03672,0.0565778,-2.49457e-05,4.53339e-09,-3.0201e-13,76090.6,23.8574], Tmin=(876.639,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(630.125,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Tertalkyl) + radical(Cs_S) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH]C)[C](C)CO[O](4747)',
    structure = SMILES('[CH2]C([CH]C)[C](C)CO[O]'),
    E0 = (430.531,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = '[CH2][C](CC)C([CH2])CO[O](941)',
    structure = SMILES('[CH2][C](CC)C([CH2])CO[O]'),
    E0 = (435.583,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,216.88,816.88,1735.04],'cm^-1')),
        HinderedRotor(inertia=(0.138605,'amu*angstrom^2'), symmetry=1, barrier=(3.54719,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138605,'amu*angstrom^2'), symmetry=1, barrier=(3.54719,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138605,'amu*angstrom^2'), symmetry=1, barrier=(3.54719,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138605,'amu*angstrom^2'), symmetry=1, barrier=(3.54719,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138605,'amu*angstrom^2'), symmetry=1, barrier=(3.54719,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.642643,0.111928,-0.000155846,1.32139e-07,-4.46051e-11,52546.4,41.365], Tmin=(100,'K'), Tmax=(874.378,'K')), NASAPolynomial(coeffs=[7.11805,0.0556726,-2.37379e-05,4.26866e-09,-2.83686e-13,51982.5,9.50242], Tmin=(874.378,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(435.583,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Tertalkyl) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH]C)C([CH2])[CH]OO(4748)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.652812,0.107741,-0.000125122,8.82911e-08,-2.61334e-11,58047.3,42.2242], Tmin=(100,'K'), Tmax=(814.014,'K')), NASAPolynomial(coeffs=[10.6983,0.0519629,-2.23395e-05,4.11349e-09,-2.80898e-13,56199.3,-10.2024], Tmin=(814.014,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(481.281,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(CCsJOOH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][C]([CH]C)C(C)CO[O](4749)',
    structure = SMILES('[CH2][C]([CH]C)C(C)CO[O]'),
    E0 = (425.043,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C([CH]C)C(C)[CH]O[O](4750)',
...
species(
    label = '[CH2][C](CO[O])C([CH2])CC(942)',
    structure = SMILES('[CH2][C](CO[O])C([CH2])CC'),
    E0 = (441.071,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,365.919,450.862,3236.01],'cm^-1')),
        HinderedRotor(inertia=(0.0374903,'amu*angstrom^2'), symmetry=1, barrier=(3.6706,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0374903,'amu*angstrom^2'), symmetry=1, barrier=(3.6706,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0374903,'amu*angstrom^2'), symmetry=1, barrier=(3.6706,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0374903,'amu*angstrom^2'), symmetry=1, barrier=(3.6706,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0374903,'amu*angstrom^2'), symmetry=1, barrier=(3.6706,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0106907,0.0893098,-7.90445e-05,4.25911e-08,-9.89984e-12,53191,42.7361], Tmin=(100,'K'), Tmax=(1009.5,'K')), NASAPolynomial(coeffs=[10.0393,0.0495736,-2.00017e-05,3.60016e-09,-2.43971e-13,51166.2,-5.74089], Tmin=(1009.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(441.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CJCOOH) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2][C](COO)C([CH2])[CH]C(4751)',
    structure = SMILES('[CH2][C](COO)C([CH2])[CH]C'),
    E0 = (483.609,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,301.777,905.237,2005.62],'cm^-1')),
        HinderedRotor(inertia=(0.0747015,'amu*angstrom^2'), symmetry=1, barrier=(3.07229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0747015,'amu*angstrom^2'), symmetry=1, barrier=(3.07229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0747015,'amu*angstrom^2'), symmetry=1, barrier=(3.07229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0747015,'amu*angstrom^2'), symmetry=1, barrier=(3.07229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0747015,'amu*angstrom^2'), symmetry=1, barrier=(3.07229,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0805541,0.0899122,-7.91552e-05,4.24268e-08,-9.96851e-12,58302.7,44.2887], Tmin=(100,'K'), Tmax=(988.059,'K')), NASAPolynomial(coeffs=[9.30725,0.0525592,-2.24482e-05,4.16505e-09,-2.8741e-13,56479.4,-0.113876], Tmin=(988.059,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(483.609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CJCOOH) + radical(Cs_S) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2][C]([CH]C)C([CH2])COO(4752)',
    structure = SMILES('[CH2][C]([CH]C)C([CH2])COO'),
    E0 = (478.121,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,236.413,846.445,1797.39],'cm^-1')),
        HinderedRotor(inertia=(0.105249,'amu*angstrom^2'), symmetry=1, barrier=(3.38126,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105249,'amu*angstrom^2'), symmetry=1, barrier=(3.38126,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105249,'amu*angstrom^2'), symmetry=1, barrier=(3.38126,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105249,'amu*angstrom^2'), symmetry=1, barrier=(3.38126,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105249,'amu*angstrom^2'), symmetry=1, barrier=(3.38126,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.696167,0.114081,-0.000161867,1.4043e-07,-4.8683e-11,57663.4,43.3541], Tmin=(100,'K'), Tmax=(853.967,'K')), NASAPolynomial(coeffs=[6.62792,0.0582343,-2.59348e-05,4.77371e-09,-3.22106e-13,57197.9,13.7746], Tmin=(853.967,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(478.121,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Cs_S) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    ...
    E0 = (497.944,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2]C([CH]C)C[CH]CO[O](976)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2]C([CH]C)[CH]CCO[O](4723)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(6.55606e+10,'s^-1'), n=0.64, Ea=(159.935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [cCs(-HC)CJ;CsJ;C] for rate rule [cCs(-HC)CJ;CsJ-HH;C]
Euclidian distance = 1.0
family: 1,2_shiftC"""),
...
reaction(
    label = 'reaction6',
    reactants = ['O(4)', '[CH2]C([CH]C)C([CH2])C[O](4724)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(T)(20)', '[CH2]C([CH]C)[CH]CO[O](4725)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CHCH3(T)(21)', '[CH2][CH]C([CH2])CO[O](778)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(T)(20)', '[CH2]C([CH][CH]C)CO[O](886)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(17)', '[CH]C([CH2])C([CH2])CO[O](1065)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2]C([C]C)C([CH2])CO[O](4726)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]C([CH]C)C([CH2])CO[O](4727)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH]C(CO[O])C([CH2])[CH]C(4728)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2]C(CO[O])C1CC1C(4729)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2]C1C(C)CC1CO[O](4700)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2]C([CH]C)C1COOC1(4731)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2]C1COOCC1[CH]C(4733)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['O(4)', '[CH2]C([CH]C)C1COC1(4734)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['O(4)', '[CH2]C1COCC1[CH]C(4736)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['HO2(9)', '[CH2]C(=C)C([CH2])[CH]C(4121)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2]C(CO[O])C(=C)CC(939)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2]C(CO[O])C(C)=CC(1302)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2]C(CC)C(=C)CO[O](940)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['C=C(CO[O])C(C)[CH]C(1303)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2]C(=CC)C(C)CO[O](4737)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2]C([CH]C)C(=C)COO(4738)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2]C(C=C)C(C)CO[O](3799)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2]C(=CC)C([CH2])COO(4739)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2]C(C=C)C([CH2])COO(4740)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', '[CH2]C([CH]C)C(=C)CO[O](4741)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(3)', '[CH2]C(=CC)C([CH2])CO[O](4742)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', '[CH2]C(C=C)C([CH2])CO[O](4743)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
...
reaction(
    label = 'reaction37',
    reactants = ['CH2(T)(20)', '[CH2]C(C=CC)CO[O](884)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
...
reaction(
    label = 'reaction38',
    reactants = ['CHCH3(T)(21)', '[CH2]C(C=C)CO[O](776)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]O[O](46)', '[CH2]C([CH]C)C=C(3803)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH2]O[O](46)', '[CH2][CH]C([CH2])[CH]C(3871)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
...
reaction(
    label = 'reaction45',
    reactants = ['H(3)', '[CH2][C](CO[O])C([CH2])[CH]C(4744)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
...
reaction(
    label = 'reaction46',
    reactants = ['H(3)', '[CH2][C]([CH]C)C([CH2])CO[O](4745)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
...
reaction(
    label = 'reaction47',
    reactants = ['H(3)', '[CH2]C([CH]C)C([CH2])[CH]O[O](4746)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2]C([CH]C)[C](C)CO[O](4747)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2][C](CC)C([CH2])CO[O](941)'],
...
reaction(
    label = 'reaction53',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2]C([CH]C)C([CH2])[CH]OO(4748)'],
...
reaction(
    label = 'reaction54',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2][C]([CH]C)C(C)CO[O](4749)'],
...
reaction(
    label = 'reaction55',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2]C([CH]C)C(C)[CH]O[O](4750)'],
...
reaction(
    label = 'reaction56',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2][C](CO[O])C([CH2])CC(942)'],
...
reaction(
    label = 'reaction58',
    reactants = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
    products = ['[CH2]C([CH]O[O])C([CH2])CC(944)'],
...
reaction(
    label = 'reaction60',
    reactants = ['[CH2][C](COO)C([CH2])[CH]C(4751)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
...
reaction(
    label = 'reaction62',
    reactants = ['[CH2][C]([CH]C)C([CH2])COO(4752)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
...
reaction(
    label = 'reaction63',
    reactants = ['[CH2][CH]C([CH2])C([CH2])COO(4693)'],
    products = ['[CH2]C([CH]C)C([CH2])CO[O](943)'],
