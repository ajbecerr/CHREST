...
species(
    label = '[C]=[C]OC[C]=[CH](18093)',
    structure = SMILES('[C]=[C]OC[C]=[CH]'),
    E0 = (1206.84,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1670,1700,300,440,3120,650,792.5,1650,191.005,191.649,192.279],'cm^-1')),
        HinderedRotor(inertia=(0.00458743,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.676308,'amu*angstrom^2'), symmetry=1, barrier=(17.6195,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.670627,'amu*angstrom^2'), symmetry=1, barrier=(17.6313,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (79.0767,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42621,0.0589286,-8.47221e-05,6.17826e-08,-1.7619e-11,145239,25.4122], Tmin=(100,'K'), Tmax=(864.423,'K')), NASAPolynomial(coeffs=[11.221,0.0136048,-6.07386e-06,1.12724e-09,-7.69163e-14,143546,-20.415], Tmin=(864.423,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1206.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)

species(
    label = '[C]=[C]CO[C]=[CH](18094)',
    structure = SMILES('[C]=[C]CO[C]=[CH]'),
    E0 = (1206.84,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1670,1700,300,440,3120,650,792.5,1650,191.005,191.649,192.279],'cm^-1')),
        HinderedRotor(inertia=(0.00458743,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (79.0767,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42621,0.0589286,-8.47221e-05,6.17826e-08,-1.7619e-11,145239,25.4122], Tmin=(100,'K'), Tmax=(864.423,'K')), NASAPolynomial(coeffs=[11.221,0.0136048,-6.07386e-06,1.12724e-09,-7.69163e-14,143546,-20.415], Tmin=(864.423,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1206.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(C=CJO) + radical(Cds_P) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.57424,0.0584134,-6.18022e-05,3.1095e-08,-5.75233e-12,61713.1,25.2303], Tmin=(100,'K'), Tmax=(1568.7,'K')), NASAPolynomial(coeffs=[16.9002,0.00487963,7.70311e-07,-3.3476e-10,2.75217e-14,58055.8,-56.2148], Tmin=(1568.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(511.965,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_P) + radical(C=C=CJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=[CH](9646)', '[CH]=[C]C[O](16850)'],
    products = ['[CH]=[C]CO[C]=[CH](16182)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=[CH](9646)', '[CH]=[C]O[CH2](9647)'],
    products = ['[CH]=[C]CO[C]=[CH](16182)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[C]=[C]OC[C]=[CH](18093)'],
    products = ['[CH]=[C]CO[C]=[CH](16182)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[C]=[C]CO[C]=[CH](18094)'],
    products = ['[CH]=[C]CO[C]=[CH](16182)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    ...
    products = ['[CH]=[C]CO[C]=[CH](16182)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.41198,'m^3/(mol*s)'), n=2.03228, Ea=(116.148,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 111.2 to 116.1 kJ/mol to match endothermicity of reaction."""),
)
