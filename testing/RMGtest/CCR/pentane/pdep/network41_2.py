...
species(
    label = '[CH]C[CH2](15460)',
    structure = SMILES('[CH]C[CH2]'),
    E0 = (533.464,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1016.41,1017.91,2464.32],'cm^-1')),
        HinderedRotor(inertia=(0.108479,'amu*angstrom^2'), symmetry=1, barrier=(2.49416,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110957,'amu*angstrom^2'), symmetry=1, barrier=(2.55112,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (41.0718,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.03485,0.0169823,3.57998e-06,-1.34823e-08,5.54462e-12,64199.3,14.3548], Tmin=(100,'K'), Tmax=(1041.24,'K')), NASAPolynomial(coeffs=[6.57149,0.0131242,-4.8766e-06,9.05151e-10,-6.41805e-14,62935.4,-5.38272], Tmin=(1041.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(533.464,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (42.0797,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.68001,-0.00873186,9.33983e-05,-1.13233e-07,4.23151e-11,5223.46,6.92151], Tmin=(100,'K'), Tmax=(940.789,'K')), NASAPolynomial(coeffs=[8.53709,0.011048,-2.60224e-06,4.75585e-10,-4.00641e-14,2520.32,-25.7239], Tmin=(940.789,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(43.2144,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), label="""cC3H6""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(T)(20)', 'C2H4(T)(23)'],
    products = ['[CH2]C[CH2](29)'],
    transitionState = 'TS9',
