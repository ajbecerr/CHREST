...
species(
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61662,0.0518956,-3.29695e-05,1.15696e-08,-1.77211e-12,-6510.18,23.9323], Tmin=(100,'K'), Tmax=(1424.38,'K')), NASAPolynomial(coeffs=[8.25151,0.0332633,-1.33479e-05,2.38594e-09,-1.60236e-13,-8400.3,-10.4243], Tmin=(1424.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-54.8428,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.49018,0.0410748,2.63606e-05,-1.30811e-07,1.16679e-10,1284.97,20.0229], Tmin=(100,'K'), Tmax=(417.523,'K')), NASAPolynomial(coeffs=[3.35006,0.0434088,-2.00048e-05,3.86554e-09,-2.73432e-13,1121.02,15.5221], Tmin=(417.523,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(10.3009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ)"""),
)

species(
    label = 'CC(C)C=C[O](1594)',
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34445,0.0416133,2.54224e-05,-6.74458e-08,3.02313e-11,-13793,22.1847], Tmin=(100,'K'), Tmax=(948.645,'K')), NASAPolynomial(coeffs=[16.5281,0.0194698,-5.78344e-06,1.02031e-09,-7.57016e-14,-18558.2,-60.1992], Tmin=(948.645,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-115.604,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ)"""),
)
...
species(
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25631,0.0724344,-0.000115024,1.15977e-07,-4.47819e-11,31095.6,24.9693], Tmin=(100,'K'), Tmax=(850.245,'K')), NASAPolynomial(coeffs=[0.0842769,0.0492304,-2.34239e-05,4.42953e-09,-3.02719e-13,32333,36.5378], Tmin=(850.245,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(257.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Tertalkyl) + radical(CCsJOH)"""),
)
...
species(
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62773,0.0564086,-4.61761e-05,2.47765e-08,-6.29287e-12,32831.8,25.0166], Tmin=(100,'K'), Tmax=(882.177,'K')), NASAPolynomial(coeffs=[5.29349,0.0397868,-1.79127e-05,3.41714e-09,-2.39683e-13,32185,7.79109], Tmin=(882.177,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(272.299,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO) + radical(CCsJOH)"""),
)

species(
    label = '[CH2][C](C)CC[O](1602)',
    structure = SMILES('[CH2][C](C)CC[O]'),
    E0 = (282.604,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,180,2344.24,2346.7],'cm^-1')),
        HinderedRotor(inertia=(0.103763,'amu*angstrom^2'), symmetry=1, barrier=(2.38572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101729,'amu*angstrom^2'), symmetry=1, barrier=(2.33894,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103301,'amu*angstrom^2'), symmetry=1, barrier=(2.3751,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102056,'amu*angstrom^2'), symmetry=1, barrier=(2.34648,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49197,0.0659612,-9.81609e-05,9.81532e-08,-3.77836e-11,34069.3,27.0504], Tmin=(100,'K'), Tmax=(861.259,'K')), NASAPolynomial(coeffs=[-0.330235,0.0483474,-2.20677e-05,4.09751e-09,-2.7719e-13,35350.3,41.184], Tmin=(861.259,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(282.604,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Tertalkyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)[CH][CH]O(1603)',
    structure = SMILES('[CH2]C(C)[CH][CH]O'),
    E0 = (251.676,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.964213,0.0648416,-6.1445e-05,3.31582e-08,-7.34134e-12,30380.6,28.9957], Tmin=(100,'K'), Tmax=(1085.96,'K')), NASAPolynomial(coeffs=[11.0104,0.0278375,-1.03321e-05,1.77992e-09,-1.17664e-13,28198.7,-20.2995], Tmin=(1085.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(251.676,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(Isobutyl) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C([CH2])CC[O](1604)',
    structure = SMILES('[CH2]C([CH2])CC[O]'),
    E0 = (302.264,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,1452.15,1453.55],'cm^-1')),
        HinderedRotor(inertia=(0.0880268,'amu*angstrom^2'), symmetry=1, barrier=(2.02391,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0891544,'amu*angstrom^2'), symmetry=1, barrier=(2.04983,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0877672,'amu*angstrom^2'), symmetry=1, barrier=(2.01794,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0869814,'amu*angstrom^2'), symmetry=1, barrier=(1.99987,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40975,0.0603262,-6.37305e-05,4.77834e-08,-1.5541e-11,36444,27.3027], Tmin=(100,'K'), Tmax=(853.206,'K')), NASAPolynomial(coeffs=[4.94788,0.0383484,-1.56153e-05,2.78311e-09,-1.85719e-13,36036.4,11.9447], Tmin=(853.206,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(302.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][C](C)C[CH]O(1605)',
    structure = SMILES('[CH2][C](C)C[CH]O'),
    E0 = (237.197,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', '[CH2]CC[CH][O](1410)'],
...
reaction(
    label = 'reaction8',
    reactants = ['[CH][O](1548)', '[CH2]C([CH2])C(102)'],
    products = ['[CH2]C(C)C[CH][O](1428)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH2]C(C)C[C][O](1590)'],
    products = ['[CH2]C(C)C[CH][O](1428)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]C(C)C[CH][O](1591)'],
    products = ['[CH2]C(C)C[CH][O](1428)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C=C(C)C[CH][O](1595)'],
    products = ['[CH2]C(C)C[CH][O](1428)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2]C(C)C=C[O](1596)'],
    products = ['[CH2]C(C)C[CH][O](1428)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH2][C](C)C[CH][O](1597)'],
    products = ['[CH2]C(C)C[CH][O](1428)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2]C(C)[CH][CH][O](1598)'],
    products = ['[CH2]C(C)C[CH][O](1428)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH2]C([CH2])C[CH][O](1488)'],
    products = ['[CH2]C(C)C[CH][O](1428)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C(C)C[CH][O](1428)'],
    products = ['[CH2]C([CH2])C[CH]O(1606)'],
