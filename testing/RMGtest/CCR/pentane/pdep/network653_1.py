...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21951,0.0491282,2.00998e-06,-2.84295e-08,1.12908e-11,-18148.5,26.3786], Tmin=(100,'K'), Tmax=(1138.82,'K')), NASAPolynomial(coeffs=[12.604,0.0361548,-1.64832e-05,3.22594e-09,-2.30999e-13,-22493.1,-37.7157], Tmin=(1138.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-151.81,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH)"""),
)

species(
    label = 'CCCCC=C=O(2525)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.977144,0.0627171,-4.008e-05,1.29894e-08,-1.7396e-12,-17838.5,26.156], Tmin=(100,'K'), Tmax=(1671.93,'K')), NASAPolynomial(coeffs=[13.2886,0.0332627,-1.36545e-05,2.45253e-09,-1.64044e-13,-21955.3,-39.5676], Tmin=(1671.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-149.244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d)"""),
)

species(
    label = 'CC=CCCC=O(2270)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4883,0.0578452,-3.25769e-05,8.79104e-09,-9.6979e-13,-19051.8,25.1553], Tmin=(100,'K'), Tmax=(1926.59,'K')), NASAPolynomial(coeffs=[12.3756,0.0352407,-1.49775e-05,2.70099e-09,-1.79522e-13,-23246.8,-34.509], Tmin=(1926.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-159.127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01065,0.0713113,-8.13431e-05,6.67275e-08,-2.38941e-11,9693.16,30.4109], Tmin=(100,'K'), Tmax=(790.952,'K')), NASAPolynomial(coeffs=[4.3377,0.0470036,-2.10553e-05,3.95303e-09,-2.72468e-13,9400.9,16.6196], Tmin=(790.952,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(79.743,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJC) + radical(CCCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.896391,0.0657001,-4.75786e-05,1.88263e-08,-3.1477e-12,6467.12,27.8423], Tmin=(100,'K'), Tmax=(1367.18,'K')), NASAPolynomial(coeffs=[11.2897,0.0352921,-1.42165e-05,2.55813e-09,-1.7293e-13,3625.23,-25.5498], Tmin=(1367.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.8261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCHO) + radical(CCCJ=O)"""),
)

species(
    label = '[CH2]CCCC[C]=O(2535)',
    structure = SMILES('[CH2]CCCC[C]=O'),
    E0 = (90.543,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,1855,455,950,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07023,0.069004,-6.12389e-05,3.39416e-08,-8.45279e-12,10991.4,29.2625], Tmin=(100,'K'), Tmax=(923.293,'K')), NASAPolynomial(coeffs=[7.0262,0.043201,-1.93192e-05,3.67351e-09,-2.57164e-13,9891.6,1.00371], Tmin=(923.293,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.543,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJ) + radical(CCCJ=O)"""),
)
...
species(
    label = '[CH2]C[CH]CCC=O(2536)',
    structure = SMILES('[CH2]C[CH]CCC=O'),
    E0 = (125.041,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,2782.5,750,1395,475,1775,1000,3000,3100,440,815,1455,1000,221.034,436.61,3418.14],'cm^-1')),
        HinderedRotor(inertia=(0.0303562,'amu*angstrom^2'), symmetry=1, barrier=(0.806072,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0303562,'amu*angstrom^2'), symmetry=1, barrier=(0.806072,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0303562,'amu*angstrom^2'), symmetry=1, barrier=(0.806072,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0303562,'amu*angstrom^2'), symmetry=1, barrier=(0.806072,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0303562,'amu*angstrom^2'), symmetry=1, barrier=(0.806072,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15273,0.0696607,-8.2578e-05,7.44638e-08,-2.88536e-11,15134.6,30.6946], Tmin=(100,'K'), Tmax=(793.097,'K')), NASAPolynomial(coeffs=[2.15153,0.0516467,-2.39649e-05,4.56419e-09,-3.16734e-13,15384.3,28.6804], Tmin=(793.097,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.041,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJCC) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C[C]=O(2354)', '[CH]CC(26)'],
    products = ['CC[CH]CC[C]=O(2264)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H5(14)', '[CH]CC[C]=O(2356)'],
    products = ['CC[CH]CC[C]=O(2264)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction8',
    reactants = ['[C]=O(2355)', '[CH2]C[CH]CC(101)'],
    products = ['CC[CH]CC[C]=O(2264)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'CC[C]CC[C]=O(2523)'],
    products = ['CC[CH]CC[C]=O(2264)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['CO(2039)', '[CH2]C[CH]CC(101)'],
    products = ['CC[CH]CC[C]=O(2264)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'CC[CH]CC=C=O(2528)'],
    products = ['CC[CH]CC[C]=O(2264)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(17)', 'C=CCC[C]=O(2291)'],
    products = ['CC[CH]CC[C]=O(2264)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', 'CC[CH][CH]C[C]=O(2529)'],
    products = ['CC[CH]CC[C]=O(2264)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH3(17)', '[CH2][CH]CC[C]=O(2285)'],
    products = ['CC[CH]CC[C]=O(2264)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', 'C[CH][CH]CC[C]=O(2530)'],
    products = ['CC[CH]CC[C]=O(2264)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', 'CC[CH]C[CH][C]=O(2531)'],
    products = ['CC[CH]CC[C]=O(2264)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2]C[CH]CC[C]=O(2532)'],
    products = ['CC[CH]CC[C]=O(2264)'],
