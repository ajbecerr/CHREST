species(
    label = 'C[CH]C(C)C1[CH]CC1(5482)',
    structure = SMILES('C[CH]C(C)C1[CH]CC1'),
    E0 = (286.397,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.797416,0.054259,2.69191e-05,-6.03169e-08,2.30871e-11,34574.7,33.9942], Tmin=(100,'K'), Tmax=(1052.74,'K')), NASAPolynomial(coeffs=[12.011,0.049557,-2.0391e-05,3.84598e-09,-2.72407e-13,30113.3,-30.6573], Tmin=(1052.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(286.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(Cs_S)"""),
)
...
species(
    label = 'C[CH]C(C)[CH]C1CC1(6552)',
    structure = SMILES('C[CH]C(C)[CH]C1CC1'),
    E0 = (300.867,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.517228,0.0616875,6.79411e-06,-4.18162e-08,1.72246e-11,36324,35.195], Tmin=(100,'K'), Tmax=(1065.93,'K')), NASAPolynomial(coeffs=[13.1668,0.0472577,-1.93931e-05,3.64064e-09,-2.56685e-13,31750.4,-35.4436], Tmin=(1065.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(300.867,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Cs_S) + radical(Cs_S)"""),
)

species(
    label = 'CC(C)[CH]C1[CH]CC1(6553)',
    structure = SMILES('CC(C)[CH]C1[CH]CC1'),
    E0 = (286.397,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.797416,0.054259,2.69191e-05,-6.03169e-08,2.30871e-11,34574.7,33.301], Tmin=(100,'K'), Tmax=(1052.74,'K')), NASAPolynomial(coeffs=[12.011,0.049557,-2.0391e-05,3.84598e-09,-2.72407e-13,30113.3,-31.3505], Tmin=(1052.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(286.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Cs_S) + radical(cyclobutane)"""),
)
...
species(
    label = 'C[CH]C1[CH]CC1(6260)',
    structure = SMILES('C[CH]C1[CH]CC1'),
    E0 = (339.652,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.22423,0.0255006,5.04548e-05,-7.16401e-08,2.56826e-11,40926.3,24.6616], Tmin=(100,'K'), Tmax=(1029.88,'K')), NASAPolynomial(coeffs=[8.21834,0.0363179,-1.49635e-05,2.85477e-09,-2.04623e-13,37883.3,-13.2122], Tmin=(1029.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(339.652,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(Cs_S)"""),
)
...
species(
    label = '[CH]C(C)C1[CH]CC1(6267)',
    structure = SMILES('[CH]C(C)C1[CH]CC1'),
    E0 = (560.503,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30276,0.0426083,3.63159e-05,-7.11487e-08,2.83211e-11,67524.8,28.3791], Tmin=(100,'K'), Tmax=(1000.06,'K')), NASAPolynomial(coeffs=[13.0698,0.0358234,-1.39247e-05,2.61923e-09,-1.88323e-13,63157,-38.4612], Tmin=(1000.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(560.503,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'C[C]C(C)C1[CH]CC1(6554)',
    structure = SMILES('C[C]C(C)C1[CH]CC1'),
    E0 = (540.07,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.563403,0.0584808,1.86894e-05,-5.82275e-08,2.41315e-11,65094,32.1799], Tmin=(100,'K'), Tmax=(1020.71,'K')), NASAPolynomial(coeffs=[14.5406,0.0433061,-1.72049e-05,3.22573e-09,-2.29544e-13,60177.8,-45.6436], Tmin=(1020.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(540.07,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C[CH]C(C)C1[C]CC1(6555)',
    structure = SMILES('C[CH]C(C)C1[C]CC1'),
    E0 = (546.773,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.593223,0.0566338,2.5688e-05,-6.65416e-08,2.72506e-11,65900.3,32.2816], Tmin=(100,'K'), Tmax=(1014.3,'K')), NASAPolynomial(coeffs=[15.094,0.0424184,-1.68358e-05,3.17491e-09,-2.27403e-13,60748.3,-48.7781], Tmin=(1014.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(546.773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Cs_S) + radical(CCJ2_triplet)"""),
)

species(
    label = 'CC1C(C)C2CCC12(6556)',
    structure = SMILES('CC1C(C)C2CCC12'),
    E0 = (61.7046,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16807,0.0371676,8.9274e-05,-1.32629e-07,5.03567e-11,7545.61,21.9274], Tmin=(100,'K'), Tmax=(988.247,'K')), NASAPolynomial(coeffs=[14.7845,0.0446649,-1.71386e-05,3.26488e-09,-2.38713e-13,1796.96,-59.0715], Tmin=(988.247,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.7046,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + polycyclic(s2_4_4_ane)"""),
)

species(
    label = 'CCC(C)C1=CCC1(6312)',
    structure = SMILES('CCC(C)C1=CCC1'),
    E0 = (27.2346,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.479157,0.0569166,3.577e-05,-8.21973e-08,3.40905e-11,3420.54,29.8509], Tmin=(100,'K'), Tmax=(988.205,'K')), NASAPolynomial(coeffs=[16.5002,0.0413779,-1.54918e-05,2.87944e-09,-2.06811e-13,-2153.55,-59.4332], Tmin=(988.205,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(27.2346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)

species(
    label = 'CC=C(C)C1CCC1(6557)',
    structure = SMILES('CC=C(C)C1CCC1'),
    E0 = (11.0423,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.656669,0.0540256,3.85703e-05,-8.02512e-08,3.21077e-11,1465.59,28.4539], Tmin=(100,'K'), Tmax=(1003.73,'K')), NASAPolynomial(coeffs=[14.6879,0.0447925,-1.73961e-05,3.25776e-09,-2.33086e-13,-3702.74,-51.0054], Tmin=(1003.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.0423,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(519.654,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutane)"""),
)

species(
    label = 'CCC(C)C1C=CC1(6192)',
    structure = SMILES('CCC(C)C1C=CC1'),
    E0 = (35.6803,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.584972,0.0533698,4.64954e-05,-9.36479e-08,3.82251e-11,4433.66,29.3178], Tmin=(100,'K'), Tmax=(983.142,'K')), NASAPolynomial(coeffs=[16.6163,0.0409692,-1.518e-05,2.82551e-09,-2.0394e-13,-1271.46,-60.735], Tmin=(983.142,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.6803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)

species(
    label = 'C=CC(C)C1CCC1(6205)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.776865,0.0465929,6.7998e-05,-1.16334e-07,4.62385e-11,3688.29,29.6676], Tmin=(100,'K'), Tmax=(978.297,'K')), NASAPolynomial(coeffs=[16.8464,0.0407993,-1.49787e-05,2.80923e-09,-2.04972e-13,-2322.79,-62.1588], Tmin=(978.297,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(29.5209,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(519.654,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)
...
species(
    label = '[CH2]CC=CC(C)[CH]C(6558)',
    structure = SMILES('[CH2]CC=CC(C)[CH]C'),
    E0 = (269.063,'kJ/mol'),
    modes = [
...
species(
    label = 'C[CH]C(C)[C]1CCC1(6565)',
    structure = SMILES('C[CH]C(C)[C]1CCC1'),
    E0 = (283.981,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.682322,0.0613657,-1.86472e-06,-2.56897e-08,1.00384e-11,34283.9,33.2046], Tmin=(100,'K'), Tmax=(1164.89,'K')), NASAPolynomial(coeffs=[10.6713,0.0519526,-2.17899e-05,4.05356e-09,-2.80925e-13,30268.2,-23.7584], Tmin=(1164.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(283.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(Cs_S)"""),
)

species(
    label = 'CC[C](C)C1[CH]CC1(6323)',
    structure = SMILES('CC[C](C)C1[CH]CC1'),
    E0 = (277.277,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.645158,0.0632463,-8.73534e-06,-1.78836e-08,7.27612e-12,33478,33.1328], Tmin=(100,'K'), Tmax=(1212.89,'K')), NASAPolynomial(coeffs=[10.6049,0.0520864,-2.17536e-05,4.01347e-09,-2.75824e-13,29466.9,-23.4152], Tmin=(1212.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(277.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(cyclobutane)"""),
)

species(
    label = 'C[CH]C(C)C1C[CH]C1(6566)',
    structure = SMILES('C[CH]C(C)C1C[CH]C1'),
    E0 = (286.397,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC(C)C1[CH]CC1(6329)',
    structure = SMILES('[CH2]CC(C)C1[CH]CC1'),
    E0 = (297.101,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.651044,0.056172,2.77632e-05,-6.57575e-08,2.61626e-11,35868.7,33.747], Tmin=(100,'K'), Tmax=(1025.06,'K')), NASAPolynomial(coeffs=[13.522,0.0469514,-1.87471e-05,3.51538e-09,-2.4973e-13,31075.8,-39.1743], Tmin=(1025.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(297.101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(RCCJ)"""),
)

species(
    label = 'C[CH][C](C)C1CCC1(6567)',
    structure = SMILES('C[CH][C](C)C1CCC1'),
    E0 = (283.981,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
...
species(
    label = 'CCC(C)[C]1[CH]CC1(6326)',
    structure = SMILES('CCC(C)[C]1[CH]CC1'),
    E0 = (277.277,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.645158,0.0632463,-8.73534e-06,-1.78836e-08,7.27612e-12,33478,33.8259], Tmin=(100,'K'), Tmax=(1212.89,'K')), NASAPolynomial(coeffs=[10.6049,0.0520864,-2.17536e-05,4.01347e-09,-2.75824e-13,29466.9,-22.722], Tmin=(1212.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(277.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(cyclobutane)"""),
)
...
species(
    label = 'CCC(C)C1[CH]C[CH]1(6327)',
    structure = SMILES('CCC(C)C1[CH]C[CH]1'),
    E0 = (279.693,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.764803,0.0561304,1.98776e-05,-5.20138e-08,2.00036e-11,33768.5,33.903], Tmin=(100,'K'), Tmax=(1065.22,'K')), NASAPolynomial(coeffs=[11.5237,0.0503385,-2.07015e-05,3.88338e-09,-2.73462e-13,29512.9,-27.8989], Tmin=(1065.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(279.693,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(cyclobutane)"""),
)

species(
    label = '[CH2]C([CH]C)C1CCC1(6328)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.664662,0.0552722,3.25759e-05,-7.34258e-08,2.98388e-11,36655.6,33.9], Tmin=(100,'K'), Tmax=(997.196,'K')), NASAPolynomial(coeffs=[13.8999,0.0452653,-1.71776e-05,3.16201e-09,-2.23801e-13,31873.9,-40.6556], Tmin=(997.196,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.641,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = 'CCC(C)C1[CH][CH]C1(6330)',
    structure = SMILES('CCC(C)C1[CH][CH]C1'),
    E0 = (279.693,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
...
species(
    label = '[CH2][CH]C(C)C1CCC1(6568)',
    structure = SMILES('[CH2][CH]C(C)C1CCC1'),
    E0 = (303.805,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.680897,0.0543254,3.47571e-05,-7.40599e-08,2.9274e-11,36675,33.8486], Tmin=(100,'K'), Tmax=(1018.47,'K')), NASAPolynomial(coeffs=[14.0711,0.0460705,-1.83816e-05,3.46541e-09,-2.47658e-13,31648.2,-42.2848], Tmin=(1018.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.805,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Cs_S) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]C(C)C1[CH]CC1(5482)'],
    products = ['C1=CCC1(4846)', 'butene2t(396)'],
    transitionState = 'TS1',
...
reaction(
    ...
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C[CH]C(C)[CH]C1CC1(6552)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CC(C)[CH]C1[CH]CC1(6553)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C1CC1C(C)[CH]C(5484)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHCH3(T)(21)', 'C[CH]C1[CH]CC1(6260)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', '[CH]C(C)C1[CH]CC1(6267)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'C[C]C(C)C1[CH]CC1(6554)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'C[CH]C(C)C1[C]CC1(6555)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CC=CC(C)[CH]C(6558)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C[CH]C(C)C1=CCC1(6559)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'CC=C(C)C1[CH]CC1(6560)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'C[CH]C(C)C1C=CC1(6233)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', 'C=CC(C)C1[CH]CC1(6232)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C1=CCC1(4846)', 'C[CH][CH]C(1186)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]1[CH]CC1(6173)', 'butene2t(396)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH3(17)', 'CC=CC1[CH]CC1(6293)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]1[CH]CC1(6173)', 'C[CH][CH]C(1186)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', 'C[CH]C(C)[C]1[CH]CC1(6561)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH3(17)', 'C[CH][CH]C1[CH]CC1(6297)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', 'C[CH][C](C)C1[CH]CC1(6562)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', 'C[CH]C(C)C1[CH]C[CH]1(6563)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', 'C[CH]C(C)C1[CH][CH]C1(6564)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', '[CH2]C([CH]C)C1[CH]CC1(5828)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', '[CH2][CH]C(C)C1[CH]CC1(5765)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
...
reaction(
    label = 'reaction32',
    reactants = ['C[CH]C(C)C1[CH]CC1(5482)'],
    products = ['C[CH]C(C)[C]1CCC1(6565)'],
...
reaction(
    label = 'reaction33',
    reactants = ['C[CH]C(C)C1[CH]CC1(5482)'],
    products = ['CC[C](C)C1[CH]CC1(6323)'],
...
reaction(
    label = 'reaction34',
    reactants = ['C[CH]C(C)C1C[CH]C1(6566)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
...
reaction(
    label = 'reaction35',
    reactants = ['C[CH]C(C)C1[CH]CC1(5482)'],
    products = ['[CH2]CC(C)C1[CH]CC1(6329)'],
...
reaction(
    label = 'reaction37',
    reactants = ['C[CH]C(C)C1[CH]CC1(5482)'],
    products = ['CCC(C)[C]1[CH]CC1(6326)'],
...
reaction(
    label = 'reaction39',
    reactants = ['C[CH]C(C)C1[CH]CC1(5482)'],
    products = ['CCC(C)C1[CH]C[CH]1(6327)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]C([CH]C)C1CCC1(6328)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
...
reaction(
    label = 'reaction41',
    reactants = ['C[CH]C(C)C1[CH]CC1(5482)'],
    products = ['CCC(C)C1[CH][CH]C1(6330)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2][CH]C(C)C1CCC1(6568)'],
    products = ['C[CH]C(C)C1[CH]CC1(5482)'],
...
network(
    ...
    isomers = [
        'C[CH]C(C)C1[CH]CC1(5482)',
    ],
    reactants = [
        ('C1=CCC1(4846)', 'butene2t(396)'),
    ],
    bathGas = {
        'Ar': 0.333333,
        'Ne': 0.333333,
