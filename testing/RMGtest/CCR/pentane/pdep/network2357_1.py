...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.10713,0.0811016,-7.14718e-05,2.57655e-08,-1.43833e-12,52914.6,29.9461], Tmin=(100,'K'), Tmax=(982.37,'K')), NASAPolynomial(coeffs=[19.3937,0.0202639,-6.9254e-06,1.20003e-09,-8.25126e-14,48187.3,-68.3467], Tmin=(982.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(438.659,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]C(C)O[C]=[CH](9696)',
    structure = SMILES('[CH]C(C)O[C]=[CH]'),
    E0 = (713.125,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.904381,0.0595374,-4.66037e-05,8.72523e-09,3.53572e-12,85888.4,26.2299], Tmin=(100,'K'), Tmax=(955.617,'K')), NASAPolynomial(coeffs=[16.9095,0.0124178,-3.83752e-06,6.53411e-10,-4.60665e-14,81922,-55.0068], Tmin=(955.617,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(713.125,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]OC(C)[C]C(10159)',
    structure = SMILES('[CH]=[C]OC(C)[C]C'),
    E0 = (689.345,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1685,370,3120,650,792.5,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.14908,0.0756194,-6.5072e-05,2.29089e-08,-1.2738e-12,83055.7,30.0866], Tmin=(100,'K'), Tmax=(1002.32,'K')), NASAPolynomial(coeffs=[18.3531,0.019939,-7.13685e-06,1.26389e-09,-8.75841e-14,78554.2,-62.0311], Tmin=(1002.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(689.345,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[C]=[C]OC(C)[CH]C(10160)',
    structure = SMILES('[C]=[C]OC(C)[CH]C'),
    E0 = (752.038,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.392818,0.0706605,-5.8952e-05,2.15255e-08,-1.96319e-12,90586.6,31.7786], Tmin=(100,'K'), Tmax=(1048.28,'K')), NASAPolynomial(coeffs=[16.7616,0.0216705,-8.12509e-06,1.45893e-09,-1.00863e-13,86414.8,-51.4929], Tmin=(1048.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(752.038,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.623638,0.0679213,-5.39328e-05,2.24066e-08,-3.78414e-12,16855.7,27.3761], Tmin=(100,'K'), Tmax=(1398.32,'K')), NASAPolynomial(coeffs=[14.575,0.028012,-1.11213e-05,1.99555e-09,-1.34911e-13,12954,-44.6088], Tmin=(1398.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(139.093,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=COC(C)C=C(6951)',
...
species(
    ...
    E0 = (441.346,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,1685,370,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH]=[C]OC[CH]C(2442)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]=[C]O[CH]C(C)C(10158)'],
    products = ['[CH]=[C]OC(C)[CH]C(2731)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=[CH](9646)', 'C[CH]C(C)[O](1371)'],
    products = ['[CH]=[C]OC(C)[CH]C(2731)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHCH3(T)(21)', '[CH]=[C]O[CH]C(9652)'],
    products = ['[CH]=[C]OC(C)[CH]C(2731)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', '[CH]C(C)O[C]=[CH](9696)'],
    products = ['[CH]=[C]OC(C)[CH]C(2731)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]=[C]OC(C)[C]C(10159)'],
    products = ['[CH]=[C]OC(C)[CH]C(2731)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[C]=[C]OC(C)[CH]C(10160)'],
    products = ['[CH]=[C]OC(C)[CH]C(2731)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'C#CO[C](C)[CH]C(7378)'],
    products = ['[CH]=[C]OC(C)[CH]C(2731)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(17)', 'C#CO[CH][CH]C(7377)'],
    products = ['[CH]=[C]OC(C)[CH]C(2731)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(17)', '[CH]=[C]O[CH][CH]C(9719)'],
    products = ['[CH]=[C]OC(C)[CH]C(2731)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH]=[C]O[C](C)[CH]C(10162)'],
    products = ['[CH]=[C]OC(C)[CH]C(2731)'],
