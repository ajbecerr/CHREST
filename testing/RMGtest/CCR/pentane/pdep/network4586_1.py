...
species(
    label = 'C#CCC[CH]C(15644)',
    structure = SMILES('C#CCC[CH]C'),
    E0 = (296.467,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2175,525,750,770,3400,2100,269.471,2398.71],'cm^-1')),
        HinderedRotor(inertia=(1.41967,'amu*angstrom^2'), symmetry=1, barrier=(73.4393,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.002815,'amu*angstrom^2'), symmetry=1, barrier=(11.4737,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221788,'amu*angstrom^2'), symmetry=1, barrier=(11.4782,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.41508,'amu*angstrom^2'), symmetry=1, barrier=(73.4317,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63098,0.0524061,-3.63393e-05,1.54678e-08,-2.98455e-12,35741.8,23.6486], Tmin=(100,'K'), Tmax=(1153.94,'K')), NASAPolynomial(coeffs=[6.63054,0.0350754,-1.38108e-05,2.45218e-09,-1.64674e-13,34587.9,-1.18711], Tmin=(1153.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(296.467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH]CC[C]=C[O](21486)',
    structure = SMILES('C[CH]CC[C]=C[O]'),
    E0 = (300.876,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,1685,370,180,180,180,660.319],'cm^-1')),
        HinderedRotor(inertia=(0.0265424,'amu*angstrom^2'), symmetry=1, barrier=(13.1533,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00115846,'amu*angstrom^2'), symmetry=1, barrier=(13.1532,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.80665,'amu*angstrom^2'), symmetry=1, barrier=(41.5384,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0265372,'amu*angstrom^2'), symmetry=1, barrier=(13.1535,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.684812,0.0658934,-5.04683e-05,2.05536e-08,-3.42201e-12,36312.1,30.9499], Tmin=(100,'K'), Tmax=(1414.61,'K')), NASAPolynomial(coeffs=[13.8792,0.0285845,-1.09072e-05,1.90959e-09,-1.27094e-13,32579.1,-37.2818], Tmin=(1414.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(300.876,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(RCCJC) + radical(Cds_S)"""),
)
...
species(
    label = 'C[C]CC[C]=CO[O](21487)',
    structure = SMILES('C[C]CC[C]=CO[O]'),
    E0 = (689.682,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.352568,0.0831766,-9.27674e-05,5.76996e-08,-1.47032e-11,83078.4,32.7096], Tmin=(100,'K'), Tmax=(946.361,'K')), NASAPolynomial(coeffs=[11.992,0.0339801,-1.47896e-05,2.76775e-09,-1.91856e-13,80875.4,-22.802], Tmin=(946.361,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(689.682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(CCJ2_triplet) + radical(Cds_S)"""),
)

species(
    label = 'C[CH]CCC1=COO1(21488)',
    structure = SMILES('C[CH]CCC1=COO1'),
    E0 = (226.362,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.753852,0.0605677,-2.33246e-05,-8.3251e-09,6.10179e-12,27351,32.0865], Tmin=(100,'K'), Tmax=(1098.34,'K')), NASAPolynomial(coeffs=[13.7461,0.033404,-1.37491e-05,2.56779e-09,-1.79921e-13,23281.5,-37.346], Tmin=(1098.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(226.362,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(RCCJC)"""),
)
...
species(
    label = 'CC=CCC=CO[O](21490)',
    structure = SMILES('CC=CCC=CO[O]'),
    E0 = (120.431,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.476398,0.0716611,-5.66043e-05,2.36527e-08,-4.04189e-12,14616.1,31.9405], Tmin=(100,'K'), Tmax=(1377.41,'K')), NASAPolynomial(coeffs=[14.4883,0.0309701,-1.22913e-05,2.20489e-09,-1.49071e-13,10756.1,-40.1452], Tmin=(1377.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.431,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ)"""),
)

species(
    label = 'CCCC=C=CO[O](19253)',
    structure = SMILES('CCCC=C=CO[O]'),
    E0 = (167.984,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.416008,0.0767934,-6.7556e-05,3.21819e-08,-6.30841e-12,20334.4,30.7076], Tmin=(100,'K'), Tmax=(1208.11,'K')), NASAPolynomial(coeffs=[13.4826,0.0335307,-1.38407e-05,2.54054e-09,-1.74587e-13,17177.3,-34.8014], Tmin=(1208.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(167.984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + radical(ROOJ)"""),
)

species(
    label = 'C=CCCC=CO[O](15495)',
    structure = SMILES('C=CCCC=CO[O]'),
    E0 = (131.407,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.266944,0.0733919,-5.85886e-05,2.44103e-08,-4.10609e-12,15946.2,33.1087], Tmin=(100,'K'), Tmax=(1413.52,'K')), NASAPolynomial(coeffs=[16.1454,0.0284582,-1.09054e-05,1.92096e-09,-1.28502e-13,11457.3,-48.9908], Tmin=(1413.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(131.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = 'C[CH]CC=C=COO(19626)',
    structure = SMILES('C[CH]CC=C=COO'),
    E0 = (210.425,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.580418,0.0777854,-7.20987e-05,3.78367e-08,-8.39248e-12,25429.3,32.1021], Tmin=(100,'K'), Tmax=(1059.38,'K')), NASAPolynomial(coeffs=[10.868,0.0389421,-1.71003e-05,3.22678e-09,-2.25087e-13,23249.6,-18.1232], Tmin=(1059.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(210.425,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH]CC=C=CO[O](19628)',
    structure = SMILES('C[CH]CC=C=CO[O]'),
    E0 = (362.43,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,540,610,2055,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.27857,'amu*angstrom^2'), symmetry=1, barrier=(6.40487,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.278592,'amu*angstrom^2'), symmetry=1, barrier=(6.40537,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.27859,'amu*angstrom^2'), symmetry=1, barrier=(6.40533,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.278652,'amu*angstrom^2'), symmetry=1, barrier=(6.40676,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.750017,0.0752535,-8.03118e-05,5.1531e-08,-1.40037e-11,43704,32.256], Tmin=(100,'K'), Tmax=(878.396,'K')), NASAPolynomial(coeffs=[8.96147,0.0378616,-1.64611e-05,3.07233e-09,-2.12319e-13,42261.3,-6.29504], Tmin=(878.396,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(362.43,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + radical(ROOJ) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH]CCC#CO[O](21492)',
    structure = SMILES('C[CH]CCC#CO[O]'),
    E0 = (423.585,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2100,2250,500,550,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.718655,0.0770272,-9.41265e-05,7.39329e-08,-2.42833e-11,51059,33.1926], Tmin=(100,'K'), Tmax=(832.915,'K')), NASAPolynomial(coeffs=[6.83992,0.0410729,-1.75667e-05,3.20199e-09,-2.16229e-13,50266.8,6.14564], Tmin=(832.915,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(423.585,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCt) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(ROOJ) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH]CC[C]=[C]O[O](21494)',
    structure = SMILES('C[CH]CC[C]=[C]O[O]'),
    E0 = (675.657,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1670,1700,300,440,180,400,3144.12],'cm^-1')),
        HinderedRotor(inertia=(0.0545918,'amu*angstrom^2'), symmetry=1, barrier=(2.62202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0545918,'amu*angstrom^2'), symmetry=1, barrier=(2.62202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0545918,'amu*angstrom^2'), symmetry=1, barrier=(2.62202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0545918,'amu*angstrom^2'), symmetry=1, barrier=(2.62202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0545918,'amu*angstrom^2'), symmetry=1, barrier=(2.62202,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.63506,0.0843749,-0.000128549,1.18641e-07,-4.28106e-11,81373.9,37.6425], Tmin=(100,'K'), Tmax=(856.453,'K')), NASAPolynomial(coeffs=[4.03594,0.0457344,-2.1017e-05,3.9125e-09,-2.65031e-13,81626,26.6348], Tmin=(856.453,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(675.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(RCCJC) + radical(Cds_S) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.879298,0.0668096,-4.65261e-05,1.70912e-08,-2.6428e-12,36891.2,33.9349], Tmin=(100,'K'), Tmax=(1457.5,'K')), NASAPolynomial(coeffs=[11.9489,0.03643,-1.52609e-05,2.79044e-09,-1.89851e-13,33664.4,-23.6399], Tmin=(1457.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(305.788,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(RCCJC) + radical(C=CCJO)"""),
)

species(
    label = '[CH2]CCC[C]=CO[O](21495)',
    structure = SMILES('[CH2]CCC[C]=CO[O]'),
    E0 = (446.713,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.486413,0.0803293,-8.18435e-05,4.78198e-08,-1.16912e-11,53851.1,34.1106], Tmin=(100,'K'), Tmax=(974.402,'K')), NASAPolynomial(coeffs=[10.8326,0.0378576,-1.64626e-05,3.08776e-09,-2.14526e-13,51834.8,-15.5356], Tmin=(974.402,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(446.713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(RCCJ) + radical(Cds_S)"""),
)

species(
    label = 'C[CH]CCC=[C]O[O](21496)',
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.70697,0.0792952,-0.000102001,8.70217e-08,-3.08434e-11,52768.9,36.9123], Tmin=(100,'K'), Tmax=(820.615,'K')), NASAPolynomial(coeffs=[5.0387,0.0465628,-2.09335e-05,3.91018e-09,-2.67627e-13,52449.2,19.2541], Tmin=(820.615,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(437.815,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(RCCJC) + radical(C=CJO)"""),
)

species(
    label = 'C[CH]CC[C]=[C]OO(21497)',
    structure = SMILES('C[CH]CC[C]=[C]OO'),
    E0 = (523.652,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1670,1700,300,440,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.39931,0.0876311,-0.000122701,1.08017e-07,-3.8634e-11,63102.3,37.7304], Tmin=(100,'K'), Tmax=(821.989,'K')), NASAPolynomial(coeffs=[5.55459,0.0475183,-2.20814e-05,4.17089e-09,-2.86646e-13,62762.4,16.9575], Tmin=(821.989,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(523.652,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJC) + radical(Cds_S) + radical(C=CJO)"""),
)

species(
    label = 'CCCC=[C][CH]O[O](19640)',
    structure = SMILES('CCCC=[C][CH]O[O]'),
    E0 = (349.183,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.548964,0.0723187,-5.55876e-05,2.23844e-08,-3.72145e-12,42124,32.8622], Tmin=(100,'K'), Tmax=(1395.12,'K')), NASAPolynomial(coeffs=[13.9678,0.0338449,-1.42214e-05,2.61716e-09,-1.79235e-13,38379.8,-36.344], Tmin=(1395.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(349.183,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(C=CCJO) + radical(Cds_S)"""),
)

species(
    label = 'C[CH][CH]CC=CO[O](21498)',
    structure = SMILES('C[CH][CH]CC=CO[O]'),
    E0 = (392.529,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.760638,0.0778854,-9.85299e-05,8.34991e-08,-2.94336e-11,47320.6,36.1553], Tmin=(100,'K'), Tmax=(827.879,'K')), NASAPolynomial(coeffs=[4.85777,0.0464854,-2.06122e-05,3.82325e-09,-2.60567e-13,47039.9,19.5647], Tmin=(827.879,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(392.529,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(RCCJCC) + radical(RCCJC)"""),
)
...
species(
    label = 'CCCC[C]=[C]O[O](21499)',
    structure = SMILES('CCCC[C]=[C]O[O]'),
    E0 = (481.211,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1670,1700,300,440,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.474054,0.0836768,-0.000107183,8.73327e-08,-2.98132e-11,57997.4,35.4882], Tmin=(100,'K'), Tmax=(795.884,'K')), NASAPolynomial(coeffs=[7.03561,0.0440439,-1.99433e-05,3.75037e-09,-2.58238e-13,57163.7,6.65467], Tmin=(795.884,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(481.211,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Cds_S) + radical(C=CJO)"""),
)

species(
    label = 'C[CH]CC=[C][CH]OO(19636)',
    structure = SMILES('C[CH]CC=[C][CH]OO'),
    E0 = (391.625,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.824006,0.0721316,-5.65646e-05,2.41286e-08,-4.4078e-12,47213.8,33.8512], Tmin=(100,'K'), Tmax=(1242.43,'K')), NASAPolynomial(coeffs=[10.7609,0.0401398,-1.79404e-05,3.40343e-09,-2.37506e-13,44744.6,-16.2455], Tmin=(1242.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(391.625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(C=CCJO) + radical(Cds_S)"""),
)

species(
    label = 'C[CH][CH]C[C]=COO(21500)',
    structure = SMILES('C[CH][CH]C[C]=COO'),
    E0 = (478.366,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.454371,0.0862032,-0.000119157,1.04384e-07,-3.71692e-11,57653.9,36.9685], Tmin=(100,'K'), Tmax=(828.056,'K')), NASAPolynomial(coeffs=[5.37083,0.047446,-2.17631e-05,4.08472e-09,-2.7965e-13,57354.2,17.2838], Tmin=(828.056,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(478.366,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJCC) + radical(RCCJC) + radical(Cds_S)"""),
)

species(
    label = '[CH2][CH]CC[C]=COO(21501)',
    structure = SMILES('[CH2][CH]CC[C]=COO'),
    E0 = (489.154,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.412837,0.0841735,-9.65356e-05,6.68643e-08,-1.95963e-11,58956.1,36.3549], Tmin=(100,'K'), Tmax=(817.617,'K')), NASAPolynomial(coeffs=[9.06011,0.0418707,-1.89304e-05,3.58957e-09,-2.49897e-13,57542,-3.62233], Tmin=(817.617,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(489.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJC) + radical(RCCJ) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['C[CH]CC[C]=CO[O](20929)'],
    products = ['O2(S)(666)', 'C#CCC[CH]C(15644)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction5',
    reactants = ['O(4)', 'C[CH]CC[C]=C[O](21486)'],
    products = ['C[CH]CC[C]=CO[O](20929)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHCH3(T)(21)', '[CH2]C[C]=CO[O](21345)'],
    products = ['C[CH]CC[C]=CO[O](20929)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[C]=CO[O](21346)', '[CH2]C[CH]C(36)'],
    products = ['C[CH]CC[C]=CO[O](20929)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', '[CH]CC[C]=CO[O](21347)'],
    products = ['C[CH]CC[C]=CO[O](20929)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'C[C]CC[C]=CO[O](21487)'],
    products = ['C[CH]CC[C]=CO[O](20929)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]CC[C]=CO[O](20929)'],
    products = ['O(4)', 'C[CH]CCC1=CO1(21489)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'CC=CC[C]=CO[O](21491)'],
    products = ['C[CH]CC[C]=CO[O](20929)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'C[CH]CC=C=CO[O](19628)'],
    products = ['C[CH]CC[C]=CO[O](20929)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'C=CCC[C]=CO[O](20982)'],
    products = ['C[CH]CC[C]=CO[O](20929)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', 'C[CH]CCC#CO[O](21492)'],
    products = ['C[CH]CC[C]=CO[O](20929)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O2(2)', 'C#CCC[CH]C(15644)'],
    products = ['C[CH]CC[C]=CO[O](20929)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O2(2)', '[CH]=[C]CC[CH]C(15215)'],
    products = ['C[CH]CC[C]=CO[O](20929)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', 'C[CH][CH]C[C]=CO[O](21493)'],
    products = ['C[CH]CC[C]=CO[O](20929)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', 'C[CH]CC=[C][CH]O[O](19631)'],
    products = ['C[CH]CC[C]=CO[O](20929)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH2][CH]CC[C]=CO[O](20977)'],
    products = ['C[CH]CC[C]=CO[O](20929)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', 'C[CH]CC[C]=[C]O[O](21494)'],
    products = ['C[CH]CC[C]=CO[O](20929)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CC[CH]C[C]=CO[O](21411)'],
    products = ['C[CH]CC[C]=CO[O](20929)'],
...
reaction(
    label = 'reaction31',
    reactants = ['C[CH]CC[C]=CO[O](20929)'],
    products = ['C[CH]CC=C[CH]O[O](19634)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]CCC[C]=CO[O](21495)'],
    products = ['C[CH]CC[C]=CO[O](20929)'],
...
reaction(
    label = 'reaction34',
    reactants = ['C[CH]CC[C]=[C]OO(21497)'],
    products = ['C[CH]CC[C]=CO[O](20929)'],
...
reaction(
    label = 'reaction36',
    reactants = ['C[CH]CC[C]=CO[O](20929)'],
    products = ['C[CH][CH]CC=CO[O](21498)'],
...
reaction(
    label = 'reaction39',
    reactants = ['C[CH]CC[C]=CO[O](20929)'],
    products = ['C[CH]CC=[C][CH]OO(19636)'],
...
reaction(
    label = 'reaction40',
    reactants = ['C[CH][CH]C[C]=COO(21500)'],
    products = ['C[CH]CC[C]=CO[O](20929)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2][CH]CC[C]=COO(21501)'],
    products = ['C[CH]CC[C]=CO[O](20929)'],
...
network(
    label = 'PDepNetwork #4586',
    isomers = [
        'C[CH]CC[C]=CO[O](20929)',
    ],
    reactants = [
