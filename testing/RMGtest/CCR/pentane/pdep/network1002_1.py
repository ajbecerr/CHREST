species(
    ...
    E0 = (244.162,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,296.816,296.821,296.855,296.906,296.927,1365.54,1365.63,2973.45],'cm^-1')),
        HinderedRotor(inertia=(0.152991,'amu*angstrom^2'), symmetry=1, barrier=(9.57026,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00191446,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.1526,0.0451368,-6.66105e-05,5.96754e-08,-2.16398e-11,29428.1,18.3868], Tmin=(100,'K'), Tmax=(802.081,'K')), NASAPolynomial(coeffs=[5.15122,0.0228323,-1.11521e-05,2.15466e-09,-1.5002e-13,29183.5,6.05543], Tmin=(802.081,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(244.162,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)
...
species(
    label = '[C-]=[O+][O+]=[C-]C(3703)',
    structure = SMILES('[C-]=[O+][O+]=[C-]C'),
    E0 = (556.786,'kJ/mol'),
    modes = [
...
species(
    label = '[C-]=[O+]OC[CH](3704)',
    structure = SMILES('[C-]=[O+]OC[CH]'),
    E0 = (582.036,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87245,0.0608822,-0.000127384,1.35181e-07,-5.20135e-11,70065.8,19.835], Tmin=(100,'K'), Tmax=(861.208,'K')), NASAPolynomial(coeffs=[0.620064,0.0321687,-1.72295e-05,3.35258e-09,-2.30123e-13,71562,33.1244], Tmin=(861.208,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(582.036,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsCs) + group(Cs-CsOsHH) + group(CsJ2_singlet-CsH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = 'C=C[C-][O+]=O(3705)',
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.80733,0.0325593,-5.39707e-05,5.8306e-08,-2.38443e-11,42852.9,13.7186], Tmin=(100,'K'), Tmax=(827.695,'K')), NASAPolynomial(coeffs=[1.14768,0.0251509,-1.25831e-05,2.44874e-09,-1.70511e-13,43656.2,24.6042], Tmin=(827.695,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(355.994,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + missing(O2d-O4dc) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH) + group(Cds-CdsHH)"""),
)

species(
    label = '[C-]=[O+]CC=O(3706)',
    structure = SMILES('[C-]=[O+]CC=O'),
    E0 = (172.111,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.01818,0.0277309,-1.94657e-05,6.12275e-09,-7.85301e-13,20729.4,-5.23375], Tmin=(100,'K'), Tmax=(1652.25,'K')), NASAPolynomial(coeffs=[7.92464,0.0158526,-8.68196e-06,1.7716e-09,-1.26932e-13,19108,-31.3683], Tmin=(1652.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.111,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsCs) + group(Cds-OdCsH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[C-]=[O+]OC=C(3674)'],
    products = ['CO(2039)', 'CH3CHO(1381)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(3.29914e+17,'s^-1'), n=-1.73308, Ea=(19.3323,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.16692063000437535, var=8.814681701569807, Tref=1000.0, N=65, correlation='Root',), comment="""BM rule fitted to 2 training reactions at node Root
...
reaction(
    label = 'reaction2',
    reactants = ['[C-]=[O+]OC=C(3674)'],
    products = ['[C-][O+]=O(3702)', 'C2H2(1342)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(6.59828e+17,'s^-1'), n=-1.73308, Ea=(349.949,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.16692063000437535, var=8.814681701569807, Tref=1000.0, N=65, correlation='Root',), comment="""BM rule fitted to 2 training reactions at node Root
    Total Standard Deviation in ln(k): 6.371362717619001
Exact match found for rate rule [Root]
Euclidian distance = 0
...
reaction(
    label = 'reaction3',
    reactants = ['[C-]=[O+][O+]=[C-]C(3703)'],
    products = ['[C-]=[O+]OC=C(3674)'],
    transitionState = 'TS3',
