...
species(
    label = '[CH2]C(C=[C]C[O])CC(19668)',
    structure = SMILES('[CH2]C(C=[C]C[O])CC'),
    E0 = (407.414,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46792,0.0659656,-1.05755e-05,-8.89138e-08,8.80906e-11,49081.2,32.282], Tmin=(100,'K'), Tmax=(477.083,'K')), NASAPolynomial(coeffs=[5.07321,0.0528935,-2.34145e-05,4.40066e-09,-3.04962e-13,48542,15.5106], Tmin=(477.083,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCOJ) + radical(Isobutyl) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]C(C=[C]CO[O])CC(19669)',
    structure = SMILES('[CH]C(C=[C]CO[O])CC'),
    E0 = (648.351,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0444432,0.0946494,-0.000103436,6.74733e-08,-1.86667e-11,78119.3,37.4165], Tmin=(100,'K'), Tmax=(862.275,'K')), NASAPolynomial(coeffs=[10.1174,0.0475093,-2.14313e-05,4.07043e-09,-2.84107e-13,76366.8,-10.1026], Tmin=(862.275,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(648.351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2]C(C=C1COO1)CC(19670)',
    structure = SMILES('[CH2]C(C=C1COO1)CC'),
    E0 = (181.744,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.346409,0.0649773,-2.6224e-06,-3.76842e-08,1.74358e-11,22003.7,36.0355], Tmin=(100,'K'), Tmax=(1029.52,'K')), NASAPolynomial(coeffs=[15.4383,0.0402565,-1.60197e-05,2.9903e-09,-2.11744e-13,17098.8,-45.9423], Tmin=(1029.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(181.744,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclobutane) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C=C1CO1)CC(19672)',
    structure = SMILES('[CH2]C(C=C1CO1)CC'),
    E0 = (115.164,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.27619,0.0637218,4.66386e-06,-5.90875e-08,2.9767e-11,14001.7,29.5817], Tmin=(100,'K'), Tmax=(938.805,'K')), NASAPolynomial(coeffs=[19.9495,0.025556,-7.3054e-06,1.21533e-09,-8.63246e-14,8295.84,-74.8041], Tmin=(938.805,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(115.164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(methyleneoxirane) + radical(Isobutyl)"""),
)

species(
    label = 'C=C(C=CCO[O])CC(19673)',
    structure = SMILES('C=C(C=CCO[O])CC'),
    E0 = (68.0334,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
...
species(
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.125893,0.0866535,-8.102e-05,4.02435e-08,-6.15087e-12,39367.7,36.5307], Tmin=(100,'K'), Tmax=(771.664,'K')), NASAPolynomial(coeffs=[11.0689,0.0413612,-1.52009e-05,2.57882e-09,-1.68296e-13,37338.5,-15.6321], Tmin=(771.664,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(326.171,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CtOsHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(ROOJ) + radical(Isobutyl)"""),
)
...
species(
    label = 'CC[C](C)C=[C]CO[O](19681)',
    structure = SMILES('CC[C](C)C=[C]CO[O]'),
    E0 = (332.117,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3010,987.5,1337.5,450,1655,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.333415,0.085646,-7.65616e-05,4.25545e-08,-1.0537e-11,40072.2,33.3087], Tmin=(100,'K'), Tmax=(933.236,'K')), NASAPolynomial(coeffs=[8.09575,0.052375,-2.30843e-05,4.352e-09,-3.03071e-13,38623.4,-3.60366], Tmin=(933.236,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.117,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Allyl_T) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.187236,0.0905183,-9.59069e-05,6.70736e-08,-2.08959e-11,47600,38.137], Tmin=(100,'K'), Tmax=(756.891,'K')), NASAPolynomial(coeffs=[6.932,0.0548714,-2.52576e-05,4.84194e-09,-3.39523e-13,46579.1,7.47649], Tmin=(756.891,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(394.678,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Cs_S) + radical(Cds_S)"""),
)

species(
    label = 'CCC(C)[C]=[C]CO[O](19685)',
    structure = SMILES('CCC(C)[C]=[C]CO[O]'),
    E0 = (437.978,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.317027,0.090814,-8.13927e-05,2.32331e-08,1.24956e-11,52799.9,35.6624], Tmin=(100,'K'), Tmax=(572.122,'K')), NASAPolynomial(coeffs=[7.92369,0.0533277,-2.4262e-05,4.61342e-09,-3.21641e-13,51672.6,0.967221], Tmin=(572.122,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(437.978,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C](C=CCO[O])CC(19686)',
    structure = SMILES('[CH2]C(=C[CH]CO[O])CC'),
    E0 = (217.85,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.489399,0.0980382,-8.80355e-05,4.24604e-08,-8.44817e-12,26363.5,33.3732], Tmin=(100,'K'), Tmax=(1187.2,'K')), NASAPolynomial(coeffs=[15.8108,0.0431187,-1.86463e-05,3.49535e-09,-2.42966e-13,22493.2,-48.0628], Tmin=(1187.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(217.85,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(ROOJ) + radical(C=CCJCO) + radical(Allyl_P)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.095699,0.0917056,-9.20746e-05,5.68927e-08,-1.53015e-11,48891.8,37.6978], Tmin=(100,'K'), Tmax=(875.108,'K')), NASAPolynomial(coeffs=[8.88979,0.0515102,-2.31787e-05,4.40857e-09,-3.08316e-13,47352.6,-3.55559], Tmin=(875.108,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(405.382,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(RCCJ) + radical(Cds_S)"""),
)

species(
    label = '[CH2]CC([CH2])C=CCO[O](19688)',
    structure = SMILES('[CH2]CC([CH2])C=CCO[O]'),
    E0 = (372.623,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.034509,0.0902404,-8.53961e-05,4.8022e-08,-1.15271e-11,44956.4,39.2164], Tmin=(100,'K'), Tmax=(982.898,'K')), NASAPolynomial(coeffs=[10.5549,0.0474265,-2.00578e-05,3.70516e-09,-2.55063e-13,42888.3,-11.3569], Tmin=(982.898,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(372.623,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C([C]=[C]COO)CC(19689)',
    structure = SMILES('[CH2]C([C]=[C]COO)CC'),
    E0 = (491.055,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.418457,0.103301,-0.000123349,8.98086e-08,-2.75155e-11,59213.8,39.2449], Tmin=(100,'K'), Tmax=(786.224,'K')), NASAPolynomial(coeffs=[9.98125,0.0503871,-2.23867e-05,4.19182e-09,-2.89026e-13,57578.6,-8.42548], Tmin=(786.224,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(491.055,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Cds_S) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00581553,0.0920601,-8.84747e-05,5.12126e-08,-1.27479e-11,46469.1,36.2392], Tmin=(100,'K'), Tmax=(946.647,'K')), NASAPolynomial(coeffs=[10.0117,0.0497327,-2.14068e-05,3.98188e-09,-2.75033e-13,44572.4,-11.5406], Tmin=(946.647,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(385.194,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_T) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C([CH]C)C=[C]COO(19692)',
    structure = SMILES('[CH2]C([CH]C)C=[C]COO'),
    E0 = (447.756,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.084317,0.0960816,-0.000104568,7.10271e-08,-2.08302e-11,53994,40.1349], Tmin=(100,'K'), Tmax=(810.756,'K')), NASAPolynomial(coeffs=[8.7816,0.0523411,-2.36442e-05,4.48679e-09,-3.12716e-13,52556.4,-0.77828], Tmin=(810.756,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(447.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_S) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = '[CH2]CC([CH2])C=[C]COO(19693)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.227169,0.0979287,-0.000103327,6.46952e-08,-1.71418e-11,55287.9,39.8763], Tmin=(100,'K'), Tmax=(899.361,'K')), NASAPolynomial(coeffs=[10.8036,0.0488673,-2.1499e-05,4.03758e-09,-2.80183e-13,53303.8,-12.1707], Tmin=(899.361,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(458.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(RCCJ) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]C(C)C=[C]CO[O](19248)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(C=[C]CO[O])CC(19262)'],
    products = ['O2(S)(666)', '[CH2]C(C=C=C)CC(15661)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction6',
    reactants = ['O(4)', '[CH2]C(C=[C]C[O])CC(19668)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(T)(20)', 'CC[CH]C=[C]CO[O](19581)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]O[O](46)', '[C]=CC([CH2])CC(15096)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH]C(C=[C]CO[O])CC(19669)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C(C=[C]CO[O])CC(19262)'],
    products = ['[CH2]C(C=C1COO1)CC(19670)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(C=[C]CO[O])CC(19262)'],
    products = ['O(4)', '[CH2]C(C=C1CO1)CC(19672)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', 'C=C(C=[C]CO[O])CC(19675)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2]C(C#CCO[O])CC(19676)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C2H5(14)', 'C=CC=[C]CO[O](19303)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O2(2)', '[CH2]C(C=C=C)CC(15661)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O2(2)', '[CH2]C([CH][C]=C)CC(15663)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C2H5(14)', '[CH2][CH]C=[C]CO[O](19552)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2][C](C=[C]CO[O])CC(19677)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH3(17)', '[CH2]C([CH2])C=[C]CO[O](19279)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH2]C([CH]C)C=[C]CO[O](19358)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', '[CH2]CC([CH2])C=[C]CO[O](19678)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', '[CH2]C([C]=[C]CO[O])CC(19680)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CC[C](C)C=[C]CO[O](19681)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C([C]=CCO[O])CC(19683)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C(C=[C]CO[O])CC(19262)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
...
reaction(
    label = 'reaction37',
    reactants = ['CCC(C)[C]=[C]CO[O](19685)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH2]C(C=[C]CO[O])CC(19262)'],
    products = ['[CH2][C](C=CCO[O])CC(19686)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]C(C=[C]CO[O])CC(19262)'],
    products = ['[CH2]C([CH]C)C=CCO[O](4797)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]CC(C)C=[C]CO[O](19687)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2]C(C=[C]CO[O])CC(19262)'],
    products = ['[CH2]CC([CH2])C=CCO[O](19688)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2]C([C]=[C]COO)CC(19689)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH2]C(C=[C]CO[O])CC(19262)'],
    products = ['[CH2][C](C=[C]COO)CC(19691)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2]C([CH]C)C=[C]COO(19692)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2]CC([CH2])C=[C]COO(19693)'],
    products = ['[CH2]C(C=[C]CO[O])CC(19262)'],
