...
species(
    label = '[CH2]CC[C]([O])[C][O](26260)',
    structure = SMILES('[CH2]CC[C]([O])[C][O]'),
    E0 = (798.546,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.458345,0.0886504,-0.000151242,1.39352e-07,-4.94517e-11,96160.1,30.2321], Tmin=(100,'K'), Tmax=(847.217,'K')), NASAPolynomial(coeffs=[7.07571,0.0352866,-1.75955e-05,3.36874e-09,-2.30928e-13,95832.7,4.08963], Tmin=(847.217,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(798.546,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCOJ) + radical(C2CsJOH) + radical(RCCJ) + radical(CH2_triplet)"""),
)
...
species(
    label = '[CH2]C[CH][C]([O])[CH][O](26262)',
    structure = SMILES('[CH2]C[CH][C]([O])[CH][O]'),
    E0 = (717.758,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,360,370,350,3000,3100,440,815,1455,1000,202.166,815.751,1087.67,1377.12,1684.41],'cm^-1')),
        HinderedRotor(inertia=(0.146064,'amu*angstrom^2'), symmetry=1, barrier=(3.44748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146064,'amu*angstrom^2'), symmetry=1, barrier=(3.44748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146064,'amu*angstrom^2'), symmetry=1, barrier=(3.44748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146064,'amu*angstrom^2'), symmetry=1, barrier=(3.44748,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.600522,0.0861738,-0.000148425,1.38474e-07,-4.93016e-11,86437.8,33.0358], Tmin=(100,'K'), Tmax=(860.983,'K')), NASAPolynomial(coeffs=[5.95182,0.0362058,-1.76304e-05,3.33013e-09,-2.2603e-13,86446.9,13.424], Tmin=(860.983,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(717.758,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCOJ) + radical(CCJCO) + radical(C2CsJOH) + radical(RCCJ) + radical(CCsJOH)"""),
)
...
species(
    label = '[CH2]C[CH]C([O])[CH][O](26264)',
    structure = SMILES('[CH2]C[CH]C([O])[CH][O]'),
    E0 = (541.13,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.803775,0.0768395,-0.000109208,9.34309e-08,-3.25439e-11,65191.7,32.8836], Tmin=(100,'K'), Tmax=(807.307,'K')), NASAPolynomial(coeffs=[7.05387,0.0366099,-1.72511e-05,3.28267e-09,-2.26743e-13,64484.4,5.93772], Tmin=(807.307,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(541.13,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCOJ) + radical(CCJCO) + radical(RCCJ) + radical(CCsJOH)"""),
)
...
species(
    label = '[CH2][CH]CC([O])[CH][O](26266)',
    structure = SMILES('[CH2][CH]CC([O])[CH][O]'),
    E0 = (535.674,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,248.698,833.592,1147.98,1495.66,1860.2],'cm^-1')),
        HinderedRotor(inertia=(0.0927376,'amu*angstrom^2'), symmetry=1, barrier=(3.29699,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0927376,'amu*angstrom^2'), symmetry=1, barrier=(3.29699,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0927376,'amu*angstrom^2'), symmetry=1, barrier=(3.29699,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0927376,'amu*angstrom^2'), symmetry=1, barrier=(3.29699,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.805363,0.0823182,-0.000137604,1.32063e-07,-4.84331e-11,64530.2,33.1151], Tmin=(100,'K'), Tmax=(859.017,'K')), NASAPolynomial(coeffs=[3.38136,0.0427875,-2.04938e-05,3.86054e-09,-2.62297e-13,65103.6,26.9922], Tmin=(859.017,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(535.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCOJ) + radical(RCCJC) + radical(CCsJOH) + radical(RCCJ)"""),
)

species(
    label = 'CC[CH][C]([O])[CH][O](26267)',
    structure = SMILES('CC[CH][C]([O])[CH][O]'),
    E0 = (512.512,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.575168,0.0852994,-0.000137489,1.25637e-07,-4.46521e-11,61754.6,31.3405], Tmin=(100,'K'), Tmax=(849.062,'K')), NASAPolynomial(coeffs=[6.09481,0.0386112,-1.84643e-05,3.48848e-09,-2.37962e-13,61562.9,10.0052], Tmin=(849.062,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(512.512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCOJ) + radical(CCJCO) + radical(C2CsJOH) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C[CH][C](O)[CH][O](26268)',
    structure = SMILES('[CH2]C[CH][C](O)[CH][O]'),
    E0 = (487.397,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.440042,0.0901341,-0.000154177,1.43236e-07,-5.07479e-11,58737.2,33.804], Tmin=(100,'K'), Tmax=(865.678,'K')), NASAPolynomial(coeffs=[6.03767,0.037963,-1.81954e-05,3.41266e-09,-2.30602e-13,58753.7,13.2993], Tmin=(865.678,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(487.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO) + radical(C2CsJOH) + radical(RCCJ) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C[CH][C]([O])C[O](26269)',
    structure = SMILES('[CH2]C[CH][C]([O])C[O]'),
    E0 = (537.46,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,360,370,350,3000,3100,440,815,1455,1000,245.242,832.97,1142.98,1484.14,1740.67],'cm^-1')),
        HinderedRotor(inertia=(0.121815,'amu*angstrom^2'), symmetry=1, barrier=(3.31491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121815,'amu*angstrom^2'), symmetry=1, barrier=(3.31491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121815,'amu*angstrom^2'), symmetry=1, barrier=(3.31491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121815,'amu*angstrom^2'), symmetry=1, barrier=(3.31491,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.863197,0.0775221,-0.000117613,1.06921e-07,-3.85827e-11,64746.2,32.5437], Tmin=(100,'K'), Tmax=(830.931,'K')), NASAPolynomial(coeffs=[5.32487,0.0394195,-1.88195e-05,3.5791e-09,-2.46143e-13,64578.7,15.2985], Tmin=(830.931,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(537.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CC(C)OJ) + radical(CCJCO) + radical(C2CsJOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]C[C](O)[CH][O](26270)',
    structure = SMILES('[CH2][CH]C[C](O)[CH][O]'),
    E0 = (481.941,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.47789,0.0951664,-0.000180945,1.79724e-07,-6.57431e-11,58074.1,33.9068], Tmin=(100,'K'), Tmax=(881.666,'K')), NASAPolynomial(coeffs=[2.20128,0.04443,-2.16095e-05,4.03184e-09,-2.69633e-13,59438.3,35.2692], Tmin=(881.666,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(481.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOH) + radical(RCCJC) + radical(CCsJOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]C[C]([O])C[O](26271)',
    structure = SMILES('[CH2][CH]C[C]([O])C[O]'),
    E0 = (532.004,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,215.544,285.809,407.434,1785.96,3318.95],'cm^-1')),
        HinderedRotor(inertia=(0.0104278,'amu*angstrom^2'), symmetry=1, barrier=(0.985358,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0104278,'amu*angstrom^2'), symmetry=1, barrier=(0.985358,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0104278,'amu*angstrom^2'), symmetry=1, barrier=(0.985358,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0104278,'amu*angstrom^2'), symmetry=1, barrier=(0.985358,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.884304,0.0827552,-0.000145083,1.44271e-07,-5.38996e-11,64083.9,32.7062], Tmin=(100,'K'), Tmax=(864.269,'K')), NASAPolynomial(coeffs=[1.58059,0.0457249,-2.21383e-05,4.1754e-09,-2.83252e-13,65226.2,36.7533], Tmin=(864.269,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(532.004,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C[CH][C]([O])[CH]O(26272)',
    structure = SMILES('[CH2]C[CH][C]([O])[CH]O'),
    E0 = (492.053,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.265036,0.088581,-0.000134818,1.11474e-07,-3.62694e-11,59308.6,33.381], Tmin=(100,'K'), Tmax=(852.011,'K')), NASAPolynomial(coeffs=[10.5985,0.0298676,-1.34921e-05,2.48994e-09,-1.67835e-13,57918,-12.6441], Tmin=(852.011,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(492.053,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO) + radical(C2CsJOH) + radical(RCCJ) + radical(CCsJOH)"""),
)

species(
    label = '[CH2][CH]C[C]([O])[CH]O(26273)',
    structure = SMILES('[CH2][CH]C[C]([O])[CH]O'),
    E0 = (486.597,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.289078,0.0937881,-0.000162255,1.48915e-07,-5.1711e-11,58646.1,33.5325], Tmin=(100,'K'), Tmax=(882.343,'K')), NASAPolynomial(coeffs=[6.8019,0.036264,-1.68643e-05,3.09901e-09,-2.06013e-13,58586.7,9.10333], Tmin=(882.343,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(486.597,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(RCCJC) + radical(CCsJOH) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC[C]([O])[CH][O](25256)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[O][C][CH][O](10223)', '[CH2]C[CH2](29)'],
    products = ['[CH2]CC[C]([O])[CH][O](25256)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]CC[C]([O])[CH][O](26259)'],
    products = ['[CH2]CC[C]([O])[CH][O](25256)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH2]CC[C]([O])[C][O](26260)'],
    products = ['[CH2]CC[C]([O])[CH][O](25256)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CC[C]([O])[CH][O](25256)'],
    products = ['[CH2][CH]CC([O])C=O(11582)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2]C[CH]C([O])=C[O](12344)'],
    products = ['[CH2]CC[C]([O])[CH][O](25256)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(3.01e+08,'cm^3/(mol*s)'), n=1.6, Ea=(90.7568,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 10 used for Cds-CsH_Cds-HH;HJ
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.270985,'m^3/(mol*s)'), n=1.98996, Ea=(178.753,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_R;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 175.5 to 178.8 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]C[CH][C]([O])[CH][O](26262)'],
    products = ['[CH2]CC[C]([O])[CH][O](25256)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2][CH]C[C]([O])[CH][O](26263)'],
    products = ['[CH2]CC[C]([O])[CH][O](25256)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C[CH]C([O])[CH][O](26264)'],
    products = ['[CH2]CC[C]([O])[CH][O](25256)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CC[C]([O])[CH][O](25256)'],
    products = ['C[CH]C[C]([O])[CH][O](26265)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][CH]CC([O])[CH][O](26266)'],
    products = ['[CH2]CC[C]([O])[CH][O](25256)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]CC[C]([O])[CH][O](25256)'],
    products = ['[CH2]C[CH][C](O)[CH][O](26268)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C[CH][C]([O])C[O](26269)'],
    products = ['[CH2]CC[C]([O])[CH][O](25256)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]CC[C]([O])[CH][O](25256)'],
    products = ['[CH2][CH]C[C](O)[CH][O](26270)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2][CH]C[C]([O])C[O](26271)'],
    products = ['[CH2]CC[C]([O])[CH][O](25256)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]CC[C]([O])[CH][O](25256)'],
    products = ['[CH2]C[CH][C]([O])[CH]O(26272)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]CC[C]([O])[CH][O](25256)'],
    products = ['[CH2][CH]C[C]([O])[CH]O(26273)'],
...
network(
    label = 'PDepNetwork #5848',
    isomers = [
        '[CH2]CC[C]([O])[CH][O](25256)',
    ],
    reactants = [
