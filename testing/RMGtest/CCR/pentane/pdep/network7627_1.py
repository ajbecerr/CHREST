...
species(
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.42883,-0.00147551,8.0944e-05,-1.04599e-07,4.09823e-11,-35622.8,13.5565], Tmin=(100,'K'), Tmax=(906.771,'K')), NASAPolynomial(coeffs=[8.45826,0.0124495,-1.82675e-06,1.72834e-10,-1.21843e-14,-38019.5,-18.4015], Tmin=(906.771,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-296.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsOs) + ring(Beta-Propiolactone)"""),
)

species(
    label = '[CH2]O[C]1CO1(29081)',
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78194,0.0386965,-3.57682e-05,1.82024e-08,-3.48776e-12,17723.4,19.4833], Tmin=(100,'K'), Tmax=(1549.83,'K')), NASAPolynomial(coeffs=[8.98794,0.0117339,-1.57712e-06,1.2688e-11,8.11269e-15,16494.4,-15.1978], Tmin=(1549.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(146.625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + ring(Ethylene_oxide) + radical(Cs_P) + radical(CsJOCH3)"""),
)

species(
    label = '[CH2][C]1OCO1(29082)',
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.37337,0.0109069,8.26219e-05,-1.30602e-07,5.48597e-11,16629.3,16.9286], Tmin=(100,'K'), Tmax=(929.229,'K')), NASAPolynomial(coeffs=[20.9198,-0.00499413,5.08396e-06,-9.2915e-10,5.16116e-14,10422.3,-86.0385], Tmin=(929.229,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(137.586,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + ring(Cyclobutane) + radical(Cs_P) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16769,0.00267304,0.000136596,-2.09866e-07,8.93456e-11,-17981.9,10.2769], Tmin=(100,'K'), Tmax=(911.517,'K')), NASAPolynomial(coeffs=[30.0843,-0.0216823,1.51579e-05,-2.91821e-09,1.86895e-13,-27148.7,-144.185], Tmin=(911.517,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-150.351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-OsOsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)

species(
    label = '[O][C]1CCO1(29083)',
...
species(
    label = '[CH]=C(O)O[CH2](29084)',
    structure = SMILES('[CH]=C(O)O[CH2]'),
    E0 = (134.008,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,350,440,435,1725,3000,3100,440,815,1455,1000,3120,650,792.5,1650,304.697],'cm^-1')),
        HinderedRotor(inertia=(0.245524,'amu*angstrom^2'), symmetry=1, barrier=(16.2514,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.24594,'amu*angstrom^2'), symmetry=1, barrier=(16.2503,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.245925,'amu*angstrom^2'), symmetry=1, barrier=(16.2511,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10852,0.0526202,-6.00727e-05,3.19164e-08,-6.27143e-12,16230.9,19.9073], Tmin=(100,'K'), Tmax=(1428.8,'K')), NASAPolynomial(coeffs=[16.3117,0.00234408,8.07286e-07,-2.6838e-10,2.11705e-14,12673.9,-56.1088], Tmin=(1428.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.008,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-OsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(C=COCJ) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(20)', 'C=C([O])[O](2321)'],
    products = ['[CH2]OC(=C)[O](28837)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(20)', '[CH2]O[C]=O(13489)'],
    products = ['[CH2]OC(=C)[O](28837)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]OC([CH2])=O(3375)'],
    products = ['[CH2]OC(=C)[O](28837)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
