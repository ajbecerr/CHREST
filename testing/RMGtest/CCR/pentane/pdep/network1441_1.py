...
species(
    label = '[CH2]C([CH]C1CC1)CC(6307)',
    structure = SMILES('[CH2]C([CH]C1CC1)CC'),
    E0 = (311.407,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.363421,0.0644559,5.71245e-06,-4.68508e-08,2.09133e-11,37598.2,34.9669], Tmin=(100,'K'), Tmax=(1005.07,'K')), NASAPolynomial(coeffs=[14.3907,0.044035,-1.665e-05,3.03078e-09,-2.12116e-13,32990.3,-41.6734], Tmin=(1005.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(311.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.434728,0.059409,2.48317e-05,-7.22662e-08,3.1423e-11,67174.7,32.0734], Tmin=(100,'K'), Tmax=(973.625,'K')), NASAPolynomial(coeffs=[16.6156,0.0387171,-1.38279e-05,2.50443e-09,-1.77923e-13,61853.8,-56.702], Tmin=(973.625,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(557.314,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(CC)C1[CH]CC1(6310)',
    structure = SMILES('[CH]C(CC)C1[CH]CC1'),
    E0 = (540.07,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.563403,0.0584808,1.86894e-05,-5.82275e-08,2.41315e-11,65094,33.2785], Tmin=(100,'K'), Tmax=(1020.71,'K')), NASAPolynomial(coeffs=[14.5406,0.0433061,-1.72049e-05,3.22573e-09,-2.29544e-13,60177.8,-44.545], Tmin=(1020.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(540.07,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'C=C(CC)C1CCC1(6313)',
    structure = SMILES('C=C(CC)C1CCC1'),
    E0 = (24.4224,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.672224,0.0501263,5.73158e-05,-1.04933e-07,4.21216e-11,3077.7,29.5034], Tmin=(100,'K'), Tmax=(982.242,'K')), NASAPolynomial(coeffs=[16.7214,0.0412229,-1.52989e-05,2.86514e-09,-2.08007e-13,-2798.45,-61.4996], Tmin=(982.242,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.4224,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(519.654,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)
...
species(
    label = '[CH2]CC=CC([CH2])CC(6314)',
    structure = SMILES('[CH2]CC=CC([CH2])CC'),
    E0 = (279.603,'kJ/mol'),
    modes = [
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.513521,0.0644004,-4.30174e-06,-2.83548e-08,1.2455e-11,35558.6,33.0244], Tmin=(100,'K'), Tmax=(1069.23,'K')), NASAPolynomial(coeffs=[11.3075,0.0496401,-1.95363e-05,3.55335e-09,-2.45087e-13,31785.9,-26.6212], Tmin=(1069.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(294.521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(CC)C1C[CH]C1(6324)',
    structure = SMILES('[CH2]C(CC)C1C[CH]C1'),
    E0 = (296.937,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.513521,0.0644004,-4.30174e-06,-2.83548e-08,1.2455e-11,35558.6,33.0244], Tmin=(100,'K'), Tmax=(1069.23,'K')), NASAPolynomial(coeffs=[11.3075,0.0496401,-1.95363e-05,3.55335e-09,-2.45087e-13,31785.9,-26.6212], Tmin=(1069.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(294.521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]CC([CH2])C1CCC1(6331)',
    structure = SMILES('[CH2]CC([CH2])C1CCC1'),
    E0 = (314.345,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.520578,0.0571278,3.37756e-05,-7.95742e-08,3.33336e-11,37949.5,33.6466], Tmin=(100,'K'), Tmax=(978.535,'K')), NASAPolynomial(coeffs=[15.5718,0.0424025,-1.53921e-05,2.79907e-09,-1.98512e-13,32763.3,-50.089], Tmin=(978.535,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(314.345,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]C(C)C1[CH]CC1(4986)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C([CH]C1CC1)CC(6307)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(CC)C1[CH]CC1(5084)'],
    products = ['CCC[CH]C1[CH]CC1(6308)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(6.55606e+10,'s^-1'), n=0.64, Ea=(159.935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [cCs(-HC)CJ;CsJ;C] for rate rule [cCs(-HC)CJ;CsJ-HH;C]
Euclidian distance = 1.0
family: 1,2_shiftC"""),
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(CC)C1CC1[CH2](5086)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(6.55606e+10,'s^-1'), n=0.64, Ea=(159.935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [cCs(-HC)CJ;CsJ;C] for rate rule [cCs(-HC)CJ;CsJ-HH;C]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(T)(20)', 'CC[CH]C1[CH]CC1(6265)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH2]C(CC)C1[C]CC1(6309)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH]C(CC)C1[CH]CC1(6310)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(C=C)C([CH2])CC(3850)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC=CC([CH2])CC(6314)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]C(CC)C1=CCC1(6315)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C=C(CC)C1[CH]CC1(6316)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2]C(CC)C1C=CC1(6238)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C2H5(14)', 'C=CC1[CH]CC1(6206)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH2]C(CC)[C]1[CH]CC1(6317)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C2H5(14)', '[CH2][CH]C1[CH]CC1(6257)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2][C](CC)C1[CH]CC1(6318)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2]C(CC)C1[CH]C[CH]1(6319)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH3(17)', '[CH2]C([CH2])C1[CH]CC1(5206)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', '[CH2]C(CC)C1[CH][CH]C1(6320)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', '[CH2]CC([CH2])C1[CH]CC1(6321)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C(CC)C1[CH]CC1(5084)'],
    products = ['[CH2]C(CC)[C]1CCC1(6322)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C(CC)C1C[CH]C1(6324)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]CC(C)C1[CH]CC1(6329)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2]CC([CH2])C1CCC1(6331)'],
    products = ['[CH2]C(CC)C1[CH]CC1(5084)'],
