species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.24651,0.0434754,-4.27681e-05,1.75412e-08,2.3237e-12,65322.3,26.6208], Tmin=(100,'K'), Tmax=(567.429,'K')), NASAPolynomial(coeffs=[5.79377,0.0251761,-1.21227e-05,2.36572e-09,-1.67388e-13,64811.7,10.5659], Tmin=(567.429,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(542.634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H2CC(T)(1341)', 'C=[C]O[O](1354)'],
    products = ['C=[C]OO[C]=C(2345)'],
    transitionState = 'TS2',
...
reaction(
    ...
    products = ['C=[C]OO[C]=C(2345)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(3.08478e+06,'m^3/(mol*s)'), n=-1.87134e-07, Ea=(220.773,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=1.52051667475e-07, var=0.241111252513, Tref=1000.0, N=4, correlation='Root_N-1R->H_N-1CNOS->N_1COS->O_Ext-1O-R_Ext-2R-R_Ext-2R-R_N-4R!H->O',), comment="""BM rule fitted to 2 training reactions at node Root_N-1R->H_N-1CNOS->N_1COS->O_Ext-1O-R_Ext-2R-R_Ext-2R-R_N-4R!H->O
    Total Standard Deviation in ln(k): 0.984387063055
Exact match found for rate rule [Root_N-1R->H_N-1CNOS->N_1COS->O_Ext-1O-R_Ext-2R-R_Ext-2R-R_N-4R!H->O]
Euclidian distance = 0
family: R_Recombination
Ea raised from 215.6 to 220.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]=[C]OO[C]=C(2665)'],
    products = ['C=[C]OO[C]=C(2345)'],
    transitionState = 'TS6',
