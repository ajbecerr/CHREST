...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.649983,0.0765696,-9.29917e-05,6.19923e-08,-1.66998e-11,65438.8,25.2486], Tmin=(100,'K'), Tmax=(902.817,'K')), NASAPolynomial(coeffs=[11.6401,0.0278751,-1.20844e-05,2.24566e-09,-1.54628e-13,63454.5,-26.6484], Tmin=(902.817,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(543.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CJCO) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][C]OC[CH]C(1660)',
    structure = SMILES('[CH2][C]OC[CH]C'),
    E0 = (575.326,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09184,0.0659897,-6.6536e-05,3.67604e-08,-8.38893e-12,69298.8,25.5387], Tmin=(100,'K'), Tmax=(1044.18,'K')), NASAPolynomial(coeffs=[10.8614,0.0285653,-1.27751e-05,2.43653e-09,-1.71121e-13,67258.6,-22.0162], Tmin=(1044.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(575.326,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CJCO) + radical(CH2_triplet)"""),
)
...
species(
    label = '[CH2]COC=CC(1662)',
    structure = SMILES('[CH2]COC=CC'),
    E0 = (-9.94348,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.723906,0.0587281,-1.86991e-05,-2.5907e-08,1.65618e-11,-1065.84,22.8819], Tmin=(100,'K'), Tmax=(948.434,'K')), NASAPolynomial(coeffs=[18.2174,0.0175789,-5.22421e-06,8.95011e-10,-6.4457e-14,-5851.65,-68.3243], Tmin=(948.434,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-9.94348,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CJCO)"""),
)

species(
    label = '[CH2]COCC=C(1425)',
    structure = SMILES('[CH2]COCC=C'),
    E0 = (47.7751,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56989,0.0556622,-3.94379e-05,1.53514e-08,-2.61219e-12,5831.38,23.4412], Tmin=(100,'K'), Tmax=(1295.45,'K')), NASAPolynomial(coeffs=[8.37469,0.0346507,-1.51086e-05,2.83092e-09,-1.95938e-13,4068.33,-11.1495], Tmin=(1295.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(47.7751,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]CO[CH][CH]C(1666)',
    structure = SMILES('[CH2]CO[CH][CH]C'),
    E0 = (294.794,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH]CO[CH][CH2](1567)'],
    products = ['[CH2][CH]OC[CH]C(1418)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH2][CH]OC[C]C(1659)'],
    products = ['[CH2][CH]OC[CH]C(1418)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH2][C]OC[CH]C(1660)'],
    products = ['[CH2][CH]OC[CH]C(1418)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH][CH]OC[CH]C(1661)'],
    products = ['[CH2][CH]OC[CH]C(1418)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH2][CH]OC=CC(1663)'],
    products = ['[CH2][CH]OC[CH]C(1418)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2][CH]O[CH][CH]C(1664)'],
    products = ['[CH2][CH]OC[CH]C(1418)'],
