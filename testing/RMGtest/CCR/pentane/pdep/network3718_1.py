...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.19957,0.017744,-1.90147e-05,1.12682e-08,-2.71129e-12,70228.4,7.15416], Tmin=(100,'K'), Tmax=(1005.24,'K')), NASAPolynomial(coeffs=[5.93287,0.00686767,-2.78499e-06,5.0471e-10,-3.44008e-14,69678.9,-6.04669], Tmin=(1005.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(583.673,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), label="""HCCCH(S)""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
species(
    ...
    molecularWeight = (39.0559,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.60143,0.00142311,3.59457e-05,-4.70285e-08,1.79588e-11,60117.1,8.63985], Tmin=(100,'K'), Tmax=(948.31,'K')), NASAPolynomial(coeffs=[6.85785,0.00645842,-1.7102e-06,3.1686e-10,-2.5412e-14,58655.4,-11.3479], Tmin=(948.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(499.667,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(cyclopropenyl-vinyl)"""),
)
...
species(
    ...
    molecularWeight = (39.0559,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.472,0.0124964,-6.55615e-07,-1.07223e-08,8.00204e-12,61276.1,7.34838], Tmin=(100,'K'), Tmax=(596.292,'K')), NASAPolynomial(coeffs=[4.11418,0.0109709,-3.81716e-06,6.37475e-10,-4.13859e-14,61150.1,4.16745], Tmin=(596.292,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(509.327,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Acetyl)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', 'HC2(2881)'],
    products = ['C3H3(5450)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [Ct_rad;Birad]
