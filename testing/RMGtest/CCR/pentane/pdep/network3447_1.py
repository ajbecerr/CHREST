species(
    label = '[CH]=CC(C)[O](15048)',
    structure = SMILES('[CH]=CC(C)[O]'),
    E0 = (288.128,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,390.542],'cm^-1')),
        HinderedRotor(inertia=(0.127727,'amu*angstrom^2'), symmetry=1, barrier=(13.8304,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127291,'amu*angstrom^2'), symmetry=1, barrier=(13.8293,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03184,0.0344978,-3.16871e-06,-2.11748e-08,1.06304e-11,34732.5,20.621], Tmin=(100,'K'), Tmax=(995.244,'K')), NASAPolynomial(coeffs=[11.556,0.01635,-6.15763e-06,1.15107e-09,-8.30063e-14,31839.7,-30.291], Tmin=(995.244,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(288.128,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.56498,0.0288349,-6.59599e-06,-4.3019e-09,1.71655e-12,-15159.9,16.5833], Tmin=(100,'K'), Tmax=(1456.2,'K')), NASAPolynomial(coeffs=[8.25951,0.0228098,-1.0296e-05,1.92719e-09,-1.31458e-13,-17838.1,-16.5308], Tmin=(1456.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-126.494,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)HHH) + group(Cds-O2d(Cds-Cds)Cs) + group(Cd-Cd(CO)H) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    E0 = (264.029,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,354.171,354.179,354.232,354.268],'cm^-1')),
        HinderedRotor(inertia=(0.580072,'amu*angstrom^2'), symmetry=1, barrier=(51.6093,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.579476,'amu*angstrom^2'), symmetry=1, barrier=(51.6093,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
...
species(
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.65213,0.0426317,-9.45875e-06,-2.05972e-08,1.18485e-11,15273.9,18.5648], Tmin=(100,'K'), Tmax=(954.095,'K')), NASAPolynomial(coeffs=[12.4355,0.0190831,-6.48977e-06,1.12281e-09,-7.76709e-14,12230.4,-38.1183], Tmin=(954.095,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(126.224,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71123,0.0437539,-2.91207e-05,3.46813e-09,2.64649e-12,32484.3,22.5969], Tmin=(100,'K'), Tmax=(1001.07,'K')), NASAPolynomial(coeffs=[12.4187,0.0143872,-5.22238e-06,9.41526e-10,-6.60804e-14,29668.3,-32.4298], Tmin=(1001.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(269.357,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]C(C)O(15224)',
    structure = SMILES('[CH]=[C]C(C)O'),
    E0 = (295.609,'kJ/mol'),
    modes = [
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH]=CC[O](15221)'],
    products = ['[CH]=CC(C)[O](15048)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['C2H2(1342)', 'C[CH][O](1382)'],
    products = ['[CH]=CC(C)[O](15048)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(17)', '[CH]=C[CH][O](15182)'],
    products = ['[CH]=CC(C)[O](15048)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH]=C[C](C)[O](15188)'],
    products = ['[CH]=CC(C)[O](15048)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH]=CC([CH2])[O](13696)'],
    products = ['[CH]=CC(C)[O](15048)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH]=[C]C(C)[O](10403)'],
    products = ['[CH]=CC(C)[O](15048)'],
