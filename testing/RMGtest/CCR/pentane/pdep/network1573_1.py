...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.28884,0.0754734,-6.40387e-05,2.94679e-08,-5.52441e-12,61914,32.0863], Tmin=(100,'K'), Tmax=(1273.02,'K')), NASAPolynomial(coeffs=[14.4441,0.0309955,-1.16304e-05,2.02229e-09,-1.34538e-13,58310,-39.6218], Tmin=(1273.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(513.629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][CH]C[CH]CC(7080)',
    structure = SMILES('[CH][CH]C[CH]CC'),
    E0 = (645.255,'kJ/mol'),
    modes = [
...
species(
    label = '[CH]C([O])C[C]CC(7081)',
    structure = SMILES('[CH]C([O])C[C]CC'),
    E0 = (762.456,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.492598,0.075993,-6.94167e-05,3.39911e-08,-6.82629e-12,91829.5,29.7593], Tmin=(100,'K'), Tmax=(1182.29,'K')), NASAPolynomial(coeffs=[13.4861,0.0320324,-1.36429e-05,2.54156e-09,-1.76155e-13,88757.1,-35.1029], Tmin=(1182.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(762.456,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1CC(CC)O1(6895)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11998,0.0485156,2.30764e-05,-6.99681e-08,3.32303e-11,30819.4,24.1662], Tmin=(100,'K'), Tmax=(900.446,'K')), NASAPolynomial(coeffs=[15.0364,0.0264526,-6.39947e-06,8.89515e-10,-5.6551e-14,26701.4,-50.4632], Tmin=(900.446,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(255.269,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(O)C=CCC(7082)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.509225,0.0664429,-3.8103e-05,2.76063e-09,3.42941e-12,24214.9,31.5996], Tmin=(100,'K'), Tmax=(1068.36,'K')), NASAPolynomial(coeffs=[15.2668,0.0293659,-1.15655e-05,2.12529e-09,-1.48241e-13,20024.3,-45.4274], Tmin=(1068.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.621012,0.0707403,-5.5622e-05,2.33093e-08,-4.03766e-12,24108.8,29.619], Tmin=(100,'K'), Tmax=(1346.8,'K')), NASAPolynomial(coeffs=[13.3524,0.0329281,-1.35086e-05,2.4632e-09,-1.68096e-13,20679.4,-35.5932], Tmin=(1346.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(199.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([O])C=CCC(7083)',
    structure = SMILES('[CH]C([O])C=CCC'),
    E0 = (430.576,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.682954,0.0623236,-3.17773e-05,-2.78341e-09,5.23397e-12,51914.9,30.784], Tmin=(100,'K'), Tmax=(1057.19,'K')), NASAPolynomial(coeffs=[15.1222,0.0277047,-1.10542e-05,2.05518e-09,-1.44683e-13,47743.5,-44.9695], Tmin=(1057.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(430.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CC(C)OJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([O])CC=CC(6958)',
    structure = SMILES('[CH]C([O])CC=CC'),
    E0 = (429.778,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1000,1200,1400,1600],'cm^-1')),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.722704,0.0674338,-5.19541e-05,2.09328e-08,-3.46147e-12,51812,29.0641], Tmin=(100,'K'), Tmax=(1410.93,'K')), NASAPolynomial(coeffs=[13.8277,0.030281,-1.24558e-05,2.2697e-09,-1.5458e-13,48113.9,-38.671], Tmin=(1410.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(429.778,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CC(C)OJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.891624,0.0733482,-8.09737e-05,5.7982e-08,-1.81492e-11,85975.2,32.7827], Tmin=(100,'K'), Tmax=(759.486,'K')), NASAPolynomial(coeffs=[6.84447,0.0419935,-1.90425e-05,3.61506e-09,-2.51758e-13,85071,5.70187], Tmin=(759.486,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(713.946,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJCC) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.947794,0.0706286,-6.01287e-05,3.05182e-08,-6.8197e-12,61287.9,30.9644], Tmin=(100,'K'), Tmax=(1028.09,'K')), NASAPolynomial(coeffs=[8.29779,0.0420324,-1.84071e-05,3.46425e-09,-2.41124e-13,59776.6,-4.69886], Tmin=(1028.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(508.687,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJC) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C](O)C[CH]CC(7088)',
    structure = SMILES('[CH][C](O)C[CH]CC'),
    E0 = (454.966,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.385988,0.0873074,-0.000121237,1.04402e-07,-3.64306e-11,54842.4,32.4156], Tmin=(100,'K'), Tmax=(833.315,'K')), NASAPolynomial(coeffs=[6.26209,0.0452228,-2.05006e-05,3.82511e-09,-2.60885e-13,54345,8.02966], Tmin=(833.315,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(454.966,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(C2CsJOH) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C]([O])CCCC(7089)',
    structure = SMILES('[CH][C]([O])CCCC'),
    E0 = (490.869,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.555655,0.0795725,-7.89804e-05,4.55024e-08,-1.11161e-11,59158.7,29.0638], Tmin=(100,'K'), Tmax=(968.008,'K')), NASAPolynomial(coeffs=[10.1087,0.040097,-1.78094e-05,3.37337e-09,-2.35653e-13,57309.2,-16.7133], Tmin=(968.008,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(490.869,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([O])CCC[CH2](7090)',
    structure = SMILES('[CH]C([O])CCC[CH2]'),
    E0 = (519.487,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.580662,0.0737098,-6.05279e-05,2.67578e-08,-4.92002e-12,62604.1,31.3223], Tmin=(100,'K'), Tmax=(1268.84,'K')), NASAPolynomial(coeffs=[12.8425,0.035055,-1.48316e-05,2.74863e-09,-1.89547e-13,59492.4,-30.7538], Tmin=(1268.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(519.487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(O)[CH][CH]CC(7091)',
    structure = SMILES('[CH]C(O)[CH][CH]CC'),
    E0 = (478.241,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.981851,0.0702392,-6.35842e-05,3.53874e-08,-8.68616e-12,57624.5,33.3624], Tmin=(100,'K'), Tmax=(945.59,'K')), NASAPolynomial(coeffs=[7.73568,0.04167,-1.82655e-05,3.43705e-09,-2.39143e-13,56347.2,1.15679], Tmin=(945.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(478.241,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCJCO) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(O)C[CH][CH]C(7092)',
    structure = SMILES('[CH]C(O)C[CH][CH]C'),
    E0 = (472.785,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.771566,0.0783968,-0.000102314,8.91057e-08,-3.19258e-11,56972,34.3428], Tmin=(100,'K'), Tmax=(832.044,'K')), NASAPolynomial(coeffs=[4.30389,0.0474261,-2.12603e-05,3.95561e-09,-2.69731e-13,56868.4,20.8608], Tmin=(832.044,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(472.785,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(O)C[CH]C[CH2](7093)',
    structure = SMILES('[CH]C(O)C[CH]C[CH2]'),
    E0 = (483.585,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10854,0.0715557,-5.83631e-05,8.01949e-09,1.62872e-11,58258.4,32.2678], Tmin=(100,'K'), Tmax=(562.264,'K')), NASAPolynomial(coeffs=[6.83153,0.0439615,-1.97483e-05,3.73435e-09,-2.59607e-13,57407.4,6.10868], Tmin=(562.264,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(483.585,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]C([O])CC([CH2])C(7079)'],
    products = ['[CH]C([O])C[CH]CC(1803)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]C([CH2])[O](6989)', '[CH]CC(26)'],
    products = ['[CH]C([O])C[CH]CC(1803)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(14)', '[CH]CC([CH])[O](6991)'],
    products = ['[CH]C([O])C[CH]CC(1803)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction7',
    reactants = ['O(4)', '[CH][CH]C[CH]CC(7080)'],
    products = ['[CH]C([O])C[CH]CC(1803)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]C([O])C[C]CC(7081)'],
    products = ['[CH]C([O])C[CH]CC(1803)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH]C([O])C=CCC(7083)'],
    products = ['[CH]C([O])C[CH]CC(1803)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH]C([O])CC=CC(6958)'],
    products = ['[CH]C([O])C[CH]CC(1803)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH](6993)', 'CC[CH]CC=O(1813)'],
    products = ['[CH]C([O])C[CH]CC(1803)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH3(17)', '[CH]C([O])CC=C(6914)'],
    products = ['[CH]C([O])C[CH]CC(1803)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(102.358,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 97.7 to 102.4 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH]C([O])[CH][CH]CC(7084)'],
    products = ['[CH]C([O])C[CH]CC(1803)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH3(17)', '[CH]C([O])C[CH][CH2](1896)'],
    products = ['[CH]C([O])C[CH]CC(1803)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH][C]([O])C[CH]CC(7085)'],
    products = ['[CH]C([O])C[CH]CC(1803)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH]C([O])C[CH]C[CH2](7086)'],
    products = ['[CH]C([O])C[CH]CC(1803)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]C([O])C[CH]CC(1803)'],
    products = ['[CH]C(O)C[CH][CH]C(7092)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]C([O])C[CH]CC(1803)'],
    products = ['[CH]C(O)C[CH]C[CH2](7093)'],
