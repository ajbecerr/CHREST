...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67158,0.0315889,4.4568e-05,-8.93319e-08,3.89672e-11,21800.2,21.623], Tmin=(100,'K'), Tmax=(937.882,'K')), NASAPolynomial(coeffs=[18.2428,0.0107534,-1.81932e-06,3.01184e-10,-2.83953e-14,16499.9,-68.9467], Tmin=(937.882,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.41,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]C([CH2])O[C]=C(2583)'],
    products = ['[CH2]C([CH2])O[C]=C(2286)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH2]C(=C)O[C]=C(2587)'],
    products = ['[CH2]C([CH2])O[C]=C(2286)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2(T)(20)', 'C=[C]OC=C(2317)'],
    products = ['[CH2]C([CH2])O[C]=C(2286)'],
