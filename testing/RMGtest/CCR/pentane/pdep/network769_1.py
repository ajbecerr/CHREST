...
species(
    label = '[CH]OC[CH2](3214)',
    structure = SMILES('[CH]OC[CH2]'),
    E0 = (437.132,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,273.084,273.841,2041.1,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.470361,'amu*angstrom^2'), symmetry=1, barrier=(24.8965,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.174148,'amu*angstrom^2'), symmetry=1, barrier=(9.73775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.447738,'amu*angstrom^2'), symmetry=1, barrier=(24.8658,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (57.0712,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01418,0.0478069,-7.3566e-05,6.35477e-08,-2.18026e-11,52642.4,15.3908], Tmin=(100,'K'), Tmax=(809.331,'K')), NASAPolynomial(coeffs=[6.92138,0.018119,-8.47018e-06,1.62939e-09,-1.13261e-13,52026.1,-6.14588], Tmin=(809.331,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(437.132,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CJCO) + radical(CH2_triplet)"""),
)
...
species(
    label = '[CH2]CO[C]C(3215)',
    structure = SMILES('[CH2]CO[C]C'),
    E0 = (399.205,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,180,180,702.503],'cm^-1')),
        HinderedRotor(inertia=(0.0321532,'amu*angstrom^2'), symmetry=1, barrier=(11.2612,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0321513,'amu*angstrom^2'), symmetry=1, barrier=(11.2613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.489784,'amu*angstrom^2'), symmetry=1, barrier=(11.2611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0615657,'amu*angstrom^2'), symmetry=1, barrier=(11.2612,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58045,0.0559383,-5.93961e-05,3.53718e-08,-8.75763e-12,48098.1,19.0463], Tmin=(100,'K'), Tmax=(964.377,'K')), NASAPolynomial(coeffs=[9.02237,0.0250708,-1.13841e-05,2.18116e-09,-1.53395e-13,46662.7,-16.5867], Tmin=(964.377,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(399.205,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CH2_triplet)"""),
)
...
species(
    label = '[CH2]COC=C(1411)',
    structure = SMILES('[CH2]COC=C'),
    E0 = (26.0821,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,199.258,199.297,199.376],'cm^-1')),
        HinderedRotor(inertia=(0.756685,'amu*angstrom^2'), symmetry=1, barrier=(21.2885,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.75479,'amu*angstrom^2'), symmetry=1, barrier=(21.2906,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.757326,'amu*angstrom^2'), symmetry=1, barrier=(21.2899,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39677,0.0428258,3.10348e-06,-4.6123e-08,2.41715e-11,3244.03,18.6616], Tmin=(100,'K'), Tmax=(926.093,'K')), NASAPolynomial(coeffs=[18.0716,0.00801342,-7.79599e-07,5.81065e-11,-7.24131e-15,-1440.09,-69.1192], Tmin=(926.093,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(26.0821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJCO)"""),
)
...
species(
    label = '[CH2]COC[CH2](3218)',
    structure = SMILES('[CH2]COC[CH2]'),
    E0 = (149.805,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,407.432,958.664,3002.78],'cm^-1')),
        HinderedRotor(inertia=(0.150527,'amu*angstrom^2'), symmetry=1, barrier=(3.46092,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.543647,'amu*angstrom^2'), symmetry=1, barrier=(12.4995,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.542475,'amu*angstrom^2'), symmetry=1, barrier=(12.4726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.48853,'amu*angstrom^2'), symmetry=1, barrier=(34.2243,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60943,0.0555486,-5.52789e-05,3.29958e-08,-8.45237e-12,18101,20.1514], Tmin=(100,'K'), Tmax=(921.712,'K')), NASAPolynomial(coeffs=[7.58641,0.0296106,-1.30682e-05,2.46583e-09,-1.71774e-13,16999.1,-8.19692], Tmin=(921.712,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.805,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CJCO)"""),
)

species(
    label = '[CH2][CH]OCC(1388)',
    structure = SMILES('[CH2][CH]OCC'),
    E0 = (118.672,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,237.79,237.802,2647.68],'cm^-1')),
        HinderedRotor(inertia=(0.00298147,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CO[CH]C(3124)'],
    products = ['C2H4(22)', 'CH3CHO(1381)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CHCH3(T)(21)', '[CH2]C[O](1358)'],
    products = ['[CH2]CO[CH]C(3124)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(20)', '[CH2]O[CH]C(3213)'],
    products = ['[CH2]CO[CH]C(3124)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', '[CH]OC[CH2](3214)'],
    products = ['[CH2]CO[CH]C(3124)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['C2H4(T)(23)', 'CH3CHO(1381)'],
    products = ['[CH2]CO[CH]C(3124)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C2H4(T)(23)', 'C[CH][O](1382)'],
    products = ['[CH2]CO[CH]C(3124)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2][CH]O[CH]C(1570)'],
    products = ['[CH2]CO[CH]C(3124)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH2][CH]OC[CH2](1407)'],
    products = ['[CH2]CO[CH]C(3124)'],
