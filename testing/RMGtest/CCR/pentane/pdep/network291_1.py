...
species(
    label = 'CC[CH]CC[CH]CO[O](720)',
    structure = SMILES('CC[CH]CC[CH]CO[O]'),
    E0 = (242.911,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.45896,0.108122,-0.000142469,1.24368e-07,-4.49852e-11,29366.3,41.435], Tmin=(100,'K'), Tmax=(812.178,'K')), NASAPolynomial(coeffs=[4.95918,0.0642145,-2.95675e-05,5.5835e-09,-3.84528e-13,29054.2,19.9198], Tmin=(812.178,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(242.911,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(CCJCOOH)"""),
)

species(
    label = 'CC[CH]C[CH]CCO[O](994)',
    structure = SMILES('CC[CH]C[CH]CCO[O]'),
    E0 = (236.954,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.246742,0.106781,-0.000151293,1.42374e-07,-5.34847e-11,28639,40.9306], Tmin=(100,'K'), Tmax=(837.79,'K')), NASAPolynomial(coeffs=[1.48031,0.0693896,-3.2162e-05,6.05138e-09,-4.14146e-13,29372.4,39.0088], Tmin=(837.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(236.954,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.598139,0.10286,-0.00010264,6.0984e-08,-1.51878e-11,29848.9,40.0774], Tmin=(100,'K'), Tmax=(960.542,'K')), NASAPolynomial(coeffs=[12.1268,0.0498683,-1.98876e-05,3.54865e-09,-2.38967e-13,27404.3,-20.8008], Tmin=(960.542,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(246.813,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C[O])C[CH]CC(996)',
    structure = SMILES('[CH2]C(C[O])C[CH]CC'),
    E0 = (244.079,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,248.481,860.724,1147.63,1494.94,1859.09],'cm^-1')),
        HinderedRotor(inertia=(0.0946502,'amu*angstrom^2'), symmetry=1, barrier=(3.3591,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0946502,'amu*angstrom^2'), symmetry=1, barrier=(3.3591,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0946502,'amu*angstrom^2'), symmetry=1, barrier=(3.3591,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0946502,'amu*angstrom^2'), symmetry=1, barrier=(3.3591,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0946502,'amu*angstrom^2'), symmetry=1, barrier=(3.3591,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.331412,0.0890041,-0.000104513,9.08811e-08,-3.36785e-11,29480,37.1362], Tmin=(100,'K'), Tmax=(817.717,'K')), NASAPolynomial(coeffs=[2.46327,0.0629647,-2.81103e-05,5.2451e-09,-3.59273e-13,29653.3,30.4716], Tmin=(817.717,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(244.079,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJCC) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C[C]CC)CO[O](997)',
    structure = SMILES('[CH2]C(C[C]CC)CO[O]'),
    E0 = (495.641,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.595445,0.105656,-0.000115559,7.47497e-08,-2.02338e-11,59773.2,38.478], Tmin=(100,'K'), Tmax=(886.575,'K')), NASAPolynomial(coeffs=[11.7368,0.0500154,-2.14189e-05,3.95988e-09,-2.71974e-13,57586.6,-19.5332], Tmin=(886.575,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(495.641,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(C[CH]CC)CO[O](998)',
    structure = SMILES('[CH]C(C[CH]CC)CO[O]'),
    E0 = (485.017,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.458387,0.105793,-0.000132728,1.07679e-07,-3.69324e-11,58487.2,39.8557], Tmin=(100,'K'), Tmax=(788.933,'K')), NASAPolynomial(coeffs=[7.46412,0.0576987,-2.62159e-05,4.93964e-09,-3.40722e-13,57483.8,5.07573], Tmin=(788.933,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(485.017,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(CCJ2_triplet)"""),
)

species(
    label = 'CCC1CC(CO[O])C1(966)',
...
species(
    label = 'CC[CH]CC1COOC1(999)',
    structure = SMILES('CC[CH]CC1COOC1'),
    E0 = (-34.1246,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.178856,0.0727185,-1.38154e-05,-3.03464e-08,1.70773e-11,-3956.38,33.2354], Tmin=(100,'K'), Tmax=(937.836,'K')), NASAPolynomial(coeffs=[13.0449,0.0457903,-1.54449e-05,2.58669e-09,-1.71885e-13,-7598.64,-34.5623], Tmin=(937.836,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-34.1246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxolane) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C1COOC(CC)C1(1000)',
    structure = SMILES('[CH2]C1COOC(CC)C1'),
    E0 = (-44.3983,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0799061,0.065118,3.29329e-05,-9.73654e-08,4.59835e-11,-5179.03,29.8782], Tmin=(100,'K'), Tmax=(905.521,'K')), NASAPolynomial(coeffs=[19.8538,0.0338033,-8.01385e-06,1.11673e-09,-7.22935e-14,-11057.4,-76.2419], Tmin=(905.521,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-44.3983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(519.654,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxane) + radical(Isobutyl)"""),
)

species(
    label = 'CC[CH]CC1COC1(1001)',
    structure = SMILES('CC[CH]CC1COC1'),
    E0 = (-6.02364,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.178,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.759267,0.06305,-8.98584e-06,-2.54355e-08,1.34402e-11,-600.364,29.6728], Tmin=(100,'K'), Tmax=(937.629,'K')), NASAPolynomial(coeffs=[9.10289,0.0475831,-1.64421e-05,2.76055e-09,-1.82045e-13,-3049.77,-14.7611], Tmin=(937.629,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.02364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C1COC(CC)C1(1002)',
    structure = SMILES('[CH2]C1COC(CC)C1'),
    E0 = (-86.5049,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.178,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.87391,0.0501934,4.91594e-05,-1.01867e-07,4.50744e-11,-10274.2,25.9368], Tmin=(100,'K'), Tmax=(903.739,'K')), NASAPolynomial(coeffs=[15.0419,0.0364992,-9.46327e-06,1.38873e-09,-9.00544e-14,-14836.7,-52.0552], Tmin=(903.739,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.5049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0127421,0.0925302,-7.53785e-05,3.54669e-08,-7.30474e-12,-3799.67,35.0109], Tmin=(100,'K'), Tmax=(1106.34,'K')), NASAPolynomial(coeffs=[10.4558,0.0546804,-2.40604e-05,4.5429e-09,-3.16746e-13,-6116,-16.5516], Tmin=(1106.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-32.7634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = 'CCC=CC(C)CO[O](1004)',
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.197728,0.0902393,-6.66645e-05,2.64649e-08,-4.42395e-12,-5050.87,36.0834], Tmin=(100,'K'), Tmax=(1366.01,'K')), NASAPolynomial(coeffs=[14.3363,0.0476815,-1.99334e-05,3.65885e-09,-2.50224e-13,-9021.68,-38.5681], Tmin=(1366.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-43.2628,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = 'C=C(C[CH]CC)COO(1005)',
    structure = SMILES('C=C(C[CH]CC)COO'),
    E0 = (9.69021,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0727507,0.0969232,-9.46334e-05,6.10336e-08,-1.78929e-11,1305.57,37.049], Tmin=(100,'K'), Tmax=(793.226,'K')), NASAPolynomial(coeffs=[6.85864,0.0619706,-2.85381e-05,5.48434e-09,-3.85678e-13,205.932,5.21462], Tmin=(793.226,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(9.69021,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJCC)"""),
)

species(
    label = 'CC=CCC(C)CO[O](726)',
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0134547,0.0909317,-7.08106e-05,3.11217e-08,-5.94981e-12,-5327.78,34.6288], Tmin=(100,'K'), Tmax=(1184.21,'K')), NASAPolynomial(coeffs=[11.116,0.0534299,-2.33084e-05,4.37975e-09,-3.04305e-13,-7957.34,-20.8118], Tmin=(1184.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-45.4672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C(C=CCC)COO(1006)',
    structure = SMILES('[CH2]C(C=CCC)COO'),
    E0 = (9.81484,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.540243,0.0966202,-7.82165e-05,3.4462e-08,-6.32158e-12,1346.43,38.3385], Tmin=(100,'K'), Tmax=(1273.66,'K')), NASAPolynomial(coeffs=[15.4746,0.0463252,-1.89842e-05,3.45862e-09,-2.36151e-13,-2733.1,-42.7979], Tmin=(1273.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(9.81484,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CC=CC)COO(1007)',
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.357172,0.097636,-8.3424e-05,4.03574e-08,-8.30827e-12,1070.67,36.9847], Tmin=(100,'K'), Tmax=(1129.82,'K')), NASAPolynomial(coeffs=[12.7195,0.0513396,-2.19586e-05,4.08869e-09,-2.82932e-13,-1884.17,-27.6986], Tmin=(1129.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(7.61047,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl)"""),
)

species(
    label = 'C=C(C[CH]CC)CO[O](1008)',
    structure = SMILES('C=C(C[CH]CC)CO[O]'),
    E0 = (161.695,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0740496,0.0968035,-0.000113238,9.11909e-08,-3.19715e-11,19587.2,37.7906], Tmin=(100,'K'), Tmax=(772.946,'K')), NASAPolynomial(coeffs=[5.8266,0.0593003,-2.69373e-05,5.09471e-09,-3.5289e-13,18883.2,12.1894], Tmin=(772.946,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.695,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C(C=CCC)CO[O](1009)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.175125,0.0918102,-7.86492e-05,3.83935e-08,-7.92032e-12,19612.7,37.7902], Tmin=(100,'K'), Tmax=(1135.58,'K')), NASAPolynomial(coeffs=[12.5968,0.0468218,-1.92235e-05,3.50628e-09,-2.39809e-13,16712,-25.4508], Tmin=(1135.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62399,0.0655449,4.26034e-05,-2.31397e-07,2.15493e-10,27458.9,36.5813], Tmin=(100,'K'), Tmax=(415.018,'K')), NASAPolynomial(coeffs=[3.89642,0.0645505,-2.93683e-05,5.60105e-09,-3.91628e-13,27090.2,25.4473], Tmin=(415.018,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(227.712,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CJCOOH) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.459204,0.104319,-0.0001216,9.29845e-08,-3.03463e-11,29245.1,40.8092], Tmin=(100,'K'), Tmax=(806.529,'K')), NASAPolynomial(coeffs=[7.79358,0.0578641,-2.49277e-05,4.58341e-09,-3.11966e-13,28093.5,3.88273], Tmin=(806.529,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(241.872,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJC) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH]OO)C[CH]CC(1018)',
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.694463,0.111286,-0.000139589,1.13168e-07,-3.85801e-11,33652.5,40.8713], Tmin=(100,'K'), Tmax=(804.269,'K')), NASAPolynomial(coeffs=[7.54976,0.0606441,-2.71618e-05,5.07362e-09,-3.47889e-13,32638.2,4.83163], Tmin=(804.269,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(278.462,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCsJOOH) + radical(Isobutyl)"""),
)

species(
    label = 'CC[CH][CH]C(C)CO[O](1019)',
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.210964,0.101521,-0.000124927,1.07248e-07,-3.9288e-11,27967.2,40.5171], Tmin=(100,'K'), Tmax=(790.998,'K')), NASAPolynomial(coeffs=[4.37717,0.06487,-2.99217e-05,5.68078e-09,-3.93496e-13,27662.1,22.1172], Tmin=(790.998,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(231.344,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH]CC(C)[CH]O[O](1020)',
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.418011,0.105686,-0.000130907,1.0935e-07,-3.87787e-11,27258.3,38.8546], Tmin=(100,'K'), Tmax=(796.096,'K')), NASAPolynomial(coeffs=[5.74317,0.0630909,-2.87223e-05,5.41543e-09,-3.73534e-13,26646.1,12.8517], Tmin=(796.096,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(225.384,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2][C](CCCC)CO[O](1021)',
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.170865,0.08789,-6.87013e-05,3.21384e-08,-6.71233e-12,28800,40.6606], Tmin=(100,'K'), Tmax=(1082.06,'K')), NASAPolynomial(coeffs=[8.95548,0.055416,-2.3684e-05,4.40253e-09,-3.04146e-13,26898.9,-2.41278], Tmin=(1082.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(238.336,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CJCOOH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CCCC([CH2])CO[O](1022)',
    structure = SMILES('[CH2]CCCC([CH2])CO[O]'),
    E0 = (252.672,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.457805,0.102746,-0.000104336,6.43799e-08,-1.69724e-11,30545.8,39.8666], Tmin=(100,'K'), Tmax=(900.726,'K')), NASAPolynomial(coeffs=[10.5196,0.0539975,-2.31549e-05,4.29526e-09,-2.9595e-13,28568.3,-11.9455], Tmin=(900.726,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C([CH]O[O])CCCC(1023)',
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.539272,0.105315,-0.000112686,7.46949e-08,-2.11716e-11,28543.7,38.5218], Tmin=(100,'K'), Tmax=(841.534,'K')), NASAPolynomial(coeffs=[9.92503,0.0555764,-2.40291e-05,4.46129e-09,-3.06985e-13,26782.5,-10.1571], Tmin=(841.534,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(236.008,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCsJOOH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][C](C[CH]CC)COO(1024)',
    structure = SMILES('[CH2][C](C[CH]CC)COO'),
    E0 = (280.79,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,245.894,857.344,1337.68,1844.67],'cm^-1')),
        HinderedRotor(inertia=(0.1229,'amu*angstrom^2'), symmetry=1, barrier=(3.42674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1229,'amu*angstrom^2'), symmetry=1, barrier=(3.42674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1229,'amu*angstrom^2'), symmetry=1, barrier=(3.42674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1229,'amu*angstrom^2'), symmetry=1, barrier=(3.42674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1229,'amu*angstrom^2'), symmetry=1, barrier=(3.42674,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.728955,0.0826211,-3.84703e-05,-4.25926e-08,5.22756e-11,33878.6,40.6069], Tmin=(100,'K'), Tmax=(518.453,'K')), NASAPolynomial(coeffs=[5.4615,0.0625733,-2.81047e-05,5.33416e-09,-3.72504e-13,33166.6,18.7499], Tmin=(518.453,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(280.79,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CJCOOH) + radical(RCCJCC) + radical(Isobutyl)"""),
)

species(
    label = 'C[CH][CH]CC(C)CO[O](1025)',
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.226653,0.103232,-0.00013396,1.1872e-07,-4.34387e-11,27954.9,40.7516], Tmin=(100,'K'), Tmax=(825.329,'K')), NASAPolynomial(coeffs=[3.44518,0.0656797,-2.98023e-05,5.58172e-09,-3.82264e-13,28021.7,27.8186], Tmin=(825.329,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(231.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C([CH][CH]CC)COO(1026)',
    structure = SMILES('[CH2]C([CH][CH]CC)COO'),
    E0 = (284.421,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04199,0.0814368,1.13817e-05,-2.20877e-07,2.2584e-10,34297,37.4423], Tmin=(100,'K'), Tmax=(432.849,'K')), NASAPolynomial(coeffs=[6.52532,0.061777,-2.79592e-05,5.23872e-09,-3.59192e-13,33531.8,12.2241], Tmin=(432.849,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(284.421,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(RCCJCC) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C[CH]CC(C)CO[O](1027)',
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.9184,0.0825061,-9.87273e-06,-1.48708e-07,1.54423e-10,29207.2,36.0011], Tmin=(100,'K'), Tmax=(454.63,'K')), NASAPolynomial(coeffs=[6.28734,0.0616227,-2.79234e-05,5.26922e-09,-3.6428e-13,28446.6,11.3359], Tmin=(454.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(242.048,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C(C[CH][CH]C)COO(1028)',
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.503695,0.108843,-0.000142706,1.22681e-07,-4.334e-11,34349.2,42.7702], Tmin=(100,'K'), Tmax=(833.928,'K')), NASAPolynomial(coeffs=[5.23957,0.0632546,-2.82546e-05,5.24304e-09,-3.56883e-13,34018.6,19.8665], Tmin=(833.928,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(284.325,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C[CH]CC([CH2])COO(1029)',
    structure = SMILES('[CH2]C[CH]CC([CH2])COO'),
    E0 = (295.125,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.618508,0.108746,-0.000131179,1.02564e-07,-3.41797e-11,35654.9,42.2381], Tmin=(100,'K'), Tmax=(785.686,'K')), NASAPolynomial(coeffs=[8.04574,0.0592507,-2.64025e-05,4.93613e-09,-3.39314e-13,34459.6,3.58575], Tmin=(785.686,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(295.125,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(C)CC([CH2])CO[O](995)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O(4)', '[CH2]C(C[O])C[CH]CC(996)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(T)(20)', 'CC[CH]C[CH]CO[O](844)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]CC(26)', '[CH2]C([CH2])CO[O](763)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C2H5(14)', '[CH]CC([CH2])CO[O](765)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2]C(C[C]CC)CO[O](997)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]C(C[CH]CC)CO[O](998)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(C[CH]CC)CO[O](721)'],
    products = ['[CH2]C1COOC(CC)C1(1000)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C[CH]CC)CO[O](721)'],
    products = ['O(4)', 'CC[CH]CC1COC1(1001)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(C[CH]CC)CO[O](721)'],
    products = ['O(4)', '[CH2]C1COC(CC)C1(1002)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(C[CH]CC)CO[O](721)'],
    products = ['HO2(9)', '[CH2]C(=C)C[CH]CC(602)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', 'C=C(C[CH]CC)CO[O](1008)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2]C(C=CCC)CO[O](1009)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH2]C(CC=CC)CO[O](1010)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]O[O](46)', 'C=CC[CH]CC(244)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CH3(17)', '[CH2]C(CC=C)CO[O](747)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction32',
    reactants = ['O2(2)', '[CH2]C([CH2])C[CH]CC(287)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]O[O](46)', '[CH2][CH]C[CH]CC(247)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(3)', '[CH2][C](C[CH]CC)CO[O](1011)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', '[CH2]C([CH][CH]CC)CO[O](1012)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction37',
    reactants = ['CH3(17)', '[CH2][CH]CC([CH2])CO[O](742)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(3)', '[CH2]C(C[CH][CH]C)CO[O](1013)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction39',
    reactants = ['H(3)', '[CH2]C([CH]O[O])C[CH]CC(1014)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction40',
    reactants = ['H(3)', '[CH2]C[CH]CC([CH2])CO[O](1015)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2]C(C[CH]CC)CO[O](721)'],
    products = ['CC[CH]C[C](C)CO[O](1016)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2]C([CH]CCC)CO[O](924)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]C(C[CH]CC)CO[O](721)'],
    products = ['[CH2]C(CC[CH]C)CO[O](1017)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH2]C(C[CH]CC)CO[O](721)'],
    products = ['[CH2]C([CH]OO)C[CH]CC(1018)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2]C(C[CH]CC)CO[O](721)'],
    products = ['CC[CH][CH]C(C)CO[O](1019)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2]C(C[CH]CC)CO[O](721)'],
    products = ['CC[CH]CC(C)[CH]O[O](1020)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]CCCC([CH2])CO[O](1022)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH2]C(C[CH]CC)CO[O](721)'],
    products = ['[CH2]C([CH]O[O])CCCC(1023)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[CH2][C](C[CH]CC)COO(1024)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH2]C(C[CH]CC)CO[O](721)'],
    products = ['C[CH][CH]CC(C)CO[O](1025)'],
...
reaction(
    label = 'reaction52',
    reactants = ['[CH2]C([CH][CH]CC)COO(1026)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction53',
    reactants = ['[CH2]C[CH]CC(C)CO[O](1027)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction54',
    reactants = ['[CH2]C(C[CH][CH]C)COO(1028)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction55',
    reactants = ['[CH2]C[CH]CC([CH2])COO(1029)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
