...
species(
    label = '[C]=[C]OC([CH2])=C(16186)',
    structure = SMILES('[C]=[C]OC([CH2])=C'),
    E0 = (884.785,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,395.358,401.645,3028.72],'cm^-1')),
        HinderedRotor(inertia=(0.0915552,'amu*angstrom^2'), symmetry=1, barrier=(10.5626,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0934727,'amu*angstrom^2'), symmetry=1, barrier=(10.5932,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.37605,'amu*angstrom^2'), symmetry=1, barrier=(43.28,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60221,0.0561373,-7.96671e-05,6.32877e-08,-2.01782e-11,106498,25.155], Tmin=(100,'K'), Tmax=(824.644,'K')), NASAPolynomial(coeffs=[8.30851,0.020489,-9.15112e-06,1.69424e-09,-1.15076e-13,105498,-5.26303], Tmin=(824.644,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(884.785,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=C(O)CJ) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50079,0.0435709,-1.27824e-05,-2.31917e-08,1.43119e-11,75597.9,23.4437], Tmin=(100,'K'), Tmax=(950.496,'K')), NASAPolynomial(coeffs=[16.3536,0.00900981,-2.34073e-06,4.15846e-10,-3.28847e-14,71512.1,-54.099], Tmin=(950.496,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(627.722,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C2CsJOC(O)) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[C]=[C]OC([CH2])=C(16186)'],
    products = ['[CH]=[C]OC([CH2])=C(9841)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction19',
    reactants = ['HC2(2881)', '[CH2][C]([CH2])[O](15953)'],
    products = ['[CH]=[C]OC([CH2])=C(9841)'],
