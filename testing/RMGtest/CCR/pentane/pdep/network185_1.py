...
species(
    ...
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.7778,0.0145126,5.13643e-05,-8.40737e-08,3.68849e-11,9195.86,14.9555], Tmin=(100,'K'), Tmax=(870.641,'K')), NASAPolynomial(coeffs=[11.0621,0.010289,3.44069e-07,-3.67513e-10,3.11791e-14,6470.88,-31.2288], Tmin=(870.641,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(75.9945,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(12dioxolane) + radical(CCJCOOH)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.288864,'amu*angstrom^2'), symmetry=1, barrier=(6.64154,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.290805,'amu*angstrom^2'), symmetry=1, barrier=(6.68619,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00827,0.0529567,-9.83851e-05,9.61266e-08,-3.47325e-11,38552.4,18.6662], Tmin=(100,'K'), Tmax=(883.065,'K')), NASAPolynomial(coeffs=[3.68438,0.0234389,-1.10018e-05,2.04009e-09,-1.36143e-13,39111.2,15.6288], Tmin=(883.065,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(320.019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(ROOJ) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75473,0.0434201,-3.68207e-05,1.56822e-08,-2.64238e-12,5795.15,18.9538], Tmin=(100,'K'), Tmax=(1428.92,'K')), NASAPolynomial(coeffs=[12.5007,0.0133387,-5.24288e-06,9.49427e-10,-6.47747e-14,2724.14,-36.7246], Tmin=(1428.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(47.4703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(C=CCJO)"""),
)
...
species(
    ...
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7193,0.0552399,-8.46316e-05,7.36669e-08,-2.53887e-11,21398.1,18.879], Tmin=(100,'K'), Tmax=(832.098,'K')), NASAPolynomial(coeffs=[6.68191,0.0228006,-1.06811e-05,2.02178e-09,-1.38689e-13,20869.3,-2.36497], Tmin=(832.098,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(177.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'allyl(82)'],
    products = ['allylperoxy(462)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction11',
    reactants = ['allylperoxy(462)'],
    products = ['C=C[CH]OO(663)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(3.32e+07,'s^-1'), n=1.69, Ea=(159.41,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 336 C3H5O2 <=> C3H5O2-2 in intra_H_migration/training
This reaction matched rate rule [R3H_SS_O;O_rad_out;Cs_H_out_H/Cd]
