...
species(
    label = '[C]=C([O])C([CH2])=C(16210)',
    structure = SMILES('[C]C(=O)C([CH2])=C'),
    E0 = (655.992,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,375,552.5,462.5,1710,2950,3100,1380,975,1025,1650,491.166,492.359],'cm^-1')),
        HinderedRotor(inertia=(0.0153044,'amu*angstrom^2'), symmetry=1, barrier=(2.62941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142035,'amu*angstrom^2'), symmetry=1, barrier=(24.4349,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88724,0.0446515,-3.78415e-05,1.60186e-08,-2.73996e-12,78975,17.608], Tmin=(100,'K'), Tmax=(1375.82,'K')), NASAPolynomial(coeffs=[11.3174,0.0172345,-7.94988e-06,1.53431e-09,-1.08026e-13,76380.2,-30.8959], Tmin=(1375.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(655.992,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-O2d)HHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-CdsHH) + radical(C=C(C=O)CJ) + radical(CJ3)"""),
)

species(
    label = '[CH2]C(=C)C1=CO1(16211)',
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25949,0.0474917,-1.29621e-05,-2.93255e-08,1.81878e-11,38152,17.0147], Tmin=(100,'K'), Tmax=(928.02,'K')), NASAPolynomial(coeffs=[18.2527,0.00710025,-7.78235e-07,6.94256e-11,-7.57384e-15,33583.3,-71.3205], Tmin=(928.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(316.296,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=C1OCC1=C(16177)',
...
species(
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17466,0.0230831,4.60807e-05,-8.38197e-08,3.59818e-11,52669.1,20.3391], Tmin=(100,'K'), Tmax=(931.957,'K')), NASAPolynomial(coeffs=[15.674,0.00876643,-1.08888e-06,1.48411e-10,-1.6094e-14,48258.5,-54.0001], Tmin=(931.957,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(437.239,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C=C(C)OJ) + radical(CCJ(C)CO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C1OC[C]1[CH2](16213)',
    structure = SMILES('[CH]C1=C([CH2])CO1'),
    E0 = (446.157,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67459,0.0327189,4.02922e-05,-8.27659e-08,3.59782e-11,53760.8,18.5424], Tmin=(100,'K'), Tmax=(941.952,'K')), NASAPolynomial(coeffs=[17.0675,0.0138054,-3.56223e-06,6.26603e-10,-4.99189e-14,48800.1,-65.7382], Tmin=(941.952,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(446.157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + ring(Cyclobutene) + radical(Allyl_P) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH2][C]1CC=C1[O](16214)',
    structure = SMILES('[CH2]C1=C([O])[CH]C1'),
    E0 = (380.06,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11636,0.0235603,4.76864e-05,-8.74601e-08,3.77597e-11,45795,21.1535], Tmin=(100,'K'), Tmax=(929.767,'K')), NASAPolynomial(coeffs=[16.4721,0.00759545,-4.39984e-07,2.35135e-11,-7.71521e-15,41146,-57.704], Tmin=(929.767,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(380.06,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + ring(Cyclobutene) + radical(C=C(C)OJ) + radical(CCJCO) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=C1OC1([CH2])[CH2](16191)',
...
species(
    label = '[CH]C1([O])CC1=C(16208)',
    structure = SMILES('[CH]C1([O])CC1=C'),
    E0 = (642.635,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80306,0.0373702,7.83375e-07,-3.16918e-08,1.58796e-11,77380.2,20.6883], Tmin=(100,'K'), Tmax=(960.918,'K')), NASAPolynomial(coeffs=[13.703,0.0143637,-4.71551e-06,8.54191e-10,-6.26497e-14,73868.4,-42.6206], Tmin=(960.918,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(642.635,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsOs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Methylene_cyclopropane) + radical(C=CC(C)2OJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(20)', '[CH]=C([O])[C]=C(9953)'],
    products = ['[CH]=C([O])C([CH2])=C(9850)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(4)', '[CH]=[C]C([CH2])=C(15991)'],
    products = ['[CH]=C([O])C([CH2])=C(9850)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[C]=C([O])C([CH2])=C(16210)'],
    products = ['[CH]=C([O])C([CH2])=C(9850)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=C([O])C([CH2])=C(9850)'],
    products = ['[CH]=C1OC[C]1[CH2](16213)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=C([O])C([CH2])=C(9850)'],
    products = ['[CH]=C1OC1([CH2])[CH2](16191)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.54e+10,'s^-1'), n=0.69, Ea=(140.31,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_D_D;doublebond_intra_2H;radadd_intra_cdsingleH]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic"""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['O(4)', 'C#CC([CH2])=C(15990)'],
    products = ['[CH]=C([O])C([CH2])=C(9850)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH][C](O)C(=[CH])[CH2](16219)'],
    products = ['[CH]=C([O])C([CH2])=C(9850)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=C([O])C([CH2])=C(9850)'],
    products = ['[CH]C1([O])CC1=C(16208)'],
    transitionState = 'TS24',
    kinetics = Arrhenius(A=(2.68477e+09,'s^-1'), n=0.889391, Ea=(263.797,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs2H] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_cs2H]
Euclidian distance = 1.4142135623730951
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Exocyclic
Ea raised from 261.1 to 263.8 kJ/mol to match endothermicity of reaction."""),
)
