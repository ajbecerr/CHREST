...
species(
    label = '[C]=CO[C]=C[O](15414)',
    structure = SMILES('[C]=CO[C]=C[O]'),
    E0 = (700.33,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.10257,'amu*angstrom^2'), symmetry=1, barrier=(25.3504,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.10305,'amu*angstrom^2'), symmetry=1, barrier=(25.3614,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.0575,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12106,0.0517513,-5.95457e-05,3.1367e-08,-6.08767e-12,84343.8,26.1504], Tmin=(100,'K'), Tmax=(1451.23,'K')), NASAPolynomial(coeffs=[16.6388,0.00099403,1.17194e-06,-3.17491e-10,2.37808e-14,80680.8,-51.5951], Tmin=(1451.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(700.33,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=COJ) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)

species(
    label = '[CH]=COC1=CO1(15415)',
    structure = SMILES('[CH]=COC1=CO1'),
    E0 = (382.132,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25778,0.0522362,-5.70412e-05,2.98932e-08,-5.95229e-12,46065.5,20.8256], Tmin=(100,'K'), Tmax=(1314.86,'K')), NASAPolynomial(coeffs=[15.455,0.00634316,-1.60251e-06,2.20886e-10,-1.32802e-14,42565.7,-50.6652], Tmin=(1314.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(382.132,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(Cds_P)"""),
)
...
species(
    label = '[C]1[CH]OC=CO1(15420)',
    structure = SMILES('[C]1=CO[CH][CH]O1'),
    E0 = (344.343,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.785291,0.0643316,-7.53926e-05,3.93847e-08,-7.07411e-12,41622.9,22.072], Tmin=(100,'K'), Tmax=(1777.27,'K')), NASAPolynomial(coeffs=[14.7966,-0.0023988,7.6491e-06,-1.78838e-09,1.27494e-13,41084.7,-47.9949], Tmin=(1777.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(344.343,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + ring(23dihydro14dioxin) + radical(CCsJOC(O)) + radical(CCsJOC(O)) + radical(C=CJO)"""),
)

species(
    label = '[O]C1[C]OC=C1(15421)',
    structure = SMILES('[O]C1[C]OC=C1'),
    E0 = (390.019,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.10961,0.0184139,6.6069e-05,-1.2071e-07,5.44598e-11,46998.3,14.2412], Tmin=(100,'K'), Tmax=(898.471,'K')), NASAPolynomial(coeffs=[22.1189,-0.00898741,8.84026e-06,-1.83803e-09,1.23149e-13,40913.2,-94.0044], Tmin=(898.471,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(390.019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(2,3-Dihydrofuran) + radical(CC(C)OJ) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=C[O](6859)', 'ketene(T)(1373)'],
    products = ['[CH]=CO[C]=C[O](15073)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[C]=CO[C]=C[O](15414)'],
    products = ['[CH]=CO[C]=C[O](15073)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'C#CO[C]=C[O](13155)'],
    products = ['[CH]=CO[C]=C[O](15073)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH]=[C]O[C]=C[O](10437)'],
    products = ['[CH]=CO[C]=C[O](15073)'],
