...
species(
    label = '[CH]=[C]OCC([CH2])C(9789)',
    structure = SMILES('[CH]=[C]OCC([CH2])C'),
    E0 = (449.814,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.120697,0.0779953,-7.27231e-05,3.51822e-08,-6.64777e-12,54259.2,33.0017], Tmin=(100,'K'), Tmax=(1370.31,'K')), NASAPolynomial(coeffs=[18.3072,0.0206909,-6.15016e-06,9.23317e-10,-5.62784e-14,49538.6,-60.5043], Tmin=(1370.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(449.814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]OC[C]CC(9790)',
    structure = SMILES('[CH]=[C]OC[C]CC'),
    E0 = (701.988,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.106187,0.0782956,-7.75363e-05,3.918e-08,-7.78766e-12,84576.1,30.5875], Tmin=(100,'K'), Tmax=(1227.98,'K')), NASAPolynomial(coeffs=[17.6012,0.0213068,-7.9223e-06,1.38615e-09,-9.32307e-14,80279.4,-57.4084], Tmin=(1227.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(701.988,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[C]=[C]OC[CH]CC(9791)',
    structure = SMILES('[C]=[C]OC[CH]CC'),
    E0 = (764.681,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.455126,0.0721115,-6.72044e-05,3.24437e-08,-6.24349e-12,92102.4,31.9012], Tmin=(100,'K'), Tmax=(1255.52,'K')), NASAPolynomial(coeffs=[15.6897,0.0235752,-9.21699e-06,1.65299e-09,-1.12427e-13,88276.9,-45.0633], Tmin=(1255.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(764.681,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.598707,0.0611879,-1.80854e-05,-2.61015e-08,1.60754e-11,19166.5,28.3686], Tmin=(100,'K'), Tmax=(962.892,'K')), NASAPolynomial(coeffs=[17.837,0.0219139,-7.27811e-06,1.29282e-09,-9.24078e-14,14347.7,-61.9284], Tmin=(962.892,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(158.239,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=COCC=CC(6956)',
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.489248,0.0636166,-2.32243e-05,-2.19927e-08,1.48573e-11,16390.1,26.5957], Tmin=(100,'K'), Tmax=(964.728,'K')), NASAPolynomial(coeffs=[18.4575,0.0211618,-7.04026e-06,1.25563e-09,-9.00693e-14,11432,-67.1743], Tmin=(964.728,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(135.123,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.684588,0.0843295,-8.4728e-05,4.11317e-08,-7.54549e-12,43075.8,29.3978], Tmin=(100,'K'), Tmax=(1489.09,'K')), NASAPolynomial(coeffs=[23.119,0.0115093,-2.43056e-06,2.82936e-10,-1.52405e-14,36971,-91.6133], Tmin=(1489.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(356.617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCJCO) + radical(CCsJOCs)"""),
)
...
species(
    label = '[CH]=[C]OCC[CH]C(4285)',
    structure = SMILES('[CH]=[C]OCC[CH]C'),
    E0 = (448.219,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=[C]OCCC[CH2](9795)',
    structure = SMILES('[CH]=[C]OCCC[CH2]'),
    E0 = (459.019,'kJ/mol'),
    modes = [
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=[CH](9646)', 'CC[CH]C[O](1363)'],
    products = ['[CH]=[C]OC[CH]CC(2546)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(14)', '[CH]CO[C]=[CH](9648)'],
    products = ['[CH]=[C]OC[CH]CC(2546)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=[C]O[CH2](9647)', '[CH]CC(26)'],
    products = ['[CH]=[C]OC[CH]CC(2546)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]=[C]OC[C]CC(9790)'],
    products = ['[CH]=[C]OC[CH]CC(2546)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[C]=[C]OC[CH]CC(9791)'],
    products = ['[CH]=[C]OC[CH]CC(2546)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH]=[C]OC=CCC(9793)'],
    products = ['[CH]=[C]OC[CH]CC(2546)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.41198,'m^3/(mol*s)'), n=2.03228, Ea=(32.8158,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(17)', 'C#COC[CH][CH2](2623)'],
    products = ['[CH]=[C]OC[CH]CC(2546)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(17)', '[CH]=[C]OC[CH][CH2](2625)'],
    products = ['[CH]=[C]OC[CH]CC(2546)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH]=[C]OC[CH][CH]C(4280)'],
    products = ['[CH]=[C]OC[CH]CC(2546)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH]=[C]O[CH][CH]CC(9794)'],
    products = ['[CH]=[C]OC[CH]CC(2546)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH]=[C]OC[CH]C[CH2](7197)'],
    products = ['[CH]=[C]OC[CH]CC(2546)'],
