...
species(
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.503365,0.104432,-0.000111165,7.31022e-08,-2.05471e-11,29965.7,40.5487], Tmin=(100,'K'), Tmax=(848.278,'K')), NASAPolynomial(coeffs=[9.97945,0.0550022,-2.37608e-05,4.41272e-09,-3.03783e-13,28187.2,-8.30019], Tmin=(848.278,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(247.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(Isobutyl)"""),
)
...
species(
    label = 'C=CCC[CH]CC(325)',
    structure = SMILES('C=CCC[CH]CC'),
    E0 = (106.596,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH]CC[CH]C[O](1031)',
    structure = SMILES('CC[CH]CC[CH]C[O]'),
    E0 = (244.593,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,258.28,872.469,1090.59,1267.42,1670.55,1822.82],'cm^-1')),
        HinderedRotor(inertia=(0.107897,'amu*angstrom^2'), symmetry=1, barrier=(3.25632,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107897,'amu*angstrom^2'), symmetry=1, barrier=(3.25632,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107897,'amu*angstrom^2'), symmetry=1, barrier=(3.25632,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107897,'amu*angstrom^2'), symmetry=1, barrier=(3.25632,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107897,'amu*angstrom^2'), symmetry=1, barrier=(3.25632,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.42806,0.0642084,-3.00251e-05,5.86965e-09,-4.24838e-13,29441.8,30.4045], Tmin=(100,'K'), Tmax=(3163.38,'K')), NASAPolynomial(coeffs=[57.9518,-0.0019147,-6.08154e-07,7.83876e-11,5.81231e-16,-7730.68,-304.639], Tmin=(3163.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(244.593,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJCC) + radical(CCJCO)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.538343,0.109158,-0.000146012,1.24616e-07,-4.39328e-11,59173.3,39.3212], Tmin=(100,'K'), Tmax=(810.698,'K')), NASAPolynomial(coeffs=[6.64293,0.0593645,-2.73096e-05,5.15141e-09,-3.545e-13,58480.9,9.09337], Tmin=(810.698,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(490.711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(CCJ2_triplet)"""),
)

species(
    label = 'CC[C]CC[CH]CO[O](1033)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.605914,0.108579,-0.000129357,9.46006e-08,-2.93479e-11,59894.5,39.3198], Tmin=(100,'K'), Tmax=(774.024,'K')), NASAPolynomial(coeffs=[9.80712,0.0547643,-2.50639e-05,4.76896e-09,-3.32163e-13,58282.6,-8.24929], Tmin=(774.024,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(496.668,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CCJ2_triplet)"""),
)

species(
    label = 'CC[CH]CCC1COO1(1034)',
    structure = SMILES('CC[CH]CCC1COO1'),
    E0 = (47.203,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.508742,0.0840591,-6.24782e-05,3.08624e-08,-7.66602e-12,5796.69,31.0821], Tmin=(100,'K'), Tmax=(864.361,'K')), NASAPolynomial(coeffs=[4.56059,0.065308,-2.99373e-05,5.76362e-09,-4.06548e-13,5096.25,12.125], Tmin=(864.361,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(47.203,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(RCCJCC)"""),
)
...
species(
    label = 'CC[CH]CCC1CO1(1035)',
    structure = SMILES('CC[CH]CCC1CO1'),
    E0 = (-4.09321,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.178,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.074105,0.0795498,-5.60104e-05,2.37884e-08,-4.35154e-12,-345.331,32.3895], Tmin=(100,'K'), Tmax=(1267.48,'K')), NASAPolynomial(coeffs=[10.8874,0.0454244,-1.56245e-05,2.54619e-09,-1.61685e-13,-3086.45,-22.3415], Tmin=(1267.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.09321,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJCC)"""),
)

species(
    label = 'CCCCC=CCO[O](1036)',
    structure = SMILES('CCCCC=CCO[O]'),
    E0 = (-29.734,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.184846,0.0881837,-6.59983e-05,2.79462e-08,-5.22073e-12,-3442.58,35.3445], Tmin=(100,'K'), Tmax=(1192.58,'K')), NASAPolynomial(coeffs=[10.1045,0.0549122,-2.41503e-05,4.55262e-09,-3.16737e-13,-5808.59,-14.2593], Tmin=(1192.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-29.734,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = 'CCC=CCCCO[O](1037)',
    structure = SMILES('CCC=CCCCO[O]'),
    E0 = (-35.2909,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0107738,0.0904207,-6.91099e-05,2.93853e-08,-5.40557e-12,-4103.37,35.5833], Tmin=(100,'K'), Tmax=(1228.11,'K')), NASAPolynomial(coeffs=[11.6298,0.0525772,-2.28883e-05,4.29439e-09,-2.97955e-13,-6957.26,-22.8591], Tmin=(1228.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-35.2909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = 'CC[CH]CCC=COO(1038)',
    structure = SMILES('CC[CH]CCC=COO'),
    E0 = (22.298,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0104382,0.0919928,-7.34702e-05,3.32716e-08,-6.55621e-12,2822.95,37.6776], Tmin=(100,'K'), Tmax=(1153.28,'K')), NASAPolynomial(coeffs=[11.0376,0.0536738,-2.3631e-05,4.46131e-09,-3.10909e-13,274.653,-17.1985], Tmin=(1153.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(22.298,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJCC)"""),
)

species(
    label = 'CCCCCC=CO[O](729)',
    structure = SMILES('CCCCCC=CO[O]'),
    E0 = (-20.1556,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.4302,0.0930627,-7.24336e-05,3.02672e-08,-5.24973e-12,-2261.3,37.373], Tmin=(100,'K'), Tmax=(1341.47,'K')), NASAPolynomial(coeffs=[15.8405,0.0445465,-1.81838e-05,3.30673e-09,-2.253e-13,-6626.62,-45.9034], Tmin=(1341.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-20.1556,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ)"""),
)

species(
    label = 'CC=CCCCCO[O](727)',
    structure = SMILES('CC=CCCCCO[O]'),
    E0 = (-36.4257,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0415984,0.0927988,-7.79211e-05,3.8931e-08,-8.64657e-12,-4243.27,34.8213], Tmin=(100,'K'), Tmax=(1025.63,'K')), NASAPolynomial(coeffs=[9.23262,0.0569531,-2.54958e-05,4.85385e-09,-3.40098e-13,-6128.57,-9.75264], Tmin=(1025.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-36.4257,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = 'CC[CH]CC=CCOO(1039)',
    structure = SMILES('CC[CH]CC=CCOO'),
    E0 = (12.7196,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.137509,0.0923102,-8.38464e-05,5.11459e-08,-1.46089e-11,1662.41,37.3459], Tmin=(100,'K'), Tmax=(800.751,'K')), NASAPolynomial(coeffs=[5.9809,0.0631208,-2.91679e-05,5.62342e-09,-3.96516e-13,726.583,10.4534], Tmin=(800.751,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(12.7196,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH]CC=CCO[O](1040)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47254,0.0696403,2.55039e-05,-2.13206e-07,2.07934e-10,19887.8,33.6442], Tmin=(100,'K'), Tmax=(424.453,'K')), NASAPolynomial(coeffs=[5.05314,0.0602613,-2.74528e-05,5.20588e-09,-3.61355e-13,19364.4,16.853], Tmin=(424.453,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(RCCJCC)"""),
)

species(
    label = 'CCC=CC[CH]CO[O](1041)',
    structure = SMILES('CCC=CC[CH]CO[O]'),
    E0 = (165.124,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.080054,0.0916955,-8.14802e-05,4.30057e-08,-9.95894e-12,19996.4,37.6573], Tmin=(100,'K'), Tmax=(996.74,'K')), NASAPolynomial(coeffs=[9.59259,0.0535207,-2.40306e-05,4.58059e-09,-3.21201e-13,18100.1,-8.20409], Tmin=(996.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(165.124,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(CCJCOOH)"""),
)
...
species(
    label = 'C=CCC[CH]CO[O](748)',
    structure = SMILES('C=CCC[CH]CO[O]'),
    E0 = (200.015,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.553809,0.0810817,-7.94626e-05,4.74812e-08,-1.23798e-11,24175.8,33.4846], Tmin=(100,'K'), Tmax=(898.83,'K')), NASAPolynomial(coeffs=[8.45218,0.0459322,-2.08039e-05,3.97381e-09,-2.78744e-13,22755.9,-3.77804], Tmin=(898.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.015,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJCOOH)"""),
)
...
species(
    label = 'CCC[CH]C[CH]CO[O](961)',
    structure = SMILES('CCC[CH]C[CH]CO[O]'),
    E0 = (242.911,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
...
species(
    label = 'C[CH]CCC[CH]CO[O](1049)',
    structure = SMILES('C[CH]CCC[CH]CO[O]'),
    E0 = (242.899,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.485372,0.107505,-0.000136717,1.15159e-07,-4.07474e-11,29367,41.7026], Tmin=(100,'K'), Tmax=(802.926,'K')), NASAPolynomial(coeffs=[6.00818,0.0623413,-2.84044e-05,5.35066e-09,-3.68549e-13,28737.2,14.3725], Tmin=(802.926,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(242.899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(RCCJC)"""),
)

species(
    label = 'CC[CH]CCC[CH]O[O](1050)',
    structure = SMILES('CC[CH]CCC[CH]O[O]'),
    E0 = (231.078,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.490754,0.108955,-0.000143806,1.25702e-07,-4.54866e-11,27944.2,39.3935], Tmin=(100,'K'), Tmax=(813.32,'K')), NASAPolynomial(coeffs=[4.90597,0.0647858,-2.98338e-05,5.63152e-09,-3.8768e-13,27649.3,18.0568], Tmin=(813.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(231.078,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(CCsJOOH)"""),
)

species(
    label = 'CC[CH]CC[CH][CH]OO(1051)',
    structure = SMILES('CC[CH]CC[CH][CH]OO'),
    E0 = (279.488,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.723081,0.114505,-0.00015484,1.3555e-07,-4.90884e-11,33774.5,41.7732], Tmin=(100,'K'), Tmax=(801.923,'K')), NASAPolynomial(coeffs=[5.76828,0.0651141,-3.06341e-05,5.83979e-09,-4.04381e-13,33280.4,15.2996], Tmin=(801.923,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(279.488,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCJCOOH) + radical(CCsJOOH)"""),
)

species(
    label = 'CC[CH][CH]CCCO[O](1052)',
    structure = SMILES('CC[CH][CH]CCCO[O]'),
    E0 = (236.954,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
...
species(
    label = 'CCCC[CH][CH]CO[O](1053)',
    structure = SMILES('CCCC[CH][CH]CO[O]'),
    E0 = (242.911,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCCC[CH]CO[O](1054)',
    structure = SMILES('[CH2]CCCC[CH]CO[O]'),
    E0 = (253.699,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.474671,0.105729,-0.000118271,8.43116e-08,-2.60831e-11,30667.4,40.7324], Tmin=(100,'K'), Tmax=(769.518,'K')), NASAPolynomial(coeffs=[8.55031,0.0588221,-2.68473e-05,5.1162e-09,-3.57166e-13,29278.2,-0.444543], Tmin=(769.518,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(253.699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(RCCJ)"""),
)

species(
    label = 'CCCCC[CH][CH]O[O](1055)',
    structure = SMILES('CCCCC[CH][CH]O[O]'),
    E0 = (237.035,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.077507,0.0985347,-7.75892e-05,-2.52107e-09,3.5513e-11,28638,37.2373], Tmin=(100,'K'), Tmax=(538.441,'K')), NASAPolynomial(coeffs=[7.90373,0.0605314,-2.78157e-05,5.30806e-09,-3.70573e-13,27503.4,1.61471], Tmin=(538.441,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(237.035,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CCsJOOH)"""),
)

species(
    label = 'C[CH][CH]CCCCO[O](1056)',
    structure = SMILES('C[CH][CH]CCCCO[O]'),
    E0 = (236.942,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.284369,0.106309,-0.000146107,1.3399e-07,-4.96398e-11,28640.1,41.2376], Tmin=(100,'K'), Tmax=(834.542,'K')), NASAPolynomial(coeffs=[2.56113,0.0674591,-3.09645e-05,5.81016e-09,-3.97457e-13,29043.1,33.2843], Tmin=(834.542,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(236.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(RCCJC)"""),
)

species(
    label = 'CC[CH]C[CH][CH]COO(1057)',
    structure = SMILES('CC[CH]C[CH][CH]COO'),
    E0 = (285.364,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.486103,0.112418,-0.000162646,1.5264e-07,-5.72549e-11,34469.6,43.3352], Tmin=(100,'K'), Tmax=(829.283,'K')), NASAPolynomial(coeffs=[2.37508,0.0696599,-3.29276e-05,6.25124e-09,-4.30135e-13,34990.8,36.0707], Tmin=(829.283,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(285.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C[CH]CCCCO[O](1058)',
    structure = SMILES('[CH2]C[CH]CCCCO[O]'),
    E0 = (247.742,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2761.11,2772.22,2783.33,2794.44,2805.56,2816.67,2827.78,2838.89,2850,1425,1431.25,1437.5,1443.75,1450,1225,1237.5,1250,1262.5,1275,1270,1287.5,1305,1322.5,1340,700,725,750,775,800,300,325,350,375,400,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.429707,0.106613,-0.000136197,1.16319e-07,-4.17004e-11,29947.1,40.8125], Tmin=(100,'K'), Tmax=(802.561,'K')), NASAPolynomial(coeffs=[5.4339,0.063334,-2.90391e-05,5.48537e-09,-3.78367e-13,29458.6,16.6335], Tmin=(802.561,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(247.742,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(RCCJ)"""),
)

species(
    label = 'CC[CH][CH]C[CH]COO(1059)',
    structure = SMILES('CC[CH][CH]C[CH]COO'),
    E0 = (285.364,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.486103,0.112418,-0.000162646,1.5264e-07,-5.72549e-11,34469.6,43.3352], Tmin=(100,'K'), Tmax=(829.283,'K')), NASAPolynomial(coeffs=[2.37508,0.0696599,-3.29276e-05,6.25124e-09,-4.30135e-13,34990.8,36.0707], Tmin=(829.283,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(285.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = 'C[CH][CH]CC[CH]COO(1060)',
    structure = SMILES('C[CH][CH]CC[CH]COO'),
    E0 = (285.352,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.521808,0.111921,-0.000157368,1.44127e-07,-5.33518e-11,34470.7,43.6355], Tmin=(100,'K'), Tmax=(825.157,'K')), NASAPolynomial(coeffs=[3.44921,0.0677413,-3.17372e-05,6.01175e-09,-4.13592e-13,34664.1,30.3836], Tmin=(825.157,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(285.352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJCC) + radical(RCCJC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(C)CC[CH]CO[O](1030)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CC[CH]CC[CH]CO[O](720)'],
    products = ['O2(S)(666)', 'C=CCC[CH]CC(325)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction7',
    reactants = ['O(4)', 'CC[CH]CC[CH]C[O](1031)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]CO[O](790)', '[CH2]C[CH]CC(101)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]CC(26)', '[CH2]C[CH]CO[O](762)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction10',
    reactants = ['C2H5(14)', '[CH]CC[CH]CO[O](792)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]O[O](46)', '[CH]CC[CH]CC(240)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'CC[CH]CC[C]CO[O](1032)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'CC[C]CC[CH]CO[O](1033)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CC[CH]CC[CH]CO[O](720)'],
    products = ['O(4)', 'CC[CH]CCC1CO1(1035)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'CC[CH]CC=CCO[O](1040)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', 'CCC=CC[CH]CO[O](1041)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', 'CC=CCC[CH]CO[O](1042)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', 'CC[CH]CCC=CO[O](1043)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH3(17)', 'C=CCC[CH]CO[O](748)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O2(2)', 'C=CCC[CH]CC(325)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O2(2)', '[CH2][CH]CC[CH]CC(330)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', 'CC[CH]C[CH][CH]CO[O](1044)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', 'CC[CH][CH]C[CH]CO[O](1045)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CH3(17)', '[CH2][CH]CC[CH]CO[O](741)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', 'C[CH][CH]CC[CH]CO[O](1046)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(3)', 'CC[CH]CC[CH][CH]O[O](1047)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(3)', '[CH2]C[CH]CC[CH]CO[O](1048)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction41',
    reactants = ['CC[CH]CC[CH]CO[O](720)'],
    products = ['C[CH]CCC[CH]CO[O](1049)'],
...
reaction(
    label = 'reaction42',
    reactants = ['CC[CH]CC[CH]CO[O](720)'],
    products = ['CC[CH]CCC[CH]O[O](1050)'],
...
reaction(
    label = 'reaction43',
    reactants = ['CC[CH]CC[CH][CH]OO(1051)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction45',
    reactants = ['CCCC[CH][CH]CO[O](1053)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2]CCCC[CH]CO[O](1054)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction49',
    reactants = ['CC[CH]C[CH][CH]COO(1057)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[CH2]C[CH]CCCCO[O](1058)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction51',
    reactants = ['CC[CH][CH]C[CH]COO(1059)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction52',
    reactants = ['C[CH][CH]CC[CH]COO(1060)'],
    products = ['CC[CH]CC[CH]CO[O](720)'],
