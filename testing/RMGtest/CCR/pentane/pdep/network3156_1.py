...
species(
    label = '[CH]C(C=[CH])C([CH2])CC(13902)',
    structure = SMILES('[CH]C(C=[CH])C([CH2])CC'),
    E0 = (778.432,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.506224,0.0880159,-7.09304e-05,3.05059e-08,-5.30917e-12,93795.2,37.9015], Tmin=(100,'K'), Tmax=(1372.21,'K')), NASAPolynomial(coeffs=[17.8225,0.0345877,-1.25268e-05,2.13147e-09,-1.39713e-13,88765,-56.3236], Tmin=(1372.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(778.432,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(CC)C([CH2])C=[CH](13903)',
    structure = SMILES('[CH]C(CC)C([CH2])C=[CH]'),
    E0 = (778.432,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[C]=CC([CH2])C([CH2])CC(13904)',
    structure = SMILES('[C]=CC([CH2])C([CH2])CC'),
    E0 = (846.305,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3010,987.5,1337.5,450,1655,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0858358,0.0859397,-7.26054e-05,3.48535e-08,-6.96075e-12,101937,37.137], Tmin=(100,'K'), Tmax=(1186.15,'K')), NASAPolynomial(coeffs=[13.3417,0.0406587,-1.53433e-05,2.66978e-09,-1.77535e-13,98751.9,-29.9354], Tmin=(1186.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(846.305,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Isobutyl) + radical(CdCdJ2_triplet)"""),
)
...
species(
    label = '[CH2]C1C=CCC1CC(13906)',
    structure = SMILES('[CH2]C1C=CCC1CC'),
    E0 = (138.725,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.897999,0.0458837,6.05706e-05,-1.08339e-07,4.41094e-11,16816.6,28.4024], Tmin=(100,'K'), Tmax=(962.521,'K')), NASAPolynomial(coeffs=[16.2193,0.0376136,-1.2879e-05,2.33348e-09,-1.68281e-13,11300.9,-58.26], Tmin=(962.521,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopentene) + radical(Isobutyl)"""),
)

species(
    label = '[CH]=CC(C)C(=C)CC(13907)',
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0461749,0.0852512,-6.23707e-05,2.433e-08,-3.96549e-12,29083,31.0041], Tmin=(100,'K'), Tmax=(1407.34,'K')), NASAPolynomial(coeffs=[14.643,0.0435013,-1.78724e-05,3.25101e-09,-2.21037e-13,24948.4,-44.8819], Tmin=(1407.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(240.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    label = 'C#CC([CH2])C([CH2])CC(13911)',
    structure = SMILES('C#CC([CH2])C([CH2])CC'),
    E0 = (453.153,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2175,525,750,770,3400,2100,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.417402,0.0874062,-7.51049e-05,3.66553e-08,-7.2677e-12,54669,35.7559], Tmin=(100,'K'), Tmax=(1239.54,'K')), NASAPolynomial(coeffs=[15.3497,0.0356094,-1.13154e-05,1.75086e-09,-1.07638e-13,50830.6,-43.4134], Tmin=(1239.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(453.153,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CtCsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH]=C[C](C)C([CH2])CC(13916)',
    structure = SMILES('[CH]C=C(C)C([CH2])CC'),
    E0 = (432.816,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.344228,0.0869485,-5.7229e-05,2.01451e-08,-2.97145e-12,52219,35.3759], Tmin=(100,'K'), Tmax=(1541,'K')), NASAPolynomial(coeffs=[15.2757,0.0464034,-1.77624e-05,3.07092e-09,-2.01455e-13,47405,-46.7355], Tmin=(1541,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(432.816,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]=CC(C)C([CH2])C[CH2](13921)',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH]=CC([CH2])C([CH2])C(4994)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
    products = ['[CH]=CC[CH]C([CH2])CC(13900)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(6.55606e+10,'s^-1'), n=0.64, Ea=(159.935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [cCs(-HC)CJ;CsJ;C] for rate rule [cCs(-HC)CJ;CsJ-HH;C]
Euclidian distance = 1.0
family: 1,2_shiftC"""),
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
    products = ['C2H2(1342)', '[CH2]C(C=C)CC(228)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(T)(20)', '[CH]=CC([CH2])[CH]CC(13813)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(T)(20)', '[CH]=C[CH]C([CH2])CC(13901)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]C(C=[CH])C([CH2])CC(13902)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH]C(CC)C([CH2])C=[CH](13903)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[C]=CC([CH2])C([CH2])CC(13904)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH]=CC([CH2])C(=C)CC(13909)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH]=CC(=C)C([CH2])CC(13910)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', 'C#CC([CH2])C([CH2])CC(13911)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.00168615,'m^3/(mol*s)'), n=2.52599, Ea=(57.8361,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cds-CsH_Cds-HH;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 53.1 to 57.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction24',
    reactants = ['C2H5(14)', '[CH]=CC([CH2])C=C(13693)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C2H2(T)(1343)', '[CH2]C(C=C)CC(228)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C2H2(1342)', '[CH2][CH]C([CH2])CC(231)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C2H5(14)', '[CH][CH]C([CH2])C=C(7163)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', '[CH]=CC([CH2])[C]([CH2])CC(13912)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
...
reaction(
    label = 'reaction31',
    reactants = ['C2H2(T)(1343)', '[CH2][CH]C([CH2])CC(231)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', '[CH]=C[C]([CH2])C([CH2])CC(13913)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CH3(17)', '[CH]=CC([CH2])C([CH2])[CH2](5215)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(3)', '[CH]=CC([CH2])C([CH2])C[CH2](5646)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', '[CH]=[C]C([CH2])C([CH2])CC(13914)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH]=C[C](C)C([CH2])CC(13916)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
    products = ['[CH2]C([C]=C)C([CH2])CC(5093)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
    products = ['[CH]=CC(C)[C]([CH2])CC(13918)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH]=[C]C(C)C([CH2])CC(13919)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
    products = ['[CH]=CC(C)C([CH2])[CH]C(5836)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH]=CC([CH2])C(C)C[CH2](5781)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH]=CC(C)C([CH2])C[CH2](13921)'],
    products = ['[CH]=CC([CH2])C([CH2])CC(5094)'],
