...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0109952,0.0715079,-8.34746e-05,4.38764e-08,-8.46166e-12,129693,25.3804], Tmin=(100,'K'), Tmax=(1463.74,'K')), NASAPolynomial(coeffs=[22.2136,-0.000699677,2.27974e-06,-5.36035e-10,3.84275e-14,124416,-86.1089], Tmin=(1463.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1077.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(Cds_S) + radical(CH2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C]=CO[CH][CH](18759)',
    structure = SMILES('[CH][C]=CO[CH][CH]'),
    E0 = (1029.14,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,1685,370,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0415011,0.0750154,-8.54511e-05,4.62384e-08,-9.41019e-12,123929,26.7568], Tmin=(100,'K'), Tmax=(1333.59,'K')), NASAPolynomial(coeffs=[20.322,0.00706823,-1.01968e-06,2.87384e-11,2.70262e-15,119153,-74.5501], Tmin=(1333.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1029.14,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOC(O)) + radical(Cds_S) + radical(CCJ2_triplet) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH][CH]O[C]=[C][CH2](18761)',
    structure = SMILES('[CH][CH]O[C]=[C][CH2]'),
    E0 = (1049.7,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1670,1700,300,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.657873,0.0695468,-8.72967e-05,5.027e-08,-1.04605e-11,126373,26.8464], Tmin=(100,'K'), Tmax=(935.387,'K')), NASAPolynomial(coeffs=[17.6043,0.00664775,-1.77585e-06,2.54303e-10,-1.58305e-14,122784,-56.0159], Tmin=(935.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1049.7,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOC(O)) + radical(Allyl_P) + radical(Cds_S) + radical(C=CJO) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]O[C]=C[CH2](18762)',
    structure = SMILES('[CH][CH]O[C]=C[CH2]'),
    E0 = (811.853,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.287119,0.069685,-7.89609e-05,4.2155e-08,-8.4364e-12,97787.3,27.7041], Tmin=(100,'K'), Tmax=(1356.83,'K')), NASAPolynomial(coeffs=[19.8491,0.00534457,-4.56911e-07,-4.06836e-11,5.88924e-15,93092.9,-70.3779], Tmin=(1356.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(811.853,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOC(O)) + radical(Allyl_P) + radical(C=CJO) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]CO[C]=[C][CH2](18763)',
    structure = SMILES('[CH]CO[C]=[C][CH2]'),
    E0 = (855.768,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1670,1700,300,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.987394,0.0606034,-6.20345e-05,2.97653e-08,-4.96049e-12,103039,26.1894], Tmin=(100,'K'), Tmax=(1001.46,'K')), NASAPolynomial(coeffs=[15.3047,0.0127839,-4.43871e-06,7.63013e-10,-5.17889e-14,99701.2,-45.2491], Tmin=(1001.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(855.768,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(CCJ2_triplet) + radical(Cds_S) + radical(C=CJO)"""),
)

species(
    label = '[CH][CH]O[C]=[C]C(18764)',
    structure = SMILES('[CH][CH]O[C]=[C]C'),
    E0 = (898.196,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1670,1700,300,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.717615,0.0713225,-9.32794e-05,6.02569e-08,-1.50295e-11,108147,26.3531], Tmin=(100,'K'), Tmax=(991.923,'K')), NASAPolynomial(coeffs=[15.2101,0.012878,-4.8954e-06,8.52016e-10,-5.67126e-14,105272,-43.4468], Tmin=(991.923,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(898.196,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOC(O)) + radical(Cds_S) + radical(C=CJO) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.378504,0.075536,-7.76191e-05,3.77416e-08,-6.82701e-12,95346.2,27.8058], Tmin=(100,'K'), Tmax=(1566.65,'K')), NASAPolynomial(coeffs=[21.5112,0.00732899,-5.20122e-07,-8.54825e-11,1.0162e-14,89999.1,-82.8024], Tmin=(1566.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(791.294,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCsJOC(O)) + radical(AllylJ2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]OC[C]=[CH](16570)',
    structure = SMILES('[CH][CH]OC[C]=[CH]'),
    E0 = (949.795,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.952835,0.0722836,-0.000112537,9.32388e-08,-3.02478e-11,114339,26.3524], Tmin=(100,'K'), Tmax=(852.973,'K')), NASAPolynomial(coeffs=[9.80052,0.0224737,-1.0314e-05,1.90977e-09,-1.28748e-13,113132,-13.1516], Tmin=(852.973,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(949.795,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOCs) + radical(Cds_S) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[CH]CO[CH][C]=[CH](18767)',
    structure = SMILES('[CH][C]=COC[CH]'),
    E0 = (835.209,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,1685,370,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.812172,0.060857,-4.19003e-05,1.95543e-09,6.25787e-12,100576,24.5183], Tmin=(100,'K'), Tmax=(944.972,'K')), NASAPolynomial(coeffs=[16.8853,0.0151571,-4.81454e-06,8.05628e-10,-5.55372e-14,96540.6,-57.3925], Tmin=(944.972,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(835.209,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCJ2_triplet) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[C]=CO[CH][C][CH2](18768)',
    structure = SMILES('[C][CH]OC=[C][CH2]'),
    E0 = (1031.21,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,1685,370,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.17082,'amu*angstrom^2'), symmetry=1, barrier=(26.9194,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17132,'amu*angstrom^2'), symmetry=1, barrier=(26.9309,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.17123,'amu*angstrom^2'), symmetry=1, barrier=(26.9288,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 7,
    opticalIsomers = 1,
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.277805,0.0753736,-9.07099e-05,4.85041e-08,-9.4249e-12,124196,24.5262], Tmin=(100,'K'), Tmax=(1476.65,'K')), NASAPolynomial(coeffs=[23.3582,-0.00318919,3.86178e-06,-8.59089e-10,6.10737e-14,118801,-93.35], Tmin=(1476.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1031.21,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(CCsJOC(O)) + radical(Cds_S) + radical(CJ3)"""),
)

species(
    label = '[CH2][C]C1C=CO1(18769)',
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59377,0.028132,5.8752e-05,-1.14473e-07,5.08068e-11,71332.9,20.3504], Tmin=(100,'K'), Tmax=(926.389,'K')), NASAPolynomial(coeffs=[23.3979,-0.00212266,4.28633e-06,-8.28067e-10,4.66512e-14,64551.5,-97.9722], Tmin=(926.389,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(592.184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]=[C]OC[C][CH2](9856)',
    structure = SMILES('[CH]=[C]OC[C][CH2]'),
    E0 = (931.015,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,180,180,498.684,690.28],'cm^-1')),
        HinderedRotor(inertia=(0.0437314,'amu*angstrom^2'), symmetry=1, barrier=(15.5834,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.678348,'amu*angstrom^2'), symmetry=1, barrier=(15.5965,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0890706,'amu*angstrom^2'), symmetry=1, barrier=(31.0361,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.6799,'amu*angstrom^2'), symmetry=1, barrier=(15.6322,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.873806,0.0632723,-7.08229e-05,3.92126e-08,-8.38427e-12,112092,27.3727], Tmin=(100,'K'), Tmax=(1155.17,'K')), NASAPolynomial(coeffs=[15.7251,0.0118478,-4.049e-06,6.7711e-10,-4.46428e-14,108661,-46.4187], Tmin=(1155.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(931.015,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(CCJ2_triplet) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]O[CH][C]C(18770)',
    structure = SMILES('[CH]=[C]O[CH][C]C'),
    E0 = (919.696,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,247.292,247.532,247.551,247.608],'cm^-1')),
        HinderedRotor(inertia=(0.436457,'amu*angstrom^2'), symmetry=1, barrier=(18.9217,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.438405,'amu*angstrom^2'), symmetry=1, barrier=(18.9283,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.434464,'amu*angstrom^2'), symmetry=1, barrier=(18.9229,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.436328,'amu*angstrom^2'), symmetry=1, barrier=(18.9197,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.546918,0.0710244,-8.41057e-05,4.56165e-08,-8.72811e-12,110743,26.2331], Tmin=(100,'K'), Tmax=(946.683,'K')), NASAPolynomial(coeffs=[17.9628,0.00844937,-2.40522e-06,3.69368e-10,-2.40812e-14,106952,-59.4405], Tmin=(946.683,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(919.696,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(CCJ2_triplet) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH][CH]O[CH][C]=C(16569)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH][CH](6981)', '[CH2][C]=C[O](16852)'],
    products = ['[CH][CH]O[CH][C]=C(16569)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH][C]OC=[C][CH2](18758)'],
    products = ['[CH][CH]O[CH][C]=C(16569)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH][C]=CO[CH][CH](18759)'],
    products = ['[CH][CH]O[CH][C]=C(16569)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]=CO[C]=[C][CH2](18064)'],
    products = ['[CH][CH]O[CH][C]=C(16569)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['[CH][CH]O[CH][C]=C(16569)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.41198,'m^3/(mol*s)'), n=2.03228, Ea=(44.7863,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 41.9 to 44.8 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH][CH]O[C]=[C][CH2](18761)'],
    products = ['[CH][CH]O[CH][C]=C(16569)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH][CH]O[CH][C]=C(16569)'],
    products = ['[CH][CH]O[C]=C[CH2](18762)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH]=[C][CH]OC=[CH](18060)'],
    products = ['[CH][CH]O[CH][C]=C(16569)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH][CH](6981)', 'CH2CCHO(16849)'],
    products = ['[CH][CH]O[CH][C]=C(16569)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH][CH]O[CH][C]=C(16569)'],
    products = ['[CH][CH]O[CH]C=[CH](18766)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH][CH]O[CH][C]=C(16569)'],
    products = ['C2H2(1342)', '[CH2][C]=C[O](16852)'],
...
reaction(
    label = 'reaction20',
    reactants = ['ketene(T)(1373)', '[CH][C][CH2](17602)'],
    products = ['[CH][CH]O[CH][C]=C(16569)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[C]=CO[CH][C][CH2](18768)'],
    products = ['[CH][CH]O[CH][C]=C(16569)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C2H2(T)(1343)', '[CH2][C]=C[O](16852)'],
    products = ['[CH][CH]O[CH][C]=C(16569)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C2H2(T)(1343)', '[CH2][C][CH][O](17607)'],
    products = ['[CH][CH]O[CH][C]=C(16569)'],
