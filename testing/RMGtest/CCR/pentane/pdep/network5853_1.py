...
species(
    label = '[CH2]COC=C([CH2])[O](25255)',
    structure = SMILES('[CH2]COC=C([CH2])[O]'),
    E0 = (72.2194,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.938547,0.0856143,-9.21128e-05,4.67933e-08,-8.75446e-12,8883.56,31.1035], Tmin=(100,'K'), Tmax=(1536.93,'K')), NASAPolynomial(coeffs=[23.4697,0.00604983,1.19402e-06,-4.70194e-10,3.8009e-14,3275.22,-90.9797], Tmin=(1536.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.2194,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(C)OJ) + radical(CJCO) + radical(C=C(O)CJ)"""),
)
...
species(
    label = '[CH2]CO[C][C]([CH2])[O](26236)',
    structure = SMILES('[CH2]CO[C][C]([CH2])[O]'),
    E0 = (821.532,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.224723,0.101781,-0.000171983,1.47441e-07,-4.86606e-11,98951.1,29.9842], Tmin=(100,'K'), Tmax=(858.894,'K')), NASAPolynomial(coeffs=[12.4658,0.0267282,-1.30513e-05,2.45746e-09,-1.66162e-13,97359.5,-25.8851], Tmin=(858.894,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(821.532,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CJCO) + radical(CJCO) + radical(CH2_triplet)"""),
)
...
species(
    label = '[CH][C]([O])[CH]OC[CH2](26238)',
    structure = SMILES('[CH][C]([O])[CH]OC[CH2]'),
    E0 = (777.625,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,360,370,350,3000,3100,440,815,1455,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.236866,0.10099,-0.000166672,1.39473e-07,-4.48916e-11,93671.9,31.1121], Tmin=(100,'K'), Tmax=(874.323,'K')), NASAPolynomial(coeffs=[13.0976,0.0253282,-1.1718e-05,2.14774e-09,-1.42718e-13,91900.4,-28.224], Tmin=(874.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(777.625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCsJOCs) + radical(C2CsJOH) + radical(CJCO) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.377348,0.08474,-9.327e-05,4.99424e-08,-1.02035e-11,28650.3,28.8645], Tmin=(100,'K'), Tmax=(1267.9,'K')), NASAPolynomial(coeffs=[21.6164,0.0119569,-3.14475e-06,4.41231e-10,-2.64077e-14,23346.2,-81.3864], Tmin=(1267.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(236.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CJCO)"""),
)
...
species(
    label = '[CH2][CH]OC[C]([CH2])[O](26243)',
    structure = SMILES('[CH2][CH]OC[C]([CH2])[O]'),
    E0 = (540.999,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][CH]O[CH]C([CH2])[O](26244)',
    structure = SMILES('[CH2][CH]O[CH]C([CH2])[O]'),
    E0 = (544.827,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.406151,0.100361,-0.000144666,1.03568e-07,-2.83573e-11,65683.2,31.3787], Tmin=(100,'K'), Tmax=(793.267,'K')), NASAPolynomial(coeffs=[16.9763,0.0205182,-8.45047e-06,1.49724e-09,-9.90226e-14,62679.8,-50.0038], Tmin=(793.267,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(544.827,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CJCO) + radical(CJCO)"""),
)

species(
    label = '[CH2][CH]O[CH][C]([CH2])O(26245)',
    structure = SMILES('[CH2][CH]O[CH][C]([CH2])O'),
    E0 = (491.094,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.833271,0.114518,-0.000193286,1.59266e-07,-4.97271e-11,59231.3,32.5197], Tmin=(100,'K'), Tmax=(908.536,'K')), NASAPolynomial(coeffs=[15.9528,0.0218749,-9.39309e-06,1.62618e-09,-1.02754e-13,56954.6,-42.597], Tmin=(908.536,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(491.094,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CJCO) + radical(CJCO)"""),
)

species(
    label = '[CH2][CH]O[CH][C](C)[O](26246)',
    structure = SMILES('[CH2][CH]O[CH][C](C)[O]'),
    E0 = (509.866,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.495614,0.105062,-0.000166653,1.33797e-07,-4.1432e-11,61478.8,30.4828], Tmin=(100,'K'), Tmax=(883.677,'K')), NASAPolynomial(coeffs=[14.9749,0.0240349,-1.04427e-05,1.86285e-09,-1.21936e-13,59174,-39.8105], Tmin=(883.677,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(509.866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CO[CH][C]([CH2])[O](25260)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]CO[CH][C]([CH2])[O](25260)'],
    products = ['[CH2]COC=C([CH2])[O](25255)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C[O](1358)', '[CH][C]([CH2])[O](13252)'],
    products = ['[CH2]CO[CH][C]([CH2])[O](25260)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[CH2]O[CH][C]([CH2])[O](26235)'],
    products = ['[CH2]CO[CH][C]([CH2])[O](25260)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2]CO[C][C]([CH2])[O](26236)'],
    products = ['[CH2]CO[CH][C]([CH2])[O](25260)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]CO[CH][C]([CH2])[O](26237)'],
    products = ['[CH2]CO[CH][C]([CH2])[O](25260)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH][C]([O])[CH]OC[CH2](26238)'],
    products = ['[CH2]CO[CH][C]([CH2])[O](25260)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH2][C]([O])[CH]OC=C(25470)'],
    products = ['[CH2]CO[CH][C]([CH2])[O](25260)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(2.182e+10,'cm^3/(mol*s)'), n=0.859, Ea=(66.7905,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [Cds-OsH_Cds;HJ]
Euclidian distance = 0
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.82396,'m^3/(mol*s)'), n=2.03228, Ea=(201.896,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 200.6 to 201.9 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2][CH]O[CH][C]([CH2])[O](26241)'],
    products = ['[CH2]CO[CH][C]([CH2])[O](25260)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]CO[CH][C]([CH2])[O](25260)'],
    products = ['[CH2][C]([O])[CH]O[CH]C(26242)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH]OC[C]([CH2])[O](26243)'],
    products = ['[CH2]CO[CH][C]([CH2])[O](25260)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][CH]O[CH]C([CH2])[O](26244)'],
    products = ['[CH2]CO[CH][C]([CH2])[O](25260)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]CO[CH][C]([CH2])[O](25260)'],
    products = ['[CH2][CH]O[CH][C]([CH2])O(26245)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]CO[CH][C]([CH2])[O](25260)'],
    products = ['[CH2][CH]O[CH][C](C)[O](26246)'],
...
network(
    label = 'PDepNetwork #5853',
    isomers = [
        '[CH2]CO[CH][C]([CH2])[O](25260)',
    ],
    reactants = [
