...
species(
    label = '[CH]C([O])[CH]C([CH2])C(9461)',
    structure = SMILES('[CH]C([O])[CH]C([CH2])C'),
    E0 = (713.531,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.314213,0.0722133,-6.20773e-05,2.8431e-08,-5.22418e-12,85958.1,34.4945], Tmin=(100,'K'), Tmax=(1312.42,'K')), NASAPolynomial(coeffs=[15.5164,0.0258788,-9.11896e-06,1.52914e-09,-9.95755e-14,81967.9,-42.9799], Tmin=(1312.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(713.531,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][CH]C(C)[CH][CH2](9462)',
    structure = SMILES('[CH][CH]C(C)[CH][CH2]'),
    E0 = (848.334,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,181.978,615.136,1650.86,2222.21,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0948923,'amu*angstrom^2'), symmetry=1, barrier=(2.22179,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0948923,'amu*angstrom^2'), symmetry=1, barrier=(2.22179,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0948923,'amu*angstrom^2'), symmetry=1, barrier=(2.22179,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0948923,'amu*angstrom^2'), symmetry=1, barrier=(2.22179,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0948923,'amu*angstrom^2'), symmetry=1, barrier=(2.22179,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94389,0.050695,-2.99483e-05,8.75527e-09,-1.0925e-12,102099,29.0719], Tmin=(100,'K'), Tmax=(1632.92,'K')), NASAPolynomial(coeffs=[8.28563,0.0351602,-1.5678e-05,2.92915e-09,-2.00522e-13,100028,-4.63313], Tmin=(1632.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(848.334,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Cs_S) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.49788,0.0747275,-7.16031e-05,3.62098e-08,-7.39998e-12,116233,31.2468], Tmin=(100,'K'), Tmax=(1174.49,'K')), NASAPolynomial(coeffs=[14.2978,0.027729,-1.15791e-05,2.13892e-09,-1.47726e-13,112992,-37.5491], Tmin=(1174.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(965.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJ) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]C(C)C([CH])[O](9464)',
...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.710905,0.0775817,-9.43753e-05,6.85196e-08,-2.08833e-11,106953,32.5685], Tmin=(100,'K'), Tmax=(789.86,'K')), NASAPolynomial(coeffs=[8.74903,0.0368733,-1.70638e-05,3.26333e-09,-2.27976e-13,105683,-4.31428], Tmin=(789.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(888.31,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(Cs_S) + radical(C2CsJOH) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.518677,0.0684572,-5.20425e-05,2.03967e-08,-3.23964e-12,80680,31.4703], Tmin=(100,'K'), Tmax=(1482.26,'K')), NASAPolynomial(coeffs=[15.5178,0.0279808,-1.10816e-05,1.97388e-09,-1.32419e-13,76233.5,-46.795], Tmin=(1482.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(669.714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJ(C)CO) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C](O)C(C)[CH][CH2](9470)',
    structure = SMILES('[CH][C](O)C(C)[CH][CH2]'),
    E0 = (657.949,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.669515,0.0797763,-9.1789e-05,5.81244e-08,-1.30974e-11,79247,32.9296], Tmin=(100,'K'), Tmax=(648.652,'K')), NASAPolynomial(coeffs=[8.78294,0.0387414,-1.77028e-05,3.36517e-09,-2.34267e-13,78005.1,-4.16005], Tmin=(648.652,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(657.949,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(Cs_S) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C]([O])C(C)C[CH2](9471)',
    structure = SMILES('[CH][C]([O])C(C)C[CH2]'),
    E0 = (693.768,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.583591,0.0780719,-8.04759e-05,4.6972e-08,-1.14182e-11,83561.6,30.4677], Tmin=(100,'K'), Tmax=(981.511,'K')), NASAPolynomial(coeffs=[10.989,0.0356653,-1.56667e-05,2.9512e-09,-2.05547e-13,81519,-19.5383], Tmin=(981.511,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(693.768,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00742,0.0659766,-5.1764e-05,2.19073e-08,-3.91311e-12,76347.4,32.4529], Tmin=(100,'K'), Tmax=(1284.48,'K')), NASAPolynomial(coeffs=[11.132,0.0344477,-1.49449e-05,2.79757e-09,-1.93767e-13,73746.4,-18.927], Tmin=(1284.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(633.896,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(Cs_S) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', '[CH]C([O])C[CH][CH2](1896)'],
    products = ['[CH]C([O])C(C)[CH][CH2](4398)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]C([O])[CH]C([CH2])C(9461)'],
    products = ['[CH]C([O])C(C)[CH][CH2](4398)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH][CH2](502)', '[CH]C([O])[CH]C(6996)'],
    products = ['[CH]C([O])C(C)[CH][CH2](4398)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O(4)', '[CH][CH]C(C)[CH][CH2](9462)'],
    products = ['[CH]C([O])C(C)[CH][CH2](4398)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]C([O])C(C)[C][CH2](9463)'],
    products = ['[CH]C([O])C(C)[CH][CH2](4398)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH][CH]C(C)C([CH])[O](9464)'],
    products = ['[CH]C([O])C(C)[CH][CH2](4398)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]C([O])C(C)[CH][CH2](4398)'],
    products = ['[CH]C(O)C(C)=C[CH2](9466)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]C([O])C(C)[CH][CH2](4398)'],
    products = ['[CH]=C([O])C(C)C[CH2](4222)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH]C([O])[C](C)C=C(7177)'],
    products = ['[CH]C([O])C(C)[CH][CH2](4398)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH](6993)', '[CH2][CH]C(C)C=O(3828)'],
    products = ['[CH]C([O])C(C)[CH][CH2](4398)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(17)', '[CH]C([O])[CH]C=C(7162)'],
    products = ['[CH]C([O])C(C)[CH][CH2](4398)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(110.898,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 106.1 to 110.9 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction20',
    reactants = ['CH3(17)', '[CH]C([O])[CH][CH][CH2](7252)'],
    products = ['[CH]C([O])C(C)[CH][CH2](4398)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH]C([O])[C](C)[CH][CH2](9467)'],
    products = ['[CH]C([O])C(C)[CH][CH2](4398)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH][C]([O])C(C)[CH][CH2](9468)'],
    products = ['[CH]C([O])C(C)[CH][CH2](4398)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]C([O])C(C)[CH][CH2](4398)'],
    products = ['[CH]C([O])[C](C)C[CH2](9469)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]C([O])C(C)[CH][CH2](4398)'],
    products = ['[CH][C](O)C(C)[CH][CH2](9470)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]C([O])C(C)[CH][CH2](4398)'],
    products = ['[CH][C]([O])C(C)C[CH2](9471)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]C([O])C(C)[CH][CH2](4398)'],
    products = ['[CH]C(O)[C](C)[CH][CH2](9472)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]C(O)C([CH2])[CH][CH2](9473)'],
    products = ['[CH]C([O])C(C)[CH][CH2](4398)'],
