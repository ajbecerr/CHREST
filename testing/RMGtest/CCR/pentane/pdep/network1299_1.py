...
species(
    label = '[CH2]C=CCCC([CH2])C(5164)',
    structure = SMILES('[CH2]C=CCCC([CH2])C'),
    E0 = (226.999,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=CCC[CH]CC(5165)',
    structure = SMILES('[CH]=CCC[CH]CC'),
    E0 = (353.692,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30519,0.0640791,-3.64852e-05,1.05072e-08,-1.29963e-12,42631,29.4251], Tmin=(100,'K'), Tmax=(1646.85,'K')), NASAPolynomial(coeffs=[9.12014,0.0450977,-1.91966e-05,3.50864e-09,-2.37224e-13,40057,-12.1762], Tmin=(1646.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(353.692,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(Cds_P)"""),
)
...
species(
    label = '[CH2]C=CCC[C]CC(5166)',
    structure = SMILES('[CH2]C=CCC[C]CC'),
    E0 = (475.826,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.508276,0.0865405,-6.07395e-05,2.17517e-08,-3.15478e-12,57401.4,35.0107], Tmin=(100,'K'), Tmax=(1610.4,'K')), NASAPolynomial(coeffs=[19.604,0.0365849,-1.42089e-05,2.48928e-09,-1.64491e-13,50923.6,-71.6027], Tmin=(1610.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(475.826,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.97549,0.0422711,7.69197e-05,-1.21903e-07,4.718e-11,-9235.24,25.5821], Tmin=(100,'K'), Tmax=(985.299,'K')), NASAPolynomial(coeffs=[15.4335,0.0435964,-1.64715e-05,3.11144e-09,-2.2662e-13,-14997.8,-58.7396], Tmin=(985.299,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-77.8709,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclohexene)"""),
)

species(
    label = 'CC=CCC=CCC(5168)',
    structure = SMILES('CC=CCC=CCC'),
    E0 = (-5.9469,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.135095,0.0728086,-2.48946e-05,-1.0033e-08,6.50708e-12,-565.979,33.23], Tmin=(100,'K'), Tmax=(1133.07,'K')), NASAPolynomial(coeffs=[13.8683,0.0462614,-1.87875e-05,3.45827e-09,-2.39167e-13,-5086.11,-40.9535], Tmin=(1133.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-5.9469,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'C=C=CCCCCC(4867)',
    structure = SMILES('C=C=CCCCCC'),
    E0 = (52.7162,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.302058,0.0842664,-5.40014e-05,1.74541e-08,-2.29839e-12,6503.57,33.1384], Tmin=(100,'K'), Tmax=(1735.04,'K')), NASAPolynomial(coeffs=[18.8811,0.0400421,-1.57688e-05,2.76406e-09,-1.81759e-13,-153.284,-69.9801], Tmin=(1735.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.7162,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'CC=CCCC=CC(3848)',
    structure = SMILES('CC=CCCC=CC'),
    E0 = (-8.3512,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0143113,0.0773584,-4.09785e-05,8.18175e-09,-2.7365e-15,-850.959,32.3972], Tmin=(100,'K'), Tmax=(1384.56,'K')), NASAPolynomial(coeffs=[15.5332,0.0442349,-1.78701e-05,3.20705e-09,-2.15319e-13,-6286.67,-51.7518], Tmin=(1384.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-8.3512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = '[CH2][CH]C[CH]C[CH]CC(5169)',
    structure = SMILES('[CH2][CH]C[CH]C[CH]CC'),
    E0 = (549.184,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2][CH]CC[CH][CH]CC(5170)',
    structure = SMILES('[CH2][CH]CC[CH][CH]CC'),
    E0 = (549.184,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,3000,3100,440,815,1455,1000,271.45,1024.88,2442.93,3402.92,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0954841,'amu*angstrom^2'), symmetry=1, barrier=(2.91548,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C[CH]C[CH][CH]CC(5171)',
    structure = SMILES('[CH2]C[CH]C[CH][CH]CC'),
    E0 = (549.196,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,3000,3100,440,815,1455,1000,208.378,1482.69,1596.53,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0763557,'amu*angstrom^2'), symmetry=1, barrier=(2.17749,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0763557,'amu*angstrom^2'), symmetry=1, barrier=(2.17749,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0763557,'amu*angstrom^2'), symmetry=1, barrier=(2.17749,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0763557,'amu*angstrom^2'), symmetry=1, barrier=(2.17749,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0763557,'amu*angstrom^2'), symmetry=1, barrier=(2.17749,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.39913,0.0589355,-2.1307e-05,1.79894e-09,1.59451e-13,66027.9,29.9686], Tmin=(100,'K'), Tmax=(2625.2,'K')), NASAPolynomial(coeffs=[50.3792,0.00875924,-4.86866e-06,7.30636e-10,-3.46183e-14,33985,-256.076], Tmin=(2625.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(549.196,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC) + radical(RCCJCC) + radical(RCCJ)"""),
)

species(
    label = 'CC[CH]CCC1[CH]C1(5172)',
    structure = SMILES('CC[CH]CCC1[CH]C1'),
    E0 = (334.501,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.450588,0.0684906,-2.40536e-05,-3.59638e-09,2.89177e-12,40366.7,35.5319], Tmin=(100,'K'), Tmax=(1312.59,'K')), NASAPolynomial(coeffs=[12.0185,0.0491489,-2.01325e-05,3.64672e-09,-2.46635e-13,35959.3,-28.6441], Tmin=(1312.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(334.501,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(cyclopropane) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C1[CH]CCC1CC(5085)',
    structure = SMILES('[CH2]C1[CH]CCC1CC'),
    E0 = (218.527,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03835,0.0437648,6.60097e-05,-1.0957e-07,4.33293e-11,26408.5,32.0568], Tmin=(100,'K'), Tmax=(969.012,'K')), NASAPolynomial(coeffs=[13.938,0.0434338,-1.5393e-05,2.78998e-09,-1.98769e-13,21424.1,-42.5902], Tmin=(969.012,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(218.527,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(519.654,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopentane) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C=CCC=CCC(5174)',
    structure = SMILES('[CH2]C=CCC=CCC'),
    E0 = (145.552,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.188725,0.0697737,-1.49185e-05,-2.45254e-08,1.26747e-11,17655.2,33.312], Tmin=(100,'K'), Tmax=(1049.8,'K')), NASAPolynomial(coeffs=[15.2213,0.0417297,-1.66186e-05,3.08024e-09,-2.16205e-13,12888,-47.6146], Tmin=(1049.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(145.552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0956984,0.0797058,-4.73825e-05,1.41261e-08,-1.73152e-12,26852.4,35.6594], Tmin=(100,'K'), Tmax=(1811.71,'K')), NASAPolynomial(coeffs=[16.6257,0.0432092,-1.71648e-05,3.0065e-09,-1.97086e-13,20863,-53.9115], Tmin=(1811.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(222.057,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(Allyl_P)"""),
)

species(
    label = 'C[C]=CCC[CH]CC(5182)',
    structure = SMILES('C[C]=CCC[CH]CC'),
    E0 = (308.412,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4458,0.067286,1.19548e-05,-1.29973e-07,1.15816e-10,37173.9,31.0583], Tmin=(100,'K'), Tmax=(453.116,'K')), NASAPolynomial(coeffs=[3.53011,0.0642973,-2.91683e-05,5.59153e-09,-3.93653e-13,36826.8,20.9069], Tmin=(453.116,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(308.412,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C=C[CH]CCCC(5183)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0730568,0.0763564,-2.68608e-05,-1.17196e-08,7.77135e-12,20450.5,32.4182], Tmin=(100,'K'), Tmax=(1102.5,'K')), NASAPolynomial(coeffs=[15.136,0.0457043,-1.85291e-05,3.42159e-09,-2.37807e-13,15606.2,-49.2016], Tmin=(1102.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(168.724,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C=CCCCC[CH2](5184)',
    structure = SMILES('[CH2]C=CCCCC[CH2]'),
    E0 = (232.857,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.342776,0.0834243,-4.93276e-05,1.1811e-08,-3.26081e-13,28172.6,36.2907], Tmin=(100,'K'), Tmax=(1270.53,'K')), NASAPolynomial(coeffs=[16.5757,0.0432422,-1.73332e-05,3.12734e-09,-2.12062e-13,22817.6,-53.5373], Tmin=(1270.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(232.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ) + radical(Allyl_P)"""),
)

species(
    label = 'CC=[C]CC[CH]CC(5185)',
    structure = SMILES('CC=[C]CC[CH]CC'),
    E0 = (308.412,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C=[C]CCCCC(5186)',
    structure = SMILES('[CH2]C=[C]CCCCC'),
    E0 = (265.453,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.202249,0.0848922,-5.55674e-05,1.85854e-08,-2.55876e-12,32083.7,34.4663], Tmin=(100,'K'), Tmax=(1648.55,'K')), NASAPolynomial(coeffs=[17.1951,0.0426795,-1.71583e-05,3.05287e-09,-2.03252e-13,26347.6,-58.1623], Tmin=(1648.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(265.453,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2][C]=CCCCCC(5187)',
    structure = SMILES('[CH2][C]=CCCCCC'),
    E0 = (265.453,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C[CH]CCC=CC(5188)',
    structure = SMILES('[CH2]C[CH]CCC=CC'),
    E0 = (275.817,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0778,0.0735009,-4.00245e-05,1.06734e-08,-1.20956e-12,33268.4,33.4088], Tmin=(100,'K'), Tmax=(1734.9,'K')), NASAPolynomial(coeffs=[9.41017,0.0542897,-2.34145e-05,4.29072e-09,-2.89805e-13,30377.3,-11.3808], Tmin=(1734.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(275.817,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(RCCJ)"""),
)
...
species(
    label = 'C=CC1CCC1CC(5078)',
    structure = SMILES('C=CC1CCC1CC'),
    E0 = (29.5209,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.776865,0.0465929,6.7998e-05,-1.16334e-07,4.62385e-11,3688.29,28.9745], Tmin=(100,'K'), Tmax=(978.297,'K')), NASAPolynomial(coeffs=[16.8464,0.0407993,-1.49787e-05,2.80923e-09,-2.04972e-13,-2322.79,-62.852], Tmin=(978.297,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(29.5209,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(519.654,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)

species(
    label = 'C=CCCC=CCC(5189)',
    structure = SMILES('C=CCCC=CCC'),
    E0 = (5.02891,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.102119,0.0725829,-2.06055e-05,-1.66272e-08,9.25363e-12,756.241,33.7566], Tmin=(100,'K'), Tmax=(1091.03,'K')), NASAPolynomial(coeffs=[14.4439,0.0454713,-1.83476e-05,3.38986e-09,-2.35986e-13,-3889.07,-43.6307], Tmin=(1091.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(5.02891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CC=CCCCC(5190)',
    structure = SMILES('C=CC=CCCCC'),
    E0 = (-12.3103,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.152189,0.0768453,-2.34611e-05,-2.05046e-08,1.22959e-11,-1318.58,32.1076], Tmin=(100,'K'), Tmax=(1032.47,'K')), NASAPolynomial(coeffs=[16.6387,0.0418184,-1.61932e-05,2.9681e-09,-2.07608e-13,-6386.08,-57.1851], Tmin=(1032.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-12.3103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CCCCC=CC(4865)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0206734,0.0768431,-3.61392e-05,1.48432e-09,2.54562e-12,622.598,33.5386], Tmin=(100,'K'), Tmax=(1213.11,'K')), NASAPolynomial(coeffs=[14.6344,0.0455593,-1.8525e-05,3.38228e-09,-2.31513e-13,-4186.75,-45.162], Tmin=(1213.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(3.89414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'CCC1C[CH][CH]CC1(5132)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2859,0.0478055,3.27626e-05,-5.27974e-08,1.70619e-11,20043.7,28.0315], Tmin=(100,'K'), Tmax=(1176.87,'K')), NASAPolynomial(coeffs=[7.15577,0.061234,-2.68968e-05,5.09793e-09,-3.56208e-13,16350.5,-11.0639], Tmin=(1176.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(165.761,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclohexane) + radical(cyclohexane) + radical(cyclohexane)"""),
)
...
species(
    label = 'C=CC[CH]C[CH]CC(5140)',
    structure = SMILES('C=CC[CH]C[CH]CC'),
    E0 = (277.274,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,201.808,838.855,1092.57,1379.19,1676.57],'cm^-1')),
        HinderedRotor(inertia=(0.14741,'amu*angstrom^2'), symmetry=1, barrier=(3.47084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14741,'amu*angstrom^2'), symmetry=1, barrier=(3.47084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14741,'amu*angstrom^2'), symmetry=1, barrier=(3.47084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14741,'amu*angstrom^2'), symmetry=1, barrier=(3.47084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14741,'amu*angstrom^2'), symmetry=1, barrier=(3.47084,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78822,0.0673035,-3.1138e-05,6.16102e-09,-4.5385e-13,33408,32.0182], Tmin=(100,'K'), Tmax=(2878.12,'K')), NASAPolynomial(coeffs=[44.0155,0.013597,-5.74342e-06,8.80074e-10,-4.73636e-14,7038.06,-219.928], Tmin=(2878.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(277.274,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = 'C=[C]CCC[CH]CC(5192)',
    structure = SMILES('C=[C]CCC[CH]CC'),
    E0 = (320.657,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.696865,0.0794102,-5.45854e-05,2.34992e-08,-4.99867e-12,38679.4,33.9702], Tmin=(100,'K'), Tmax=(984.486,'K')), NASAPolynomial(coeffs=[5.0458,0.0617404,-2.76633e-05,5.26834e-09,-3.69162e-13,37823.1,13.057], Tmin=(984.486,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(320.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(Cds_S)"""),
)

species(
    label = 'C=CCC[CH][CH]CC(5193)',
    structure = SMILES('C=CCC[CH][CH]CC'),
    E0 = (277.274,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,201.808,838.855,1092.57,1379.19,1676.57],'cm^-1')),
        HinderedRotor(inertia=(0.14741,'amu*angstrom^2'), symmetry=1, barrier=(3.47084,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=CCCC[CH]CC(5194)',
    structure = SMILES('[CH]=CCCC[CH]CC'),
    E0 = (329.912,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.688222,0.0784143,-4.84869e-05,1.60299e-08,-2.3568e-12,39793,33.8947], Tmin=(100,'K'), Tmax=(1409.73,'K')), NASAPolynomial(coeffs=[8.78252,0.0554472,-2.4049e-05,4.47304e-09,-3.07314e-13,37510.8,-7.93512], Tmin=(1409.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(329.912,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(Cds_P)"""),
)

species(
    label = 'C=CCCC[CH][CH]C(5195)',
    structure = SMILES('C=CCCC[CH][CH]C'),
    E0 = (277.262,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58495,0.0688434,-3.31101e-05,7.09892e-09,-5.90393e-13,33415.8,32.9127], Tmin=(100,'K'), Tmax=(2581.35,'K')), NASAPolynomial(coeffs=[19.6917,0.0407855,-1.68059e-05,2.88812e-09,-1.82582e-13,24067.9,-71.6126], Tmin=(2581.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(277.262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C[CH]CCCC=C(5196)',
    structure = SMILES('[CH2]C[CH]CCCC=C'),
    E0 = (288.062,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.809192,0.0756899,-4.30461e-05,1.22364e-08,-1.47856e-12,34754.4,34.827], Tmin=(100,'K'), Tmax=(1697.29,'K')), NASAPolynomial(coeffs=[10.8084,0.0521246,-2.22197e-05,4.05604e-09,-2.73632e-13,31360.2,-18.7032], Tmin=(1697.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(288.062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJ)"""),
)

species(
    label = '[CH]=C[CH]CCCCC(5197)',
    structure = SMILES('[CH]C=CCCCCC'),
    E0 = (246.796,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.559642,0.0867268,-5.063e-05,1.45092e-08,-1.67714e-12,29858.6,36.1481], Tmin=(100,'K'), Tmax=(1966.1,'K')), NASAPolynomial(coeffs=[22.0009,0.0408273,-1.56115e-05,2.63504e-09,-1.67265e-13,20987.4,-87.9456], Tmin=(1966.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(246.796,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C[CH]CC[CH]CC(4069)'],
    products = ['butadiene13(1350)', 'butene1(35)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'C=C[CH]CC[CH]C(3961)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(CC)C[CH]C=C(4034)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C=CCCC([CH2])C(5164)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]CC(26)', '[CH2]C=CC[CH2](507)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(14)', '[CH]CCC=C[CH2](4958)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(T)(20)', '[CH]=CCC[CH]CC(5165)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH2]C=CCC[C]CC(5166)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH]C=CCC[CH]CC(5167)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][CH]C[CH]C[CH]CC(5169)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH]CC[CH][CH]CC(5170)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C[CH]C[CH][CH]CC(5171)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C=C[CH]CC[CH]CC(4069)'],
    products = ['CC[CH]CCC1[CH]C1(5172)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=C[CH]CC[CH]CC(4069)'],
    products = ['[CH2]C1[CH]CCC1CC(5085)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.73e+06,'s^-1'), n=1.31, Ea=(78.3881,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra;radadd_intra_csHNd]
Euclidian distance = 0
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH2]C=CCC=CCC(5174)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', 'C=C[CH]CCC=CC(4929)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', 'C=C=CCC[CH]CC(5175)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2][CH]C=C(3743)', 'butene1(35)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(1310,'cm^3/(mol*s)','*|/',2), n=2.62, Ea=(45.6056,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""From training reaction 6 used for Cds-HH_Cds-CsH;CsJ-CdHH
...
reaction(
    label = 'reaction24',
    reactants = ['CH3(17)', 'C=C[CH]CCC=C(4876)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2]C=CC[CH][CH]CC(5176)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]C=C(3739)', '[CH2]C[CH]CC(101)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH2]C=C[CH]C[CH]CC(5177)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH3(17)', '[CH2][CH]CC[CH]C=C(4160)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', '[CH2]C=CCC[CH]C[CH2](5178)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', '[CH2]C=[C]CC[CH]CC(5179)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', '[CH2][C]=CCC[CH]CC(5180)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH2]C=CCCCC[CH2](5184)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2]C[CH]CCC=CC(5188)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(C=C)C[CH]CC(4055)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction47',
    reactants = ['C2H3(60)', '[CH]CC[CH]CC(240)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction53',
    reactants = ['H(3)', 'C=CC=CC[CH]CC(5191)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction54',
    reactants = ['butadiene13(1350)', '[CH2][CH]CC(37)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction55',
    reactants = ['C=CC[CH]C[CH]CC(5140)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction60',
    reactants = ['[CH2]C[CH]CCCC=C(5196)'],
    products = ['C=C[CH]CC[CH]CC(4069)'],
...
network(
    ...
    isomers = [
        'C=C[CH]CC[CH]CC(4069)',
    ],
    reactants = [
        ('butadiene13(1350)', 'butene1(35)'),
    ],
    bathGas = {
        'Ar': 0.333333,
        'Ne': 0.333333,
