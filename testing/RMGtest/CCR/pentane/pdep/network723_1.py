...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69686,0.0377193,1.2452e-05,-5.93426e-08,3.18005e-11,5335.63,20.2866], Tmin=(100,'K'), Tmax=(863.468,'K')), NASAPolynomial(coeffs=[16.9898,0.00501405,3.01258e-06,-9.00762e-10,6.92564e-14,1272.86,-59.481], Tmin=(863.468,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(43.5699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42701,0.056019,-6.25958e-05,3.68783e-08,-8.64125e-12,6398.01,23.1929], Tmin=(100,'K'), Tmax=(1040.73,'K')), NASAPolynomial(coeffs=[11.4622,0.0174483,-7.00268e-06,1.26584e-09,-8.6345e-14,4309.29,-25.6213], Tmin=(1040.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(52.4213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H2CC(T)(1341)', '[CH2]C([O])[O](1528)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', 'C=[C]O[CH][O](2840)'],
    products = ['[CH2]C([O])O[C]=C(2322)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]C([O])O[C]=C(2841)'],
    products = ['[CH2]C([O])O[C]=C(2322)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(T)(20)', 'C=[C]OC=O(2846)'],
    products = ['[CH2]C([O])O[C]=C(2322)'],
