...
species(
    ...
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.27209,0.0261405,2.85014e-05,-6.94373e-08,3.44776e-11,59720.2,16.0321], Tmin=(100,'K'), Tmax=(850.657,'K')), NASAPolynomial(coeffs=[14.1572,0.00540239,3.09084e-06,-9.49403e-10,7.44198e-14,56426.4,-46.8591], Tmin=(850.657,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(495.929,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCsJOCs) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1OC1[CH2](15178)',
    ...
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.856819,0.0488332,-4.64273e-05,2.29356e-08,-4.12929e-12,62666.4,20.892], Tmin=(100,'K'), Tmax=(1706.51,'K')), NASAPolynomial(coeffs=[10.6799,0.0108784,5.76203e-08,-3.50945e-10,3.31817e-14,61487.6,-25.3793], Tmin=(1706.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(519.951,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJCO) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]COC=[CH](15179)',
    structure = SMILES('[CH]COC=[CH]'),
    E0 = (509.804,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,458.171,458.251,458.26,458.274,458.279],'cm^-1')),
        HinderedRotor(inertia=(0.12535,'amu*angstrom^2'), symmetry=1, barrier=(18.6847,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1254,'amu*angstrom^2'), symmetry=1, barrier=(18.6842,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.125352,'amu*angstrom^2'), symmetry=1, barrier=(18.6859,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43028,0.0441205,-1.29537e-05,-2.87599e-08,1.82965e-11,61419.4,19.3152], Tmin=(100,'K'), Tmax=(918.289,'K')), NASAPolynomial(coeffs=[18.3756,0.00291571,1.08964e-06,-2.86551e-10,1.73864e-14,56932.4,-68.4772], Tmin=(918.289,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(509.804,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH][CH](6981)', 'vinoxy(1351)'],
...
reaction(
    label = 'reaction5',
    reactants = ['[CH][CH]OC=C(6927)'],
    products = ['[CH]C1OC1[CH2](15178)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(9.65211e+08,'s^-1'), n=0.77, Ea=(63.315,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H_pri;radadd_intra_cs]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 61.3 to 63.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['ketene(T)(1373)', 'C2H3(60)'],
    products = ['[CH][CH]OC=C(6927)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.71664,'m^3/(mol*s)'), n=1.87317, Ea=(19.0023,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R_R;CdsJ-H] for rate rule [Od_R;CdsJ-H]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 16.0 to 19.0 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction7',
    reactants = ['[CH][CH][O](6986)', 'C2H3(60)'],
    products = ['[CH][CH]OC=C(6927)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH][CH]O[C]=C(7111)'],
    products = ['[CH][CH]OC=C(6927)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH][CH]OC=[CH](15061)'],
    products = ['[CH][CH]OC=C(6927)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction13',
    reactants = ['ketene(T)(1373)', '[CH][CH2](502)'],
    products = ['[CH][CH]OC=C(6927)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[C]=CO[CH][CH2](15180)'],
    products = ['[CH][CH]OC=C(6927)'],
