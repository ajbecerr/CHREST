species(
    label = 'CC([O])C(C)[O](3206)',
    structure = SMILES('CC([O])C(C)[O]'),
    E0 = (-28.5233,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,440.27,441.497,444.299],'cm^-1')),
        HinderedRotor(inertia=(0.000860517,'amu*angstrom^2'), symmetry=1, barrier=(0.119631,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.371315,'amu*angstrom^2'), symmetry=1, barrier=(12.1537,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0884176,'amu*angstrom^2'), symmetry=1, barrier=(12.1608,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.976988,0.0577826,-4.38576e-05,1.71432e-08,-2.69649e-12,-3314.48,24.1069], Tmin=(100,'K'), Tmax=(1508.09,'K')), NASAPolynomial(coeffs=[14.4246,0.0221145,-8.38091e-06,1.46034e-09,-9.66978e-14,-7370.53,-46.295], Tmin=(1508.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-28.5233,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00193341,'amu*angstrom^2'), symmetry=1, barrier=(21.952,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0272041,'amu*angstrom^2'), symmetry=1, barrier=(15.5738,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.955325,'amu*angstrom^2'), symmetry=1, barrier=(21.9648,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77702,0.0411625,-1.2512e-05,-9.86032e-09,5.76955e-12,-22084.7,24.5586], Tmin=(100,'K'), Tmax=(1066.4,'K')), NASAPolynomial(coeffs=[10.5509,0.0236259,-9.46971e-06,1.75654e-09,-1.23082e-13,-24830.1,-22.4329], Tmin=(1066.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-184.342,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(C=OCOJ)"""),
)
...
species(
    label = 'C[C]([O])C(C)[O](3475)',
    structure = SMILES('C[C]([O])C(C)[O]'),
    E0 = (148.105,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,359.869,359.871,359.879],'cm^-1')),
        HinderedRotor(inertia=(0.00130167,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0930489,'amu*angstrom^2'), symmetry=1, barrier=(8.55132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0930422,'amu*angstrom^2'), symmetry=1, barrier=(8.55106,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32922,0.0606585,-6.10067e-05,3.44883e-08,-8.11033e-12,17907.5,22.9543], Tmin=(100,'K'), Tmax=(1012.94,'K')), NASAPolynomial(coeffs=[9.70095,0.0275991,-1.20505e-05,2.26747e-09,-1.57931e-13,16211.5,-17.542], Tmin=(1012.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.105,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
species(
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15725,0.0647436,-6.71611e-05,3.97642e-08,-9.79164e-12,-9792.63,23.7646], Tmin=(100,'K'), Tmax=(971.067,'K')), NASAPolynomial(coeffs=[9.71786,0.0294808,-1.26905e-05,2.3683e-09,-1.64058e-13,-11455.2,-17.284], Tmin=(971.067,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.2562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = 'C[C]([O])C(C)O(3496)',
    structure = SMILES('C[C]([O])C(C)O'),
    E0 = (-82.2562,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.95167,0.0637474,-5.91791e-05,2.92199e-08,-5.82355e-12,-5575.76,25.7037], Tmin=(100,'K'), Tmax=(1205.53,'K')), NASAPolynomial(coeffs=[13.0064,0.0237483,-9.4085e-06,1.69586e-09,-1.15555e-13,-8482.18,-34.7066], Tmin=(1205.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.295,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CJCO)"""),
)

species(
    label = '[CH2]C([O])C(C)O(3498)',
    structure = SMILES('[CH2]C([O])C(C)O'),
    E0 = (-47.295,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,206.919,207.391],'cm^-1')),
        HinderedRotor(inertia=(0.0115232,'amu*angstrom^2'), symmetry=1, barrier=(8.84468,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00184145,'amu*angstrom^2'), symmetry=1, barrier=(19.313,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.635267,'amu*angstrom^2'), symmetry=1, barrier=(19.3145,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.633627,'amu*angstrom^2'), symmetry=1, barrier=(19.3113,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'CC([O])C[O](3493)'],
    products = ['CC([O])C(C)[O](3206)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', 'CH3CHOCHO(3472)'],
    products = ['CC([O])C(C)[O](3206)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(17)', 'CC([O])[CH][O](3465)'],
    products = ['CC([O])C(C)[O](3206)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C[C]([O])C(C)[O](3475)'],
    products = ['CC([O])C(C)[O](3206)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH2]C([O])C(C)[O](3178)'],
    products = ['CC([O])C(C)[O](3206)'],
