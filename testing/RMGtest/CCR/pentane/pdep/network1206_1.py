...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.451852,0.0843564,-8.48514e-05,4.32013e-08,-8.45916e-12,47877.2,33.2577], Tmin=(100,'K'), Tmax=(1355.24,'K')), NASAPolynomial(coeffs=[20.3011,0.0174481,-4.53649e-06,6.13679e-10,-3.50145e-14,42771.5,-71.2555], Tmin=(1355.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(396.645,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(Isobutyl) + radical(C=CJO)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.263866,0.0727835,-5.86923e-05,1.75387e-08,3.14753e-13,78018.5,31.0582], Tmin=(100,'K'), Tmax=(1003.46,'K')), NASAPolynomial(coeffs=[17.8845,0.0205154,-7.42427e-06,1.3252e-09,-9.22698e-14,73577.4,-58.5203], Tmin=(1003.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(647.495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(CCJ2_triplet) + radical(C=CJO)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.03728,'amu*angstrom^2'), symmetry=1, barrier=(23.8491,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03732,'amu*angstrom^2'), symmetry=1, barrier=(23.85,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03667,'amu*angstrom^2'), symmetry=1, barrier=(23.8351,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03686,'amu*angstrom^2'), symmetry=1, barrier=(23.8394,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.539182,0.0618218,-3.3891e-05,-1.81415e-08,1.64087e-11,72607.2,23.2517], Tmin=(100,'K'), Tmax=(927.272,'K')), NASAPolynomial(coeffs=[22.6242,0.0034433,8.69316e-07,-2.2869e-10,1.2024e-14,66925.4,-90.18], Tmin=(927.272,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(602.544,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(CJCO) + radical(CH2_triplet)"""),
)

species(
    label = '[CH2][CH][C](C)O[C]=C(4192)',
    structure = SMILES('[CH2][C]OC(C)=C[CH2]'),
    E0 = (560.753,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.134062,0.0811079,-7.51094e-05,2.95837e-08,-2.95168e-12,67600.4,27.672], Tmin=(100,'K'), Tmax=(1014.03,'K')), NASAPolynomial(coeffs=[20.4174,0.0173128,-6.29204e-06,1.13877e-09,-8.03623e-14,62544.4,-76.1421], Tmin=(1014.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(560.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(CJCO) + radical(CH2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.407762,0.0759329,-7.17791e-05,3.57108e-08,-7.16199e-12,48180.2,31.4426], Tmin=(100,'K'), Tmax=(1197.53,'K')), NASAPolynomial(coeffs=[14.8389,0.0277293,-1.13997e-05,2.09712e-09,-1.44617e-13,44723.9,-40.7806], Tmin=(1197.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(399.496,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C2CsJOC(O)) + radical(RCCJ) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.228059,0.0734153,-5.63752e-05,1.58812e-08,5.37869e-13,53830.8,31.6846], Tmin=(100,'K'), Tmax=(1016.75,'K')), NASAPolynomial(coeffs=[17.3629,0.0235354,-8.65059e-06,1.54679e-09,-1.07209e-13,49440.3,-55.7219], Tmin=(1016.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(446.376,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', '[CH2][CH]CO[C]=C(2284)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(C)[CH]O[C]=C(4185)'],
    products = ['[CH2][CH]C(C)O[C]=C(2730)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2CC(T)(1341)', '[CH2][CH]C(C)[O](1587)'],
    products = ['[CH2][CH]C(C)O[C]=C(2730)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH][CH2](502)', 'C=[C]O[CH]C(2369)'],
    products = ['[CH2][CH]C(C)O[C]=C(2730)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH2][C]C(C)O[C]=C(4186)'],
    products = ['[CH2][CH]C(C)O[C]=C(2730)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH][CH]C(C)O[C]=C(4187)'],
    products = ['[CH2][CH]C(C)O[C]=C(2730)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2]C=C(C)O[C]=C(4190)'],
    products = ['[CH2][CH]C(C)O[C]=C(2730)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'C#COC(C)[CH][CH2](4191)'],
    products = ['[CH2][CH]C(C)O[C]=C(2730)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(17)', '[CH2]C=CO[C]=C(2622)'],
    products = ['[CH2][CH]C(C)O[C]=C(2730)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(17)', '[CH2][CH][CH]O[C]=C(2624)'],
    products = ['[CH2][CH]C(C)O[C]=C(2730)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2][CH][C](C)O[C]=C(4192)'],
    products = ['[CH2][CH]C(C)O[C]=C(2730)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH]=[C]OC(C)[CH][CH2](4194)'],
    products = ['[CH2][CH]C(C)O[C]=C(2730)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C[C](C)O[C]=C(4195)'],
    products = ['[CH2][CH]C(C)O[C]=C(2730)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]=[C]OC(C)C[CH2](4199)'],
    products = ['[CH2][CH]C(C)O[C]=C(2730)'],
