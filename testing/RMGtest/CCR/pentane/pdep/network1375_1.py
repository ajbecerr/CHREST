species(
    label = 'C#COCCC=C(4906)',
    structure = SMILES('C#COCCC=C'),
    E0 = (104.041,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,2175,525,750,770,3400,2100,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.00584,'amu*angstrom^2'), symmetry=1, barrier=(23.1262,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00665,'amu*angstrom^2'), symmetry=1, barrier=(23.1448,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.00409,'amu*angstrom^2'), symmetry=1, barrier=(23.086,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.397928,0.0670516,-3.85578e-05,-5.30189e-09,8.75319e-12,12653.8,24.0321], Tmin=(100,'K'), Tmax=(980.771,'K')), NASAPolynomial(coeffs=[18.7781,0.0191714,-6.74885e-06,1.23071e-09,-8.85734e-14,7745.96,-70.925], Tmin=(980.771,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(104.041,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
species(
    label = '[C]1=CC[CH]CCO1(6753)',
    structure = SMILES('[C]1=CC[CH]CCO1'),
    E0 = (270.19,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87505,-0.00757046,0.000231966,-3.36068e-07,1.41185e-10,32624,25.9837], Tmin=(100,'K'), Tmax=(900.342,'K')), NASAPolynomial(coeffs=[37.5132,-0.0234873,2.12161e-05,-4.32949e-09,2.86942e-13,20434.5,-174.264], Tmin=(900.342,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.19,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cycloheptane) + radical(RCCJCC) + radical(C=CJO)"""),
)

species(
    label = 'C#COC[CH]C[CH2](6754)',
    structure = SMILES('C#COC[CH]C[CH2]'),
    E0 = (381.407,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.308608,0.0705183,-5.0547e-05,7.80885e-09,4.0188e-12,46015.1,28.1614], Tmin=(100,'K'), Tmax=(989.935,'K')), NASAPolynomial(coeffs=[18.5058,0.0193561,-6.91473e-06,1.24878e-09,-8.84874e-14,41316.4,-64.9808], Tmin=(989.935,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(381.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCJCO) + radical(RCCJ)"""),
)

species(
    label = 'C#CO[CH]CC[CH2](6755)',
    structure = SMILES('C#CO[CH]CC[CH2]'),
    E0 = (361.961,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2175,525,750,770,3400,2100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.510181,0.0864926,-9.11033e-05,4.70483e-08,-9.31621e-12,43707.1,28.053], Tmin=(100,'K'), Tmax=(1297.66,'K')), NASAPolynomial(coeffs=[22.0197,0.0141347,-4.09866e-06,6.21799e-10,-3.89726e-14,38104.9,-85.5668], Tmin=(1297.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(361.961,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCsJOCs) + radical(RCCJ)"""),
)

species(
    label = 'C#CO[CH]C[CH]C(6756)',
    structure = SMILES('C#CO[CH]C[CH]C'),
    E0 = (351.161,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0279215,0.0822511,-8.74355e-05,4.7446e-08,-1.0069e-11,42385.4,27.2673], Tmin=(100,'K'), Tmax=(1156.79,'K')), NASAPolynomial(coeffs=[17.8575,0.020407,-7.24371e-06,1.2315e-09,-8.14939e-14,38247.4,-61.6246], Tmin=(1156.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(351.161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(RCCJC) + radical(CCsJOCs)"""),
)

species(
    label = '[C]#COCCC[CH2](6757)',
    structure = SMILES('[C]#COCCC[CH2]'),
    E0 = (518.649,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,2175,525,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.155789,0.0790432,-8.08656e-05,4.28877e-08,-8.97997e-12,62522.2,26.956], Tmin=(100,'K'), Tmax=(1166,'K')), NASAPolynomial(coeffs=[16.574,0.0227203,-8.40917e-06,1.46042e-09,-9.76381e-14,58693.5,-54.7736], Tmin=(1166,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(518.649,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(RCCJ) + radical(Acetyl)"""),
)

species(
    label = '[C]#COCC[CH]C(6758)',
    structure = SMILES('[C]#COCC[CH]C'),
    E0 = (507.849,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2175,525,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.537942,0.0758761,-8.05026e-05,4.70121e-08,-1.11144e-11,61205.1,26.537], Tmin=(100,'K'), Tmax=(1024.31,'K')), NASAPolynomial(coeffs=[12.6219,0.0286877,-1.14003e-05,2.03759e-09,-1.37701e-13,58729.5,-32.0516], Tmin=(1024.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(507.849,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(RCCJC) + radical(Acetyl)"""),
)
...
species(
    label = 'C#CO[CH]CC=C(6759)',
    structure = SMILES('C#CO[CH]CC=C'),
    E0 = (284.497,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,2175,525,750,770,3400,2100,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.0635,'amu*angstrom^2'), symmetry=1, barrier=(24.4519,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06423,'amu*angstrom^2'), symmetry=1, barrier=(24.4688,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06344,'amu*angstrom^2'), symmetry=1, barrier=(24.4505,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.06452,'amu*angstrom^2'), symmetry=1, barrier=(24.4755,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.568293,0.0817182,-8.3624e-05,4.08509e-08,-7.5014e-12,34397.6,26.9582], Tmin=(100,'K'), Tmax=(1497.81,'K')), NASAPolynomial(coeffs=[23.0468,0.00923443,-1.60232e-06,1.45416e-10,-6.52654e-15,28379.9,-92.9848], Tmin=(1497.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(284.497,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCsJOCs)"""),
)

species(
    label = 'C#COCC[C]=C(6760)',
    structure = SMILES('C#COCC[C]=C'),
    E0 = (341.883,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3100,1380,975,1025,1650,1685,370,2175,525,750,770,3400,2100,192.479,192.535,192.797,192.821],'cm^-1')),
        HinderedRotor(inertia=(0.848544,'amu*angstrom^2'), symmetry=1, barrier=(22.376,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.850199,'amu*angstrom^2'), symmetry=1, barrier=(22.3761,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.84843,'amu*angstrom^2'), symmetry=1, barrier=(22.3776,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.850851,'amu*angstrom^2'), symmetry=1, barrier=(22.3756,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.330778,0.0720449,-6.46679e-05,2.55826e-08,-2.84926e-12,41258.7,24.7473], Tmin=(100,'K'), Tmax=(1035.16,'K')), NASAPolynomial(coeffs=[17.8269,0.0182738,-6.80025e-06,1.22679e-09,-8.55438e-14,36895.1,-63.8464], Tmin=(1035.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(341.883,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CCCOC#C(6761)',
    structure = SMILES('[CH]=CCCOC#C'),
    E0 = (351.137,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,2175,525,750,770,3400,2100,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.02807,'amu*angstrom^2'), symmetry=1, barrier=(23.6374,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02983,'amu*angstrom^2'), symmetry=1, barrier=(23.6779,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02857,'amu*angstrom^2'), symmetry=1, barrier=(23.6489,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02922,'amu*angstrom^2'), symmetry=1, barrier=(23.6637,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.321371,0.0706087,-5.53434e-05,1.2258e-08,2.75631e-12,42373.7,24.71], Tmin=(100,'K'), Tmax=(984.789,'K')), NASAPolynomial(coeffs=[19.0301,0.0163181,-5.70294e-06,1.02911e-09,-7.34695e-14,37636.6,-70.6048], Tmin=(984.789,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(351.137,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Cds_P)"""),
)

species(
    label = '[C]#COCCC=C(6762)',
    structure = SMILES('[C]#COCCC=C'),
    E0 = (441.185,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,2175,525,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.430214,0.070492,-6.08184e-05,2.12515e-08,-9.35135e-13,53198,24.658], Tmin=(100,'K'), Tmax=(982.105,'K')), NASAPolynomial(coeffs=[17.1038,0.0187466,-6.47427e-06,1.12062e-09,-7.67344e-14,49143.4,-59.4501], Tmin=(982.105,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(441.185,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Acetyl)"""),
)

species(
    label = 'C#COCC[C]C(6763)',
    structure = SMILES('C#COCC[C]C'),
    E0 = (404.923,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.148774,0.0813158,-8.10699e-05,4.19208e-08,-8.66151e-12,48842.5,33.7523], Tmin=(100,'K'), Tmax=(1170.24,'K')), NASAPolynomial(coeffs=[16.1288,0.0266936,-1.10548e-05,2.03388e-09,-1.40294e-13,45102.5,-45.8542], Tmin=(1170.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(404.923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)

species(
    label = '[CH]CCCOC#C(6764)',
    structure = SMILES('[CH]CCCOC#C'),
    E0 = (427.359,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2175,525,750,770,3400,2100,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.165746,0.0801944,-8.12666e-05,4.18921e-08,-8.55284e-12,51541,24.5346], Tmin=(100,'K'), Tmax=(1188.87,'K')), NASAPolynomial(coeffs=[16.9988,0.0235586,-9.80856e-06,1.82129e-09,-1.26554e-13,47538.5,-59.5872], Tmin=(1188.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(427.359,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsCsHH) + group(CsJ2_singlet-CsH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)

species(
    label = '[C]=COCCC=C(6765)',
    structure = SMILES('[C]=COCCC=C'),
    E0 = (280.671,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.573518,0.0752891,-7.55307e-05,4.03233e-08,-8.73566e-12,33880.5,24.4992], Tmin=(100,'K'), Tmax=(1107.87,'K')), NASAPolynomial(coeffs=[13.4893,0.0286572,-1.23947e-05,2.33167e-09,-1.62705e-13,31018.6,-39.1354], Tmin=(1107.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(280.671,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]1=CC[CH]CCO1(6753)'],
    products = ['C#COCCC=C(4906)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction8',
    reactants = ['HCCO(2227)', 'buten3yl1(65)'],
    products = ['C#COCCC=C(4906)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HC2(2881)', 'C=CCC[O](1554)'],
    products = ['C#COCCC=C(4906)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C#CO[CH2](3066)', 'allyl(82)'],
    products = ['C#COCCC=C(4906)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C2H3(60)', 'C#COC[CH2](2366)'],
    products = ['C#COCCC=C(4906)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'C#CO[CH]CC=C(6759)'],
    products = ['C#COCCC=C(4906)'],
