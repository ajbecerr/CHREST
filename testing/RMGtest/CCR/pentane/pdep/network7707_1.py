...
species(
    label = '[C]=[C]OC[O](29367)',
    structure = SMILES('[C]=[C]OC[O]'),
    E0 = (685.328,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1685,370,425.157,425.187,425.483,425.605],'cm^-1')),
        HinderedRotor(inertia=(0.186257,'amu*angstrom^2'), symmetry=1, barrier=(23.8515,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.186156,'amu*angstrom^2'), symmetry=1, barrier=(23.8437,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (70.0468,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09297,0.0341426,-2.08765e-05,-6.32992e-09,7.14786e-12,82501.7,19.591], Tmin=(100,'K'), Tmax=(951.921,'K')), NASAPolynomial(coeffs=[14.2191,0.00209838,-1.80128e-07,4.40497e-11,-6.73615e-15,79336.3,-42.8131], Tmin=(951.921,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(685.328,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(OCOJ) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (71.0547,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19391,0.03094,-7.72838e-06,-1.74814e-08,1.00755e-11,-5592.31,16.0124], Tmin=(100,'K'), Tmax=(977.485,'K')), NASAPolynomial(coeffs=[13.1042,0.00690243,-2.46643e-06,4.98791e-10,-3.95316e-14,-8709.78,-41.411], Tmin=(977.485,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.1032,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-OdOsH) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[O](28827)', '[C]=[CH](9646)'],
    products = ['[CH]=[C]OC[O](10398)'],
    transitionState = 'TS2',
