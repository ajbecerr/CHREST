...
species(
    ...
    molecularWeight = (40.0639,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.28451,0.0144723,-2.91525e-06,-2.0462e-09,7.91504e-13,67868.8,10.0416], Tmin=(100,'K'), Tmax=(1455.88,'K')), NASAPolynomial(coeffs=[5.67833,0.0121696,-4.94649e-06,9.00466e-10,-6.07638e-14,66718.8,-3.96204], Tmin=(1455.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(564.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CH3(17)', 'C2H2(1342)'],
    products = ['propen1yl(84)'],
    transitionState = 'TS1',
