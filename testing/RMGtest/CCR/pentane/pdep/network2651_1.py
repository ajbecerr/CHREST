...
species(
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.973111,0.0966122,-0.000100691,5.22519e-08,-1.04677e-11,-7329.17,31.0955], Tmin=(100,'K'), Tmax=(1254.14,'K')), NASAPolynomial(coeffs=[23.0617,0.0185832,-5.72454e-06,8.98493e-10,-5.70703e-14,-13249.9,-89.8711], Tmin=(1254.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.5172,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH]C(CC)OC=[C][O](11756)',
    structure = SMILES('[CH]C(CC)OC=[C][O]'),
    E0 = (374.919,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.365148,0.0804457,-4.79982e-05,-1.13114e-08,1.46403e-11,45263.7,33.8974], Tmin=(100,'K'), Tmax=(941.528,'K')), NASAPolynomial(coeffs=[24.3455,0.013964,-3.4177e-06,5.52095e-10,-4.14242e-14,38904.2,-92.8901], Tmin=(941.528,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCJ2_triplet) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0925296,0.0693073,-2.01596e-05,-3.30707e-08,2.03015e-11,-19322.7,31.2501], Tmin=(100,'K'), Tmax=(956.855,'K')), NASAPolynomial(coeffs=[21.3936,0.0203808,-6.35391e-06,1.12982e-09,-8.29171e-14,-25235.8,-80.1733], Tmin=(956.855,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-161.953,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=COJ)"""),
)

species(
    label = 'C=C(CC)OC=[C][O](11757)',
    structure = SMILES('C=C(CC)O[CH][C]=O'),
    E0 = (32.0654,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,1855,455,950,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.281162,0.0823808,-6.74097e-05,1.85817e-08,1.29035e-12,4021.11,31.3283], Tmin=(100,'K'), Tmax=(1004.3,'K')), NASAPolynomial(coeffs=[21.4696,0.0188072,-6.89515e-06,1.27164e-09,-9.12855e-14,-1510.51,-79.4887], Tmin=(1004.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(32.0654,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsOs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(CsCJ=O)"""),
)

species(
    label = '[CH2]C(CC)OC#C[O](11248)',
    structure = SMILES('[CH2]C(CC)O[C]=C=O'),
    E0 = (177.227,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,1685,370,2120,512.5,787.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.246233,0.0922689,-0.000106251,6.346e-08,-1.49687e-11,21469.4,31.6169], Tmin=(100,'K'), Tmax=(1037.24,'K')), NASAPolynomial(coeffs=[16.9301,0.0260299,-1.04596e-05,1.89158e-09,-1.29113e-13,17906.3,-51.877], Tmin=(1037.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(177.227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(CJC(C)OC) + radical(C=CJO)"""),
)
...
species(
    label = '[CH2][C](CC)OC=[C][O](11758)',
    structure = SMILES('[CH2][C](CC)O[CH][C]=O'),
    E0 = (328.268,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,1855,455,950,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.588215,0.111148,-0.000180388,1.56058e-07,-5.23924e-11,39636.9,34.3231], Tmin=(100,'K'), Tmax=(858.084,'K')), NASAPolynomial(coeffs=[11.084,0.0373774,-1.75899e-05,3.28399e-09,-2.21887e-13,38346.5,-16.0492], Tmin=(858.084,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(328.268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CCsJOCs) + radical(CsCJ=O)"""),
)
...
species(
    label = '[CH2]CC([CH2])OC=[C][O](11759)',
    structure = SMILES('[CH2]CC([CH2])OC=[C][O]'),
    E0 = (342.46,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C(CC)O[C]=[C]O(11629)',
    structure = SMILES('[CH2]C(CC)O[C]=[C]O'),
    E0 = (235.495,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,1670,1700,300,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.21177,0.102984,-0.000116706,6.5134e-08,-1.38948e-11,28521.2,37.4002], Tmin=(100,'K'), Tmax=(1212.79,'K')), NASAPolynomial(coeffs=[24.0326,0.0158067,-4.0396e-06,5.39173e-10,-3.06009e-14,22686,-88.072], Tmin=(1212.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CJC(C)OC) + radical(C=CJO) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.64586,0.104714,-0.000112825,5.81402e-08,-1.12867e-11,11968.7,35.6166], Tmin=(100,'K'), Tmax=(1396.12,'K')), NASAPolynomial(coeffs=[27.5715,0.0112328,-1.89081e-06,1.54506e-10,-5.74833e-15,4762.78,-111.68], Tmin=(1396.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.6853,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C2CsJOC(O)) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2][C](CC)OC=[C]O(11762)',
    structure = SMILES('[CH2][C](CC)OC=[C]O'),
    E0 = (195.967,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.50627,0.109555,-0.000130139,7.47255e-08,-1.62948e-11,23777.6,36.8253], Tmin=(100,'K'), Tmax=(1191.64,'K')), NASAPolynomial(coeffs=[25.9124,0.0129827,-2.86646e-06,3.28112e-10,-1.64468e-14,17565,-98.9101], Tmin=(1191.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(195.967,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C2CsJOC(O)) + radical(CJC(C)OC) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.14406,0.104161,-0.000106505,5.12811e-08,-9.13703e-12,12601.7,37.7138], Tmin=(100,'K'), Tmax=(1602.79,'K')), NASAPolynomial(coeffs=[28.7437,0.0086329,1.5715e-07,-2.63627e-10,2.26343e-14,5069.42,-118.483], Tmin=(1602.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(102.716,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CJC(C)OC) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC([CH2])OC=[C]O(11764)',
    structure = SMILES('[CH2]CC([CH2])OC=[C]O'),
    E0 = (200.998,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3010,987.5,1337.5,450,1655,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.84345,0.107321,-0.000118833,6.24933e-08,-1.22602e-11,24403,38.3286], Tmin=(100,'K'), Tmax=(1416,'K')), NASAPolynomial(coeffs=[28.0907,0.0090299,-1.65759e-07,-2.2451e-10,2.1964e-14,17302.2,-111.638], Tmin=(1416,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.998,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CJC(C)OC) + radical(RCCJ) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0848322,0.0729854,-4.04628e-05,-4.25987e-09,7.85631e-12,-19315,30.5419], Tmin=(100,'K'), Tmax=(1013.88,'K')), NASAPolynomial(coeffs=[19.081,0.0251,-9.65047e-06,1.80256e-09,-1.29109e-13,-24557.8,-68.2239], Tmin=(1013.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-161.862,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsOs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CsCJ=O)"""),
)

species(
    label = '[CH2][C](CC)OC[C]=O(11766)',
    structure = SMILES('[CH2][C](CC)OC[C]=O'),
    E0 = (147.812,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,1855,455,950,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.255158,0.103772,-0.000160104,1.41249e-07,-4.92758e-11,17921,32.9883], Tmin=(100,'K'), Tmax=(834.947,'K')), NASAPolynomial(coeffs=[8.16279,0.0450055,-2.14044e-05,4.0553e-09,-2.77967e-13,17158,-2.25626], Tmin=(834.947,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.812,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CsCJ=O)"""),
)
...
species(
    label = '[CH2]CC([CH2])OC[C]=O(11768)',
    structure = SMILES('[CH2]CC([CH2])OC[C]=O'),
    E0 = (172.354,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1855,455,950,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.169577,0.090086,-0.000105336,7.07297e-08,-1.97883e-11,20862.2,33.3241], Tmin=(100,'K'), Tmax=(858.578,'K')), NASAPolynomial(coeffs=[10.7829,0.0406401,-1.89508e-05,3.65336e-09,-2.57053e-13,19039.8,-16.2607], Tmin=(858.578,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.354,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CJC(C)OC) + radical(RCCJ) + radical(CsCJ=O)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(CC)O[CH][C]=O(10996)'],
    products = ['[CH2]C(CC)OC=C=O(11009)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', '[CH2]C(C)O[CH][C]=O(10956)'],
    products = ['[CH2]C(CC)O[CH][C]=O(10996)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', 'CC[CH]OC=[C][O](11583)'],
    products = ['[CH2]C(CC)O[CH][C]=O(10996)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]C(CC)OC=[C][O](11756)'],
    products = ['[CH2]C(CC)O[CH][C]=O(10996)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'C=C(CC)OC=[C][O](11757)'],
    products = ['[CH2]C(CC)O[CH][C]=O(10996)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH2]C(CC)OC#C[O](11248)'],
    products = ['[CH2]C(CC)O[CH][C]=O(10996)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C2H5(14)', 'C=CO[CH][C]=O(2661)'],
    products = ['[CH2]C(CC)O[CH][C]=O(10996)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HCCO(2227)', '[CH2]C([O])CC(1362)'],
    products = ['[CH2]C(CC)O[CH][C]=O(10996)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=[C][O](6861)', '[CH2]C([O])CC(1362)'],
    products = ['[CH2]C(CC)O[CH][C]=O(10996)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C2H5(14)', '[CH2][CH]O[CH][C]=O(2797)'],
    products = ['[CH2]C(CC)O[CH][C]=O(10996)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2][C](CC)OC=[C][O](11758)'],
    products = ['[CH2]C(CC)O[CH][C]=O(10996)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH3(17)', '[CH2]C([CH2])O[CH][C]=O(11038)'],
    products = ['[CH2]C(CC)O[CH][C]=O(10996)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH2]CC([CH2])OC=[C][O](11759)'],
    products = ['[CH2]C(CC)O[CH][C]=O(10996)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH2]C(CC)O[C]=[C][O](11627)'],
    products = ['[CH2]C(CC)O[CH][C]=O(10996)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(CC)O[CH][C]=O(10996)'],
    products = ['[CH2]C(CC)O[C]=C[O](11006)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(CC)O[C]=[C]O(11629)'],
    products = ['[CH2]C(CC)O[CH][C]=O(10996)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.31549e+08,'s^-1'), n=1.13, Ea=(140.248,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4H_SSS_O(Cs)Cs;Y_rad_out;Cs_H_out_2H] for rate rule [R4H_SSS_O(Cs)Cs;Cd_rad_out;Cs_H_out_2H]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 3.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C(CC)O[CH][C]=O(10996)'],
    products = ['[CH2][C](CC)OC=C[O](11630)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(CC)O[CH][C]=O(10996)'],
    products = ['[CH2]CC(C)OC=[C][O](11761)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2][C](CC)OC=[C]O(11762)'],
    products = ['[CH2]C(CC)O[CH][C]=O(10996)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(46.1,'s^-1'), n=3.21, Ea=(60.7935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6Hall;C_rad_out_H/NonDeC;XH_out] for rate rule [R6HJ_4;C_rad_out_H/NonDeC;O_H_out]
Euclidian distance = 1.4142135623730951
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C(CC)O[CH][C]=O(10996)'],
    products = ['[CH2]CC([CH2])OC=C[O](11634)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]CC([CH2])OC=[C]O(11764)'],
    products = ['[CH2]C(CC)O[CH][C]=O(10996)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2][C](CC)OC[C]=O(11766)'],
    products = ['[CH2]C(CC)O[CH][C]=O(10996)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]CC([CH2])OC[C]=O(11768)'],
    products = ['[CH2]C(CC)O[CH][C]=O(10996)'],
