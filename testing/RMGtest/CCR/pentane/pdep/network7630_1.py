...
species(
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09555,0.0444916,-6.12341e-05,4.83703e-08,-1.52752e-11,-28501.7,16.784], Tmin=(100,'K'), Tmax=(867.088,'K')), NASAPolynomial(coeffs=[7.01796,0.0175594,-7.33543e-06,1.31125e-09,-8.70534e-14,-29196.5,-5.34605], Tmin=(867.088,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-237.526,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)OsHH) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d)"""),
)
...
species(
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.60725,0.0276496,-1.51511e-05,3.74756e-09,-3.45646e-13,-32764.1,16.6664], Tmin=(100,'K'), Tmax=(1863.4,'K')), NASAPolynomial(coeffs=[10.4163,0.0132389,-5.4442e-06,9.52169e-10,-6.14926e-14,-36082.8,-26.9637], Tmin=(1863.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-272.855,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-O2d)HH) + group(Cds-OdCsH) + group(Cds-OdCsH)"""),
)
...
species(
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82499,0.0543892,-9.35816e-05,8.42485e-08,-2.868e-11,-2681.19,20.2696], Tmin=(100,'K'), Tmax=(890.636,'K')), NASAPolynomial(coeffs=[6.28991,0.019161,-8.69203e-06,1.57499e-09,-1.036e-13,-2874.62,2.62505], Tmin=(890.636,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-22.8922,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCsJOH) + radical(CCCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.26831,0.0406716,-5.45531e-05,4.35003e-08,-1.40926e-11,-335.57,21.6264], Tmin=(100,'K'), Tmax=(838.579,'K')), NASAPolynomial(coeffs=[6.32208,0.0179151,-7.73005e-06,1.41273e-09,-9.5345e-14,-895.2,3.49993], Tmin=(838.579,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-3.28798,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(CCCJ=O)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(2355)', '[CH2]C[O](1358)'],
    products = ['[O]CC[C]=O(3357)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(2039)', '[CH2]C[O](1358)'],
    products = ['[O]CC[C]=O(3357)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[O]C[CH][C]=O(10377)'],
    products = ['[O]CC[C]=O(3357)'],
