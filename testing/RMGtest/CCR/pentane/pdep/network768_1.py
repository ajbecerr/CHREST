...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94488,0.034945,7.66394e-06,-3.36252e-08,1.4984e-11,-22687.9,20.7218], Tmin=(100,'K'), Tmax=(989.594,'K')), NASAPolynomial(coeffs=[11.3698,0.0209937,-7.78753e-06,1.43963e-09,-1.03047e-13,-25735.5,-30.6231], Tmin=(989.594,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-189.328,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)

species(
    label = '[CH2]CC(C)=O(1575)',
    structure = SMILES('[CH2]CC(C)=O'),
    E0 = (-46.6048,'kJ/mol'),
    modes = [
        ...
        HinderedRotor(inertia=(0.0860401,'amu*angstrom^2'), symmetry=1, barrier=(1.97823,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0859657,'amu*angstrom^2'), symmetry=1, barrier=(1.97652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0860901,'amu*angstrom^2'), symmetry=1, barrier=(1.97938,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28203,0.0410002,-2.92976e-05,1.25295e-08,-2.50945e-12,-5546.14,17.7899], Tmin=(100,'K'), Tmax=(1074.57,'K')), NASAPolynomial(coeffs=[5.39528,0.0294112,-1.312e-05,2.49269e-09,-1.74336e-13,-6215.2,2.5464], Tmin=(1074.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-46.6048,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CJCC=O)"""),
)
...
species(
    label = '[CH2]C[C](C)[O](1584)',
    structure = SMILES('[CH2]C[C](C)[O]'),
    E0 = (295.461,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,180,1951.8],'cm^-1')),
        HinderedRotor(inertia=(0.01376,'amu*angstrom^2'), symmetry=1, barrier=(4.01755,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.471447,'amu*angstrom^2'), symmetry=1, barrier=(10.8395,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0607356,'amu*angstrom^2'), symmetry=1, barrier=(10.835,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93016,0.047828,-4.28994e-05,2.29657e-08,-5.35131e-12,35608.3,20.4179], Tmin=(100,'K'), Tmax=(997.495,'K')), NASAPolynomial(coeffs=[7.0737,0.0272019,-1.18819e-05,2.23507e-09,-1.55558e-13,34582.2,-4.38366], Tmin=(997.495,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(295.461,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74737,0.0520372,-4.94716e-05,2.87645e-08,-7.24988e-12,7908.68,21.2673], Tmin=(100,'K'), Tmax=(932.136,'K')), NASAPolynomial(coeffs=[7.09924,0.0290718,-1.25165e-05,2.33486e-09,-1.61614e-13,6910.92,-4.17645], Tmin=(932.136,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.0998,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79499,0.0417469,-1.70399e-05,-5.22698e-09,4.43755e-12,10714.1,24.1601], Tmin=(100,'K'), Tmax=(1041.52,'K')), NASAPolynomial(coeffs=[10.1682,0.022764,-8.67518e-06,1.56437e-09,-1.07963e-13,8255.38,-20.0068], Tmin=(1041.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(88.374,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC([CH2])O(3224)',
    structure = SMILES('[CH2]CC([CH2])O'),
    E0 = (100.061,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53762,0.0510969,-4.16986e-05,1.84751e-08,-3.37147e-12,12125.7,23.2207], Tmin=(100,'K'), Tmax=(1292.35,'K')), NASAPolynomial(coeffs=[10.6393,0.0229262,-9.0017e-06,1.60832e-09,-1.08678e-13,9773.17,-23.0239], Tmin=(1292.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.061,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8589,0.0476153,-3.47198e-05,1.40983e-08,-2.47518e-12,10926.7,18.8778], Tmin=(100,'K'), Tmax=(1281.5,'K')), NASAPolynomial(coeffs=[8.1314,0.0280367,-1.18029e-05,2.1764e-09,-1.49398e-13,9319.09,-12.9391], Tmin=(1281.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.2142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(17)', 'CH2CH2CHO(1580)'],
    products = ['[CH2]CC(C)[O](3123)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(17)', '[CH2]C[CH][O](1549)'],
    products = ['[CH2]CC(C)[O](3123)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]C[C](C)[O](1584)'],
    products = ['[CH2]CC(C)[O](3123)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2][CH]C(C)[O](1587)'],
    products = ['[CH2]CC(C)[O](3123)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2]CC([CH2])[O](1406)'],
    products = ['[CH2]CC(C)[O](3123)'],
