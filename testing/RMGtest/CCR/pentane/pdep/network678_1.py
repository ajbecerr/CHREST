...
species(
    label = '[CH2]C[CH]C[C]=O(2617)',
    structure = SMILES('[CH2]C[CH]C[C]=O'),
    E0 = (314.225,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1855,455,950,2443.45,2443.45],'cm^-1')),
        HinderedRotor(inertia=(0.10752,'amu*angstrom^2'), symmetry=1, barrier=(5.70973,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.030247,'amu*angstrom^2'), symmetry=1, barrier=(16.7494,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107522,'amu*angstrom^2'), symmetry=1, barrier=(5.70941,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.31549,'amu*angstrom^2'), symmetry=1, barrier=(16.7494,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85242,0.049812,-4.20533e-05,2.12088e-08,-4.72294e-12,37867.7,26.6981], Tmin=(100,'K'), Tmax=(1029.21,'K')), NASAPolynomial(coeffs=[6.95834,0.029968,-1.31321e-05,2.47519e-09,-1.72467e-13,36816.7,1.91794], Tmin=(1029.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(314.225,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCC=O) + radical(RCCJ) + radical(CCCJ=O)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[CH][CH2](502)', '[CH2]C[C]=O(2354)'],
    products = ['[CH2][CH]CC[C]=O(2285)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[C]=O(2355)', '[CH2][CH]C[CH2](66)'],
    products = ['[CH2][CH]CC[C]=O(2285)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH][CH]CC[C]=O(2610)'],
    products = ['[CH2][CH]CC[C]=O(2285)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction12',
    reactants = ['CO(2039)', '[CH2][CH]C[CH2](66)'],
    products = ['[CH2][CH]CC[C]=O(2285)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2]C=CC[C]=O(2613)'],
    products = ['[CH2][CH]CC[C]=O(2285)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2][CH][CH]C[C]=O(2615)'],
    products = ['[CH2][CH]CC[C]=O(2285)'],
