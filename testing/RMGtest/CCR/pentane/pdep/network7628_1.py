...
species(
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.2682,0.02741,8.96118e-06,-3.49163e-08,1.60192e-11,-35312.1,15.3427], Tmin=(100,'K'), Tmax=(975.347,'K')), NASAPolynomial(coeffs=[12.8622,0.00973856,-3.5025e-06,6.98069e-10,-5.44432e-14,-38604.7,-41.788], Tmin=(975.347,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-294.199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-OdOsH)"""),
)
...
species(
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03824,0.0527526,-6.03071e-05,3.19426e-08,-6.20959e-12,10796.1,22.3127], Tmin=(100,'K'), Tmax=(1470.45,'K')), NASAPolynomial(coeffs=[16.3515,0.00166969,1.4186e-06,-4.02119e-10,3.07611e-14,7311.73,-54.004], Tmin=(1470.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(88.7885,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(OCJO) + radical(C=CJO)"""),
)

species(
    label = '[CH]=COC[O](28868)',
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.30745,'amu*angstrom^2'), symmetry=1, barrier=(30.0608,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.3079,'amu*angstrom^2'), symmetry=1, barrier=(30.0713,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84782,0.0295035,2.66727e-05,-7.14121e-08,3.37937e-11,16280.1,17.3678], Tmin=(100,'K'), Tmax=(924.08,'K')), NASAPolynomial(coeffs=[19.884,-0.00241645,3.57104e-06,-6.98834e-10,4.12193e-14,10976.2,-78.8842], Tmin=(924.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.578,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(OCOJ) + radical(Cds_P)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.950994,'amu*angstrom^2'), symmetry=1, barrier=(21.8652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.951589,'amu*angstrom^2'), symmetry=1, barrier=(21.8789,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52212,0.0338833,2.49854e-05,-8.27999e-08,4.20755e-11,17779.6,21.1923], Tmin=(100,'K'), Tmax=(896.586,'K')), NASAPolynomial(coeffs=[24.6117,-0.0131481,1.00151e-05,-2.03076e-09,1.3674e-13,11389.3,-100.229], Tmin=(896.586,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(146.924,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[O](28827)', 'H2CC(T)(1341)'],
    products = ['C=[C]OC[O](3369)'],
    transitionState = 'TS2',
