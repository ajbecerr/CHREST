...
species(
    label = '[CH2][C]CC[CH2](216)',
    structure = SMILES('[CH2][C]CC[CH2]'),
    E0 = (690.624,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,295.349,1466.28,1466.28],'cm^-1')),
        HinderedRotor(inertia=(0.256913,'amu*angstrom^2'), symmetry=1, barrier=(15.9404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00598279,'amu*angstrom^2'), symmetry=1, barrier=(9.12642,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146796,'amu*angstrom^2'), symmetry=1, barrier=(9.12645,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.570159,'amu*angstrom^2'), symmetry=1, barrier=(35.3919,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7312,0.047202,-3.22285e-05,1.15545e-08,-1.72947e-12,83146.5,23.4707], Tmin=(100,'K'), Tmax=(1514.33,'K')), NASAPolynomial(coeffs=[10.1821,0.0248801,-1.01183e-05,1.82088e-09,-1.22596e-13,80586.9,-20.8068], Tmin=(1514.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(690.624,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]CC[CH][CH2](217)',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH][CH2](215)', '[CH2]C[CH2](21)'],
    products = ['[CH2][CH]CC[CH2](134)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(9)', '[CH2][C]CC[CH2](216)'],
    products = ['[CH2][CH]CC[CH2](134)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(9)', '[CH]CC[CH][CH2](217)'],
    products = ['[CH2][CH]CC[CH2](134)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['H(9)', '[CH][CH]CC[CH2](218)'],
    products = ['[CH2][CH]CC[CH2](134)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['H(9)', '[CH2]C=CC[CH2](219)'],
    products = ['[CH2][CH]CC[CH2](134)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(9)', '[CH2][CH][CH]C[CH2](221)'],
    products = ['[CH2][CH]CC[CH2](134)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(9)', '[CH2][CH]C[CH][CH2](222)'],
    products = ['[CH2][CH]CC[CH2](134)'],
