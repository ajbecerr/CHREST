species(
    label = '[CH]=CO[C]=C(15046)',
    structure = SMILES('[CH]=CO[C]=C'),
    E0 = (456.654,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,234.462,234.462],'cm^-1')),
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.16819,'amu*angstrom^2'), symmetry=1, barrier=(26.859,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87029,0.0366534,-9.50513e-06,-2.4687e-08,1.53141e-11,55893.2,18.7973], Tmin=(100,'K'), Tmax=(918.679,'K')), NASAPolynomial(coeffs=[15.5465,0.00386026,3.55371e-07,-1.42281e-10,8.13112e-15,52251.4,-52.167], Tmin=(918.679,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(464.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H2CC(T)(1341)', 'ketene(T)(1373)'],
    products = ['[CH]=CO[C]=C(15046)'],
    transitionState = 'TS2',
