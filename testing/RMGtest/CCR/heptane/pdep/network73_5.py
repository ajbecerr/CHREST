...
species(
    ...
    E0 = (532.938,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,181.894],'cm^-1')),
        HinderedRotor(inertia=(0.799417,'amu*angstrom^2'), symmetry=1, barrier=(20.4611,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00686664,'amu*angstrom^2'), symmetry=1, barrier=(33.8172,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (41.0718,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.04384,0.0162269,8.19929e-06,-1.95239e-08,7.97721e-12,64136.3,12.4835], Tmin=(100,'K'), Tmax=(994.051,'K')), NASAPolynomial(coeffs=[6.51415,0.0136529,-5.10446e-06,9.25401e-10,-6.47359e-14,62883.6,-7.06867], Tmin=(994.051,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(532.938,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    E0 = (522.015,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,207.632,1480.41,1480.59],'cm^-1')),
        HinderedRotor(inertia=(0.00239246,'amu*angstrom^2'), symmetry=1, barrier=(3.72084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124812,'amu*angstrom^2'), symmetry=1, barrier=(3.71744,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (41.0718,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.15627,0.0161614,5.77898e-07,-6.36827e-09,2.16633e-12,62816.2,13.7456], Tmin=(100,'K'), Tmax=(1255.21,'K')), NASAPolynomial(coeffs=[4.8916,0.0164623,-6.74964e-06,1.22436e-09,-8.29833e-14,61921.2,3.14942], Tmin=(1255.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(522.015,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJC) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][CH]C(39)'],
    products = ['C=CC(38)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(6.31e+07,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 2 C3H6 => C3H6-2 in 1,2-Birad_to_alkene/training
This reaction matched rate rule [Y_12_10]
family: 1,2-Birad_to_alkene"""),
)

reaction(
    label = 'reaction18',
    reactants = ['[CH3](12)', '[CH][CH2](215)'],
    products = ['[CH2][CH]C(39)'],
