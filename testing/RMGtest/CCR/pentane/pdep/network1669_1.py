...
species(
    label = '[CH]C([O])OC#C(7113)',
    structure = SMILES('[CH]C([O])OC#C'),
    E0 = (497.509,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2175,525,750,770,3400,2100,454.99,454.99,454.992,454.992,454.993,454.994],'cm^-1')),
        HinderedRotor(inertia=(0.00081431,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199297,'amu*angstrom^2'), symmetry=1, barrier=(29.2788,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199305,'amu*angstrom^2'), symmetry=1, barrier=(29.2784,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31877,0.0568847,-6.62296e-05,3.71108e-08,-8.0654e-12,59934.9,20.7909], Tmin=(100,'K'), Tmax=(1129.72,'K')), NASAPolynomial(coeffs=[14.3416,0.0107752,-5.00795e-06,9.8333e-10,-7.06989e-14,56992.4,-43.6253], Tmin=(1129.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(497.509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCOJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.974915,0.0607133,-6.67091e-05,3.19644e-08,-4.83777e-12,66181.8,27.2365], Tmin=(100,'K'), Tmax=(965.09,'K')), NASAPolynomial(coeffs=[16.8735,0.00696513,-2.04931e-06,3.39826e-10,-2.3852e-14,62547.4,-51.8307], Tmin=(965.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(549.317,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H2CC(T)(1341)', '[CH]C([O])[O](6931)'],
    products = ['[CH]C([O])O[C]=C(2841)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C([O])OC#C(7113)'],
    products = ['[CH]C([O])O[C]=C(2841)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH](6993)', 'C=[C]OC=O(2846)'],
    products = ['[CH]C([O])O[C]=C(2841)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]C([O])O[C]=[CH](7115)'],
    products = ['[CH]C([O])O[C]=C(2841)'],
