...
species(
    label = 'C=[C]C[CH]C1CC1(16118)',
    structure = SMILES('C=[C]C[CH]C1CC1'),
    E0 = (498.076,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    ...
    E0 = (499.575,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = 'C=[C]CC1[C]CC1(16119)',
    structure = SMILES('C=[C]CC1[C]CC1'),
    E0 = (747.33,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37498,0.0416713,2.80927e-05,-6.37053e-08,2.64408e-11,89991.8,25.9009], Tmin=(100,'K'), Tmax=(989.534,'K')), NASAPolynomial(coeffs=[14.1366,0.0287457,-1.09186e-05,2.06045e-09,-1.49745e-13,85573.4,-45.0965], Tmin=(989.534,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(747.33,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(CCJ2_triplet) + radical(Cds_S)"""),
)
...
species(
    label = 'C=CCC1=CCC1(16121)',
    structure = SMILES('C=CCC1=CCC1'),
    E0 = (188.039,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48224,0.036308,5.06986e-05,-8.9368e-08,3.597e-11,22723.5,24.7523], Tmin=(100,'K'), Tmax=(974.923,'K')), NASAPolynomial(coeffs=[14.7196,0.0290402,-1.04999e-05,1.9755e-09,-1.45309e-13,17906.8,-50.2403], Tmin=(974.923,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(188.039,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutene)"""),
)

species(
    label = 'C=C=CC1CCC1(16122)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56081,0.0334351,6.07982e-05,-9.96897e-08,3.94639e-11,27371.8,23.5044], Tmin=(100,'K'), Tmax=(974.941,'K')), NASAPolynomial(coeffs=[14.6506,0.0298679,-1.08532e-05,2.05388e-09,-1.5174e-13,22436.7,-51.5344], Tmin=(974.941,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(226.702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cdd-Cd)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + ring(Cyclobutane)"""),
)

species(
    label = 'C=CCC1C=CC1(15542)',
...
species(
    label = '[CH2]CC=CC[C]=C(16123)',
    structure = SMILES('[CH2]CC=CC[C]=C'),
    E0 = (473.167,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,195.799,197.005,4000],'cm^-1')),
        HinderedRotor(inertia=(0.784876,'amu*angstrom^2'), symmetry=1, barrier=(21.7962,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.762332,'amu*angstrom^2'), symmetry=1, barrier=(21.7795,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.375986,'amu*angstrom^2'), symmetry=1, barrier=(10.3527,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00818505,'amu*angstrom^2'), symmetry=1, barrier=(21.7994,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46973,0.0464011,2.34164e-07,-2.19889e-08,8.65259e-12,58375.1,26.7995], Tmin=(100,'K'), Tmax=(1138.7,'K')), NASAPolynomial(coeffs=[9.2308,0.0390406,-1.62872e-05,3.03289e-09,-2.10797e-13,55317.3,-17.317], Tmin=(1138.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(484.537,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]CC1C[CH]C1(16134)',
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48655,0.0359175,5.35382e-05,-9.21217e-08,3.67957e-11,52960,25.4715], Tmin=(100,'K'), Tmax=(976.508,'K')), NASAPolynomial(coeffs=[14.5614,0.0301542,-1.10252e-05,2.0776e-09,-1.52587e-13,48127.7,-48.9642], Tmin=(976.508,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(439.438,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutane) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7828,0.0352121,3.61093e-05,-6.07348e-08,2.24234e-11,52644.4,28.7564], Tmin=(100,'K'), Tmax=(1040.57,'K')), NASAPolynomial(coeffs=[9.59358,0.0381996,-1.57851e-05,3.00071e-09,-2.14095e-13,49231.6,-17.8247], Tmin=(1040.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(436.95,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(cyclobutane)"""),
)
...
species(
    label = '[CH]=[C]CC1CCC1(16137)',
    structure = SMILES('[CH]=[C]CC1CCC1'),
    E0 = (546.211,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2750,2850,1437.5,1250,1305,750,350,1685,370,3120,650,792.5,1650,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34719,0.0422099,3.07283e-05,-6.57594e-08,2.68239e-11,65803.8,26.4986], Tmin=(100,'K'), Tmax=(994.12,'K')), NASAPolynomial(coeffs=[13.5696,0.0318419,-1.21883e-05,2.29219e-09,-1.6552e-13,61455.9,-42.0409], Tmin=(994.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(546.211,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['C=[C]C[CH]C1CC1(16118)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C1CC1C[C]=C(15827)'],
    products = ['C=[C]CC1[CH]CC1(15541)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['H2CC(T)(1341)', '[CH2]C1[CH]CC1(6246)'],
    products = ['C=[C]CC1[CH]CC1(15541)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'C=[C]CC1[C]CC1(16119)'],
    products = ['C=[C]CC1[CH]CC1(15541)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'C=[C]CC1=CCC1(16124)'],
    products = ['C=[C]CC1[CH]CC1(15541)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C=[C]CC1C=CC1(16125)'],
    products = ['C=[C]CC1[CH]CC1(15541)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'C=C=CC1[CH]CC1(16126)'],
    products = ['C=[C]CC1[CH]CC1(15541)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', 'C#CCC1[CH]CC1(16127)'],
    products = ['C=[C]CC1[CH]CC1(15541)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', 'C=[C]C[C]1[CH]CC1(16128)'],
    products = ['C=[C]CC1[CH]CC1(15541)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', 'C=[C]CC1[CH]C[CH]1(16129)'],
    products = ['C=[C]CC1[CH]CC1(15541)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', 'C=[C]CC1[CH][CH]C1(16130)'],
    products = ['C=[C]CC1[CH]CC1(15541)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C=[C][CH]C1[CH]CC1(16131)'],
    products = ['C=[C]CC1[CH]CC1(15541)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH]=[C]CC1[CH]CC1(16132)'],
    products = ['C=[C]CC1[CH]CC1(15541)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C=[C]CC1C[CH]C1(16134)'],
    products = ['C=[C]CC1[CH]CC1(15541)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C=[C]CC1[CH]CC1(15541)'],
    products = ['[CH2]C=CC1[CH]CC1(6382)'],
...
reaction(
    label = 'reaction31',
    reactants = ['C=[C]CC1[CH]CC1(15541)'],
    products = ['C=CCC1[CH]C[CH]1(16136)'],
