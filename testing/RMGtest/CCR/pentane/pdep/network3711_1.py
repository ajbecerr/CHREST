...
reaction(
    label = 'reaction3',
    reactants = ['H2CC(T)(1341)', '[CH]C=C(3739)'],
    products = ['[CH]=CC[C]=C(15597)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH]=C[CH][C]=C(15981)'],
    products = ['[CH]=CC[C]=C(15597)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH]=[C]C[C]=C(15982)'],
    products = ['[CH]=CC[C]=C(15597)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH]=[C]CC=[CH](15983)'],
    products = ['[CH]=CC[C]=C(15597)'],
