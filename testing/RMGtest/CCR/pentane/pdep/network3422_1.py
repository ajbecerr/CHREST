...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH]=CC([CH2])C(13652)'],
    products = ['[CH]=CC([CH2])CC(4956)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', '[CH]C=CCC(13631)'],
    products = ['[CH]=CC([CH2])CC(4956)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]C(C=[CH])CC(15095)'],
    products = ['[CH]=CC([CH2])CC(4956)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[C]=CC([CH2])CC(15096)'],
    products = ['[CH]=CC([CH2])CC(4956)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]=CC(=C)CC(13781)'],
    products = ['[CH]=CC([CH2])CC(4956)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C#CC([CH2])CC(9780)'],
    products = ['[CH]=CC([CH2])CC(4956)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C2H5(14)', 'CH2CHCHCH(4849)'],
    products = ['[CH]=CC([CH2])CC(4956)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C2H5(14)', '[CH]C=C[CH2](15066)'],
    products = ['[CH]=CC([CH2])CC(4956)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH]=C[C]([CH2])CC(13791)'],
    products = ['[CH]=CC([CH2])CC(4956)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH3(17)', '[CH]=CC([CH2])[CH2](13775)'],
    products = ['[CH]=CC([CH2])CC(4956)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH]=[C]C([CH2])CC(9773)'],
    products = ['[CH]=CC([CH2])CC(4956)'],
