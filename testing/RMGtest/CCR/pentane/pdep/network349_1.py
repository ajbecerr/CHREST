species(
    ...
    E0 = (147.228,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2762.5,2775,2787.5,2800,2812.5,2825,2837.5,2850,1350,1380,1410,1440,1470,1500,700,750,800,1000,1050,1100,1350,1375,1400,900,1000,1100,3000,3050,390,425,1340,1360,335,370,212.891,816.078,1225.49,1674.52],'cm^-1')),
        HinderedRotor(inertia=(0.108519,'amu*angstrom^2'), symmetry=1, barrier=(3.51441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108519,'amu*angstrom^2'), symmetry=1, barrier=(3.51441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108519,'amu*angstrom^2'), symmetry=1, barrier=(3.51441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108519,'amu*angstrom^2'), symmetry=1, barrier=(3.51441,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108519,'amu*angstrom^2'), symmetry=1, barrier=(3.51441,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH]C[CH]C(C)C(1237)',
    structure = SMILES('CC[CH]C[CH]C(C)C'),
    E0 = (143.881,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.774924,0.0777537,-3.89084e-05,8.82168e-09,-7.80156e-13,17412.7,34.2663], Tmin=(100,'K'), Tmax=(2499.73,'K')), NASAPolynomial(coeffs=[24.55,0.0397105,-1.60806e-05,2.7338e-09,-1.71319e-13,5526.12,-102.218], Tmin=(2499.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(143.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(RCCJCC)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.364005,0.0837855,-5.27402e-05,1.7782e-08,-2.63346e-12,48344.2,33.8074], Tmin=(100,'K'), Tmax=(1430.77,'K')), NASAPolynomial(coeffs=[10.124,0.0564995,-2.41338e-05,4.45282e-09,-3.04436e-13,45551.3,-16.775], Tmin=(1430.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(400.901,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C[CH]C(C)C[C]CC(1240)',
    ...
    molecularWeight = (111.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0977107,0.0865892,-5.49737e-05,1.77349e-08,-2.37741e-12,48376.9,35.47], Tmin=(100,'K'), Tmax=(1656.38,'K')), NASAPolynomial(coeffs=[15.9928,0.047732,-1.97848e-05,3.57185e-09,-2.39741e-13,43046.6,-50.2771], Tmin=(1656.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(400.985,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'CC=C(C)CCCC(1241)',
    structure = SMILES('CC=C(C)CCCC'),
    E0 = (-139.163,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.281413,0.0869016,-5.16753e-05,1.53124e-08,-1.85631e-12,-16577.8,32.5144], Tmin=(100,'K'), Tmax=(1839.22,'K')), NASAPolynomial(coeffs=[18.566,0.0459112,-1.82447e-05,3.19462e-09,-2.09157e-13,-23510.7,-69.8978], Tmin=(1839.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-139.163,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CCC=CC(C)CC(358)',
    structure = SMILES('CCC=CC(C)CC'),
    E0 = (-130.725,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.165683,0.0772598,-1.76021e-05,-2.28602e-08,1.17788e-11,-15560.5,33.997], Tmin=(100,'K'), Tmax=(1071.89,'K')), NASAPolynomial(coeffs=[14.8246,0.0501253,-1.99395e-05,3.66393e-09,-2.54692e-13,-20428.8,-47.0819], Tmin=(1071.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-130.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'C=CC(C)CCCC(1168)',
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.302639,0.0810185,-2.80326e-05,-1.21361e-08,8.02025e-12,-14220,34.2612], Tmin=(100,'K'), Tmax=(1101.73,'K')), NASAPolynomial(coeffs=[15.1381,0.0500382,-1.99985e-05,3.66391e-09,-2.53405e-13,-19144.4,-48.6351], Tmin=(1101.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-119.615,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'CC=CCC(C)CC(219)',
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.287919,0.081802,-3.46671e-05,-2.48577e-09,4.07412e-12,-15420.5,33.7418], Tmin=(100,'K'), Tmax=(1180.35,'K')), NASAPolynomial(coeffs=[14.6969,0.0508371,-2.04985e-05,3.7346e-09,-2.55758e-13,-20338.4,-46.8833], Tmin=(1180.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.582,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    label = 'CC[CH]C[C](C)CC(368)',
    structure = SMILES('CC[CH]C[C](C)CC'),
    E0 = (138.109,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97981,0.0727627,-3.34007e-05,6.48892e-09,-4.67844e-13,16652.4,29.0672], Tmin=(100,'K'), Tmax=(3059.47,'K')), NASAPolynomial(coeffs=[57.8909,0.00503007,-2.82374e-06,3.99427e-10,-1.70983e-14,-20070.8,-307.298], Tmin=(3059.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(RCCJCC)"""),
)
...
species(
    label = 'C[CH]CCC(C)[CH]C(1251)',
    structure = SMILES('C[CH]CCC(C)[CH]C'),
    E0 = (147.216,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.525357,0.0796429,-4.15263e-05,1.0164e-08,-9.96156e-13,17826.3,36.0388], Tmin=(100,'K'), Tmax=(2190.71,'K')), NASAPolynomial(coeffs=[18.5803,0.0466765,-1.89539e-05,3.29489e-09,-2.12262e-13,9915.67,-65.2253], Tmin=(2190.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(RCCJC)"""),
)

species(
    label = '[CH2]CC(C)C[CH]CC(375)',
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.437774,0.0817986,-4.51706e-05,1.22861e-08,-1.39253e-12,19118.4,35.4081], Tmin=(100,'K'), Tmax=(1840.93,'K')), NASAPolynomial(coeffs=[13.401,0.0536319,-2.22203e-05,3.97501e-09,-2.63882e-13,14345.5,-35.0431], Tmin=(1840.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.933,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJ)"""),
)

species(
    label = 'CC[CH][CH]C(C)CC(371)',
    structure = SMILES('CC[CH][CH]C(C)CC'),
    E0 = (147.228,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2762.5,2775,2787.5,2800,2812.5,2825,2837.5,2850,1350,1380,1410,1440,1470,1500,700,750,800,1000,1050,1100,1350,1375,1400,900,1000,1100,3000,3050,390,425,1340,1360,335,370,212.891,816.078,1225.49,1674.52],'cm^-1')),
        HinderedRotor(inertia=(0.108519,'amu*angstrom^2'), symmetry=1, barrier=(3.51441,'kJ/mol'), semiclassical=False),
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.318356,0.0837671,-5.04101e-05,1.66637e-08,-2.45924e-12,19104.6,35.8489], Tmin=(100,'K'), Tmax=(1417.49,'K')), NASAPolynomial(coeffs=[9.04095,0.0591527,-2.43627e-05,4.41306e-09,-2.98601e-13,16631.8,-9.27573], Tmin=(1417.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.768,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Isobutyl)"""),
)

species(
    label = 'C[CH][C](C)CCCC(1252)',
    structure = SMILES('C[CH][C](C)CCCC'),
    E0 = (138.193,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56355,0.066507,4.86484e-05,-2.26448e-07,2.01464e-10,16694.8,31.0849], Tmin=(100,'K'), Tmax=(414.112,'K')), NASAPolynomial(coeffs=[2.84723,0.0715463,-3.2771e-05,6.31565e-09,-4.4609e-13,16439,24.2182], Tmin=(414.112,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.193,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Cs_S)"""),
)

species(
    label = '[CH2]CCCC(C)[CH]C(1253)',
    structure = SMILES('[CH2]CCCC(C)[CH]C'),
    E0 = (158.016,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.145063,0.0856645,-4.98466e-05,1.42102e-08,-1.64861e-12,19158,37.5362], Tmin=(100,'K'), Tmax=(1909.24,'K')), NASAPolynomial(coeffs=[18.9456,0.0456683,-1.84235e-05,3.23798e-09,-2.11885e-13,11868.2,-66.9112], Tmin=(1909.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(158.016,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C([CH]C)CCCC(374)',
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.142886,0.0865654,-5.26267e-05,1.65984e-08,-2.19712e-12,19137.4,37.5097], Tmin=(100,'K'), Tmax=(1663.79,'K')), NASAPolynomial(coeffs=[14.9003,0.0503994,-2.00211e-05,3.53372e-09,-2.34031e-13,14131.6,-42.7235], Tmin=(1663.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][CH]C(C)CCCC(1254)',
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15644,0.0754167,-3.61951e-05,7.83536e-09,-6.61038e-13,17783.3,33.7175], Tmin=(100,'K'), Tmax=(2561.17,'K')), NASAPolynomial(coeffs=[21.5648,0.0435433,-1.75279e-05,2.97633e-09,-1.86742e-13,7329.43,-83.9344], Tmin=(2561.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.132,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C[CH]CC(C)CC(378)',
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'C[CH]CC[CH]CC(203)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', 'C[CH]CC(C)[CH]C(312)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C[CH]C(C)C[CH]CC(370)'],
    products = ['CC[CH]C[CH]C(C)C(1237)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(C)CC(C)[CH]C(1238)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHCH3(T)(21)', 'C[CH]C[CH]CC(137)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]CC(26)', '[CH2]C(C)[CH]C(114)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H5(14)', '[CH]CC(C)[CH]C(1181)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(17)', '[CH]C(C)C[CH]CC(277)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C[C]C(C)C[CH]CC(1239)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'C[CH]C(C)C[C]CC(1240)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'CC=C(C)C[CH]CC(1242)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'C[CH]C(C)C=CCC(1243)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', 'C[CH]C(C)CC=CC(1244)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', 'C=CC(C)C[CH]CC(1245)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH3(17)', 'CC=CC[CH]CC(323)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH3(17)', 'C=CCC(C)[CH]C(1172)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH3(17)', 'C[CH][CH]C[CH]CC(327)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', 'C[CH][C](C)C[CH]CC(1246)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', 'C[CH]C(C)[CH][CH]CC(1247)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH3(17)', '[CH2][CH]CC(C)[CH]C(591)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', 'C[CH][CH]CC(C)[CH]C(1248)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', '[CH2]C([CH]C)C[CH]CC(363)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', '[CH2]C[CH]CC(C)[CH]C(1249)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', '[CH2][CH]C(C)C[CH]CC(1250)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction36',
    reactants = ['C[CH]C(C)[CH]CCC(1220)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C(CC)C[CH]CC(217)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2]CCCC(C)[CH]C(1253)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH2][CH]C(C)CCCC(1254)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2]C[CH]CC(C)CC(378)'],
    products = ['C[CH]C(C)C[CH]CC(370)'],
