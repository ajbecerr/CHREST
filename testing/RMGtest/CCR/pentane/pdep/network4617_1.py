...
species(
    label = '[CH2]C(CC)C[C]=C[O](21558)',
    structure = SMILES('[CH2]C(CC)C[C]=C[O]'),
    E0 = (282.037,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.131413,0.0797639,-4.83237e-05,2.4098e-09,6.08017e-12,34079.9,34.8843], Tmin=(100,'K'), Tmax=(980.273,'K')), NASAPolynomial(coeffs=[17.5273,0.0315736,-1.11028e-05,1.93258e-09,-1.32098e-13,29471.1,-55.8056], Tmin=(980.273,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(282.037,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Isobutyl) + radical(Cds_S)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.280515,0.0954848,-9.69385e-05,5.4208e-08,-1.24389e-11,79557.6,38.0419], Tmin=(100,'K'), Tmax=(1044.42,'K')), NASAPolynomial(coeffs=[14.2603,0.0397953,-1.69571e-05,3.15479e-09,-2.18458e-13,76520.3,-32.741], Tmin=(1044.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(660.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2]C(CC)CC1=COO1(21560)',
    structure = SMILES('[CH2]C(CC)CC1=COO1'),
    E0 = (207.523,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.10033,0.0748692,-2.25782e-05,-2.48559e-08,1.50099e-11,25120.4,36.1577], Tmin=(100,'K'), Tmax=(1001.51,'K')), NASAPolynomial(coeffs=[18.3288,0.0349137,-1.31342e-05,2.40644e-09,-1.70062e-13,19741.4,-61.2051], Tmin=(1001.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(207.523,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.469973,0.0890896,-7.27169e-05,3.11415e-08,-5.39358e-12,11565,37.2036], Tmin=(100,'K'), Tmax=(1373.7,'K')), NASAPolynomial(coeffs=[18.1646,0.0348282,-1.34661e-05,2.38641e-09,-1.60392e-13,6445.43,-58.6139], Tmin=(1373.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.7562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.73041,0.0971853,-8.85074e-05,4.2833e-08,-8.35018e-12,22944.7,37.8448], Tmin=(100,'K'), Tmax=(1233.79,'K')), NASAPolynomial(coeffs=[18.2382,0.0356878,-1.37404e-05,2.43306e-09,-1.63989e-13,18264,-57.6529], Tmin=(1233.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.309,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cdd-Cd)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(CC)CC#CO[O](21106)',
    structure = SMILES('[CH2]C(CC)CC#CO[O]'),
    E0 = (404.747,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2100,2250,500,550,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.111793,0.0909085,-9.11405e-05,5.31407e-08,-1.28414e-11,48827.5,37.187], Tmin=(100,'K'), Tmax=(993.557,'K')), NASAPolynomial(coeffs=[12.2136,0.0412867,-1.62241e-05,2.872e-09,-1.92584e-13,46378.3,-22.1961], Tmin=(993.557,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(404.747,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCt) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(ROOJ) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C=C[CH]O[O])CC(19682)',
    structure = SMILES('[CH2]C(C=C[CH]O[O])CC'),
    E0 = (284.672,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.375177,0.0853956,-5.96321e-05,1.75577e-08,-6.93396e-13,34404.8,39.4886], Tmin=(100,'K'), Tmax=(1091.41,'K')), NASAPolynomial(coeffs=[16.9703,0.0370372,-1.40773e-05,2.50256e-09,-1.70215e-13,29712.5,-49.8612], Tmin=(1091.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(284.672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Isobutyl) + radical(C=CCJO)"""),
)

species(
    label = '[CH2]C(CC)CC=[C]O[O](21569)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00265852,0.0915451,-9.25924e-05,5.67736e-08,-1.48111e-11,50532,40.4634], Tmin=(100,'K'), Tmax=(911.849,'K')), NASAPolynomial(coeffs=[10.0686,0.0473893,-1.99562e-05,3.66859e-09,-2.51448e-13,48696.3,-7.17007], Tmin=(911.849,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(418.977,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Isobutyl) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C(CC)C[C]=[C]OO(21570)',
    structure = SMILES('[CH2]C(CC)C[C]=[C]OO'),
    E0 = (504.814,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,1670,1700,300,440,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.291016,0.0996604,-0.000112246,7.60022e-08,-2.16575e-11,60864.8,41.2348], Tmin=(100,'K'), Tmax=(842.197,'K')), NASAPolynomial(coeffs=[10.4681,0.0485611,-2.12369e-05,3.96214e-09,-2.73283e-13,59052.6,-8.8241], Tmin=(842.197,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(504.814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Isobutyl) + radical(Cds_S) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.28146,0.0909948,-8.16974e-05,2.03489e-08,1.52176e-11,43983.1,37.5498], Tmin=(100,'K'), Tmax=(583.622,'K')), NASAPolynomial(coeffs=[8.93737,0.049579,-2.12831e-05,3.91846e-09,-2.67542e-13,42667.7,-2.16184], Tmin=(583.622,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(364.655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Tertalkyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]CC([CH2])CC=CO[O](9010)',
    structure = SMILES('[CH2]CC([CH2])CC=CO[O]'),
    E0 = (384.479,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.377171,0.0931325,-8.60106e-05,4.38778e-08,-9.16041e-12,46402.4,40.4722], Tmin=(100,'K'), Tmax=(1146.66,'K')), NASAPolynomial(coeffs=[15.1441,0.0389878,-1.51807e-05,2.69705e-09,-1.81919e-13,42842.9,-36.533], Tmin=(1146.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(384.479,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C(C=[C][CH]OO)CC(19684)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.61835,0.0929026,-7.70102e-05,3.34471e-08,-5.88105e-12,44735.3,40.0788], Tmin=(100,'K'), Tmax=(1352.68,'K')), NASAPolynomial(coeffs=[18.4925,0.0363902,-1.43435e-05,2.56205e-09,-1.7297e-13,39565.1,-57.8935], Tmin=(1352.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(370.509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(C=CCJO) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C](CC)C[C]=COO(21574)',
    structure = SMILES('[CH2][C](CC)C[C]=COO'),
    E0 = (450.492,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.567521,0.10731,-0.000140138,1.11e-07,-3.62655e-11,54339.6,40.2216], Tmin=(100,'K'), Tmax=(812.55,'K')), NASAPolynomial(coeffs=[9.72392,0.0500069,-2.20969e-05,4.0949e-09,-2.79224e-13,52886.4,-5.94351], Tmin=(812.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(450.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Tertalkyl) + radical(Isobutyl) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2]CC([CH2])C[C]=COO(21576)',
    structure = SMILES('[CH2]CC([CH2])C[C]=COO'),
    E0 = (470.316,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.519247,0.0994321,-9.91992e-05,5.45615e-08,-1.22837e-11,56728.7,40.702], Tmin=(100,'K'), Tmax=(1065.84,'K')), NASAPolynomial(coeffs=[15.059,0.0409684,-1.69211e-05,3.09799e-09,-2.12584e-13,53407.9,-35.4475], Tmin=(1065.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(470.316,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Isobutyl) + radical(RCCJ) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]C(C)C[C]=CO[O](20931)'],
    products = ['[CH2]C(CC)C[C]=CO[O](20955)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(CC)C[C]=CO[O](20955)'],
    products = ['CCC[CH]C[C]=CO[O](21557)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(CC)C[C]=CO[O](20955)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(6.55606e+10,'s^-1'), n=0.64, Ea=(159.935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [cCs(-HC)CJ;CsJ;C] for rate rule [cCs(-HC)CJ;CsJ-HH;C]
Euclidian distance = 1.0
family: 1,2_shiftC"""),
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(CC)C[C]=CO[O](20955)'],
    products = ['O2(S)(666)', 'C#CCC([CH2])CC(15534)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction7',
    reactants = ['O(4)', '[CH2]C(CC)C[C]=C[O](21558)'],
    products = ['[CH2]C(CC)C[C]=CO[O](20955)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[C]=CO[O](21346)', '[CH2]C([CH2])CC(117)'],
    products = ['[CH2]C(CC)C[C]=CO[O](20955)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]C(CC)C[C]=CO[O](21559)'],
    products = ['[CH2]C(CC)C[C]=CO[O](20955)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(CC)C[C]=CO[O](20955)'],
    products = ['[CH2]C(CC)CC1=COO1(21560)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C(CC)C[C]=CO[O](20955)'],
    products = ['O(4)', '[CH2]C(CC)CC1=CO1(21562)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CC)C[C]=CO[O](20955)'],
    products = ['[CH2]C(C=C=COO)CC(19674)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C=C(CC)C[C]=CO[O](21564)'],
    products = ['[CH2]C(CC)C[C]=CO[O](20955)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2]C(C=C=CO[O])CC(19372)'],
    products = ['[CH2]C(CC)C[C]=CO[O](20955)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH2]C(CC)CC#CO[O](21106)'],
    products = ['[CH2]C(CC)C[C]=CO[O](20955)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C2H5(14)', 'C=CC[C]=CO[O](21013)'],
    products = ['[CH2]C(CC)C[C]=CO[O](20955)'],
...
reaction(
    label = 'reaction23',
    reactants = ['O2(2)', 'C#CCC([CH2])CC(15534)'],
    products = ['[CH2]C(CC)C[C]=CO[O](20955)'],
...
reaction(
    label = 'reaction24',
    reactants = ['O2(2)', '[CH]=[C]CC([CH2])CC(15665)'],
    products = ['[CH2]C(CC)C[C]=CO[O](20955)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C2H5(14)', '[CH2][CH]C[C]=CO[O](21352)'],
    products = ['[CH2]C(CC)C[C]=CO[O](20955)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH2][C](CC)C[C]=CO[O](21565)'],
    products = ['[CH2]C(CC)C[C]=CO[O](20955)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH3(17)', '[CH2]C([CH2])C[C]=CO[O](20979)'],
    products = ['[CH2]C(CC)C[C]=CO[O](20955)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', '[CH2]C(C=[C][CH]O[O])CC(19679)'],
    products = ['[CH2]C(CC)C[C]=CO[O](20955)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', '[CH2]CC([CH2])C[C]=CO[O](21566)'],
    products = ['[CH2]C(CC)C[C]=CO[O](20955)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', '[CH2]C(CC)C[C]=[C]O[O](21567)'],
    products = ['[CH2]C(CC)C[C]=CO[O](20955)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C(CC)C[C]=CO[O](20955)'],
    products = ['[CH2]C(C=C[CH]O[O])CC(19682)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]C(CC)C[C]=CO[O](20955)'],
    products = ['[CH2]C(CC)CC=[C]O[O](21569)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C(CC)C[C]=[C]OO(21570)'],
    products = ['[CH2]C(CC)C[C]=CO[O](20955)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]C(CC)C[C]=CO[O](20955)'],
    products = ['[CH2][C](CC)CC=CO[O](21571)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2]CC(C)C[C]=CO[O](21572)'],
    products = ['[CH2]C(CC)C[C]=CO[O](20955)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2]C(CC)C[C]=CO[O](20955)'],
    products = ['[CH2]CC([CH2])CC=CO[O](9010)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH2]C(CC)C[C]=CO[O](20955)'],
    products = ['[CH2]C(C=[C][CH]OO)CC(19684)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2][C](CC)C[C]=COO(21574)'],
    products = ['[CH2]C(CC)C[C]=CO[O](20955)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH2]CC([CH2])C[C]=COO(21576)'],
    products = ['[CH2]C(CC)C[C]=CO[O](20955)'],
...
network(
    label = 'PDepNetwork #4617',
    isomers = [
        '[CH2]C(CC)C[C]=CO[O](20955)',
    ],
    reactants = [
