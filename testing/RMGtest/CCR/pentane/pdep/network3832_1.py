...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.341788,0.0918912,-0.000145258,1.34598e-07,-4.85146e-11,81785.1,35.3611], Tmin=(100,'K'), Tmax=(852.727,'K')), NASAPolynomial(coeffs=[4.73911,0.0465127,-2.18951e-05,4.11214e-09,-2.79699e-13,81935,20.1237], Tmin=(852.727,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(678.996,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(RCCJCC) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]CC([CH2])C[O](18196)',
    structure = SMILES('[CH]=[C]CC([CH2])C[O]'),
    E0 = (682.774,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,180,1148.23,1149.57],'cm^-1')),
        ...
        HinderedRotor(inertia=(0.205755,'amu*angstrom^2'), symmetry=1, barrier=(4.73071,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205795,'amu*angstrom^2'), symmetry=1, barrier=(4.73162,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.909056,0.0742505,-9.89908e-05,8.3808e-08,-2.90181e-11,82224,31.6053], Tmin=(100,'K'), Tmax=(835.781,'K')), NASAPolynomial(coeffs=[5.76415,0.0400128,-1.77987e-05,3.29505e-09,-2.23912e-13,81796.7,11.3519], Tmin=(835.781,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(682.774,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Isobutyl) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]C(C[C]=[CH])CO[O](18197)',
    structure = SMILES('[CH]C(C[C]=[CH])CO[O]'),
    E0 = (923.712,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.11798,0.0910526,-0.000127235,1.00597e-07,-3.22336e-11,111231,34.3294], Tmin=(100,'K'), Tmax=(794.822,'K')), NASAPolynomial(coeffs=[10.7837,0.0347134,-1.58843e-05,2.98474e-09,-2.04951e-13,109620,-14.1479], Tmin=(794.822,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(923.712,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_S) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[C]=[C]CC([CH2])CO[O](18198)',
    structure = SMILES('[C]=[C]CC([CH2])CO[O]'),
    E0 = (991.585,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.136001,0.093628,-0.000144689,1.24599e-07,-4.18708e-11,119391,35.0141], Tmin=(100,'K'), Tmax=(869.327,'K')), NASAPolynomial(coeffs=[8.60808,0.0370165,-1.65885e-05,3.03422e-09,-2.02851e-13,118584,-0.841058], Tmin=(869.327,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(991.585,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Isobutyl) + radical(Cds_S) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.863278,0.0566638,-3.5927e-06,-4.36137e-08,2.4359e-11,49185.7,27.3246], Tmin=(100,'K'), Tmax=(893.506,'K')), NASAPolynomial(coeffs=[15.8822,0.0236459,-5.6072e-06,7.5001e-10,-4.60178e-14,45135.9,-51.0852], Tmin=(893.506,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(12dioxolane) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C1CC([CH2])COO1(18201)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.965388,0.0485127,2.17703e-05,-6.01383e-08,2.47801e-11,42690.4,26.4136], Tmin=(100,'K'), Tmax=(1031.15,'K')), NASAPolynomial(coeffs=[16.8623,0.0296451,-1.30426e-05,2.62145e-09,-1.94943e-13,37136.7,-61.8005], Tmin=(1031.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(353.908,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclohexanone) + radical(Isobutyl) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]CC1COC1(18202)',
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45427,0.046852,1.83759e-06,-3.96546e-08,2.12204e-11,52541.3,23.7252], Tmin=(100,'K'), Tmax=(878.328,'K')), NASAPolynomial(coeffs=[11.9473,0.025429,-6.59976e-06,9.22952e-10,-5.6114e-14,49681.1,-31.3254], Tmin=(878.328,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(436.018,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C1CC([CH2])CO1(18203)',
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.404604,0.0820993,-8.95054e-05,5.10816e-08,-9.71207e-12,36554,29.1184], Tmin=(100,'K'), Tmax=(735.041,'K')), NASAPolynomial(coeffs=[11.4398,0.0332607,-1.27235e-05,2.19657e-09,-1.44359e-13,34628.8,-22.7835], Tmin=(735.041,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(302.872,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(ROOJ) + radical(Sec_Propargyl)"""),
)

species(
    label = '[CH]=[C]CC(=C)COO(18206)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.479582,0.0824862,-9.07538e-05,5.69763e-08,-1.49763e-11,54606,31.6278], Tmin=(100,'K'), Tmax=(908.488,'K')), NASAPolynomial(coeffs=[10.5169,0.038293,-1.77873e-05,3.43235e-09,-2.42025e-13,52782.2,-15.8332], Tmin=(908.488,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(453.002,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C=CC([CH2])COO(18207)',
...
species(
    label = '[CH]=[C]C[C]([CH2])CO[O](18209)',
    structure = SMILES('[CH]=[C]C[C]([CH2])CO[O]'),
    E0 = (871.489,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,180,1735.02],'cm^-1')),
        HinderedRotor(inertia=(0.105763,'amu*angstrom^2'), symmetry=1, barrier=(2.4317,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105751,'amu*angstrom^2'), symmetry=1, barrier=(2.43143,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105565,'amu*angstrom^2'), symmetry=1, barrier=(2.42714,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105637,'amu*angstrom^2'), symmetry=1, barrier=(2.42881,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105793,'amu*angstrom^2'), symmetry=1, barrier=(2.43239,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.718379,0.0770619,-9.98379e-05,7.90568e-08,-2.57954e-11,104929,37.7955], Tmin=(100,'K'), Tmax=(825.054,'K')), NASAPolynomial(coeffs=[7.88784,0.0366173,-1.59699e-05,2.9364e-09,-1.99179e-13,103940,5.75857], Tmin=(825.054,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(871.489,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(C2CJCOOH) + radical(Isobutyl) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.945257,0.072276,-7.54871e-05,4.9757e-08,-1.4378e-11,80255.7,35.2141], Tmin=(100,'K'), Tmax=(816.323,'K')), NASAPolynomial(coeffs=[7.21853,0.041539,-1.90114e-05,3.63825e-09,-2.55076e-13,79231.5,6.22189], Tmin=(816.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(666.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(C2CJCOOH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.124364,0.0966296,-0.000134448,1.06648e-07,-3.41814e-11,86396.9,35.3669], Tmin=(100,'K'), Tmax=(820.634,'K')), NASAPolynomial(coeffs=[10.8738,0.0376505,-1.68251e-05,3.11746e-09,-2.1201e-13,84772.7,-14.4168], Tmin=(820.634,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(717.156,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOOH) + radical(Isobutyl) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.158024,0.0909499,-0.000125436,1.02307e-07,-3.41035e-11,80002.4,33.3295], Tmin=(100,'K'), Tmax=(804.802,'K')), NASAPolynomial(coeffs=[9.06147,0.0401078,-1.83921e-05,3.46085e-09,-2.37791e-13,78782.8,-6.36505], Tmin=(804.802,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(664.079,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCsJOOH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC[C]([CH2])CO[O](18214)',
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.922899,0.0703219,-6.69519e-05,3.82523e-08,-9.36886e-12,76318.8,36.5954], Tmin=(100,'K'), Tmax=(962.821,'K')), NASAPolynomial(coeffs=[8.79817,0.0376032,-1.59768e-05,2.95536e-09,-2.03533e-13,74802.3,-1.09955], Tmin=(962.821,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(633.648,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(C2CJCOOH) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.186193,0.0882555,-0.000113594,8.54181e-08,-2.62723e-11,76063.4,34.5387], Tmin=(100,'K'), Tmax=(816.748,'K')), NASAPolynomial(coeffs=[10.3525,0.0367049,-1.56832e-05,2.85819e-09,-1.93114e-13,74461.5,-12.0902], Tmin=(816.748,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(631.319,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCsJOOH) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]C[C]([CH2])COO(18216)',
    structure = SMILES('[CH]=[C]C[C]([CH2])COO'),
    E0 = (719.485,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,201.003,843.529],'cm^-1')),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.642701,0.0782472,-8.57963e-05,5.62283e-08,-1.55921e-11,86651,37.3206], Tmin=(100,'K'), Tmax=(861.681,'K')), NASAPolynomial(coeffs=[9.11239,0.0389292,-1.73504e-05,3.27155e-09,-2.27292e-13,85191.5,-2.2797], Tmin=(861.681,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(719.485,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C2CJCOOH) + radical(Isobutyl) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    ...
    products = ['[CH]=[C]CC([CH2])CO[O](16238)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]=[C]CC([CH2])CO[O](16238)'],
    products = ['[CH]=[C]C[CH]CCO[O](18195)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O(4)', '[CH]=[C]CC([CH2])C[O](18196)'],
    products = ['[CH]=[C]CC([CH2])CO[O](16238)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[C]=[CH](9646)', '[CH2]C([CH2])CO[O](763)'],
    products = ['[CH]=[C]CC([CH2])CO[O](16238)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]C(C[C]=[CH])CO[O](18197)'],
    products = ['[CH]=[C]CC([CH2])CO[O](16238)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[C]=[C]CC([CH2])CO[O](18198)'],
    products = ['[CH]=[C]CC([CH2])CO[O](16238)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=[C]CC([CH2])CO[O](16238)'],
    products = ['[CH]=C1CC([CH2])COO1(18201)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=[C]CC([CH2])CO[O](16238)'],
    products = ['O(4)', '[CH]=[C]CC1COC1(18202)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]=[C]CC([CH2])CO[O](16238)'],
    products = ['O(4)', '[CH]=C1CC([CH2])CO1(18203)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=[C]CC([CH2])CO[O](16238)'],
    products = ['HO2(9)', '[CH]=[C]CC([CH2])=C(16008)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=[C]CC([CH2])CO[O](16238)'],
    products = ['[CH]=C=CC([CH2])COO(18207)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH]=[C]CC(=C)CO[O](18208)'],
    products = ['[CH]=[C]CC([CH2])CO[O](16238)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH]=[C]C[C]([CH2])CO[O](18209)'],
    products = ['[CH]=[C]CC([CH2])CO[O](16238)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', '[CH]=[C]CC([CH2])[CH]O[O](18210)'],
    products = ['[CH]=[C]CC([CH2])CO[O](16238)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]=[C]CC([CH2])CO[O](16238)'],
    products = ['[CH]=[C]C[C](C)CO[O](18211)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]=[C]CC([CH2])CO[O](16238)'],
    products = ['[CH]=[C]CC([CH2])[CH]OO(18212)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]=[C]CC([CH2])CO[O](16238)'],
    products = ['[CH]=[C][CH]C(C)CO[O](18162)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]=[C]CC([CH2])CO[O](16238)'],
    products = ['[CH]=[C]CC(C)[CH]O[O](18213)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH]=[C]CC([CH2])CO[O](16238)'],
    products = ['[CH]=CC[C]([CH2])CO[O](18214)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH]=[C]CC([CH2])CO[O](16238)'],
    products = ['[CH]=CCC([CH2])[CH]O[O](18215)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH]=[C]CC([CH2])CO[O](16238)'],
    products = ['[CH2][C](C[C]=C)CO[O](16235)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH]=[C]C[C]([CH2])COO(18216)'],
    products = ['[CH]=[C]CC([CH2])CO[O](16238)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH]=[C]CC([CH2])CO[O](16238)'],
    products = ['[CH2]C([CH]O[O])C[C]=C(16237)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH]=[C]CC([CH2])CO[O](16238)'],
    products = ['[CH]=[C][CH]C([CH2])COO(18163)'],
...
network(
    label = 'PDepNetwork #3832',
    isomers = [
        '[CH]=[C]CC([CH2])CO[O](16238)',
    ],
    reactants = [
