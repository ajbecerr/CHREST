...
species(
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32867,0.0352417,-2.25199e-05,7.01362e-09,-8.89683e-13,-21911.8,19.7252], Tmin=(100,'K'), Tmax=(1762.7,'K')), NASAPolynomial(coeffs=[10.0007,0.017832,-7.70474e-06,1.41039e-09,-9.49875e-14,-24616.5,-21.6367], Tmin=(1762.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-182.692,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cds-(Cdd-O2d)CsH) + group(Cds-OdCsH) + missing(Cdd-CdO2d)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(2355)', '[CH2]C[C]=O(2354)'],
    products = ['O=[C]CC[C]=O(2347)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CO(2039)', '[CH2]C[C]=O(2354)'],
    products = ['O=[C]CC[C]=O(2347)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'O=[C][CH]C[C]=O(2650)'],
    products = ['O=[C]CC[C]=O(2347)'],
