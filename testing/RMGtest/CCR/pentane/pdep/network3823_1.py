...
species(
    label = '[CH2][C]CC=[C][CH2](17115)',
    structure = SMILES('[CH2][C]CC=[C][CH2]'),
    E0 = (966.475,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1685,370,226.369,226.497,1956.91],'cm^-1')),
        HinderedRotor(inertia=(0.00329195,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.607677,'amu*angstrom^2'), symmetry=1, barrier=(22.1089,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.607676,'amu*angstrom^2'), symmetry=1, barrier=(22.1089,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.33058,'amu*angstrom^2'), symmetry=1, barrier=(95.4231,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40264,0.0554322,-4.58775e-05,2.02945e-08,-3.71274e-12,116335,25.8974], Tmin=(100,'K'), Tmax=(1280.36,'K')), NASAPolynomial(coeffs=[11.0152,0.0254019,-1.06964e-05,1.97647e-09,-1.36064e-13,113873,-22.8535], Tmin=(1280.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(966.475,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ) + radical(Allyl_P) + radical(CCJ2_triplet) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70692,0.0543633,-5.19131e-05,4.00988e-08,-1.46594e-11,112159,28.467], Tmin=(100,'K'), Tmax=(773.954,'K')), NASAPolynomial(coeffs=[3.1465,0.0420996,-1.87962e-05,3.52004e-09,-2.42706e-13,112081,22.8241], Tmin=(773.954,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(931.891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(RCCJ) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH2][C]=[C]C[CH][CH2](17121)',
    structure = SMILES('[CH2][C]=[C]C[CH][CH2]'),
    E0 = (950.548,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1670,1700,300,440,180,1745.85],'cm^-1')),
        HinderedRotor(inertia=(0.124045,'amu*angstrom^2'), symmetry=1, barrier=(2.85205,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123887,'amu*angstrom^2'), symmetry=1, barrier=(2.8484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123779,'amu*angstrom^2'), symmetry=1, barrier=(2.84591,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0279679,'amu*angstrom^2'), symmetry=1, barrier=(60.4402,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6154,0.0572698,-7.12305e-05,6.02534e-08,-2.14795e-11,114406,28.4383], Tmin=(100,'K'), Tmax=(810.629,'K')), NASAPolynomial(coeffs=[4.57459,0.0349848,-1.57769e-05,2.95587e-09,-2.02916e-13,114178,16.3402], Tmin=(810.629,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(950.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(RCCJ) + radical(Allyl_P) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C]=C[CH]C[CH2](17122)',
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37602,0.0502772,-2.76876e-05,4.57732e-09,6.91061e-13,79404.8,24.9903], Tmin=(100,'K'), Tmax=(1214.98,'K')), NASAPolynomial(coeffs=[11.42,0.0269606,-1.0939e-05,1.99252e-09,-1.36222e-13,76244.5,-28.3834], Tmin=(1214.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(659.372,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(RCCJ) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2][CH]C[C]=C[CH2](17123)',
...
species(
    label = '[CH2][C]=[C]CC[CH2](17124)',
    structure = SMILES('[CH2][C]=[C]CC[CH2]'),
    E0 = (756.101,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1670,1700,300,440,298.832,4000],'cm^-1')),
        HinderedRotor(inertia=(0.36255,'amu*angstrom^2'), symmetry=1, barrier=(22.9744,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16095,'amu*angstrom^2'), symmetry=1, barrier=(10.1991,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00664866,'amu*angstrom^2'), symmetry=1, barrier=(22.9743,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.828514,'amu*angstrom^2'), symmetry=1, barrier=(52.5036,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61502,0.054672,-4.30025e-05,1.92702e-08,-3.77336e-12,91022,25.7063], Tmin=(100,'K'), Tmax=(1156.56,'K')), NASAPolynomial(coeffs=[8.03352,0.0324732,-1.42116e-05,2.67432e-09,-1.86004e-13,89537.3,-6.19277], Tmin=(1156.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(756.101,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ) + radical(Allyl_P) + radical(Cds_S) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63833,0.045476,-2.07133e-05,1.51925e-09,9.8976e-13,74175.2,26.314], Tmin=(100,'K'), Tmax=(1288.61,'K')), NASAPolynomial(coeffs=[9.75017,0.0290122,-1.1695e-05,2.10287e-09,-1.41867e-13,71360.9,-17.6858], Tmin=(1288.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(615.977,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(RCCJC) + radical(RCCJ) + radical(Allyl_P)"""),
)

species(
    label = '[CH2][CH]C[C]=[C]C(17126)',
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.124581,'amu*angstrom^2'), symmetry=1, barrier=(2.86436,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124596,'amu*angstrom^2'), symmetry=1, barrier=(2.86471,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124575,'amu*angstrom^2'), symmetry=1, barrier=(2.86422,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.124568,'amu*angstrom^2'), symmetry=1, barrier=(2.86405,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59785,0.0600079,-8.08276e-05,7.53064e-08,-2.83877e-11,96182.9,28.2189], Tmin=(100,'K'), Tmax=(834.787,'K')), NASAPolynomial(coeffs=[2.35709,0.0409049,-1.87136e-05,3.50967e-09,-2.40111e-13,96595,27.9206], Tmin=(834.787,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(799.049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(RCCJ) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C]=[C]C[CH]C(16969)',
    structure = SMILES('[CH2][C]=[C]C[CH]C'),
    E0 = (745.301,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1670,1700,300,440,180,798.151],'cm^-1')),
        HinderedRotor(inertia=(0.108492,'amu*angstrom^2'), symmetry=1, barrier=(2.49445,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109496,'amu*angstrom^2'), symmetry=1, barrier=(2.51753,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109066,'amu*angstrom^2'), symmetry=1, barrier=(2.50764,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109046,'amu*angstrom^2'), symmetry=1, barrier=(2.50719,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.36107,0.0439215,6.92433e-06,-9.8823e-08,9.41833e-11,89689.8,24.154], Tmin=(100,'K'), Tmax=(446.192,'K')), NASAPolynomial(coeffs=[4.52614,0.0377505,-1.68341e-05,3.16977e-09,-2.19636e-13,89364.8,13.9793], Tmin=(446.192,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(745.301,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(Allyl_P) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = '[CH2][CH][CH]C=[C]C(17127)',
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39072,0.0472838,-1.00846e-05,-1.87535e-08,9.91933e-12,80023.5,22.5748], Tmin=(100,'K'), Tmax=(1026.08,'K')), NASAPolynomial(coeffs=[12.5337,0.0255637,-1.00827e-05,1.87389e-09,-1.32493e-13,76593.5,-37.042], Tmin=(1026.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(664.499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28442,0.0523916,-2.77935e-05,-1.18071e-09,4.46261e-12,52962.9,23.8432], Tmin=(100,'K'), Tmax=(993.891,'K')), NASAPolynomial(coeffs=[11.9769,0.0246017,-8.85768e-06,1.54885e-09,-1.05451e-13,50084.6,-31.464], Tmin=(993.891,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(439.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(RCCJ) + radical(C=CJC=C)"""),
)
...
species(
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.25571,0.047494,-2.23907e-05,4.67257e-09,-3.76168e-13,87447.4,24.6422], Tmin=(100,'K'), Tmax=(2746.46,'K')), NASAPolynomial(coeffs=[17.9083,0.0246973,-9.94017e-06,1.65038e-09,-1.0107e-13,78849.6,-66.6865], Tmin=(2746.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(726.645,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][CH]C[CH][C]=C(15726)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH][CH2](502)', '[CH2][C]=C[CH2](8994)'],
    products = ['[CH2][CH]C[CH][C]=C(15726)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2][C]CC=[C][CH2](17115)'],
    products = ['[CH2][CH]C[CH][C]=C(15726)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH][C]=CC[CH][CH2](17116)'],
    products = ['[CH2][CH]C[CH][C]=C(15726)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH2][C]=CC=C[CH2](17118)'],
    products = ['[CH2][CH]C[CH][C]=C(15726)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2]C#CC[CH][CH2](17119)'],
    products = ['[CH2][CH]C[CH][C]=C(15726)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2][C]=C[CH][CH][CH2](17120)'],
    products = ['[CH2][CH]C[CH][C]=C(15726)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2][C]=[C]C[CH][CH2](17121)'],
    products = ['[CH2][CH]C[CH][C]=C(15726)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][CH]C[CH][C]=C(15726)'],
    products = ['[CH2][C]=C[CH]C[CH2](17122)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][CH]C[C]=C[CH2](17123)'],
    products = ['[CH2][CH]C[CH][C]=C(15726)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][C]=[C]CC[CH2](17124)'],
    products = ['[CH2][CH]C[CH][C]=C(15726)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][CH]C[CH][C]=C(15726)'],
    products = ['[CH2][C]=C[CH][CH]C(16968)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2][CH]C[CH][C]=C(15726)'],
    products = ['[CH2][CH][CH]C=C[CH2](17125)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2][CH]C[C]=[C]C(17126)'],
    products = ['[CH2][CH]C[CH][C]=C(15726)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2][C]=[C]C[CH]C(16969)'],
    products = ['[CH2][CH]C[CH][C]=C(15726)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2][CH]C[CH][C]=C(15726)'],
    products = ['[CH2][CH][CH]C=[C]C(17127)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH][C]=CCC=C(15322)'],
    products = ['[CH2][CH]C[CH][C]=C(15726)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH][CH2](502)', 'CH2CHCCH2(4848)'],
    products = ['[CH2][CH]C[CH][C]=C(15726)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2][CH][CH]C[C]=C(9135)'],
    products = ['[CH2][CH]C[CH][C]=C(15726)'],
