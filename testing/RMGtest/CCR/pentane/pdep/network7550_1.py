...
species(
    ...
    molecularWeight = (58.0791,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.38889,0.0203564,3.95657e-05,-7.42352e-08,3.24731e-11,-17723.4,12.6367], Tmin=(100,'K'), Tmax=(922.779,'K')), NASAPolynomial(coeffs=[14.7891,0.00555508,3.11087e-07,-1.33468e-10,5.00863e-15,-21670.3,-55.176], Tmin=(922.779,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-147.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (58.0791,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90617,0.0490483,-6.79663e-05,5.41304e-08,-1.728e-11,18907.6,15.3998], Tmin=(100,'K'), Tmax=(841.227,'K')), NASAPolynomial(coeffs=[7.45106,0.0190455,-7.98282e-06,1.4544e-09,-9.80983e-14,18103.4,-9.62756], Tmin=(841.227,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(156.604,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCsJOCs) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CO[CH2](28794)'],
    products = ['CH2O(3111)', 'C2H4(22)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(20)', '[CH2]C[O](1358)'],
    products = ['[CH2]CO[CH2](28794)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(20)', '[CH2]O[CH2](3113)'],
    products = ['[CH2]CO[CH2](28794)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][O](3109)', 'C2H4(T)(23)'],
    products = ['[CH2]CO[CH2](28794)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2][CH]O[CH2](1565)'],
    products = ['[CH2]CO[CH2](28794)'],
