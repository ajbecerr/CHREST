species(
    label = '[CH2]OC[C]=O(28839)',
    structure = SMILES('[CH2]OC[C]=O'),
    E0 = (40.0284,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1855,455,950,239.089,239.56],'cm^-1')),
        HinderedRotor(inertia=(0.00294109,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00294471,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0119218,'amu*angstrom^2'), symmetry=1, barrier=(27.3493,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35724,0.0326478,-2.40797e-05,9.12777e-09,-1.40842e-12,4876.24,19.6339], Tmin=(100,'K'), Tmax=(1513.01,'K')), NASAPolynomial(coeffs=[9.3782,0.0140859,-5.67722e-06,1.01907e-09,-6.85753e-14,2751.72,-17.1454], Tmin=(1513.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(40.0284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)OsHH) + group(Cs-OsHHH) + group(Cds-OdCsH) + radical(CsJOCC) + radical(CsCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02134,0.0332074,-2.88718e-06,-2.98558e-08,1.67989e-11,-21000,14.6195], Tmin=(100,'K'), Tmax=(918.915,'K')), NASAPolynomial(coeffs=[14.8645,0.00430806,2.02528e-07,-1.14324e-10,6.12471e-15,-24500.6,-52.4597], Tmin=(918.915,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-175.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(Cs-OsHHH) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d)"""),
)
...
species(
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97536,0.0308683,1.17614e-05,-5.07102e-08,2.56657e-11,3026.91,18.5197], Tmin=(100,'K'), Tmax=(912.3,'K')), NASAPolynomial(coeffs=[17.155,0.000412954,2.48061e-06,-5.54144e-10,3.54179e-14,-1245.04,-61.5533], Tmin=(912.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(24.4549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(2355)', '[CH2]O[CH2](3113)'],
    products = ['[CH2]OC[C]=O(28839)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['CO(2039)', '[CH2]O[CH2](3113)'],
    products = ['[CH2]OC[C]=O(28839)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1508.14,'m^3/(mol*s)'), n=1.0822, Ea=(24.7919,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [COm;C_pri_rad] for rate rule [COm;C_rad/H2/O]
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH2]OC=C=O(28887)'],
    products = ['[CH2]OC[C]=O(28839)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2]OC=[C][O](11465)'],
    products = ['[CH2]OC[C]=O(28839)'],
