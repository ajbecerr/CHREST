...
species(
    label = 'CCC[CH]O[C]=C[O](11619)',
    structure = SMILES('CCC[CH]O[C]=C[O]'),
    E0 = (133.274,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.54194,0.0989185,-0.000100038,4.86438e-08,-8.90156e-12,16248.3,36.9509], Tmin=(100,'K'), Tmax=(1506.3,'K')), NASAPolynomial(coeffs=[26.6621,0.012356,-2.22031e-06,2.09039e-10,-9.47312e-15,9075.1,-106.278], Tmin=(1506.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(133.274,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCsJOC(O)) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.799191,0.0971116,-0.000102553,5.4381e-08,-1.12379e-11,15818,29.3448], Tmin=(100,'K'), Tmax=(1188.28,'K')), NASAPolynomial(coeffs=[21.4185,0.0223241,-8.14851e-06,1.41829e-09,-9.5453e-14,10537.7,-81.676], Tmin=(1188.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(130.022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclopropene) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]CC([CH2])O[C]=CO(11637)',
    structure = SMILES('[CH2]CC([CH2])O[C]=CO'),
    E0 = (200.998,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC1CO[CH][C]O1(11638)',
    structure = SMILES('CCC1CO[CH][C]O1'),
    E0 = (242.257,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.12428,0.0878838,-8.41123e-05,4.33731e-08,-8.31428e-12,29342.6,27.3962], Tmin=(100,'K'), Tmax=(1565.78,'K')), NASAPolynomial(coeffs=[15.8068,0.0233798,-1.95969e-06,-2.73406e-10,3.85193e-14,26645.6,-53.5594], Tmin=(1565.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(242.257,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(1,4-Dioxane) + radical(CCsJOCs) + radical(CH2_triplet)"""),
)

species(
    label = 'CCC1CC([O])[C]O1(11639)',
    structure = SMILES('CCC1CC([O])[C]O1'),
    E0 = (260.113,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.745857,0.0553767,1.30132e-05,-6.46228e-08,3.21515e-11,31416.7,23.5473], Tmin=(100,'K'), Tmax=(909.793,'K')), NASAPolynomial(coeffs=[17.6853,0.02377,-5.55578e-06,7.7578e-10,-5.09335e-14,26560.2,-66.3248], Tmin=(909.793,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(260.113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CC(C)OJ) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]C(C)O[C]=C[O](10966)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=C[O](6859)', '[CH2]C([O])CC(1362)'],
    products = ['[CH2]C(CC)O[C]=C[O](11006)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', 'CC[CH]O[C]=C[O](11472)'],
    products = ['[CH2]C(CC)O[C]=C[O](11006)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(4)', '[CH]=[C]OC([CH2])CC(2484)'],
    products = ['[CH2]C(CC)O[C]=C[O](11006)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C(CC)O[C]=C[O](11620)'],
    products = ['[CH2]C(CC)O[C]=C[O](11006)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]C(CC)O[C]=C[O](11006)'],
    products = ['[CH2]C(CC)OC1=CO1(11621)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'C=C(CC)O[C]=C[O](11624)'],
    products = ['[CH2]C(CC)O[C]=C[O](11006)'],
...
reaction(
    label = 'reaction14',
    reactants = ['O(4)', 'C#COC([CH2])CC(2480)'],
    products = ['[CH2]C(CC)O[C]=C[O](11006)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C2H5(14)', 'C=CO[C]=C[O](11102)'],
    products = ['[CH2]C(CC)O[C]=C[O](11006)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C2H5(14)', '[CH2][CH]O[C]=C[O](10214)'],
    products = ['[CH2]C(CC)O[C]=C[O](11006)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH2][C](CC)O[C]=C[O](11625)'],
    products = ['[CH2]C(CC)O[C]=C[O](11006)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH3(17)', '[CH2]C([CH2])O[C]=C[O](11048)'],
    products = ['[CH2]C(CC)O[C]=C[O](11006)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2]CC([CH2])O[C]=C[O](11626)'],
    products = ['[CH2]C(CC)O[C]=C[O](11006)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C(CC)O[C]=C[O](11006)'],
    products = ['[CH2]CC(C)O[C]=C[O](11632)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2][C](CC)O[C]=CO(11635)'],
    products = ['[CH2]C(CC)O[C]=C[O](11006)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]CC([CH2])O[C]=CO(11637)'],
    products = ['[CH2]C(CC)O[C]=C[O](11006)'],
