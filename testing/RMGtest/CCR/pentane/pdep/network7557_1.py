...
species(
    label = 'C[C]CC[O](29010)',
    structure = SMILES('C[C]CC[O]'),
    E0 = (369.789,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,692.085,706.215],'cm^-1')),
        HinderedRotor(inertia=(0.172747,'amu*angstrom^2'), symmetry=1, barrier=(3.9718,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166803,'amu*angstrom^2'), symmetry=1, barrier=(3.83513,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171877,'amu*angstrom^2'), symmetry=1, barrier=(3.9518,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06602,0.0464742,-5.03245e-05,4.22362e-08,-1.60799e-11,44541.2,20.0167], Tmin=(100,'K'), Tmax=(756.605,'K')), NASAPolynomial(coeffs=[3.44534,0.0341324,-1.58452e-05,3.03441e-09,-2.11961e-13,44477,14.7021], Tmin=(756.605,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(369.789,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11642,0.0389099,-1.83641e-05,3.46286e-09,-1.58357e-13,-27244.3,18.4213], Tmin=(100,'K'), Tmax=(1843.53,'K')), NASAPolynomial(coeffs=[12.005,0.0224533,-9.04164e-06,1.56256e-09,-1.00128e-13,-31739.7,-37.6378], Tmin=(1843.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-227.103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH)"""),
)
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86161,0.0407202,-1.67184e-05,-3.01935e-09,3.01656e-12,-21127.6,20.4595], Tmin=(100,'K'), Tmax=(1102.33,'K')), NASAPolynomial(coeffs=[9.38416,0.0244476,-9.57665e-06,1.73403e-09,-1.19058e-13,-23455.9,-19.6035], Tmin=(1102.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-176.349,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'C[CH]C[CH]O(29011)',
    structure = SMILES('C[CH]C[CH]O'),
    E0 = (70.6126,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,188.238,2010.86],'cm^-1')),
        HinderedRotor(inertia=(0.19135,'amu*angstrom^2'), symmetry=1, barrier=(4.83789,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191353,'amu*angstrom^2'), symmetry=1, barrier=(4.83634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00476739,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19173,'amu*angstrom^2'), symmetry=1, barrier=(4.83984,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70788,0.0548554,-6.82335e-05,5.69027e-08,-1.9722e-11,8570.99,22.8199], Tmin=(100,'K'), Tmax=(839.458,'K')), NASAPolynomial(coeffs=[4.72093,0.0325243,-1.4082e-05,2.58196e-09,-1.74741e-13,8346.09,10.4845], Tmin=(839.458,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(70.6126,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]CCC[O](29012)',
    structure = SMILES('[CH2]CCC[O]'),
    E0 = (126.82,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,196.658,1626.27,1626.39],'cm^-1')),
        HinderedRotor(inertia=(0.147039,'amu*angstrom^2'), symmetry=1, barrier=(4.01176,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144948,'amu*angstrom^2'), symmetry=1, barrier=(4.01665,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145054,'amu*angstrom^2'), symmetry=1, barrier=(4.01086,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.84954,0.0364831,-1.59529e-05,2.65371e-09,-1.22873e-13,15283.1,19.0407], Tmin=(100,'K'), Tmax=(2487.28,'K')), NASAPolynomial(coeffs=[21.9256,0.0123779,-5.37942e-06,8.82087e-10,-5.15859e-14,3760.62,-94.4589], Tmin=(2487.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(126.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85882,0.0520585,-6.1715e-05,5.44773e-08,-2.07046e-11,12324.6,20.4029], Tmin=(100,'K'), Tmax=(792.665,'K')), NASAPolynomial(coeffs=[3.11838,0.0370918,-1.70982e-05,3.24825e-09,-2.25145e-13,12395.4,16.3253], Tmin=(792.665,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(101.872,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = 'C[CH][CH]CO(3780)',
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.33226,0.0390924,-2.22695e-05,7.06367e-09,-1.03683e-12,10908.3,23.5189], Tmin=(100,'K'), Tmax=(1355.37,'K')), NASAPolynomial(coeffs=[5.30812,0.0303099,-1.25499e-05,2.28284e-09,-1.54992e-13,10101.6,8.25719], Tmin=(1355.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.2168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJC)"""),
)

species(
    label = '[CH2][CH]CCO(28710)',
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02008,0.0467668,-4.71408e-05,3.64185e-08,-1.28123e-11,11561.6,23.9381], Tmin=(100,'K'), Tmax=(791.082,'K')), NASAPolynomial(coeffs=[3.8808,0.0334588,-1.4513e-05,2.69099e-09,-1.84482e-13,11389.2,16.1685], Tmin=(791.082,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.5611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(C)C[O](3237)'],
    products = ['C[CH]CC[O](3258)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH]CC[O](28985)'],
    products = ['C[CH]CC[O](3258)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C[CH][CH]C[O](3807)'],
    products = ['C[CH]CC[O](3258)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'C[CH]C[CH][O](1560)'],
    products = ['C[CH]CC[O](3258)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH2][CH]CC[O](1561)'],
    products = ['C[CH]CC[O](3258)'],
