...
species(
    label = '[CH]=[C]CC[C][CH2](17145)',
    structure = SMILES('[CH]=[C]CC[C][CH2]'),
    E0 = (1074.32,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,290.581,290.71,290.815],'cm^-1')),
        HinderedRotor(inertia=(0.00199377,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00199476,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131163,'amu*angstrom^2'), symmetry=1, barrier=(7.86168,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.477681,'amu*angstrom^2'), symmetry=1, barrier=(28.6502,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42135,0.0594641,-5.98424e-05,3.45506e-08,-8.40514e-12,129301,26.4012], Tmin=(100,'K'), Tmax=(974.668,'K')), NASAPolynomial(coeffs=[8.85186,0.0289694,-1.29112e-05,2.4498e-09,-1.7132e-13,127853,-9.25602], Tmin=(974.668,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1074.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(CCJ2_triplet) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[C]=[C]CC[CH][CH2](17146)',
    structure = SMILES('[C]=[C]CC[CH][CH2]'),
    E0 = (1131.55,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1685,370,180,1589.75,1589.8],'cm^-1')),
        HinderedRotor(inertia=(0.153672,'amu*angstrom^2'), symmetry=1, barrier=(3.53322,'kJ/mol'), semiclassical=False),
        ...
        HinderedRotor(inertia=(0.153271,'amu*angstrom^2'), symmetry=1, barrier=(3.52401,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52488,0.061821,-8.94563e-05,8.29703e-08,-3.06656e-11,136177,28.8235], Tmin=(100,'K'), Tmax=(837.48,'K')), NASAPolynomial(coeffs=[3.42077,0.037148,-1.7292e-05,3.25723e-09,-2.22963e-13,136407,23.2831], Tmin=(837.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1131.55,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(RCCJ) + radical(Cds_S) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[CH][CH2](502)', '[CH]=[C]C[CH2](9654)'],
    products = ['[CH]=[C]CC[CH][CH2](15153)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[C]=[CH](9646)', '[CH2][CH]C[CH2](66)'],
    products = ['[CH]=[C]CC[CH][CH2](15153)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]=[C]CC[C][CH2](17145)'],
    products = ['[CH]=[C]CC[CH][CH2](15153)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH][CH]CC[C]=[CH](15315)'],
    products = ['[CH]=[C]CC[CH][CH2](15153)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[C]=[C]CC[CH][CH2](17146)'],
    products = ['[CH]=[C]CC[CH][CH2](15153)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.270985,'m^3/(mol*s)'), n=1.98996, Ea=(49.129,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_R;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 44.7 to 49.1 kJ/mol to match endothermicity of reaction."""),
)
