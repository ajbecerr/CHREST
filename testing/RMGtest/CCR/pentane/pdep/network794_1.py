...
species(
    label = '[CH2]C(C)C(C)[O](3130)',
    structure = SMILES('[CH2]C(C)C(C)[O]'),
    E0 = (89.1941,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3100,440,815,1455,1000,770.193,3176.29],'cm^-1')),
        HinderedRotor(inertia=(0.656344,'amu*angstrom^2'), symmetry=1, barrier=(15.0906,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.656829,'amu*angstrom^2'), symmetry=1, barrier=(15.1018,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0130076,'amu*angstrom^2'), symmetry=1, barrier=(5.46837,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.53194,'amu*angstrom^2'), symmetry=1, barrier=(81.2064,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20766,0.0663156,-4.07162e-05,1.34719e-08,-1.99928e-12,7370.36,28.8337], Tmin=(100,'K'), Tmax=(1387.03,'K')), NASAPolynomial(coeffs=[7.62946,0.047796,-2.06883e-05,3.8456e-09,-2.64225e-13,5588.91,-4.24872], Tmin=(1387.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.4842,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJCC)"""),
)

species(
    label = 'CCC[CH]C(C)[O](3282)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.382412,0.0693856,-3.77125e-05,5.03264e-09,1.6428e-12,8067.98,31.7483], Tmin=(100,'K'), Tmax=(1161.09,'K')), NASAPolynomial(coeffs=[14.029,0.0369839,-1.47297e-05,2.67504e-09,-1.83287e-13,3914.09,-40.3683], Tmin=(1161.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.9279,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO)"""),
)
...
species(
    label = 'CC[CH]C(C)[O](3238)',
    structure = SMILES('CC[CH]C(C)[O]'),
    E0 = (89.7082,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,435.277,435.287,435.302],'cm^-1')),
        HinderedRotor(inertia=(0.000889711,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000889689,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0567232,'amu*angstrom^2'), symmetry=1, barrier=(7.62786,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0567238,'amu*angstrom^2'), symmetry=1, barrier=(7.62776,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17401,0.0529681,-1.85302e-05,-9.37456e-09,6.22794e-12,10899,26.6569], Tmin=(100,'K'), Tmax=(1066.06,'K')), NASAPolynomial(coeffs=[11.8673,0.0306076,-1.20601e-05,2.20814e-09,-1.5336e-13,7609.69,-30.3501], Tmin=(1066.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.7082,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO)"""),
)
...
species(
    label = '[CH]C(CC)C(C)[O](3283)',
    structure = SMILES('[CH]C(CC)C(C)[O]'),
    E0 = (311.894,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2145,0.0448046,4.27999e-05,-8.86892e-08,3.89919e-11,-22657.3,22.8873], Tmin=(100,'K'), Tmax=(909.341,'K')), NASAPolynomial(coeffs=[13.6715,0.0330946,-8.95553e-06,1.35914e-09,-8.94958e-14,-26704.2,-45.8214], Tmin=(909.341,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-189.345,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane)"""),
)

species(
    label = 'C=C(CC)C(C)O(3284)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.398284,0.0674212,-2.72243e-05,-9.9993e-09,7.87487e-12,-30052,29.9439], Tmin=(100,'K'), Tmax=(1046.74,'K')), NASAPolynomial(coeffs=[15.0726,0.0345937,-1.34981e-05,2.47779e-09,-1.7311e-13,-34397.7,-47.6053], Tmin=(1046.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.029,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.334331,0.0814451,-7.44027e-05,4.00299e-08,-9.11169e-12,1938.78,30.5397], Tmin=(100,'K'), Tmax=(1038.97,'K')), NASAPolynomial(coeffs=[10.7106,0.0414946,-1.67216e-05,3.0162e-09,-2.04869e-13,-217.235,-19.916], Tmin=(1038.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(15.0281,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.388884,0.0704712,-4.15189e-05,8.23781e-09,1.01952e-12,-948.001,31.1113], Tmin=(100,'K'), Tmax=(1095.5,'K')), NASAPolynomial(coeffs=[13.0978,0.0372277,-1.40206e-05,2.46961e-09,-1.66604e-13,-4522.25,-34.9654], Tmin=(1095.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-9.0258,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(O)C([CH2])CC(3290)',
    structure = SMILES('[CH2]C(O)C([CH2])CC'),
    E0 = (49.9894,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.066953,0.0811386,-6.86527e-05,3.21392e-08,-6.17958e-12,6158.39,32.7032], Tmin=(100,'K'), Tmax=(1237.69,'K')), NASAPolynomial(coeffs=[14.2082,0.0354361,-1.32639e-05,2.30441e-09,-1.53239e-13,2657.91,-38.5358], Tmin=(1237.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.9894,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]C(CC)C[O](3281)'],
    products = ['[CH2]C(CC)C(C)[O](3144)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', '[CH2]C(C)C(C)[O](3130)'],
    products = ['[CH2]C(CC)C(C)[O](3144)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(20)', 'CC[CH]C(C)[O](3238)'],
    products = ['[CH2]C(CC)C(C)[O](3144)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O(4)', '[CH2]C([CH]C)CC(234)'],
    products = ['[CH2]C(CC)C(C)[O](3144)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]C(CC)C(C)[O](3283)'],
    products = ['[CH2]C(CC)C(C)[O](3144)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'C=C(CC)C(C)[O](1763)'],
    products = ['[CH2]C(CC)C(C)[O](3144)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2]C(CC)C(C)=O(1761)'],
    products = ['[CH2]C(CC)C(C)[O](3144)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C[CH][O](1382)', 'butene1(35)'],
    products = ['[CH2]C(CC)C(C)[O](3144)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C2H5(14)', 'C=CC(C)[O](1578)'],
    products = ['[CH2]C(CC)C(C)[O](3144)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(17)', '[CH2]C(C=O)CC(1767)'],
    products = ['[CH2]C(CC)C(C)[O](3144)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C2H5(14)', '[CH2][CH]C(C)[O](1587)'],
    products = ['[CH2]C(CC)C(C)[O](3144)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH2][C](CC)C(C)[O](1777)'],
    products = ['[CH2]C(CC)C(C)[O](3144)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH3(17)', '[CH2]C([CH][O])CC(1756)'],
    products = ['[CH2]C(CC)C(C)[O](3144)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2]C(CC)[C](C)[O](1774)'],
    products = ['[CH2]C(CC)C(C)[O](3144)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH3(17)', '[CH2]C([CH2])C(C)[O](1658)'],
    products = ['[CH2]C(CC)C(C)[O](3144)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2]C([O])C([CH2])CC(1448)'],
    products = ['[CH2]C(CC)C(C)[O](3144)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2]CC([CH2])C(C)[O](1782)'],
    products = ['[CH2]C(CC)C(C)[O](3144)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C(CC)C(C)[O](3144)'],
    products = ['[CH2]C(O)C([CH2])CC(3290)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C(CC)C(C)[O](3144)'],
    products = ['[CH2]C([CH]C)C(C)O(3291)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C(CC)C(C)[O](3144)'],
    products = ['[CH2]CC([CH2])C(C)O(3294)'],
