...
species(
    label = '[CH2]C([CH]C)CC(C)[CH]O[O](8892)',
    structure = SMILES('[CH2]C([CH]C)CC(C)[CH]O[O]'),
    E0 = (404.423,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.964903,0.116133,-0.000127012,8.75422e-08,-2.59894e-11,48813.3,44.5727], Tmin=(100,'K'), Tmax=(803.012,'K')), NASAPolynomial(coeffs=[9.69148,0.0630515,-2.78568e-05,5.22306e-09,-3.61233e-13,47101.9,-4.50038], Tmin=(803.012,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(404.423,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(CCsJOOH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH]C)C[CH]C(C)[O](8893)',
    structure = SMILES('[CH2]C([CH]C)C[CH]C(C)[O]'),
    E0 = (415.645,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.435781,0.0940734,-7.00174e-05,2.83366e-08,-4.82266e-12,50152.8,43.2219], Tmin=(100,'K'), Tmax=(1350.52,'K')), NASAPolynomial(coeffs=[14.7918,0.0489715,-1.99229e-05,3.60774e-09,-2.44946e-13,46039.8,-34.8178], Tmin=(1350.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(415.645,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH]C)C[C]C(C)O[O](8894)',
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.01888,0.116578,-0.000128021,8.37337e-08,-2.30866e-11,79207,44.4586], Tmin=(100,'K'), Tmax=(867.942,'K')), NASAPolynomial(coeffs=[11.8951,0.0570607,-2.5158e-05,4.72125e-09,-3.27136e-13,76965.3,-16.0142], Tmin=(867.942,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(657.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2]C([C]C)C[CH]C(C)O[O](8895)',
    ...
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.23223,0.120422,-0.000134785,8.77989e-08,-2.37686e-11,79921.8,44.9705], Tmin=(100,'K'), Tmax=(888.662,'K')), NASAPolynomial(coeffs=[13.4026,0.0545484,-2.3594e-05,4.38376e-09,-3.01965e-13,77320.7,-23.9066], Tmin=(888.662,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(662.98,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([CH]C)C[CH]C(C)O[O](8896)',
    structure = SMILES('[CH]C([CH]C)C[CH]C(C)O[O]'),
    E0 = (652.439,'kJ/mol'),
    modes = [
...
species(
    label = 'CC([CH]CC1CC1C)O[O](8897)',
    structure = SMILES('CC([CH]CC1CC1C)O[O]'),
    E0 = (156.543,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.13445,0.0988365,-6.25935e-05,1.46335e-08,4.65158e-13,19024.3,41.5045], Tmin=(100,'K'), Tmax=(1146.11,'K')), NASAPolynomial(coeffs=[19.5032,0.0458585,-1.81878e-05,3.30526e-09,-2.27041e-13,13042.7,-66.3326], Tmin=(1146.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(156.543,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(ROOJ) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C([CH]C)CC1OOC1C(8898)',
    structure = SMILES('[CH2]C([CH]C)CC1OOC1C'),
    E0 = (213.599,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.417935,0.0975186,-6.90536e-05,2.64312e-08,-4.33217e-12,25848.2,37.0722], Tmin=(100,'K'), Tmax=(1365.38,'K')), NASAPolynomial(coeffs=[13.5832,0.0565013,-2.39923e-05,4.42934e-09,-3.03662e-13,22024.8,-34.8354], Tmin=(1365.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(213.599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH]C)CC1OC1C(8900)',
    structure = SMILES('[CH2]C([CH]C)CC1OC1C'),
    E0 = (162.303,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.408589,0.0872407,-4.0291e-05,-1.18627e-08,1.30528e-11,19688.3,36.8269], Tmin=(100,'K'), Tmax=(901.663,'K')), NASAPolynomial(coeffs=[15.409,0.044288,-1.41152e-05,2.26247e-09,-1.46134e-13,15729.5,-43.9819], Tmin=(901.663,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.303,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.882351,0.109195,-9.33041e-05,4.41742e-08,-8.83481e-12,7796.51,38.8179], Tmin=(100,'K'), Tmax=(1163.24,'K')), NASAPolynomial(coeffs=[14.7171,0.0555543,-2.41343e-05,4.53237e-09,-3.15171e-13,4167.3,-38.7994], Tmin=(1163.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.3756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C([CH]C)CC=C(C)OO(8902)',
    structure = SMILES('[CH2]C([CH]C)CC=C(C)OO'),
    E0 = (179.978,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.585164,0.10699,-9.75255e-05,5.30342e-08,-1.25933e-11,21806.3,43.2543], Tmin=(100,'K'), Tmax=(977.812,'K')), NASAPolynomial(coeffs=[10.5954,0.0612544,-2.73669e-05,5.20175e-09,-3.64136e-13,19619.8,-10.4347], Tmin=(977.812,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(179.978,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C=C)CCC(C)O[O](7558)',
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.991507,0.108592,-9.37293e-05,4.51632e-08,-9.09769e-12,16598.7,42.3894], Tmin=(100,'K'), Tmax=(1167.66,'K')), NASAPolynomial(coeffs=[15.4223,0.0523652,-2.15004e-05,3.92545e-09,-2.68719e-13,12765.4,-39.3422], Tmin=(1167.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(136.507,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH]C)C=CC(C)OO(8903)',
    structure = SMILES('[CH2]C([CH]C)C=CC(C)OO'),
    E0 = (167.598,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.01693,0.105587,-8.28585e-05,3.43958e-08,-5.90266e-12,20341.5,45.4145], Tmin=(100,'K'), Tmax=(1356.04,'K')), NASAPolynomial(coeffs=[18.0665,0.0492967,-2.05932e-05,3.78503e-09,-2.59341e-13,15165.9,-52.4644], Tmin=(1356.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(167.598,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(=CC)C[CH]C(C)O[O](8904)',
    ...
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.788518,0.11025,-0.00010517,5.74067e-08,-1.32986e-11,31895,40.7983], Tmin=(100,'K'), Tmax=(1015.38,'K')), NASAPolynomial(coeffs=[12.9947,0.0559525,-2.49575e-05,4.74232e-09,-3.32037e-13,29095.9,-25.9084], Tmin=(1015.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(ROOJ) + radical(CCJCOOH) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C([CH]C)CC=C(C)O[O](8905)',
    structure = SMILES('[CH2]C([CH]C)CC=C(C)O[O]'),
    E0 = (331.983,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.503905,0.105555,-0.000109822,7.23809e-08,-2.07823e-11,40084.7,43.7211], Tmin=(100,'K'), Tmax=(824.462,'K')), NASAPolynomial(coeffs=[8.93697,0.0597499,-2.64825e-05,4.98931e-09,-3.46556e-13,38528,-0.00297886], Tmin=(824.462,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(331.983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH]C)C=CC(C)O[O](8906)',
    structure = SMILES('[CH2]C([CH]C)C=CC(C)O[O]'),
    E0 = (319.602,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.602636,0.100251,-8.16936e-05,3.65795e-08,-6.88223e-12,38605.6,44.6862], Tmin=(100,'K'), Tmax=(1235.15,'K')), NASAPolynomial(coeffs=[14.7907,0.0504001,-2.11545e-05,3.904e-09,-2.68623e-13,34803,-32.8288], Tmin=(1235.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2][C]([CH]C)C[CH]C(C)O[O](8907)',
    structure = SMILES('[CH2][C]([CH]C)C[CH]C(C)O[O]'),
    E0 = (594.729,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,180,400,1004.75,3200],'cm^-1')),
        HinderedRotor(inertia=(0.0728796,'amu*angstrom^2'), symmetry=1, barrier=(2.96493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0728796,'amu*angstrom^2'), symmetry=1, barrier=(2.96493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0728796,'amu*angstrom^2'), symmetry=1, barrier=(2.96493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0728796,'amu*angstrom^2'), symmetry=1, barrier=(2.96493,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0728796,'amu*angstrom^2'), symmetry=1, barrier=(2.96493,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.14272,0.126683,-0.000185931,1.66884e-07,-5.95319e-11,71701.5,48.4166], Tmin=(100,'K'), Tmax=(844.477,'K')), NASAPolynomial(coeffs=[5.66463,0.0668842,-3.07677e-05,5.7522e-09,-3.91617e-13,71534.3,22.5432], Tmin=(844.477,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(594.729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Tertalkyl) + radical(CCJCOOH) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH]C)C[CH][C](C)O[O](8908)',
    structure = SMILES('[CH2]C([CH]C)C[CH][C](C)O[O]'),
    E0 = (596.206,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,360,370,350,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06299,0.121404,-0.000162588,1.37403e-07,-4.77754e-11,71879.6,47.2919], Tmin=(100,'K'), Tmax=(818.781,'K')), NASAPolynomial(coeffs=[7.44838,0.0641993,-2.91666e-05,5.4643e-09,-3.74355e-13,71009.5,11.1293], Tmin=(818.781,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(596.206,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(C2CsJOOH) + radical(CCJCOOH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH]C)C[CH]C([CH2])O[O](8909)',
    structure = SMILES('[CH2]C([CH]C)C[CH]C([CH2])O[O]'),
    E0 = (623.269,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.12671,0.119768,-0.000143245,1.03864e-07,-3.16071e-11,75140.1,49.2347], Tmin=(100,'K'), Tmax=(791.933,'K')), NASAPolynomial(coeffs=[11.1786,0.0576186,-2.55346e-05,4.77825e-09,-3.29394e-13,73191,-7.26159], Tmin=(791.933,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(623.269,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(Cs_S) + radical(Isobutyl) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2]C([CH]C)CC[C](C)O[O](8910)',
    structure = SMILES('[CH2]C([CH]C)CC[C](C)O[O]'),
    E0 = (395.791,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.01484,0.11845,-0.000143151,1.13286e-07,-3.83098e-11,47775.5,44.8184], Tmin=(100,'K'), Tmax=(782.988,'K')), NASAPolynomial(coeffs=[7.93168,0.0659659,-2.96172e-05,5.55979e-09,-3.83113e-13,46582.3,5.17234], Tmin=(782.988,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(395.791,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOOH) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH]C)C[CH][C](C)OO(8911)',
    structure = SMILES('[CH2]C([CH]C)C[CH][C](C)OO'),
    E0 = (444.201,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,360,370,350,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.288021,0.109157,-7.91839e-05,-2.6854e-08,6.10615e-11,53564.7,43.9468], Tmin=(100,'K'), Tmax=(519.009,'K')), NASAPolynomial(coeffs=[8.5194,0.0668414,-3.07689e-05,5.85761e-09,-4.07666e-13,52306.2,3.91537], Tmin=(519.009,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(444.201,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(C2CsJOOH) + radical(CCJCOOH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH]C)CCC([CH2])O[O](8912)',
    structure = SMILES('[CH2]C([CH]C)CCC([CH2])O[O]'),
    E0 = (422.854,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.00485,0.115919,-0.000120506,7.50641e-08,-1.98784e-11,51032.8,46.4984], Tmin=(100,'K'), Tmax=(898.166,'K')), NASAPolynomial(coeffs=[11.713,0.0592807,-2.59169e-05,4.8561e-09,-3.36594e-13,48748.2,-13.4923], Tmin=(898.166,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(422.854,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(Isobutyl) + radical(CJCOOH)"""),
)

species(
    label = '[CH2][C]([CH]C)CCC(C)O[O](8913)',
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.13602,0.124266,-0.000168601,1.45838e-07,-5.15296e-11,47599.1,46.0888], Tmin=(100,'K'), Tmax=(827.65,'K')), NASAPolynomial(coeffs=[6.27096,0.0684288,-3.10848e-05,5.81516e-09,-3.97616e-13,47059.4,15.902], Tmin=(827.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(394.314,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Tertalkyl) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH]C)C[CH]C([CH2])OO(8914)',
    structure = SMILES('[CH2]C([CH]C)C[CH]C([CH2])OO'),
    E0 = (471.264,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.18714,0.12082,-0.000128959,8.10174e-08,-2.1518e-11,56861,48.7022], Tmin=(100,'K'), Tmax=(897.054,'K')), NASAPolynomial(coeffs=[12.5165,0.0597143,-2.678e-05,5.07959e-09,-3.5458e-13,54402.4,-15.9212], Tmin=(897.054,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(471.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(Cs_S) + radical(Isobutyl) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2]C([CH]C)[CH][CH]C(C)OO(8915)',
    structure = SMILES('[CH2]C([CH]C)[CH][CH]C(C)OO'),
    E0 = (451.844,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.942838,0.116994,-0.0001275,8.70618e-08,-2.58172e-11,54514.8,48.3884], Tmin=(100,'K'), Tmax=(800.075,'K')), NASAPolynomial(coeffs=[9.46933,0.0649356,-2.98951e-05,5.72787e-09,-4.01525e-13,52848.8,0.4786], Tmin=(800.075,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(451.844,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Cs_S) + radical(CCJCOOH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2][C]([CH]C)C[CH]C(C)OO(8916)',
    structure = SMILES('[CH2][C]([CH]C)C[CH]C(C)OO'),
    E0 = (442.725,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.36901,0.129821,-0.000179641,1.5566e-07,-5.50956e-11,53429.5,48.471], Tmin=(100,'K'), Tmax=(817.029,'K')), NASAPolynomial(coeffs=[7.14494,0.0687363,-3.18727e-05,6.02042e-09,-4.14062e-13,52685.8,13.0797], Tmin=(817.029,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(442.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(CCJCOOH) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]C([CH]C)C[CH]CO[O](976)'],
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C([CH]C)CC(C)[CH]O[O](8892)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    products = ['O2(S)(666)', '[CH2]C([CH]C)CC=CC(3841)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction8',
    reactants = ['O(4)', '[CH2]C([CH]C)C[CH]C(C)[O](8893)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CHCH3(T)(21)', '[CH2][CH]C[CH]C(C)O[O](7647)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['C[CH]O[O](57)', '[CH]CC([CH2])[CH]C(3863)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]C(C)O[O](668)', '[CH2]C([CH2])[CH]C(500)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(17)', '[CH]C([CH2])C[CH]C(C)O[O](8160)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH2]C([CH]C)C[C]C(C)O[O](8894)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2]C([C]C)C[CH]C(C)O[O](8895)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH]C([CH]C)C[CH]C(C)O[O](8896)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    products = ['CC([CH]CC1CC1C)O[O](8897)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    products = ['[CH2]C([CH]C)CC1OOC1C(8898)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    products = ['O(4)', '[CH2]C([CH]C)CC1OC1C(8900)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    products = ['HO2(9)', '[CH2]C([CH]C)C[CH]C=C(4573)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    products = ['C=C(CC)C[CH]C(C)O[O](7840)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    products = ['CC=C(C)C[CH]C(C)O[O](8498)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    products = ['[CH2]C(=CC)CCC(C)O[O](8901)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    products = ['[CH2]C([CH]C)CC=C(C)OO(8902)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    products = ['[CH2]C(C=CC(C)O[O])CC(7841)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    products = ['C[CH]C(C)C=CC(C)O[O](8499)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    products = ['[CH2]C(C=C)CCC(C)O[O](7558)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    products = ['[CH2]C([CH]C)C=CC(C)OO(8903)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    products = ['[CH2]C(CC)CC=C(C)O[O](7560)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    products = ['C[CH]C(C)CC=C(C)O[O](7549)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', '[CH2]C(=CC)C[CH]C(C)O[O](8904)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(3)', '[CH2]C([CH]C)CC=C(C)O[O](8905)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', '[CH2]C([CH]C)C=CC(C)O[O](8906)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(3)', '[CH2]C(C=C)C[CH]C(C)O[O](7563)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction38',
    reactants = ['CH2(T)(20)', 'CC=CC[CH]C(C)O[O](7771)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CHCH3(T)(21)', 'C=CC[CH]C(C)O[O](7476)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction41',
    reactants = ['CH3(17)', '[CH2]C([CH]C)CC=CO[O](4798)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction43',
    reactants = ['O2(2)', '[CH2]C([CH]C)CC=CC(3841)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction46',
    reactants = ['H(3)', '[CH2][C]([CH]C)C[CH]C(C)O[O](8907)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction47',
    reactants = ['CH3(17)', '[CH2]C([CH]C)C[CH][CH]O[O](4802)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction48',
    reactants = ['H(3)', '[CH2]C([CH]C)C[CH][C](C)O[O](8908)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction49',
    reactants = ['H(3)', '[CH2]C([CH]C)[CH][CH]C(C)O[O](8309)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction50',
    reactants = ['H(3)', '[CH2]C([CH]C)C[CH]C([CH2])O[O](8909)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction52',
    reactants = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    products = ['[CH2][C](CC)C[CH]C(C)O[O](7842)'],
...
reaction(
    label = 'reaction54',
    reactants = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    products = ['[CH2]C([CH]C)CC[C](C)O[O](8910)'],
...
reaction(
    label = 'reaction57',
    reactants = ['[CH2]C([CH]C)C[CH][C](C)OO(8911)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction58',
    reactants = ['[CH2]C([CH][CH]C(C)O[O])CC(7844)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction60',
    reactants = ['[CH2]C([CH]C)CCC([CH2])O[O](8912)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction61',
    reactants = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    products = ['[CH2][C]([CH]C)CCC(C)O[O](8913)'],
...
reaction(
    label = 'reaction62',
    reactants = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    products = ['[CH2]C([CH]C)C[CH]C([CH2])OO(8914)'],
...
reaction(
    label = 'reaction64',
    reactants = ['[CH2]C([CH]C)[CH][CH]C(C)OO(8915)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction65',
    reactants = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
    products = ['[CH2]C(CC)C[CH][C](C)O[O](7843)'],
...
reaction(
    label = 'reaction67',
    reactants = ['[CH2][C]([CH]C)C[CH]C(C)OO(8916)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
...
reaction(
    label = 'reaction68',
    reactants = ['[CH2]C(CC)C[CH]C([CH2])O[O](7845)'],
    products = ['[CH2]C([CH]C)C[CH]C(C)O[O](7542)'],
