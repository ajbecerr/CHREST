...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0939387,0.0790831,-4.21075e-05,6.26435e-09,1.44898e-12,33149,36.8784], Tmin=(100,'K'), Tmax=(1168.13,'K')), NASAPolynomial(coeffs=[14.1853,0.0450581,-1.75117e-05,3.12534e-09,-2.11592e-13,28798.4,-38.5725], Tmin=(1168.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(274.315,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C=C)C(C)[C]C(5476)',
    structure = SMILES('[CH2]C(C=C)C(C)[C]C'),
    E0 = (531.336,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.255905,0.0825268,-4.79683e-05,5.81244e-09,3.34168e-12,64067.7,35.4943], Tmin=(100,'K'), Tmax=(1044.9,'K')), NASAPolynomial(coeffs=[15.9369,0.0400555,-1.50155e-05,2.66299e-09,-1.81515e-13,59618.3,-48.436], Tmin=(1044.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(531.336,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(C=C)C(C)[CH]C(5477)',
    structure = SMILES('[CH]C(C=C)C(C)[CH]C'),
    E0 = (520.796,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.21135,0.0808517,-4.97984e-05,1.33334e-08,-8.68054e-13,62798.5,37.2259], Tmin=(100,'K'), Tmax=(1290.4,'K')), NASAPolynomial(coeffs=[16.6028,0.0403194,-1.6153e-05,2.91046e-09,-1.97054e-13,57494.3,-51.9176], Tmin=(1290.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(520.796,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.287804,0.0825174,-5.41314e-05,1.88445e-08,-2.81415e-12,-2261.34,28.2864], Tmin=(100,'K'), Tmax=(1465.25,'K')), NASAPolynomial(coeffs=[12.0292,0.0504645,-2.13184e-05,3.91518e-09,-2.66918e-13,-5702.18,-32.8449], Tmin=(1465.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.9006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CC(=C)C(C)CC(5080)',
    structure = SMILES('C=CC(=C)C(C)CC'),
    E0 = (-21.8473,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.251894,0.0774913,-1.85567e-05,-3.05674e-08,1.715e-11,-2460.4,31.0131], Tmin=(100,'K'), Tmax=(996.838,'K')), NASAPolynomial(coeffs=[18.2158,0.0390832,-1.4477e-05,2.62793e-09,-1.8465e-13,-7915.84,-66.9204], Tmin=(996.838,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-21.8473,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CC(C)C(C)C=C(3838)',
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.12327,0.0692764,-3.30448e-06,-4.01494e-08,1.89374e-11,177.066,32.2624], Tmin=(100,'K'), Tmax=(1015.06,'K')), NASAPolynomial(coeffs=[15.971,0.0424663,-1.63535e-05,3.01162e-09,-2.12174e-13,-4876.31,-53.475], Tmin=(1015.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(0.195693,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.406564,0.0807783,-5.4134e-05,2.06809e-08,-3.5178e-12,32425.9,34.341], Tmin=(100,'K'), Tmax=(1284.17,'K')), NASAPolynomial(coeffs=[9.22887,0.053298,-2.20349e-05,4.01683e-09,-2.73663e-13,30160,-10.428], Tmin=(1284.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(268.543,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Tertalkyl) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0741174,0.0809269,-4.95231e-05,1.51248e-08,-1.88247e-12,37488.7,36.2079], Tmin=(100,'K'), Tmax=(1813.76,'K')), NASAPolynomial(coeffs=[18.3196,0.0403627,-1.59766e-05,2.79459e-09,-1.82958e-13,30816.3,-63.483], Tmin=(1813.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(310.422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.436096,0.0861947,-5.95552e-05,2.19612e-08,-3.33706e-12,38771.9,36.7238], Tmin=(100,'K'), Tmax=(1529.39,'K')), NASAPolynomial(coeffs=[16.9018,0.0408481,-1.50795e-05,2.57387e-09,-1.67898e-13,33468.7,-54.2879], Tmin=(1529.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(320.962,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CC(C)C(C)[CH]C(5492)',
    structure = SMILES('[CH]=CC(C)C(C)[CH]C'),
    E0 = (319.677,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2762.5,2775,2787.5,2800,2812.5,2825,2837.5,2850,1350,1380,1410,1440,1470,1500,700,750,800,1000,1050,1100,1350,1375,1400,900,1000,1100,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.230609,0.0812789,-4.67212e-05,1.06296e-08,-1.74027e-13,38610.2,36.6951], Tmin=(100,'K'), Tmax=(1287.9,'K')), NASAPolynomial(coeffs=[16.1022,0.0433147,-1.73693e-05,3.13037e-09,-2.11897e-13,33344.7,-50.3429], Tmin=(1287.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.677,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (110.197,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.294267,0.0831824,-4.57014e-05,4.16922e-09,3.58228e-12,39880.1,36.1303], Tmin=(100,'K'), Tmax=(1058.38,'K')), NASAPolynomial(coeffs=[15.4616,0.0430013,-1.62008e-05,2.87519e-09,-1.95693e-13,35460.3,-45.9005], Tmin=(1058.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(330.217,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]C(C=C)C[CH]C(3951)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
    products = ['[CH2]C([CH]C(C)C)C=C(5474)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
    products = ['C=CC[CH]C(C)[CH]C(5475)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(6.55606e+10,'s^-1'), n=0.64, Ea=(159.935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [cCs(-HC)CJ;CsJ;C] for rate rule [cCs(-HC)CJ;CsJ-HH;C]
Euclidian distance = 1.0
family: 1,2_shiftC"""),
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', '[CH]C(C)C([CH2])C=C(4979)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH2]C(C=C)C(C)[C]C(5476)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]C(C=C)C(C)[CH]C(5477)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C[C]([CH2])C(C)[CH]C(5480)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]CC([CH2])[C](C)[CH]C(5481)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C([CH]C)[C](C)[CH]C(4490)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH2]C(C=C)C(C)=CC(5485)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', 'C=CC(=C)C(C)[CH]C(5486)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2]C(C=C)C(C)C=C(4923)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.0171758,'m^3/(mol*s)'), n=2.41179, Ea=(31.2263,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cds-CsH_Cds-CsH;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 4.0
family: R_Addition_MultipleBond
Ea raised from 25.8 to 31.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction28',
    reactants = ['CH3(17)', '[CH2]C(C=C)C=CC(5041)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C2H3(60)', 'C=CC(C)[CH]C(1184)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
...
reaction(
    label = 'reaction34',
    reactants = ['C2H3(60)', '[CH2][CH]C(C)[CH]C(1188)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(3)', '[CH2]C([C]=C)C(C)[CH]C(5489)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
...
reaction(
    label = 'reaction39',
    reactants = ['H(3)', '[CH]=CC([CH2])C(C)[CH]C(5490)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
    products = ['[CH2]C(C=C)[C](C)CC(5095)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2]C=C(C)C(C)[CH]C(4476)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
    products = ['[CH2]CC(C)C([CH2])C=C(3849)'],
...
reaction(
    label = 'reaction47',
    reactants = ['C=[C]C(C)C(C)[CH]C(5491)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]C([CH]C)C(C)C=C(3836)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH2]C([C]=C)C(C)CC(5098)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[CH]=CC(C)C(C)[CH]C(5492)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH2][CH]C(C)C(C)C=C(3843)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
...
reaction(
    label = 'reaction52',
    reactants = ['[CH]=CC([CH2])C(C)CC(5101)'],
    products = ['[CH2]C(C=C)C(C)[CH]C(3845)'],
