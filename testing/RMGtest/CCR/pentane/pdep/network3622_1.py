...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.841357,0.0603496,-3.06337e-05,2.74782e-09,1.70209e-12,23370.2,26.8374], Tmin=(100,'K'), Tmax=(1195.83,'K')), NASAPolynomial(coeffs=[12.7574,0.0336597,-1.36736e-05,2.50177e-09,-1.71729e-13,19578.7,-36.7188], Tmin=(1195.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(193.303,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    label = 'C=[C]CCC1[CH]C1(15868)',
    structure = SMILES('C=[C]CCC1[CH]C1'),
    E0 = (529.447,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2732,0.0485476,2.16707e-06,-3.04352e-08,1.3109e-11,63785.7,28.6966], Tmin=(100,'K'), Tmax=(1050.08,'K')), NASAPolynomial(coeffs=[11.4989,0.0347252,-1.39849e-05,2.60899e-09,-1.83759e-13,60252.7,-27.7329], Tmin=(1050.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(529.447,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(cyclopropane) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C1[CH]CCC1=C(15853)',
    structure = SMILES('[CH2]C1[CH]CCC1=C'),
    E0 = (361.008,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87794,0.0270499,7.22974e-05,-1.07352e-07,4.1367e-11,43513.2,24.937], Tmin=(100,'K'), Tmax=(972.086,'K')), NASAPolynomial(coeffs=[12.5061,0.0323945,-1.16809e-05,2.1786e-09,-1.59021e-13,39128.1,-37.9637], Tmin=(972.086,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(361.008,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclopentane) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][C]1CCC1C=C(15852)',
    structure = SMILES('[CH2][C]1CCC1C=C'),
    E0 = (443.806,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60462,0.0399857,2.58379e-05,-5.45134e-08,2.18487e-11,53475,27.3687], Tmin=(100,'K'), Tmax=(994.638,'K')), NASAPolynomial(coeffs=[10.2207,0.0356653,-1.33861e-05,2.43434e-09,-1.70648e-13,50260.7,-21.6943], Tmin=(994.638,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(443.806,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31451,0.0626486,-4.30472e-05,1.63143e-08,-2.74261e-12,60633.3,27.4296], Tmin=(100,'K'), Tmax=(1287.48,'K')), NASAPolynomial(coeffs=[8.20128,0.0412524,-1.81192e-05,3.40633e-09,-2.36169e-13,58860,-7.53531], Tmin=(1287.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(503.358,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CCCC=C[CH2](5720)',
    structure = SMILES('[CH]=CCCC=C[CH2]'),
    E0 = (426.27,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3100,440,815,1455,1000,3120,650,792.5,1650,180,1001.09],'cm^-1')),
        HinderedRotor(inertia=(0.0976155,'amu*angstrom^2'), symmetry=1, barrier=(2.24437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.805868,'amu*angstrom^2'), symmetry=1, barrier=(18.5285,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.805928,'amu*angstrom^2'), symmetry=1, barrier=(18.5299,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.805847,'amu*angstrom^2'), symmetry=1, barrier=(18.528,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.726565,0.061209,-2.47008e-05,-8.6495e-09,6.80623e-12,51395.5,29.2831], Tmin=(100,'K'), Tmax=(1059.97,'K')), NASAPolynomial(coeffs=[14.038,0.0318343,-1.26494e-05,2.33583e-09,-1.63406e-13,47401.8,-41.2393], Tmin=(1059.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(426.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cds_P)"""),
)
...
species(
    label = 'C=[C]CC[C]=CC(15877)',
    structure = SMILES('C=[C]CC[C]=CC'),
    E0 = (503.358,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1670,1700,300,440,339.413,339.413,339.413],'cm^-1')),
        HinderedRotor(inertia=(0.102945,'amu*angstrom^2'), symmetry=1, barrier=(8.41573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102945,'amu*angstrom^2'), symmetry=1, barrier=(8.41573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102945,'amu*angstrom^2'), symmetry=1, barrier=(8.41573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102945,'amu*angstrom^2'), symmetry=1, barrier=(8.41573,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = '[CH2]C=[C]CCC=C(15878)',
    structure = SMILES('[CH2]C=[C]CCC=C'),
    E0 = (417.015,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,1685,370,262.033,262.036,262.037],'cm^-1')),
        HinderedRotor(inertia=(0.00245519,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.424097,'amu*angstrom^2'), symmetry=1, barrier=(20.6638,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.424093,'amu*angstrom^2'), symmetry=1, barrier=(20.6638,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00245522,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.851841,0.0605611,-3.44134e-05,8.58435e-09,-6.27401e-13,49026.7,27.5401], Tmin=(100,'K'), Tmax=(1461.76,'K')), NASAPolynomial(coeffs=[13.9432,0.032217,-1.3003e-05,2.32014e-09,-1.54724e-13,44400.3,-43.3218], Tmin=(1461.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(406.629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_S) + radical(Cds_S)"""),
)
...
species(
    label = 'C=CC1CCC1=C(15845)',
    structure = SMILES('C=CC1CCC1=C'),
    E0 = (187.716,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32074,0.0474195,5.94802e-06,-3.27252e-08,1.33636e-11,22683.2,21.5259], Tmin=(100,'K'), Tmax=(1068.34,'K')), NASAPolynomial(coeffs=[10.9515,0.0369154,-1.51839e-05,2.85139e-09,-2.0098e-13,19167.1,-32.3992], Tmin=(1068.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(187.716,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(methylenecyclobutane)"""),
)

species(
    label = 'C=CC=CCC=C(13681)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.928284,0.0526922,5.52927e-06,-4.52841e-08,2.12071e-11,17024.7,26.4843], Tmin=(100,'K'), Tmax=(980.341,'K')), NASAPolynomial(coeffs=[15.6611,0.0277122,-1.00059e-05,1.83678e-09,-1.31771e-13,12447.8,-52.9113], Tmin=(980.341,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.522,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    E0 = (472.22,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,239.438,239.438,239.438,1921.89],'cm^-1')),
        HinderedRotor(inertia=(0.00294046,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00294046,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.291753,'amu*angstrom^2'), symmetry=1, barrier=(11.8694,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00294046,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'C=[C]CCC[C]=C(15883)',
    structure = SMILES('C=[C]CCC[C]=C'),
    E0 = (515.603,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1670,1700,300,440,311.84,311.844,311.862,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0760784,'amu*angstrom^2'), symmetry=1, barrier=(5.25004,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.213048,'amu*angstrom^2'), symmetry=1, barrier=(14.7024,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.2846,'amu*angstrom^2'), symmetry=1, barrier=(19.6387,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.284583,'amu*angstrom^2'), symmetry=1, barrier=(19.6387,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12472,0.0641247,-4.43504e-05,1.64048e-08,-2.60067e-12,62115.1,27.8538], Tmin=(100,'K'), Tmax=(1398.27,'K')), NASAPolynomial(coeffs=[10.2734,0.0379532,-1.62748e-05,3.0189e-09,-2.07371e-13,59556.6,-19.3502], Tmin=(1398.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(515.603,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CCCC[C]=C(15884)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.816063,0.0660881,-4.63204e-05,1.69112e-08,-2.56068e-12,63243.3,29.5919], Tmin=(100,'K'), Tmax=(1507.48,'K')), NASAPolynomial(coeffs=[13.1715,0.0333036,-1.36984e-05,2.48435e-09,-1.68119e-13,59518.2,-35.0868], Tmin=(1507.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(524.858,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = 'C#CCCC[CH][CH2](15561)',
    structure = SMILES('C#CCCC[CH][CH2]'),
    E0 = (477.933,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2175,525,750,770,3400,2100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0402,0.0676003,-5.90927e-05,3.33432e-08,-8.38906e-12,57586.5,29.809], Tmin=(100,'K'), Tmax=(923.802,'K')), NASAPolynomial(coeffs=[6.99475,0.0418176,-1.72289e-05,3.132e-09,-2.13314e-13,56486.3,1.55364], Tmin=(923.802,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(477.933,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJC) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H2CC(T)(1341)', '[CH2]C=CC[CH2](507)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[CH]=CCC[C]=C(15168)'],
    products = ['C=[C]CC[CH]C=C(15535)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]=C[CH]CC[C]=C(15589)'],
    products = ['C=[C]CC[CH]C=C(15535)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C]=CCC[CH][CH2](5282)'],
    products = ['C=[C]CC[CH]C=C(15535)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C[CH]C[CH][C]=C(15867)'],
    products = ['C=[C]CC[CH]C=C(15535)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C=[C]CC[CH]C=C(15535)'],
    products = ['[CH2]C1[CH]CCC1=C(15853)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'C=C=CC[CH]C=C(13509)'],
    products = ['C=[C]CC[CH]C=C(15535)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', 'C=[C]CCC=C=C(15869)'],
    products = ['C=[C]CC[CH]C=C(15535)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C#CCCC=C[CH2](15870)'],
    products = ['C=[C]CC[CH]C=C(15535)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(3960,'cm^3/(mol*s)'), n=2.65, Ea=(48.5344,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 41 used for Cds-HH_Ca;CsJ-CdHH
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]C=C(3739)', '[CH2]C[C]=C(2373)'],
    products = ['C=[C]CC[CH]C=C(15535)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2]C=CC[CH][C]=C(15872)'],
    products = ['C=[C]CC[CH]C=C(15535)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH2]C=[C]CC[C]=C(15873)'],
    products = ['C=[C]CC[CH]C=C(15535)'],
...
reaction(
    label = 'reaction37',
    reactants = ['C2H3(60)', '[CH]CC[C]=C(15604)'],
    products = ['C=[C]CC[CH]C=C(15535)'],
...
reaction(
    label = 'reaction41',
    reactants = ['H(3)', 'C=[C]CC=CC=C(15591)'],
    products = ['C=[C]CC[CH]C=C(15535)'],
...
reaction(
    label = 'reaction44',
    reactants = ['C=[C]CCC[C]=C(15883)'],
    products = ['C=[C]CC[CH]C=C(15535)'],
    transitionState = 'TS44',
    kinetics = Arrhenius(A=(3.8108e+11,'s^-1'), n=0.853, Ea=(200.196,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R2H_S;Cd_rad_out_Cd;Cs_H_out_H/(NonDeC/Cs)]
Euclidian distance = 0
Multiplied by reaction path degeneracy 4.0
family: intra_H_migration"""),
)
