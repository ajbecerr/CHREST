...
species(
    label = '[CH2][C]C([CH2])C=C[CH2](18665)',
    structure = SMILES('[CH2][C]C([CH2])C=C[CH2]'),
    E0 = (901.963,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.553374,0.0676549,-4.7024e-05,1.17728e-08,8.79794e-13,108612,32.2526], Tmin=(100,'K'), Tmax=(1019.65,'K')), NASAPolynomial(coeffs=[14.378,0.0280421,-1.02572e-05,1.79594e-09,-1.21805e-13,105033,-38.4388], Tmin=(1019.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(901.963,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Allyl_P) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][CH]CC=[C][CH2](15387)',
    structure = SMILES('[CH][CH]CC=[C][CH2]'),
    E0 = (955.675,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73942,0.0527065,-4.66951e-05,2.55799e-08,-6.23664e-12,115020,26.7469], Tmin=(100,'K'), Tmax=(946.697,'K')), NASAPolynomial(coeffs=[6.59991,0.0321699,-1.41556e-05,2.66545e-09,-1.85485e-13,114100,3.56405], Tmin=(946.697,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(955.675,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(Allyl_P) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH2][C][C]CC=C[CH2](18666)',
    structure = SMILES('[CH2][C][C]CC=C[CH2]'),
    E0 = (1153.07,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.561988,0.0707133,-6.15098e-05,2.78096e-08,-5.07963e-12,138810,30.5929], Tmin=(100,'K'), Tmax=(1304.85,'K')), NASAPolynomial(coeffs=[14.8864,0.0268021,-1.10317e-05,2.01985e-09,-1.38518e-13,135072,-42.326], Tmin=(1304.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1153.07,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(RCCJ) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C=CC[CH][C][CH2](18667)',
    structure = SMILES('[CH]C=CC[CH][C][CH2]'),
    E0 = (1118.5,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17476,0.0667539,-6.01162e-05,3.82828e-08,-1.16293e-11,134622,31.8944], Tmin=(100,'K'), Tmax=(754.052,'K')), NASAPolynomial(coeffs=[4.84309,0.0472947,-2.14074e-05,4.06001e-09,-2.8308e-13,134068,15.2324], Tmin=(754.052,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1118.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(RCCJ) + radical(CCJ2_triplet) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH][C][CH]CC=C[CH2](18668)',
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14156,0.0660725,-5.92956e-05,3.0958e-08,-6.98834e-12,137485,30.3972], Tmin=(100,'K'), Tmax=(1028.82,'K')), NASAPolynomial(coeffs=[8.72908,0.0365724,-1.62847e-05,3.08708e-09,-2.15755e-13,135924,-6.42377], Tmin=(1028.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1142.28,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(Allyl_P) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH2][C][CH][CH]C[CH][CH2](18669)',
    structure = SMILES('[CH2][C][CH][CH]C[CH][CH2]'),
    E0 = (1226.43,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,246.321,346.101,2041.93,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0267889,'amu*angstrom^2'), symmetry=1, barrier=(0.838115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0267889,'amu*angstrom^2'), symmetry=1, barrier=(0.838115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0267889,'amu*angstrom^2'), symmetry=1, barrier=(0.838115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0267889,'amu*angstrom^2'), symmetry=1, barrier=(0.838115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0267889,'amu*angstrom^2'), symmetry=1, barrier=(0.838115,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10993,0.0784371,-0.000129831,1.33633e-07,-5.15786e-11,147595,38.0509], Tmin=(100,'K'), Tmax=(865.847,'K')), NASAPolynomial(coeffs=[-1.68981,0.0548685,-2.57629e-05,4.81482e-09,-3.25737e-13,149448,59.0562], Tmin=(865.847,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1226.43,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC) + radical(RCCJCC) + radical(RCCJ) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][C][CH]CC1[CH]C1(18670)',
    structure = SMILES('[CH2][C][CH]CC1[CH]C1'),
    E0 = (1011.74,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34255,0.0545277,-3.02503e-05,8.04193e-09,-8.58528e-13,121783,31.7697], Tmin=(100,'K'), Tmax=(2082.4,'K')), NASAPolynomial(coeffs=[15.1752,0.0279553,-1.11083e-05,1.91333e-09,-1.22718e-13,116022,-45.1106], Tmin=(2082.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1011.74,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(cyclopropane) + radical(RCCJCC) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][C]C1C[CH]C1[CH2](18671)',
    structure = SMILES('[CH2][C]C1C[CH]C1[CH2]'),
    E0 = (970.832,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3662,0.0449484,1.35519e-05,-4.65238e-08,2.02793e-11,116870,29.9266], Tmin=(100,'K'), Tmax=(983.572,'K')), NASAPolynomial(coeffs=[12.5082,0.0303963,-1.11664e-05,2.02678e-09,-1.42947e-13,113191,-31.2064], Tmin=(983.572,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(970.832,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(Isobutyl) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2]C1[CH]C[CH][C]C1(18672)',
    structure = SMILES('[CH2]C1[CH]C[CH][C]C1'),
    E0 = (855.266,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89211,0.0355794,2.79424e-05,-4.62786e-08,1.58267e-11,102949,25.2783], Tmin=(100,'K'), Tmax=(1117.49,'K')), NASAPolynomial(coeffs=[7.55946,0.0428013,-1.86753e-05,3.56031e-09,-2.51069e-13,99965.3,-10.3779], Tmin=(1117.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(855.266,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclohexane) + radical(Cs_S) + radical(cyclohexane) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][C]C1CC1[CH][CH2](18673)',
    structure = SMILES('[CH2][C]C1CC1[CH][CH2]'),
    E0 = (982.119,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10505,0.0514112,-4.39695e-06,-2.85375e-08,1.37477e-11,118236,31.065], Tmin=(100,'K'), Tmax=(1020.7,'K')), NASAPolynomial(coeffs=[13.7412,0.0290532,-1.1456e-05,2.14394e-09,-1.52628e-13,114242,-37.087], Tmin=(1020.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(982.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Cs_S) + radical(RCCJ) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][CH]C1C[C][CH]C1(18674)',
    structure = SMILES('[CH2][CH]C1C[C][CH]C1'),
    E0 = (885.609,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94684,0.0333858,3.11125e-05,-5.37479e-08,2.00779e-11,106598,30.0016], Tmin=(100,'K'), Tmax=(1027.85,'K')), NASAPolynomial(coeffs=[8.52529,0.0361941,-1.44446e-05,2.69072e-09,-1.89839e-13,103745,-9.21635], Tmin=(1027.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(885.609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopentane) + radical(Cs_S) + radical(cyclopentane) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH2][C][CH][CH2](18675)',
    structure = SMILES('[CH2][C][CH][CH2]'),
    E0 = (909.119,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1457.93,1458.31],'cm^-1')),
        HinderedRotor(inertia=(0.102908,'amu*angstrom^2'), symmetry=1, barrier=(2.36606,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103118,'amu*angstrom^2'), symmetry=1, barrier=(2.37089,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.103092,'amu*angstrom^2'), symmetry=1, barrier=(2.3703,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (53.0825,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53729,0.0377348,-5.79094e-05,5.70759e-08,-2.17573e-11,109389,20.2072], Tmin=(100,'K'), Tmax=(840.231,'K')), NASAPolynomial(coeffs=[2.86211,0.023752,-1.07452e-05,2.03862e-09,-1.4038e-13,109774,21.309], Tmin=(840.231,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(909.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(RCCJC) + radical(RCCJ) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][C][CH][CH]C=C[CH2](18676)',
    structure = SMILES('[CH2][C]=C[CH][CH][CH][CH2]'),
    E0 = (1024.5,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1685,370,240.812,2032.58,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0509665,'amu*angstrom^2'), symmetry=1, barrier=(2.21617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0509665,'amu*angstrom^2'), symmetry=1, barrier=(2.21617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0509665,'amu*angstrom^2'), symmetry=1, barrier=(2.21617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0509665,'amu*angstrom^2'), symmetry=1, barrier=(2.21617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0509665,'amu*angstrom^2'), symmetry=1, barrier=(2.21617,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42678,0.0630531,-7.66911e-05,6.89346e-08,-2.61774e-11,123305,33.0357], Tmin=(100,'K'), Tmax=(811.401,'K')), NASAPolynomial(coeffs=[2.47142,0.0453507,-2.07602e-05,3.91431e-09,-2.69601e-13,123549,30.7606], Tmin=(811.401,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1024.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(Allyl_S) + radical(RCCJC) + radical(RCCJ) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2][C][CH]C[C]=C[CH2](18677)',
    structure = SMILES('[CH2][C][CH]C[C]=C[CH2]'),
    E0 = (1137.15,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53993,0.0624511,-4.21776e-05,-1.76554e-08,3.47055e-11,136848,30.3244], Tmin=(100,'K'), Tmax=(520.326,'K')), NASAPolynomial(coeffs=[6.24362,0.040255,-1.84443e-05,3.51154e-09,-2.44749e-13,136170,8.88838], Tmin=(520.326,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1137.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(Allyl_P) + radical(RCCJ) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][C][CH]CC=[C][CH2](18678)',
    structure = SMILES('[CH2][C][CH]CC=[C][CH2]'),
    E0 = (1137.15,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1685,370,200,800,1200,1600],'cm^-1')),
    ...
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54017,0.0624472,-4.21562e-05,-1.77015e-08,3.47395e-11,136848,30.3236], Tmin=(100,'K'), Tmax=(520.295,'K')), NASAPolynomial(coeffs=[6.24355,0.0402552,-1.84444e-05,3.51156e-09,-2.44751e-13,136170,8.88875], Tmin=(520.295,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1137.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(RCCJ) + radical(Allyl_P) + radical(CCJ2_triplet) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12821,0.067901,-6.51289e-05,4.08018e-08,-1.15437e-11,112182,29.9217], Tmin=(100,'K'), Tmax=(822.173,'K')), NASAPolynomial(coeffs=[6.28519,0.0428117,-1.93554e-05,3.68621e-09,-2.57906e-13,111334,6.052], Tmin=(822.173,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(931.907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(Allyl_P) + radical(CCJ2_triplet) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12417,0.0671033,-5.91275e-05,3.17596e-08,-7.5634e-12,112181,30.1036], Tmin=(100,'K'), Tmax=(967.998,'K')), NASAPolynomial(coeffs=[7.55788,0.0405182,-1.79324e-05,3.38876e-09,-2.36363e-13,110936,-0.7262], Tmin=(967.998,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(931.895,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(Allyl_P) + radical(CCJ2_triplet) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2][C]=C[CH][CH][CH]C(17722)',
    structure = SMILES('[CH2][C]=C[CH][CH][CH]C'),
    E0 = (819.25,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,256.111,1008.45,3796.32],'cm^-1')),
        HinderedRotor(inertia=(0.0157024,'amu*angstrom^2'), symmetry=1, barrier=(0.488722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0157024,'amu*angstrom^2'), symmetry=1, barrier=(0.488722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0157024,'amu*angstrom^2'), symmetry=1, barrier=(0.488722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0157024,'amu*angstrom^2'), symmetry=1, barrier=(0.488722,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0157024,'amu*angstrom^2'), symmetry=1, barrier=(0.488722,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.74155,0.0481205,-2.2307e-05,4.40019e-09,-3.2563e-13,98555.2,25.6868], Tmin=(100,'K'), Tmax=(3203.1,'K')), NASAPolynomial(coeffs=[31.3619,0.0123805,-5.57052e-06,9.16874e-10,-5.37654e-14,80220.1,-145.708], Tmin=(3203.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(819.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(RCCJCC) + radical(Allyl_S) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C=C[CH][CH][C]C(18679)',
    structure = SMILES('[CH2]C=C[CH][CH][C]C'),
    E0 = (835.177,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24279,0.0597252,-3.80893e-05,1.24517e-08,-1.711e-12,100548,27.9073], Tmin=(100,'K'), Tmax=(1598.94,'K')), NASAPolynomial(coeffs=[11.2547,0.0346789,-1.45929e-05,2.65508e-09,-1.79269e-13,97346.3,-25.0935], Tmin=(1598.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(835.177,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(RCCJCC) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2]C=[C]C[CH][C]C(18680)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1282,0.0679012,-6.51295e-05,4.08025e-08,-1.1544e-11,112182,29.9217], Tmin=(100,'K'), Tmax=(822.125,'K')), NASAPolynomial(coeffs=[6.28516,0.0428117,-1.93555e-05,3.68622e-09,-2.57907e-13,111334,6.05214], Tmin=(822.125,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(931.907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(Allyl_P) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94151,0.0494842,-6.37915e-05,5.41893e-08,-1.91692e-11,135743,24.4977], Tmin=(100,'K'), Tmax=(815.666,'K')), NASAPolynomial(coeffs=[4.79282,0.0286853,-1.30076e-05,2.4371e-09,-1.67109e-13,135505,12.7127], Tmin=(815.666,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1128.05,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJ) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH2][C]C1C[CH][CH]C1(18682)',
    structure = SMILES('[CH2][C]C1C[CH][CH]C1'),
    E0 = (876.948,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00919,0.0350503,1.88747e-05,-3.65755e-08,1.32014e-11,105551,29.7874], Tmin=(100,'K'), Tmax=(1070.73,'K')), NASAPolynomial(coeffs=[6.43227,0.0391056,-1.56361e-05,2.8622e-09,-1.97886e-13,103425,2.63765], Tmin=(1070.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(876.948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopentane) + radical(cyclopentane) + radical(cyclopentane) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[C]1[CH]C[CH][CH]CC1(18683)',
    structure = SMILES('[C]1[CH]C[CH][CH]CC1'),
    E0 = (821.022,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82823,0.00452364,0.000180005,-2.62649e-07,1.09211e-10,98864.8,30.3373], Tmin=(100,'K'), Tmax=(909.161,'K')), NASAPolynomial(coeffs=[29.6848,-0.00543199,1.06494e-05,-2.23484e-09,1.42937e-13,89145.8,-126.995], Tmin=(909.161,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(821.022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cycloheptane) + radical(cycloheptane) + radical(cycloheptane) + radical(cycloheptane) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32552,0.0638865,-4.25075e-05,1.69343e-08,-3.26821e-12,109931,29.5612], Tmin=(100,'K'), Tmax=(1074.15,'K')), NASAPolynomial(coeffs=[5.29435,0.049107,-2.18685e-05,4.12472e-09,-2.86883e-13,109078,10.13], Tmin=(1074.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(913.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(CCJ2_triplet) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C][CH]CC=C[CH2](16602)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2][C]C([CH2])C=C[CH2](18665)'],
    products = ['[CH2][C][CH]CC=C[CH2](16602)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[CH][CH]CC=[C][CH2](15387)'],
    products = ['[CH2][C][CH]CC=C[CH2](16602)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2][C][C]CC=C[CH2](18666)'],
    products = ['[CH2][C][CH]CC=C[CH2](16602)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]C=CC[CH][C][CH2](18667)'],
    products = ['[CH2][C][CH]CC=C[CH2](16602)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH][C][CH]CC=C[CH2](18668)'],
    products = ['[CH2][C][CH]CC=C[CH2](16602)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C][CH][CH]C[CH][CH2](18669)'],
    products = ['[CH2][C][CH]CC=C[CH2](16602)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C][CH]CC=C[CH2](16602)'],
    products = ['[CH2][C][CH]CC1[CH]C1(18670)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C][CH]CC=C[CH2](16602)'],
    products = ['[CH2][C]C1C[CH]C1[CH2](18671)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][C][CH]CC=C[CH2](16602)'],
    products = ['[CH2]C1[CH]C[CH][C]C1(18672)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C][CH]CC=C[CH2](16602)'],
    products = ['[CH2][C]C1CC1[CH][CH2](18673)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(5.86885e+09,'s^-1'), n=0.611527, Ea=(82.8075,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra;radadd_intra_cs]
Euclidian distance = 0
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][C][CH]CC=C[CH2](16602)'],
    products = ['[CH2][CH]C1C[C][CH]C1(18674)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(8.22e+08,'cm^3/(mol*s)'), n=1.533, Ea=(28.2553,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 192 used for Cd_R;HJ
Exact match found for rate rule [Cd_R;HJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 24.8 to 28.3 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=C[CH2](16804)', '[CH2][C][CH][CH2](18675)'],
    products = ['[CH2][C][CH]CC=C[CH2](16602)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH2][C][CH][CH]C=C[CH2](18676)'],
    products = ['[CH2][C][CH]CC=C[CH2](16602)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2][C][CH]C[C]=C[CH2](18677)'],
    products = ['[CH2][C][CH]CC=C[CH2](16602)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH2][C][CH]CC=[C][CH2](18678)'],
    products = ['[CH2][C][CH]CC=C[CH2](16602)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2][C][CH]CC=C[CH2](16602)'],
    products = ['[CH2][C]C[CH]C=C[CH2](16601)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2][C][CH]CC=C[CH2](16602)'],
    products = ['[CH2][C]=CC[CH][C]C(17717)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2][C]CC[C]=C[CH2](16603)'],
    products = ['[CH2][C][CH]CC=C[CH2](16602)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2][C]=CC[C][CH]C(17718)'],
    products = ['[CH2][C][CH]CC=C[CH2](16602)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2][C]CCC=[C][CH2](16604)'],
    products = ['[CH2][C][CH]CC=C[CH2](16602)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2][C][CH]CC=C[CH2](16602)'],
    products = ['[CH2][C]=C[CH][CH][CH]C(17722)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2][C][CH]CC=C[CH2](16602)'],
    products = ['[CH2]C=C[CH][CH][C]C(18679)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C=[C]C[CH][C]C(18680)'],
    products = ['[CH2][C][CH]CC=C[CH2](16602)'],
...
reaction(
    label = 'reaction32',
    reactants = ['C2H3(60)', '[CH]C[CH][C][CH2](18681)'],
    products = ['[CH2][C][CH]CC=C[CH2](16602)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2][C][CH]CC=C[CH2](16602)'],
    products = ['[CH2][C]C1C[CH][CH]C1(18682)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2][C][CH]CC=C[CH2](16602)'],
    products = ['[C]1[CH]C[CH][CH]CC1(18683)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2][C][CH]CC=C[CH2](16602)'],
    products = ['[CH2][C]=C[CH]C[CH][CH2](17302)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH]C=CCC[C][CH2](14055)'],
    products = ['[CH2][C][CH]CC=C[CH2](16602)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH]=C[CH]C[CH][C]C(18684)'],
    products = ['[CH2][C][CH]CC=C[CH2](16602)'],
