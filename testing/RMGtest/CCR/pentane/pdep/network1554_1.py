...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.853692,0.0601336,-4.90377e-05,2.05191e-08,-3.42348e-12,26560.5,26.4098], Tmin=(100,'K'), Tmax=(1438.65,'K')), NASAPolynomial(coeffs=[15.1419,0.020407,-7.617e-06,1.32491e-09,-8.80223e-14,22449.3,-47.7192], Tmin=(1438.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(219.832,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26452,0.05145,-2.31403e-05,-4.9574e-09,5.07008e-12,58426.1,24.0609], Tmin=(100,'K'), Tmax=(1052.48,'K')), NASAPolynomial(coeffs=[12.4652,0.0255848,-1.00832e-05,1.85142e-09,-1.29153e-13,55143.2,-34.9439], Tmin=(1052.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(484.901,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJ(C)CO) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C](O)C([CH2])C(7017)',
    structure = SMILES('[CH][C](O)C([CH2])C'),
    E0 = (483.676,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.852841,0.0706165,-8.32479e-05,5.58071e-08,-1.51493e-11,58284.9,27.4364], Tmin=(100,'K'), Tmax=(897.677,'K')), NASAPolynomial(coeffs=[10.608,0.0271453,-1.06041e-05,1.85442e-09,-1.22739e-13,56533.6,-18.5731], Tmin=(897.677,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(483.676,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C]([O])C(C)C(7018)',
    structure = SMILES('[CH][C]([O])C(C)C'),
    E0 = (508.955,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14763,0.0631743,-5.86827e-05,3.02582e-08,-6.48377e-12,61315.5,23.7114], Tmin=(100,'K'), Tmax=(1105.71,'K')), NASAPolynomial(coeffs=[10.6029,0.0289683,-1.22782e-05,2.27903e-09,-1.57582e-13,59224.5,-22.8549], Tmin=(1105.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(508.955,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(O)[C]([CH2])C(7019)',
    structure = SMILES('[CH]C(O)[C]([CH2])C'),
    E0 = (459.622,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13336,0.057005,-4.12965e-05,1.25229e-08,-2.4482e-13,55388.3,27.196], Tmin=(100,'K'), Tmax=(1011.08,'K')), NASAPolynomial(coeffs=[12.0645,0.0244225,-8.77744e-06,1.51155e-09,-1.01193e-13,52632.8,-28.3562], Tmin=(1011.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(459.622,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(O)C([CH2])[CH2](7020)',
    structure = SMILES('[CH]C(O)C([CH2])[CH2]'),
    E0 = (512.131,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0017,0.0638057,-5.92901e-05,2.63409e-08,-2.96312e-12,61705.2,28.568], Tmin=(100,'K'), Tmax=(852.468,'K')), NASAPolynomial(coeffs=[11.9983,0.0233179,-7.59935e-06,1.20661e-09,-7.61769e-14,59426.6,-25.0972], Tmin=(852.468,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(512.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH]C([O])C[CH2](1571)'],
    products = ['[CH]C([O])C([CH2])C(1638)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', '[CH]C([O])[CH]C(6996)'],
    products = ['[CH]C([O])C([CH2])C(1638)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(4)', '[CH][CH]C([CH2])C(7010)'],
    products = ['[CH]C([O])C([CH2])C(1638)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C(C)C([CH])[O](7011)'],
    products = ['[CH]C([O])C([CH2])C(1638)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH]C([O])C(=C)C(7013)'],
    products = ['[CH]C([O])C([CH2])C(1638)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH](6993)', '[CH2]C(C)C=O(1648)'],
    products = ['[CH]C([O])C([CH2])C(1638)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(17)', '[CH]C([O])C=C(6928)'],
    products = ['[CH]C([O])C([CH2])C(1638)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(101.871,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 97.0 to 101.9 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction18',
    reactants = ['CH3(17)', '[CH]C([O])[CH][CH2](6994)'],
    products = ['[CH]C([O])C([CH2])C(1638)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH]C([O])[C]([CH2])C(7014)'],
    products = ['[CH]C([O])C([CH2])C(1638)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH][C]([O])C([CH2])C(7015)'],
    products = ['[CH]C([O])C([CH2])C(1638)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH]C([O])C([CH2])[CH2](1868)'],
    products = ['[CH]C([O])C([CH2])C(1638)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]C(O)C([CH2])[CH2](7020)'],
    products = ['[CH]C([O])C([CH2])C(1638)'],
