...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(2)', '[CH2]CC[CH2](23)'],
    products = ['[CH2]CC([CH2])C(79)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(15)', '[CH2]C([CH2])C(86)'],
    products = ['[CH2]CC([CH2])C(79)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction18',
    reactants = ['[CH3](12)', '[CH2][CH]C[CH2](85)'],
    products = ['[CH2]CC([CH2])C(79)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(9)', '[CH2]C[C]([CH2])C(94)'],
    products = ['[CH2]CC([CH2])C(79)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(9)', '[CH2][CH]C([CH2])C(95)'],
    products = ['[CH2]CC([CH2])C(79)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(9)', '[CH2]CC([CH2])[CH2](96)'],
    products = ['[CH2]CC([CH2])C(79)'],
