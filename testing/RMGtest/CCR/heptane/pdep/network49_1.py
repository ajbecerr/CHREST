...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([CH2])[CH2](96)'],
    products = ['C=C(17)', '[CH2]C=C(53)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(15)', '[CH2][CH]C[CH2](85)'],
    products = ['[CH2]CC([CH2])[CH2](96)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(15)', '[CH2]C([CH2])[CH2](202)'],
    products = ['[CH2]CC([CH2])[CH2](96)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(9)', '[CH]CC([CH2])[CH2](203)'],
    products = ['[CH2]CC([CH2])[CH2](96)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(9)', '[CH]C([CH2])C[CH2](204)'],
    products = ['[CH2]CC([CH2])[CH2](96)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction12',
    reactants = ['H(9)', '[CH2]CC([CH2])=C(208)'],
    products = ['[CH2]CC([CH2])[CH2](96)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(9)', '[CH2]C([CH2])C=C(209)'],
    products = ['[CH2]CC([CH2])[CH2](96)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(T)(15)', '[CH2]CC=C(54)'],
    products = ['[CH2]CC([CH2])[CH2](96)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH2](18)', '[CH2]C=C(53)'],
    products = ['[CH2]CC([CH2])[CH2](96)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=C(17)', '[CH2][CH][CH2](210)'],
    products = ['[CH2]CC([CH2])[CH2](96)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][CH2](18)', '[CH2][CH][CH2](210)'],
    products = ['[CH2]CC([CH2])[CH2](96)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(9)', '[CH2]C[C]([CH2])[CH2](211)'],
    products = ['[CH2]CC([CH2])[CH2](96)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(9)', '[CH2][CH]C([CH2])[CH2](212)'],
    products = ['[CH2]CC([CH2])[CH2](96)'],
