...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17336,0.0530026,-3.23514e-05,-3.33139e-09,7.1997e-12,81723.7,27.7028], Tmin=(100,'K'), Tmax=(956.164,'K')), NASAPolynomial(coeffs=[15.8068,0.0134286,-4.22267e-06,7.29928e-10,-5.1883e-14,77935.9,-47.413], Tmin=(956.164,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(678.574,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(C=CJO) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.654879,0.0717367,-6.90872e-05,3.60215e-08,-7.63124e-12,78219.4,30.9506], Tmin=(100,'K'), Tmax=(1133.73,'K')), NASAPolynomial(coeffs=[13.0311,0.0280709,-1.1314e-05,2.04891e-09,-1.39841e-13,75413.1,-30.3107], Tmin=(1133.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(649.338,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(CCJ2_triplet) + radical(C=CJO)"""),
)

species(
    label = 'C=[C]OC[CH][C]C(4272)',
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.425647,0.0689946,-5.05037e-05,1.04447e-08,2.56161e-12,78890.7,31.5323], Tmin=(100,'K'), Tmax=(995.339,'K')), NASAPolynomial(coeffs=[17.2147,0.0210104,-7.55673e-06,1.34859e-09,-9.40773e-14,74583.3,-54.2354], Tmin=(995.339,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(654.794,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(CCJ2_triplet) + radical(C=CJO)"""),
)
...
species(
    label = 'C=[C]O[CH]C[CH]C(4281)',
    structure = SMILES('C=[C]O[CH]C[CH]C'),
    E0 = (395.05,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.283471,0.0787506,-7.88281e-05,4.20961e-08,-9.01799e-12,47650,31.8512], Tmin=(100,'K'), Tmax=(1130.31,'K')), NASAPolynomial(coeffs=[14.7921,0.0274067,-1.06912e-05,1.90846e-09,-1.29365e-13,44370.1,-39.9218], Tmin=(1130.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(395.05,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(CCsJOC(O)) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H2CC(T)(1341)', 'C[CH][CH]C[O](3807)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]O[C]=C(2363)', '[CH][CH]C(3874)'],
    products = ['C=[C]OC[CH][CH]C(2543)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH][CH]CO[C]=C(2620)'],
    products = ['C=[C]OC[CH][CH]C(2543)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'C=[C]OC[C][CH]C(4271)'],
    products = ['C=[C]OC[CH][CH]C(2543)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', 'C=[C]OC[CH][C]C(4272)'],
    products = ['C=[C]OC[CH][CH]C(2543)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'C=[C]OC=C[CH]C(4275)'],
    products = ['C=[C]OC[CH][CH]C(2543)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C=[C]OC[CH]C=C(4276)'],
    products = ['C=[C]OC[CH][CH]C(2543)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'C=[C]O[CH][CH][CH]C(4278)'],
    products = ['C=[C]OC[CH][CH]C(2543)'],
