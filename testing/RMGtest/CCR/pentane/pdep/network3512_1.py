...
reaction(
    label = 'reaction4',
    reactants = ['CHCH3(T)(21)', '[CH2]C[C]=C(2373)'],
    products = ['C=[C]CC[CH]C(9375)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H2CC(T)(1341)', '[CH2]C[CH]C(36)'],
    products = ['C=[C]CC[CH]C(9375)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', '[CH]CC[C]=C(15604)'],
    products = ['C=[C]CC[CH]C(9375)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', 'C=[C]CC[C]C(15642)'],
    products = ['C=[C]CC[CH]C(9375)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'C#CCC[CH]C(15644)'],
    products = ['C=[C]CC[CH]C(9375)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'C=[C]C[CH][CH]C(4308)'],
    products = ['C=[C]CC[CH]C(9375)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', 'C=[C][CH]C[CH]C(15645)'],
    products = ['C=[C]CC[CH]C(9375)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH2][CH]CC[C]=C(15485)'],
    products = ['C=[C]CC[CH]C(9375)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH]=[C]CC[CH]C(15215)'],
    products = ['C=[C]CC[CH]C(9375)'],
