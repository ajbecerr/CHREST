...
species(
    label = 'C[C]OO[CH]C(3480)',
    structure = SMILES('C[C]OO[CH]C'),
    E0 = (424.739,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,315.88,316.022],'cm^-1')),
        HinderedRotor(inertia=(0.122579,'amu*angstrom^2'), symmetry=1, barrier=(8.68628,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122584,'amu*angstrom^2'), symmetry=1, barrier=(8.68207,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.5552,'amu*angstrom^2'), symmetry=1, barrier=(39.4972,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.277608,'amu*angstrom^2'), symmetry=1, barrier=(19.6483,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.557151,'amu*angstrom^2'), symmetry=1, barrier=(39.4934,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22239,0.0662926,-7.24091e-05,4.52593e-08,-1.2003e-11,51179.9,21.6821], Tmin=(100,'K'), Tmax=(893.906,'K')), NASAPolynomial(coeffs=[8.74314,0.0326391,-1.59374e-05,3.14317e-09,-2.24327e-13,49835.4,-13.7577], Tmin=(893.906,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(424.739,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH3(17)', '[CH]OO[CH]C(3479)'],
    products = ['C[CH]OO[CH]C(3208)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C[C]OO[CH]C(3480)'],
    products = ['C[CH]OO[CH]C(3208)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH2][CH]OO[CH]C(3181)'],
    products = ['C[CH]OO[CH]C(3208)'],
    transitionState = 'TS9',
