...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19158,0.0412376,3.44666e-05,-8.32681e-08,3.71707e-11,72334.4,25.5097], Tmin=(100,'K'), Tmax=(947.961,'K')), NASAPolynomial(coeffs=[19.8939,0.0137601,-3.4483e-06,6.3728e-10,-5.30155e-14,66477.4,-75.9094], Tmin=(947.961,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(600.426,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(CCJ2_triplet) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46851,0.0367408,4.12921e-05,-8.2997e-08,3.51068e-11,8090.28,24.2646], Tmin=(100,'K'), Tmax=(960.248,'K')), NASAPolynomial(coeffs=[16.6683,0.0204215,-6.62909e-06,1.24152e-09,-9.43274e-14,3004.43,-59.7313], Tmin=(960.248,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(66.3661,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclobutene)"""),
)

species(
    label = 'C=COC1C=CC1(6219)',
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19381,0.0322631,8.11029e-05,-1.43334e-07,6.12092e-11,5266.77,22.8122], Tmin=(100,'K'), Tmax=(935.559,'K')), NASAPolynomial(coeffs=[24.6207,0.007267,6.64836e-07,-1.37329e-10,-3.77356e-15,-2406.2,-106.229], Tmin=(935.559,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(42.7249,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclobutene)"""),
)
...
species(
    label = '[CH2]CC=CO[C]=C(6418)',
    structure = SMILES('[CH2]CC=CO[C]=C'),
    E0 = (356.133,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,180,180,822.462,822.5],'cm^-1')),
        HinderedRotor(inertia=(0.15103,'amu*angstrom^2'), symmetry=1, barrier=(3.47249,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.670363,'amu*angstrom^2'), symmetry=1, barrier=(15.413,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0321066,'amu*angstrom^2'), symmetry=1, barrier=(15.4125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.670341,'amu*angstrom^2'), symmetry=1, barrier=(15.4125,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.857959,0.0608358,-4.08762e-05,9.84058e-09,5.89019e-13,42953.1,31.9527], Tmin=(100,'K'), Tmax=(1077.37,'K')), NASAPolynomial(coeffs=[13.8159,0.0256432,-9.86227e-06,1.77774e-09,-1.22308e-13,39411.3,-35.0069], Tmin=(1077.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(356.133,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(C=CJO)"""),
)

species(
    label = 'C=[C]OC1=CCC1(6419)',
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66916,0.0385872,1.42105e-05,-4.41451e-08,1.89548e-11,36911.7,26.6741], Tmin=(100,'K'), Tmax=(996.565,'K')), NASAPolynomial(coeffs=[12.7032,0.0242568,-9.31139e-06,1.75486e-09,-1.269e-13,33224.9,-33.9843], Tmin=(996.565,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(306.11,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclobutene) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40533,0.038807,3.55919e-05,-7.64082e-08,3.24902e-11,41008.4,27.1845], Tmin=(100,'K'), Tmax=(966.184,'K')), NASAPolynomial(coeffs=[16.4546,0.0214774,-7.3262e-06,1.38269e-09,-1.04069e-13,36001.1,-55.7651], Tmin=(966.184,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(340.049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(C=CJO)"""),
)

species(
    label = '[CH]=COC1[CH]CC1(6428)',
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1446,0.0348547,7.24139e-05,-1.33316e-07,5.74932e-11,43362.2,25.5439], Tmin=(100,'K'), Tmax=(934.521,'K')), NASAPolynomial(coeffs=[23.9527,0.0085653,1.10469e-07,-5.39015e-11,-8.01764e-15,35984.3,-99.6137], Tmin=(934.521,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(359.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(CCJCO) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40638,0.0261957,9.74263e-05,-1.59842e-07,6.71128e-11,37679.3,26.6976], Tmin=(100,'K'), Tmax=(932.663,'K')), NASAPolynomial(coeffs=[24.2597,0.00713082,1.11586e-06,-2.39827e-10,3.2713e-15,29982.7,-100.371], Tmin=(932.663,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(312.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(CCJCO) + radical(CCJCO)"""),
)

species(
    label = '[CH]=[C]OC1CCC1(6431)',
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.16559,0.0417591,3.71379e-05,-8.53265e-08,3.75338e-11,48146.3,26.1006], Tmin=(100,'K'), Tmax=(951.004,'K')), NASAPolynomial(coeffs=[19.2964,0.0169066,-4.74639e-06,8.7563e-10,-6.93327e-14,42373.2,-72.6813], Tmin=(951.004,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(399.307,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['H2CC(T)(1341)', '[O]C1[CH]CC1(6207)'],
    products = ['C=[C]OC1[CH]CC1(5351)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C=[C]OC1[C]CC1(6415)'],
    products = ['C=[C]OC1[CH]CC1(5351)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C=[C]OC1=CCC1(6419)'],
    products = ['C=[C]OC1[CH]CC1(5351)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'C=[C]OC1C=CC1(6420)'],
    products = ['C=[C]OC1[CH]CC1(5351)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'C#COC1[CH]CC1(6421)'],
    products = ['C=[C]OC1[CH]CC1(5351)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', 'C=[C]O[C]1[CH]CC1(6422)'],
    products = ['C=[C]OC1[CH]CC1(5351)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C=[C]OC1[CH]C[CH]1(6423)'],
    products = ['C=[C]OC1[CH]CC1(5351)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'C=[C]OC1[CH][CH]C1(6424)'],
    products = ['C=[C]OC1[CH]CC1(5351)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH]=[C]OC1[CH]CC1(6425)'],
    products = ['C=[C]OC1[CH]CC1(5351)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C=[C]OC1[CH]CC1(5351)'],
    products = ['C=COC1[CH]C[CH]1(6430)'],
