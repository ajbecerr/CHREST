...
species(
    label = '[C]1=CC[CH]O1(16792)',
    structure = SMILES('[C]1=CC[CH]O1'),
    E0 = (305.148,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.69532,0.0130788,5.43623e-05,-9.23225e-08,4.09504e-11,36762.6,13.6278], Tmin=(100,'K'), Tmax=(886.014,'K')), NASAPolynomial(coeffs=[14.7647,0.000645386,4.21392e-06,-1.01757e-09,7.16824e-14,32973.2,-52.4545], Tmin=(886.014,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(305.148,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(2,3-Dihydrofuran) + radical(CCsJOC(O)) + radical(C=CJO)"""),
)

species(
    label = '[C]#COC[CH2](16793)',
    structure = SMILES('[C]#COC[CH2]'),
    E0 = (572.552,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2175,525,236.235,236.239,236.309],'cm^-1')),
        HinderedRotor(inertia=(0.610105,'amu*angstrom^2'), symmetry=1, barrier=(24.1633,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.610166,'amu*angstrom^2'), symmetry=1, barrier=(24.1639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.610376,'amu*angstrom^2'), symmetry=1, barrier=(24.1627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20013,0.0546494,-6.50731e-05,3.71846e-08,-7.98786e-12,68968.9,17.5624], Tmin=(100,'K'), Tmax=(1262.77,'K')), NASAPolynomial(coeffs=[15.1548,0.00539996,-5.77071e-07,-3.00697e-11,6.33666e-15,65847,-51.4232], Tmin=(1262.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(572.552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CJCO) + radical(Acetyl)"""),
)

species(
    label = '[C]#CO[CH]C(16794)',
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.07921,'amu*angstrom^2'), symmetry=1, barrier=(24.8131,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07867,'amu*angstrom^2'), symmetry=1, barrier=(24.8008,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.908975,0.0581872,-7.06387e-05,3.99662e-08,-8.34075e-12,65237.4,17.4171], Tmin=(100,'K'), Tmax=(1351.58,'K')), NASAPolynomial(coeffs=[16.7671,0.00231324,1.29485e-06,-4.09917e-10,3.29768e-14,61767.5,-60.8451], Tmin=(1351.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(541.419,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCsJOCs) + radical(Acetyl)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.42277,'amu*angstrom^2'), symmetry=1, barrier=(32.7124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.42796,'amu*angstrom^2'), symmetry=1, barrier=(32.8316,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (67.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53111,0.0435354,-4.5171e-05,2.21033e-08,-4.03868e-12,51362.5,17.7681], Tmin=(100,'K'), Tmax=(1523.99,'K')), NASAPolynomial(coeffs=[14.4018,0.00389657,-3.90984e-07,-7.64499e-12,2.18464e-15,48119.8,-47.5165], Tmin=(1523.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(426.236,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Cds_P)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.42192,'amu*angstrom^2'), symmetry=1, barrier=(32.6928,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.42079,'amu*angstrom^2'), symmetry=1, barrier=(32.6667,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (67.066,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81766,0.0414357,-4.42058e-05,2.33975e-08,-4.70962e-12,62178.8,17.0706], Tmin=(100,'K'), Tmax=(1343.27,'K')), NASAPolynomial(coeffs=[12.2231,0.00679855,-1.44941e-06,1.53611e-10,-6.96465e-15,59712.8,-34.9738], Tmin=(1343.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(516.284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Acetyl)"""),
)

species(
    label = 'C#C[O+]=[C-]C(16796)',
    structure = SMILES('C#C[O+]=[C-]C'),
    E0 = (475.73,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,242.324,242.372,242.389,242.448],'cm^-1')),
        HinderedRotor(inertia=(1.34855,'amu*angstrom^2'), symmetry=1, barrier=(56.2256,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.34893,'amu*angstrom^2'), symmetry=1, barrier=(56.2258,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.00906,0.0525669,-9.05567e-05,8.77897e-08,-3.1799e-11,57280.5,25.6089], Tmin=(100,'K'), Tmax=(889.684,'K')), NASAPolynomial(coeffs=[2.72282,0.0278743,-1.2704e-05,2.31069e-09,-1.52741e-13,58003.7,27.0273], Tmin=(889.684,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(475.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH) + group(Ct-CtCs) + group(Ct-CtH)"""),
)

species(
    label = '[CH]COC#C(16797)',
    structure = SMILES('[CH]COC#C'),
    E0 = (474.919,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2175,525,750,770,3400,2100,359.349,359.374,359.399,359.402,359.576],'cm^-1')),
        HinderedRotor(inertia=(0.00130565,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.25465,'amu*angstrom^2'), symmetry=1, barrier=(23.3842,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.255105,'amu*angstrom^2'), symmetry=1, barrier=(23.3876,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36023,0.0517569,-5.73676e-05,3.04664e-08,-6.18941e-12,57220,15.7582], Tmin=(100,'K'), Tmax=(1219.76,'K')), NASAPolynomial(coeffs=[14.9982,0.00703123,-2.36352e-06,4.02182e-10,-2.71973e-14,53893.2,-52.7459], Tmin=(1219.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(474.919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(CsJ2_singlet-CsH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.790415,'amu*angstrom^2'), symmetry=1, barrier=(18.1732,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05046,0.0451438,-5.49928e-05,3.73112e-08,-1.03229e-11,42857.5,16.5933], Tmin=(100,'K'), Tmax=(876.175,'K')), NASAPolynomial(coeffs=[8.07218,0.0176522,-7.92635e-06,1.49828e-09,-1.04152e-13,41802.3,-11.6619], Tmin=(876.175,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(355.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]1=CC[CH]O1(16792)'],
    products = ['C#COC=C(3099)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['HC2(2881)', 'vinoxy(1351)'],
    products = ['C#COC=C(3099)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(106477,'m^3/(mol*s)'), n=0.348287, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.0108230153501, var=2.70964383578, Tref=1000.0, N=19, correlation='Root_N-1R->H_N-1CNOS->N_1COS->O_Ext-1O-R_Ext-2R-R',), comment="""BM rule fitted to 2 training reactions at node Root_N-1R->H_N-1CNOS->N_1COS->O_Ext-1O-R_Ext-2R-R
    Total Standard Deviation in ln(k): 3.32718707999
