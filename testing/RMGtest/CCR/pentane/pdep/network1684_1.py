...
species(
    label = '[CH][CH]OO[CH](7335)',
    structure = SMILES('[CH][CH]OO[CH]'),
    E0 = (910.502,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.6598,0.0564983,-9.22276e-05,8.04728e-08,-2.7894e-11,109588,20.3647], Tmin=(100,'K'), Tmax=(786.844,'K')), NASAPolynomial(coeffs=[7.97374,0.018905,-1.00848e-05,1.99924e-09,-1.40661e-13,108764,-7.50181], Tmin=(786.844,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(910.502,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(166.289,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCsJOOC) + radical(CCJ2_triplet) + radical(CH2_triplet)"""),
)
...
species(
    label = '[CH][CH]OO[C]C(7336)',
    structure = SMILES('[CH][CH]OO[C]C'),
    E0 = (872.955,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00051,0.0714448,-9.97473e-05,7.58748e-08,-2.34504e-11,105095,23.4758], Tmin=(100,'K'), Tmax=(787.174,'K')), NASAPolynomial(coeffs=[9.93301,0.0260546,-1.32541e-05,2.62274e-09,-1.86213e-13,103689,-17.4807], Tmin=(787.174,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(872.955,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CH2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C]OO[CH]C(7337)',
...
species(
    label = '[CH][CH]OO[CH][CH2](1957)',
    structure = SMILES('[CH][CH]OO[CH][CH2]'),
    E0 = (812.369,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0022,0.0720657,-0.000109885,9.43908e-08,-3.25616e-11,97807.5,27.0157], Tmin=(100,'K'), Tmax=(799.581,'K')), NASAPolynomial(coeffs=[8.15348,0.0286868,-1.42429e-05,2.75395e-09,-1.91489e-13,96907,-4.36562], Tmin=(799.581,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(812.369,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(236.962,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CJCOOH) + radical(CCsJOOC) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]OOC[CH2](7338)',
    structure = SMILES('[CH][CH]OOC[CH2]'),
    E0 = (625.929,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11082,0.0686808,-8.9512e-05,6.77269e-08,-2.13047e-11,75381.2,26.3417], Tmin=(100,'K'), Tmax=(768.29,'K')), NASAPolynomial(coeffs=[8.46391,0.0303988,-1.47724e-05,2.87481e-09,-2.02474e-13,74251.3,-7.19475], Tmin=(768.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(625.929,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH) + radical(CCsJOOC) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]COO[CH][CH2](7339)',
    structure = SMILES('[CH]COO[CH][CH2]'),
    E0 = (625.929,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11082,0.0686808,-8.9512e-05,6.77269e-08,-2.13047e-11,75381.2,26.3417], Tmin=(100,'K'), Tmax=(768.29,'K')), NASAPolynomial(coeffs=[8.46391,0.0303988,-1.47724e-05,2.87481e-09,-2.02474e-13,74251.3,-7.19475], Tmin=(768.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(625.929,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CJCOOH) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH][CH]O[O](6930)', 'CHCH3(T)(21)'],
    products = ['[CH][CH]OO[CH]C(3442)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH][CH](6981)', 'C[CH]O[O](57)'],
    products = ['[CH][CH]OO[CH]C(3442)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', '[CH][CH]OO[CH](7335)'],
    products = ['[CH][CH]OO[CH]C(3442)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH][CH]OO[C]C(7336)'],
    products = ['[CH][CH]OO[CH]C(3442)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH][C]OO[CH]C(7337)'],
    products = ['[CH][CH]OO[CH]C(3442)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH]=COO[CH][CH2](2804)'],
    products = ['[CH][CH]OO[CH]C(3442)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH][CH]OO[CH][CH2](1957)'],
    products = ['[CH][CH]OO[CH]C(3442)'],
