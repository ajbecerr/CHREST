...
species(
    label = '[CH2][CH][C]CC[CH2](9027)',
    structure = SMILES('[CH2][CH][C]CC[CH2]'),
    E0 = (861.29,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2][C][CH]CC[CH2](9028)',
    structure = SMILES('[CH2][C][CH]CC[CH2]'),
    E0 = (861.302,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,279.234,853.274,1280.45,1684.72],'cm^-1')),
        HinderedRotor(inertia=(0.0797866,'amu*angstrom^2'), symmetry=1, barrier=(3.57589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0797866,'amu*angstrom^2'), symmetry=1, barrier=(3.57589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0797866,'amu*angstrom^2'), symmetry=1, barrier=(3.57589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0797866,'amu*angstrom^2'), symmetry=1, barrier=(3.57589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0797866,'amu*angstrom^2'), symmetry=1, barrier=(3.57589,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40278,0.0617188,-6.78019e-05,5.40615e-08,-1.92531e-11,103680,29.461], Tmin=(100,'K'), Tmax=(767.131,'K')), NASAPolynomial(coeffs=[4.47198,0.0411344,-1.85951e-05,3.51456e-09,-2.43595e-13,103344,16.3461], Tmin=(767.131,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(861.302,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJ) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][CH][CH]CC[CH2](9030)',
    structure = SMILES('[CH][CH][CH]CC[CH2]'),
    E0 = (850.502,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,180.336,996.628,1017.97,2460.18,2622.71,3804.05],'cm^-1')),
        HinderedRotor(inertia=(0.129332,'amu*angstrom^2'), symmetry=1, barrier=(2.98256,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][CH][CH][CH]C[CH2](9031)',
    structure = SMILES('[CH2][CH][CH][CH]C[CH2]'),
    E0 = (801.991,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1357.39,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00843575,'amu*angstrom^2'), symmetry=1, barrier=(4.50771,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00843575,'amu*angstrom^2'), symmetry=1, barrier=(4.50771,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00843575,'amu*angstrom^2'), symmetry=1, barrier=(4.50771,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00843575,'amu*angstrom^2'), symmetry=1, barrier=(4.50771,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00843575,'amu*angstrom^2'), symmetry=1, barrier=(4.50771,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86842,0.0598776,-9.38361e-05,1.02263e-07,-4.13979e-11,96521.5,33.1786], Tmin=(100,'K'), Tmax=(863.054,'K')), NASAPolynomial(coeffs=[-3.72676,0.0529135,-2.45585e-05,4.58559e-09,-3.10781e-13,98712.4,66.4458], Tmin=(863.054,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(801.991,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC) + radical(RCCJC) + radical(RCCJ) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH][CH][CH]CC(9032)',
    structure = SMILES('[CH2][CH][CH][CH]CC'),
    E0 = (596.745,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83997,0.0590422,-8.30485e-05,8.9635e-08,-3.68446e-11,71838.4,31.4942], Tmin=(100,'K'), Tmax=(854.116,'K')), NASAPolynomial(coeffs=[-3.57389,0.0553013,-2.5382e-05,4.74143e-09,-3.22501e-13,73824.5,62.9719], Tmin=(854.116,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(596.745,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C[CH][CH]C[CH2](9033)',
    structure = SMILES('[CH2]C[CH][CH]C[CH2]'),
    E0 = (607.545,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1018.04,3690.92,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0142567,'amu*angstrom^2'), symmetry=1, barrier=(7.60235,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0142567,'amu*angstrom^2'), symmetry=1, barrier=(7.60235,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0142567,'amu*angstrom^2'), symmetry=1, barrier=(7.60235,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0142567,'amu*angstrom^2'), symmetry=1, barrier=(7.60235,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0142567,'amu*angstrom^2'), symmetry=1, barrier=(7.60235,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66613,0.0597071,-7.4509e-05,7.38787e-08,-2.97688e-11,73146.6,30.4765], Tmin=(100,'K'), Tmax=(830.754,'K')), NASAPolynomial(coeffs=[-0.600125,0.0509958,-2.33488e-05,4.39049e-09,-3.012e-13,74200.3,45.0652], Tmin=(830.754,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(607.545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC) + radical(RCCJ) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][CH][CH]CC[CH2](655)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH][CH][CH2](5537)', '[CH2]C[CH2](29)'],
    products = ['[CH2][CH][CH]CC[CH2](655)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2][CH][C]CC[CH2](9027)'],
    products = ['[CH2][CH][CH]CC[CH2](655)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH2][C][CH]CC[CH2](9028)'],
    products = ['[CH2][CH][CH]CC[CH2](655)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]CC[CH][CH][CH2](9029)'],
    products = ['[CH2][CH][CH]CC[CH2](655)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH][CH][CH]CC[CH2](9030)'],
    products = ['[CH2][CH][CH]CC[CH2](655)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2][CH][CH][CH]C[CH2](9031)'],
    products = ['[CH2][CH][CH]CC[CH2](655)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C[CH][CH]C[CH2](9033)'],
    products = ['[CH2][CH][CH]CC[CH2](655)'],
    transitionState = 'TS23',
    kinetics = Arrhenius(A=(1.73469e+06,'s^-1'), n=1.96939, Ea=(174.054,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R3Hall;C_rad_out_H/NonDeC;XH_out] for rate rule [R3HJ;C_rad_out_H/NonDeC;XH_out]
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2][CH][CH]CC[CH2](655)'],
    products = ['[CH2]C[CH][CH][CH]C(3880)'],
