...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', '[CH]CC[CH][CH2](504)'],
    products = ['[CH2][CH]CC[CH]C(161)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH2][CH]CC[C]C(549)'],
    products = ['[CH2][CH]CC[CH]C(161)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH2][C]CC[CH]C(550)'],
    products = ['[CH2][CH]CC[CH]C(161)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH][CH]CC[CH]C(551)'],
    products = ['[CH2][CH]CC[CH]C(161)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]C=CC[CH]C(554)'],
    products = ['[CH2][CH]CC[CH]C(161)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2][CH]CCC=C(487)'],
    products = ['[CH2][CH]CC[CH]C(161)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2][CH][CH]C[CH]C(556)'],
    products = ['[CH2][CH]CC[CH]C(161)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH2][CH]CC[CH][CH2](483)'],
    products = ['[CH2][CH]CC[CH]C(161)'],
