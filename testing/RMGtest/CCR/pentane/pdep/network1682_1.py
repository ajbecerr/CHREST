...
species(
    ...
    E0 = (586.019,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH][CH]OC[O](7346)'],
    products = ['[CH][CH]OC(C)[O](3446)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH][CH](6981)', 'CC([O])[O](3177)'],
    products = ['[CH][CH]OC(C)[O](3446)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH][C]OC(C)[O](7347)'],
    products = ['[CH][CH]OC(C)[O](3446)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]=CO[C](C)[O](2827)'],
    products = ['[CH][CH]OC(C)[O](3446)'],
    transitionState = 'TS8',
...
reaction(
    ...
    products = ['[CH][CH]OC(C)[O](3446)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.41198,'m^3/(mol*s)'), n=2.03228, Ea=(73.7298,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(17)', '[CH][CH]OC=O(6946)'],
    products = ['[CH][CH]OC(C)[O](3446)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(17)', '[CH][CH]O[CH][O](7306)'],
    products = ['[CH][CH]OC(C)[O](3446)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH][CH]O[C](C)[O](7312)'],
    products = ['[CH][CH]OC(C)[O](3446)'],
