...
species(
    label = '[CH][CH]OO[C][CH2](7299)',
    structure = SMILES('[CH][CH]OO[C][CH2]'),
    E0 = (1086.92,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.940244,0.0738999,-0.000110655,8.26284e-08,-2.28776e-11,130830,25.698], Tmin=(100,'K'), Tmax=(652.123,'K')), NASAPolynomial(coeffs=[10.9058,0.0217543,-1.13685e-05,2.24665e-09,-1.58364e-13,129339,-19.5836], Tmin=(652.123,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1086.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(212.019,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CJCOOH) + radical(CH2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]OO[CH][CH](6978)',
    structure = SMILES('[CH][CH]OO[CH][CH]'),
    E0 = (1046.62,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3050,390,425,1340,1360,335,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00648,0.0725139,-0.000116675,1.0209e-07,-3.53174e-11,125981,26.0085], Tmin=(100,'K'), Tmax=(814.196,'K')), NASAPolynomial(coeffs=[8.37933,0.0263831,-1.34316e-05,2.60597e-09,-1.80893e-13,125109,-6.02867], Tmin=(814.196,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1046.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(212.019,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOC) + radical(CCsJOOC) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C]OO[CH][CH2](7300)',
...
reaction(
    label = 'reaction1',
    reactants = ['[CH][CH]OO[CH][CH2](1957)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH][CH]O[O](6930)', '[CH][CH2](502)'],
    products = ['[CH][CH]OO[CH][CH2](1957)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH][CH](6981)', '[CH2][CH]O[O](674)'],
    products = ['[CH][CH]OO[CH][CH2](1957)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH][CH]OO[C][CH2](7299)'],
    products = ['[CH][CH]OO[CH][CH2](1957)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH][CH]OO[CH][CH](6978)'],
    products = ['[CH][CH]OO[CH][CH2](1957)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH][C]OO[CH][CH2](7300)'],
    products = ['[CH][CH]OO[CH][CH2](1957)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
