...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.734022,0.0730277,-5.53513e-05,2.52195e-08,-5.09533e-12,75455.6,32.2057], Tmin=(100,'K'), Tmax=(1123.12,'K')), NASAPolynomial(coeffs=[8.47812,0.0454469,-1.8515e-05,3.35397e-09,-2.28146e-13,73716.1,-6.05426], Tmin=(1123.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(626.405,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2]C(C)C[CH][C]C(3929)',
...
species(
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.976007,0.0671194,-3.69507e-05,1.00451e-08,-1.13151e-12,11089,28.8976], Tmin=(100,'K'), Tmax=(1881.37,'K')), NASAPolynomial(coeffs=[12.6541,0.0422906,-1.71551e-05,3.0305e-09,-1.99402e-13,6694.82,-34.8229], Tmin=(1881.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(91.309,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJC)"""),
)

species(
    label = 'C[CH]C=CC(C)C(3933)',
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.72283,0.0599598,-6.06365e-06,-2.56366e-08,1.15857e-11,3972.54,26.0611], Tmin=(100,'K'), Tmax=(1074.13,'K')), NASAPolynomial(coeffs=[12.1705,0.0426192,-1.71645e-05,3.17263e-09,-2.21187e-13,54.3404,-36.7773], Tmin=(1074.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(31.9633,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S)"""),
)
...
species(
    label = 'C[CH][CH]C[C](C)C(3940)',
    structure = SMILES('C[CH][CH]C[C](C)C'),
    E0 = (352.988,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.99526,0.0776164,-9.98769e-05,1.00187e-07,-4.02568e-11,42551.7,32.5815], Tmin=(100,'K'), Tmax=(837.972,'K')), NASAPolynomial(coeffs=[-2.36566,0.0661892,-3.02487e-05,5.67237e-09,-3.88066e-13,44079.4,53.9567], Tmin=(837.972,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(352.988,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(RCCJCC) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH][CH][CH]C(C)C(3941)',
    structure = SMILES('C[CH][CH][CH]C(C)C'),
    E0 = (362.108,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21982,0.0564483,-2.25569e-05,2.99999e-09,-1.76001e-14,43598.6,29.5485], Tmin=(100,'K'), Tmax=(2390.7,'K')), NASAPolynomial(coeffs=[28.4015,0.0246855,-1.01841e-05,1.65684e-09,-9.74909e-14,27638.5,-126.78], Tmin=(2390.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(362.108,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(RCCJC) + radical(RCCJCC)"""),
)

species(
    label = '[CH2][C](C)CC[CH]C(3942)',
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.737733,0.0790285,-8.8815e-05,7.63911e-08,-2.81208e-11,43842.9,33.4199], Tmin=(100,'K'), Tmax=(832.956,'K')), NASAPolynomial(coeffs=[2.03973,0.0582706,-2.53121e-05,4.65895e-09,-3.16486e-13,44129.2,30.3971], Tmin=(832.956,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(363.612,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(RCCJC) + radical(Isobutyl)"""),
)
...
species(
    ...
    E0 = (383.272,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,288.979,970.344,2135.76],'cm^-1')),
        HinderedRotor(inertia=(0.0684834,'amu*angstrom^2'), symmetry=1, barrier=(3.28726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0684834,'amu*angstrom^2'), symmetry=1, barrier=(3.28726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0684834,'amu*angstrom^2'), symmetry=1, barrier=(3.28726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0684834,'amu*angstrom^2'), symmetry=1, barrier=(3.28726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0684834,'amu*angstrom^2'), symmetry=1, barrier=(3.28726,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][CH][CH]CC(C)C(3943)',
    structure = SMILES('[CH2][CH][CH]CC(C)C'),
    E0 = (372.812,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,477.712,3046.35,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0360745,'amu*angstrom^2'), symmetry=1, barrier=(5.01942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0360745,'amu*angstrom^2'), symmetry=1, barrier=(5.01942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0360745,'amu*angstrom^2'), symmetry=1, barrier=(5.01942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0360745,'amu*angstrom^2'), symmetry=1, barrier=(5.01942,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0360745,'amu*angstrom^2'), symmetry=1, barrier=(5.01942,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99089,0.0596521,-2.71912e-05,5.38279e-09,-4.01629e-13,44894.4,29.5681], Tmin=(100,'K'), Tmax=(3498.78,'K')), NASAPolynomial(coeffs=[22.5089,0.0290429,-1.10022e-05,1.71386e-09,-9.77262e-14,34914.3,-88.8606], Tmin=(3498.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(372.812,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', '[CH2]CC[CH][CH]C(246)'],
...
reaction(
    label = 'reaction8',
    reactants = ['[CH][CH]C(3874)', '[CH2]C([CH2])C(102)'],
    products = ['[CH2]C(C)C[CH][CH]C(286)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(17)', '[CH][CH]CC([CH2])C(527)'],
    products = ['[CH2]C(C)C[CH][CH]C(286)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH2]C(C)C[C][CH]C(3928)'],
    products = ['[CH2]C(C)C[CH][CH]C(286)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2]C(C)C[CH][C]C(3929)'],
    products = ['[CH2]C(C)C[CH][CH]C(286)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]C(C)C[CH][CH]C(3930)'],
    products = ['[CH2]C(C)C[CH][CH]C(286)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', 'C=C(C)C[CH][CH]C(3934)'],
    products = ['[CH2]C(C)C[CH][CH]C(286)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2]C(C)C=C[CH]C(3935)'],
    products = ['[CH2]C(C)C[CH][CH]C(286)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2]C(C)C[CH]C=C(3936)'],
    products = ['[CH2]C(C)C[CH][CH]C(286)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH2][C](C)C[CH][CH]C(3937)'],
    products = ['[CH2]C(C)C[CH][CH]C(286)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2]C(C)[CH][CH][CH]C(3938)'],
    products = ['[CH2]C(C)C[CH][CH]C(286)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH2][CH][CH]CC([CH2])C(3939)'],
    products = ['[CH2]C(C)C[CH][CH]C(286)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(C)[CH]C[CH]C(3899)'],
    products = ['[CH2]C(C)C[CH][CH]C(286)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C[CH]CC([CH2])C(288)'],
    products = ['[CH2]C(C)C[CH][CH]C(286)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C(C)C[CH][CH]C(286)'],
    products = ['C[CH][CH][CH]C(C)C(3941)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C(C)[CH][CH]CC(285)'],
    products = ['[CH2]C(C)C[CH][CH]C(286)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]C([CH2])CC[CH]C(609)'],
    products = ['[CH2]C(C)C[CH][CH]C(286)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH2][CH][CH]CC(C)C(3943)'],
    products = ['[CH2]C(C)C[CH][CH]C(286)'],
