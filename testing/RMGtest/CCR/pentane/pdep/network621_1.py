...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.02165,'amu*angstrom^2'), symmetry=1, barrier=(23.4898,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02266,'amu*angstrom^2'), symmetry=1, barrier=(23.513,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.02468,'amu*angstrom^2'), symmetry=1, barrier=(23.5594,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17436,0.0514531,-5.18096e-05,2.57726e-08,-4.85723e-12,43524.7,17.0282], Tmin=(100,'K'), Tmax=(1459.3,'K')), NASAPolynomial(coeffs=[14.7562,0.00846089,-1.6936e-06,1.71031e-10,-7.60938e-15,40174.5,-51.5267], Tmin=(1459.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(360.963,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.668845,'amu*angstrom^2'), symmetry=1, barrier=(15.3781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.668985,'amu*angstrom^2'), symmetry=1, barrier=(15.3813,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.669127,'amu*angstrom^2'), symmetry=1, barrier=(15.3845,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'C#COC(3065)'],
    products = ['C#COCC(2243)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', 'C#CO[CH2](3066)'],
    products = ['C#COCC(2243)'],
    transitionState = 'TS5',
