...
os.remove('FULL_pentane_'+tag+'.yaml')
os.remove('outputs/IgnitionDelayTimeTthreshold_'+tag+'.dat')
os.remove('outputs/IgnitionDelayTime_'+tag+'.dat')
os.remove('outputs/IgnSolution_'+tag+'.dat')
