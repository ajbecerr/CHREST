...
species(
    label = '[C]=CCC=C[CH](15313)',
    structure = SMILES('[C]=CCC=C[CH]'),
    E0 = (981.511,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,367.173,367.19,367.19,367.212,367.235],'cm^-1')),
        HinderedRotor(inertia=(0.536047,'amu*angstrom^2'), symmetry=1, barrier=(51.3025,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.536111,'amu*angstrom^2'), symmetry=1, barrier=(51.3027,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.536002,'amu*angstrom^2'), symmetry=1, barrier=(51.3023,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (78.1118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59557,0.049321,-3.06051e-05,9.46345e-09,-1.20538e-12,118138,24.7524], Tmin=(100,'K'), Tmax=(1748.15,'K')), NASAPolynomial(coeffs=[11.664,0.0262832,-1.08374e-05,1.92493e-09,-1.27313e-13,114617,-29.4456], Tmin=(1748.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(981.511,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(CdCdJ2_triplet)"""),
)
...
species(
    label = '[CH]C[CH]C[C]=[CH](15316)',
    structure = SMILES('[CH]C[CH]C[C]=[CH]'),
    E0 = (1063.53,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,202.056,821.589,1082.93,1429.63,1669.5],'cm^-1')),
        HinderedRotor(inertia=(0.142296,'amu*angstrom^2'), symmetry=1, barrier=(3.3951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142296,'amu*angstrom^2'), symmetry=1, barrier=(3.3951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142296,'amu*angstrom^2'), symmetry=1, barrier=(3.3951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142296,'amu*angstrom^2'), symmetry=1, barrier=(3.3951,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45824,0.061466,-8.19829e-05,7.09359e-08,-2.52878e-11,127999,28.1354], Tmin=(100,'K'), Tmax=(818.392,'K')), NASAPolynomial(coeffs=[4.93804,0.0349622,-1.60004e-05,3.00837e-09,-2.06516e-13,127748,13.9876], Tmin=(818.392,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1063.53,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(Cds_S) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[CH]C1[CH]CC=C1(15317)',
    structure = SMILES('[CH]C1[CH]CC=C1'),
    E0 = (625.462,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.4003,0.0192598,5.84287e-05,-8.59216e-08,3.30215e-11,75297.5,21.0646], Tmin=(100,'K'), Tmax=(976.109,'K')), NASAPolynomial(coeffs=[11.2476,0.0228908,-8.44487e-06,1.61466e-09,-1.19978e-13,71670.2,-31.1379], Tmin=(976.109,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(625.462,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopentene) + radical(cyclopentene-4) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C=C[CH]C=[CH](15318)',
    structure = SMILES('[CH]C=CC=C[CH]'),
    E0 = (763.239,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (78.1118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34047,0.0484905,-4.85822e-06,-2.46851e-08,1.20586e-11,91901,22.6778], Tmin=(100,'K'), Tmax=(1001.87,'K')), NASAPolynomial(coeffs=[11.2381,0.0311297,-1.20375e-05,2.16544e-09,-1.49493e-13,88805.8,-30.6404], Tmin=(1001.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(763.239,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + radical(AllylJ2_triplet) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=[C]CC=[CH](15319)',
...
species(
    label = '[C]=C[CH]CC=[CH](15323)',
    structure = SMILES('[C]C=CCC=[CH]'),
    E0 = (969.298,'kJ/mol'),
    modes = [
        ...
        HinderedRotor(inertia=(0.752389,'amu*angstrom^2'), symmetry=1, barrier=(17.2989,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.75173,'amu*angstrom^2'), symmetry=1, barrier=(17.2838,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (78.1118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40951,0.0498661,-3.52683e-05,9.24162e-09,2.05296e-13,116679,22.7865], Tmin=(100,'K'), Tmax=(1088.22,'K')), NASAPolynomial(coeffs=[12.8274,0.0187763,-7.41004e-06,1.36176e-09,-9.49069e-14,113550,-36.2231], Tmin=(1088.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(969.298,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(CJ3)"""),
)

species(
    label = '[CH]=CCC1C=C1(15324)',
    structure = SMILES('[CH]=CCC1C=C1'),
    E0 = (568.399,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4428,0.0488708,-2.78242e-05,2.62534e-09,2.1145e-12,68461,20.1949], Tmin=(100,'K'), Tmax=(1081.99,'K')), NASAPolynomial(coeffs=[11.8544,0.0228253,-8.96917e-06,1.63804e-09,-1.13535e-13,65479.5,-34.2217], Tmin=(1081.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(568.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=CC=CC=[CH](15325)',
    structure = SMILES('[CH]=CC=CC=[CH]'),
    E0 = (639.885,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,3115,3125,620,680,785,800,1600,1700],'cm^-1')),
        HinderedRotor(inertia=(1.12682,'amu*angstrom^2'), symmetry=1, barrier=(25.9077,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction2',
    reactants = ['H(3)', '[C]=CCC=C[CH](15313)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH][CH]C[CH]C=[CH](15314)'],
    products = ['[CH]=C[CH]CC=[CH](15075)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]C[CH]C[C]=[CH](15316)'],
    products = ['[CH]=C[CH]CC=[CH](15075)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]=C[CH]CC=[CH](15075)'],
    products = ['[CH]=CC1[CH][CH]C1(15234)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]C=CCC#C(14997)'],
    products = ['[CH]=C[CH]CC=[CH](15075)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]C=[CH](13797)', '[CH]C=C(3739)'],
    products = ['[CH]=C[CH]CC=[CH](15075)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]C=C[CH]C=[CH](15318)'],
    products = ['[CH]=C[CH]CC=[CH](15075)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH]C=[C]CC=[CH](15319)'],
    products = ['[CH]=C[CH]CC=[CH](15075)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH]C=CC[C]=[CH](14989)'],
    products = ['[CH]=C[CH]CC=[CH](15075)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH][C]=CCC=[CH](15320)'],
    products = ['[CH]=C[CH]CC=[CH](15075)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=C[CH]CC=[CH](15075)'],
    products = ['[CH]=C[CH]C=C[CH2](15158)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C2H2(T)(1343)', '[CH]CC=[CH](15079)'],
    products = ['[CH]=C[CH]CC=[CH](15075)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[C]=C[CH]CC=[CH](15323)'],
    products = ['[CH]=C[CH]CC=[CH](15075)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH]=CC=CC=[CH](15325)'],
    products = ['[CH]=C[CH]CC=[CH](15075)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', '[CH]=C=CCC=[CH](15326)'],
    products = ['[CH]=C[CH]CC=[CH](15075)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C2H2(1342)', '[CH]CC=[CH](15079)'],
    products = ['[CH]=C[CH]CC=[CH](15075)'],
