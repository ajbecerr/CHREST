...
species(
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57848,0.0574742,-5.19365e-05,3.83955e-08,-1.40415e-11,42195.4,23.9003], Tmin=(100,'K'), Tmax=(729.006,'K')), NASAPolynomial(coeffs=[3.28816,0.0451029,-2.03282e-05,3.86317e-09,-2.69581e-13,42025.6,16.7375], Tmin=(729.006,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(350.141,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Tertalkyl) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]=[C]CC(C)C(15627)',
    structure = SMILES('[CH]=[C]CC(C)C'),
    E0 = (411.814,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1685,370,3120,650,792.5,1650,296.096],'cm^-1')),
        HinderedRotor(inertia=(0.182462,'amu*angstrom^2'), symmetry=1, barrier=(11.3518,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00192283,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182463,'amu*angstrom^2'), symmetry=1, barrier=(11.3518,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182459,'amu*angstrom^2'), symmetry=1, barrier=(11.3518,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.972727,0.0586182,-3.81083e-05,1.27193e-08,-1.73566e-12,49645.3,25.3544], Tmin=(100,'K'), Tmax=(1683.71,'K')), NASAPolynomial(coeffs=[13.9542,0.0277781,-1.06333e-05,1.84059e-09,-1.20383e-13,45273.9,-44.0371], Tmin=(1683.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(411.814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]CC[C]=C(15467)'],
    products = ['[CH2]C(C)C[C]=C(15471)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H2CC(T)(1341)', '[CH2]C([CH2])C(102)'],
    products = ['[CH2]C(C)C[C]=C(15471)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]C(C)C[C]=C(15617)'],
    products = ['[CH2]C(C)C[C]=C(15471)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'C=[C]CC(=C)C(15620)'],
    products = ['[CH2]C(C)C[C]=C(15471)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2]C(C)C=C=C(15621)'],
    products = ['[CH2]C(C)C[C]=C(15471)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C#CCC([CH2])C(15489)'],
    products = ['[CH2]C(C)C[C]=C(15471)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(17)', 'C=[C]CC=C(15500)'],
    products = ['[CH2]C(C)C[C]=C(15471)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(17)', '[CH2][CH]C[C]=C(2629)'],
    products = ['[CH2]C(C)C[C]=C(15471)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH2][C](C)C[C]=C(15622)'],
    products = ['[CH2]C(C)C[C]=C(15471)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH2]C(C)[CH][C]=C(15623)'],
    products = ['[CH2]C(C)C[C]=C(15471)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2]C([CH2])C[C]=C(15486)'],
    products = ['[CH2]C(C)C[C]=C(15471)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH]=[C]CC([CH2])C(15624)'],
    products = ['[CH2]C(C)C[C]=C(15471)'],
