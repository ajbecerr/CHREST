...
species(
    label = '[CH2]CO[C]=C(2240)',
    structure = SMILES('[CH2]CO[C]=C'),
    E0 = (265.826,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,408.513,408.513,408.514],'cm^-1')),
        HinderedRotor(inertia=(0.136999,'amu*angstrom^2'), symmetry=1, barrier=(16.2241,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136999,'amu*angstrom^2'), symmetry=1, barrier=(16.224,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136999,'amu*angstrom^2'), symmetry=1, barrier=(16.224,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'C=[C]OC(=C)C(2402)',
    structure = SMILES('C=[C]OC(=C)C'),
    E0 = (167.766,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,350.031,350.064,350.512],'cm^-1')),
        HinderedRotor(inertia=(0.00137572,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112189,'amu*angstrom^2'), symmetry=1, barrier=(9.7737,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112136,'amu*angstrom^2'), symmetry=1, barrier=(9.77026,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82767,0.0474585,-3.31132e-05,1.23019e-08,-1.93997e-12,20255.8,23.9663], Tmin=(100,'K'), Tmax=(1420.36,'K')), NASAPolynomial(coeffs=[9.14088,0.0268634,-1.13638e-05,2.09364e-09,-1.43224e-13,18178.3,-13.8821], Tmin=(1420.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(167.766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.879422,'amu*angstrom^2'), symmetry=1, barrier=(20.2196,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.875339,'amu*angstrom^2'), symmetry=1, barrier=(20.1258,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.875461,'amu*angstrom^2'), symmetry=1, barrier=(20.1286,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.876219,'amu*angstrom^2'), symmetry=1, barrier=(20.146,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.459568,0.0773263,-7.70733e-05,3.69494e-08,-6.62298e-12,28523.7,26.7608], Tmin=(100,'K'), Tmax=(1570.7,'K')), NASAPolynomial(coeffs=[21.6232,0.00947567,-1.18573e-06,3.23078e-11,2.18379e-15,23019.2,-85.1863], Tmin=(1570.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.676,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]OC(C)C(2407)',
    structure = SMILES('[CH]=[C]OC(C)C'),
    E0 = (264.91,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1685,370,3120,650,792.5,1650,317.28,319.873],'cm^-1')),
        HinderedRotor(inertia=(0.222483,'amu*angstrom^2'), symmetry=1, barrier=(16.0654,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224589,'amu*angstrom^2'), symmetry=1, barrier=(16.0652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.22356,'amu*angstrom^2'), symmetry=1, barrier=(16.0583,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.224616,'amu*angstrom^2'), symmetry=1, barrier=(16.0679,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.946874,0.0565982,-2.74882e-05,-1.04495e-08,9.70798e-12,31980.8,24.3802], Tmin=(100,'K'), Tmax=(965.811,'K')), NASAPolynomial(coeffs=[16.0967,0.018355,-6.14543e-06,1.08484e-09,-7.67805e-14,27911.7,-54.0978], Tmin=(965.811,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(264.91,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]CO[C]=C(2240)'],
    products = ['[CH2]C(C)O[C]=C(2249)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H2CC(T)(1341)', '[CH2]C(C)[O](667)'],
    products = ['[CH2]C(C)O[C]=C(2249)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]C(C)O[C]=C(2399)'],
    products = ['[CH2]C(C)O[C]=C(2249)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(17)', 'C=[C]OC=C(2317)'],
    products = ['[CH2]C(C)O[C]=C(2249)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(17)', '[CH2][CH]O[C]=C(2367)'],
    products = ['[CH2]C(C)O[C]=C(2249)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2][C](C)O[C]=C(2403)'],
    products = ['[CH2]C(C)O[C]=C(2249)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]C([CH2])O[C]=C(2286)'],
    products = ['[CH2]C(C)O[C]=C(2249)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH]=[C]OC([CH2])C(2404)'],
    products = ['[CH2]C(C)O[C]=C(2249)'],
