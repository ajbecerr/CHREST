species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00407642,'amu*angstrom^2'), symmetry=1, barrier=(12.2405,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.70983,'amu*angstrom^2'), symmetry=1, barrier=(39.3123,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.01042,'amu*angstrom^2'), symmetry=1, barrier=(46.2235,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.51938,0.0356378,-3.0968e-05,1.57289e-08,-3.5717e-12,47091.2,19.666], Tmin=(100,'K'), Tmax=(998.12,'K')), NASAPolynomial(coeffs=[5.91957,0.0220114,-1.04899e-05,2.05108e-09,-1.4581e-13,46412.5,3.2684], Tmin=(998.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(391.117,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CsJOOC) + radical(C=CJO)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.26511,'amu*angstrom^2'), symmetry=1, barrier=(29.0873,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26058,'amu*angstrom^2'), symmetry=1, barrier=(28.9833,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.370887,'amu*angstrom^2'), symmetry=1, barrier=(8.52742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.37067,'amu*angstrom^2'), symmetry=1, barrier=(8.52244,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28314,0.0415167,-5.5856e-05,4.8739e-08,-1.78769e-11,53533.2,21.2112], Tmin=(100,'K'), Tmax=(769.44,'K')), NASAPolynomial(coeffs=[4.84158,0.0234686,-1.14162e-05,2.21559e-09,-1.55303e-13,53280,10.452], Tmin=(769.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(444.616,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]O[O](46)', 'H2CC(T)(1341)'],
    products = ['[CH2]OO[C]=C(28838)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(15399.6,'m^3/(mol*s)'), n=0.932885, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    ...
    products = ['[CH2]OO[C]=C(28838)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(6.16957e+06,'m^3/(mol*s)'), n=-1.87134e-07, Ea=(38.3661,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=1.52051667475e-07, var=0.241111252513, Tref=1000.0, N=4, correlation='Root_N-1R->H_N-1CNOS->N_1COS->O_Ext-1O-R_Ext-2R-R_Ext-2R-R_N-4R!H->O',), comment="""BM rule fitted to 2 training reactions at node Root_N-1R->H_N-1CNOS->N_1COS->O_Ext-1O-R_Ext-2R-R_Ext-2R-R_N-4R!H->O
    Total Standard Deviation in ln(k): 0.984387063055
Exact match found for rate rule [Root_N-1R->H_N-1CNOS->N_1COS->O_Ext-1O-R_Ext-2R-R_Ext-2R-R_N-4R!H->O]
Euclidian distance = 0
family: R_Recombination
Ea raised from 35.0 to 38.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]=[C]OO[CH2](28886)'],
    products = ['[CH2]OO[C]=C(28838)'],
    transitionState = 'TS8',
