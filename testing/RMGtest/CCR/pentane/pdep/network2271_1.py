...
species(
    label = '[C]=[C]OC([CH2])C(9697)',
    structure = SMILES('[C]=[C]OC([CH2])C'),
    E0 = (786.426,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,1685,370,341.118,341.194,341.196],'cm^-1')),
        HinderedRotor(inertia=(0.173011,'amu*angstrom^2'), symmetry=1, barrier=(14.2809,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172862,'amu*angstrom^2'), symmetry=1, barrier=(14.2808,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172685,'amu*angstrom^2'), symmetry=1, barrier=(14.2811,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17277,'amu*angstrom^2'), symmetry=1, barrier=(14.2791,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.73792,0.0709291,-8.68322e-05,5.3987e-08,-1.31143e-11,94703.5,25.5534], Tmin=(100,'K'), Tmax=(1012.84,'K')), NASAPolynomial(coeffs=[14.4558,0.0167541,-6.60135e-06,1.17881e-09,-7.98214e-14,91924.6,-40.8029], Tmin=(1012.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(786.426,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27191,0.0523934,-3.39303e-05,5.39577e-09,2.01982e-12,21166.7,23.2396], Tmin=(100,'K'), Tmax=(1039.02,'K')), NASAPolynomial(coeffs=[13.1428,0.0204942,-7.80274e-06,1.41552e-09,-9.84469e-14,17954.9,-38.0702], Tmin=(1039.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(175.118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.915203,0.0642612,-6.52342e-05,3.41684e-08,-7.08986e-12,56055.8,25.2998], Tmin=(100,'K'), Tmax=(1172.14,'K')), NASAPolynomial(coeffs=[14.1211,0.0191947,-7.5614e-06,1.36604e-09,-9.35066e-14,52960.1,-40.5083], Tmin=(1172.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(465.126,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C2CsJOC(O)) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH]=[C]OC[CH2](2368)'],
    products = ['[CH]=[C]OC([CH2])C(2404)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', '[CH]=[C]O[CH]C(9652)'],
    products = ['[CH]=[C]OC([CH2])C(2404)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]C(C)O[C]=[CH](9696)'],
    products = ['[CH]=[C]OC([CH2])C(2404)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[C]=[C]OC([CH2])C(9697)'],
    products = ['[CH]=[C]OC([CH2])C(2404)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'C#CO[C]([CH2])C(3101)'],
    products = ['[CH]=[C]OC([CH2])C(2404)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(17)', 'C#CO[CH][CH2](3100)'],
    products = ['[CH]=[C]OC([CH2])C(2404)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(17)', '[CH]=[C]O[CH][CH2](9651)'],
    products = ['[CH]=[C]OC([CH2])C(2404)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH]=[C]O[C]([CH2])C(9699)'],
    products = ['[CH]=[C]OC([CH2])C(2404)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH]=[C]OC([CH2])[CH2](2590)'],
    products = ['[CH]=[C]OC([CH2])C(2404)'],
