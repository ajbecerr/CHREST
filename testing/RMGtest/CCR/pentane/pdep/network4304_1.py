species(
    ...
    E0 = (394.678,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,1685,370,200,800,1600],'cm^-1')),
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.356599,0.0849699,-7.09798e-05,3.47981e-08,-7.53065e-12,41041.2,33.1324], Tmin=(100,'K'), Tmax=(1053.61,'K')), NASAPolynomial(coeffs=[9.2619,0.0511609,-2.28461e-05,4.34141e-09,-3.0382e-13,39164.7,-10.2955], Tmin=(1053.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(340.179,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Allyl_S) + radical(Cds_S)"""),
)
...
species(
    label = 'C[CH]C(C)C=[C]C[O](20158)',
    structure = SMILES('C[CH]C(C)C=[C]C[O]'),
    E0 = (396.873,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.829349,0.0762458,-8.00711e-05,6.69782e-08,-2.59705e-11,47840.8,35.1565], Tmin=(100,'K'), Tmax=(739.46,'K')), NASAPolynomial(coeffs=[2.83471,0.0577573,-2.70678e-05,5.21913e-09,-3.66426e-13,47753.1,27.4996], Tmin=(739.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(396.873,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCOJ) + radical(Cs_S) + radical(Cds_S)"""),
)
...
species(
    label = 'C[C]C(C)C=[C]CO[O](20159)',
    structure = SMILES('C[C]C(C)C=[C]CO[O]'),
    E0 = (648.351,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0444472,0.0946495,-0.000103437,6.74734e-08,-1.86668e-11,78119.3,36.3179], Tmin=(100,'K'), Tmax=(862.265,'K')), NASAPolynomial(coeffs=[10.1174,0.0475093,-2.14313e-05,4.07044e-09,-2.84107e-13,76366.8,-11.2012], Tmin=(862.265,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(648.351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(CCJ2_triplet) + radical(Cds_S)"""),
)

species(
    label = 'C[CH]C(C)C=C1COO1(20160)',
    structure = SMILES('C[CH]C(C)C=C1COO1'),
    E0 = (171.204,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.5105,0.062057,-8.6094e-07,-3.37527e-08,1.4316e-11,20729.1,36.2286], Tmin=(100,'K'), Tmax=(1095.2,'K')), NASAPolynomial(coeffs=[14.3657,0.0432446,-1.86366e-05,3.57188e-09,-2.54062e-13,15787.6,-40.5791], Tmin=(1095.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(171.204,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclobutane) + radical(Cs_S)"""),
)

species(
    label = 'CC1C=C(CO[O])C1C(20142)',
    structure = SMILES('CC1C=C(CO[O])C1C'),
    E0 = (112.282,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.151371,0.0704474,-1.7782e-05,-2.43976e-08,1.35759e-11,13655.3,31.7597], Tmin=(100,'K'), Tmax=(1021.15,'K')), NASAPolynomial(coeffs=[16.2075,0.0379339,-1.46491e-05,2.69224e-09,-1.89162e-13,8792.2,-53.794], Tmin=(1021.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(112.282,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(ROOJ)"""),
)

species(
    label = 'C[CH]C(C)C=C1CO1(20161)',
    structure = SMILES('C[CH]C(C)C=C1CO1'),
    E0 = (104.624,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.430261,0.0610439,4.94048e-06,-5.22087e-08,2.48991e-11,12727.5,29.8031], Tmin=(100,'K'), Tmax=(975.796,'K')), NASAPolynomial(coeffs=[18.234,0.0295718,-1.04884e-05,1.92612e-09,-1.39081e-13,7276.71,-65.7794], Tmin=(975.796,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(104.624,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(methyleneoxirane) + radical(Cs_S)"""),
)

species(
    label = 'CC=C(C)C=CCO[O](20162)',
    structure = SMILES('CC=C(C)C=CCO[O]'),
    E0 = (54.6533,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0127339,0.0911066,-8.33345e-05,4.35452e-08,-9.64994e-12,6715.4,31.8956], Tmin=(100,'K'), Tmax=(1058.86,'K')), NASAPolynomial(coeffs=[11.7869,0.0465322,-2.01901e-05,3.78932e-09,-2.63528e-13,4216.56,-25.7055], Tmin=(1058.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(54.6533,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + radical(ROOJ)"""),
)
...
species(
    label = 'C[CH]C(C)C#CCO[O](20165)',
    structure = SMILES('C[CH]C(C)C#CCO[O]'),
    E0 = (315.631,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2100,2250,500,550,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.316612,0.0836909,-8.06254e-05,4.86649e-08,-1.26719e-11,38091.9,36.6125], Tmin=(100,'K'), Tmax=(909.438,'K')), NASAPolynomial(coeffs=[8.82671,0.0462604,-1.88881e-05,3.40775e-09,-2.30791e-13,36544,-3.63591], Tmin=(909.438,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(315.631,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CtCsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CtOsHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(ROOJ) + radical(Cs_S)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.187246,0.0905181,-9.59065e-05,6.70731e-08,-2.08957e-11,47600,38.137], Tmin=(100,'K'), Tmax=(756.932,'K')), NASAPolynomial(coeffs=[6.93201,0.0548713,-2.52576e-05,4.84193e-09,-3.39523e-13,46579.1,7.47643], Tmin=(756.932,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(394.678,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Cs_S) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.136688,0.0934611,-8.10929e-05,3.88059e-08,-7.85385e-12,25098.9,30.7229], Tmin=(100,'K'), Tmax=(1148.59,'K')), NASAPolynomial(coeffs=[13.0447,0.0475568,-2.11444e-05,4.01058e-09,-2.80394e-13,22070.9,-34.6956], Tmin=(1148.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(207.464,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Allyl_S) + radical(C=CCJCO)"""),
)
...
species(
    label = 'C[CH]C(C)[C]=[C]COO(20173)',
    structure = SMILES('C[CH]C(C)[C]=[C]COO'),
    E0 = (480.515,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,1670,1700,300,440,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.432443,0.0901707,-7.20947e-05,-1.81982e-09,3.32708e-11,57909.7,37.0873], Tmin=(100,'K'), Tmax=(529.548,'K')), NASAPolynomial(coeffs=[7.33233,0.0560758,-2.65729e-05,5.14659e-09,-3.62472e-13,56926.2,5.79969], Tmin=(529.548,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(480.515,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_S) + radical(Cds_S) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.362107,0.0867116,-7.8194e-05,4.42532e-08,-1.13677e-11,45185.8,35.0104], Tmin=(100,'K'), Tmax=(892.177,'K')), NASAPolynomial(coeffs=[7.34324,0.0554111,-2.55668e-05,4.92668e-09,-3.47404e-13,43940.1,2.12726], Tmin=(892.177,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.654,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_T) + radical(Cs_S) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2][CH]C(C)C=[C]COO(20175)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.104552,0.0930203,-9.46495e-05,5.99254e-08,-1.67572e-11,54006.2,39.4697], Tmin=(100,'K'), Tmax=(837.33,'K')), NASAPolynomial(coeffs=[8.17104,0.0544885,-2.56279e-05,4.97539e-09,-3.52e-13,52655.2,1.98507], Tmin=(837.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(447.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_S) + radical(RCCJ) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]C(C)C=[C]CO[O](19299)'],
    products = ['C#CCO[O](16808)', 'butene2t(396)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['CC(C)[CH]C=[C]CO[O](20157)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O(4)', 'C[CH]C(C)C=[C]C[O](20158)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CHCH3(T)(21)', 'C[CH]C=[C]CO[O](19555)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', '[CH]C(C)C=[C]CO[O](19583)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2]O[O](46)', '[C]=CC(C)[CH]C(15133)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'C[C]C(C)C=[C]CO[O](20159)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C[CH]C(C)C=[C]CO[O](19299)'],
    products = ['C[CH]C(C)C=C1COO1(20160)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C[CH]C(C)C=[C]CO[O](19299)'],
    products = ['CC1C=C(CO[O])C1C(20142)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]C(C)C=[C]CO[O](19299)'],
    products = ['O(4)', 'C[CH]C(C)C=C1CO1(20161)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'CC=C(C)C=[C]CO[O](20164)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'C=CC(C)C=[C]CO[O](19363)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', 'C[CH]C(C)C#CCO[O](20165)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH3(17)', 'CC=CC=[C]CO[O](19627)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=[C]CO[O](16805)', 'butene2t(396)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C#CCO[O](16808)', 'C[CH][CH]C(1186)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH3(17)', 'C[CH][CH]C=[C]CO[O](19630)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]=[C]CO[O](16805)', 'C[CH][CH]C(1186)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', 'C[CH][C](C)C=[C]CO[O](20166)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', '[CH2][CH]C(C)C=[C]CO[O](19366)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', 'C[CH]C(C)[C]=[C]CO[O](20168)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
...
reaction(
    label = 'reaction36',
    reactants = ['C[CH]C(C)[C]=CCO[O](20170)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
...
reaction(
    label = 'reaction40',
    reactants = ['C[CH]C(C)C=[C]CO[O](19299)'],
    products = ['C[CH][C](C)C=CCO[O](20172)'],
...
reaction(
    label = 'reaction43',
    reactants = ['C[CH]C(C)[C]=[C]COO(20173)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
...
reaction(
    label = 'reaction45',
    reactants = ['C[CH]C(C)C=[C]CO[O](19299)'],
    products = ['C[CH][C](C)C=[C]COO(20174)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH2][CH]C(C)C=[C]COO(20175)'],
    products = ['C[CH]C(C)C=[C]CO[O](19299)'],
...
network(
    ...
    isomers = [
        'C[CH]C(C)C=[C]CO[O](19299)',
    ],
    reactants = [
        ('C#CCO[O](16808)', 'butene2t(396)'),
    ],
    bathGas = {
        'Ar': 0.333333,
        'Ne': 0.333333,
