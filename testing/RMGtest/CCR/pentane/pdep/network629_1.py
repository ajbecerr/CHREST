...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.967233,0.0583506,-4.14284e-05,6.70357e-09,3.14431e-12,57687.6,24.8476], Tmin=(100,'K'), Tmax=(983.785,'K')), NASAPolynomial(coeffs=[15.3604,0.0175259,-6.16448e-06,1.09165e-09,-7.61395e-14,53999.3,-48.7081], Tmin=(983.785,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(478.672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33935,0.0455795,1.75167e-06,-3.88838e-08,1.93761e-11,-7855.93,22.3949], Tmin=(100,'K'), Tmax=(956.608,'K')), NASAPolynomial(coeffs=[15.2212,0.0190753,-6.14791e-06,1.08993e-09,-7.86341e-14,-11955,-51.5045], Tmin=(956.608,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-66.2118,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]CCO[C]=C(2443)',
    structure = SMILES('[CH2]CCO[C]=C'),
    E0 = (235.703,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,256.952,256.957,256.995,4000],'cm^-1')),
        HinderedRotor(inertia=(0.519177,'amu*angstrom^2'), symmetry=1, barrier=(24.3406,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.519225,'amu*angstrom^2'), symmetry=1, barrier=(24.3421,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.519551,'amu*angstrom^2'), symmetry=1, barrier=(24.3425,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00255245,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04865,0.0561205,-3.26555e-05,-3.97878e-10,4.97503e-12,28462.6,26.4367], Tmin=(100,'K'), Tmax=(997.475,'K')), NASAPolynomial(coeffs=[14.3449,0.0211638,-7.70155e-06,1.37996e-09,-9.62066e-14,24896.5,-42.2555], Tmin=(997.475,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(C=CJO)"""),
)

species(
    label = '[CH]=COC[CH]C(2444)',
    structure = SMILES('[CH]=COC[CH]C'),
    E0 = (237.711,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,407.08,407.108,407.124],'cm^-1')),
        HinderedRotor(inertia=(0.14618,'amu*angstrom^2'), symmetry=1, barrier=(17.1932,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146247,'amu*angstrom^2'), symmetry=1, barrier=(17.1934,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146168,'amu*angstrom^2'), symmetry=1, barrier=(17.1947,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146318,'amu*angstrom^2'), symmetry=1, barrier=(17.1927,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.943741,0.0516908,-2.52249e-06,-4.45519e-08,2.39571e-11,28714.3,24.7976], Tmin=(100,'K'), Tmax=(935.948,'K')), NASAPolynomial(coeffs=[19.2934,0.0125442,-2.72833e-06,4.29387e-10,-3.35372e-14,23559.2,-71.7041], Tmin=(935.948,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(237.711,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]OCCC(2445)',
    structure = SMILES('[CH]=[C]OCCC'),
    E0 = (277.553,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,256.485,256.491,256.492],'cm^-1')),
        HinderedRotor(inertia=(0.00256279,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.352691,'amu*angstrom^2'), symmetry=1, barrier=(16.4634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.352653,'amu*angstrom^2'), symmetry=1, barrier=(16.4634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.352639,'amu*angstrom^2'), symmetry=1, barrier=(16.4634,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.934156,0.0589529,-3.90219e-05,4.95405e-09,3.39474e-12,33499.8,25.4641], Tmin=(100,'K'), Tmax=(995.892,'K')), NASAPolynomial(coeffs=[14.8128,0.0205887,-7.41487e-06,1.31883e-09,-9.15358e-14,29873.6,-45.7622], Tmin=(995.892,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(277.553,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H2CC(T)(1341)', 'C[CH]C[O](1360)'],
    products = ['C=[C]OC[CH]C(2247)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHCH3(T)(21)', '[CH2]O[C]=C(2363)'],
    products = ['C=[C]OC[CH]C(2247)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', '[CH]CO[C]=C(2364)'],
    products = ['C=[C]OC[CH]C(2247)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C=[C]O[CH][CH]C(2441)'],
    products = ['C=[C]OC[CH]C(2247)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2][CH]CO[C]=C(2284)'],
    products = ['C=[C]OC[CH]C(2247)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH]=[C]OC[CH]C(2442)'],
    products = ['C=[C]OC[CH]C(2247)'],
