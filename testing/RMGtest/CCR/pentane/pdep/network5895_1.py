...
species(
    label = '[CH2]C(=C[O])OC[CH]C(25276)',
    structure = SMILES('[CH2]C(=C[O])OC[CH]C'),
    E0 = (40.4099,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.275935,0.0762962,-2.96669e-05,-3.21976e-08,2.25381e-11,5030.48,32.7355], Tmin=(100,'K'), Tmax=(933.534,'K')), NASAPolynomial(coeffs=[24.585,0.0147683,-3.10339e-06,4.63765e-10,-3.53925e-14,-1571.89,-95.9954], Tmin=(933.534,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(40.4099,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCJCO) + radical(C=C(O)CJ)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.830754,0.128741,-0.000249967,2.43917e-07,-8.77826e-11,90852.3,35.1843], Tmin=(100,'K'), Tmax=(881.422,'K')), NASAPolynomial(coeffs=[4.57863,0.0504347,-2.52214e-05,4.73512e-09,-3.16848e-13,91986.9,21.6157], Tmin=(881.422,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(754.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CCsJOH) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][C]([C][O])OC[CH]C(26360)',
    structure = SMILES('[CH2][C]([C][O])OC[CH]C'),
    E0 = (786.498,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,360,370,350,3000,3100,440,815,1455,1000,180,180,180,1140.32,1600,2272.13,3200],'cm^-1')),
        HinderedRotor(inertia=(0.146368,'amu*angstrom^2'), symmetry=1, barrier=(3.36528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146368,'amu*angstrom^2'), symmetry=1, barrier=(3.36528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146368,'amu*angstrom^2'), symmetry=1, barrier=(3.36528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146368,'amu*angstrom^2'), symmetry=1, barrier=(3.36528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146368,'amu*angstrom^2'), symmetry=1, barrier=(3.36528,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.550846,0.117962,-0.000216792,2.07088e-07,-7.42296e-11,94740.6,35.9532], Tmin=(100,'K'), Tmax=(868.787,'K')), NASAPolynomial(coeffs=[5.98384,0.0469174,-2.34149e-05,4.43549e-09,-3.0012e-13,95150.9,14.2421], Tmin=(868.787,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(786.498,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CH2_triplet)"""),
)

species(
    label = '[CH][C]([CH][O])OC[CH]C(26361)',
    structure = SMILES('[CH][C]([CH][O])OC[CH]C'),
    E0 = (743.512,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,360,370,350,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.26939,0.110593,-0.000197305,1.89126e-07,-6.84037e-11,89561.6,37.012], Tmin=(100,'K'), Tmax=(865.219,'K')), NASAPolynomial(coeffs=[4.79659,0.0489222,-2.40745e-05,4.55303e-09,-3.08657e-13,90116.7,21.5787], Tmin=(865.219,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(743.512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO) + radical(C2CsJOCs) + radical(CCsJOH) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH2]C([CH][O])OC=CC(26362)',
    structure = SMILES('[CH2]C([CH][O])OC=CC'),
    E0 = (198.73,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.531084,0.101841,-0.000123802,7.93969e-08,-2.02706e-11,24063,31.5282], Tmin=(100,'K'), Tmax=(956.564,'K')), NASAPolynomial(coeffs=[16.2957,0.0314768,-1.34612e-05,2.49564e-09,-1.72064e-13,20843.9,-48.9041], Tmin=(956.564,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(198.73,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CCOJ) + radical(CCsJOH) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C([CH][O])OCC=C(25290)',
    structure = SMILES('[CH2]C([CH][O])OCC=C'),
    E0 = (258.54,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.240112,0.105479,-0.00016902,1.54505e-07,-5.51031e-11,31236.1,34.0708], Tmin=(100,'K'), Tmax=(844.454,'K')), NASAPolynomial(coeffs=[6.54411,0.0483772,-2.32418e-05,4.40638e-09,-3.01429e-13,30980.5,7.75865], Tmin=(844.454,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(258.54,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCsJOH) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]CCO[C]([CH2])[CH][O](26365)',
    structure = SMILES('[CH2]CCO[C]([CH2])[CH][O]'),
    E0 = (511.151,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.734283,0.126344,-0.000240679,2.36286e-07,-8.58067e-11,61626.6,36.7188], Tmin=(100,'K'), Tmax=(877.806,'K')), NASAPolynomial(coeffs=[3.43337,0.0542916,-2.68841e-05,5.05298e-09,-3.39359e-13,62939.2,28.7998], Tmin=(877.806,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(511.151,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOCs) + radical(RCCJ) + radical(CCsJOH) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C([CH][O])O[CH][CH]C(26366)',
    structure = SMILES('[CH2]C([CH][O])O[CH][CH]C'),
    E0 = (505.559,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.786311,0.116754,-0.000190049,1.66374e-07,-5.64085e-11,60966.1,37.117], Tmin=(100,'K'), Tmax=(861.221,'K')), NASAPolynomial(coeffs=[10.4733,0.0416566,-1.95385e-05,3.64097e-09,-2.45656e-13,59872.3,-10.6126], Tmin=(861.221,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(505.559,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO) + radical(CCsJOCs) + radical(CCsJOH) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][C](C[O])O[CH][CH]C(26367)',
    structure = SMILES('[CH2][C](C[O])O[CH][CH]C'),
    E0 = (505.965,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.656876,0.11923,-0.000211434,1.98219e-07,-7.00711e-11,61005.2,37.0481], Tmin=(100,'K'), Tmax=(875.232,'K')), NASAPolynomial(coeffs=[6.52237,0.0478349,-2.29482e-05,4.27927e-09,-2.87079e-13,61226.4,11.8117], Tmin=(875.232,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(505.965,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOCs) + radical(CCJCO) + radical(CCsJOCs) + radical(CJC(C)OC)"""),
)

species(
    label = 'C[CH][CH]O[C](C)[CH][O](26368)',
    structure = SMILES('C[CH][CH]O[C](C)[CH][O]'),
    E0 = (475.753,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.521689,0.114581,-0.000196955,1.82957e-07,-6.4701e-11,57368.2,36.36], Tmin=(100,'K'), Tmax=(867.794,'K')), NASAPolynomial(coeffs=[6.66339,0.0476479,-2.28107e-05,4.27092e-09,-2.8811e-13,57394.4,10.051], Tmin=(867.794,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(475.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOCs) + radical(CCJCO) + radical(CCsJOCs) + radical(CCsJOH)"""),
)

species(
    label = '[CH2][CH]COC([CH2])[CH][O](26369)',
    structure = SMILES('[CH2][CH]COC([CH2])[CH][O]'),
    E0 = (530.35,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.434205,0.11033,-0.000180985,1.64778e-07,-5.80987e-11,63933.7,38.193], Tmin=(100,'K'), Tmax=(852.332,'K')), NASAPolynomial(coeffs=[7.43715,0.0468297,-2.24896e-05,4.24684e-09,-2.89208e-13,63556.7,7.13547], Tmin=(852.332,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(530.35,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO) + radical(CCsJOH) + radical(CJC(C)OC) + radical(RCCJ)"""),
)

species(
    label = '[CH2][C]([CH]O)O[CH][CH]C(26370)',
    structure = SMILES('[CH2][C]([CH]O)O[CH][CH]C'),
    E0 = (460.558,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.25593,0.130317,-0.000228847,2.03269e-07,-6.81093e-11,55567.7,37.8877], Tmin=(100,'K'), Tmax=(892.462,'K')), NASAPolynomial(coeffs=[11.7317,0.038394,-1.76855e-05,3.20555e-09,-2.10059e-13,54592.1,-15.7706], Tmin=(892.462,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(460.558,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOCs) + radical(CCJCO) + radical(CCsJOCs) + radical(CCsJOH) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][CH]CO[C]([CH2])C[O](26371)',
    structure = SMILES('[CH2][CH]CO[C]([CH2])C[O]'),
    E0 = (530.756,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,180,612.981,1600,1731.32,3200],'cm^-1')),
        HinderedRotor(inertia=(0.142196,'amu*angstrom^2'), symmetry=1, barrier=(3.26936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142196,'amu*angstrom^2'), symmetry=1, barrier=(3.26936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142196,'amu*angstrom^2'), symmetry=1, barrier=(3.26936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142196,'amu*angstrom^2'), symmetry=1, barrier=(3.26936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.142196,'amu*angstrom^2'), symmetry=1, barrier=(3.26936,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.306379,0.112824,-0.000202418,1.96654e-07,-7.17544e-11,63972.9,38.1299], Tmin=(100,'K'), Tmax=(867.793,'K')), NASAPolynomial(coeffs=[3.50278,0.0529793,-2.58824e-05,4.88111e-09,-3.30293e-13,64904,29.4671], Tmin=(867.793,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(530.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOCs) + radical(CCJCO) + radical(CJC(C)OC) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]CO[C](C)[CH][O](26372)',
    structure = SMILES('[CH2][CH]CO[C](C)[CH][O]'),
    E0 = (500.543,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.171135,0.108176,-0.000187954,1.81435e-07,-6.64167e-11,60335.9,37.4415], Tmin=(100,'K'), Tmax=(860.417,'K')), NASAPolynomial(coeffs=[3.63667,0.0528045,-2.57521e-05,4.87446e-09,-3.31466e-13,61075,27.7464], Tmin=(860.417,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(500.543,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOCs) + radical(CCJCO) + radical(CCsJOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]CO[C]([CH2])[CH]O(26373)',
    structure = SMILES('[CH2][CH]CO[C]([CH2])[CH]O'),
    E0 = (485.348,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.901619,0.123858,-0.000219601,2.01323e-07,-6.95838e-11,58535.2,38.9563], Tmin=(100,'K'), Tmax=(882.281,'K')), NASAPolynomial(coeffs=[8.72054,0.0435244,-2.06119e-05,3.80556e-09,-2.53124e-13,58266,1.83707], Tmin=(882.281,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(485.348,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOCs) + radical(CCJCO) + radical(CCsJOH) + radical(RCCJ) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
    products = ['[CH2]C(=C[O])OC[CH]C(25276)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2][C][CH][O](17607)', 'C[CH]C[O](1360)'],
    products = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHCH3(T)(21)', '[CH2]O[C]([CH2])[CH][O](26247)'],
    products = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH]CO[C]([CH2])[CH][O](26248)'],
    products = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH2][C]([CH][O])OC[C]C(26359)'],
    products = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH2][C]([C][O])OC[CH]C(26360)'],
    products = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH][C]([CH][O])OC[CH]C(26361)'],
    products = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
    products = ['[CH2]C([CH][O])OC=CC(26362)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
    products = ['[CH2]C([CH][O])OCC=C(25290)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH2][C]([CH][O])OC=CC(26363)'],
    products = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2][CH]COC([CH2])=C[O](25384)'],
    products = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(5.014e+08,'cm^3/(mol*s)'), n=1.733, Ea=(48.3587,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""From training reaction 2823 used for Cds-HH_Cds-Cs\O2s/H;HJ
Exact match found for rate rule [Cds-HH_Cds-Cs\O2s/H;HJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 47.3 to 48.4 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.41198,'m^3/(mol*s)'), n=2.03228, Ea=(199.985,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 199.4 to 200.0 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2][C]([CH][O])O[CH][CH]C(26364)'],
    products = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2][CH]CO[C]([CH2])[CH][O](25395)'],
    products = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
    products = ['[CH2][C]([CH][O])O[CH]CC(26343)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CCO[C]([CH2])[CH][O](26365)'],
    products = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C([CH][O])O[CH][CH]C(26366)'],
    products = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2][C](C[O])O[CH][CH]C(26367)'],
    products = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
    products = ['C[CH][CH]O[C](C)[CH][O](26368)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2][CH]COC([CH2])[CH][O](26369)'],
    products = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
    products = ['[CH2][C]([CH]O)O[CH][CH]C(26370)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2][CH]CO[C]([CH2])C[O](26371)'],
    products = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
    products = ['[CH2][CH]CO[C](C)[CH][O](26372)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2][C]([CH][O])OC[CH]C(25286)'],
    products = ['[CH2][CH]CO[C]([CH2])[CH]O(26373)'],
...
network(
    label = 'PDepNetwork #5895',
    isomers = [
        '[CH2][C]([CH][O])OC[CH]C(25286)',
    ],
    reactants = [
