...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69182,0.0477288,-4.52038e-05,2.28281e-08,-4.62515e-12,-12240.8,17.6577], Tmin=(100,'K'), Tmax=(1192.94,'K')), NASAPolynomial(coeffs=[10.9068,0.0168302,-6.35181e-06,1.11584e-09,-7.49609e-14,-14439.4,-28.4248], Tmin=(1192.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-102.488,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), label="""propen2ooh""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
species(
    label = '[CH2][C](C)O[O](675)',
    structure = SMILES('[CH2][C](C)O[O]'),
    E0 = (332.806,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(0.0837921,'amu*angstrom^2'), symmetry=1, barrier=(1.92655,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0842885,'amu*angstrom^2'), symmetry=1, barrier=(1.93796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0838825,'amu*angstrom^2'), symmetry=1, barrier=(1.92862,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.94138,0.0519235,-8.46893e-05,7.83909e-08,-2.77792e-11,40095.1,21.5608], Tmin=(100,'K'), Tmax=(868.171,'K')), NASAPolynomial(coeffs=[4.82374,0.0238732,-1.07055e-05,1.98256e-09,-1.33554e-13,40151.2,11.2683], Tmin=(868.171,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.806,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(ROOJ) + radical(C2CsJOOH) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2][C](C)OO(676)',
    structure = SMILES('[CH2][C](C)OO'),
    E0 = (180.804,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(0.144688,'amu*angstrom^2'), symmetry=1, barrier=(3.32666,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144514,'amu*angstrom^2'), symmetry=1, barrier=(3.32267,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14484,'amu*angstrom^2'), symmetry=1, barrier=(3.33017,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.380564,'amu*angstrom^2'), symmetry=1, barrier=(8.74992,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70667,0.0551266,-7.85437e-05,6.72214e-08,-2.32886e-11,21823.8,21.6495], Tmin=(100,'K'), Tmax=(812.896,'K')), NASAPolynomial(coeffs=[6.31113,0.0257067,-1.17775e-05,2.23132e-09,-1.53906e-13,21298.7,1.7638], Tmin=(812.896,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.804,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(C2CsJOOH) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C([CH2])OO(467)',
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59507,0.0541721,-6.21486e-05,3.83338e-08,-9.48462e-12,25086.3,23.0636], Tmin=(100,'K'), Tmax=(982.375,'K')), NASAPolynomial(coeffs=[10.333,0.018593,-7.82188e-06,1.46588e-09,-1.02175e-13,23369.5,-18.9364], Tmin=(982.375,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(207.868,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CJCOOH) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]CO[O](49)'],
    products = ['[CH2]C(C)O[O](87)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'propen2peroxy(672)'],
    products = ['[CH2]C(C)O[O](87)'],
...
reaction(
    label = 'reaction13',
    reactants = ['O2(2)', 'C3H6(27)'],
    products = ['[CH2]C(C)O[O](87)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(88.4,'cm^3/(mol*s)'), n=3.08, Ea=(148.556,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 2808 propene_2 + O2 <=> C3H6O2 in R_Addition_MultipleBond/training
This reaction matched rate rule [Cds-CsH_Cds-HH;O2b]
family: R_Addition_MultipleBond
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(17)', '[CH2][CH]O[O](674)'],
    products = ['[CH2]C(C)O[O](87)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2]C([CH2])O[O](460)'],
    products = ['[CH2]C(C)O[O](87)'],
