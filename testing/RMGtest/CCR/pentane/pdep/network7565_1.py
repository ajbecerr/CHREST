...
species(
    ...
    molecularWeight = (63.0327,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32071,0.0488626,-0.000107306,1.13342e-07,-4.28887e-11,-17115.4,14.5038], Tmin=(100,'K'), Tmax=(874.423,'K')), NASAPolynomial(coeffs=[1.58938,0.0228027,-1.216e-05,2.34502e-09,-1.59183e-13,-15863.3,24.3621], Tmin=(874.423,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-142.713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(OCJO)"""),
)
...
species(
    ...
    E0 = (-106.6,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,296.961],'cm^-1')),
        HinderedRotor(inertia=(0.190609,'amu*angstrom^2'), symmetry=1, barrier=(11.9553,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190195,'amu*angstrom^2'), symmetry=1, barrier=(11.9549,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (63.0327,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.44714,0.0340634,-4.14969e-05,2.61185e-08,-6.46108e-12,-12765,14.0867], Tmin=(100,'K'), Tmax=(992.648,'K')), NASAPolynomial(coeffs=[8.67812,0.00895441,-3.5537e-06,6.35247e-10,-4.29519e-14,-14002,-15.928], Tmin=(992.648,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-106.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), label="""HOOCH2O""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['HOCH2OO(7385)'],
    products = ['HO2(9)', 'CH2O(3111)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(4)', 'HOCH2O(28715)'],
    products = ['HOCH2OO(7385)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['HOCH2OO(7385)'],
    products = ['O[CH]OO(29507)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(6e+08,'s^-1'), n=1.23, Ea=(154.18,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 269 CH3O3 <=> CH3O3-2 in intra_H_migration/training
This reaction matched rate rule [R3H_SS_O;O_rad_out;Cs_H_out_H/NonDeO]
family: intra_H_migration"""),
)

reaction(
    label = 'reaction8',
    reactants = ['HOOCH2O(28802)'],
    products = ['HOCH2OO(7385)'],
    transitionState = 'TS8',
