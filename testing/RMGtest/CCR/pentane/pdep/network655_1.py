...
species(
    label = '[CH2]C(C)O[C]=C(2249)',
    structure = SMILES('[CH2]C(C)O[C]=C'),
    E0 = (228.324,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,335.125,335.139,335.215],'cm^-1')),
        HinderedRotor(inertia=(0.191269,'amu*angstrom^2'), symmetry=1, barrier=(15.2567,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191241,'amu*angstrom^2'), symmetry=1, barrier=(15.2557,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191141,'amu*angstrom^2'), symmetry=1, barrier=(15.2562,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191203,'amu*angstrom^2'), symmetry=1, barrier=(15.2576,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'C=[C]O[CH]CC(2398)',
    structure = SMILES('C=[C]O[CH]CC'),
    E0 = (224.384,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,348.91,349.996,351.215,351.395],'cm^-1')),
        HinderedRotor(inertia=(0.168538,'amu*angstrom^2'), symmetry=1, barrier=(14.8027,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.170386,'amu*angstrom^2'), symmetry=1, barrier=(14.7914,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.17101,'amu*angstrom^2'), symmetry=1, barrier=(14.7904,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165913,'amu*angstrom^2'), symmetry=1, barrier=(14.7641,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.654257,0.0646707,-4.87231e-05,9.58019e-09,3.1325e-12,27115.7,25.5389], Tmin=(100,'K'), Tmax=(969.072,'K')), NASAPolynomial(coeffs=[16.9401,0.0171676,-5.71712e-06,9.92439e-10,-6.90705e-14,23033.3,-57.2963], Tmin=(969.072,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(224.384,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(C=CJO)"""),
)
...
species(
    label = '[CH]C(CC)O[C]=C(2476)',
    structure = SMILES('[CH]C(CC)O[C]=C'),
    E0 = (442.249,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.690983,0.0608125,-1.99484e-05,-1.72396e-08,1.08287e-11,-11250.9,27.8338], Tmin=(100,'K'), Tmax=(1011.56,'K')), NASAPolynomial(coeffs=[15.208,0.0291156,-1.10677e-05,2.03156e-09,-1.43243e-13,-15503.2,-48.8706], Tmin=(1011.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-94.6232,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH]=COC([CH2])CC(2486)',
    structure = SMILES('[CH]=COC([CH2])CC'),
    E0 = (211.896,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.341959,0.0833635,-6.14979e-05,8.40153e-09,6.22915e-12,25652.5,28.567], Tmin=(100,'K'), Tmax=(953.147,'K')), NASAPolynomial(coeffs=[21.6469,0.01961,-6.05867e-06,1.02426e-09,-7.15052e-14,20165,-83.2588], Tmin=(953.147,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(211.896,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]C(C)O[C]=C(2249)'],
    products = ['[CH2]C(CC)O[C]=C(2265)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H2CC(T)(1341)', '[CH2]C([O])CC(1362)'],
    products = ['[CH2]C(CC)O[C]=C(2265)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', 'C=[C]O[CH]CC(2398)'],
    products = ['[CH2]C(CC)O[C]=C(2265)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]C(CC)O[C]=C(2476)'],
    products = ['[CH2]C(CC)O[C]=C(2265)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'C=[C]OC(=C)CC(2479)'],
    products = ['[CH2]C(CC)O[C]=C(2265)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['C2H5(14)', 'C=[C]OC=C(2317)'],
    products = ['[CH2]C(CC)O[C]=C(2265)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C2H5(14)', '[CH2][CH]O[C]=C(2367)'],
    products = ['[CH2]C(CC)O[C]=C(2265)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2][C](CC)O[C]=C(2481)'],
    products = ['[CH2]C(CC)O[C]=C(2265)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(17)', '[CH2]C([CH2])O[C]=C(2286)'],
    products = ['[CH2]C(CC)O[C]=C(2265)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2]CC([CH2])O[C]=C(2483)'],
    products = ['[CH2]C(CC)O[C]=C(2265)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH]=[C]OC([CH2])CC(2484)'],
    products = ['[CH2]C(CC)O[C]=C(2265)'],
