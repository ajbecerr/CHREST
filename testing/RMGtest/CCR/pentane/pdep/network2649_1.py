species(
    label = 'CC[CH]CO[CH][C]=O(10994)',
    structure = SMILES('CC[CH]COC=[C][O]'),
    E0 = (139.249,'kJ/mol'),
    modes = [
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.124859,0.0744666,-3.1205e-05,-2.52404e-08,1.85799e-11,16911.1,34.8722], Tmin=(100,'K'), Tmax=(946.699,'K')), NASAPolynomial(coeffs=[22.6504,0.0181121,-5.09544e-06,8.6563e-10,-6.34456e-14,10811.9,-83.1956], Tmin=(946.699,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(139.249,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCJCO) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0939119,0.0769771,-4.6413e-05,-3.74529e-09,9.49017e-12,-7115.19,31.0261], Tmin=(100,'K'), Tmax=(966.687,'K')), NASAPolynomial(coeffs=[20.4651,0.0218296,-7.27154e-06,1.28143e-09,-9.07513e-14,-12488.1,-74.6939], Tmin=(966.687,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-60.4823,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(CCJCO)"""),
)
...
species(
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.230884,0.0781286,-3.95583e-05,-1.94832e-08,1.7828e-11,16449.5,34.2595], Tmin=(100,'K'), Tmax=(921.867,'K')), NASAPolynomial(coeffs=[22.7916,0.0172032,-3.83353e-06,5.37288e-10,-3.67922e-14,10548.9,-83.9192], Tmin=(921.867,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(135.388,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Isobutyl) + radical(C=CJO)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.365449,0.0826607,-5.9084e-05,3.58903e-09,8.49907e-12,46782.2,33.1447], Tmin=(100,'K'), Tmax=(950.402,'K')), NASAPolynomial(coeffs=[22.9672,0.0163555,-4.777e-06,8.07127e-10,-5.7913e-14,40906.6,-85.8136], Tmin=(950.402,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(387.562,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCJ2_triplet) + radical(C=CJO)"""),
)
...
species(
    label = 'CCC=COC=C[O](11695)',
    structure = SMILES('CCC=COC=C[O]'),
    E0 = (-156.187,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0557045,0.066349,-2.14756e-06,-5.89271e-08,3.14413e-11,-18624.2,31.1842], Tmin=(100,'K'), Tmax=(937.388,'K')), NASAPolynomial(coeffs=[23.9997,0.0156521,-3.3948e-06,5.42447e-10,-4.30612e-14,-25374.8,-94.8467], Tmin=(937.388,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-156.187,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ)"""),
)

species(
    label = 'CC=CCOC=C[O](11011)',
    structure = SMILES('CC=CCOC=C[O]'),
    E0 = (-179.304,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0530296,0.0687698,-7.26319e-06,-5.48405e-08,3.02283e-11,-21400.6,29.4086], Tmin=(100,'K'), Tmax=(938.31,'K')), NASAPolynomial(coeffs=[24.6132,0.0149117,-3.16354e-06,5.06803e-10,-4.085e-14,-28287.6,-100.054], Tmin=(938.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-179.304,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ)"""),
)
...
species(
    label = 'CCC=COC=[C][O](11783)',
    structure = SMILES('CCC=CO[CH][C]=O'),
    E0 = (37.8313,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,1855,455,950,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.294535,0.0791623,-4.85853e-05,-8.14627e-09,1.27031e-11,4718.56,31.1774], Tmin=(100,'K'), Tmax=(955.605,'K')), NASAPolynomial(coeffs=[23.8785,0.0144075,-4.1232e-06,7.28042e-10,-5.50334e-14,-1564.75,-93.0488], Tmin=(955.605,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(37.8313,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CCsJOC(O)) + radical(CsCJ=O)"""),
)

species(
    label = 'CC[CH]CO[C]=C=O(11697)',
    structure = SMILES('CC[CH]CO[C]=C=O'),
    E0 = (179.262,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1685,370,2120,512.5,787.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.063828,0.0792947,-7.49299e-05,3.65709e-08,-7.08051e-12,21708.1,33.5914], Tmin=(100,'K'), Tmax=(1253.01,'K')), NASAPolynomial(coeffs=[17.2443,0.0244485,-9.27188e-06,1.63696e-09,-1.10435e-13,17402.6,-53.1695], Tmin=(1253.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(179.262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + missing(O2d-Cdd) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(CCJCO) + radical(C=CJO)"""),
)
...
species(
    label = 'CC[CH][CH]OC=[C][O](11784)',
    structure = SMILES('CC[CH][CH]O[CH][C]=O'),
    E0 = (327.963,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,1855,455,950,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.095673,0.0898439,-0.000100811,5.88313e-08,-1.36566e-11,39592.6,34.4563], Tmin=(100,'K'), Tmax=(1048.74,'K')), NASAPolynomial(coeffs=[16.2409,0.0275337,-1.16887e-05,2.17702e-09,-1.51147e-13,36166,-45.1357], Tmin=(1048.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(327.963,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CsCJ=O)"""),
)

species(
    label = '[CH2]C[CH]COC=[C][O](11785)',
    structure = SMILES('[CH2]C[CH]COC=[C][O]'),
    E0 = (344.495,'kJ/mol'),
    modes = [
...
species(
    label = 'C[CH]CCOC=[C][O](11786)',
    structure = SMILES('C[CH]CCOC=[C][O]'),
    E0 = (133.793,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.101663,0.0796699,-5.85606e-05,1.19907e-08,3.27397e-12,16248.7,35.0276], Tmin=(100,'K'), Tmax=(976.322,'K')), NASAPolynomial(coeffs=[18.891,0.0244511,-8.43685e-06,1.46784e-09,-1.01082e-13,11463.2,-61.6606], Tmin=(976.322,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(133.793,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(RCCJC) + radical(C=CJO)"""),
)

species(
    label = 'CCC[CH]OC=[C][O](11755)',
    structure = SMILES('CCC[CH]O[CH][C]=O'),
    E0 = (128.061,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.204349,0.0939961,-0.000105508,6.29439e-08,-1.50951e-11,15552.3,32.3534], Tmin=(100,'K'), Tmax=(1011.09,'K')), NASAPolynomial(coeffs=[15.3783,0.0323478,-1.40478e-05,2.638e-09,-1.8368e-13,12401.3,-42.9954], Tmin=(1011.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(128.061,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CsCJ=O)"""),
)

species(
    label = 'CC[CH]CO[C]=C[O](11004)',
    structure = SMILES('CC[CH]CO[C]=C[O]'),
    E0 = (139.249,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
...
species(
    label = '[CH2]CCCOC=[C][O](11787)',
    structure = SMILES('[CH2]CCCOC=[C][O]'),
    E0 = (144.593,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.282366,0.080417,-5.02966e-05,-3.47459e-09,1.02846e-11,17557.2,34.7274], Tmin=(100,'K'), Tmax=(958.377,'K')), NASAPolynomial(coeffs=[21.9159,0.0200523,-6.34718e-06,1.10311e-09,-7.86071e-14,11819.7,-79.1577], Tmin=(958.377,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(144.593,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(RCCJ) + radical(C=CJO)"""),
)

species(
    label = 'CC[CH]CO[C]=[C]O(11702)',
    structure = SMILES('CC[CH]CO[C]=[C]O'),
    E0 = (237.53,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1670,1700,300,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06774,0.0917574,-9.06401e-05,4.40583e-08,-8.12959e-12,28767.6,39.986], Tmin=(100,'K'), Tmax=(1479.69,'K')), NASAPolynomial(coeffs=[23.7639,0.0151438,-3.35763e-06,4.00594e-10,-2.13644e-14,22457.6,-86.0325], Tmin=(1479.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(237.53,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCJCO) + radical(C=CJO) + radical(C=CJO)"""),
)

species(
    label = 'CCCCO[C]=[C][O](11705)',
    structure = SMILES('CCCCO[C]=[C][O]'),
    E0 = (179.091,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1670,1700,300,440,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.178105,0.0822246,-6.93266e-05,2.61604e-08,-2.67916e-12,21698.4,35.6963], Tmin=(100,'K'), Tmax=(1042.76,'K')), NASAPolynomial(coeffs=[18.479,0.025642,-9.48967e-06,1.6868e-09,-1.15829e-13,16992.7,-59.0013], Tmin=(1042.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(179.091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=CJO) + radical(C=CJO)"""),
)

species(
    label = 'CC[CH][CH]OC=C[O](11703)',
    structure = SMILES('CC[CH][CH]OC=C[O]'),
    E0 = (93.4319,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.693429,0.0819904,-3.07208e-05,-4.21566e-08,2.87874e-11,11425.9,33.2587], Tmin=(100,'K'), Tmax=(924.466,'K')), NASAPolynomial(coeffs=[29.2348,0.00760576,5.54705e-07,-2.27865e-10,1.0974e-14,3537.5,-121.514], Tmin=(924.466,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(93.4319,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCJCO) + radical(CCsJOC(O))"""),
)

species(
    label = 'CC[CH][CH]OC=[C]O(11788)',
    structure = SMILES('CC[CH][CH]OC=[C]O'),
    E0 = (191.714,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-2.18333,0.10567,-0.00011232,5.58355e-08,-1.02154e-11,23306.5,40.3405], Tmin=(100,'K'), Tmax=(1569.75,'K')), NASAPolynomial(coeffs=[29.0268,0.00634652,1.50468e-06,-5.38174e-10,4.20543e-14,15946.8,-116.535], Tmin=(1569.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(191.714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCJCO) + radical(CCsJOC(O)) + radical(C=CJO)"""),
)

species(
    label = 'C[CH][CH]COC=C[O](11706)',
    structure = SMILES('C[CH][CH]COC=C[O]'),
    E0 = (93.9508,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0934045,0.0724145,-2.20356e-05,-3.76325e-08,2.39298e-11,11463.3,34.3664], Tmin=(100,'K'), Tmax=(933.312,'K')), NASAPolynomial(coeffs=[23.4172,0.0163316,-3.70822e-06,5.68659e-10,-4.22877e-14,5128.76,-87.8613], Tmin=(933.312,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(93.9508,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCJCO) + radical(RCCJC)"""),
)

species(
    label = 'C[CH][CH]COC=[C]O(11789)',
    structure = SMILES('C[CH][CH]COC=[C]O'),
    E0 = (192.232,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.27179,0.0924349,-9.08558e-05,4.37156e-08,-7.9071e-12,23330.2,40.329], Tmin=(100,'K'), Tmax=(1550.91,'K')), NASAPolynomial(coeffs=[24.0477,0.0139757,-2.24733e-06,1.57004e-10,-3.93428e-15,17058.8,-87.8332], Tmin=(1550.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(192.232,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCJCO) + radical(RCCJC) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C[CH]COC=C[O](11708)',
    structure = SMILES('[CH2]C[CH]COC=C[O]'),
    E0 = (104.751,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.289362,0.0733414,-1.43939e-05,-5.2314e-08,3.06222e-11,12772.4,34.1209], Tmin=(100,'K'), Tmax=(931.739,'K')), NASAPolynomial(coeffs=[26.523,0.0117958,-1.53974e-06,1.85334e-10,-1.82726e-14,5451.08,-105.814], Tmin=(931.739,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(104.751,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCJCO) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C[CH]COC=[C]O(11790)',
    structure = SMILES('[CH2]C[CH]COC=[C]O'),
    E0 = (203.032,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.490077,0.0820526,-4.45884e-05,-1.99227e-08,1.92518e-11,24596.3,36.5602], Tmin=(100,'K'), Tmax=(923.252,'K')), NASAPolynomial(coeffs=[25.6902,0.0121439,-1.71152e-06,1.7019e-10,-1.34028e-14,17907.4,-97.6986], Tmin=(923.252,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(203.032,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCJCO) + radical(RCCJ) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.067312,0.0698281,-2.19164e-05,-3.05231e-08,1.90195e-11,-18617.4,30.4052], Tmin=(100,'K'), Tmax=(966.94,'K')), NASAPolynomial(coeffs=[21.4517,0.0207609,-6.91171e-06,1.2665e-09,-9.34631e-14,-24594.6,-81.5663], Tmin=(966.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-156.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CsCJ=O)"""),
)

species(
    label = 'CC=CCOC[C]=O(11001)',
    structure = SMILES('CC=CCOC[C]=O'),
    E0 = (-111.758,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17484,0.0673624,-4.97483e-05,2.01859e-08,-3.62886e-12,-13344.2,28.9235], Tmin=(100,'K'), Tmax=(1217.44,'K')), NASAPolynomial(coeffs=[8.55641,0.0431098,-1.98672e-05,3.82319e-09,-2.68829e-13,-15141.6,-8.1407], Tmin=(1217.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-111.758,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + radical(CsCJ=O)"""),
)

species(
    label = 'CC[CH][CH]OC[C]=O(11792)',
    structure = SMILES('CC[CH][CH]OC[C]=O'),
    E0 = (147.507,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,1855,455,950,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.313162,0.0815674,-7.72392e-05,3.93244e-08,-8.23051e-12,17873.3,33.5422], Tmin=(100,'K'), Tmax=(1134.95,'K')), NASAPolynomial(coeffs=[13.6362,0.0346118,-1.51803e-05,2.87103e-09,-2.00747e-13,14849.1,-32.4201], Tmin=(1134.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(147.507,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(CCsJOCs) + radical(CsCJ=O)"""),
)

species(
    label = 'C[CH][CH]COC[C]=O(11793)',
    structure = SMILES('C[CH][CH]COC[C]=O'),
    E0 = (161.497,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,1855,455,950,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.936033,0.0730731,-7.0655e-05,4.42294e-08,-1.25385e-11,19528.9,34.6133], Tmin=(100,'K'), Tmax=(818.451,'K')), NASAPolynomial(coeffs=[6.43216,0.0462128,-2.1429e-05,4.13374e-09,-2.91437e-13,18629.2,9.19854], Tmin=(818.451,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.497,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(RCCJC) + radical(CsCJ=O)"""),
)

species(
    label = '[CH2]C[CH]COC[C]=O(11794)',
    structure = SMILES('[CH2]C[CH]COC[C]=O'),
    E0 = (172.297,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1855,455,950,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.829406,0.073179,-6.10988e-05,2.81045e-08,-5.54377e-12,20833.7,34.0307], Tmin=(100,'K'), Tmax=(1160.83,'K')), NASAPolynomial(coeffs=[10.4478,0.0400362,-1.82727e-05,3.50956e-09,-2.46962e-13,18600.7,-13.8069], Tmin=(1160.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(172.297,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(RCCJ) + radical(CsCJ=O)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC[CH]CO[CH][C]=O(10994)'],
...
reaction(
    ...
    products = ['CC[CH]CO[CH][C]=O(10994)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CC[CH]CO[CH][C]=O(10994)'],
    products = ['[CH2]C(C)COC=[C][O](11781)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(14)', '[CH]CO[CH][C]=O(7098)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]OC=[C][O](11465)', '[CH]CC(26)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', 'CC[C]COC=[C][O](11782)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C[CH][CH]COC=C=O(11227)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'CCC=COC=[C][O](11783)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'CC[CH]CO[C]=C=O(11697)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(17)', 'C=CCO[CH][C]=O(11042)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.000791,'m^3/(mol*s)'), n=2.78, Ea=(39.748,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cds-HH_Cds-CsH;OJ_sec] for rate rule [Cds-HH_Cds-CsH;O_rad/OneDe]
...
reaction(
    label = 'reaction16',
    reactants = ['HCCO(2227)', 'CC[CH]C[O](1363)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=[C][O](6861)', 'CC[CH]C[O](1363)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(17)', '[CH2][CH]CO[CH][C]=O(11036)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', 'C[CH][CH]CO[CH][C]=O(11210)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', 'CC[CH][CH]OC=[C][O](11784)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2]C[CH]COC=[C][O](11785)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'CC[CH]CO[C]=[C][O](11700)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CC[CH]CO[C]=[C]O(11702)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CCCCO[C]=[C][O](11705)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
    transitionState = 'TS29',
    kinetics = Arrhenius(A=(3.03311e+07,'s^-1'), n=1.28625, Ea=(100.087,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R4H_SSS;Y_rad_out;Cs_H_out_H/(NonDeC/Cs)] + [R4H_SSS_OCs;Y_rad_out;Cs_H_out_H/NonDeC] for rate rule [R4H_SSS_OCs;Cd_rad_out;Cs_H_out_H/(NonDeC/Cs)]
Euclidian distance = 1.4142135623730951
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction30',
    reactants = ['CC[CH]CO[CH][C]=O(10994)'],
    products = ['CC[CH][CH]OC=C[O](11703)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CC[CH][CH]OC=[C]O(11788)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CC[CH]CO[CH][C]=O(10994)'],
    products = ['C[CH][CH]COC=C[O](11706)'],
...
reaction(
    label = 'reaction33',
    reactants = ['C[CH][CH]COC=[C]O(11789)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CC[CH]CO[CH][C]=O(10994)'],
    products = ['[CH2]C[CH]COC=C[O](11708)'],
    transitionState = 'TS34',
    kinetics = Arrhenius(A=(305745,'s^-1'), n=1.095, Ea=(83.5753,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R7Hall;Y_rad_out;Cs_H_out_2H] for rate rule [R7HJ_4;Cd_rad_out;Cs_H_out_2H]
Euclidian distance = 1.4142135623730951
Multiplied by reaction path degeneracy 3.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]C[CH]COC=[C]O(11790)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
...
reaction(
    label = 'reaction40',
    reactants = ['CC[CH][CH]OC[C]=O(11792)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
...
reaction(
    label = 'reaction41',
    reactants = ['C[CH][CH]COC[C]=O(11793)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2]C[CH]COC[C]=O(11794)'],
    products = ['CC[CH]CO[CH][C]=O(10994)'],
