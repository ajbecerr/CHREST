species(
    ...
    E0 = (-23.741,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,200,800,1200,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0600259,0.0751843,-4.92982e-05,5.66116e-09,4.41763e-12,-2703.46,24.7712], Tmin=(100,'K'), Tmax=(1011.04,'K')), NASAPolynomial(coeffs=[18.3472,0.0256135,-9.54945e-06,1.73561e-09,-1.21922e-13,-7565.53,-69.4123], Tmin=(1011.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-23.741,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
species(
    ...
    E0 = (152.889,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.363124,0.0818776,-8.07173e-05,4.3936e-08,-9.89773e-12,18517.7,24.784], Tmin=(100,'K'), Tmax=(1056.66,'K')), NASAPolynomial(coeffs=[12.4441,0.036146,-1.58e-05,2.97959e-09,-2.07927e-13,15964.6,-34.1661], Tmin=(1056.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['HCCO(2227)', 'butyl_1(16)'],
    products = ['C#COCCCC(2274)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['C#CO[CH2](3066)', 'npropyl(13)'],
    products = ['C#COCCCC(2274)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', 'C#COCC[CH2](2294)'],
    products = ['C#COCCCC(2274)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(3.18795e+10,'m^3/(mol*s)'), n=-1.17734, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.298025015457, var=0.3094099417, Tref=1000.0, N=5, correlation='Root_N-1R->H_N-1CNOS->N_N-1COS->O_1CS->C_N-1C-inRing_Ext-2R-R_Ext-3R!H-R_N-Sp-3R!H=2R',), comment="""BM rule fitted to 2 training reactions at node Root_N-1R->H_N-1CNOS->N_N-1COS->O_1CS->C_N-1C-inRing_Ext-2R-R_Ext-3R!H-R_N-Sp-3R!H=2R
    Total Standard Deviation in ln(k): 1.86393303255
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'C#COCC[CH]C(3086)'],
    products = ['C#COCCCC(2274)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.76637e+07,'m^3/(mol*s)'), n=0.153073, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=-0.00248871722291, var=1.13870876508, Tref=1000.0, N=5, correlation='Root_1R->H_N-2R->S_N-2CHNO->H_N-2CNO-inRing_Ext-2CNO-R_N-Sp-3R!H=2CCNNOO_N-2CNO->O_Ext-2CN-R',), comment="""BM rule fitted to 2 training reactions at node Root_1R->H_N-2R->S_N-2CHNO->H_N-2CNO-inRing_Ext-2CNO-R_N-Sp-3R!H=2CCNNOO_N-2CNO->O_Ext-2CN-R
    Total Standard Deviation in ln(k): 2.14551182899
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'C#CO[CH]CCC(3087)'],
    products = ['C#COCCCC(2274)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C#COCCC[CH2](3088)'],
    products = ['C#COCCCC(2274)'],
