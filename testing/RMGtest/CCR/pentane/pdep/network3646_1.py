...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.245015,0.099987,-0.000113773,7.99091e-08,-2.39947e-11,47840.8,36.6332], Tmin=(100,'K'), Tmax=(795.955,'K')), NASAPolynomial(coeffs=[9.25816,0.052228,-2.37674e-05,4.52037e-09,-3.15199e-13,46328,-7.04502], Tmin=(795.955,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(396.55,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCsJOOH) + radical(Cds_S)"""),
)
...
species(
    label = 'C=[C]CC[CH]C(C)[O](16504)',
    structure = SMILES('C=[C]CC[CH]C(C)[O]'),
    E0 = (407.772,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.217536,0.078656,-5.90724e-05,2.33311e-08,-3.80843e-12,49183.2,35.5251], Tmin=(100,'K'), Tmax=(1418.2,'K')), NASAPolynomial(coeffs=[14.8491,0.0373884,-1.5425e-05,2.81354e-09,-1.91626e-13,45033.1,-40.176], Tmin=(1418.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.772,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CCJCO) + radical(Cds_S)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.292715,0.100356,-0.000114506,7.57163e-08,-2.0912e-11,78234.2,36.4968], Tmin=(100,'K'), Tmax=(868.836,'K')), NASAPolynomial(coeffs=[11.4628,0.0462342,-2.10662e-05,4.01791e-09,-2.8104e-13,76191.5,-18.5635], Tmin=(868.836,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(649.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJ2_triplet) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]CCC1OOC1C(16506)',
    structure = SMILES('C=[C]CCC1OOC1C'),
    E0 = (205.726,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.243647,0.0820326,-5.7967e-05,2.13293e-08,-3.29864e-12,24878.2,29.3432], Tmin=(100,'K'), Tmax=(1452.99,'K')), NASAPolynomial(coeffs=[13.8446,0.0445895,-1.93119e-05,3.59319e-09,-2.46932e-13,20925.8,-41.3547], Tmin=(1452.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(205.726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(12dioxetane) + radical(Cds_S)"""),
)
...
species(
    label = 'C=[C]CCC1OC1C(16507)',
    structure = SMILES('C=[C]CCC1OC1C'),
    E0 = (154.43,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.32421,0.0709342,-2.64528e-05,-2.03409e-08,1.54438e-11,18715.2,28.8417], Tmin=(100,'K'), Tmax=(900.07,'K')), NASAPolynomial(coeffs=[14.9569,0.0334966,-1.00443e-05,1.56413e-09,-1.0046e-13,14963.5,-46.4207], Tmin=(900.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(154.43,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_S)"""),
)
...
species(
    label = 'C=[C]CCC=C(C)OO(16508)',
    structure = SMILES('C=[C]CCC=C(C)OO'),
    E0 = (175.452,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.143868,0.0907532,-8.40424e-05,4.51607e-08,-1.05172e-11,21236,35.2808], Tmin=(100,'K'), Tmax=(996.977,'K')), NASAPolynomial(coeffs=[10.2208,0.0503224,-2.32111e-05,4.48269e-09,-3.16699e-13,19226.7,-13.3038], Tmin=(996.977,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(175.452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)

species(
    label = 'C=CCC=CC(C)O[O](16509)',
    structure = SMILES('C=CCC=CC(C)O[O]'),
    E0 = (80.7817,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.37125,0.0855532,-6.39648e-05,2.43971e-08,-3.76005e-12,9881.8,38.0357], Tmin=(100,'K'), Tmax=(1525.09,'K')), NASAPolynomial(coeffs=[19.0718,0.0345589,-1.38103e-05,2.47335e-09,-1.66261e-13,3951.21,-63.9723], Tmin=(1525.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(80.7817,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = 'C=C=CCCC(C)O[O](16510)',
    structure = SMILES('C=C=CCCC(C)O[O]'),
    E0 = (127.536,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.047904,0.0918637,-8.20763e-05,4.10479e-08,-8.68888e-12,15482.4,33.8427], Tmin=(100,'K'), Tmax=(1103.52,'K')), NASAPolynomial(coeffs=[12.4336,0.0466215,-2.05795e-05,3.89624e-09,-2.72293e-13,12727.7,-27.6028], Tmin=(1103.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(127.536,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(ROOJ)"""),
)

species(
    label = 'C=[C]CC=CC(C)OO(16511)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.333762,0.0899905,-7.17071e-05,2.93029e-08,-4.88128e-12,20199.7,37.6026], Tmin=(100,'K'), Tmax=(1405.05,'K')), NASAPolynomial(coeffs=[17.8686,0.0381704,-1.63848e-05,3.05353e-09,-2.10712e-13,15084.7,-56.4032], Tmin=(1405.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(166.619,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)

species(
    label = 'C=CCCC=C(C)O[O](15555)',
    structure = SMILES('C=CCCC=C(C)O[O]'),
    E0 = (89.6153,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.368667,0.0835865,-6.82749e-05,3.166e-08,-6.37319e-12,10905.8,34.7465], Tmin=(100,'K'), Tmax=(1133.67,'K')), NASAPolynomial(coeffs=[10.4304,0.0480858,-2.13039e-05,4.03893e-09,-2.82264e-13,8624.4,-15.0584], Tmin=(1133.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.6153,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)
...
species(
    label = 'C=C=CC[CH]C(C)O[O](16514)',
    structure = SMILES('C=C=CC[CH]C(C)O[O]'),
    E0 = (327.951,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,540,610,2055,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.020668,0.0937119,-9.67179e-05,5.78352e-08,-1.46359e-11,39583.7,36.0609], Tmin=(100,'K'), Tmax=(937.152,'K')), NASAPolynomial(coeffs=[11.0496,0.0464609,-2.10875e-05,4.03299e-09,-2.83167e-13,37508.8,-16.6278], Tmin=(937.152,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(327.951,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(ROOJ) + radical(CCJCOOH)"""),
)

species(
    label = 'C#CCC[CH]C(C)O[O](16515)',
    structure = SMILES('C#CCC[CH]C(C)O[O]'),
    E0 = (329.695,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2175,525,750,770,3400,2100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.347491,0.0999888,-0.000116627,7.94114e-08,-2.23431e-11,39805.8,36.4543], Tmin=(100,'K'), Tmax=(859.001,'K')), NASAPolynomial(coeffs=[11.6918,0.0439296,-1.87408e-05,3.44565e-09,-2.35407e-13,37737.3,-19.7992], Tmin=(859.001,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(329.695,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(ROOJ) + radical(CCJCOOH)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.677348,0.086752,-4.77652e-05,-6.76289e-08,8.9822e-11,46761.4,33.6064], Tmin=(100,'K'), Tmax=(486.376,'K')), NASAPolynomial(coeffs=[7.47201,0.0552157,-2.5583e-05,4.87256e-09,-3.38519e-13,45812.5,2.76345], Tmin=(486.376,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(387.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(C2CsJOOH) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]C[CH]CC(C)O[O](16436)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12625,0.0784127,-6.07255e-06,-1.71773e-07,1.8282e-10,47652.2,34.3844], Tmin=(100,'K'), Tmax=(442.479,'K')), NASAPolynomial(coeffs=[6.89501,0.0551671,-2.52536e-05,4.75451e-09,-3.26733e-13,46858.8,8.0598], Tmin=(442.479,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(395.477,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(RCCJCC) + radical(Cds_S)"""),
)
...
species(
    label = 'C=[C]CC[CH][C](C)OO(16522)',
    structure = SMILES('C=[C]CC[CH][C](C)OO'),
    E0 = (436.328,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.32087,0.0945575,-7.26108e-05,-2.3922e-08,5.78986e-11,52597,36.3916], Tmin=(100,'K'), Tmax=(508.411,'K')), NASAPolynomial(coeffs=[8.18064,0.055835,-2.65643e-05,5.12592e-09,-3.59113e-13,51499,0.851544], Tmin=(508.411,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(436.328,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C2CsJOOH) + radical(CCJCOOH) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(CCC[C]=C)O[O](16523)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.27776,0.0996885,-0.000106973,6.7041e-08,-1.77077e-11,50059.9,38.5331], Tmin=(100,'K'), Tmax=(902.7,'K')), NASAPolynomial(coeffs=[11.2873,0.0484419,-2.18175e-05,4.15084e-09,-2.90332e-13,47972,-16.0776], Tmin=(902.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(414.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CJCOOH) + radical(Cds_S)"""),
)

species(
    label = 'C=[C][CH]CCC(C)O[O](16524)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.109965,0.094143,-8.83882e-05,4.713e-08,-1.06437e-11,41070.2,35.7704], Tmin=(100,'K'), Tmax=(1040.47,'K')), NASAPolynomial(coeffs=[12.0356,0.0474495,-2.10711e-05,3.99677e-09,-2.79595e-13,38542.8,-23.3066], Tmin=(1040.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(340.272,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2]C([CH]CC[C]=C)OO(16525)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.4599,0.104588,-0.000115421,7.29867e-08,-1.9344e-11,55888.1,40.7363], Tmin=(100,'K'), Tmax=(901.077,'K')), NASAPolynomial(coeffs=[12.0908,0.0488754,-2.26806e-05,4.37431e-09,-3.08317e-13,53626.3,-18.5065], Tmin=(901.077,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(463.391,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJCOOH) + radical(CJCOOH) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]C[CH][CH]C(C)OO(16526)',
    structure = SMILES('C=[C]C[CH][CH]C(C)OO'),
    E0 = (443.887,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.761464,0.086572,-3.46269e-05,-1.14543e-07,1.35453e-10,53487.9,37.1873], Tmin=(100,'K'), Tmax=(462.343,'K')), NASAPolynomial(coeffs=[7.56049,0.0558767,-2.62947e-05,5.02347e-09,-3.48716e-13,52558.6,6.38001], Tmin=(462.343,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(443.887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJCOOH) + radical(RCCJCC) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]=[C]CCCC(C)O[O](16527)',
    structure = SMILES('[CH]=[C]CCCC(C)O[O]'),
    E0 = (448.115,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.294776,0.10058,-0.000110724,7.21227e-08,-1.98548e-11,54045.1,37.003], Tmin=(100,'K'), Tmax=(867.321,'K')), NASAPolynomial(coeffs=[10.7711,0.0495449,-2.24608e-05,4.27935e-09,-2.99292e-13,52125.5,-14.8082], Tmin=(867.321,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(448.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = 'C=[C][CH]C[CH]C(C)OO(16528)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.281569,0.0989193,-9.64127e-05,5.25361e-08,-1.20524e-11,46898,37.9358], Tmin=(100,'K'), Tmax=(1027.55,'K')), NASAPolynomial(coeffs=[12.8218,0.0479101,-2.19487e-05,4.22348e-09,-2.97835e-13,44205.2,-25.6363], Tmin=(1027.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(388.683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCJCOOH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C([CH]CCC=C)O[O](16529)',
    structure = SMILES('[CH2]C([CH]CCC=C)O[O]'),
    E0 = (377.554,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.189644,0.0968056,-9.71937e-05,5.59673e-08,-1.3594e-11,45556.3,40.0451], Tmin=(100,'K'), Tmax=(975.323,'K')), NASAPolynomial(coeffs=[11.8545,0.0474092,-2.12229e-05,4.03764e-09,-2.82822e-13,43206.9,-17.7598], Tmin=(975.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(377.554,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CJCOOH)"""),
)

species(
    label = '[CH]=[C]CC[CH]C(C)OO(16530)',
    structure = SMILES('[CH]=[C]CC[CH]C(C)OO'),
    E0 = (496.525,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.478566,0.105497,-0.000119229,7.81367e-08,-2.15181e-11,59873.4,39.2122], Tmin=(100,'K'), Tmax=(868.281,'K')), NASAPolynomial(coeffs=[11.5716,0.0499843,-2.33277e-05,4.50379e-09,-3.17362e-13,57780.8,-17.221], Tmin=(868.281,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(496.525,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJCOOH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'C=[C]CC[CH]CO[O](15491)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['C=[C]CCC(C)[CH]O[O](16503)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['C=[C]CC[CH]C(C)O[O](15551)'],
    products = ['O2(S)(666)', 'C=[C]CCC=CC(15532)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction7',
    reactants = ['O(4)', 'C=[C]CC[CH]C(C)[O](16504)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C[CH]O[O](57)', '[CH]CC[C]=C(15604)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]C(C)O[O](668)', '[CH2]C[C]=C(2373)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H2CC(T)(1341)', '[CH2]C[CH]C(C)O[O](7603)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C=[C]CC[C]C(C)O[O](16505)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C=[C]CC[CH]C(C)O[O](15551)'],
    products = ['O(4)', 'C=[C]CCC1OC1C(16507)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C=[C]CC[CH]C(C)O[O](15551)'],
    products = ['HO2(9)', 'C=[C]CC[CH]C=C(15535)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', 'C=[C]CCC=C(C)O[O](16512)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', 'C=[C]CC=CC(C)O[O](16513)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C=C=CC[CH]C(C)O[O](16514)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', 'C#CCC[CH]C(C)O[O](16515)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH3(17)', 'C=[C]CCC=CO[O](16288)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O2(2)', 'C=[C]CCC=CC(15532)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
...
reaction(
    label = 'reaction29',
    reactants = ['O2(2)', 'C=[C]CC[CH][CH]C(15526)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH3(17)', 'C=[C]CC[CH][CH]O[O](16292)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', 'C=[C]CC[CH][C](C)O[O](16516)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', 'C=[C]C[CH][CH]C(C)O[O](16517)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', 'C=[C][CH]C[CH]C(C)O[O](16518)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(3)', '[CH2]C([CH]CC[C]=C)O[O](16519)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', '[CH]=[C]CC[CH]C(C)O[O](16520)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
...
reaction(
    label = 'reaction37',
    reactants = ['C=[C]CC[CH]C(C)O[O](15551)'],
    products = ['C=[C]CCC[C](C)O[O](16521)'],
...
reaction(
    label = 'reaction38',
    reactants = ['C=[C]CC[CH]C(C)O[O](15551)'],
    products = ['C=[C]C[CH]CC(C)O[O](16436)'],
...
reaction(
    label = 'reaction39',
    reactants = ['C=[C]CC[CH]C(C)O[O](15551)'],
    products = ['[CH2]C=CC[CH]C(C)O[O](8226)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH]=CCC[CH]C(C)O[O](8405)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
...
reaction(
    label = 'reaction41',
    reactants = ['C=[C]CC[CH][C](C)OO(16522)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2]C(CCC[C]=C)O[O](16523)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
...
reaction(
    label = 'reaction43',
    reactants = ['C=[C]CC[CH]C(C)O[O](15551)'],
    products = ['C=[C][CH]CCC(C)O[O](16524)'],
...
reaction(
    label = 'reaction44',
    reactants = ['C=[C]CC[CH]C(C)O[O](15551)'],
    products = ['[CH2][CH]CC=CC(C)O[O](8225)'],
...
reaction(
    label = 'reaction45',
    reactants = ['C=[C]CC[CH]C(C)O[O](15551)'],
    products = ['[CH2]C([CH]CC[C]=C)OO(16525)'],
...
reaction(
    label = 'reaction46',
    reactants = ['C=[C]C[CH][CH]C(C)OO(16526)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
...
reaction(
    label = 'reaction47',
    reactants = ['C=[C]CC[CH]C(C)O[O](15551)'],
    products = ['[CH2][CH]CCC=C(C)O[O](8224)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH]=[C]CCCC(C)O[O](16527)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
...
reaction(
    label = 'reaction49',
    reactants = ['C=[C]CC[CH]C(C)O[O](15551)'],
    products = ['C=[C][CH]C[CH]C(C)OO(16528)'],
...
reaction(
    label = 'reaction50',
    reactants = ['C=[C]CC[CH]C(C)O[O](15551)'],
    products = ['[CH2]C([CH]CCC=C)O[O](16529)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH]=[C]CC[CH]C(C)OO(16530)'],
    products = ['C=[C]CC[CH]C(C)O[O](15551)'],
