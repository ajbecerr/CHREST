...
species(
    ...
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.520216,0.0674122,-3.67844e-05,1.7627e-09,3.91041e-12,32043.3,32.7472], Tmin=(100,'K'), Tmax=(1026.61,'K')), NASAPolynomial(coeffs=[13.5816,0.0336365,-1.24417e-05,2.19435e-09,-1.49316e-13,28459.6,-35.002], Tmin=(1026.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(265.316,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11502,0.0651407,-4.2189e-05,1.44232e-08,-2.12353e-12,-12679.4,27.4655], Tmin=(100,'K'), Tmax=(1470.74,'K')), NASAPolynomial(coeffs=[10.0184,0.040926,-1.74926e-05,3.2287e-09,-2.20662e-13,-15298.3,-18.9229], Tmin=(1470.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-106.269,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(RCCJ)"""),
)
...
species(
    ...
    E0 = (489.401,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,330.561,330.562,1731.43],'cm^-1')),
        HinderedRotor(inertia=(5.62326e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.346248,'amu*angstrom^2'), symmetry=1, barrier=(26.8483,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00761436,'amu*angstrom^2'), symmetry=1, barrier=(86.4539,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00539737,'amu*angstrom^2'), symmetry=1, barrier=(11.4822,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    ...
    E0 = (416.041,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,260.834,947.872,2086.67],'cm^-1')),
        HinderedRotor(inertia=(0.0756947,'amu*angstrom^2'), symmetry=1, barrier=(3.34934,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0756947,'amu*angstrom^2'), symmetry=1, barrier=(3.34934,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0756947,'amu*angstrom^2'), symmetry=1, barrier=(3.34934,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0756947,'amu*angstrom^2'), symmetry=1, barrier=(3.34934,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0756947,'amu*angstrom^2'), symmetry=1, barrier=(3.34934,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (440.095,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,219.24,827.214,1691.94],'cm^-1')),
        HinderedRotor(inertia=(0.138005,'amu*angstrom^2'), symmetry=1, barrier=(3.41617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138005,'amu*angstrom^2'), symmetry=1, barrier=(3.41617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138005,'amu*angstrom^2'), symmetry=1, barrier=(3.41617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138005,'amu*angstrom^2'), symmetry=1, barrier=(3.41617,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138005,'amu*angstrom^2'), symmetry=1, barrier=(3.41617,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.570604,0.065449,-3.29053e-05,1.53105e-09,2.65851e-12,26771.9,30.2773], Tmin=(100,'K'), Tmax=(1143.73,'K')), NASAPolynomial(coeffs=[13.5049,0.0357704,-1.43848e-05,2.6284e-09,-1.80912e-13,22795.8,-38.3083], Tmin=(1143.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(221.499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJ(C)CO) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]C(C)[C](C)O(4609)',
    structure = SMILES('[CH2][CH]C(C)[C](C)O'),
    E0 = (209.734,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.734531,0.0768561,-7.45307e-05,4.51235e-08,-1.204e-11,25338.4,31.6771], Tmin=(100,'K'), Tmax=(876.448,'K')), NASAPolynomial(coeffs=[7.681,0.0451548,-2.02779e-05,3.85832e-09,-2.70008e-13,24120.7,-0.919783], Tmin=(876.448,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.734,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC(C)[C](C)[O](4610)',
    structure = SMILES('[CH2]CC(C)[C](C)[O]'),
    E0 = (245.553,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.650086,0.0749678,-6.12448e-05,2.81186e-08,-5.51565e-12,29652.6,29.216], Tmin=(100,'K'), Tmax=(1175.45,'K')), NASAPolynomial(coeffs=[10.752,0.0405916,-1.73774e-05,3.23898e-09,-2.2418e-13,27277.8,-21.1531], Tmin=(1175.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(245.553,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (99.1509,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.799388,0.0658517,-4.17438e-05,1.33623e-08,-1.76221e-12,22450.7,32.2029], Tmin=(100,'K'), Tmax=(1700.23,'K')), NASAPolynomial(coeffs=[14.1216,0.0345092,-1.4092e-05,2.5198e-09,-1.67912e-13,17920.6,-39.1397], Tmin=(1700.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(185.68,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(Cs_S) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', '[CH2][CH]CC(C)[O](1690)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(11)', '[CH2][CH]C(C)C[O](4602)'],
    products = ['[CH2][CH]C(C)C(C)[O](2038)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(143764,'m^3/(mol*s)'), n=0.444, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [carbene;R_H]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(C)[CH]C(C)[O](4603)'],
    products = ['[CH2][CH]C(C)C(C)[O](2038)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH2][C]C(C)C(C)[O](4604)'],
    products = ['[CH2][CH]C(C)C(C)[O](2038)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH][CH]C(C)C(C)[O](4605)'],
    products = ['[CH2][CH]C(C)C(C)[O](2038)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH2]C=C(C)C(C)[O](4403)'],
    products = ['[CH2][CH]C(C)C(C)[O](2038)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2][CH]C(C)C(C)=O(2752)'],
    products = ['[CH2][CH]C(C)C(C)[O](2038)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(17)', '[CH2]C=CC(C)[O](1902)'],
    products = ['[CH2][CH]C(C)C(C)[O](2038)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(17)', '[CH2][CH]C(C)C=O(3828)'],
    products = ['[CH2][CH]C(C)C(C)[O](2038)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH3(17)', '[CH2][CH][CH]C(C)[O](1913)'],
    products = ['[CH2][CH]C(C)C(C)[O](2038)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2][CH][C](C)C(C)[O](4411)'],
    products = ['[CH2][CH]C(C)C(C)[O](2038)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH3(17)', '[CH2][CH]C(C)[CH][O](4396)'],
    products = ['[CH2][CH]C(C)C(C)[O](2038)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH2][CH]C(C)[C](C)[O](4408)'],
    products = ['[CH2][CH]C(C)C(C)[O](2038)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2][CH]C(C)C(C)[O](2038)'],
    products = ['[CH2][CH]C(C)[C](C)O(4609)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2][CH]C(C)C(C)[O](2038)'],
    products = ['[CH2][CH][C](C)C(C)O(4611)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2][CH]C([CH2])C(C)O(4612)'],
    products = ['[CH2][CH]C(C)C(C)[O](2038)'],
