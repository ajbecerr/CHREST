...
species(
    label = 'C=C([O])C[C]C(2447)',
    structure = SMILES('C=C([O])C[C]C'),
    E0 = (331.159,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,347.47,349.226,349.564,349.709],'cm^-1')),
        HinderedRotor(inertia=(0.00140997,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164725,'amu*angstrom^2'), symmetry=1, barrier=(14.2588,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.167861,'amu*angstrom^2'), symmetry=1, barrier=(14.2716,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21185,0.0541356,-3.71639e-05,6.99971e-09,2.04728e-12,39936,23.7933], Tmin=(100,'K'), Tmax=(999.82,'K')), NASAPolynomial(coeffs=[13.3449,0.0198628,-7.15107e-06,1.26069e-09,-8.66271e-14,36796.7,-38.3057], Tmin=(999.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(331.159,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.953364,0.0557141,-2.30748e-05,-1.77922e-08,1.32805e-11,-18642.1,19.9791], Tmin=(100,'K'), Tmax=(941.076,'K')), NASAPolynomial(coeffs=[16.8666,0.0160983,-4.59648e-06,7.59538e-10,-5.35637e-14,-22878.1,-62.4196], Tmin=(941.076,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-155.997,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CCC(=C)O(2253)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23937,0.0467515,1.42069e-06,-4.20758e-08,2.14756e-11,-15019.2,22.7895], Tmin=(100,'K'), Tmax=(946.628,'K')), NASAPolynomial(coeffs=[16.7612,0.0158265,-4.50245e-06,7.77403e-10,-5.74636e-14,-19510.9,-59.4462], Tmin=(946.628,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-125.809,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57795,0.0526696,-4.77329e-05,2.98444e-08,-7.82596e-12,26975.7,23.7852], Tmin=(100,'K'), Tmax=(1072.73,'K')), NASAPolynomial(coeffs=[5.84213,0.0311921,-9.90224e-06,1.48734e-09,-8.78602e-14,26381.7,4.4093], Tmin=(1072.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(223.56,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(RCCJC)"""),
)

species(
    label = 'CC1C[C]([O])C1(2450)',
...
species(
    ...
    E0 = (88.1906,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,180,180,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00969444,'amu*angstrom^2'), symmetry=1, barrier=(1.72592,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0990121,'amu*angstrom^2'), symmetry=1, barrier=(17.4019,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0951243,'amu*angstrom^2'), symmetry=1, barrier=(17.402,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    label = '[CH]=C(O)C[CH]C(2455)',
    structure = SMILES('[CH]=C(O)C[CH]C'),
    E0 = (186.682,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,350,440,435,1725,3120,650,792.5,1650,392.179],'cm^-1')),
        HinderedRotor(inertia=(0.00109611,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0967758,'amu*angstrom^2'), symmetry=1, barrier=(10.5613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0967746,'amu*angstrom^2'), symmetry=1, barrier=(10.5615,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.096774,'amu*angstrom^2'), symmetry=1, barrier=(10.5613,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05164,0.0584477,-4.50718e-05,1.47093e-08,-6.08857e-13,22564.4,26.1003], Tmin=(100,'K'), Tmax=(1008.71,'K')), NASAPolynomial(coeffs=[13.1531,0.0219255,-7.81149e-06,1.35218e-09,-9.12547e-14,19539.7,-35.2783], Tmin=(1008.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(186.682,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJC) + radical(Cds_P)"""),
)
...
species(
    ...
    E0 = (144.832,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,180,570.543],'cm^-1')),
        HinderedRotor(inertia=(0.0143289,'amu*angstrom^2'), symmetry=1, barrier=(3.30992,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.014329,'amu*angstrom^2'), symmetry=1, barrier=(3.30992,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.045039,'amu*angstrom^2'), symmetry=1, barrier=(10.4037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0450378,'amu*angstrom^2'), symmetry=1, barrier=(10.4037,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8439,0.0371821,7.58188e-06,-2.84845e-08,1.0818e-11,-17715.3,21.0088], Tmin=(100,'K'), Tmax=(1132.82,'K')), NASAPolynomial(coeffs=[10.9324,0.0291217,-1.35655e-05,2.68708e-09,-1.93818e-13,-21316.4,-30.7771], Tmin=(1132.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-148.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', '[CH]CC(=C)[O](2374)'],
    products = ['[CH2]C(=O)C[CH]C(1679)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'C=C([O])C[C]C(2447)'],
    products = ['[CH2]C(=O)C[CH]C(1679)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C([O])[CH][CH]C(1681)'],
    products = ['[CH2]C(=O)C[CH]C(1679)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'C=C([O])[CH][CH]C(2452)'],
    products = ['[CH2]C(=O)C[CH]C(1679)'],
