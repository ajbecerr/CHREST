...
species(
    label = '[CH]=C(C[O])C[CH]C(19602)',
    structure = SMILES('[CH]=C(C[O])C[CH]C'),
    E0 = (434.755,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3025,407.5,1350,352.5,3120,650,792.5,1650,180,1915.5,1915.57],'cm^-1')),
        HinderedRotor(inertia=(0.154303,'amu*angstrom^2'), symmetry=1, barrier=(3.54772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154236,'amu*angstrom^2'), symmetry=1, barrier=(3.5462,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154275,'amu*angstrom^2'), symmetry=1, barrier=(3.54708,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154278,'amu*angstrom^2'), symmetry=1, barrier=(3.54716,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18842,0.0695948,-8.96256e-05,8.26589e-08,-3.1552e-11,52382.6,30.9241], Tmin=(100,'K'), Tmax=(815.979,'K')), NASAPolynomial(coeffs=[2.19858,0.0488993,-2.26404e-05,4.28564e-09,-2.95476e-13,52741.9,29.4677], Tmin=(815.979,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(434.755,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ) + radical(RCCJC) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(C[C]C)CO[O](19603)',
    structure = SMILES('[CH]=C(C[C]C)CO[O]'),
    E0 = (686.328,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3120,650,792.5,1650,200,800,1600],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.283398,0.0868897,-0.00010638,7.55015e-08,-2.21738e-11,82675.4,32.0165], Tmin=(100,'K'), Tmax=(822.919,'K')), NASAPolynomial(coeffs=[10.3494,0.0379625,-1.71985e-05,3.25479e-09,-2.26015e-13,81018.7,-14.5846], Tmin=(822.919,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(686.328,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[C]=C(C[CH]C)CO[O](19604)',
    structure = SMILES('[C]=C(C[CH]C)CO[O]'),
    E0 = (743.565,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3025,407.5,1350,352.5,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.417286,0.0889373,-0.000135124,1.23029e-07,-4.4123e-11,89549.5,34.3266], Tmin=(100,'K'), Tmax=(846.251,'K')), NASAPolynomial(coeffs=[5.07777,0.0458415,-2.1394e-05,4.01615e-09,-2.73689e-13,89515,17.0775], Tmin=(846.251,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(743.565,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(RCCJC) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.842025,0.0492975,3.03849e-05,-6.9876e-08,2.77218e-11,16774.7,23.941], Tmin=(100,'K'), Tmax=(1045.04,'K')), NASAPolynomial(coeffs=[17.5598,0.0332103,-1.52801e-05,3.11655e-09,-2.32587e-13,10664.8,-69.9643], Tmin=(1045.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.383,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclohexanone) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74728,0.0311317,5.59486e-05,-9.22374e-08,3.67479e-11,13222.9,23.4165], Tmin=(100,'K'), Tmax=(968.415,'K')), NASAPolynomial(coeffs=[13.6387,0.0277897,-9.77712e-06,1.81855e-09,-1.33455e-13,8773.27,-44.6534], Tmin=(968.415,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(109.129,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.150288,0.0844289,-8.11988e-05,4.18189e-08,-8.80061e-12,22481.9,29.1433], Tmin=(100,'K'), Tmax=(1133.99,'K')), NASAPolynomial(coeffs=[14.3829,0.0342249,-1.47905e-05,2.77766e-09,-1.93519e-13,19253.9,-41.3106], Tmin=(1133.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(185.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C(CC=C)COO(19610)',
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.467681,0.0786194,-6.93503e-05,3.29813e-08,-6.53331e-12,26004.1,31.1817], Tmin=(100,'K'), Tmax=(1182.51,'K')), NASAPolynomial(coeffs=[12.8172,0.0368454,-1.63605e-05,3.10721e-09,-2.1749e-13,23083.4,-30.4681], Tmin=(1182.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(215.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(CC[CH2])CO[O](19614)',
    structure = SMILES('[CH]=C(CC[CH2])CO[O]'),
    E0 = (443.359,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,350,440,435,1725,3000,3100,440,815,1455,1000,3120,650,792.5,1650,246.981,3828.5],'cm^-1')),
        HinderedRotor(inertia=(0.206417,'amu*angstrom^2'), symmetry=1, barrier=(8.93367,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.206406,'amu*angstrom^2'), symmetry=1, barrier=(8.93377,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.25478,'amu*angstrom^2'), symmetry=1, barrier=(54.2823,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00276323,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.206462,'amu*angstrom^2'), symmetry=1, barrier=(8.93371,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.420082,0.0839768,-9.50794e-05,6.49352e-08,-1.87875e-11,53448,33.4094], Tmin=(100,'K'), Tmax=(827.194,'K')), NASAPolynomial(coeffs=[9.10009,0.042005,-1.8972e-05,3.59948e-09,-2.50792e-13,52012,-6.82015], Tmin=(827.194,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(443.359,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(RCCJ) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.552208,0.0771459,-5.56643e-05,2.13725e-08,-3.51582e-12,40842.4,29.5294], Tmin=(100,'K'), Tmax=(1356.05,'K')), NASAPolynomial(coeffs=[11.5826,0.0446088,-1.9673e-05,3.67818e-09,-2.53701e-13,37850.9,-27.0455], Tmin=(1356.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(338.564,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C(C[CH][CH2])COO(19620)',
    structure = SMILES('[CH]=C(C[CH][CH2])COO'),
    E0 = (485.801,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,440,435,1725,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3120,650,792.5,1650,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.23287,0.0894128,-0.000116609,9.48483e-08,-3.23239e-11,58557.8,36.0456], Tmin=(100,'K'), Tmax=(778.956,'K')), NASAPolynomial(coeffs=[7.78578,0.0451765,-2.09272e-05,3.97534e-09,-2.75403e-13,57546.5,2.55555], Tmin=(778.956,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(485.801,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJC) + radical(RCCJ) + radical(Cds_P)"""),
)
...
reaction(
    ...
    products = ['[CH]=C(C[CH]C)CO[O](19247)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(4)', '[CH]=C(C[O])C[CH]C(19602)'],
    products = ['[CH]=C(C[CH]C)CO[O](19247)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHCH3(T)(21)', '[CH]=C([CH2])CO[O](19529)'],
    products = ['[CH]=C(C[CH]C)CO[O](19247)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH]CC(=[CH])CO[O](19530)'],
    products = ['[CH]=C(C[CH]C)CO[O](19247)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]=C(C[C]C)CO[O](19603)'],
    products = ['[CH]=C(C[CH]C)CO[O](19247)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[C]=C(C[CH]C)CO[O](19604)'],
    products = ['[CH]=C(C[CH]C)CO[O](19247)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(C[CH]C)CO[O](19247)'],
    products = ['O(4)', '[CH]=C1COC(C)C1(19607)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH]=C(C=CC)CO[O](19611)'],
    products = ['[CH]=C(C[CH]C)CO[O](19247)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH]=C(CC=C)CO[O](19282)'],
    products = ['[CH]=C(C[CH]C)CO[O](19247)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]O[O](46)', 'C#CC[CH]C(9726)'],
    products = ['[CH]=C(C[CH]C)CO[O](19247)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH]=C([CH][CH]C)CO[O](19612)'],
    products = ['[CH]=C(C[CH]C)CO[O](19247)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]O[O](46)', '[CH]=[C]C[CH]C(9720)'],
    products = ['[CH]=C(C[CH]C)CO[O](19247)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH]=C(C[CH][CH2])CO[O](19278)'],
    products = ['[CH]=C(C[CH]C)CO[O](19247)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]=C([CH]CC)CO[O](19563)'],
    products = ['[CH]=C(C[CH]C)CO[O](19247)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]=C(CC[CH2])CO[O](19614)'],
    products = ['[CH]=C(C[CH]C)CO[O](19247)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]=C(C[CH]C)CO[O](19247)'],
    products = ['[CH]=C([CH]OO)C[CH]C(19615)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]=C(C[CH]C)CO[O](19247)'],
    products = ['[CH]=C([CH]O[O])CCC(19618)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]=C(C[CH]C)CO[O](19247)'],
    products = ['[CH]=C([CH][CH]C)COO(19619)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH]=C(C[CH][CH2])COO(19620)'],
    products = ['[CH]=C(C[CH]C)CO[O](19247)'],
