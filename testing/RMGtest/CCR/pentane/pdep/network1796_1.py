...
species(
    label = 'CC[CH]C[CH]CC(C)O[O](7863)',
    structure = SMILES('CC[CH]C[CH]CC(C)O[O]'),
    E0 = (200.531,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.90595,0.119508,-0.000154696,1.36667e-07,-5.01818e-11,24283.7,45.1977], Tmin=(100,'K'), Tmax=(814.092,'K')), NASAPolynomial(coeffs=[3.77441,0.0754278,-3.46307e-05,6.53257e-09,-4.49658e-13,24220.3,27.8712], Tmin=(814.092,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.531,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(RCCJCC)"""),
)
...
species(
    label = '[CH2]C(C)CC([CH2])C(C)O[O](7864)',
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.29685,0.116112,-0.000108086,5.80187e-08,-1.29944e-11,25897.8,44.4815], Tmin=(100,'K'), Tmax=(1062.76,'K')), NASAPolynomial(coeffs=[14.944,0.0549849,-2.18107e-05,3.89845e-09,-2.6342e-13,22445.7,-34.86], Tmin=(1062.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(213.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C[CH]CC)C(C)[O](7865)',
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.241903,0.0969998,-7.67605e-05,3.65992e-08,-7.77152e-12,26087.4,40.0493], Tmin=(100,'K'), Tmax=(1069.61,'K')), NASAPolynomial(coeffs=[9.50139,0.0605628,-2.56617e-05,4.75021e-09,-3.27408e-13,24003.1,-7.61206], Tmin=(1069.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(215.659,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJCC) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(C[C]CC)C(C)O[O](7866)',
...
species(
    label = '[CH]C(C[CH]CC)C(C)O[O](7867)',
    structure = SMILES('[CH]C(C[CH]CC)C(C)O[O]'),
    E0 = (451.941,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.925252,0.115974,-0.000125773,8.60906e-08,-2.55643e-11,54526.4,43.4498], Tmin=(100,'K'), Tmax=(799.924,'K')), NASAPolynomial(coeffs=[9.38555,0.0644165,-2.90962e-05,5.52156e-09,-3.84812e-13,52876.7,-3.99237], Tmin=(799.924,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(451.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'CC[CH]CC1COOC1C(7868)',
    structure = SMILES('CC[CH]CC1COOC1C'),
    E0 = (-70.5478,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.561983,0.0864325,-2.07422e-05,-3.15095e-08,1.85223e-11,-8308.15,37.1001], Tmin=(100,'K'), Tmax=(951.141,'K')), NASAPolynomial(coeffs=[15.7352,0.0511388,-1.75091e-05,2.97113e-09,-1.99296e-13,-12912.1,-48.6128], Tmin=(951.141,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-70.5478,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(586.17,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxolane) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C1CC(CC)OOC1C(7869)',
    structure = SMILES('[CH2]C1CC(CC)OOC1C'),
    E0 = (-80.8215,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.650005,0.0787099,2.63896e-05,-9.89354e-08,4.75486e-11,-9531.27,33.7034], Tmin=(100,'K'), Tmax=(914.279,'K')), NASAPolynomial(coeffs=[22.4611,0.0392924,-1.01588e-05,1.5202e-09,-1.01281e-13,-16335.8,-89.8246], Tmin=(914.279,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-80.8215,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(590.328,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxane) + radical(Isobutyl)"""),
)

species(
    label = 'CC[CH]CC1COC1C(7870)',
    structure = SMILES('CC[CH]CC1COC1C'),
    E0 = (-42.4468,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.204,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0123306,0.076838,-1.618e-05,-2.62415e-08,1.47291e-11,-4951.88,34.2524], Tmin=(100,'K'), Tmax=(956.561,'K')), NASAPolynomial(coeffs=[11.8168,0.0528912,-1.84828e-05,3.1394e-09,-2.08993e-13,-8372.97,-28.2508], Tmin=(956.561,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.4468,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(561.227,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C1CC(CC)OC1C(7871)',
    structure = SMILES('[CH2]C1CC(CC)OC1C'),
    E0 = (-122.928,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.204,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.143684,0.0637897,4.25965e-05,-1.03405e-07,4.66218e-11,-14626.5,29.7631], Tmin=(100,'K'), Tmax=(913.809,'K')), NASAPolynomial(coeffs=[17.6482,0.0419898,-1.1609e-05,1.79238e-09,-1.19057e-13,-20114.6,-65.6328], Tmin=(913.809,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-122.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(Isobutyl)"""),
)
...
species(
    label = 'C=C(CCCC)C(C)O[O](7872)',
    structure = SMILES('C=C(CCCC)C(C)O[O]'),
    E0 = (-75.0798,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.12292,0.108204,-8.33902e-05,3.39707e-08,-5.73569e-12,-8842.28,41.4109], Tmin=(100,'K'), Tmax=(1372.1,'K')), NASAPolynomial(coeffs=[18.2364,0.0517668,-2.16923e-05,3.99328e-09,-2.73727e-13,-14154.9,-58.1109], Tmin=(1372.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.0798,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = 'CCC=CC(C)C(C)O[O](7873)',
    structure = SMILES('CCC=CC(C)C(C)O[O]'),
    E0 = (-79.686,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06744,0.105391,-7.82069e-05,3.06584e-08,-4.98186e-12,-9396.97,41.1087], Tmin=(100,'K'), Tmax=(1421.14,'K')), NASAPolynomial(coeffs=[18.197,0.0511682,-2.09748e-05,3.81022e-09,-2.58827e-13,-14872.4,-58.6017], Tmin=(1421.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.686,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = 'C=C(C[CH]CC)C(C)OO(7874)',
    structure = SMILES('C=C(C[CH]CC)C(C)OO'),
    E0 = (-32.6262,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.663458,0.106722,-8.32282e-05,3.5716e-08,-6.61188e-12,-3759.88,41.569], Tmin=(100,'K'), Tmax=(1221.56,'K')), NASAPolynomial(coeffs=[13.2551,0.0611464,-2.72641e-05,5.1738e-09,-3.61271e-13,-7160.36,-28.3653], Tmin=(1221.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-32.6262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJCC)"""),
)

species(
    label = 'CC=CCC(C)C(C)O[O](7433)',
    structure = SMILES('CC=CCC(C)C(C)O[O]'),
    E0 = (-78.5431,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.783854,0.105365,-8.03798e-05,3.33653e-08,-5.87937e-12,-9274.83,39.3841], Tmin=(100,'K'), Tmax=(1294.95,'K')), NASAPolynomial(coeffs=[14.87,0.057011,-2.43693e-05,4.52985e-09,-3.12441e-13,-13329,-40.1826], Tmin=(1294.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-78.5431,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C(C=CCC)C(C)OO(7875)',
    structure = SMILES('[CH2]C(C=CCC)C(C)OO'),
    E0 = (-26.6083,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.39028,0.111571,-8.91906e-05,3.80787e-08,-6.69041e-12,-3000.6,43.2908], Tmin=(100,'K'), Tmax=(1336.21,'K')), NASAPolynomial(coeffs=[19.1508,0.0500814,-2.01636e-05,3.6397e-09,-2.47043e-13,-8490.07,-61.7616], Tmin=(1336.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-26.6083,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CC=CC)C(C)OO(7876)',
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.14054,0.111898,-9.23977e-05,4.18694e-08,-7.95408e-12,-2876.91,41.6909], Tmin=(100,'K'), Tmax=(1226.53,'K')), NASAPolynomial(coeffs=[16.192,0.0553735,-2.32704e-05,4.2963e-09,-2.95731e-13,-7128.72,-45.4678], Tmin=(1226.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-25.4655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl)"""),
)

species(
    label = 'C=C(C[CH]CC)C(C)O[O](7877)',
    structure = SMILES('C=C(C[CH]CC)C(C)O[O]'),
    E0 = (119.379,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.416572,0.103137,-8.72358e-05,4.34561e-08,-9.54768e-12,14511.9,41.4572], Tmin=(100,'K'), Tmax=(1040.4,'K')), NASAPolynomial(coeffs=[10.3382,0.0617875,-2.76197e-05,5.2547e-09,-3.68049e-13,12274.1,-10.8539], Tmin=(1040.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(119.379,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C(C=CCC)C(C)O[O](7878)',
    structure = SMILES('[CH2]C(C=CCC)C(C)O[O]'),
    E0 = (125.396,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.971432,0.1062,-8.79684e-05,4.02443e-08,-7.67546e-12,15263.2,42.5446], Tmin=(100,'K'), Tmax=(1230.07,'K')), NASAPolynomial(coeffs=[16.0194,0.0509482,-2.05918e-05,3.7278e-09,-2.53797e-13,11083.2,-42.9444], Tmin=(1230.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.396,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Isobutyl)"""),
)
...
species(
    label = 'CC[CH]C[C](C)C(C)O[O](7884)',
    structure = SMILES('CC[CH]C[C](C)C(C)O[O]'),
    E0 = (194.636,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0495635,0.0967749,-7.32599e-05,3.5246e-08,-8.12901e-12,23548.6,44.1515], Tmin=(100,'K'), Tmax=(946.695,'K')), NASAPolynomial(coeffs=[6.13627,0.0706374,-3.18446e-05,6.08018e-09,-4.26714e-13,22377.5,14.6475], Tmin=(946.695,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(194.636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CJCOOH) + radical(RCCJCC)"""),
)
...
species(
    label = '[CH2]C(CC[CH]C)C(C)O[O](7885)',
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.957039,0.114945,-0.000116628,7.46686e-08,-2.07381e-11,25285.6,44.5095], Tmin=(100,'K'), Tmax=(852.748,'K')), NASAPolynomial(coeffs=[9.82366,0.064378,-2.7682e-05,5.13404e-09,-3.53363e-13,23446.9,-5.78422], Tmin=(852.748,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.796,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJC) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C[CH]CC)[C](C)OO(7886)',
    structure = SMILES('[CH2]C(C[CH]CC)[C](C)OO'),
    E0 = (243.702,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.189716,0.100961,-2.84338e-05,-1.42845e-07,1.56187e-10,29430,40.0708], Tmin=(100,'K'), Tmax=(467.513,'K')), NASAPolynomial(coeffs=[7.42638,0.070525,-3.17872e-05,5.96822e-09,-4.10929e-13,28409.3,6.98094], Tmin=(467.513,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(243.702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(RCCJCC) + radical(Isobutyl)"""),
)

species(
    label = 'CC[CH]CC(C)[C](C)O[O](7887)',
    structure = SMILES('CC[CH]CC(C)[C](C)O[O]'),
    E0 = (190.625,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.943734,0.118197,-0.000142571,1.18514e-07,-4.23683e-11,23095.8,42.7865], Tmin=(100,'K'), Tmax=(785.157,'K')), NASAPolynomial(coeffs=[5.55443,0.0730723,-3.34008e-05,6.3216e-09,-4.37471e-13,22445.8,15.3676], Tmin=(785.157,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(190.625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOOH) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH][CH]C(C)C(C)O[O](7888)',
    structure = SMILES('CC[CH][CH]C(C)C(C)O[O]'),
    E0 = (198.268,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.224844,0.0972388,-4.17919e-05,-7.3534e-08,8.63186e-11,23967.8,41.0749], Tmin=(100,'K'), Tmax=(494.173,'K')), NASAPolynomial(coeffs=[6.10936,0.0719859,-3.30662e-05,6.33148e-09,-4.43707e-13,23112.9,14.0686], Tmin=(494.173,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(198.268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(RCCJCC)"""),
)

species(
    label = '[CH2][C](CCCC)C(C)O[O](7889)',
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.575222,0.101776,-7.66152e-05,3.25637e-08,-5.99011e-12,24850.6,45.2283], Tmin=(100,'K'), Tmax=(1232.54,'K')), NASAPolynomial(coeffs=[12.5245,0.0592642,-2.48793e-05,4.581e-09,-3.14425e-13,21621.4,-20.7095], Tmin=(1232.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(205.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CJCOOH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CCCC([CH2])C(C)O[O](7890)',
    structure = SMILES('[CH2]CCCC([CH2])C(C)O[O]'),
    E0 = (219.596,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2][C](C[CH]CC)C(C)OO(7892)',
    structure = SMILES('[CH2][C](C[CH]CC)C(C)OO'),
    E0 = (247.714,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.387053,0.103173,-8.51337e-05,4.38745e-08,-1.03347e-11,29945.4,46.3822], Tmin=(100,'K'), Tmax=(960.315,'K')), NASAPolynomial(coeffs=[8.06317,0.0679747,-3.01547e-05,5.70697e-09,-3.98411e-13,28322.5,5.957], Tmin=(960.315,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(247.714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CJCOOH) + radical(RCCJCC) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C[CH]CC)C([CH2])OO(7893)',
    structure = SMILES('[CH2]C(C[CH]CC)C([CH2])OO'),
    E0 = (270.766,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.19513,0.121032,-0.000127505,8.2249e-08,-2.2738e-11,32746.7,46.4327], Tmin=(100,'K'), Tmax=(859.884,'K')), NASAPolynomial(coeffs=[11.0347,0.064141,-2.82633e-05,5.30665e-09,-3.67928e-13,30643.5,-10.7228], Tmin=(859.884,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.766,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Isobutyl) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C(O[O])C(C)C[CH]CC(7894)',
    structure = SMILES('[CH2]C(O[O])C(C)C[CH]CC'),
    E0 = (217.688,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.889682,0.115024,-0.000117055,7.55725e-08,-2.14244e-11,26351.3,44.316], Tmin=(100,'K'), Tmax=(830.981,'K')), NASAPolynomial(coeffs=[9.1379,0.0667558,-2.99272e-05,5.67402e-09,-3.95768e-13,24684.7,-2.2048], Tmin=(830.981,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(217.688,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C(CCCC)C([CH2])O[O](7895)',
    structure = SMILES('[CH2]C(CCCC)C([CH2])O[O]'),
    E0 = (228.312,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C([CH][CH]CC)C(C)OO(7896)',
    structure = SMILES('[CH2]C([CH][CH]CC)C(C)OO'),
    E0 = (251.345,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.475246,0.110032,-9.11138e-05,2.17993e-08,1.59369e-11,30380.1,44.498], Tmin=(100,'K'), Tmax=(574.022,'K')), NASAPolynomial(coeffs=[7.83899,0.069673,-3.15837e-05,6.0082e-09,-4.19602e-13,29136,6.4792], Tmin=(574.022,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(251.345,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(RCCJCC) + radical(Isobutyl)"""),
)

species(
    label = 'C[CH][CH]CC(C)C(C)O[O](7897)',
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.854492,0.115553,-0.000135775,1.10703e-07,-3.9039e-11,24000.9,44.9085], Tmin=(100,'K'), Tmax=(788.492,'K')), NASAPolynomial(coeffs=[5.64728,0.0718839,-3.23709e-05,6.08723e-09,-4.1984e-13,23307.8,17.1927], Tmin=(788.492,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(198.172,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C[CH]CC(C)C(C)O[O](7898)',
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.790516,0.113082,-0.000114534,7.55906e-08,-2.22006e-11,25299.1,43.7513], Tmin=(100,'K'), Tmax=(799.901,'K')), NASAPolynomial(coeffs=[8.1309,0.0684696,-3.08764e-05,5.86796e-09,-4.09739e-13,23871.8,2.70234], Tmin=(799.901,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.972,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C(C[CH][CH]C)C(C)OO(7899)',
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.13053,0.121148,-0.000144429,1.1447e-07,-3.8809e-11,30395.1,46.9237], Tmin=(100,'K'), Tmax=(795.343,'K')), NASAPolynomial(coeffs=[7.45563,0.069434,-3.08084e-05,5.74496e-09,-3.94155e-13,29299.2,9.16284], Tmin=(795.343,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(251.249,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C[CH]CC([CH2])C(C)OO(7900)',
    structure = SMILES('[CH2]C[CH]CC([CH2])C(C)OO'),
    E0 = (262.049,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.08147,0.118905,-0.000124267,8.1215e-08,-2.29998e-11,31693.9,45.8168], Tmin=(100,'K'), Tmax=(836.809,'K')), NASAPolynomial(coeffs=[10.0115,0.0658828,-2.92288e-05,5.50445e-09,-3.82221e-13,29837.3,-5.72454], Tmin=(836.809,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(262.049,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]C(C[CH]CC)CO[O](721)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['CC[CH]C[CH]CC(C)O[O](7863)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(C)CC([CH2])C(C)O[O](7864)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['O(4)', '[CH2]C(C[CH]CC)C(C)[O](7865)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]CC(26)', '[CH2]C([CH2])C(C)O[O](7604)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C2H5(14)', '[CH]CC([CH2])C(C)O[O](7606)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH2]C(C[C]CC)C(C)O[O](7866)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH]C(C[CH]CC)C(C)O[O](7867)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['[CH2]C1CC(CC)OOC1C(7869)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['O(4)', 'CC[CH]CC1COC1C(7870)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['O(4)', '[CH2]C1CC(CC)OC1C(7871)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['HO2(9)', '[CH2]C(=CC)C[CH]CC(4053)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['HO2(9)', '[CH2]C(C=C)C[CH]CC(4055)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['C=C(CCCC)C(C)O[O](7872)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['CCC=CC(C)C(C)O[O](7873)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['C=C(C[CH]CC)C(C)OO(7874)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['CC=CCC(C)C(C)O[O](7433)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['[CH2]C(C=CCC)C(C)OO(7875)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['[CH2]C(CC=CC)C(C)OO(7876)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', 'C=C(C[CH]CC)C(C)O[O](7877)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH2]C(C=CCC)C(C)O[O](7878)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', '[CH2]C(CC=CC)C(C)O[O](7554)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C[CH]O[O](57)', 'C=CC[CH]CC(244)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CH3(17)', '[CH2]C(CC=C)C(C)O[O](7453)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction34',
    reactants = ['O2(2)', '[CH2]C([CH]C)C[CH]CC(363)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction35',
    reactants = ['C[CH]O[O](57)', '[CH2][CH]C[CH]CC(247)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(3)', '[CH2][C](C[CH]CC)C(C)O[O](7879)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction38',
    reactants = ['CH3(17)', '[CH2]C([CH]O[O])C[CH]CC(1014)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction39',
    reactants = ['H(3)', '[CH2]C(C[CH]CC)[C](C)O[O](7880)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction40',
    reactants = ['H(3)', '[CH2]C([CH][CH]CC)C(C)O[O](7881)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction41',
    reactants = ['CH3(17)', '[CH2][CH]CC([CH2])C(C)O[O](7449)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction42',
    reactants = ['H(3)', '[CH2]C(C[CH][CH]C)C(C)O[O](7541)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction43',
    reactants = ['H(3)', '[CH2]C(C[CH]CC)C([CH2])O[O](7882)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction44',
    reactants = ['H(3)', '[CH2]C[CH]CC([CH2])C(C)O[O](7883)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['CC[CH]C[C](C)C(C)O[O](7884)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2]C([CH]CCC)C(C)O[O](7790)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['[CH2]C(CC[CH]C)C(C)O[O](7885)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['[CH2]C(C[CH]CC)[C](C)OO(7886)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['CC[CH]CC(C)[C](C)O[O](7887)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['CC[CH][CH]C(C)C(C)O[O](7888)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['[CH2][C](CCCC)C(C)O[O](7889)'],
...
reaction(
    label = 'reaction52',
    reactants = ['[CH2]CCCC([CH2])C(C)O[O](7890)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction53',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['[CH2]C(CCCC)[C](C)O[O](7891)'],
...
reaction(
    label = 'reaction54',
    reactants = ['[CH2][C](C[CH]CC)C(C)OO(7892)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction55',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['[CH2]C(C[CH]CC)C([CH2])OO(7893)'],
...
reaction(
    label = 'reaction56',
    reactants = ['[CH2]C(O[O])C(C)C[CH]CC(7894)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction57',
    reactants = ['[CH2]C(CCCC)C([CH2])O[O](7895)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction58',
    reactants = ['[CH2]C([CH][CH]CC)C(C)OO(7896)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction59',
    reactants = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
    products = ['C[CH][CH]CC(C)C(C)O[O](7897)'],
...
reaction(
    label = 'reaction60',
    reactants = ['[CH2]C[CH]CC(C)C(C)O[O](7898)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction61',
    reactants = ['[CH2]C(C[CH][CH]C)C(C)OO(7899)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
...
reaction(
    label = 'reaction62',
    reactants = ['[CH2]C[CH]CC([CH2])C(C)OO(7900)'],
    products = ['[CH2]C(C[CH]CC)C(C)O[O](7428)'],
