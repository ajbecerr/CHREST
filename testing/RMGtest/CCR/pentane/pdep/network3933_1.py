...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.611178,0.0746154,-7.2806e-05,4.02086e-08,-9.17401e-12,125768,31.2632], Tmin=(100,'K'), Tmax=(1048.82,'K')), NASAPolynomial(coeffs=[11.5151,0.0330308,-1.33337e-05,2.40674e-09,-1.63625e-13,123481,-21.862], Tmin=(1048.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1044.68,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(CCJ2_triplet) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]C([CH]C)C[C]=[CH](17732)',
...
species(
    label = '[C]=[C]CC([CH2])[CH]C(17733)',
    structure = SMILES('[C]=[C]CC([CH2])[CH]C'),
    E0 = (1102.01,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.883297,0.0732948,-8.56989e-05,6.58967e-08,-2.18347e-11,132649,32.9129], Tmin=(100,'K'), Tmax=(774.999,'K')), NASAPolynomial(coeffs=[6.5891,0.0411537,-1.82807e-05,3.42088e-09,-2.35562e-13,131846,7.36157], Tmin=(774.999,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1102.01,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Isobutyl) + radical(Cds_S) + radical(CdCdJ2_triplet)"""),
)

species(
    label = '[CH]=[C]CC1CC1C(17734)',
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10469,0.0483331,1.58074e-05,-5.39422e-08,2.37591e-11,65256,26.381], Tmin=(100,'K'), Tmax=(981.886,'K')), NASAPolynomial(coeffs=[14.8331,0.0290122,-1.05985e-05,1.95547e-09,-1.40503e-13,60795.5,-48.5854], Tmin=(981.886,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(541.589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]CC(=C)CC(17055)',
    structure = SMILES('[CH]=[C]CC(=C)CC'),
    E0 = (511.987,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,299.232,299.235],'cm^-1')),
        HinderedRotor(inertia=(0.00188276,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1895,'amu*angstrom^2'), symmetry=1, barrier=(12.0397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.189492,'amu*angstrom^2'), symmetry=1, barrier=(12.0397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.189446,'amu*angstrom^2'), symmetry=1, barrier=(12.0397,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.641915,0.0679011,-4.93902e-05,1.87879e-08,-2.93772e-12,61703.4,29.428], Tmin=(100,'K'), Tmax=(1483.19,'K')), NASAPolynomial(coeffs=[14.1221,0.0315468,-1.26241e-05,2.26234e-09,-1.52253e-13,57704.7,-40.92], Tmin=(1483.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(511.987,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]C[C]([CH2])[CH]C(17738)',
    structure = SMILES('[CH]=[C]C[C]([CH2])[CH]C'),
    E0 = (976.428,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,1982.55,1982.55],'cm^-1')),
        HinderedRotor(inertia=(0.169364,'amu*angstrom^2'), symmetry=1, barrier=(3.89401,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169331,'amu*angstrom^2'), symmetry=1, barrier=(3.89325,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169312,'amu*angstrom^2'), symmetry=1, barrier=(3.89281,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169337,'amu*angstrom^2'), symmetry=1, barrier=(3.8934,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.169321,'amu*angstrom^2'), symmetry=1, barrier=(3.89301,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.858773,0.078811,-0.000115759,1.07227e-07,-3.9116e-11,117541,34.1553], Tmin=(100,'K'), Tmax=(854.346,'K')), NASAPolynomial(coeffs=[3.18215,0.0464262,-2.11391e-05,3.92803e-09,-2.66187e-13,117929,27.9058], Tmin=(854.346,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(976.428,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Tertalkyl) + radical(Cs_S) + radical(Isobutyl) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]C[C]([CH2])CC(17056)',
    structure = SMILES('[CH]=[C]C[C]([CH2])CC'),
    E0 = (781.886,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,180,2093.76],'cm^-1')),
        HinderedRotor(inertia=(0.179582,'amu*angstrom^2'), symmetry=1, barrier=(4.12895,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.18008,'amu*angstrom^2'), symmetry=1, barrier=(4.1404,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.179879,'amu*angstrom^2'), symmetry=1, barrier=(4.13576,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.178411,'amu*angstrom^2'), symmetry=1, barrier=(4.10201,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180237,'amu*angstrom^2'), symmetry=1, barrier=(4.144,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.67998,0.0798603,-0.000103619,8.77945e-08,-3.05382e-11,94152.1,32.2425], Tmin=(100,'K'), Tmax=(841.982,'K')), NASAPolynomial(coeffs=[5.22338,0.045592,-1.99735e-05,3.67348e-09,-2.48721e-13,93836.6,13.7746], Tmin=(841.982,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(781.886,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Tertalkyl) + radical(Isobutyl) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=CC[C]([CH2])[CH]C(17739)',
    structure = SMILES('[CH]=CC[C]([CH2])[CH]C'),
    E0 = (738.586,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.934917,0.0736778,-8.90079e-05,7.53264e-08,-2.70223e-11,88935.8,33.4102], Tmin=(100,'K'), Tmax=(815.175,'K')), NASAPolynomial(coeffs=[4.16944,0.0472822,-2.1072e-05,3.92969e-09,-2.6912e-13,88758.1,20.6112], Tmin=(815.175,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(738.586,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Tertalkyl) + radical(Cs_S) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['CHCH3(T)(21)', '[CH]=[C]C[CH][CH2](9862)'],
    products = ['[CH]=[C]CC([CH2])[CH]C(16049)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[C]=[CH](9646)', '[CH2]C([CH2])[CH]C(500)'],
    products = ['[CH]=[C]CC([CH2])[CH]C(16049)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH3(17)', '[CH]C([CH2])C[C]=[CH](17129)'],
    products = ['[CH]=[C]CC([CH2])[CH]C(16049)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH]=[C]CC([CH2])[C]C(17731)'],
    products = ['[CH]=[C]CC([CH2])[CH]C(16049)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]C([CH]C)C[C]=[CH](17732)'],
    products = ['[CH]=[C]CC([CH2])[CH]C(16049)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[C]=[C]CC([CH2])[CH]C(17733)'],
    products = ['[CH]=[C]CC([CH2])[CH]C(16049)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH]=[C]CC([CH2])[CH]C(16049)'],
    products = ['C#C[CH]C([CH2])CC(17031)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=[C]CC([CH2])[CH]C(16049)'],
    products = ['C#C[CH]C(C)[CH]C(17447)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH]=[C]CC([CH2])=CC(17737)'],
    products = ['[CH]=[C]CC([CH2])[CH]C(16049)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CHCH3(T)(21)', 'C#CC[CH][CH2](9869)'],
    products = ['[CH]=[C]CC([CH2])[CH]C(16049)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.0018001,'m^3/(mol*s)'), n=2.5041, Ea=(54.6381,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cds_Cds;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 50.2 to 54.6 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', '[CH]=[C]C[C]([CH2])[CH]C(17738)'],
    products = ['[CH]=[C]CC([CH2])[CH]C(16049)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]=[C]CC([CH2])[CH]C(16049)'],
    products = ['[CH]=[C]C[C]([CH2])CC(17056)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH]=[C]CC([CH2])[CH]C(16049)'],
    products = ['[CH]=CC[C]([CH2])[CH]C(17739)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH]=[C]CC([CH2])[CH]C(16049)'],
    products = ['[CH2][C]([CH]C)C[C]=C(16048)'],
...
network(
    label = 'PDepNetwork #3933',
    isomers = [
        '[CH]=[C]CC([CH2])[CH]C(16049)',
    ],
    reactants = [
