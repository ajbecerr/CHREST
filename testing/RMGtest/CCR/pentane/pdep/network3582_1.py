...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57307,0.0400656,3.81527e-06,-4.04995e-08,2.01978e-11,45878.2,22.7811], Tmin=(100,'K'), Tmax=(953.311,'K')), NASAPolynomial(coeffs=[16.1172,0.0118363,-3.37116e-06,6.13778e-10,-4.76837e-14,41614.9,-54.507], Tmin=(953.311,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(380.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C2CsJOC(O)) + radical(C=CJO)"""),
)
...
species(
    ...
    E0 = (334.035,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,235.581,651.667],'cm^-1')),
        HinderedRotor(inertia=(0.745637,'amu*angstrom^2'), symmetry=1, barrier=(17.1437,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0581378,'amu*angstrom^2'), symmetry=1, barrier=(17.1134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.745416,'amu*angstrom^2'), symmetry=1, barrier=(17.1386,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
...
species(
    label = '[CH]=C(C)O[C]=C(15770)',
    structure = SMILES('[CH]=C(C)O[C]=C'),
    E0 = (414.863,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,395.287,395.311],'cm^-1')),
        HinderedRotor(inertia=(0.0814618,'amu*angstrom^2'), symmetry=1, barrier=(9.03523,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0814688,'amu*angstrom^2'), symmetry=1, barrier=(9.03498,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0814081,'amu*angstrom^2'), symmetry=1, barrier=(9.03577,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83062,0.0499527,-4.57597e-05,2.41741e-08,-5.46696e-12,49972.7,24.3695], Tmin=(100,'K'), Tmax=(1033.03,'K')), NASAPolynomial(coeffs=[7.87862,0.0265338,-1.1754e-05,2.2282e-09,-1.5582e-13,48723.2,-5.00503], Tmin=(1033.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(414.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(20)', 'C=[C]O[C]=C(2695)'],
    products = ['[CH2]C(=C)O[C]=C(2587)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]C(=C)O[C]=C(15765)'],
    products = ['[CH2]C(=C)O[C]=C(2587)'],
    transitionState = 'TS4',
