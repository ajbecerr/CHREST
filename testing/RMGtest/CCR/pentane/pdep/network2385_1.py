...
species(
    label = '[CH2][C]O[CH][C]=O(10210)',
    structure = SMILES('[CH2][C]OC=[C][O]'),
    E0 = (659.485,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,180,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(1.03141,'amu*angstrom^2'), symmetry=1, barrier=(23.7142,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03106,'amu*angstrom^2'), symmetry=1, barrier=(23.706,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.03115,'amu*angstrom^2'), symmetry=1, barrier=(23.7083,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
...
species(
    label = '[CH2][CH]O[C][C]=O(10211)',
    structure = SMILES('[CH2][CH]O[C]=[C][O]'),
    E0 = (632.168,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1670,1700,300,440,344.931,345.318,345.319,346.391],'cm^-1')),
        HinderedRotor(inertia=(0.207246,'amu*angstrom^2'), symmetry=1, barrier=(17.5302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.210151,'amu*angstrom^2'), symmetry=1, barrier=(17.5936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.207465,'amu*angstrom^2'), symmetry=1, barrier=(17.5999,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.57523,0.0675304,-8.94939e-05,5.37541e-08,-1.1944e-11,76162.3,29.2985], Tmin=(100,'K'), Tmax=(1231.14,'K')), NASAPolynomial(coeffs=[19.1879,-0.000179227,1.81914e-06,-4.66614e-10,3.57295e-14,72127.8,-62.1401], Tmin=(1231.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(632.168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCsJOC(O)) + radical(CJCO) + radical(C=CJO) + radical(C=CJO)"""),
)
...
species(
    label = '[CH2][CH]O[C]=[C]O(10216)',
    structure = SMILES('[CH2][CH]O[C]=[C]O'),
    E0 = (490.705,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1670,1700,300,440,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.773996,'amu*angstrom^2'), symmetry=1, barrier=(17.7957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.77415,'amu*angstrom^2'), symmetry=1, barrier=(17.7992,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.774977,'amu*angstrom^2'), symmetry=1, barrier=(17.8183,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.774146,'amu*angstrom^2'), symmetry=1, barrier=(17.7991,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0544373,0.0771485,-0.000102532,6.06123e-08,-1.30444e-11,59174.7,30.1433], Tmin=(100,'K'), Tmax=(1319.76,'K')), NASAPolynomial(coeffs=[22.1701,-0.00352534,4.292e-06,-9.93339e-10,7.34526e-14,54468,-78.8503], Tmin=(1319.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(490.705,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCsJOC(O)) + radical(CJCO) + radical(C=CJO) + radical(C=CJO)"""),
)
...
species(
    label = '[O][C]C1C[CH]O1(10219)',
    structure = SMILES('[O][C]C1C[CH]O1'),
    E0 = (574.579,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32488,0.0513045,-5.47377e-05,3.09287e-08,-6.59533e-12,69208.8,20.7056], Tmin=(100,'K'), Tmax=(1348.13,'K')), NASAPolynomial(coeffs=[11.584,0.0122957,-1.80001e-06,3.55095e-11,7.91343e-15,67221.3,-28.9654], Tmin=(1348.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(574.579,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Oxetane) + radical(CCOJ) + radical(CCsJOCs) + radical(CH2_triplet)"""),
)

species(
    label = '[C]1[CH]O[CH]CO1(10220)',
    structure = SMILES('[C]1[CH]O[CH]CO1'),
    E0 = (482.916,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.136702,0.0646485,-7.7771e-05,4.59812e-08,-9.51935e-12,58238.2,18.844], Tmin=(100,'K'), Tmax=(1526.04,'K')), NASAPolynomial(coeffs=[12.231,0.00659128,5.20196e-06,-1.58398e-09,1.26997e-13,57615.8,-34.5609], Tmin=(1526.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(482.916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(1,4-Dioxane) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CH2_triplet)"""),
)

species(
    label = '[CH2]C1OC1[C][O](10221)',
    structure = SMILES('[CH2]C1OC1[C][O]'),
    E0 = (598.601,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25547,0.0580493,-7.31494e-05,4.81803e-08,-1.20223e-11,72096,20.7382], Tmin=(100,'K'), Tmax=(1135.66,'K')), NASAPolynomial(coeffs=[11.5206,0.0133296,-2.77123e-06,2.25977e-10,-4.09745e-15,70316.7,-27.6594], Tmin=(1135.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(598.601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CCOJ) + radical(CJCO) + radical(CH2_triplet)"""),
)

species(
    label = '[CH2]C1O[C][CH]O1(10222)',
    structure = SMILES('[CH2]C1O[C][CH]O1'),
    E0 = (481.212,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0080338,0.0620514,-7.85274e-05,4.47286e-08,-8.80044e-12,58042.5,21.7482], Tmin=(100,'K'), Tmax=(1600.66,'K')), NASAPolynomial(coeffs=[15.265,-0.00322026,8.07752e-06,-1.93661e-09,1.42743e-13,56635.7,-48.1723], Tmin=(1600.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(481.212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(1,3-Dioxolane) + radical(CJCO) + radical(CCsJOCs) + radical(CH2_triplet)"""),
)
...
species(
    label = 'C=[C]OC[C][O](2763)',
    structure = SMILES('C=[C]OC[C][O]'),
    E0 = (581.103,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1685,370,332.735,333.056,333.578,333.597,333.955,334.042],'cm^-1')),
        HinderedRotor(inertia=(0.00152618,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.206491,'amu*angstrom^2'), symmetry=1, barrier=(16.4824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20888,'amu*angstrom^2'), symmetry=1, barrier=(16.4879,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40207,0.0596174,-7.66979e-05,5.11039e-08,-1.35332e-11,69982,23.4427], Tmin=(100,'K'), Tmax=(922.536,'K')), NASAPolynomial(coeffs=[11.1242,0.0174634,-8.15754e-06,1.57348e-09,-1.10797e-13,68188.2,-22.677], Tmin=(922.536,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(581.103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=CJO) + radical(CH2_triplet)"""),
)

species(
    label = '[CH][CH]OC[C]=O(2795)',
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36855,0.060075,-7.66385e-05,5.05556e-08,-1.32414e-11,53419.2,23.7766], Tmin=(100,'K'), Tmax=(932.993,'K')), NASAPolynomial(coeffs=[11.3207,0.0174083,-8.04319e-06,1.54199e-09,-1.08222e-13,51562.1,-23.5464], Tmin=(932.993,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(443.38,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(CsCJ=O) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C=[C]O[CH][C]O(10224)',
    structure = SMILES('[CH2][C]OC=[C]O'),
    E0 = (518.022,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.980123,'amu*angstrom^2'), symmetry=1, barrier=(22.5349,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.979987,'amu*angstrom^2'), symmetry=1, barrier=(22.5318,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.981094,'amu*angstrom^2'), symmetry=1, barrier=(22.5573,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.980528,'amu*angstrom^2'), symmetry=1, barrier=(22.5443,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.721179,0.0789706,-9.77417e-05,5.23519e-08,-1.00047e-11,62495.1,28.6779], Tmin=(100,'K'), Tmax=(1547.6,'K')), NASAPolynomial(coeffs=[24.7611,-0.00788376,6.78725e-06,-1.44107e-09,1.00815e-13,57121.6,-97.2658], Tmin=(1547.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(518.022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CJCO) + radical(CH2_triplet) + radical(C=CJO)"""),
)

species(
    label = '[CH]=CO[CH][C]O(10225)',
    structure = SMILES('[CH][CH]OC=[C]O'),
    E0 = (487.587,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.800618,0.0806252,-0.000100638,5.44123e-08,-1.04855e-11,58837.6,29.3789], Tmin=(100,'K'), Tmax=(1537.95,'K')), NASAPolynomial(coeffs=[24.9009,-0.00804365,7.12703e-06,-1.52775e-09,1.07556e-13,53512.9,-97.2886], Tmin=(1537.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(487.587,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCsJOC(O)) + radical(C=CJO) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][CH]O[CH][C]=O(2797)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[O][C]=C[O](9592)', '[CH][CH2](502)'],
    products = ['[CH2][CH]O[CH][C]=O(2797)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2][C]O[CH][C]=O(10210)'],
    products = ['[CH2][CH]O[CH][C]=O(2797)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH2][CH]O[C][C]=O(10211)'],
    products = ['[CH2][CH]O[CH][C]=O(2797)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH][CH]O[CH][C]=O(7097)'],
    products = ['[CH2][CH]O[CH][C]=O(2797)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['OCHCO(3676)', '[CH][CH2](502)'],
    products = ['[CH2][CH]O[CH][C]=O(2797)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]O[C]=C[O](10214)'],
    products = ['[CH2][CH]O[CH][C]=O(2797)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH]O[C]=[C]O(10216)'],
    products = ['[CH2][CH]O[CH][C]=O(2797)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH][C][O](10218)', 'vinoxy(1351)'],
    products = ['[CH2][CH]O[CH][C]=O(2797)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][CH]O[CH][C]=O(2797)'],
    products = ['[O][C]C1C[CH]O1(10219)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(6.61918e+08,'s^-1'), n=0.930343, Ea=(187.369,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_pri_2H;radadd_intra_cs]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic
Ea raised from 184.1 to 187.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction19',
    reactants = ['[CH2][CH]O[CH][C]=O(2797)'],
    products = ['[C]1[CH]O[CH]CO1(10220)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(9.91671e+09,'s^-1'), n=0.30082, Ea=(95.7061,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6_linear;doublebond_intra_pri_2H;radadd_intra] for rate rule [R6_linear;doublebond_intra_pri_2H;radadd_intra_O]
Euclidian distance = 1.0
family: Intra_R_Add_Endocyclic
Ea raised from 93.4 to 95.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction20',
    reactants = ['[CH2][CH]O[CH][C]=O(2797)'],
    products = ['[CH2]C1OC1[C][O](10221)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(9.65211e+08,'s^-1'), n=0.77, Ea=(211.391,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H_pri;radadd_intra_cs]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 209.4 to 211.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction21',
    reactants = ['[CH2][CH]O[CH][C]=O(2797)'],
    products = ['[CH2]C1O[C][CH]O1(10222)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[O][C]=C[O](9592)', 'C2H3(60)'],
    products = ['[CH2][CH]O[CH][C]=O(2797)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[O][C][CH][O](10223)', 'C2H3(60)'],
    products = ['[CH2][CH]O[CH][C]=O(2797)'],
