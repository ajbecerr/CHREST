...
species(
    label = '[CH]C1[CH]C[C]([CH2])C1(16389)',
    structure = SMILES('[CH]C1[CH]C[C]([CH2])C1'),
    E0 = (875.945,'kJ/mol'),
    modes = [
...
species(
    label = '[CH][CH]C[CH]C([CH2])=C(16391)',
    structure = SMILES('[CH][CH]CC=C([CH2])[CH2]'),
    E0 = (830.277,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.7226,0.0681544,-5.31446e-05,2.22026e-08,-3.84087e-12,99980.4,30.9501], Tmin=(100,'K'), Tmax=(1348.45,'K')), NASAPolynomial(coeffs=[12.8961,0.0320432,-1.29748e-05,2.34267e-09,-1.58862e-13,96697.3,-31.4191], Tmin=(1348.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(830.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(RCCJC) + radical(Allyl_P) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.833543,0.0760872,-8.97773e-05,7.54253e-08,-2.68355e-11,107136,31.9591], Tmin=(100,'K'), Tmax=(835.209,'K')), NASAPolynomial(coeffs=[3.63257,0.0505593,-2.21583e-05,4.07316e-09,-2.76099e-13,107091,21.4907], Tmin=(835.209,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(889.882,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Tertalkyl) + radical(Isobutyl) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C[CH]CC(=[CH])[CH2](16394)',
    structure = SMILES('[CH]C[CH]CC([CH])=C'),
    E0 = (910.221,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,350,440,435,1725,2950,3100,1380,975,1025,1650,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]C=CC[C]1CC1(16396)',
    structure = SMILES('[CH]C=CC[C]1CC1'),
    E0 = (609.554,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25687,0.0510518,-5.89894e-06,-1.78808e-08,7.64681e-12,73418.8,27.7443], Tmin=(100,'K'), Tmax=(1130.46,'K')), NASAPolynomial(coeffs=[9.49981,0.0405284,-1.66733e-05,3.0618e-09,-2.10895e-13,70363.9,-18.3027], Tmin=(1130.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(609.554,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(Tertalkyl) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C1[CH]CC(=C)C1(16397)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81212,0.0286349,6.40617e-05,-9.83767e-08,3.78108e-11,72628.8,24.362], Tmin=(100,'K'), Tmax=(988.693,'K')), NASAPolynomial(coeffs=[13.4127,0.0301404,-1.17109e-05,2.26878e-09,-1.6816e-13,67967.5,-43.4447], Tmin=(988.693,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(603.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclopentane) + radical(Cs_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]C1CC(=C)C1(16398)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40965,0.0455369,5.34942e-06,-3.15646e-08,1.29199e-11,84554.4,26.6448], Tmin=(100,'K'), Tmax=(1074.09,'K')), NASAPolynomial(coeffs=[11.2691,0.0342486,-1.4399e-05,2.73507e-09,-1.94015e-13,80969.6,-28.4546], Tmin=(1074.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(702.169,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane) + radical(Cs_S) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[C]=C[CH]CC([CH2])=C(16406)',
    structure = SMILES('[C]C=CCC([CH2])=C'),
    E0 = (834.646,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,368.003,368.004,368.006],'cm^-1')),
        HinderedRotor(inertia=(0.197195,'amu*angstrom^2'), symmetry=1, barrier=(18.9507,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197191,'amu*angstrom^2'), symmetry=1, barrier=(18.9507,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197191,'amu*angstrom^2'), symmetry=1, barrier=(18.9507,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (92.1384,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.659548,0.0636211,-3.98317e-05,4.58182e-09,3.14535e-12,100514,25.4186], Tmin=(100,'K'), Tmax=(1045.23,'K')), NASAPolynomial(coeffs=[15.5881,0.0245058,-9.55109e-06,1.75814e-09,-1.23373e-13,96408.7,-51.9711], Tmin=(1045.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(834.646,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(CJ3)"""),
)

species(
    label = '[CH2]C(=C)CC1C=C1(16407)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.689735,0.0626611,-3.25046e-05,-1.89348e-09,4.99944e-12,52295.7,22.8381], Tmin=(100,'K'), Tmax=(1045.54,'K')), NASAPolynomial(coeffs=[14.6361,0.0285204,-1.1091e-05,2.02998e-09,-1.41637e-13,48329.1,-50.0886], Tmin=(1045.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(433.747,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(Allyl_P)"""),
)
...
species(
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.600228,0.0687479,-5.86574e-05,2.8238e-08,-5.56371e-12,40654.2,25.6804], Tmin=(100,'K'), Tmax=(1217.33,'K')), NASAPolynomial(coeffs=[12.5828,0.0293744,-1.01408e-05,1.66782e-09,-1.07017e-13,37736.9,-34.4848], Tmin=(1217.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(336.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CtCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Sec_Propargyl)"""),
)

species(
    label = '[CH2][C]1C[CH]C=CC1(16409)',
    structure = SMILES('[CH2][C]1C[CH]C=CC1'),
    E0 = (475.017,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01021,0.030335,4.40783e-05,-6.90379e-08,2.59592e-11,57214.7,21.4339], Tmin=(100,'K'), Tmax=(1000.12,'K')), NASAPolynomial(coeffs=[8.84208,0.0359917,-1.38713e-05,2.56373e-09,-1.81404e-13,54198.8,-19.773], Tmin=(1000.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(475.017,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclohexene) + radical(Tertalkyl) + radical(cyclohexene-allyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C1([CH2])C=C[CH]C1(16410)',
    structure = SMILES('[CH2]C1([CH2])[CH]C=CC1'),
    E0 = (490.637,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64935,0.0313929,6.01732e-05,-9.86025e-08,3.90583e-11,59112.8,22.9399], Tmin=(100,'K'), Tmax=(977.323,'K')), NASAPolynomial(coeffs=[15.1229,0.0266284,-9.83786e-06,1.89971e-09,-1.42474e-13,54073.1,-54.0625], Tmin=(977.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(490.637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsCs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopentene) + radical(cyclopentene-allyl) + radical(Neopentyl) + radical(Neopentyl)"""),
)
...
species(
    ...
    E0 = (563.764,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3120,650,792.5,1650,193.679],'cm^-1')),
        HinderedRotor(inertia=(0.193011,'amu*angstrom^2'), symmetry=1, barrier=(25.2357,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0108924,'amu*angstrom^2'), symmetry=1, barrier=(1.49318,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.190272,'amu*angstrom^2'), symmetry=1, barrier=(25.2343,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09201,'amu*angstrom^2'), symmetry=1, barrier=(25.2182,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
...
species(
    label = '[CH]=[C]CCC([CH2])=C(16413)',
    structure = SMILES('[CH]=[C]CCC([CH2])=C'),
    E0 = (661.082,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,293.989,1618.53],'cm^-1')),
        HinderedRotor(inertia=(0.10741,'amu*angstrom^2'), symmetry=1, barrier=(6.5992,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.328434,'amu*angstrom^2'), symmetry=1, barrier=(20.0045,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.313926,'amu*angstrom^2'), symmetry=1, barrier=(20.0323,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.320407,'amu*angstrom^2'), symmetry=1, barrier=(20.0449,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.605466,0.0689298,-5.47471e-05,2.27769e-08,-3.86355e-12,79636.6,28.4495], Tmin=(100,'K'), Tmax=(1388.58,'K')), NASAPolynomial(coeffs=[14.4362,0.0290886,-1.1709e-05,2.114e-09,-1.43404e-13,75795.6,-42.816], Tmin=(1388.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(661.082,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]C1[CH]C[C]([CH2])C1(16389)'],
    products = ['[CH]C=CCC([CH2])=C(14022)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]C=C[CH]C([CH2])[CH2](14024)'],
    products = ['[CH]C=CCC([CH2])=C(14022)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH][CH]C[CH]C([CH2])=C(16391)'],
    products = ['[CH]C=CCC([CH2])=C(14022)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]C=[C]CC([CH2])[CH2](14025)'],
    products = ['[CH]C=CCC([CH2])=C(14022)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]C=[C]C[C]([CH2])C(16392)'],
    products = ['[CH]C=CCC([CH2])=C(14022)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH][C]=CCC([CH2])[CH2](14026)'],
    products = ['[CH]C=CCC([CH2])=C(14022)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]C[CH]CC(=[CH])[CH2](16394)'],
    products = ['[CH]C=CCC([CH2])=C(14022)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH][C]=CC[C]([CH2])C(16395)'],
    products = ['[CH]C=CCC([CH2])=C(14022)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]C=CCC([CH2])=C(14022)'],
    products = ['[CH]C1[CH]CC(=C)C1(16397)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]C=CCC([CH2])=C(14022)'],
    products = ['[CH][CH]C1CC(=C)C1(16398)'],
    transitionState = 'TS16',
    kinetics = Arrhenius(A=(2.41102e+07,'s^-1'), n=1.225, Ea=(166.316,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra;radadd_intra_cs2H]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: Intra_R_Add_Exocyclic
Ea raised from 163.5 to 166.3 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH]C=C[CH]C([CH2])=C(16399)'],
    products = ['[CH]C=CCC([CH2])=C(14022)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH]C=[C]CC([CH2])=C(16400)'],
    products = ['[CH]C=CCC([CH2])=C(14022)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH][C]=CCC([CH2])=C(16401)'],
    products = ['[CH]C=CCC([CH2])=C(14022)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]C=CCC([CH2])=C(14022)'],
    products = ['[CH]C=C[CH]C(=C)C(16402)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C2H2(T)(1343)', '[CH]CC([CH2])=C(15609)'],
    products = ['[CH]C=CCC([CH2])=C(14022)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', '[C]=C[CH]CC([CH2])=C(16406)'],
    products = ['[CH]C=CCC([CH2])=C(14022)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]C=CCC([CH2])=C(14022)'],
    products = ['[CH2]C(=C)CC1C=C1(16407)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH]C=CCC([CH2])=C(14022)'],
    products = ['[CH2][C]1C[CH]C=CC1(16409)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1e+10,'s^-1'), n=0, Ea=(166.9,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_csHCd]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 164.8 to 166.9 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction40',
    reactants = ['[CH]C=CCC([CH2])=C(14022)'],
    products = ['[CH2]C1([CH2])C=C[CH]C1(16410)'],
...
reaction(
    label = 'reaction41',
    reactants = ['H(3)', '[CH]=CC=CC([CH2])=C(16411)'],
    products = ['[CH]C=CCC([CH2])=C(14022)'],
...
reaction(
    label = 'reaction42',
    reactants = ['H(3)', '[CH]=C=CCC([CH2])=C(16412)'],
    products = ['[CH]C=CCC([CH2])=C(14022)'],
...
reaction(
    label = 'reaction43',
    reactants = ['C2H2(1342)', '[CH]CC([CH2])=C(15609)'],
    products = ['[CH]C=CCC([CH2])=C(14022)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH]=CC[CH]C([CH2])=C(16344)'],
    products = ['[CH]C=CCC([CH2])=C(14022)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH]=[C]CCC([CH2])=C(16413)'],
    products = ['[CH]C=CCC([CH2])=C(14022)'],
