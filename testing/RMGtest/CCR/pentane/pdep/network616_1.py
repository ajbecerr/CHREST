...
species(
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84379,0.0410264,-3.41594e-05,1.76359e-08,-3.61246e-12,31130.2,19.6341], Tmin=(100,'K'), Tmax=(1408.14,'K')), NASAPolynomial(coeffs=[7.37293,0.0192189,-4.43002e-06,4.8395e-10,-2.10258e-14,30178,-6.78541], Tmin=(1408.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(258.14,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(RCCJ)"""),
)

species(
    label = '[O][C]1CCC1(2377)',
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.5401,0.0201294,3.63678e-05,-5.92553e-08,2.33435e-11,29937.8,16.0024], Tmin=(100,'K'), Tmax=(977.342,'K')), NASAPolynomial(coeffs=[10.1725,0.0185824,-6.82615e-06,1.29129e-09,-9.50333e-14,27027.9,-27.8991], Tmin=(977.342,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.391,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclobutane) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C1([O])CC1(2378)',
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91957,0.0355117,6.72162e-07,-2.97391e-08,1.49025e-11,32409.8,16.6502], Tmin=(100,'K'), Tmax=(960.502,'K')), NASAPolynomial(coeffs=[13.0426,0.0140292,-4.5697e-06,8.23214e-10,-6.01142e-14,29127.3,-42.5282], Tmin=(960.502,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(268.77,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CJC(C)2O)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.115457,'amu*angstrom^2'), symmetry=1, barrier=(13.8735,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115795,'amu*angstrom^2'), symmetry=1, barrier=(13.8772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115508,'amu*angstrom^2'), symmetry=1, barrier=(13.8701,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62099,0.043167,-1.84853e-05,-1.48307e-08,1.12083e-11,26705.8,20.8641], Tmin=(100,'K'), Tmax=(932.66,'K')), NASAPolynomial(coeffs=[14.7958,0.00990304,-2.36424e-06,3.63344e-10,-2.61413e-14,23237.5,-47.1971], Tmin=(932.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(221.262,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C]=O(1376)', 'C2H4(22)'],
    products = ['[CH2]CC([CH2])=O(1579)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2][CH]C(=C)[O](2379)'],
    products = ['[CH2]CC([CH2])=O(1579)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH2(T)(20)', '[CH2]C[C]=O(2354)'],
    products = ['[CH2]CC([CH2])=O(1579)'],
