...
species(
    label = '[C]=C(C)C[CH2](559)',
    structure = SMILES('[C]=C(C)C[CH2]'),
    E0 = (707.772,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,277.41],'cm^-1')),
        HinderedRotor(inertia=(0.00220305,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10709,'amu*angstrom^2'), symmetry=1, barrier=(5.84512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107462,'amu*angstrom^2'), symmetry=1, barrier=(5.84346,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (67.1091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.15902,0.0431894,-3.23835e-05,1.4101e-08,-2.7631e-12,85189.2,19.6111], Tmin=(100,'K'), Tmax=(1128.91,'K')), NASAPolynomial(coeffs=[6.37785,0.0282409,-1.25211e-05,2.37137e-09,-1.65516e-13,84236.7,-1.25382], Tmin=(1128.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(707.772,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJ) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(15)', '[CH]=C([CH2])C(557)'],
    products = ['[CH]=C(C)C[CH2](296)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction13',
    reactants = ['H(9)', '[CH]=C(C)[CH][CH2](562)'],
    products = ['[CH]=C(C)C[CH2](296)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH3](12)', '[CH]=[C]C[CH2](308)'],
    products = ['[CH]=C(C)C[CH2](296)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(9)', '[CH]C(=C)C[CH2](287)'],
    products = ['[CH]=C(C)C[CH2](296)'],
