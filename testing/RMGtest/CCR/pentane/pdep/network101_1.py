...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC[CH]CC(199)'],
    products = ['C2H4(22)', 'butene1(35)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C[CH2](29)', '[CH]CC(26)'],
    products = ['[CH2]CC[CH]CC(199)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(14)', '[CH]CC[CH2](63)'],
    products = ['[CH2]CC[CH]CC(199)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(T)(20)', '[CH2]C[CH]CC(101)'],
    products = ['[CH2]CC[CH]CC(199)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction17',
    reactants = ['C2H4(T)(23)', 'butene1(35)'],
    products = ['[CH2]CC[CH]CC(199)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH3(17)', '[CH2]CCC=C(122)'],
    products = ['[CH2]CC[CH]CC(199)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C2H4(22)', '[CH2][CH]CC(37)'],
    products = ['[CH2]CC[CH]CC(199)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C2H4(T)(23)', '[CH2][CH]CC(37)'],
    products = ['[CH2]CC[CH]CC(199)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH2]C[CH][CH]CC(245)'],
    products = ['[CH2]CC[CH]CC(199)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH3(17)', '[CH2][CH]CC[CH2](125)'],
    products = ['[CH2]CC[CH]CC(199)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH2]CC[CH][CH]C(246)'],
    products = ['[CH2]CC[CH]CC(199)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH2][CH]C[CH]CC(247)'],
    products = ['[CH2]CC[CH]CC(199)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2]C[CH]CC[CH2](248)'],
    products = ['[CH2]CC[CH]CC(199)'],
