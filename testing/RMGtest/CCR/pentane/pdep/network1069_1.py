...
species(
    label = '[CH]C(CC)O[O](7327)',
    structure = SMILES('[CH]C(CC)O[O]'),
    E0 = (354.95,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,308.312,308.428,308.533,1587.19],'cm^-1')),
        HinderedRotor(inertia=(0.00177141,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132606,'amu*angstrom^2'), symmetry=1, barrier=(8.95682,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132577,'amu*angstrom^2'), symmetry=1, barrier=(8.95639,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00177101,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60828,0.0462222,-2.1628e-05,2.38634e-09,6.24116e-13,-9039.13,17.8276], Tmin=(100,'K'), Tmax=(1380.55,'K')), NASAPolynomial(coeffs=[10.6298,0.0286397,-1.18211e-05,2.14004e-09,-1.44269e-13,-12345.5,-31.5587], Tmin=(1380.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.9145,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane)"""),
)
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20777,0.0292791,2.93785e-05,-6.38311e-08,2.97833e-11,-15225.7,15.4419], Tmin=(100,'K'), Tmax=(863.802,'K')), NASAPolynomial(coeffs=[10.6394,0.0192001,-3.41786e-06,3.00089e-10,-1.25574e-14,-17762.9,-30.2565], Tmin=(863.802,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-127.211,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide)"""),
)

species(
    label = 'C=C(CC)OO(7330)',
    ...
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40844,0.0536721,-3.81025e-05,1.3862e-08,-2.07625e-12,-12723.6,23.4825], Tmin=(100,'K'), Tmax=(1529.05,'K')), NASAPolynomial(coeffs=[12.0181,0.0259175,-1.08755e-05,1.99111e-09,-1.3538e-13,-15968.1,-32.2084], Tmin=(1529.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-106.586,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=C(CC)O[O](7331)',
    structure = SMILES('C=C(CC)O[O]'),
    E0 = (45.4192,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,180],'cm^-1')),
        HinderedRotor(inertia=(0.209296,'amu*angstrom^2'), symmetry=1, barrier=(4.81214,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.209397,'amu*angstrom^2'), symmetry=1, barrier=(4.81445,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85815,0.0479654,-3.5857e-05,1.49213e-08,-2.68041e-12,5538.91,22.624], Tmin=(100,'K'), Tmax=(1257.24,'K')), NASAPolynomial(coeffs=[8.17493,0.0278683,-1.18797e-05,2.2072e-09,-1.52262e-13,3950.55,-9.29695], Tmin=(1257.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(45.4192,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(ROOJ)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.144254,'amu*angstrom^2'), symmetry=1, barrier=(3.31668,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144265,'amu*angstrom^2'), symmetry=1, barrier=(3.31693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144278,'amu*angstrom^2'), symmetry=1, barrier=(3.31723,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144306,'amu*angstrom^2'), symmetry=1, barrier=(3.31787,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35916,0.0632078,-8.38604e-05,7.05002e-08,-2.45123e-11,37085.5,25.2518], Tmin=(100,'K'), Tmax=(811.468,'K')), NASAPolynomial(coeffs=[5.86532,0.0335562,-1.52981e-05,2.87488e-09,-1.97464e-13,36599.1,5.96275], Tmin=(811.468,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(307.597,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOOH) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2][C](CC)OO(7333)',
    structure = SMILES('[CH2][C](CC)OO'),
    E0 = (155.592,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,2403.28],'cm^-1')),
        HinderedRotor(inertia=(0.0902498,'amu*angstrom^2'), symmetry=1, barrier=(7.96323,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.481159,'amu*angstrom^2'), symmetry=1, barrier=(42.4461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0902518,'amu*angstrom^2'), symmetry=1, barrier=(7.96327,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0902886,'amu*angstrom^2'), symmetry=1, barrier=(7.96277,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.481312,'amu*angstrom^2'), symmetry=1, barrier=(42.4458,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (88.1051,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29764,0.0641786,-6.88241e-05,4.59932e-08,-1.33997e-11,18806.5,24.7289], Tmin=(100,'K'), Tmax=(811.521,'K')), NASAPolynomial(coeffs=[7.01194,0.0360144,-1.67691e-05,3.23251e-09,-2.27511e-13,17879,-1.64622], Tmin=(811.521,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(155.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]C(C)O[O](87)'],
    products = ['[CH2]C(CC)O[O](191)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(20)', 'CC[CH]O[O](51)'],
    products = ['[CH2]C(CC)O[O](191)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C(CC)O[O](7327)'],
    products = ['[CH2]C(CC)O[O](191)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH]O[O](674)', 'C2H5(14)'],
    products = ['[CH2]C(CC)O[O](191)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(17)', '[CH2]C([CH2])O[O](460)'],
    products = ['[CH2]C(CC)O[O](191)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2][C](CC)O[O](7332)'],
    products = ['[CH2]C(CC)O[O](191)'],
