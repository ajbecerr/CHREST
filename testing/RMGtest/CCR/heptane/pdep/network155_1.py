...
species(
    ...
    E0 = (426.566,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,180],'cm^-1')),
        HinderedRotor(inertia=(0.00379992,'amu*angstrom^2'), symmetry=1, barrier=(2.60419,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.444448,'amu*angstrom^2'), symmetry=1, barrier=(10.2187,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (54.0904,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.62032,0.0259569,-5.29452e-06,-6.6044e-09,3.12349e-12,51357.4,17.2939], Tmin=(100,'K'), Tmax=(1131.63,'K')), NASAPolynomial(coeffs=[6.83997,0.0194379,-7.78298e-06,1.41829e-09,-9.73912e-14,49864.8,-5.96066], Tmin=(1131.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(426.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_S)"""),
)
...
species(
    label = 'C=[C]CC[C]C(664)',
    structure = SMILES('C=[C]CC[C]C'),
    E0 = (621.975,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,261.767,261.788,261.809,261.817],'cm^-1')),
        HinderedRotor(inertia=(0.00245827,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00246003,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.316965,'amu*angstrom^2'), symmetry=1, barrier=(15.421,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.401766,'amu*angstrom^2'), symmetry=1, barrier=(19.5452,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29418,0.0572655,-4.03277e-05,1.49911e-08,-2.33414e-12,74905.2,24.6566], Tmin=(100,'K'), Tmax=(1457.87,'K')), NASAPolynomial(coeffs=[11.1364,0.0302605,-1.25419e-05,2.28477e-09,-1.55186e-13,72035.5,-26.5367], Tmin=(1457.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(621.975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]C(16)', '[CH2]C[C]=C(270)'],
    products = ['C=[C]CC[CH]C(627)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=C(228)', '[CH2]C[CH]C(34)'],
    products = ['C=[C]CC[CH]C(627)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(3.22604e+07,'m^3/(mol*s)'), n=-0.594572, Ea=(56.8079,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction6',
    reactants = ['[CH3](12)', '[CH]CC[C]=C(271)'],
    products = ['C=[C]CC[CH]C(627)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction19',
    reactants = ['H(9)', 'C=[C]C[CH][CH]C(669)'],
    products = ['C=[C]CC[CH]C(627)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(9)', '[CH2][CH]CC[C]=C(671)'],
    products = ['C=[C]CC[CH]C(627)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(9)', '[CH]=[C]CC[CH]C(672)'],
    products = ['C=[C]CC[CH]C(627)'],
