...
species(
    label = '[C]=C(C)OC#C(18661)',
    structure = SMILES('[C]=C(C)OC#C'),
    E0 = (695.451,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2175,525,750,770,3400,2100,257.587,257.764],'cm^-1')),
        HinderedRotor(inertia=(0.524591,'amu*angstrom^2'), symmetry=1, barrier=(25.3445,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.232786,'amu*angstrom^2'), symmetry=1, barrier=(11.1183,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.3837,'amu*angstrom^2'), symmetry=1, barrier=(18.6353,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54954,0.0579629,-8.00155e-05,6.11861e-08,-1.90165e-11,83727.9,19.6815], Tmin=(100,'K'), Tmax=(783.481,'K')), NASAPolynomial(coeffs=[8.66046,0.021658,-1.05072e-05,2.0401e-09,-1.43272e-13,82613.7,-12.8893], Tmin=(783.481,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(695.451,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CdCdJ2_triplet)"""),
)

species(
    label = 'CC1=CC=[C]O1(18662)',
    structure = SMILES('CC1=CC=[C]O1'),
    E0 = (150.754,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.84103,0.0183817,2.40924e-05,-3.44145e-08,1.1485e-11,18179.1,19.294], Tmin=(100,'K'), Tmax=(1117.34,'K')), NASAPolynomial(coeffs=[6.14747,0.0257489,-1.15791e-05,2.2517e-09,-1.60727e-13,16241.5,-2.38885], Tmin=(1117.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + ring(Furan) + radical(C=CJO)"""),
)

species(
    label = '[CH]=C1C=C(C)O1(18663)',
    structure = SMILES('[CH]=C1C=C(C)O1'),
    E0 = (302.558,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87028,0.0363424,-6.91462e-08,-2.90195e-08,1.44738e-11,36475.4,17.3697], Tmin=(100,'K'), Tmax=(971.307,'K')), NASAPolynomial(coeffs=[13.2559,0.0145025,-5.0233e-06,9.30522e-10,-6.83963e-14,33082,-43.3103], Tmin=(971.307,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(302.558,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(Cyclobutene) + radical(Cds_P)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.630824,'amu*angstrom^2'), symmetry=1, barrier=(14.5039,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (40.0639,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.22084,0.0161542,-7.04071e-06,1.2099e-09,-3.01617e-14,59071.4,10.7688], Tmin=(100,'K'), Tmax=(1807.72,'K')), NASAPolynomial(coeffs=[6.96326,0.0100049,-3.70701e-06,6.3279e-10,-4.0564e-14,57370,-10.4654], Tmin=(1807.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(490.907,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[C]#COC(=[CH])C(18664)',
    structure = SMILES('[C]#COC(=[CH])C'),
    E0 = (721.589,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3120,650,792.5,1650,2175,525,257.534,257.537],'cm^-1')),
        HinderedRotor(inertia=(0.221806,'amu*angstrom^2'), symmetry=1, barrier=(10.4388,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.221837,'amu*angstrom^2'), symmetry=1, barrier=(10.4397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.924246,'amu*angstrom^2'), symmetry=1, barrier=(43.4975,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43233,0.0599581,-8.70407e-05,6.90353e-08,-2.17448e-11,86876.2,20.8633], Tmin=(100,'K'), Tmax=(843.615,'K')), NASAPolynomial(coeffs=[9.03834,0.0199198,-8.78335e-06,1.60798e-09,-1.08213e-13,85734.3,-13.6996], Tmin=(843.615,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(721.589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Cds_P) + radical(Acetyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH]=COC#C(15069)'],
    products = ['[CH]=C(C)OC#C(16767)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[C]=C(C)OC#C(18661)'],
    products = ['[CH]=C(C)OC#C(16767)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'C#COC#C(10719)'],
    products = ['[CH]=C(C)OC#C(16767)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(0.285789,'m^3/(mol*s)'), n=2.41919, Ea=(30.9288,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Ct_Ct;CsJ-HHH] for rate rule [Ct-O_Ct;CsJ-HHH]
...
reaction(
    label = 'reaction7',
    reactants = ['HCCO(2227)', 'propyne(3682)'],
    products = ['[CH]=C(C)OC#C(16767)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(520000,'m^3/(mol*s)'), n=0, Ea=(47.0674,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Ct_Ct;OJ_sec] for rate rule [Ct-Cs_Ct-H;O_rad/OneDe]
Euclidian distance = 2.23606797749979
family: R_Addition_MultipleBond
Ea raised from 42.8 to 47.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction8',
    reactants = ['HCCO(2227)', '[CH]=[C]C(16803)'],
    products = ['[CH]=C(C)OC#C(16767)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HC2(2881)', '[CH]=C(C)[O](2895)'],
    products = ['[CH]=C(C)OC#C(16767)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[C]#COC(=[CH])C(18664)'],
    products = ['[CH]=C(C)OC#C(16767)'],
