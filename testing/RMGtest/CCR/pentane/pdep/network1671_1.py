...
species(
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19333,0.0662945,-0.000103969,8.51444e-08,-2.70235e-11,20023.9,22.2149], Tmin=(100,'K'), Tmax=(880.179,'K')), NASAPolynomial(coeffs=[9.76595,0.0187148,-8.19141e-06,1.47217e-09,-9.70488e-14,18848.8,-16.1518], Tmin=(880.179,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(165.684,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.14363,0.0711938,-0.000126041,1.13005e-07,-3.8215e-11,46427.4,25.4935], Tmin=(100,'K'), Tmax=(887.877,'K')), NASAPolynomial(coeffs=[7.91939,0.0216375,-1.01681e-05,1.8609e-09,-1.22767e-13,45974.3,-2.1656], Tmin=(887.877,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(385.23,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(C2CsJOH) + radical(CCCJ=O) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54175,0.0566021,-7.78055e-05,5.74879e-08,-1.69071e-11,49217.9,27.1406], Tmin=(100,'K'), Tmax=(834.055,'K')), NASAPolynomial(coeffs=[9.67515,0.0175928,-7.64468e-06,1.40399e-09,-9.52674e-14,47861.2,-10.622], Tmin=(834.055,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(408.504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(CCJ2_triplet) + radical(CCCJ=O)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['O(4)', '[CH][CH]C[C]=O(7099)'],
    products = ['[CH]C([O])C[C]=O(2828)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(2355)', '[CH]C([CH2])[O](6989)'],
    products = ['[CH]C([O])C[C]=O(2828)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(2039)', '[CH]C([CH2])[O](6989)'],
    products = ['[CH]C([O])C[C]=O(2828)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]C([O])C=C=O(7101)'],
    products = ['[CH]C([O])C[C]=O(2828)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH](6993)', 'O=[C]CC=O(2835)'],
    products = ['[CH]C([O])C[C]=O(2828)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(127.359,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 123.5 to 127.4 kJ/mol to match endothermicity of reaction."""),
)
