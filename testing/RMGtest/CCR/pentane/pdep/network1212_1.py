...
species(
    label = '[CH]C(CC)OC#C(7379)',
    structure = SMILES('[CH]C(CC)OC#C'),
    E0 = (411.831,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0308852,0.0757714,-5.69426e-05,9.60227e-09,4.4419e-12,49685.1,25.5342], Tmin=(100,'K'), Tmax=(977.84,'K')), NASAPolynomial(coeffs=[20.3937,0.017524,-6.01748e-06,1.08064e-09,-7.73018e-14,44505.2,-78.3718], Tmin=(977.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(411.831,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCJ2_triplet)"""),
)

species(
    label = 'CCC1CC=[C]O1(7380)',
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62059,0.032883,5.76562e-05,-1.03741e-07,4.44597e-11,6239.63,21.4595], Tmin=(100,'K'), Tmax=(919.842,'K')), NASAPolynomial(coeffs=[15.9742,0.0207073,-4.41868e-06,6.28787e-10,-4.50153e-14,1473.52,-58.1426], Tmin=(919.842,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.017,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(2,3-Dihydrofuran) + radical(C=CJO)"""),
)
...
species(
    label = 'C#COC(=C)CC(7382)',
    structure = SMILES('C#COC(=C)CC'),
    E0 = (114.703,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,2175,525,750,770,3400,2100,369.278,369.404,369.816],'cm^-1')),
        HinderedRotor(inertia=(0.151427,'amu*angstrom^2'), symmetry=1, barrier=(14.7119,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151783,'amu*angstrom^2'), symmetry=1, barrier=(14.7111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.2383,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.151667,'amu*angstrom^2'), symmetry=1, barrier=(14.7111,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.733043,0.065879,-5.35969e-05,2.24657e-08,-3.80649e-12,13918.1,25.1435], Tmin=(100,'K'), Tmax=(1397.63,'K')), NASAPolynomial(coeffs=[14.7579,0.0257398,-1.05174e-05,1.91675e-09,-1.30783e-13,9997.79,-47.2133], Tmin=(1397.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.224506,0.0887758,-0.000102637,6.0415e-08,-1.38572e-11,61647.3,25.9412], Tmin=(100,'K'), Tmax=(1074.03,'K')), NASAPolynomial(coeffs=[18.1068,0.0205045,-7.2881e-06,1.23022e-09,-8.07839e-14,57709.6,-63.8056], Tmin=(1074.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(511.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CJC(C)OC) + radical(Acetyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'C#COC([CH2])C(2293)'],
    products = ['C#COC([CH2])CC(2480)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', 'C#CO[CH]CC(3083)'],
    products = ['C#COC([CH2])CC(2480)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]C(CC)OC#C(7379)'],
    products = ['C#COC([CH2])CC(2480)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H5(14)', 'C#COC=C(3099)'],
    products = ['C#COC([CH2])CC(2480)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HCCO(2227)', 'butene1(35)'],
    products = ['C#COC([CH2])CC(2480)'],
...
reaction(
    label = 'reaction12',
    reactants = ['HC2(2881)', '[CH2]C([O])CC(1362)'],
    products = ['C#COC([CH2])CC(2480)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(17)', 'C#COC([CH2])[CH2](2588)'],
    products = ['C#COC([CH2])CC(2480)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C#COC([CH2])C[CH2](6768)'],
    products = ['C#COC([CH2])CC(2480)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[C]#COC([CH2])CC(7384)'],
    products = ['C#COC([CH2])CC(2480)'],
