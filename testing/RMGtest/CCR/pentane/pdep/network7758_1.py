...
species(
    label = '[CH][C]=CO[CH2](29284)',
    structure = SMILES('[CH][C]=CO[CH2]'),
    E0 = (616.549,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,341.25,341.25,341.25,341.25,341.251],'cm^-1')),
        HinderedRotor(inertia=(0.604974,'amu*angstrom^2'), symmetry=1, barrier=(49.9931,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.604973,'amu*angstrom^2'), symmetry=1, barrier=(49.9931,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.604973,'amu*angstrom^2'), symmetry=1, barrier=(49.9931,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C#CO[CH2](29286)',
    structure = SMILES('[CH2]C#CO[CH2]'),
    E0 = (363.464,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2100,2250,500,550,415.035,415.347],'cm^-1')),
        HinderedRotor(inertia=(0.214894,'amu*angstrom^2'), symmetry=1, barrier=(26.2422,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214616,'amu*angstrom^2'), symmetry=1, barrier=(26.2434,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214641,'amu*angstrom^2'), symmetry=1, barrier=(26.2436,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92158,0.0351276,-6.23664e-06,-2.61161e-08,1.49875e-11,43799.2,17.0375], Tmin=(100,'K'), Tmax=(939.511,'K')), NASAPolynomial(coeffs=[15.2293,0.00507245,-7.25149e-07,1.11928e-10,-1.15121e-14,40124.5,-52.5828], Tmin=(939.511,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(363.464,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CtHHH) + group(Cs-OsHHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(Propargyl) + radical(CsJOCH3)"""),
)
...
species(
    label = '[CH2][C]=[C]O[CH2](29287)',
    structure = SMILES('[CH2][C]=[C]O[CH2]'),
    E0 = (637.108,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1670,1700,300,440,253.449,920.668],'cm^-1')),
        HinderedRotor(inertia=(0.0226357,'amu*angstrom^2'), symmetry=1, barrier=(13.4146,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.58311,'amu*angstrom^2'), symmetry=1, barrier=(13.4068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0484836,'amu*angstrom^2'), symmetry=1, barrier=(29.0134,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02282,0.0378533,-2.63841e-05,2.45714e-09,3.16834e-12,76702.7,22.1244], Tmin=(100,'K'), Tmax=(958.349,'K')), NASAPolynomial(coeffs=[11.8109,0.0100358,-3.24864e-06,5.57305e-10,-3.8807e-14,74227.9,-27.8043], Tmin=(958.349,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(637.108,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(C=COCJ) + radical(Cds_S) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C=[C]O[CH2](29288)',
    structure = SMILES('[CH2]C=[C]O[CH2]'),
    E0 = (399.266,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05647,0.0332415,-1.52644e-06,-2.69555e-08,1.42245e-11,48099.3,21.5301], Tmin=(100,'K'), Tmax=(944.95,'K')), NASAPolynomial(coeffs=[12.9967,0.0105427,-2.97532e-06,5.09379e-10,-3.75722e-14,44977.5,-36.2087], Tmin=(944.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(399.266,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(C=COCJ) + radical(C=CJO)"""),
)

species(
    label = '[CH2][C]=[C]OC(29289)',
    structure = SMILES('[CH2][C]=[C]OC'),
    E0 = (445.1,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,1670,1700,300,440,264.82,266.334],'cm^-1')),
        HinderedRotor(inertia=(0.00238255,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.42101,'amu*angstrom^2'), symmetry=1, barrier=(21.1907,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.419195,'amu*angstrom^2'), symmetry=1, barrier=(21.2059,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90289,0.0399941,-2.48628e-05,-4.68218e-11,4.03815e-12,53614.2,20.0693], Tmin=(100,'K'), Tmax=(964.998,'K')), NASAPolynomial(coeffs=[11.8294,0.0128098,-4.30969e-06,7.47193e-10,-5.1776e-14,51048.3,-30.8349], Tmin=(964.998,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(445.1,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(Cds_S) + radical(C=CJO)"""),
)

species(
    label = '[CH2]O[C]=[C]C(29290)',
    structure = SMILES('[CH2]O[C]=[C]C'),
    E0 = (485.609,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,1670,1700,300,440,376.486,376.515],'cm^-1')),
        HinderedRotor(inertia=(0.00118904,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107809,'amu*angstrom^2'), symmetry=1, barrier=(10.8507,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107782,'amu*angstrom^2'), symmetry=1, barrier=(10.85,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.99784,0.0406295,-3.58302e-05,1.68075e-08,-3.17844e-12,58480.2,21.9344], Tmin=(100,'K'), Tmax=(1269.69,'K')), NASAPolynomial(coeffs=[10.0827,0.0151594,-5.74005e-06,1.00833e-09,-6.76251e-14,56427.1,-19.0006], Tmin=(1269.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(485.609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COCJ) + radical(Cds_S) + radical(C=CJO)"""),
)

species(
    label = 'C=[C]C1CO1(29291)',
    ...
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.52303,0.0229682,2.63042e-05,-5.89496e-08,2.8392e-11,28696.4,16.1679], Tmin=(100,'K'), Tmax=(853.541,'K')), NASAPolynomial(coeffs=[11.2462,0.00994331,2.42489e-07,-3.59813e-10,3.24874e-14,26192.7,-30.4785], Tmin=(853.541,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(238.077,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_S)"""),
)

species(
    label = 'C#C[CH]O[CH2](29292)',
    structure = SMILES('[CH]=C=CO[CH2]'),
    E0 = (339.104,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,540,610,2055,3120,650,792.5,1650,180],'cm^-1')),
        HinderedRotor(inertia=(1.25231,'amu*angstrom^2'), symmetry=1, barrier=(28.793,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.252,'amu*angstrom^2'), symmetry=1, barrier=(28.786,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90099,0.0345611,2.4184e-07,-3.90585e-08,2.20362e-11,40871.3,18.3613], Tmin=(100,'K'), Tmax=(893.634,'K')), NASAPolynomial(coeffs=[16.5622,0.00103568,2.63462e-06,-6.47387e-10,4.53168e-14,36969.2,-57.8934], Tmin=(893.634,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(339.104,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=COCJ) + radical(C=C=CJ)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.13779,'amu*angstrom^2'), symmetry=1, barrier=(49.152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.13641,'amu*angstrom^2'), symmetry=1, barrier=(49.1202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.13926,'amu*angstrom^2'), symmetry=1, barrier=(49.1858,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70598,0.0405035,-5.61545e-06,-2.67333e-08,1.47957e-11,51152.2,18.4759], Tmin=(100,'K'), Tmax=(938.317,'K')), NASAPolynomial(coeffs=[13.5212,0.0149951,-4.57767e-06,7.64415e-10,-5.34232e-14,47840.6,-43.6049], Tmin=(938.317,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(424.541,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(20)', '[CH2][C]=C[O](16852)'],
    products = ['[CH2][C]=CO[CH2](28915)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH]OC=[C][CH2](17775)'],
    products = ['[CH2][C]=CO[CH2](28915)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH][C]=CO[CH2](29284)'],
    products = ['[CH2][C]=CO[CH2](28915)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH2]C#CO[CH2](29286)'],
    products = ['[CH2][C]=CO[CH2](28915)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH2][C]=[C]O[CH2](29287)'],
    products = ['[CH2][C]=CO[CH2](28915)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C#C[CH]O[CH2](29292)'],
    products = ['[CH2][C]=CO[CH2](28915)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(T)(20)', 'CH2CCHO(16849)'],
    products = ['[CH2][C]=CO[CH2](28915)'],
