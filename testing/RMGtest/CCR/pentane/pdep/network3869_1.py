...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12793,0.0595968,-6.65093e-05,4.15282e-08,-9.97672e-12,80720.6,22.2721], Tmin=(100,'K'), Tmax=(1184.99,'K')), NASAPolynomial(coeffs=[10.5517,0.0191678,-4.4231e-06,4.61154e-10,-1.77915e-14,79092.3,-22.2383], Tmin=(1184.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(670.263,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C]1CC[CH]O1(17628)',
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.864326,0.0518409,-4.35502e-05,2.03199e-08,-3.59803e-12,69210.8,21.7665], Tmin=(100,'K'), Tmax=(1676.62,'K')), NASAPolynomial(coeffs=[10.5342,0.0175848,-2.89486e-06,1.74941e-10,-8.65594e-16,67540.5,-25.1934], Tmin=(1676.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(574.39,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(C2CsJOCs) + radical(CCsJOCs) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C(=[CH])O[CH][CH2](17630)',
    structure = SMILES('[CH]C(=[CH])O[CH][CH2]'),
    E0 = (795.999,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,350,440,435,1725,3000,3100,440,815,1455,1000,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.332019,0.0743732,-7.92391e-05,3.8436e-08,-6.16595e-12,95874.3,25.4724], Tmin=(100,'K'), Tmax=(961.139,'K')), NASAPolynomial(coeffs=[18.1453,0.0133418,-4.43878e-06,7.36281e-10,-4.91784e-14,91844.9,-62.9085], Tmin=(961.139,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(795.999,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(CJCO) + radical(AllylJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=[CH])OC[CH2](17631)',
    structure = SMILES('[CH]C(=[CH])OC[CH2]'),
    E0 = (602.071,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3000,3100,440,815,1455,1000,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.678407,0.065221,-5.3199e-05,1.68527e-08,-1.73747e-13,72538.9,24.0625], Tmin=(100,'K'), Tmax=(995.347,'K')), NASAPolynomial(coeffs=[15.8,0.0195576,-7.14838e-06,1.25618e-09,-8.60736e-14,68780.4,-52.579], Tmin=(995.347,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(602.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CJCO) + radical(AllylJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(=[CH])O[CH]C(17632)',
    structure = SMILES('[CH]C(=[CH])O[CH]C'),
    E0 = (584.409,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,350,440,435,1725,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.132982,0.0732301,-7.31654e-05,3.63003e-08,-6.95303e-12,70437.5,24.8655], Tmin=(100,'K'), Tmax=(1346.75,'K')), NASAPolynomial(coeffs=[18.9109,0.0145232,-4.50984e-06,6.96731e-10,-4.35427e-14,65645.7,-70.3295], Tmin=(1346.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(584.409,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(AllylJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    label = '[C]=C([CH2])O[CH][CH2](17633)',
    structure = SMILES('[C]C(=C)O[CH][CH2]'),
    E0 = (847.696,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3025,407.5,1350,352.5,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,211.92,212.398,212.587,213.916],'cm^-1')),
        HinderedRotor(inertia=(0.586959,'amu*angstrom^2'), symmetry=1, barrier=(18.7665,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.581609,'amu*angstrom^2'), symmetry=1, barrier=(18.7621,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.589909,'amu*angstrom^2'), symmetry=1, barrier=(18.7549,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.109013,0.0759284,-9.32027e-05,5.30614e-08,-1.13227e-11,102103,23.906], Tmin=(100,'K'), Tmax=(1241.13,'K')), NASAPolynomial(coeffs=[21.0877,0.00355397,2.35342e-08,-1.06527e-10,9.70238e-15,97262,-80.3582], Tmin=(1241.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(847.696,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(CJCO) + radical(CJ3)"""),
)

species(
    label = '[CH2][CH]OC1=CC1(17634)',
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55355,0.0331418,3.91706e-05,-8.86105e-08,4.02188e-11,41094,22.9123], Tmin=(100,'K'), Tmax=(930.094,'K')), NASAPolynomial(coeffs=[20.7747,0.00349343,1.48645e-06,-3.15903e-10,1.36422e-14,35225.4,-80.7529], Tmin=(930.094,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(340.784,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(C2CsJOC(O)) + radical(CCJCO)"""),
)

species(
    label = '[CH]=C1CC([CH2])O1(9839)',
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32397,0.0432332,1.01351e-05,-6.12982e-08,3.25811e-11,44124.3,17.2721], Tmin=(100,'K'), Tmax=(888.369,'K')), NASAPolynomial(coeffs=[19.6725,0.0040735,2.87928e-06,-7.88572e-10,5.6799e-14,39149.4,-78.7284], Tmin=(888.369,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(365.946,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(CJC(C)OC) + radical(Cds_P)"""),
)
...
species(
    label = '[CH][C](C)O[C]=C(17635)',
    structure = SMILES('[CH][C](C)O[C]=C'),
    E0 = (666.245,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,2950,3100,1380,975,1025,1650,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.923297,0.0639536,-6.86765e-05,3.72766e-08,-7.9295e-12,80244.7,26.5647], Tmin=(100,'K'), Tmax=(1150.8,'K')), NASAPolynomial(coeffs=[14.6949,0.0160861,-6.28422e-06,1.13248e-09,-7.75783e-14,77075,-41.8095], Tmin=(1150.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(666.245,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C2CsJOC(O)) + radical(C=CJO) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([CH2])OC=[CH](17636)',
    structure = SMILES('[CH]C([CH2])OC=[CH]'),
    E0 = (683.891,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.254521,0.0775574,-8.76347e-05,4.62224e-08,-9.04458e-12,82420,27.0143], Tmin=(100,'K'), Tmax=(1427.13,'K')), NASAPolynomial(coeffs=[22.1126,0.00417821,7.25034e-07,-3.01425e-10,2.45972e-14,77124.3,-85.0362], Tmin=(1427.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(683.891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[CH][CH]OC(=[CH])C(16579)',
    structure = SMILES('[CH][CH]OC(=[CH])C'),
    E0 = (661.94,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3025,407.5,1350,352.5,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.413782,0.0725372,-8.02193e-05,4.07021e-08,-7.19659e-12,79747.8,24.4402], Tmin=(100,'K'), Tmax=(981.64,'K')), NASAPolynomial(coeffs=[18.4302,0.0107072,-3.43959e-06,5.78978e-10,-3.9574e-14,75652.6,-64.9872], Tmin=(981.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(661.94,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(Cds_P) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]C(=C)O[CH][CH2](15945)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH][CH2](502)', '[CH]=C([CH2])[O](9653)'],
    products = ['[CH]C(=C)O[CH][CH2](15945)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]C(=C)O[C][CH2](17627)'],
    products = ['[CH]C(=C)O[CH][CH2](15945)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH][CH]OC([CH])=C(16574)'],
    products = ['[CH]C(=C)O[CH][CH2](15945)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    ...
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.36716e+08,'s^-1'), n=1.01412, Ea=(115.772,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R5;doublebond_intra_2H;radadd_intra_cs2H]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 114.0 to 115.8 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]C(=[CH])O[CH][CH2](17630)'],
    products = ['[CH]C(=C)O[CH][CH2](15945)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]C(=[CH])OC[CH2](17631)'],
    products = ['[CH]C(=C)O[CH][CH2](15945)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]C(=[CH])O[CH]C(17632)'],
    products = ['[CH]C(=C)O[CH][CH2](15945)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(T)(20)', '[CH]=[C]O[CH][CH2](9651)'],
    products = ['[CH]C(=C)O[CH][CH2](15945)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[C]=C([CH2])O[CH][CH2](17633)'],
    products = ['[CH]C(=C)O[CH][CH2](15945)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(T)(20)', 'C#CO[CH][CH2](3100)'],
    products = ['[CH]C(=C)O[CH][CH2](15945)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C2H3(60)', '[CH]=C([CH2])[O](9653)'],
    products = ['[CH]C(=C)O[CH][CH2](15945)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C2H3(60)', '[CH][C]([CH2])[O](13252)'],
    products = ['[CH]C(=C)O[CH][CH2](15945)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]C([CH2])OC=[CH](17636)'],
    products = ['[CH]C(=C)O[CH][CH2](15945)'],
...
network(
    label = 'PDepNetwork #3869',
    isomers = [
        '[CH]C(=C)O[CH][CH2](15945)',
    ],
    reactants = [
