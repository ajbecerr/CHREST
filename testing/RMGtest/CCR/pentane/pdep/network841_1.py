...
species(
    label = 'CC([O])C1CO1(3467)',
    structure = SMILES('CC([O])C1CO1'),
    E0 = (-69.3204,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64485,0.0428168,9.97212e-07,-4.04194e-08,2.2809e-11,-8243.83,19.6295], Tmin=(100,'K'), Tmax=(857.401,'K')), NASAPolynomial(coeffs=[13.0314,0.0173556,-2.8498e-06,1.97634e-10,-4.9807e-15,-11213.1,-39.4811], Tmin=(857.401,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-69.3204,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31086,0.0497092,-2.25517e-05,-1.13834e-08,9.4844e-12,-31897,24.555], Tmin=(100,'K'), Tmax=(958.687,'K')), NASAPolynomial(coeffs=[14.6721,0.0163117,-5.26765e-06,9.15956e-10,-6.45995e-14,-35485.9,-44.6986], Tmin=(958.687,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-266.082,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.87031,0.0680784,-7.58777e-05,4.44493e-08,-1.03509e-11,19873.4,26.6318], Tmin=(100,'K'), Tmax=(1047.03,'K')), NASAPolynomial(coeffs=[13.1829,0.0210394,-8.4877e-06,1.54009e-09,-1.05329e-13,17295.1,-33.3352], Tmin=(1047.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(164.294,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CJCO) + radical(CJCO)"""),
)

species(
    label = '[CH2]C(O)[C](C)[O](3478)',
    structure = SMILES('[CH2]C(O)[C](C)[O]'),
    E0 = (129.333,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]C([O])C[O](3464)'],
    products = ['[CH2]C([O])C(C)[O](3178)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(4)', '[CH2]C([O])[CH]C(1585)'],
    products = ['[CH2]C([O])C(C)[O](3178)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(4)', '[CH2][CH]C(C)[O](1587)'],
    products = ['[CH2]C([O])C(C)[O](3178)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(20)', 'CC([O])[CH][O](3465)'],
    products = ['[CH2]C([O])C(C)[O](3178)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C([O])C(C)[O](3466)'],
    products = ['[CH2]C([O])C(C)[O](3178)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2]C([O])C(C)=O(1977)'],
    products = ['[CH2]C([O])C(C)[O](3178)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]C(=O)C(C)[O](1979)'],
    products = ['[CH2]C([O])C(C)[O](3178)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH2(T)(20)', 'CH3CHOCHO(3472)'],
    products = ['[CH2]C([O])C(C)[O](3178)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH3(17)', '[CH2]C([O])C=O(1981)'],
    products = ['[CH2]C([O])C(C)[O](3178)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH3(17)', '[CH2]C([O])[CH][O](1973)'],
    products = ['[CH2]C([O])C(C)[O](3178)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH2]C([O])[C](C)[O](1984)'],
    products = ['[CH2]C([O])C(C)[O](3178)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2][C]([O])C(C)[O](1986)'],
    products = ['[CH2]C([O])C(C)[O](3178)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2]C([O])C([CH2])[O](1530)'],
    products = ['[CH2]C([O])C(C)[O](3178)'],
