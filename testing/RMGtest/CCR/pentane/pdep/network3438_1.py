...
species(
    label = '[CH]=CC[CH][O](15044)',
    structure = SMILES('[CH]=CC[CH][O]'),
    E0 = (476.75,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,3120,650,792.5,1650,180,1380.6],'cm^-1')),
        HinderedRotor(inertia=(0.307313,'amu*angstrom^2'), symmetry=1, barrier=(7.06574,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.307435,'amu*angstrom^2'), symmetry=1, barrier=(7.06853,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0447,0.0483647,-7.07381e-05,6.46192e-08,-2.365e-11,57405,20.6123], Tmin=(100,'K'), Tmax=(826.183,'K')), NASAPolynomial(coeffs=[4.29485,0.0269513,-1.27616e-05,2.42549e-09,-1.67019e-13,57392.2,12.359], Tmin=(826.183,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(476.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCsJOH) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]C([O])C=[CH](15060)',
    structure = SMILES('[CH]C([O])C=[CH]'),
    E0 = (736.344,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,612.564,612.711,613.234,615.594],'cm^-1')),
        HinderedRotor(inertia=(0.0153805,'amu*angstrom^2'), symmetry=1, barrier=(4.10613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.043984,'amu*angstrom^2'), symmetry=1, barrier=(11.6822,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98386,0.0375063,-2.25502e-05,-1.61912e-09,4.2785e-12,88640.3,21.797], Tmin=(100,'K'), Tmax=(994.086,'K')), NASAPolynomial(coeffs=[12.3755,0.0104002,-3.84195e-06,7.17724e-10,-5.21277e-14,85847.6,-31.9301], Tmin=(994.086,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(736.344,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=CC1CO1(15184)',
    structure = SMILES('[CH]=CC1CO1'),
    E0 = (247.331,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.47156,0.0220214,3.39631e-05,-7.02062e-08,3.31643e-11,29813.3,16.2817], Tmin=(100,'K'), Tmax=(861.646,'K')), NASAPolynomial(coeffs=[12.7134,0.00754651,1.59106e-06,-6.16311e-10,4.9407e-14,26820.7,-38.7277], Tmin=(861.646,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(247.331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C1C=CO1(15181)',
    ...
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96042,0.0216293,6.16467e-05,-1.13358e-07,5.00821e-11,20903.7,14.8506], Tmin=(100,'K'), Tmax=(918.711,'K')), NASAPolynomial(coeffs=[21.798,-0.00436653,5.5141e-06,-1.09318e-09,6.69427e-14,14710.8,-93.0392], Tmin=(918.711,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(173.013,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(CJC(C)OC)"""),
)

species(
    label = '[O]C1C=CC1(15172)',
    ...
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.86312,0.00713014,7.39935e-05,-1.03469e-07,4.05222e-11,24354.8,15.7629], Tmin=(100,'K'), Tmax=(950.684,'K')), NASAPolynomial(coeffs=[12.9223,0.0102449,-2.61437e-06,5.27382e-10,-4.62906e-14,20388.8,-43.0573], Tmin=(950.684,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(202.022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(232.805,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH]=CC(=C)O(15185)',
    ...
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55551,0.0432869,-1.76989e-05,-2.10388e-08,1.52116e-11,15387.4,16.4164], Tmin=(100,'K'), Tmax=(907.966,'K')), NASAPolynomial(coeffs=[16.9959,0.00364244,9.1463e-07,-2.83683e-10,1.9138e-14,11413.8,-63.0252], Tmin=(907.966,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(127.124,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC(C)=O(15186)',
    structure = SMILES('[CH]=CC(C)=O'),
    E0 = (120.602,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.72572,0.0297241,-1.46437e-05,2.73919e-09,-1.34381e-13,14549.4,16.4009], Tmin=(100,'K'), Tmax=(2060.69,'K')), NASAPolynomial(coeffs=[13.6523,0.0132573,-6.10949e-06,1.09509e-09,-7.04134e-14,9039.2,-46.6569], Tmin=(2060.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(120.602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)HHH) + group(Cds-O2d(Cds-Cds)Cs) + group(Cd-Cd(CO)H) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62185,0.0430874,-1.22518e-05,-2.21456e-08,1.41115e-11,34388.7,19.3643], Tmin=(100,'K'), Tmax=(914.567,'K')), NASAPolynomial(coeffs=[13.9913,0.0133323,-3.37798e-06,4.91279e-10,-3.24684e-14,31108,-44.7728], Tmin=(914.567,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(285.141,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(O)CJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C[C](C)[O](15188)',
...
species(
    label = '[CH]=[C]C([CH2])O(15189)',
    structure = SMILES('[CH]=[C]C([CH2])O'),
    E0 = (507.199,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(0.0848576,'amu*angstrom^2'), symmetry=1, barrier=(10.9393,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0851491,'amu*angstrom^2'), symmetry=1, barrier=(10.928,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0849858,'amu*angstrom^2'), symmetry=1, barrier=(10.9208,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77961,0.0471463,-4.96278e-05,2.70935e-08,-5.86668e-12,61083.3,22.8261], Tmin=(100,'K'), Tmax=(1124.05,'K')), NASAPolynomial(coeffs=[11.031,0.0142241,-5.69388e-06,1.03623e-09,-7.11908e-14,59003.5,-22.8883], Tmin=(1124.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(507.199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC([CH2])[O](13696)'],
    products = ['C2H2(1342)', 'vinoxy(1351)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['O(4)', '[CH]C=C[CH2](15066)'],
    products = ['[CH]=CC([CH2])[O](13696)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[CH]=C[CH][O](15182)'],
    products = ['[CH]=CC([CH2])[O](13696)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]C([O])C=[CH](15060)'],
    products = ['[CH]=CC([CH2])[O](13696)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[C]=CC([CH2])[O](15183)'],
    products = ['[CH]=CC([CH2])[O](13696)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C#CC([CH2])[O](10254)'],
    products = ['[CH]=CC([CH2])[O](13696)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH2(T)(20)', 'CHCHCHO(3667)'],
    products = ['[CH]=CC([CH2])[O](13696)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C2H2(T)(1343)', 'vinoxy(1351)'],
    products = ['[CH]=CC([CH2])[O](13696)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C2H2(1342)', '[CH2][CH][O](1556)'],
    products = ['[CH]=CC([CH2])[O](13696)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C2H2(T)(1343)', '[CH2][CH][O](1556)'],
    products = ['[CH]=CC([CH2])[O](13696)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH][CH]C(=C)[O](7131)'],
    products = ['[CH]=CC([CH2])[O](13696)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH]=[C]C([CH2])[O](10250)'],
    products = ['[CH]=CC([CH2])[O](13696)'],
