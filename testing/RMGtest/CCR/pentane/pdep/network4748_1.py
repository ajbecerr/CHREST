...
species(
    label = 'C#CCC(C)[O](15510)',
    structure = SMILES('C#CCC(C)[O]'),
    E0 = (183.692,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2175,525,750,770,3400,2100,180,180],'cm^-1')),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0252701,'amu*angstrom^2'), symmetry=1, barrier=(0.58101,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(5.20297,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34249,0.0530072,-3.86528e-05,1.16699e-08,-1.13392e-13,22193.5,21.8691], Tmin=(100,'K'), Tmax=(996.629,'K')), NASAPolynomial(coeffs=[11.4779,0.0224761,-7.97422e-06,1.36469e-09,-9.11125e-14,19669.2,-29.5224], Tmin=(996.629,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(183.692,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CC([O])C[C]=C[O](23238)',
    structure = SMILES('CC([O])C[C]=C[O]'),
    E0 = (188.1,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,1685,370,390.203,390.203,390.203,390.203],'cm^-1')),
        HinderedRotor(inertia=(0.146948,'amu*angstrom^2'), symmetry=1, barrier=(15.8772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146948,'amu*angstrom^2'), symmetry=1, barrier=(15.8772,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146948,'amu*angstrom^2'), symmetry=1, barrier=(15.8772,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.674333,0.0633022,-4.20759e-05,3.61031e-09,4.71543e-12,22751.7,28.1681], Tmin=(100,'K'), Tmax=(988.7,'K')), NASAPolynomial(coeffs=[16.7384,0.0192005,-6.85908e-06,1.23347e-09,-8.69753e-14,18554.2,-54.3126], Tmin=(988.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(188.1,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CC(C)OJ) + radical(C=COJ) + radical(Cds_S)"""),
)
...
species(
    label = 'CC([O])CC1=COO1(23239)',
    structure = SMILES('CC([O])CC1=COO1'),
    E0 = (113.586,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.713441,0.0583086,-1.59646e-05,-2.41583e-08,1.38723e-11,13791.9,29.413], Tmin=(100,'K'), Tmax=(1007.47,'K')), NASAPolynomial(coeffs=[17.5206,0.0225747,-8.91063e-06,1.71216e-09,-1.25345e-13,8832.3,-59.6037], Tmin=(1007.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(113.586,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-CsH) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.803019,0.0588819,-2.86673e-05,-1.06964e-08,9.83264e-12,15206.1,25.7723], Tmin=(100,'K'), Tmax=(978.96,'K')), NASAPolynomial(coeffs=[16.9771,0.0186222,-6.55308e-06,1.19313e-09,-8.57201e-14,10801.7,-58.2352], Tmin=(978.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.388,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclopropene) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    E0 = (157.539,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,3010,987.5,1337.5,450,1655,1685,370,303.977,304.003],'cm^-1')),
        HinderedRotor(inertia=(0.00182399,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146389,'amu*angstrom^2'), symmetry=1, barrier=(9.59978,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146393,'amu*angstrom^2'), symmetry=1, barrier=(9.59981,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146402,'amu*angstrom^2'), symmetry=1, barrier=(9.59956,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = 'CC([O])CC#CO[O](21042)',
    structure = SMILES('CC([O])CC#CO[O]'),
    E0 = (310.81,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2100,2250,500,550,180,180,3371.08],'cm^-1')),
        HinderedRotor(inertia=(0.696332,'amu*angstrom^2'), symmetry=1, barrier=(16.0101,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.32171,'amu*angstrom^2'), symmetry=1, barrier=(76.3728,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.696177,'amu*angstrom^2'), symmetry=1, barrier=(16.0065,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.31282,'amu*angstrom^2'), symmetry=1, barrier=(76.1682,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.703452,0.0743136,-8.43373e-05,5.35183e-08,-1.38209e-11,37498.9,30.4382], Tmin=(100,'K'), Tmax=(938.401,'K')), NASAPolynomial(coeffs=[11.3044,0.0291261,-1.21064e-05,2.20329e-09,-1.50023e-13,35509.3,-20.0312], Tmin=(938.401,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(310.81,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-OsCt) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(CC(C)OJ) + radical(ROOJ)"""),
)
...
species(
    ...
    E0 = (499.765,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3010,987.5,1337.5,450,1655,1685,370,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.283699,'amu*angstrom^2'), symmetry=1, barrier=(6.5228,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.283702,'amu*angstrom^2'), symmetry=1, barrier=(6.52288,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.283717,'amu*angstrom^2'), symmetry=1, barrier=(6.52321,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.283711,'amu*angstrom^2'), symmetry=1, barrier=(6.52307,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
...
species(
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0151625,0.09359,-0.000138386,1.11622e-07,-3.55909e-11,32539.6,33.5434], Tmin=(100,'K'), Tmax=(851.197,'K')), NASAPolynomial(coeffs=[11.5168,0.0312077,-1.37697e-05,2.52016e-09,-1.6934e-13,30883.5,-18.3191], Tmin=(851.197,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(269.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(C2CsJOH) + radical(Cds_S)"""),
)
...
species(
    label = 'CC([O])CC=[C]O[O](23242)',
    structure = SMILES('CC([O])CC=[C]O[O]'),
    E0 = (325.039,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.76107,0.0756495,-8.83732e-05,6.07169e-08,-1.74174e-11,39205.9,33.9165], Tmin=(100,'K'), Tmax=(838.753,'K')), NASAPolynomial(coeffs=[9.28071,0.0350214,-1.57187e-05,2.97155e-09,-2.06537e-13,37776.7,-5.68817], Tmin=(838.753,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(325.039,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CC(C)OJ) + radical(ROOJ) + radical(C=CJO)"""),
)

species(
    label = 'CC([O])C[C]=[C]OO(23243)',
    structure = SMILES('CC([O])C[C]=[C]OO'),
    E0 = (410.877,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1670,1700,300,440,200,800,1600],'cm^-1')),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.425312,0.0843354,-0.000110399,8.3623e-08,-2.61354e-11,49540.5,34.8342], Tmin=(100,'K'), Tmax=(775.804,'K')), NASAPolynomial(coeffs=[9.80554,0.0359642,-1.68605e-05,3.23109e-09,-2.25474e-13,48085.3,-8.03739], Tmin=(775.804,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(410.877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CC(C)OJ) + radical(Cds_S) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.103697,0.0889272,-0.000116685,8.20554e-08,-2.29694e-11,36744.1,34.4412], Tmin=(100,'K'), Tmax=(875.16,'K')), NASAPolynomial(coeffs=[13.4931,0.0277312,-1.17996e-05,2.15958e-09,-1.4683e-13,34400.5,-28.3699], Tmin=(875.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(304.365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(CJCO) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.386323,0.0865392,-0.000128023,1.0807e-07,-3.62499e-11,40116.3,35.9149], Tmin=(100,'K'), Tmax=(844.919,'K')), NASAPolynomial(coeffs=[8.66129,0.0354145,-1.60457e-05,2.9782e-09,-2.01884e-13,39144.5,-0.0884573], Tmin=(844.919,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Cds_S) + radical(C=CJO)"""),
)
...
species(
    label = 'C[C]([O])C[C]=COO(23246)',
    structure = SMILES('C[C]([O])C[C]=COO'),
    E0 = (347.76,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3010,987.5,1337.5,450,1655,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0877093,0.0909693,-0.000119188,8.49108e-08,-2.438e-11,41962.4,32.3436], Tmin=(100,'K'), Tmax=(848.964,'K')), NASAPolynomial(coeffs=[12.6528,0.031768,-1.4589e-05,2.77378e-09,-1.9297e-13,39828.9,-26.2187], Tmin=(848.964,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(347.76,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C([O])C[C]=COO(23247)',
    structure = SMILES('[CH2]C([O])C[C]=COO'),
    E0 = (382.721,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.107,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0989478,0.0873706,-0.000101932,6.21423e-08,-1.51177e-11,46170,33.5087], Tmin=(100,'K'), Tmax=(1000.3,'K')), NASAPolynomial(coeffs=[15.0742,0.0274874,-1.21346e-05,2.29514e-09,-1.60434e-13,43174,-38.7429], Tmin=(1000.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(382.721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CC(C)OJ) + radical(CJCO) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[O]CC[C]=CO[O](23237)'],
    products = ['CC([O])C[C]=CO[O](21065)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CC([O])C[C]=CO[O](21065)'],
    products = ['O2(S)(666)', 'C#CCC(C)[O](15510)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction5',
    reactants = ['O(4)', 'CC([O])C[C]=C[O](23238)'],
    products = ['CC([O])C[C]=CO[O](21065)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(4)', 'C[CH]C[C]=CO[O](21354)'],
    products = ['CC([O])C[C]=CO[O](21065)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[C]=CO[O](21346)', '[CH2]C(C)[O](667)'],
    products = ['CC([O])C[C]=CO[O](21065)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['CC([O])C[C]=CO[O](21065)'],
    products = ['O(4)', 'CC([O])CC1=CO1(23240)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'CC(=O)C[C]=CO[O](22843)'],
    products = ['CC([O])C[C]=CO[O](21065)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', 'CC([O])CC#CO[O](21042)'],
    products = ['CC([O])C[C]=CO[O](21065)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.0201871,'m^3/(mol*s)'), n=2.2105, Ea=(63.6596,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO-CsH_O;YJ] for rate rule [CO-CsH_O;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 59.3 to 63.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction18',
    reactants = ['CH3(17)', '[O]OC=[C]CC=O(21077)'],
    products = ['CC([O])C[C]=CO[O](21065)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O2(2)', 'C#CCC(C)[O](15510)'],
    products = ['CC([O])C[C]=CO[O](21065)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O2(2)', '[CH]=[C]CC(C)[O](15967)'],
    products = ['CC([O])C[C]=CO[O](21065)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH3(17)', '[O][CH]C[C]=CO[O](22760)'],
    products = ['CC([O])C[C]=CO[O](21065)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', 'C[C]([O])C[C]=CO[O](22848)'],
    products = ['CC([O])C[C]=CO[O](21065)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2]C([O])C[C]=CO[O](21021)'],
    products = ['CC([O])C[C]=CO[O](21065)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', 'CC([O])C[C]=[C]O[O](22852)'],
    products = ['CC([O])C[C]=CO[O](21065)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CC([O])C[C]=CO[O](21065)'],
    products = ['[CH2]C(O)C[C]=CO[O](23244)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CC([O])C[C]=CO[O](21065)'],
    products = ['CC(=O)C[CH][CH]O[O](3054)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]C([O])C[C]=COO(23247)'],
    products = ['CC([O])C[C]=CO[O](21065)'],
