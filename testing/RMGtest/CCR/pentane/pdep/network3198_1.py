...
species(
    label = '[CH]C=CC[CH]C(C)C(14399)',
    structure = SMILES('[CH]C=CC[CH]C(C)C'),
    E0 = (435.644,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.210923,0.0812633,-4.58856e-05,1.24436e-08,-1.3498e-12,52557.4,36.4805], Tmin=(100,'K'), Tmax=(2088.95,'K')), NASAPolynomial(coeffs=[22.536,0.0377061,-1.46083e-05,2.46158e-09,-1.55167e-13,43054.1,-90.0166], Tmin=(2088.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(435.644,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_S) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C=CCC(C)[C]C(14400)',
    structure = SMILES('[CH]C=CCC(C)[C]C'),
    E0 = (689.317,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.443445,0.0858009,-5.64815e-05,1.89396e-08,-2.59427e-12,83075.5,35.3275], Tmin=(100,'K'), Tmax=(1678.74,'K')), NASAPolynomial(coeffs=[18.7535,0.0400599,-1.5611e-05,2.70911e-09,-1.77217e-13,76630.1,-67.2315], Tmin=(1678.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(689.317,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCJ2_triplet) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH][CH]C[CH]C(C)[CH]C(14401)',
    structure = SMILES('[CH][CH]C[CH]C(C)[CH]C'),
    E0 = (789.974,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,219.89,1109.13,1234.15,1254.91,1322.52,1830.74,1933.83],'cm^-1')),
        HinderedRotor(inertia=(0.104824,'amu*angstrom^2'), symmetry=1, barrier=(3.0984,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104824,'amu*angstrom^2'), symmetry=1, barrier=(3.0984,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104824,'amu*angstrom^2'), symmetry=1, barrier=(3.0984,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104824,'amu*angstrom^2'), symmetry=1, barrier=(3.0984,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.104824,'amu*angstrom^2'), symmetry=1, barrier=(3.0984,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43701,0.0677719,5.27854e-06,-1.23468e-07,1.14636e-10,95092.4,36.5881], Tmin=(100,'K'), Tmax=(452.355,'K')), NASAPolynomial(coeffs=[3.94794,0.0617666,-2.85195e-05,5.50088e-09,-3.88187e-13,94699.5,24.6344], Tmin=(452.355,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(789.974,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Cs_S) + radical(RCCJC) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]CC[C](C)[CH]C(14402)',
    structure = SMILES('[CH][CH]CC[C](C)[CH]C'),
    E0 = (780.854,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3000,3050,390,425,1340,1360,335,370,181.667,192.929,773.359,955.934,2386.09,3337.66,3407.66],'cm^-1')),
        HinderedRotor(inertia=(0.110469,'amu*angstrom^2'), symmetry=1, barrier=(2.5579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110469,'amu*angstrom^2'), symmetry=1, barrier=(2.5579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110469,'amu*angstrom^2'), symmetry=1, barrier=(2.5579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110469,'amu*angstrom^2'), symmetry=1, barrier=(2.5579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110469,'amu*angstrom^2'), symmetry=1, barrier=(2.5579,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.191268,0.094288,-0.000122765,1.13218e-07,-4.31e-11,94042,39.4013], Tmin=(100,'K'), Tmax=(816.174,'K')), NASAPolynomial(coeffs=[1.77897,0.0652343,-3.02736e-05,5.73483e-09,-3.95483e-13,94491.3,36.4046], Tmin=(816.174,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(780.854,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Cs_S) + radical(RCCJC) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C[CH]C[C](C)[CH]C(14403)',
    structure = SMILES('[CH]C[CH]C[C](C)[CH]C'),
    E0 = (780.866,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3000,3050,390,425,1340,1360,335,370,189.878,524.644,632.698,949.425,2871.78,3105.02,4000],'cm^-1')),
        HinderedRotor(inertia=(0.114797,'amu*angstrom^2'), symmetry=1, barrier=(2.64035,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114797,'amu*angstrom^2'), symmetry=1, barrier=(2.64035,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114797,'amu*angstrom^2'), symmetry=1, barrier=(2.64035,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114797,'amu*angstrom^2'), symmetry=1, barrier=(2.64035,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114797,'amu*angstrom^2'), symmetry=1, barrier=(2.64035,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.224989,0.09481,-0.000128139,1.21864e-07,-4.7063e-11,94041,39.1081], Tmin=(100,'K'), Tmax=(821.807,'K')), NASAPolynomial(coeffs=[0.711847,0.0671403,-3.14564e-05,5.97249e-09,-4.11872e-13,94815.3,42.0527], Tmin=(821.807,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(780.866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(RCCJCC) + radical(Cs_S) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C1[CH]CC(C)C1C(14404)',
    structure = SMILES('[CH]C1[CH]CC(C)C1C'),
    E0 = (452.618,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01822,0.0421631,7.06764e-05,-1.16866e-07,4.63197e-11,54565.7,30.3786], Tmin=(100,'K'), Tmax=(972.228,'K')), NASAPolynomial(coeffs=[15.8933,0.0390038,-1.3997e-05,2.59904e-09,-1.89162e-13,48930.3,-55.0731], Tmin=(972.228,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(452.618,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopentane) + radical(Cs_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]C1CC(C)C1C(14405)',
    structure = SMILES('[CH][CH]C1CC(C)C1C'),
    E0 = (534.385,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.648781,0.0536174,3.74426e-05,-8.10026e-08,3.29592e-11,64410,31.5136], Tmin=(100,'K'), Tmax=(997.618,'K')), NASAPolynomial(coeffs=[15.8478,0.0408485,-1.57895e-05,2.97299e-09,-2.14356e-13,58980.3,-53.7911], Tmin=(997.618,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(534.385,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Cs_S) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[C]=C[CH]CC(C)[CH]C(14411)',
    structure = SMILES('[C]C=CCC(C)[CH]C'),
    E0 = (734.438,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.149376,0.0792726,-5.4526e-05,1.91643e-08,-2.77342e-12,88475,33.1731], Tmin=(100,'K'), Tmax=(1575.24,'K')), NASAPolynomial(coeffs=[16.002,0.0390181,-1.61941e-05,2.94163e-09,-1.98775e-13,83480.7,-50.5103], Tmin=(1575.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(734.438,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_S) + radical(CJ3)"""),
)

species(
    label = 'C[CH]C(C)CC1C=C1(14412)',
    structure = SMILES('C[CH]C(C)CC1C=C1'),
    E0 = (338.156,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0599712,0.0794766,-5.05681e-05,1.62103e-08,-2.12912e-12,40818.1,31.0581], Tmin=(100,'K'), Tmax=(1720.77,'K')), NASAPolynomial(coeffs=[17.0629,0.0399522,-1.61144e-05,2.86198e-09,-1.89811e-13,34966.5,-60.2], Tmin=(1720.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(338.156,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Cs_S)"""),
)
...
species(
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.105506,0.0810726,-5.43487e-05,1.88552e-08,-2.71898e-12,28493.5,31.9869], Tmin=(100,'K'), Tmax=(1566.01,'K')), NASAPolynomial(coeffs=[15.181,0.0425662,-1.74659e-05,3.15395e-09,-2.12444e-13,23771.7,-47.5057], Tmin=(1566.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.716,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0453739,0.0765183,-3.44753e-05,-4.82104e-09,5.96099e-12,30857.3,34.2128], Tmin=(100,'K'), Tmax=(1085.75,'K')), NASAPolynomial(coeffs=[15.679,0.0409655,-1.62727e-05,2.98465e-09,-2.07132e-13,26123.8,-49.0158], Tmin=(1085.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(255.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    E0 = (522.191,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.489576,0.080077,-5.48238e-05,2.01276e-08,-3.20124e-12,68136.1,34.8001], Tmin=(100,'K'), Tmax=(1376.2,'K')), NASAPolynomial(coeffs=[10.9722,0.0496085,-2.16143e-05,4.03996e-09,-2.78746e-13,65250.9,-19.1198], Tmin=(1376.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(565.49,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=CCC[C](C)[CH]C(14416)',
    structure = SMILES('[CH]=CCC[C](C)[CH]C'),
    E0 = (513.071,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,223.467,815.59,1724.72],'cm^-1')),
        HinderedRotor(inertia=(0.133137,'amu*angstrom^2'), symmetry=1, barrier=(3.55693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133137,'amu*angstrom^2'), symmetry=1, barrier=(3.55693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133137,'amu*angstrom^2'), symmetry=1, barrier=(3.55693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133137,'amu*angstrom^2'), symmetry=1, barrier=(3.55693,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133137,'amu*angstrom^2'), symmetry=1, barrier=(3.55693,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43127,0.0683966,6.17181e-06,-1.338e-07,1.2658e-10,61788.3,32.3425], Tmin=(100,'K'), Tmax=(447.517,'K')), NASAPolynomial(coeffs=[4.22945,0.0610176,-2.81935e-05,5.4329e-09,-3.82788e-13,61361.3,19.1201], Tmin=(447.517,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(513.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Tertalkyl) + radical(Cs_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=CCCC(C)[CH][CH2](5816)',
    structure = SMILES('[CH]=CCCC(C)[CH][CH2]'),
    E0 = (532.895,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.248585,0.0797662,-5.2328e-05,1.75717e-08,-2.45815e-12,64229,36.984], Tmin=(100,'K'), Tmax=(1595.07,'K')), NASAPolynomial(coeffs=[14.7074,0.0435073,-1.82301e-05,3.32024e-09,-2.24474e-13,59616.4,-39.5226], Tmin=(1595.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(532.895,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(RCCJ) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]C=CC[CH]C(C)C(14399)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHCH3(T)(21)', '[CH]C=CC[CH]C(13802)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH]C=CCC([CH])C(13836)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]C=CCC(C)[C]C(14400)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH][CH]C[CH]C(C)[CH]C(14401)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH][CH]CC[C](C)[CH]C(14402)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]C[CH]C[C](C)[CH]C(14403)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]C=CCC(C)[CH]C(5496)'],
    products = ['[CH]C1[CH]CC(C)C1C(14404)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]C=CCC(C)[CH]C(5496)'],
    products = ['[CH][CH]C1CC(C)C1C(14405)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH]C=CCC(C)=CC(14406)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH]=C[CH]CC(C)C=C(5719)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(17)', '[CH]C=CCC=CC(13884)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(17)', '[CH]C=CC[CH][CH]C(13885)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH]C=CC[C](C)[CH]C(14407)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]C=[CH](13797)', '[CH2]C(C)[CH]C(114)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH]C=C[CH]C(C)[CH]C(14408)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH]C=CCC(C)[CH][CH2](5785)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH]C=[C]CC(C)[CH]C(14409)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH][C]=CCC(C)[CH]C(14410)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]C=CCC(C)[CH]C(5496)'],
    products = ['[CH]=C[CH]CC(C)C[CH2](5818)'],
...
reaction(
    label = 'reaction35',
    reactants = ['C2H2(T)(1343)', '[CH]CC(C)[CH]C(1181)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', '[C]=C[CH]CC(C)[CH]C(14411)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH]C=CCC(C)[CH]C(5496)'],
    products = ['C[CH]C(C)CC1C=C1(14412)'],
...
reaction(
    label = 'reaction45',
    reactants = ['H(3)', '[CH]=CC=CC(C)[CH]C(14414)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
...
reaction(
    label = 'reaction46',
    reactants = ['H(3)', '[CH]=C=CCC(C)[CH]C(13508)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
...
reaction(
    label = 'reaction47',
    reactants = ['C2H2(1342)', '[CH]CC(C)[CH]C(1181)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH]=CC[CH]C(C)[CH]C(14382)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[CH]=[C]CCC(C)[CH]C(14415)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
...
reaction(
    label = 'reaction52',
    reactants = ['[CH]=CCC[C](C)[CH]C(14416)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
...
reaction(
    label = 'reaction55',
    reactants = ['[CH]=CCCC(C)[CH][CH2](5816)'],
    products = ['[CH]C=CCC(C)[CH]C(5496)'],
