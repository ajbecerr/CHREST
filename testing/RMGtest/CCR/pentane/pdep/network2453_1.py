...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.356024,0.0859518,-9.51e-05,5.27287e-08,-1.12155e-11,77589.5,33.3123], Tmin=(100,'K'), Tmax=(1226.48,'K')), NASAPolynomial(coeffs=[20.0131,0.015491,-3.99732e-06,5.29943e-10,-2.95673e-14,72896.1,-67.8797], Tmin=(1226.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(643.741,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(Isobutyl) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.164929,0.0766019,-7.63725e-05,3.62188e-08,-6.13766e-12,107739,31.8164], Tmin=(100,'K'), Tmax=(1035.75,'K')), NASAPolynomial(coeffs=[18.2584,0.0174584,-6.26231e-06,1.09644e-09,-7.49283e-14,103416,-58.8888], Tmin=(1035.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(894.591,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(CCJ2_triplet) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH][CH]C(C)O[C]=[CH](10276)',
    structure = SMILES('[CH][CH]C(C)O[C]=[CH]'),
    E0 = (889.247,'kJ/mol'),
    modes = [
...
species(
    label = '[C]=[C]OC(C)[CH][CH2](10277)',
    structure = SMILES('[C]=[C]OC(C)[CH][CH2]'),
    E0 = (957.284,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.391496,0.0718169,-7.07107e-05,3.5189e-08,-6.86638e-12,115271,33.5717], Tmin=(100,'K'), Tmax=(1252.02,'K')), NASAPolynomial(coeffs=[17.0616,0.0185577,-6.9015e-06,1.21163e-09,-8.17441e-14,111097,-50.5982], Tmin=(1252.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(957.284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(RCCJ) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.423593,0.0783615,-8.4492e-05,4.79138e-08,-1.08786e-11,77896.2,31.7923], Tmin=(100,'K'), Tmax=(1067.86,'K')), NASAPolynomial(coeffs=[14.3834,0.0260704,-1.10393e-05,2.05694e-09,-1.42873e-13,74914.8,-36.4723], Tmin=(1067.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(646.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C2CsJOC(O)) + radical(RCCJ) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', '[CH]=[C]OC[CH][CH2](2625)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=[C]O[CH]C([CH2])C(10274)'],
    products = ['[CH]=[C]OC(C)[CH][CH2](4194)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=[CH](9646)', '[CH2][CH]C(C)[O](1587)'],
    products = ['[CH]=[C]OC(C)[CH][CH2](4194)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH][CH2](502)', '[CH]=[C]O[CH]C(9652)'],
    products = ['[CH]=[C]OC(C)[CH][CH2](4194)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]=[C]OC(C)[C][CH2](10275)'],
    products = ['[CH]=[C]OC(C)[CH][CH2](4194)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH][CH]C(C)O[C]=[CH](10276)'],
    products = ['[CH]=[C]OC(C)[CH][CH2](4194)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[C]=[C]OC(C)[CH][CH2](10277)'],
    products = ['[CH]=[C]OC(C)[CH][CH2](4194)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]=[C]O[C](C)C=C(10059)'],
    products = ['[CH]=[C]OC(C)[CH][CH2](4194)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(17)', '[CH]=[C]OC=C[CH2](9859)'],
    products = ['[CH]=[C]OC(C)[CH][CH2](4194)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(17)', '[CH]=[C]O[CH][CH][CH2](9860)'],
    products = ['[CH]=[C]OC(C)[CH][CH2](4194)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH]=[C]O[C](C)[CH][CH2](10279)'],
    products = ['[CH]=[C]OC(C)[CH][CH2](4194)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=[C]O[C](C)C[CH2](10280)'],
    products = ['[CH]=[C]OC(C)[CH][CH2](4194)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=[C]OC(C)[CH][CH2](4194)'],
    products = ['[CH2][CH][C](C)O[C]=C(4192)'],
