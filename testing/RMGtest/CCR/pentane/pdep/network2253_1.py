...
species(
    label = '[C]=C([O])C[CH2](9656)',
    structure = SMILES('[C]C(=O)C[CH2]'),
    E0 = (622.873,'kJ/mol'),
    modes = [
        ...
        HinderedRotor(inertia=(0.09214,'amu*angstrom^2'), symmetry=1, barrier=(12.3541,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.31629,'amu*angstrom^2'), symmetry=1, barrier=(30.264,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08408,0.0447976,-5.51638e-05,3.81537e-08,-1.08214e-11,74981,16.9551], Tmin=(100,'K'), Tmax=(853.199,'K')), NASAPolynomial(coeffs=[7.75894,0.0181926,-8.38991e-06,1.60602e-09,-1.12414e-13,74012.6,-9.52185], Tmin=(853.199,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(622.873,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CJCC=O) + radical(CJ3)"""),
)

species(
    label = '[CH2]CC1=CO1(9657)',
    structure = SMILES('[CH2]CC1=CO1'),
    E0 = (296.525,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.15463,0.0300255,7.71457e-06,-3.61776e-08,1.73263e-11,35739.7,18.297], Tmin=(100,'K'), Tmax=(948.459,'K')), NASAPolynomial(coeffs=[12.9964,0.0105499,-2.99615e-06,5.29157e-10,-4.00761e-14,32502.5,-39.6582], Tmin=(948.459,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(296.525,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclopropene) + radical(RCCJ)"""),
)
...
species(
    label = '[CH]C1([O])CC1(9664)',
    structure = SMILES('[CH]C1([O])CC1'),
    E0 = (504.969,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16654,0.0281238,1.73734e-05,-4.78356e-08,2.17643e-11,60810.9,16.9291], Tmin=(100,'K'), Tmax=(945.834,'K')), NASAPolynomial(coeffs=[13.6323,0.0102039,-2.68828e-06,4.76217e-10,-3.73928e-14,57274.6,-44.9768], Tmin=(945.834,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(504.969,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[C]=C([O])C[CH2](9656)'],
    products = ['[CH]=C([O])C[CH2](2380)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH]=C([O])[CH][CH2](9660)'],
    products = ['[CH]=C([O])C[CH2](2380)'],
