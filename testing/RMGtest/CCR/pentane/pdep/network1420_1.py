species(
    ...
    E0 = (172.527,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,540,610,2055,334.86,335.504,335.801],'cm^-1')),
        HinderedRotor(inertia=(0.183709,'amu*angstrom^2'), symmetry=1, barrier=(14.711,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.18426,'amu*angstrom^2'), symmetry=1, barrier=(14.7117,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.18401,'amu*angstrom^2'), symmetry=1, barrier=(14.7113,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184228,'amu*angstrom^2'), symmetry=1, barrier=(14.7133,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = 'C=C=CCCC=C(13492)',
    structure = SMILES('C=C=CCCC=C'),
    E0 = (204.279,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,540,610,2055,285.277,285.957,286.507],'cm^-1')),
        HinderedRotor(inertia=(0.259201,'amu*angstrom^2'), symmetry=1, barrier=(15.0529,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.25855,'amu*angstrom^2'), symmetry=1, barrier=(15.0475,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.260193,'amu*angstrom^2'), symmetry=1, barrier=(15.0536,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.821491,0.0599954,-2.60146e-05,-4.11036e-09,4.49538e-12,24691.8,27.3152], Tmin=(100,'K'), Tmax=(1110.23,'K')), NASAPolynomial(coeffs=[13.0759,0.0332703,-1.34502e-05,2.48208e-09,-1.7244e-13,20896.8,-37.923], Tmin=(1110.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(204.279,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C=C1[CH]CC(C)[CH]C1(13493)',
    structure = SMILES('[CH2]C1=CCC(C)[CH]C1'),
    E0 = (252.896,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06077,0.0426665,6.14109e-05,-1.03567e-07,4.0504e-11,30541.6,26.6256], Tmin=(100,'K'), Tmax=(991.072,'K')), NASAPolynomial(coeffs=[15.2758,0.0392709,-1.51443e-05,2.88352e-09,-2.10479e-13,25073.1,-55.2], Tmin=(991.072,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.896,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclohexene) + radical(Cs_S) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH2]C[C](C)CC=C=C(13494)',
    structure = SMILES('[CH2]C[C](C)CC=C=C'),
    E0 = (437.691,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,540,610,2055,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.601357,0.0809201,-7.03444e-05,4.02751e-08,-1.07695e-11,52759.1,32.5354], Tmin=(100,'K'), Tmax=(849.838,'K')), NASAPolynomial(coeffs=[6.0421,0.0553116,-2.51441e-05,4.81689e-09,-3.3859e-13,51834.3,7.1722], Tmin=(849.838,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(437.691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Tertalkyl) + radical(RCCJ)"""),
)

species(
    label = 'C=[C]C[CH]C(C)C=C(13495)',
    structure = SMILES('C=[C]C[CH]C(C)C=C'),
    E0 = (440.552,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.324704,0.0745945,-4.69356e-05,1.47447e-08,-1.8934e-12,53123.1,35.5195], Tmin=(100,'K'), Tmax=(1754.36,'K')), NASAPolynomial(coeffs=[16.5449,0.0376117,-1.53147e-05,2.72853e-09,-1.81053e-13,47431.9,-51.8508], Tmin=(1754.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(440.552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.171962,0.0812353,-5.11924e-05,9.82463e-09,1.98396e-12,46338.9,33.3152], Tmin=(100,'K'), Tmax=(1046.85,'K')), NASAPolynomial(coeffs=[16.0221,0.0372964,-1.39368e-05,2.46756e-09,-1.68046e-13,41965.4,-50.2479], Tmin=(1046.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(383.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(RCCJ) + radical(C=CJC=C)"""),
)

species(
    label = '[CH2]CC([CH2])CC=C=C(9014)',
    structure = SMILES('[CH2]CC([CH2])CC=C=C'),
    E0 = (457.351,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,540,610,2055,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0367449,0.0821723,-6.14308e-05,2.48071e-08,-4.15126e-12,55157.2,35.4513], Tmin=(100,'K'), Tmax=(1392.3,'K')), NASAPolynomial(coeffs=[14.8875,0.039296,-1.5238e-05,2.68891e-09,-1.79757e-13,51001.4,-41.4889], Tmin=(1392.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(457.351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = 'C=[C]CC[C](C)C=C(13497)',
    structure = SMILES('C=[C]CC[C](C)C=C'),
    E0 = (377.99,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3010,987.5,1337.5,450,1655,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.216964,0.0727694,-3.86888e-05,5.63108e-09,1.3019e-12,45606.5,31.6008], Tmin=(100,'K'), Tmax=(1191.86,'K')), NASAPolynomial(coeffs=[13.8925,0.0408871,-1.62011e-05,2.91811e-09,-1.98407e-13,41351.3,-40.9518], Tmin=(1191.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(377.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Allyl_T) + radical(Cds_S)"""),
)
...
species(
    label = 'C=C=C[CH]C(C)[CH]C(13498)',
    structure = SMILES('C=[C]C=CC(C)[CH]C'),
    E0 = (373.255,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.214685,0.0813505,-5.8183e-05,2.18991e-08,-3.36496e-12,45053.4,34.2541], Tmin=(100,'K'), Tmax=(1524.62,'K')), NASAPolynomial(coeffs=[17.1533,0.0357838,-1.33522e-05,2.29609e-09,-1.50554e-13,39757.5,-56.8613], Tmin=(1524.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(373.255,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cs_S) + radical(C=CJC=C)"""),
)
...
species(
    label = 'C=CC(C)[CH]C=[C]C(13499)',
    structure = SMILES('C=CC(C)[CH]C=[C]C'),
    E0 = (374.877,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.190579,0.073029,-3.90833e-05,6.06409e-09,1.03836e-12,45233.2,31.9015], Tmin=(100,'K'), Tmax=(1232.37,'K')), NASAPolynomial(coeffs=[14.5694,0.0403487,-1.63344e-05,2.96959e-09,-2.02582e-13,40626.8,-44.7829], Tmin=(1232.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.877,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_S) + radical(Cds_S)"""),
)
...
species(
    label = 'C=[C]CCC(C)[C]=C(13500)',
    structure = SMILES('C=[C]CCC(C)[C]=C'),
    E0 = (483.851,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1670,1700,300,440,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.273673,0.0785971,-5.49901e-05,2.02544e-08,-3.11984e-12,58330.3,33.6055], Tmin=(100,'K'), Tmax=(1473.44,'K')), NASAPolynomial(coeffs=[13.984,0.0413773,-1.70994e-05,3.11051e-09,-2.11029e-13,54290,-37.8529], Tmin=(1473.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(483.851,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = '[CH2]CC(C)C[C]=C=C(13501)',
    structure = SMILES('[CH2]C#CCC(C)C[CH2]'),
    E0 = (392.019,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2100,2250,500,550,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00719651,0.0783053,-5.37829e-05,1.96631e-08,-2.96763e-12,47301.3,35.0338], Tmin=(100,'K'), Tmax=(1534.57,'K')), NASAPolynomial(coeffs=[15.5734,0.0376935,-1.40862e-05,2.41772e-09,-1.58173e-13,42519.4,-46.8058], Tmin=(1534.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(392.019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(RCCJ) + radical(Propargyl)"""),
)
...
species(
    label = 'C=C=[C]CC(C)[CH]C(13502)',
    structure = SMILES('[CH2]C#CCC(C)[CH]C'),
    E0 = (381.315,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2100,2250,500,550,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.353857,0.0739805,-4.66745e-05,1.53693e-08,-2.11055e-12,45997.6,34.5016], Tmin=(100,'K'), Tmax=(1634.73,'K')), NASAPolynomial(coeffs=[14.1271,0.0402792,-1.5751e-05,2.75833e-09,-1.8197e-13,41494.4,-38.7157], Tmin=(1634.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(381.315,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Cs_S) + radical(Propargyl)"""),
)

species(
    label = 'C=C[C](C)CC=[C]C(13503)',
    structure = SMILES('C=C[C](C)CC=[C]C'),
    E0 = (365.745,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=CC(C)CC[C]=C(13504)',
    structure = SMILES('[CH]=CC(C)CC[C]=C'),
    E0 = (493.106,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0573708,0.0807643,-5.74551e-05,2.11864e-08,-3.1984e-12,59459.8,34.7356], Tmin=(100,'K'), Tmax=(1536.09,'K')), NASAPolynomial(coeffs=[16.7795,0.0369208,-1.46415e-05,2.60508e-09,-1.74261e-13,54287.2,-53.7194], Tmin=(1536.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(493.106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = 'C=[C]C(C)CC=[C]C(13505)',
    structure = SMILES('C=[C]C(C)CC=[C]C'),
    E0 = (471.606,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1670,1700,300,440,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.502657,0.0767528,-5.27537e-05,1.93208e-08,-3.01413e-12,56846.6,32.34], Tmin=(100,'K'), Tmax=(1427.73,'K')), NASAPolynomial(coeffs=[12.0445,0.0444163,-1.87801e-05,3.45699e-09,-2.36291e-13,53550.9,-27.4525], Tmin=(1427.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(471.606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]=CC(C)CC=[C]C(13507)',
    structure = SMILES('[CH]=CC(C)CC=[C]C'),
    E0 = (480.86,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,3120,650,792.5,1650,272.434,272.436],'cm^-1')),
        HinderedRotor(inertia=(0.219067,'amu*angstrom^2'), symmetry=1, barrier=(11.538,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00227135,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.219071,'amu*angstrom^2'), symmetry=1, barrier=(11.538,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.219069,'amu*angstrom^2'), symmetry=1, barrier=(11.538,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.219071,'amu*angstrom^2'), symmetry=1, barrier=(11.538,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.186981,0.078781,-5.48841e-05,1.9968e-08,-3.01419e-12,57975.2,33.4115], Tmin=(100,'K'), Tmax=(1512.35,'K')), NASAPolynomial(coeffs=[14.9215,0.03981,-1.62316e-05,2.92949e-09,-1.97653e-13,53518.4,-43.7694], Tmin=(1512.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(480.86,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C=CCC(C)[CH]C(13508)',
    structure = SMILES('C#C[CH]CC(C)[CH]C'),
    E0 = (392.866,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,2175,525,750,770,3400,2100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.147015,0.0812004,-6.27468e-05,2.76588e-08,-5.16017e-12,47392.4,32.8414], Tmin=(100,'K'), Tmax=(1247.07,'K')), NASAPolynomial(coeffs=[12.1635,0.0426575,-1.63869e-05,2.87562e-09,-1.91922e-13,44395.3,-27.7846], Tmin=(1247.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(392.866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cs_S) + radical(Sec_Propargyl)"""),
)
...
species(
    label = 'C=C=CC[C](C)C=C(13510)',
    structure = SMILES('C=C=CC[C](C)C=C'),
    E0 = (304.507,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,540,610,2055,180,808.111,814.496],'cm^-1')),
        HinderedRotor(inertia=(0.158929,'amu*angstrom^2'), symmetry=1, barrier=(3.65409,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.669889,'amu*angstrom^2'), symmetry=1, barrier=(15.4021,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.669587,'amu*angstrom^2'), symmetry=1, barrier=(15.3951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.44963,'amu*angstrom^2'), symmetry=1, barrier=(33.3298,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.431193,0.0670303,-2.46288e-05,-1.06836e-08,7.52851e-12,36762,28.9661], Tmin=(100,'K'), Tmax=(1064.5,'K')), NASAPolynomial(coeffs=[13.9619,0.038209,-1.50481e-05,2.75074e-09,-1.90828e-13,32633.6,-43.0181], Tmin=(1064.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(304.507,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Allyl_T)"""),
)
...
species(
    label = 'C=C=C[CH]C(C)C=C(13511)',
    structure = SMILES('C=[C]C=CC(C)C=C'),
    E0 = (305.947,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.831956,'amu*angstrom^2'), symmetry=1, barrier=(19.1283,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.831577,'amu*angstrom^2'), symmetry=1, barrier=(19.1196,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.83127,'amu*angstrom^2'), symmetry=1, barrier=(19.1125,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.832016,'amu*angstrom^2'), symmetry=1, barrier=(19.1297,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0531015,0.0832208,-6.79011e-05,3.01136e-08,-5.48903e-12,36947.7,29.1907], Tmin=(100,'K'), Tmax=(1297.25,'K')), NASAPolynomial(coeffs=[15.0162,0.0367551,-1.41726e-05,2.50189e-09,-1.67796e-13,33038,-47.4316], Tmin=(1297.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(305.947,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJC=C)"""),
)
...
species(
    label = 'C=[C]C(C)CC=C=C(13512)',
    structure = SMILES('C=[C]C(C)CC=C=C'),
    E0 = (410.368,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,540,610,2055,180,527.398,759.178],'cm^-1')),
        HinderedRotor(inertia=(0.616703,'amu*angstrom^2'), symmetry=1, barrier=(14.1792,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.616683,'amu*angstrom^2'), symmetry=1, barrier=(14.1788,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.616721,'amu*angstrom^2'), symmetry=1, barrier=(14.1796,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.616693,'amu*angstrom^2'), symmetry=1, barrier=(14.179,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0876584,0.0772522,-5.48519e-05,2.00645e-08,-2.99441e-12,49503.9,32.4294], Tmin=(100,'K'), Tmax=(1556.64,'K')), NASAPolynomial(coeffs=[16.7175,0.0345202,-1.36753e-05,2.42992e-09,-1.62299e-13,44326.4,-55.1594], Tmin=(1556.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(410.368,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_S)"""),
)

species(
    label = 'C=C=[C]CC(C)C=C(13513)',
    structure = SMILES('[CH2]C#CCC(C)C=C'),
    E0 = (312.277,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,2100,2250,500,550,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.431389,0.0677251,-2.7023e-05,-9.63081e-09,7.82062e-12,37696.1,32.1693], Tmin=(100,'K'), Tmax=(1024.29,'K')), NASAPolynomial(coeffs=[13.7902,0.0371877,-1.39797e-05,2.49687e-09,-1.71465e-13,33824.7,-38.1386], Tmin=(1024.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(312.277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Propargyl)"""),
)
...
species(
    label = 'C=C=CCC(C)[C]C(13517)',
    structure = SMILES('C=C=CCC(C)[C]C'),
    E0 = (472.339,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,540,610,2055,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.285035,0.0826247,-5.94458e-05,2.30755e-08,-3.83805e-12,56941.7,40.0183], Tmin=(100,'K'), Tmax=(1346.46,'K')), NASAPolynomial(coeffs=[12.036,0.0477158,-2.05565e-05,3.8206e-09,-2.62985e-13,53777.3,-20.1691], Tmin=(1346.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(472.339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH) + group(Cdd-CdsCds)"""),
)

species(
    label = 'C=C[C]CC(C)C=C(13518)',
    structure = SMILES('C=C[C]CC(C)C=C'),
    E0 = (435.697,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.322251,0.079819,-5.38559e-05,1.9005e-08,-2.83359e-12,52534.8,41.109], Tmin=(100,'K'), Tmax=(1492.36,'K')), NASAPolynomial(coeffs=[13.1883,0.0453337,-1.9194e-05,3.52082e-09,-2.39662e-13,48694.7,-26.1134], Tmin=(1492.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(435.697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]CC(C)CC=C=C(13519)',
    structure = SMILES('[CH]CC(C)CC=C=C'),
    E0 = (494.775,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,540,610,2055,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.291179,0.0816219,-6.00109e-05,2.34574e-08,-3.87663e-12,59640.6,30.84], Tmin=(100,'K'), Tmax=(1368.97,'K')), NASAPolynomial(coeffs=[13.0389,0.0443748,-1.91994e-05,3.58316e-09,-2.47265e-13,56150.3,-34.6641], Tmin=(1368.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(494.775,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C=CCC(C)C=C(13520)',
    structure = SMILES('[CH]C=CCC(C)C=C'),
    E0 = (447.022,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2950,3100,1380,975,1025,1650,200,800,1000,1200,1400,1600],'cm^-1')),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.241218,0.0775059,-5.16922e-05,1.75193e-08,-2.44577e-12,53903.4,32.4843], Tmin=(100,'K'), Tmax=(1621.93,'K')), NASAPolynomial(coeffs=[15.8002,0.039134,-1.62045e-05,2.93249e-09,-1.97378e-13,48856.3,-50.103], Tmin=(1621.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(447.022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'C=C=CCCC=C(13492)'],
...
reaction(
    label = 'reaction3',
    reactants = ['C=C1[CH]CC(C)[CH]C1(13493)'],
    products = ['C=C=CCC(C)C=C(4937)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C[C](C)CC=C=C(13494)'],
    products = ['C=C=CCC(C)C=C(4937)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C=[C]C[CH]C(C)C=C(13495)'],
    products = ['C=C=CCC(C)C=C(4937)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]CC(C)[CH]C=C=C(13496)'],
    products = ['C=C=CCC(C)C=C(4937)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]CC([CH2])CC=C=C(9014)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C=[C]CC[C](C)C=C(13497)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C=C[CH]C(C)C=C(5699)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C=C=C[CH]C(C)[CH]C(13498)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([CH]C)CC=C=C(5851)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C=CC(C)[CH]C=[C]C(13499)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CC(C)C[C]=C=C(13501)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C=C=[C]CC(C)[CH]C(13502)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C=C[C](C)CC=[C]C(13503)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=CC(C)CC[C]=C(13504)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C(C=C)CC=[C]C(5698)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C=[C]C(C)CC=[C]C(13505)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]=C=CCC(C)C[CH2](13506)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]=CC(C)CC=[C]C(13507)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]=C=CCC(C)[CH]C(13508)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CH2CHCCH2(4848)', 'm1_allyl(186)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH3(17)', 'C=C=CC[CH]C=C(13509)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction33',
    reactants = ['C2H3(60)', 'C=C=CC[CH]C(9379)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', 'C=C=CC[C](C)C=C(13510)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction35',
    reactants = ['C3H3(5450)', '[CH2]C(C)C=C(109)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', 'C=C=C[CH]C(C)C=C(13511)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(3)', 'C=[C]C(C)CC=C=C(13512)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction39',
    reactants = ['H(3)', 'C=C=[C]CC(C)C=C(13513)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction40',
    reactants = ['H(3)', '[CH]=CC(C)CC=C=C(13514)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction41',
    reactants = ['H(3)', '[CH]=C=CCC(C)C=C(13515)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction46',
    reactants = ['C=C[C]CC(C)C=C(13518)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH]CC(C)CC=C=C(13519)'],
    products = ['C=C=CCC(C)C=C(4937)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH]C=CCC(C)C=C(13520)'],
    products = ['C=C=CCC(C)C=C(4937)'],
