species(
    label = 'C=[C]CO[CH]C(15519)',
    structure = SMILES('C=[C]CO[CH]C'),
    E0 = (254.484,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,365.424,365.439,365.451,365.454],'cm^-1')),
        HinderedRotor(inertia=(0.00126232,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101499,'amu*angstrom^2'), symmetry=1, barrier=(9.61938,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10151,'amu*angstrom^2'), symmetry=1, barrier=(9.61955,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101502,'amu*angstrom^2'), symmetry=1, barrier=(9.61947,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29422,0.0629981,-6.60743e-05,4.16023e-08,-1.11575e-11,30701.7,23.7313], Tmin=(100,'K'), Tmax=(886.432,'K')), NASAPolynomial(coeffs=[8.06722,0.0324357,-1.43582e-05,2.70846e-09,-1.88469e-13,29501,-8.12812], Tmin=(886.432,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(254.484,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOCs) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]OC[C]=C(16088)',
    structure = SMILES('[CH]OC[C]=C'),
    E0 = (572.564,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1685,370,338.314,338.323,338.342,2003.49,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0985777,'amu*angstrom^2'), symmetry=1, barrier=(8.00726,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.348621,'amu*angstrom^2'), symmetry=1, barrier=(28.3152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.348603,'amu*angstrom^2'), symmetry=1, barrier=(28.3153,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.62234,0.0373785,-1.14381e-05,-6.2805e-08,7.21181e-11,68905.7,17.6502], Tmin=(100,'K'), Tmax=(448.74,'K')), NASAPolynomial(coeffs=[5.53576,0.024432,-1.16949e-05,2.25099e-09,-1.56804e-13,68513.1,4.4682], Tmin=(448.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(572.564,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CH2_triplet)"""),
)
...
species(
    label = 'C=[C]CO[C]C(16089)',
    structure = SMILES('C=[C]CO[C]C'),
    E0 = (535.016,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4107,0.0615573,-7.05892e-05,4.90401e-08,-1.45587e-11,64436.7,22.602], Tmin=(100,'K'), Tmax=(803.575,'K')), NASAPolynomial(coeffs=[7.39604,0.0317639,-1.49755e-05,2.90185e-09,-2.04696e-13,63474.8,-4.96493], Tmin=(803.575,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(535.016,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CH2_triplet)"""),
)

species(
    label = 'C=C1COC1C(16090)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.22987,0.0200911,6.9e-05,-1.01229e-07,3.90863e-11,-3859.02,19.0608], Tmin=(100,'K'), Tmax=(973.804,'K')), NASAPolynomial(coeffs=[13.0215,0.0230536,-8.40715e-06,1.63296e-09,-1.23601e-13,-8203.07,-44.2292], Tmin=(973.804,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-32.7561,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)

species(
    label = 'C=C=COCC(16091)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.927304,0.0530337,-7.41612e-06,-3.75015e-08,2.08256e-11,-5279.7,20.5721], Tmin=(100,'K'), Tmax=(943.713,'K')), NASAPolynomial(coeffs=[18.5223,0.0146453,-3.92088e-06,6.64477e-10,-4.96944e-14,-10212.1,-71.8323], Tmin=(943.713,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-44.9283,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23939,0.0441579,1.53098e-05,-5.96061e-08,2.83448e-11,-9019.89,21.6944], Tmin=(100,'K'), Tmax=(942.441,'K')), NASAPolynomial(coeffs=[18.0158,0.0145224,-3.68279e-06,6.29935e-10,-4.87468e-14,-14028.1,-68.0412], Tmin=(942.441,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-75.948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]COC[C]=C(16094)',
    structure = SMILES('[CH2]COC[C]=C'),
    E0 = (285.617,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,306.15,306.177,306.191,3170.66],'cm^-1')),
        HinderedRotor(inertia=(0.141147,'amu*angstrom^2'), symmetry=1, barrier=(9.39093,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.552145,'amu*angstrom^2'), symmetry=1, barrier=(36.7311,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00179835,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141178,'amu*angstrom^2'), symmetry=1, barrier=(9.39089,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70181,0.0571009,-4.59622e-05,6.11144e-09,1.29701e-11,34428.3,23.5122], Tmin=(100,'K'), Tmax=(555.436,'K')), NASAPolynomial(coeffs=[5.96927,0.0363124,-1.66758e-05,3.19243e-09,-2.23701e-13,33800.8,4.05261], Tmin=(555.436,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(285.617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.854825,0.0554951,-1.46032e-05,-3.00257e-08,1.81949e-11,20308.4,22.5328], Tmin=(100,'K'), Tmax=(943.412,'K')), NASAPolynomial(coeffs=[18.4234,0.014948,-4.10224e-06,6.90406e-10,-5.07244e-14,15483.1,-69.2076], Tmin=(943.412,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(167.808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
species(
    label = '[CH]=[C]COCC(16096)',
    structure = SMILES('[CH]=[C]COCC'),
    E0 = (321.124,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,301.17,301.215,3536.21],'cm^-1')),
        HinderedRotor(inertia=(0.143375,'amu*angstrom^2'), symmetry=1, barrier=(9.2281,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143372,'amu*angstrom^2'), symmetry=1, barrier=(9.22771,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.593827,'amu*angstrom^2'), symmetry=1, barrier=(38.2305,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143384,'amu*angstrom^2'), symmetry=1, barrier=(9.2279,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91632,0.0531534,-3.0135e-05,-2.40526e-08,3.49152e-11,38690.1,22.5469], Tmin=(100,'K'), Tmax=(509.702,'K')), NASAPolynomial(coeffs=[5.4121,0.0372319,-1.71598e-05,3.28978e-09,-2.30658e-13,38184.2,6.57068], Tmin=(509.702,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(321.124,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CHCH3(T)(21)', 'C=[C]C[O](15501)'],
    products = ['C=[C]CO[CH]C(15519)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2CC(T)(1341)', '[CH2]O[CH]C(3213)'],
    products = ['C=[C]CO[CH]C(15519)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', '[CH]OC[C]=C(16088)'],
    products = ['C=[C]CO[CH]C(15519)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C=[C]CO[C]C(16089)'],
    products = ['C=[C]CO[CH]C(15519)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'C=C=CO[CH]C(16092)'],
    products = ['C=[C]CO[CH]C(15519)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C#CCO[CH]C(16093)'],
    products = ['C=[C]CO[CH]C(15519)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(8e+09,'cm^3/(mol*s)'), n=1.39, Ea=(37.0065,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Od_CO-CsH;YJ] for rate rule [Od_CO-CsH;CJ]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 35.9 to 37.0 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C=[C][CH]O[CH]C(15942)'],
    products = ['C=[C]CO[CH]C(15519)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2][CH]OC[C]=C(15503)'],
    products = ['C=[C]CO[CH]C(15519)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH]=[C]CO[CH]C(15944)'],
    products = ['C=[C]CO[CH]C(15519)'],
