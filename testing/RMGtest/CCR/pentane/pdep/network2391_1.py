...
species(
    label = '[C]=[C]OC[CH][O](10190)',
    structure = SMILES('[C]=[C]OC[CH][O]'),
    E0 = (858.515,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,1685,370,352.953,352.954,352.954,352.954,2679.29],'cm^-1')),
        HinderedRotor(inertia=(0.13078,'amu*angstrom^2'), symmetry=1, barrier=(11.5613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.426281,'amu*angstrom^2'), symmetry=1, barrier=(37.6842,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130781,'amu*angstrom^2'), symmetry=1, barrier=(11.5613,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15322,0.0707581,-0.000127512,1.14459e-07,-3.88409e-11,103350,25.522], Tmin=(100,'K'), Tmax=(875.589,'K')), NASAPolynomial(coeffs=[8.48566,0.0196446,-9.76885e-06,1.83163e-09,-1.22654e-13,102741,-5.02244], Tmin=(875.589,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(858.515,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCsJOH) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31288,0.0419749,5.93267e-06,-5.69873e-08,3.05275e-11,18103.1,22.3582], Tmin=(100,'K'), Tmax=(910.623,'K')), NASAPolynomial(coeffs=[21.8267,-0.00259985,4.35249e-06,-9.19433e-10,5.96929e-14,12479.1,-85.0544], Tmin=(910.623,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.58,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=COJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]O[CH][CH][O](10192)',
    structure = SMILES('[CH][C]OC=C[O]'),
    E0 = (656.367,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.988909,0.0743376,-8.69749e-05,4.33958e-08,-7.63977e-12,79153,27.6321], Tmin=(100,'K'), Tmax=(1721.97,'K')), NASAPolynomial(coeffs=[23.7049,-0.00817073,6.8028e-06,-1.39121e-09,9.37669e-14,74376.8,-94.0962], Tmin=(1721.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(656.367,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CH2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]=[C]O[CH]C[O](10193)',
    structure = SMILES('[CH]=[C]O[CH]C[O]'),
    E0 = (561.138,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,215.903,216.229,216.453,216.884],'cm^-1')),
        HinderedRotor(inertia=(0.00192971,'amu*angstrom^2'), symmetry=1, barrier=(21.0262,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.630992,'amu*angstrom^2'), symmetry=1, barrier=(21.0295,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.633409,'amu*angstrom^2'), symmetry=1, barrier=(21.0292,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.034,0.068316,-0.000101496,7.67735e-08,-2.27123e-11,67593.3,25.9033], Tmin=(100,'K'), Tmax=(833.91,'K')), NASAPolynomial(coeffs=[11.9715,0.0158489,-7.11429e-06,1.31586e-09,-8.92264e-14,65769.2,-24.8768], Tmin=(833.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(561.138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCsJOC(O)) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]O[CH][CH]O(10194)',
    structure = SMILES('[CH][C]OC=CO'),
    E0 = (514.904,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.64732,0.0842791,-0.000101067,5.15028e-08,-9.21769e-12,62166.6,28.581], Tmin=(100,'K'), Tmax=(1702.9,'K')), NASAPolynomial(coeffs=[25.9682,-0.0104979,8.76363e-06,-1.80907e-09,1.2317e-13,57098,-106.615], Tmin=(1702.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(514.904,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CH2_triplet) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=[CH](9646)', '[O][CH]C[O](1529)'],
    products = ['[CH]=[C]OC[CH][O](2767)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH][O](1548)', '[CH]=[C]O[CH2](9647)'],
    products = ['[CH]=[C]OC[CH][O](2767)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH][C]OC[C]=O(7094)'],
    products = ['[CH]=[C]OC[CH][O](2767)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[C]=[C]OC[CH][O](10190)'],
    products = ['[CH]=[C]OC[CH][O](2767)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH]=[C]OC=C[O](9604)'],
    products = ['[CH]=[C]OC[CH][O](2767)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]=[C]O[CH][CH][O](10192)'],
    products = ['[CH]=[C]OC[CH][O](2767)'],
