...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95348,0.0295576,3.34409e-05,-6.75746e-08,2.86745e-11,77561,21.8328], Tmin=(100,'K'), Tmax=(958.94,'K')), NASAPolynomial(coeffs=[14.4494,0.0158144,-5.09797e-06,9.56172e-10,-7.30454e-14,73399.8,-47.1303], Tmin=(958.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(644.15,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)OJ) + radical(CCJ(C)CO) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1OC[C]1[CH2](16591)',
    structure = SMILES('[CH]C1OC[C]1[CH2]'),
    E0 = (640.307,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19609,0.0268267,4.124e-05,-8.25622e-08,3.85822e-11,77088.5,20.8004], Tmin=(100,'K'), Tmax=(857.674,'K')), NASAPolynomial(coeffs=[12.9244,0.0136201,-7.13497e-08,-3.86679e-10,3.61129e-14,73893.7,-37.2067], Tmin=(857.674,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(640.307,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCJ(C)CO) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C([O])C(=[CH])C(16592)',
    structure = SMILES('[CH]C([O])C(=[CH])C'),
    E0 = (697.289,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3120,650,792.5,1650,180,180,1257.99,4000],'cm^-1')),
        HinderedRotor(inertia=(0.858655,'amu*angstrom^2'), symmetry=1, barrier=(19.7422,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102099,'amu*angstrom^2'), symmetry=1, barrier=(19.7028,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0174592,'amu*angstrom^2'), symmetry=1, barrier=(19.711,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13078,0.0575697,-5.30313e-05,2.48588e-08,-4.62315e-12,83972.4,25.6183], Tmin=(100,'K'), Tmax=(1299.58,'K')), NASAPolynomial(coeffs=[14.0677,0.0177511,-7.07191e-06,1.28226e-09,-8.77485e-14,80609.8,-40.1847], Tmin=(1299.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(697.289,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(O)C(=[CH])[CH2](16593)',
    structure = SMILES('[CH]C(=C)C([CH])O'),
    E0 = (590.516,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00156,0.0584457,-4.36148e-05,1.42341e-08,-1.06468e-12,71137,26.979], Tmin=(100,'K'), Tmax=(1095.38,'K')), NASAPolynomial(coeffs=[13.4622,0.0230646,-9.0245e-06,1.61737e-09,-1.10404e-13,67799.9,-37.0434], Tmin=(1095.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(590.516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(AllylJ2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['O(4)', '[CH]=C[C]([CH2])[CH2](15108)'],
    products = ['[CH]C([O])C([CH2])=C(7236)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[CH]C([O])[C]=C(7132)'],
    products = ['[CH]C([O])C([CH2])=C(7236)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH][C]([O])C([CH2])[CH2](7238)'],
    products = ['[CH]C([O])C([CH2])=C(7236)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]C([O])C([CH2])=C(7236)'],
    products = ['[CH]C1OC[C]1[CH2](16591)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH](6993)', '[CH2]C(=C)C=O(3654)'],
    products = ['[CH]C([O])C([CH2])=C(7236)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]C([O])C([CH2])=C(7236)'],
    products = ['[CH]C(O)C(=[CH])[CH2](16593)'],
