...
species(
    ...
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70468,0.0574506,-9.75e-05,9.58277e-08,-3.80678e-11,-5240.8,19.2685], Tmin=(100,'K'), Tmax=(736.077,'K')), NASAPolynomial(coeffs=[5.25867,0.0278821,-1.63459e-05,3.39823e-09,-2.46549e-13,-5486.18,5.09881], Tmin=(736.077,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-44.2053,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cd-Cd(CO)H) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + group(Cds-O2d(Cds-Cds)H) + radical(C=CCJ=O)"""),
)
...
species(
    label = '[O]C#CC[C]=O(9879)',
    structure = SMILES('O=[C]C[C]=C=O'),
    E0 = (179.549,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1685,370,1855,455,950,2120,512.5,787.5,319.427],'cm^-1')),
        HinderedRotor(inertia=(0.11209,'amu*angstrom^2'), symmetry=1, barrier=(8.11842,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.346975,'amu*angstrom^2'), symmetry=1, barrier=(25.1337,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.0575,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3173,0.0383391,-4.17656e-05,2.46585e-08,-5.94944e-12,21654.3,20.2974], Tmin=(100,'K'), Tmax=(996.421,'K')), NASAPolynomial(coeffs=[8.09091,0.0151616,-6.87421e-06,1.31394e-09,-9.22996e-14,20503.7,-7.53623], Tmin=(996.421,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(179.549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cds-(Cdd-O2d)CsH) + group(Cds-OdCsH) + missing(Cdd-CdO2d) + radical(CCCJ=C=O) + radical(CCCJ=O)"""),
)
...
species(
    label = 'O=[C]C[C]=[C]O(9882)',
    structure = SMILES('O=[C]C[C]=[C]O'),
    E0 = (335.615,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,1670,1700,300,440,1855,455,950,252.778],'cm^-1')),
        HinderedRotor(inertia=(0.33481,'amu*angstrom^2'), symmetry=1, barrier=(15.3077,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.336744,'amu*angstrom^2'), symmetry=1, barrier=(15.3062,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.336067,'amu*angstrom^2'), symmetry=1, barrier=(15.3008,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58886,0.0468302,-4.72114e-05,2.2392e-08,-4.09005e-12,40457.2,24.6056], Tmin=(100,'K'), Tmax=(1342.67,'K')), NASAPolynomial(coeffs=[14.719,0.00771442,-3.51293e-06,6.95027e-10,-5.02358e-14,36931.2,-42.609], Tmin=(1342.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(335.615,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(Cds_S) + radical(CCCJ=O) + radical(C=CJO)"""),
)

species(
    label = 'O=[C][CH]C=[C]O(9883)',
    structure = SMILES('O=[C][CH]C=[C]O'),
    E0 = (259.902,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,1685,370,1855,455,950,317.691],'cm^-1')),
        HinderedRotor(inertia=(0.321503,'amu*angstrom^2'), symmetry=1, barrier=(23.0273,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.321528,'amu*angstrom^2'), symmetry=1, barrier=(23.0272,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.321501,'amu*angstrom^2'), symmetry=1, barrier=(23.0271,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78414,0.0344198,4.44654e-06,-4.07766e-08,2.03237e-11,31351.7,23.8103], Tmin=(100,'K'), Tmax=(964.616,'K')), NASAPolynomial(coeffs=[17.865,0.0026697,-5.02596e-07,1.86526e-10,-2.27188e-14,26624.2,-61.6153], Tmin=(964.616,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(259.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(CCJC=O) + radical(C=CJO) + radical(CCCJ=O)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=O(2355)', '[CH2][CH][C]=O(9632)'],
    products = ['O=[C][CH]C[C]=O(2650)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'O=[C][C]C[C]=O(9876)'],
    products = ['O=[C][CH]C[C]=O(2650)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['CO(2039)', '[CH2][CH][C]=O(9632)'],
    products = ['O=[C][CH]C[C]=O(2650)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[C]=O(2355)', 'CH2CHCO(3668)'],
    products = ['O=[C][CH]C[C]=O(2650)'],
