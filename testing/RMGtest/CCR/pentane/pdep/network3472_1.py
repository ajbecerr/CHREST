...
species(
    label = '[CH]C([CH][CH2])C=C(15397)',
    structure = SMILES('[CH]C([CH][CH2])C=C'),
    E0 = (775.949,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,200.488,803.548,1071.4,1351.17,1619.29],'cm^-1')),
        HinderedRotor(inertia=(0.153341,'amu*angstrom^2'), symmetry=1, barrier=(3.55696,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153341,'amu*angstrom^2'), symmetry=1, barrier=(3.55696,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153341,'amu*angstrom^2'), symmetry=1, barrier=(3.55696,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153341,'amu*angstrom^2'), symmetry=1, barrier=(3.55696,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.30074,0.0522458,-3.46337e-05,1.15398e-08,-1.55855e-12,93428.2,29.3751], Tmin=(100,'K'), Tmax=(1707.98,'K')), NASAPolynomial(coeffs=[13.653,0.0233175,-9.22801e-06,1.62333e-09,-1.07063e-13,89208.7,-36.8297], Tmin=(1707.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(775.949,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15847,0.056341,-4.22116e-05,1.18584e-08,5.64104e-13,123923,27.2114], Tmin=(100,'K'), Tmax=(978.882,'K')), NASAPolynomial(coeffs=[12.8881,0.0210013,-7.3524e-06,1.25776e-09,-8.44803e-14,121023,-32.2082], Tmin=(978.882,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1029.46,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]C([CH])C=C(15399)',
    structure = SMILES('[CH][CH]C([CH])C=C'),
    E0 = (1018.92,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32081,0.0534427,-4.04945e-05,1.57492e-08,-2.48801e-12,122648,28.5088], Tmin=(100,'K'), Tmax=(1483.54,'K')), NASAPolynomial(coeffs=[12.8337,0.0224011,-9.10841e-06,1.64505e-09,-1.11228e-13,119232,-31.5751], Tmin=(1483.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1018.92,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12588,0.0520009,-1.56539e-05,-2.07314e-08,1.28095e-11,58072.8,22.8279], Tmin=(100,'K'), Tmax=(968.53,'K')), NASAPolynomial(coeffs=[15.222,0.0200554,-6.86568e-06,1.22549e-09,-8.70442e-14,54110.1,-51.0881], Tmin=(968.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(481.9,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][CH][C]([CH2])C[CH2](15401)',
    structure = SMILES('[CH][CH][C]([CH2])C[CH2]'),
    E0 = (1044.3,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,181.361,893.28,2166.38,3541.44,4000],'cm^-1')),
        HinderedRotor(inertia=(0.049811,'amu*angstrom^2'), symmetry=1, barrier=(2.01929,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.049811,'amu*angstrom^2'), symmetry=1, barrier=(2.01929,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.049811,'amu*angstrom^2'), symmetry=1, barrier=(2.01929,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.049811,'amu*angstrom^2'), symmetry=1, barrier=(2.01929,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.049811,'amu*angstrom^2'), symmetry=1, barrier=(2.01929,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34164,0.0668358,-9.75999e-05,9.05429e-08,-3.30358e-11,125688,31.6177], Tmin=(100,'K'), Tmax=(858.63,'K')), NASAPolynomial(coeffs=[3.03382,0.0401546,-1.81494e-05,3.35749e-09,-2.26841e-13,126090,27.7469], Tmin=(858.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1044.3,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Cs_S) + radical(RCCJ) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][CH]C1[CH]CC1(15402)',
    structure = SMILES('[CH][CH]C1[CH]CC1'),
    E0 = (787.867,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17389,0.028535,3.09938e-05,-5.19993e-08,1.93032e-11,94834.2,25.8462], Tmin=(100,'K'), Tmax=(1037.01,'K')), NASAPolynomial(coeffs=[9.06148,0.0303294,-1.2626e-05,2.41638e-09,-1.73332e-13,91880.8,-14.9855], Tmin=(1037.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(787.867,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(Cs_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1C([CH2])C1[CH2](15403)',
    structure = SMILES('[CH]C1C([CH2])C1[CH2]'),
    E0 = (801.987,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68417,0.0354347,3.33187e-05,-7.55772e-08,3.43827e-11,96554.6,24.302], Tmin=(100,'K'), Tmax=(909.618,'K')), NASAPolynomial(coeffs=[15.1869,0.0167978,-3.13108e-06,3.75926e-10,-2.51642e-14,92412.7,-48.8262], Tmin=(909.618,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(801.987,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Isobutyl) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]C1CC1[CH2](15404)',
    structure = SMILES('[CH][CH]C1CC1[CH2]'),
    E0 = (800.488,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79337,0.0356985,2.18174e-05,-5.37038e-08,2.33121e-11,96367.6,25.6555], Tmin=(100,'K'), Tmax=(956.865,'K')), NASAPolynomial(coeffs=[12.4298,0.0228586,-7.62855e-06,1.35101e-09,-9.60796e-14,92884.3,-32.7552], Tmin=(956.865,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(800.488,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Cs_S) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][CH][C]([CH2])C=C(15405)',
    structure = SMILES('[CH]C=C([CH2])[CH][CH2]'),
    E0 = (776.94,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,522.345,522.35,522.361,522.364],'cm^-1')),
        HinderedRotor(inertia=(0.00061783,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265405,'amu*angstrom^2'), symmetry=1, barrier=(51.3895,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265411,'amu*angstrom^2'), symmetry=1, barrier=(51.3896,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.265401,'amu*angstrom^2'), symmetry=1, barrier=(51.3895,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
...
species(
    label = '[CH][CH]C([CH2])[C]=C(15406)',
    structure = SMILES('[CH][CH]C([CH2])[C]=C'),
    E0 = (1013.63,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,213.621,820.337,1093.78,1367.64,1762.69],'cm^-1')),
        HinderedRotor(inertia=(0.13722,'amu*angstrom^2'), symmetry=1, barrier=(3.40634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13722,'amu*angstrom^2'), symmetry=1, barrier=(3.40634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13722,'amu*angstrom^2'), symmetry=1, barrier=(3.40634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13722,'amu*angstrom^2'), symmetry=1, barrier=(3.40634,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60327,0.0538285,-4.86323e-05,2.59318e-08,-5.90162e-12,121997,28.7449], Tmin=(100,'K'), Tmax=(1033.01,'K')), NASAPolynomial(coeffs=[8.15518,0.028458,-1.17922e-05,2.15627e-09,-1.47604e-13,120643,-3.077], Tmin=(1033.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1013.63,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Isobutyl) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]C([CH2])C=[CH](15407)',
    structure = SMILES('[CH][CH]C([CH2])C=[CH]'),
    E0 = (1022.88,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,180,984.298,984.482,984.796],'cm^-1')),
        HinderedRotor(inertia=(0.00369165,'amu*angstrom^2'), symmetry=1, barrier=(2.54205,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11046,'amu*angstrom^2'), symmetry=1, barrier=(2.5397,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110798,'amu*angstrom^2'), symmetry=1, barrier=(2.54746,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110413,'amu*angstrom^2'), symmetry=1, barrier=(2.5386,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42585,0.0544201,-4.65519e-05,2.20979e-08,-4.34178e-12,123119,29.3064], Tmin=(100,'K'), Tmax=(1204.95,'K')), NASAPolynomial(coeffs=[10.3315,0.0248564,-9.74897e-06,1.73567e-09,-1.17071e-13,120973,-15.3186], Tmin=(1204.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1022.88,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Isobutyl) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[CH]C[C]([CH2])C=C(15408)',
    structure = SMILES('[CH]CC([CH2])=C[CH2]'),
    E0 = (659.611,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08389,0.054182,-2.34739e-05,-9.53641e-09,7.84346e-12,79446.6,24.6732], Tmin=(100,'K'), Tmax=(1006.33,'K')), NASAPolynomial(coeffs=[14.2137,0.0231483,-8.74943e-06,1.59914e-09,-1.12609e-13,75732.8,-44.0758], Tmin=(1006.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(659.611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.155,0.0581363,-4.82321e-05,2.21587e-08,-4.18499e-12,98619.3,27.7928], Tmin=(100,'K'), Tmax=(1258.68,'K')), NASAPolynomial(coeffs=[11.389,0.0256136,-9.4743e-06,1.63068e-09,-1.07727e-13,96043,-23.9349], Tmin=(1258.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(819.085,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH][CH]C([CH2])C=C(7163)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C([CH][CH2])C=C(15397)'],
    products = ['[CH][CH]C([CH2])C=C(7163)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', '[CH]=C[CH][CH][CH2](15115)'],
    products = ['[CH][CH]C([CH2])C=C(7163)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH][C]C([CH2])C=C(15398)'],
    products = ['[CH][CH]C([CH2])C=C(7163)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH][CH]C([CH])C=C(15399)'],
    products = ['[CH][CH]C([CH2])C=C(7163)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['[CH][CH][C]([CH2])C[CH2](15401)'],
    products = ['[CH][CH]C([CH2])C=C(7163)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH][CH]C([CH2])C=C(7163)'],
    products = ['[CH][CH]C1[CH]CC1(15402)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH][CH]C([CH2])C=C(7163)'],
    products = ['[CH]C1C([CH2])C1[CH2](15403)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH][CH]C([CH2])C=C(7163)'],
    products = ['[CH][CH]C1CC1[CH2](15404)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(8.22e+08,'cm^3/(mol*s)'), n=1.533, Ea=(27.0372,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 192 used for Cd_R;HJ
Exact match found for rate rule [Cd_R;HJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 21.7 to 27.0 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.21282,'m^3/(mol*s)'), n=2.065, Ea=(15.9938,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cds-CdH_Cds-HH;YJ] for rate rule [Cds-CdH_Cds-HH;Y_1centerbirad]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 4.0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction20',
    reactants = ['C2H3(60)', '[CH][CH][CH][CH2](14430)'],
    products = ['[CH][CH]C([CH2])C=C(7163)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH][CH][C]([CH2])C=C(15405)'],
    products = ['[CH][CH]C([CH2])C=C(7163)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH][CH]C([CH2])[C]=C(15406)'],
    products = ['[CH][CH]C([CH2])C=C(7163)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH][CH]C([CH2])C=[CH](15407)'],
    products = ['[CH][CH]C([CH2])C=C(7163)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH][CH]C([CH2])C=C(7163)'],
    products = ['[CH]=C[C](C)[CH][CH2](15199)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]CC([CH2])C=[CH](13777)'],
    products = ['[CH][CH]C([CH2])C=C(7163)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH][CH]C(C)C=[CH](15195)'],
    products = ['[CH][CH]C([CH2])C=C(7163)'],
