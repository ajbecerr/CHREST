...
species(
    label = '[CH2]C([CH2])CC(C)[CH]O[O](8157)',
    structure = SMILES('[CH2]C([CH2])CC(C)[CH]O[O]'),
    E0 = (435.396,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.665448,0.106448,-0.000122512,8.50514e-08,-2.45184e-11,52530.5,39.7742], Tmin=(100,'K'), Tmax=(839.058,'K')), NASAPolynomial(coeffs=[11.3696,0.049075,-1.99467e-05,3.5608e-09,-2.38439e-13,50510.8,-16.1761], Tmin=(839.058,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(435.396,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCsJOOH) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH2])C[CH]C(C)[O](8158)',
    structure = SMILES('[CH2]C([CH2])C[CH]C(C)[O]'),
    E0 = (446.618,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.306445,0.0862019,-7.11458e-05,3.25077e-08,-6.07135e-12,53877.9,39.0486], Tmin=(100,'K'), Tmax=(1278.98,'K')), NASAPolynomial(coeffs=[15.5623,0.0365724,-1.29395e-05,2.16765e-09,-1.40799e-13,49818.7,-41.4135], Tmin=(1278.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(446.618,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH2])C[C]C(C)O[O](8159)',
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.761364,0.107406,-0.000125413,8.38832e-08,-2.28505e-11,82925.9,39.8095], Tmin=(100,'K'), Tmax=(892.277,'K')), NASAPolynomial(coeffs=[13.5934,0.0430545,-1.72329e-05,3.05588e-09,-2.04111e-13,80364.3,-27.8076], Tmin=(892.277,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(688.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Isobutyl) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([CH2])C[CH]C(C)O[O](8160)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.615022,0.106022,-0.000122432,8.1837e-08,-2.25794e-11,82357.7,41.6054], Tmin=(100,'K'), Tmax=(875.467,'K')), NASAPolynomial(coeffs=[12.4998,0.0460983,-1.97552e-05,3.64516e-09,-2.49777e-13,80061.5,-19.9213], Tmin=(875.467,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(683.413,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = 'CC([CH]CC1CC1)O[O](8161)',
    structure = SMILES('CC([CH]CC1CC1)O[O]'),
    E0 = (189.364,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.478223,0.0862584,-5.74739e-05,1.68403e-08,-1.21043e-12,22946.6,37.8806], Tmin=(100,'K'), Tmax=(1207.54,'K')), NASAPolynomial(coeffs=[17.72,0.0392539,-1.55783e-05,2.81588e-09,-1.92071e-13,17583.6,-57.3552], Tmin=(1207.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.364,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(ROOJ) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C([CH2])CC1OOC1C(8162)',
    structure = SMILES('[CH2]C([CH2])CC1OOC1C'),
    E0 = (244.572,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.302381,0.0897716,-7.04785e-05,3.08508e-08,-5.64809e-12,29574.1,32.9514], Tmin=(100,'K'), Tmax=(1277.45,'K')), NASAPolynomial(coeffs=[14.1996,0.0443625,-1.71585e-05,3.02454e-09,-2.02439e-13,25868.9,-40.5634], Tmin=(1277.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(244.572,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH2])CC1OC1C(8164)',
    structure = SMILES('[CH2]C([CH2])CC1OC1C'),
    E0 = (193.276,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.17,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06399,0.088616,-7.37591e-05,3.43216e-08,-6.18389e-12,23447.6,35.4696], Tmin=(100,'K'), Tmax=(1590.64,'K')), NASAPolynomial(coeffs=[16.0866,0.0314996,-6.70685e-06,6.90305e-10,-2.91874e-14,19761,-49.67], Tmin=(1590.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(193.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.19267,0.0977297,-9.49642e-05,5.45311e-08,-1.34634e-11,17984.7,36.5759], Tmin=(100,'K'), Tmax=(951.626,'K')), NASAPolynomial(coeffs=[10.5908,0.0524026,-2.35162e-05,4.47708e-09,-3.13633e-13,15932.4,-14.9131], Tmin=(951.626,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.317,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C(=C)CCC(C)O[O](8165)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.446209,0.0961406,-8.16982e-05,3.74956e-08,-7.13693e-12,12116.5,34.7495], Tmin=(100,'K'), Tmax=(1232.81,'K')), NASAPolynomial(coeffs=[15.482,0.0444594,-1.88157e-05,3.49038e-09,-2.41032e-13,8189.25,-45.4285], Tmin=(1232.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(99.4012,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]C([CH2])CC=C(C)OO(8166)',
    structure = SMILES('[CH2]C([CH2])CC=C(C)OO'),
    E0 = (210.952,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.382066,0.0984349,-9.69729e-05,5.5747e-08,-1.34287e-11,25527.7,38.8019], Tmin=(100,'K'), Tmax=(989.618,'K')), NASAPolynomial(coeffs=[12.2651,0.0473154,-1.9489e-05,3.54903e-09,-2.42259e-13,23024.5,-22.0813], Tmin=(989.618,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(210.952,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)C=CC(C)O[O](7708)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.566476,0.0915314,-7.29168e-05,3.09888e-08,-5.37213e-12,18073.1,39.7605], Tmin=(100,'K'), Tmax=(1365.6,'K')), NASAPolynomial(coeffs=[17.5138,0.0385714,-1.47437e-05,2.58909e-09,-1.72928e-13,13135.1,-53.0998], Tmin=(1365.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])C=CC(C)OO(8167)',
    structure = SMILES('[CH2]C([CH2])C=CC(C)OO'),
    E0 = (201.918,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.886862,0.0977056,-8.39482e-05,3.8518e-08,-7.13249e-12,24469.2,41.2387], Tmin=(100,'K'), Tmax=(1295.91,'K')), NASAPolynomial(coeffs=[18.7884,0.0369746,-1.36521e-05,2.35458e-09,-1.55973e-13,19369.8,-58.7829], Tmin=(1295.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)CC=C(C)O[O](7455)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0302889,0.0918859,-8.46448e-05,4.66163e-08,-1.1038e-11,19130.2,37.2119], Tmin=(100,'K'), Tmax=(991.444,'K')), NASAPolynomial(coeffs=[10.3744,0.049908,-2.11348e-05,3.91114e-09,-2.69598e-13,17067.1,-12.8955], Tmin=(991.444,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.874,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH2])CC=C(C)O[O](8169)',
    structure = SMILES('[CH2]C([CH2])CC=C(C)O[O]'),
    E0 = (362.956,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,201.49,840.152],'cm^-1')),
        HinderedRotor(inertia=(0.148904,'amu*angstrom^2'), symmetry=1, barrier=(3.51698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148904,'amu*angstrom^2'), symmetry=1, barrier=(3.51698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148904,'amu*angstrom^2'), symmetry=1, barrier=(3.51698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148904,'amu*angstrom^2'), symmetry=1, barrier=(3.51698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148904,'amu*angstrom^2'), symmetry=1, barrier=(3.51698,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.218501,0.0960484,-0.000106014,7.09037e-08,-1.98062e-11,43802.5,38.9723], Tmin=(100,'K'), Tmax=(862.792,'K')), NASAPolynomial(coeffs=[10.6314,0.045745,-1.85559e-05,3.3231e-09,-2.23431e-13,41930.3,-11.7704], Tmin=(862.792,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(362.956,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])C=CC(C)O[O](8170)',
    structure = SMILES('[CH2]C([CH2])C=CC(C)O[O]'),
    E0 = (353.923,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.467853,0.0923555,-8.28742e-05,4.09246e-08,-8.22421e-12,42732.9,40.4898], Tmin=(100,'K'), Tmax=(1194.59,'K')), NASAPolynomial(coeffs=[15.9597,0.0373492,-1.3805e-05,2.37908e-09,-1.57537e-13,38808.1,-41.6843], Tmin=(1194.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(353.923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2][C]([CH2])C[CH]C(C)O[O](8171)',
    structure = SMILES('[CH2][C]([CH2])C[CH]C(C)O[O]'),
    E0 = (625.702,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,260.875,876.557,1886.78],'cm^-1')),
        HinderedRotor(inertia=(0.0994414,'amu*angstrom^2'), symmetry=1, barrier=(3.29716,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0994414,'amu*angstrom^2'), symmetry=1, barrier=(3.29716,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0994414,'amu*angstrom^2'), symmetry=1, barrier=(3.29716,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0994414,'amu*angstrom^2'), symmetry=1, barrier=(3.29716,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0994414,'amu*angstrom^2'), symmetry=1, barrier=(3.29716,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.6795,0.114865,-0.000172959,1.51813e-07,-5.19107e-11,75411.7,43.0434], Tmin=(100,'K'), Tmax=(881.515,'K')), NASAPolynomial(coeffs=[6.89841,0.0537083,-2.33387e-05,4.207e-09,-2.7875e-13,75115.9,13.3398], Tmin=(881.515,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(625.702,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Tertalkyl) + radical(CCJCOOH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])C[CH][CH]O[O](1101)',
    structure = SMILES('[CH2]C([CH2])C[CH][CH]O[O]'),
    E0 = (665.285,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0864693,0.0972347,-0.000138586,1.14124e-07,-3.70485e-11,80155.5,38.0304], Tmin=(100,'K'), Tmax=(889.892,'K')), NASAPolynomial(coeffs=[8.88702,0.0410137,-1.70426e-05,3.00897e-09,-1.9722e-13,79187.4,-0.680501], Tmin=(889.892,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(665.285,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(Isobutyl) + radical(Isobutyl) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2]C([CH2])C[CH][C](C)O[O](8172)',
    structure = SMILES('[CH2]C([CH2])C[CH][C](C)O[O]'),
    E0 = (627.179,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.625269,0.109901,-0.00015077,1.23863e-07,-4.07966e-11,75590.9,42.009], Tmin=(100,'K'), Tmax=(868.038,'K')), NASAPolynomial(coeffs=[8.79858,0.0508175,-2.16155e-05,3.88966e-09,-2.59008e-13,74544.8,1.27586], Tmin=(868.038,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(627.179,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOOH) + radical(CCJCOOH) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH2])C[CH]C([CH2])O[O](8174)',
    structure = SMILES('[CH2]C([CH2])C[CH]C([CH2])O[O]'),
    E0 = (654.242,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.815191,0.109922,-0.000138087,1.00361e-07,-2.96222e-11,78856.8,44.3942], Tmin=(100,'K'), Tmax=(851.149,'K')), NASAPolynomial(coeffs=[12.8293,0.0436923,-1.7655e-05,3.12344e-09,-2.07235e-13,76610.4,-18.7852], Tmin=(851.149,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(654.242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(Isobutyl) + radical(Isobutyl) + radical(CJCOOH)"""),
)

species(
    label = '[CH2][C](C)C[CH]C(C)O[O](7709)',
    structure = SMILES('[CH2][C](C)C[CH]C(C)O[O]'),
    E0 = (420.62,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.643022,0.112554,-0.000158422,1.37085e-07,-4.76277e-11,50746.1,41.8237], Tmin=(100,'K'), Tmax=(847.038,'K')), NASAPolynomial(coeffs=[6.70953,0.0577652,-2.58612e-05,4.78262e-09,-3.23947e-13,50220.4,11.8219], Tmin=(847.038,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(420.62,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Tertalkyl) + radical(CCJCOOH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])CC[C](C)O[O](8175)',
    structure = SMILES('[CH2]C([CH2])CC[C](C)O[O]'),
    E0 = (426.764,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.614934,0.107431,-0.000133196,1.0238e-07,-3.25352e-11,51488.4,39.6687], Tmin=(100,'K'), Tmax=(844.71,'K')), NASAPolynomial(coeffs=[9.4228,0.0523311,-2.19144e-05,3.94829e-09,-2.64644e-13,50062.5,-5.46551], Tmin=(844.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(426.764,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOOH) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH2])C[CH][C](C)OO(8176)',
    structure = SMILES('[CH2]C([CH2])C[CH][C](C)OO'),
    E0 = (475.174,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.833307,0.112793,-0.00014345,1.1099e-07,-3.54791e-11,57318.1,41.9997], Tmin=(100,'K'), Tmax=(822.912,'K')), NASAPolynomial(coeffs=[10.2772,0.0526744,-2.2724e-05,4.15886e-09,-2.81543e-13,55696.5,-8.17891], Tmin=(822.912,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(475.174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CCJCOOH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)[CH][CH]C(C)O[O](7711)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.333166,0.101263,-0.000112508,7.79717e-08,-2.31231e-11,51836.4,42.1482], Tmin=(100,'K'), Tmax=(805.897,'K')), NASAPolynomial(coeffs=[9.28947,0.0534993,-2.36022e-05,4.42122e-09,-3.05549e-13,50285.5,-2.1984], Tmin=(805.897,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(429.74,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(CCJCOOH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])CCC([CH2])O[O](8177)',
    structure = SMILES('[CH2]C([CH2])CCC([CH2])O[O]'),
    E0 = (453.827,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.764331,0.106946,-0.000118593,7.61246e-08,-2.00421e-11,54752.5,41.9102], Tmin=(100,'K'), Tmax=(919.575,'K')), NASAPolynomial(coeffs=[13.4129,0.0452756,-1.79943e-05,3.19163e-09,-2.13665e-13,52145.1,-25.2979], Tmin=(919.575,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(453.827,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Isobutyl) + radical(Isobutyl) + radical(CJCOOH)"""),
)

species(
    label = '[CH2][C]([CH2])CCC(C)O[O](8178)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.688704,0.112642,-0.000156328,1.31668e-07,-4.42704e-11,51310,40.7721], Tmin=(100,'K'), Tmax=(870.533,'K')), NASAPolynomial(coeffs=[7.58465,0.055112,-2.35724e-05,4.24988e-09,-2.8306e-13,50609,6.2522], Tmin=(870.533,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(425.288,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Tertalkyl) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])C[CH]C([CH2])OO(8179)',
    structure = SMILES('[CH2]C([CH2])C[CH]C([CH2])OO'),
    E0 = (502.238,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.944368,0.111822,-0.000126966,8.19809e-08,-2.16425e-11,60580.6,44.1058], Tmin=(100,'K'), Tmax=(917.4,'K')), NASAPolynomial(coeffs=[14.2196,0.0457029,-1.88534e-05,3.41406e-09,-2.31559e-13,57798.4,-27.7435], Tmin=(917.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(502.238,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(Isobutyl) + radical(Isobutyl) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C([CH2])[CH][CH]C(C)OO(8180)',
    structure = SMILES('[CH2]C([CH2])[CH][CH]C(C)OO'),
    E0 = (482.817,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.634554,0.107207,-0.000122656,8.41321e-08,-2.41569e-11,58231.6,43.5581], Tmin=(100,'K'), Tmax=(838.353,'K')), NASAPolynomial(coeffs=[11.1585,0.0509364,-2.19702e-05,4.06178e-09,-2.78391e-13,56254.4,-11.2567], Tmin=(838.353,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(482.817,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(CCJCOOH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)C[CH][C](C)O[O](7710)',
    structure = SMILES('[CH2]C(C)C[CH][C](C)O[O]'),
    E0 = (422.097,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.54823,0.107078,-0.000134291,1.06421e-07,-3.52828e-11,50923.5,40.6461], Tmin=(100,'K'), Tmax=(809.382,'K')), NASAPolynomial(coeffs=[8.46149,0.0551379,-2.42948e-05,4.50318e-09,-3.07403e-13,49707.9,0.584826], Tmin=(809.382,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(422.097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOOH) + radical(CCJCOOH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][C]([CH2])C[CH]C(C)OO(8181)',
    structure = SMILES('[CH2][C]([CH2])C[CH]C(C)OO'),
    E0 = (473.698,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.922888,0.118205,-0.000167351,1.41363e-07,-4.7713e-11,57140.4,43.1588], Tmin=(100,'K'), Tmax=(857.579,'K')), NASAPolynomial(coeffs=[8.49488,0.0553558,-2.43227e-05,4.4461e-09,-2.98747e-13,56220.9,3.22738], Tmin=(857.579,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(473.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(CCJCOOH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)C[CH]C([CH2])O[O](7712)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.608254,0.105447,-0.000115203,7.35356e-08,-1.953e-11,54183.8,42.5727], Tmin=(100,'K'), Tmax=(904.931,'K')), NASAPolynomial(coeffs=[12.3143,0.0483265,-2.05198e-05,3.78155e-09,-2.59375e-13,51845.1,-18.4803], Tmin=(904.931,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(449.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(Isobutyl) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]C([CH2])C[CH]CO[O](743)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C([CH2])CC(C)[CH]O[O](8157)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
    products = ['O2(S)(666)', '[CH2]C([CH2])CC=CC(604)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction7',
    reactants = ['O(4)', '[CH2]C([CH2])C[CH]C(C)[O](8158)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH]O[O](57)', '[CH]CC([CH2])[CH2](490)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]C(C)O[O](668)', '[CH2]C([CH2])[CH2](489)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2]C([CH2])C[C]C(C)O[O](8159)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]C([CH2])C[CH]C(C)O[O](8160)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
    products = ['CC([CH]CC1CC1)O[O](8161)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
    products = ['[CH2]C([CH2])CC1OOC1C(8162)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
    products = ['O(4)', '[CH2]C([CH2])CC1OC1C(8164)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
    products = ['HO2(9)', '[CH2]C([CH2])C[CH]C=C(4133)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
    products = ['C=C(C)C[CH]C(C)O[O](7707)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
    products = ['[CH2]C(=C)CCC(C)O[O](8165)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
    products = ['[CH2]C([CH2])CC=C(C)OO(8166)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
    products = ['[CH2]C(C)C=CC(C)O[O](7708)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
    products = ['[CH2]C([CH2])C=CC(C)OO(8167)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
    products = ['[CH2]C(C)CC=C(C)O[O](7455)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH2]C(=C)C[CH]C(C)O[O](8168)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2]C([CH2])CC=C(C)O[O](8169)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2]C([CH2])C=CC(C)O[O](8170)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH2(T)(20)', 'C=CC[CH]C(C)O[O](7476)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH3(17)', '[CH2]C([CH2])CC=CO[O](1098)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
...
reaction(
    label = 'reaction31',
    reactants = ['O2(2)', '[CH2]C([CH2])CC=CC(604)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', '[CH2][C]([CH2])C[CH]C(C)O[O](8171)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CH3(17)', '[CH2]C([CH2])C[CH][CH]O[O](1101)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', '[CH2]C([CH2])C[CH][C](C)O[O](8172)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(3)', '[CH2]C([CH2])[CH][CH]C(C)O[O](8173)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(3)', '[CH2]C([CH2])C[CH]C([CH2])O[O](8174)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
    products = ['[CH2][C](C)C[CH]C(C)O[O](7709)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
    products = ['[CH2]C([CH2])CC[C](C)O[O](8175)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2]C([CH2])C[CH][C](C)OO(8176)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
    products = ['[CH2]C(C)[CH][CH]C(C)O[O](7711)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH2]C([CH2])CCC([CH2])O[O](8177)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
    products = ['[CH2][C]([CH2])CCC(C)O[O](8178)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
    products = ['[CH2]C([CH2])C[CH]C([CH2])OO(8179)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH2]C([CH2])[CH][CH]C(C)OO(8180)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
    products = ['[CH2]C(C)C[CH][C](C)O[O](7710)'],
    transitionState = 'TS48',
    kinetics = Arrhenius(A=(8.80621e+06,'s^-1'), n=1.47577, Ea=(78.4176,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [RnH;C_rad_out_2H;Cs_H_out_NonDe] + [R5Hall;Y_rad_out;Cs_H_out_NDMustO] + [R5Hall;C_rad_out_2H;Cs_H_out_noH] for rate rule [R5HJ_3;C_rad_out_2H;Cs_H_out_NDMustO]
Euclidian distance = 2.23606797749979
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction49',
    reactants = ['[CH2][C]([CH2])C[CH]C(C)OO(8181)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[CH2]C(C)C[CH]C([CH2])O[O](7712)'],
    products = ['[CH2]C([CH2])C[CH]C(C)O[O](7450)'],
