...
reaction(
    ...
    products = ['[CH2]C([CH2])C([CH2])[CH2](485)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]C([CH2])C([CH2])[CH2](632)'],
    products = ['[CH2]C([CH2])C([CH2])[CH2](485)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2][C]([CH2])C([CH2])[CH2](636)'],
    products = ['[CH2]C([CH2])C([CH2])[CH2](485)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C([CH2])C([CH2])[CH2](485)'],
    products = ['[CH2][C](C)C([CH2])[CH2](521)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C([CH2])C([CH2])[CH2](485)'],
    products = ['[CH2][C]([CH2])C([CH2])C(522)'],
