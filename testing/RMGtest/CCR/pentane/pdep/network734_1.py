species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.9851,'amu*angstrom^2'), symmetry=1, barrier=(22.6494,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.984799,'amu*angstrom^2'), symmetry=1, barrier=(22.6425,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.984812,'amu*angstrom^2'), symmetry=1, barrier=(22.6428,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.984861,'amu*angstrom^2'), symmetry=1, barrier=(22.6439,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.13045,'amu*angstrom^2'), symmetry=1, barrier=(25.9912,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.1318,'amu*angstrom^2'), symmetry=1, barrier=(26.0224,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.12831,'amu*angstrom^2'), symmetry=1, barrier=(25.9421,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0547,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.80122,0.056992,-7.09587e-05,3.89703e-08,-7.74775e-12,7147.07,17.4889], Tmin=(100,'K'), Tmax=(1448.59,'K')), NASAPolynomial(coeffs=[18.5347,-0.00345272,3.5155e-06,-7.73429e-10,5.51826e-14,3213.54,-70.4805], Tmin=(1448.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(58.3708,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(OCJO)"""),
)
...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74738,0.0316506,3.34062e-05,-8.24508e-08,3.93364e-11,-908.996,17.2587], Tmin=(100,'K'), Tmax=(898.402,'K')), NASAPolynomial(coeffs=[19.3811,0.00124539,3.8521e-06,-9.18099e-10,6.26091e-14,-6018.82,-76.7291], Tmin=(898.402,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-8.37231,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#COC([CH2])O(2332)'],
    products = ['ketene(1375)', 'vinoxy(1351)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(3.29914e+17,'s^-1'), n=-1.73308, Ea=(142.084,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.16692063000437535, var=8.814681701569807, Tref=1000.0, N=65, correlation='Root',), comment="""BM rule fitted to 2 training reactions at node Root
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(20)', 'C#CO[CH]O(9522)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH]C(O)OC#C(6941)'],
    products = ['C#COC([CH2])O(2332)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['HCCO(2227)', 'ethenol(1347)'],
    products = ['C#COC([CH2])O(2332)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['HCCO(2227)', '[CH2][CH]O(1380)'],
    products = ['C#COC([CH2])O(2332)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['HC2(2881)', '[CH2]C([O])O(1468)'],
    products = ['C#COC([CH2])O(2332)'],
...
reaction(
    label = 'reaction11',
    reactants = ['OH(5)', 'C#CO[CH][CH2](3100)'],
    products = ['C#COC([CH2])O(2332)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH]=[C]OC(=C)O(2699)'],
    products = ['C#COC([CH2])O(2332)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[C]#COC([CH2])O(3074)'],
    products = ['C#COC([CH2])O(2332)'],
