...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0980913,0.103925,-0.000189708,1.76582e-07,-6.21681e-11,142325,34.0381], Tmin=(100,'K'), Tmax=(861.55,'K')), NASAPolynomial(coeffs=[8.24713,0.0352596,-1.80674e-05,3.45799e-09,-2.35406e-13,141997,1.46512], Tmin=(861.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1182.24,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CCOJ) + radical(C2CsJOH) + radical(Cds_S) + radical(CH2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[C]=[C]CC[C]([O])[CH][O](28254)',
    structure = SMILES('[C]=[C]CC[C]([O])[CH][O]'),
    E0 = (1212.56,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,3025,407.5,1350,352.5,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.103,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.105429,0.109434,-0.000215845,2.11135e-07,-7.61877e-11,145966,34.8561], Tmin=(100,'K'), Tmax=(876.301,'K')), NASAPolynomial(coeffs=[4.97001,0.040973,-2.11252e-05,4.01391e-09,-2.70443e-13,146816,20.963], Tmin=(876.301,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1212.56,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CCOJ) + radical(C2CsJOH) + radical(CCsJOH) + radical(Cds_S) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.375857,0.0657208,-3.30485e-05,-1.84287e-08,1.59407e-11,44236.9,33.7764], Tmin=(100,'K'), Tmax=(932.727,'K')), NASAPolynomial(coeffs=[21.4224,0.0109816,-2.13859e-06,3.05666e-10,-2.36392e-14,38765.7,-74.5774], Tmin=(932.727,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(366.614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(C=COJ) + radical(CCJCO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C=CCC([O])[CH][O](28257)',
    structure = SMILES('C#C[CH]CC([O])[CH][O]'),
    E0 = (552.297,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.124077,0.0936333,-0.000147347,1.25115e-07,-4.08587e-11,66557.6,31.4402], Tmin=(100,'K'), Tmax=(900.123,'K')), NASAPolynomial(coeffs=[9.42237,0.0329616,-1.39928e-05,2.46362e-09,-1.59834e-13,65667.7,-8.08559], Tmin=(900.123,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(552.297,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsOsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(CC(C)OJ) + radical(CCOJ) + radical(Sec_Propargyl) + radical(CCsJOH)"""),
)

species(
    label = '[CH]=[C]CC=C([O])[CH][O](28258)',
    structure = SMILES('[CH]=[C]C[CH]C([O])=C[O]'),
    E0 = (604.456,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,350,440,435,1725,3010,987.5,1337.5,450,1655,1685,370,3120,650,792.5,1650,394.436,394.439,394.44,394.447],'cm^-1')),
        HinderedRotor(inertia=(0.00108349,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140477,'amu*angstrom^2'), symmetry=1, barrier=(15.5091,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.140473,'amu*angstrom^2'), symmetry=1, barrier=(15.5091,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (109.103,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.254955,0.0772768,-8.176e-05,4.13544e-08,-7.84833e-12,72866.4,36.5198], Tmin=(100,'K'), Tmax=(1451.86,'K')), NASAPolynomial(coeffs=[21.5581,0.00818065,-1.07498e-06,3.60005e-11,1.55133e-15,67481,-73.5819], Tmin=(1451.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(604.456,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(C=COJ) + radical(CCJCO) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]C[CH][C]([O])[CH][O](28259)',
    structure = SMILES('[CH]=[C]C[CH][C]([O])[CH][O]'),
    E0 = (1101.45,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,360,370,350,1685,370,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (109.103,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0470346,0.101414,-0.000186778,1.75579e-07,-6.19812e-11,132603,36.8312], Tmin=(100,'K'), Tmax=(871.823,'K')), NASAPolynomial(coeffs=[7.10321,0.036214,-1.81229e-05,3.42432e-09,-2.30923e-13,132620,10.9116], Tmin=(871.823,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1101.45,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CCOJ) + radical(CCJCO) + radical(C2CsJOH) + radical(CCsJOH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]C[CH]C([O])[CH][O](28260)',
    structure = SMILES('[CH]=[C]C[CH]C([O])[CH][O]'),
    E0 = (924.824,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,1685,370,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.22701,0.092368,-0.000148625,1.31956e-07,-4.5826e-11,111357,36.7615], Tmin=(100,'K'), Tmax=(840.812,'K')), NASAPolynomial(coeffs=[8.30556,0.0364402,-1.7638e-05,3.35136e-09,-2.29485e-13,110617,2.86549], Tmin=(840.812,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(924.824,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CCOJ) + radical(CCJCO) + radical(CCsJOH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=CC[CH][C]([O])[CH][O](28261)',
    structure = SMILES('[CH]=CC[CH][C]([O])[CH][O]'),
    E0 = (863.61,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0958899,0.0966214,-0.000161302,1.45421e-07,-5.06546e-11,103999,36.1826], Tmin=(100,'K'), Tmax=(852.4,'K')), NASAPolynomial(coeffs=[8.19675,0.0368816,-1.79439e-05,3.39896e-09,-2.31577e-13,103407,3.02402], Tmin=(852.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(863.61,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CCOJ) + radical(CCJCO) + radical(C2CsJOH) + radical(CCsJOH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]C[CH][C](O)[CH][O](28262)',
    structure = SMILES('[CH]=[C]C[CH][C](O)[CH][O]'),
    E0 = (871.091,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.113123,0.105371,-0.000192524,1.80344e-07,-6.34359e-11,104902,37.5982], Tmin=(100,'K'), Tmax=(875.278,'K')), NASAPolynomial(coeffs=[7.18427,0.0379794,-1.86928e-05,3.50801e-09,-2.35591e-13,104928,10.8138], Tmin=(875.278,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(871.091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCJCO) + radical(C2CsJOH) + radical(CCsJOH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]C[CH][C]([O])C[O](28263)',
    structure = SMILES('[CH]=[C]C[CH][C]([O])C[O]'),
    E0 = (921.154,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,360,370,350,1685,370,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.300329,0.092875,-0.000156364,1.44518e-07,-5.14479e-11,110911,36.3725], Tmin=(100,'K'), Tmax=(851.394,'K')), NASAPolynomial(coeffs=[6.52658,0.0393391,-1.92597e-05,3.66071e-09,-2.49977e-13,110731,12.5049], Tmin=(851.394,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(921.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CC(C)OJ) + radical(CCJCO) + radical(C2CsJOH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]C[CH][C]([O])[CH]O(28264)',
    structure = SMILES('[CH]=[C]C[CH][C]([O])[CH]O'),
    E0 = (875.746,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.298116,0.103944,-0.000173647,1.49267e-07,-4.92768e-11,105474,37.2105], Tmin=(100,'K'), Tmax=(872.279,'K')), NASAPolynomial(coeffs=[11.775,0.0298309,-1.39579e-05,2.57769e-09,-1.72183e-13,104081,-15.297], Tmin=(872.279,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(875.746,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CCJCO) + radical(C2CsJOH) + radical(CCsJOH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[O][C][CH][O](10223)', '[CH]=[C]C[CH2](9654)'],
    products = ['[CH]=[C]CC[C]([O])[CH][O](25998)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[C]=[CH](9646)', '[CH2]C[C]([O])[CH][O](26258)'],
    products = ['[CH]=[C]CC[C]([O])[CH][O](25998)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]=[C]CC[C]([O])[C][O](28253)'],
    products = ['[CH]=[C]CC[C]([O])[CH][O](25998)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[C]=[C]CC[C]([O])[CH][O](28254)'],
    products = ['[CH]=[C]CC[C]([O])[CH][O](25998)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[C]CC[C]([O])[CH][O](25998)'],
    products = ['[CH]=CCC=C([O])[CH][O](28256)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[C]CC[C]([O])[CH][O](25998)'],
    products = ['[CH]=C=CCC([O])[CH][O](28257)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]=[C]CC=C([O])[CH][O](28258)'],
    products = ['[CH]=[C]CC[C]([O])[CH][O](25998)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.135493,'m^3/(mol*s)'), n=1.98996, Ea=(266.101,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_R;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 264.1 to 266.1 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH]=[C]C[CH][C]([O])[CH][O](28259)'],
    products = ['[CH]=[C]CC[C]([O])[CH][O](25998)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=[C]C[CH]C([O])[CH][O](28260)'],
    products = ['[CH]=[C]CC[C]([O])[CH][O](25998)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]=[C]CC[C]([O])[CH][O](25998)'],
    products = ['[CH]=[C][CH]CC([O])[CH][O](28103)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=[C]CC[C]([O])[CH][O](25998)'],
    products = ['[CH]=CC[CH][C]([O])[CH][O](28261)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=[C]CC[C]([O])[CH][O](25998)'],
    products = ['[CH]=[C]C[CH][C](O)[CH][O](28262)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=[C]C[CH][C]([O])C[O](28263)'],
    products = ['[CH]=[C]CC[C]([O])[CH][O](25998)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]=[C]CC[C]([O])[CH][O](25998)'],
    products = ['[CH]=[C][CH]C[C]([O])C[O](28105)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]=[C]CC[C]([O])[CH][O](25998)'],
    products = ['C=[C]C[CH][C]([O])[CH][O](27631)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]=[C]CC[C]([O])[CH][O](25998)'],
    products = ['[CH]=[C]C[CH][C]([O])[CH]O(28264)'],
...
network(
    label = 'PDepNetwork #6704',
    isomers = [
        '[CH]=[C]CC[C]([O])[CH][O](25998)',
    ],
    reactants = [
