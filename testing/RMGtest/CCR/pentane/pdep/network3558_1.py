...
species(
    label = '[CH]C(C)C[C]=C(15617)',
    structure = SMILES('[CH]C(C)C[C]=C'),
    E0 = (612.933,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02505,0.0578556,-4.02405e-05,1.44752e-08,-2.12467e-12,73832.1,26.4559], Tmin=(100,'K'), Tmax=(1583.26,'K')), NASAPolynomial(coeffs=[13.648,0.0259646,-1.00267e-05,1.75303e-09,-1.15826e-13,69835,-40.2429], Tmin=(1583.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(612.933,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'C=[C]CC(C)[C]C(15799)',
    structure = SMILES('C=[C]CC(C)[C]C'),
    E0 = (592.5,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2950,3100,1380,975,1025,1650,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.480922,0.0715565,-5.08012e-05,1.88505e-08,-2.88714e-12,71392.5,29.5465], Tmin=(100,'K'), Tmax=(1503.75,'K')), NASAPolynomial(coeffs=[14.387,0.0345661,-1.3903e-05,2.49215e-09,-1.67551e-13,67210.3,-43.2155], Tmin=(1503.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(592.5,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['CHCH3(T)(21)', 'C=[C]C[CH]C(2446)'],
    products = ['C=[C]CC(C)[CH]C(15499)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H2CC(T)(1341)', '[CH2]C(C)[CH]C(114)'],
    products = ['C=[C]CC(C)[CH]C(15499)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', '[CH]C(C)C[C]=C(15617)'],
    products = ['C=[C]CC(C)[CH]C(15499)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'C=[C]CC(C)[C]C(15799)'],
    products = ['C=[C]CC(C)[CH]C(15499)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'C=[C]CC(C)=CC(15802)'],
    products = ['C=[C]CC(C)[CH]C(15499)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C=C=CC(C)[CH]C(15803)'],
    products = ['C=[C]CC(C)[CH]C(15499)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'C=[C]CC(C)C=C(15528)'],
    products = ['C=[C]CC(C)[CH]C(15499)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', 'C#CCC(C)[CH]C(15529)'],
    products = ['C=[C]CC(C)[CH]C(15499)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH3(17)', 'C=[C]CC=CC(15643)'],
    products = ['C=[C]CC(C)[CH]C(15499)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH3(17)', 'C=[C]C[CH][CH]C(4308)'],
    products = ['C=[C]CC(C)[CH]C(15499)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', 'C=[C]C[C](C)[CH]C(15804)'],
    products = ['C=[C]CC(C)[CH]C(15499)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C=[C][CH]C(C)[CH]C(15805)'],
    products = ['C=[C]CC(C)[CH]C(15499)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2][CH]C(C)C[C]=C(15531)'],
    products = ['C=[C]CC(C)[CH]C(15499)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH]=[C]CC(C)[CH]C(15806)'],
    products = ['C=[C]CC(C)[CH]C(15499)'],
