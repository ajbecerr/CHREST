...
species(
    label = '[CH2]C(C)C[O](3237)',
    structure = SMILES('[CH2]C(C)C[O]'),
    E0 = (117.614,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1388.77,1388.79],'cm^-1')),
        HinderedRotor(inertia=(0.222179,'amu*angstrom^2'), symmetry=1, barrier=(5.10833,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.222253,'amu*angstrom^2'), symmetry=1, barrier=(5.11003,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.222295,'amu*angstrom^2'), symmetry=1, barrier=(5.11099,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.82323,0.0316164,2.62371e-05,-1.07545e-07,9.11679e-11,14182.1,19.0535], Tmin=(100,'K'), Tmax=(429.108,'K')), NASAPolynomial(coeffs=[3.40129,0.0347935,-1.48107e-05,2.74613e-09,-1.89509e-13,14053.6,15.8349], Tmin=(429.108,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(117.614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0641,0.0553477,-2.40879e-05,-5.338e-09,5.2291e-12,-27354.6,24.6419], Tmin=(100,'K'), Tmax=(1062.37,'K')), NASAPolynomial(coeffs=[12.7116,0.0288994,-1.13214e-05,2.07331e-09,-1.44242e-13,-30811.7,-36.8783], Tmin=(1062.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-228.383,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CC(=O)C(C)C(3241)',
...
species(
    ...
    E0 = (1.97728,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,2950,3100,1380,975,1025,1650,227.029,4000],'cm^-1')),
        HinderedRotor(inertia=(0.524533,'amu*angstrom^2'), symmetry=1, barrier=(19.1879,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.524281,'amu*angstrom^2'), symmetry=1, barrier=(19.1871,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.524264,'amu*angstrom^2'), symmetry=1, barrier=(19.1875,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    ...
    E0 = (-77.224,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,375,552.5,462.5,1710,3000,3100,440,815,1455,1000,294.901],'cm^-1')),
        HinderedRotor(inertia=(0.138843,'amu*angstrom^2'), symmetry=1, barrier=(8.56769,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138842,'amu*angstrom^2'), symmetry=1, barrier=(8.56764,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00265278,'amu*angstrom^2'), symmetry=1, barrier=(21.3876,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138832,'amu*angstrom^2'), symmetry=1, barrier=(8.5677,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    ...
    E0 = (241.768,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3000,3100,440,815,1455,1000,180,3036.79],'cm^-1')),
        HinderedRotor(inertia=(0.00316599,'amu*angstrom^2'), symmetry=1, barrier=(20.7167,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.411846,'amu*angstrom^2'), symmetry=1, barrier=(81.8028,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.55717,'amu*angstrom^2'), symmetry=1, barrier=(81.7864,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0201796,'amu*angstrom^2'), symmetry=1, barrier=(20.7126,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    ...
    E0 = (265.822,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3000,3100,440,815,1455,1000,426.053,2876.29],'cm^-1')),
        HinderedRotor(inertia=(0.0671975,'amu*angstrom^2'), symmetry=1, barrier=(8.61289,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0668418,'amu*angstrom^2'), symmetry=1, barrier=(8.60902,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0670905,'amu*angstrom^2'), symmetry=1, barrier=(8.60629,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.58964,'amu*angstrom^2'), symmetry=1, barrier=(75.9671,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32201,0.0483332,-3.40154e-06,-2.49394e-08,1.15854e-11,4517.8,22.8505], Tmin=(100,'K'), Tmax=(1035.26,'K')), NASAPolynomial(coeffs=[11.5781,0.0316462,-1.24619e-05,2.29939e-09,-1.6123e-13,1164.97,-32.9216], Tmin=(1035.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(36.6857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2]C(C)[C](C)O(3243)',
    structure = SMILES('[CH2]C(C)[C](C)O'),
    E0 = (35.4612,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.951837,0.067019,-6.18571e-05,3.36918e-08,-7.71352e-12,4374.78,26.0765], Tmin=(100,'K'), Tmax=(1038.3,'K')), NASAPolynomial(coeffs=[9.73779,0.0331719,-1.29598e-05,2.29645e-09,-1.54287e-13,2550.27,-16.641], Tmin=(1038.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(35.4612,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(Isobutyl)"""),
)

species(
    label = 'C[C]([O])C(C)C(3244)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07848,0.0615926,-4.43772e-05,1.71997e-08,-2.79947e-12,7412.4,22.9509], Tmin=(100,'K'), Tmax=(1404.39,'K')), NASAPolynomial(coeffs=[11.3426,0.0323588,-1.31538e-05,2.37817e-09,-1.61103e-13,4529.36,-30.0537], Tmin=(1404.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.7396,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2][C](C)C(C)O(3245)',
    structure = SMILES('[CH2][C](C)C(C)O'),
    E0 = (11.4073,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18599,0.0539412,-2.17204e-05,-7.2854e-09,6.21415e-12,1480.24,26.0034], Tmin=(100,'K'), Tmax=(1004.78,'K')), NASAPolynomial(coeffs=[11.2247,0.0304067,-1.11129e-05,1.94955e-09,-1.32457e-13,-1366.43,-26.6022], Tmin=(1004.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.4073,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)C([CH2])O(3246)',
    structure = SMILES('[CH2]C(C)C([CH2])O'),
    E0 = (70.4224,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.657609,0.0669866,-5.68928e-05,2.66214e-08,-5.06361e-12,8595.66,28.3394], Tmin=(100,'K'), Tmax=(1261.42,'K')), NASAPolynomial(coeffs=[13.2154,0.0271652,-9.53947e-06,1.59479e-09,-1.03579e-13,5427.54,-35.1612], Tmin=(1261.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(70.4224,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CJCO)"""),
)

species(
    label = '[CH2]C([CH2])C(C)O(3247)',
    structure = SMILES('[CH2]C([CH2])C(C)O'),
    E0 = (63.9157,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1955.73],'cm^-1')),
        HinderedRotor(inertia=(0.00212292,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144683,'amu*angstrom^2'), symmetry=1, barrier=(8.13554,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00212382,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.144512,'amu*angstrom^2'), symmetry=1, barrier=(8.13554,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.24447,'amu*angstrom^2'), symmetry=1, barrier=(69.9698,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.991269,0.0615608,-4.29687e-05,1.13993e-08,1.08855e-12,7799.82,27.5969], Tmin=(100,'K'), Tmax=(921.726,'K')), NASAPolynomial(coeffs=[11.2322,0.0291641,-9.8499e-06,1.62362e-09,-1.05642e-13,5400.26,-23.7508], Tmin=(921.726,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.9157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([O])C(C)C(3248)',
    structure = SMILES('[CH2]C([O])C(C)C'),
    E0 = (95.7009,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3100,440,815,1455,1000,401.311,424.563],'cm^-1')),
        HinderedRotor(inertia=(0.101616,'amu*angstrom^2'), symmetry=1, barrier=(2.39073,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0201006,'amu*angstrom^2'), symmetry=1, barrier=(2.36681,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120444,'amu*angstrom^2'), symmetry=1, barrier=(13.7866,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118889,'amu*angstrom^2'), symmetry=1, barrier=(13.789,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.851396,0.0607026,-3.625e-05,6.03753e-09,1.51289e-12,11630.7,24.9792], Tmin=(100,'K'), Tmax=(1093.29,'K')), NASAPolynomial(coeffs=[13.1698,0.0290597,-1.12569e-05,2.03011e-09,-1.39345e-13,8134.8,-39.2186], Tmin=(1093.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.7009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]CC(C)[O](3123)'],
    products = ['[CH2]C(C)C(C)[O](3130)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', '[CH2]C(C)C[O](3237)'],
    products = ['[CH2]C(C)C(C)[O](3130)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(143764,'m^3/(mol*s)'), n=0.444, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [carbene;R_H]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]C(C)C(C)[O](3239)'],
    products = ['[CH2]C(C)C(C)[O](3130)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'C=C(C)C(C)[O](1644)'],
    products = ['[CH2]C(C)C(C)[O](3130)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2]C(C)C(C)=O(1642)'],
    products = ['[CH2]C(C)C(C)[O](3130)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(17)', 'C=CC(C)[O](1578)'],
    products = ['[CH2]C(C)C(C)[O](3130)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(17)', '[CH2]C(C)C=O(1648)'],
    products = ['[CH2]C(C)C(C)[O](3130)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(17)', '[CH2][CH]C(C)[O](1587)'],
    products = ['[CH2]C(C)C(C)[O](3130)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH2][C](C)C(C)[O](1656)'],
    products = ['[CH2]C(C)C(C)[O](3130)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH3(17)', '[CH2]C(C)[CH][O](1637)'],
    products = ['[CH2]C(C)C(C)[O](3130)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2]C(C)[C](C)[O](1653)'],
    products = ['[CH2]C(C)C(C)[O](3130)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH2]C([CH2])C(C)[O](1658)'],
    products = ['[CH2]C(C)C(C)[O](3130)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH2]C(C)C([CH2])[O](1419)'],
    products = ['[CH2]C(C)C(C)[O](3130)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2]C([CH2])C(C)O(3247)'],
    products = ['[CH2]C(C)C(C)[O](3130)'],
