...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70778,0.0726083,-3.27849e-05,6.20383e-09,-4.23471e-13,18038.8,31.8172], Tmin=(100,'K'), Tmax=(2765.73,'K')), NASAPolynomial(coeffs=[46.2078,0.0165978,-6.93534e-06,1.06432e-09,-5.75564e-14,-9769.23,-233.912], Tmin=(2765.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH]CC[CH]CC(216)',
    structure = SMILES('CC[CH]CC[CH]CC'),
    E0 = (149.492,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70778,0.0726083,-3.27849e-05,6.20383e-09,-4.23471e-13,18038.8,31.124], Tmin=(100,'K'), Tmax=(2765.73,'K')), NASAPolynomial(coeffs=[46.2078,0.0165978,-6.93534e-06,1.06432e-09,-5.75564e-14,-9769.23,-234.605], Tmin=(2765.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.524189,0.0924576,-6.65086e-05,2.58988e-08,-4.20838e-12,49663.5,36.2302], Tmin=(100,'K'), Tmax=(1420.57,'K')), NASAPolynomial(coeffs=[15.7446,0.0466483,-1.8138e-05,3.19869e-09,-2.13482e-13,45041.3,-47.9688], Tmin=(1420.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(411.525,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(CC)C[CH]CC(355)',
    structure = SMILES('[CH]C(CC)C[CH]CC'),
    E0 = (400.901,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (111.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.364005,0.0837855,-5.27402e-05,1.7782e-08,-2.63346e-12,48344.2,34.9061], Tmin=(100,'K'), Tmax=(1430.77,'K')), NASAPolynomial(coeffs=[10.124,0.0564995,-2.41338e-05,4.45282e-09,-3.04436e-13,45551.3,-15.6764], Tmin=(1430.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(400.901,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCJ2_triplet)"""),
)

species(
    label = 'CCC1CC(CC)C1(356)',
    structure = SMILES('CCC1CC(CC)C1'),
    E0 = (-99.331,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.456322,0.0548005,5.64785e-05,-1.04093e-07,4.13172e-11,-11798.7,28.2305], Tmin=(100,'K'), Tmax=(991.123,'K')), NASAPolynomial(coeffs=[16.1214,0.0478487,-1.81609e-05,3.39392e-09,-2.44081e-13,-17667.6,-61.1471], Tmin=(991.123,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-99.331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane)"""),
)

species(
    label = 'C=C(CC)CCCC(357)',
    structure = SMILES('C=C(CC)CCCC'),
    E0 = (-125.783,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.45751,0.0853301,-4.14921e-05,2.43764e-09,2.82021e-12,-14957.2,34.2486], Tmin=(100,'K'), Tmax=(1183.72,'K')), NASAPolynomial(coeffs=[15.6633,0.0495611,-1.98699e-05,3.61006e-09,-2.46881e-13,-20084.3,-51.7796], Tmin=(1183.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-125.783,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0942055,0.0854548,-5.26204e-05,1.77099e-08,-2.6023e-12,19114,36.8279], Tmin=(100,'K'), Tmax=(1467.62,'K')), NASAPolynomial(coeffs=[10.9189,0.0559521,-2.24669e-05,4.01263e-09,-2.69059e-13,15936.7,-19.5477], Tmin=(1467.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.152297,0.0902486,-7.00325e-05,3.65345e-08,-9.14885e-12,18022.1,35.0506], Tmin=(100,'K'), Tmax=(888.91,'K')), NASAPolynomial(coeffs=[5.63442,0.0655798,-2.84051e-05,5.3148e-09,-3.68584e-13,17047.5,9.24804], Tmin=(888.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CCCC([CH2])CC(373)',
    structure = SMILES('[CH2]CCCC([CH2])CC'),
    E0 = (168.557,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.50909,0.0909303,-5.98095e-05,2.09364e-08,-3.06143e-12,20441.5,38.0622], Tmin=(100,'K'), Tmax=(1553.68,'K')), NASAPolynomial(coeffs=[16.0829,0.0482135,-1.85685e-05,3.24026e-09,-2.13968e-13,15285.8,-49.2953], Tmin=(1553.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(168.557,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CC([CH2])CCCC(376)',
    structure = SMILES('[CH2]CC([CH2])CCCC'),
    E0 = (168.557,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    ...
    products = ['butene1(35)', 'butene1(35)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]C(C)C[CH]CC(205)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(C)CC([CH2])CC(353)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(T)(20)', 'CC[CH]C[CH]CC(274)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]CC(26)', '[CH2]C([CH2])CC(117)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C2H5(14)', '[CH]CC([CH2])CC(223)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2]C(CC)C[C]CC(354)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]C(CC)C[CH]CC(355)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C=C(CC)C[CH]CC(359)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2]C(C=CCC)CC(360)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH2]C(CC)CC=CC(361)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C2H5(14)', 'C=CC[CH]CC(244)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2][CH]CC(37)', 'butene1(35)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH3(17)', '[CH2]C(CC)CC=C(304)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C2H5(14)', '[CH2][CH]C[CH]CC(247)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2][CH]CC(37)', '[CH2][CH]CC(37)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2][C](CC)C[CH]CC(362)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH3(17)', '[CH2]C([CH2])C[CH]CC(287)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH2]C([CH][CH]CC)CC(364)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH3(17)', '[CH2][CH]CC([CH2])CC(309)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', '[CH2]C(CC)C[CH][CH]C(365)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', '[CH2]CC([CH2])C[CH]CC(366)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', '[CH2]C[CH]CC([CH2])CC(367)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2]CC(C)C[CH]CC(375)'],
    products = ['[CH2]C(CC)C[CH]CC(217)'],
...
network(
    ...
    isomers = [
        '[CH2]C(CC)C[CH]CC(217)',
    ],
    reactants = [
        ('butene1(35)', 'butene1(35)'),
    ],
    bathGas = {
        'Ar': 0.333333,
        'Ne': 0.333333,
