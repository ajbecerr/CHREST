...
species(
    label = '[C]=[C]OC([CH])[O](13324)',
    structure = SMILES('[C]=[C]OC([CH])[O]'),
    E0 = (1086.03,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52746,0.0588579,-9.18845e-05,7.19022e-08,-2.17741e-11,130704,26.0987], Tmin=(100,'K'), Tmax=(702.249,'K')), NASAPolynomial(coeffs=[10.0925,0.0147647,-7.72553e-06,1.52357e-09,-1.07091e-13,129385,-13.0189], Tmin=(702.249,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1086.03,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCJ2_triplet) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=[CH](9646)', '[CH]C([O])[O](6931)'],
    products = ['[CH]C([O])O[C]=[CH](7115)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[C]=[C]OC([CH])[O](13324)'],
    products = ['[CH]C([O])O[C]=[CH](7115)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH](6993)', 'C#CO[CH][O](6783)'],
    products = ['[CH]C([O])O[C]=[CH](7115)'],
    transitionState = 'TS8',
