...
reaction(
    label = 'reaction3',
    reactants = ['[O]C[C]=O(2320)', '[CH][CH2](502)'],
    products = ['[CH2][CH]OC[C]=O(2325)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(2355)', '[CH2][CH]O[CH2](1565)'],
    products = ['[CH2][CH]OC[C]=O(2325)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH][CH]OC[C]=O(2795)'],
    products = ['[CH2][CH]OC[C]=O(2325)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['CO(2039)', '[CH2][CH]O[CH2](1565)'],
    products = ['[CH2][CH]OC[C]=O(2325)'],
    transitionState = 'TS9',
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.41198,'m^3/(mol*s)'), n=2.03228, Ea=(39.2913,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 37.1 to 39.3 kJ/mol to match endothermicity of reaction."""),
)
