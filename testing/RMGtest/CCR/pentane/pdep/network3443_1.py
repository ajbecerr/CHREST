...
species(
    label = 'C=C1C=CO1(15121)',
    structure = SMILES('C=C1C=CO1'),
    E0 = (97.253,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.5685,0.0141055,5.5842e-05,-9.16716e-08,3.87605e-11,11764.5,11.7634], Tmin=(100,'K'), Tmax=(926.063,'K')), NASAPolynomial(coeffs=[15.4918,0.0030119,1.36412e-06,-2.99319e-10,1.41766e-14,7453.02,-59.9466], Tmin=(926.063,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclobutene)"""),
)
...
species(
    ...
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32507,0.0216646,4.20988e-05,-7.62609e-08,3.26822e-11,43245.3,14.3993], Tmin=(100,'K'), Tmax=(928.878,'K')), NASAPolynomial(coeffs=[14.0282,0.0100785,-1.86471e-06,2.73729e-10,-2.28862e-14,39396.8,-50.2107], Tmin=(928.878,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(358.944,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(methyleneoxirane) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[O][C]1C=CC1(15124)',
    structure = SMILES('[O]C1=C[CH]C1'),
    E0 = (232.257,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.95502,0.00615156,6.959e-05,-9.95386e-08,3.99684e-11,27987.2,13.5029], Tmin=(100,'K'), Tmax=(932.565,'K')), NASAPolynomial(coeffs=[12.8992,0.00658583,-4.12762e-07,4.83977e-11,-1.02205e-14,24258.9,-43.823], Tmin=(932.565,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(232.257,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(C=C(C)OJ) + radical(cyclobutene-allyl)"""),
)

species(
    label = '[CH2]C1([O])C=C1(15125)',
    structure = SMILES('[CH2]C1([O])C=C1'),
    E0 = (486.481,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11019,0.0341493,-1.43655e-05,-7.55847e-09,5.51488e-12,58584.6,15.7485], Tmin=(100,'K'), Tmax=(1032.68,'K')), NASAPolynomial(coeffs=[11.7484,0.0123041,-5.13094e-06,1.00288e-09,-7.35288e-14,55768.1,-35.0588], Tmin=(1032.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(486.481,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsOs) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CC(C)2OJ) + radical(CJC(C)2O)"""),
)
...
species(
    ...
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.975313,0.0521159,-5.9084e-05,3.16215e-08,-6.13984e-12,29652.6,20.2511], Tmin=(100,'K'), Tmax=(1523.02,'K')), NASAPolynomial(coeffs=[14.951,0.00272981,2.04471e-06,-6.02972e-10,4.70924e-14,26866.3,-48.2249], Tmin=(1523.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(245.537,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C(O)CJ) + radical(C=C=CJ)"""),
)

species(
    label = '[CH]=CC(=[CH])O(15127)',
    structure = SMILES('[CH]=CC(=[CH])O'),
    E0 = (374.221,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.810516,0.0546965,-6.18879e-05,3.21342e-08,-6.07293e-12,45136.5,19.4951], Tmin=(100,'K'), Tmax=(1538.44,'K')), NASAPolynomial(coeffs=[17.0577,0.00075528,2.11114e-06,-5.41579e-10,4.01183e-14,41521.8,-61.3877], Tmin=(1538.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.221,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(Cds_P)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.181912,'amu*angstrom^2'), symmetry=1, barrier=(15.5173,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182363,'amu*angstrom^2'), symmetry=1, barrier=(15.5159,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.4387,0.0274413,-4.68116e-06,-1.14203e-08,5.23462e-12,37817.6,18.4997], Tmin=(100,'K'), Tmax=(1137.06,'K')), NASAPolynomial(coeffs=[10.2747,0.014622,-7.2231e-06,1.47541e-09,-1.0834e-13,35082.3,-24.5027], Tmin=(1137.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(313.918,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCCJ=O) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.30208,0.00277524,6.24728e-05,-7.44247e-08,2.52092e-11,4731.47,11.7869], Tmin=(100,'K'), Tmax=(1059.04,'K')), NASAPolynomial(coeffs=[8.0729,0.0194011,-1.01464e-05,2.17941e-09,-1.66243e-13,1778.13,-20.6759], Tmin=(1059.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(39.0414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-O2d(Cds-Cds)Cs) + group(Cd-Cd(CO)H) + ring(Cyclobutene)"""),
)

species(
    label = '[CH2][C]1C=CO1(15129)',
    structure = SMILES('C=C1[CH][CH]O1'),
    E0 = (255.607,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88259,0.0268496,4.16585e-05,-9.45963e-08,4.51417e-11,30837.3,10.5783], Tmin=(100,'K'), Tmax=(890.826,'K')), NASAPolynomial(coeffs=[21.2498,-0.00654068,7.67499e-06,-1.65589e-09,1.13669e-13,25261,-92.5493], Tmin=(890.826,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(255.607,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(C=CCJCO) + radical(CCsJOC(O))"""),
)

species(
    label = '[CH]=[C]C(C)=O(15130)',
    ...
    molecularWeight = (68.074,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84954,0.0420336,-4.38889e-05,2.41059e-08,-5.09749e-12,27074.1,17.9251], Tmin=(100,'K'), Tmax=(1285.22,'K')), NASAPolynomial(coeffs=[10.8248,0.0102892,-2.39199e-06,2.73677e-10,-1.29164e-14,25081.8,-26.403], Tmin=(1285.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(224.425,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C(C)OJ) + radical(C=C=CJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(4)', '[CH]=C[C]=C(13645)'],
    products = ['[CH]=CC(=C)[O](15045)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction10',
    reactants = ['C2H2(T)(1343)', 'ketene(1375)'],
    products = ['[CH]=CC(=C)[O](15045)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C2H2(1342)', '[CH2][C]=O(1376)'],
    products = ['[CH]=CC(=C)[O](15045)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C2H2(T)(1343)', '[CH2][C]=O(1376)'],
    products = ['[CH]=CC(=C)[O](15045)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH2(T)(20)', '[CH]=C[C]=O(15128)'],
    products = ['[CH]=CC(=C)[O](15045)'],
