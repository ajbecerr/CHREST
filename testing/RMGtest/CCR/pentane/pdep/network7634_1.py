...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.43302,'amu*angstrom^2'), symmetry=1, barrier=(55.94,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.885579,'amu*angstrom^2'), symmetry=1, barrier=(20.3612,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.42714,'amu*angstrom^2'), symmetry=1, barrier=(55.8048,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0547,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08116,0.0470468,-7.3904e-05,6.57972e-08,-2.30477e-11,63380,16.7548], Tmin=(100,'K'), Tmax=(839.886,'K')), NASAPolynomial(coeffs=[5.7466,0.0203745,-9.81023e-06,1.85831e-09,-1.27133e-13,63089.4,1.64567], Tmin=(839.886,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(526.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-OsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.22257,'amu*angstrom^2'), symmetry=1, barrier=(28.1093,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.360918,'amu*angstrom^2'), symmetry=1, barrier=(8.29821,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97815,0.0542819,-0.00010049,1.02243e-07,-3.89926e-11,41404.8,17.3205], Tmin=(100,'K'), Tmax=(846.808,'K')), NASAPolynomial(coeffs=[2.44406,0.0290766,-1.50929e-05,2.93155e-09,-2.02357e-13,42150.7,20.0203], Tmin=(846.808,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(343.732,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#COOC(3499)'],
    products = ['CH2O(3111)', 'ketene(1375)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(9.89742e+17,'s^-1'), n=-1.73308, Ea=(50.321,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.16692063000437535, var=8.814681701569807, Tref=1000.0, N=65, correlation='Root',), comment="""BM rule fitted to 2 training reactions at node Root
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'C#COO(9570)'],
    products = ['C#COOC(3499)'],
    transitionState = 'TS2',
