...
species(
    label = '[CH][CH]C[CH][CH]C(9499)',
    structure = SMILES('[CH][CH]C[CH][CH]C'),
    E0 = (839.701,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,188.309,622.168,2313.28,2405.82,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.12434,'amu*angstrom^2'), symmetry=1, barrier=(3.14051,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12434,'amu*angstrom^2'), symmetry=1, barrier=(3.14051,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12434,'amu*angstrom^2'), symmetry=1, barrier=(3.14051,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12434,'amu*angstrom^2'), symmetry=1, barrier=(3.14051,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12434,'amu*angstrom^2'), symmetry=1, barrier=(3.14051,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.98478,0.0367396,-1.1871e-05,4.52801e-10,1.84629e-13,100956,22.9699], Tmin=(100,'K'), Tmax=(2686.27,'K')), NASAPolynomial(coeffs=[38.7793,0.00146826,-1.41125e-06,1.48989e-10,-4.07191e-16,76294.6,-190.383], Tmin=(2686.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(839.701,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC) + radical(RCCJC) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C([O])C[C][CH]C(9500)',
    structure = SMILES('[CH]C([O])C[C][CH]C'),
    E0 = (956.902,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.78053,0.0749967,-8.40694e-05,5.57931e-08,-1.55679e-11,115201,31.4729], Tmin=(100,'K'), Tmax=(858.815,'K')), NASAPolynomial(coeffs=[9.13513,0.036085,-1.61074e-05,3.03733e-09,-2.1095e-13,113766,-7.56171], Tmin=(858.815,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(956.902,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJC) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([O])C[CH][C]C(9501)',
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.950191,0.0734445,-7.93595e-05,4.56525e-08,-7.84178e-12,115194,30.7182], Tmin=(100,'K'), Tmax=(630.284,'K')), NASAPolynomial(coeffs=[7.94757,0.038233,-1.74464e-05,3.31492e-09,-2.30847e-13,114129,-1.25928], Tmin=(630.284,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(956.914,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJCC) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.35563,0.0752292,-6.5161e-05,2.93999e-08,-5.36849e-12,38181.4,27.7723], Tmin=(100,'K'), Tmax=(1303.44,'K')), NASAPolynomial(coeffs=[15.4157,0.0290123,-1.1974e-05,2.19623e-09,-1.50759e-13,34255.5,-48.8746], Tmin=(1303.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(316.334,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CCJCO) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][C]([O])C[CH][CH]C(9504)',
    structure = SMILES('[CH][C]([O])C[CH][CH]C'),
    E0 = (879.773,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,360,370,350,211.473,1082.75,1148.32,1270.29,1400.04,1735.6,1870.3],'cm^-1')),
        HinderedRotor(inertia=(0.111267,'amu*angstrom^2'), symmetry=1, barrier=(3.18084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111267,'amu*angstrom^2'), symmetry=1, barrier=(3.18084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111267,'amu*angstrom^2'), symmetry=1, barrier=(3.18084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111267,'amu*angstrom^2'), symmetry=1, barrier=(3.18084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111267,'amu*angstrom^2'), symmetry=1, barrier=(3.18084,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.740819,0.0836238,-0.000135251,1.28715e-07,-4.69755e-11,105918,33.6841], Tmin=(100,'K'), Tmax=(864.945,'K')), NASAPolynomial(coeffs=[3.0543,0.0453742,-2.11395e-05,3.93623e-09,-2.6577e-13,106549,28.816], Tmin=(864.945,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(879.773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJCC) + radical(RCCJC) + radical(C2CsJOH) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C([O])[CH]C[CH]C(9505)',
    structure = SMILES('[CH]C([O])[CH]C[CH]C'),
    E0 = (708.589,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.580068,0.0875879,-0.00014102,1.33507e-07,-4.84387e-11,78217.6,34.4532], Tmin=(100,'K'), Tmax=(869.104,'K')), NASAPolynomial(coeffs=[3.13929,0.0471328,-2.17054e-05,4.01895e-09,-2.70357e-13,78855.8,28.6962], Tmin=(869.104,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(649.413,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC) + radical(C2CsJOH) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.954329,0.073315,-9.4103e-05,8.00536e-08,-2.82044e-11,81009.1,36.1837], Tmin=(100,'K'), Tmax=(829.112,'K')), NASAPolynomial(coeffs=[4.91341,0.0430528,-1.91597e-05,3.55646e-09,-2.42375e-13,80736.3,20.139], Tmin=(829.112,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(672.687,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJC) + radical(RCCJCC) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.788173,0.0793811,-0.000113664,1.02518e-07,-3.68336e-11,81655.5,36.0691], Tmin=(100,'K'), Tmax=(849.06,'K')), NASAPolynomial(coeffs=[4.1924,0.0449648,-2.03931e-05,3.78923e-09,-2.57122e-13,81739.9,24.1038], Tmin=(849.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(678.031,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]C([O])C[CH][CH]C(4451)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]C([CH2])[O](6989)', '[CH][CH]C(3874)'],
    products = ['[CH]C([O])C[CH][CH]C(4451)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(4)', '[CH][CH]C[CH][CH]C(9499)'],
    products = ['[CH]C([O])C[CH][CH]C(4451)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', '[CH][CH]CC([CH])[O](7250)'],
    products = ['[CH]C([O])C[CH][CH]C(4451)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C([O])C[C][CH]C(9500)'],
    products = ['[CH]C([O])C[CH][CH]C(4451)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]C([O])C[CH][C]C(9501)'],
    products = ['[CH]C([O])C[CH][CH]C(4451)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]C([O])[CH]C=CC(7217)'],
    products = ['[CH]C([O])C[CH][CH]C(4451)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH](6993)', 'CC=CC[CH][O](1612)'],
    products = ['[CH]C([O])C[CH][CH]C(4451)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(102.361,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH]C([O])[CH][CH][CH]C(9503)'],
    products = ['[CH]C([O])C[CH][CH]C(4451)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH][C]([O])C[CH][CH]C(9504)'],
    products = ['[CH]C([O])C[CH][CH]C(4451)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]C([O])[CH]C[CH]C(9505)'],
    products = ['[CH]C([O])C[CH][CH]C(4451)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]C([O])C[CH][CH]C(4451)'],
    products = ['[CH][C](O)C[CH][CH]C(9506)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]C([O])C[CH]C[CH2](7086)'],
    products = ['[CH]C([O])C[CH][CH]C(4451)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]C([O])C[CH][CH]C(4451)'],
    products = ['[CH]C(O)[CH][CH][CH]C(9508)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]C([O])CC[CH][CH2](9509)'],
    products = ['[CH]C([O])C[CH][CH]C(4451)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]C([O])C[CH][CH]C(4451)'],
    products = ['[CH]C(O)C[CH][CH][CH2](9510)'],
