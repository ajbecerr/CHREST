...
species(
    ...
    E0 = (259.662,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,570.46,570.471,570.487,570.49,2595.54],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (42.0367,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.31417,0.0119135,-5.00134e-07,-9.18335e-09,4.80348e-12,31257.7,8.09654], Tmin=(100,'K'), Tmax=(945.068,'K')), NASAPolynomial(coeffs=[6.90182,0.00459354,-1.36476e-06,2.32146e-10,-1.65654e-14,30228.3,-10.8673], Tmin=(945.068,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(259.662,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), label="""oxirene""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
species(
    ...
    E0 = (273.347,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2782.5,750,1395,475,1775,1000,1775.12,2035.45],'cm^-1')),
        HinderedRotor(inertia=(0.109476,'amu*angstrom^2'), symmetry=1, barrier=(2.85195,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (42.0367,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.66977,0.00698959,2.70385e-06,-4.6667e-09,1.29284e-12,32888.1,9.36101], Tmin=(100,'K'), Tmax=(1428.72,'K')), NASAPolynomial(coeffs=[4.571,0.00902798,-4.2254e-06,8.01332e-10,-5.49989e-14,32165,3.06225], Tmin=(1428.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(273.347,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(103.931,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-OdCsH) + group(CsJ2_singlet-CsH)"""),
)
...
species(
    label = '[C-]1=[O+]C1(28531)',
    structure = SMILES('[C-]1=[O+]C1'),
    E0 = (531.698,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,395.431,395.589,395.689,4000,4000],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (42.0367,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.33875,0.0122035,-6.27004e-06,-3.20771e-10,6.50258e-13,63974.1,-3.68946], Tmin=(100,'K'), Tmax=(1310,'K')), NASAPolynomial(coeffs=[7.44154,0.00436671,-2.66779e-06,5.79427e-10,-4.3176e-14,62496.7,-26.1272], Tmin=(1310,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(531.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsCs) + group(CsJ2_singlet-CsH) + ring(Cyclopropene)"""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]=[C][O](6861)'],
    products = ['[CH2][C]=O(1376)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][C]=O(1376)'],
    products = ['ketene(1375)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction18',
    reactants = ['[C-]1=[O+]C1(28531)'],
    products = ['oxirene(6860)'],
    transitionState = 'TS18',
    kinetics = Arrhenius(A=(1.22929e+15,'s^-1'), n=-1.07844, Ea=(56.8484,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CsJ2-C;singletcarbene;CH]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: Singlet_Carbene_Intra_Disproportionation"""),
)
