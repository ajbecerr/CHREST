...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.242773,'amu*angstrom^2'), symmetry=1, barrier=(5.58184,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (62.0248,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.20139,0.0259573,-5.56224e-05,6.79652e-08,-2.90808e-11,5760.79,12.7813], Tmin=(100,'K'), Tmax=(837.443,'K')), NASAPolynomial(coeffs=[-1.03156,0.0241471,-1.29231e-05,2.56267e-09,-1.79326e-13,7242.21,37.0639], Tmin=(837.443,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(47.7268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(OCOJ) + radical(ROOJ)"""),
)
...
species(
    label = 'CC1OOO1(3716)',
    structure = SMILES('CC1OOO1'),
    E0 = (-21.3786,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.00073,0.00150369,8.94659e-05,-1.19935e-07,4.61435e-11,-2516.69,15.2094], Tmin=(100,'K'), Tmax=(958.904,'K')), NASAPolynomial(coeffs=[13.9468,0.00798869,-2.24911e-06,5.39593e-10,-5.13399e-14,-7013.32,-49.6402], Tmin=(958.904,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-21.3786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Cyclobutane)"""),
)

species(
    label = 'CC1OO1(3717)',
    structure = SMILES('CC1OO1'),
    E0 = (-62.591,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.08172,0.00561644,6.05988e-05,-9.02469e-08,3.77162e-11,-7481.23,11.824], Tmin=(100,'K'), Tmax=(904.332,'K')), NASAPolynomial(coeffs=[12.3303,0.00280439,2.07423e-06,-5.20688e-10,3.41163e-14,-10711.8,-40.4778], Tmin=(904.332,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-62.591,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(dioxirane)"""),
)
...
species(
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.51325,0.0190093,3.61505e-05,-6.37966e-08,2.63944e-11,-53545.8,16.9361], Tmin=(100,'K'), Tmax=(959.884,'K')), NASAPolynomial(coeffs=[12.8818,0.00999265,-3.18907e-06,6.34362e-10,-5.13715e-14,-57111.5,-40.8665], Tmin=(959.884,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-445.754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-O2d)) + group(O2s-OsH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs)"""),
)
...
species(
    ...
    E0 = (236.683,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3025,407.5,1350,352.5,2214.32],'cm^-1')),
        HinderedRotor(inertia=(0.00193595,'amu*angstrom^2'), symmetry=1, barrier=(6.74171,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (61.0168,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.14259,0.0424685,-0.000136811,1.72647e-07,-7.12408e-11,28474.8,12.7768], Tmin=(100,'K'), Tmax=(876.681,'K')), NASAPolynomial(coeffs=[-9.01869,0.0362696,-2.06594e-05,4.05831e-09,-2.77087e-13,32977.6,83.3672], Tmin=(876.681,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(236.683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(OCOJ) + radical(ROOJ) + radical(OCJO)"""),
)
...
species(
    ...
    E0 = (45.6545,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,180],'cm^-1')),
        HinderedRotor(inertia=(0.202977,'amu*angstrom^2'), symmetry=1, barrier=(4.66684,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205614,'amu*angstrom^2'), symmetry=1, barrier=(4.72748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0414709,'amu*angstrom^2'), symmetry=1, barrier=(47.2993,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.16955,0.045631,-6.91015e-05,6.57334e-08,-2.53382e-11,5551.64,19.8556], Tmin=(100,'K'), Tmax=(784.001,'K')), NASAPolynomial(coeffs=[4.05256,0.0263063,-1.35358e-05,2.67397e-09,-1.88618e-13,5555.04,13.134], Tmin=(784.001,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(45.6545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Cs_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[O]CO[O](3715)'],
    products = ['CC([O])O[O](1438)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'acetylperoxy(2257)'],
    products = ['CC([O])O[O](1438)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['formylperoxy(3615)', 'CH3(17)'],
    products = ['CC([O])O[O](1438)'],
...
reaction(
    label = 'reaction11',
    reactants = ['O2(2)', 'CH3CHO(1381)'],
    products = ['CC([O])O[O](1438)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.0849,'cm^3/(mol*s)'), n=3.486, Ea=(178.867,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1600,'K'), comment="""Estimated using template [CO-CsH_O;OJ] for rate rule [CO-CsH_O;O2b]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
...
reaction(
    label = 'reaction13',
    reactants = ['[O][CH]O[O](3719)', 'CH3(17)'],
    products = ['CC([O])O[O](1438)'],
