...
species(
    label = '[C]=C([O])C[CH][CH2](9865)',
    structure = SMILES('[C]C(=O)C[CH][CH2]'),
    E0 = (792.652,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,375,552.5,462.5,1710,3000,3100,440,815,1455,1000,309.362,309.392,1783.53],'cm^-1')),
        HinderedRotor(inertia=(0.0017615,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00176134,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00176146,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86508,0.0494121,-4.94087e-05,2.77385e-08,-6.53997e-12,95408.9,23.6354], Tmin=(100,'K'), Tmax=(1003.56,'K')), NASAPolynomial(coeffs=[8.35027,0.0235632,-1.07725e-05,2.07219e-09,-1.46113e-13,94107.2,-7.6749], Tmin=(1003.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(792.652,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CCJCC=O) + radical(RCCJ) + radical(CJ3)"""),
)

species(
    label = '[CH2][CH]CC1=CO1(9866)',
    structure = SMILES('[CH2][CH]CC1=CO1'),
    E0 = (467.191,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62446,0.0459939,-2.90444e-05,5.05827e-09,1.40637e-12,56281,25.1805], Tmin=(100,'K'), Tmax=(1045.67,'K')), NASAPolynomial(coeffs=[11.2337,0.0201398,-7.59863e-06,1.35792e-09,-9.3168e-14,53675.2,-24.458], Tmin=(1045.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(467.191,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclopropene) + radical(RCCJC) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17419,0.0501352,-1.56165e-05,-2.7789e-08,1.81642e-11,25268.4,21.149], Tmin=(100,'K'), Tmax=(912.557,'K')), NASAPolynomial(coeffs=[17.8093,0.00925459,-1.07832e-06,5.98889e-11,-4.11393e-15,20898.4,-64.8925], Tmin=(912.557,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(209.155,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CC=CCJ) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22915,0.0501257,-1.3784e-05,-2.18848e-08,1.31898e-11,54224.5,24.3684], Tmin=(100,'K'), Tmax=(960.097,'K')), NASAPolynomial(coeffs=[14.6272,0.0200094,-6.88921e-06,1.21163e-09,-8.50242e-14,50467.2,-45.8931], Tmin=(960.097,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(449.938,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(RCCJ) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH][C]1C[CH]CO1(9874)',
    structure = SMILES('[CH][C]1C[CH]CO1'),
    E0 = (593.836,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31048,0.028402,2.36922e-05,-5.4876e-08,2.58835e-11,71491.2,19.6256], Tmin=(100,'K'), Tmax=(861.792,'K')), NASAPolynomial(coeffs=[9.79878,0.0189132,-3.77253e-06,3.92814e-10,-1.93036e-14,69262.2,-20.8313], Tmin=(861.792,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(593.836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CCJCO) + radical(C2CsJOCs) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C1([O])C[CH]C1(9875)',
    structure = SMILES('[CH]C1([O])C[CH]C1'),
    E0 = (664.608,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89131,0.0354304,8.18463e-06,-3.48088e-08,1.53345e-11,80019.5,22.5238], Tmin=(100,'K'), Tmax=(1001.12,'K')), NASAPolynomial(coeffs=[11.9742,0.0207125,-8.07323e-06,1.52932e-09,-1.10735e-13,76719.4,-32.5308], Tmin=(1001.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(664.608,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CC(C)2OJ) + radical(cyclobutane) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C([O])C[CH][CH2](2639)'],
...
reaction(
    label = 'reaction5',
    reactants = ['O(4)', '[CH]=[C]C[CH][CH2](9862)'],
    products = ['[CH]=C([O])C[CH][CH2](2639)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH][CH]CC(=[CH])[O](9864)'],
    products = ['[CH]=C([O])C[CH][CH2](2639)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[C]=C([O])C[CH][CH2](9865)'],
    products = ['[CH]=C([O])C[CH][CH2](2639)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH]=C([O])C=C[CH2](9868)'],
    products = ['[CH]=C([O])C[CH][CH2](2639)'],
...
reaction(
    label = 'reaction15',
    reactants = ['O(4)', 'C#CC[CH][CH2](9869)'],
    products = ['[CH]=C([O])C[CH][CH2](2639)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH]=C([O])[CH][CH][CH2](9870)'],
    products = ['[CH]=C([O])C[CH][CH2](2639)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=C([O])C[CH][CH2](2639)'],
    products = ['[CH]=C(O)[CH][CH][CH2](9872)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]C([O])[CH][CH][CH2](7252)'],
    products = ['[CH]=C([O])C[CH][CH2](2639)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.63856e+09,'s^-1'), n=0.755479, Ea=(147.497,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_cs]
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]=C([O])C[CH][CH2](2639)'],
    products = ['[CH]C1([O])C[CH]C1(9875)'],
    transitionState = 'TS28',
    kinetics = Arrhenius(A=(3.54938e+07,'s^-1'), n=1.23279, Ea=(134.875,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5;multiplebond_intra;radadd_intra_cs2H] for rate rule [R5;carbonylbond_intra;radadd_intra_cs2H]
Euclidian distance = 1.0
family: Intra_R_Add_Exocyclic
Ea raised from 132.6 to 134.9 kJ/mol to match endothermicity of reaction."""),
)

network(
    label = 'PDepNetwork #2322',
    isomers = [
        '[CH]=C([O])C[CH][CH2](2639)',
    ],
    reactants = [
        ('HCCO(2227)', 'allyl(82)'),
    ],
