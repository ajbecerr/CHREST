...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.00563292,'amu*angstrom^2'), symmetry=1, barrier=(3.74214,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (28.0532,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.73432,0.00234883,2.20925e-05,-2.60631e-08,9.04796e-12,42651.2,6.39831], Tmin=(100,'K'), Tmax=(990.224,'K')), NASAPolynomial(coeffs=[3.97022,0.0104689,-3.95153e-06,7.2402e-10,-5.10039e-14,42159.6,3.01647], Tmin=(990.224,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(354.517,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), label="""CHCH3(S)""", comment="""Thermo library: DFT_QCI_thermo"""),
)
