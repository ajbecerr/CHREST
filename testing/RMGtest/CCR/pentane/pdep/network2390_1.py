...
species(
    label = '[C]=C([O])C[CH][O](10196)',
    structure = SMILES('[C]C(=O)C[CH][O]'),
    E0 = (657.459,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,375,552.5,462.5,1710,180,180,180,2198.91],'cm^-1')),
        HinderedRotor(inertia=(0.0764138,'amu*angstrom^2'), symmetry=1, barrier=(1.7569,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0764112,'amu*angstrom^2'), symmetry=1, barrier=(1.75684,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.49785,0.0667321,-0.000129839,1.2804e-07,-4.67854e-11,79153,21.5295], Tmin=(100,'K'), Tmax=(867.949,'K')), NASAPolynomial(coeffs=[4.10655,0.0272448,-1.41312e-05,2.70767e-09,-1.83991e-13,79734.7,15.273], Tmin=(867.949,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(657.459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CCOJ) + radical(CCsJOH) + radical(CJ3)"""),
)

species(
    label = '[O][CH]CC1=CO1(10197)',
    structure = SMILES('[O][CH]CC1=CO1'),
    E0 = (337.454,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72816,0.0520341,-5.96489e-05,3.71064e-08,-9.38632e-12,40666.4,21.163], Tmin=(100,'K'), Tmax=(955.092,'K')), NASAPolynomial(coeffs=[9.43928,0.0197394,-8.92923e-06,1.70342e-09,-1.1943e-13,39193.4,-15.6844], Tmin=(955.092,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(337.454,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclopropene) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = '[CH]=C1CC([O])O1(10198)',
...
species(
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27932,0.0542481,-4.67951e-05,1.99434e-08,-3.38472e-12,4764.44,21.1802], Tmin=(100,'K'), Tmax=(1407.38,'K')), NASAPolynomial(coeffs=[14.163,0.0176308,-7.7683e-06,1.45676e-09,-1.00867e-13,1137.97,-45.3789], Tmin=(1407.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(38.7615,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9141,0.0494654,-5.64561e-05,4.52032e-08,-1.57859e-11,40555.1,23.7435], Tmin=(100,'K'), Tmax=(797.81,'K')), NASAPolynomial(coeffs=[4.55789,0.0316001,-1.41988e-05,2.64912e-09,-1.81656e-13,40279.9,12.5055], Tmin=(797.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(336.598,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(CCOJ) + radical(C=C(C)OJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C(O)[CH][CH][O](10204)',
    structure = SMILES('[CH]C(O)=C[CH][O]'),
    E0 = (316.088,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55866,0.0447089,-1.69766e-05,-1.25082e-08,8.63625e-12,38112.5,24.1139], Tmin=(100,'K'), Tmax=(985.881,'K')), NASAPolynomial(coeffs=[13.1215,0.0178821,-6.72185e-06,1.22371e-09,-8.64722e-14,34856.5,-36.4565], Tmin=(985.881,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(316.088,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(CCOJ) + radical(C=CCJO) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59848,0.0430828,-1.09622e-05,-2.17757e-08,1.30602e-11,27540,24.6106], Tmin=(100,'K'), Tmax=(943.799,'K')), NASAPolynomial(coeffs=[13.8262,0.0152433,-4.83419e-06,8.20864e-10,-5.74683e-14,24163.8,-39.3327], Tmin=(943.799,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(228.188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(C)OJ) + radical(C=CCJO) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08835,0.0430585,-4.70436e-05,3.32032e-08,-9.47544e-12,62807.9,21.2013], Tmin=(100,'K'), Tmax=(1010.02,'K')), NASAPolynomial(coeffs=[5.73724,0.0225289,-7.5269e-06,1.16132e-09,-6.95556e-14,62380.9,5.09605], Tmin=(1010.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(521.65,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CCOJ) + radical(C2CsJOCs) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C]1C[CH]OO1(10207)',
    structure = SMILES('[CH][C]1C[CH]OO1'),
    E0 = (659.832,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2772,0.0445127,-3.62306e-05,1.62505e-08,-2.78443e-12,79470.8,21.8634], Tmin=(100,'K'), Tmax=(1718.05,'K')), NASAPolynomial(coeffs=[9.83486,0.0154923,-2.95154e-06,2.55287e-10,-8.45878e-15,77872.8,-20.1467], Tmin=(1718.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(659.832,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxolane) + radical(C2CsJOOC) + radical(CCsJOOC) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C1([O])C[CH]O1(10209)',
    structure = SMILES('[CH]C1([O])C[CH]O1'),
    E0 = (515.752,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66261,0.037701,1.22657e-05,-6.23826e-08,3.4043e-11,62128,19.3168], Tmin=(100,'K'), Tmax=(858.696,'K')), NASAPolynomial(coeffs=[18.3672,0.000832943,5.14288e-06,-1.32259e-09,9.90371e-14,57749.6,-67.5183], Tmin=(858.696,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(515.752,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsOs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)(O)OJ) + radical(CCsJOCs) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH][O](1548)', '[CH]=C([CH2])[O](9653)'],
    products = ['[CH]=C([O])C[CH][O](2783)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(4)', '[CH]=[C]C[CH][O](10195)'],
    products = ['[CH]=C([O])C[CH][O](2783)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH][C]([O])C[C]=O(7102)'],
    products = ['[CH]=C([O])C[CH][O](2783)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[C]=C([O])C[CH][O](10196)'],
    products = ['[CH]=C([O])C[CH][O](2783)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH]=C([O])C=C[O](9605)'],
    products = ['[CH]=C([O])C[CH][O](2783)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH]=C([O])[CH][CH][O](10202)'],
    products = ['[CH]=C([O])C[CH][O](2783)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=C([O])C[CH][O](2783)'],
    products = ['[CH][C]1C[CH]OO1(10207)'],
    transitionState = 'TS25',
    kinetics = Arrhenius(A=(6.44463e+09,'s^-1'), n=0.470283, Ea=(259.836,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_linear;multiplebond_intra;radadd_intra] for rate rule [R5_linear;carbonyl_intra;radadd_intra_O]
Euclidian distance = 1.4142135623730951
family: Intra_R_Add_Endocyclic
Ea raised from 256.5 to 259.8 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.63856e+09,'s^-1'), n=0.755479, Ea=(162.864,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S;multiplebond_intra;radadd_intra_cs] for rate rule [R4_S_CO;carbonylbond_intra;radadd_intra_cs]
Euclidian distance = 1.4142135623730951
family: Intra_R_Add_Exocyclic
Ea raised from 160.4 to 162.9 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction27',
    reactants = ['[CH]=C([O])C[CH][O](2783)'],
    products = ['[CH]C1([O])C[CH]O1(10209)'],
    transitionState = 'TS27',
    kinetics = Arrhenius(A=(2.724e+10,'s^-1'), n=0.478, Ea=(122.043,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5;multiplebond_intra;radadd_intra_O] for rate rule [R5;carbonylbond_intra;radadd_intra_O]
Euclidian distance = 1.0
family: Intra_R_Add_Exocyclic"""),
)

network(
    label = 'PDepNetwork #2390',
    isomers = [
        '[CH]=C([O])C[CH][O](2783)',
    ],
    reactants = [
