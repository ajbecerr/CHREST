...
species(
    label = 'C[C]CC(C)[O](3259)',
    structure = SMILES('C[C]CC(C)[O]'),
    E0 = (338.021,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,243.854,243.854,243.854,591.084],'cm^-1')),
        HinderedRotor(inertia=(0.00283492,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00283491,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.369473,'amu*angstrom^2'), symmetry=1, barrier=(15.5908,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.513285,'amu*angstrom^2'), symmetry=1, barrier=(21.6594,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.937173,0.0610472,-4.5615e-05,1.77704e-08,-2.82645e-12,40769.9,24.9198], Tmin=(100,'K'), Tmax=(1471.21,'K')), NASAPolynomial(coeffs=[13.5884,0.0266509,-1.05461e-05,1.87936e-09,-1.26144e-13,37047.4,-40.9994], Tmin=(1471.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(338.021,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71358,0.0516611,-2.75844e-05,6.92397e-09,-6.9635e-13,-33833.7,21.4224], Tmin=(100,'K'), Tmax=(2148.93,'K')), NASAPolynomial(coeffs=[13.64,0.0294616,-1.20887e-05,2.11675e-09,-1.37096e-13,-38959.6,-45.239], Tmin=(2148.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-281.974,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs)"""),
)

species(
    label = 'CC=CC(C)O(3261)',
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13113,0.0543074,-2.31751e-05,-4.84064e-09,4.76959e-12,-25479.9,24.9804], Tmin=(100,'K'), Tmax=(1072.04,'K')), NASAPolynomial(coeffs=[12.028,0.0298715,-1.16829e-05,2.12816e-09,-1.47259e-13,-28748.4,-32.6965], Tmin=(1072.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-212.772,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    E0 = (-82.0721,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,375,552.5,462.5,1710,265.546,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00439673,'amu*angstrom^2'), symmetry=1, barrier=(8.38202,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16826,'amu*angstrom^2'), symmetry=1, barrier=(8.38792,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.558564,'amu*angstrom^2'), symmetry=1, barrier=(27.6086,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00240345,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    ...
    E0 = (260.88,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3025,407.5,1350,352.5,236.629,1716.71,1716.71],'cm^-1')),
        HinderedRotor(inertia=(0.00301045,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.194829,'amu*angstrom^2'), symmetry=1, barrier=(7.74172,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.194837,'amu*angstrom^2'), symmetry=1, barrier=(7.74172,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.194836,'amu*angstrom^2'), symmetry=1, barrier=(7.7417,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06027,0.0525804,6.38676e-06,-1.27942e-07,1.27108e-10,3729.98,23.5629], Tmin=(100,'K'), Tmax=(443.48,'K')), NASAPolynomial(coeffs=[5.38673,0.0411843,-1.80034e-05,3.33091e-09,-2.27189e-13,3251.96,8.15648], Tmin=(443.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.5194,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(RCCJC)"""),
)
...
species(
    label = '[CH2]CCC(C)[O](3263)',
    structure = SMILES('[CH2]CCC(C)[O]'),
    E0 = (95.0525,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,232.986,1583.71,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00310475,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.66269,'amu*angstrom^2'), symmetry=1, barrier=(25.5378,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289589,'amu*angstrom^2'), symmetry=1, barrier=(11.1579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.662942,'amu*angstrom^2'), symmetry=1, barrier=(25.538,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.923873,0.0597865,-3.9592e-05,1.34153e-08,-1.85514e-12,11549.4,26.8592], Tmin=(100,'K'), Tmax=(1665.47,'K')), NASAPolynomial(coeffs=[14.2458,0.0277912,-1.07757e-05,1.88057e-09,-1.23702e-13,7111.88,-44.2069], Tmin=(1665.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.0525,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJ)"""),
)

species(
    label = 'C[CH][CH]C(C)O(3264)',
    structure = SMILES('C[CH][CH]C(C)O'),
    E0 = (53.7937,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4691,0.0541963,-3.37392e-05,1.12376e-08,-1.60159e-12,6561.75,28.518], Tmin=(100,'K'), Tmax=(1536.26,'K')), NASAPolynomial(coeffs=[9.50793,0.0332653,-1.33022e-05,2.36877e-09,-1.58337e-13,4091.82,-13.7161], Tmin=(1536.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(53.7937,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C(O)C[CH]C(3265)',
    structure = SMILES('[CH2]C(O)C[CH]C'),
    E0 = (65.4807,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28958,0.0624582,-5.40639e-05,2.90171e-08,-6.90277e-12,7970.7,27.3141], Tmin=(100,'K'), Tmax=(971.46,'K')), NASAPolynomial(coeffs=[7.25317,0.0379032,-1.61496e-05,2.99842e-09,-2.07048e-13,6812.01,-1.28411], Tmin=(971.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.4807,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(CJCO)"""),
)

species(
    label = 'CCC[C](C)[O](3266)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25614,0.0618806,-4.67645e-05,1.98709e-08,-3.66544e-12,8087.51,23.2873], Tmin=(100,'K'), Tmax=(1224.01,'K')), NASAPolynomial(coeffs=[9.03264,0.0364674,-1.56213e-05,2.90855e-09,-2.00948e-13,6183.8,-15.8017], Tmin=(1224.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(66.4339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C([O])CCC(1393)',
    structure = SMILES('[CH2]C([O])CCC'),
    E0 = (101.395,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,570.038,574.611],'cm^-1')),
        HinderedRotor(inertia=(0.0423539,'amu*angstrom^2'), symmetry=1, barrier=(9.73161,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0415483,'amu*angstrom^2'), symmetry=1, barrier=(9.74174,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154162,'amu*angstrom^2'), symmetry=1, barrier=(3.5445,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.042397,'amu*angstrom^2'), symmetry=1, barrier=(9.74157,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53095,0.0574175,-4.28238e-05,1.96922e-08,-4.17473e-12,7198.92,27.5987], Tmin=(100,'K'), Tmax=(1045.41,'K')), NASAPolynomial(coeffs=[6.25657,0.0393355,-1.68781e-05,3.14578e-09,-2.17679e-13,6210.91,4.59058], Tmin=(1045.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJC) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', '[CH]CC(C)[O](3219)'],
    products = ['C[CH]CC(C)[O](3128)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'C[CH]CC(C)=O(1674)'],
    products = ['C[CH]CC(C)[O](3128)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(17)', 'C[CH]CC=O(1680)'],
    products = ['C[CH]CC(C)[O](3128)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(17)', 'C[CH]C[CH][O](1560)'],
    products = ['C[CH]CC(C)[O](3128)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', 'C[CH]C[C](C)[O](1684)'],
    products = ['C[CH]CC(C)[O](3128)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', 'C[CH][CH]C(C)[O](1688)'],
    products = ['C[CH]CC(C)[O](3128)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2]C([O])C[CH]C(1417)'],
    products = ['C[CH]CC(C)[O](3128)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH2][CH]CC(C)[O](1690)'],
    products = ['C[CH]CC(C)[O](3128)'],
