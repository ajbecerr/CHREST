...
species(
    label = '[C]=[C]OO[C]=C(9935)',
    structure = SMILES('[C]=[C]OO[C]=C'),
    E0 = (1100.74,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2950,3100,1380,975,1025,1650,1670,1700,300,440,180],'cm^-1')),
        HinderedRotor(inertia=(0.132563,'amu*angstrom^2'), symmetry=1, barrier=(3.04788,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130874,'amu*angstrom^2'), symmetry=1, barrier=(3.00905,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.691353,'amu*angstrom^2'), symmetry=1, barrier=(15.8956,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.0575,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89542,0.0542989,-9.99521e-05,9.60075e-08,-3.48862e-11,132456,28.2166], Tmin=(100,'K'), Tmax=(850.483,'K')), NASAPolynomial(coeffs=[5.08212,0.0216903,-1.13623e-05,2.20381e-09,-1.5161e-13,132551,17.1053], Tmin=(850.483,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1100.74,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=[C]O[O](9590)', 'H2CC(T)(1341)'],
    products = ['[CH]=[C]OO[C]=C(2665)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=[CH](9646)', 'C=[C]O[O](1354)'],
    products = ['[CH]=[C]OO[C]=C(2665)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(15399.6,'m^3/(mol*s)'), n=0.932885, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
