species(
    label = 'C=C([CH]O[O])C[CH]CC(19712)',
    structure = SMILES('C=C([CH]O[O])C[CH]CC'),
    E0 = (278.99,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3050,390,425,1340,1360,335,370,2950,3100,1380,975,1025,1650,200,800,1200,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.340432,0.0833096,-6.43702e-05,2.77576e-08,-5.18996e-12,33684,36.8974], Tmin=(100,'K'), Tmax=(1208.91,'K')), NASAPolynomial(coeffs=[10.8313,0.0485981,-2.13011e-05,4.00688e-09,-2.78427e-13,31147.4,-15.7055], Tmin=(1208.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(278.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(RCCJCC) + radical(C=CCJO)"""),
)
...
species(
    label = '[CH2]C(C)CC(=C)[CH]O[O](21700)',
    structure = SMILES('[CH2]C(C)CC(=C)[CH]O[O]'),
    E0 = (280.573,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.678613,0.0912501,-7.46089e-05,3.21477e-08,-5.58e-12,33923.2,39.5003], Tmin=(100,'K'), Tmax=(1378.45,'K')), NASAPolynomial(coeffs=[18.951,0.0342889,-1.2625e-05,2.17018e-09,-1.43181e-13,28511.5,-61.5013], Tmin=(1378.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(280.573,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(Isobutyl) + radical(C=CCJO)"""),
)
...
species(
    label = 'C=[C]C(C[CH]CC)O[O](20952)',
    structure = SMILES('C=[C]C(C[CH]CC)O[O]'),
    E0 = (395.141,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.573082,0.0864223,-6.42579e-05,-9.0799e-09,3.57507e-11,47637.1,37.0706], Tmin=(100,'K'), Tmax=(531.04,'K')), NASAPolynomial(coeffs=[7.09488,0.0549837,-2.54118e-05,4.86862e-09,-3.40874e-13,46695,7.38645], Tmin=(531.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(395.141,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(RCCJCC) + radical(Cds_S)"""),
)
...
species(
    label = 'C=C([CH][O])C[CH]CC(21701)',
    structure = SMILES('[CH2]C(=C[O])C[CH]CC'),
    E0 = (175.49,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0890557,0.0792955,-5.30052e-05,1.36273e-08,1.93236e-13,21262.8,34.118], Tmin=(100,'K'), Tmax=(1098.46,'K')), NASAPolynomial(coeffs=[16.3313,0.0349256,-1.34786e-05,2.42138e-09,-1.65768e-13,16724.8,-50.8785], Tmin=(1098.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(175.49,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(RCCJCC) + radical(Allyl_P)"""),
)
...
species(
    label = 'C=C([CH]O[O])C[C]CC(21702)',
    structure = SMILES('C=C([CH]O[O])C[C]CC'),
    E0 = (532.747,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.417421,0.0911937,-7.83794e-05,3.50507e-08,-6.34888e-12,64238.5,36.9597], Tmin=(100,'K'), Tmax=(1312.14,'K')), NASAPolynomial(coeffs=[17.8519,0.0355001,-1.47118e-05,2.70261e-09,-1.85619e-13,59444.1,-56.1424], Tmin=(1312.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(532.747,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(C=CCJO) + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'C=C(C[CH]CC)C1OO1(21704)',
    structure = SMILES('C=C(C[CH]CC)C1OO1'),
    E0 = (125.474,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.374087,0.0842395,-6.29063e-05,2.50571e-08,-4.06626e-12,15258.4,37.0124], Tmin=(100,'K'), Tmax=(1457.06,'K')), NASAPolynomial(coeffs=[17.311,0.0356893,-1.29252e-05,2.18861e-09,-1.42502e-13,10104.8,-54.965], Tmin=(1457.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(dioxirane) + radical(RCCJCC)"""),
)

species(
    label = 'C=C1CC(CC)C1O[O](21581)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0909136,0.0724316,-2.52353e-05,-1.35722e-08,8.67067e-12,13396,31.9135], Tmin=(100,'K'), Tmax=(1088.08,'K')), NASAPolynomial(coeffs=[15.9943,0.0400334,-1.65062e-05,3.09649e-09,-2.17884e-13,8392.14,-53.2442], Tmin=(1088.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(110.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane) + radical(ROOJ)"""),
)

species(
    label = 'C=C(C=CCC)CO[O](19701)',
    structure = SMILES('C=C(C=CCC)CO[O]'),
    E0 = (68.0334,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.286244,0.0907062,-7.7119e-05,3.52999e-08,-6.64727e-12,8339.71,33.9745], Tmin=(100,'K'), Tmax=(1253.98,'K')), NASAPolynomial(coeffs=[15.6438,0.0398908,-1.63328e-05,2.98274e-09,-2.04226e-13,4344.61,-46.4837], Tmin=(1253.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(68.0334,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(ROOJ)"""),
)
...
species(
    label = '[CH2]C([CH][CH]CC)[CH]O[O](21705)',
    structure = SMILES('[CH2]C([CH][CH]CC)[CH]O[O]'),
    E0 = (625.008,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,3000,3100,440,815,1455,1000,180,400,1155.79,3200],'cm^-1')),
        HinderedRotor(inertia=(0.0397628,'amu*angstrom^2'), symmetry=1, barrier=(3.6569,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0397628,'amu*angstrom^2'), symmetry=1, barrier=(3.6569,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0397628,'amu*angstrom^2'), symmetry=1, barrier=(3.6569,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0397628,'amu*angstrom^2'), symmetry=1, barrier=(3.6569,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0397628,'amu*angstrom^2'), symmetry=1, barrier=(3.6569,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.307722,0.107338,-0.000158968,1.4524e-07,-5.22896e-11,75314.1,42.7941], Tmin=(100,'K'), Tmax=(854.54,'K')), NASAPolynomial(coeffs=[4.07113,0.0595486,-2.71757e-05,5.04856e-09,-3.41943e-13,75562.2,28.1876], Tmin=(854.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(625.008,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(RCCJCC) + radical(CCsJOOH) + radical(Isobutyl)"""),
)

species(
    label = 'CC[CH]C[C]1CC1O[O](21706)',
    structure = SMILES('CC[CH]C[C]1CC1O[O]'),
    E0 = (374.318,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.289105,0.0714599,-4.07789e-05,1.12539e-08,-1.24286e-12,45162.6,40.2678], Tmin=(100,'K'), Tmax=(2057.79,'K')), NASAPolynomial(coeffs=[20.1458,0.0328619,-1.26434e-05,2.13884e-09,-1.3548e-13,36990.3,-69.8588], Tmin=(2057.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.318,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(ROOJ) + radical(C2CJCOOH) + radical(RCCJCC)"""),
)

species(
    label = 'CCC1C[C]([CH]O[O])C1(21707)',
    structure = SMILES('CCC1C[C]([CH]O[O])C1'),
    E0 = (367.625,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.537798,0.0626523,-4.85294e-06,-2.95279e-08,1.32088e-11,44351.1,36.9961], Tmin=(100,'K'), Tmax=(1072.64,'K')), NASAPolynomial(coeffs=[13.383,0.0433158,-1.77576e-05,3.31919e-09,-2.33135e-13,39952.2,-33.5354], Tmin=(1072.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(367.625,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(ROOJ) + radical(C2CJCOOH) + radical(CCsJOOH)"""),
)

species(
    label = 'CC[CH]C[C]1[CH]OOC1(21708)',
    structure = SMILES('CC[CH]C[C]1[CH]OOC1'),
    E0 = (343.227,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.773357,0.0612639,-5.19173e-06,-3.04641e-08,1.53631e-11,41405.6,36.9343], Tmin=(100,'K'), Tmax=(948.834,'K')), NASAPolynomial(coeffs=[10.2978,0.0444218,-1.5417e-05,2.61231e-09,-1.74002e-13,38548.8,-14.0448], Tmin=(948.834,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(343.227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxolane) + radical(C2CJCOOH) + radical(RCCJCC) + radical(CCsJOOC)"""),
)

species(
    label = '[CH2]C1([CH]O[O])CC1CC(21621)',
    structure = SMILES('[CH2]C1([CH]O[O])CC1CC'),
    E0 = (374.071,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.679051,0.0894866,-6.86709e-05,2.67551e-08,-4.17748e-12,45170,35.5415], Tmin=(100,'K'), Tmax=(1520.55,'K')), NASAPolynomial(coeffs=[20.8426,0.0328709,-1.28203e-05,2.26802e-09,-1.51462e-13,38625.1,-77.3073], Tmin=(1520.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(ROOJ) + radical(CCsJOOH) + radical(Neopentyl)"""),
)

species(
    label = '[CH2]C1(C[CH]CC)[CH]OO1(21709)',
    structure = SMILES('[CH2]C1(C[CH]CC)[CH]OO1'),
    E0 = (430.629,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.523938,0.0877932,-6.24248e-05,-1.62416e-08,4.16577e-11,51906.8,31.1272], Tmin=(100,'K'), Tmax=(528.221,'K')), NASAPolynomial(coeffs=[7.22169,0.0559433,-2.5564e-05,4.86458e-09,-3.39067e-13,50936,0.597399], Tmin=(528.221,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(430.629,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(RCCJCC) + radical(CCsJOO) + radical(CJCOOH)"""),
)
...
species(
    label = 'C=C([CH]O[O])C=CCC(21710)',
    structure = SMILES('C=C([CH]O[O])C=CCC'),
    E0 = (185.329,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.394,0.0833715,-5.02252e-05,1.95175e-09,6.14006e-12,22459.7,34.9589], Tmin=(100,'K'), Tmax=(1017.55,'K')), NASAPolynomial(coeffs=[19.6386,0.0309381,-1.17228e-05,2.14078e-09,-1.50392e-13,17020.5,-68.7295], Tmin=(1017.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(185.329,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(ROOJ) + radical(C=CCJO)"""),
)

species(
    label = 'C=C(C=O)C[CH]CC(21711)',
    structure = SMILES('C=C(C=O)C[CH]CC'),
    E0 = (-0.429797,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,2782.5,750,1395,475,1775,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63359,0.0623274,-1.18224e-06,-9.30867e-08,8.66951e-11,23.0282,28.4409], Tmin=(100,'K'), Tmax=(451.128,'K')), NASAPolynomial(coeffs=[3.39268,0.0586263,-2.84304e-05,5.63285e-09,-4.04489e-13,-256.74,20.0129], Tmin=(451.128,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-0.429797,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cd-CdCs(CO)) + group(Cds-CdsHH) + group(Cds-O2d(Cds-Cds)H) + radical(RCCJCC)"""),
)
...
species(
    label = 'C=C([CH]O[O])CC[CH]C(21714)',
    structure = SMILES('C=C([CH]O[O])CC[CH]C'),
    E0 = (278.978,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.160431,0.0845596,-6.53837e-05,2.76284e-08,-4.9573e-12,33691.2,37.7118], Tmin=(100,'K'), Tmax=(1275.31,'K')), NASAPolynomial(coeffs=[12.615,0.0454957,-1.94372e-05,3.60985e-09,-2.48912e-13,30514.5,-25.4033], Tmin=(1275.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(278.978,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(RCCJC) + radical(C=CCJO)"""),
)

species(
    label = 'C=C([CH]CCC)[CH]O[O](21609)',
    structure = SMILES('[CH2]C([CH]O[O])=CCCC'),
    E0 = (223.786,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.748957,0.0906567,-7.04149e-05,2.78735e-08,-4.41982e-12,27097.6,38.1055], Tmin=(100,'K'), Tmax=(1500.96,'K')), NASAPolynomial(coeffs=[20.9299,0.0328831,-1.26778e-05,2.22882e-09,-1.48407e-13,20589.9,-75.2862], Tmin=(1500.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(223.786,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(ROOJ) + radical(C=CCJO) + radical(Allyl_P)"""),
)

species(
    label = '[CH2]CCCC(=C)[CH]O[O](21715)',
    structure = SMILES('[CH2]CCCC(=C)[CH]O[O]'),
    E0 = (289.778,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,350,440,435,1725,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.370677,0.0893426,-7.07613e-05,2.91622e-08,-4.90323e-12,35015,38.6747], Tmin=(100,'K'), Tmax=(1397.01,'K')), NASAPolynomial(coeffs=[17.5646,0.0379887,-1.5621e-05,2.84842e-09,-1.9422e-13,30003.9,-53.8485], Tmin=(1397.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(289.778,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(C=CCJO) + radical(RCCJ)"""),
)

species(
    label = 'C=C([CH][CH]CC)CO[O](19711)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0892396,0.0868277,-6.91795e-05,3.01521e-08,-5.57522e-12,29919.7,33.3713], Tmin=(100,'K'), Tmax=(1242.34,'K')), NASAPolynomial(coeffs=[12.7541,0.0460503,-1.99448e-05,3.73167e-09,-2.58555e-13,26772.9,-30.4775], Tmin=(1242.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(247.603,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Allyl_S) + radical(Allyl_P)"""),
)
...
species(
    ...
    E0 = (408.791,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3025,407.5,1350,352.5,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=C([CH]O[O])CCCC(19713)',
    structure = SMILES('[CH]=C([CH]O[O])CCCC'),
    E0 = (331.628,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3025,407.5,1350,352.5,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.435974,0.0916233,-7.53447e-05,3.24252e-08,-5.6906e-12,40050.1,37.5239], Tmin=(100,'K'), Tmax=(1344.21,'K')), NASAPolynomial(coeffs=[17.4965,0.038261,-1.57977e-05,2.89253e-09,-1.98021e-13,35229.1,-54.2943], Tmin=(1344.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(331.628,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(C=CCJO) + radical(Cds_P)"""),
)
...
species(
    label = 'C=C([CH][CH]CC)[CH]OO(21716)',
    structure = SMILES('[CH2]C([CH]OO)=C[CH]CC'),
    E0 = (212.894,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.598871,0.086714,-4.97599e-05,2.5015e-09,4.93254e-12,25783,35.6856], Tmin=(100,'K'), Tmax=(1078.95,'K')), NASAPolynomial(coeffs=[19.8925,0.0361811,-1.48677e-05,2.79078e-09,-1.96976e-13,19880.7,-71.591], Tmin=(1078.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(212.894,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(C=CCJO) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=C([CH]OO)C[CH]CC(19709)',
    structure = SMILES('[CH]=C([CH]OO)C[CH]CC'),
    E0 = (374.082,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,350,440,435,1725,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0149905,0.090245,-7.55383e-05,3.45963e-08,-6.72657e-12,45132.8,37.712], Tmin=(100,'K'), Tmax=(1185.88,'K')), NASAPolynomial(coeffs=[12.7611,0.0472521,-2.11572e-05,4.02487e-09,-2.81689e-13,42109.7,-25.9536], Tmin=(1185.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.082,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJCC) + radical(C=CCJO) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C[CH]CC(=C)CO[O](19715)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0913258,0.0982241,-0.000126287,1.07042e-07,-3.80147e-11,44272.2,39.636], Tmin=(100,'K'), Tmax=(802.278,'K')), NASAPolynomial(coeffs=[5.82726,0.0566366,-2.59483e-05,4.89866e-09,-3.37764e-13,43711.3,14.8087], Tmin=(802.278,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(366.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ) + radical(RCCJCC) + radical(RCCJ)"""),
)

species(
    label = 'C=C([CH]OO)C[CH][CH]C(21717)',
    structure = SMILES('C=C([CH]OO)C[CH][CH]C'),
    E0 = (321.432,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,2950,3100,1380,975,1025,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.39753,0.0854145,-7.21741e-05,3.69193e-08,-8.5264e-12,38783.8,38.6879], Tmin=(100,'K'), Tmax=(981.413,'K')), NASAPolynomial(coeffs=[7.99689,0.0544415,-2.4835e-05,4.76242e-09,-3.34961e-13,37292.2,2.16791], Tmin=(981.413,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(321.432,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJC) + radical(C=CCJO)"""),
)

species(
    label = '[CH2]C[CH]CC(=C)[CH]OO(21718)',
    structure = SMILES('[CH2]C[CH]CC(=C)[CH]OO'),
    E0 = (332.232,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,440,435,1725,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.12421,0.087519,-6.96974e-05,3.0053e-08,-5.51485e-12,40095.6,38.6999], Tmin=(100,'K'), Tmax=(1243.97,'K')), NASAPolynomial(coeffs=[12.6614,0.0472058,-2.10872e-05,4.00195e-09,-2.79401e-13,36976.4,-24.5218], Tmin=(1243.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.232,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJCC) + radical(C=CCJO) + radical(RCCJ)"""),
)

species(
    label = 'CC[CH]CC[C]=CO[O](20953)',
    structure = SMILES('CC[CH]CC[C]=CO[O]'),
    E0 = (412.144,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.117682,0.0970175,-0.000117398,9.17187e-08,-3.05564e-11,49711.7,39.295], Tmin=(100,'K'), Tmax=(777.699,'K')), NASAPolynomial(coeffs=[7.75218,0.0524294,-2.347e-05,4.40454e-09,-3.03594e-13,48611.9,4.10524], Tmin=(777.699,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(412.144,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(RCCJCC) + radical(Cds_S)"""),
)
...
species(
    label = 'CCC1CC(=CO[O])C1(21561)',
    structure = SMILES('CCC1CC(=CO[O])C1'),
    E0 = (127.119,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.12101,0.0722501,-2.60438e-05,-1.33906e-08,9.02678e-12,15439.7,33.0613], Tmin=(100,'K'), Tmax=(1059.73,'K')), NASAPolynomial(coeffs=[15.6732,0.039206,-1.55895e-05,2.88001e-09,-2.01498e-13,10702.7,-49.669], Tmin=(1059.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(127.119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(methylenecyclobutane) + radical(ROOJ)"""),
)

species(
    label = 'CC[CH]CC1=COOC1(19159)',
    structure = SMILES('CC[CH]CC1=COOC1'),
    E0 = (90.8484,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.149709,0.0736598,-3.81611e-05,4.66211e-09,1.50976e-12,11074.2,36.0612], Tmin=(100,'K'), Tmax=(1225.82,'K')), NASAPolynomial(coeffs=[14.7338,0.0411354,-1.67968e-05,3.06884e-09,-2.10018e-13,6366.84,-41.8846], Tmin=(1225.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.8484,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(12dioxolene) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C1=COOC(CC)C1(21719)',
    structure = SMILES('C=C1[CH]OOC(CC)C1'),
    E0 = (-15.1986,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.348689,0.0510781,6.73453e-05,-1.21675e-07,4.80874e-11,-1670.78,28.1474], Tmin=(100,'K'), Tmax=(1008.74,'K')), NASAPolynomial(coeffs=[22.3134,0.035363,-1.54336e-05,3.18476e-09,-2.43459e-13,-9733.89,-96.0125], Tmin=(1008.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-15.1986,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclohexanone) + radical(C=CCJO)"""),
)

species(
    label = 'CC[CH]CC1=COC1(19699)',
    structure = SMILES('CC[CH]CC1=COC1'),
    E0 = (90.0168,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.436082,0.0606041,8.84462e-06,-5.68616e-08,2.67306e-11,10970.8,29.5589], Tmin=(100,'K'), Tmax=(969.46,'K')), NASAPolynomial(coeffs=[18.0741,0.0305048,-1.06134e-05,1.92536e-09,-1.38287e-13,5545.52,-65.3301], Tmin=(969.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(90.0168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C1=COC(CC)C1(21720)',
    structure = SMILES('[CH2]C1=COC(CC)C1'),
    E0 = (-76.283,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.580039,0.0484676,6.31838e-05,-1.29783e-07,5.77748e-11,-9026.74,23.1033], Tmin=(100,'K'), Tmax=(918.45,'K')), NASAPolynomial(coeffs=[23.2106,0.019326,-2.5951e-06,2.55588e-10,-2.13469e-14,-16111.6,-100.09], Tmin=(918.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-76.283,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(2,3-Dihydrofuran) + radical(Allyl_P)"""),
)

species(
    label = 'CCC=CC(C)=CO[O](21721)',
    structure = SMILES('CCC=CC(C)=CO[O]'),
    E0 = (65.3664,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.742887,0.0944229,-8.31193e-05,3.83942e-08,-7.09852e-12,8040.78,35.0024], Tmin=(100,'K'), Tmax=(1303.28,'K')), NASAPolynomial(coeffs=[19.3252,0.0328298,-1.22284e-05,2.13092e-09,-1.4229e-13,2809.98,-67.1298], Tmin=(1303.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.3664,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + radical(ROOJ)"""),
)

species(
    label = 'CC=CCC(C)=CO[O](20959)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.044159,0.0879011,-7.42496e-05,3.43693e-08,-6.63641e-12,9933.65,34.5634], Tmin=(100,'K'), Tmax=(1213.02,'K')), NASAPolynomial(coeffs=[13.8378,0.0421243,-1.76425e-05,3.25833e-09,-2.24495e-13,6565.86,-35.0897], Tmin=(1213.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(81.376,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C(C=CCC)=COO(21722)',
    structure = SMILES('C=C([CH]OO)C=CCC'),
    E0 = (33.3239,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.676584,0.0871669,-4.61408e-05,-6.70605e-09,9.69803e-12,4190.04,35.2151], Tmin=(100,'K'), Tmax=(1017.26,'K')), NASAPolynomial(coeffs=[21.5125,0.0321115,-1.24322e-05,2.31484e-09,-1.64981e-13,-1990.17,-80.4018], Tmin=(1017.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(33.3239,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CCJO)"""),
)

species(
    label = '[CH2]C(=COO)CC=CC(21723)',
    structure = SMILES('C=C([CH]OO)CC=CC'),
    E0 = (49.3335,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.559267,0.087267,-5.92758e-05,1.60666e-08,-4.93677e-13,6108.43,36.8768], Tmin=(100,'K'), Tmax=(1174.52,'K')), NASAPolynomial(coeffs=[19.2756,0.0361146,-1.48905e-05,2.76035e-09,-1.91636e-13,318.085,-66.8206], Tmin=(1174.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(49.3335,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C=CCJO)"""),
)

species(
    label = '[CH2][C]1CC(CC)C1O[O](21724)',
    structure = SMILES('[CH2][C]1CC(CC)C1O[O]'),
    E0 = (371.482,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.595454,0.0589703,1.1519e-05,-5.23659e-08,2.30576e-11,44815.5,37.3779], Tmin=(100,'K'), Tmax=(994.822,'K')), NASAPolynomial(coeffs=[14.6897,0.0393562,-1.47809e-05,2.70191e-09,-1.90547e-13,40177.6,-39.7619], Tmin=(994.822,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(371.482,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(ROOJ) + radical(C2CJCOOH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][C](C[CH]CC)C1OO1(21725)',
    structure = SMILES('[CH2][C](C[CH]CC)C1OO1'),
    E0 = (403.265,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.356747,0.07026,-2.81251e-05,-9.46907e-09,8.14715e-12,48641.4,41.7354], Tmin=(100,'K'), Tmax=(993.634,'K')), NASAPolynomial(coeffs=[12.8954,0.0405643,-1.46662e-05,2.54825e-09,-1.71985e-13,45123.8,-23.8384], Tmin=(993.634,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(403.265,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(dioxirane) + radical(C2CJCOOH) + radical(RCCJCC) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(=[C]OO)C[CH]CC(21726)',
    structure = SMILES('[CH2]C(=[C]OO)C[CH]CC'),
    E0 = (398.267,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,350,440,435,1725,3000,3100,440,815,1455,1000,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.238817,0.0923303,-8.60213e-05,3.245e-08,5.89348e-12,48026.8,38.781], Tmin=(100,'K'), Tmax=(582.209,'K')), NASAPolynomial(coeffs=[7.84414,0.054371,-2.50452e-05,4.79228e-09,-3.35466e-13,46899,4.12342], Tmin=(582.209,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(398.267,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(RCCJCC) + radical(Allyl_P) + radical(C=CJO)"""),
)

species(
    label = 'CC[CH][CH]C(C)=CO[O](21727)',
    structure = SMILES('CC[CH]C=C(C)[CH]O[O]'),
    E0 = (213.399,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.348869,0.08563,-6.23073e-05,2.31241e-08,-3.48378e-12,25830.7,35.2765], Tmin=(100,'K'), Tmax=(1549.16,'K')), NASAPolynomial(coeffs=[18.7003,0.0364446,-1.4683e-05,2.62954e-09,-1.76448e-13,19928.6,-64.963], Tmin=(1549.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(213.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Allyl_S) + radical(C=CCJO)"""),
)

species(
    label = 'CC[CH]CC(C)=[C]O[O](21728)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0661298,0.0993927,-0.000136506,1.21077e-07,-4.36224e-11,48098,40.2715], Tmin=(100,'K'), Tmax=(830.623,'K')), NASAPolynomial(coeffs=[4.68699,0.0574195,-2.62449e-05,4.92062e-09,-3.36663e-13,47966.7,22.1854], Tmin=(830.623,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(398.772,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(ROOJ) + radical(RCCJCC) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C(=[C]O[O])CCCC(21729)',
    structure = SMILES('[CH2]C(=[C]O[O])CCCC'),
    E0 = (355.813,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0199059,0.0926441,-8.9524e-05,5.05949e-08,-1.21888e-11,42935.6,37.8376], Tmin=(100,'K'), Tmax=(978.321,'K')), NASAPolynomial(coeffs=[10.8916,0.0480309,-2.11215e-05,3.98273e-09,-2.77536e-13,40800.6,-14.565], Tmin=(978.321,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(355.813,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Allyl_P) + radical(C=CJO)"""),
)

species(
    label = 'C[CH][CH]CC(C)=CO[O](21730)',
    structure = SMILES('C[CH][CH]CC(C)=CO[O]'),
    E0 = (353.474,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,180,400,3134.63],'cm^-1')),
        HinderedRotor(inertia=(0.0381984,'amu*angstrom^2'), symmetry=1, barrier=(3.51302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0381984,'amu*angstrom^2'), symmetry=1, barrier=(3.51302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0381984,'amu*angstrom^2'), symmetry=1, barrier=(3.51302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0381984,'amu*angstrom^2'), symmetry=1, barrier=(3.51302,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0381984,'amu*angstrom^2'), symmetry=1, barrier=(3.51302,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0460308,0.0974583,-0.000127646,1.08877e-07,-3.82283e-11,42650.6,39.8073], Tmin=(100,'K'), Tmax=(830.527,'K')), NASAPolynomial(coeffs=[5.57533,0.0554324,-2.47385e-05,4.59549e-09,-3.13169e-13,42232.6,16.8359], Tmin=(830.527,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(353.474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(ROOJ) + radical(RCCJCC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C[CH]CC(C)=CO[O](21731)',
    structure = SMILES('[CH2]C[CH]CC(C)=CO[O]'),
    E0 = (364.274,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.131079,0.0969653,-0.0001145,8.62778e-08,-2.78117e-11,43955.1,39.1712], Tmin=(100,'K'), Tmax=(760.105,'K')), NASAPolynomial(coeffs=[8.31348,0.0515529,-2.29619e-05,4.30712e-09,-2.97182e-13,42699.5,0.93242], Tmin=(760.105,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(364.274,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + radical(ROOJ) + radical(RCCJCC) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['C=C=CO[O](16806)', 'butene1(35)'],
    transitionState = 'TS1',
...
reaction(
    ...
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(C)CC(=C)[CH]O[O](21700)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['C=[C]C(C[CH]CC)O[O](20952)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(4)', 'C=C([CH][O])C[CH]CC(21701)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O2(2)', '[CH]C(=C)C[CH]CC(15696)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H5(14)', '[CH]CC(=C)[CH]O[O](21388)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]CC(26)', '[CH2]C(=C)[CH]O[O](21386)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]O[O](21387)', 'C=[C]C[CH]CC(2553)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C=C([CH]O[O])C[C]CC(21702)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'C=C([C]O[O])C[CH]CC(21703)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['C=C(C[CH]CC)C1OO1(21704)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['C=C1CC(CC)C1O[O](21581)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C([CH][CH]CC)[CH]O[O](21705)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['CC[CH]C[C]1CC1O[O](21706)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['CCC1C[C]([CH]O[O])C1(21707)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['CC[CH]C[C]1[CH]OOC1(21708)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['[CH2]C1([CH]O[O])CC1CC(21621)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(6.73316e+11,'s^-1'), n=0.231216, Ea=(95.0814,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_csHNd]
Euclidian distance = 0
...
reaction(
    label = 'reaction22',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['[CH2]C1(C[CH]CC)[CH]OO1(21709)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C=C([CH]O[O])CC=CC(21100)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', 'C=C([CH]O[O])C=CCC(21710)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O(4)', 'C=C(C=O)C[CH]CC(21711)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH3(17)', 'C=CCC(=C)[CH]O[O](20983)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2][C]=CO[O](16807)', 'butene1(35)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C=C=CO[O](16806)', '[CH2][CH]CC(37)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH3(17)', '[CH2][CH]CC(=C)[CH]O[O](20050)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', 'C=C([CH]O[O])C[CH][CH]C(20593)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2][C]=CO[O](16807)', '[CH2][CH]CC(37)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', 'C=C([CH][CH]CC)[CH]O[O](21712)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', '[CH2]C[CH]CC(=C)[CH]O[O](21713)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', '[CH]=C([CH]O[O])C[CH]CC(19706)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction35',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['C=C([CH]O[O])CC[CH]C(21714)'],
...
reaction(
    label = 'reaction36',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['C=C([CH]CCC)[CH]O[O](21609)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]CCCC(=C)[CH]O[O](21715)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction38',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['C=C([CH][CH]CC)CO[O](19711)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH]=C(C[CH]CC)CO[O](19261)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH]=C([CH]O[O])CCCC(19713)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction42',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['C=C([CH][CH]CC)[CH]OO(21716)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH]=C([CH]OO)C[CH]CC(19709)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH2]C[CH]CC(=C)CO[O](19715)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
    transitionState = 'TS44',
    kinetics = Arrhenius(A=(32953.2,'s^-1'), n=1.82816, Ea=(64.6002,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6Hall;C_rad_out_2H;Cs_H_out_1H] for rate rule [R6HJ_2;C_rad_out_2H;Cs_H_out_H/NonDeO]
Euclidian distance = 1.4142135623730951
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction45',
    reactants = ['C=C([CH]OO)C[CH][CH]C(21717)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
    transitionState = 'TS45',
    kinetics = Arrhenius(A=(423.689,'s^-1'), n=2.58367, Ea=(106.315,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;C_rad_out_H/NonDeC;O_H_out] for rate rule [R7Hall;C_rad_out_H/NonDeC;O_H_out]
Euclidian distance = 1.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2]C[CH]CC(=C)[CH]OO(21718)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction5',
    reactants = ['CC[CH]CC[C]=CO[O](20953)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction48',
    reactants = ['CH2(T)(20)', 'CC[CH]C[C]=CO[O](21411)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction50',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['CC[CH]CC1=COOC1(19159)'],
...
reaction(
    label = 'reaction51',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['[CH2]C1=COOC(CC)C1(21719)'],
...
reaction(
    label = 'reaction52',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['O(4)', 'CC[CH]CC1=COC1(19699)'],
...
reaction(
    label = 'reaction53',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['O(4)', '[CH2]C1=COC(CC)C1(21720)'],
...
reaction(
    label = 'reaction56',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['[CH2]C(C=CCC)=COO(21722)'],
...
reaction(
    label = 'reaction57',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['[CH2]C(=COO)CC=CC(21723)'],
...
reaction(
    label = 'reaction58',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['[CH2][C]1CC(CC)C1O[O](21724)'],
...
reaction(
    label = 'reaction59',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['[CH2][C](C[CH]CC)C1OO1(21725)'],
...
reaction(
    label = 'reaction60',
    reactants = ['[CH2]C(=[C]OO)C[CH]CC(21726)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction61',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['CC[CH][CH]C(C)=CO[O](21727)'],
...
reaction(
    label = 'reaction62',
    reactants = ['C=C([CH]O[O])C[CH]CC(19712)'],
    products = ['CC[CH]CC(C)=[C]O[O](21728)'],
...
reaction(
    label = 'reaction63',
    reactants = ['[CH2]C(=[C]O[O])CCCC(21729)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction64',
    reactants = ['C[CH][CH]CC(C)=CO[O](21730)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
reaction(
    label = 'reaction65',
    reactants = ['[CH2]C[CH]CC(C)=CO[O](21731)'],
    products = ['C=C([CH]O[O])C[CH]CC(19712)'],
...
network(
    label = 'PDepNetwork #4612',
    isomers = [
        'C=C([CH]O[O])C[CH]CC(19712)',
    ],
    reactants = [
        ('C=C=CO[O](16806)', 'butene1(35)'),
    ],
    bathGas = {
        'Ar': 0.333333,
        'Ne': 0.333333,
