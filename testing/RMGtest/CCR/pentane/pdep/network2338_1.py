...
species(
    label = '[CH]=[C]OC[CH]C[O](10666)',
    structure = SMILES('[CH]=[C]OC[CH]C[O]'),
    E0 = (543.333,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0612,0.0671062,-7.47204e-05,4.56899e-08,-1.14189e-11,65451.6,31.0789], Tmin=(100,'K'), Tmax=(964.281,'K')), NASAPolynomial(coeffs=[10.7978,0.026717,-1.18922e-05,2.25282e-09,-1.57366e-13,63573.9,-15.5405], Tmin=(964.281,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(543.333,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCJCO) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]OC[C]CO[O](10667)',
    structure = SMILES('[CH]=[C]OC[C]CO[O]'),
    E0 = (789.45,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0791297,0.0929185,-0.000131804,9.48954e-08,-2.67065e-11,95093,33.2375], Tmin=(100,'K'), Tmax=(876.021,'K')), NASAPolynomial(coeffs=[15.5813,0.0214126,-9.36778e-06,1.72113e-09,-1.16811e-13,92349.1,-40.2426], Tmin=(876.021,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(789.45,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJ2_triplet) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[C]=[C]OC[CH]CO[O](10668)',
    structure = SMILES('[C]=[C]OC[CH]CO[O]'),
    E0 = (852.656,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0427022,0.095756,-0.000152737,1.26401e-07,-4.07566e-11,102690,35.4754], Tmin=(100,'K'), Tmax=(851.458,'K')), NASAPolynomial(coeffs=[12.5439,0.0263461,-1.23475e-05,2.30019e-09,-1.55336e-13,100919,-21.0352], Tmin=(851.458,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(852.656,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJCOOH) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)
...
species(
    label = '[CH]=[C]OCC1COO1(10669)',
    structure = SMILES('[CH]=[C]OCC1COO1'),
    E0 = (345.943,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.460137,0.07431,-7.33757e-05,3.72853e-08,-7.55352e-12,41737.7,26.7871], Tmin=(100,'K'), Tmax=(1193.34,'K')), NASAPolynomial(coeffs=[15.5207,0.0238282,-9.92173e-06,1.83651e-09,-1.27205e-13,38143.2,-48.5337], Tmin=(1193.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(345.943,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(12dioxetane) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]OCC1CO1(10670)',
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.217303,0.0723024,-7.42494e-05,3.83088e-08,-7.28248e-12,35607.2,28.9928], Tmin=(100,'K'), Tmax=(1556.12,'K')), NASAPolynomial(coeffs=[16.8833,0.0117453,1.24981e-07,-4.09661e-10,3.92088e-14,32294.9,-54.6118], Tmin=(1556.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(294.646,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=COC=CCO[O](10671)',
    structure = SMILES('[CH]=COC=CCO[O]'),
    E0 = (251.258,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.293646,0.0771092,-8.18004e-05,4.447e-08,-9.51303e-12,30356.6,31.8275], Tmin=(100,'K'), Tmax=(1142.99,'K')), NASAPolynomial(coeffs=[16.3658,0.0208626,-7.98465e-06,1.41546e-09,-9.58638e-14,26682.6,-47.8594], Tmin=(1142.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(251.258,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]OCC=COO(10672)',
    structure = SMILES('[CH]=[C]OCC=COO'),
    E0 = (326.594,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.151793,0.0828424,-8.98557e-05,4.78811e-08,-9.85153e-12,39437,34.1228], Tmin=(100,'K'), Tmax=(1199.1,'K')), NASAPolynomial(coeffs=[20.0868,0.0153301,-5.40259e-06,9.27811e-10,-6.23009e-14,34583.3,-67.1915], Tmin=(1199.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(326.594,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=COCC=CO[O](9581)',
    structure = SMILES('[CH]=COCC=CO[O]'),
    E0 = (238.855,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.598504,0.0833224,-8.77932e-05,4.42517e-08,-8.36922e-12,28908.4,33.3617], Tmin=(100,'K'), Tmax=(1458.34,'K')), NASAPolynomial(coeffs=[22.9294,0.00896088,-1.19846e-06,4.44588e-11,1.33209e-15,23091.2,-85.4407], Tmin=(1458.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(238.855,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]OC=CCOO(10673)',
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.702904,0.102879,-0.000135371,8.65512e-08,-2.13596e-11,35360.1,30.486], Tmin=(100,'K'), Tmax=(1001.33,'K')), NASAPolynomial(coeffs=[20.6738,0.0174852,-7.45043e-06,1.38362e-09,-9.59225e-14,31079.1,-72.6727], Tmin=(1001.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(292.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCJCOOH) + radical(CCsJOCs)"""),
)
...
species(
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.457097,0.102394,-0.000159267,1.22926e-07,-3.66973e-11,88625.9,36.4627], Tmin=(100,'K'), Tmax=(860.325,'K')), NASAPolynomial(coeffs=[16.7028,0.0192522,-8.45246e-06,1.52289e-09,-1.00725e-13,85797.6,-43.0201], Tmin=(860.325,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(735.578,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CCsJOC(O)) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]OCC[CH]O[O](10678)',
    structure = SMILES('[CH]=[C]OCC[CH]O[O]'),
    E0 = (529.818,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0153371,0.0924985,-0.000128704,9.46101e-08,-2.75697e-11,63863.1,33.2533], Tmin=(100,'K'), Tmax=(842.449,'K')), NASAPolynomial(coeffs=[13.7958,0.0269228,-1.19458e-05,2.21446e-09,-1.51118e-13,61536.1,-31.0096], Tmin=(842.449,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(529.818,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCsJOOH) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CO[CH][CH]CO[O](10679)',
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.617951,0.0952312,-0.000116675,6.91734e-08,-1.56922e-11,59223.5,32.8166], Tmin=(100,'K'), Tmax=(1094.17,'K')), NASAPolynomial(coeffs=[21.8104,0.0132391,-4.27249e-06,6.87751e-10,-4.44337e-14,54315.4,-77.406], Tmin=(1094.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(490.984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(CCsJOC(O)) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]=[C]OC[CH][CH]OO(10680)',
    structure = SMILES('[CH]=[C]OC[CH][CH]OO'),
    E0 = (578.228,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,1685,370,3120,650,792.5,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.20091,0.0974347,-0.000137264,1.0068e-07,-2.92518e-11,69691.5,35.4691], Tmin=(100,'K'), Tmax=(844.465,'K')), NASAPolynomial(coeffs=[14.5907,0.0273731,-1.28197e-05,2.44065e-09,-1.6934e-13,67193.2,-33.3919], Tmin=(844.465,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(578.228,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCOOH) + radical(CCsJOOH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.21818,0.0930163,-0.000118743,7.64457e-08,-1.92091e-11,59143.9,33.1553], Tmin=(100,'K'), Tmax=(979.813,'K')), NASAPolynomial(coeffs=[17.387,0.0211449,-8.71547e-06,1.58328e-09,-1.07974e-13,55693.9,-51.4209], Tmin=(979.813,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(490.489,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CCsJOOH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]O[CH][CH]COO(10682)',
    structure = SMILES('[CH]=[C]O[CH][CH]COO'),
    E0 = (583.573,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,1685,370,3120,650,792.5,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.587762,0.104302,-0.000148135,1.04481e-07,-2.86706e-11,70349.8,36.1802], Tmin=(100,'K'), Tmax=(899.076,'K')), NASAPolynomial(coeffs=[18.0665,0.0213121,-9.68115e-06,1.82101e-09,-1.25692e-13,66995.4,-51.832], Tmin=(899.076,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(583.573,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCOOH) + radical(CCsJOC(O)) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=[C]OC[CH]CO[O](3018)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=[C]OC[CH]CO[O](3018)'],
    products = ['O2(S)(666)', 'C#COC[CH][CH2](2623)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=[CH](9646)', '[O]C[CH]CO[O](1370)'],
    products = ['[CH]=[C]OC[CH]CO[O](3018)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(4)', '[CH]=[C]OC[CH]C[O](10666)'],
    products = ['[CH]=[C]OC[CH]CO[O](3018)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]CO[O](790)', '[CH]=[C]O[CH2](9647)'],
    products = ['[CH]=[C]OC[CH]CO[O](3018)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]O[O](46)', '[CH]CO[C]=[CH](9648)'],
    products = ['[CH]=[C]OC[CH]CO[O](3018)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/O;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]=[C]OC[C]CO[O](10667)'],
    products = ['[CH]=[C]OC[CH]CO[O](3018)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[C]=[C]OC[CH]CO[O](10668)'],
    products = ['[CH]=[C]OC[CH]CO[O](3018)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[C]OC[CH]CO[O](3018)'],
    products = ['O(4)', '[CH]=[C]OCC1CO1(10670)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH]=[C]OC=CCO[O](10674)'],
    products = ['[CH]=[C]OC[CH]CO[O](3018)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH]=[C]OCC=CO[O](10675)'],
    products = ['[CH]=[C]OC[CH]CO[O](3018)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O2(2)', 'C#COC[CH][CH2](2623)'],
    products = ['[CH]=[C]OC[CH]CO[O](3018)'],
    transitionState = 'TS19',
    kinetics = Arrhenius(A=(552,'cm^3/(mol*s)'), n=2.78, Ea=(145.084,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [Cds-HH_Cds-CsH;O2b] for rate rule [Cds-HH_Cds-Cs\O2s/H;O2b]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 142.3 to 145.1 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction21',
    reactants = ['O2(2)', '[CH]=[C]OC[CH][CH2](2625)'],
    products = ['[CH]=[C]OC[CH]CO[O](3018)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH]=[C]O[CH][CH]CO[O](10676)'],
    products = ['[CH]=[C]OC[CH]CO[O](3018)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH]=[C]OC[CH][CH]O[O](10677)'],
    products = ['[CH]=[C]OC[CH]CO[O](3018)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=[C]OC[CH]CO[O](3018)'],
    products = ['[CH]=[C]OCC[CH]O[O](10678)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]=[C]OC[CH]CO[O](3018)'],
    products = ['[CH]=CO[CH][CH]CO[O](10679)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]=[C]OC[CH][CH]OO(10680)'],
    products = ['[CH]=[C]OC[CH]CO[O](3018)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]=[C]OC[CH]CO[O](3018)'],
    products = ['C=[C]O[CH][CH]CO[O](3016)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]=[C]OC[CH]CO[O](3018)'],
    products = ['[CH]=COC[CH][CH]O[O](10681)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]=[C]O[CH][CH]COO(10682)'],
    products = ['[CH]=[C]OC[CH]CO[O](3018)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]=[C]OC[CH]CO[O](3018)'],
    products = ['C=[C]OC[CH][CH]O[O](3017)'],
