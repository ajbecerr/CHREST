...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.116648,0.0893327,-8.19709e-05,4.34807e-08,-9.8729e-12,49031.3,37.48], Tmin=(100,'K'), Tmax=(1029.53,'K')), NASAPolynomial(coeffs=[10.8972,0.0474472,-2.09445e-05,3.96322e-09,-2.76859e-13,46811.5,-14.8435], Tmin=(1029.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(406.534,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Cs_S) + radical(Cds_S)"""),
)
...
species(
    label = 'C#CCC(C)[CH]C(15529)',
    structure = SMILES('C#CCC(C)[CH]C'),
    E0 = (267.089,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,2175,525,750,770,3400,2100,182.803,1018.13],'cm^-1')),
        HinderedRotor(inertia=(0.437796,'amu*angstrom^2'), symmetry=1, barrier=(10.2464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00190396,'amu*angstrom^2'), symmetry=1, barrier=(21.6176,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.45795,'amu*angstrom^2'), symmetry=1, barrier=(104.225,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0051405,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.42107,'amu*angstrom^2'), symmetry=1, barrier=(104.211,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.67001,0.0669083,-4.43171e-05,1.57309e-08,-2.33519e-12,32248.2,28.8884], Tmin=(100,'K'), Tmax=(1534.58,'K')), NASAPolynomial(coeffs=[12.7638,0.035385,-1.35041e-05,2.34481e-09,-1.54449e-13,28536.5,-34.6362], Tmin=(1534.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(267.089,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Cs_S)"""),
)
...
species(
    label = 'C[CH]C(C)C[C]=C[O](22373)',
    structure = SMILES('C[CH]C(C)C[C]=C[O]'),
    E0 = (271.497,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.043619,0.0777677,-4.99034e-05,1.08215e-08,9.88362e-13,32808.5,35.3494], Tmin=(100,'K'), Tmax=(1109.93,'K')), NASAPolynomial(coeffs=[16.658,0.0342096,-1.35141e-05,2.46519e-09,-1.70328e-13,28076.6,-51.583], Tmin=(1109.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(271.497,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Cs_S) + radical(Cds_S)"""),
)
...
species(
    label = 'C[C]C(C)C[C]=CO[O](22374)',
    structure = SMILES('C[C]C(C)C[C]=CO[O]'),
    E0 = (660.207,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.280515,0.0954848,-9.69385e-05,5.4208e-08,-1.24389e-11,79557.6,36.9433], Tmin=(100,'K'), Tmax=(1044.42,'K')), NASAPolynomial(coeffs=[14.2603,0.0397953,-1.69571e-05,3.15479e-09,-2.18458e-13,76520.3,-33.8396], Tmin=(1044.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(660.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(CCJ2_triplet) + radical(Cds_S)"""),
)

species(
    label = 'C[CH]C(C)CC1=COO1(22375)',
    structure = SMILES('C[CH]C(C)CC1=COO1'),
    E0 = (196.983,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0452219,0.072199,-2.18428e-05,-1.93704e-08,1.11288e-11,23846.6,36.4153], Tmin=(100,'K'), Tmax=(1068.94,'K')), NASAPolynomial(coeffs=[17.1388,0.0380793,-1.58446e-05,3.00861e-09,-2.13996e-13,18487.1,-55.1668], Tmin=(1068.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(196.983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(Cs_S)"""),
)
...
species(
    label = 'C[CH]C(C)CC1=CO1(22377)',
    structure = SMILES('C[CH]C(C)CC1=CO1'),
    E0 = (208.785,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.12094,0.0729604,-3.53253e-05,-4.71078e-09,6.49245e-12,25261.3,32.8227], Tmin=(100,'K'), Tmax=(1056.28,'K')), NASAPolynomial(coeffs=[16.5207,0.0342406,-1.35474e-05,2.50293e-09,-1.75423e-13,20492.3,-53.3695], Tmin=(1056.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.785,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclopropene) + radical(Cs_S)"""),
)

species(
    label = 'CC=C(C)CC=CO[O](22378)',
    structure = SMILES('CC=C(C)CC=CO[O]'),
    E0 = (81.376,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
...
species(
    label = 'CCC(C)C=C=CO[O](19266)',
    structure = SMILES('CCC(C)C=C=CO[O]'),
    E0 = (136.231,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.393351,0.0908352,-7.69523e-05,3.47441e-08,-6.39701e-12,16547.8,35.6122], Tmin=(100,'K'), Tmax=(1289.23,'K')), NASAPolynomial(coeffs=[16.7727,0.037576,-1.49869e-05,2.702e-09,-1.83668e-13,12121.5,-51.5653], Tmin=(1289.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(136.231,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cdd-Cd)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + radical(ROOJ)"""),
)
...
species(
    label = 'C[CH]C(C)C=C=COO(20163)',
    structure = SMILES('C[CH]C(C)C=C=COO'),
    E0 = (178.769,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.271002,0.0909111,-7.55884e-05,3.30652e-08,-5.94587e-12,21657,36.9695], Tmin=(100,'K'), Tmax=(1304.26,'K')), NASAPolynomial(coeffs=[16.2932,0.0401106,-1.71636e-05,3.20141e-09,-2.21562e-13,17336.2,-47.3429], Tmin=(1304.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(178.769,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cdd-Cd)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cdd-CdsCds) + radical(Cs_S)"""),
)

species(
    label = 'CC=C(C)C[C]=CO[O](22379)',
    structure = SMILES('CC=C(C)C[C]=CO[O]'),
    E0 = (319.218,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.387551,'amu*angstrom^2'), symmetry=1, barrier=(8.91057,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.38793,'amu*angstrom^2'), symmetry=1, barrier=(8.91927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.387798,'amu*angstrom^2'), symmetry=1, barrier=(8.91625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.388087,'amu*angstrom^2'), symmetry=1, barrier=(8.92288,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.387659,'amu*angstrom^2'), symmetry=1, barrier=(8.91303,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0494286,0.0908314,-9.25095e-05,5.44644e-08,-1.34839e-11,38532,34.7149], Tmin=(100,'K'), Tmax=(960.565,'K')), NASAPolynomial(coeffs=[11.3132,0.043926,-1.92617e-05,3.62685e-09,-2.52495e-13,36368.1,-19.1727], Tmin=(960.565,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.218,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.142671,0.0870682,-7.60922e-05,3.56318e-08,-6.81485e-12,40743.9,37.0444], Tmin=(100,'K'), Tmax=(1242.72,'K')), NASAPolynomial(coeffs=[15.6774,0.0361476,-1.46295e-05,2.65965e-09,-1.81794e-13,36811.9,-42.7158], Tmin=(1242.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(337.497,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_S)"""),
)

species(
    label = 'C[CH]C(C)CC#CO[O](21092)',
    structure = SMILES('C[CH]C(C)CC#CO[O]'),
    E0 = (394.207,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,2100,2250,500,550,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.306635,0.0849984,-7.90439e-05,4.39944e-08,-1.058e-11,47541.9,36.468], Tmin=(100,'K'), Tmax=(974.059,'K')), NASAPolynomial(coeffs=[9.59339,0.0468617,-2.0315e-05,3.79876e-09,-2.63347e-13,45732.8,-8.09111], Tmin=(974.059,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(394.207,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCt) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(ROOJ) + radical(Cs_S)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.41401,'amu*angstrom^2'), symmetry=1, barrier=(9.51891,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.414037,'amu*angstrom^2'), symmetry=1, barrier=(9.51952,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.414028,'amu*angstrom^2'), symmetry=1, barrier=(9.51931,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.413865,'amu*angstrom^2'), symmetry=1, barrier=(9.51557,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.771027,0.072386,-6.79019e-05,3.57047e-08,-7.84301e-12,43205.4,31.3596], Tmin=(100,'K'), Tmax=(1076.96,'K')), NASAPolynomial(coeffs=[11.0673,0.034145,-1.46407e-05,2.73531e-09,-1.89842e-13,40987.6,-19.0774], Tmin=(1076.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(358.273,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.135408,0.100954,-0.00014472,1.282e-07,-4.57648e-11,71335.2,40.1994], Tmin=(100,'K'), Tmax=(827.142,'K')), NASAPolynomial(coeffs=[5.9556,0.0531455,-2.47379e-05,4.67059e-09,-3.20586e-13,70955.4,15.7648], Tmin=(827.142,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(591.957,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Tertalkyl) + radical(Cs_S) + radical(Cds_S)"""),
)
...
species(
    label = 'C[CH]C(C)C[C]=[C]O[O](22381)',
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12831,0.0767897,-2.47546e-05,-1.12605e-07,1.27592e-10,77818.5,37.9241], Tmin=(100,'K'), Tmax=(461.012,'K')), NASAPolynomial(coeffs=[6.98987,0.0511778,-2.35648e-05,4.46175e-09,-3.082e-13,77009.7,11.2745], Tmin=(461.012,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(646.278,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Cs_S) + radical(Cds_S) + radical(C=CJO)"""),
)

species(
    label = 'CC[C](C)C[C]=CO[O](21568)',
    structure = SMILES('CC[C](C)C[C]=CO[O]'),
    E0 = (397.414,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.286732,0.101651,-0.000131215,1.06803e-07,-3.62648e-11,47945.2,38.1898], Tmin=(100,'K'), Tmax=(800.995,'K')), NASAPolynomial(coeffs=[7.91227,0.052463,-2.36632e-05,4.43811e-09,-3.04989e-13,46896.2,2.10462], Tmin=(800.995,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(397.414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Tertalkyl) + radical(Cds_S)"""),
)

species(
    label = 'C[CH]C(C)C=C[CH]O[O](20169)',
    structure = SMILES('C[CH]C(C)C=C[CH]O[O]'),
    E0 = (274.131,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.250716,0.0827596,-5.80155e-05,2.05113e-08,-2.9353e-12,33132.2,39.8361], Tmin=(100,'K'), Tmax=(1625.01,'K')), NASAPolynomial(coeffs=[19.0419,0.0352706,-1.41799e-05,2.5276e-09,-1.68617e-13,26862,-62.6064], Tmin=(1625.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(274.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Cs_S) + radical(C=CCJO)"""),
)

species(
    label = '[CH2]CC(C)C[C]=CO[O](21572)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.160455,0.0928219,-8.67436e-05,4.536e-08,-9.89227e-12,50330.9,38.3921], Tmin=(100,'K'), Tmax=(1085.56,'K')), NASAPolynomial(coeffs=[13.2463,0.0434214,-1.84833e-05,3.43979e-09,-2.38203e-13,47420.1,-27.3886], Tmin=(1085.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(417.238,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(RCCJ) + radical(Cds_S)"""),
)

species(
    label = 'C[CH]C(C)CC=[C]O[O](22382)',
    structure = SMILES('C[CH]C(C)CC=[C]O[O]'),
    E0 = (408.436,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.347807,0.0864773,-8.33501e-05,5.12514e-08,-1.40903e-11,49249.7,40.0086], Tmin=(100,'K'), Tmax=(847.042,'K')), NASAPolynomial(coeffs=[7.4352,0.0530088,-2.40827e-05,4.60559e-09,-3.23179e-13,48049,6.99247], Tmin=(847.042,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(408.436,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Cs_S) + radical(C=CJO)"""),
)

species(
    label = 'C[CH]C(C)C[C]=[C]OO(22383)',
    structure = SMILES('C[CH]C(C)C[C]=[C]OO'),
    E0 = (494.273,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,1670,1700,300,440,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00980129,0.0954143,-0.000106225,7.5241e-08,-2.32771e-11,59585.2,41.005], Tmin=(100,'K'), Tmax=(767.038,'K')), NASAPolynomial(coeffs=[7.92898,0.0540148,-2.52656e-05,4.87567e-09,-3.43046e-13,58367.3,4.81049], Tmin=(767.038,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(494.273,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cs_S) + radical(Cds_S) + radical(C=CJO)"""),
)

species(
    label = 'CCC(C)C=[C][CH]O[O](19690)',
    structure = SMILES('CCC(C)C=[C][CH]O[O]'),
    E0 = (317.431,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.308447,0.0868451,-6.63444e-05,2.63205e-08,-4.26071e-12,38339.6,37.9453], Tmin=(100,'K'), Tmax=(1446.66,'K')), NASAPolynomial(coeffs=[17.5423,0.0374881,-1.51677e-05,2.73676e-09,-1.85168e-13,33174.8,-54.7659], Tmin=(1446.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(317.431,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(C=CCJO) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.931219,0.0801518,-3.6197e-05,-7.43407e-08,8.95815e-11,42687.8,36.1121], Tmin=(100,'K'), Tmax=(482.9,'K')), NASAPolynomial(coeffs=[6.69298,0.0544818,-2.49726e-05,4.74802e-09,-3.30095e-13,41874.1,9.84642], Tmin=(482.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(354.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Tertalkyl) + radical(Cs_S)"""),
)
...
species(
    label = 'CCC(C)C[C]=[C]O[O](21573)',
    structure = SMILES('CCC(C)C[C]=[C]O[O]'),
    E0 = (451.736,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,1670,1700,300,440,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00873655,0.0937329,-0.000102143,6.98811e-08,-2.06329e-11,54469.7,39.1377], Tmin=(100,'K'), Tmax=(806.136,'K')), NASAPolynomial(coeffs=[8.59283,0.0511361,-2.28765e-05,4.32353e-09,-3.00611e-13,53085.8,-0.425085], Tmin=(806.136,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(451.736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Cds_S) + radical(C=CJO)"""),
)

species(
    label = 'C[CH]C(C)C=[C][CH]OO(20171)',
    structure = SMILES('C[CH]C(C)C=[C][CH]OO'),
    E0 = (359.968,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.180558,0.0868861,-6.49553e-05,2.46823e-08,-3.84002e-12,43448.4,39.28], Tmin=(100,'K'), Tmax=(1485,'K')), NASAPolynomial(coeffs=[17.4374,0.0394301,-1.70197e-05,3.16226e-09,-2.17101e-13,38215.9,-52.6827], Tmin=(1485,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(359.968,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_S) + radical(C=CCJO) + radical(Cds_S)"""),
)

species(
    label = 'C[CH][C](C)C[C]=COO(22385)',
    structure = SMILES('C[CH][C](C)C[C]=COO'),
    E0 = (439.952,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.821409,0.0848523,-3.4318e-05,-1.09703e-07,1.29945e-10,53012.9,36.286], Tmin=(100,'K'), Tmax=(463.338,'K')), NASAPolynomial(coeffs=[7.43191,0.0550107,-2.58533e-05,4.94183e-09,-3.43317e-13,52108.1,6.32578], Tmin=(463.338,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(439.952,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Tertalkyl) + radical(Cs_S) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C([CH]C)C[C]=COO(21575)',
    structure = SMILES('[CH2]C([CH]C)C[C]=COO'),
    E0 = (459.612,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.240782,0.0959375,-9.44487e-05,5.2754e-08,-1.23074e-11,55429,40.4774], Tmin=(100,'K'), Tmax=(1018.98,'K')), NASAPolynomial(coeffs=[12.7588,0.0449083,-1.93316e-05,3.6092e-09,-2.50214e-13,52779.7,-22.4825], Tmin=(1018.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(459.612,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cs_S) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = '[CH2][CH]C(C)C[C]=COO(22386)',
    structure = SMILES('[CH2][CH]C(C)C[C]=COO'),
    E0 = (459.776,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0687101,0.0931904,-8.61399e-05,4.43908e-08,-9.65948e-12,55441.7,39.8644], Tmin=(100,'K'), Tmax=(1076.79,'K')), NASAPolynomial(coeffs=[12.5399,0.0463526,-2.08936e-05,3.99529e-09,-2.80809e-13,52726.3,-21.8978], Tmin=(1076.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(459.776,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cs_S) + radical(RCCJ) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'C[CH]CC[C]=CO[O](20929)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CC(C)[CH]C[C]=CO[O](22372)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C[CH]C(C)C[C]=CO[O](21008)'],
    products = ['O2(S)(666)', 'C#CCC(C)[CH]C(15529)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction6',
    reactants = ['O(4)', 'C[CH]C(C)C[C]=C[O](22373)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHCH3(T)(21)', 'C[CH]C[C]=CO[O](21354)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[C]=CO[O](21346)', '[CH2]C(C)[CH]C(114)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(17)', '[CH]C(C)C[C]=CO[O](21413)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'C[C]C(C)C[C]=CO[O](22374)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C[CH]C(C)C[C]=CO[O](21008)'],
    products = ['C[CH]C(C)CC1=COO1(22375)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C[CH]C(C)C[C]=CO[O](21008)'],
    products = ['O(4)', 'C[CH]C(C)CC1=CO1(22377)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C[CH]C(C)C[C]=CO[O](21008)'],
    products = ['C[CH]C(C)C=C=COO(20163)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'CC=C(C)C[C]=CO[O](22379)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'C[CH]C(C)C=C=CO[O](19364)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', 'C=CC(C)C[C]=CO[O](21090)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', 'C[CH]C(C)CC#CO[O](21092)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH3(17)', 'CC=CC[C]=CO[O](21491)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O2(2)', 'C#CCC(C)[CH]C(15529)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O2(2)', '[CH]=[C]CC(C)[CH]C(15806)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH3(17)', 'C[CH][CH]C[C]=CO[O](21493)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', 'C[CH][C](C)C[C]=CO[O](22380)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', 'C[CH]C(C)C=[C][CH]O[O](20167)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', '[CH2]C([CH]C)C[C]=CO[O](21086)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', '[CH2][CH]C(C)C[C]=CO[O](21097)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', 'C[CH]C(C)C[C]=[C]O[O](22381)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
...
reaction(
    label = 'reaction34',
    reactants = ['C[CH]C(C)C[C]=CO[O](21008)'],
    products = ['CC[C](C)C[C]=CO[O](21568)'],
...
reaction(
    label = 'reaction35',
    reactants = ['C[CH]C(C)C[C]=CO[O](21008)'],
    products = ['C[CH]C(C)C=C[CH]O[O](20169)'],
...
reaction(
    label = 'reaction36',
    reactants = ['C[CH]C(C)C[C]=CO[O](21008)'],
    products = ['[CH2]CC(C)C[C]=CO[O](21572)'],
...
reaction(
    label = 'reaction37',
    reactants = ['C[CH]C(C)C[C]=CO[O](21008)'],
    products = ['C[CH]C(C)CC=[C]O[O](22382)'],
...
reaction(
    label = 'reaction38',
    reactants = ['C[CH]C(C)C[C]=[C]OO(22383)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
...
reaction(
    label = 'reaction39',
    reactants = ['C[CH]C(C)C[C]=CO[O](21008)'],
    products = ['CCC(C)C=[C][CH]O[O](19690)'],
...
reaction(
    label = 'reaction41',
    reactants = ['C[CH]C(C)C[C]=CO[O](21008)'],
    products = ['C[CH][C](C)CC=CO[O](22384)'],
...
reaction(
    label = 'reaction42',
    reactants = ['C[CH]C(C)C[C]=CO[O](21008)'],
    products = ['[CH2]C([CH]C)CC=CO[O](4798)'],
...
reaction(
    label = 'reaction43',
    reactants = ['C[CH]C(C)C[C]=CO[O](21008)'],
    products = ['[CH2][CH]C(C)CC=CO[O](4708)'],
...
reaction(
    label = 'reaction44',
    reactants = ['CCC(C)C[C]=[C]O[O](21573)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
...
reaction(
    label = 'reaction45',
    reactants = ['C[CH]C(C)C[C]=CO[O](21008)'],
    products = ['C[CH]C(C)C=[C][CH]OO(20171)'],
...
reaction(
    label = 'reaction46',
    reactants = ['C[CH][C](C)C[C]=COO(22385)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH2]C([CH]C)C[C]=COO(21575)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2][CH]C(C)C[C]=COO(22386)'],
    products = ['C[CH]C(C)C[C]=CO[O](21008)'],
...
network(
    label = 'PDepNetwork #4678',
    isomers = [
        'C[CH]C(C)C[C]=CO[O](21008)',
    ],
    reactants = [
