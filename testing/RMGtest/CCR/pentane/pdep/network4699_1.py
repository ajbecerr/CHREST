...
species(
    label = 'C=COC[C][CH][O](22774)',
    structure = SMILES('C=COC[C][CH][O]'),
    E0 = (485.103,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.320959,0.0799514,-9.4789e-05,5.69676e-08,-1.34313e-11,58477.9,27.1562], Tmin=(100,'K'), Tmax=(1040.12,'K')), NASAPolynomial(coeffs=[15.9185,0.0199684,-8.28581e-06,1.52377e-09,-1.05105e-13,55233.2,-48.7066], Tmin=(1040.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(485.103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCsJOH) + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'C=COC[C][C]O[O](22775)',
    structure = SMILES('C=COC[C][C]O[O]'),
    E0 = (763.599,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.616954,0.0959076,-0.000121936,7.34831e-08,-1.68674e-11,92010.9,30.3609], Tmin=(100,'K'), Tmax=(1082.88,'K')), NASAPolynomial(coeffs=[22.5198,0.0104417,-3.54665e-06,5.95766e-10,-3.97833e-14,87000.1,-83.1025], Tmin=(1082.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(763.599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJ2_triplet) + radical(CH2_triplet)"""),
)

species(
    label = 'C=COC[C]C1OO1(22776)',
    structure = SMILES('C=COC[C]C1OO1'),
    E0 = (273.08,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.09041,0.0650698,-7.81239e-06,-6.02954e-08,3.5015e-11,33004.3,28.2798], Tmin=(100,'K'), Tmax=(909.349,'K')), NASAPolynomial(coeffs=[27.0748,0.0023365,3.35306e-06,-8.02477e-10,5.26723e-14,25782.8,-112.063], Tmin=(909.349,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(273.08,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(dioxirane) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2]CO[CH][C][CH]O[O](22777)',
    structure = SMILES('[CH2]CO[CH][C][CH]O[O]'),
    E0 = (795.372,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3000,3050,390,425,1340,1360,335,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.676578,0.114809,-0.000200246,1.76096e-07,-5.88359e-11,95818.2,34.374], Tmin=(100,'K'), Tmax=(879.876,'K')), NASAPolynomial(coeffs=[11.8967,0.0319892,-1.53121e-05,2.82939e-09,-1.88085e-13,94598.9,-19.0312], Tmin=(879.876,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(795.372,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CJCO) + radical(CCsJOCs) + radical(CCsJOOH) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C[CH]O[CH][C][CH]O[O](22778)',
    structure = SMILES('C[CH]O[CH][C][CH]O[O]'),
    E0 = (764.239,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.83288,0.116714,-0.000199868,1.70754e-07,-5.55072e-11,92080.8,33.7474], Tmin=(100,'K'), Tmax=(887.488,'K')), NASAPolynomial(coeffs=[13.8388,0.0284285,-1.31998e-05,2.39813e-09,-1.57499e-13,90349.3,-30.3675], Tmin=(887.488,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(764.239,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CCsJOOH) + radical(CCJ2_triplet)"""),
)

species(
    label = '[O]OC1[C]CO[CH]C1(22779)',
    structure = SMILES('[O]OC1[C]CO[CH]C1'),
    E0 = (435.548,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.152352,0.0722757,-6.59918e-05,3.17207e-08,-5.78826e-12,52550.2,26.9516], Tmin=(100,'K'), Tmax=(1574.53,'K')), NASAPolynomial(coeffs=[16.0612,0.0188116,-3.36512e-06,2.53057e-10,-5.80493e-15,48965.9,-53.7981], Tmin=(1574.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(435.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Oxane) + radical(ROOJ) + radical(CCsJOCs) + radical(CCJ2_triplet)"""),
)

species(
    label = '[C]1[CH]OOC[CH]OC1(22780)',
    structure = SMILES('[C]1[CH]OOC[CH]OC1'),
    E0 = (535.369,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.900224,0.0575833,-2.53901e-05,-4.66861e-09,4.55564e-12,64510.4,23.8701], Tmin=(100,'K'), Tmax=(1141.31,'K')), NASAPolynomial(coeffs=[14.3778,0.0291886,-1.28337e-05,2.46092e-09,-1.74335e-13,60206.9,-48.3089], Tmin=(1141.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(535.369,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Cyclooctane) + radical(CCsJOCs) + radical(CCsJOOC) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2]C1OC[C]C1O[O](22781)',
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.141907,0.073629,-7.37635e-05,3.93833e-08,-8.07609e-12,57251.3,26.0996], Tmin=(100,'K'), Tmax=(1356.69,'K')), NASAPolynomial(coeffs=[15.5223,0.0194933,-4.19231e-06,4.21674e-10,-1.66692e-14,53886.8,-49.8128], Tmin=(1356.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(474.779,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(ROOJ) + radical(CJC(C)OC) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2]C1OC[C][CH]OO1(22782)',
    structure = SMILES('[CH2]C1OC[C][CH]OO1'),
    E0 = (512.841,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.668853,0.0280209,0.000134111,-2.33272e-07,1.02911e-10,61842.9,29.4656], Tmin=(100,'K'), Tmax=(909.434,'K')), NASAPolynomial(coeffs=[38.3653,-0.0190788,1.6012e-05,-3.17814e-09,2.05238e-13,50077.7,-175.807], Tmin=(909.434,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(512.841,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cycloheptane) + radical(CJCOOH) + radical(CCsJOOC) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C=COC[C]C=O(22783)',
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.07679,'amu*angstrom^2'), symmetry=1, barrier=(24.7576,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07194,'amu*angstrom^2'), symmetry=1, barrier=(24.646,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.07148,'amu*angstrom^2'), symmetry=1, barrier=(24.6355,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.58777,0.0574584,-1.02322e-05,-4.57772e-08,2.68501e-11,11512.6,25.777], Tmin=(100,'K'), Tmax=(923.294,'K')), NASAPolynomial(coeffs=[23.2832,0.00483694,1.00894e-06,-2.82428e-10,1.51502e-14,5373.65,-92.4532], Tmin=(923.294,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.5637,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=COJ) + radical(Cds_S)"""),
)
...
species(
    label = '[O]C[C][CH]O[O](22784)',
    structure = SMILES('[O]C[C][CH]O[O]'),
    E0 = (645.834,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,180,180,180,847.131],'cm^-1')),
        HinderedRotor(inertia=(0.129727,'amu*angstrom^2'), symmetry=1, barrier=(2.98268,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.122193,'amu*angstrom^2'), symmetry=1, barrier=(2.80945,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.128378,'amu*angstrom^2'), symmetry=1, barrier=(2.95166,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (87.0541,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51575,0.0682724,-0.000137191,1.38352e-07,-5.09993e-11,77752.3,24.1177], Tmin=(100,'K'), Tmax=(877.68,'K')), NASAPolynomial(coeffs=[2.64338,0.0300705,-1.53957e-05,2.91831e-09,-1.96483e-13,78827.8,26.0794], Tmin=(877.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(645.834,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(ROOJ) + radical(CCsJOOH) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0124876,0.0922646,-0.000132448,9.81476e-08,-2.86e-11,88052.2,32.7444], Tmin=(100,'K'), Tmax=(844.781,'K')), NASAPolynomial(coeffs=[14.4862,0.0236143,-1.05526e-05,1.95333e-09,-1.32892e-13,85602.5,-34.7579], Tmin=(844.781,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(730.937,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCsJOOH) + radical(CCJ2_triplet) + radical(C=CJO)"""),
)

species(
    label = '[CH][CH]OC[C]=CO[O](21144)',
    structure = SMILES('[CH][CH]OC[C]=CO[O]'),
    E0 = (770.406,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0856121,0.0968271,-0.000156316,1.29217e-07,-4.12339e-11,92798.9,34.3372], Tmin=(100,'K'), Tmax=(875.035,'K')), NASAPolynomial(coeffs=[12.826,0.0250253,-1.13251e-05,2.06104e-09,-1.36634e-13,91028.6,-23.4346], Tmin=(875.035,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(770.406,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(CCsJOCs) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.151335,0.094307,-0.000121961,8.0784e-08,-2.11396e-11,69776.4,32.4889], Tmin=(100,'K'), Tmax=(935.921,'K')), NASAPolynomial(coeffs=[15.9517,0.0254873,-1.16674e-05,2.22344e-09,-1.55465e-13,66762.1,-44.133], Tmin=(935.921,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(578.932,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOOH) + radical(CCJ2_triplet) + radical(C=CJO)"""),
)

species(
    label = '[CH]=COC[C][CH]OO(22787)',
    structure = SMILES('[CH]=COC[C][CH]OO'),
    E0 = (586.284,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.642249,0.0986467,-0.000121315,7.25427e-08,-1.67416e-11,70683.9,31.516], Tmin=(100,'K'), Tmax=(1069.97,'K')), NASAPolynomial(coeffs=[21.185,0.0170469,-6.91854e-06,1.26557e-09,-8.75223e-14,66013.1,-75.2638], Tmin=(1069.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(586.284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOOH) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(4)', 'C=COC[C][CH][O](22774)'],
    products = ['C=COC[C][CH]O[O](20452)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O2(2)', '[CH]=[C]CO[CH][CH2](15939)'],
    products = ['C=COC[C][CH]O[O](20452)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', 'C=COC[C][C]O[O](22775)'],
    products = ['C=COC[C][CH]O[O](20452)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]CO[CH][C][CH]O[O](22777)'],
    products = ['C=COC[C][CH]O[O](20452)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C[CH]O[CH][C][CH]O[O](22778)'],
    products = ['C=COC[C][CH]O[O](20452)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['C=COC[C][CH]O[O](20452)'],
    products = ['[O]OC1[C]CO[CH]C1(22779)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C=COC[C][CH]O[O](20452)'],
    products = ['[C]1[CH]OOC[CH]OC1(22780)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.06679e+09,'s^-1'), n=0.473387, Ea=(44.1763,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6plus;doublebond_intra_pri_2H;radadd_intra] for rate rule [R8_linear;doublebond_intra_pri_2H;radadd_intra_O]
Euclidian distance = 2.23606797749979
family: Intra_R_Add_Endocyclic
Ea raised from 39.4 to 44.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction10',
    reactants = ['C=COC[C][CH]O[O](20452)'],
    products = ['[CH2]C1OC[C]C1O[O](22781)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C=COC[C][CH]O[O](20452)'],
    products = ['[CH2]C1OC[C][CH]OO1(22782)'],
...
reaction(
    label = 'reaction12',
    reactants = ['O(4)', 'C=COC[C]C=O(22783)'],
    products = ['C=COC[C][CH]O[O](20452)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(7.30563e+10,'m^3/(mol*s)'), n=-2.06375, Ea=(153.624,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R_R;O_atom_triplet] for rate rule [Od_R;O_atom_triplet]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 152.3 to 153.6 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['C2H3(60)', '[O]C[C][CH]O[O](22784)'],
    products = ['C=COC[C][CH]O[O](20452)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', 'C=[C]OC[C][CH]O[O](22785)'],
    products = ['C=COC[C][CH]O[O](20452)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH][CH]OC[C]=CO[O](21144)'],
    products = ['C=COC[C][CH]O[O](20452)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.59726e+10,'s^-1'), n=0.976078, Ea=(136.859,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;Cd_rad_out_Cd;Cs_H_out_1H] for rate rule [R5Hall;Cd_rad_out_Cd;Cs_H_out_H/NonDeO]
Euclidian distance = 1.4142135623730951
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(23000,'s^-1'), n=2.11, Ea=(64.7265,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using an average for rate rule [R5Hall;O_rad_out;Cs_H_out_H/NonDeO]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction22',
    reactants = ['C=[C]OC[C][CH]OO(22786)'],
    products = ['C=COC[C][CH]O[O](20452)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]=COC[C][CH]OO(22787)'],
    products = ['C=COC[C][CH]O[O](20452)'],
...
network(
    label = 'PDepNetwork #4699',
    isomers = [
        'C=COC[C][CH]O[O](20452)',
    ],
    reactants = [
