...
species(
    ...
    E0 = (266.679,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.219086,0.100141,-0.000104943,7.20086e-08,-2.19875e-11,28685.9,39.6153], Tmin=(100,'K'), Tmax=(771.275,'K')), NASAPolynomial(coeffs=[7.42856,0.060478,-2.78031e-05,5.32963e-09,-3.73836e-13,27506.2,4.70619], Tmin=(771.275,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(237.3,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(CCJCOOH)"""),
)
...
species(
    label = 'C[CH]C(C)C[CH]C[O](1318)',
    structure = SMILES('C[CH]C(C)C[CH]C[O]'),
    E0 = (242.33,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,244.864,829.94,1106.59,1404.21,1639.84],'cm^-1')),
        HinderedRotor(inertia=(0.132698,'amu*angstrom^2'), symmetry=1, barrier=(3.43698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132698,'amu*angstrom^2'), symmetry=1, barrier=(3.43698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132698,'amu*angstrom^2'), symmetry=1, barrier=(3.43698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132698,'amu*angstrom^2'), symmetry=1, barrier=(3.43698,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.132698,'amu*angstrom^2'), symmetry=1, barrier=(3.43698,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3635,0.0703564,-3.80294e-05,9.69111e-09,-1.02526e-12,29227.3,34.0716], Tmin=(100,'K'), Tmax=(1849.21,'K')), NASAPolynomial(coeffs=[10.0238,0.0516235,-2.28341e-05,4.21298e-09,-2.84656e-13,26024.4,-13.0331], Tmin=(1849.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(242.33,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Cs_S) + radical(CCJCO)"""),
)
...
species(
    label = 'C[C]C(C)C[CH]CO[O](1319)',
    structure = SMILES('C[C]C(C)C[CH]CO[O]'),
    E0 = (494.32,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.45747,0.104368,-0.000112893,7.30978e-08,-2.01282e-11,59608,38.5124], Tmin=(100,'K'), Tmax=(865.019,'K')), NASAPolynomial(coeffs=[10.6343,0.053078,-2.39534e-05,4.55235e-09,-3.17924e-13,57689.1,-13.3905], Tmin=(865.019,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(494.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C[CH]C(C)C[C]CO[O](1320)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.262003,0.10074,-0.00010691,7.00977e-08,-1.99332e-11,58894,38.0644], Tmin=(100,'K'), Tmax=(832.144,'K')), NASAPolynomial(coeffs=[9.13207,0.0555842,-2.55152e-05,4.88959e-09,-3.43092e-13,57330.5,-5.53053], Tmin=(832.144,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(488.448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C[CH]C(C)CC1COO1(1321)',
    structure = SMILES('C[CH]C(C)CC1COO1'),
    E0 = (44.9398,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.319569,0.0820338,-4.94369e-05,1.46369e-08,-1.79262e-12,5535.12,31.4273], Tmin=(100,'K'), Tmax=(1764.86,'K')), NASAPolynomial(coeffs=[15.2471,0.0482011,-2.06817e-05,3.77475e-09,-2.53957e-13,266.108,-49.0693], Tmin=(1764.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.9398,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(Cs_S)"""),
)
...
species(
    label = 'C[CH]C(C)CC1CO1(1322)',
    structure = SMILES('C[CH]C(C)CC1CO1'),
    E0 = (-6.35648,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.178,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.25906,0.0725455,-2.3609e-05,-1.91485e-08,1.32341e-11,-620.935,31.4399], Tmin=(100,'K'), Tmax=(929.935,'K')), NASAPolynomial(coeffs=[13.0185,0.0421497,-1.40786e-05,2.33556e-09,-1.54051e-13,-4052.83,-34.883], Tmin=(929.935,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.35648,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Cs_S)"""),
)

species(
    label = 'CC=C(C)CCCO[O](1323)',
    structure = SMILES('CC=C(C)CCCO[O]'),
    E0 = (-51.7004,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.149131,0.0978138,-9.3346e-05,5.55768e-08,-1.4651e-11,-6074.37,34.0257], Tmin=(100,'K'), Tmax=(883.91,'K')), NASAPolynomial(coeffs=[8.58165,0.0583063,-2.63052e-05,5.01586e-09,-3.51485e-13,-7617.9,-7.01838], Tmin=(883.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-51.7004,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = 'CCC(C)C=CCO[O](969)',
    structure = SMILES('CCC(C)C=CCO[O]'),
    E0 = (-37.7059,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00535284,0.0877209,-6.2805e-05,2.43102e-08,-4.01482e-12,-4391.52,35.7358], Tmin=(100,'K'), Tmax=(1362.04,'K')), NASAPolynomial(coeffs=[12.9054,0.0498365,-2.10835e-05,3.88927e-09,-2.66612e-13,-7905.62,-30.4855], Tmin=(1362.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-37.7059,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = 'C[CH]C(C)CC=COO(1324)',
    structure = SMILES('C[CH]C(C)CC=COO'),
    E0 = (16.6875,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.531104,0.0933042,-6.99297e-05,2.71475e-08,-4.32668e-12,2175.04,39.257], Tmin=(100,'K'), Tmax=(1455.37,'K')), NASAPolynomial(coeffs=[17.8857,0.0426862,-1.77591e-05,3.24931e-09,-2.21471e-13,-3185.57,-56.5044], Tmin=(1455.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.6875,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cs_S)"""),
)

species(
    label = 'C=CC(C)CCCO[O](1177)',
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.191376,0.0923368,-7.14916e-05,3.03271e-08,-5.46335e-12,-3716.52,35.8325], Tmin=(100,'K'), Tmax=(1271.01,'K')), NASAPolynomial(coeffs=[13.3591,0.0496917,-2.11631e-05,3.92882e-09,-2.70928e-13,-7161.07,-32.7903], Tmin=(1271.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-32.1522,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = 'CCC(C)CC=CO[O](728)',
    structure = SMILES('CCC(C)CC=CO[O]'),
    E0 = (-25.8499,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.657881,0.093256,-7.13123e-05,2.87907e-08,-4.75178e-12,-2933.88,37.9177], Tmin=(100,'K'), Tmax=(1423.39,'K')), NASAPolynomial(coeffs=[18.0755,0.0406123,-1.58358e-05,2.80772e-09,-1.8825e-13,-8266.91,-59.0736], Tmin=(1423.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-25.8499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ)"""),
)

species(
    label = 'C[CH]C(C)C=CCOO(1325)',
    structure = SMILES('C[CH]C(C)C=CCOO'),
    E0 = (4.83157,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.142437,0.0876711,-6.11701e-05,2.24351e-08,-3.52059e-12,716.876,37.0363], Tmin=(100,'K'), Tmax=(1405.36,'K')), NASAPolynomial(coeffs=[12.7068,0.0519097,-2.30003e-05,4.3283e-09,-2.99561e-13,-2814.61,-27.8552], Tmin=(1405.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.83157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_S)"""),
)
...
species(
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.605922,0.112465,-0.000155114,1.37684e-07,-4.98155e-11,28001.4,40.2524], Tmin=(100,'K'), Tmax=(821.546,'K')), NASAPolynomial(coeffs=[5.0663,0.0643446,-2.98191e-05,5.63136e-09,-3.87139e-13,27761.4,18.2133], Tmin=(821.546,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(231.528,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Tertalkyl) + radical(CCJCOOH)"""),
)
...
species(
    label = 'C[CH]C(C)CC[CH]O[O](1334)',
    structure = SMILES('C[CH]C(C)CC[CH]O[O]'),
    E0 = (228.815,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.261432,0.101112,-0.00010683,7.41775e-08,-2.29122e-11,27666.8,38.304], Tmin=(100,'K'), Tmax=(763.289,'K')), NASAPolynomial(coeffs=[7.38733,0.0610279,-2.80566e-05,5.37457e-09,-3.76728e-13,26499.2,3.46937], Tmin=(763.289,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(228.815,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2]CC(C)C[CH]CO[O](987)',
    structure = SMILES('[CH2]CC(C)C[CH]CO[O]'),
    E0 = (251.352,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.317024,0.101421,-0.000101526,6.25153e-08,-1.67643e-11,30380.5,39.8912], Tmin=(100,'K'), Tmax=(877.279,'K')), NASAPolynomial(coeffs=[9.40862,0.0570752,-2.56985e-05,4.8899e-09,-3.42083e-13,28674.1,-5.75565], Tmin=(877.279,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(251.352,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]C(C)C[CH][CH]OO(1335)',
    structure = SMILES('C[CH]C(C)C[CH][CH]OO'),
    E0 = (277.225,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.444503,0.106007,-0.000115183,7.98788e-08,-2.43849e-11,33495.1,40.5115], Tmin=(100,'K'), Tmax=(774.044,'K')), NASAPolynomial(coeffs=[8.16591,0.0615094,-2.89498e-05,5.6056e-09,-3.95369e-13,32162.2,1.17693], Tmin=(774.044,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(277.225,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(CCJCOOH) + radical(CCsJOOH)"""),
)

species(
    label = 'CCC(C)[CH][CH]CO[O](984)',
    structure = SMILES('CCC(C)[CH][CH]CO[O]'),
    E0 = (240.647,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH][C](C)CCCO[O](1336)',
    structure = SMILES('C[CH][C](C)CCCO[O]'),
    E0 = (225.655,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.429708,0.109119,-0.000150399,1.36775e-07,-5.07359e-11,27288.2,39.8701], Tmin=(100,'K'), Tmax=(816.971,'K')), NASAPolynomial(coeffs=[3.65317,0.0666843,-3.12784e-05,5.94318e-09,-4.10123e-13,27370.1,25.5819], Tmin=(816.971,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(225.655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Tertalkyl) + radical(Cs_S)"""),
)

species(
    label = '[CH2]C([CH]C)CCCO[O](986)',
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.310736,0.10085,-0.000105404,7.0485e-08,-2.05604e-11,29654.3,40.11], Tmin=(100,'K'), Tmax=(812.37,'K')), NASAPolynomial(coeffs=[8.49986,0.0574662,-2.52965e-05,4.74351e-09,-3.28396e-13,28222.9,-0.564908], Tmin=(812.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(245.315,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][CH]C(C)CCCO[O](1337)',
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.122762,0.0977993,-9.55269e-05,5.94418e-08,-1.65151e-11,29666.5,39.448], Tmin=(100,'K'), Tmax=(839.275,'K')), NASAPolynomial(coeffs=[7.88954,0.0596133,-2.72801e-05,5.23211e-09,-3.67679e-13,28321.6,2.19699], Tmin=(839.275,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(245.479,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = 'CCC(C)C[CH][CH]O[O](989)',
    structure = SMILES('CCC(C)C[CH][CH]O[O]'),
    E0 = (234.688,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.425929,0.104331,-0.000111149,7.46298e-08,-2.18123e-11,28379.5,38.6437], Tmin=(100,'K'), Tmax=(810.641,'K')), NASAPolynomial(coeffs=[8.83826,0.0586143,-2.65504e-05,5.05085e-09,-3.52706e-13,26877.7,-4.10512], Tmin=(810.641,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.688,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CCsJOOH)"""),
)

species(
    label = 'C[CH]C(C)[CH][CH]COO(1338)',
    structure = SMILES('C[CH]C(C)[CH][CH]COO'),
    E0 = (283.185,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2750,2850,1437.5,1250,1305,750,350,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.26406,0.102174,-0.000110466,7.96248e-08,-2.5816e-11,34205.1,42.2682], Tmin=(100,'K'), Tmax=(725.864,'K')), NASAPolynomial(coeffs=[6.78725,0.0633163,-3.01681e-05,5.87595e-09,-4.15781e-13,33181.5,10.5089], Tmin=(725.864,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(283.185,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Cs_S) + radical(CCJCOOH)"""),
)

species(
    label = 'C[CH][C](C)C[CH]COO(1339)',
    structure = SMILES('C[CH][C](C)C[CH]COO'),
    E0 = (274.065,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3000,3050,390,425,1340,1360,335,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.665349,0.114711,-0.000161602,1.46873e-07,-5.44581e-11,33118.7,42.2615], Tmin=(100,'K'), Tmax=(807.307,'K')), NASAPolynomial(coeffs=[4.52441,0.0669964,-3.20689e-05,6.14908e-09,-4.26622e-13,32997.7,22.7751], Tmin=(807.307,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(274.065,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(CCJCOOH) + radical(Cs_S)"""),
)

species(
    label = '[CH2]C([CH]C)C[CH]COO(992)',
    structure = SMILES('[CH2]C([CH]C)C[CH]COO'),
    E0 = (293.725,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.495866,0.105778,-0.000113923,7.64832e-08,-2.2202e-11,35482.7,42.3244], Tmin=(100,'K'), Tmax=(818.037,'K')), NASAPolynomial(coeffs=[9.29033,0.0579249,-2.61756e-05,4.971e-09,-3.4673e-13,33881.6,-2.92263], Tmin=(818.037,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(293.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(CCJCOOH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][CH]C(C)C[CH]COO(1340)',
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.306326,0.102713,-0.000104013,6.54226e-08,-1.81605e-11,35494.8,41.6565], Tmin=(100,'K'), Tmax=(843.365,'K')), NASAPolynomial(coeffs=[8.68782,0.060057,-2.81497e-05,5.45719e-09,-3.85804e-13,33977.6,-0.203342], Tmin=(843.365,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(293.889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(Cs_S) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'C[CH]CC[CH]CO[O](702)'],
...
reaction(
    label = 'reaction3',
    reactants = ['C[CH]C(C)C[CH]CO[O](983)'],
    products = ['CC(C)[CH]C[CH]CO[O](1317)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C[CH]C(C)C[CH]CO[O](983)'],
    products = ['O2(S)(666)', 'C=CCC(C)[CH]C(1172)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction6',
    reactants = ['O(4)', 'C[CH]C(C)C[CH]C[O](1318)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHCH3(T)(21)', 'C[CH]C[CH]CO[O](805)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]CO[O](790)', '[CH2]C(C)[CH]C(114)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]O[O](46)', '[CH]CC(C)[CH]C(1181)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(17)', '[CH]C(C)C[CH]CO[O](847)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C[C]C(C)C[CH]CO[O](1319)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'C[CH]C(C)C[C]CO[O](1320)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C[CH]C(C)C[CH]CO[O](983)'],
    products = ['C[CH]C(C)CC1COO1(1321)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C[CH]C(C)C[CH]CO[O](983)'],
    products = ['O(4)', 'C[CH]C(C)CC1CO1(1322)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', 'CC=C(C)C[CH]CO[O](1326)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C[CH]C(C)C=CCO[O](1327)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', 'C[CH]C(C)CC=CO[O](1328)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', 'C=CC(C)C[CH]CO[O](1329)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH3(17)', 'CC=CC[CH]CO[O](909)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction29',
    reactants = ['O2(2)', 'C=CCC(C)[CH]C(1172)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction30',
    reactants = ['O2(2)', '[CH2][CH]CC(C)[CH]C(591)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH3(17)', 'C[CH][CH]C[CH]CO[O](912)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', 'C[CH][C](C)C[CH]CO[O](1330)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', 'C[CH]C(C)[CH][CH]CO[O](1331)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(3)', '[CH2]C([CH]C)C[CH]CO[O](976)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', 'C[CH]C(C)C[CH][CH]O[O](1332)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(3)', '[CH2][CH]C(C)C[CH]CO[O](1333)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction39',
    reactants = ['C[CH]C(C)[CH]CCO[O](1288)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction40',
    reactants = ['C[CH]C(C)C[CH]CO[O](983)'],
    products = ['C[CH]C(C)CC[CH]O[O](1334)'],
...
reaction(
    label = 'reaction41',
    reactants = ['C[CH]C(C)C[CH]CO[O](983)'],
    products = ['[CH2]CC(C)C[CH]CO[O](987)'],
...
reaction(
    label = 'reaction42',
    reactants = ['C[CH]C(C)C[CH][CH]OO(1335)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction43',
    reactants = ['CCC(C)[CH][CH]CO[O](984)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2]C(CC)C[CH]CO[O](722)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2]C([CH]C)CCCO[O](986)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH2][CH]C(C)CCCO[O](1337)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction48',
    reactants = ['C[CH]C(C)C[CH]CO[O](983)'],
    products = ['CCC(C)C[CH][CH]O[O](989)'],
...
reaction(
    label = 'reaction49',
    reactants = ['C[CH]C(C)[CH][CH]COO(1338)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction50',
    reactants = ['C[CH][C](C)C[CH]COO(1339)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH2]C([CH]C)C[CH]COO(992)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
...
reaction(
    label = 'reaction52',
    reactants = ['[CH2][CH]C(C)C[CH]COO(1340)'],
    products = ['C[CH]C(C)C[CH]CO[O](983)'],
