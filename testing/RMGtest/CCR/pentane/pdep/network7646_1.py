...
species(
    label = 'C[CH][C]CC[O](29256)',
    structure = SMILES('C[CH][C]CC[O]'),
    E0 = (540.455,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53929,0.0624609,-8.7426e-05,8.42918e-08,-3.24827e-11,65082.2,26.8841], Tmin=(100,'K'), Tmax=(832.415,'K')), NASAPolynomial(coeffs=[1.50971,0.043986,-2.0587e-05,3.89384e-09,-2.67455e-13,65732.1,30.8957], Tmin=(832.415,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(540.455,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJC) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C[C][CH]CC[O](29257)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.91875,0.0381505,-1.5788e-05,2.18228e-09,-5.47885e-14,64967.3,17.9364], Tmin=(100,'K'), Tmax=(2879.96,'K')), NASAPolynomial(coeffs=[48.1825,-0.0100443,2.39521e-06,-4.25312e-10,3.25442e-14,33962.9,-251.996], Tmin=(2879.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(540.467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJCC) + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'C[CH]C=CCO(29258)',
    structure = SMILES('CC=C[CH]CO'),
    E0 = (-95.4582,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03043,0.0597944,-4.30763e-05,1.60813e-08,-2.4624e-12,-11369.7,22.451], Tmin=(100,'K'), Tmax=(1512.56,'K')), NASAPolynomial(coeffs=[13.2169,0.0275671,-1.11168e-05,1.99508e-09,-1.34204e-13,-15056.3,-41.3848], Tmin=(1512.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-95.4582,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CCJCO)"""),
)

species(
    label = 'C[CH]CCC=O(1424)',
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.67194,0.0433391,-1.95106e-05,3.62425e-09,-2.37546e-13,-6754.83,21.3081], Tmin=(100,'K'), Tmax=(2727.9,'K')), NASAPolynomial(coeffs=[29.3419,0.00991848,-4.26031e-06,6.61388e-10,-3.60429e-14,-23421.1,-138.001], Tmin=(2727.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-56.4374,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJC)"""),
)
...
species(
    ...
    E0 = (130.247,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,270.243,270.253,2427.13],'cm^-1')),
        HinderedRotor(inertia=(0.729055,'amu*angstrom^2'), symmetry=1, barrier=(37.7934,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244264,'amu*angstrom^2'), symmetry=1, barrier=(12.6612,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.729044,'amu*angstrom^2'), symmetry=1, barrier=(37.7938,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    label = 'C[CH][CH][CH]C[O](29259)',
    structure = SMILES('C[CH][CH][CH]C[O]'),
    E0 = (486.6,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,180,1787.69,1787.71,1788.11],'cm^-1')),
        HinderedRotor(inertia=(0.00167989,'amu*angstrom^2'), symmetry=1, barrier=(3.80548,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.165315,'amu*angstrom^2'), symmetry=1, barrier=(3.80091,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00167548,'amu*angstrom^2'), symmetry=1, barrier=(3.80188,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.164996,'amu*angstrom^2'), symmetry=1, barrier=(3.79359,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03569,0.0547225,-8.34233e-05,9.14794e-08,-3.76143e-11,58584,30.2566], Tmin=(100,'K'), Tmax=(852.161,'K')), NASAPolynomial(coeffs=[-3.11534,0.0497664,-2.34156e-05,4.41329e-09,-3.01321e-13,60519.8,60.4902], Tmin=(852.161,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(486.6,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJC) + radical(CCJCO) + radical(RCCJCC)"""),
)
...
species(
    label = 'C[CH]C[CH]C[O](1616)',
    structure = SMILES('C[CH]C[CH]C[O]'),
    E0 = (292.142,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,180,1612.9,1614.45,1614.57],'cm^-1')),
        HinderedRotor(inertia=(0.204571,'amu*angstrom^2'), symmetry=1, barrier=(4.70348,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205189,'amu*angstrom^2'), symmetry=1, barrier=(4.7177,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205215,'amu*angstrom^2'), symmetry=1, barrier=(4.71829,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00254928,'amu*angstrom^2'), symmetry=1, barrier=(4.71154,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.815,0.0538447,-5.80713e-05,5.36507e-08,-2.17343e-11,35209.6,28.4864], Tmin=(100,'K'), Tmax=(796.49,'K')), NASAPolynomial(coeffs=[0.995246,0.0460902,-2.11107e-05,4.00171e-09,-2.77137e-13,35716.7,34.6186], Tmin=(796.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(292.142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO) + radical(RCCJC)"""),
)

species(
    label = 'C[CH][CH]C[CH]O(1621)',
    structure = SMILES('C[CH][CH]C[CH]O'),
    E0 = (241.291,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,281.274,1395.16,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0824251,'amu*angstrom^2'), symmetry=1, barrier=(2.22245,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0824251,'amu*angstrom^2'), symmetry=1, barrier=(2.22245,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0824251,'amu*angstrom^2'), symmetry=1, barrier=(2.22245,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0824251,'amu*angstrom^2'), symmetry=1, barrier=(2.22245,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0824251,'amu*angstrom^2'), symmetry=1, barrier=(2.22245,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26177,0.0707789,-0.000108543,1.04723e-07,-3.889e-11,29109,29.2282], Tmin=(100,'K'), Tmax=(867.965,'K')), NASAPolynomial(coeffs=[1.50951,0.0446569,-2.02297e-05,3.73313e-09,-2.51197e-13,30007,33.4885], Tmin=(867.965,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(241.291,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC) + radical(CCsJOH)"""),
)
...
species(
    label = 'C[CH][CH][CH]CO(29260)',
    structure = SMILES('C[CH][CH][CH]CO'),
    E0 = (260.895,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70461,0.0570747,-6.96109e-05,6.41994e-08,-2.44591e-11,31454.7,30.5862], Tmin=(100,'K'), Tmax=(838.915,'K')), NASAPolynomial(coeffs=[1.51424,0.0434583,-1.92952e-05,3.57743e-09,-2.4349e-13,31997.7,34.5173], Tmin=(838.915,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(260.895,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJC) + radical(RCCJCC)"""),
)
...
species(
    label = '[CH2][CH]CCC[O](1622)',
    structure = SMILES('[CH2][CH]CCC[O]'),
    E0 = (297.486,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,180,1513.31,1513.37,1513.38],'cm^-1')),
        HinderedRotor(inertia=(0.203947,'amu*angstrom^2'), symmetry=1, barrier=(4.68915,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203961,'amu*angstrom^2'), symmetry=1, barrier=(4.68947,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00288566,'amu*angstrom^2'), symmetry=1, barrier=(4.68973,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203956,'amu*angstrom^2'), symmetry=1, barrier=(4.68934,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.46601,0.0404004,-1.59913e-05,1.98405e-09,-4.38285e-15,35768.9,21.6905], Tmin=(100,'K'), Tmax=(2682.42,'K')), NASAPolynomial(coeffs=[36.4398,0.00376259,-2.51164e-06,3.75637e-10,-1.68064e-14,13570.2,-178.329], Tmin=(2682.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(297.486,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJC) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54505,0.0630569,-8.88495e-05,8.62045e-08,-3.28748e-11,32100.8,30.4484], Tmin=(100,'K'), Tmax=(854.652,'K')), NASAPolynomial(coeffs=[0.772642,0.0454072,-2.05505e-05,3.8155e-09,-2.58685e-13,33009.5,38.597], Tmin=(854.652,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(266.239,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C[O](1358)', '[CH][CH]C(3874)'],
    products = ['C[CH][CH]CC[O](1619)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(4)', '[CH2]C[CH][CH]C(123)'],
    products = ['C[CH][CH]CC[O](1619)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', '[CH][CH]CC[O](29076)'],
    products = ['C[CH][CH]CC[O](1619)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', 'C[CH][C]CC[O](29256)'],
    products = ['C[CH][CH]CC[O](1619)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'C[C][CH]CC[O](29257)'],
    products = ['C[CH][CH]CC[O](1619)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', 'CC=C[CH]C[O](29161)'],
    products = ['C[CH][CH]CC[O](1619)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH2]C=CCC[O](1846)'],
    products = ['C[CH][CH]CC[O](1619)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'C[CH][CH][CH]C[O](29259)'],
    products = ['C[CH][CH]CC[O](1619)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'C[CH][CH]C[CH][O](1614)'],
    products = ['C[CH][CH]CC[O](1619)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH2][CH][CH]CC[O](1855)'],
    products = ['C[CH][CH]CC[O](1619)'],
