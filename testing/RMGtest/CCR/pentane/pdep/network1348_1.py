...
species(
    label = '[CH2][CH][C]COC=C(5572)',
    structure = SMILES('[CH2][CH][C]COC=C'),
    E0 = (614.84,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.300484,0.0728924,-6.04793e-05,1.99838e-08,-5.0473e-13,74088.9,30.878], Tmin=(100,'K'), Tmax=(989.33,'K')), NASAPolynomial(coeffs=[17.198,0.0212506,-7.46664e-06,1.29962e-09,-8.89428e-14,69929.3,-54.5862], Tmin=(989.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(614.84,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][C][CH]COC=C(5573)',
    structure = SMILES('[CH2][C][CH]COC=C'),
    E0 = (620.296,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.284556,0.0676041,-3.28325e-05,-1.761e-08,1.49468e-11,74751,30.6965], Tmin=(100,'K'), Tmax=(946.992,'K')), NASAPolynomial(coeffs=[20.9171,0.0149796,-4.16413e-06,7.06552e-10,-5.20614e-14,69295.2,-75.8937], Tmin=(946.992,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(620.296,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH2][CH][CH][CH]OC[CH2](5575)',
    structure = SMILES('[CH2][CH][CH][CH]OC[CH2]'),
    E0 = (670.706,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2][CH]C[CH]OC=C(5583)',
    structure = SMILES('[CH2][CH]C[CH]OC=C'),
    E0 = (360.553,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.380707,0.0834566,-8.21387e-05,4.07746e-08,-7.8407e-12,43533.1,32.8966], Tmin=(100,'K'), Tmax=(1332.7,'K')), NASAPolynomial(coeffs=[20.4301,0.0181764,-5.49161e-06,8.46179e-10,-5.29051e-14,38236.5,-72.5415], Tmin=(1332.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(360.553,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(CCsJOC(O)) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH]CCO[C]=C(4284)',
    structure = SMILES('[CH2][CH]CCO[C]=C'),
    E0 = (406.369,'kJ/mol'),
    modes = [
...
species(
    label = '[CH]=COCC[CH][CH2](5585)',
    structure = SMILES('[CH]=COCC[CH][CH2]'),
    E0 = (413.721,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.26328,0.0735432,-5.82402e-05,1.84458e-08,-3.41198e-13,49901.3,31.5094], Tmin=(100,'K'), Tmax=(1004.08,'K')), NASAPolynomial(coeffs=[16.6719,0.0242774,-8.69644e-06,1.52197e-09,-1.0394e-13,45794.5,-51.7614], Tmin=(1004.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(413.721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(RCCJ) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.256517,0.0681508,-3.02539e-05,-1.9542e-08,1.52533e-11,50563,31.2948], Tmin=(100,'K'), Tmax=(951.902,'K')), NASAPolynomial(coeffs=[20.3263,0.0181144,-5.4554e-06,9.43275e-10,-6.82429e-14,45188.2,-72.7036], Tmin=(951.902,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(419.177,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(RCCJ) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH][CH][CH2](5537)', 'CH2OCHCH2(5571)'],
    products = ['[CH2][CH][CH]COC=C(4286)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH2][CH][C]COC=C(5572)'],
    products = ['[CH2][CH][CH]COC=C(4286)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2][C][CH]COC=C(5573)'],
    products = ['[CH2][CH][CH]COC=C(4286)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][CH][CH][CH]OC[CH2](5575)'],
    products = ['[CH2][CH][CH]COC=C(4286)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][CH][CH][CH]O[CH]C(5576)'],
    products = ['[CH2][CH][CH]COC=C(4286)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C=C[CH][CH]OC=C(5382)'],
    products = ['[CH2][CH][CH]COC=C(4286)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.6e+11,'cm^3/(mol*s)'), n=0, Ea=(85.281,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using an average for rate rule [Cd_R;O_rad/OneDe]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 81.2 to 85.3 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['C2H3(60)', '[CH2][CH][CH]C[O](5580)'],
    products = ['[CH2][CH][CH]COC=C(4286)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2][CH][CH][CH]OC=C(5581)'],
    products = ['[CH2][CH][CH]COC=C(4286)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH2][CH][CH]CO[C]=C(4279)'],
    products = ['[CH2][CH][CH]COC=C(4286)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2][CH][CH]COC=C(4286)'],
    products = ['[CH2][CH]C[CH]OC=C(5583)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2]C[CH]CO[C]=C(2545)'],
    products = ['[CH2][CH][CH]COC=C(4286)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]=COC[CH]C[CH2](5586)'],
    products = ['[CH2][CH][CH]COC=C(4286)'],
