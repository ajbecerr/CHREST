species(
    ...
    E0 = (89.6972,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2175,525,750,770,3400,2100,341.177,341.178,341.191,341.21],'cm^-1')),
        HinderedRotor(inertia=(0.237299,'amu*angstrom^2'), symmetry=1, barrier=(19.6032,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.237334,'amu*angstrom^2'), symmetry=1, barrier=(19.6033,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.337211,'amu*angstrom^2'), symmetry=1, barrier=(27.8541,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38746,0.0578276,-6.20371e-05,3.48144e-08,-7.85329e-12,10881.9,19.0865], Tmin=(100,'K'), Tmax=(1071.08,'K')), NASAPolynomial(coeffs=[11.5679,0.0198076,-8.79075e-06,1.67195e-09,-1.17391e-13,8701.14,-30.727], Tmin=(1071.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(89.6972,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCOJ)"""),
)
...
species(
    label = '[C]1=COCCO1(3600)',
    structure = SMILES('[C]1=COCCO1'),
    E0 = (-43.5115,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18225,0.0194748,6.89362e-05,-1.23762e-07,5.67353e-11,-5148.13,12.4515], Tmin=(100,'K'), Tmax=(869.982,'K')), NASAPolynomial(coeffs=[19.1953,-0.00192353,7.85568e-06,-1.87822e-09,1.35851e-13,-10258.8,-79.6162], Tmin=(869.982,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-43.5115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + ring(23dihydro14dioxin) + radical(C=CJO)"""),
)

species(
    label = '[CH]=C1OCCO1(3601)',
    structure = SMILES('[CH]=C1OCCO1'),
    E0 = (9.55975,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90158,0.02347,6.25082e-05,-1.12153e-07,4.87155e-11,1246.35,15.1426], Tmin=(100,'K'), Tmax=(924.554,'K')), NASAPolynomial(coeffs=[20.4291,0.00182787,2.68413e-06,-5.59988e-10,3.02538e-14,-4680.56,-86.314], Tmin=(924.554,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(9.55975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(Cds_P)"""),
)
...
species(
    label = 'C#COC[CH]O(3605)',
    structure = SMILES('C#COC[CH]O'),
    E0 = (44.2899,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2175,525,750,770,3400,2100,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.949781,'amu*angstrom^2'), symmetry=1, barrier=(21.8373,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.94991,'amu*angstrom^2'), symmetry=1, barrier=(21.8403,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.949844,'amu*angstrom^2'), symmetry=1, barrier=(21.8388,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.949779,'amu*angstrom^2'), symmetry=1, barrier=(21.8373,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.548812,0.0718403,-9.02045e-05,5.46943e-08,-1.26773e-11,5454.67,20.7794], Tmin=(100,'K'), Tmax=(1071.52,'K')), NASAPolynomial(coeffs=[17.219,0.00961053,-3.09038e-06,4.946e-10,-3.17647e-14,1882.18,-60.796], Tmin=(1071.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.2899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCsJOH)"""),
)

species(
    label = 'C#CO[CH]CO(3606)',
    structure = SMILES('C#CO[CH]CO'),
    E0 = (44.4481,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.24037,0.0734156,-8.98773e-05,5.15641e-08,-1.1081e-11,5489.24,21.7802], Tmin=(100,'K'), Tmax=(1250.34,'K')), NASAPolynomial(coeffs=[19.9501,0.00443965,-2.4092e-08,-1.32598e-10,1.29385e-14,1023.39,-75.8599], Tmin=(1250.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.4481,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCsJOCs)"""),
)
...
species(
    ...
    E0 = (201.136,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2175,525,316.107,316.541,316.868,317.06],'cm^-1')),
        HinderedRotor(inertia=(0.216301,'amu*angstrom^2'), symmetry=1, barrier=(15.457,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.217174,'amu*angstrom^2'), symmetry=1, barrier=(15.4579,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.422533,'amu*angstrom^2'), symmetry=1, barrier=(30.1554,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21781,'amu*angstrom^2'), symmetry=1, barrier=(15.4592,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.868676,0.0663079,-8.037e-05,4.77178e-08,-1.06176e-11,24306.1,20.8254], Tmin=(100,'K'), Tmax=(925.161,'K')), NASAPolynomial(coeffs=[14.9045,0.0124183,-4.01427e-06,6.35409e-10,-4.01811e-14,21418.2,-47.3693], Tmin=(925.161,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.136,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(Acetyl)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['C#COCC[O](2340)'],
    products = ['[CH]=C1OCCO1(3601)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(132522,'s^-1'), n=1.48406, Ea=(26.3859,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R6_SSS;multiplebond_intra;radadd_intra] for rate rule [R6_SSS_T;triplebond_intra_H;radadd_intra_O]
Euclidian distance = 2.449489742783178
...
reaction(
    label = 'reaction6',
    reactants = ['CH2O(3111)', 'C#CO[CH2](3066)'],
    products = ['C#COCC[O](2340)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['HCCO(2227)', '[CH2]C[O](1358)'],
    products = ['C#COCC[O](2340)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['HC2(2881)', '[O]CC[O](3602)'],
    products = ['C#COCC[O](2340)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][O](3109)', 'C#CO[CH2](3066)'],
    products = ['C#COCC[O](2340)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'C#CO[CH]C[O](3603)'],
    products = ['C#COCC[O](2340)'],
