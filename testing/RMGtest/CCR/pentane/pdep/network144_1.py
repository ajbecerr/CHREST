species(
    ...
    E0 = (40.5393,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([655.335,655.335,655.338,3392.56,3392.56],'cm^-1')),
        HinderedRotor(inertia=(0.00280963,'amu*angstrom^2'), symmetry=1, barrier=(0.856255,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (49.0061,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.63394,0.0032826,1.60671e-05,-2.8916e-08,1.34739e-11,4893.52,10.6841], Tmin=(100,'K'), Tmax=(862.254,'K')), NASAPolynomial(coeffs=[7.76351,-0.00247589,2.77616e-06,-6.1846e-10,4.43003e-14,3683.29,-11.5149], Tmin=(862.254,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(40.5393,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(78.9875,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsOs) + group(O2s-OsH) + group(O2s-OsH) + radical(ROOJ)"""),
)
