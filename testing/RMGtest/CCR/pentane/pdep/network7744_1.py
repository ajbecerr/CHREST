...
species(
    ...
    molecularWeight = (56.0633,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.45507,-0.00220263,7.24454e-05,-9.26502e-08,3.52768e-11,4953.89,10.1696], Tmin=(100,'K'), Tmax=(945.854,'K')), NASAPolynomial(coeffs=[9.50812,0.00847921,-2.03e-06,3.9514e-10,-3.46504e-14,2185.95,-27.2748], Tmin=(945.854,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(40.9181,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), label="""oxetene""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
species(
    label = '[CH]=[C]OC(9544)',
    structure = SMILES('[CH]=[C]OC'),
    E0 = (338.881,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,207.933],'cm^-1')),
        HinderedRotor(inertia=(0.50251,'amu*angstrom^2'), symmetry=1, barrier=(15.8893,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.498074,'amu*angstrom^2'), symmetry=1, barrier=(15.8892,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (56.0633,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.53116,0.0255658,-3.74151e-06,-1.83298e-08,1.04212e-11,40817.1,15.6577], Tmin=(100,'K'), Tmax=(927.157,'K')), NASAPolynomial(coeffs=[10.8838,0.00685756,-1.50752e-06,2.20879e-10,-1.59669e-14,38523.5,-28.0237], Tmin=(927.157,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(338.881,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CO[CH2](7184)'],
    products = ['CH2O(3111)', 'C2H2(1342)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(20)', 'ketene(T)(1373)'],
    products = ['[CH]=CO[CH2](7184)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2O(3111)', 'C2H2(T)(1343)'],
    products = ['[CH]=CO[CH2](7184)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH2][O](3109)', 'C2H2(T)(1343)'],
    products = ['[CH]=CO[CH2](7184)'],
    transitionState = 'TS8',
