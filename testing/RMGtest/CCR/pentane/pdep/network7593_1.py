...
species(
    label = '[CH2]OC[CH]C[O](29414)',
    structure = SMILES('[CH2]OC[CH]C[O]'),
    E0 = (193.946,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,185.067,208.2,1217.66,1335.1,3268.71],'cm^-1')),
        HinderedRotor(inertia=(0.0982394,'amu*angstrom^2'), symmetry=1, barrier=(2.36565,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0982394,'amu*angstrom^2'), symmetry=1, barrier=(2.36565,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0982394,'amu*angstrom^2'), symmetry=1, barrier=(2.36565,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0982394,'amu*angstrom^2'), symmetry=1, barrier=(2.36565,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74598,0.054381,-6.56589e-05,5.64457e-08,-2.0818e-11,23402.8,27.2412], Tmin=(100,'K'), Tmax=(791.733,'K')), NASAPolynomial(coeffs=[3.92183,0.0359121,-1.65042e-05,3.12917e-09,-2.1663e-13,23292.6,18.7318], Tmin=(791.733,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(193.946,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + radical(CCOJ) + radical(CCJCO) + radical(CsJOCC)"""),
)
...
species(
    label = '[CH2]OC[C]CO[O](29415)',
    structure = SMILES('[CH2]OC[C]CO[O]'),
    E0 = (440.063,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.688124,0.0791684,-0.000118841,9.99443e-08,-3.32768e-11,53040.6,29.107], Tmin=(100,'K'), Tmax=(846.946,'K')), NASAPolynomial(coeffs=[8.7389,0.0305412,-1.3937e-05,2.58656e-09,-1.75115e-13,52057.2,-6.15059], Tmin=(846.946,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(440.063,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + radical(ROOJ) + radical(CsJOCC) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.60343,0.0559858,-4.3733e-05,1.9639e-08,-3.91441e-12,-330.767,21.3168], Tmin=(100,'K'), Tmax=(1124.38,'K')), NASAPolynomial(coeffs=[7.52775,0.0349096,-1.56155e-05,2.9673e-09,-2.075e-13,-1662.99,-7.9591], Tmin=(1124.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-3.44437,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + ring(12dioxetane) + radical(CsJOCC)"""),
)

species(
    label = '[CH2]OCC1CO1(29417)',
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.906161,0.0542147,-4.54005e-05,2.15677e-08,-3.95814e-12,-6460.51,23.5928], Tmin=(100,'K'), Tmax=(1579.03,'K')), NASAPolynomial(coeffs=[10.7821,0.0199203,-4.01002e-06,3.71927e-10,-1.32524e-14,-8422.89,-24.9021], Tmin=(1579.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-54.7406,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + ring(Ethylene_oxide) + radical(CsJOCC)"""),
)

species(
    label = 'COC=CCO[O](29418)',
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.683193,0.0650019,-5.18166e-05,1.56479e-08,1.96805e-13,-13537.8,25.8392], Tmin=(100,'K'), Tmax=(996.664,'K')), NASAPolynomial(coeffs=[15.7834,0.019829,-7.05273e-06,1.23879e-09,-8.51989e-14,-17314.1,-50.8045], Tmin=(996.664,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-113.611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]OCC=COO(29419)',
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01547,0.0642818,-5.95706e-05,2.96036e-08,-6.00821e-12,-2632.71,28.563], Tmin=(100,'K'), Tmax=(1174.67,'K')), NASAPolynomial(coeffs=[12.1877,0.026238,-1.09903e-05,2.0325e-09,-1.40365e-13,-5257.44,-27.135], Tmin=(1174.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-22.7925,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CsJOCC)"""),
)

species(
    label = 'COCC=CO[O](28824)',
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34171,0.0623321,-6.64158e-05,4.38266e-08,-1.24618e-11,-6950.77,26.4723], Tmin=(100,'K'), Tmax=(835.37,'K')), NASAPolynomial(coeffs=[7.31267,0.0337401,-1.50734e-05,2.85098e-09,-1.98487e-13,-7948.32,-1.25982], Tmin=(835.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-58.5593,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]OC=CCOO(29420)',
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.516026,0.0667131,-4.94668e-05,9.79456e-09,2.74564e-12,-8718.82,28.1664], Tmin=(100,'K'), Tmax=(1000.99,'K')), NASAPolynomial(coeffs=[17.6455,0.0182161,-6.69365e-06,1.22114e-09,-8.66634e-14,-13147.7,-59.4836], Tmin=(1000.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-73.6081,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COCJ)"""),
)

species(
    label = '[CH2]OC=CCO[O](29421)',
    structure = SMILES('[CH2]OC=CCO[O]'),
    E0 = (78.3966,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,316.559,316.623,316.629],'cm^-1')),
        HinderedRotor(inertia=(0.0016845,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211239,'amu*angstrom^2'), symmetry=1, barrier=(15.0084,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211258,'amu*angstrom^2'), symmetry=1, barrier=(15.0104,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.211527,'amu*angstrom^2'), symmetry=1, barrier=(15.0108,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.804571,0.0628456,-5.32915e-05,1.81059e-08,-6.60775e-13,9550.57,27.889], Tmin=(100,'K'), Tmax=(992.179,'K')), NASAPolynomial(coeffs=[15.7512,0.0170777,-6.00448e-06,1.05188e-09,-7.24746e-14,5871.42,-47.6966], Tmin=(992.179,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(78.3966,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(C=COCJ)"""),
)
...
species(
    ...
    molecularWeight = (102.089,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.436814,0.0854815,-0.000135499,1.14432e-07,-3.7438e-11,44949.3,31.854], Tmin=(100,'K'), Tmax=(876.444,'K')), NASAPolynomial(coeffs=[9.953,0.0278041,-1.24046e-05,2.25316e-09,-1.49553e-13,43828.4,-9.67953], Tmin=(876.444,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(372.719,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CCsJOCs) + radical(CsJOCC)"""),
)
...
species(
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.740917,0.0788977,-0.000116362,1.00619e-07,-3.46256e-11,21811.2,29.161], Tmin=(100,'K'), Tmax=(844.138,'K')), NASAPolynomial(coeffs=[6.99154,0.0359814,-1.64725e-05,3.06944e-09,-2.08531e-13,21229.7,2.87066], Tmin=(844.138,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.431,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + radical(ROOJ) + radical(CCsJOOH) + radical(CsJOCC)"""),
)

species(
    label = 'CO[CH][CH]CO[O](29426)',
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.407802,0.0883636,-0.000142685,1.2678e-07,-4.3655e-11,22364.5,30.2677], Tmin=(100,'K'), Tmax=(861.564,'K')), NASAPolynomial(coeffs=[7.7137,0.0351372,-1.64021e-05,3.05414e-09,-2.06132e-13,21822.1,0.268232], Tmin=(861.564,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CCsJOCs)"""),
)

species(
    label = '[CH2]OC[CH][CH]OO(29427)',
    structure = SMILES('[CH2]OC[CH][CH]OO'),
    E0 = (228.841,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.506165,0.0844737,-0.00012747,1.10511e-07,-3.82068e-11,27641.7,31.5495], Tmin=(100,'K'), Tmax=(826.572,'K')), NASAPolynomial(coeffs=[7.87885,0.0362652,-1.72463e-05,3.2713e-09,-2.24691e-13,26850.9,-0.0259314], Tmin=(826.572,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(228.841,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + radical(CCJCOOH) + radical(CCsJOOH) + radical(CsJOCC)"""),
)

species(
    label = 'COC[CH][CH]O[O](29428)',
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.71144,0.0841234,-0.000140628,1.3373e-07,-4.87573e-11,23328.5,29.8803], Tmin=(100,'K'), Tmax=(855.709,'K')), NASAPolynomial(coeffs=[4.10305,0.0418453,-2.01977e-05,3.81823e-09,-2.60018e-13,23715.5,19.6991], Tmin=(855.709,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(193.074,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2]O[CH][CH]COO(29429)',
    ...
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.218242,0.088508,-0.0001287,1.02311e-07,-3.24775e-11,26677,31.8818], Tmin=(100,'K'), Tmax=(816.883,'K')), NASAPolynomial(coeffs=[11.4611,0.0296086,-1.34818e-05,2.5148e-09,-1.7145e-13,24968.5,-19.2988], Tmin=(816.883,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(220.715,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + radical(CCJCOOH) + radical(CCsJOCs) + radical(CsJOCC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC[CH]CO[O](28818)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]OC[CH]CO[O](28818)'],
    products = ['O2(S)(666)', '[CH2]OCC=C(28817)'],
    transitionState = 'TS2',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction4',
    reactants = ['O(4)', '[CH2]OC[CH]C[O](29414)'],
    products = ['[CH2]OC[CH]CO[O](28818)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]CO[O](790)', '[CH2]O[CH2](3113)'],
    products = ['[CH2]OC[CH]CO[O](28818)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]O[O](46)', '[CH]CO[CH2](28984)'],
    products = ['[CH2]OC[CH]CO[O](28818)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH2]OC[C]CO[O](29415)'],
    products = ['[CH2]OC[CH]CO[O](28818)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]OC[CH]CO[O](3555)'],
    products = ['[CH2]OC[CH]CO[O](28818)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]OC[CH]CO[O](28818)'],
    products = ['O(4)', '[CH2]OCC1CO1(29417)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]OC=CCO[O](29421)'],
    products = ['[CH2]OC[CH]CO[O](28818)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2]OCC=CO[O](29422)'],
    products = ['[CH2]OC[CH]CO[O](28818)'],
...
reaction(
    label = 'reaction19',
    reactants = ['O2(2)', '[CH2]OCC=C(28817)'],
    products = ['[CH2]OC[CH]CO[O](28818)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O2(2)', '[CH2][CH]CO[CH2](28814)'],
    products = ['[CH2]OC[CH]CO[O](28818)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2]O[CH][CH]CO[O](29423)'],
    products = ['[CH2]OC[CH]CO[O](28818)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH2]OC[CH][CH]O[O](29424)'],
    products = ['[CH2]OC[CH]CO[O](28818)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]OC[CH][CH]OO(29427)'],
    products = ['[CH2]OC[CH]CO[O](28818)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]O[CH][CH]COO(29429)'],
    products = ['[CH2]OC[CH]CO[O](28818)'],
...
network(
    label = 'PDepNetwork #7593',
    isomers = [
        '[CH2]OC[CH]CO[O](28818)',
    ],
    reactants = [
