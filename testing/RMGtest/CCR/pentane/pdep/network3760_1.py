...
species(
    label = '[CH]=[C]CC[C]C(16998)',
    structure = SMILES('[CH]=[C]CC[C]C'),
    E0 = (869.071,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,304.277,304.278,304.281],'cm^-1')),
        HinderedRotor(inertia=(0.00182071,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.168631,'amu*angstrom^2'), symmetry=1, barrier=(11.0792,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.322425,'amu*angstrom^2'), symmetry=1, barrier=(21.1842,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16864,'amu*angstrom^2'), symmetry=1, barrier=(11.0792,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37198,0.0589669,-5.05912e-05,2.42577e-08,-4.92883e-12,104619,24.785], Tmin=(100,'K'), Tmax=(1144.96,'K')), NASAPolynomial(coeffs=[9.54773,0.0304046,-1.31725e-05,2.47051e-09,-1.71683e-13,102746,-15.7651], Tmin=(1144.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(869.071,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[C]=[C]CC[CH]C(16999)',
    structure = SMILES('[C]=[C]CC[CH]C'),
    E0 = (926.308,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1685,370,217.915,1674.59,1674.59],'cm^-1')),
        HinderedRotor(inertia=(0.00354996,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241007,'amu*angstrom^2'), symmetry=1, barrier=(8.12143,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241009,'amu*angstrom^2'), symmetry=1, barrier=(8.12145,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.241009,'amu*angstrom^2'), symmetry=1, barrier=(8.12145,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.51099,0.0608048,-7.80011e-05,6.94465e-08,-2.57302e-11,111493,27.0876], Tmin=(100,'K'), Tmax=(814.786,'K')), NASAPolynomial(coeffs=[3.51292,0.0396435,-1.81796e-05,3.42854e-09,-2.35987e-13,111543,20.148], Tmin=(814.786,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(926.308,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(Cds_S) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['CHCH3(T)(21)', '[CH]=[C]C[CH2](9654)'],
    products = ['[CH]=[C]CC[CH]C(15215)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=[CH](9646)', '[CH2]C[CH]C(36)'],
    products = ['[CH]=[C]CC[CH]C(15215)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', '[CH]CC[C]=[CH](16930)'],
    products = ['[CH]=[C]CC[CH]C(15215)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]=[C]CC[C]C(16998)'],
    products = ['[CH]=[C]CC[CH]C(15215)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[C]=[C]CC[CH]C(16999)'],
    products = ['[CH]=[C]CC[CH]C(15215)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
