species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.26575,'amu*angstrom^2'), symmetry=1, barrier=(29.102,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27071,'amu*angstrom^2'), symmetry=1, barrier=(29.216,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26877,'amu*angstrom^2'), symmetry=1, barrier=(29.1715,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.26821,'amu*angstrom^2'), symmetry=1, barrier=(29.1586,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.49802,'amu*angstrom^2'), symmetry=1, barrier=(34.4423,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.49888,'amu*angstrom^2'), symmetry=1, barrier=(34.4622,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3275,0.0401583,-3.87762e-05,2.12742e-08,-5.05632e-12,22824,15.1398], Tmin=(100,'K'), Tmax=(976.234,'K')), NASAPolynomial(coeffs=[6.78205,0.0219063,-1.07316e-05,2.1226e-09,-1.51848e-13,21954.3,-6.24364], Tmin=(976.234,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.292,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCt) + group(Cs-OsHHH) + group(Ct-CtOs) + group(Ct-CtH)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.401685,'amu*angstrom^2'), symmetry=1, barrier=(9.23554,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.401391,'amu*angstrom^2'), symmetry=1, barrier=(9.22878,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.401537,'amu*angstrom^2'), symmetry=1, barrier=(9.23214,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.9017,'amu*angstrom^2'), symmetry=1, barrier=(43.7238,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17683,0.0711071,-0.000115645,1.0932e-07,-4.04548e-11,36918.4,22.0273], Tmin=(100,'K'), Tmax=(825.404,'K')), NASAPolynomial(coeffs=[4.70134,0.0356831,-1.79334e-05,3.47459e-09,-2.4106e-13,36961.5,9.4851], Tmin=(825.404,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(306.184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdOsH) + group(CdJ2_singlet-Cds)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C#COOCC(3202)'],
    products = ['ketene(1375)', 'CH3CHO(1381)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(6.59828e+17,'s^-1'), n=-1.73308, Ea=(45.345,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.16692063000437535, var=8.814681701569807, Tref=1000.0, N=65, correlation='Root',), comment="""BM rule fitted to 2 training reactions at node Root
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'C#COOC(3499)'],
    products = ['C#COOCC(3202)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['HCCO(2227)', 'CH3CH2O(56)'],
    products = ['C#COOCC(3202)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['HC2(2881)', 'CH3CH2OO(25)'],
    products = ['C#COOCC(3202)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', 'C#COO[CH2](2887)'],
    products = ['C#COOCC(3202)'],
    transitionState = 'TS6',
