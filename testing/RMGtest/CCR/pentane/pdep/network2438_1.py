...
species(
    label = '[CH][CH]CO[C]=[CH](9857)',
    structure = SMILES('[CH][CH]CO[C]=[CH]'),
    E0 = (925.67,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.740697,0.0606829,-6.31982e-05,3.19509e-08,-6.13652e-12,111459,29.6632], Tmin=(100,'K'), Tmax=(1392.41,'K')), NASAPolynomial(coeffs=[17.2533,0.00858014,-2.04216e-06,2.63232e-10,-1.49795e-14,107313,-53.8424], Tmin=(1392.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(925.67,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(CCJ2_triplet) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]OC[C][CH]C(10350)',
    structure = SMILES('[CH]=[C]OC[C][CH]C'),
    E0 = (896.434,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.627787,0.0746619,-8.34752e-05,5.02864e-08,-1.21729e-11,107937,31.4547], Tmin=(100,'K'), Tmax=(1003.67,'K')), NASAPolynomial(coeffs=[12.8451,0.0259715,-1.07069e-05,1.95171e-09,-1.33446e-13,105485,-27.5316], Tmin=(1003.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(896.434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(CCJ2_triplet) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]OC[CH][C]C(10351)',
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.140488,0.0749438,-7.531e-05,3.78667e-08,-7.39366e-12,108620,32.9627], Tmin=(100,'K'), Tmax=(1259.94,'K')), NASAPolynomial(coeffs=[18.6245,0.0162619,-5.44773e-06,9.00956e-10,-5.88816e-14,103962,-60.483], Tmin=(1259.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(901.89,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(CCJ2_triplet) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[C]=[C]OC[CH][CH]C(10352)',
    structure = SMILES('[C]=[C]OC[CH][CH]C'),
    E0 = (959.127,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.957661,0.0686727,-7.37077e-05,4.41594e-08,-1.08521e-11,115464,32.8389], Tmin=(100,'K'), Tmax=(979.477,'K')), NASAPolynomial(coeffs=[10.8031,0.0284658,-1.21339e-05,2.25022e-09,-1.55296e-13,113536,-14.4555], Tmin=(979.477,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(959.127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(RCCJC) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)
...
species(
    label = '[CH]=COC=C[CH]C(10353)',
    structure = SMILES('[CH]=CO[CH]C=CC'),
    E0 = (246.062,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.674628,0.0615512,-2.91574e-05,-1.01659e-08,9.31625e-12,29724.4,26.8663], Tmin=(100,'K'), Tmax=(992.401,'K')), NASAPolynomial(coeffs=[16.6895,0.0223488,-8.21602e-06,1.50347e-09,-1.06985e-13,25297.6,-56.5627], Tmin=(992.401,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(246.062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CCJ(O)C) + radical(Cds_P)"""),
)
...
species(
    ...
    E0 = (485.806,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,283.623,283.971,4000],'cm^-1')),
        HinderedRotor(inertia=(0.379919,'amu*angstrom^2'), symmetry=1, barrier=(21.5625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.885897,'amu*angstrom^2'), symmetry=1, barrier=(50.3618,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.379707,'amu*angstrom^2'), symmetry=1, barrier=(21.5674,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.376798,'amu*angstrom^2'), symmetry=1, barrier=(21.5669,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (95.1192,'amu'),
...
species(
    label = '[CH]=[C]O[CH][CH][CH]C(10354)',
    structure = SMILES('[CH][C]OC=C[CH]C'),
    E0 = (806.138,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.170434,0.0690601,-3.65909e-05,-1.69575e-08,1.54911e-11,97107.8,25.7769], Tmin=(100,'K'), Tmax=(947.029,'K')), NASAPolynomial(coeffs=[22.8819,0.0103004,-2.39099e-06,4.08864e-10,-3.32473e-14,91139.4,-91.3563], Tmin=(947.029,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(806.138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_S) + radical(CH2_triplet) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]=[C]O[CH]C[CH]C(10355)',
    structure = SMILES('[CH]=[C]O[CH]C[CH]C'),
    E0 = (642.147,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.26922,0.0815376,-9.27886e-05,5.58724e-08,-1.33742e-11,77367.2,32.3083], Tmin=(100,'K'), Tmax=(1019.97,'K')), NASAPolynomial(coeffs=[14.6109,0.0252937,-1.00739e-05,1.80842e-09,-1.22706e-13,74441.6,-37.1654], Tmin=(1019.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(642.147,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(CCsJOC(O)) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.22527,0.0818937,-8.48428e-05,4.36975e-08,-8.68877e-12,78050.1,33.8429], Tmin=(100,'K'), Tmax=(1260.33,'K')), NASAPolynomial(coeffs=[20.3089,0.0157207,-4.89301e-06,7.76094e-10,-4.96684e-14,72953.7,-69.6578], Tmin=(1260.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(647.602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(CCsJOC(O)) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0650248,0.0712614,-3.70721e-05,-1.71375e-08,1.55592e-11,68652.1,26.478], Tmin=(100,'K'), Tmax=(948.306,'K')), NASAPolynomial(coeffs=[22.8321,0.0125422,-3.21316e-06,5.5172e-10,-4.27588e-14,62656.3,-90.9978], Tmin=(948.306,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(569.512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_S) + radical(CJCO) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=[CH](9646)', 'C[CH][CH]C[O](3807)'],
    products = ['[CH]=[C]OC[CH][CH]C(4280)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=[C]O[CH2](9647)', '[CH][CH]C(3874)'],
    products = ['[CH]=[C]OC[CH][CH]C(4280)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH][CH]CO[C]=[CH](9857)'],
    products = ['[CH]=[C]OC[CH][CH]C(4280)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]=[C]OC[C][CH]C(10350)'],
    products = ['[CH]=[C]OC[CH][CH]C(4280)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]=[C]OC[CH][C]C(10351)'],
    products = ['[CH]=[C]OC[CH][CH]C(4280)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[C]=[C]OC[CH][CH]C(10352)'],
    products = ['[CH]=[C]OC[CH][CH]C(4280)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH]=[C]O[CH]C=CC(10111)'],
    products = ['[CH]=[C]OC[CH][CH]C(4280)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.41198,'m^3/(mol*s)'), n=2.03228, Ea=(32.8194,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 31.4 to 32.8 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH]=[C]O[CH][CH][CH]C(10354)'],
    products = ['[CH]=[C]OC[CH][CH]C(4280)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=[C]OC[CH][CH]C(4280)'],
    products = ['[CH]=[C]O[CH]C[CH]C(10355)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]=[C]O[CH][CH]CC(9794)'],
    products = ['[CH]=[C]OC[CH][CH]C(4280)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]=[C]OC[CH][CH]C(4280)'],
    products = ['C=[C]O[CH][CH][CH]C(4278)'],
