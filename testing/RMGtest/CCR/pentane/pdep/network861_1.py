species(
    label = 'C=[C]OC(C)[O](3196)',
    structure = SMILES('C=[C]OC(C)[O]'),
    E0 = (79.7113,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,477.573,478.802,479.293,479.751],'cm^-1')),
        HinderedRotor(inertia=(0.111282,'amu*angstrom^2'), symmetry=1, barrier=(2.55859,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.243221,'amu*angstrom^2'), symmetry=1, barrier=(15.8762,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0975446,'amu*angstrom^2'), symmetry=1, barrier=(15.876,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47254,0.0511821,-4.15165e-05,1.7185e-08,-2.87284e-12,9681.58,24.9086], Tmin=(100,'K'), Tmax=(1413.64,'K')), NASAPolynomial(coeffs=[12.5242,0.0199107,-8.33473e-06,1.53671e-09,-1.05475e-13,6556.94,-32.2353], Tmin=(1413.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(79.7113,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=CJO)"""),
)
...
species(
    ...
    E0 = (127.226,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2950,3100,1380,975,1025,1650,1685,370,404.092,404.448,404.564,404.615],'cm^-1')),
        HinderedRotor(inertia=(0.214813,'amu*angstrom^2'), symmetry=1, barrier=(24.9137,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.214905,'amu*angstrom^2'), symmetry=1, barrier=(24.9182,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13391,0.0277147,1.6498e-05,-5.00065e-08,2.34459e-11,15381.2,19.0661], Tmin=(100,'K'), Tmax=(940.012,'K')), NASAPolynomial(coeffs=[15.4944,0.0045579,-3.19009e-07,5.38249e-11,-9.55393e-15,11380.7,-52.4827], Tmin=(940.012,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(127.226,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-OsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(OCOJ) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69584,0.026155,6.55529e-05,-1.16435e-07,4.96067e-11,-23488.7,15.048], Tmin=(100,'K'), Tmax=(940.906,'K')), NASAPolynomial(coeffs=[21.44,0.00452966,6.91162e-07,-9.37005e-11,-6.28993e-15,-29962.4,-93.6606], Tmin=(940.906,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.173,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)

species(
    label = 'C=COC(C)=O(3205)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66885,0.0408267,-5.27872e-06,-2.36574e-08,1.21244e-11,-42010.4,19.8058], Tmin=(100,'K'), Tmax=(998.588,'K')), NASAPolynomial(coeffs=[13.2485,0.0182072,-6.99889e-06,1.32296e-09,-9.60114e-14,-45508,-41.976], Tmin=(998.588,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-350.069,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92788,0.0418917,-2.91009e-05,1.00732e-08,-1.41747e-12,-13191.6,22.0108], Tmin=(100,'K'), Tmax=(1631.98,'K')), NASAPolynomial(coeffs=[11.2787,0.018973,-8.03566e-06,1.4681e-09,-9.92766e-14,-16243.7,-27.6814], Tmin=(1631.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-110.325,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-O2d)(Cds-Cd)) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12967,0.0549677,-4.13141e-05,7.54323e-09,2.87403e-12,7237.07,25.9618], Tmin=(100,'K'), Tmax=(980.787,'K')), NASAPolynomial(coeffs=[15.606,0.0134552,-4.63122e-06,8.29402e-10,-5.89906e-14,3554.43,-47.8947], Tmin=(980.787,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.2526,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cs_P) + radical(C=CJO)"""),
)

species(
    label = '[CH]=COC(C)[O](3372)',
    structure = SMILES('[CH]=COC(C)[O]'),
    E0 = (87.0633,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,325.099,325.164,325.324],'cm^-1')),
        HinderedRotor(inertia=(0.25159,'amu*angstrom^2'), symmetry=1, barrier=(18.843,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251813,'amu*angstrom^2'), symmetry=1, barrier=(18.8533,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.251197,'amu*angstrom^2'), symmetry=1, barrier=(18.8447,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13664,0.0536378,-3.41501e-05,2.90997e-10,5.10252e-12,10582.7,23.3849], Tmin=(100,'K'), Tmax=(996.722,'K')), NASAPolynomial(coeffs=[15.7423,0.0148022,-5.4713e-06,1.01834e-09,-7.36369e-14,6688.63,-51.9595], Tmin=(996.722,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(87.0633,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.940847,0.0594195,-5.06233e-05,1.45068e-08,1.10854e-12,8006.5,26.5852], Tmin=(100,'K'), Tmax=(969.285,'K')), NASAPolynomial(coeffs=[16.5961,0.0120187,-3.89355e-06,6.78657e-10,-4.80013e-14,4163.43,-52.623], Tmin=(969.285,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.5953,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJCO) + radical(C=CJO)"""),
)
...
species(
    label = '[CH]=[C]OC(C)O(3374)',
    structure = SMILES('[CH]=[C]OC(C)O'),
    E0 = (101.102,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,360.882,360.979],'cm^-1')),
        HinderedRotor(inertia=(0.1612,'amu*angstrom^2'), symmetry=1, barrier=(14.9031,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161192,'amu*angstrom^2'), symmetry=1, barrier=(14.9023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161252,'amu*angstrom^2'), symmetry=1, barrier=(14.9023,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161242,'amu*angstrom^2'), symmetry=1, barrier=(14.9025,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'C=[C]OC[O](3369)'],
    products = ['C=[C]OC(C)[O](3196)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2CC(T)(1341)', 'CC([O])[O](3177)'],
    products = ['C=[C]OC(C)[O](3196)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(17)', 'C=[C]OC=O(2846)'],
    products = ['C=[C]OC(C)[O](3196)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(17)', 'C=[C]O[CH][O](2840)'],
    products = ['C=[C]OC(C)[O](3196)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'C=[C]O[C](C)[O](2824)'],
    products = ['C=[C]OC(C)[O](3196)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH2]C([O])O[C]=C(2322)'],
    products = ['C=[C]OC(C)[O](3196)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH]=[C]OC(C)[O](2849)'],
    products = ['C=[C]OC(C)[O](3196)'],
