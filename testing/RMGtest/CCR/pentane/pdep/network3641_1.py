...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69651,0.0300296,5.05648e-05,-1.03265e-07,4.71865e-11,42985.9,16.0893], Tmin=(100,'K'), Tmax=(901.471,'K')), NASAPolynomial(coeffs=[20.0413,0.00350596,3.38833e-06,-8.49099e-10,5.72298e-14,37448.7,-82.8783], Tmin=(901.471,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(356.555,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(2methyleneoxetane) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]O[C]1CC1(16576)',
    structure = SMILES('[CH][CH]O[C]1CC1'),
    E0 = (662.175,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26153,0.0595888,-6.21064e-05,3.45197e-08,-7.72116e-12,79740.5,22.6665], Tmin=(100,'K'), Tmax=(1081.35,'K')), NASAPolynomial(coeffs=[11.6681,0.0210939,-8.70781e-06,1.59872e-09,-1.10052e-13,77489.9,-28.3532], Tmin=(1081.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(662.175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(C2CsJOCs) + radical(CCsJOCs) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1C[C]([CH2])O1(16577)',
...
species(
    label = '[CH]C1OC1([CH2])[CH2](16578)',
    structure = SMILES('[CH]C1OC1([CH2])[CH2]'),
    E0 = (687.618,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0951369,0.0809506,-0.000108911,7.19528e-08,-1.7517e-11,82846.4,22.4839], Tmin=(100,'K'), Tmax=(1195.45,'K')), NASAPolynomial(coeffs=[16.2233,0.0104641,2.62681e-07,-4.90706e-10,5.04839e-14,80170.8,-53.2668], Tmin=(1195.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(687.618,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]COC(=[CH])[CH2](16580)',
    structure = SMILES('[CH]COC([CH])=C'),
    E0 = (591.601,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,2950,3100,1380,975,1025,1650,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.866548,0.05939,-3.5682e-05,-8.42129e-10,5.8833e-12,71274.5,24.0477], Tmin=(100,'K'), Tmax=(983.258,'K')), NASAPolynomial(coeffs=[15.565,0.0202243,-7.40378e-06,1.32236e-09,-9.22812e-14,67386.8,-51.6866], Tmin=(983.258,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(591.601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[C]=CO[C]([CH2])[CH2](16581)',
    structure = SMILES('[C][CH]OC([CH2])=C'),
    E0 = (795.023,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,3025,407.5,1350,352.5,248.646,249.508,249.907,249.997],'cm^-1')),
        HinderedRotor(inertia=(0.447588,'amu*angstrom^2'), symmetry=1, barrier=(20.2194,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.444581,'amu*angstrom^2'), symmetry=1, barrier=(20.1692,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.449673,'amu*angstrom^2'), symmetry=1, barrier=(20.2248,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0482404,0.0744959,-8.78657e-05,4.76075e-08,-9.52196e-12,95777.5,23.1405], Tmin=(100,'K'), Tmax=(1398.08,'K')), NASAPolynomial(coeffs=[21.7597,0.00158503,1.64399e-06,-4.55248e-10,3.45957e-14,90707.5,-85.7021], Tmin=(1398.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(795.023,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(O)CJ) + radical(CCsJOC(O)) + radical(CJ3)"""),
)

species(
    label = '[CH2]C1([CH2])C=CO1(16582)',
...
species(
    label = '[CH]=[C]O[C]([CH2])C(9699)',
    structure = SMILES('[CH]=[C]O[C]([CH2])C'),
    E0 = (675.636,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,277.02,278.389],'cm^-1')),
        HinderedRotor(inertia=(0.198018,'amu*angstrom^2'), symmetry=1, barrier=(10.7774,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195919,'amu*angstrom^2'), symmetry=1, barrier=(10.7732,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197283,'amu*angstrom^2'), symmetry=1, barrier=(10.7687,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.196905,'amu*angstrom^2'), symmetry=1, barrier=(10.7737,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.633534,0.0761475,-0.000105478,7.45295e-08,-2.05779e-11,81379.6,27.4535], Tmin=(100,'K'), Tmax=(893.004,'K')), NASAPolynomial(coeffs=[13.6627,0.0177872,-7.44987e-06,1.34866e-09,-9.09559e-14,79052.5,-33.9306], Tmin=(893.004,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(675.636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C2CsJOC(O)) + radical(CJC(C)OC) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH][CH]OC([CH2])=C(7229)'],
    products = ['ketene(T)(1373)', 'allene(458)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH][CH](6981)', '[CH2]C(=C)[O](2372)'],
    products = ['[CH][CH]OC([CH2])=C(7229)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(20)', '[CH][CH]O[C]=C(7111)'],
    products = ['[CH][CH]OC([CH2])=C(7229)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]=[C]O[C]([CH2])[CH2](9842)'],
    products = ['[CH][CH]OC([CH2])=C(7229)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH][CH]OC([CH2])=C(7229)'],
    products = ['[CH]C1C[C]([CH2])O1(16577)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH][CH]OC([CH2])=C(7229)'],
    products = ['[CH]C1OC1([CH2])[CH2](16578)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['ketene(T)(1373)', '[CH2][C]=C(459)'],
    products = ['[CH][CH]OC([CH2])=C(7229)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH][CH][O](6986)', '[CH2][C]=C(459)'],
    products = ['[CH][CH]OC([CH2])=C(7229)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH][CH]OC([CH2])=C(7229)'],
    products = ['C2H2(1342)', '[CH2]C(=C)[O](2372)'],
...
reaction(
    label = 'reaction15',
    reactants = ['ketene(T)(1373)', '[CH2][C][CH2](15952)'],
    products = ['[CH][CH]OC([CH2])=C(7229)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[C]=CO[C]([CH2])[CH2](16581)'],
    products = ['[CH][CH]OC([CH2])=C(7229)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH][CH]OC([CH2])=C(7229)'],
    products = ['[CH2]C1([CH2])C=CO1(16582)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH]=[C]OC([CH2])=C(9841)'],
    products = ['[CH][CH]OC([CH2])=C(7229)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C2H2(T)(1343)', '[CH2]C(=C)[O](2372)'],
    products = ['[CH][CH]OC([CH2])=C(7229)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C2H2(T)(1343)', '[CH2][C]([CH2])[O](15953)'],
    products = ['[CH][CH]OC([CH2])=C(7229)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=[C]OC([CH2])[CH2](2590)'],
    products = ['[CH][CH]OC([CH2])=C(7229)'],
...
network(
    label = 'PDepNetwork #3641',
    isomers = [
        '[CH][CH]OC([CH2])=C(7229)',
    ],
    reactants = [
        ('ketene(T)(1373)', 'allene(458)'),
    ],
    bathGas = {
        'Ar': 0.333333,
        'Ne': 0.333333,
