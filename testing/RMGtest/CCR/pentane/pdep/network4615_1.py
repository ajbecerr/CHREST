...
species(
    ...
    E0 = (247.566,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,180,3180.28],'cm^-1')),
        HinderedRotor(inertia=(0.97265,'amu*angstrom^2'), symmetry=1, barrier=(22.3631,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.97251,'amu*angstrom^2'), symmetry=1, barrier=(22.3599,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0952137,'amu*angstrom^2'), symmetry=1, barrier=(22.3595,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.972462,'amu*angstrom^2'), symmetry=1, barrier=(22.3588,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0512374,'amu*angstrom^2'), symmetry=1, barrier=(84.2411,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
...
species(
    label = '[CH]C(CC)C(=C)[CH]O[O](21612)',
    structure = SMILES('[CH]C(CC)C(=C)[CH]O[O]'),
    E0 = (528.959,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.68904,0.091614,-7.74946e-05,3.35818e-08,-5.80837e-12,63797.5,38.796], Tmin=(100,'K'), Tmax=(1387.9,'K')), NASAPolynomial(coeffs=[20.3305,0.0310345,-1.20223e-05,2.13272e-09,-1.43515e-13,57962.8,-69.5014], Tmin=(1387.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(528.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(ROOJ) + radical(C=CCJO) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2]C(CC)C(=C)C1OO1(21613)',
    structure = SMILES('[CH2]C(CC)C(=C)C1OO1'),
    E0 = (132.31,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.248731,0.0787527,-2.73086e-05,-2.79355e-08,1.90895e-11,16079.6,35.5215], Tmin=(100,'K'), Tmax=(934.488,'K')), NASAPolynomial(coeffs=[19.6123,0.0306556,-9.36211e-06,1.53548e-09,-1.0416e-13,10755.7,-67.5754], Tmin=(934.488,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(132.31,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + ring(dioxirane) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2][C](CC)C([CH2])[CH]O[O](21615)',
    structure = SMILES('[CH2][C](CC)C([CH2])[CH]O[O]'),
    E0 = (624.166,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,227.111,963.421,1816.89],'cm^-1')),
        HinderedRotor(inertia=(0.119144,'amu*angstrom^2'), symmetry=1, barrier=(3.36076,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119144,'amu*angstrom^2'), symmetry=1, barrier=(3.36076,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119144,'amu*angstrom^2'), symmetry=1, barrier=(3.36076,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119144,'amu*angstrom^2'), symmetry=1, barrier=(3.36076,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119144,'amu*angstrom^2'), symmetry=1, barrier=(3.36076,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.662544,0.114951,-0.000173693,1.53456e-07,-5.2678e-11,75225.9,41.5852], Tmin=(100,'K'), Tmax=(884.418,'K')), NASAPolynomial(coeffs=[6.36677,0.0548611,-2.37829e-05,4.27678e-09,-2.82779e-13,75089.3,14.7931], Tmin=(884.418,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(624.166,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Tertalkyl) + radical(CCsJOOH) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]CC([CH2])[C](C)[CH]O[O](21617)',
    structure = SMILES('[CH2]CC([CH2])[C](C)[CH]O[O]'),
    E0 = (629.818,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,395.67,492.812,3292.76],'cm^-1')),
        HinderedRotor(inertia=(0.0409144,'amu*angstrom^2'), symmetry=1, barrier=(2.2675,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0409144,'amu*angstrom^2'), symmetry=1, barrier=(2.2675,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0409144,'amu*angstrom^2'), symmetry=1, barrier=(2.2675,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0409144,'amu*angstrom^2'), symmetry=1, barrier=(2.2675,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0409144,'amu*angstrom^2'), symmetry=1, barrier=(2.2675,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.132919,0.0897994,-8.87401e-05,5.508e-08,-1.49084e-11,75884.7,42.4606], Tmin=(100,'K'), Tmax=(871.002,'K')), NASAPolynomial(coeffs=[8.54926,0.0511484,-2.21776e-05,4.13333e-09,-2.8548e-13,74418.6,3.01894], Tmin=(871.002,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(629.818,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CJCOOH) + radical(CCsJOOH) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C(CC)[C]1CC1O[O](21618)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.293266,0.0681658,-1.53879e-05,-2.5731e-08,1.41049e-11,45758.2,39.1413], Tmin=(100,'K'), Tmax=(1003.89,'K')), NASAPolynomial(coeffs=[15.1825,0.0381224,-1.42512e-05,2.57017e-09,-1.78819e-13,41293.2,-40.0976], Tmin=(1003.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(379.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(ROOJ) + radical(C2CJCOOH) + radical(Isobutyl)"""),
)

species(
    label = 'CCC1CC[C]1[CH]O[O](21619)',
    structure = SMILES('CCC1CC[C]1[CH]O[O]'),
    E0 = (367.625,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
...
species(
    label = '[CH2]C(CC)[C]1[CH]OOC1(21620)',
    structure = SMILES('[CH2]C(CC)[C]1[CH]OOC1'),
    E0 = (348.157,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.604608,0.0592516,1.9108e-05,-7.06759e-08,3.40253e-11,42010.2,36.4813], Tmin=(100,'K'), Tmax=(901.418,'K')), NASAPolynomial(coeffs=[15.374,0.0350865,-9.52745e-06,1.41988e-09,-9.13278e-14,37666.7,-42.5632], Tmin=(901.418,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(348.157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxolane) + radical(C2CJCOOH) + radical(CCsJOOC) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(CC)C1([CH2])[CH]OO1(21622)',
    structure = SMILES('[CH2]C(CC)C1([CH2])[CH]OO1'),
    E0 = (435.559,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.353418,0.0966867,-9.25255e-05,5.02226e-08,-1.13473e-11,52541.6,33.0771], Tmin=(100,'K'), Tmax=(1053.34,'K')), NASAPolynomial(coeffs=[13.3286,0.0447293,-1.8535e-05,3.39282e-09,-2.32568e-13,49659.3,-33.6415], Tmin=(1053.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(435.559,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(CCsJOO) + radical(Isobutyl) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2]C(CC)C(=C)C=O(21624)',
    structure = SMILES('[CH2]C(CC)C(=C)C=O'),
    E0 = (2.22232,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,2782.5,750,1395,475,1775,1000,894.569,894.647],'cm^-1')),
        HinderedRotor(inertia=(0.20673,'amu*angstrom^2'), symmetry=1, barrier=(4.75313,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.206749,'amu*angstrom^2'), symmetry=1, barrier=(4.75356,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.206731,'amu*angstrom^2'), symmetry=1, barrier=(4.75315,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.79153,'amu*angstrom^2'), symmetry=1, barrier=(18.1988,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.791516,'amu*angstrom^2'), symmetry=1, barrier=(18.1985,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.471616,0.0752886,-5.18956e-05,1.83512e-08,-2.69945e-12,395.585,31.3903], Tmin=(100,'K'), Tmax=(1531.83,'K')), NASAPolynomial(coeffs=[14.1665,0.0395277,-1.68778e-05,3.11108e-09,-2.12213e-13,-3800.07,-40.5201], Tmin=(1531.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(2.22232,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cd-CdCs(CO)) + group(Cds-CdsHH) + group(Cds-O2d(Cds-Cds)H) + radical(Isobutyl)"""),
)
...
species(
    ...
    E0 = (373.777,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][C](CC)C(=C)[CH]OO(21629)',
    structure = SMILES('[CH2]C([CH]OO)=C([CH2])CC'),
    E0 = (208.005,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.909748,0.0936724,-6.34208e-05,1.21616e-08,2.62715e-12,25206.3,36.699], Tmin=(100,'K'), Tmax=(1064.47,'K')), NASAPolynomial(coeffs=[21.5162,0.0338529,-1.35812e-05,2.52651e-09,-1.77926e-13,19046.7,-79.401], Tmin=(1064.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.005,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(C=CCJO) + radical(Allyl_P) + radical(Allyl_P)"""),
)
...
species(
    ...
    E0 = (380.918,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3120,650,792.5,1650,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC([CH2])C(=C)[CH]OO(21631)',
    structure = SMILES('[CH2]CC([CH2])C(=C)[CH]OO'),
    E0 = (339.068,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.966858,0.0959671,-8.09496e-05,3.52238e-08,-6.11248e-12,40970.3,41.6004], Tmin=(100,'K'), Tmax=(1386.86,'K')), NASAPolynomial(coeffs=[21.1353,0.0322205,-1.20034e-05,2.08162e-09,-1.38219e-13,34839.8,-72.2583], Tmin=(1386.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(339.068,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(C=CCJO) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C(CC)C[C]=CO[O](20955)',
    structure = SMILES('[CH2]C(CC)C[C]=CO[O]'),
    E0 = (417.074,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.320657,0.0954427,-9.46696e-05,5.32955e-08,-1.23817e-11,50317.7,38.9615], Tmin=(100,'K'), Tmax=(1031.8,'K')), NASAPolynomial(coeffs=[13.478,0.0419494,-1.69026e-05,3.04884e-09,-2.07175e-13,47470.2,-28.0409], Tmin=(1031.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(417.074,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C([C]=CO[O])CC(21632)',
    structure = SMILES('[CH2]C([C]=CO[O])CC'),
    E0 = (438.577,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,1685,370,357.025,357.026],'cm^-1')),
        HinderedRotor(inertia=(0.0844552,'amu*angstrom^2'), symmetry=1, barrier=(7.63926,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0844552,'amu*angstrom^2'), symmetry=1, barrier=(7.63927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0844552,'amu*angstrom^2'), symmetry=1, barrier=(7.63927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0844552,'amu*angstrom^2'), symmetry=1, barrier=(7.63927,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0844552,'amu*angstrom^2'), symmetry=1, barrier=(7.63927,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.271033,0.0810526,-8.17839e-05,4.63196e-08,-1.07008e-11,52883.7,34.6246], Tmin=(100,'K'), Tmax=(1044.47,'K')), NASAPolynomial(coeffs=[12.8254,0.0329715,-1.27302e-05,2.24216e-09,-1.50224e-13,50261.3,-26.4884], Tmin=(1044.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(438.577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = 'CCC1CCC1=CO[O](21633)',
    structure = SMILES('CCC1CCC1=CO[O]'),
    E0 = (128.188,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.124564,0.0719379,-2.44877e-05,-1.55821e-08,9.95421e-12,15568.5,33.0825], Tmin=(100,'K'), Tmax=(1049.78,'K')), NASAPolynomial(coeffs=[15.8099,0.038859,-1.5355e-05,2.83447e-09,-1.98547e-13,10804.7,-50.3564], Tmin=(1049.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(128.188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(methylenecyclobutane) + radical(ROOJ)"""),
)
...
species(
    label = '[CH2]C1=COOCC1CC(21634)',
    structure = SMILES('C=C1[CH]OOCC1CC'),
    E0 = (-10.5276,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.397614,0.0500547,6.93955e-05,-1.23438e-07,4.87062e-11,-1110.76,28.0712], Tmin=(100,'K'), Tmax=(1006.46,'K')), NASAPolynomial(coeffs=[22.0098,0.0355371,-1.53439e-05,3.15341e-09,-2.40775e-13,-9076.21,-94.2934], Tmin=(1006.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-10.5276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(473.925,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclohexanone) + radical(C=CCJO)"""),
)
...
species(
    label = '[CH2]C1=COCC1CC(21635)',
    structure = SMILES('[CH2]C1=COCC1CC'),
    E0 = (-71.612,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.630417,0.0474166,6.5387e-05,-1.31842e-07,5.85701e-11,-8466.79,23.0225], Tmin=(100,'K'), Tmax=(916.354,'K')), NASAPolynomial(coeffs=[22.9485,0.0194321,-2.46735e-06,2.15462e-10,-1.79474e-14,-15472.4,-98.6072], Tmin=(916.354,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.612,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(2,3-Dihydrofuran) + radical(Allyl_P)"""),
)

species(
    label = 'C=C(CC)C(C)=CO[O](21636)',
    structure = SMILES('C=C(CC)C(C)=CO[O]'),
    E0 = (63.8014,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.867058,0.0980214,-9.03657e-05,4.37051e-08,-8.43158e-12,7856.34,34.2407], Tmin=(100,'K'), Tmax=(1254.32,'K')), NASAPolynomial(coeffs=[19.656,0.0325745,-1.21009e-05,2.10819e-09,-1.40962e-13,2707.77,-69.4221], Tmin=(1254.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.8014,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C(=COO)C(=C)CC(21637)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.847034,0.0912817,-5.50497e-05,5.48179e-10,7.62861e-12,4007.64,34.6213], Tmin=(100,'K'), Tmax=(1015.38,'K')), NASAPolynomial(coeffs=[22.2382,0.0312254,-1.19572e-05,2.21274e-09,-1.57237e-13,-2272.59,-84.9445], Tmin=(1015.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(31.7589,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CCJO)"""),
)
...
species(
    label = '[CH2][C]1C(CC)CC1O[O](21638)',
    structure = SMILES('[CH2][C]1C(CC)CC1O[O]'),
    E0 = (371.482,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
...
species(
    label = '[CH2][C](C([CH2])CC)C1OO1(21639)',
    structure = SMILES('[CH2][C](C([CH2])CC)C1OO1'),
    E0 = (411.542,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.211411,0.068,-3.12559e-06,-5.02754e-08,2.68897e-11,49647.6,41.1969], Tmin=(100,'K'), Tmax=(918.18,'K')), NASAPolynomial(coeffs=[17.7393,0.0316179,-8.99831e-06,1.40772e-09,-9.35881e-14,44743.8,-51.0452], Tmin=(918.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(411.542,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(dioxirane) + radical(C2CJCOOH) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(=[C]OO)C([CH2])CC(21640)',
    structure = SMILES('[CH2]C(=[C]OO)C([CH2])CC'),
    E0 = (405.103,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1685,370,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.430689,0.097332,-9.39597e-05,5.03726e-08,-1.11228e-11,48882.3,40.0797], Tmin=(100,'K'), Tmax=(1082.04,'K')), NASAPolynomial(coeffs=[14.5184,0.0420694,-1.73511e-05,3.17264e-09,-2.1749e-13,45647.2,-33.22], Tmin=(1082.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(405.103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsOsH) + radical(Isobutyl) + radical(Allyl_P) + radical(C=CJO)"""),
)

species(
    label = '[CH2][C](CC)C(C)=CO[O](21641)',
    structure = SMILES('[CH2]C(CC)=C(C)[CH]O[O]'),
    E0 = (208.511,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C(CC)C(C)=[C]O[O](21642)',
    structure = SMILES('[CH2]C(CC)C(C)=[C]O[O]'),
    E0 = (405.608,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.184683,0.0963792,-0.000107485,7.32503e-08,-2.10084e-11,48930.1,39.6807], Tmin=(100,'K'), Tmax=(838.08,'K')), NASAPolynomial(coeffs=[10.0592,0.04749,-1.99881e-05,3.653e-09,-2.48689e-13,47213,-7.93122], Tmin=(838.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(405.608,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Isobutyl) + radical(C=CJO)"""),
)
...
species(
    label = '[CH2]CC([CH2])C(C)=CO[O](21645)',
    structure = SMILES('[CH2]CC([CH2])C(C)=CO[O]'),
    E0 = (371.11,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.43057,0.0963302,-9.49384e-05,5.23051e-08,-1.17916e-11,44794.8,39.2132], Tmin=(100,'K'), Tmax=(1066.56,'K')), NASAPolynomial(coeffs=[14.5823,0.040026,-1.57525e-05,2.80886e-09,-1.89719e-13,41592.4,-34.1827], Tmin=(1066.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(371.11,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]C(C)C(=C)[CH]O[O](19577)'],
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(T)(20)', 'C=C([CH]CC)[CH]O[O](21455)'],
    products = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]O[O](21387)', '[CH2]C([C]=C)CC(2492)'],
    products = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH2]C(CC)C(=C)[C]O[O](21611)'],
    products = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH]C(CC)C(=C)[CH]O[O](21612)'],
    products = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
    products = ['[CH2]C(CC)C(=C)C1OO1(21613)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C](CC)C([CH2])[CH]O[O](21615)'],
    products = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2]CC([CH2])[C](C)[CH]O[O](21617)'],
    products = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
    products = ['[CH2]C(CC)[C]1CC1O[O](21618)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
    products = ['CCC1CC[C]1[CH]O[O](21619)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
    products = ['[CH2]C(CC)[C]1[CH]OOC1(21620)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
    products = ['[CH2]C(CC)C1([CH2])[CH]OO1(21622)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', 'C=C([CH]O[O])C(=C)CC(21623)'],
    products = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O(4)', '[CH2]C(CC)C(=C)C=O(21624)'],
    products = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C2H5(14)', 'C=CC(=C)[CH]O[O](21014)'],
    products = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C2H5(14)', '[CH2][CH]C(=C)[CH]O[O](21398)'],
    products = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', '[CH2][C](CC)C(=C)[CH]O[O](21625)'],
    products = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CH3(17)', '[CH2]C([CH2])C(=C)[CH]O[O](20019)'],
    products = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(3)', '[CH2]CC([CH2])C(=C)[CH]O[O](21626)'],
    products = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(105.204,'s^-1'), n=2.9075, Ea=(76.0547,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R4H_SSS;C_rad_out_H/NonDeC;Cs_H_out_1H] + [R4H_SS(Cd)S;C_rad_out_1H;Cs_H_out_1H] for rate rule [R4H_SS(Cd)S;C_rad_out_H/NonDeC;Cs_H_out_H/NonDeO]
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2]CC([CH2])C(=C)CO[O](19663)'],
    products = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
    transitionState = 'TS45',
    kinetics = Arrhenius(A=(30977.5,'s^-1'), n=1.81667, Ea=(54.4617,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5H_CCC;C_rad_out_2H;Cs_H_out_1H] for rate rule [R5H_CCC(Cd);C_rad_out_2H;Cs_H_out_H/NonDeO]
Euclidian distance = 1.4142135623730951
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
    products = ['[CH2][C](CC)C(=C)[CH]OO(21629)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH]=C([CH]OO)C([CH2])CC(19658)'],
    products = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH2]CC([CH2])C(=C)[CH]OO(21631)'],
    products = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
    transitionState = 'TS49',
    kinetics = Arrhenius(A=(60975.7,'s^-1'), n=1.58648, Ea=(80.9836,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R7Hall;C_rad_out_2H;XH_out] for rate rule [R7HJ_4;C_rad_out_2H;O_H_out]
Euclidian distance = 1.4142135623730951
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(CC)C[C]=CO[O](20955)'],
    products = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
...
reaction(
    label = 'reaction51',
    reactants = ['CH2(T)(20)', '[CH2]C([C]=CO[O])CC(21632)'],
    products = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
...
reaction(
    label = 'reaction54',
    reactants = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
    products = ['[CH2]C1=COOCC1CC(21634)'],
...
reaction(
    label = 'reaction56',
    reactants = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
    products = ['O(4)', '[CH2]C1=COCC1CC(21635)'],
...
reaction(
    label = 'reaction57',
    reactants = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
    products = ['C=C(CC)C(C)=CO[O](21636)'],
...
reaction(
    label = 'reaction58',
    reactants = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
    products = ['[CH2]C(=COO)C(=C)CC(21637)'],
...
reaction(
    label = 'reaction61',
    reactants = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
    products = ['[CH2][C]1C(CC)CC1O[O](21638)'],
...
reaction(
    label = 'reaction62',
    reactants = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
    products = ['[CH2][C](C([CH2])CC)C1OO1(21639)'],
...
reaction(
    label = 'reaction64',
    reactants = ['[CH2]C(=[C]OO)C([CH2])CC(21640)'],
    products = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
...
reaction(
    label = 'reaction65',
    reactants = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
    products = ['[CH2][C](CC)C(C)=CO[O](21641)'],
...
reaction(
    label = 'reaction66',
    reactants = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
    products = ['[CH2]C(CC)C(C)=[C]O[O](21642)'],
...
reaction(
    label = 'reaction69',
    reactants = ['[CH2]CC([CH2])C(C)=CO[O](21645)'],
    products = ['[CH2]C(CC)C(=C)[CH]O[O](19660)'],
...
network(
    label = 'PDepNetwork #4615',
    isomers = [
        '[CH2]C(CC)C(=C)[CH]O[O](19660)',
    ],
    reactants = [
