...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.522039,'amu*angstrom^2'), symmetry=1, barrier=(25.7652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00173929,'amu*angstrom^2'), symmetry=1, barrier=(6.52398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.522034,'amu*angstrom^2'), symmetry=1, barrier=(25.7648,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (58.0791,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.4465,0.0325713,-2.2601e-05,8.44364e-09,-1.31566e-12,13607.8,17.8684], Tmin=(100,'K'), Tmax=(1466.58,'K')), NASAPolynomial(coeffs=[8.15548,0.0170006,-6.67573e-06,1.20455e-09,-8.16709e-14,11933.3,-11.8603], Tmin=(1466.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(112.668,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCsJOH) + radical(RCCJ)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.978042,'amu*angstrom^2'), symmetry=1, barrier=(22.4871,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.976229,'amu*angstrom^2'), symmetry=1, barrier=(22.4454,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (57.0712,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.54772,0.0242082,5.90939e-06,-2.65757e-08,1.23969e-11,-2951.28,13.5324], Tmin=(100,'K'), Tmax=(959.503,'K')), NASAPolynomial(coeffs=[10.1178,0.011534,-3.79869e-06,6.81308e-10,-4.93313e-14,-5273.25,-27.2056], Tmin=(959.503,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-25.0312,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), label="""hydroxyl1allyl""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.442399,'amu*angstrom^2'), symmetry=1, barrier=(10.1716,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.441423,'amu*angstrom^2'), symmetry=1, barrier=(10.1492,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (57.0712,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29121,0.043273,-6.92102e-05,6.46069e-08,-2.32088e-11,11384.7,14.0645], Tmin=(100,'K'), Tmax=(864.704,'K')), NASAPolynomial(coeffs=[4.14829,0.0219053,-9.9791e-06,1.8528e-09,-1.25062e-13,11541.2,8.13719], Tmin=(864.704,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.1914,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Cds_S)"""),
)
...
species(
    ...
    E0 = (103.446,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(0.559045,'amu*angstrom^2'), symmetry=1, barrier=(12.8535,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.55899,'amu*angstrom^2'), symmetry=1, barrier=(12.8523,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (57.0712,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.25464,0.0421344,-6.07984e-05,5.22427e-08,-1.78981e-11,12500.9,14.1259], Tmin=(100,'K'), Tmax=(845.79,'K')), NASAPolynomial(coeffs=[5.58229,0.0195679,-8.66609e-06,1.60492e-09,-1.08871e-13,12182.3,0.0731822], Tmin=(845.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(103.446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Cds_P)"""),
)
...
species(
    ...
    E0 = (148.313,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.193465,'amu*angstrom^2'), symmetry=1, barrier=(4.44815,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.63693,'amu*angstrom^2'), symmetry=1, barrier=(60.6281,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.63998,'amu*angstrom^2'), symmetry=1, barrier=(60.6984,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (58.0791,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.33667,0.0393346,-4.27306e-05,3.35608e-08,-1.16889e-11,17895.2,25.333], Tmin=(100,'K'), Tmax=(790.807,'K')), NASAPolynomial(coeffs=[4.33312,0.0260528,-1.14994e-05,2.14169e-09,-1.47009e-13,17678.9,16.7992], Tmin=(790.807,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.313,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
species(
    ...
    E0 = (170.749,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,343.184,351.062,1780.67,3316.08],'cm^-1')),
        HinderedRotor(inertia=(0.00141176,'amu*angstrom^2'), symmetry=1, barrier=(0.11963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.101657,'amu*angstrom^2'), symmetry=1, barrier=(8.64593,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102969,'amu*angstrom^2'), symmetry=1, barrier=(8.61061,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (58.0791,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.69841,0.0330428,-1.76936e-05,-1.53535e-08,2.11527e-11,20578.8,14.9381], Tmin=(100,'K'), Tmax=(514.959,'K')), NASAPolynomial(coeffs=[4.81702,0.0236084,-1.06668e-05,2.02965e-09,-1.41793e-13,20267.5,5.21912], Tmin=(514.959,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(170.749,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsCsHH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', 'hydroxyl1allyl(9369)'],
    products = ['propen3ol(479)'],
    transitionState = 'TS7',
