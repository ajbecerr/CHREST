...
species(
    label = '[CH]=CC([CH2])C[C][CH]C(14620)',
    structure = SMILES('[CH]=CC([CH2])C[C][CH]C'),
    E0 = (975.225,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3120,650,792.5,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.252721,0.084034,-7.73064e-05,4.20852e-08,-9.74507e-12,117426,37.094], Tmin=(100,'K'), Tmax=(1019.09,'K')), NASAPolynomial(coeffs=[10.5222,0.0437252,-1.79751e-05,3.2715e-09,-2.2329e-13,115333,-12.6442], Tmin=(1019.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(975.225,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(Isobutyl) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC([CH2])C[CH][C]C(14621)',
    structure = SMILES('[CH]=CC([CH2])C[CH][C]C'),
    E0 = (975.237,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.335644,0.0838911,-7.99673e-05,4.66879e-08,-1.17623e-11,117423,36.63], Tmin=(100,'K'), Tmax=(935.702,'K')), NASAPolynomial(coeffs=[9.16367,0.0461525,-1.94698e-05,3.58482e-09,-2.46081e-13,115771,-5.37348], Tmin=(935.702,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(975.237,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(Isobutyl) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[CH]C(C=[CH])C[CH][CH]C(14622)',
    structure = SMILES('[CH]C(C=[CH])C[CH][CH]C'),
    E0 = (964.601,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,211.305,882.221,1102.78,1323.33,1706.96,1950.81],'cm^-1')),
        HinderedRotor(inertia=(0.114787,'amu*angstrom^2'), symmetry=1, barrier=(3.19536,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114787,'amu*angstrom^2'), symmetry=1, barrier=(3.19536,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114787,'amu*angstrom^2'), symmetry=1, barrier=(3.19536,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114787,'amu*angstrom^2'), symmetry=1, barrier=(3.19536,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.114787,'amu*angstrom^2'), symmetry=1, barrier=(3.19536,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26936,0.0704696,-2.46152e-05,-6.65555e-08,7.2668e-11,116103,35.4951], Tmin=(100,'K'), Tmax=(491.572,'K')), NASAPolynomial(coeffs=[5.62067,0.0525824,-2.34955e-05,4.43054e-09,-3.07449e-13,115463,15.4395], Tmin=(491.572,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(964.601,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJC) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[C]=CC([CH2])C[CH][CH]C(14623)',
    structure = SMILES('[C]=CC([CH2])C[CH][CH]C'),
    E0 = (1032.47,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,207.705,458.636,1229.8,3469.28],'cm^-1')),
        HinderedRotor(inertia=(0.0524421,'amu*angstrom^2'), symmetry=1, barrier=(1.68672,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0524421,'amu*angstrom^2'), symmetry=1, barrier=(1.68672,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0524421,'amu*angstrom^2'), symmetry=1, barrier=(1.68672,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0524421,'amu*angstrom^2'), symmetry=1, barrier=(1.68672,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0524421,'amu*angstrom^2'), symmetry=1, barrier=(1.68672,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.45255,0.0860962,-0.000109066,9.44237e-08,-3.37058e-11,124298,39.0038], Tmin=(100,'K'), Tmax=(843.043,'K')), NASAPolynomial(coeffs=[3.77651,0.05425,-2.3801e-05,4.38004e-09,-2.96678e-13,124309,26.9231], Tmin=(843.043,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1032.47,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJC) + radical(Isobutyl) + radical(CdCdJ2_triplet)"""),
)
...
species(
    label = 'CC=CCC1[CH][CH]C1(6541)',
    structure = SMILES('CC=CCC1[CH][CH]C1'),
    E0 = (400.924,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08692,0.0512884,1.42079e-05,-4.12263e-08,1.55243e-11,48335.6,33.0652], Tmin=(100,'K'), Tmax=(1097.6,'K')), NASAPolynomial(coeffs=[10.4083,0.0466827,-1.96277e-05,3.69918e-09,-2.60061e-13,44520.6,-20.8306], Tmin=(1097.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(400.924,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutane) + radical(cyclobutane) + radical(cyclobutane)"""),
)

species(
    label = '[CH2]C1C=CC([CH]C)C1(14624)',
    structure = SMILES('[CH2]C1C=CC([CH]C)C1'),
    E0 = (334.337,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08494,0.0444243,5.05624e-05,-9.22348e-08,3.7143e-11,40334,30.3225], Tmin=(100,'K'), Tmax=(975.083,'K')), NASAPolynomial(coeffs=[14.4664,0.0378565,-1.36748e-05,2.51147e-09,-1.80282e-13,35427,-45.6779], Tmin=(975.083,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(334.337,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopentene) + radical(Cs_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH]=CC(=C)CC[CH]C(14625)',
    structure = SMILES('[CH]=CC(=C)CC[CH]C'),
    E0 = (427.667,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0905924,0.0833972,-6.3734e-05,2.6125e-08,-4.4174e-12,51589,33.8207], Tmin=(100,'K'), Tmax=(1383.09,'K')), NASAPolynomial(coeffs=[15.4137,0.0385573,-1.51033e-05,2.68411e-09,-1.80313e-13,47300.3,-46.0066], Tmin=(1383.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(427.667,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(RCCJC) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=CC(C)C=C[CH]C(14626)',
    structure = SMILES('[CH]=CC(C)[CH]C=CC'),
    E0 = (384.131,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.213603,0.0713383,-2.9471e-05,-6.77395e-09,6.07289e-12,46346.7,31.7393], Tmin=(100,'K'), Tmax=(1098.54,'K')), NASAPolynomial(coeffs=[14.7302,0.0400195,-1.6117e-05,2.97001e-09,-2.06344e-13,41857.6,-45.5745], Tmin=(1098.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(384.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_S) + radical(Cds_P)"""),
)
...
species(
    ...
    E0 = (589.213,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3100,440,815,1455,1000,3120,650,792.5,1650,180,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0765554,'amu*angstrom^2'), symmetry=1, barrier=(1.76016,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.826108,'amu*angstrom^2'), symmetry=1, barrier=(18.9939,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.825995,'amu*angstrom^2'), symmetry=1, barrier=(18.9912,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(4.28617,'amu*angstrom^2'), symmetry=1, barrier=(98.5475,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102225,'amu*angstrom^2'), symmetry=1, barrier=(98.5312,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
...
species(
    label = '[CH]=C[C]([CH2])C[CH][CH]C(14627)',
    structure = SMILES('[CH]C=C([CH2])C[CH][CH]C'),
    E0 = (771.925,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69172,0.0620516,2.95801e-05,-1.74072e-07,1.5559e-10,92912.4,32.3872], Tmin=(100,'K'), Tmax=(434.846,'K')), NASAPolynomial(coeffs=[3.68326,0.0611348,-2.72881e-05,5.14735e-09,-3.57932e-13,92574.7,22.5458], Tmin=(434.846,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(771.925,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(RCCJC) + radical(Allyl_P) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=CC([CH2])[CH][CH][CH]C(14628)',
    structure = SMILES('[CH]=CC([CH2])[CH][CH][CH]C'),
    E0 = (916.011,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,356.219,3037.34,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0247156,'amu*angstrom^2'), symmetry=1, barrier=(3.82497,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0247156,'amu*angstrom^2'), symmetry=1, barrier=(3.82497,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0247156,'amu*angstrom^2'), symmetry=1, barrier=(3.82497,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0247156,'amu*angstrom^2'), symmetry=1, barrier=(3.82497,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0247156,'amu*angstrom^2'), symmetry=1, barrier=(3.82497,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.625393,0.0818017,-9.91908e-05,8.57355e-08,-3.10641e-11,110285,40.9648], Tmin=(100,'K'), Tmax=(832.853,'K')), NASAPolynomial(coeffs=[3.17511,0.0548471,-2.41531e-05,4.46543e-09,-3.03774e-13,110370,32.1929], Tmin=(832.853,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(916.011,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(RCCJC) + radical(RCCJCC) + radical(Isobutyl) + radical(Cds_P)"""),
)

species(
    label = '[CH][CH]C([CH2])CC=C[CH2](9214)',
    structure = SMILES('[CH][CH]C([CH2])CC=C[CH2]'),
    E0 = (869.756,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0894073,0.0803928,-6.17535e-05,2.54368e-08,-4.33215e-12,104753,37.9981], Tmin=(100,'K'), Tmax=(1370.6,'K')), NASAPolynomial(coeffs=[14.7408,0.0376335,-1.49573e-05,2.6749e-09,-1.80326e-13,100737,-37.3054], Tmin=(1370.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(869.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_S) + radical(Isobutyl) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]=[C]C([CH2])C[CH][CH]C(14629)',
    structure = SMILES('[CH]=[C]C([CH2])C[CH][CH]C'),
    E0 = (959.31,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,202.289,685.102,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00224459,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00224459,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00224459,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00224459,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00224459,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.375139,0.0879269,-0.000113597,9.79456e-08,-3.44822e-11,115501,39.7805], Tmin=(100,'K'), Tmax=(853.597,'K')), NASAPolynomial(coeffs=[4.20341,0.0532025,-2.30818e-05,4.21579e-09,-2.83929e-13,115459,25.4992], Tmin=(853.597,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(959.31,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJC) + radical(Isobutyl) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C[C](C)C[CH][CH]C(14630)',
    structure = SMILES('[CH]C=C(C)C[CH][CH]C'),
    E0 = (620.426,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17342,0.0664669,-3.04575e-05,5.94133e-09,-4.34851e-13,74656.2,29.9022], Tmin=(100,'K'), Tmax=(3286.84,'K')), NASAPolynomial(coeffs=[47.9315,0.0107798,-5.04359e-06,7.86579e-10,-4.27712e-14,44576.6,-245.302], Tmin=(3286.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(620.426,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(RCCJC) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=CC([CH2])[CH]C[CH]C(14631)',
    structure = SMILES('[CH]=CC([CH2])[CH]C[CH]C'),
    E0 = (721.552,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,236.916,463.531,3210.9],'cm^-1')),
        HinderedRotor(inertia=(0.0433902,'amu*angstrom^2'), symmetry=1, barrier=(2.68039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0433902,'amu*angstrom^2'), symmetry=1, barrier=(2.68039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0433902,'amu*angstrom^2'), symmetry=1, barrier=(2.68039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0433902,'amu*angstrom^2'), symmetry=1, barrier=(2.68039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0433902,'amu*angstrom^2'), symmetry=1, barrier=(2.68039,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.629617,0.0780996,-6.30085e-05,3.21187e-08,-7.46661e-12,86900.7,38.3981], Tmin=(100,'K'), Tmax=(975.402,'K')), NASAPolynomial(coeffs=[7.13235,0.0514326,-2.19989e-05,4.08932e-09,-2.82522e-13,85632.1,7.18816], Tmin=(975.402,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(721.552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(RCCJC) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=CC(C)[CH][CH][CH]C(14632)',
    structure = SMILES('[CH]=CC(C)[CH][CH][CH]C'),
    E0 = (710.928,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.706867,0.0789405,-8.26937e-05,6.85608e-08,-2.58722e-11,85617.2,38.8922], Tmin=(100,'K'), Tmax=(771.188,'K')), NASAPolynomial(coeffs=[2.73317,0.0593543,-2.69438e-05,5.10592e-09,-3.54448e-13,85574.6,31.3929], Tmin=(771.188,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(710.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(RCCJC) + radical(RCCJCC) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]C(C)C[CH][CH]C(14633)',
    structure = SMILES('[CH]=[C]C(C)C[CH][CH]C'),
    E0 = (754.228,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,1685,370,3120,650,792.5,1650,224.223,403.386,3068.13],'cm^-1')),
        HinderedRotor(inertia=(0.091113,'amu*angstrom^2'), symmetry=1, barrier=(2.16874,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.091113,'amu*angstrom^2'), symmetry=1, barrier=(2.16874,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.091113,'amu*angstrom^2'), symmetry=1, barrier=(2.16874,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.091113,'amu*angstrom^2'), symmetry=1, barrier=(2.16874,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.091113,'amu*angstrom^2'), symmetry=1, barrier=(2.16874,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.441288,0.0852537,-9.77704e-05,8.15925e-08,-2.95771e-11,90834.1,37.7623], Tmin=(100,'K'), Tmax=(798.597,'K')), NASAPolynomial(coeffs=[3.85165,0.0575478,-2.57755e-05,4.83271e-09,-3.32607e-13,90628.2,24.1973], Tmin=(798.597,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(754.228,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJC) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C[C]([CH2])CC[CH]C(14634)',
    structure = SMILES('[CH]C=C([CH2])CC[CH]C'),
    E0 = (577.467,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.285007,0.0805777,-4.995e-05,1.61276e-08,-2.21886e-12,69587.1,34.5794], Tmin=(100,'K'), Tmax=(1577.2,'K')), NASAPolynomial(coeffs=[12.4842,0.0496389,-2.05256e-05,3.69029e-09,-2.47436e-13,65739,-29.8331], Tmin=(1577.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(577.467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(RCCJC) + radical(Allyl_P) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]=[C]C([CH2])CC[CH]C(14635)',
    structure = SMILES('[CH]=[C]C([CH2])CC[CH]C'),
    E0 = (764.852,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.302822,0.0851324,-8.06561e-05,4.87498e-08,-1.2932e-11,92120.2,37.4883], Tmin=(100,'K'), Tmax=(885.951,'K')), NASAPolynomial(coeffs=[8.1072,0.0498962,-2.09978e-05,3.85771e-09,-2.64266e-13,90737.4,0.781755], Tmin=(885.951,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(764.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(Isobutyl) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH][CH]C(C)CC=C[CH2](5786)',
    structure = SMILES('[CH][CH]C(C)CC=C[CH2]'),
    E0 = (664.674,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
    products = ['C2H2(1342)', '[CH2][CH]CC=CC(553)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction8',
    reactants = ['[CH][CH]C(3874)', '[CH]=CC([CH2])[CH2](13775)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(17)', '[CH][CH]CC([CH2])C=[CH](14038)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]=CC([CH2])C[C][CH]C(14620)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH]=CC([CH2])C[CH][C]C(14621)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]C(C=[CH])C[CH][CH]C(14622)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[C]=CC([CH2])C[CH][CH]C(14623)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
    products = ['CC=CCC1[CH][CH]C1(6541)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
    products = ['[CH2]C1C=CC([CH]C)C1(14624)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
    products = ['[CH]=CC(=C)CC[CH]C(14625)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
    products = ['[CH]=CC(C)C=C[CH]C(14626)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH]=C[C]([CH2])CC=CC(14319)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH]=CC([CH2])[CH]C=CC(14317)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH]=[C]C([CH2])CC=CC(14320)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C2H2(T)(1343)', '[CH2][CH]CC=CC(553)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.135493,'m^3/(mol*s)'), n=1.98996, Ea=(105.697,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_R;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 100.9 to 105.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction28',
    reactants = ['C2H2(1342)', '[CH2][CH]C[CH][CH]C(555)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C2H2(T)(1343)', '[CH2][CH]C[CH][CH]C(555)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', '[CH]=C[C]([CH2])C[CH][CH]C(14627)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', '[CH]=CC([CH2])[CH][CH][CH]C(14628)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', '[CH][CH]C([CH2])CC=C[CH2](9214)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', '[CH]=[C]C([CH2])C[CH][CH]C(14629)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]=C[C](C)C[CH][CH]C(14630)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH]=CC([CH2])[CH]C[CH]C(14631)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
    products = ['[CH2]C([C]=C)C[CH][CH]C(5874)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
    products = ['[CH]=CC(C)[CH][CH][CH]C(14632)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH]=[C]C(C)C[CH][CH]C(14633)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
    products = ['[CH]=C[C]([CH2])CC[CH]C(14634)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH]=CC([CH2])[CH][CH]CC(13963)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
    products = ['[CH2][C](C=C)C[CH][CH]C(5872)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH]=[C]C([CH2])CC[CH]C(14635)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
    products = ['[CH2]C([CH][CH][CH]C)C=C(5873)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
    products = ['[CH]=C[C]([CH2])C[CH]CC(13962)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH]=[C]C([CH2])C[CH]CC(13964)'],
    products = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH]=CC([CH2])C[CH][CH]C(5875)'],
    products = ['[CH][CH]C(C)CC=C[CH2](5786)'],
