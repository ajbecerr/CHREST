...
species(
    label = 'C=C([O])[CH]C(C)C(2733)',
    structure = SMILES('[CH2]C([O])=CC(C)C'),
    E0 = (-2.13663,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655,350,440,435,1725,3000,3100,440,815,1455,1000,390.704,390.721],'cm^-1')),
        HinderedRotor(inertia=(0.00110427,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0949376,'amu*angstrom^2'), symmetry=1, barrier=(10.282,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0949151,'amu*angstrom^2'), symmetry=1, barrier=(10.2821,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0948681,'amu*angstrom^2'), symmetry=1, barrier=(10.2814,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.605608,0.0642651,-2.93862e-05,-1.02268e-08,9.60217e-12,-125.443,27.6206], Tmin=(100,'K'), Tmax=(965.299,'K')), NASAPolynomial(coeffs=[15.2469,0.027499,-9.40048e-06,1.62456e-09,-1.11287e-13,-4065.81,-48.267], Tmin=(965.299,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-2.13663,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(C=C(C)OJ) + radical(C=C(O)CJ)"""),
)
...
species(
    label = 'C=C([O])C(C)[C]C(2735)',
    structure = SMILES('C=C([O])C(C)[C]C'),
    E0 = (299.407,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,2950,3100,1380,975,1025,1650,381.472,381.474,381.894,382.057],'cm^-1')),
        HinderedRotor(inertia=(0.00115701,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.136853,'amu*angstrom^2'), symmetry=1, barrier=(14.1677,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137097,'amu*angstrom^2'), symmetry=1, barrier=(14.1734,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.137025,'amu*angstrom^2'), symmetry=1, barrier=(14.1706,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.532059,0.0666688,-4.14165e-05,3.1475e-09,4.56316e-12,36143.7,28.2323], Tmin=(100,'K'), Tmax=(994.095,'K')), NASAPolynomial(coeffs=[15.7335,0.0253857,-9.12731e-06,1.61446e-09,-1.11429e-13,32138.9,-49.9576], Tmin=(994.095,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0934997,0.0759168,-5.43751e-05,1.03249e-08,3.39121e-12,-23133.7,23.6654], Tmin=(100,'K'), Tmax=(976.528,'K')), NASAPolynomial(coeffs=[17.8703,0.024556,-8.43945e-06,1.46465e-09,-1.00585e-13,-27628.6,-66.9134], Tmin=(976.528,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-193.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CC(C)C(=C)O(2315)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.281534,0.0714086,-4.54865e-05,4.24128e-09,4.67279e-12,-19025.8,25.8135], Tmin=(100,'K'), Tmax=(995.087,'K')), NASAPolynomial(coeffs=[16.9122,0.0259875,-9.32223e-06,1.65497e-09,-1.14706e-13,-23396.6,-59.6692], Tmin=(995.087,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-159.379,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'C[CH]C(C)[C]1CO1(2737)',
    structure = SMILES('C[CH]C(C)[C]1CO1'),
    E0 = (194.181,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07724,0.0616763,-3.62128e-05,4.43332e-09,3.98629e-12,23462.4,27.3791], Tmin=(100,'K'), Tmax=(846.744,'K')), NASAPolynomial(coeffs=[8.88954,0.0364964,-1.23776e-05,2.02083e-09,-1.29805e-13,21719.1,-11.4931], Tmin=(846.744,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(194.181,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(Cs_S)"""),
)

species(
    label = 'CC1C[C]([O])C1C(2738)',
    structure = SMILES('CC1C[C]([O])C1C'),
    E0 = (182.748,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17998,0.0457594,2.48765e-05,-6.26029e-08,2.64661e-11,22095.5,24.1203], Tmin=(100,'K'), Tmax=(985.416,'K')), NASAPolynomial(coeffs=[14.5502,0.0305261,-1.13606e-05,2.11592e-09,-1.52649e-13,17565,-49.8043], Tmin=(985.416,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(182.748,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C1([O])C(C)C1C(2739)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.559294,0.0611469,-1.08548e-05,-3.30108e-08,1.79777e-11,24567.4,24.0754], Tmin=(100,'K'), Tmax=(974.161,'K')), NASAPolynomial(coeffs=[17.4053,0.0259972,-9.11779e-06,1.65098e-09,-1.17985e-13,19671,-65.0416], Tmin=(974.161,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(203.127,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)2OJ) + radical(CJC(C)2O)"""),
)
...
species(
    label = 'C=C([O])[C](C)CC(2506)',
    structure = SMILES('[CH2]C([O])=C(C)CC'),
    E0 = (-9.43951,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,325,375,415,465,420,450,1700,1750,3000,3100,440,815,1455,1000,313.838,314.785],'cm^-1')),
        HinderedRotor(inertia=(0.00170235,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112888,'amu*angstrom^2'), symmetry=1, barrier=(7.94834,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113847,'amu*angstrom^2'), symmetry=1, barrier=(7.94226,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112472,'amu*angstrom^2'), symmetry=1, barrier=(7.94566,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.28084,0.0735632,-6.17138e-05,2.79013e-08,-5.09813e-12,-994.535,28.2407], Tmin=(100,'K'), Tmax=(1312.97,'K')), NASAPolynomial(coeffs=[15.0975,0.028424,-1.01446e-05,1.71688e-09,-1.12402e-13,-4885.29,-47.2754], Tmin=(1312.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-9.43951,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + radical(C=C(C)OJ) + radical(C=C(O)CJ)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.29032,0.0702849,-3.85062e-05,-5.83289e-09,9.10741e-12,-593.726,25.5954], Tmin=(100,'K'), Tmax=(962.618,'K')), NASAPolynomial(coeffs=[17.5214,0.0247965,-8.31384e-06,1.4373e-09,-9.93335e-14,-5120.96,-63.1624], Tmin=(962.618,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-6.13165,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + radical(Allyl_S) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH]=C(O)C(C)[CH]C(2746)',
    structure = SMILES('[CH]=C(O)C(C)[CH]C'),
    E0 = (155.026,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,350,440,435,1725,3120,650,792.5,1650,418.318],'cm^-1')),
        HinderedRotor(inertia=(0.000963394,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.098078,'amu*angstrom^2'), symmetry=1, barrier=(12.1773,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0980788,'amu*angstrom^2'), symmetry=1, barrier=(12.1771,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0980702,'amu*angstrom^2'), symmetry=1, barrier=(12.1776,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.098097,'amu*angstrom^2'), symmetry=1, barrier=(12.1777,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.3335,0.0699013,-4.24063e-05,1.80393e-09,5.27355e-12,18786.7,30.4984], Tmin=(100,'K'), Tmax=(1003.95,'K')), NASAPolynomial(coeffs=[16.8641,0.0259617,-9.51082e-06,1.71038e-09,-1.19373e-13,14362.7,-54.8198], Tmin=(1003.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(155.026,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Cs_S) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83065,0.0541944,-2.67796e-05,5.50335e-09,-4.00973e-13,-24687.9,22.3535], Tmin=(100,'K'), Tmax=(2362.45,'K')), NASAPolynomial(coeffs=[25.8621,0.0195953,-8.67804e-06,1.48637e-09,-9.13537e-14,-37741.9,-117.841], Tmin=(2362.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-205.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-O2d)HHH) + group(Cd-CdCs(CO)) + group(Cds-CdsCsH) + group(Cds-O2d(Cds-Cds)Cs)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.289379,0.0717601,-6.07435e-05,2.9962e-08,-5.94571e-12,22900.6,25.5543], Tmin=(100,'K'), Tmax=(1346.29,'K')), NASAPolynomial(coeffs=[12.6365,0.0298955,-8.32792e-06,1.14856e-09,-6.44774e-14,20045.5,-35.9412], Tmin=(1346.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.226,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)

species(
    label = 'C[CH][C](C)C(C)=O(2751)',
    structure = SMILES('C[CH]C(C)=C(C)[O]'),
    E0 = (-27.2435,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.497559,0.0678563,-4.90851e-05,1.86593e-08,-2.89263e-12,-3142.97,25.6763], Tmin=(100,'K'), Tmax=(1513.02,'K')), NASAPolynomial(coeffs=[14.9951,0.0295285,-1.10869e-05,1.91648e-09,-1.26151e-13,-7529.96,-50.2696], Tmin=(1513.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-27.2435,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + radical(C=C(C)OJ) + radical(Allyl_S)"""),
)
...
species(
    label = '[CH2]C(=C[CH]C)OC(2753)',
    structure = SMILES('[CH2]C(=C[CH]C)OC'),
    E0 = (51.6075,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.573932,0.0625205,-1.93686e-05,-2.21952e-08,1.38011e-11,6341.75,25.4558], Tmin=(100,'K'), Tmax=(979.054,'K')), NASAPolynomial(coeffs=[16.5154,0.0267378,-9.50921e-06,1.70784e-09,-1.20405e-13,1813.69,-58.2983], Tmin=(979.054,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.6075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(C=C(O)CJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=O)C(C)[CH]C(2027)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CHCH3(T)(21)', 'C=C([O])[CH]C(2381)'],
    products = ['[CH2]C(=O)C(C)[CH]C(2027)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH]C(C)C(=C)[O](2410)'],
    products = ['[CH2]C(=O)C(C)[CH]C(2027)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(4)', 'C=[C]C(C)[CH]C(2734)'],
    products = ['[CH2]C(=O)C(C)[CH]C(2027)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', 'C=C([O])C(C)[C]C(2735)'],
    products = ['[CH2]C(=O)C(C)[CH]C(2027)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C([O])[C](C)[CH]C(2030)'],
    products = ['[CH2]C(=O)C(C)[CH]C(2027)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(=O)C(C)[CH]C(2027)'],
    products = ['CC1C[C]([O])C1C(2738)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(1.82767e+08,'s^-1'), n=1.02667, Ea=(137.014,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_Cs_RR_D;doublebond_intra;radadd_intra_csHCs]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(=O)C(C)[CH]C(2027)'],
    products = ['[CH2]C1([O])C(C)C1C(2739)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C=C([O])C(C)=CC(2740)'],
    products = ['[CH2]C(=O)C(C)[CH]C(2027)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'C=CC(C)C(=C)[O](2741)'],
    products = ['[CH2]C(=O)C(C)[CH]C(2027)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(17)', 'C=C([O])C=CC(2451)'],
    products = ['[CH2]C(=O)C(C)[CH]C(2027)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH3(17)', 'C=C([O])[CH][CH]C(2452)'],
    products = ['[CH2]C(=O)C(C)[CH]C(2027)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', 'C=C([O])[C](C)[CH]C(2742)'],
    products = ['[CH2]C(=O)C(C)[CH]C(2027)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]=C(O)C(C)[CH]C(2746)'],
    products = ['[CH2]C(=O)C(C)[CH]C(2027)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2]C([CH]C)C(=C)O(2509)'],
    products = ['[CH2]C(=O)C(C)[CH]C(2027)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2][CH]C(C)C(=C)O(2747)'],
    products = ['[CH2]C(=O)C(C)[CH]C(2027)'],
...
reaction(
    label = 'reaction37',
    reactants = ['CH2(T)(20)', 'C[CH]C(C)[C]=O(2748)'],
    products = ['[CH2]C(=O)C(C)[CH]C(2027)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2][C](O)C([CH2])[CH]C(2515)'],
    products = ['[CH2]C(=O)C(C)[CH]C(2027)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH2]C([CH]C)C(C)=O(2519)'],
    products = ['[CH2]C(=O)C(C)[CH]C(2027)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2][CH]C(C)C(C)=O(2752)'],
    products = ['[CH2]C(=O)C(C)[CH]C(2027)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2]C(=C[CH]C)OC(2753)'],
    products = ['[CH2]C(=O)C(C)[CH]C(2027)'],
