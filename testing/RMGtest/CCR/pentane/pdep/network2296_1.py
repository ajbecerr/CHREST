...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.263472,0.0852868,-8.71925e-05,4.51446e-08,-9.12982e-12,54006.6,31.4821], Tmin=(100,'K'), Tmax=(1212.9,'K')), NASAPolynomial(coeffs=[19.3143,0.0207215,-7.34409e-06,1.25606e-09,-8.36033e-14,49257.4,-66.748], Tmin=(1212.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(447.7,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    ...
    E0 = (471.48,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,298.416,298.562,298.733],'cm^-1')),
        HinderedRotor(inertia=(0.240105,'amu*angstrom^2'), symmetry=1, barrier=(15.1795,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240037,'amu*angstrom^2'), symmetry=1, barrier=(15.1854,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240058,'amu*angstrom^2'), symmetry=1, barrier=(15.1809,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.239901,'amu*angstrom^2'), symmetry=1, barrier=(15.1775,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
...
species(
    label = '[CH]C(CC)O[C]=[CH](9767)',
    structure = SMILES('[CH]C(CC)O[C]=[CH]'),
    E0 = (689.345,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.14908,0.0756194,-6.5072e-05,2.29089e-08,-1.2738e-12,83055.7,31.1852], Tmin=(100,'K'), Tmax=(1002.32,'K')), NASAPolynomial(coeffs=[18.3531,0.019939,-7.13685e-06,1.26389e-09,-8.75841e-14,78554.2,-60.9324], Tmin=(1002.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(689.345,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[C]=[C]OC([CH2])CC(9768)',
    structure = SMILES('[C]=[C]OC([CH2])CC'),
    E0 = (762.646,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.118577,0.0853736,-9.94277e-05,6.03738e-08,-1.45279e-11,91865,30.0234], Tmin=(100,'K'), Tmax=(1015.34,'K')), NASAPolynomial(coeffs=[15.4199,0.0250931,-1.03731e-05,1.90101e-09,-1.30614e-13,88757.8,-44.0294], Tmin=(1015.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(762.646,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.606062,0.0644642,-3.70421e-05,6.7959e-10,4.69928e-12,18469.3,28.5419], Tmin=(100,'K'), Tmax=(1027.68,'K')), NASAPolynomial(coeffs=[15.5222,0.0261595,-9.9636e-06,1.81641e-09,-1.27027e-13,14360.4,-48.9022], Tmin=(1027.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.473,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = 'C#CO[C]([CH2])CC(7383)',
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.140594,0.0934051,-0.000121397,8.22346e-08,-2.19823e-11,42823.3,25.5453], Tmin=(100,'K'), Tmax=(918.314,'K')), NASAPolynomial(coeffs=[15.3955,0.0257324,-1.08576e-05,1.98594e-09,-1.35348e-13,39969.9,-48.0833], Tmin=(918.314,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(354.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH]=[C]O[C]([CH2])CC(9770)',
    structure = SMILES('[CH]=[C]O[C]([CH2])CC'),
    E0 = (651.856,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0126989,0.0905917,-0.000117994,8.07171e-08,-2.18707e-11,78541.2,31.9301], Tmin=(100,'K'), Tmax=(904.697,'K')), NASAPolynomial(coeffs=[14.5704,0.026229,-1.1284e-05,2.08616e-09,-1.43053e-13,75907,-36.8452], Tmin=(904.697,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(651.856,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C2CsJOC(O)) + radical(CJC(C)OC) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.311352,0.0785466,-7.73716e-05,4.00738e-08,-8.33645e-12,53216.6,30.4057], Tmin=(100,'K'), Tmax=(1159.4,'K')), NASAPolynomial(coeffs=[15.1142,0.0274748,-1.12952e-05,2.07858e-09,-1.43452e-13,49784.2,-43.1988], Tmin=(1159.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(441.346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C2CsJOC(O)) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH]=[C]OC([CH2])C(2404)'],
    products = ['[CH]=[C]OC([CH2])CC(2484)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=[CH](9646)', '[CH2]C([O])CC(1362)'],
    products = ['[CH]=[C]OC([CH2])CC(2484)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', '[CH]=[C]O[CH]CC(9695)'],
    products = ['[CH]=[C]OC([CH2])CC(2484)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]C(CC)O[C]=[CH](9767)'],
    products = ['[CH]=[C]OC([CH2])CC(2484)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[C]=[C]OC([CH2])CC(9768)'],
    products = ['[CH]=[C]OC([CH2])CC(2484)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'C#CO[C]([CH2])CC(7383)'],
    products = ['[CH]=[C]OC([CH2])CC(2484)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C2H5(14)', 'C#CO[CH][CH2](3100)'],
    products = ['[CH]=[C]OC([CH2])CC(2484)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C2H5(14)', '[CH]=[C]O[CH][CH2](9651)'],
    products = ['[CH]=[C]OC([CH2])CC(2484)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH]=[C]O[C]([CH2])CC(9770)'],
    products = ['[CH]=[C]OC([CH2])CC(2484)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(17)', '[CH]=[C]OC([CH2])[CH2](2590)'],
    products = ['[CH]=[C]OC([CH2])CC(2484)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH]=[C]OC([CH2])C[CH2](7160)'],
    products = ['[CH]=[C]OC([CH2])CC(2484)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]=[C]OC([CH2])CC(2484)'],
    products = ['[CH]=COC([CH2])C[CH2](5570)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]=[C]OC([CH2])CC(2484)'],
    products = ['[CH2]CC([CH2])O[C]=C(2483)'],
