...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C[CH][C]=C(15607)'],
    products = ['C2H4(22)', 'C3H3(5450)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(20)', '[CH2][C]=C[CH2](8994)'],
    products = ['[CH2]C[CH][C]=C(15607)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH]CC=[C][CH2](16914)'],
    products = ['[CH2]C[CH][C]=C(15607)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH][C]=CC[CH2](16915)'],
    products = ['[CH2]C[CH][C]=C(15607)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', 'C=[C][CH]C=C(15984)'],
    products = ['[CH2]C[CH][C]=C(15607)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH2]C#CC[CH2](16917)'],
    products = ['[CH2]C[CH][C]=C(15607)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H4(22)', '[CH]=[C][CH2](16918)'],
    products = ['[CH2]C[CH][C]=C(15607)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['C2H4(T)(23)', '[CH]=[C][CH2](16918)'],
    products = ['[CH2]C[CH][C]=C(15607)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH2][C]=C[CH][CH2](16919)'],
    products = ['[CH2]C[CH][C]=C(15607)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2][C]=[C]C[CH2](16920)'],
    products = ['[CH2]C[CH][C]=C(15607)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C#C[CH]C[CH2](16928)'],
    products = ['[CH2]C[CH][C]=C(15607)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(T)(20)', 'CH2CHCCH2(4848)'],
    products = ['[CH2]C[CH][C]=C(15607)'],
