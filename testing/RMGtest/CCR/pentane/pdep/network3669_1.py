...
species(
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32226,0.0485318,-2.31505e-05,-1.42104e-08,1.16767e-11,43101.9,21.9134], Tmin=(100,'K'), Tmax=(938.857,'K')), NASAPolynomial(coeffs=[16.5371,0.00960072,-2.31764e-06,3.70396e-10,-2.76653e-14,39103.8,-56.6066], Tmin=(938.857,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(357.489,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=[CH](9646)', 'C=[C]C[O](15501)'],
    products = ['[CH]=[C]OC[C]=C(15563)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2CC(T)(1341)', '[CH]=[C]O[CH2](9647)'],
    products = ['[CH]=[C]OC[C]=C(15563)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[C]=[C]OC[C]=C(16176)'],
    products = ['[CH]=[C]OC[C]=C(15563)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[CH]=[C]OC[C]=C(15563)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(2.82396,'m^3/(mol*s)'), n=2.03228, Ea=(88.2335,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 83.6 to 88.2 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]=[C]CO[C]=[CH](16182)'],
    products = ['[CH]=[C]OC[C]=C(15563)'],
