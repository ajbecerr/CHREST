...
species(
    label = '[O][C]CC[O](29171)',
    structure = SMILES('[O][C]CC[O]'),
    E0 = (472.22,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,180,180,180,1886.08,1892.02],'cm^-1')),
        HinderedRotor(inertia=(0.210021,'amu*angstrom^2'), symmetry=1, barrier=(4.82879,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.212057,'amu*angstrom^2'), symmetry=1, barrier=(4.87561,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.15819,0.0519733,-0.000101234,1.07957e-07,-4.2218e-11,56850.2,19.8278], Tmin=(100,'K'), Tmax=(853.318,'K')), NASAPolynomial(coeffs=[0.439135,0.0319225,-1.65761e-05,3.21392e-09,-2.2128e-13,58167,33.845], Tmin=(853.318,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(472.22,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCOJ) + radical(CH2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.11992,0.0318115,1.19585e-06,-2.96735e-08,1.53115e-11,-25703,18.9378], Tmin=(100,'K'), Tmax=(937.022,'K')), NASAPolynomial(coeffs=[12.8448,0.0100968,-2.57148e-06,4.18993e-10,-3.08698e-14,-28769.5,-37.7442], Tmin=(937.022,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-214.342,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ)"""),
)

species(
    label = '[O]C=CC[O](28866)',
    structure = SMILES('[O]C=CC[O]'),
    E0 = (11.363,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,291.387,291.44,291.68],'cm^-1')),
        HinderedRotor(inertia=(0.00198365,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
...
species(
    label = '[O][CH][CH]C[O](29172)',
    structure = SMILES('[O][CH][CH]C[O]'),
    E0 = (391.431,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,180,1845.09,1846.67,1848.81],'cm^-1')),
        HinderedRotor(inertia=(0.114765,'amu*angstrom^2'), symmetry=1, barrier=(2.63868,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.115114,'amu*angstrom^2'), symmetry=1, barrier=(2.6467,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30645,0.0494199,-9.81241e-05,1.06665e-07,-4.18765e-11,47127.6,22.61], Tmin=(100,'K'), Tmax=(865.202,'K')), NASAPolynomial(coeffs=[-0.703593,0.0328752,-1.66308e-05,3.1801e-09,-2.16786e-13,48788.6,43.2846], Tmin=(865.202,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(391.431,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCOJ) + radical(CCJCO) + radical(CCsJOH)"""),
)
...
species(
    label = '[O]C[CH]C[O](29173)',
    structure = SMILES('[O]C[CH]C[O]'),
    E0 = (211.134,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,180,1950.05,1950.05,1950.31],'cm^-1')),
        HinderedRotor(inertia=(0.0818769,'amu*angstrom^2'), symmetry=1, barrier=(1.88251,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0818188,'amu*angstrom^2'), symmetry=1, barrier=(1.88117,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.55459,0.0409525,-6.80184e-05,7.61148e-08,-3.1624e-11,25436.6,21.476], Tmin=(100,'K'), Tmax=(840.678,'K')), NASAPolynomial(coeffs=[-1.28641,0.0360103,-1.77732e-05,3.41777e-09,-2.35945e-13,26902.9,44.2197], Tmin=(840.678,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(211.134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = '[O][CH]C[CH]O(29174)',
    structure = SMILES('[O][CH]C[CH]O'),
    E0 = (146.122,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,180,180,1929.54],'cm^-1')),
        HinderedRotor(inertia=(0.197763,'amu*angstrom^2'), symmetry=1, barrier=(4.54696,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197815,'amu*angstrom^2'), symmetry=1, barrier=(4.54817,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.197835,'amu*angstrom^2'), symmetry=1, barrier=(4.54862,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53486,0.0654523,-0.000123185,1.19888e-07,-4.31797e-11,17652.5,21.573], Tmin=(100,'K'), Tmax=(883.127,'K')), NASAPolynomial(coeffs=[3.89395,0.0278131,-1.34726e-05,2.50656e-09,-1.67215e-13,18286.9,16.4359], Tmin=(883.127,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(146.122,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCsJOH) + radical(CCsJOH)"""),
)

species(
    label = '[O][CH][CH]CO(29175)',
    ...
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96458,0.0519086,-8.48328e-05,8.01226e-08,-2.90626e-11,19998.7,22.9777], Tmin=(100,'K'), Tmax=(861.016,'K')), NASAPolynomial(coeffs=[3.95958,0.0265075,-1.2475e-05,2.33567e-09,-1.58232e-13,20253.2,17.1242], Tmin=(861.016,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(165.726,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCJCO) + radical(CCsJOH)"""),
)

species(
    label = '[O]C[CH][CH]O(29176)',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH][O](1548)', '[CH2]C[O](1358)'],
    products = ['[O][CH]CC[O](3426)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[O][CH][CH]C[O](29172)'],
    products = ['[O][CH]CC[O](3426)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[O][CH]C[CH][O](1933)'],
    products = ['[O][CH]CC[O](3426)'],
