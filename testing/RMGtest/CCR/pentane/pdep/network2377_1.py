...
species(
    label = '[CH][C]1OC([CH2])O1(10239)',
    structure = SMILES('[CH][C]1OC([CH2])O1'),
    E0 = (539.979,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
...
species(
    label = '[CH][C]1O[CH]CO1(10240)',
    structure = SMILES('[CH][C]1O[CH]CO1'),
    E0 = (462.096,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.28558,0.0554547,-6.57887e-05,3.65839e-08,-7.03429e-12,55733.8,23.779], Tmin=(100,'K'), Tmax=(1655.03,'K')), NASAPolynomial(coeffs=[12.3018,0.00124773,6.14872e-06,-1.58073e-09,1.1846e-13,55202.9,-29.8339], Tmin=(1655.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(462.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(1,3-Dioxolane) + radical(CCsJOCs) + radical(Cs_P) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[C]=C([O])O[CH][CH2](10242)',
    structure = SMILES('[C]C(=O)O[CH][CH2]'),
    E0 = (611.507,'kJ/mol'),
    modes = [
...
species(
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31839,0.0403057,1.9547e-05,-8.15521e-08,4.37046e-11,23302.3,20.1007], Tmin=(100,'K'), Tmax=(867.999,'K')), NASAPolynomial(coeffs=[23.5769,-0.00814585,9.74701e-06,-2.18983e-09,1.56893e-13,17399.4,-95.8774], Tmin=(867.999,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(192.794,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cs_P) + radical(CCsJO)"""),
)

species(
    label = '[CH]=C1OC([CH2])O1(10244)',
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47087,0.0348538,2.91931e-05,-7.99574e-08,3.75648e-11,31683.1,17.5856], Tmin=(100,'K'), Tmax=(933.904,'K')), NASAPolynomial(coeffs=[22.4795,-0.00205965,3.24587e-06,-5.89248e-10,3.04584e-14,25444.9,-94.7223], Tmin=(933.904,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(262.512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(CJCO) + radical(Cds_P)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.58565,0.0523251,-5.46024e-05,2.90117e-08,-6.1475e-12,63582.5,25.5054], Tmin=(100,'K'), Tmax=(1140.74,'K')), NASAPolynomial(coeffs=[11.8254,0.0164192,-7.38789e-06,1.41853e-09,-1.00238e-13,61246.4,-25.2437], Tmin=(1140.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(527.926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=CJO) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C](O)O[C]=C(7116)',
    structure = SMILES('[CH][C](O)O[C]=C'),
    E0 = (507.468,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,360,370,350,2950,3100,1380,975,1025,1650,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.883369,0.0602821,-6.85877e-05,3.70548e-08,-7.5929e-12,61153.5,27.8512], Tmin=(100,'K'), Tmax=(1260.14,'K')), NASAPolynomial(coeffs=[17.2673,0.00610929,-1.52512e-06,2.11897e-10,-1.29967e-14,57196.3,-54.298], Tmin=(1260.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(507.468,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cs_P) + radical(C=CJO) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([O])OC=[CH](6975)',
    structure = SMILES('[CH]C([O])OC=[CH]'),
    E0 = (535.278,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,449.142,449.155,449.164,449.175,449.256,449.327],'cm^-1')),
        HinderedRotor(inertia=(0.0025318,'amu*angstrom^2'), symmetry=1, barrier=(25.3775,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177263,'amu*angstrom^2'), symmetry=1, barrier=(25.3732,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.177126,'amu*angstrom^2'), symmetry=1, barrier=(25.372,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08857,0.0566475,-5.35359e-05,1.98525e-08,-1.2519e-12,64490.5,24.5612], Tmin=(100,'K'), Tmax=(996.138,'K')), NASAPolynomial(coeffs=[16.5621,0.00885188,-3.15532e-06,5.84926e-10,-4.27523e-14,60696.4,-53.6003], Tmin=(996.138,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(535.278,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]C(=O)O[CH][CH2](2809)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]=C([O])[O](9591)', '[CH][CH2](502)'],
    products = ['[CH]C(=O)O[CH][CH2](2809)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH][C]([O])O[C]=C(7114)'],
    products = ['[CH]C(=O)O[CH][CH2](2809)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]C(=O)O[CH][CH2](2809)'],
    products = ['[CH][C]1OC([CH2])O1(10239)'],
    transitionState = 'TS6',
...
reaction(
    ...
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(3.54938e+07,'s^-1'), n=1.23279, Ea=(125.508,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5;multiplebond_intra;radadd_intra_cs2H] for rate rule [R5;carbonylbond_intra;radadd_intra_cs2H]
Euclidian distance = 1.0
family: Intra_R_Add_Exocyclic
Ea raised from 123.6 to 125.5 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['O(4)', '[CH]=[C]O[CH][CH2](9651)'],
    products = ['[CH]C(=O)O[CH][CH2](2809)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[C]=C([O])O[CH][CH2](10242)'],
    products = ['[CH]C(=O)O[CH][CH2](2809)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O(4)', 'C#CO[CH][CH2](3100)'],
    products = ['[CH]C(=O)O[CH][CH2](2809)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]=C([O])[O](9591)', 'C2H3(60)'],
    products = ['[CH]C(=O)O[CH][CH2](2809)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH][C]([O])[O](10245)', 'C2H3(60)'],
    products = ['[CH]C(=O)O[CH][CH2](2809)'],
...
network(
    label = 'PDepNetwork #2377',
    isomers = [
        '[CH]C(=O)O[CH][CH2](2809)',
    ],
    reactants = [
