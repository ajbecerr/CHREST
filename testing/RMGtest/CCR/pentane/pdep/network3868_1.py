...
species(
    label = '[C]=[C]CC([CH2])[O](17637)',
    structure = SMILES('[C]=[C]CC([CH2])[O]'),
    E0 = (1025.12,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,387.82,387.866,387.873],'cm^-1')),
        HinderedRotor(inertia=(0.00112073,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.086856,'amu*angstrom^2'), symmetry=1, barrier=(9.27115,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.086855,'amu*angstrom^2'), symmetry=1, barrier=(9.27105,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46342,0.0613771,-7.83517e-05,4.9722e-08,-9.66129e-12,123380,25.1105], Tmin=(100,'K'), Tmax=(628.231,'K')), NASAPolynomial(coeffs=[8.81732,0.0239012,-1.11894e-05,2.13335e-09,-1.48082e-13,122271,-8.41739], Tmin=(628.231,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1025.12,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CJCO) + radical(Cds_S) + radical(CdCdJ2_triplet)"""),
)

species(
    label = '[CH]=[C]CC1CO1(17638)',
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04579,0.0530315,-4.7565e-05,2.37083e-08,-4.52987e-12,55649.8,23.1973], Tmin=(100,'K'), Tmax=(1512.61,'K')), NASAPolynomial(coeffs=[11.1547,0.0173275,-3.26185e-06,2.60952e-10,-6.48741e-15,53618,-26.3631], Tmin=(1512.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(461.729,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.684864,'amu*angstrom^2'), symmetry=1, barrier=(15.7464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.684437,'amu*angstrom^2'), symmetry=1, barrier=(15.7366,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.683707,'amu*angstrom^2'), symmetry=1, barrier=(15.7198,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13554,0.054843,-3.99413e-05,4.51873e-09,4.58932e-12,43303.8,24.0389], Tmin=(100,'K'), Tmax=(950.21,'K')), NASAPolynomial(coeffs=[15.8043,0.012506,-3.75282e-06,6.29177e-10,-4.40477e-14,39639.7,-50.5918], Tmin=(950.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(359.129,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.965994,0.0590823,-5.91217e-05,3.04314e-08,-6.10152e-12,38280,26.3552], Tmin=(100,'K'), Tmax=(1262.52,'K')), NASAPolynomial(coeffs=[14.6821,0.0142936,-4.32505e-06,6.60377e-10,-4.08108e-14,34922.9,-42.5937], Tmin=(1262.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(317.316,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CJCO) + radical(C=C=CJ)"""),
)
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.867206,0.0746492,-0.000115837,9.673e-08,-3.1562e-11,79533,26.8604], Tmin=(100,'K'), Tmax=(862.419,'K')), NASAPolynomial(coeffs=[9.45709,0.0246108,-1.10689e-05,2.03174e-09,-1.36197e-13,78430.6,-11.1107], Tmin=(862.419,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(660.382,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C2CsJOH) + radical(CJCO) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[C]=[C]CC([CH2])[O](17637)'],
    products = ['[CH]=[C]CC([CH2])[O](15961)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH]=[C]CC(=C)[O](15779)'],
    products = ['[CH]=[C]CC([CH2])[O](15961)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(93.0912,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 89.6 to 93.1 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH]=[C]C[C]([CH2])[O](17641)'],
    products = ['[CH]=[C]CC([CH2])[O](15961)'],
