...
species(
    label = '[CH]=CC[C]C(15090)',
    structure = SMILES('[CH]=CC[C]C'),
    E0 = (655.009,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180,759.267],'cm^-1')),
        HinderedRotor(inertia=(0.844642,'amu*angstrom^2'), symmetry=1, barrier=(19.42,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.84678,'amu*angstrom^2'), symmetry=1, barrier=(19.4691,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.386824,'amu*angstrom^2'), symmetry=1, barrier=(8.89384,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (67.1091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.74881,0.0431292,-2.42214e-05,2.6052e-09,1.59315e-12,78865.9,20.7139], Tmin=(100,'K'), Tmax=(1098.68,'K')), NASAPolynomial(coeffs=[10.6137,0.0211746,-8.33728e-06,1.51656e-09,-1.04588e-13,76295.1,-25.7229], Tmin=(1098.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(655.009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.71859,0.00907029,8.67829e-05,-1.17239e-07,4.49727e-11,13620,15.2057], Tmin=(100,'K'), Tmax=(953.253,'K')), NASAPolynomial(coeffs=[11.8045,0.0195071,-6.05653e-06,1.1315e-09,-8.70667e-14,9681.37,-39.7667], Tmin=(953.253,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(112.715,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)
...
species(
    label = '[CH]=[C]CCC(15094)',
    structure = SMILES('[CH]=[C]CCC'),
    E0 = (444.636,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,352.563],'cm^-1')),
        HinderedRotor(inertia=(0.101724,'amu*angstrom^2'), symmetry=1, barrier=(8.983,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102531,'amu*angstrom^2'), symmetry=1, barrier=(9.03003,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102018,'amu*angstrom^2'), symmetry=1, barrier=(9.00701,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80017,0.0442028,-2.73483e-05,8.62697e-09,-1.12131e-12,53559.8,21.1033], Tmin=(100,'K'), Tmax=(1729.86,'K')), NASAPolynomial(coeffs=[10.904,0.0231522,-9.0952e-06,1.59262e-09,-1.04726e-13,50410,-27.8069], Tmin=(1729.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(444.636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC[CH]C(15031)'],
    products = ['C2H2(1342)', 'C3H6(27)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=CC([CH2])C(13652)'],
    products = ['[CH]=CC[CH]C(15031)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CHCH3(T)(21)', '[CH]C=C(3739)'],
    products = ['[CH]=CC[CH]C(15031)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', '[CH]CC=[CH](15079)'],
    products = ['[CH]=CC[CH]C(15031)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction15',
    reactants = ['C2H2(T)(1343)', 'C3H6(T)(28)'],
    products = ['[CH]=CC[CH]C(15031)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH]=C[CH][CH]C(15093)'],
    products = ['[CH]=CC[CH]C(15031)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH]=CC[CH][CH2](15036)'],
    products = ['[CH]=CC[CH]C(15031)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH]=[C]C[CH]C(9720)'],
    products = ['[CH]=CC[CH]C(15031)'],
