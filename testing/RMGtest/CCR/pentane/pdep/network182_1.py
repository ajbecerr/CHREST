...
species(
    ...
    molecularWeight = (41.0718,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.52418,-0.00309166,7.19178e-05,-9.14842e-08,3.49794e-11,33782.5,9.3787], Tmin=(100,'K'), Tmax=(937.427,'K')), NASAPolynomial(coeffs=[9.02682,0.00813464,-1.57961e-06,2.78563e-10,-2.51265e-14,31225.9,-24.9464], Tmin=(937.427,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(280.638,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), label="""cC3H5""", comment="""Thermo library: DFT_QCI_thermo"""),
)
