...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57445,0.0446625,-2.34071e-05,-7.80525e-09,7.86042e-12,77300.6,18.5034], Tmin=(100,'K'), Tmax=(962.297,'K')), NASAPolynomial(coeffs=[14.3268,0.0119575,-4.07515e-06,7.26866e-10,-5.21921e-14,73906.2,-47.4136], Tmin=(962.297,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(641.922,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(CH2_triplet)"""),
)
...
species(
    label = '[CH]C(=C)O[C]C(17804)',
    structure = SMILES('[CH]C(=C)O[C]C'),
    E0 = (604.374,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.716012,0.0621567,-4.08305e-05,1.99007e-09,5.40143e-12,72816.6,22.3163], Tmin=(100,'K'), Tmax=(984.38,'K')), NASAPolynomial(coeffs=[16.9339,0.0179634,-6.56671e-06,1.18704e-09,-8.39926e-14,68572,-61.0125], Tmin=(984.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(604.374,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CH2_triplet) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C(=[CH])OCC(17806)',
    structure = SMILES('[CH]C(=[CH])OCC'),
    E0 = (390.482,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.834529,0.0599798,-3.3232e-05,-2.6473e-09,6.15688e-12,47086.6,22.8687], Tmin=(100,'K'), Tmax=(993.244,'K')), NASAPolynomial(coeffs=[15.0122,0.0232959,-8.6592e-06,1.55072e-09,-1.07775e-13,43263.4,-50.5031], Tmin=(993.244,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(390.482,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    label = '[C]=C([CH2])O[CH]C(17807)',
    structure = SMILES('[C]C(=C)O[CH]C'),
    E0 = (636.107,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,350,440,435,1725,2950,3100,1380,975,1025,1650,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.808548,'amu*angstrom^2'), symmetry=1, barrier=(18.5901,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.808232,'amu*angstrom^2'), symmetry=1, barrier=(18.5829,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.807422,'amu*angstrom^2'), symmetry=1, barrier=(18.5642,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0967075,0.0725894,-7.95067e-05,4.117e-08,-8.01849e-12,76657.8,22.6291], Tmin=(100,'K'), Tmax=(1384.01,'K')), NASAPolynomial(coeffs=[20.8089,0.00644345,-1.00588e-06,7.58532e-11,-2.79904e-15,71526.6,-81.8519], Tmin=(1384.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(636.107,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(CJ3)"""),
)

species(
    label = 'C[CH]OC1=CC1(17808)',
    structure = SMILES('C[CH]OC1=CC1'),
    E0 = (235.156,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.874437,0.0544136,-1.63054e-05,-3.00772e-08,1.88536e-11,28408.5,20.9691], Tmin=(100,'K'), Tmax=(940.095,'K')), NASAPolynomial(coeffs=[19.8744,0.00946662,-1.86323e-06,2.97231e-10,-2.49334e-14,23249.9,-77.9572], Tmin=(940.095,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(235.156,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CCsJOC(O))"""),
)
...
reaction(
    ...
    products = ['[CH]=C([CH2])O[CH]C(15951)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH3(17)', '[CH]OC([CH])=C(17803)'],
    products = ['[CH]=C([CH2])O[CH]C(15951)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]C(=C)O[C]C(17804)'],
    products = ['[CH]=C([CH2])O[CH]C(15951)'],
    transitionState = 'TS4',
...
reaction(
    ...
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(6.73316e+11,'s^-1'), n=0.231216, Ea=(139.794,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_csHNd]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]=C([CH2])OC=C(15771)'],
    products = ['[CH]=C([CH2])O[CH]C(15951)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH]C(=[CH])O[CH]C(17632)'],
    products = ['[CH]=C([CH2])O[CH]C(15951)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[C]=C([CH2])O[CH]C(17807)'],
    products = ['[CH]=C([CH2])O[CH]C(15951)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(T)(20)', 'C#CO[CH]C(3067)'],
    products = ['[CH]=C([CH2])O[CH]C(15951)'],
