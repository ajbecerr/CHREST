...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.927978,0.0586764,-2.30921e-05,-9.34031e-09,7.49267e-12,54246.2,27.3448], Tmin=(100,'K'), Tmax=(995.92,'K')), NASAPolynomial(coeffs=[12.2006,0.032259,-1.17067e-05,2.05118e-09,-1.39556e-13,51065.7,-31.6885], Tmin=(995.92,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(450.044,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (84.1595,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08853,0.0532259,-5.17697e-06,-2.43857e-08,1.1371e-11,-9885.93,22.593], Tmin=(100,'K'), Tmax=(1042.83,'K')), NASAPolynomial(coeffs=[11.4671,0.0364696,-1.42343e-05,2.60304e-09,-1.81103e-13,-13304,-33.923], Tmin=(1042.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-83.1449,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (84.1595,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02611,0.0569757,-1.48991e-05,-1.81004e-08,1.09673e-11,25000.4,26.3841], Tmin=(100,'K'), Tmax=(951.683,'K')), NASAPolynomial(coeffs=[10.9871,0.0351464,-1.2075e-05,2.04503e-09,-1.36546e-13,22197,-25.9459], Tmin=(951.683,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(206.912,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(15)', '[CH2]C(C)[CH]C(98)'],
    products = ['[CH2]C(C)C([CH2])C(81)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(9)', '[CH]C(C)C([CH2])C(155)'],
    products = ['[CH2]C(C)C([CH2])C(81)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(9)', '[CH2]C(C)C(=C)C(158)'],
    products = ['[CH2]C(C)C([CH2])C(81)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH3](12)', '[CH2]C(C)C=C(93)'],
    products = ['[CH2]C(C)C([CH2])C(81)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH3](12)', '[CH2][CH]C([CH2])C(95)'],
    products = ['[CH2]C(C)C([CH2])C(81)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(9)', '[CH2][C](C)C([CH2])C(159)'],
    products = ['[CH2]C(C)C([CH2])C(81)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(9)', '[CH2]C([CH2])C([CH2])C(160)'],
    products = ['[CH2]C(C)C([CH2])C(81)'],
