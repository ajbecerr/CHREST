...
species(
    label = '[CH2]C=CCC[C]C(5052)',
    structure = SMILES('[CH2]C=CCC[C]C'),
    E0 = (499.606,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.390032,0.0690638,-3.87343e-05,4.83033e-09,2.06774e-12,60227.4,29.5226], Tmin=(100,'K'), Tmax=(1128.21,'K')), NASAPolynomial(coeffs=[14.5995,0.0344989,-1.38043e-05,2.52303e-09,-1.74026e-13,56014.7,-45.2045], Tmin=(1128.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(499.606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.801036,0.0607033,-2.15083e-05,-5.88524e-09,4.15632e-12,2131.45,27.2364], Tmin=(100,'K'), Tmax=(1183.76,'K')), NASAPolynomial(coeffs=[11.7488,0.040196,-1.64124e-05,3.00955e-09,-2.06789e-13,-1615.51,-32.3056], Tmin=(1183.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.6986,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19165,0.0519353,-1.70326e-06,-2.2578e-08,9.19379e-12,43199.1,30.7815], Tmin=(100,'K'), Tmax=(1119.66,'K')), NASAPolynomial(coeffs=[9.37517,0.0432253,-1.75328e-05,3.22021e-09,-2.223e-13,40079.9,-15.3697], Tmin=(1119.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(358.269,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(cyclopropane) + radical(RCCJC)"""),
)
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.599038,0.0608355,-5.37023e-06,-3.39978e-08,1.67135e-11,1514.24,27.1654], Tmin=(100,'K'), Tmax=(1002.43,'K')), NASAPolynomial(coeffs=[15.0955,0.034456,-1.29813e-05,2.37753e-09,-1.67697e-13,-2973.04,-50.6924], Tmin=(1002.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.4699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CCCCC=C(4858)',
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.734381,0.0601625,-1.25658e-05,-1.95626e-08,9.83612e-12,4928.7,28.3182], Tmin=(100,'K'), Tmax=(1072.04,'K')), NASAPolynomial(coeffs=[12.8661,0.0385786,-1.55015e-05,2.86937e-09,-2.00452e-13,966.721,-37.4012], Tmin=(1072.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(39.9197,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    E0 = (301.042,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,186.494,285.292,1034.02,3305.5],'cm^-1')),
        HinderedRotor(inertia=(0.0641418,'amu*angstrom^2'), symmetry=1, barrier=(1.5644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0641418,'amu*angstrom^2'), symmetry=1, barrier=(1.5644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0641418,'amu*angstrom^2'), symmetry=1, barrier=(1.5644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0641418,'amu*angstrom^2'), symmetry=1, barrier=(1.5644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0641418,'amu*angstrom^2'), symmetry=1, barrier=(1.5644,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04658,0.066069,-3.93899e-05,1.21142e-08,-1.58901e-12,42642.3,30.5366], Tmin=(100,'K'), Tmax=(1621.79,'K')), NASAPolynomial(coeffs=[10.5482,0.0426341,-1.77149e-05,3.20422e-09,-2.15535e-13,39560.4,-19.8974], Tmin=(1621.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(353.68,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(Cds_P)"""),
)

species(
    label = '[CH2][CH]CCCC=C(5072)',
    structure = SMILES('[CH2][CH]CCCC=C'),
    E0 = (311.83,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.08121,0.0641198,-3.57871e-05,9.85113e-09,-1.12057e-12,37608.5,31.7986], Tmin=(100,'K'), Tmax=(1878.73,'K')), NASAPolynomial(coeffs=[12.7209,0.0393384,-1.60018e-05,2.83047e-09,-1.86357e-13,33234.8,-31.6962], Tmin=(1878.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(311.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CHCH3(T)(21)', '[CH2]C=CC[CH2](507)'],
    products = ['C=C[CH]CC[CH]C(3961)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', '[CH]CCC=C[CH2](4958)'],
    products = ['C=C[CH]CC[CH]C(3961)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', '[CH]=CCC[CH]C(5051)'],
    products = ['C=C[CH]CC[CH]C(3961)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH2]C=CCC[C]C(5052)'],
    products = ['C=C[CH]CC[CH]C(3961)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C=CCC[CH]C(5053)'],
    products = ['C=C[CH]CC[CH]C(3961)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2]C=CCC=CC(5057)'],
    products = ['C=C[CH]CC[CH]C(3961)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'C=C[CH]CCC=C(4876)'],
    products = ['C=C[CH]CC[CH]C(3961)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]C=C(3739)', '[CH2]C[CH]C(36)'],
    products = ['C=C[CH]CC[CH]C(3961)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2]C=C[CH]C[CH]C(5059)'],
    products = ['C=C[CH]CC[CH]C(3961)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH2]C=[C]CC[CH]C(5060)'],
    products = ['C=C[CH]CC[CH]C(3961)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH2][C]=CCC[CH]C(5061)'],
    products = ['C=C[CH]CC[CH]C(3961)'],
...
reaction(
    label = 'reaction40',
    reactants = ['C2H3(60)', '[CH]CC[CH]C(119)'],
    products = ['C=C[CH]CC[CH]C(3961)'],
...
reaction(
    label = 'reaction45',
    reactants = ['H(3)', 'C=CC=CC[CH]C(5069)'],
    products = ['C=C[CH]CC[CH]C(3961)'],
