...
species(
    label = '[CH2]C([O])O(1468)',
    structure = SMILES('[CH2]C([O])O'),
    E0 = (-19.5078,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,1935.17],'cm^-1')),
        HinderedRotor(inertia=(0.200316,'amu*angstrom^2'), symmetry=1, barrier=(4.60566,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.200412,'amu*angstrom^2'), symmetry=1, barrier=(4.60787,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.66059,0.0330655,-4.66668e-05,4.29193e-08,-1.6098e-11,-2301.52,17.2788], Tmin=(100,'K'), Tmax=(804.611,'K')), NASAPolynomial(coeffs=[3.98159,0.019821,-9.52738e-06,1.83298e-09,-1.27457e-13,-2297.95,12.5361], Tmin=(804.611,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.5078,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJCO)"""),
)
...
species(
    label = '[CH]C(O)O[O](2219)',
    structure = SMILES('[CH]C(O)O[O]'),
    E0 = (214.923,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,492.5,1135,1000,1380,1390,370,380,2900,435,345.856,345.922,1842.75],'cm^-1')),
        HinderedRotor(inertia=(0.00140944,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.085008,'amu*angstrom^2'), symmetry=1, barrier=(7.22435,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0850769,'amu*angstrom^2'), symmetry=1, barrier=(7.22514,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (75.0434,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09897,0.0454075,-6.27506e-05,4.3509e-08,-1.07112e-11,25914.4,20.3416], Tmin=(100,'K'), Tmax=(663.346,'K')), NASAPolynomial(coeffs=[8.25456,0.0144679,-6.7602e-06,1.28023e-09,-8.82772e-14,24961.8,-7.85363], Tmin=(663.346,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(214.923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.61752,0.0293608,-1.72906e-05,4.78394e-09,-5.28723e-13,-25921.6,13.2054], Tmin=(100,'K'), Tmax=(2016.21,'K')), NASAPolynomial(coeffs=[10.1472,0.014423,-6.17777e-06,1.10956e-09,-7.3134e-14,-28958,-28.4012], Tmin=(2016.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-215.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(12dioxetane)"""),
)
...
species(
    ...
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.99494,0.0147547,2.68642e-05,-5.45522e-08,2.66664e-11,-32097.9,11.6358], Tmin=(100,'K'), Tmax=(823.133,'K')), NASAPolynomial(coeffs=[9.62025,0.00544685,2.11767e-06,-7.29551e-10,5.99158e-14,-33964,-23.7479], Tmin=(823.133,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-267.238,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + ring(Ethylene_oxide)"""),
)
...
species(
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80314,0.0487072,-5.97405e-05,3.75382e-08,-9.28553e-12,-23889.7,16.9375], Tmin=(100,'K'), Tmax=(990.921,'K')), NASAPolynomial(coeffs=[10.6887,0.0128394,-5.44581e-06,1.01009e-09,-6.98361e-14,-25650.6,-25.8492], Tmin=(990.921,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-199.285,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2][C](O)OO(2226)',
    structure = SMILES('[CH2][C](O)OO'),
    E0 = (33.9119,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,3615,1277.5,1000,360,370,350,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(0.00185551,'amu*angstrom^2'), symmetry=1, barrier=(21.0676,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.768765,'amu*angstrom^2'), symmetry=1, barrier=(35.2089,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.801173,'amu*angstrom^2'), symmetry=1, barrier=(35.2382,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160334,'amu*angstrom^2'), symmetry=1, barrier=(6.75928,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.88184,0.0492617,-6.25251e-05,4.17382e-08,-1.1189e-11,4152.65,22.0344], Tmin=(100,'K'), Tmax=(907.222,'K')), NASAPolynomial(coeffs=[9.38778,0.0161673,-7.80658e-06,1.52839e-09,-1.08505e-13,2790.74,-13.4465], Tmin=(907.222,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(33.9119,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(Cs_P) + radical(CJCOOH)"""),
)
...
species(
    label = '[CH2]C([O])OO(1435)',
    structure = SMILES('[CH2]C([O])OO'),
    E0 = (54.3707,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.0813063,'amu*angstrom^2'), symmetry=1, barrier=(1.86939,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.65523,'amu*angstrom^2'), symmetry=1, barrier=(38.0571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00661045,'amu*angstrom^2'), symmetry=1, barrier=(38.0538,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06043,0.0476779,-7.19263e-05,6.60271e-08,-2.46632e-11,6604.26,21.5555], Tmin=(100,'K'), Tmax=(779.667,'K')), NASAPolynomial(coeffs=[5.02746,0.0246556,-1.26268e-05,2.49022e-09,-1.75537e-13,6378.68,9.50013], Tmin=(779.667,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(54.3707,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(O)O[O](1433)'],
    products = ['HO2(9)', 'vinoxy(1351)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(O)O[O](1433)'],
    products = ['O2(S)(666)', 'ethenol(1347)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(4)', '[CH2]C([O])O(1468)'],
    products = ['[CH2]C(O)O[O](1433)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[O]O[CH]O(2218)'],
    products = ['[CH2]C(O)O[O](1433)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction11',
    reactants = ['O2(2)', 'ethenol(1347)'],
    products = ['[CH2]C(O)O[O](1433)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(0.000167406,'m^3/(mol*s)'), n=2.98833, Ea=(127.577,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cds_Cds;O2b] for rate rule [Cds-OsH_Cds;O2b]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 124.4 to 127.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction12',
    reactants = ['O2(2)', '[CH2][CH]O(1380)'],
    products = ['[CH2]C(O)O[O](1433)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH2]C([O])O[O](1384)'],
    products = ['[CH2]C(O)O[O](1433)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2][C](O)O[O](2224)'],
    products = ['[CH2]C(O)O[O](1433)'],
