...
species(
    label = '[CH]C([CH2])C[CH2](491)',
    structure = SMILES('[CH]C([CH2])C[CH2]'),
    E0 = (684.765,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,180,2940.91,2940.92],'cm^-1')),
        HinderedRotor(inertia=(0.0867852,'amu*angstrom^2'), symmetry=1, barrier=(80.1981,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.682885,'amu*angstrom^2'), symmetry=1, barrier=(15.7009,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00232921,'amu*angstrom^2'), symmetry=1, barrier=(2.15232,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0867922,'amu*angstrom^2'), symmetry=1, barrier=(80.1976,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63993,0.0466574,-2.80134e-05,4.85777e-09,1.38317e-12,82447.8,24.6113], Tmin=(100,'K'), Tmax=(1013.06,'K')), NASAPolynomial(coeffs=[9.82532,0.0239596,-8.65197e-06,1.49176e-09,-9.97668e-14,80295.6,-17.4215], Tmin=(1013.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(684.765,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.853537,0.063044,-4.72048e-05,1.94045e-08,-3.30496e-12,80019,28.583], Tmin=(100,'K'), Tmax=(1375.89,'K')), NASAPolynomial(coeffs=[12.2488,0.029916,-1.10888e-05,1.9052e-09,-1.25349e-13,76883.3,-30.0288], Tmin=(1375.89,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(664.332,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH2]CC1CC1C(3865)',
    structure = SMILES('[CH2]CC1CC1C'),
    E0 = (157.895,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66495,0.0330183,5.43978e-05,-9.13166e-08,3.65381e-11,19091,22.5611], Tmin=(100,'K'), Tmax=(967.165,'K')), NASAPolynomial(coeffs=[13.6264,0.0290948,-1.0157e-05,1.87308e-09,-1.36575e-13,14647,-45.7597], Tmin=(967.165,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(157.895,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C1CCC1C(517)',
...
species(
    label = 'C[CH]C1CCC1(3866)',
    structure = SMILES('C[CH]C1CCC1'),
    E0 = (151.813,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05969,0.0249472,6.84178e-05,-9.73282e-08,3.62305e-11,18344.4,22.9027], Tmin=(100,'K'), Tmax=(994.296,'K')), NASAPolynomial(coeffs=[10.6289,0.0348908,-1.35912e-05,2.58649e-09,-1.88012e-13,14444.8,-29.4309], Tmin=(994.296,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(151.813,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Cs_S)"""),
)

species(
    label = '[CH2]CC(=C)CC(227)',
...
species(
    ...
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09322,0.0540859,-1.39038e-05,-1.44193e-08,7.7764e-12,7316.93,23.358], Tmin=(100,'K'), Tmax=(1069.71,'K')), NASAPolynomial(coeffs=[11.6177,0.0343009,-1.36014e-05,2.49401e-09,-1.73171e-13,3945.66,-33.359], Tmin=(1069.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(59.8968,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH2]C[C]([CH2])[CH]C(3870)',
    structure = SMILES('[CH2]C[C]([CH2])[CH]C'),
    E0 = (596.082,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2060.52,2060.68],'cm^-1')),
        HinderedRotor(inertia=(0.23432,'amu*angstrom^2'), symmetry=1, barrier=(5.38748,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0202164,'amu*angstrom^2'), symmetry=1, barrier=(60.896,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00178882,'amu*angstrom^2'), symmetry=1, barrier=(5.38799,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.234327,'amu*angstrom^2'), symmetry=1, barrier=(5.38764,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.234341,'amu*angstrom^2'), symmetry=1, barrier=(5.38796,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42476,0.0634169,-7.68388e-05,6.93665e-08,-2.61143e-11,71778.2,30.3157], Tmin=(100,'K'), Tmax=(832.452,'K')), NASAPolynomial(coeffs=[1.97732,0.0465124,-2.07024e-05,3.84729e-09,-2.62427e-13,72180,30.7167], Tmin=(832.452,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(596.082,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Cs_S) + radical(RCCJ) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (83.1515,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.792,0.0479727,-2.11879e-05,3.98355e-09,-2.78303e-13,47026.2,23.4647], Tmin=(100,'K'), Tmax=(3197.24,'K')), NASAPolynomial(coeffs=[44.5231,-0.000533018,-1.6856e-07,-3.69948e-11,7.74701e-15,18448.6,-229.327], Tmin=(3197.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(390.835,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([CH2])[CH]C(230)'],
    products = ['C2H4(22)', 'm1_allyl(186)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2][CH]C(C)C[CH2](1189)'],
    products = ['[CH2]CC([CH2])[CH]C(230)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CHCH3(T)(21)', '[CH2][CH]C[CH2](66)'],
    products = ['[CH2]CC([CH2])[CH]C(230)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', '[CH2]C[CH][CH]C(123)'],
    products = ['[CH2]CC([CH2])[CH]C(230)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(20)', '[CH2]C([CH2])[CH]C(500)'],
    products = ['[CH2]CC([CH2])[CH]C(230)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', '[CH]C([CH2])C[CH2](491)'],
    products = ['[CH2]CC([CH2])[CH]C(230)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH2]CC([CH2])[C]C(3862)'],
    products = ['[CH2]CC([CH2])[CH]C(230)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH]CC([CH2])[CH]C(3863)'],
    products = ['[CH2]CC([CH2])[CH]C(230)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]C([CH]C)C[CH2](3864)'],
    products = ['[CH2]CC([CH2])[CH]C(230)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH2]CC([CH2])=CC(3868)'],
    products = ['[CH2]CC([CH2])[CH]C(230)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH2]C([CH]C)C=C(3803)'],
    products = ['[CH2]CC([CH2])[CH]C(230)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2]CC([CH2])C=C(3869)'],
    products = ['[CH2]CC([CH2])[CH]C(230)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH2(T)(20)', '[CH2]CC=CC(120)'],
    products = ['[CH2]CC([CH2])[CH]C(230)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CHCH3(T)(21)', 'buten3yl1(65)'],
    products = ['[CH2]CC([CH2])[CH]C(230)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C2H4(T)(23)', 'm1_allyl(186)'],
    products = ['[CH2]CC([CH2])[CH]C(230)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C2H4(22)', '[CH2][CH][CH]C(3856)'],
    products = ['[CH2]CC([CH2])[CH]C(230)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C2H4(T)(23)', '[CH2][CH][CH]C(3856)'],
    products = ['[CH2]CC([CH2])[CH]C(230)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH2]C[C]([CH2])[CH]C(3870)'],
    products = ['[CH2]CC([CH2])[CH]C(230)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', '[CH2][CH]C([CH2])[CH]C(3871)'],
    products = ['[CH2]CC([CH2])[CH]C(230)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', '[CH2][CH]C([CH2])C[CH2](3859)'],
    products = ['[CH2]CC([CH2])[CH]C(230)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]CC([CH2])C[CH2](232)'],
    products = ['[CH2]CC([CH2])[CH]C(230)'],
