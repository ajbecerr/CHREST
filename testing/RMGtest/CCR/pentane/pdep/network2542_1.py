...
species(
    label = '[C]=[C]OO[C]=[CH](10465)',
    structure = SMILES('[C]=[C]OO[C]=[CH]'),
    E0 = (1347.83,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,1670,1700,300,440,3120,650,792.5,1650],'cm^-1')),
        HinderedRotor(inertia=(0.228962,'amu*angstrom^2'), symmetry=1, barrier=(5.26428,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.22893,'amu*angstrom^2'), symmetry=1, barrier=(5.26356,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.784795,'amu*angstrom^2'), symmetry=1, barrier=(18.044,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (81.0495,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80973,0.057954,-0.000117013,1.13776e-07,-4.08784e-11,162176,28.9277], Tmin=(100,'K'), Tmax=(869.594,'K')), NASAPolynomial(coeffs=[5.42984,0.0186727,-1.0221e-05,1.97954e-09,-1.34617e-13,162402,16.8881], Tmin=(869.594,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1347.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(145.503,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=[CH](9646)', '[CH]=[C]O[O](9590)'],
    products = ['[CH]=[C]OO[C]=[CH](9620)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[C]=[C]OO[C]=[CH](10465)'],
    products = ['[CH]=[C]OO[C]=[CH](9620)'],
    transitionState = 'TS3',
...
reaction(
    ...
    products = ['[CH]=[C]OO[C]=[CH](9620)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(3.08478e+06,'m^3/(mol*s)'), n=-1.87134e-07, Ea=(186.741,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=1.52051667475e-07, var=0.241111252513, Tref=1000.0, N=4, correlation='Root_N-1R->H_N-1CNOS->N_1COS->O_Ext-1O-R_Ext-2R-R_Ext-2R-R_N-4R!H->O',), comment="""BM rule fitted to 2 training reactions at node Root_N-1R->H_N-1CNOS->N_1COS->O_Ext-1O-R_Ext-2R-R_Ext-2R-R_N-4R!H->O
    Total Standard Deviation in ln(k): 0.984387063055
Exact match found for rate rule [Root_N-1R->H_N-1CNOS->N_1COS->O_Ext-1O-R_Ext-2R-R_Ext-2R-R_N-4R!H->O]
Euclidian distance = 0
family: R_Recombination
Ea raised from 182.8 to 186.7 kJ/mol to match endothermicity of reaction."""),
)
