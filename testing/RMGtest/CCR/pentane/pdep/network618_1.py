...
species(
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.24366,0.0334188,-1.32665e-05,-1.87712e-09,1.89778e-12,-12162.2,17.1242], Tmin=(100,'K'), Tmax=(1185.58,'K')), NASAPolynomial(coeffs=[8.37004,0.0212601,-8.6513e-06,1.58276e-09,-1.08604e-13,-14213,-15.9975], Tmin=(1185.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d)"""),
)
...
species(
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.02045,0.0379613,-2.55997e-05,9.29986e-09,-1.39601e-12,12149.6,19.3286], Tmin=(100,'K'), Tmax=(1546.99,'K')), NASAPolynomial(coeffs=[9.61092,0.0183349,-6.56952e-06,1.09894e-09,-7.07097e-14,9801.14,-20.6029], Tmin=(1546.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(100.387,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCHO) + radical(CCCJ=O)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=O(2355)', '[CH2]C[CH2](29)'],
    products = ['[CH2]CC[C]=O(2241)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['CO(2039)', '[CH2]C[CH2](29)'],
    products = ['[CH2]CC[C]=O(2241)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2][CH]C[C]=O(2359)'],
    products = ['[CH2]CC[C]=O(2241)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]C[CH][C]=O(2360)'],
    products = ['[CH2]CC[C]=O(2241)'],
