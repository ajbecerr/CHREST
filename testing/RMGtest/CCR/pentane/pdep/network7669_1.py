...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08204,0.0318746,1.96637e-05,-4.10114e-08,1.58806e-11,30296.4,24.0692], Tmin=(100,'K'), Tmax=(1031.14,'K')), NASAPolynomial(coeffs=[9.09992,0.0290385,-1.16873e-05,2.19486e-09,-1.55772e-13,27552.6,-16.29], Tmin=(1031.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(251.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CCOJ) + radical(CCJCO)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13447,0.0309624,1.84809e-05,-3.87157e-08,1.47956e-11,59627.9,21.3055], Tmin=(100,'K'), Tmax=(1047.38,'K')), NASAPolynomial(coeffs=[9.07303,0.0282717,-1.17617e-05,2.2364e-09,-1.59379e-13,56868.5,-18.7243], Tmin=(1047.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(495.144,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclobutane) + radical(CCOJ) + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'OCC1=CCC1(29344)',
    structure = SMILES('OCC1=CCC1'),
    E0 = (-47.7233,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98422,0.0313472,2.88593e-05,-5.70389e-08,2.32769e-11,-5655.62,21.047], Tmin=(100,'K'), Tmax=(979.657,'K')), NASAPolynomial(coeffs=[11.4541,0.0243444,-8.8996e-06,1.6484e-09,-1.18859e-13,-9030.48,-32.1999], Tmin=(979.657,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.7233,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)

species(
    label = 'O=CC1CCC1(29345)',
    structure = SMILES('O=CC1CCC1'),
    E0 = (-98.4672,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28423,0.0230631,5.11733e-05,-7.66097e-08,2.90203e-11,-11768.1,19.4697], Tmin=(100,'K'), Tmax=(991.966,'K')), NASAPolynomial(coeffs=[10.2565,0.027423,-1.06238e-05,2.02296e-09,-1.47423e-13,-15145.9,-27.9808], Tmin=(991.966,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-98.4672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cds-OdCsH) + ring(Cyclobutane)"""),
)

species(
    label = 'OCC1C=CC1(28864)',
    structure = SMILES('OCC1C=CC1'),
    E0 = (-47.1121,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.98593,0.0289051,4.1046e-05,-7.33266e-08,2.99596e-11,-5579.88,20.5385], Tmin=(100,'K'), Tmax=(963.538,'K')), NASAPolynomial(coeffs=[12.8979,0.021821,-7.41808e-06,1.36779e-09,-1.00644e-13,-9456.66,-40.9055], Tmin=(963.538,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-47.1121,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)
...
species(
    label = '[CH2]CC=CC[O](29346)',
    structure = SMILES('[CH2]CC=CC[O]'),
    E0 = (225.268,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,238.389,1613.89,1613.91],'cm^-1')),
        HinderedRotor(inertia=(0.131384,'amu*angstrom^2'), symmetry=1, barrier=(5.29856,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131365,'amu*angstrom^2'), symmetry=1, barrier=(5.29856,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131372,'amu*angstrom^2'), symmetry=1, barrier=(5.29809,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46982,0.0413249,-1.8894e-05,3.44443e-09,-1.98743e-13,27141,23.7604], Tmin=(100,'K'), Tmax=(2386.46,'K')), NASAPolynomial(coeffs=[21.043,0.0162178,-6.89924e-06,1.15137e-09,-6.93297e-14,16560.9,-85.5935], Tmin=(2386.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(225.268,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCOJ) + radical(RCCJ)"""),
)

species(
    label = '[O]CC1=CCC1(29347)',
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30468,0.0289912,1.57554e-05,-3.18659e-08,1.16302e-11,21474.3,20.7632], Tmin=(100,'K'), Tmax=(1082.54,'K')), NASAPolynomial(coeffs=[7.50546,0.0295422,-1.23991e-05,2.34092e-09,-1.65006e-13,19190,-10.09], Tmin=(1082.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(177.982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(CCOJ)"""),
)
...
species(
    label = '[O]C[C]1[CH]CC1(29349)',
    structure = SMILES('[O]C[C]1[CH]CC1'),
    E0 = (387.341,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.63768,0.0215953,3.23501e-05,-4.40081e-08,1.45526e-11,46642.3,22.8347], Tmin=(100,'K'), Tmax=(1106.69,'K')), NASAPolynomial(coeffs=[5.56581,0.0336516,-1.46768e-05,2.80591e-09,-1.98401e-13,44607.8,2.14757], Tmin=(1106.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(387.341,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclobutane) + radical(CCOJ) + radical(CCJ(C)CO) + radical(cyclobutane)"""),
)

species(
    label = '[O]CC1[CH]C[CH]1(29350)',
    structure = SMILES('[O]CC1[CH]C[CH]1'),
    E0 = (422.606,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2850,1437.5,1250,1305,750,350,302.113,805.823,805.823,805.823,805.823,805.823,805.823,805.823,1615.36,1615.36,1615.36,1615.36,1615.36,1615.36,1615.36],'cm^-1')),
        HinderedRotor(inertia=(0.15073,'amu*angstrom^2'), symmetry=1, barrier=(3.51457,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.61756,0.0275656,8.29202e-06,-1.66976e-08,4.86894e-12,50879.5,24.3823], Tmin=(100,'K'), Tmax=(1364.22,'K')), NASAPolynomial(coeffs=[5.67676,0.0336888,-1.50359e-05,2.81207e-09,-1.92451e-13,48640.4,3.52583], Tmin=(1364.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(422.606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclobutane) + radical(CCOJ) + radical(cyclobutane) + radical(cyclobutane)"""),
)

species(
    label = '[O]CC1[CH][CH]C1(29351)',
    structure = SMILES('[O]CC1[CH][CH]C1'),
    E0 = (422.606,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2850,1437.5,1250,1305,750,350,302.113,805.823,805.823,805.823,805.823,805.823,805.823,805.823,1615.36,1615.36,1615.36,1615.36,1615.36,1615.36,1615.36],'cm^-1')),
        HinderedRotor(inertia=(0.15073,'amu*angstrom^2'), symmetry=1, barrier=(3.51457,'kJ/mol'), semiclassical=False),
...
species(
    label = '[O]C[C]1CCC1(29352)',
    structure = SMILES('[O]C[C]1CCC1'),
    E0 = (199.503,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46698,0.0211643,4.96374e-05,-6.8441e-08,2.43925e-11,24060.7,20.4016], Tmin=(100,'K'), Tmax=(1028.32,'K')), NASAPolynomial(coeffs=[7.6727,0.0327042,-1.35665e-05,2.59704e-09,-1.86566e-13,21309.3,-13.0309], Tmin=(1028.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(199.503,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclobutane) + radical(CCOJ) + radical(CCJ(C)CO)"""),
)

species(
    label = '[O]CC1C[CH]C1(29353)',
    structure = SMILES('[O]CC1C[CH]C1'),
    E0 = (234.767,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2850,1437.5,1250,1305,750,350,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77383,0.0393879,2.65164e-06,-2.67417e-08,1.16836e-11,22863.2,23.7281], Tmin=(100,'K'), Tmax=(1031.93,'K')), NASAPolynomial(coeffs=[10.4129,0.0272668,-1.07863e-05,2.00392e-09,-1.4131e-13,19942.6,-23.7337], Tmin=(1031.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.36,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(CCsJOH)"""),
)

species(
    label = '[O][CH]C1CCC1(29355)',
    structure = SMILES('[O][CH]C1CCC1'),
    E0 = (227.227,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93526,0.0364051,7.80849e-06,-2.77072e-08,1.08073e-11,27411,21.6661], Tmin=(100,'K'), Tmax=(1081.77,'K')), NASAPolynomial(coeffs=[8.89007,0.0310148,-1.29018e-05,2.42562e-09,-1.7065e-13,24717,-17.9305], Tmin=(1081.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(227.227,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclobutane) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = 'OC[C]1[CH]CC1(29356)',
    structure = SMILES('OC[C]1[CH]CC1'),
    E0 = (161.636,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.299,0.0242017,4.44037e-05,-6.75544e-08,2.53852e-11,19513.2,23.1816], Tmin=(100,'K'), Tmax=(1001.48,'K')), NASAPolynomial(coeffs=[9.36791,0.0286795,-1.12981e-05,2.14034e-09,-1.54392e-13,16456.9,-19.1223], Tmin=(1001.48,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(161.636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclobutane) + radical(CCJ(C)CO) + radical(cyclobutane)"""),
)

species(
    label = 'OCC1[CH]C[CH]1(29357)',
    structure = SMILES('OCC1[CH]C[CH]1'),
    E0 = (196.901,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.17463,0.0315764,1.46574e-05,-3.1846e-08,1.17303e-11,23754.6,25.091], Tmin=(100,'K'), Tmax=(1082.26,'K')), NASAPolynomial(coeffs=[7.68626,0.0313866,-1.30502e-05,2.45136e-09,-1.72271e-13,21379.7,-7.39547], Tmin=(1082.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(196.901,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(cyclobutane)"""),
)

species(
    label = 'OCC1[CH][CH]C1(29358)',
    structure = SMILES('OCC1[CH][CH]C1'),
    E0 = (196.901,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['[O]C[CH]C1CC1(29342)'],
    products = ['[O]CC1[CH]CC1(6706)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['O(4)', '[CH2]C1[CH]CC1(6246)'],
    products = ['[O]CC1[CH]CC1(6706)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[O]CC1[C]CC1(29343)'],
    products = ['[O]CC1[CH]CC1(6706)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[O]CC1=CCC1(29347)'],
    products = ['[O]CC1[CH]CC1(6706)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[O]CC1C=CC1(29348)'],
    products = ['[O]CC1[CH]CC1(6706)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'O=CC1[CH]CC1(6227)'],
    products = ['[O]CC1[CH]CC1(6706)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][O](3109)', 'C1=CCC1(4846)'],
    products = ['[O]CC1[CH]CC1(6706)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[O]C[C]1[CH]CC1(29349)'],
    products = ['[O]CC1[CH]CC1(6706)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[O]CC1[CH]C[CH]1(29350)'],
    products = ['[O]CC1[CH]CC1(6706)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[O]CC1[CH][CH]C1(29351)'],
    products = ['[O]CC1[CH]CC1(6706)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[O][CH]C1[CH]CC1(6609)'],
    products = ['[O]CC1[CH]CC1(6706)'],
