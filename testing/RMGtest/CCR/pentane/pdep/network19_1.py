species(
    ...
    E0 = (-95.5174,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,180,1271.33,1271.34,1271.35,1271.36,3039.51,3703.33,3703.43],'cm^-1')),
        HinderedRotor(inertia=(0.00645138,'amu*angstrom^2'), symmetry=1, barrier=(7.39915,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (30.069,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.74673,4.52281e-05,4.07972e-05,-4.57426e-08,1.56848e-11,-11474.1,4.74132], Tmin=(100,'K'), Tmax=(981.603,'K')), NASAPolynomial(coeffs=[3.34696,0.016175,-6.00966e-06,1.09623e-09,-7.72311e-14,-12094.2,3.10405], Tmin=(981.603,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-95.5174,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), label="""C2H6""", comment="""Thermo library: DFT_QCI_thermo"""),
)
