...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0938186,0.0820876,-6.55096e-05,2.78675e-08,-4.83369e-12,49095.2,36.5603], Tmin=(100,'K'), Tmax=(1365.11,'K')), NASAPolynomial(coeffs=[16.1544,0.034478,-1.31961e-05,2.31982e-09,-1.5506e-13,44659.1,-46.8853], Tmin=(1365.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(406.921,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(Isobutyl) + radical(Cds_S)"""),
)
...
species(
    ...
    E0 = (283.568,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,180.109,1665.73],'cm^-1')),
        HinderedRotor(inertia=(0.179241,'amu*angstrom^2'), symmetry=1, barrier=(5.33933,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0819371,'amu*angstrom^2'), symmetry=1, barrier=(1.88438,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.2279,'amu*angstrom^2'), symmetry=1, barrier=(5.24121,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.227775,'amu*angstrom^2'), symmetry=1, barrier=(5.23833,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.79717,'amu*angstrom^2'), symmetry=1, barrier=(64.3166,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.200713,0.0944165,-9.19821e-05,4.89714e-08,-1.07803e-11,77509.1,37.8832], Tmin=(100,'K'), Tmax=(1079.51,'K')), NASAPolynomial(coeffs=[14.1098,0.0413911,-1.8303e-05,3.47023e-09,-2.429e-13,74419.4,-32.2516], Tmin=(1079.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(643.203,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2]C(CC)C1OOC1=C(21580)',
    structure = SMILES('[CH2]C(CC)C1OOC1=C'),
    E0 = (176.597,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.189077,0.0646311,9.72612e-06,-5.78288e-08,2.61353e-11,21393.8,35.1288], Tmin=(100,'K'), Tmax=(998.881,'K')), NASAPolynomial(coeffs=[18.5775,0.0356396,-1.37799e-05,2.60412e-09,-1.88557e-13,15493,-64.7128], Tmin=(998.881,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(176.597,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(Isobutyl)"""),
)
...
species(
    label = 'C=[C]C1OOCC1CC(21582)',
    structure = SMILES('C=[C]C1OOCC1CC'),
    E0 = (124.062,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.232588,0.06382,1.77213e-05,-7.58318e-08,3.67595e-11,15074.5,31.2981], Tmin=(100,'K'), Tmax=(919.477,'K')), NASAPolynomial(coeffs=[19.343,0.030107,-7.90731e-06,1.20875e-09,-8.18332e-14,9470.96,-70.655], Tmin=(919.477,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(124.062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(469.768,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(12dioxolane) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C(CC)C1OC1=C(21583)',
    structure = SMILES('[CH2]C(CC)C1OC1=C'),
    E0 = (110.016,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0989625,0.063582,1.64465e-05,-7.87695e-08,3.84088e-11,13392.7,28.748], Tmin=(100,'K'), Tmax=(935.342,'K')), NASAPolynomial(coeffs=[23.3349,0.0205332,-4.83664e-06,7.75956e-10,-5.87811e-14,6582.38,-94.9686], Tmin=(935.342,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(110.016,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(methyleneoxirane) + radical(Isobutyl)"""),
)

species(
    label = 'C=[C]C1OCC1CC(21584)',
    structure = SMILES('C=[C]C1OCC1CC'),
    E0 = (152.163,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.162,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.815411,0.05412,2.26764e-05,-7.11094e-08,3.3216e-11,18430.4,28.4202], Tmin=(100,'K'), Tmax=(915.615,'K')), NASAPolynomial(coeffs=[15.3995,0.0319028,-8.90644e-06,1.38311e-09,-9.20378e-14,14020.3,-50.1525], Tmin=(915.615,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(152.163,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.11171,0.087232,-6.8474e-05,2.81542e-08,-4.78088e-12,8897.23,35.8485], Tmin=(100,'K'), Tmax=(1367.11,'K')), NASAPolynomial(coeffs=[15.8115,0.0406428,-1.73561e-05,3.22673e-09,-2.2247e-13,4543.48,-45.9508], Tmin=(1367.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.7258,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C(CC)C(=C=C)OO(21586)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.309097,0.0955495,-9.02258e-05,4.73214e-08,-1.02932e-11,22229.7,36.5362], Tmin=(100,'K'), Tmax=(1091.85,'K')), NASAPolynomial(coeffs=[13.9867,0.0431771,-1.82761e-05,3.39024e-09,-2.34354e-13,19107.9,-33.6888], Tmin=(1091.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(183.543,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cdd-Cd)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.168862,0.0925917,-7.86842e-05,3.54257e-08,-6.63865e-12,19219.8,35.7699], Tmin=(100,'K'), Tmax=(1241.56,'K')), NASAPolynomial(coeffs=[14.9756,0.0437991,-1.9734e-05,3.7714e-09,-2.64633e-13,15459.3,-40.57], Tmin=(1241.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(158.563,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
species(
    label = 'C#CC(O[O])C([CH2])CC(21107)',
    structure = SMILES('C#CC(O[O])C([CH2])CC'),
    E0 = (328.179,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.551299,0.0964983,-9.77621e-05,5.42422e-08,-1.21103e-11,39637.7,37.0537], Tmin=(100,'K'), Tmax=(1087.09,'K')), NASAPolynomial(coeffs=[16.155,0.035025,-1.29371e-05,2.22129e-09,-1.46681e-13,36005.6,-44.9394], Tmin=(1087.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(328.179,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(ROOJ) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(CC)[C](C=C)O[O](21596)',
    structure = SMILES('[CH2]C=C(O[O])C([CH2])CC'),
    E0 = (310.443,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.197474,0.0911999,-8.23792e-05,4.16729e-08,-8.75074e-12,37489.7,38.1176], Tmin=(100,'K'), Tmax=(1129.8,'K')), NASAPolynomial(coeffs=[13.7186,0.0419307,-1.69657e-05,3.07391e-09,-2.09585e-13,34345.3,-30.7174], Tmin=(1129.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(310.443,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(ROOJ) + radical(Isobutyl) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=CC(O[O])C([CH2])CC(21597)',
    structure = SMILES('[CH]=CC(O[O])C([CH2])CC'),
    E0 = (409.325,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.416355,0.0949389,-8.75231e-05,4.40738e-08,-9.09907e-12,49391.2,39.3578], Tmin=(100,'K'), Tmax=(1155.33,'K')), NASAPolynomial(coeffs=[15.4348,0.040059,-1.62712e-05,2.95913e-09,-2.02361e-13,45728.6,-39.4036], Tmin=(1155.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(409.325,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Isobutyl) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C(CC)[C]([C]=C)OO(21598)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.361213,0.097732,-9.62825e-05,5.31637e-08,-1.21747e-11,47817,38.4268], Tmin=(100,'K'), Tmax=(1040.87,'K')), NASAPolynomial(coeffs=[13.6469,0.0438994,-1.87039e-05,3.47515e-09,-2.40327e-13,44900.9,-29.7155], Tmin=(1040.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(396.28,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Allyl_P) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2][C](CC)C(C=C)O[O](21600)',
    structure = SMILES('[CH2][C](CC)C(C=C)O[O]'),
    E0 = (353.139,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0426616,0.0814048,-5.90662e-05,2.26508e-08,-3.581e-12,42624.4,42.4625], Tmin=(100,'K'), Tmax=(1468.01,'K')), NASAPolynomial(coeffs=[15.7579,0.0383517,-1.50749e-05,2.67304e-09,-1.78809e-13,37985.3,-39.832], Tmin=(1468.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(353.139,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(C2CJCOOH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2][C](CC)C([C]=C)OO(21603)',
    structure = SMILES('[CH2][C](CC)C([C]=C)OO'),
    E0 = (438.976,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0415725,0.0861905,-6.77173e-05,2.84025e-08,-4.9573e-12,52944.1,42.1663], Tmin=(100,'K'), Tmax=(1328.63,'K')), NASAPolynomial(coeffs=[14.7127,0.0417707,-1.75676e-05,3.23869e-09,-2.22341e-13,49023.6,-33.2067], Tmin=(1328.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(438.976,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C2CJCOOH) + radical(Isobutyl) + radical(Cds_S)"""),
)

species(
    label = '[CH2]CC([CH2])C(C=C)O[O](21604)',
    structure = SMILES('[CH2]CC([CH2])C(C=C)O[O]'),
    E0 = (367.475,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.317019,0.0922957,-8.18479e-05,3.96264e-08,-7.89626e-12,44354.6,40.3838], Tmin=(100,'K'), Tmax=(1191.04,'K')), NASAPolynomial(coeffs=[15.1644,0.0403031,-1.63689e-05,2.97595e-09,-2.03374e-13,40666.8,-37.012], Tmin=(1191.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(367.475,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
species(
    label = '[CH]=[C]C(OO)C([CH2])CC(21606)',
    structure = SMILES('[CH]=[C]C(OO)C([CH2])CC'),
    E0 = (495.162,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.559662,0.101244,-0.0001007,5.47114e-08,-1.21945e-11,59717.6,39.5927], Tmin=(100,'K'), Tmax=(1073.12,'K')), NASAPolynomial(coeffs=[15.3011,0.0421234,-1.80605e-05,3.37173e-09,-2.33999e-13,56313.6,-38.0457], Tmin=(1073.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(495.162,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH2]CC([CH2])C([C]=C)OO(21608)',
    structure = SMILES('[CH2]CC([CH2])C([C]=C)OO'),
    E0 = (453.312,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.444258,0.09842,-9.44348e-05,4.95643e-08,-1.0722e-11,54680.3,40.5605], Tmin=(100,'K'), Tmax=(1100.51,'K')), NASAPolynomial(coeffs=[14.9348,0.042521,-1.82427e-05,3.40779e-09,-2.36566e-13,51295.4,-35.1073], Tmin=(1100.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(453.312,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(RCCJ) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]C(C)C([C]=C)O[O](20930)'],
    products = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['O(4)', '[CH2]C(CC)C([O])[C]=C(21578)'],
    products = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(T)(20)', 'C=[C]C([CH]CC)O[O](21426)'],
    products = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H2CC(T)(1341)', '[CH2]C([CH]O[O])CC(786)'],
    products = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]C(CC)C([C]=C)O[O](21579)'],
    products = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
    products = ['[CH2]C(CC)C1OOC1=C(21580)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
    products = ['O(4)', '[CH2]C(CC)C1OC1=C(21583)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
    products = ['O(4)', 'C=[C]C1OCC1CC(21584)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
    products = ['HO2(9)', '[CH2][C]=CC(=C)CC(17016)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
    products = ['C=CC(O[O])C(=C)CC(21585)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
    products = ['[CH2]C(CC)C(=C=C)OO(21586)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
    products = ['C=[C]C(OO)C(=C)CC(21588)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', 'C=[C]C(O[O])C(=C)CC(21589)'],
    products = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2]C(CC)C(=C=C)O[O](21590)'],
    products = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C#CC(O[O])C([CH2])CC(21107)'],
    products = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C2H5(14)', 'C=[C]C(C=C)O[O](21012)'],
    products = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C2H5(14)', '[CH2][CH]C([C]=C)O[O](21374)'],
    products = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', '[CH2][C](CC)C([C]=C)O[O](21591)'],
    products = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH3(17)', '[CH2]C([CH2])C([C]=C)O[O](20978)'],
    products = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', '[CH2]C(CC)[C]([C]=C)O[O](21592)'],
    products = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(3)', '[CH2]CC([CH2])C([C]=C)O[O](21593)'],
    products = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', '[CH]=[C]C(O[O])C([CH2])CC(21594)'],
    products = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
    products = ['[CH2]C(CC)[C](C=C)O[O](21596)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH]=CC(O[O])C([CH2])CC(21597)'],
    products = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
    products = ['[CH2]C(CC)[C]([C]=C)OO(21598)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
    products = ['[CH2][C](CC)C(C=C)O[O](21600)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2]CC(C)C([C]=C)O[O](21602)'],
    products = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2][C](CC)C([C]=C)OO(21603)'],
    products = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
    products = ['[CH2]CC([CH2])C(C=C)O[O](21604)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH]=[C]C(OO)C([CH2])CC(21606)'],
    products = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH2]C(CC)C([C]=C)O[O](20954)'],
    products = ['[CH2]CC([CH2])C([C]=C)OO(21608)'],
...
network(
    label = 'PDepNetwork #4616',
    isomers = [
        '[CH2]C(CC)C([C]=C)O[O](20954)',
    ],
    reactants = [
