...
species(
    label = '[CH][CH]C[CH]C[CH]C(13880)',
    structure = SMILES('[CH][CH]C[CH]C[CH]C'),
    E0 = (815.921,'kJ/mol'),
    modes = [
...
species(
    label = '[CH]C[CH]C[CH][CH]C(13881)',
    structure = SMILES('[CH]C[CH]C[CH][CH]C'),
    E0 = (815.933,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,192.207,543.014,809.571,1720.18,2859.28,3161.7,3251.66],'cm^-1')),
        HinderedRotor(inertia=(0.0656502,'amu*angstrom^2'), symmetry=1, barrier=(1.53602,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0656502,'amu*angstrom^2'), symmetry=1, barrier=(1.53602,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0656502,'amu*angstrom^2'), symmetry=1, barrier=(1.53602,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0656502,'amu*angstrom^2'), symmetry=1, barrier=(1.53602,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0656502,'amu*angstrom^2'), symmetry=1, barrier=(1.53602,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.80509,0.047571,-1.7639e-05,1.79852e-09,5.79969e-14,98095.6,25.635], Tmin=(100,'K'), Tmax=(2770.06,'K')), NASAPolynomial(coeffs=[51.2718,-0.00290218,-9.21259e-08,-6.96331e-11,1.40737e-14,64866,-264.24], Tmin=(2770.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(815.933,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC) + radical(RCCJC) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1[CH]CCC1C(13882)',
    structure = SMILES('[CH]C1[CH]CCC1C'),
    E0 = (485.44,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
species(
    label = '[CH][CH]C1CCC1C(13883)',
    structure = SMILES('[CH][CH]C1CCC1C'),
    E0 = (567.207,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.916785,0.0620517,-3.12605e-05,7.14224e-09,-6.11377e-13,73017.3,30.2167], Tmin=(100,'K'), Tmax=(1973.51,'K')), NASAPolynomial(coeffs=[17.5251,0.0331469,-1.2907e-05,2.16385e-09,-1.35468e-13,65535.5,-63.5465], Tmin=(1973.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(606.136,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(Allyl_S) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.651817,0.0630287,-1.7603e-05,-1.19711e-08,6.43348e-12,49644.1,28.4019], Tmin=(100,'K'), Tmax=(1138.03,'K')), NASAPolynomial(coeffs=[11.6711,0.0437959,-1.79531e-05,3.28945e-09,-2.26263e-13,45873.4,-31.732], Tmin=(1138.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(411.689,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=[C]CCCC(13890)',
...
species(
    label = '[C]=C[CH]CC[CH]C(13892)',
    structure = SMILES('[C]C=CCC[CH]C'),
    E0 = (763.816,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,391.063,391.067,391.069,2665.25],'cm^-1')),
        HinderedRotor(inertia=(0.0662126,'amu*angstrom^2'), symmetry=1, barrier=(7.18571,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0662136,'amu*angstrom^2'), symmetry=1, barrier=(7.18577,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0914134,'amu*angstrom^2'), symmetry=1, barrier=(9.92068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.183237,'amu*angstrom^2'), symmetry=1, barrier=(19.8858,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15362,0.0643168,-4.52185e-05,1.75098e-08,-2.95403e-12,91966.6,27.7743], Tmin=(100,'K'), Tmax=(1311.43,'K')), NASAPolynomial(coeffs=[9.2494,0.0396238,-1.69749e-05,3.15215e-09,-2.1702e-13,89843.2,-13.4781], Tmin=(1311.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(763.816,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(CJ3)"""),
)

species(
    label = 'C[CH]CCC1C=C1(13893)',
    structure = SMILES('C[CH]CCC1C=C1'),
    E0 = (364.187,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.15178,0.0637009,-3.91924e-05,1.27055e-08,-1.77528e-12,43902.5,25.3282], Tmin=(100,'K'), Tmax=(1532.14,'K')), NASAPolynomial(coeffs=[9.77267,0.0411939,-1.71575e-05,3.1176e-09,-2.108e-13,41260.8,-19.9407], Tmin=(1532.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(364.187,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(RCCJC)"""),
)
...
species(
    label = 'C=C=CCC[CH]C(5058)',
    structure = SMILES('C=C=CCC[CH]C'),
    E0 = (270.943,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,540,610,2055,233.996,2090,2090],'cm^-1')),
        HinderedRotor(inertia=(0.699283,'amu*angstrom^2'), symmetry=1, barrier=(27.1703,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305039,'amu*angstrom^2'), symmetry=1, barrier=(11.8522,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305039,'amu*angstrom^2'), symmetry=1, barrier=(11.8522,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305037,'amu*angstrom^2'), symmetry=1, barrier=(11.8522,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19617,0.0625232,-3.67308e-05,1.09664e-08,-1.38333e-12,32686.1,28.2121], Tmin=(100,'K'), Tmax=(1687.29,'K')), NASAPolynomial(coeffs=[10.7918,0.0397749,-1.65072e-05,2.97575e-09,-1.99374e-13,29448,-23.1009], Tmin=(1687.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.943,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(RCCJC)"""),
)

species(
    label = '[CH]=CCCC=CC(13894)',
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.631624,0.0646535,-3.57544e-05,6.7534e-09,4.46454e-13,33176.3,29.3546], Tmin=(100,'K'), Tmax=(1253.11,'K')), NASAPolynomial(coeffs=[13.4644,0.0351534,-1.41635e-05,2.56664e-09,-1.74611e-13,29060.1,-39.0427], Tmin=(1253.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(274.771,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC=CCCC(13895)',
...
species(
    label = 'C=CC=CC[CH]C(5069)',
    structure = SMILES('C=CC=CC[CH]C'),
    E0 = (205.916,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2950,3100,1380,975,1025,1650,258.78,258.781,258.782],'cm^-1')),
        HinderedRotor(inertia=(0.00251729,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00251733,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.287951,'amu*angstrom^2'), symmetry=1, barrier=(13.684,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.287951,'amu*angstrom^2'), symmetry=1, barrier=(13.684,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.7873,0.0611277,-2.49226e-05,-5.577e-09,5.15281e-12,24889.7,29.2275], Tmin=(100,'K'), Tmax=(1078.29,'K')), NASAPolynomial(coeffs=[12.2343,0.0359578,-1.39656e-05,2.52187e-09,-1.73223e-13,21415.7,-31.5221], Tmin=(1078.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(205.916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(RCCJC)"""),
)

species(
    label = '[CH]=CCCCC=C(13657)',
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.629957,0.0640125,-3.01958e-05,-1.18517e-09,3.61723e-12,34649.8,29.7914], Tmin=(100,'K'), Tmax=(1124.58,'K')), NASAPolynomial(coeffs=[13.4704,0.0351585,-1.41416e-05,2.59579e-09,-1.79513e-13,30698.3,-38.3923], Tmin=(1124.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(287.016,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C=CCCCC(9534)',
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.379431,0.0725985,-5.59385e-05,2.43746e-08,-4.41239e-12,27131.4,27.4884], Tmin=(100,'K'), Tmax=(1304.13,'K')), NASAPolynomial(coeffs=[12.7587,0.0346287,-1.22657e-05,2.04903e-09,-1.3258e-13,23902.6,-35.5216], Tmin=(1304.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(224.451,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Sec_Propargyl)"""),
)

species(
    label = '[CH]=CC=CC[CH]C(13896)',
    structure = SMILES('[CH]=CC=CC[CH]C'),
    E0 = (453.012,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3120,650,792.5,1650,261.927,945.733],'cm^-1')),
        HinderedRotor(inertia=(0.148191,'amu*angstrom^2'), symmetry=1, barrier=(7.52291,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.286487,'amu*angstrom^2'), symmetry=1, barrier=(14.3363,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153163,'amu*angstrom^2'), symmetry=1, barrier=(7.50365,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.281397,'amu*angstrom^2'), symmetry=1, barrier=(14.3346,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.552668,0.0663651,-4.67292e-05,1.72963e-08,-2.615e-12,54616.7,30.4848], Tmin=(100,'K'), Tmax=(1546.3,'K')), NASAPolynomial(coeffs=[14.7971,0.029517,-1.09842e-05,1.8852e-09,-1.23372e-13,50211.5,-44.4452], Tmin=(1546.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(453.012,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(RCCJC) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03972,0.0699592,-6.0269e-05,3.5061e-08,-9.58335e-12,71246,31.0676], Tmin=(100,'K'), Tmax=(832.747,'K')), NASAPolynomial(coeffs=[5.51112,0.0484816,-2.15824e-05,4.09015e-09,-2.8564e-13,70501.3,10.314], Tmin=(832.747,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(591.522,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    ...
    E0 = (558.926,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction3',
    reactants = ['CHCH3(T)(21)', '[CH]=C[CH]C[CH2](13774)'],
    products = ['[CH]C=CCC[CH]C(5053)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', '[CH]C=CCC[CH](13792)'],
    products = ['[CH]C=CCC[CH]C(5053)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]C=CCC[C]C(13879)'],
    products = ['[CH]C=CCC[CH]C(5053)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH][CH]C[CH]C[CH]C(13880)'],
    products = ['[CH]C=CCC[CH]C(5053)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH][CH]CC[CH][CH]C(4156)'],
    products = ['[CH]C=CCC[CH]C(5053)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]C[CH]C[CH][CH]C(13881)'],
    products = ['[CH]C=CCC[CH]C(5053)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]C=CCC[CH]C(5053)'],
    products = ['[CH][CH]C1CCC1C(13883)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(4.73e+06,'s^-1'), n=1.31, Ea=(102.184,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(2500,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra;radadd_intra_csHNd]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH]C=CCC=CC(13884)'],
    products = ['[CH]C=CCC[CH]C(5053)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]=C[CH]CCC=C(13680)'],
    products = ['[CH]C=CCC[CH]C(5053)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH]C=CC[CH][CH]C(13885)'],
    products = ['[CH]C=CCC[CH]C(5053)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]C=[CH](13797)', '[CH2]C[CH]C(36)'],
    products = ['[CH]C=CCC[CH]C(5053)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH]C=C[CH]C[CH]C(13886)'],
    products = ['[CH]C=CCC[CH]C(5053)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH]C=[C]CC[CH]C(13887)'],
    products = ['[CH]C=CCC[CH]C(5053)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH][C]=CCC[CH]C(13888)'],
    products = ['[CH]C=CCC[CH]C(5053)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C2H2(T)(1343)', '[CH]CC[CH]C(119)'],
    products = ['[CH]C=CCC[CH]C(5053)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[C]=C[CH]CC[CH]C(13892)'],
    products = ['[CH]C=CCC[CH]C(5053)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(3)', '[CH]=CC=CC[CH]C(13896)'],
    products = ['[CH]C=CCC[CH]C(5053)'],
...
reaction(
    label = 'reaction38',
    reactants = ['H(3)', '[CH]=C=CCC[CH]C(13897)'],
    products = ['[CH]C=CCC[CH]C(5053)'],
...
reaction(
    label = 'reaction39',
    reactants = ['C2H2(1342)', '[CH]CC[CH]C(119)'],
    products = ['[CH]C=CCC[CH]C(5053)'],
