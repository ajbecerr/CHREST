...
species(
    label = '[CH2][C]C([CH2])O[C]=C(9159)',
    structure = SMILES('[CH2][C]C([CH2])O[C]=C'),
    E0 = (858.005,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0141601,0.0846684,-9.90721e-05,5.81616e-08,-1.3275e-11,103342,31.8091], Tmin=(100,'K'), Tmax=(1079.33,'K')), NASAPolynomial(coeffs=[17.8914,0.0183095,-6.84856e-06,1.19743e-09,-8.05128e-14,99476.8,-55.9416], Tmin=(1079.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(858.005,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(RCCJ) + radical(CCJ2_triplet) + radical(C=CJO)"""),
)

species(
    label = '[CH]C([CH][CH2])O[C]=C(9160)',
    structure = SMILES('[CH]C([CH][CH2])O[C]=C'),
    E0 = (847.397,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.478176,0.0673438,-4.93226e-05,7.17519e-09,4.48318e-12,102054,33.8838], Tmin=(100,'K'), Tmax=(970.629,'K')), NASAPolynomial(coeffs=[18.2675,0.0165236,-5.54236e-06,9.77466e-10,-6.91633e-14,97541.4,-56.8668], Tmin=(970.629,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(847.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(RCCJ) + radical(CCJ2_triplet) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][CH]C([CH2])O[C]=C(4193)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H2CC(T)(1341)', '[CH2][CH]C([CH2])[O](1582)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH][CH2](502)', '[CH2][CH]O[C]=C(2367)'],
    products = ['[CH2][CH]C([CH2])O[C]=C(4193)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', '[CH2][CH][CH]O[C]=C(2624)'],
    products = ['[CH2][CH]C([CH2])O[C]=C(4193)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH2][C]C([CH2])O[C]=C(9159)'],
    products = ['[CH2][CH]C([CH2])O[C]=C(4193)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C([CH][CH2])O[C]=C(9160)'],
    products = ['[CH2][CH]C([CH2])O[C]=C(4193)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction18',
    reactants = ['[CH][CH2](502)', 'C=[C]OC=C(2317)'],
    products = ['[CH2][CH]C([CH2])O[C]=C(4193)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH2][CH][C]([CH2])O[C]=C(9163)'],
    products = ['[CH2][CH]C([CH2])O[C]=C(4193)'],
