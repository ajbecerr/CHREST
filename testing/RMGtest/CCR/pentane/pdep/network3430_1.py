...
species(
    label = '[CH]=CC[C]CO[O](15262)',
    structure = SMILES('[CH]=CC[C]CO[O]'),
    E0 = (718.691,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,275.565,275.566,275.568],'cm^-1')),
        HinderedRotor(inertia=(0.176506,'amu*angstrom^2'), symmetry=1, barrier=(9.51132,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.176506,'amu*angstrom^2'), symmetry=1, barrier=(9.51131,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.176502,'amu*angstrom^2'), symmetry=1, barrier=(9.51134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.21998,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.877497,0.0729928,-9.3924e-05,6.85062e-08,-2.04377e-11,86547.1,28.0723], Tmin=(100,'K'), Tmax=(814.053,'K')), NASAPolynomial(coeffs=[9.77411,0.0292758,-1.33665e-05,2.53108e-09,-1.75532e-13,85098.7,-13.0181], Tmin=(814.053,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(718.691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[C]=CC[CH]CO[O](15263)',
    structure = SMILES('[C]=CC[CH]CO[O]'),
    E0 = (781.897,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,281.815,281.839,1430.76],'cm^-1')),
        HinderedRotor(inertia=(0.135784,'amu*angstrom^2'), symmetry=1, barrier=(7.6546,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135779,'amu*angstrom^2'), symmetry=1, barrier=(7.65447,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13581,'amu*angstrom^2'), symmetry=1, barrier=(7.65474,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.13575,'amu*angstrom^2'), symmetry=1, barrier=(7.6544,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.868271,0.0764384,-0.000117341,1.03807e-07,-3.63946e-11,94146,30.4696], Tmin=(100,'K'), Tmax=(832.142,'K')), NASAPolynomial(coeffs=[6.86188,0.0339808,-1.62076e-05,3.07622e-09,-2.11167e-13,93621,5.4943], Tmin=(832.142,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(781.897,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CdCdJ2_triplet)"""),
)

species(
    label = '[CH]=CCC1COO1(15264)',
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.36738,0.0549732,-3.74157e-05,1.29006e-08,-1.83391e-12,33193.7,21.7963], Tmin=(100,'K'), Tmax=(1592.38,'K')), NASAPolynomial(coeffs=[12.223,0.0277042,-1.17285e-05,2.14634e-09,-1.45503e-13,29736.5,-35.626], Tmin=(1592.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(275.184,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(12dioxetane) + radical(Cds_P)"""),
)

species(
    label = '[O]OCC1C=CC1(15243)',
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53189,0.0427254,3.58184e-06,-3.3718e-08,1.54717e-11,21314.8,23.6897], Tmin=(100,'K'), Tmax=(998.094,'K')), NASAPolynomial(coeffs=[12.7083,0.024639,-9.37044e-06,1.74024e-09,-1.24313e-13,17753.6,-36.8724], Tmin=(998.094,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(176.398,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(ROOJ)"""),
)

species(
    label = '[CH]=CCC1CO1(15265)',
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73411,0.0405298,5.84167e-06,-4.44443e-08,2.39685e-11,27018,20.2642], Tmin=(100,'K'), Tmax=(860.643,'K')), NASAPolynomial(coeffs=[12.7263,0.0174973,-2.91337e-06,2.14424e-10,-6.49859e-15,24086.9,-37.1535], Tmin=(860.643,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(223.887,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.689057,0.0643405,-5.20652e-05,1.87901e-08,-1.91261e-12,30380.7,29.0153], Tmin=(100,'K'), Tmax=(1097.66,'K')), NASAPolynomial(coeffs=[15.6858,0.0209609,-8.18639e-06,1.49411e-09,-1.0372e-13,26409.4,-47.8253], Tmin=(1097.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(251.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.726593,0.067598,-6.17807e-05,2.91805e-08,-5.52996e-12,26985.6,26.4717], Tmin=(100,'K'), Tmax=(1266.37,'K')), NASAPolynomial(coeffs=[14.6304,0.0236808,-9.76104e-06,1.79517e-09,-1.23669e-13,23464.1,-43.8896], Tmin=(1266.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(223.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC=CCO[O](15269)',
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.66276,'amu*angstrom^2'), symmetry=1, barrier=(15.2381,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.661855,'amu*angstrom^2'), symmetry=1, barrier=(15.2173,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.662168,'amu*angstrom^2'), symmetry=1, barrier=(15.2246,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10284,0.0626934,-6.2018e-05,3.29905e-08,-7.11313e-12,45251.3,25.8805], Tmin=(100,'K'), Tmax=(1115.64,'K')), NASAPolynomial(coeffs=[11.9293,0.0238755,-9.82535e-06,1.80132e-09,-1.23871e-13,42835.7,-27.5352], Tmin=(1115.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(375.366,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C[CH][CH]CO[O](15271)',
    structure = SMILES('[CH]C=C[CH]CO[O]'),
    E0 = (498.736,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01631,0.0683528,-6.21504e-05,3.21548e-08,-7.12279e-12,60089.3,25.1342], Tmin=(100,'K'), Tmax=(1052.37,'K')), NASAPolynomial(coeffs=[9.48922,0.0361474,-1.62459e-05,3.07448e-09,-2.14425e-13,58305.9,-16.1751], Tmin=(1052.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(498.736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(C=CCJCO) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]=C[CH]CCO[O](15240)',
    structure = SMILES('[CH]C=CCCO[O]'),
    E0 = (381.819,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24556,0.0642288,-5.36462e-05,2.71487e-08,-6.17431e-12,46018.4,27.1152], Tmin=(100,'K'), Tmax=(999.917,'K')), NASAPolynomial(coeffs=[7.18141,0.0404836,-1.80256e-05,3.3999e-09,-2.36649e-13,44831.3,-1.5214], Tmin=(999.917,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(381.819,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=CCC[CH]O[O](15273)',
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.88739,0.0732866,-9.3734e-05,7.26963e-08,-2.35849e-11,55319.6,28.2766], Tmin=(100,'K'), Tmax=(759.547,'K')), NASAPolynomial(coeffs=[8.08683,0.0346071,-1.58363e-05,2.99795e-09,-2.07588e-13,54248,-4.33114], Tmin=(759.547,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(459.059,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCsJOOH) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=CC[CH][CH]OO(15274)',
    structure = SMILES('[CH]=CC[CH][CH]OO'),
    E0 = (507.469,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,272.878,272.88],'cm^-1')),
        HinderedRotor(inertia=(0.00226388,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.848887,'amu*angstrom^2'), symmetry=1, barrier=(44.8559,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00226391,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.141026,'amu*angstrom^2'), symmetry=1, barrier=(7.45205,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.848879,'amu*angstrom^2'), symmetry=1, barrier=(44.8559,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.70057,0.0782225,-0.000102213,7.85371e-08,-2.51067e-11,61148,30.4978], Tmin=(100,'K'), Tmax=(756.817,'K')), NASAPolynomial(coeffs=[8.85698,0.0351055,-1.67405e-05,3.2318e-09,-2.26478e-13,59913.6,-6.57805], Tmin=(756.817,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(507.469,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJCOOH) + radical(CCsJOOH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]CCCO[O](15275)',
    structure = SMILES('[CH]=[C]CCCO[O]'),
    E0 = (508.318,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1685,370,3120,650,792.5,1650,252.805,252.824],'cm^-1')),
        HinderedRotor(inertia=(0.166754,'amu*angstrom^2'), symmetry=1, barrier=(7.5542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166545,'amu*angstrom^2'), symmetry=1, barrier=(7.55356,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166605,'amu*angstrom^2'), symmetry=1, barrier=(7.55499,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166832,'amu*angstrom^2'), symmetry=1, barrier=(7.55467,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.810341,0.0756856,-0.000103885,8.53083e-08,-2.86932e-11,61246.1,28.8736], Tmin=(100,'K'), Tmax=(805.113,'K')), NASAPolynomial(coeffs=[7.86453,0.034533,-1.58386e-05,2.98302e-09,-2.05104e-13,60308.1,-2.4007], Tmin=(805.113,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(508.318,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]C[CH]COO(15279)',
    structure = SMILES('[CH]=[C]C[CH]COO'),
    E0 = (556.728,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,235.393,235.451],'cm^-1')),
        HinderedRotor(inertia=(0.12237,'amu*angstrom^2'), symmetry=1, barrier=(4.82079,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121617,'amu*angstrom^2'), symmetry=1, barrier=(4.82003,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.474706,'amu*angstrom^2'), symmetry=1, barrier=(18.7124,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00304409,'amu*angstrom^2'), symmetry=1, barrier=(0.119708,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.22441,'amu*angstrom^2'), symmetry=1, barrier=(48.3751,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.589018,0.0810903,-0.000114337,9.42852e-08,-3.18667e-11,67076,31.2148], Tmin=(100,'K'), Tmax=(778.24,'K')), NASAPolynomial(coeffs=[8.699,0.0349121,-1.66697e-05,3.19881e-09,-2.22445e-13,65949.8,-5.0034], Tmin=(778.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(556.728,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJCOOH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC[CH]CO[O](15038)'],
    products = ['C2H2(1342)', 'allylperoxy(462)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]=CC[CH]CO[O](15038)'],
    products = ['O2(S)(666)', '[CH]=CCC=C(15037)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction4',
    reactants = ['O(4)', '[CH]=CC[CH]C[O](15261)'],
    products = ['[CH]=CC[CH]CO[O](15038)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]CO[O](790)', '[CH]C=C(3739)'],
    products = ['[CH]=CC[CH]CO[O](15038)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]O[O](46)', '[CH]CC=[CH](15079)'],
    products = ['[CH]=CC[CH]CO[O](15038)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]=CC[C]CO[O](15262)'],
    products = ['[CH]=CC[CH]CO[O](15038)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[C]=CC[CH]CO[O](15263)'],
    products = ['[CH]=CC[CH]CO[O](15038)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH]=CC=CCO[O](15269)'],
    products = ['[CH]=CC[CH]CO[O](15038)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH]=CCC=CO[O](15270)'],
    products = ['[CH]=CC[CH]CO[O](15038)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'C#CC[CH]CO[O](10695)'],
    products = ['[CH]=CC[CH]CO[O](15038)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C2H2(T)(1343)', 'allylperoxy(462)'],
    products = ['[CH]=CC[CH]CO[O](15038)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C2H2(1342)', '[CH2][CH]CO[O](461)'],
    products = ['[CH]=CC[CH]CO[O](15038)'],
...
reaction(
    label = 'reaction22',
    reactants = ['O2(2)', '[CH]=CC[CH][CH2](15036)'],
    products = ['[CH]=CC[CH]CO[O](15038)'],
...
reaction(
    label = 'reaction23',
    reactants = ['C2H2(T)(1343)', '[CH2][CH]CO[O](461)'],
    products = ['[CH]=CC[CH]CO[O](15038)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH]=C[CH][CH]CO[O](15271)'],
    products = ['[CH]=CC[CH]CO[O](15038)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH]=CC[CH][CH]O[O](15272)'],
    products = ['[CH]=CC[CH]CO[O](15038)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH]=[C]C[CH]CO[O](10684)'],
    products = ['[CH]=CC[CH]CO[O](15038)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]=CC[CH][CH]OO(15274)'],
    products = ['[CH]=CC[CH]CO[O](15038)'],
