...
species(
    label = '[CH][CH]C[C]=[CH](18796)',
    structure = SMILES('[CH][CH]C[C]=[CH]'),
    E0 = (1087.3,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,180,1420.52,1420.53,1420.77],'cm^-1')),
        HinderedRotor(inertia=(0.145983,'amu*angstrom^2'), symmetry=1, barrier=(3.35645,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146186,'amu*angstrom^2'), symmetry=1, barrier=(3.36111,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.145867,'amu*angstrom^2'), symmetry=1, barrier=(3.35377,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (65.0932,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.09374,0.0458804,-6.16624e-05,5.2483e-08,-1.82308e-11,130836,23.7814], Tmin=(100,'K'), Tmax=(836.092,'K')), NASAPolynomial(coeffs=[5.05037,0.0246975,-1.10326e-05,2.04503e-09,-1.39024e-13,130588,11.5178], Tmin=(836.092,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1087.3,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(Cds_S) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    label = '[C]=[C]CC([CH])[O](18797)',
    structure = SMILES('[C]=[C]CC([CH])[O]'),
    E0 = (1261.75,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,1685,370,390.765,390.784,390.826,390.829,391.042,1559.76],'cm^-1')),
        HinderedRotor(inertia=(0.00110411,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00110103,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0632536,'amu*angstrom^2'), symmetry=1, barrier=(6.86571,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 7,
    opticalIsomers = 1,
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.55259,0.0593788,-7.86223e-05,5.08957e-08,-1.01258e-11,151836,25.1601], Tmin=(100,'K'), Tmax=(625.018,'K')), NASAPolynomial(coeffs=[8.92407,0.0215579,-1.03067e-05,1.97582e-09,-1.37331e-13,150732,-8.40047], Tmin=(625.018,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1261.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CCJ2_triplet) + radical(Cds_S) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07343,0.0568619,-5.85983e-05,3.05972e-08,-6.18279e-12,66735.6,26.3397], Tmin=(100,'K'), Tmax=(1268.04,'K')), NASAPolynomial(coeffs=[14.6742,0.0121439,-3.55363e-06,5.29119e-10,-3.22375e-14,63432.2,-41.9309], Tmin=(1268.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(553.942,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CCJ2_triplet) + radical(C=C=CJ)"""),
)
...
species(
    label = '[CH][C]([O])C[C]=[CH](18799)',
    structure = SMILES('[CH][C]([O])C[C]=[CH]'),
    E0 = (1127.37,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,1685,370,3120,650,792.5,1650,339.69,339.744,339.772,1466.88,1467.14],'cm^-1')),
        HinderedRotor(inertia=(0.00145826,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118582,'amu*angstrom^2'), symmetry=1, barrier=(9.70697,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.118474,'amu*angstrom^2'), symmetry=1, barrier=(9.70552,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 7,
    opticalIsomers = 1,
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12975,0.0685266,-0.000109736,9.23068e-08,-3.02432e-11,135689,26.0963], Tmin=(100,'K'), Tmax=(853.791,'K')), NASAPolynomial(coeffs=[9.44015,0.0205791,-9.66274e-06,1.80187e-09,-1.21741e-13,134599,-10.759], Tmin=(853.791,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1127.37,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(Cds_S) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.966065,0.0725278,-0.000115645,9.72964e-08,-3.17974e-11,107989,26.8759], Tmin=(100,'K'), Tmax=(864.757,'K')), NASAPolynomial(coeffs=[9.53465,0.0223209,-1.02186e-05,1.88219e-09,-1.26126e-13,106902,-10.9319], Tmin=(864.757,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(897.008,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C2CsJOH) + radical(Cds_S) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=[CH](9646)', '[CH]C([CH2])[O](6989)'],
    products = ['[CH]C([O])C[C]=[CH](16586)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(4)', '[CH][CH]C[C]=[CH](18796)'],
    products = ['[CH]C([O])C[C]=[CH](16586)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[C]=[C]CC([CH])[O](18797)'],
    products = ['[CH]C([O])C[C]=[CH](16586)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH](6993)', 'C#CC[CH][O](10201)'],
    products = ['[CH]C([O])C[C]=[CH](16586)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(185.577,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 181.1 to 185.6 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH][C]([O])C[C]=[CH](18799)'],
    products = ['[CH]C([O])C[C]=[CH](16586)'],
