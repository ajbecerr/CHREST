...
species(
    label = '[O]CC1CC1(29064)',
    structure = SMILES('[O]CC1CC1'),
    E0 = (75.1285,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.62129,0.0212628,2.86036e-05,-4.45413e-08,1.63565e-11,9093.36,17.3926], Tmin=(100,'K'), Tmax=(1025.7,'K')), NASAPolynomial(coeffs=[7.23325,0.025573,-1.03052e-05,1.94017e-09,-1.38011e-13,6974.43,-10.6917], Tmin=(1025.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(75.1285,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclopropane) + radical(CCOJ)"""),
)

species(
    label = '[CH2]C1COC1(28816)',
    ...
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.69971,0.0169043,5.57345e-05,-9.07609e-08,4.02639e-11,9191.76,15.2021], Tmin=(100,'K'), Tmax=(848.289,'K')), NASAPolynomial(coeffs=[9.95878,0.015793,-8.61934e-07,-2.58929e-10,2.84782e-14,6768.63,-25.6477], Tmin=(848.289,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(75.9411,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86827,0.0408893,-2.07647e-05,-1.13972e-11,2.44578e-12,-4075.71,18.9171], Tmin=(100,'K'), Tmax=(1064.4,'K')), NASAPolynomial(coeffs=[9.88775,0.0213577,-8.18532e-06,1.47059e-09,-1.00902e-13,-6383.66,-23.0949], Tmin=(1064.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-34.5679,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH2][C]([CH2])C[O](29065)',
    structure = SMILES('[CH2][C]([CH2])C[O]'),
    E0 = (475.271,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1104.77,1104.84],'cm^-1')),
        HinderedRotor(inertia=(0.160887,'amu*angstrom^2'), symmetry=1, barrier=(3.6991,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00426951,'amu*angstrom^2'), symmetry=1, barrier=(3.69823,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00426882,'amu*angstrom^2'), symmetry=1, barrier=(3.69945,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35486,0.0385758,-3.73877e-05,2.83695e-08,-9.50082e-12,57218.8,21.8599], Tmin=(100,'K'), Tmax=(881.726,'K')), NASAPolynomial(coeffs=[3.45551,0.0284076,-1.12856e-05,1.97732e-09,-1.30348e-13,57225.9,17.8292], Tmin=(881.726,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(475.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJ(C)CO) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH2])[CH]O(29066)',
    structure = SMILES('[CH2]C([CH2])[CH]O'),
    E0 = (277.29,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1620.12],'cm^-1')),
        HinderedRotor(inertia=(0.130512,'amu*angstrom^2'), symmetry=1, barrier=(7.34054,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129936,'amu*angstrom^2'), symmetry=1, barrier=(7.30815,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0357045,'amu*angstrom^2'), symmetry=1, barrier=(66.4818,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.131643,'amu*angstrom^2'), symmetry=1, barrier=(7.33956,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41282,0.0572232,-6.96997e-05,4.83629e-08,-1.31932e-11,33443,23.7308], Tmin=(100,'K'), Tmax=(1012,'K')), NASAPolynomial(coeffs=[9.1841,0.0205718,-6.57764e-06,9.85486e-10,-5.77097e-14,32174,-12.3523], Tmin=(1012,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(277.29,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75894,0.0441227,-3.51061e-05,1.66117e-08,-3.25076e-12,30100.8,23.135], Tmin=(100,'K'), Tmax=(1284.6,'K')), NASAPolynomial(coeffs=[8.84018,0.0208175,-6.42697e-06,9.67266e-10,-5.80823e-14,28385.1,-12.3981], Tmin=(1284.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(249.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(20)', '[CH2][CH]C[O](1367)'],
    products = ['[CH2]C([CH2])C[O](3328)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(4)', '[CH2]C([CH2])[CH2](489)'],
    products = ['[CH2]C([CH2])C[O](3328)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1.72862e+13,'m^3/(mol*s)'), n=-4.75325, Ea=(276.349,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Y_rad;O_birad] for rate rule [C_rad/H2/Cs;O_birad]
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]C([CH2])C[O](29063)'],
    products = ['[CH2]C([CH2])C[O](3328)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2]C(=C)C[O](16109)'],
    products = ['[CH2]C([CH2])C[O](3328)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH2]C([CH2])C=O(1878)'],
    products = ['[CH2]C([CH2])C[O](3328)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH2(T)(20)', 'allyloxy(656)'],
    products = ['[CH2]C([CH2])C[O](3328)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2][C]([CH2])C[O](29065)'],
    products = ['[CH2]C([CH2])C[O](3328)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2]C([CH2])[CH][O](1867)'],
    products = ['[CH2]C([CH2])C[O](3328)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C([CH2])[CH]O(29066)'],
    products = ['[CH2]C([CH2])C[O](3328)'],
