...
species(
    label = 'C=[C]CC[C]=C(15601)',
    structure = SMILES('C=[C]CC[C]=C'),
    E0 = (539.384,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1670,1700,300,440,317.727,317.734,317.743],'cm^-1')),
        HinderedRotor(inertia=(0.00167267,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154564,'amu*angstrom^2'), symmetry=1, barrier=(11.0975,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155123,'amu*angstrom^2'), symmetry=1, barrier=(11.0973,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70132,0.0501285,-3.30739e-05,1.14154e-08,-1.6677e-12,64955.5,23.5409], Tmin=(100,'K'), Tmax=(1513.36,'K')), NASAPolynomial(coeffs=[9.64884,0.0291221,-1.22528e-05,2.24325e-09,-1.52491e-13,62550,-18.0941], Tmin=(1513.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(539.384,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.34145,0.0142995,9.07755e-05,-1.2831e-07,5.00638e-11,23669.6,16.8968], Tmin=(100,'K'), Tmax=(953.432,'K')), NASAPolynomial(coeffs=[14.4949,0.0195248,-5.88447e-06,1.11682e-09,-8.8111e-14,18797.1,-54.5562], Tmin=(953.432,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(196.136,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)

species(
    label = 'C=C=CC(=C)C(16001)',
    structure = SMILES('C=C=CC(=C)C'),
    E0 = (196.909,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20075,0.0525089,-2.40193e-05,-7.17067e-09,6.79639e-12,23791.5,19.5028], Tmin=(100,'K'), Tmax=(1003.74,'K')), NASAPolynomial(coeffs=[13.4195,0.0229705,-8.50151e-06,1.53485e-09,-1.07222e-13,20373.7,-44.2979], Tmin=(1003.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(196.909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06365,0.0374108,-6.54918e-06,-7.43253e-09,3.00637e-12,57046.4,21.4158], Tmin=(100,'K'), Tmax=(1273.59,'K')), NASAPolynomial(coeffs=[6.81649,0.0327539,-1.31608e-05,2.36028e-09,-1.58844e-13,55002.9,-5.93341], Tmin=(1273.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(473.697,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane) + radical(Tertalkyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C1([CH2])CC1=C(16004)',
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(=C)C[C]=C(15600)'],
    products = ['allene(458)', 'allene(458)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['H2CC(T)(1341)', '[CH2]C([CH2])=C(15608)'],
    products = ['[CH2]C(=C)C[C]=C(15600)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', 'C=[C]C[C]=C(15772)'],
    products = ['[CH2]C(=C)C[C]=C(15600)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]C(=C)C[C]=C(15999)'],
    products = ['[CH2]C(=C)C[C]=C(15600)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C(=C)C[C]=C(15600)'],
    products = ['[CH2]C1([CH2])CC1=C(16004)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2]C(=C)C=C=C(16005)'],
    products = ['[CH2]C(=C)C[C]=C(15600)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C#CCC([CH2])=C(16006)'],
    products = ['[CH2]C(=C)C[C]=C(15600)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][C]=C(459)', 'allene(458)'],
    products = ['[CH2]C(=C)C[C]=C(15600)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][C]=C(459)', '[CH2][C]=C(459)'],
    products = ['[CH2]C(=C)C[C]=C(15600)'],
...
network(
    label = 'PDepNetwork #3714',
    isomers = [
        '[CH2]C(=C)C[C]=C(15600)',
    ],
    reactants = [
        ('allene(458)', 'allene(458)'),
    ],
    bathGas = {
        'Ar': 0.333333,
        'Ne': 0.333333,
