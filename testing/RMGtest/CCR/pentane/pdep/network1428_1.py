...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86078,0.0298918,4.9958e-05,-8.35697e-08,3.32294e-11,73546.5,22.7511], Tmin=(100,'K'), Tmax=(974.705,'K')), NASAPolynomial(coeffs=[13.1568,0.0260168,-9.45477e-06,1.78194e-09,-1.31162e-13,69326.5,-41.8079], Tmin=(974.705,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(610.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.52768,0.0115445,0.000100736,-1.29236e-07,4.72109e-11,15388,13.8112], Tmin=(100,'K'), Tmax=(984.258,'K')), NASAPolynomial(coeffs=[10.4047,0.0327245,-1.26059e-05,2.44065e-09,-1.81129e-13,11260.9,-37.1543], Tmin=(984.258,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(127.348,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_4_4_ane)"""),
)

species(
    label = 'CCC1=CCC1(6250)',
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89244,0.028567,5.75234e-05,-9.12213e-08,3.58039e-11,10046.4,20.5342], Tmin=(100,'K'), Tmax=(972.847,'K')), NASAPolynomial(coeffs=[12.7401,0.0282094,-1.01441e-05,1.89805e-09,-1.39065e-13,5842.06,-42.2617], Tmin=(972.847,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(82.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)
...
species(
    label = '[CH2]CC=CC[CH2](6251)',
    structure = SMILES('[CH2]CC=CC[CH2]'),
    E0 = (335.3,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,962.386],'cm^-1')),
        HinderedRotor(inertia=(0.00540119,'amu*angstrom^2'), symmetry=1, barrier=(3.54985,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154388,'amu*angstrom^2'), symmetry=1, barrier=(3.54968,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154398,'amu*angstrom^2'), symmetry=1, barrier=(3.54991,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.621919,'amu*angstrom^2'), symmetry=1, barrier=(14.2991,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32874,0.0502837,-1.63577e-05,-7.97731e-09,4.90708e-12,40430.5,27.2701], Tmin=(100,'K'), Tmax=(1119.91,'K')), NASAPolynomial(coeffs=[10.7032,0.0322957,-1.30188e-05,2.38974e-09,-1.65157e-13,37359.1,-23.3563], Tmin=(1119.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(335.3,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC1=CCC1(6252)',
    ...
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93285,0.029263,4.72028e-05,-7.9136e-08,3.14366e-11,34728.9,22.1758], Tmin=(100,'K'), Tmax=(974.843,'K')), NASAPolynomial(coeffs=[12.5101,0.0259551,-9.39847e-06,1.76077e-09,-1.28896e-13,30761.7,-38.3548], Tmin=(974.843,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(288.013,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C[C]1[CH]CC1(6254)',
    structure = SMILES('[CH2]C[C]1[CH]CC1'),
    E0 = (535.778,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,300.767,802.856,802.856,802.856,802.856,802.856,802.856,1604.72,1604.72,1604.72,1604.72,1604.72,1604.72,1604.72],'cm^-1')),
        HinderedRotor(inertia=(0.154415,'amu*angstrom^2'), symmetry=1, barrier=(3.57589,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154415,'amu*angstrom^2'), symmetry=1, barrier=(3.57589,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.15189,0.0347268,6.03176e-06,-1.90584e-08,6.29507e-12,64510.4,25.9927], Tmin=(100,'K'), Tmax=(1242.29,'K')), NASAPolynomial(coeffs=[6.42856,0.0368529,-1.57295e-05,2.92003e-09,-2.00764e-13,62221.2,-0.504599], Tmin=(1242.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(535.778,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(cyclobutane) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC1[CH]C[CH]1(6255)',
    structure = SMILES('[CH2]CC1[CH]C[CH]1'),
    E0 = (538.194,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23386,0.0280405,3.32192e-05,-5.14655e-08,1.83473e-11,64802.6,26.2058], Tmin=(100,'K'), Tmax=(1055.5,'K')), NASAPolynomial(coeffs=[7.52479,0.0348069,-1.45072e-05,2.75006e-09,-1.95116e-13,62191.8,-6.68216], Tmin=(1055.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(538.194,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(cyclobutane) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC1[CH][CH]C1(6256)',
    structure = SMILES('[CH2]CC1[CH][CH]C1'),
    E0 = (538.194,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97552,0.034454,2.23451e-05,-4.16473e-08,1.51136e-11,41928.9,23.5736], Tmin=(100,'K'), Tmax=(1070.49,'K')), NASAPolynomial(coeffs=[7.70605,0.0371812,-1.53019e-05,2.86358e-09,-2.01035e-13,39318.9,-10.9236], Tmin=(1070.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(347.94,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC1C[CH]C1(6259)',
...
species(
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.10329,0.0341884,1.55192e-05,-2.96717e-08,9.87435e-12,39828.2,24.3764], Tmin=(100,'K'), Tmax=(1167.39,'K')), NASAPolynomial(coeffs=[6.11116,0.0399462,-1.69228e-05,3.15704e-09,-2.18841e-13,37564.3,-1.26776], Tmin=(1167.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(330.532,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(cyclobutane)"""),
)

species(
    label = 'CCC1[CH]C[CH]1(6262)',
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.19548,0.0273319,4.3526e-05,-6.34397e-08,2.26227e-11,40120,24.5563], Tmin=(100,'K'), Tmax=(1039.87,'K')), NASAPolynomial(coeffs=[7.67815,0.037185,-1.53215e-05,2.90307e-09,-2.06563e-13,37306.7,-10.1529], Tmin=(1039.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.948,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(cyclobutane)"""),
)

species(
    label = 'CCC1[CH][CH]C1(6263)',
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC1[CH]CC1(4945)'],
    products = ['C2H4(22)', 'C1=CCC1(4846)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[CH2]C1[CH]CC1(6246)'],
    products = ['[CH2]CC1[CH]CC1(4945)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2]CC1[C]CC1(6247)'],
    products = ['[CH2]CC1[CH]CC1(4945)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]CC1[CH]CC1(6248)'],
    products = ['[CH2]CC1[CH]CC1(4945)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2]CC1=CCC1(6252)'],
    products = ['[CH2]CC1[CH]CC1(4945)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH2]CC1C=CC1(6253)'],
    products = ['[CH2]CC1[CH]CC1(4945)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'C=CC1[CH]CC1(6206)'],
    products = ['[CH2]CC1[CH]CC1(4945)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C2H4(T)(23)', 'C1=CCC1(4846)'],
    products = ['[CH2]CC1[CH]CC1(4945)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C2H4(22)', '[CH]1[CH]CC1(6173)'],
    products = ['[CH2]CC1[CH]CC1(4945)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C2H4(T)(23)', '[CH]1[CH]CC1(6173)'],
    products = ['[CH2]CC1[CH]CC1(4945)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH2]C[C]1[CH]CC1(6254)'],
    products = ['[CH2]CC1[CH]CC1(4945)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH2]CC1[CH]C[CH]1(6255)'],
    products = ['[CH2]CC1[CH]CC1(4945)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH2]CC1[CH][CH]C1(6256)'],
    products = ['[CH2]CC1[CH]CC1(4945)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2][CH]C1[CH]CC1(6257)'],
    products = ['[CH2]CC1[CH]CC1(4945)'],
