...
species(
    ...
    molecularWeight = (57.0712,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.03717,0.0169046,8.69145e-06,-1.69497e-08,6.01712e-12,8796.85,13.6307], Tmin=(100,'K'), Tmax=(1098.54,'K')), NASAPolynomial(coeffs=[5.43554,0.0184606,-7.48215e-06,1.3913e-09,-9.70962e-14,7649.07,-0.991192], Tmin=(1098.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.8234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(C2CsJO)"""),
)
...
species(
    ...
    molecularWeight = (57.0712,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.30806,0.0310285,-1.27443e-05,-9.3616e-09,7.002e-12,7377.65,13.9634], Tmin=(100,'K'), Tmax=(947.811,'K')), NASAPolynomial(coeffs=[10.9726,0.00959362,-2.76892e-06,4.65962e-10,-3.30278e-14,5055.5,-30.9591], Tmin=(947.811,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.788,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'vinoxy(1351)'],
    products = ['propen2oxy(2239)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(T)(20)', 'acetyl(1377)'],
    products = ['propen2oxy(2239)'],
