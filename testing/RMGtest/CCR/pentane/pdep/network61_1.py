...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]CC([CH2])C(93)'],
    products = ['[CH2]C(C)C([CH2])C(98)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]C(C)C([CH2])C(128)'],
    products = ['[CH2]C(C)C([CH2])C(98)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH2]C(C)C(=C)C(131)'],
    products = ['[CH2]C(C)C([CH2])C(98)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction11',
    reactants = ['CH3(17)', '[CH2]C(C)C=C(109)'],
    products = ['[CH2]C(C)C([CH2])C(98)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(17)', '[CH2][CH]C([CH2])C(111)'],
    products = ['[CH2]C(C)C([CH2])C(98)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH2][C](C)C([CH2])C(132)'],
    products = ['[CH2]C(C)C([CH2])C(98)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2]C([CH2])C([CH2])C(133)'],
    products = ['[CH2]C(C)C([CH2])C(98)'],
