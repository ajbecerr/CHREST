...
species(
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41032,0.0459657,-1.41273e-05,-2.64353e-08,1.7338e-11,31959.9,21.8221], Tmin=(100,'K'), Tmax=(905.511,'K')), NASAPolynomial(coeffs=[16.7826,0.00790631,-5.21996e-07,-5.19413e-11,4.34682e-15,27952.4,-57.5712], Tmin=(905.511,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(264.869,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['H2CC(T)(1341)', '[CH]=[C]C[O](16850)'],
    products = ['[CH]=[C]CO[C]=C(15762)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=[CH](9646)', '[CH2]O[C]=C(2363)'],
    products = ['[CH]=[C]CO[C]=C(15762)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[C]=[C]CO[C]=C(17233)'],
    products = ['[CH]=[C]CO[C]=C(15762)'],
    transitionState = 'TS4',
...
reaction(
    ...
    products = ['[CH]=[C]CO[C]=C(15762)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(11.6997,'m^3/(mol*s)'), n=2.021, Ea=(95.228,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd;CJ]
Euclidian distance = 1.4142135623730951
family: R_Addition_MultipleBond
Ea raised from 90.2 to 95.2 kJ/mol to match endothermicity of reaction."""),
)
