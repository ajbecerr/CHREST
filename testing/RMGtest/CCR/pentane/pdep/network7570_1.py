...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.29601,0.0466158,1.77771e-05,-1.35466e-07,1.29027e-10,41666.9,21.6622], Tmin=(100,'K'), Tmax=(424.354,'K')), NASAPolynomial(coeffs=[4.23111,0.0428158,-1.9834e-05,3.81127e-09,-2.67506e-13,41372.6,12.4533], Tmin=(424.354,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(346.009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJ2_triplet)"""),
)

species(
    label = 'CCC1CCO1(28807)',
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29064,0.0521635,-2.56897e-05,3.1484e-09,8.85141e-13,-24634.4,25.3748], Tmin=(100,'K'), Tmax=(1253.46,'K')), NASAPolynomial(coeffs=[10.7449,0.0315783,-1.25258e-05,2.24746e-09,-1.51885e-13,-27757.4,-25.3759], Tmin=(1253.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-205.683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26603,0.0556179,-3.44445e-05,1.09169e-08,-1.43129e-12,-25441,24.407], Tmin=(100,'K'), Tmax=(1707.68,'K')), NASAPolynomial(coeffs=[12.2715,0.029839,-1.18007e-05,2.07688e-09,-1.37122e-13,-29199.7,-34.5772], Tmin=(1707.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-212.375,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CCC=CC[O](29050)',
    structure = SMILES('CCC=CC[O]'),
    E0 = (20.022,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,190.718,190.719,2193.22],'cm^-1')),
        HinderedRotor(inertia=(0.00463453,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240738,'amu*angstrom^2'), symmetry=1, barrier=(6.21373,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.240734,'amu*angstrom^2'), symmetry=1, barrier=(6.21373,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0978,0.0440769,-1.88471e-05,2.6914e-09,1.0139e-14,2474.46,23.345], Tmin=(100,'K'), Tmax=(2012.63,'K')), NASAPolynomial(coeffs=[15.4458,0.0251908,-1.04673e-05,1.80233e-09,-1.13781e-13,-4446.31,-54.2329], Tmin=(2012.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(20.022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CCOJ)"""),
)
...
species(
    label = 'CC[CH][CH]C[O](29051)',
    structure = SMILES('CC[CH][CH]C[O]'),
    E0 = (292.154,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,180,1720.05,1720.08,1720.13],'cm^-1')),
        HinderedRotor(inertia=(0.195366,'amu*angstrom^2'), symmetry=1, barrier=(4.49184,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195419,'amu*angstrom^2'), symmetry=1, barrier=(4.49307,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00213946,'amu*angstrom^2'), symmetry=1, barrier=(4.49212,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.195429,'amu*angstrom^2'), symmetry=1, barrier=(4.49329,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84425,0.0544235,-6.36622e-05,6.26004e-08,-2.58329e-11,35208.8,28.209], Tmin=(100,'K'), Tmax=(808.658,'K')), NASAPolynomial(coeffs=[-0.0559575,0.0479675,-2.22763e-05,4.23518e-09,-2.9317e-13,36034.5,40.1782], Tmin=(808.658,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(292.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJCC) + radical(CCJCO)"""),
)
...
species(
    label = '[CH2]C[CH]CC[O](29052)',
    structure = SMILES('[CH2]C[CH]CC[O]'),
    E0 = (297.498,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,180,1937.93,1937.95,1937.97],'cm^-1')),
        HinderedRotor(inertia=(0.102634,'amu*angstrom^2'), symmetry=1, barrier=(2.35976,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102664,'amu*angstrom^2'), symmetry=1, barrier=(2.36044,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10266,'amu*angstrom^2'), symmetry=1, barrier=(2.36036,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.102673,'amu*angstrom^2'), symmetry=1, barrier=(2.36065,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67837,0.0604796,-8.31428e-05,8.48617e-08,-3.43111e-11,35855.2,28.0937], Tmin=(100,'K'), Tmax=(829.866,'K')), NASAPolynomial(coeffs=[-0.753998,0.0498392,-2.34859e-05,4.4622e-09,-3.07434e-13,37029,44.0148], Tmin=(829.866,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(297.498,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJCC) + radical(RCCJ)"""),
)

species(
    label = 'CCC[CH]C[O](29024)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.96741,0.0496375,-2.4542e-05,5.39303e-09,-4.5532e-13,11817.7,25.1854], Tmin=(100,'K'), Tmax=(2712.53,'K')), NASAPolynomial(coeffs=[22.264,0.019706,-7.9895e-06,1.3247e-09,-8.03472e-14,807.084,-92.9869], Tmin=(2712.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.6954,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = 'C[CH]CCC[O](29053)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62953,0.0589602,-6.64069e-05,6.2868e-08,-2.55234e-11,11172.6,26.6552], Tmin=(100,'K'), Tmax=(804.139,'K')), NASAPolynomial(coeffs=[0.397757,0.0504419,-2.31984e-05,4.39771e-09,-3.04227e-13,11844.2,35.2735], Tmin=(804.139,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.2397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJC)"""),
)

species(
    label = 'CC[CH]C[CH]O(29054)',
    structure = SMILES('CC[CH]C[CH]O'),
    E0 = (46.8444,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07371,0.0704231,-8.84788e-05,7.52352e-08,-2.67145e-11,5733.6,27.1693], Tmin=(100,'K'), Tmax=(822.809,'K')), NASAPolynomial(coeffs=[4.60821,0.0427897,-1.90503e-05,3.54543e-09,-2.42244e-13,5505.73,12.9565], Tmin=(822.809,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(46.8444,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCsJOH)"""),
)

species(
    label = 'CCCC[CH][O](1395)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20782,0.0668875,-7.57509e-05,6.29869e-08,-2.32054e-11,9487.51,24.9861], Tmin=(100,'K'), Tmax=(767.663,'K')), NASAPolynomial(coeffs=[4.00982,0.0455652,-2.09524e-05,3.99082e-09,-2.77684e-13,9255.38,13.499], Tmin=(767.663,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(78.0912,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]CCCC[O](29055)',
    structure = SMILES('[CH2]CCCC[O]'),
    E0 = (103.04,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3000,3100,440,815,1455,1000,270.966,270.972,1581.59,1581.59],'cm^-1')),
        HinderedRotor(inertia=(0.00229599,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0955958,'amu*angstrom^2'), symmetry=1, barrier=(4.98062,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0955923,'amu*angstrom^2'), symmetry=1, barrier=(4.9806,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0955917,'amu*angstrom^2'), symmetry=1, barrier=(4.98058,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46221,0.0488931,-2.37785e-05,4.99973e-09,-3.99888e-13,12431.2,22.6168], Tmin=(100,'K'), Tmax=(2806.71,'K')), NASAPolynomial(coeffs=[20.6575,0.0229616,-9.91963e-06,1.70784e-09,-1.06668e-13,2217.59,-83.9424], Tmin=(2806.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(103.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(RCCJ)"""),
)

species(
    label = 'CC[CH][CH]CO(29056)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69861,0.0543547,-4.01641e-05,2.07317e-08,-5.3971e-12,8071.52,27.8878], Tmin=(100,'K'), Tmax=(836.198,'K')), NASAPolynomial(coeffs=[4.2184,0.0423012,-1.85421e-05,3.49336e-09,-2.43319e-13,7650.11,16.182], Tmin=(836.198,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(66.4486,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCJCO)"""),
)

species(
    label = 'C[CH][CH]CCO(28728)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.39271,0.0424972,-1.74238e-05,2.72258e-09,-1.27071e-13,7326.03,21.8304], Tmin=(100,'K'), Tmax=(2935.98,'K')), NASAPolynomial(coeffs=[44.866,-0.00361851,8.29644e-07,-2.17099e-10,2.06297e-14,-21504.1,-230.547], Tmin=(2935.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.9928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC)"""),
)

species(
    label = '[CH2]C[CH]CCO(29057)',
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38534,0.062345,-6.74481e-05,5.48888e-08,-1.99021e-11,8724.2,28.2893], Tmin=(100,'K'), Tmax=(786.374,'K')), NASAPolynomial(coeffs=[3.75593,0.0437459,-1.94942e-05,3.65759e-09,-2.52249e-13,8553.6,18.7082], Tmin=(786.374,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(71.7929,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C[O](1358)', '[CH]CC(26)'],
    products = ['CC[CH]CC[O](3308)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['C2H5(14)', '[CH]CC[O](28985)'],
    products = ['CC[CH]CC[O](3308)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][O](3109)', 'butene1(35)'],
    products = ['CC[CH]CC[O](3308)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', 'CC[CH][CH]C[O](29051)'],
    products = ['CC[CH]CC[O](3308)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH3(17)', '[CH2][CH]CC[O](1561)'],
    products = ['CC[CH]CC[O](3308)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', 'C[CH][CH]CC[O](1619)'],
    products = ['CC[CH]CC[O](3308)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'CC[CH]C[CH][O](1589)'],
    products = ['CC[CH]CC[O](3308)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH2]C[CH]CC[O](29052)'],
    products = ['CC[CH]CC[O](3308)'],
