...
species(
    label = '[CH2]C(C)[CH]C[CH]C(C)O[O](8832)',
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.939312,0.11551,-0.000124213,8.29168e-08,-2.37923e-11,48997.4,46.5736], Tmin=(100,'K'), Tmax=(829.445,'K')), NASAPolynomial(coeffs=[10.1511,0.0620249,-2.7487e-05,5.1711e-09,-3.58699e-13,47157.6,-4.85703], Tmin=(829.445,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(405.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(CCJCOOH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][CH]C(C)CC(C)[CH]O[O](8833)',
    structure = SMILES('[CH2][CH]C(C)CC(C)[CH]O[O]'),
    E0 = (404.587,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.780007,0.113111,-0.000117189,7.65077e-08,-2.19205e-11,48825.6,43.9222], Tmin=(100,'K'), Tmax=(822.404,'K')), NASAPolynomial(coeffs=[9.06383,0.0652323,-2.98617e-05,5.71701e-09,-4.00982e-13,47206.5,-1.64386], Tmin=(822.404,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(404.587,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(CCsJOOH) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH]C(C)C[CH]C(C)[O](8834)',
    structure = SMILES('[CH2][CH]C(C)C[CH]C(C)[O]'),
    E0 = (415.809,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.346908,0.0922929,-6.49329e-05,2.38212e-08,-3.64659e-12,50168.9,42.9069], Tmin=(100,'K'), Tmax=(1481.07,'K')), NASAPolynomial(coeffs=[15.9795,0.0481992,-2.02754e-05,3.71962e-09,-2.53497e-13,45332.8,-42.2709], Tmin=(1481.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(415.809,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO) + radical(Cs_S) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH]C(C)C[C]C(C)O[O](8835)',
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.832712,0.113581,-0.00011848,7.33451e-08,-1.94196e-11,79219.2,43.8011], Tmin=(100,'K'), Tmax=(894.171,'K')), NASAPolynomial(coeffs=[11.349,0.0590873,-2.70672e-05,5.19138e-09,-3.6483e-13,77040.6,-13.6062], Tmin=(894.171,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(657.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][C]C(C)C[CH]C(C)O[O](8836)',
    ...
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.05004,0.11748,-0.000125478,7.77721e-08,-2.02815e-11,79934.1,44.3266], Tmin=(100,'K'), Tmax=(914.199,'K')), NASAPolynomial(coeffs=[12.8789,0.0565346,-2.54789e-05,4.84794e-09,-3.39154e-13,77387.4,-21.6227], Tmin=(914.199,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(663.144,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]C(C)C[CH]C(C)O[O](8837)',
    structure = SMILES('[CH][CH]C(C)C[CH]C(C)O[O]'),
    E0 = (652.439,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.891529,0.115417,-0.00012581,8.26938e-08,-2.32576e-11,78639.6,45.6296], Tmin=(100,'K'), Tmax=(845.33,'K')), NASAPolynomial(coeffs=[10.7939,0.060123,-2.76934e-05,5.31411e-09,-3.7313e-13,76664,-8.78223], Tmin=(845.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(652.439,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(Cs_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][CH]C(C)CC1OOC1C(8838)',
    structure = SMILES('[CH2][CH]C(C)CC1OOC1C'),
    E0 = (213.763,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.311945,0.0955992,-6.36931e-05,2.17385e-08,-3.12389e-12,25863.3,36.6904], Tmin=(100,'K'), Tmax=(1533.73,'K')), NASAPolynomial(coeffs=[15.2927,0.0549021,-2.38912e-05,4.43787e-09,-3.0387e-13,21076.6,-45.2671], Tmin=(1533.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(213.763,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(Cs_S) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH]C(C)CC1OC1C(8840)',
    structure = SMILES('[CH2][CH]C(C)CC1OC1C'),
    E0 = (162.467,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.441848,0.086964,-4.09021e-05,-8.1394e-09,1.02603e-11,19709.9,36.9477], Tmin=(100,'K'), Tmax=(945.05,'K')), NASAPolynomial(coeffs=[15.4698,0.0452585,-1.54053e-05,2.58459e-09,-1.71445e-13,15557.3,-44.9756], Tmin=(945.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.467,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Cs_S) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C=C(C)CCC(C)O[O](8841)',
    structure = SMILES('C=C[C](C)CCC(C)O[O]'),
    E0 = (63.4054,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.763473,0.101921,-7.72471e-05,3.16765e-08,-5.45794e-12,7799.41,38.0382], Tmin=(100,'K'), Tmax=(1334.9,'K')), NASAPolynomial(coeffs=[15.7032,0.0525796,-2.1803e-05,3.98716e-09,-2.72314e-13,3403.1,-46.1608], Tmin=(1334.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.4054,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Allyl_T)"""),
)

species(
    label = '[CH2][CH]C(C)CC=C(C)OO(8842)',
    structure = SMILES('[CH2][CH]C(C)CC=C(C)OO'),
    E0 = (180.142,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.385805,0.103939,-8.82377e-05,4.3505e-08,-9.48574e-12,21817.8,42.5422], Tmin=(100,'K'), Tmax=(1042.7,'K')), NASAPolynomial(coeffs=[10.3603,0.0627153,-2.89337e-05,5.58809e-09,-3.94696e-13,19576.8,-9.751], Tmin=(1042.7,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(180.142,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC(C)C=CC(C)O[O](8843)',
    structure = SMILES('[CH2]CC(C)C=CC(C)O[O]'),
    E0 = (125.224,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.0604,0.103805,-7.92528e-05,3.15905e-08,-5.16579e-12,15249,43.7819], Tmin=(100,'K'), Tmax=(1425.63,'K')), NASAPolynomial(coeffs=[19.2974,0.0466844,-1.91515e-05,3.48485e-09,-2.37063e-13,9444.6,-61.6514], Tmin=(1425.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.224,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]C(C)C=CC(C)OO(8844)',
    structure = SMILES('[CH2][CH]C(C)C=CC(C)OO'),
    E0 = (167.762,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.931389,0.103833,-7.78257e-05,2.99118e-08,-4.7316e-12,20357.8,45.1126], Tmin=(100,'K'), Tmax=(1456.35,'K')), NASAPolynomial(coeffs=[19.1405,0.0487044,-2.10445e-05,3.9194e-09,-2.69707e-13,14511.5,-59.2682], Tmin=(1456.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(167.762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC(C)CC=C(C)O[O](7559)',
    structure = SMILES('[CH2]CC(C)CC=C(C)O[O]'),
    E0 = (137.605,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.464687,0.103438,-8.84578e-05,4.40683e-08,-9.57614e-12,16706.4,41.0223], Tmin=(100,'K'), Tmax=(1058.17,'K')), NASAPolynomial(coeffs=[11.1012,0.059718,-2.64819e-05,5.02222e-09,-3.51192e-13,14258.7,-15.4303], Tmin=(1058.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(137.605,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(ROOJ) + radical(RCCJ)"""),
)
...
species(
    ...
    E0 = (326.382,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][CH][C](C)C[CH]C(C)O[O](8845)',
    structure = SMILES('[CH2][CH][C](C)C[CH]C(C)O[O]'),
    E0 = (594.893,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,180,400,1117.41,3200],'cm^-1')),
        HinderedRotor(inertia=(0.0414172,'amu*angstrom^2'), symmetry=1, barrier=(3.80905,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0414172,'amu*angstrom^2'), symmetry=1, barrier=(3.80905,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0414172,'amu*angstrom^2'), symmetry=1, barrier=(3.80905,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0414172,'amu*angstrom^2'), symmetry=1, barrier=(3.80905,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0414172,'amu*angstrom^2'), symmetry=1, barrier=(3.80905,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.08404,0.125304,-0.000182661,1.65689e-07,-6.03603e-11,71719.2,48.2093], Tmin=(100,'K'), Tmax=(823.914,'K')), NASAPolynomial(coeffs=[5.27109,0.0686429,-3.2519e-05,6.18444e-09,-4.26135e-13,71547.9,24.0963], Tmin=(823.914,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(594.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Tertalkyl) + radical(CCJCOOH) + radical(Cs_S) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH]C(C)C[CH][C](C)O[O](8846)',
    structure = SMILES('[CH2][CH]C(C)C[CH][C](C)O[O]'),
    E0 = (596.37,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.984753,0.11978,-0.000158409,1.34997e-07,-4.80994e-11,71896.4,47.0154], Tmin=(100,'K'), Tmax=(789.093,'K')), NASAPolynomial(coeffs=[6.9679,0.0661138,-3.10112e-05,5.9192e-09,-4.1079e-13,71057.1,13.1664], Tmin=(789.093,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(596.37,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOOH) + radical(CCJCOOH) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]C(C)[CH][CH]C(C)O[O](8847)',
    structure = SMILES('[CH2][CH]C(C)[CH][CH]C(C)O[O]'),
    E0 = (604.013,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,3000,3100,440,815,1455,1000,233.392,849.723,1228.78,1867.14],'cm^-1')),
        HinderedRotor(inertia=(0.12048,'amu*angstrom^2'), symmetry=1, barrier=(3.50157,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12048,'amu*angstrom^2'), symmetry=1, barrier=(3.50157,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12048,'amu*angstrom^2'), symmetry=1, barrier=(3.50157,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12048,'amu*angstrom^2'), symmetry=1, barrier=(3.50157,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12048,'amu*angstrom^2'), symmetry=1, barrier=(3.50157,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0362123,0.10127,-7.11652e-05,-2.69646e-08,5.74031e-11,72774.7,45.7966], Tmin=(100,'K'), Tmax=(512.426,'K')), NASAPolynomial(coeffs=[7.57183,0.064932,-3.06162e-05,5.91382e-09,-4.15697e-13,71707.2,11.5994], Tmin=(512.426,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(604.013,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(CCJCOOH) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]C([CH2])C[CH]C(C)O[O](8848)',
    structure = SMILES('[CH2][CH]C([CH2])C[CH]C(C)O[O]'),
    E0 = (614.553,'kJ/mol'),
    modes = [
...
species(
    ...
    molecularWeight = (141.188,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.945224,0.116778,-0.000133492,9.28585e-08,-2.7523e-11,75152.6,48.597], Tmin=(100,'K'), Tmax=(806.398,'K')), NASAPolynomial(coeffs=[10.5345,0.0598318,-2.75601e-05,5.27739e-09,-3.69597e-13,73301.2,-4.31505], Tmin=(806.398,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(623.433,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(523.812,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(Cs_S) + radical(CJCOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C[C](C)C[CH]C(C)O[O](8850)',
    structure = SMILES('[CH2]C[C](C)C[CH]C(C)O[O]'),
    E0 = (400.351,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.24203,0.12609,-0.000169515,1.44845e-07,-5.11421e-11,48329.5,46.2231], Tmin=(100,'K'), Tmax=(806.302,'K')), NASAPolynomial(coeffs=[7.23954,0.0679389,-3.14313e-05,5.94877e-09,-4.10266e-13,47484.3,10.3707], Tmin=(806.302,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(400.351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Tertalkyl) + radical(CCJCOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]C(C)CC[C](C)O[O](8851)',
    structure = SMILES('[CH2][CH]C(C)CC[C](C)O[O]'),
    E0 = (395.955,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0786618,0.100931,-5.73712e-05,-5.553e-08,7.8261e-11,47748.8,41.109], Tmin=(100,'K'), Tmax=(499.737,'K')), NASAPolynomial(coeffs=[7.10744,0.0685564,-3.18925e-05,6.1239e-09,-4.29092e-13,46748.1,9.09074], Tmin=(499.737,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(395.955,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOOH) + radical(Cs_S) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH]C(C)C[CH][C](C)OO(8852)',
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.303896,0.109115,-8.38893e-05,-9.32513e-09,4.54924e-11,53585.6,43.9836], Tmin=(100,'K'), Tmax=(524.125,'K')), NASAPolynomial(coeffs=[7.8371,0.0691322,-3.28451e-05,6.36985e-09,-4.49028e-13,52428,7.06537], Tmin=(524.125,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(444.365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH) + radical(CCJCOOH) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC(C)[CH][CH]C(C)O[O](8853)',
    structure = SMILES('[CH2]CC(C)[CH][CH]C(C)O[O]'),
    E0 = (409.471,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.751596,0.112471,-0.000114421,7.20491e-08,-1.98523e-11,49412.1,45.912], Tmin=(100,'K'), Tmax=(853.154,'K')), NASAPolynomial(coeffs=[9.55704,0.0641413,-2.94514e-05,5.65492e-09,-3.9757e-13,47653.1,-2.18446], Tmin=(853.154,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(409.471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(CCJCOOH) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH]C(C)CCC([CH2])O[O](8854)',
    structure = SMILES('[CH2][CH]C(C)CCC([CH2])O[O]'),
    E0 = (423.018,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.817471,0.112929,-0.000111092,6.49737e-08,-1.63923e-11,51044.9,45.835], Tmin=(100,'K'), Tmax=(931.11,'K')), NASAPolynomial(coeffs=[11.2233,0.061203,-2.77621e-05,5.31044e-09,-3.72935e-13,48802.6,-11.3953], Tmin=(931.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(423.018,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(CJCOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH][C](C)CCC(C)O[O](8855)',
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.0662,0.122749,-0.000164832,1.44e-07,-5.21047e-11,47616.3,45.842], Tmin=(100,'K'), Tmax=(802.592,'K')), NASAPolynomial(coeffs=[5.82292,0.0702848,-3.28941e-05,6.26148e-09,-4.33324e-13,47094.4,17.7587], Tmin=(802.592,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(394.478,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Tertalkyl) + radical(Cs_S) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH]C([CH2])CCC(C)O[O](8856)',
    structure = SMILES('[CH2][CH]C([CH2])CCC(C)O[O]'),
    E0 = (414.138,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.879942,0.113649,-0.000116711,7.32212e-08,-1.97518e-11,49979.5,45.8429], Tmin=(100,'K'), Tmax=(878.359,'K')), NASAPolynomial(coeffs=[10.6675,0.0610618,-2.69055e-05,5.05947e-09,-3.51353e-13,47951,-8.36904], Tmin=(878.359,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(414.138,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH]C(C)C[CH]C([CH2])OO(8857)',
    structure = SMILES('[CH2][CH]C(C)C[CH]C([CH2])OO'),
    E0 = (471.428,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.998571,0.117816,-0.000119494,7.08586e-08,-1.80015e-11,56873.1,48.0345], Tmin=(100,'K'), Tmax=(927.332,'K')), NASAPolynomial(coeffs=[12.0254,0.0616387,-2.86265e-05,5.53419e-09,-3.90942e-13,54457.5,-13.8164], Tmin=(927.332,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(471.428,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(Cs_S) + radical(CJCOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH]C(C)[CH][CH]C(C)OO(8858)',
    structure = SMILES('[CH2][CH]C(C)[CH][CH]C(C)OO'),
    E0 = (452.008,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.753924,0.113925,-0.000117515,7.58142e-08,-2.16538e-11,54527,47.7235], Tmin=(100,'K'), Tmax=(820.17,'K')), NASAPolynomial(coeffs=[8.84571,0.067108,-3.18945e-05,6.22038e-09,-4.41146e-13,52952.3,3.3136], Tmin=(820.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(452.008,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(CCJCOOH) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC(C)C[CH][C](C)O[O](8859)',
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.436274,0.110066,-9.50588e-05,2.02693e-08,2.09625e-11,48476.5,42.6141], Tmin=(100,'K'), Tmax=(560.334,'K')), NASAPolynomial(coeffs=[8.42276,0.0663949,-3.0541e-05,5.83837e-09,-4.08343e-13,47176.5,2.26432], Tmin=(560.334,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(401.828,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOOH) + radical(CCJCOOH) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH][C](C)C[CH]C(C)OO(8860)',
    structure = SMILES('[CH2][CH][C](C)C[CH]C(C)OO'),
    E0 = (442.889,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.29738,0.128285,-0.000175821,1.53806e-07,-5.57013e-11,53446.6,48.2177], Tmin=(100,'K'), Tmax=(792.062,'K')), NASAPolynomial(coeffs=[6.67637,0.070629,-3.37041e-05,6.47208e-09,-4.50222e-13,52728.9,15.0508], Tmin=(792.062,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(442.889,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(CCJCOOH) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC(C)C[CH]C([CH2])O[O](8861)',
    structure = SMILES('[CH2]CC(C)C[CH]C([CH2])O[O]'),
    E0 = (428.891,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.04495,0.11695,-0.00011852,6.99704e-08,-1.75052e-11,51760.3,46.3969], Tmin=(100,'K'), Tmax=(947.182,'K')), NASAPolynomial(coeffs=[12.7635,0.0586343,-2.61653e-05,4.96512e-09,-3.47112e-13,49144.6,-19.4712], Tmin=(947.182,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(428.891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CJCOOH) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH]C([CH2])C[CH]C(C)OO(8862)',
    structure = SMILES('[CH2][CH]C([CH2])C[CH]C(C)OO'),
    E0 = (462.548,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.06331,0.118562,-0.000125202,7.92205e-08,-2.14099e-11,55807.8,48.0506], Tmin=(100,'K'), Tmax=(878.464,'K')), NASAPolynomial(coeffs=[11.4692,0.0614989,-2.7771e-05,5.28354e-09,-3.69391e-13,53605.8,-10.7882], Tmin=(878.464,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(462.548,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(544.598,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(Cs_S) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    products = ['C=CC(C)C[CH]C(C)O[O](7547)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', '[CH2][CH]CC[CH]C(C)O[O](7448)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(S)(11)', '[CH2][CH]C(C)C[CH]CO[O](1333)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(143764,'m^3/(mol*s)'), n=0.444, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [carbene;R_H]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    products = ['[CH2]C(C)[CH]C[CH]C(C)O[O](8832)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][CH]C(C)CC(C)[CH]O[O](8833)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    products = ['O2(S)(666)', 'C=CC(C)C[CH][CH]C(3837)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction10',
    reactants = ['O(4)', '[CH2][CH]C(C)C[CH]C(C)[O](8834)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH][CH2](502)', 'C[CH]C[CH]C(C)O[O](7650)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH]O[O](57)', '[CH]CC(C)[CH][CH2](3852)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]C(C)O[O](668)', '[CH2][CH]C([CH2])C(111)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH2][CH]C(C)C[C]C(C)O[O](8835)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2][C]C(C)C[CH]C(C)O[O](8836)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH][CH]C(C)C[CH]C(C)O[O](8837)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    products = ['[CH2][CH]C(C)CC1OOC1C(8838)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    products = ['O(4)', '[CH2][CH]C(C)CC1OC1C(8840)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    products = ['HO2(9)', '[CH2][CH]C(C)C[CH]C=C(4544)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    products = ['[CH2]C=C(C)CCC(C)O[O](8841)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    products = ['[CH2][CH]C(C)CC=C(C)OO(8842)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    products = ['[CH2]CC(C)C=CC(C)O[O](8843)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    products = ['[CH2][CH]C(C)C=CC(C)OO(8844)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    products = ['[CH2]CC(C)CC=C(C)O[O](7559)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', 'C=C[C](C)C[CH]C(C)O[O](8323)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', 'C=CC(C)C[CH][C](C)O[O](8335)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', 'C=CC(C)[CH][CH]C(C)O[O](8326)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH3(17)', '[CH2]C=CC[CH]C(C)O[O](8226)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CH3(17)', '[CH2][CH]C(C)CC=CO[O](4708)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction33',
    reactants = ['O2(2)', 'C=CC(C)C[CH][CH]C(3837)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    transitionState = 'TS33',
    kinetics = Arrhenius(A=(9.03779e-05,'m^3/(mol*s)'), n=3.085, Ea=(148.802,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Cds-CsH_Cds;O2b] + [Cds-CsH_Cds-CsH;OJ] for rate rule [Cds-CsH_Cds-CsH;O2b]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 146.7 to 148.8 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction34',
    reactants = ['O2(2)', '[CH2][CH]C(C)C[CH][CH]C(3839)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction36',
    reactants = ['CH3(17)', '[CH2][CH][CH]C[CH]C(C)O[O](8229)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(3)', '[CH2][CH][C](C)C[CH]C(C)O[O](8845)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction38',
    reactants = ['CH3(17)', '[CH2][CH]C(C)C[CH][CH]O[O](4712)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction39',
    reactants = ['H(3)', '[CH2][CH]C(C)C[CH][C](C)O[O](8846)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction40',
    reactants = ['H(3)', '[CH2][CH]C(C)[CH][CH]C(C)O[O](8847)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction41',
    reactants = ['H(3)', '[CH2][CH]C([CH2])C[CH]C(C)O[O](8848)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction42',
    reactants = ['H(3)', '[CH2][CH]C(C)C[CH]C([CH2])O[O](8849)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    products = ['[CH2]C[C](C)C[CH]C(C)O[O](8850)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    products = ['[CH2][CH]C(C)CC[C](C)O[O](8851)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2][CH]C(C)C[CH][C](C)OO(8852)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH2]CC(C)[CH][CH]C(C)O[O](8853)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]CC([CH2])C[CH]C(C)O[O](7846)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH2][CH]C(C)CCC([CH2])O[O](8854)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    products = ['[CH2][CH][C](C)CCC(C)O[O](8855)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    products = ['C[CH][C](C)C[CH]C(C)O[O](8500)'],
...
reaction(
    label = 'reaction52',
    reactants = ['[CH2][CH]C([CH2])CCC(C)O[O](8856)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction53',
    reactants = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    products = ['C[CH]C(C)[CH][CH]C(C)O[O](8502)'],
...
reaction(
    label = 'reaction54',
    reactants = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    products = ['[CH2][CH]C(C)C[CH]C([CH2])OO(8857)'],
...
reaction(
    label = 'reaction55',
    reactants = ['[CH2][CH]C(C)[CH][CH]C(C)OO(8858)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction56',
    reactants = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    products = ['[CH2]CC(C)C[CH][C](C)O[O](8859)'],
...
reaction(
    label = 'reaction57',
    reactants = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
    products = ['C[CH]C(C)C[CH][C](C)O[O](8501)'],
...
reaction(
    label = 'reaction58',
    reactants = ['[CH2][CH][C](C)C[CH]C(C)OO(8860)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction59',
    reactants = ['[CH2]CC(C)C[CH]C([CH2])O[O](8861)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction60',
    reactants = ['[CH2]C([CH]CC(C)[CH]C)O[O](8503)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
...
reaction(
    label = 'reaction61',
    reactants = ['[CH2][CH]C([CH2])C[CH]C(C)OO(8862)'],
    products = ['[CH2][CH]C(C)C[CH]C(C)O[O](7551)'],
