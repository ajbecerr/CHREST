species(
    label = 'C[CH]C(C)C(C)[O](3171)',
    structure = SMILES('C[CH]C(C)C(C)[O]'),
    E0 = (58.2209,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2762.5,2775,2787.5,2800,2812.5,2825,2837.5,2850,1350,1380,1410,1440,1470,1500,700,750,800,1000,1050,1100,1350,1375,1400,900,1000,1100,3025,407.5,1350,352.5,200,800,1600],'cm^-1')),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.441886,0.0700285,-4.36411e-05,1.35777e-08,-1.71781e-12,7137.09,31.3298], Tmin=(100,'K'), Tmax=(1795.49,'K')), NASAPolynomial(coeffs=[16.6978,0.0338135,-1.3386e-05,2.34397e-09,-1.53642e-13,1299.65,-56.6096], Tmin=(1795.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(58.2209,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(Cs_S)"""),
)
...
species(
    label = 'C[CH]CC(C)[O](3128)',
    structure = SMILES('C[CH]CC(C)[O]'),
    E0 = (84.2524,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,233.151,233.151,1652.86],'cm^-1')),
        HinderedRotor(inertia=(0.00310119,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00310119,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20998,'amu*angstrom^2'), symmetry=1, barrier=(8.09992,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0031011,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56731,0.0539585,-3.15906e-05,9.53096e-09,-1.22414e-12,10219.6,25.4706], Tmin=(100,'K'), Tmax=(1654.08,'K')), NASAPolynomial(coeffs=[9.44507,0.034908,-1.43147e-05,2.56802e-09,-1.71754e-13,7613.55,-16.4995], Tmin=(1654.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(84.2524,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJC)"""),
)
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.490214,0.0658285,-2.44399e-05,-1.08305e-08,7.69512e-12,7380.51,30.3826], Tmin=(100,'K'), Tmax=(1056.4,'K')), NASAPolynomial(coeffs=[14.066,0.0365618,-1.43168e-05,2.6179e-09,-1.81952e-13,3277.01,-41.7038], Tmin=(1056.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.2336,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO)"""),
)
...
species(
    label = '[CH]C(C)C(C)[O](3239)',
    structure = SMILES('[CH]C(C)C(C)[O]'),
    E0 = (332.327,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.964274,0.0584185,-3.55066e-05,5.92373e-09,1.54752e-12,40086.1,25.6374], Tmin=(100,'K'), Tmax=(1086.85,'K')), NASAPolynomial(coeffs=[13.1549,0.026924,-1.04943e-05,1.90103e-09,-1.30959e-13,36646.5,-37.8236], Tmin=(1086.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.327,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.119428,0.0753777,-5.618e-05,2.17041e-08,-3.39896e-12,37660.1,29.8269], Tmin=(100,'K'), Tmax=(1503.73,'K')), NASAPolynomial(coeffs=[16.7857,0.0310447,-1.19572e-05,2.09843e-09,-1.39471e-13,32647.7,-57.3776], Tmin=(1503.73,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(311.894,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.252739,0.0725886,-4.91579e-05,1.70455e-08,-2.40573e-12,-31658.1,29.3783], Tmin=(100,'K'), Tmax=(1640.95,'K')), NASAPolynomial(coeffs=[16.6379,0.032648,-1.26481e-05,2.2127e-09,-1.45953e-13,-37035.6,-57.7859], Tmin=(1640.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-264.409,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH)"""),
)

species(
    label = 'CCC(C)C(C)=O(3285)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.844701,0.0670135,-4.01541e-05,1.20884e-08,-1.50838e-12,-37351.8,26.6576], Tmin=(100,'K'), Tmax=(1756.24,'K')), NASAPolynomial(coeffs=[13.4249,0.0383605,-1.56814e-05,2.79846e-09,-1.85947e-13,-41770.6,-41.1195], Tmin=(1756.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-311.515,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs)"""),
)

species(
    label = 'C=CC(C)C(C)O(3175)',
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.453644,0.0668238,-2.74215e-05,-8.62005e-09,7.21713e-12,-29272.2,29.4105], Tmin=(100,'K'), Tmax=(1047.14,'K')), NASAPolynomial(coeffs=[14.3469,0.035506,-1.37205e-05,2.49595e-09,-1.73193e-13,-33374.5,-43.9508], Tmin=(1047.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-244.525,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    E0 = (-34.0483,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2762.5,2775,2787.5,2800,2812.5,2825,2837.5,2850,1350,1380,1410,1440,1470,1500,700,750,800,1000,1050,1100,1350,1375,1400,900,1000,1100,350,440,435,1725,3010,987.5,1337.5,450,1655,271.133,271.133],'cm^-1')),
        HinderedRotor(inertia=(0.00229659,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.205408,'amu*angstrom^2'), symmetry=1, barrier=(10.7917,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.21244,'amu*angstrom^2'), symmetry=1, barrier=(10.7926,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.207353,'amu*angstrom^2'), symmetry=1, barrier=(10.7889,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1509,'amu'),
...
species(
    ...
    E0 = (-111.613,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2762.5,2775,2787.5,2800,2812.5,2825,2837.5,2850,1350,1380,1410,1440,1470,1500,700,750,800,1000,1050,1100,1350,1375,1400,900,1000,1100,3025,407.5,1350,352.5,375,552.5,462.5,1710,268.073,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00267866,'amu*angstrom^2'), symmetry=1, barrier=(7.31185,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143383,'amu*angstrom^2'), symmetry=1, barrier=(7.31185,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00234583,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.422407,'amu*angstrom^2'), symmetry=1, barrier=(21.5408,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.422407,'amu*angstrom^2'), symmetry=1, barrier=(21.5408,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (-14.1638,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,278.322,278.328,278.329],'cm^-1')),
        HinderedRotor(inertia=(0.00217638,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00217609,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.297137,'amu*angstrom^2'), symmetry=1, barrier=(16.3347,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.297122,'amu*angstrom^2'), symmetry=1, barrier=(16.3347,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (99.1509,'amu'),
...
species(
    ...
    E0 = (5.00671,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,2995,3025,975,1000,1300,1375,400,500,1630,1680,247.18,247.432],'cm^-1')),
        HinderedRotor(inertia=(0.00276091,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.289053,'amu*angstrom^2'), symmetry=1, barrier=(12.5174,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.287339,'amu*angstrom^2'), symmetry=1, barrier=(12.5195,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    ...
    E0 = (284.154,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,314.815,1414.18,1414.22],'cm^-1')),
        HinderedRotor(inertia=(0.00170202,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00170176,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0754159,'amu*angstrom^2'), symmetry=1, barrier=(5.29464,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0754342,'amu*angstrom^2'), symmetry=1, barrier=(5.29828,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
...
species(
    ...
    E0 = (210.795,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2762.5,2775,2787.5,2800,2812.5,2825,2837.5,2850,1350,1380,1410,1440,1470,1500,700,750,800,1000,1050,1100,1350,1375,1400,900,1000,1100,360,370,350,3025,407.5,1350,352.5,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.560166,0.0644425,-2.17111e-05,-1.13636e-08,7.22526e-12,2088.05,28.5256], Tmin=(100,'K'), Tmax=(1085.87,'K')), NASAPolynomial(coeffs=[13.3241,0.0386829,-1.54938e-05,2.84874e-09,-1.97803e-13,-1937.25,-39.8755], Tmin=(1085.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.2527,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJ(C)CO)"""),
)

species(
    label = 'C[CH]C(C)[C](C)O(3412)',
    structure = SMILES('C[CH]C(C)[C](C)O'),
    E0 = (4.48793,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.774931,0.0753015,-6.16089e-05,3.01168e-08,-6.56932e-12,652.232,29.7392], Tmin=(100,'K'), Tmax=(1040.09,'K')), NASAPolynomial(coeffs=[8.14167,0.0469703,-2.07498e-05,3.92718e-09,-2.74261e-13,-880.174,-6.09058], Tmin=(1040.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.48793,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(Cs_S)"""),
)

species(
    label = '[CH2]CC(C)C(C)[O](3293)',
    structure = SMILES('[CH2]CC(C)C(C)[O]'),
    E0 = (68.9251,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0974383,0.0741947,-5.03409e-05,1.75032e-08,-2.46948e-12,8440,31.7995], Tmin=(100,'K'), Tmax=(1650.42,'K')), NASAPolynomial(coeffs=[17.3949,0.0322718,-1.22386e-05,2.11214e-09,-1.38079e-13,2730.42,-60.3172], Tmin=(1650.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(68.9251,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJ)"""),
)

species(
    label = 'CCC(C)[C](C)[O](3288)',
    structure = SMILES('CCC(C)[C](C)[O]'),
    E0 = (40.3066,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.498986,0.0756265,-5.57863e-05,2.23444e-08,-3.78787e-12,4974.63,27.9668], Tmin=(100,'K'), Tmax=(1344.8,'K')), NASAPolynomial(coeffs=[12.1916,0.0408475,-1.69935e-05,3.11325e-09,-2.12769e-13,1829.78,-31.9073], Tmin=(1344.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(40.3066,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = '[CH2]C(CC)C(C)[O](3144)',
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3817.96,'J/mol'), sigma=(6.83058,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=596.36 K, Pc=27.18 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0767894,0.0753319,-5.37829e-05,2.05281e-08,-3.20861e-12,8420.41,31.8569], Tmin=(100,'K'), Tmax=(1501.78,'K')), NASAPolynomial(coeffs=[15.7192,0.0336677,-1.21678e-05,2.05424e-09,-1.33259e-13,3722.15,-49.9698], Tmin=(1501.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(68.7611,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(Isobutyl)"""),
)

species(
    label = 'C[CH][C](C)C(C)O(3413)',
    structure = SMILES('C[CH][C](C)C(C)O'),
    E0 = (-19.566,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.447401,0.0684407,-4.13557e-05,1.23556e-08,-1.4913e-12,-2217.19,31.7089], Tmin=(100,'K'), Tmax=(1887.58,'K')), NASAPolynomial(coeffs=[17.625,0.0320387,-1.24277e-05,2.13848e-09,-1.38061e-13,-8701.87,-62.0754], Tmin=(1887.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(Cs_S)"""),
)

species(
    label = '[CH2]C(O)C(C)[CH]C(3414)',
    structure = SMILES('[CH2]C(O)C(C)[CH]C'),
    E0 = (39.4492,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.529925,0.0748399,-5.57076e-05,2.23868e-08,-3.79238e-12,4870.48,31.8136], Tmin=(100,'K'), Tmax=(1349.43,'K')), NASAPolynomial(coeffs=[12.4138,0.039613,-1.65492e-05,3.04082e-09,-2.08201e-13,1663.27,-29.0802], Tmin=(1349.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(39.4492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(CJCO)"""),
)

species(
    label = '[CH2]C([CH]C)C(C)O(3291)',
    structure = SMILES('[CH2]C([CH]C)C(C)O'),
    E0 = (32.9424,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,180,1600],'cm^-1')),
        HinderedRotor(inertia=(0.166596,'amu*angstrom^2'), symmetry=1, barrier=(3.83037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166596,'amu*angstrom^2'), symmetry=1, barrier=(3.83037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166596,'amu*angstrom^2'), symmetry=1, barrier=(3.83037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166596,'amu*angstrom^2'), symmetry=1, barrier=(3.83037,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.166596,'amu*angstrom^2'), symmetry=1, barrier=(3.83037,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (100.159,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.686267,0.0707701,-4.76503e-05,1.68184e-08,-2.49555e-12,4102.28,32.4042], Tmin=(100,'K'), Tmax=(1509.43,'K')), NASAPolynomial(coeffs=[12.5978,0.0392044,-1.62818e-05,2.96394e-09,-2.00902e-13,506.345,-29.9665], Tmin=(1509.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(33.1065,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'C[CH]CC(C)[O](3128)'],
    products = ['C[CH]C(C)C(C)[O](3171)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', 'C[CH]C(C)C[O](3408)'],
    products = ['C[CH]C(C)C(C)[O](3171)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(143764,'m^3/(mol*s)'), n=0.444, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [carbene;R_H]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['O(4)', 'C[CH]C(C)[CH]C(1190)'],
    products = ['C[CH]C(C)C(C)[O](3171)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.15242e+13,'m^3/(mol*s)'), n=-4.75325, Ea=(276.349,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [Y_rad;O_birad] for rate rule [C_rad/H/NonDeC;O_birad]
Euclidian distance = 3.0
Multiplied by reaction path degeneracy 2.0
family: Birad_R_Recombination"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', '[CH]C(C)C(C)[O](3239)'],
    products = ['C[CH]C(C)C(C)[O](3171)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'C[C]C(C)C(C)[O](3410)'],
    products = ['C[CH]C(C)C(C)[O](3171)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'CC=C(C)C(C)[O](2025)'],
    products = ['C[CH]C(C)C(C)[O](3171)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C[CH]C(C)C(C)=O(2023)'],
    products = ['C[CH]C(C)C(C)[O](3171)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'C=CC(C)C(C)[O](1521)'],
    products = ['C[CH]C(C)C(C)[O](3171)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C[CH][O](1382)', 'butene2t(396)'],
    products = ['C[CH]C(C)C(C)[O](3171)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(17)', 'CC=CC(C)[O](1676)'],
    products = ['C[CH]C(C)C(C)[O](3171)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(17)', 'C[CH]C(C)C=O(2029)'],
    products = ['C[CH]C(C)C(C)[O](3171)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH3(17)', 'C[CH][CH]C(C)[O](1688)'],
    products = ['C[CH]C(C)C(C)[O](3171)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', 'C[CH][C](C)C(C)[O](2036)'],
    products = ['C[CH]C(C)C(C)[O](3171)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH3(17)', 'C[CH]C(C)[CH][O](2018)'],
    products = ['C[CH]C(C)C(C)[O](3171)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', 'C[CH]C(C)[C](C)[O](2034)'],
    products = ['C[CH]C(C)C(C)[O](3171)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2]C([CH]C)C(C)[O](1779)'],
    products = ['C[CH]C(C)C(C)[O](3171)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2]C([O])C(C)[CH]C(1512)'],
    products = ['C[CH]C(C)C(C)[O](3171)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH2][CH]C(C)C(C)[O](2038)'],
    products = ['C[CH]C(C)C(C)[O](3171)'],
...
reaction(
    label = 'reaction34',
    reactants = ['C[CH]C(C)C(C)[O](3171)'],
    products = ['[CH2]C(O)C(C)[CH]C(3414)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]C([CH]C)C(C)O(3291)'],
    products = ['C[CH]C(C)C(C)[O](3171)'],
...
reaction(
    label = 'reaction37',
    reactants = ['C[CH]C(C)C(C)[O](3171)'],
    products = ['[CH2][CH]C(C)C(C)O(3415)'],
