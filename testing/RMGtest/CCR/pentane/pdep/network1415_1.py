...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.34966,0.0352877,7.90839e-05,-1.20116e-07,4.61011e-11,9384.2,20.6245], Tmin=(100,'K'), Tmax=(983.363,'K')), NASAPolynomial(coeffs=[14.3453,0.0396762,-1.49388e-05,2.83037e-09,-2.06982e-13,4060.25,-55.9283], Tmin=(983.363,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(77.0609,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(1,4-cyclooctadiene)"""),
)

species(
    label = 'C=C=CCCC=CC(5723)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0377659,0.0768526,-4.95131e-05,1.59877e-08,-2.0936e-12,20387.3,31.9569], Tmin=(100,'K'), Tmax=(1752.52,'K')), NASAPolynomial(coeffs=[18.281,0.0352136,-1.38737e-05,2.43032e-09,-1.59606e-13,13993,-66.2915], Tmin=(1752.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(168.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.652559,0.0571294,1.45012e-05,-5.39269e-08,2.2974e-11,49095.2,32.5358], Tmin=(100,'K'), Tmax=(1013.38,'K')), NASAPolynomial(coeffs=[14.8702,0.0391619,-1.53762e-05,2.87991e-09,-2.05429e-13,44254.6,-45.9108], Tmin=(1013.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.079,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(cyclopropane) + radical(Allyl_P)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.81877,0.0351221,4.9067e-05,-6.87194e-08,2.33987e-11,41588.6,25.1842], Tmin=(100,'K'), Tmax=(1071.54,'K')), NASAPolynomial(coeffs=[5.94172,0.0527173,-2.17394e-05,4.06198e-09,-2.84531e-13,38811.3,-3.82792], Tmin=(1071.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(345.045,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(cis-Cyclooctene) + radical(RCCJCC) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.18669,0.0687131,-1.27841e-05,-3.12859e-08,1.65061e-11,14038.7,31.3642], Tmin=(100,'K'), Tmax=(1005.34,'K')), NASAPolynomial(coeffs=[17.0021,0.0354849,-1.34528e-05,2.47699e-09,-1.75377e-13,8955.79,-58.314], Tmin=(1005.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(115.472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(465.61,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[CH]=CCCC=C[CH2](5720)'],
    products = ['C=C[CH]CC[CH]C=C(4933)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][CH]CC[CH]C=C[CH2](5725)'],
    products = ['C=C[CH]CC[CH]C=C(4933)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]C=C[CH]C[CH]C[CH2](5726)'],
    products = ['C=C[CH]CC[CH]C=C(4933)'],
...
reaction(
    label = 'reaction15',
    reactants = ['C=C[CH]CC[CH]C=C(4933)'],
    products = ['[CH2]C=CCCC1[CH]C1(5731)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]C=C(3739)', '[CH2]C=CC[CH2](507)'],
    products = ['C=C[CH]CC[CH]C=C(4933)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2]C=[C]CCC=C[CH2](5734)'],
    products = ['C=C[CH]CC[CH]C=C(4933)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C=C[CH]CC[CH]C=C(4933)'],
    products = ['[CH2]C=CC[CH]C=CC(5738)'],
...
reaction(
    label = 'reaction32',
    reactants = ['C2H3(60)', '[CH]CCC=C[CH2](4958)'],
    products = ['C=C[CH]CC[CH]C=C(4933)'],
...
reaction(
    label = 'reaction37',
    reactants = ['C=C[CH]CC[CH]C=C(4933)'],
    products = ['[CH]1[CH]CCC=CCC1(5743)'],
...
reaction(
    label = 'reaction39',
    reactants = ['H(3)', '[CH2]C=CCC=CC=C(5745)'],
    products = ['C=C[CH]CC[CH]C=C(4933)'],
