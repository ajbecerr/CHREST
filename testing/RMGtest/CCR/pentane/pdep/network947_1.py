...
species(
    label = '[C-]=[O+]C[C]C(3688)',
    structure = SMILES('[C-]=[O+]C[C]C'),
    E0 = (658.003,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,378.605,709.192,1607.21,2045.3,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0698034,'amu*angstrom^2'), symmetry=1, barrier=(6.26149,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0698034,'amu*angstrom^2'), symmetry=1, barrier=(6.26149,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0698034,'amu*angstrom^2'), symmetry=1, barrier=(6.26149,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.83749,0.0531166,-7.82551e-05,7.25872e-08,-2.79667e-11,79212,7.65253], Tmin=(100,'K'), Tmax=(744.037,'K')), NASAPolynomial(coeffs=[4.96583,0.0290736,-1.52182e-05,3.05436e-09,-2.18146e-13,78946.5,-5.17109], Tmin=(744.037,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(658.003,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsCs) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[C-]=[O+]CC[CH](3689)',
    structure = SMILES('[C-]=[O+]CC[CH]'),
    E0 = (680.439,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,180,180,180,180,180,1130.04,3921.3,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00167192,'amu*angstrom^2'), symmetry=1, barrier=(18.9831,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00167192,'amu*angstrom^2'), symmetry=1, barrier=(18.9831,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00167192,'amu*angstrom^2'), symmetry=1, barrier=(18.9831,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89853,0.0514764,-7.66937e-05,7.05064e-08,-2.71779e-11,81908.6,-1.72296], Tmin=(100,'K'), Tmax=(709.348,'K')), NASAPolynomial(coeffs=[5.54146,0.0264442,-1.42658e-05,2.91166e-09,-2.10233e-13,81504.7,-17.2507], Tmin=(709.348,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(680.439,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsCs) + group(Cs-CsCsHH) + group(CsJ2_singlet-CsH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[C-]=[O+]CC=C(3637)'],
    products = ['CO(2039)', 'C3H6(27)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(2.60496e+13,'s^-1'), n=-0.343905, Ea=(72.7755,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=6.4548336266697035, var=111.97246879746811, Tref=1000.0, N=4, correlation='Root_1R!H->C_N-2R!H->C',), comment="""BM rule fitted to 2 training reactions at node Root_1R!H->C_N-2R!H->C
...
reaction(
    label = 'reaction3',
    reactants = ['[C-]=[O+]C[C]C(3688)'],
    products = ['[C-]=[O+]CC=C(3637)'],
    transitionState = 'TS3',
