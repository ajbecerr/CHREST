species(
    label = '[CH2]OC([CH2])C(28798)',
    structure = SMILES('[CH2]OC([CH2])C'),
    E0 = (123.939,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,489.176,489.199],'cm^-1')),
        HinderedRotor(inertia=(0.492599,'amu*angstrom^2'), symmetry=1, barrier=(11.3258,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129403,'amu*angstrom^2'), symmetry=1, barrier=(2.97522,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.492596,'amu*angstrom^2'), symmetry=1, barrier=(11.3257,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0666932,'amu*angstrom^2'), symmetry=1, barrier=(11.3262,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28928,0.0617634,-6.84367e-05,4.30503e-08,-1.11387e-11,15002.2,19.9619], Tmin=(100,'K'), Tmax=(931.776,'K')), NASAPolynomial(coeffs=[9.57865,0.0261785,-1.11518e-05,2.06464e-09,-1.42166e-13,13457.4,-19.4439], Tmin=(931.776,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.939,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJC(C)OC) + radical(CsJOCC2)"""),
)
...
species(
    label = '[CH2]CO[CH2](28794)',
    structure = SMILES('[CH2]CO[CH2]'),
    E0 = (163.919,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,416.214,2171.5],'cm^-1')),
        HinderedRotor(inertia=(0.318109,'amu*angstrom^2'), symmetry=1, barrier=(9.19216,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0198322,'amu*angstrom^2'), symmetry=1, barrier=(2.72597,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0837956,'amu*angstrom^2'), symmetry=1, barrier=(9.19363,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.3362,0.0379301,-3.71701e-05,2.20962e-08,-5.55876e-12,19773.7,16.104], Tmin=(100,'K'), Tmax=(945.83,'K')), NASAPolynomial(coeffs=[6.70523,0.0194525,-7.86561e-06,1.44049e-09,-9.8918e-14,18947.2,-4.73056], Tmin=(945.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(163.919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CJCO) + radical(CsJOCC)"""),
)

species(
    label = '[CH2]O[CH]CC(28986)',
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7563,0.0391681,-3.46325e-08,-2.85117e-08,1.39082e-11,-22731.9,16.911], Tmin=(100,'K'), Tmax=(978.572,'K')), NASAPolynomial(coeffs=[12.3461,0.0198222,-7.07795e-06,1.2875e-09,-9.17983e-14,-25950.7,-39.8062], Tmin=(978.572,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-189.751,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH)"""),
)

species(
    label = '[CH2]OC(=C)C(28989)',
    structure = SMILES('[CH2]OC(=C)C'),
    E0 = (2.25681,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,422.702,423.523],'cm^-1')),
        HinderedRotor(inertia=(0.000945274,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105215,'amu*angstrom^2'), symmetry=1, barrier=(13.354,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105213,'amu*angstrom^2'), symmetry=1, barrier=(13.339,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87533,0.0370392,-1.60365e-06,-2.59359e-08,1.30029e-11,356.597,18.9692], Tmin=(100,'K'), Tmax=(975.619,'K')), NASAPolynomial(coeffs=[12.3268,0.0170492,-6.0173e-06,1.09768e-09,-7.88338e-14,-2770.72,-36.7712], Tmin=(975.619,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(2.25681,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=COCJ)"""),
)
...
species(
    label = '[CH2]O[C]([CH2])C(28990)',
    structure = SMILES('[CH2]O[C]([CH2])C'),
    E0 = (304.642,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,220.517,2209.64],'cm^-1')),
        HinderedRotor(inertia=(0.248351,'amu*angstrom^2'), symmetry=1, barrier=(8.57043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.248311,'amu*angstrom^2'), symmetry=1, barrier=(8.56966,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.248418,'amu*angstrom^2'), symmetry=1, barrier=(8.57039,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.248112,'amu*angstrom^2'), symmetry=1, barrier=(8.57012,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03776,0.0743942,-0.000126459,1.14977e-07,-3.96754e-11,36737.9,20.8027], Tmin=(100,'K'), Tmax=(883.826,'K')), NASAPolynomial(coeffs=[6.41561,0.0288587,-1.32039e-05,2.41341e-09,-1.60065e-13,36615.2,0.205342], Tmin=(883.826,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(304.642,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CsJOCC2)"""),
)
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.44815,0.0609285,-8.04973e-05,6.71298e-08,-2.30606e-11,11408.8,18.8854], Tmin=(100,'K'), Tmax=(822.254,'K')), NASAPolynomial(coeffs=[5.91475,0.031913,-1.42724e-05,2.65821e-09,-1.81566e-13,10920.6,-0.291272], Tmin=(822.254,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.1324,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(C2CsJOCs) + radical(CsJOCC2)"""),
)

species(
    label = '[CH2][C](C)OC(28992)',
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37203,0.0674897,-0.000109476,1.04179e-07,-3.79393e-11,14645.2,20.1851], Tmin=(100,'K'), Tmax=(867.261,'K')), NASAPolynomial(coeffs=[3.25927,0.0363509,-1.68169e-05,3.12371e-09,-2.10558e-13,15161.6,16.2131], Tmin=(867.261,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(121.058,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]C([CH2])OC(28993)',
    structure = SMILES('[CH2]C([CH2])OC'),
    E0 = (150.864,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,214.102,214.122],'cm^-1')),
        HinderedRotor(inertia=(0.175819,'amu*angstrom^2'), symmetry=1, barrier=(5.7152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175619,'amu*angstrom^2'), symmetry=1, barrier=(5.71558,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175606,'amu*angstrom^2'), symmetry=1, barrier=(5.71582,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.175672,'amu*angstrom^2'), symmetry=1, barrier=(5.71584,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10979,0.069632,-0.000102455,8.74319e-08,-2.95703e-11,18243,20.2406], Tmin=(100,'K'), Tmax=(854.941,'K')), NASAPolynomial(coeffs=[7.06204,0.0303722,-1.35523e-05,2.49558e-09,-1.68258e-13,17642.3,-5.10379], Tmin=(854.941,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.864,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]OC([CH2])C(28798)'],
    products = ['CH2O(3111)', 'C3H6(27)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]CO[CH2](28794)'],
    products = ['[CH2]OC([CH2])C(28798)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[CH2]C(C)[O](667)'],
    products = ['[CH2]OC([CH2])C(28798)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]C(C)O[CH2](28987)'],
    products = ['[CH2]OC([CH2])C(28798)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]OC([CH2])C(3227)'],
    products = ['[CH2]OC([CH2])C(28798)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH2]OC(=C)C(28989)'],
    products = ['[CH2]OC([CH2])C(28798)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(17)', 'CH2OCHCH2(5571)'],
    products = ['[CH2]OC([CH2])C(28798)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][O](3109)', 'C3H6(T)(28)'],
    products = ['[CH2]OC([CH2])C(28798)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(17)', '[CH2][CH]O[CH2](1565)'],
    products = ['[CH2]OC([CH2])C(28798)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH2]O[C]([CH2])C(28990)'],
    products = ['[CH2]OC([CH2])C(28798)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]OC([CH2])[CH2](28815)'],
    products = ['[CH2]OC([CH2])C(28798)'],
