...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(20)', '[CH2]C([CH2])CC(117)'],
    products = ['[CH2]CC([CH2])CC(200)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C(C[CH2])CC(222)'],
    products = ['[CH2]CC([CH2])CC(200)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]CC([CH2])CC(223)'],
    products = ['[CH2]CC([CH2])CC(200)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2]C(C=C)CC(228)'],
    products = ['[CH2]CC([CH2])CC(200)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C2H5(14)', 'buten3yl1(65)'],
    products = ['[CH2]CC([CH2])CC(200)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C2H5(14)', '[CH2][CH]C[CH2](66)'],
    products = ['[CH2]CC([CH2])CC(200)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH2]C[C]([CH2])CC(229)'],
    products = ['[CH2]CC([CH2])CC(200)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH3(17)', '[CH2]CC([CH2])[CH2](112)'],
    products = ['[CH2]CC([CH2])CC(200)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2][CH]C([CH2])CC(231)'],
    products = ['[CH2]CC([CH2])CC(200)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH2]CC([CH2])C[CH2](232)'],
    products = ['[CH2]CC([CH2])CC(200)'],
