...
species(
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.70097,0.0250364,-6.69453e-06,-3.46048e-09,1.6165e-12,2728.68,17.6873], Tmin=(100,'K'), Tmax=(1337.17,'K')), NASAPolynomial(coeffs=[7.26287,0.0189181,-8.27613e-06,1.53841e-09,-1.05284e-13,835.656,-8.16324], Tmin=(1337.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(22.2754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-(Cds-O2d)HHH) + group(Cs-OsHHH) + group(Cds-OdCsOs) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][C]([O])O[CH2](29854)',
    structure = SMILES('[CH][C]([O])O[CH2]'),
    E0 = (630.981,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3000,3100,440,815,1455,1000,180,1277.63,1277.73,1278.37,1279.05,1279.97],'cm^-1')),
        HinderedRotor(inertia=(0.145487,'amu*angstrom^2'), symmetry=1, barrier=(3.34504,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146856,'amu*angstrom^2'), symmetry=1, barrier=(3.37652,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.146556,'amu*angstrom^2'), symmetry=1, barrier=(3.36962,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (71.0547,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.13035,0.0477812,-8.30077e-05,8.00903e-08,-2.98012e-11,75950.4,22.3664], Tmin=(100,'K'), Tmax=(828.34,'K')), NASAPolynomial(coeffs=[4.48164,0.0224184,-1.17119e-05,2.29343e-09,-1.59619e-13,76041.5,14.3666], Tmin=(828.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(630.981,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(170.447,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCOJ) + radical(Cs_P) + radical(CsJOCH3) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C](O)O[CH2](29855)',
    structure = SMILES('[CH][C](O)O[CH2]'),
    E0 = (405.276,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.91371,0.048655,-6.33576e-05,4.41347e-08,-1.23725e-11,48816.2,22.2935], Tmin=(100,'K'), Tmax=(868.716,'K')), NASAPolynomial(coeffs=[8.89883,0.0164913,-7.81957e-06,1.5129e-09,-1.0647e-13,47602.6,-10.4224], Tmin=(868.716,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(405.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(191.233,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(Cs_P) + radical(CsJOCH3) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C]([O])OC(29856)',
    structure = SMILES('[CH][C]([O])OC'),
    E0 = (443.11,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,180,180,1532.94,1533.09,1533.1,1533.21],'cm^-1')),
        HinderedRotor(inertia=(0.113685,'amu*angstrom^2'), symmetry=1, barrier=(2.61385,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.113993,'amu*angstrom^2'), symmetry=1, barrier=(2.62092,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.11365,'amu*angstrom^2'), symmetry=1, barrier=(2.61304,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23601,0.0463132,-7.80985e-05,7.9169e-08,-3.08675e-11,53350.1,21.1962], Tmin=(100,'K'), Tmax=(826.577,'K')), NASAPolynomial(coeffs=[2.39309,0.0284225,-1.45449e-05,2.83762e-09,-1.97532e-13,53909.3,24.0083], Tmin=(826.577,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(443.11,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCOJ) + radical(Cs_P) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(20)', '[CH]C([O])[O](6931)'],
    products = ['[CH]C([O])O[CH2](28869)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]=C([O])O[CH2](28885)'],
    products = ['[CH]C([O])O[CH2](28869)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH](6993)', 'CH2OCHO(28726)'],
    products = ['[CH]C([O])O[CH2](28869)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH][C]([O])O[CH2](29854)'],
    products = ['[CH]C([O])O[CH2](28869)'],
