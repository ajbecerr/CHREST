...
species(
    ...
    molecularWeight = (65.0932,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28409,0.0306602,-2.24222e-06,-1.93341e-08,9.85756e-12,42896.9,14.5042], Tmin=(100,'K'), Tmax=(965.72,'K')), NASAPolynomial(coeffs=[9.88976,0.0159727,-5.54716e-06,9.77546e-10,-6.81548e-14,40643.8,-25.9832], Tmin=(965.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(356.098,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCtH) + group(Ct-Ct(Cds-Cds)) + group(Ct-CtH) + radical(CTCC=CCJ)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=[CH](9646)', '[CH]=C[CH2](16804)'],
    products = ['[CH]=[C]CC=[CH](15983)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH]=[C]C[C]=[CH](17536)'],
    products = ['[CH]=[C]CC=[CH](15983)'],
