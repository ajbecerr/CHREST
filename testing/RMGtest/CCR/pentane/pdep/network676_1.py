...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2433,0.0466741,7.89973e-07,-4.47857e-08,2.38842e-11,-4451.11,20.4974], Tmin=(100,'K'), Tmax=(920.214,'K')), NASAPolynomial(coeffs=[17.5626,0.0120974,-2.11768e-06,2.59848e-10,-1.90758e-14,-8994.06,-65.242], Tmin=(920.214,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-37.9415,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(C=CC=CCJ)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.64811,0.0530059,-5.67551e-05,4.01902e-08,-1.14275e-11,51657,25.3206], Tmin=(100,'K'), Tmax=(1038.25,'K')), NASAPolynomial(coeffs=[5.53723,0.0290673,-9.23219e-06,1.36806e-09,-7.91918e-14,51332.1,8.73628], Tmin=(1038.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(428.806,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(C2CsJO) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C1C[C]([O])C1(2634)',
    structure = SMILES('[CH2]C1C[C]([O])C1'),
    E0 = (420.652,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
...
species(
    label = '[O][C]1C[CH]CC1(2635)',
    structure = SMILES('[O][C]1C[CH]CC1'),
    E0 = (328.725,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.43979,0.0248178,2.88567e-05,-4.73228e-08,1.78569e-11,39601,22.057], Tmin=(100,'K'), Tmax=(1003.86,'K')), NASAPolynomial(coeffs=[7.38538,0.0282434,-1.08268e-05,1.986e-09,-1.39527e-13,37442.6,-7.627], Tmin=(1003.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(328.725,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclopentane) + radical(CC(C)OJ) + radical(cyclopentane) + radical(C2CsJOH)"""),
)
...
species(
    label = '[CH2]C1([O])C[CH]C1(2636)',
    structure = SMILES('[CH2]C1([O])C[CH]C1'),
    E0 = (428.409,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62809,0.0429828,-8.94445e-06,-1.64087e-08,8.46996e-12,51619,22.3048], Tmin=(100,'K'), Tmax=(1045.46,'K')), NASAPolynomial(coeffs=[11.6087,0.0241696,-9.7478e-06,1.82837e-09,-1.29537e-13,48473.4,-31.3531], Tmin=(1045.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(428.409,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsOs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CC(C)2OJ) + radical(cyclobutane) + radical(CJC(C)2O)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18297,0.0508659,-1.78179e-05,-2.15184e-08,1.45003e-11,28756.8,24.1152], Tmin=(100,'K'), Tmax=(933.564,'K')), NASAPolynomial(coeffs=[16.3362,0.0140026,-3.67836e-06,5.83895e-10,-4.12316e-14,24704.6,-54.4985], Tmin=(933.564,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(238.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(C=C(O)CJ) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][C]1C[CH]CO1(2646)',
    structure = SMILES('[CH2][C]1C[CH]CO1'),
    E0 = (356.131,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03615,0.0377511,1.32202e-06,-3.2546e-08,1.84001e-11,42908.7,19.3623], Tmin=(100,'K'), Tmax=(827.834,'K')), NASAPolynomial(coeffs=[9.17346,0.0223447,-5.33505e-06,6.56973e-10,-3.50224e-14,41073.2,-17.6714], Tmin=(827.834,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(356.131,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(C2CsJOCs) + radical(CCJCO) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][CH]CC([CH2])=O(1905)'],
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH][CH]CC(=C)[O](2631)'],
    products = ['[CH2][CH]CC([CH2])=O(1905)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][CH][CH]C([CH2])[O](1906)'],
    products = ['[CH2][CH]CC([CH2])=O(1905)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH]CC([CH2])=O(1905)'],
    products = ['[CH2]C1([O])C[CH]C1(2636)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]C=CC(=C)[O](2637)'],
    products = ['[CH2][CH]CC([CH2])=O(1905)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH2][CH][CH]C(=C)[O](2638)'],
    products = ['[CH2][CH]CC([CH2])=O(1905)'],
