...
species(
    label = 'CC1CCC=[C]O1(9386)',
    structure = SMILES('CC1CCC=[C]O1'),
    E0 = (48.9346,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77699,0.0286126,6.86302e-05,-1.11937e-07,4.61764e-11,5984.16,20.5069], Tmin=(100,'K'), Tmax=(932.134,'K')), NASAPolynomial(coeffs=[15.0644,0.0233053,-6.04427e-06,9.86432e-10,-7.21102e-14,1260.49,-54.7138], Tmin=(932.134,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(48.9346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(3,4-Dihydro-2H-pyran) + radical(C=CJO)"""),
)

species(
    label = '[CH]=C1CCC(C)O1(9387)',
    structure = SMILES('[CH]=C1CCC(C)O1'),
    E0 = (60.9197,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.47046,0.0280213,8.9039e-05,-1.44571e-07,5.98947e-11,7443.38,22.4979], Tmin=(100,'K'), Tmax=(938.077,'K')), NASAPolynomial(coeffs=[21.001,0.0150396,-2.60979e-06,4.45795e-10,-4.21052e-14,686.093,-86.9634], Tmin=(938.077,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.9197,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'C#COCC[CH2](2294)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(20)', 'C#COC([CH2])C(2293)'],
    products = ['C#COC(C)C[CH2](3092)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]CC(C)OC#C(9385)'],
    products = ['C#COC(C)C[CH2](3092)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction8',
    reactants = ['C2H4(22)', 'C#CO[CH]C(3067)'],
    products = ['C#COC(C)C[CH2](3092)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['HC2(2881)', '[CH2]CC(C)[O](3123)'],
    products = ['C#COC(C)C[CH2](3092)'],
...
reaction(
    label = 'reaction11',
    reactants = ['C2H4(T)(23)', 'C#CO[CH]C(3067)'],
    products = ['C#COC(C)C[CH2](3092)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(17)', 'C#CO[CH]C[CH2](3107)'],
    products = ['C#COC(C)C[CH2](3092)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'C#CO[C](C)C[CH2](6767)'],
    products = ['C#COC(C)C[CH2](3092)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[C]#COC(C)C[CH2](6769)'],
    products = ['C#COC(C)C[CH2](3092)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C#COC(C)C[CH2](3092)'],
    products = ['ketene(1375)', 'buten3yl1(65)'],
    transitionState = 'TS17',
    kinetics = Arrhenius(A=(556593,'s^-1'), n=1.69565, Ea=(133.689,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.0, var=33.13686319048999, Tref=1000.0, N=1, correlation='Root_N-1R!H->C_N-3R!H-inRing_N-5R!H->O',), comment="""BM rule fitted to 2 training reactions at node Root_N-1R!H->C_N-3R!H-inRing_N-5R!H->O
    Total Standard Deviation in ln(k): 11.540182761524994
Exact match found for rate rule [Root_N-1R!H->C_N-3R!H-inRing_N-5R!H->O]
Euclidian distance = 0
