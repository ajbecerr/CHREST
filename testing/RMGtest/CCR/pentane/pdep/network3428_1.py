...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(20)', '[CH]C=C[CH2](15066)'],
    products = ['[CH]=CC([CH2])[CH2](13775)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]C([CH2])C=[CH](15102)'],
    products = ['[CH]=CC([CH2])[CH2](13775)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[C]=CC([CH2])[CH2](15103)'],
    products = ['[CH]=CC([CH2])[CH2](13775)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]=CC([CH2])=C(15107)'],
    products = ['[CH]=CC([CH2])[CH2](13775)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C#CC([CH2])[CH2](9851)'],
    products = ['[CH]=CC([CH2])[CH2](13775)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH2(T)(20)', 'CH2CHCHCH(4849)'],
    products = ['[CH]=CC([CH2])[CH2](13775)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH]=C[C]([CH2])[CH2](15108)'],
    products = ['[CH]=CC([CH2])[CH2](13775)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH]=[C]C([CH2])[CH2](9843)'],
    products = ['[CH]=CC([CH2])[CH2](13775)'],
