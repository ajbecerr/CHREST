species(
    label = '[CH2]OC(C)[O](28842)',
    structure = SMILES('[CH2]OC(C)[O]'),
    E0 = (-22.4801,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,1122.61,1122.69],'cm^-1')),
        HinderedRotor(inertia=(0.13503,'amu*angstrom^2'), symmetry=1, barrier=(3.10461,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.135054,'amu*angstrom^2'), symmetry=1, barrier=(3.10517,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.134948,'amu*angstrom^2'), symmetry=1, barrier=(3.10273,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.22222,0.0324637,-1.64326e-05,3.44964e-09,-2.70688e-13,-2692.85,16.6534], Tmin=(100,'K'), Tmax=(2919.74,'K')), NASAPolynomial(coeffs=[17.7395,0.0125757,-6.2155e-06,1.11681e-09,-7.09462e-14,-11170.4,-68.9396], Tmin=(2919.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-22.4801,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCOJ) + radical(CsJOCH3)"""),
)
...
species(
    label = '[CH2]OC[O](28981)',
    structure = SMILES('[CH2]OC[O]'),
    E0 = (25.0348,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,420.73,421.879,422.37],'cm^-1')),
        HinderedRotor(inertia=(0.000951511,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.000946865,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48579,0.00501573,0.000112711,-1.61865e-07,6.53864e-11,-33505.4,15.2033], Tmin=(100,'K'), Tmax=(934.503,'K')), NASAPolynomial(coeffs=[20.3467,0.00102334,2.81382e-06,-4.94194e-10,1.94864e-14,-40007.5,-86.6835], Tmin=(934.503,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-279.25,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(253.591,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + ring(Cyclobutane)"""),
)
...
species(
    ...
    E0 = (-224.235,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,180,180,933.698,936.326,936.53],'cm^-1')),
        HinderedRotor(inertia=(0.00383885,'amu*angstrom^2'), symmetry=1, barrier=(2.3765,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.10396,'amu*angstrom^2'), symmetry=1, barrier=(2.39024,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0785889,'amu*angstrom^2'), symmetry=1, barrier=(48.7537,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
...
species(
    ...
    E0 = (182.766,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,180,1450.45,1450.49],'cm^-1')),
        HinderedRotor(inertia=(0.120281,'amu*angstrom^2'), symmetry=1, barrier=(2.7655,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12049,'amu*angstrom^2'), symmetry=1, barrier=(2.7703,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12039,'amu*angstrom^2'), symmetry=1, barrier=(2.76801,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
...
species(
    ...
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04707,0.0446944,-4.08695e-05,2.07799e-08,-4.46073e-12,-5095.48,20.8073], Tmin=(100,'K'), Tmax=(1089.99,'K')), NASAPolynomial(coeffs=[8.15284,0.0222876,-1.00341e-05,1.92005e-09,-1.35028e-13,-6426.53,-9.1756], Tmin=(1089.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.9389,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(Cs_P) + radical(CsJOCH3)"""),
)

species(
    label = 'CO[C](C)[O](29275)',
    structure = SMILES('CO[C](C)[O]'),
    E0 = (-5.10465,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,180,1735.92,1738.66],'cm^-1')),
        HinderedRotor(inertia=(0.199252,'amu*angstrom^2'), symmetry=1, barrier=(4.58119,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198636,'amu*angstrom^2'), symmetry=1, barrier=(4.56704,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.20007,'amu*angstrom^2'), symmetry=1, barrier=(4.60001,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32046,0.0428932,-5.74326e-05,5.83411e-08,-2.42448e-11,-559.3,19.8887], Tmin=(100,'K'), Tmax=(792.617,'K')), NASAPolynomial(coeffs=[1.27759,0.0348842,-1.71595e-05,3.34224e-09,-2.34364e-13,22.9166,27.3075], Tmin=(792.617,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-5.10465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCOJ) + radical(Cs_P)"""),
)

species(
    label = '[CH2]OC([CH2])O(29276)',
    structure = SMILES('[CH2]OC([CH2])O'),
    E0 = (-36.5961,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.82116,0.0495591,-5.15255e-05,2.93897e-08,-6.90034e-12,-4324.38,21.5655], Tmin=(100,'K'), Tmax=(1018.79,'K')), NASAPolynomial(coeffs=[9.12123,0.0208981,-9.32799e-06,1.77756e-09,-1.24775e-13,-5811.86,-13.7891], Tmin=(1018.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-36.5961,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CJCO) + radical(CsJOCH3)"""),
)

species(
    label = '[CH2]C([O])OC(29277)',
    structure = SMILES('[CH2]C([O])OC'),
    E0 = (1.23808,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,887.115,1724.91],'cm^-1')),
        HinderedRotor(inertia=(0.14346,'amu*angstrom^2'), symmetry=1, barrier=(3.29843,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.160167,'amu*angstrom^2'), symmetry=1, barrier=(3.68256,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147177,'amu*angstrom^2'), symmetry=1, barrier=(3.38389,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.70063,0.0306887,-1.46019e-05,2.6804e-09,-1.70254e-13,133.531,14.7233], Tmin=(100,'K'), Tmax=(3044.32,'K')), NASAPolynomial(coeffs=[39.5579,-0.0101859,2.46377e-06,-3.83576e-10,2.60776e-14,-24589.8,-202.935], Tmin=(3044.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1.23808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCOJ) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]OC[O](28981)'],
    products = ['[CH2]OC(C)[O](28842)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(20)', 'CC([O])[O](3177)'],
    products = ['[CH2]OC(C)[O](28842)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH2]OC(C)=O(29185)'],
    products = ['[CH2]OC(C)[O](28842)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(17)', 'CH2OCHO(28726)'],
    products = ['[CH2]OC(C)[O](28842)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CH3(17)', '[CH2]O[CH][O](29182)'],
    products = ['[CH2]OC(C)[O](28842)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2]O[C](C)[O](29189)'],
    products = ['[CH2]OC(C)[O](28842)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH2]OC([CH2])[O](28828)'],
    products = ['[CH2]OC(C)[O](28842)'],
