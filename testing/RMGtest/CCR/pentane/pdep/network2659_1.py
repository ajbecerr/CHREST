...
species(
    label = '[CH]=[C]OC[CH]CC(2546)',
    structure = SMILES('[CH]=[C]OC[CH]CC'),
    E0 = (453.675,'kJ/mol'),
    modes = [
...
species(
    label = 'CC[CH]COC1=CO1(11694)',
    structure = SMILES('CC[CH]COC1=CO1'),
    E0 = (132.056,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.19466,0.0806763,-5.92804e-05,1.23953e-08,2.85195e-12,16044,30.2633], Tmin=(100,'K'), Tmax=(1004.38,'K')), NASAPolynomial(coeffs=[19.8027,0.0239484,-8.77908e-06,1.58805e-09,-1.1166e-13,10871.3,-72.0531], Tmin=(1004.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(132.056,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclopropene) + radical(CCJCO)"""),
)
...
species(
    label = 'CCC=CO[C]=C[O](11696)',
    structure = SMILES('CCC=CO[C]=C[O]'),
    E0 = (83.5569,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.258816,0.0681887,-2.93288e-05,-1.9733e-08,1.50327e-11,10197,33.5836], Tmin=(100,'K'), Tmax=(955.803,'K')), NASAPolynomial(coeffs=[19.9174,0.0196799,-6.1854e-06,1.0809e-09,-7.7688e-14,4896.93,-68.4364], Tmin=(955.803,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(83.5569,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=CJO)"""),
)
...
species(
    label = 'C#COC[CH]CC(2542)',
    structure = SMILES('C#COC[CH]CC'),
    E0 = (176.161,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2175,525,750,770,3400,2100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.272082,0.0697765,-4.00675e-05,-4.47867e-09,8.46965e-12,21332.4,26.506], Tmin=(100,'K'), Tmax=(983.209,'K')), NASAPolynomial(coeffs=[18.716,0.0216439,-7.67951e-06,1.39056e-09,-9.90295e-14,16405.2,-68.776], Tmin=(983.209,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(176.161,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(CCJCO)"""),
)
...
species(
    label = '[CH2]CCCO[C]=C[O](11704)',
    structure = SMILES('[CH2]CCCO[C]=C[O]'),
    E0 = (144.593,'kJ/mol'),
    modes = [
...
species(
    label = 'CC[CH][CH]O[C]=CO(11707)',
    structure = SMILES('CC[CH][CH]O[C]=CO'),
    E0 = (191.714,'kJ/mol'),
    modes = [
...
species(
    label = 'C[CH][CH]CO[C]=CO(11709)',
    structure = SMILES('C[CH][CH]CO[C]=CO'),
    E0 = (192.232,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C[CH]CO[C]=CO(11710)',
    structure = SMILES('[CH2]C[CH]CO[C]=CO'),
    E0 = (203.032,'kJ/mol'),
    modes = [
...
species(
    label = 'CCC1CO[C][CH]O1(11711)',
    structure = SMILES('CCC1CO[C][CH]O1'),
    E0 = (242.257,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
...
species(
    label = 'CCC1CO[C]C1[O](11712)',
    structure = SMILES('CCC1CO[C]C1[O]'),
    E0 = (263.715,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.799608,0.0545677,1.38441e-05,-6.46249e-08,3.20253e-11,31847.6,23.4198], Tmin=(100,'K'), Tmax=(907.648,'K')), NASAPolynomial(coeffs=[17.189,0.0243825,-5.7518e-06,8.01857e-10,-5.21711e-14,27140.6,-63.6013], Tmin=(907.648,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(263.715,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CC(C)OJ) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC[CH]CO[C]=C[O](11004)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CC[CH]CO[C]=C[O](11004)'],
    products = ['[CH2]C(C)CO[C]=C[O](11692)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=C[O](6859)', 'CC[CH]C[O](1363)'],
    products = ['CC[CH]CO[C]=C[O](11004)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(14)', '[CH]CO[C]=C[O](11427)'],
    products = ['CC[CH]CO[C]=C[O](11004)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]O[C]=C[O](11426)', '[CH]CC(26)'],
    products = ['CC[CH]CO[C]=C[O](11004)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O(4)', '[CH]=[C]OC[CH]CC(2546)'],
    products = ['CC[CH]CO[C]=C[O](11004)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'CC[C]CO[C]=C[O](11693)'],
    products = ['CC[CH]CO[C]=C[O](11004)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'CC=CCO[C]=C[O](11241)'],
    products = ['CC[CH]CO[C]=C[O](11004)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'CCC=CO[C]=C[O](11696)'],
    products = ['CC[CH]CO[C]=C[O](11004)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O(4)', 'C#COC[CH]CC(2542)'],
    products = ['CC[CH]CO[C]=C[O](11004)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(17)', 'C=CCO[C]=C[O](11052)'],
    products = ['CC[CH]CO[C]=C[O](11004)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH3(17)', '[CH2][CH]CO[C]=C[O](11046)'],
    products = ['CC[CH]CO[C]=C[O](11004)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', 'C[CH][CH]CO[C]=C[O](11221)'],
    products = ['CC[CH]CO[C]=C[O](11004)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'CC[CH][CH]O[C]=C[O](11698)'],
    products = ['CC[CH]CO[C]=C[O](11004)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH2]C[CH]CO[C]=C[O](11699)'],
    products = ['CC[CH]CO[C]=C[O](11004)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]CCCO[C]=C[O](11704)'],
    products = ['CC[CH]CO[C]=C[O](11004)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(379583,'s^-1'), n=1.54051, Ea=(43.2505,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5Hall;Y_rad_out;Cs_H_out_H/NonDeC] for rate rule [R5HJ_1;Cd_rad_out;Cs_H_out_H/(NonDeC/Cs)]
...
reaction(
    label = 'reaction34',
    reactants = ['CC[CH][CH]O[C]=CO(11707)'],
    products = ['CC[CH]CO[C]=C[O](11004)'],
...
reaction(
    label = 'reaction36',
    reactants = ['C[CH][CH]CO[C]=CO(11709)'],
    products = ['CC[CH]CO[C]=C[O](11004)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]C[CH]CO[C]=CO(11710)'],
    products = ['CC[CH]CO[C]=C[O](11004)'],
...
network(
    label = 'PDepNetwork #2659',
    isomers = [
        'CC[CH]CO[C]=C[O](11004)',
    ],
    reactants = [
