...
species(
    label = '[CH]=C(CC=O)CO[O](19314)',
    structure = SMILES('[CH]=C(CC=O)CO[O]'),
    E0 = (185.276,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43352,0.0637186,-5.62084e-05,2.71994e-08,-5.79906e-12,22369.9,27.3291], Tmin=(100,'K'), Tmax=(1056.08,'K')), NASAPolynomial(coeffs=[8.29757,0.0377206,-1.92826e-05,3.88962e-09,-2.8112e-13,20920.1,-6.16054], Tmin=(1056.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(185.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(C[O])C[CH][O](20370)',
    structure = SMILES('[CH]=C(C[O])C[CH][O]'),
    E0 = (510.264,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,440,435,1725,3025,407.5,1350,352.5,3120,650,792.5,1650,180,180,1887.04,1887.17],'cm^-1')),
        HinderedRotor(inertia=(0.173403,'amu*angstrom^2'), symmetry=1, barrier=(3.98688,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173285,'amu*angstrom^2'), symmetry=1, barrier=(3.98417,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173506,'amu*angstrom^2'), symmetry=1, barrier=(3.98925,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00054,0.0803639,-0.000145139,1.46245e-07,-5.51675e-11,61464.8,29.7305], Tmin=(100,'K'), Tmax=(858.252,'K')), NASAPolynomial(coeffs=[1.47699,0.0440031,-2.19218e-05,4.18402e-09,-2.85749e-13,62640.4,34.8299], Tmin=(858.252,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(510.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCOJ) + radical(CCsJOH) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(C[C][O])CO[O](20371)',
    structure = SMILES('[CH]=C(C[C][O])CO[O]'),
    E0 = (788.759,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,440,435,1725,3120,650,792.5,1650,239.306,240.708,242.103,1618.61],'cm^-1')),
        HinderedRotor(inertia=(0.208426,'amu*angstrom^2'), symmetry=1, barrier=(7.91731,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.202718,'amu*angstrom^2'), symmetry=1, barrier=(7.78526,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.199349,'amu*angstrom^2'), symmetry=1, barrier=(7.82206,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.19401,'amu*angstrom^2'), symmetry=1, barrier=(7.78873,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.259684,0.0939193,-0.000163522,1.50839e-07,-5.32545e-11,94989.3,32.2333], Tmin=(100,'K'), Tmax=(853.662,'K')), NASAPolynomial(coeffs=[7.51292,0.035444,-1.77431e-05,3.3888e-09,-2.31465e-13,94643.3,3.6145], Tmin=(853.662,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(788.759,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ) + radical(ROOJ) + radical(CH2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[C]=C(C[CH][O])CO[O](20372)',
    structure = SMILES('[C]=C(C[CH][O])CO[O]'),
    E0 = (819.075,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,440,435,1725,3025,407.5,1350,352.5,180,180,180,2047.77],'cm^-1')),
        HinderedRotor(inertia=(0.198359,'amu*angstrom^2'), symmetry=1, barrier=(4.56067,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1983,'amu*angstrom^2'), symmetry=1, barrier=(4.55931,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198317,'amu*angstrom^2'), symmetry=1, barrier=(4.5597,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.198337,'amu*angstrom^2'), symmetry=1, barrier=(4.56016,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.24872,0.099473,-0.000189814,1.85588e-07,-6.73506e-11,98630.8,33.0642], Tmin=(100,'K'), Tmax=(872.63,'K')), NASAPolynomial(coeffs=[4.25435,0.0411249,-2.07817e-05,3.94014e-09,-2.66116e-13,99454.2,23.0086], Tmin=(872.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(819.075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ) + radical(ROOJ) + radical(CCsJOH) + radical(CdCdJ2_triplet)"""),
)
...
species(
    label = '[CH]=C1COOC([O])C1(20374)',
    structure = SMILES('[CH]=C1COOC([O])C1'),
    E0 = (200.28,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28325,0.0473559,6.55973e-07,-2.71871e-08,1.06757e-11,24196,24.4945], Tmin=(100,'K'), Tmax=(1179.07,'K')), NASAPolynomial(coeffs=[14.6006,0.031366,-1.61361e-05,3.30375e-09,-2.41246e-13,19026.7,-50.5517], Tmin=(1179.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.28,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclohexanone) + radical(CCOJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C1COC([O])C1(20376)',
    structure = SMILES('[CH]=C1COC([O])C1'),
    E0 = (171.027,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.14849,0.0298554,2.29513e-05,-4.39009e-08,1.66658e-11,20645.8,24.1011], Tmin=(100,'K'), Tmax=(1041.91,'K')), NASAPolynomial(coeffs=[9.44992,0.0278647,-1.16716e-05,2.23957e-09,-1.60806e-13,17710.8,-18.2067], Tmin=(1041.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(171.027,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(CCOJ) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(C=C[O])COO(20377)',
    structure = SMILES('[CH]C(=CC=O)COO'),
    E0 = (132.634,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.965324,0.076592,-7.08445e-05,1.90145e-08,1.36651e-11,16052,27.6105], Tmin=(100,'K'), Tmax=(534.432,'K')), NASAPolynomial(coeffs=[6.5658,0.0472922,-2.40217e-05,4.78221e-09,-3.42083e-13,15273.2,2.41458], Tmin=(534.432,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(132.634,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=C(C=C[O])CO[O](19390)',
    structure = SMILES('[CH]C(=CC=O)CO[O]'),
    E0 = (284.639,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3010,987.5,1337.5,450,1655,2782.5,750,1395,475,1775,1000,355.862,355.911,355.932,356.004],'cm^-1')),
        HinderedRotor(inertia=(0.586959,'amu*angstrom^2'), symmetry=1, barrier=(52.7957,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.586766,'amu*angstrom^2'), symmetry=1, barrier=(52.793,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.586969,'amu*angstrom^2'), symmetry=1, barrier=(52.7945,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.586859,'amu*angstrom^2'), symmetry=1, barrier=(52.7947,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.654068,0.0814879,-0.000115873,1.03546e-07,-3.83097e-11,34347,29.3916], Tmin=(100,'K'), Tmax=(775.77,'K')), NASAPolynomial(coeffs=[5.67545,0.0443261,-2.22253e-05,4.34178e-09,-3.04781e-13,33907.1,8.62712], Tmin=(775.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(284.639,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cd-Cd(CO)H) + group(Cds-O2d(Cds-Cds)H) + radical(ROOJ) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]=C([CH][CH][O])CO[O](20378)',
    structure = SMILES('[CH][C](C=C[O])CO[O]'),
    E0 = (548.867,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1000,1200,1400,1600],'cm^-1')),
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.361681,0.071871,-6.67147e-05,2.71527e-08,-3.07797e-12,66151.6,31.8282], Tmin=(100,'K'), Tmax=(1010.08,'K')), NASAPolynomial(coeffs=[17.8503,0.016834,-6.09947e-06,1.08288e-09,-7.50693e-14,61893.3,-56.3103], Tmin=(1010.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(548.867,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(ROOJ) + radical(CCJ(C)CO) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.730009,0.0828374,-0.000124712,1.18443e-07,-4.43242e-11,53588.7,32.4637], Tmin=(100,'K'), Tmax=(840.482,'K')), NASAPolynomial(coeffs=[2.45706,0.0505419,-2.41062e-05,4.56003e-09,-3.12233e-13,54148.8,29.4907], Tmin=(840.482,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(444.671,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(CCOJ) + radical(ROOJ) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.711711,0.0728261,-6.58371e-05,3.28558e-08,-6.85882e-12,40560.8,32.2712], Tmin=(100,'K'), Tmax=(1127.62,'K')), NASAPolynomial(coeffs=[11.4895,0.0345943,-1.49801e-05,2.7885e-09,-1.92767e-13,38130.1,-21.02], Tmin=(1127.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(336.261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(ROOJ) + radical(C=CCJO) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0771274,0.0756898,-6.27132e-05,1.86028e-08,4.34026e-13,47882.1,32.0915], Tmin=(100,'K'), Tmax=(1012.47,'K')), NASAPolynomial(coeffs=[19.7325,0.0179935,-6.80089e-06,1.25505e-09,-8.95014e-14,42879.1,-68.0291], Tmin=(1012.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(396.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-(Cds-Cd)H) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCJ(C)CO) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['O(4)', '[CH]=C(C[O])C[CH][O](20370)'],
    products = ['[CH]=C(C[CH][O])CO[O](19320)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH][O](1548)', '[CH]=C([CH2])CO[O](19529)'],
    products = ['[CH]=C(C[CH][O])CO[O](19320)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]=C(C[C][O])CO[O](20371)'],
    products = ['[CH]=C(C[CH][O])CO[O](19320)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[C]=C(C[CH][O])CO[O](20372)'],
    products = ['[CH]=C(C[CH][O])CO[O](19320)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=C(C[CH][O])CO[O](19320)'],
    products = ['O(4)', '[CH]=C1COC([O])C1(20376)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH]=C(C=C[O])CO[O](19390)'],
    products = ['[CH]=C(C[CH][O])CO[O](19320)'],
    transitionState = 'TS15',
    kinetics = Arrhenius(A=(8.22e+08,'cm^3/(mol*s)'), n=1.533, Ea=(11.6377,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 192 used for Cd_R;HJ
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]O[O](46)', 'C#CC[CH][O](10201)'],
    products = ['[CH]=C(C[CH][O])CO[O](19320)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH]=C([CH][CH][O])CO[O](20378)'],
    products = ['[CH]=C(C[CH][O])CO[O](19320)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]O[O](46)', '[CH]=[C]C[CH][O](10195)'],
    products = ['[CH]=C(C[CH][O])CO[O](19320)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=C(C[CH][O])CO[O](19320)'],
    products = ['[CH]=C([CH]C[O])CO[O](20380)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=C(C[CH][O])CO[O](19320)'],
    products = ['[CH]=C([CH]OO)C[CH][O](20381)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]=C(C[CH][O])CO[O](19320)'],
    products = ['[CH]=C([CH][CH]O)CO[O](20383)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]=C(C[CH][O])CO[O](19320)'],
    products = ['[CH]=C([CH]O[O])CC[O](20384)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]=C(C[CH][O])CO[O](19320)'],
    products = ['[CH]=C([CH]O[O])C[CH]O(20385)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]=C(C[CH][O])CO[O](19320)'],
    products = ['[CH]=C([CH][CH][O])COO(20386)'],
...
network(
    label = 'PDepNetwork #4328',
    isomers = [
        '[CH]=C(C[CH][O])CO[O](19320)',
    ],
    reactants = [
