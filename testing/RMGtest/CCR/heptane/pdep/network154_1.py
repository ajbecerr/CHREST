...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.133716,'amu*angstrom^2'), symmetry=1, barrier=(35.0977,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133716,'amu*angstrom^2'), symmetry=1, barrier=(35.0977,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    label = '[CH2]C(=C)C[C]C(675)',
    structure = SMILES('[CH2]C(=C)C[C]C'),
    E0 = (520.357,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,649.502,649.529,649.581],'cm^-1')),
        HinderedRotor(inertia=(0.171262,'amu*angstrom^2'), symmetry=1, barrier=(3.93766,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.9979,0.0568976,-2.88423e-05,-1.96501e-09,4.48869e-12,62700.5,23.3492], Tmin=(100,'K'), Tmax=(1050.07,'K')), NASAPolynomial(coeffs=[13.3638,0.0269202,-1.04869e-05,1.91482e-09,-1.33202e-13,59159.2,-41.4094], Tmin=(1050.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(520.357,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01431,0.0278377,5.3579e-05,-8.15362e-08,3.08414e-11,10091.2,18.6652], Tmin=(100,'K'), Tmax=(995.703,'K')), NASAPolynomial(coeffs=[10.6202,0.0325249,-1.2625e-05,2.38894e-09,-1.72816e-13,6431.3,-32.5886], Tmin=(995.703,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(83.1923,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane)"""),
)
...
species(
    label = 'C[CH]C[C]1CC1(678)',
    structure = SMILES('C[CH]C[C]1CC1'),
    E0 = (341.559,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86797,0.042478,-1.01533e-05,-4.64951e-09,1.99415e-12,41160.3,24.9119], Tmin=(100,'K'), Tmax=(1432.08,'K')), NASAPolynomial(coeffs=[7.8873,0.0362356,-1.46865e-05,2.61493e-09,-1.73773e-13,38352.4,-10.0741], Tmin=(1432.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(341.559,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Tertalkyl) + radical(RCCJC)"""),
)

species(
    label = '[CH2][C]1CC(C)C1(679)',
...
species(
    ...
    E0 = (277.388,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,180,1107.95],'cm^-1')),
        HinderedRotor(inertia=(0.11879,'amu*angstrom^2'), symmetry=1, barrier=(2.73122,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0265662,'amu*angstrom^2'), symmetry=1, barrier=(23.0433,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117135,'amu*angstrom^2'), symmetry=1, barrier=(2.69316,'kJ/mol'), semiclassical=False),
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]C(16)', '[CH2]C([CH2])=C(285)'],
    products = ['[CH2]C(=C)C[CH]C(436)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(9.67813e+07,'m^3/(mol*s)'), n=-0.594572, Ea=(56.8079,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cd;Birad]
...
reaction(
    label = 'reaction5',
    reactants = ['[CH3](12)', '[CH]CC([CH2])=C(286)'],
    products = ['[CH2]C(=C)C[CH]C(436)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(15)', 'C=[C]C[CH]C(281)'],
    products = ['[CH2]C(=C)C[CH]C(436)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(9)', '[CH2]C(=C)C[C]C(675)'],
    products = ['[CH2]C(=C)C[CH]C(436)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]C([CH2])[CH][CH]C(440)'],
    products = ['[CH2]C(=C)C[CH]C(436)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(9)', '[CH2]C(=C)C=CC(680)'],
    products = ['[CH2]C(=C)C[CH]C(436)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(9)', '[CH2]C(=C)CC=C(681)'],
    products = ['[CH2]C(=C)C[CH]C(436)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(9)', '[CH2]C(=C)[CH][CH]C(682)'],
    products = ['[CH2]C(=C)C[CH]C(436)'],
