...
species(
    label = '[CH]C1[CH]CC([CH2])[CH]C1(14245)',
    structure = SMILES('[CH]C1[CH]CC([CH2])[CH]C1'),
    E0 = (834.87,'kJ/mol'),
    modes = [
...
species(
    label = '[CH]C=CCC([CH])C=C(14246)',
    structure = SMILES('[CH]C=CCC([CH])C=C'),
    E0 = (814.822,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2950,3100,1380,975,1025,1650,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0205605,0.0762024,-4.14773e-05,4.07308e-09,2.68204e-12,98153.2,35.2487], Tmin=(100,'K'), Tmax=(1118.99,'K')), NASAPolynomial(coeffs=[15.2377,0.0394405,-1.58365e-05,2.8801e-09,-1.97829e-13,93643.6,-44.8089], Tmin=(1118.99,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(814.822,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=CC[C]([CH2])C[CH2](14247)',
    structure = SMILES('[CH]C=CC[C]([CH2])C[CH2]'),
    E0 = (836.853,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,360,370,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.22686,0.0718055,-1.10121e-05,-9.42907e-08,9.18268e-11,100739,34.3084], Tmin=(100,'K'), Tmax=(483.441,'K')), NASAPolynomial(coeffs=[5.13934,0.0579387,-2.54037e-05,4.73345e-09,-3.26161e-13,100145,16.0401], Tmin=(483.441,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(836.853,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Tertalkyl) + radical(RCCJ) + radical(Isobutyl) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH][CH]C[CH]C([CH2])C=C(14248)',
    structure = SMILES('[CH][CH]C[CH]C([CH2])C=C'),
    E0 = (922.671,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,208.179,805.437,969.566,1131.16,1305.51,1497.4,1663.77],'cm^-1')),
        HinderedRotor(inertia=(0.14561,'amu*angstrom^2'), symmetry=1, barrier=(3.55283,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14561,'amu*angstrom^2'), symmetry=1, barrier=(3.55283,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14561,'amu*angstrom^2'), symmetry=1, barrier=(3.55283,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14561,'amu*angstrom^2'), symmetry=1, barrier=(3.55283,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14561,'amu*angstrom^2'), symmetry=1, barrier=(3.55283,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.625118,0.0779422,-6.69756e-05,3.58958e-08,-8.5828e-12,111090,39.0148], Tmin=(100,'K'), Tmax=(963.6,'K')), NASAPolynomial(coeffs=[7.79593,0.0481749,-2.06373e-05,3.83607e-09,-2.64976e-13,109708,4.68582], Tmin=(963.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(922.671,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(RCCJC) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C=C[CH]C([CH2])C[CH2](14249)',
    structure = SMILES('[CH]C=C[CH]C([CH2])C[CH2]'),
    E0 = (792.543,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.151769,0.0801981,-5.22922e-05,1.78291e-08,-2.51001e-12,95479.6,36.8305], Tmin=(100,'K'), Tmax=(1629.02,'K')), NASAPolynomial(coeffs=[16.3598,0.0396548,-1.49602e-05,2.55132e-09,-1.65395e-13,90100,-50.8854], Tmin=(1629.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(792.543,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Isobutyl) + radical(RCCJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH][CH]CC[C]([CH2])C=C(14250)',
    structure = SMILES('[CH][CH]CCC([CH2])=C[CH2]'),
    E0 = (806.497,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,350,440,435,1725,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.139355,0.0822285,-6.46742e-05,2.74755e-08,-4.87281e-12,97140.2,35.2866], Tmin=(100,'K'), Tmax=(1308.63,'K')), NASAPolynomial(coeffs=[13.8161,0.0404242,-1.67573e-05,3.06512e-09,-2.0953e-13,93560.6,-34.3749], Tmin=(1308.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(806.497,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(RCCJC) + radical(Allyl_P) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C=C[CH]C([CH2])[CH]C(14251)',
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.198447,0.0759811,-4.5475e-05,1.38085e-08,-1.73362e-12,94176.4,36.3386], Tmin=(100,'K'), Tmax=(1774.75,'K')), NASAPolynomial(coeffs=[15.5987,0.0412715,-1.61387e-05,2.7886e-09,-1.81302e-13,88710.1,-46.7931], Tmin=(1774.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(781.839,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_S) + radical(Allyl_S) + radical(Isobutyl) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C[CH]C[C]([CH2])C=C(14252)',
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.339162,0.0807838,-6.31336e-05,2.70901e-08,-4.94107e-12,97132,34.3981], Tmin=(100,'K'), Tmax=(1256.65,'K')), NASAPolynomial(coeffs=[12.0677,0.043451,-1.85712e-05,3.44924e-09,-2.37905e-13,94184.3,-24.8645], Tmin=(1256.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(806.509,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(Allyl_P) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]CCC([CH2])[C]=C(14253)',
    structure = SMILES('[CH][CH]CCC([CH2])[C]=C'),
    E0 = (965.971,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.303683,0.0849219,-8.44823e-05,5.23973e-08,-1.40115e-11,116309,38.0851], Tmin=(100,'K'), Tmax=(886.299,'K')), NASAPolynomial(coeffs=[8.79719,0.0465889,-1.96055e-05,3.59684e-09,-2.46065e-13,114804,-1.86584], Tmin=(886.299,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(965.971,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(Isobutyl) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C=[C]CC([CH2])C[CH2](14254)',
    structure = SMILES('[CH]C=[C]CC([CH2])C[CH2]'),
    E0 = (889.272,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3010,987.5,1337.5,450,1655,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.247222,0.0829083,-6.26087e-05,2.7202e-08,-5.15039e-12,107089,36.9585], Tmin=(100,'K'), Tmax=(1199.85,'K')), NASAPolynomial(coeffs=[10.4015,0.0490566,-2.02889e-05,3.68809e-09,-2.51069e-13,104653,-13.8802], Tmin=(1199.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(889.272,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(RCCJ) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C[CH]CC([CH2])[C]=C(14255)',
    structure = SMILES('[CH]C[CH]CC([CH2])[C]=C'),
    E0 = (965.983,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.599728,0.0815684,-7.16452e-05,2.81046e-08,2.03688e-12,116297,36.8948], Tmin=(100,'K'), Tmax=(622.563,'K')), NASAPolynomial(coeffs=[7.47636,0.0489878,-2.10999e-05,3.91302e-09,-2.69284e-13,115216,5.17213], Tmin=(622.563,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(965.983,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(Isobutyl) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C=[C]CC([CH2])[CH]C(14256)',
    structure = SMILES('[CH]C=[C]CC([CH2])[CH]C'),
    E0 = (878.568,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.563975,0.078986,-5.64776e-05,2.3763e-08,-4.54294e-12,105788,36.5951], Tmin=(100,'K'), Tmax=(1148.71,'K')), NASAPolynomial(coeffs=[7.96861,0.0532024,-2.28098e-05,4.22395e-09,-2.90651e-13,104087,-0.154767], Tmin=(1148.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(878.568,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cs_S) + radical(Isobutyl) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH][CH]CCC([CH2])C=[CH](14257)',
    structure = SMILES('[CH][CH]CCC([CH2])C=[CH]'),
    E0 = (975.225,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3120,650,792.5,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.252721,0.084034,-7.73064e-05,4.20852e-08,-9.74507e-12,117426,38.1926], Tmin=(100,'K'), Tmax=(1019.09,'K')), NASAPolynomial(coeffs=[10.5222,0.0437252,-1.79751e-05,3.2715e-09,-2.2329e-13,115333,-11.5456], Tmin=(1019.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(975.225,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(Isobutyl) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[CH][C]=CCC([CH2])C[CH2](14258)',
    structure = SMILES('[CH][C]=CCC([CH2])C[CH2]'),
    E0 = (889.272,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]C[CH]CC([CH2])C=[CH](14259)',
    structure = SMILES('[CH]C[CH]CC([CH2])C=[CH]'),
    E0 = (975.237,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.335644,0.0838911,-7.99673e-05,4.66879e-08,-1.17623e-11,117423,37.7286], Tmin=(100,'K'), Tmax=(935.702,'K')), NASAPolynomial(coeffs=[9.16367,0.0461525,-1.94698e-05,3.58482e-09,-2.46081e-13,115771,-4.27487], Tmin=(935.702,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(975.237,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(Isobutyl) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[CH][C]=CCC([CH2])[CH]C(14260)',
...
species(
    label = '[CH]C1[CH]CC(C=C)C1(14261)',
    structure = SMILES('[CH]C1[CH]CC(C=C)C1'),
    E0 = (590.512,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
...
species(
    label = '[CH]C=CCC(C)[C]=C(14272)',
    structure = SMILES('[CH]C=CCC(C)[C]=C'),
    E0 = (604.448,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.113074,0.0792039,-5.02771e-05,1.61224e-08,-2.10933e-12,72855.8,35.2217], Tmin=(100,'K'), Tmax=(1747.56,'K')), NASAPolynomial(coeffs=[18.0288,0.0376787,-1.46341e-05,2.52514e-09,-1.64133e-13,66515,-62.4292], Tmin=(1747.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(604.448,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=[C]CC(C)C=C(14273)',
...
species(
    label = '[C]=C[CH]CC([CH2])C=C(14275)',
    structure = SMILES('[C]C=CCC([CH2])C=C'),
    E0 = (870.482,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,315.773,315.793,315.806,315.814],'cm^-1')),
        HinderedRotor(inertia=(0.254373,'amu*angstrom^2'), symmetry=1, barrier=(18.0027,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.254357,'amu*angstrom^2'), symmetry=1, barrier=(18.0027,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.47394,'amu*angstrom^2'), symmetry=1, barrier=(104.343,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00158558,'amu*angstrom^2'), symmetry=1, barrier=(18.0028,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (106.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0816645,0.0765931,-5.3865e-05,1.49594e-08,4.07396e-14,104844,33.1462], Tmin=(100,'K'), Tmax=(1056.44,'K')), NASAPolynomial(coeffs=[15.9196,0.0318354,-1.19106e-05,2.112e-09,-1.43992e-13,100649,-48.1492], Tmin=(1056.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(870.482,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(CJ3)"""),
)

species(
    label = '[CH2]C(C=C)CC1C=C1(14276)',
    structure = SMILES('[CH2]C(C=C)CC1C=C1'),
    E0 = (470.853,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.117843,0.0754533,-4.58072e-05,7.45825e-09,2.33214e-12,56778.9,30.5711], Tmin=(100,'K'), Tmax=(1048.23,'K')), NASAPolynomial(coeffs=[15.0122,0.035698,-1.33607e-05,2.3678e-09,-1.61307e-13,52717.9,-46.4634], Tmin=(1048.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(470.853,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH]=C=CCC(C)C=C(13515)',
    structure = SMILES('C#C[CH]CC(C)C=C'),
    E0 = (320.481,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,2175,525,750,770,3400,2100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.156465,0.0756266,-4.48304e-05,3.8886e-09,4.69844e-12,38691.3,30.7602], Tmin=(100,'K'), Tmax=(969.999,'K')), NASAPolynomial(coeffs=[14.6431,0.0352385,-1.22986e-05,2.0963e-09,-1.40237e-13,34970.5,-43.381], Tmin=(969.999,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(320.481,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Sec_Propargyl)"""),
)
...
species(
    label = '[CH2]C1[CH]CC=C[CH]C1(14281)',
...
species(
    label = '[CH2]C1C=C[CH]CC1[CH2](14282)',
    structure = SMILES('[CH2]C1[CH]C=CCC1[CH2]'),
    E0 = (461.855,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27797,0.0372448,7.32211e-05,-1.20768e-07,4.91263e-11,55666.9,25.9793], Tmin=(100,'K'), Tmax=(945.542,'K')), NASAPolynomial(coeffs=[15.7946,0.0328244,-1.01759e-05,1.77628e-09,-1.28184e-13,50374,-56.7141], Tmin=(945.542,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(461.855,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclohexene) + radical(cyclohexene-allyl) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.129059,0.0788436,-4.70688e-05,5.39471e-09,3.34616e-12,64951.2,33.3918], Tmin=(100,'K'), Tmax=(1070.38,'K')), NASAPolynomial(coeffs=[17.3049,0.0342955,-1.35121e-05,2.47689e-09,-1.72385e-13,60038.8,-57.4155], Tmin=(1070.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(538.714,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Allyl_P) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CCCC([CH2])[C]=C(14287)',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]C=CCC([CH2])C=C(5666)'],
    products = ['[CH]C=CC[CH]CC=C(14244)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(6.55606e+10,'s^-1'), n=0.64, Ea=(159.935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [cCs(-HC)CJ;CsJ;C] for rate rule [cCs(-HC)CJ;CsJ-HH;C]
Euclidian distance = 1.0
family: 1,2_shiftC"""),
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]C1[CH]CC([CH2])[CH]C1(14245)'],
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]C(C=C)CC=C[CH2](5665)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C=CCC([CH])C=C(14246)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]C=CC[C]([CH2])C[CH2](14247)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH][CH]C[CH]C([CH2])C=C(14248)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(4.48818e+10,'s^-1'), n=0.34095, Ea=(22.3009,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Rn;Y_rad_NDe;XH_Rrad] + [R2radExo;Y_rad;XH_Rrad] for rate rule [R2radExo;Y_rad_NDe;XH_Rrad]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]C=C[CH]C([CH2])C[CH2](14249)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH][CH]CC[C]([CH2])C=C(14250)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]C=C[CH]C([CH2])[CH]C(14251)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]C[CH]C[C]([CH2])C=C(14252)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH][CH]CCC([CH2])[C]=C(14253)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]C=[C]CC([CH2])C[CH2](14254)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]C[CH]CC([CH2])[C]=C(14255)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]C=[C]CC([CH2])[CH]C(14256)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH][CH]CCC([CH2])C=[CH](14257)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH][C]=CCC([CH2])C[CH2](14258)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]C[CH]CC([CH2])C=[CH](14259)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH][C]=CCC([CH2])[CH]C(14260)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]C=CCC([CH2])C=C(5666)'],
    products = ['[CH]C1[CH]CC(C=C)C1(14261)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]C=CCC([CH2])C=C(5666)'],
    products = ['[CH]C=CCC1CC1[CH2](14262)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH]C=CCC(=C)C=C(14264)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C2H3(60)', '[CH]=C[CH]CC=C(13694)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C2H3(60)', '[CH]C=CC[CH][CH2](13799)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', '[CH]C=CC[C]([CH2])C=C(14265)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]C=[CH](13797)', '[CH2]C([CH2])C=C(496)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', '[CH]C=C[CH]C([CH2])C=C(14266)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', '[CH]C=CCC([CH2])[C]=C(14267)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(3)', '[CH]C=[C]CC([CH2])C=C(14268)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', '[CH][C]=CCC([CH2])C=C(14269)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(4.83014e+38,'s^-1'), n=-8.23851, Ea=(295.401,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.41826346251888336, var=21.571226466455663, Tref=1000.0, N=5, correlation='Root_1R!H->C_2R!H->C_N-5R!H->O_Ext-4R!H-R',), comment="""BM rule fitted to 2 training reactions at node Root_1R!H->C_2R!H->C_N-5R!H->O_Ext-4R!H-R
    Total Standard Deviation in ln(k): 10.36187210002245
Exact match found for rate rule [Root_1R!H->C_2R!H->C_N-5R!H->O_Ext-4R!H-R]
Euclidian distance = 0
family: Retroene"""),
...
reaction(
    label = 'reaction40',
    reactants = ['[CH]C=CC[C](C)C=C(14270)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH]C=CCC([CH2])C=C(5666)'],
    products = ['[CH]C=C[CH]C(C)C=C(14271)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH]C=CCC(C)[C]=C(14272)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH]C=[C]CC(C)C=C(14273)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH]=C=CCC(C)[CH][CH2](13735)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction47',
    reactants = ['C2H2(T)(1343)', '[CH]CC([CH2])C=C(4941)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction48',
    reactants = ['H(3)', '[C]=C[CH]CC([CH2])C=C(14275)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH]C=CCC([CH2])C=C(5666)'],
    products = ['[CH2]C(C=C)CC1C=C1(14276)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(3.31911e+11,'s^-1'), n=-0.0941588, Ea=(107.993,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R5_linear;doublebond_intra_pri_2H;radadd_intra_csHCd] + [R5_SS_D;doublebond_intra;radadd_intra_csHCd] + [R5_SS_D;doublebond_intra_pri_2H;radadd_intra_cs] for rate rule [R5_SS_D;doublebond_intra_pri_2H;radadd_intra_csHCd]
Euclidian distance = 2.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction57',
    reactants = ['[CH]C=CCC([CH2])C=C(5666)'],
    products = ['[CH2]C1[CH]CC=C[CH]C1(14281)'],
...
reaction(
    label = 'reaction59',
    reactants = ['[CH]C=CCC([CH2])C=C(5666)'],
    products = ['[CH2]C1C=C[CH]CC1[CH2](14282)'],
...
reaction(
    label = 'reaction60',
    reactants = ['H(3)', '[CH]=CC=CC([CH2])C=C(14283)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction61',
    reactants = ['H(3)', '[CH]=C=CCC([CH2])C=C(14284)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction62',
    reactants = ['C2H2(1342)', '[CH]CC([CH2])C=C(4941)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction65',
    reactants = ['[CH]=[C]CCC([CH2])C=C(14285)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction66',
    reactants = ['[CH2][C]=CCC([CH2])C=C(5695)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction67',
    reactants = ['[CH]C=CCC([CH2])C=C(5666)'],
    products = ['[CH]=CCC[C]([CH2])C=C(14286)'],
...
reaction(
    label = 'reaction68',
    reactants = ['[CH]=CCCC([CH2])[C]=C(14287)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
reaction(
    label = 'reaction70',
    reactants = ['[CH]=CCCC([CH2])C=[CH](14288)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
    transitionState = 'TS70',
    kinetics = Arrhenius(A=(61296.5,'s^-1'), n=1.90159, Ea=(35.9101,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R5H;Cd_rad_out_singleH;Cs_H_out] + [R5H_RSSR;Y_rad_out;Cs_H_out_H/OneDe] for rate rule [R5H_DSSS;Cd_rad_out_singleH;Cs_H_out_H/OneDe]
...
reaction(
    label = 'reaction72',
    reactants = ['[CH2]C=CCC([CH2])[C]=C(5694)'],
    products = ['[CH]C=CCC([CH2])C=C(5666)'],
...
network(
    label = 'PDepNetwork #3290',
    isomers = [
        '[CH]C=CCC([CH2])C=C(5666)',
    ],
    reactants = [
