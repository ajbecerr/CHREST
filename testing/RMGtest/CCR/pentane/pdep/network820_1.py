...
species(
    label = 'CC([O])[CH]CO[O](3532)',
    structure = SMILES('CC([O])[CH]CO[O]'),
    E0 = (177.684,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,266.035,266.178,1506.56],'cm^-1')),
        HinderedRotor(inertia=(0.00237941,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182163,'amu*angstrom^2'), symmetry=1, barrier=(9.14982,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182152,'amu*angstrom^2'), symmetry=1, barrier=(9.15003,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.182074,'amu*angstrom^2'), symmetry=1, barrier=(9.15019,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (103.097,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11857,0.0704627,-7.69117e-05,3.77928e-08,-6.96729e-13,21467.5,28.6962], Tmin=(100,'K'), Tmax=(596.287,'K')), NASAPolynomial(coeffs=[8.31438,0.0341557,-1.56748e-05,2.97609e-09,-2.06686e-13,20396.6,-4.08239], Tmin=(596.287,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(177.684,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(ROOJ) + radical(CCJCOOH)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.242193,0.0864669,-9.8594e-05,6.28272e-08,-1.64362e-11,47761,32.4642], Tmin=(100,'K'), Tmax=(921.702,'K')), NASAPolynomial(coeffs=[11.9543,0.0356394,-1.58774e-05,2.99907e-09,-2.08824e-13,45601.9,-23.0852], Tmin=(921.702,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(396.009,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(ROOJ) + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'CC([O])C1COOC1(3534)',
    structure = SMILES('CC([O])C1COOC1'),
    E0 = (-123.132,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.79117,0.0545513,1.55851e-05,-6.77622e-08,3.36456e-11,-14678.8,26.1537], Tmin=(100,'K'), Tmax=(901.494,'K')), NASAPolynomial(coeffs=[17.3991,0.0239645,-5.24244e-06,6.78538e-10,-4.2694e-14,-19424.7,-61.9623], Tmin=(901.494,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-123.132,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxolane) + radical(CC(C)OJ)"""),
)
...
species(
    label = 'CC([O])C1COC1(3536)',
    structure = SMILES('CC([O])C1COC1'),
    E0 = (-95.0311,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (101.124,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.37705,0.0448083,2.0729e-05,-6.33525e-08,3.02721e-11,-11323,22.5721], Tmin=(100,'K'), Tmax=(892.571,'K')), NASAPolynomial(coeffs=[13.464,0.0257471,-6.23428e-06,8.51231e-10,-5.27647e-14,-14879.1,-42.2002], Tmin=(892.571,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-95.0311,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)OJ)"""),
)
...
species(
    label = '[CH2]C(=C)C(C)[O](1875)',
    structure = SMILES('[CH2]C(=C)C(C)[O]'),
    E0 = (153.476,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,410.491,410.709],'cm^-1')),
        HinderedRotor(inertia=(0.000999741,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180816,'amu*angstrom^2'), symmetry=1, barrier=(21.637,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180915,'amu*angstrom^2'), symmetry=1, barrier=(21.6366,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01701,0.0753673,-5.95526e-05,-6.30566e-09,3.23654e-11,-26849.4,28.1398], Tmin=(100,'K'), Tmax=(530.955,'K')), NASAPolynomial(coeffs=[7.26649,0.0449421,-2.06527e-05,3.93296e-09,-2.7388e-13,-27747.9,-0.264813], Tmin=(530.955,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-224.053,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(ROOJ)"""),
)

species(
    label = 'C=C(COO)C(C)[O](3540)',
    structure = SMILES('C=C(COO)C(C)[O]'),
    E0 = (-79.6535,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.287274,0.0794884,-6.83108e-05,3.05873e-08,-5.60382e-12,-9444.81,31.7532], Tmin=(100,'K'), Tmax=(1285.22,'K')), NASAPolynomial(coeffs=[15.0498,0.0335429,-1.46873e-05,2.77191e-09,-1.93209e-13,-13239.4,-43.172], Tmin=(1285.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-79.6535,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CC(C)OJ)"""),
)

species(
    label = '[CH2]C(COO)C(C)=O(3541)',
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.128591,0.0981184,-0.000136257,1.1206e-07,-3.79277e-11,-19768.9,31.728], Tmin=(100,'K'), Tmax=(778.053,'K')), NASAPolynomial(coeffs=[9.38968,0.0436836,-2.07077e-05,3.96534e-09,-2.75562e-13,-21083.6,-10.7335], Tmin=(778.053,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-165.546,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CJC(C)C=O)"""),
)
...
species(
    ...
    E0 = (72.3512,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,308.156,308.156,3571.04],'cm^-1')),
        HinderedRotor(inertia=(0.10129,'amu*angstrom^2'), symmetry=1, barrier=(6.82549,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.284853,'amu*angstrom^2'), symmetry=1, barrier=(19.1951,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.187071,'amu*angstrom^2'), symmetry=1, barrier=(12.606,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.284855,'amu*angstrom^2'), symmetry=1, barrier=(19.1951,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
...
species(
    ...
    E0 = (-13.5418,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,3000,3100,440,815,1455,1000,228.994,1963.63],'cm^-1')),
        HinderedRotor(inertia=(0.217737,'amu*angstrom^2'), symmetry=1, barrier=(8.10877,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.218048,'amu*angstrom^2'), symmetry=1, barrier=(8.10994,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.218147,'amu*angstrom^2'), symmetry=1, barrier=(8.10939,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.218185,'amu*angstrom^2'), symmetry=1, barrier=(8.10929,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.218102,'amu*angstrom^2'), symmetry=1, barrier=(8.10945,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (116.115,'amu'),
...
species(
    ...
    E0 = (294.276,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,323.72,1473.54],'cm^-1')),
        HinderedRotor(inertia=(0.122737,'amu*angstrom^2'), symmetry=1, barrier=(8.97499,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.125116,'amu*angstrom^2'), symmetry=1, barrier=(8.99926,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(7.73757e-05,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.947063,'amu*angstrom^2'), symmetry=1, barrier=(68.601,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (343.787,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,256.724,907.204,2009.06],'cm^-1')),
        HinderedRotor(inertia=(0.0885939,'amu*angstrom^2'), symmetry=1, barrier=(3.35625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0885939,'amu*angstrom^2'), symmetry=1, barrier=(3.35625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0885939,'amu*angstrom^2'), symmetry=1, barrier=(3.35625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0885939,'amu*angstrom^2'), symmetry=1, barrier=(3.35625,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0885939,'amu*angstrom^2'), symmetry=1, barrier=(3.35625,'kJ/mol'), semiclassical=False),
...
species(
    ...
    E0 = (329.504,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.959147,0.0693517,-5.4273e-05,2.37716e-08,-4.51263e-12,16789.6,33.7198], Tmin=(100,'K'), Tmax=(1193.8,'K')), NASAPolynomial(coeffs=[9.654,0.0402182,-1.76668e-05,3.32904e-09,-2.31629e-13,14713.6,-9.76802], Tmin=(1193.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.705,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(ROOJ) + radical(C2CJCOOH)"""),
)

species(
    label = '[CH2]C(CO[O])[C](C)O(3543)',
    structure = SMILES('[CH2]C(CO[O])[C](C)O'),
    E0 = (99.1434,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.273098,0.101169,-0.000147057,1.20341e-07,-3.88563e-11,12071.2,34.6953], Tmin=(100,'K'), Tmax=(874.718,'K')), NASAPolynomial(coeffs=[10.3866,0.0387353,-1.6522e-05,2.96381e-09,-1.96394e-13,10730,-12.3116], Tmin=(874.718,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(99.1434,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH]OO)C(C)[O](3544)',
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0132271,0.0921938,-0.000106324,6.9577e-08,-1.87174e-11,22927.2,33.5489], Tmin=(100,'K'), Tmax=(897.713,'K')), NASAPolynomial(coeffs=[12.0024,0.0386553,-1.68669e-05,3.14391e-09,-2.16926e-13,20769.8,-23.1233], Tmin=(897.713,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(189.454,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCsJOOH) + radical(Isobutyl)"""),
)

species(
    label = 'C[C]([O])C(C)CO[O](3545)',
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.369635,0.0884925,-9.74712e-05,4.8794e-08,-1.72583e-12,15087.1,30.4796], Tmin=(100,'K'), Tmax=(602.349,'K')), NASAPolynomial(coeffs=[9.66656,0.0418662,-1.89913e-05,3.58361e-09,-2.47904e-13,13693,-11.9355], Tmin=(602.349,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(124.422,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(ROOJ) + radical(C2CsJOH)"""),
)

species(
    label = 'CC([O])C(C)[CH]O[O](3546)',
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.313376,0.0859302,-9.49455e-05,6.16295e-08,-1.68214e-11,16530.8,31.3568], Tmin=(100,'K'), Tmax=(876.53,'K')), NASAPolynomial(coeffs=[10.0969,0.0412818,-1.85361e-05,3.51225e-09,-2.44828e-13,14815.8,-14.5534], Tmin=(876.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(136.376,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(ROOJ) + radical(CCsJOOH)"""),
)

species(
    label = '[CH2][C](CO[O])C(C)O(3547)',
    structure = SMILES('[CH2][C](CO[O])C(C)O'),
    E0 = (113.426,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.246025,0.0972919,-0.000128417,9.5245e-08,-2.83953e-11,16278.3,35.8097], Tmin=(100,'K'), Tmax=(846.447,'K')), NASAPolynomial(coeffs=[12.4919,0.0350291,-1.44151e-05,2.57014e-09,-1.71092e-13,14196,-23.0823], Tmin=(846.447,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(134.105,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Isobutyl) + radical(CJCO)"""),
)

species(
    label = '[CH2]C([CH]O[O])C(C)O(3549)',
    structure = SMILES('[CH2]C([CH]O[O])C(C)O'),
    E0 = (111.098,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0943083,0.0948986,-0.000125739,9.64705e-08,-2.99688e-11,13504.8,34.7804], Tmin=(100,'K'), Tmax=(844.755,'K')), NASAPolynomial(coeffs=[10.8236,0.0381769,-1.60989e-05,2.90312e-09,-1.94407e-13,11839.5,-14.989], Tmin=(844.755,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(111.098,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCsJOOH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([O])C(C)CO[O](3550)',
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.147544,0.0885388,-9.86116e-05,6.2028e-08,-1.60952e-11,19304.8,32.4336], Tmin=(100,'K'), Tmax=(927.157,'K')), NASAPolynomial(coeffs=[11.88,0.0379227,-1.67234e-05,3.14753e-09,-2.18798e-13,17129.3,-23.2813], Tmin=(927.157,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(159.383,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(ROOJ) + radical(CJCO)"""),
)

species(
    label = '[CH2][C](COO)C(C)[O](3551)',
    structure = SMILES('[CH2][C](COO)C(C)[O]'),
    E0 = (191.782,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.590026,0.076041,-6.68443e-05,3.29649e-08,-6.85712e-12,23188,36.0701], Tmin=(100,'K'), Tmax=(1125.63,'K')), NASAPolynomial(coeffs=[11.2611,0.0381207,-1.63123e-05,3.03681e-09,-2.10154e-13,20785.7,-16.6744], Tmin=(1125.63,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(191.782,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CJCOOH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(COO)[C](C)[O](3552)',
    structure = SMILES('[CH2]C(COO)[C](C)[O]'),
    E0 = (177.499,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
    ...
    molecularWeight = (117.123,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0352705,0.09609,-0.000116226,7.24702e-08,-1.47772e-11,21486.9,32.9311], Tmin=(100,'K'), Tmax=(657.588,'K')), NASAPolynomial(coeffs=[11.4869,0.0393853,-1.74061e-05,3.23507e-09,-2.21641e-13,19682.1,-20.0271], Tmin=(657.588,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(177.499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([O])C([CH2])COO(3553)',
...
reaction(
    ...
    products = ['[CH2]C(CO[O])C(C)[O](3161)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(20)', 'CC([O])[CH]CO[O](3532)'],
    products = ['[CH2]C(CO[O])C(C)[O](3161)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O(4)', '[CH2]C([CH]C)CO[O](781)'],
    products = ['[CH2]C(CO[O])C(C)[O](3161)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]C(CO[O])C(C)[O](3533)'],
    products = ['[CH2]C(CO[O])C(C)[O](3161)'],
    transitionState = 'TS8',
...
reaction(
    ...
    kinetics = Arrhenius(A=(3.63066e+10,'s^-1'), n=0, Ea=(101.545,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4OO_SSS;Y_rad_intra;OO] for rate rule [R4OO_SSS;Y_rad_intra;OOJ]
Euclidian distance = 1.0
family: Cyclic_Ether_Formation
Ea raised from 101.4 to 101.5 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction14',
    reactants = ['[CH2]C(CO[O])C(C)[O](3161)'],
    products = ['HO2(9)', '[CH2]C(=C)C(C)[O](1875)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'C=C(CO[O])C(C)[O](2145)'],
    products = ['[CH2]C(CO[O])C(C)[O](3161)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH2]C(CO[O])C(C)=O(2143)'],
    products = ['[CH2]C(CO[O])C(C)[O](3161)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]O[O](46)', 'C=CC(C)[O](1578)'],
    products = ['[CH2]C(CO[O])C(C)[O](3161)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH3(17)', '[CH2]C(C=O)CO[O](2151)'],
    products = ['[CH2]C(CO[O])C(C)[O](3161)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O2(2)', '[CH2]C([CH2])C(C)[O](1658)'],
    products = ['[CH2]C(CO[O])C(C)[O](3161)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]O[O](46)', '[CH2][CH]C(C)[O](1587)'],
    products = ['[CH2]C(CO[O])C(C)[O](3161)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH2][C](CO[O])C(C)[O](2162)'],
    products = ['[CH2]C(CO[O])C(C)[O](3161)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CH3(17)', '[CH2]C([CH][O])CO[O](2132)'],
    products = ['[CH2]C(CO[O])C(C)[O](3161)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', '[CH2]C(CO[O])[C](C)[O](2157)'],
    products = ['[CH2]C(CO[O])C(C)[O](3161)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', '[CH2]C([CH]O[O])C(C)[O](2164)'],
    products = ['[CH2]C(CO[O])C(C)[O](3161)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', '[CH2]C([O])C([CH2])CO[O](1493)'],
    products = ['[CH2]C(CO[O])C(C)[O](3161)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C(CO[O])C(C)[O](3161)'],
    products = ['[CH2]C(CO[O])[C](C)O(3543)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]C(CO[O])C(C)[O](3161)'],
    products = ['[CH2]C([CH]OO)C(C)[O](3544)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH2]C(CO[O])C(C)[O](3161)'],
    products = ['[CH2][C](CO[O])C(C)O(3547)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]C(CO[O])C(C)[O](3161)'],
    products = ['[CH2]C(O)C([CH2])CO[O](3548)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]C(CO[O])C(C)[O](3161)'],
    products = ['[CH2]C([CH]O[O])C(C)O(3549)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2]C([O])C(C)CO[O](3550)'],
    products = ['[CH2]C(CO[O])C(C)[O](3161)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2][C](COO)C(C)[O](3551)'],
    products = ['[CH2]C(CO[O])C(C)[O](3161)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]C(COO)[C](C)[O](3552)'],
    products = ['[CH2]C(CO[O])C(C)[O](3161)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH2]C(CO[O])C(C)[O](3161)'],
    products = ['[CH2]C([O])C([CH2])COO(3553)'],
