species(
    ...
    E0 = (144.965,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2759.09,2768.18,2777.27,2786.36,2795.45,2804.55,2813.64,2822.73,2831.82,2840.91,2850,1350,1371.43,1392.86,1414.29,1435.71,1457.14,1478.57,1500,700,733.333,766.667,800,1000,1033.33,1066.67,1100,1350,1366.67,1383.33,1400,900,966.667,1033.33,1100,3000,3050,390,425,1340,1360,335,370,203.594,805.424,1628.75],'cm^-1')),
        HinderedRotor(inertia=(0.150169,'amu*angstrom^2'), symmetry=1, barrier=(3.57787,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150169,'amu*angstrom^2'), symmetry=1, barrier=(3.57787,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150169,'amu*angstrom^2'), symmetry=1, barrier=(3.57787,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150169,'amu*angstrom^2'), symmetry=1, barrier=(3.57787,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.150169,'amu*angstrom^2'), symmetry=1, barrier=(3.57787,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH]C(C)[CH]C(C)C(1280)',
    structure = SMILES('C[CH]C(C)[CH]C(C)C'),
    E0 = (141.618,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.193685,0.0831755,-4.55607e-05,1.17828e-08,-1.2066e-12,17191.6,37.5504], Tmin=(100,'K'), Tmax=(2215.64,'K')), NASAPolynomial(coeffs=[25.1762,0.0373739,-1.45528e-05,2.45282e-09,-1.53858e-13,5949.5,-105.028], Tmin=(2215.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(141.618,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Cs_S)"""),
)
...
species(
    label = 'C[C]C(C)C(C)[CH]C(1281)',
    structure = SMILES('C[C]C(C)C(C)[CH]C'),
    E0 = (398.638,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2759.09,2768.18,2777.27,2786.36,2795.45,2804.55,2813.64,2822.73,2831.82,2840.91,2850,1350,1371.43,1392.86,1414.29,1435.71,1457.14,1478.57,1500,700,733.333,766.667,800,1000,1033.33,1066.67,1100,1350,1366.67,1383.33,1400,900,966.667,1033.33,1100,3025,407.5,1350,352.5,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.402327,0.0875015,-5.56654e-05,1.78832e-08,-2.3502e-12,48110.9,36.3058], Tmin=(100,'K'), Tmax=(1727.34,'K')), NASAPolynomial(coeffs=[18.7451,0.0431616,-1.7161e-05,3.02233e-09,-1.99365e-13,41496.1,-66.5353], Tmin=(1727.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(398.638,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(527.969,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(CCJ2_triplet)"""),
)

species(
    label = 'CC1C(C)C(C)C1C(1282)',
    structure = SMILES('CC1C(C)C(C)C1C'),
    E0 = (-117.414,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.213,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.560137,0.0488341,7.98608e-05,-1.33028e-07,5.28284e-11,-13973.7,25.2178], Tmin=(100,'K'), Tmax=(972.241,'K')), NASAPolynomial(coeffs=[17.7701,0.0444783,-1.59391e-05,2.96019e-09,-2.15548e-13,-20460.8,-73.477], Tmin=(972.241,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-117.414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(565.384,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane)"""),
)
...
species(
    label = 'C[CH]C(C)C(C)=CC(1283)',
    structure = SMILES('C[CH]C(C)C(C)=CC'),
    E0 = (51.5913,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2759.09,2768.18,2777.27,2786.36,2795.45,2804.55,2813.64,2822.73,2831.82,2840.91,2850,1350,1371.43,1392.86,1414.29,1435.71,1457.14,1478.57,1500,700,733.333,766.667,800,1000,1033.33,1066.67,1100,1350,1366.67,1383.33,1400,900,966.667,1033.33,1100,350,440,435,1725,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,200,800],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.205,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0274864,0.0816472,-4.71937e-05,1.33469e-08,-1.53348e-12,6352.1,33.7153], Tmin=(100,'K'), Tmax=(1930.75,'K')), NASAPolynomial(coeffs=[18.5935,0.0431838,-1.73119e-05,3.02918e-09,-1.97517e-13,-817.251,-68.0699], Tmin=(1930.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.5913,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(532.126,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsCsH) + radical(Cs_S)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]C(C)C(C)[CH]C(1178)'],
    products = ['butene2t(396)', 'butene2t(396)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['C[CH]C(C)C(C)[CH]C(1178)'],
    products = ['C[CH]C(C)[CH]C(C)C(1280)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHCH3(T)(21)', 'C[CH]C(C)[CH]C(1190)'],
    products = ['C[CH]C(C)C(C)[CH]C(1178)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH]C(C)C(C)[CH]C(1195)'],
    products = ['C[CH]C(C)C(C)[CH]C(1178)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'C[C]C(C)C(C)[CH]C(1281)'],
    products = ['C[CH]C(C)C(C)[CH]C(1178)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'C[CH]C(C)C(C)=CC(1283)'],
    products = ['C[CH]C(C)C(C)[CH]C(1178)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C=CC(C)C(C)[CH]C(1284)'],
    products = ['C[CH]C(C)C(C)[CH]C(1178)'],
...
reaction(
    label = 'reaction12',
    reactants = ['C[CH][CH]C(1186)', 'butene2t(396)'],
    products = ['C[CH]C(C)C(C)[CH]C(1178)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(17)', 'C[CH]C(C)C=CC(1211)'],
    products = ['C[CH]C(C)C(C)[CH]C(1178)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C[CH][CH]C(1186)', 'C[CH][CH]C(1186)'],
    products = ['C[CH]C(C)C(C)[CH]C(1178)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(17)', 'C[CH][CH]C(C)[CH]C(1214)'],
    products = ['C[CH]C(C)C(C)[CH]C(1178)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', 'C[CH][C](C)C(C)[CH]C(1285)'],
    products = ['C[CH]C(C)C(C)[CH]C(1178)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2][CH]C(C)C(C)[CH]C(1286)'],
    products = ['C[CH]C(C)C(C)[CH]C(1178)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.45e+11,'s^-1'), n=0.6, Ea=(154.39,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""From training reaction 150 used for R2H_S;C_rad_out_H/NonDeC;Cs_H_out_Cs2
...
reaction(
    label = 'reaction20',
    reactants = ['C[CH]C(C)C(C)[CH]C(1178)'],
    products = ['[CH2]CC(C)C(C)[CH]C(1235)'],
    transitionState = 'TS20',
    kinetics = Arrhenius(A=(1.008e-10,'s^-1'), n=6.833, Ea=(117.248,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 33 used for R2H_S;C_rad_out_H/NonDeC;Cs_H_out_2H
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C([CH]C)C(C)CC(349)'],
    products = ['C[CH]C(C)C(C)[CH]C(1178)'],
...
network(
    ...
    isomers = [
        'C[CH]C(C)C(C)[CH]C(1178)',
    ],
    reactants = [
        ('butene2t(396)', 'butene2t(396)'),
    ],
    bathGas = {
        'Ar': 0.333333,
        'Ne': 0.333333,
