...
species(
    label = '[CH]=C(C[O])O[CH2](29604)',
    structure = SMILES('[CH]=C(C[O])O[CH2]'),
    E0 = (321.922,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3000,3100,440,815,1455,1000,3120,650,792.5,1650,180,318.44,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0154666,'amu*angstrom^2'), symmetry=1, barrier=(11.5307,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00618302,'amu*angstrom^2'), symmetry=1, barrier=(28.4418,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23708,'amu*angstrom^2'), symmetry=1, barrier=(28.443,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89006,0.0489876,-4.88178e-05,2.75198e-08,-6.5426e-12,38792.1,23.9443], Tmin=(100,'K'), Tmax=(993.737,'K')), NASAPolynomial(coeffs=[8.12519,0.0238894,-1.09324e-05,2.10327e-09,-1.48297e-13,37552.9,-6.0973], Tmin=(993.737,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(321.922,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCOJ) + radical(C=COCJ) + radical(Cds_P)"""),
)
...
species(
    label = '[C]=C(CO[O])O[CH2](29605)',
    structure = SMILES('[C]=C(CO[O])O[CH2]'),
    E0 = (630.733,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3000,3100,440,815,1455,1000,317.903,317.905,317.905],'cm^-1')),
        HinderedRotor(inertia=(0.00166805,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.1206,'amu*angstrom^2'), symmetry=1, barrier=(8.64885,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120599,'amu*angstrom^2'), symmetry=1, barrier=(8.64885,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00166803,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01031,0.069656,-9.92385e-05,7.48842e-08,-2.24787e-11,75963.7,27.7341], Tmin=(100,'K'), Tmax=(816.882,'K')), NASAPolynomial(coeffs=[10.965,0.0209137,-9.7404e-06,1.84793e-09,-1.27768e-13,74337.2,-18.2789], Tmin=(816.882,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(630.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(ROOJ) + radical(C=COCJ) + radical(CdCdJ2_triplet)"""),
)
...
species(
    label = '[CH]=C1COOCO1(29607)',
    structure = SMILES('[CH]=C1COOCO1'),
    E0 = (8.50273,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (101.081,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25464,0.0231667,0.00010964,-1.7971e-07,7.49608e-11,1155.54,18.4755], Tmin=(100,'K'), Tmax=(947.924,'K')), NASAPolynomial(coeffs=[30.2315,-0.00470459,4.35891e-06,-6.04782e-10,1.64329e-14,-8579.4,-142.143], Tmin=(947.924,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(8.50273,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(282.692,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclohexanone) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C1COCO1(29609)',
    structure = SMILES('[CH]=C1COCO1'),
    E0 = (-20.7505,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.14171,0.00504874,0.000135945,-2.04604e-07,8.58812e-11,-2395.37,18.0261], Tmin=(100,'K'), Tmax=(914.684,'K')), NASAPolynomial(coeffs=[27.2416,-0.0116531,1.07204e-05,-2.10173e-09,1.31827e-13,-10880.1,-122.109], Tmin=(914.684,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-20.7505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(257.749,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsOsHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(20)', '[CH]=C([O])CO[O](19306)'],
    products = ['[CH]=C(CO[O])O[CH2](28921)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['O(4)', '[CH]=C(C[O])O[CH2](29604)'],
    products = ['[CH]=C(CO[O])O[CH2](28921)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]OC(=[CH])CO[O](20619)'],
    products = ['[CH]=C(CO[O])O[CH2](28921)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[C]=C(CO[O])O[CH2](29605)'],
    products = ['[CH]=C(CO[O])O[CH2](28921)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2]O[O](46)', 'C#CO[CH2](3066)'],
    products = ['[CH]=C(CO[O])O[CH2](28921)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]O[O](46)', '[CH]=[C]O[CH2](9647)'],
    products = ['[CH]=C(CO[O])O[CH2](28921)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]=C(CO[O])O[CH2](28921)'],
    products = ['[CH]=C([CH]OO)O[CH2](29611)'],
...
network(
    label = 'PDepNetwork #7766',
    isomers = [
        '[CH]=C(CO[O])O[CH2](28921)',
    ],
    reactants = [
