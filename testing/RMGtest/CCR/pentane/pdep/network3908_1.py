...
species(
    label = '[C]=[C]CC(C)[O](17809)',
    structure = SMILES('[C]=[C]CC(C)[O]'),
    E0 = (813.532,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,338.647,338.671,338.675],'cm^-1')),
        HinderedRotor(inertia=(0.00146988,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112563,'amu*angstrom^2'), symmetry=1, barrier=(9.16139,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112556,'amu*angstrom^2'), symmetry=1, barrier=(9.16143,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5824,0.0569407,-6.3532e-05,4.19109e-08,-1.17007e-11,97929.1,24.0305], Tmin=(100,'K'), Tmax=(855.031,'K')), NASAPolynomial(coeffs=[7.74213,0.0281238,-1.29772e-05,2.49283e-09,-1.75137e-13,96875.7,-4.72181], Tmin=(855.031,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(813.532,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(Cds_S) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7643,0.0407162,-8.84458e-06,-1.17886e-08,5.35792e-12,12004.7,21.7015], Tmin=(100,'K'), Tmax=(1200.6,'K')), NASAPolynomial(coeffs=[11.6906,0.0254813,-1.20947e-05,2.38999e-09,-1.7109e-13,8335.72,-33.3557], Tmin=(1200.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(99.0866,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C=CC(C)O(17811)',
    structure = SMILES('[CH]=C=CC(C)O'),
    E0 = (105.727,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33162,0.0513994,-3.07684e-05,3.05823e-10,4.64371e-12,12818.6,24.4081], Tmin=(100,'K'), Tmax=(967.961,'K')), NASAPolynomial(coeffs=[13.0027,0.01951,-6.67249e-06,1.14983e-09,-7.85097e-14,9793.69,-35.4721], Tmin=(967.961,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(105.727,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ)"""),
)

species(
    label = '[CH]=[C]CC(C)=O(15785)',
    structure = SMILES('[CH]=[C]CC(C)=O'),
    E0 = (336.928,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,1685,370,3120,650,792.5,1650,699.992],'cm^-1')),
        HinderedRotor(inertia=(0.00173247,'amu*angstrom^2'), symmetry=1, barrier=(19.6706,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.855857,'amu*angstrom^2'), symmetry=1, barrier=(19.6778,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.854357,'amu*angstrom^2'), symmetry=1, barrier=(19.6433,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.85735,0.0435597,-2.64071e-05,6.8591e-09,-6.6032e-13,40603.4,21.862], Tmin=(100,'K'), Tmax=(1938.46,'K')), NASAPolynomial(coeffs=[17.6695,0.0149515,-7.38059e-06,1.38542e-09,-9.23641e-14,33717.8,-66.8366], Tmin=(1938.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(336.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]C[C](C)[O](17643)',
    structure = SMILES('[CH]=[C]C[C](C)[O]'),
    E0 = (679.154,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,1685,370,3120,650,792.5,1650,328.042,328.08],'cm^-1')),
        HinderedRotor(inertia=(0.100029,'amu*angstrom^2'), symmetry=1, barrier=(7.64148,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100085,'amu*angstrom^2'), symmetry=1, barrier=(7.64001,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100146,'amu*angstrom^2'), symmetry=1, barrier=(7.64082,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50509,0.0608802,-6.94654e-05,3.61393e-08,-2.02773e-12,81767.6,23.7898], Tmin=(100,'K'), Tmax=(602.259,'K')), NASAPolynomial(coeffs=[8.14814,0.0273823,-1.24924e-05,2.36057e-09,-1.63269e-13,80774.8,-6.49005], Tmin=(602.259,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(679.154,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06677,0.0688809,-9.39823e-05,7.47832e-08,-2.42223e-11,54078.8,25.5121], Tmin=(100,'K'), Tmax=(813.111,'K')), NASAPolynomial(coeffs=[8.43766,0.0287516,-1.28155e-05,2.38264e-09,-1.62614e-13,53008.1,-7.73674], Tmin=(813.111,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(448.793,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C2CsJOH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]CC([CH2])O(15966)',
    structure = SMILES('[CH]=[C]CC([CH2])O'),
    E0 = (483.755,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,312.126],'cm^-1')),
        HinderedRotor(inertia=(0.00173274,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.154663,'amu*angstrom^2'), symmetry=1, barrier=(10.7798,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.155371,'amu*angstrom^2'), symmetry=1, barrier=(10.7574,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156036,'amu*angstrom^2'), symmetry=1, barrier=(10.7713,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1743,0.064005,-7.15675e-05,4.42745e-08,-1.11584e-11,58282.4,26.3409], Tmin=(100,'K'), Tmax=(959.034,'K')), NASAPolynomial(coeffs=[10.4971,0.0251212,-1.07511e-05,1.99878e-09,-1.38109e-13,56494.2,-18.2466], Tmin=(959.034,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(483.755,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJCO) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC[C](C)[O](17813)',
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42509,0.058303,-5.59497e-05,3.01888e-08,-6.81621e-12,53169,23.5646], Tmin=(100,'K'), Tmax=(1048.42,'K')), NASAPolynomial(coeffs=[9.47033,0.0276088,-1.20356e-05,2.26529e-09,-1.57848e-13,51482,-15.6296], Tmin=(1048.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(441.312,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH]=[C]CC[O](15174)'],
    products = ['[CH]=[C]CC(C)[O](15967)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=[CH](9646)', '[CH2]C(C)[O](667)'],
    products = ['[CH]=[C]CC(C)[O](15967)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[C]=[C]CC(C)[O](17809)'],
    products = ['[CH]=[C]CC(C)[O](15967)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]=[C]CC(C)=O(15785)'],
    products = ['[CH]=[C]CC(C)[O](15967)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.0201871,'m^3/(mol*s)'), n=2.2105, Ea=(65.8673,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO-CsH_O;YJ] for rate rule [CO-CsH_O;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 61.8 to 65.9 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction13',
    reactants = ['CH3(17)', 'C#CC[CH][O](10201)'],
    products = ['[CH]=[C]CC(C)[O](15967)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(17)', '[CH]=[C]C[CH][O](10195)'],
    products = ['[CH]=[C]CC(C)[O](15967)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH]=[C]C[C](C)[O](17643)'],
    products = ['[CH]=[C]CC(C)[O](15967)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH]=[C]CC([CH2])[O](15961)'],
    products = ['[CH]=[C]CC(C)[O](15967)'],
