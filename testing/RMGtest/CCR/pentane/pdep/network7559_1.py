...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.66087,0.015559,6.64979e-05,-9.99653e-08,4.18766e-11,-15470.7,13.5545], Tmin=(100,'K'), Tmax=(882.054,'K')), NASAPolynomial(coeffs=[9.94135,0.019544,-3.20185e-06,2.72481e-10,-1.29835e-14,-18194.4,-28.8151], Tmin=(882.054,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-129.141,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane)"""),
)

species(
    label = 'C=C(C)CO(28995)',
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95509,0.0423414,-2.54718e-05,7.93254e-09,-1.03317e-12,-22303.3,19.0183], Tmin=(100,'K'), Tmax=(1694.45,'K')), NASAPolynomial(coeffs=[9.55837,0.0243929,-9.58312e-06,1.68135e-09,-1.10871e-13,-24880,-21.6729], Tmin=(1694.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-186.067,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)

species(
    label = 'CC(C)C=O(28996)',
...
species(
    ...
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.99129,0.0319806,-1.23568e-05,1.2616e-09,8.4544e-14,4794.29,16.1339], Tmin=(100,'K'), Tmax=(2274.01,'K')), NASAPolynomial(coeffs=[16.8271,0.0155274,-6.70428e-06,1.12907e-09,-6.84994e-14,-3536.7,-66.4645], Tmin=(2274.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(39.638,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCOJ)"""),
)
...
species(
    label = '[CH2][C](C)C[O](28998)',
    structure = SMILES('[CH2][C](C)C[O]'),
    E0 = (270.188,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3100,440,815,1455,1000,1080.19,1084.65],'cm^-1')),
        HinderedRotor(inertia=(0.149228,'amu*angstrom^2'), symmetry=1, barrier=(3.43105,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00409111,'amu*angstrom^2'), symmetry=1, barrier=(3.41757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.147296,'amu*angstrom^2'), symmetry=1, barrier=(3.38663,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.59418,0.0339532,-1.48348e-05,2.79738e-09,-1.88112e-13,32543.6,19.9031], Tmin=(100,'K'), Tmax=(2446.28,'K')), NASAPolynomial(coeffs=[15.5824,0.0160575,-5.9107e-06,9.2379e-10,-5.37073e-14,25189.1,-56.4202], Tmin=(2446.28,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.188,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32035,0.0348488,-9.55709e-06,-2.53964e-09,1.19172e-12,7892.53,18.4434], Tmin=(100,'K'), Tmax=(1566.85,'K')), NASAPolynomial(coeffs=[8.47418,0.0281905,-1.18484e-05,2.12232e-09,-1.40418e-13,4853,-17.5545], Tmin=(1566.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJ(C)CO)"""),
)

species(
    label = '[CH2]C(C)[CH]O(29000)',
    structure = SMILES('[CH2]C(C)[CH]O'),
    E0 = (72.2072,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48616,0.0544228,-5.31333e-05,3.03867e-08,-7.16883e-12,8775.77,22.3819], Tmin=(100,'K'), Tmax=(1020.78,'K')), NASAPolynomial(coeffs=[9.16144,0.0243467,-8.93751e-06,1.52266e-09,-9.97149e-14,7208.82,-14.8047], Tmin=(1020.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(72.2072,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(Isobutyl)"""),
)

species(
    label = 'CC(C)[CH][O](29001)',
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.77223,0.034517,3.3118e-05,-1.54124e-07,1.44708e-10,11201.1,16.3795], Tmin=(100,'K'), Tmax=(401.365,'K')), NASAPolynomial(coeffs=[3.89239,0.0355146,-1.60592e-05,3.05007e-09,-2.12537e-13,11013.2,10.7776], Tmin=(401.365,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(92.83,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = '[CH2][C](C)CO(29002)',
    ...
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92241,0.0402915,-1.5082e-05,-5.64317e-09,4.51227e-12,5429.62,21.4606], Tmin=(100,'K'), Tmax=(998.33,'K')), NASAPolynomial(coeffs=[8.5056,0.0251035,-9.07341e-06,1.5707e-09,-1.05493e-13,3557.6,-13.081], Tmin=(998.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(44.4832,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH2])CO(28709)',
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.129586,'amu*angstrom^2'), symmetry=1, barrier=(2.97943,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123974,'amu*angstrom^2'), symmetry=1, barrier=(2.85041,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110372,'amu*angstrom^2'), symmetry=1, barrier=(2.53767,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0049673,'amu*angstrom^2'), symmetry=1, barrier=(2.68225,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.1057,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.78752,0.0471031,-3.29592e-05,7.73741e-09,2.14222e-12,11746.7,22.8457], Tmin=(100,'K'), Tmax=(825.251,'K')), NASAPolynomial(coeffs=[8.52599,0.0238554,-7.81411e-06,1.24685e-09,-7.8926e-14,10313.9,-10.3114], Tmin=(825.251,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(96.9916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]CC[O](677)'],
    products = ['[CH2]C(C)C[O](3237)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', 'C[CH]C[O](1360)'],
    products = ['[CH2]C(C)C[O](3237)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C(C)C[O](28994)'],
    products = ['[CH2]C(C)C[O](3237)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH2]C(C)C=O(1648)'],
    products = ['[CH2]C(C)C[O](3237)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(17)', '[CH2][CH]C[O](1367)'],
    products = ['[CH2]C(C)C[O](3237)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2][C](C)C[O](28998)'],
    products = ['[CH2]C(C)C[O](3237)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH2]C([CH2])C[O](3328)'],
    products = ['[CH2]C(C)C[O](3237)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH2]C(C)[CH][O](1637)'],
    products = ['[CH2]C(C)C[O](3237)'],
