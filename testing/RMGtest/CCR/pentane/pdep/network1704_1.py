...
species(
    label = '[CH][CH]C([CH2])[CH]C(9481)',
    structure = SMILES('[CH][CH]C([CH2])[CH]C'),
    E0 = (848.17,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,235.266,481.201,1227.77,3079.97,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0422605,'amu*angstrom^2'), symmetry=1, barrier=(1.51645,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0422605,'amu*angstrom^2'), symmetry=1, barrier=(1.51645,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0422605,'amu*angstrom^2'), symmetry=1, barrier=(1.51645,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0422605,'amu*angstrom^2'), symmetry=1, barrier=(1.51645,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0422605,'amu*angstrom^2'), symmetry=1, barrier=(1.51645,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68559,0.0540906,-3.9245e-05,1.72426e-08,-3.50381e-12,102092,30.0252], Tmin=(100,'K'), Tmax=(1077.64,'K')), NASAPolynomial(coeffs=[6.12608,0.0376087,-1.63036e-05,3.05051e-09,-2.1146e-13,101135,8.27029], Tmin=(1077.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(848.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Cs_S) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C([O])C([CH2])[C]C(9482)',
    structure = SMILES('[CH]C([O])C([CH2])[C]C'),
    E0 = (965.191,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.363271,0.0770516,-7.85264e-05,4.29117e-08,-9.39687e-12,116219,31.7243], Tmin=(100,'K'), Tmax=(1108.3,'K')), NASAPolynomial(coeffs=[14.3608,0.0265327,-1.0153e-05,1.7837e-09,-1.19614e-13,113116,-37.2452], Tmin=(1108.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(965.191,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(Isobutyl) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([O])C([CH])[CH]C(9483)',
    structure = SMILES('[CH]C([O])C([CH])[CH]C'),
    E0 = (954.651,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.821571,0.0707421,-6.53221e-05,3.26487e-08,-6.76167e-12,114932,31.9557], Tmin=(100,'K'), Tmax=(1140.22,'K')), NASAPolynomial(coeffs=[11.9363,0.0317505,-1.40271e-05,2.6573e-09,-1.85843e-13,112397,-23.1247], Tmin=(1140.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(954.651,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(Cs_S) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([O])C1CC1C(9484)',
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00089,0.0490308,1.63242e-05,-5.95072e-08,2.71254e-11,55298.6,26.3281], Tmin=(100,'K'), Tmax=(965.37,'K')), NASAPolynomial(coeffs=[17.1014,0.0234972,-7.98524e-06,1.46654e-09,-1.07621e-13,50271.3,-60.7183], Tmin=(965.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(458.754,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)OJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1OC(C)C1[CH2](9455)',
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20622,0.046936,2.37614e-05,-7.48234e-08,3.7134e-11,54394.5,24.6699], Tmin=(100,'K'), Tmax=(871.934,'K')), NASAPolynomial(coeffs=[15.9074,0.0209711,-2.92436e-06,1.35811e-10,-3.91887e-16,50254.1,-53.2816], Tmin=(871.934,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(451.31,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(369.994,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1OCC1[CH]C(6954)',
...
species(
    label = '[CH]C([O])C(=C)CC(7056)',
    structure = SMILES('[CH]C([O])C(=C)CC'),
    E0 = (427.547,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.507492,0.0664977,-4.0893e-05,4.73692e-09,3.05264e-12,51556.6,30.3642], Tmin=(100,'K'), Tmax=(1059.32,'K')), NASAPolynomial(coeffs=[15.8703,0.026781,-1.05578e-05,1.94805e-09,-1.36523e-13,47275.4,-49.4824], Tmin=(1059.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(427.547,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([O])C(C)=CC(7270)',
    structure = SMILES('[CH]C([O])C(C)=CC'),
    E0 = (414.167,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.614202,0.0689367,-5.43669e-05,2.22213e-08,-3.69841e-12,49939.1,28.8763], Tmin=(100,'K'), Tmax=(1411.72,'K')), NASAPolynomial(coeffs=[14.7153,0.0289827,-1.19145e-05,2.17379e-09,-1.48244e-13,45957.7,-44.0154], Tmin=(1411.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(414.167,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(CC(C)OJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(O)C([CH2])=CC(9485)',
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.181603,0.0735085,-6.20258e-05,2.67358e-08,-4.58121e-12,40474.1,30.9086], Tmin=(100,'K'), Tmax=(1405.35,'K')), NASAPolynomial(coeffs=[17.6406,0.0238154,-8.98572e-06,1.57469e-09,-1.05253e-13,35566.9,-59.2621], Tmin=(1405.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(335.305,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.274093,0.0732604,-6.52851e-05,3.09955e-08,-5.87701e-12,49305.5,32.8414], Tmin=(100,'K'), Tmax=(1277.98,'K')), NASAPolynomial(coeffs=[15.7054,0.0249616,-8.59577e-06,1.42329e-09,-9.20828e-14,45361.3,-45.3909], Tmin=(1277.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(408.773,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([O])C([CH2])=CC(9486)',
    structure = SMILES('[CH]C([O])C([CH2])=CC'),
    E0 = (565.666,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.480048,0.068029,-5.14623e-05,1.64319e-08,-1.05402e-12,68168.6,29.6383], Tmin=(100,'K'), Tmax=(1106.19,'K')), NASAPolynomial(coeffs=[16.1471,0.0242792,-9.63336e-06,1.7672e-09,-1.22799e-13,63913,-51.0957], Tmin=(1106.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(565.666,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(CC(C)OJ) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][C]([O])C([CH2])[CH]C(7168)',
    structure = SMILES('[CH][C]([O])C([CH2])[CH]C'),
    E0 = (888.146,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,360,370,350,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.85693,0.0758597,-8.25418e-05,4.11699e-08,-1.90121e-12,106926,32.0791], Tmin=(100,'K'), Tmax=(618.82,'K')), NASAPolynomial(coeffs=[9.19202,0.0350469,-1.52809e-05,2.82501e-09,-1.93044e-13,105645,-6.15373], Tmin=(618.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(888.146,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(Cs_S) + radical(C2CsJOH) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C([O])[C]([CH2])CC(7057)',
    structure = SMILES('[CH]C([O])[C]([CH2])CC'),
    E0 = (669.55,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.456184,0.0700015,-5.65689e-05,2.44471e-08,-4.29026e-12,80662.5,31.6844], Tmin=(100,'K'), Tmax=(1357.32,'K')), NASAPolynomial(coeffs=[14.6156,0.0282741,-1.04551e-05,1.7977e-09,-1.18559e-13,76818.7,-40.9524], Tmin=(1357.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(669.55,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJ(C)CO) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C([O])C([CH2])C[CH2](7059)',
    structure = SMILES('[CH]C([O])C([CH2])C[CH2]'),
    E0 = (722.223,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2850,1437.5,1250,1305,750,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.459057,0.074658,-6.91948e-05,3.50779e-08,-7.24055e-12,86993.5,33.2613], Tmin=(100,'K'), Tmax=(1162.43,'K')), NASAPolynomial(coeffs=[13.4273,0.0300336,-1.16119e-05,2.05366e-09,-1.38165e-13,83978.6,-31.255], Tmin=(1162.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(722.223,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(Isobutyl) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C]([O])C([CH2])CC(7058)',
    structure = SMILES('[CH][C]([O])C([CH2])CC'),
    E0 = (693.604,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.409458,0.080894,-8.9252e-05,5.61674e-08,-1.44939e-11,83548.9,31.0843], Tmin=(100,'K'), Tmax=(936.514,'K')), NASAPolynomial(coeffs=[11.4287,0.0338303,-1.38726e-05,2.50909e-09,-1.70229e-13,81485,-21.3545], Tmin=(936.514,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(693.604,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C]([O])C(C)[CH]C(7272)',
    structure = SMILES('[CH][C]([O])C(C)[CH]C'),
    E0 = (683.064,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,360,370,350,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.787776,0.0754384,-7.86659e-05,4.88951e-08,-1.30093e-11,82265.2,30.5104], Tmin=(100,'K'), Tmax=(889.988,'K')), NASAPolynomial(coeffs=[8.79829,0.0394359,-1.79871e-05,3.44251e-09,-2.41615e-13,80839.3,-7.20213], Tmin=(889.988,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(683.064,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(Cs_S) + radical(C2CsJOH) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(O)[C]([CH2])[CH]C(9489)',
    structure = SMILES('[CH]C(O)[C]([CH2])[CH]C'),
    E0 = (633.731,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.869401,0.0682955,-5.85135e-05,2.82545e-08,-5.73351e-12,76333.5,32.9464], Tmin=(100,'K'), Tmax=(1156.65,'K')), NASAPolynomial(coeffs=[10.8234,0.0338727,-1.38732e-05,2.52544e-09,-1.7251e-13,74030.7,-16.5248], Tmin=(1156.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(633.731,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(Cs_S) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(O)C([CH2])[CH][CH2](9473)',
    structure = SMILES('[CH]C(O)C([CH2])[CH][CH2]'),
    E0 = (686.404,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,214.13,902.764,1189.82,1606.55,1972.88],'cm^-1')),
        HinderedRotor(inertia=(0.112249,'amu*angstrom^2'), symmetry=1, barrier=(3.28644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112249,'amu*angstrom^2'), symmetry=1, barrier=(3.28644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112249,'amu*angstrom^2'), symmetry=1, barrier=(3.28644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112249,'amu*angstrom^2'), symmetry=1, barrier=(3.28644,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.112249,'amu*angstrom^2'), symmetry=1, barrier=(3.28644,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.67769,0.0750802,-7.78396e-05,4.66072e-08,-1.16015e-11,82673.3,35.2327], Tmin=(100,'K'), Tmax=(962.704,'K')), NASAPolynomial(coeffs=[10.4872,0.0343208,-1.43298e-05,2.62562e-09,-1.79791e-13,80784.6,-11.7193], Tmin=(962.704,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(686.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Isobutyl) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    ...
    products = ['ketene(T)(1373)', 'm1_allyl(186)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C([O])C(C)[CH][CH2](4398)'],
    products = ['[CH]C([O])C([CH2])[CH]C(4439)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]C([O])C([CH2])[CH]C(4439)'],
    products = ['[CH]C([O])C[CH][CH]C(4451)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHCH3(T)(21)', '[CH]C([O])[CH][CH2](6994)'],
    products = ['[CH]C([O])C([CH2])[CH]C(4439)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', '[CH]C([O])[CH][CH]C(7033)'],
    products = ['[CH]C([O])C([CH2])[CH]C(4439)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Y_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction6',
    reactants = ['O(4)', '[CH][CH]C([CH2])[CH]C(9481)'],
    products = ['[CH]C([O])C([CH2])[CH]C(4439)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH3(17)', '[CH]C([CH2])C([CH])[O](7233)'],
    products = ['[CH]C([O])C([CH2])[CH]C(4439)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]C([O])C([CH2])[C]C(9482)'],
    products = ['[CH]C([O])C([CH2])[CH]C(4439)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH]C([O])C([CH])[CH]C(9483)'],
    products = ['[CH]C([O])C([CH2])[CH]C(4439)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]C([O])C([CH2])[CH]C(4439)'],
    products = ['[CH]C1OC(C)C1[CH2](9455)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]C([O])C([CH2])[CH]C(4439)'],
    products = ['[CH]C(O)C([CH2])C=C(6960)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH]C([O])C([CH2])=CC(9486)'],
    products = ['[CH]C([O])C([CH2])[CH]C(4439)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH](6993)', '[CH2]C([CH]C)C=O(3827)'],
    products = ['[CH]C([O])C([CH2])[CH]C(4439)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH2(T)(20)', '[CH]C([O])C=CC(7032)'],
    products = ['[CH]C([O])C([CH2])[CH]C(4439)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CHCH3(T)(21)', '[CH]C([O])C=C(6928)'],
    products = ['[CH]C([O])C([CH2])[CH]C(4439)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH][CH][O](6986)', 'm1_allyl(186)'],
    products = ['[CH]C([O])C([CH2])[CH]C(4439)'],
...
reaction(
    label = 'reaction27',
    reactants = ['ketene(T)(1373)', '[CH2][CH][CH]C(3856)'],
    products = ['[CH]C([O])C([CH2])[CH]C(4439)'],
    transitionState = 'TS27',
    kinetics = Arrhenius(A=(2339.95,'m^3/(mol*s)'), n=0.573452, Ea=(110.734,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 106.1 to 110.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction28',
    reactants = ['[CH][CH][O](6986)', '[CH2][CH][CH]C(3856)'],
    products = ['[CH]C([O])C([CH2])[CH]C(4439)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', '[CH]C([O])[C]([CH2])[CH]C(9487)'],
    products = ['[CH]C([O])C([CH2])[CH]C(4439)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', '[CH][C]([O])C([CH2])[CH]C(7168)'],
    products = ['[CH]C([O])C([CH2])[CH]C(4439)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]C([O])C([CH2])[CH]C(4439)'],
    products = ['[CH][C](O)C([CH2])[CH]C(9488)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]C([O])C([CH2])C[CH2](7059)'],
    products = ['[CH]C([O])C([CH2])[CH]C(4439)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH]C([O])C([CH2])[CH]C(4439)'],
    products = ['[CH]C(O)[C]([CH2])[CH]C(9489)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH]C([O])C([CH2])[CH]C(4439)'],
    products = ['[CH]C(O)C([CH2])[CH][CH2](9473)'],
...
network(
    ...
    isomers = [
        '[CH]C([O])C([CH2])[CH]C(4439)',
    ],
    reactants = [
        ('ketene(T)(1373)', 'm1_allyl(186)'),
    ],
    bathGas = {
        'Ar': 0.333333,
        'Ne': 0.333333,
