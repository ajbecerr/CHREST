...
species(
    label = '[CH]OC[CH]C(3249)',
    structure = SMILES('[CH]OC[CH]C'),
    E0 = (401.285,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,180,180,799.54,2768.39,3200],'cm^-1')),
        HinderedRotor(inertia=(0.0533375,'amu*angstrom^2'), symmetry=1, barrier=(1.22633,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0533375,'amu*angstrom^2'), symmetry=1, barrier=(1.22633,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0533375,'amu*angstrom^2'), symmetry=1, barrier=(1.22633,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0533375,'amu*angstrom^2'), symmetry=1, barrier=(1.22633,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (71.0978,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01998,0.0443966,-3.35999e-05,1.36877e-08,-2.37406e-12,48333.8,20.8324], Tmin=(100,'K'), Tmax=(1305.08,'K')), NASAPolynomial(coeffs=[8.49739,0.0245434,-1.07812e-05,2.03122e-09,-1.41116e-13,46643.1,-12.142], Tmin=(1305.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(401.285,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCJCO) + radical(CH2_triplet)"""),
)
...
species(
    label = 'C[C]CO[CH]C(3250)',
    structure = SMILES('C[C]CO[CH]C'),
    E0 = (331.518,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.863247,0.0706869,-7.09172e-05,3.99065e-08,-9.3088e-12,39984,23.8477], Tmin=(100,'K'), Tmax=(1023.05,'K')), NASAPolynomial(coeffs=[10.8687,0.0315671,-1.35603e-05,2.53047e-09,-1.75425e-13,37936.7,-24.6511], Tmin=(1023.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(331.518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C[C]OC[CH]C(3251)',
    ...
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19735,0.0614536,-4.9419e-05,2.12823e-08,-3.83641e-12,43848.4,24.5178], Tmin=(100,'K'), Tmax=(1282.18,'K')), NASAPolynomial(coeffs=[11.0978,0.0305673,-1.32857e-05,2.49487e-09,-1.7323e-13,41309.5,-25.7071], Tmin=(1282.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(363.737,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CH2_triplet)"""),
)
...
species(
    label = 'CC=COCC(3252)',
    structure = SMILES('CC=COCC'),
    E0 = (-221.533,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.873657,0.0535669,9.6375e-07,-4.4975e-08,2.26902e-11,-26517.9,21.7107], Tmin=(100,'K'), Tmax=(954.442,'K')), NASAPolynomial(coeffs=[17.4401,0.0212983,-6.72366e-06,1.1868e-09,-8.59247e-14,-31372.8,-66.3069], Tmin=(954.442,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-221.533,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH)"""),
)
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.821286,0.0534043,5.41804e-06,-5.23049e-08,2.59559e-11,-25042,22.3373], Tmin=(100,'K'), Tmax=(948.464,'K')), NASAPolynomial(coeffs=[18.5285,0.0196056,-5.77929e-06,1.00751e-09,-7.41172e-14,-30239.6,-71.8459], Tmin=(948.464,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-209.287,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH)"""),
)

species(
    label = 'C=CCOCC(3134)',
    structure = SMILES('C=CCOCC'),
    E0 = (-163.814,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.42562,0.0537514,-3.00705e-05,8.08516e-09,-8.76193e-13,-19607.7,23.3381], Tmin=(100,'K'), Tmax=(2038.66,'K')), NASAPolynomial(coeffs=[14.3349,0.0284227,-1.14344e-05,1.99096e-09,-1.28871e-13,-24871.3,-48.1368], Tmin=(2038.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-163.814,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    label = 'C=COC[CH]C(1430)',
    structure = SMILES('C=COC[CH]C'),
    E0 = (-9.38516,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,330.227,330.234,330.236,330.236],'cm^-1')),
        HinderedRotor(inertia=(0.00154588,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.25272,'amu*angstrom^2'), symmetry=1, barrier=(19.5566,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.252706,'amu*angstrom^2'), symmetry=1, barrier=(19.5565,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.252713,'amu*angstrom^2'), symmetry=1, barrier=(19.5565,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1244,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.015,0.0481995,1.40168e-05,-6.17678e-08,2.97955e-11,-1005.31,24.1386], Tmin=(100,'K'), Tmax=(939.718,'K')), NASAPolynomial(coeffs=[19.0547,0.0153742,-3.76062e-06,6.27729e-10,-4.83686e-14,-6336.85,-72.0991], Tmin=(939.718,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-9.38516,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO)"""),
)
...
species(
    label = '[CH2]CCO[CH]C(3254)',
    structure = SMILES('[CH2]CCO[CH]C'),
    E0 = (88.5492,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.988979,0.0679608,-6.05184e-05,3.0816e-08,-6.66704e-12,10757,25.2758], Tmin=(100,'K'), Tmax=(1081.58,'K')), NASAPolynomial(coeffs=[9.8456,0.0352066,-1.50932e-05,2.81689e-09,-1.95278e-13,8841.14,-18.1469], Tmin=(1081.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(88.5492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(RCCJ)"""),
)

species(
    label = '[CH2]COC[CH]C(3255)',
    structure = SMILES('[CH2]COC[CH]C'),
    E0 = (114.338,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2634,0.0606679,-4.40766e-05,1.74837e-08,-2.97397e-12,13849.5,26.1799], Tmin=(100,'K'), Tmax=(1322.76,'K')), NASAPolynomial(coeffs=[9.78937,0.0348855,-1.48395e-05,2.74828e-09,-1.88982e-13,11594,-17.3378], Tmin=(1322.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.338,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(CJCO)"""),
)

species(
    label = 'C[CH][CH]OCC(3256)',
    structure = SMILES('C[CH][CH]OCC'),
    E0 = (83.2049,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][CH]OCCC(1392)',
    structure = SMILES('[CH2][CH]OCCC'),
    E0 = (94.892,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.76549,0.0727998,-7.10959e-05,3.93373e-08,-9.07344e-12,11528,24.9266], Tmin=(100,'K'), Tmax=(1031.21,'K')), NASAPolynomial(coeffs=[10.817,0.0338109,-1.43831e-05,2.67335e-09,-1.84933e-13,9454.91,-23.8752], Tmin=(1031.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.892,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CJCO)"""),
)

species(
    label = '[CH2][CH]COCC(3257)',
    structure = SMILES('[CH2][CH]COCC'),
    E0 = (107.995,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43429,0.056472,-3.57351e-05,1.16907e-08,-1.61964e-12,13080.5,26.7146], Tmin=(100,'K'), Tmax=(1573.17,'K')), NASAPolynomial(coeffs=[10.2714,0.0340024,-1.43107e-05,2.61165e-09,-1.76848e-13,10300,-19.9234], Tmin=(1573.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(107.995,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCO) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', '[CH]CO[CH]C(3216)'],
    products = ['C[CH]CO[CH]C(3129)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH3(17)', '[CH]OC[CH]C(3249)'],
    products = ['C[CH]CO[CH]C(3129)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_methyl;Birad]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'C[C]CO[CH]C(3250)'],
    products = ['C[CH]CO[CH]C(3129)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', 'C[C]OC[CH]C(3251)'],
    products = ['C[CH]CO[CH]C(3129)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C[CH][CH]O[CH]C(1667)'],
    products = ['C[CH]CO[CH]C(3129)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2][CH]CO[CH]C(1669)'],
    products = ['C[CH]CO[CH]C(3129)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH2][CH]OC[CH]C(1418)'],
    products = ['C[CH]CO[CH]C(3129)'],
