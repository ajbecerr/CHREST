...
species(
    ...
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.948165,0.0613832,-3.83155e-05,1.23014e-08,-1.65031e-12,94510.7,23.945], Tmin=(100,'K'), Tmax=(1662.93,'K')), NASAPolynomial(coeffs=[12.3949,0.0338492,-1.3479e-05,2.34435e-09,-1.53386e-13,90703.7,-37.1002], Tmin=(1662.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(784.856,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + radical(Allyl_P) + radical(AllylJ2_triplet) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C(=[CH])[C]([CH2])C(17501)',
...
species(
    ...
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.06761,0.0257087,5.78353e-05,-9.12048e-08,3.63191e-11,69594,18.6857], Tmin=(100,'K'), Tmax=(953.859,'K')), NASAPolynomial(coeffs=[12.0284,0.0259994,-8.76557e-06,1.57232e-09,-1.13413e-13,65780.4,-38.9287], Tmin=(953.859,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(577.933,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(Allyl_T) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH][C]1CCC1=C(17503)',
    structure = SMILES('[CH]C1=C([CH2])CC1'),
    E0 = (588.541,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73676,0.0336539,4.00594e-05,-7.48798e-08,3.07229e-11,70881.1,20.3267], Tmin=(100,'K'), Tmax=(965.858,'K')), NASAPolynomial(coeffs=[13.2872,0.0255695,-9.11858e-06,1.67471e-09,-1.21352e-13,66795.8,-44.5944], Tmin=(965.858,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(588.541,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + ring(Cyclobutene) + radical(Allyl_P) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C(=C)C(=[CH])C(17505)',
    structure = SMILES('[CH]C(=C)C(=[CH])C'),
    E0 = (636.521,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,325,375,415,465,420,450,1700,1750,2950,3100,1380,975,1025,1650,3120,650,792.5,1650,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(2.11669,'amu*angstrom^2'), symmetry=1, barrier=(48.667,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.11644,'amu*angstrom^2'), symmetry=1, barrier=(48.661,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.11683,'amu*angstrom^2'), symmetry=1, barrier=(48.67,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.895333,0.0606762,-4.09672e-05,9.40624e-09,1.04673e-12,76674.1,21.8521], Tmin=(100,'K'), Tmax=(1031.13,'K')), NASAPolynomial(coeffs=[13.2617,0.0259734,-9.78749e-06,1.72746e-09,-1.17365e-13,73418.4,-41.6083], Tmin=(1031.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(636.521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C(=[CH])C(=C)C(17506)',
    ...
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.895333,0.0606762,-4.09672e-05,9.40624e-09,1.04673e-12,76674.1,21.1589], Tmin=(100,'K'), Tmax=(1031.13,'K')), NASAPolynomial(coeffs=[13.2617,0.0259734,-9.78749e-06,1.72746e-09,-1.17365e-13,73418.4,-42.3014], Tmin=(1031.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(636.521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(1.29058,'amu*angstrom^2'), symmetry=1, barrier=(29.673,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (78.1118,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.984564,0.0560443,-3.34426e-05,-6.10575e-09,9.04904e-12,101113,18.0604], Tmin=(100,'K'), Tmax=(947.693,'K')), NASAPolynomial(coeffs=[17.2886,0.0121705,-3.4777e-06,5.86412e-10,-4.23753e-14,96902.3,-65.6308], Tmin=(947.693,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(839.717,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(CJ3)"""),
)

species(
    label = '[CH2]C(=C)C1=CC1(17508)',
    ...
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3351,0.04283,1.2768e-05,-5.58406e-08,2.69713e-11,52881.9,17.9379], Tmin=(100,'K'), Tmax=(939.125,'K')), NASAPolynomial(coeffs=[17.6965,0.0129362,-3.04549e-06,5.05506e-10,-3.95925e-14,48053.9,-69.3119], Tmin=(939.125,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(438.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH2][C]1CC=C1[CH2](17509)',
    structure = SMILES('[CH2]C1=C([CH2])C[CH]1'),
    E0 = (533.899,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.93839,0.0259694,5.73139e-05,-9.63086e-08,3.95083e-11,64305.1,17.6681], Tmin=(100,'K'), Tmax=(952.882,'K')), NASAPolynomial(coeffs=[15.6897,0.0169226,-5.07331e-06,9.51071e-10,-7.45855e-14,59474.4,-59.6067], Tmin=(952.882,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(533.899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsCs) + ring(Cyclobutene) + radical(cyclobutene-allyl) + radical(Allyl_P) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]C(=C)C([CH2])=C(16082)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(20)', '[CH]C(=C)[C]=C(17249)'],
    products = ['[CH]C(=C)C([CH2])=C(16082)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]=C([CH2])C(=[CH])[CH2](16900)'],
    products = ['[CH]C(=C)C([CH2])=C(16082)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH]C(=C)C([CH])[CH2](17134)'],
    products = ['[CH]C(=C)C([CH2])=C(16082)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]C(=[CH])C([CH2])[CH2](17140)'],
    products = ['[CH]C(=C)C([CH2])=C(16082)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH][C](C)C(=[CH])[CH2](17500)'],
    products = ['[CH]C(=C)C([CH2])=C(16082)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]C(=[CH])[C]([CH2])C(17501)'],
    products = ['[CH]C(=C)C([CH2])=C(16082)'],
    transitionState = 'TS8',
...
reaction(
    ...
    kinetics = Arrhenius(A=(6.48119e+09,'s^-1'), n=0.736667, Ea=(234.776,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H] for rate rule [R4_S_(Cd)_D;doublebond_intra_2H;radadd_intra_cs2H]
Euclidian distance = 2.0
Multiplied by reaction path degeneracy 2.0
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH]C(=[CH])C([CH2])=C(17504)'],
    products = ['[CH]C(=C)C([CH2])=C(16082)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH2(T)(20)', '[CH]=[C]C([CH2])=C(15991)'],
    products = ['[CH]C(=C)C([CH2])=C(16082)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[C]=C([CH2])C([CH2])=C(17507)'],
    products = ['[CH]C(=C)C([CH2])=C(16082)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]C(=C)C([CH2])=C(16082)'],
    products = ['[CH2][C]1CC=C1[CH2](17509)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(3.24059e+09,'s^-1'), n=0.736667, Ea=(238.655,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4_S_D;doublebond_intra_2H;radadd_intra_cs2H] for rate rule [R4_S_(Cd)_D;doublebond_intra_2H;radadd_intra_cs2H]
Euclidian distance = 2.0
family: Intra_R_Add_Exocyclic
Ea raised from 236.6 to 238.7 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.54e+10,'s^-1'), n=0.69, Ea=(132.672,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_D_D;doublebond_intra_2H;radadd_intra_cdsingleH]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 129.5 to 132.7 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction26',
    reactants = ['CH2(T)(20)', 'C#CC([CH2])=C(15990)'],
    products = ['[CH]C(=C)C([CH2])=C(16082)'],
...
network(
    label = 'PDepNetwork #4108',
    isomers = [
        '[CH]C(=C)C([CH2])=C(16082)',
    ],
    reactants = [
