...
species(
    label = '[CH2][C]=CC[C]C(16963)',
    structure = SMILES('[CH2][C]=CC[C]C'),
    E0 = (761.228,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,283.809,283.809,1077.04],'cm^-1')),
        HinderedRotor(inertia=(0.0907928,'amu*angstrom^2'), symmetry=1, barrier=(5.18078,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.287959,'amu*angstrom^2'), symmetry=1, barrier=(16.4604,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.287918,'amu*angstrom^2'), symmetry=1, barrier=(16.4597,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.743316,'amu*angstrom^2'), symmetry=1, barrier=(42.5343,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
...
species(
    ...
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.21887,0.0222629,6.42428e-05,-9.24432e-08,3.48507e-11,27185.5,17.5518], Tmin=(100,'K'), Tmax=(986.345,'K')), NASAPolynomial(coeffs=[10.8454,0.0296191,-1.13337e-05,2.15919e-09,-1.58045e-13,23424.1,-34.3881], Tmin=(986.345,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(225.375,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane) + radical(Allyl_S)"""),
)

species(
    label = 'C=CC=C[CH]C(15213)',
    ...
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62188,0.0397425,1.75005e-05,-4.91143e-08,2.1294e-11,16926.1,21.7005], Tmin=(100,'K'), Tmax=(970.032,'K')), NASAPolynomial(coeffs=[12.1207,0.0268189,-9.47635e-06,1.70058e-09,-1.20077e-13,13460.4,-35.9957], Tmin=(970.032,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(139.926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + radical(C=CC=CCJ)"""),
)
...
species(
    label = '[CH2]C#CC[CH]C(16967)',
    structure = SMILES('[CH2]C#CC[CH]C'),
    E0 = (434.474,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2100,2250,500,550,320.041,320.048],'cm^-1')),
        HinderedRotor(inertia=(0.00164533,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00164515,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0016453,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00164583,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97075,0.0446832,-2.51923e-05,7.89405e-09,-1.10963e-12,52327.7,24.6544], Tmin=(100,'K'), Tmax=(1474.16,'K')), NASAPolynomial(coeffs=[6.51707,0.0323472,-1.26401e-05,2.21755e-09,-1.46972e-13,50987.3,0.956654], Tmin=(1474.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(434.474,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(RCCJC) + radical(Propargyl)"""),
)
...
species(
    label = '[CH2][C]=[C]CCC(16971)',
    structure = SMILES('[CH2][C]=[C]CCC'),
    E0 = (550.855,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,1670,1700,300,440,336.366,336.649],'cm^-1')),
        HinderedRotor(inertia=(0.0895745,'amu*angstrom^2'), symmetry=1, barrier=(7.20311,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0896773,'amu*angstrom^2'), symmetry=1, barrier=(7.20455,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00148914,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.270137,'amu*angstrom^2'), symmetry=1, barrier=(21.6927,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.46916,0.0552998,-3.75357e-05,1.35615e-08,-2.08695e-12,66343.6,24.4356], Tmin=(100,'K'), Tmax=(1444.65,'K')), NASAPolynomial(coeffs=[9.82371,0.0321673,-1.35168e-05,2.47735e-09,-1.68814e-13,63929.7,-18.9436], Tmin=(1444.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(550.855,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S) + radical(Cds_S)"""),
)

species(
    label = 'C=C[CH][CH][CH]C(15216)',
    structure = SMILES('[CH2]C=C[CH][CH]C'),
    E0 = (410.731,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    label = 'C#C[CH]C[CH]C(16975)',
    structure = SMILES('C#C[CH]C[CH]C'),
    E0 = (442.678,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,2175,525,750,770,3400,2100,219.74,2603.31],'cm^-1')),
        HinderedRotor(inertia=(2.11649,'amu*angstrom^2'), symmetry=1, barrier=(71.8435,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.1043,'amu*angstrom^2'), symmetry=1, barrier=(71.8508,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0953734,'amu*angstrom^2'), symmetry=1, barrier=(3.20319,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0149381,'amu*angstrom^2'), symmetry=1, barrier=(71.8452,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77572,0.0510667,-3.46915e-05,5.45649e-09,5.4958e-12,53320.1,22.9952], Tmin=(100,'K'), Tmax=(685.532,'K')), NASAPolynomial(coeffs=[6.61865,0.0316859,-1.17087e-05,1.9956e-09,-1.30669e-13,52447.6,-0.062059], Tmin=(685.532,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(442.678,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJC) + radical(Sec_Propargyl)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CHCH3(T)(21)', '[CH2][C]=C[CH2](8994)'],
    products = ['C=[C][CH]C[CH]C(15645)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', '[CH]CC=[C][CH2](16914)'],
    products = ['C=[C][CH]C[CH]C(15645)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2][C]=CC[C]C(16963)'],
    products = ['C=[C][CH]C[CH]C(15645)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH][C]=CC[CH]C(16964)'],
    products = ['C=[C][CH]C[CH]C(15645)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH2][C]=CC=CC(16966)'],
    products = ['C=[C][CH]C[CH]C(15645)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH2]C#CC[CH]C(16967)'],
    products = ['C=[C][CH]C[CH]C(15645)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2][C]=C[CH][CH]C(16968)'],
    products = ['C=[C][CH]C[CH]C(15645)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2][C]=[C]C[CH]C(16969)'],
    products = ['C=[C][CH]C[CH]C(15645)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2]C=[C]C[CH]C(16970)'],
    products = ['C=[C][CH]C[CH]C(15645)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', 'C#C[CH]C[CH]C(16975)'],
    products = ['C=[C][CH]C[CH]C(15645)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CHCH3(T)(21)', 'CH2CHCCH2(4848)'],
    products = ['C=[C][CH]C[CH]C(15645)'],
