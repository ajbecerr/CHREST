species(
    label = 'C=C=CCCCC(4860)',
    structure = SMILES('C=C=CCCCC'),
    E0 = (76.4964,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,540,610,2055,180,180,292.668],'cm^-1')),
        HinderedRotor(inertia=(0.0350611,'amu*angstrom^2'), symmetry=1, barrier=(11.8762,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0350614,'amu*angstrom^2'), symmetry=1, barrier=(11.8762,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.516526,'amu*angstrom^2'), symmetry=1, barrier=(11.8759,'kJ/mol'), semiclassical=False),
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.424767,0.0686738,-3.79666e-05,7.43075e-09,3.33007e-13,9337.27,28.2752], Tmin=(100,'K'), Tmax=(1266.67,'K')), NASAPolynomial(coeffs=[13.9765,0.0376312,-1.5123e-05,2.73272e-09,-1.8544e-13,4961.33,-44.0294], Tmin=(1266.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.4964,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    label = '[CH2]C=[C]CCCC(5066)',
    structure = SMILES('[CH2]C=[C]CCCC'),
    E0 = (289.233,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.316668,0.0714211,-4.55656e-05,1.46889e-08,-1.92797e-12,34927.2,30.3731], Tmin=(100,'K'), Tmax=(1744.21,'K')), NASAPolynomial(coeffs=[16.7841,0.0336571,-1.30896e-05,2.27625e-09,-1.48882e-13,29182.6,-58.2339], Tmin=(1744.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(289.233,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH]=C[CH]CCCC(5073)',
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.408183,0.0687165,-2.78243e-05,-2.35795e-09,3.20572e-12,32680.6,30.3876], Tmin=(100,'K'), Tmax=(1208.43,'K')), NASAPolynomial(coeffs=[12.3328,0.0451694,-1.83622e-05,3.32666e-09,-2.26257e-13,28635.8,-34.21], Tmin=(1208.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(270.577,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.69214,0.0602196,-8.51344e-06,-2.52578e-08,1.20775e-11,23282.7,27.4236], Tmin=(100,'K'), Tmax=(1055.22,'K')), NASAPolynomial(coeffs=[13.2954,0.0388174,-1.55791e-05,2.89085e-09,-2.02731e-13,19154.6,-41.0145], Tmin=(1055.22,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(192.504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Allyl_P)"""),
)
...
species(
    label = 'C[C]=C[CH]CCC(9527)',
    structure = SMILES('C[C]=C[CH]CCC'),
    E0 = (278.847,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.687491,0.0666821,-3.82218e-05,1.06437e-08,-1.19615e-12,33661.6,27.6533], Tmin=(100,'K'), Tmax=(1989.96,'K')), NASAPolynomial(coeffs=[17.1053,0.0336803,-1.33453e-05,2.30958e-09,-1.49117e-13,27127.5,-62.8504], Tmin=(1989.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(278.847,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Cds_S)"""),
)

species(
    label = 'C=[C]CCC[CH]C(5070)',
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33491,0.0642698,-3.77466e-05,1.18217e-08,-1.67045e-12,41515.3,29.5712], Tmin=(100,'K'), Tmax=(1414.79,'K')), NASAPolynomial(coeffs=[6.96471,0.0483528,-2.08709e-05,3.86967e-09,-2.65282e-13,39922.3,0.457223], Tmin=(1414.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(344.426,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.07772,0.0583382,-2.81904e-05,6.02846e-09,-4.99253e-13,40004.4,26.1964], Tmin=(100,'K'), Tmax=(2558.82,'K')), NASAPolynomial(coeffs=[16.2325,0.0362111,-1.52193e-05,2.64901e-09,-1.69076e-13,32760.6,-55.3912], Tmin=(2558.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.192,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(Cds_S)"""),
)

species(
    label = '[CH2]CCCC[C]=C(9529)',
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.760936,0.0694909,-4.43624e-05,1.45968e-08,-2.01518e-12,42841.1,30.6926], Tmin=(100,'K'), Tmax=(1599.68,'K')), NASAPolynomial(coeffs=[12.636,0.0397972,-1.65189e-05,2.993e-09,-2.01712e-13,39041.9,-32.1765], Tmin=(1599.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(355.226,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_S)"""),
)

species(
    label = '[CH2]C=CCCC[CH2](5062)',
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.486226,0.0666523,-2.92934e-05,-3.18624e-09,4.31044e-12,31001.8,31.0591], Tmin=(100,'K'), Tmax=(1124.5,'K')), NASAPolynomial(coeffs=[13.5589,0.0381821,-1.53685e-05,2.81791e-09,-1.94648e-13,26921.7,-38.6119], Tmin=(1124.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.638,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ) + radical(Allyl_P)"""),
)

species(
    label = 'C[C]=CCC[CH]C(5063)',
    structure = SMILES('C[C]=CCC[CH]C'),
    E0 = (332.18,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,1685,370,200,800,1600],'cm^-1')),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26712,0.0653857,-4.37286e-05,1.92207e-08,-4.37449e-12,40046,29.4112], Tmin=(100,'K'), Tmax=(906.238,'K')), NASAPolynomial(coeffs=[4.00503,0.0533012,-2.37267e-05,4.5067e-09,-3.15461e-13,39549.7,16.4719], Tmin=(906.238,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.18,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(Cds_S)"""),
)

species(
    label = '[CH2]CCCC=[C]C(9530)',
    structure = SMILES('[CH2]CCCC=[C]C'),
    E0 = (342.98,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,1600],'cm^-1')),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00823,0.0674801,-4.17222e-05,1.33169e-08,-1.81344e-12,41356.4,29.3574], Tmin=(100,'K'), Tmax=(1573.55,'K')), NASAPolynomial(coeffs=[10.7444,0.0427305,-1.81295e-05,3.32145e-09,-2.25393e-13,38292.3,-22.028], Tmin=(1573.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(342.98,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ) + radical(Cds_S)"""),
)
...
species(
    ...
    E0 = (281.743,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,540,610,2055,180,180,978.425],'cm^-1')),
        HinderedRotor(inertia=(0.123647,'amu*angstrom^2'), symmetry=1, barrier=(2.84288,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.689356,'amu*angstrom^2'), symmetry=1, barrier=(15.8497,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.689235,'amu*angstrom^2'), symmetry=1, barrier=(15.8469,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.123649,'amu*angstrom^2'), symmetry=1, barrier=(2.84294,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
...
species(
    label = 'C=C=[C]CCCC(9533)',
    structure = SMILES('[CH2]C#CCCCC'),
    E0 = (216.247,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2100,2250,500,550,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.699871,0.0640995,-3.57705e-05,7.42865e-09,3.21968e-13,26134.3,28.7384], Tmin=(100,'K'), Tmax=(1185.34,'K')), NASAPolynomial(coeffs=[11.8447,0.0367048,-1.40294e-05,2.47074e-09,-1.65662e-13,22774.7,-29.9508], Tmin=(1185.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(216.247,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Propargyl)"""),
)
...
species(
    label = 'C=C[C]CCCC(9535)',
    structure = SMILES('C=C[C]CCCC'),
    E0 = (339.667,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.996881,0.0715179,-4.69431e-05,1.69718e-08,-2.77654e-12,40955.6,36.2158], Tmin=(100,'K'), Tmax=(1283.96,'K')), NASAPolynomial(coeffs=[7.74885,0.050483,-2.23688e-05,4.21221e-09,-2.92107e-13,39221.7,1.95383], Tmin=(1283.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(339.667,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C=CCCCC(9536)',
    structure = SMILES('[CH]C=CCCCC'),
    E0 = (350.992,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1000,1200,1400,1600],'cm^-1')),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.0275,0.0681853,-4.22966e-05,1.33423e-08,-1.78791e-12,42318.2,27.1662], Tmin=(100,'K'), Tmax=(1592.45,'K')), NASAPolynomial(coeffs=[11.0114,0.0431073,-1.86745e-05,3.45308e-09,-2.35398e-13,39138.4,-25.6455], Tmin=(1592.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(350.992,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction17',
    reactants = ['C2H5(14)', '[CH2]CC=C=C(9378)'],
    products = ['C=C=CCCCC(4860)'],
...
reaction(
    label = 'reaction18',
    reactants = ['npropyl(13)', 'CH2CHCCH2(4848)'],
    products = ['C=C=CCCCC(4860)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'C=C=CC[CH]CC(9531)'],
    products = ['C=C=CCCCC(4860)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CH3(17)', '[CH2]CCC=C=C(4962)'],
    products = ['C=C=CCCCC(4860)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', 'C=C=CCC[CH]C(5058)'],
    products = ['C=C=CCCCC(4860)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C3H3(5450)', 'butyl_1(16)'],
    products = ['C=C=CCCCC(4860)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C=C=C[CH]CCC(9532)'],
    products = ['C=C=CCCCC(4860)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH2]CCCC=C=C(4878)'],
    products = ['C=C=CCCCC(4860)'],
