...
species(
    label = '[CH][CH]C[CH]O[C]=C(14126)',
    structure = SMILES('[CH][CH]C[CH]O[C]=C'),
    E0 = (843.266,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.269764,0.0813232,-9.65679e-05,5.94196e-08,-1.4397e-11,101556,32.9068], Tmin=(100,'K'), Tmax=(1012.16,'K')), NASAPolynomial(coeffs=[15.2712,0.02204,-8.71383e-06,1.55541e-09,-1.05172e-13,98519.6,-39.6482], Tmin=(1012.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(843.266,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOC(O)) + radical(RCCJC) + radical(C=CJO) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1[CH]COC1=C(14127)',
    structure = SMILES('[CH]C1[CH]COC1=C'),
    E0 = (466.612,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73436,0.0213177,9.69101e-05,-1.537e-07,6.40268e-11,56228.3,24.055], Tmin=(100,'K'), Tmax=(929.703,'K')), NASAPolynomial(coeffs=[21.8935,0.00771526,8.65017e-07,-2.19627e-10,3.95477e-15,49319.4,-88.7296], Tmin=(929.703,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(466.612,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(CCJCO) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]=C[CH]COC#C(13743)',
    structure = SMILES('[CH]C=CCOC#C'),
    E0 = (468.037,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,2175,525,750,770,3400,2100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.550397,0.0657875,-4.26226e-05,3.95961e-09,4.31883e-12,56425,24.5392], Tmin=(100,'K'), Tmax=(1004.21,'K')), NASAPolynomial(coeffs=[16.4933,0.0226432,-8.58913e-06,1.55508e-09,-1.08716e-13,52196.4,-57.5544], Tmin=(1004.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(468.037,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtOs) + group(Ct-CtH) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.53779,0.0645203,-3.05869e-05,-1.12582e-08,1.03557e-11,59856.5,27.6009], Tmin=(100,'K'), Tmax=(972.466,'K')), NASAPolynomial(coeffs=[16.8703,0.0237556,-8.45278e-06,1.49985e-09,-1.04864e-13,55431,-57.1598], Tmin=(972.466,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(496.553,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH][C]=CCOC=C(14134)',
    structure = SMILES('[CH][C]=CCOC=C'),
    E0 = (496.553,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
...
species(
    label = '[C]=C[CH]CO[C]=C(14135)',
    structure = SMILES('[C]C=CCO[C]=C'),
    E0 = (797.248,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,1685,370,294.339,294.344,294.657,294.758,294.801],'cm^-1')),
        HinderedRotor(inertia=(0.284712,'amu*angstrom^2'), symmetry=1, barrier=(17.5527,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.285177,'amu*angstrom^2'), symmetry=1, barrier=(17.554,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.284918,'amu*angstrom^2'), symmetry=1, barrier=(17.5546,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.716553,0.0639904,-5.3523e-05,1.7415e-08,-4.08454e-13,96012.3,26.9592], Tmin=(100,'K'), Tmax=(1009.94,'K')), NASAPolynomial(coeffs=[16.4865,0.0168049,-6.12623e-06,1.10248e-09,-7.72231e-14,92048,-53.134], Tmin=(1009.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(797.248,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=CJO) + radical(CJ3)"""),
)

species(
    label = 'C=[C]OCC1C=C1(14136)',
    structure = SMILES('C=[C]OCC1C=C1'),
    E0 = (392.062,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.657623,0.064131,-4.51481e-05,6.84727e-09,3.62538e-12,47282.9,24.3417], Tmin=(100,'K'), Tmax=(986.947,'K')), NASAPolynomial(coeffs=[16.6415,0.0191115,-6.76037e-06,1.20489e-09,-8.44179e-14,43165.4,-57.4373], Tmin=(986.947,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(392.062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(C=CJO)"""),
)
...
species(
    label = '[CH]=CC=COC=C(14138)',
    structure = SMILES('[CH]=CC=COC=C'),
    E0 = (268.682,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1192,'amu'),
...
species(
    label = '[CH]=CC=CO[C]=C(14139)',
    structure = SMILES('[CH]=CC=CO[C]=C'),
    E0 = (508.426,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.927372,'amu*angstrom^2'), symmetry=1, barrier=(21.3221,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.930237,'amu*angstrom^2'), symmetry=1, barrier=(21.388,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.93033,'amu*angstrom^2'), symmetry=1, barrier=(21.3901,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.848287,0.0595001,-3.80805e-05,-1.67082e-09,7.42046e-12,61271.9,28.5188], Tmin=(100,'K'), Tmax=(950.651,'K')), NASAPolynomial(coeffs=[17.0731,0.0147201,-4.48492e-06,7.59607e-10,-5.35009e-14,57125.7,-54.5178], Tmin=(950.651,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(508.426,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C=CCO[C]=C(14140)',
    structure = SMILES('[CH]=C=CCO[C]=C'),
    E0 = (458.852,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1685,370,540,610,2055,3120,650,792.5,1650,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.928213,'amu*angstrom^2'), symmetry=1, barrier=(21.3414,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.92986,'amu*angstrom^2'), symmetry=1, barrier=(21.3793,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.928777,'amu*angstrom^2'), symmetry=1, barrier=(21.3544,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (94.1112,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.448485,0.0668618,-6.53378e-05,3.24386e-08,-6.21684e-12,55324.5,29.1514], Tmin=(100,'K'), Tmax=(1377.91,'K')), NASAPolynomial(coeffs=[16.9436,0.014773,-4.0567e-06,5.74845e-10,-3.38798e-14,51177.9,-54.2674], Tmin=(1377.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(458.852,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=CJO) + radical(C=C=CJ)"""),
)
...
species(
    ...
    E0 = (575.483,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,1685,370,3120,650,792.5,1650,285.297,285.297,285.297,285.298],'cm^-1')),
        HinderedRotor(inertia=(0.288897,'amu*angstrom^2'), symmetry=1, barrier=(16.6865,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.288896,'amu*angstrom^2'), symmetry=1, barrier=(16.6865,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.288897,'amu*angstrom^2'), symmetry=1, barrier=(16.6865,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.2889,'amu*angstrom^2'), symmetry=1, barrier=(16.6865,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (95.1192,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['H2CC(T)(1341)', '[CH]=C[CH]C[O](13697)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH][CH]C[CH]O[C]=C(14126)'],
    products = ['[CH]=C[CH]CO[C]=C(5378)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=C[CH]CO[C]=C(5378)'],
    products = ['[CH]C1[CH]COC1=C(14127)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]=C[CH]COC#C(13743)'],
    products = ['[CH]=C[CH]CO[C]=C(5378)'],
    transitionState = 'TS6',
...
reaction(
    ...
    products = ['[CH]=C[CH]CO[C]=C(5378)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(0.000198678,'m^3/(mol*s)'), n=2.77646, Ea=(65.5453,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R_R;CsJ-CdHH] for rate rule [Od_Cdd;CsJ-CdHH]
Euclidian distance = 2.0
family: R_Addition_MultipleBond
Ea raised from 60.4 to 65.5 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]C=[CH](13797)', '[CH2]O[C]=C(2363)'],
    products = ['[CH]=C[CH]CO[C]=C(5378)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]C=C[CH]O[C]=C(14129)'],
    products = ['[CH]=C[CH]CO[C]=C(5378)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH]C=[C]CO[C]=C(14130)'],
    products = ['[CH]=C[CH]CO[C]=C(5378)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH][C]=CCO[C]=C(14131)'],
    products = ['[CH]=C[CH]CO[C]=C(5378)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C2H2(T)(1343)', '[CH]CO[C]=C(2364)'],
    products = ['[CH]=C[CH]CO[C]=C(5378)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[C]=C[CH]CO[C]=C(14135)'],
    products = ['[CH]=C[CH]CO[C]=C(5378)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH]=CC=CO[C]=C(14139)'],
    products = ['[CH]=C[CH]CO[C]=C(5378)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH]=C=CCO[C]=C(14140)'],
    products = ['[CH]=C[CH]CO[C]=C(5378)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C2H2(1342)', '[CH]CO[C]=C(2364)'],
    products = ['[CH]=C[CH]CO[C]=C(5378)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]=CC[CH]O[C]=C(14111)'],
    products = ['[CH]=C[CH]CO[C]=C(5378)'],
