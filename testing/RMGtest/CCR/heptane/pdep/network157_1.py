...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(2)', '[CH2]CC[C]=C(268)'],
    products = ['[CH2]C(C)C[C]=C(628)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['[C]=C(228)', '[CH2]C([CH2])C(86)'],
    products = ['[CH2]C(C)C[C]=C(628)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(9)', '[CH]C(C)C[C]=C(639)'],
    products = ['[CH2]C(C)C[C]=C(628)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction19',
    reactants = ['[CH3](12)', '[CH2][CH]C[C]=C(278)'],
    products = ['[CH2]C(C)C[C]=C(628)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(9)', '[CH2][C](C)C[C]=C(644)'],
    products = ['[CH2]C(C)C[C]=C(628)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(9)', '[CH2]C([CH2])C[C]=C(646)'],
    products = ['[CH2]C(C)C[C]=C(628)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(9)', '[CH]=[C]CC([CH2])C(647)'],
    products = ['[CH2]C(C)C[C]=C(628)'],
