...
species(
    label = '[CH][CH]C[CH]O[CH2](29477)',
    structure = SMILES('[CH][CH]C[CH]O[CH2]'),
    E0 = (727.503,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.05742,0.0683173,-9.08206e-05,7.01554e-08,-2.19029e-11,87601,29.0827], Tmin=(100,'K'), Tmax=(853.057,'K')), NASAPolynomial(coeffs=[8.73285,0.0278147,-1.1667e-05,2.09578e-09,-1.39903e-13,86455.6,-5.76469], Tmin=(853.057,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(727.503,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCsJOCs) + radical(RCCJC) + radical(CsJOCC) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1[CH]COC1(29478)',
    structure = SMILES('[CH]C1[CH]COC1'),
    E0 = (416.733,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.42736,0.0173392,7.34516e-05,-1.13767e-07,4.81135e-11,50194.4,18.63], Tmin=(100,'K'), Tmax=(890.535,'K')), NASAPolynomial(coeffs=[12.8724,0.016128,-1.49202e-06,-3.20113e-11,5.94544e-15,46521.7,-40.7256], Tmin=(890.535,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(416.733,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CCJCO) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]C1COC1(29479)',
    structure = SMILES('[CH][CH]C1COC1'),
    E0 = (489.836,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.10039,0.0328272,1.92835e-05,-5.0458e-08,2.37153e-11,58990.5,21.3704], Tmin=(100,'K'), Tmax=(879.169,'K')), NASAPolynomial(coeffs=[9.8763,0.0224407,-5.63564e-06,7.71629e-10,-4.66994e-14,56657.4,-20.6355], Tmin=(879.169,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(489.836,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(Cs_S) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.1595,0.0435727,-2.18254e-05,4.91949e-09,-4.33436e-13,61052.8,24.3851], Tmin=(100,'K'), Tmax=(2497.67,'K')), NASAPolynomial(coeffs=[15.2449,0.0226167,-9.24012e-06,1.56029e-09,-9.72038e-14,54516.2,-50.7221], Tmin=(2497.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(507.103,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CCJ(O)C) + radical(CsJOCC) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=[C]CO[CH2](29481)',
    structure = SMILES('[CH]C=[C]CO[CH2]'),
    E0 = (634.006,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80646,0.0514652,-4.38109e-05,2.55467e-08,-7.0741e-12,76329.4,25.2214], Tmin=(100,'K'), Tmax=(820.39,'K')), NASAPolynomial(coeffs=[4.91611,0.0363034,-1.60892e-05,3.01947e-09,-2.09324e-13,75819.2,10.8347], Tmin=(820.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(634.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CsJOCC) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH][C]=CCO[CH2](29482)',
    structure = SMILES('[CH][C]=CCO[CH2]'),
    E0 = (634.006,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.37095,0.0434724,-1.80313e-05,2.33323e-09,3.17792e-14,38458.2,21.9487], Tmin=(100,'K'), Tmax=(2185.93,'K')), NASAPolynomial(coeffs=[18.5957,0.022604,-9.76426e-06,1.65802e-09,-1.02129e-13,29257.5,-73.8352], Tmin=(2185.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.332,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(C=CCJ(O)C) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=[C]COC(29484)',
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.78291,0.0441375,-2.09701e-05,4.22143e-09,-3.20205e-13,53693.7,19.8877], Tmin=(100,'K'), Tmax=(3030.74,'K')), NASAPolynomial(coeffs=[23.1071,0.0173135,-7.69413e-06,1.30114e-09,-7.93161e-14,41374.2,-100.7], Tmin=(3030.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(446.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH][C]=CCOC(29485)',
...
species(
    label = '[C]=C[CH]CO[CH2](29486)',
    structure = SMILES('[C]C=CCO[CH2]'),
    E0 = (694.958,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,335.932,335.933,335.938,335.941],'cm^-1')),
        HinderedRotor(inertia=(0.00149382,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00149369,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0995269,'amu*angstrom^2'), symmetry=1, barrier=(7.97175,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7266,0.0499157,-4.31417e-05,2.05115e-08,-4.07406e-12,83666,22.3677], Tmin=(100,'K'), Tmax=(1180.68,'K')), NASAPolynomial(coeffs=[9.39009,0.0239528,-1.01571e-05,1.8869e-09,-1.30466e-13,81856.3,-15.8771], Tmin=(1180.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(694.958,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CsJOCC) + radical(CJ3)"""),
)

species(
    label = '[CH2]OCC1C=C1(29487)',
    structure = SMILES('[CH2]OCC1C=C1'),
    E0 = (289.771,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.53022,0.0516783,-4.03962e-05,1.71035e-08,-3.00857e-12,34942.4,20.2426], Tmin=(100,'K'), Tmax=(1325.77,'K')), NASAPolynomial(coeffs=[10.4494,0.0247685,-9.95017e-06,1.7938e-09,-1.21639e-13,32577.5,-25.3023], Tmin=(1325.77,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(289.771,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CsJOCC)"""),
)
...
species(
    label = '[CH]=CC=COC(29488)',
    structure = SMILES('[CH]=CC=COC'),
    E0 = (150.909,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.02273,0.0483201,5.23134e-06,-5.62443e-08,2.94681e-11,18273.3,20.5789], Tmin=(100,'K'), Tmax=(921.705,'K')), NASAPolynomial(coeffs=[20.9025,0.00668247,3.51086e-07,-1.72545e-10,8.14213e-15,12712.6,-83.9942], Tmin=(921.705,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(150.909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77666,0.0515041,-4.72576e-05,2.8158e-08,-7.49564e-12,20378.4,21.7333], Tmin=(100,'K'), Tmax=(875.531,'K')), NASAPolynomial(coeffs=[6.08015,0.0318436,-1.35753e-05,2.51173e-09,-1.72821e-13,19624.8,1.54342], Tmin=(875.531,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(168.789,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ)"""),
)

species(
    label = '[CH]=CC=CO[CH2](29489)',
    structure = SMILES('[CH]=CC=CO[CH2]'),
    E0 = (342.916,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3100,440,815,1455,1000,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.986495,'amu*angstrom^2'), symmetry=1, barrier=(22.6815,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.988322,'amu*angstrom^2'), symmetry=1, barrier=(22.7235,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.987277,'amu*angstrom^2'), symmetry=1, barrier=(22.6994,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13916,0.0462193,3.57936e-06,-5.35901e-08,2.85457e-11,41361.9,22.6466], Tmin=(100,'K'), Tmax=(919.307,'K')), NASAPolynomial(coeffs=[20.9082,0.00386761,1.43562e-06,-3.67963e-10,2.15688e-14,35881.9,-81.0999], Tmin=(919.307,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(342.916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=COCJ) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C=CCO[CH2](29490)',
    structure = SMILES('[CH]=C=CCO[CH2]'),
    E0 = (356.561,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,540,610,2055,3120,650,792.5,1650,298.663,2043.02],'cm^-1')),
        HinderedRotor(inertia=(0.140326,'amu*angstrom^2'), symmetry=1, barrier=(9.00835,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14173,'amu*angstrom^2'), symmetry=1, barrier=(8.97995,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.09506,'amu*angstrom^2'), symmetry=1, barrier=(70.6318,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68428,0.0501878,-4.61885e-05,2.46794e-08,-5.49411e-12,42968.4,23.7462], Tmin=(100,'K'), Tmax=(1071.19,'K')), NASAPolynomial(coeffs=[8.77785,0.0236992,-9.0962e-06,1.59455e-09,-1.0645e-13,41448.7,-10.964], Tmin=(1071.19,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(356.561,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CsJOCC) + radical(C=C=CJ)"""),
)
...
species(
    ...
    E0 = (459.72,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,180,180,713.763],'cm^-1')),
        HinderedRotor(inertia=(0.0105618,'amu*angstrom^2'), symmetry=1, barrier=(5.55234,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00331249,'amu*angstrom^2'), symmetry=1, barrier=(17.1838,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.746399,'amu*angstrom^2'), symmetry=1, barrier=(17.1612,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.747201,'amu*angstrom^2'), symmetry=1, barrier=(17.1796,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
...
species(
    label = '[CH]=[C]CCO[CH2](29491)',
    structure = SMILES('[CH]=[C]CCO[CH2]'),
    E0 = (517.106,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,357.343,358.346,1244.33],'cm^-1')),
        HinderedRotor(inertia=(0.00130922,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0884833,'amu*angstrom^2'), symmetry=1, barrier=(8.04613,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0881086,'amu*angstrom^2'), symmetry=1, barrier=(8.05138,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0881767,'amu*angstrom^2'), symmetry=1, barrier=(8.04864,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56404,0.0564653,-5.72371e-05,3.48178e-08,-9.04944e-12,62278.7,25.4387], Tmin=(100,'K'), Tmax=(911.707,'K')), NASAPolynomial(coeffs=[7.69959,0.0295463,-1.2948e-05,2.43221e-09,-1.68926e-13,61160,-3.5946], Tmin=(911.707,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(517.106,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsJOCC) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=C[CH]CO[CH2](28902)'],
...
reaction(
    label = 'reaction3',
    reactants = ['H(3)', '[CH]C=CCO[CH](14677)'],
    products = ['[CH]=C[CH]CO[CH2](28902)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH][CH]C[CH]O[CH2](29477)'],
    products = ['[CH]=C[CH]CO[CH2](28902)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]=C[CH]CO[CH2](28902)'],
    products = ['[CH][CH]C1COC1(29479)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1.20551e+07,'s^-1'), n=1.225, Ea=(93.6717,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra;radadd_intra_cs2H]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 91.2 to 93.7 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]C=C[CH]O[CH2](29480)'],
    products = ['[CH]=C[CH]CO[CH2](28902)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH]C=[C]CO[CH2](29481)'],
    products = ['[CH]=C[CH]CO[CH2](28902)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH][C]=CCO[CH2](29482)'],
    products = ['[CH]=C[CH]CO[CH2](28902)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C2H2(T)(1343)', '[CH]CO[CH2](28984)'],
    products = ['[CH]=C[CH]CO[CH2](28902)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[C]=C[CH]CO[CH2](29486)'],
    products = ['[CH]=C[CH]CO[CH2](28902)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH]=CC=CO[CH2](29489)'],
    products = ['[CH]=C[CH]CO[CH2](28902)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH]=C=CCO[CH2](29490)'],
    products = ['[CH]=C[CH]CO[CH2](28902)'],
...
reaction(
    label = 'reaction26',
    reactants = ['C2H2(1342)', '[CH]CO[CH2](28984)'],
    products = ['[CH]=C[CH]CO[CH2](28902)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]=CC[CH]O[CH2](29450)'],
    products = ['[CH]=C[CH]CO[CH2](28902)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]=C[CH]CO[CH2](28902)'],
    products = ['[CH2]O[CH][CH]C=C(29139)'],
...
network(
    label = 'PDepNetwork #7734',
    isomers = [
        '[CH]=C[CH]CO[CH2](28902)',
    ],
    reactants = [
