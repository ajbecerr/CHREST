...
species(
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.63291,0.0252132,-4.52092e-06,-8.60971e-09,4.14232e-12,33730.9,15.9952], Tmin=(100,'K'), Tmax=(1081.32,'K')), NASAPolynomial(coeffs=[7.48836,0.0170918,-6.90484e-06,1.27559e-09,-8.88208e-14,32105.5,-10.4691], Tmin=(1081.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(280.011,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + ring(Cyclopropane) + radical(ROOJ) + radical(C2CsJOOH)"""),
)
...
species(
    label = '[CH2]C1([CH2])OO1(16565)',
    structure = SMILES('[CH2]C1([CH2])OO1'),
    E0 = (316.975,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68271,0.023699,6.76541e-05,-1.37199e-07,6.46725e-11,38232.6,18.7151], Tmin=(100,'K'), Tmax=(886.569,'K')), NASAPolynomial(coeffs=[27.6938,-0.0193982,1.49309e-05,-3.07643e-09,2.10716e-13,30702.1,-120.101], Tmin=(886.569,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(316.975,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsOs) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(dioxirane) + radical(CJCOOH) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'allene(458)'],
    products = ['[CH2]C(=C)O[O](15463)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(83220,'cm^3/(mol*s)'), n=2.487, Ea=(41.1148,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Ca_Cds-HH;OJ] for rate rule [Ca_Cds-HH;O2b]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from -7.6 to 41.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(=C)O[O](15463)'],
    products = ['O2(S)(666)', 'allene(458)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', 'C=[C]O[O](1354)'],
    products = ['[CH2]C(=C)O[O](15463)'],
    transitionState = 'TS4',
