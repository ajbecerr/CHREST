...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(20)', '[CH]=[C]C[CH2](9654)'],
    products = ['[CH]=[C]CC[CH2](15116)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=[CH](9646)', '[CH2]C[CH2](29)'],
    products = ['[CH]=[C]CC[CH2](15116)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]CC[C]=[CH](16930)'],
    products = ['[CH]=[C]CC[CH2](15116)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[C]=[C]CC[CH2](16931)'],
    products = ['[CH]=[C]CC[CH2](15116)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'C#CC[CH][CH2](9869)'],
    products = ['[CH]=[C]CC[CH2](15116)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH]=[C]C[CH][CH2](9862)'],
    products = ['[CH]=[C]CC[CH2](15116)'],
