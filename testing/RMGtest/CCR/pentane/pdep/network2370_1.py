...
species(
    label = '[C]1=COO1(10911)',
    structure = SMILES('[C]1=COO1'),
    E0 = (383.657,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (57.0281,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.52778,-0.000281301,4.61208e-05,-6.31241e-08,2.49193e-11,46170.1,13.1119], Tmin=(100,'K'), Tmax=(941.259,'K')), NASAPolynomial(coeffs=[9.63061,0.00104952,5.49344e-07,-7.23458e-11,-1.19866e-15,43813.4,-22.3772], Tmin=(941.259,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(383.657,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['OCHCO(3676)'],
    products = ['O=C1[CH]O1(10908)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction1',
    reactants = ['CO(2039)', 'HCO(1372)'],
    products = ['OCHCO(3676)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(1099.39,'m^3/(mol*s)'), n=0.635039, Ea=(16.7529,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [COm;Y_rad] for rate rule [COm;CO_pri_rad]
Euclidian distance = 2.0
