...
species(
    ...
    molecularWeight = (69.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.34281,0.020228,6.00643e-05,-8.95539e-08,3.49463e-11,23012.3,18.8567], Tmin=(100,'K'), Tmax=(962.59,'K')), NASAPolynomial(coeffs=[11.4551,0.0230938,-7.87312e-06,1.45687e-09,-1.07447e-13,19370.9,-34.5594], Tmin=(962.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(190.717,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C1CCC1(493)',
    ...
    molecularWeight = (69.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.61536,0.0121054,8.45228e-05,-1.15508e-07,4.45973e-11,22453.3,17.8878], Tmin=(100,'K'), Tmax=(945.073,'K')), NASAPolynomial(coeffs=[11.0213,0.023144,-6.98586e-06,1.23581e-09,-9.12771e-14,18782.7,-33.2049], Tmin=(945.073,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(186.134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (69.125,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.80357,0.0378054,8.87509e-06,-3.53091e-08,1.53729e-11,11625.1,18.3063], Tmin=(100,'K'), Tmax=(996.436,'K')), NASAPolynomial(coeffs=[10.9565,0.0255812,-9.63205e-06,1.76724e-09,-1.24959e-13,8583.89,-31.9262], Tmin=(996.436,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(95.9224,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH2]C[C]([CH2])[CH2](498)',
    structure = SMILES('[CH2]C[C]([CH2])[CH2]'),
    E0 = (627.055,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,1587.14],'cm^-1')),
        HinderedRotor(inertia=(0.195391,'amu*angstrom^2'), symmetry=1, barrier=(4.49241,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.191079,'amu*angstrom^2'), symmetry=1, barrier=(4.39329,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00247573,'amu*angstrom^2'), symmetry=1, barrier=(4.44822,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0024966,'amu*angstrom^2'), symmetry=1, barrier=(4.46421,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (68.117,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87792,0.0517315,-6.44048e-05,5.51183e-08,-1.89102e-11,75488.9,24.9777], Tmin=(100,'K'), Tmax=(906.514,'K')), NASAPolynomial(coeffs=[3.21677,0.033325,-1.3266e-05,2.3002e-09,-1.49395e-13,75759.7,21.4825], Tmin=(906.514,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(627.055,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(RCCJ) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC([CH2])[CH2](112)'],
    products = ['C2H4(22)', 'allyl(82)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(20)', '[CH2][CH]C[CH2](66)'],
    products = ['[CH2]CC([CH2])[CH2](112)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[CH2]C([CH2])[CH2](489)'],
    products = ['[CH2]CC([CH2])[CH2](112)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]CC([CH2])[CH2](490)'],
    products = ['[CH2]CC([CH2])[CH2](112)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]C([CH2])C[CH2](491)'],
    products = ['[CH2]CC([CH2])[CH2](112)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH2]CC([CH2])=C(495)'],
    products = ['[CH2]CC([CH2])[CH2](112)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2]C([CH2])C=C(496)'],
    products = ['[CH2]CC([CH2])[CH2](112)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(T)(20)', 'buten3yl1(65)'],
    products = ['[CH2]CC([CH2])[CH2](112)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C2H4(22)', '[CH2][CH][CH2](497)'],
    products = ['[CH2]CC([CH2])[CH2](112)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C2H4(T)(23)', '[CH2][CH][CH2](497)'],
    products = ['[CH2]CC([CH2])[CH2](112)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2]C[C]([CH2])[CH2](498)'],
    products = ['[CH2]CC([CH2])[CH2](112)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH2][CH]C([CH2])[CH2](499)'],
    products = ['[CH2]CC([CH2])[CH2](112)'],
