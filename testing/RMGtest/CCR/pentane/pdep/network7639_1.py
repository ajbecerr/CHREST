...
species(
    label = '[CH]OO[CH2](29261)',
    structure = SMILES('[CH]OO[CH2]'),
    E0 = (516.503,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3000,3100,440,815,1455,1000,180,899.094],'cm^-1')),
        HinderedRotor(inertia=(0.124192,'amu*angstrom^2'), symmetry=1, barrier=(2.85543,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12594,'amu*angstrom^2'), symmetry=1, barrier=(2.89561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00309999,'amu*angstrom^2'), symmetry=1, barrier=(2.91027,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (59.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.50639,0.0318166,-3.33991e-05,1.7473e-08,-3.57949e-12,62175.6,13.7382], Tmin=(100,'K'), Tmax=(1189.18,'K')), NASAPolynomial(coeffs=[9.56539,0.00807231,-3.44845e-06,6.82194e-10,-4.95485e-14,60496.7,-21.5404], Tmin=(1189.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(516.503,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CsJOOC) + radical(CH2_triplet)"""),
)
...
species(
    label = '[CH2]OO[C]C(29266)',
    structure = SMILES('[CH2]OO[C]C'),
    E0 = (469.443,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180],'cm^-1')),
        HinderedRotor(inertia=(0.366952,'amu*angstrom^2'), symmetry=1, barrier=(8.43694,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.60576,'amu*angstrom^2'), symmetry=1, barrier=(36.9195,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0843201,'amu*angstrom^2'), symmetry=1, barrier=(22.1376,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.60578,'amu*angstrom^2'), symmetry=1, barrier=(36.9201,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90383,0.0488204,-4.89182e-05,2.61252e-08,-5.79853e-12,56534.2,16.7959], Tmin=(100,'K'), Tmax=(1063.58,'K')), NASAPolynomial(coeffs=[9.13167,0.0216372,-1.05807e-05,2.09471e-09,-1.50016e-13,54996.8,-18.5198], Tmin=(1063.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(469.443,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CsJOOC) + radical(CH2_triplet)"""),
)

species(
    label = '[CH]OO[CH]C(3479)',
    structure = SMILES('[CH]OO[CH]C'),
    E0 = (462.287,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,180,180,772.187],'cm^-1')),
        HinderedRotor(inertia=(0.162933,'amu*angstrom^2'), symmetry=1, barrier=(3.74614,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00883047,'amu*angstrom^2'), symmetry=1, barrier=(3.70776,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00882525,'amu*angstrom^2'), symmetry=1, barrier=(3.74452,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.25308,'amu*angstrom^2'), symmetry=1, barrier=(51.8027,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.86022,0.051519,-6.50953e-05,4.95511e-08,-1.60631e-11,55673.3,18.6527], Tmin=(100,'K'), Tmax=(739.586,'K')), NASAPolynomial(coeffs=[6.61186,0.0258207,-1.29765e-05,2.57203e-09,-1.83321e-13,54970.4,-2.83789], Tmin=(739.586,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(462.287,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCsJOOC) + radical(CH2_triplet)"""),
)
...
species(
    label = '[CH2][CH]OO[CH2](28829)',
    structure = SMILES('[CH2][CH]OO[CH2]'),
    E0 = (408.858,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100],'cm^-1')),
        HinderedRotor(inertia=(0.00697855,'amu*angstrom^2'), symmetry=1, barrier=(8.42765,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.19427,'amu*angstrom^2'), symmetry=1, barrier=(50.4505,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.19412,'amu*angstrom^2'), symmetry=1, barrier=(50.4471,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0418041,'amu*angstrom^2'), symmetry=1, barrier=(50.4531,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97799,0.048314,-5.38051e-05,3.59314e-08,-1.03269e-11,49243.7,20.0935], Tmin=(100,'K'), Tmax=(825.152,'K')), NASAPolynomial(coeffs=[6.68788,0.0254843,-1.23075e-05,2.40694e-09,-1.70737e-13,48466.4,-1.72425], Tmin=(825.152,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(408.858,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCsJOOC) + radical(CJCOOH) + radical(CsJOOC)"""),
)
...
species(
    label = '[CH2][CH]OOC(29268)',
    structure = SMILES('[CH2][CH]OOC'),
    E0 = (215.261,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,500,795,815,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000],'cm^-1')),
        HinderedRotor(inertia=(2.26836,'amu*angstrom^2'), symmetry=1, barrier=(52.1542,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00478255,'amu*angstrom^2'), symmetry=1, barrier=(5.72495,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.248993,'amu*angstrom^2'), symmetry=1, barrier=(5.72484,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.26851,'amu*angstrom^2'), symmetry=1, barrier=(52.1574,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (74.0785,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.32334,0.0431364,-2.54482e-05,-1.97112e-08,2.97121e-11,25944.1,19.2314], Tmin=(100,'K'), Tmax=(498.404,'K')), NASAPolynomial(coeffs=[5.06759,0.0303217,-1.45984e-05,2.851e-09,-2.01972e-13,25556.2,6.75544], Tmin=(498.404,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(215.261,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(CCsJOOC) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]O[O](46)', 'CHCH3(T)(21)'],
    products = ['[CH2]OO[CH]C(28843)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(20)', 'C[CH]O[O](57)'],
    products = ['[CH2]OO[CH]C(28843)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(15399.6,'m^3/(mol*s)'), n=0.932885, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using an average for rate rule [O_rad/NonDe;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', '[CH]OO[CH2](29261)'],
    products = ['[CH2]OO[CH]C(28843)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2]OO[C]C(29266)'],
    products = ['[CH2]OO[CH]C(28843)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2][CH]OO[CH2](28829)'],
    products = ['[CH2]OO[CH]C(28843)'],
