...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.119319,'amu*angstrom^2'), symmetry=1, barrier=(2.74337,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12162,'amu*angstrom^2'), symmetry=1, barrier=(2.79627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (44.0526,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.89021,0.0236515,-2.20415e-05,1.13909e-08,-2.38186e-12,17149.7,12.5725], Tmin=(100,'K'), Tmax=(1151.8,'K')), NASAPolynomial(coeffs=[7.00898,0.0093476,-3.41315e-06,6.08609e-10,-4.15212e-14,16200.9,-7.88023], Tmin=(1151.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCsJOH) + radical(CJCO)"""),
)
...
species(
    ...
    E0 = (156.505,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,958.393,958.75,959.134,959.154,959.694,2401.16],'cm^-1')),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (43.0446,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.7805,-0.00530963,5.75488e-05,-7.05606e-08,2.65071e-11,18840.3,8.42959], Tmin=(100,'K'), Tmax=(942.755,'K')), NASAPolynomial(coeffs=[7.32944,0.00562546,-1.20653e-06,2.33276e-10,-2.12879e-14,17016.1,-14.609], Tmin=(942.755,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(156.505,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), label="""oxiranyl""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
species(
    ...
    molecularWeight = (43.0446,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.08188,0.0104652,2.52038e-05,-4.72197e-08,2.08833e-11,14310.7,10.1559], Tmin=(100,'K'), Tmax=(919.509,'K')), NASAPolynomial(coeffs=[11.3957,-0.000441272,1.78868e-06,-3.67199e-10,2.20238e-14,11713.9,-35.0626], Tmin=(919.509,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(118.635,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), label="""CHCHOH""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
species(
    ...
    E0 = (253.129,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,1995.88,1996.92,3399.29],'cm^-1')),
        HinderedRotor(inertia=(0.20311,'amu*angstrom^2'), symmetry=1, barrier=(4.6699,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (44.0526,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.26194,0.0211712,-3.27332e-05,3.82916e-08,-1.66082e-11,30466.2,10.0413], Tmin=(100,'K'), Tmax=(831.835,'K')), NASAPolynomial(coeffs=[0.467391,0.0217723,-1.0669e-05,2.05669e-09,-1.42562e-13,31375.2,25.6784], Tmin=(831.835,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(253.129,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsHHH) + group(CsJ2_singlet-CsH)"""),
)
...
species(
    ...
    E0 = (194.529,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,236.361,1681.07,3288.7],'cm^-1')),
        HinderedRotor(inertia=(0.241947,'amu*angstrom^2'), symmetry=1, barrier=(9.56306,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00302632,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (44.0526,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.04631,0.0228904,-2.71812e-05,2.2902e-08,-8.25894e-12,23428.9,11.383], Tmin=(100,'K'), Tmax=(804.369,'K')), NASAPolynomial(coeffs=[4.05198,0.014886,-6.65373e-06,1.24677e-09,-8.57305e-14,23364.3,7.35412], Tmin=(804.369,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(194.529,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(149.66,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsOsHH) + group(CsJ2_singlet-CsH)"""),
)
...
species(
    ...
    E0 = (-83.5891,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1284.58,1286.15,1290.67,1679.17,1918.38,1930.29,3402.98,3406.61,3407.29],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.22005,-0.00648435,2.94635e-05,-2.67192e-08,8.05733e-12,-10060,-0.850161], Tmin=(100,'K'), Tmax=(1010.11,'K')), NASAPolynomial(coeffs=[1.2401,0.0107229,-4.11809e-06,7.43562e-10,-5.1169e-14,-9733.79,12.191], Tmin=(1010.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-83.5891,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(108.088,'J/(mol*K)'), label="""CH4""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
species(
    ...
    molecularWeight = (43.0446,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.63677,0.00450848,1.80293e-05,-2.25968e-08,7.88617e-12,-2544.95,9.39484], Tmin=(100,'K'), Tmax=(1011.57,'K')), NASAPolynomial(coeffs=[4.39402,0.0104823,-4.12725e-06,7.69392e-10,-5.45055e-14,-3157,3.46486], Tmin=(1011.57,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-21.2938,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), label="""acetyl""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O(4)', 'C2H4(22)'],
    products = ['[CH2]C[O](1358)'],
    transitionState = 'TS1',
    kinetics = Arrhenius(A=(8.84e+07,'cm^3/(mol*s)'), n=1.55, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 2801 C2H4 + O <=> C2H4O-3 in R_Addition_MultipleBond/training
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C[O](1358)'],
    products = ['oxirane(2889)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'vinoxy(1351)'],
    products = ['[CH2]C[O](1358)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(6.5e+06,'cm^3/(mol*s)'), n=1.86, Ea=(27.6144,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Matched reaction 2811 H + C2H3O-6 <=> C2H4O-4 in R_Addition_MultipleBond/training
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(T)(20)', 'CH2O(3111)'],
    products = ['[CH2]C[O](1358)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(10.1845,'m^3/(mol*s)'), n=1.51316, Ea=(51.0137,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO-HH_O;YJ] for rate rule [CO-HH_O;CH2_triplet]
...
reaction(
    label = 'reaction13',
    reactants = ['CH2(S)(11)', 'CH2O(3111)'],
    products = ['oxirane(2889)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(7.23836e+08,'m^3/(mol*s)'), n=-0.586333, Ea=(3.56505,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [carbene;multiplebond] for rate rule [carbene;mb_carbonyl_2H]
Euclidian distance = 2.0
...
reaction(
    label = 'reaction14',
    reactants = ['O(S)(3112)', 'C2H4(22)'],
    products = ['oxirane(2889)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(7e+11,'cm^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), comment="""Matched reaction 2 C2H4 + O <=> C2H4O in 1+2_Cycloaddition/training
This reaction matched rate rule [o_atom_singlet;mb_db_unsub]
family: 1+2_Cycloaddition"""),
)

reaction(
    label = 'reaction15',
    reactants = ['[CH2]O[CH2](3113)'],
    products = ['oxirane(2889)'],
