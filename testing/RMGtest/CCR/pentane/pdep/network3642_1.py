...
species(
    label = '[CH]C1OCC1=C(16567)',
    structure = SMILES('[CH]C1OCC1=C'),
    E0 = (415.459,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.18206,0.0230963,4.96366e-05,-8.17077e-08,3.27546e-11,50048.8,20.2363], Tmin=(100,'K'), Tmax=(970.733,'K')), NASAPolynomial(coeffs=[13.8464,0.017095,-6.08659e-06,1.1985e-09,-9.26309e-14,45802.4,-45.8991], Tmin=(970.733,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(415.459,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]COC=C=C(16568)',
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.883428,0.0559853,-2.65535e-05,-1.83374e-08,1.46789e-11,48628,21.7339], Tmin=(100,'K'), Tmax=(934.498,'K')), NASAPolynomial(coeffs=[19.3586,0.00866895,-1.59074e-06,2.27866e-10,-1.85542e-14,43788,-73.5677], Tmin=(934.498,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(403.287,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]=[C]COC=[CH](16184)',
    structure = SMILES('[CH]=[C]COC=[CH]'),
    E0 = (656.086,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,1685,370,3115,3125,620,680,785,800,1600,1700,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.948439,'amu*angstrom^2'), symmetry=1, barrier=(21.8065,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.94946,'amu*angstrom^2'), symmetry=1, barrier=(21.83,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.949406,'amu*angstrom^2'), symmetry=1, barrier=(21.8287,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.508683,0.0621654,-6.45013e-05,3.18889e-08,-5.90045e-12,79047.1,25.6051], Tmin=(100,'K'), Tmax=(1502.13,'K')), NASAPolynomial(coeffs=[18.4006,0.00642539,-7.5594e-07,9.81362e-12,2.34823e-15,74585.3,-64.9528], Tmin=(1502.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(656.086,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P) + radical(Cds_P)"""),
)
...
species(
    label = '[CH][CH]OCC=[CH](16571)',
    structure = SMILES('[CH][CH]OCC=[CH]'),
    E0 = (711.953,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,3120,650,792.5,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12438,0.0659286,-8.10022e-05,5.42611e-08,-1.46692e-11,85729.4,25.271], Tmin=(100,'K'), Tmax=(899.852,'K')), NASAPolynomial(coeffs=[10.6539,0.0235677,-1.03884e-05,1.94558e-09,-1.34559e-13,84014.4,-19.698], Tmin=(899.852,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(711.953,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOCs) + radical(Cds_P) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]CO[CH][C]=C(16572)',
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.811616,0.0584382,-3.37085e-05,-1.09073e-08,1.20698e-11,74216.1,23.6923], Tmin=(100,'K'), Tmax=(933.333,'K')), NASAPolynomial(coeffs=[19.2584,0.00897406,-1.77356e-06,2.54148e-10,-1.96139e-14,69483.7,-70.9353], Tmin=(933.333,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(616.024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]COC[C]=[CH](16573)',
    structure = SMILES('[CH]COC[C]=[CH]'),
    E0 = (769.339,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,3120,650,792.5,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29665,0.0647733,-9.17507e-05,7.77482e-08,-2.68366e-11,92622.4,25.6726], Tmin=(100,'K'), Tmax=(806.903,'K')), NASAPolynomial(coeffs=[6.83498,0.0301808,-1.41756e-05,2.69249e-09,-1.85791e-13,91960.9,1.58153], Tmin=(806.903,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(769.339,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH][CH](6981)', 'C=[C]C[O](15501)'],
    products = ['[CH][CH]OC[C]=C(15548)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['H2CC(T)(1341)', '[CH][CH]O[CH2](6982)'],
    products = ['[CH][CH]OC[C]=C(15548)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH]=[C]OC[C][CH2](9856)'],
    products = ['[CH][CH]OC[C]=C(15548)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]=CO[CH][C]=C(16183)'],
    products = ['[CH][CH]OC[C]=C(15548)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]=[C]COC=[CH](16184)'],
    products = ['[CH][CH]OC[C]=C(15548)'],
    transitionState = 'TS8',
...
reaction(
    ...
    products = ['[CH][CH]OC[C]=C(15548)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(2.82396,'m^3/(mol*s)'), n=2.03228, Ea=(156.716,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 154.1 to 156.7 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH][CH]OC[C]=[CH](16570)'],
    products = ['[CH][CH]OC[C]=C(15548)'],
