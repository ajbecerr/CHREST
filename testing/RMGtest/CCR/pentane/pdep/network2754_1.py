...
species(
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.62849,0.0860027,-5.46069e-05,-8.2776e-09,1.44496e-11,15122.9,32.6844], Tmin=(100,'K'), Tmax=(935.273,'K')), NASAPolynomial(coeffs=[25.4629,0.0141614,-3.13405e-06,4.7141e-10,-3.49717e-14,8503.95,-100.739], Tmin=(935.273,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(124.233,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCsJOC(O)) + radical(C=CJO)"""),
)
...
species(
    label = 'C[CH]C(C)OC1=CO1(12391)',
    structure = SMILES('C[CH]C(C)OC1=CO1'),
    E0 = (119.414,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.178758,0.0782881,-4.76512e-05,-3.09432e-09,9.18249e-12,14524.8,29.8609], Tmin=(100,'K'), Tmax=(977.221,'K')), NASAPolynomial(coeffs=[21.0517,0.0217722,-7.5421e-06,1.36161e-09,-9.75221e-14,8924.55,-79.498], Tmin=(977.221,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(119.414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + ring(Cyclopropene) + radical(CCJCO)"""),
)
...
species(
    label = 'CC[C](C)O[C]=C[O](11628)',
    structure = SMILES('CC[C](C)O[C]=C[O]'),
    E0 = (126.919,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360,370,350,3010,987.5,1337.5,450,1655,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.443965,0.0862533,-7.05766e-05,1.95448e-08,1.54915e-12,15435.1,33.9805], Tmin=(100,'K'), Tmax=(983.264,'K')), NASAPolynomial(coeffs=[21.5234,0.020787,-7.16399e-06,1.26935e-09,-8.9209e-14,9959.9,-77.5032], Tmin=(983.264,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(126.919,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C2CsJOC(O)) + radical(C=CJO)"""),
)

species(
    label = '[CH2]CC(C)O[C]=C[O](11632)',
...
species(
    label = 'C[CH][C](C)O[C]=CO(12400)',
    structure = SMILES('C[CH][C](C)O[C]=CO'),
    E0 = (185.359,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]C([CH]C)O[C]=CO(11636)',
    structure = SMILES('[CH2]C([CH]C)O[C]=CO'),
    E0 = (195.653,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2][CH]C(C)O[C]=CO(12401)',
    structure = SMILES('[CH2][CH]C(C)O[C]=CO'),
    E0 = (190.39,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC1O[C][CH]OC1C(12402)',
    structure = SMILES('CC1O[C][CH]OC1C'),
    E0 = (229.614,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.42196,0.0890448,-8.42691e-05,4.23817e-08,-7.86319e-12,27837.5,27.4364], Tmin=(100,'K'), Tmax=(1633.61,'K')), NASAPolynomial(coeffs=[16.1438,0.0223016,-1.19316e-06,-4.14072e-10,4.70006e-14,25265.1,-56.2367], Tmin=(1633.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(229.614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(1,4-Dioxane) + radical(CCsJOCs) + radical(CH2_triplet)"""),
)

species(
    label = 'CC1O[C]C([O])C1C(12403)',
    structure = SMILES('CC1O[C]C([O])C1C'),
    E0 = (251.072,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.791972,0.0524462,2.46089e-05,-7.91267e-08,3.80091e-11,30329.4,22.4092], Tmin=(100,'K'), Tmax=(907.142,'K')), NASAPolynomial(coeffs=[18.6111,0.0219162,-4.34929e-06,5.36608e-10,-3.48341e-14,25119.8,-72.7166], Tmin=(907.142,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(251.072,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CC(C)OJ) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]C(C)O[C]=C[O](11093)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'C[CH]CO[C]=C[O](10964)'],
...
reaction(
    label = 'reaction3',
    reactants = ['CC(C)[CH]O[C]=C[O](12389)'],
    products = ['C[CH]C(C)O[C]=C[O](11093)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=C[O](6859)', 'C[CH]C(C)[O](1371)'],
    products = ['C[CH]C(C)O[C]=C[O](11093)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CHCH3(T)(21)', 'C[CH]O[C]=C[O](10373)'],
    products = ['C[CH]C(C)O[C]=C[O](11093)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', '[CH]C(C)O[C]=C[O](11473)'],
    products = ['C[CH]C(C)O[C]=C[O](11093)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['O(4)', '[CH]=[C]OC(C)[CH]C(2731)'],
    products = ['C[CH]C(C)O[C]=C[O](11093)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'C[C]C(C)O[C]=C[O](12390)'],
    products = ['C[CH]C(C)O[C]=C[O](11093)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C[CH]C(C)O[C]=C[O](11093)'],
    products = ['C[CH]C(C)OC1=CO1(12391)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'CC=C(C)O[C]=C[O](12394)'],
    products = ['C[CH]C(C)O[C]=C[O](11093)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'C=CC(C)O[C]=C[O](11228)'],
    products = ['C[CH]C(C)O[C]=C[O](11093)'],
...
reaction(
    label = 'reaction17',
    reactants = ['O(4)', 'C#COC(C)[CH]C(2728)'],
    products = ['C[CH]C(C)O[C]=C[O](11093)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(17)', 'CC=CO[C]=C[O](11535)'],
    products = ['C[CH]C(C)O[C]=C[O](11093)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH3(17)', 'C[CH][CH]O[C]=C[O](11537)'],
    products = ['C[CH]C(C)O[C]=C[O](11093)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', 'C[CH][C](C)O[C]=C[O](12395)'],
    products = ['C[CH]C(C)O[C]=C[O](11093)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH2]C([CH]C)O[C]=C[O](11223)'],
    products = ['C[CH]C(C)O[C]=C[O](11093)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH2][CH]C(C)O[C]=C[O](11240)'],
    products = ['C[CH]C(C)O[C]=C[O](11093)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CC[C](C)O[C]=C[O](11628)'],
    products = ['C[CH]C(C)O[C]=C[O](11093)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]CC(C)O[C]=C[O](11632)'],
    products = ['C[CH]C(C)O[C]=C[O](11093)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2]C(CC)O[C]=C[O](11006)'],
    products = ['C[CH]C(C)O[C]=C[O](11093)'],
...
reaction(
    label = 'reaction35',
    reactants = ['C[CH][C](C)O[C]=CO(12400)'],
    products = ['C[CH]C(C)O[C]=C[O](11093)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C([CH]C)O[C]=CO(11636)'],
    products = ['C[CH]C(C)O[C]=C[O](11093)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2][CH]C(C)O[C]=CO(12401)'],
    products = ['C[CH]C(C)O[C]=C[O](11093)'],
