...
species(
    label = '[CH]C(CC)C[O](29025)',
    structure = SMILES('[CH]C(CC)C[O]'),
    E0 = (340.314,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,1000,1200,1400,1600],'cm^-1')),
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06421,0.0568394,-3.6126e-05,1.18278e-08,-1.58733e-12,-24990.3,25.1447], Tmin=(100,'K'), Tmax=(1704.87,'K')), NASAPolynomial(coeffs=[13.4815,0.0277053,-1.04924e-05,1.80397e-09,-1.17417e-13,-29224.2,-41.3857], Tmin=(1704.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-208.713,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (86.1323,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.867436,0.0688611,-6.57125e-05,3.6758e-08,-8.57776e-12,6339.83,26.8497], Tmin=(100,'K'), Tmax=(1023.91,'K')), NASAPolynomial(coeffs=[10.1287,0.0326797,-1.27056e-05,2.24396e-09,-1.5043e-13,4443.36,-18.0492], Tmin=(1023.91,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.7741,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOH) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['O(4)', '[CH2]C([CH2])CC(117)'],
    products = ['[CH2]C(CC)C[O](3281)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C(CC)C[O](29025)'],
    products = ['[CH2]C(CC)C[O](3281)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C=C(CC)C[O](29028)'],
    products = ['[CH2]C(CC)C[O](3281)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH2]C(C=O)CC(1767)'],
    products = ['[CH2]C(CC)C[O](3281)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C2H5(14)', 'allyloxy(656)'],
    products = ['[CH2]C(CC)C[O](3281)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C2H5(14)', '[CH2][CH]C[O](1367)'],
    products = ['[CH2]C(CC)C[O](3281)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2][C](CC)C[O](29029)'],
    products = ['[CH2]C(CC)C[O](3281)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(17)', '[CH2]C([CH2])C[O](3328)'],
    products = ['[CH2]C(CC)C[O](3281)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH2]C([CH][O])CC(1756)'],
    products = ['[CH2]C(CC)C[O](3281)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2]CC([CH2])C[O](761)'],
    products = ['[CH2]C(CC)C[O](3281)'],
