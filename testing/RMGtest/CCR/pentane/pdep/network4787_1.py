...
species(
    label = '[CH2]C(C)[CH]C[C]=CO[O](22953)',
...
species(
    label = '[CH2][CH]C(C)C[C]=C[O](22954)',
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0975547,0.0794504,-6.30715e-05,2.57274e-08,-4.21307e-12,57495.3,37.3376], Tmin=(100,'K'), Tmax=(1454.16,'K')), NASAPolynomial(coeffs=[18.1418,0.0292788,-1.13182e-05,2.00083e-09,-1.3397e-13,52190.8,-57.4859], Tmin=(1454.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(476.743,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(Cs_S) + radical(RCCJ) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2][C]C(C)C[C]=CO[O](22955)',
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.23831,0.0961071,-0.000106782,6.54216e-08,-1.63496e-11,104240,38.5821], Tmin=(100,'K'), Tmax=(965.935,'K')), NASAPolynomial(coeffs=[13.8088,0.0379368,-1.64482e-05,3.07495e-09,-2.13149e-13,101527,-28.6999], Tmin=(965.935,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(865.453,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(RCCJ) + radical(CCJ2_triplet) + radical(Cds_S)"""),
)

species(
    label = '[CH][CH]C(C)C[C]=CO[O](22956)',
...
species(
    label = '[CH2][CH]C(C)CC1=COO1(22957)',
    structure = SMILES('[CH2][CH]C(C)CC1=COO1'),
    E0 = (402.229,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0716911,0.0730353,-3.25321e-05,-6.99832e-09,6.72818e-12,48529.7,38.1083], Tmin=(100,'K'), Tmax=(1095.94,'K')), NASAPolynomial(coeffs=[17.1226,0.0354804,-1.4908e-05,2.82752e-09,-2.00272e-13,43310.4,-52.4757], Tmin=(1095.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(402.229,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(Cs_S) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH]C(C)CC1=CO1(22959)',
    structure = SMILES('[CH2][CH]C(C)CC1=CO1'),
    E0 = (414.032,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (110.154,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.137156,0.0739182,-4.64407e-05,8.21173e-09,1.85946e-12,49944.9,34.5524], Tmin=(100,'K'), Tmax=(1093.96,'K')), NASAPolynomial(coeffs=[16.5405,0.0315803,-1.25753e-05,2.31344e-09,-1.61003e-13,45300.5,-50.8814], Tmin=(1093.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(414.032,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclopropene) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C=C(C)CC=CO[O](22960)',
    structure = SMILES('C=C[C](C)CC=CO[O]'),
    E0 = (231.636,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.118664,0.0804072,-5.73156e-05,1.82552e-08,-1.36536e-12,28016.2,34.7406], Tmin=(100,'K'), Tmax=(1112.11,'K')), NASAPolynomial(coeffs=[16.2373,0.0346262,-1.31651e-05,2.33813e-09,-1.58736e-13,23571.4,-49.5328], Tmin=(1112.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(231.636,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Allyl_T)"""),
)
...
species(
    label = '[CH2][CH][CH]C[C]=CO[O](22218)',
    structure = SMILES('[CH2][CH][CH]C[C]=CO[O]'),
    E0 = (835.617,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,180,778.879,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00268983,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00268983,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00268983,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00268983,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00268983,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.718784,0.0837844,-0.000135829,1.27749e-07,-4.59887e-11,100609,38.5641], Tmin=(100,'K'), Tmax=(871.563,'K')), NASAPolynomial(coeffs=[3.67986,0.0433082,-1.98952e-05,3.67527e-09,-2.46715e-13,101114,30.5439], Tmin=(871.563,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(835.617,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(RCCJCC) + radical(RCCJC) + radical(RCCJ) + radical(Cds_S)"""),
)

species(
    label = '[CH2][CH][C](C)C[C]=CO[O](22961)',
    structure = SMILES('[CH2][CH][C](C)C[C]=CO[O]'),
    E0 = (797.203,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,180,400,3200],'cm^-1')),
        HinderedRotor(inertia=(0.0390441,'amu*angstrom^2'), symmetry=1, barrier=(3.5908,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0390441,'amu*angstrom^2'), symmetry=1, barrier=(3.5908,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0390441,'amu*angstrom^2'), symmetry=1, barrier=(3.5908,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0390441,'amu*angstrom^2'), symmetry=1, barrier=(3.5908,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0390441,'amu*angstrom^2'), symmetry=1, barrier=(3.5908,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.118972,0.101939,-0.000156063,1.41581e-07,-5.06446e-11,96018.8,41.9263], Tmin=(100,'K'), Tmax=(841.368,'K')), NASAPolynomial(coeffs=[5.85073,0.0506726,-2.38639e-05,4.50255e-09,-3.07838e-13,95824.2,18.9708], Tmin=(841.368,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(797.203,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Tertalkyl) + radical(Cs_S) + radical(RCCJ) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2][CH]C(C)C[C]=[C]O[O](22962)',
    structure = SMILES('[CH2][CH]C(C)C[C]=[C]O[O]'),
    E0 = (851.525,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1670,1700,300,440,241.346,400,3200],'cm^-1')),
        HinderedRotor(inertia=(0.0394848,'amu*angstrom^2'), symmetry=1, barrier=(3.63134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0394848,'amu*angstrom^2'), symmetry=1, barrier=(3.63134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0394848,'amu*angstrom^2'), symmetry=1, barrier=(3.63134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0394848,'amu*angstrom^2'), symmetry=1, barrier=(3.63134,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0394848,'amu*angstrom^2'), symmetry=1, barrier=(3.63134,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (125.145,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0270147,0.0959928,-0.000134983,1.16853e-07,-4.11735e-11,102550,43.3976], Tmin=(100,'K'), Tmax=(815.522,'K')), NASAPolynomial(coeffs=[6.82683,0.0488079,-2.27518e-05,4.30845e-09,-2.96693e-13,101900,14.7993], Tmin=(815.522,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(851.525,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Cs_S) + radical(RCCJ) + radical(Cds_S) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C[C](C)C[C]=CO[O](22963)',
    structure = SMILES('[CH2]C[C](C)C[C]=CO[O]'),
    E0 = (602.661,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.289484,0.102884,-0.000143526,1.21591e-07,-4.18137e-11,72629.6,39.9842], Tmin=(100,'K'), Tmax=(825.664,'K')), NASAPolynomial(coeffs=[7.86304,0.0498899,-2.2729e-05,4.25544e-09,-2.91001e-13,71743.4,5.00096], Tmin=(825.664,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(602.661,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Tertalkyl) + radical(RCCJ) + radical(Cds_S)"""),
)
...
species(
    label = '[CH2][CH]C(C)CC=[C]O[O](22964)',
    structure = SMILES('[CH2][CH]C(C)CC=[C]O[O]'),
    E0 = (613.683,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.234583,0.0891197,-0.000101171,7.42213e-08,-2.371e-11,73938.8,42.1927], Tmin=(100,'K'), Tmax=(745.757,'K')), NASAPolynomial(coeffs=[7.47709,0.0502785,-2.30571e-05,4.40126e-09,-3.07391e-13,72858.4,9.37546], Tmin=(745.757,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(613.683,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Cs_S) + radical(RCCJ) + radical(C=CJO)"""),
)

species(
    label = '[CH2][CH]C(C)C[C]=[C]OO(22965)',
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.513904,0.0882849,-7.50958e-05,1.08117e-09,3.32609e-11,84247,41.0254], Tmin=(100,'K'), Tmax=(529.441,'K')), NASAPolynomial(coeffs=[7.89478,0.0514473,-2.4349e-05,4.69988e-09,-3.29805e-13,83200.1,7.6056], Tmin=(529.441,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(699.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Cs_S) + radical(RCCJ) + radical(Cds_S) + radical(C=CJO)"""),
)
...
species(
    label = '[CH2][CH][C](C)CC=CO[O](22966)',
    structure = SMILES('[CH2][CH][C](C)CC=CO[O]'),
    E0 = (559.361,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0315548,0.0966657,-0.000128796,1.08995e-07,-3.8267e-11,67413.1,41.1412], Tmin=(100,'K'), Tmax=(801.065,'K')), NASAPolynomial(coeffs=[6.78688,0.0516198,-2.38512e-05,4.5174e-09,-3.11885e-13,66673.6,11.9614], Tmin=(801.065,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(559.361,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Tertalkyl) + radical(Cs_S) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]CC(C)C[C]=[C]O[O](22967)',
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0914068,0.0962558,-0.000119723,9.27979e-08,-3.03481e-11,79158.2,41.2729], Tmin=(100,'K'), Tmax=(768.787,'K')), NASAPolynomial(coeffs=[8.70523,0.0482681,-2.17636e-05,4.09713e-09,-2.82898e-13,77871.2,1.5736], Tmin=(768.787,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(656.982,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(RCCJ) + radical(Cds_S) + radical(C=CJO)"""),
)
...
species(
    label = '[CH2][CH][C](C)C[C]=COO(22968)',
    structure = SMILES('[CH2][CH][C](C)C[C]=COO'),
    E0 = (645.198,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.343793,0.105062,-0.000149736,1.30351e-07,-4.62367e-11,77746.7,41.9753], Tmin=(100,'K'), Tmax=(805.421,'K')), NASAPolynomial(coeffs=[7.31314,0.0525565,-2.49877e-05,4.77534e-09,-3.30669e-13,76982.9,9.60719], Tmin=(805.421,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(645.198,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(428.195,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Tertalkyl) + radical(Cs_S) + radical(RCCJ) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', '[CH2][CH]CC[C]=CO[O](20977)'],
    products = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
    products = ['[CH2]C(C)[CH]C[C]=CO[O](22953)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
    products = ['O2(S)(666)', 'C#CCC(C)[CH][CH2](15560)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction8',
    reactants = ['O(4)', '[CH2][CH]C(C)C[C]=C[O](22954)'],
    products = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH][CH2](502)', 'C[CH]C[C]=CO[O](21354)'],
    products = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[C]=CO[O](21346)', '[CH2][CH]C([CH2])C(111)'],
    products = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2][C]C(C)C[C]=CO[O](22955)'],
    products = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH][CH]C(C)C[C]=CO[O](22956)'],
    products = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
    products = ['[CH2][CH]C(C)CC1=COO1(22957)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
    products = ['O(4)', '[CH2][CH]C(C)CC1=CO1(22959)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
    products = ['[CH2]C=C(C)CC=CO[O](22960)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'C=C[C](C)C[C]=CO[O](21910)'],
    products = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH2][CH]C(C)CC#CO[O](21180)'],
    products = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.135493,'m^3/(mol*s)'), n=1.98996, Ea=(52.5944,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_R;CJ]
Euclidian distance = 0
family: R_Addition_MultipleBond
Ea raised from 47.7 to 52.6 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction23',
    reactants = ['CH3(17)', 'C=C[CH]C[C]=CO[O](21892)'],
    products = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
...
reaction(
    label = 'reaction25',
    reactants = ['O2(2)', 'C#CCC(C)[CH][CH2](15560)'],
    products = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O2(2)', '[CH]=[C]CC(C)[CH][CH2](16021)'],
    products = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
...
reaction(
    label = 'reaction28',
    reactants = ['CH3(17)', '[CH2][CH][CH]C[C]=CO[O](22218)'],
    products = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', '[CH2][CH][C](C)C[C]=CO[O](22961)'],
    products = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', '[CH2][CH]C(C)C[C]=[C]O[O](22962)'],
    products = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
    products = ['[CH2]C[C](C)C[C]=CO[O](22963)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
    products = ['[CH2][CH]C(C)CC=[C]O[O](22964)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2][CH]C(C)C[C]=[C]OO(22965)'],
    products = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
    products = ['[CH2][CH][C](C)CC=CO[O](22966)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]CC(C)C[C]=[C]O[O](22967)'],
    products = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2][CH][C](C)C[C]=COO(22968)'],
    products = ['[CH2][CH]C(C)C[C]=CO[O](21097)'],
...
network(
    label = 'PDepNetwork #4787',
    isomers = [
        '[CH2][CH]C(C)C[C]=CO[O](21097)',
    ],
    reactants = [
