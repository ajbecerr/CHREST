...
species(
    label = '[CH]C([O])[CH]C(C)C(7266)',
    structure = SMILES('[CH]C([O])[CH]C(C)C'),
    E0 = (508.449,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.416255,0.0691288,-4.47653e-05,9.82569e-09,9.32304e-13,61289.5,31.6526], Tmin=(100,'K'), Tmax=(1093.38,'K')), NASAPolynomial(coeffs=[15.0907,0.0302766,-1.18132e-05,2.14112e-09,-1.47529e-13,57193.9,-44.5078], Tmin=(1093.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(508.449,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][CH]C(C)[CH]C(7267)',
    structure = SMILES('[CH][CH]C(C)[CH]C'),
    E0 = (643.088,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,222.073,393.407,1448.96,1552.06,2935.29],'cm^-1')),
        HinderedRotor(inertia=(0.0750855,'amu*angstrom^2'), symmetry=1, barrier=(2.30877,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0750855,'amu*angstrom^2'), symmetry=1, barrier=(2.30877,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0750855,'amu*angstrom^2'), symmetry=1, barrier=(2.30877,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0750855,'amu*angstrom^2'), symmetry=1, barrier=(2.30877,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0750855,'amu*angstrom^2'), symmetry=1, barrier=(2.30877,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62331,0.0530403,-2.90957e-05,7.44883e-09,-7.60743e-13,77429.4,28.4535], Tmin=(100,'K'), Tmax=(2140.14,'K')), NASAPolynomial(coeffs=[14.6994,0.0286004,-1.19659e-05,2.11274e-09,-1.37402e-13,71832.5,-44.5799], Tmin=(2140.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(643.088,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Cs_S) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C(C)C([CH])[O](7011)',
    structure = SMILES('[CH]C(C)C([CH])[O]'),
    E0 = (780.542,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2800,2850,1350,1500,750,1050,1375,1000,200,800,933.333,1066.67,1200,1333.33,1466.67,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.911725,0.0614636,-5.49159e-05,2.5341e-08,-4.6621e-12,93994.1,26.8307], Tmin=(100,'K'), Tmax=(1311.02,'K')), NASAPolynomial(coeffs=[14.4087,0.0202829,-7.79848e-06,1.38099e-09,-9.30776e-14,90455.2,-41.9395], Tmin=(1311.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(780.542,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C([O])C(C)[C]C(7268)',
    structure = SMILES('[CH]C([O])C(C)[C]C'),
    E0 = (760.109,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.514723,0.0722227,-5.79837e-05,2.45525e-08,-4.26151e-12,22235.7,29.4228], Tmin=(100,'K'), Tmax=(1352.94,'K')), NASAPolynomial(coeffs=[14.252,0.0316082,-1.29545e-05,2.36418e-09,-1.61497e-13,18518.6,-41.0041], Tmin=(1352.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(183.806,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.382609,0.0700942,-4.76644e-05,1.19624e-08,4.7105e-13,24636.6,30.6698], Tmin=(100,'K'), Tmax=(1078.66,'K')), NASAPolynomial(coeffs=[15.3308,0.029286,-1.12529e-05,2.02737e-09,-1.39433e-13,20561,-46.5223], Tmin=(1078.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(203.691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.593826,0.0798062,-8.5913e-05,5.57287e-08,-1.54153e-11,54566,31.3979], Tmin=(100,'K'), Tmax=(860.442,'K')), NASAPolynomial(coeffs=[8.9077,0.0411557,-1.85318e-05,3.52049e-09,-2.45825e-13,53135.3,-7.46185], Tmin=(860.442,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(452.703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(C2CsJOH) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.799138,0.0672238,-4.79976e-05,1.78802e-08,-2.76964e-12,51672.1,31.4149], Tmin=(100,'K'), Tmax=(1473.21,'K')), NASAPolynomial(coeffs=[13.0113,0.0340658,-1.42365e-05,2.60247e-09,-1.77044e-13,48073.8,-32.2333], Tmin=(1473.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(428.649,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ(C)CO) + radical(Cs_S) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    E0 = (481.158,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.785338,0.0719921,-6.07304e-05,2.84162e-08,-5.63142e-12,58004.2,33.0589], Tmin=(100,'K'), Tmax=(1170.59,'K')), NASAPolynomial(coeffs=[10.9627,0.0372152,-1.6167e-05,3.03665e-09,-2.1116e-13,55621.5,-17.6439], Tmin=(1170.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(481.322,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]C([O])C(C)[CH]C(2020)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH]C([O])C[CH]C(1671)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]C([O])[CH]C(C)C(7266)'],
    products = ['[CH]C([O])C(C)[CH]C(2020)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CHCH3(T)(21)', '[CH]C([O])[CH]C(6996)'],
    products = ['[CH]C([O])C(C)[CH]C(2020)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(4)', '[CH][CH]C(C)[CH]C(7267)'],
    products = ['[CH]C([O])C(C)[CH]C(2020)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', '[CH]C(C)C([CH])[O](7011)'],
    products = ['[CH]C([O])C(C)[CH]C(2020)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C([O])C(C)[C]C(7268)'],
    products = ['[CH]C([O])C(C)[CH]C(2020)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]C([O])C(C)=CC(7270)'],
    products = ['[CH]C([O])C(C)[CH]C(2020)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH]=C([O])C(C)[CH]C(2744)'],
    products = ['[CH]C([O])C(C)[CH]C(2020)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH]C([O])C(C)C=C(6955)'],
    products = ['[CH]C([O])C(C)[CH]C(2020)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH](6993)', 'C[CH]C(C)C=O(2029)'],
    products = ['[CH]C([O])C(C)[CH]C(2020)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH][CH][O](6986)', 'butene2t(396)'],
    products = ['[CH]C([O])C(C)[CH]C(2020)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(17)', '[CH]C([O])C=CC(7032)'],
    products = ['[CH]C([O])C(C)[CH]C(2020)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(4679.9,'m^3/(mol*s)'), n=0.573452, Ea=(110.895,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
...
reaction(
    label = 'reaction20',
    reactants = ['CH3(17)', '[CH]C([O])[CH][CH]C(7033)'],
    products = ['[CH]C([O])C(C)[CH]C(2020)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH]C([O])[C](C)[CH]C(7271)'],
    products = ['[CH]C([O])C(C)[CH]C(2020)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH][C]([O])C(C)[CH]C(7272)'],
    products = ['[CH]C([O])C(C)[CH]C(2020)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]C([O])C(C)[CH]C(2020)'],
    products = ['[CH]C([O])C(C)C[CH2](7065)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]C(O)C([CH2])[CH]C(7064)'],
    products = ['[CH]C([O])C(C)[CH]C(2020)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH]C([O])C(C)[CH]C(2020)'],
    products = ['[CH]C(O)C(C)[CH][CH2](7275)'],
