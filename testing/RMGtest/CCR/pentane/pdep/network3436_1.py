...
species(
    ...
    E0 = (446.164,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,180,180,658.67,1341.99,1342,1342.04,1342.04,1342.05],'cm^-1')),
        HinderedRotor(inertia=(0.247855,'amu*angstrom^2'), symmetry=1, barrier=(5.69868,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (53.0825,'amu'),
