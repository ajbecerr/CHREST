...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(15)', '[CH2]C([CH2])=C(285)'],
    products = ['[CH2]CC([CH2])=C(208)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][CH]C([CH2])[CH2](212)'],
    products = ['[CH2]CC([CH2])=C(208)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction17',
    reactants = ['H(9)', '[CH2][CH]C([CH2])=C(293)'],
    products = ['[CH2]CC([CH2])=C(208)'],
