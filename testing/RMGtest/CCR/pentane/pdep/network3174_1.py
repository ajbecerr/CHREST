...
species(
    label = '[CH][CH]C[CH]C[CH][CH2](14057)',
    structure = SMILES('[CH][CH]C[CH]C[CH][CH2]'),
    E0 = (1021.17,'kJ/mol'),
    modes = [
...
species(
    label = '[CH]C[CH]C[CH][CH][CH2](14058)',
    structure = SMILES('[CH]C[CH]C[CH][CH][CH2]'),
    E0 = (1021.18,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,3000,3100,440,815,1455,1000,182.291,556.701,696.446,2399.01,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0336796,'amu*angstrom^2'), symmetry=1, barrier=(0.776841,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0336796,'amu*angstrom^2'), symmetry=1, barrier=(0.776841,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0336796,'amu*angstrom^2'), symmetry=1, barrier=(0.776841,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0336796,'amu*angstrom^2'), symmetry=1, barrier=(0.776841,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0336796,'amu*angstrom^2'), symmetry=1, barrier=(0.776841,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[4.25969,0.0441548,-1.63342e-05,1.60471e-09,5.89873e-14,122757,25.7257], Tmin=(100,'K'), Tmax=(2865.27,'K')), NASAPolynomial(coeffs=[60.0026,-0.0141049,3.92606e-06,-7.26895e-10,5.45566e-14,82784.5,-315.89], Tmin=(2865.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1021.18,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC) + radical(RCCJC) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1[CH]CCC1[CH2](14059)',
    structure = SMILES('[CH]C1[CH]CCC1[CH2]'),
    E0 = (690.522,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89171,0.0336431,4.15319e-05,-6.04939e-08,2.03029e-11,78285.4,24.5995], Tmin=(100,'K'), Tmax=(1114.97,'K')), NASAPolynomial(coeffs=[7.94302,0.0458988,-2.065e-05,4.00742e-09,-2.85661e-13,74824.8,-14.7206], Tmin=(1114.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(650.183,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(403.252,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclohexane) + radical(Cs_S) + radical(cyclohexane) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]C1CCC1[CH2](14061)',
    structure = SMILES('[CH][CH]C1CCC1[CH2]'),
    E0 = (772.289,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
...
species(
    label = '[CH][CH]C1C[CH]CC1(14062)',
    structure = SMILES('[CH][CH]C1C[CH]CC1'),
    E0 = (680.363,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.90927,0.0326621,4.14995e-05,-6.58686e-08,2.44351e-11,81915.6,29.4482], Tmin=(100,'K'), Tmax=(1017.08,'K')), NASAPolynomial(coeffs=[8.70974,0.0385229,-1.52319e-05,2.83764e-09,-2.00796e-13,78845.8,-11.766], Tmin=(1017.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(680.363,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopentane) + radical(cyclopentane) + radical(Cs_S) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C=C[CH]C[CH][CH2](14064)',
    ...
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.32061,0.059039,-3.07654e-05,7.50957e-09,-7.34021e-13,97681.9,30.5078], Tmin=(100,'K'), Tmax=(2213.08,'K')), NASAPolynomial(coeffs=[15.389,0.0336116,-1.35312e-05,2.31798e-09,-1.4756e-13,91455,-48.5397], Tmin=(2213.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(811.382,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(RCCJC) + radical(RCCJ) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C=CC[CH]C[CH2](14068)',
    structure = SMILES('[CH]C=CC[CH]C[CH2]'),
    E0 = (670.281,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.62436,0.0598231,-2.97306e-05,6.69616e-09,-5.93889e-13,80692.7,30.3061], Tmin=(100,'K'), Tmax=(2403.24,'K')), NASAPolynomial(coeffs=[16.0547,0.0358048,-1.47393e-05,2.53751e-09,-1.61278e-13,73756.8,-51.9649], Tmin=(2403.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(670.281,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(RCCJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=C[CH]CC[CH2](14069)',
    structure = SMILES('[CH]C=C[CH]CC[CH2]'),
    E0 = (616.936,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.654737,0.0640803,-2.87621e-05,6.26273e-10,2.08923e-12,74328.4,30.1837], Tmin=(100,'K'), Tmax=(1236.74,'K')), NASAPolynomial(coeffs=[12.2661,0.0402512,-1.65079e-05,2.99438e-09,-2.03459e-13,70406.7,-32.5452], Tmin=(1236.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(616.936,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(RCCJ) + radical(AllylJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.988003,0.067624,-4.20379e-05,1.35797e-08,-1.88645e-12,85940.5,30.5402], Tmin=(100,'K'), Tmax=(1538.88,'K')), NASAPolynomial(coeffs=[10.2866,0.0434544,-1.84792e-05,3.3737e-09,-2.28442e-13,83078.6,-18.3283], Tmin=(1538.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(713.665,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH][C]=CCCC[CH2](14071)',
    structure = SMILES('[CH][C]=CCCC[CH2]'),
    E0 = (713.665,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[C]=C[CH]CC[CH][CH2](14072)',
    structure = SMILES('[C]C=CCC[CH][CH2]'),
    E0 = (969.063,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,332.347,335.337,1282.02,1285.32],'cm^-1')),
        HinderedRotor(inertia=(0.110202,'amu*angstrom^2'), symmetry=1, barrier=(8.57267,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110643,'amu*angstrom^2'), symmetry=1, barrier=(8.57878,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.111746,'amu*angstrom^2'), symmetry=1, barrier=(8.60598,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00153581,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (93.1464,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2274,0.0644576,-5.30039e-05,2.57478e-08,-5.5385e-12,116648,29.309], Tmin=(100,'K'), Tmax=(1057.82,'K')), NASAPolynomial(coeffs=[7.87583,0.0393178,-1.73558e-05,3.2816e-09,-2.29018e-13,115242,-3.13963], Tmin=(1057.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(969.063,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(RCCJ) + radical(CJ3)"""),
)

species(
    label = '[CH2][CH]CCC1C=C1(14073)',
    structure = SMILES('[CH2][CH]CCC1C=C1'),
    E0 = (569.433,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2808,0.0631991,-4.48589e-05,1.84714e-08,-3.44103e-12,68582,26.6656], Tmin=(100,'K'), Tmax=(1173.11,'K')), NASAPolynomial(coeffs=[7.34618,0.0425177,-1.84146e-05,3.44336e-09,-2.38428e-13,67158.9,-3.56474], Tmin=(1173.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(569.433,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(RCCJC) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.549802,0.0652363,-3.2955e-05,-3.79927e-09,6.14814e-12,55917.2,29.5321], Tmin=(100,'K'), Tmax=(1026.68,'K')), NASAPolynomial(coeffs=[15.2171,0.0291834,-1.10964e-05,2.0169e-09,-1.40638e-13,51793.9,-47.0287], Tmin=(1026.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(463.812,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]C=CCC[CH][CH2](5270)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH][CH2](502)', '[CH]=C[CH]C[CH2](13774)'],
    products = ['[CH]C=CCC[CH][CH2](5270)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH][CH]CCC=C[CH](14056)'],
    products = ['[CH]C=CCC[CH][CH2](5270)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['[CH][CH]C[CH]C[CH][CH2](14057)'],
    products = ['[CH]C=CCC[CH][CH2](5270)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH][CH]CC[CH][CH][CH2](9242)'],
    products = ['[CH]C=CCC[CH][CH2](5270)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]C[CH]C[CH][CH][CH2](14058)'],
    products = ['[CH]C=CCC[CH][CH2](5270)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]C=CCC[CH][CH2](5270)'],
    products = ['[CH]C1[CH]CCC1[CH2](14059)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]C=CCC[CH][CH2](5270)'],
    products = ['[CH]C1[CH]CC[CH]C1(14060)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]C=CCC[CH][CH2](5270)'],
    products = ['[CH][CH]C1CCC1[CH2](14061)'],
    transitionState = 'TS12',
    kinetics = Arrhenius(A=(4.06771e+06,'s^-1'), n=1.35044, Ea=(102.02,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R5_SS_D;doublebond_intra;radadd_intra_cs]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic
Ea raised from 98.5 to 102.0 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction13',
    reactants = ['[CH]C=CCC[CH][CH2](5270)'],
    products = ['[CH][CH]C1C[CH]CC1(14062)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH]C=CCC=C[CH2](14063)'],
    products = ['[CH]C=CCC[CH][CH2](5270)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]C=[CH](13797)', '[CH2][CH]C[CH2](66)'],
    products = ['[CH]C=CCC[CH][CH2](5270)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH]C=C[CH]C[CH][CH2](14064)'],
    products = ['[CH]C=CCC[CH][CH2](5270)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH]C=CC[CH][CH][CH2](14065)'],
    products = ['[CH]C=CCC[CH][CH2](5270)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH]C=[C]CC[CH][CH2](14066)'],
    products = ['[CH]C=CCC[CH][CH2](5270)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH][C]=CCC[CH][CH2](14067)'],
    products = ['[CH]C=CCC[CH][CH2](5270)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH]C=CC[CH]C[CH2](14068)'],
    products = ['[CH]C=CCC[CH][CH2](5270)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]C=CCC[CH][CH2](5270)'],
    products = ['[CH]C=C[CH]CC[CH2](14069)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]C=[C]CCC[CH2](14070)'],
    products = ['[CH]C=CCC[CH][CH2](5270)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]C=CCC[CH][CH2](5270)'],
    products = ['[CH]C=C[CH]C[CH]C(13886)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]C=[C]CC[CH]C(13887)'],
    products = ['[CH]C=CCC[CH][CH2](5270)'],
...
reaction(
    label = 'reaction31',
    reactants = ['C2H2(T)(1343)', '[CH]CC[CH][CH2](504)'],
    products = ['[CH]C=CCC[CH][CH2](5270)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', '[C]=C[CH]CC[CH][CH2](14072)'],
    products = ['[CH]C=CCC[CH][CH2](5270)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]C=CCC[CH][CH2](5270)'],
    products = ['[CH2][CH]CCC1C=C1(14073)'],
...
reaction(
    label = 'reaction40',
    reactants = ['H(3)', '[CH]=CC=CC[CH][CH2](14075)'],
    products = ['[CH]C=CCC[CH][CH2](5270)'],
...
reaction(
    label = 'reaction41',
    reactants = ['H(3)', '[CH]=C=CCC[CH][CH2](14076)'],
    products = ['[CH]C=CCC[CH][CH2](5270)'],
...
reaction(
    label = 'reaction42',
    reactants = ['C2H2(1342)', '[CH]CC[CH][CH2](504)'],
    products = ['[CH]C=CCC[CH][CH2](5270)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH][CH]CCC=C[CH2](5271)'],
    products = ['[CH]C=CCC[CH][CH2](5270)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH]C=CCC[CH][CH2](5270)'],
    products = ['[CH2][CH]C[CH]C=C[CH2](5279)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH]C=CCC[CH][CH2](5270)'],
    products = ['[CH2][CH][CH]CC=C[CH2](5280)'],
