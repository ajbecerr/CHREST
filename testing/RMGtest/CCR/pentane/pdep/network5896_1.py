...
species(
    label = '[CH2]C(=C[O])OC([CH2])C(25274)',
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.73622,0.102682,-0.000107175,5.35557e-08,-1.00174e-11,4842.07,34.8974], Tmin=(100,'K'), Tmax=(1487.93,'K')), NASAPolynomial(coeffs=[27.3208,0.0110766,-1.22473e-06,-9.16983e-12,6.42207e-15,-2311.43,-111.814], Tmin=(1487.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(38.375,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CJC(C)OC) + radical(C=C(O)CJ)"""),
)
...
species(
    label = '[CH2][C]([C][O])OC([CH2])C(26345)',
    structure = SMILES('[CH2][C]([C][O])OC([CH2])C'),
    E0 = (786.555,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.11635,0.133946,-0.000258545,2.47198e-07,-8.75563e-11,94764.6,34.8942], Tmin=(100,'K'), Tmax=(881.379,'K')), NASAPolynomial(coeffs=[7.16876,0.0459972,-2.31789e-05,4.35702e-09,-2.91367e-13,95259.7,7.06346], Tmin=(881.379,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(786.555,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CH2_triplet)"""),
)

species(
    label = '[CH][C]([CH][O])OC([CH2])C(26346)',
    structure = SMILES('[CH][C]([CH][O])OC([CH2])C'),
    E0 = (743.569,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,180,180,180,383.398,1425.21,1600,2933.33,3200],'cm^-1')),
        HinderedRotor(inertia=(0.146096,'amu*angstrom^2'), symmetry=1, barrier=(3.35903,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.49867,0.104828,-0.000141841,1.05292e-07,-3.14824e-11,23364.8,31.6117], Tmin=(100,'K'), Tmax=(816.721,'K')), NASAPolynomial(coeffs=[13.412,0.036699,-1.67144e-05,3.1542e-09,-2.17936e-13,21092.6,-32.6829], Tmin=(816.721,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(192.964,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCOJ) + radical(CCsJOH) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2][C]([CH][O])O[C](C)C(26350)',
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.877238,0.134194,-0.000270175,2.71074e-07,-9.90504e-11,57406.6,34.3532], Tmin=(100,'K'), Tmax=(885.589,'K')), NASAPolynomial(coeffs=[1.55763,0.0574001,-2.86567e-05,5.36435e-09,-3.57693e-13,59555.5,37.4695], Tmin=(885.589,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(476.058,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOCs) + radical(C2CsJOCs) + radical(CCsJOH) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][C](C)OC([CH2])[CH][O](26351)',
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.14936,0.136461,-0.000263624,2.54986e-07,-9.09842e-11,61004.8,35.83], Tmin=(100,'K'), Tmax=(885.387,'K')), NASAPolynomial(coeffs=[5.39219,0.0513653,-2.53588e-05,4.72822e-09,-3.14719e-13,62023.4,17.3611], Tmin=(885.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(505.864,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOCs) + radical(CCsJOH) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][C](C)O[C]([CH2])C[O](26352)',
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.00852,0.138797,-0.000284494,2.86141e-07,-1.04348e-10,61043.4,35.7206], Tmin=(100,'K'), Tmax=(888.996,'K')), NASAPolynomial(coeffs=[1.39396,0.0576265,-2.88173e-05,5.37823e-09,-3.57124e-13,63396.6,40.0502], Tmin=(888.996,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(506.27,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOCs) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][C](C)O[C](C)[CH][O](26353)',
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.877238,0.134194,-0.000270175,2.71074e-07,-9.90504e-11,57406.6,35.0464], Tmin=(100,'K'), Tmax=(885.589,'K')), NASAPolynomial(coeffs=[1.55763,0.0574001,-2.86567e-05,5.36435e-09,-3.57693e-13,59555.5,38.1626], Tmin=(885.589,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(476.058,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOCs) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C([CH2])OC([CH2])[CH][O](26354)',
    structure = SMILES('[CH2]C([CH2])OC([CH2])[CH][O]'),
    E0 = (535.671,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,3025,407.5,1350,352.5,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.42169,0.13873,-0.000257082,2.38913e-07,-8.29252e-11,64603,35.9211], Tmin=(100,'K'), Tmax=(885.07,'K')), NASAPolynomial(coeffs=[9.22727,0.0453296,-2.20604e-05,4.09195e-09,-2.71734e-13,64491.2,-4.13633], Tmin=(885.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(535.671,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CCsJOH) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][C](C[O])OC([CH2])[CH2](26355)',
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.28115,0.14107,-0.000277967,2.70089e-07,-9.62992e-11,64641.7,35.8128], Tmin=(100,'K'), Tmax=(889.344,'K')), NASAPolynomial(coeffs=[5.22974,0.0515895,-2.55182e-05,4.74178e-09,-3.14124e-13,65864.1,18.5488], Tmin=(889.344,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(536.076,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)
...
species(
    ...
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.14936,0.136461,-0.000263624,2.54986e-07,-9.09842e-11,61004.8,35.1368], Tmin=(100,'K'), Tmax=(885.387,'K')), NASAPolynomial(coeffs=[5.39219,0.0513653,-2.53588e-05,4.72822e-09,-3.14719e-13,62023.4,16.668], Tmin=(885.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(505.864,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CCsJOH)"""),
)

species(
    label = '[CH2][C](C)O[C]([CH2])[CH]O(26357)',
    structure = SMILES('[CH2][C](C)O[C]([CH2])[CH]O'),
    E0 = (460.863,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.60071,0.149803,-0.000301632,2.90863e-07,-1.02268e-10,55605.6,36.5356], Tmin=(100,'K'), Tmax=(899.953,'K')), NASAPolynomial(coeffs=[6.56105,0.0482587,-2.35973e-05,4.31468e-09,-2.80955e-13,56779.6,12.7047], Tmin=(899.953,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(460.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOCs) + radical(C2CsJOCs) + radical(CCsJOH) + radical(CJC(C)OC) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2][C]([CH]O)OC([CH2])[CH2](26358)',
    structure = SMILES('[CH2][C]([CH]O)OC([CH2])[CH2]'),
    E0 = (490.669,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.134,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.87631,0.152114,-0.000295255,2.75034e-07,-9.43276e-11,59203.9,36.6383], Tmin=(100,'K'), Tmax=(902.085,'K')), NASAPolynomial(coeffs=[10.4015,0.0422132,-2.02931e-05,3.677e-09,-2.3785e-13,59245.3,-8.82296], Tmin=(902.085,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(490.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(378.308,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + longDistanceInteraction_noncyclic(OsCs-ST) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CCsJOH) + radical(CJC(C)OC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
    products = ['[CH2]C(=C[O])OC([CH2])C(25274)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', '[CH2]CO[C]([CH2])[CH][O](25258)'],
    products = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][C][CH][O](17607)', '[CH2]C(C)[O](667)'],
    products = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(20)', '[CH2][C]([CH][O])O[CH]C(26253)'],
    products = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C(C)O[C]([CH2])[CH][O](26344)'],
    products = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH2][C]([C][O])OC([CH2])C(26345)'],
    products = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH][C]([CH][O])OC([CH2])C(26346)'],
    products = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
    products = ['[CH2]C([CH][O])OC(=C)C(26347)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH2][C]([CH][O])OC(=C)C(26348)'],
    products = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.41198,'m^3/(mol*s)'), n=2.03228, Ea=(201.604,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(17)', '[CH2][CH]OC(=C)[CH][O](22808)'],
    products = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
    transitionState = 'TS14',
    kinetics = Arrhenius(A=(0.00632077,'m^3/(mol*s)'), n=2.46811, Ea=(99.5097,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cds_Cds;CsJ-HHH] for rate rule [Cds-OsH_Cds;CsJ-HHH]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 96.7 to 99.5 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(17)', '[CH2][CH]O[C]([CH2])[CH][O](26252)'],
    products = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2][C](C)O[C]([CH2])[CH][O](26349)'],
    products = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2][C]([CH][O])OC([CH2])[CH2](25396)'],
    products = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
    products = ['[CH2][C]([CH][O])O[C](C)C(26350)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][C](C)OC([CH2])[CH][O](26351)'],
    products = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
    products = ['[CH2][C](C)O[C]([CH2])C[O](26352)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
    products = ['[CH2][C](C)O[C](C)[CH][O](26353)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2]C([CH2])OC([CH2])[CH][O](26354)'],
    products = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2][C](C[O])OC([CH2])[CH2](26355)'],
    products = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
    products = ['[CH2][C](C)O[C]([CH2])[CH]O(26357)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2][C]([CH][O])OC([CH2])C(25287)'],
    products = ['[CH2][C]([CH]O)OC([CH2])[CH2](26358)'],
...
network(
    label = 'PDepNetwork #5896',
    isomers = [
        '[CH2][C]([CH][O])OC([CH2])C(25287)',
    ],
    reactants = [
