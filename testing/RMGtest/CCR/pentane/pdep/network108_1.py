...
reaction(
    label = 'reaction6',
    reactants = ['[CH]CC(26)', '[CH2]C[CH]C(36)'],
    products = ['C[CH]CC[CH]CC(203)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CHCH3(T)(21)', '[CH2]C[CH]CC(101)'],
    products = ['C[CH]CC[CH]CC(203)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction8',
    reactants = ['C2H5(14)', '[CH]CC[CH]C(119)'],
    products = ['C[CH]CC[CH]CC(203)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction9',
    reactants = ['CH3(17)', '[CH]CC[CH]CC(240)'],
    products = ['C[CH]CC[CH]CC(203)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'C[CH]CC[C]CC(319)'],
    products = ['C[CH]CC[CH]CC(203)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C[C]CC[CH]CC(320)'],
    products = ['C[CH]CC[CH]CC(203)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH3(17)', 'C=CCC[CH]C(159)'],
    products = ['C[CH]CC[CH]CC(203)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', 'C[CH]C[CH][CH]CC(326)'],
    products = ['C[CH]CC[CH]CC(203)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', 'C[CH][CH]C[CH]CC(327)'],
    products = ['C[CH]CC[CH]CC(203)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH3(17)', '[CH2][CH]CC[CH]C(161)'],
    products = ['C[CH]CC[CH]CC(203)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', 'C[CH][CH]CC[CH]C(328)'],
    products = ['C[CH]CC[CH]CC(203)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH2]C[CH]CC[CH]C(329)'],
    products = ['C[CH]CC[CH]CC(203)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', '[CH2][CH]CC[CH]CC(330)'],
    products = ['C[CH]CC[CH]CC(203)'],
