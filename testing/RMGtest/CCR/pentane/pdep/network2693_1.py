...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.447885,0.0803092,-0.000103333,6.86382e-08,-1.80021e-11,43073.7,29.5538], Tmin=(100,'K'), Tmax=(934.634,'K')), NASAPolynomial(coeffs=[14.0891,0.0219277,-9.63541e-06,1.80425e-09,-1.24911e-13,40523.8,-35.3351], Tmin=(934.634,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(357.087,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(CCsJOCs) + radical(RCCJ) + radical(CCsJOCs) + radical(CsCJ=O)"""),
)
...
species(
    label = '[CH2][CH][CH]OC=[C]O(12379)',
    structure = SMILES('[CH2][CH][CH]OC=[C]O'),
    E0 = (420.74,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.34571,0.0899176,-0.00010347,5.36119e-08,-1.00411e-11,50819.6,37.5606], Tmin=(100,'K'), Tmax=(1564.03,'K')), NASAPolynomial(coeffs=[26.2966,-0.00182166,4.69622e-06,-1.09652e-09,7.87671e-14,44746.8,-99.9327], Tmin=(1564.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(420.74,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(CCJCO) + radical(CCsJOC(O)) + radical(RCCJ) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.747025,0.0550859,-9.56184e-06,-4.02018e-08,2.28692e-11,2302.93,25.334], Tmin=(100,'K'), Tmax=(944.279,'K')), NASAPolynomial(coeffs=[21.243,0.00924897,-1.85402e-06,3.20755e-10,-2.84006e-14,-3395.08,-82.0473], Tmin=(944.279,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(18.0486,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(Allyl_P) + radical(CsCJ=O)"""),
)

species(
    label = '[CH2][CH][CH]OC[C]=O(12381)',
    structure = SMILES('[CH2][CH][CH]OC[C]=O'),
    E0 = (376.533,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.00965,0.0673121,-7.29033e-05,4.20512e-08,-9.82921e-12,45392.9,30.5874], Tmin=(100,'K'), Tmax=(1031.06,'K')), NASAPolynomial(coeffs=[11.9485,0.0248746,-1.11641e-05,2.13129e-09,-1.49803e-13,43137.2,-22.5206], Tmin=(1031.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(376.533,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(CCsJOCs) + radical(RCCJ) + radical(CsCJ=O)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH][CH2](502)', '[CH2]OC=[C][O](11465)'],
    products = ['[CH2][CH]CO[CH][C]=O(11036)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2][C]COC=[C][O](12375)'],
    products = ['[CH2][CH]CO[CH][C]=O(11036)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH][CH]COC=[C][O](12376)'],
    products = ['[CH2][CH]CO[CH][C]=O(11036)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'C=C[CH]OC=[C][O](12182)'],
    products = ['[CH2][CH]CO[CH][C]=O(11036)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction11',
    reactants = ['HCCO(2227)', '[CH2][CH]C[O](1367)'],
    products = ['[CH2][CH]CO[CH][C]=O(11036)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=[C][O](6861)', '[CH2][CH]C[O](1367)'],
    products = ['[CH2][CH]CO[CH][C]=O(11036)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH2][CH][CH]OC=[C][O](12377)'],
    products = ['[CH2][CH]CO[CH][C]=O(11036)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][CH]CO[CH][C]=O(11036)'],
    products = ['[CH2]C[CH]OC=[C][O](12378)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2][CH][CH]OC=[C]O(12379)'],
    products = ['[CH2][CH]CO[CH][C]=O(11036)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2][CH][CH]OC[C]=O(12381)'],
    products = ['[CH2][CH]CO[CH][C]=O(11036)'],
