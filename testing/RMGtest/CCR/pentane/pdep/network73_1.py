...
species(
    ...
    molecularWeight = (75.0865,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.0636,0.0442419,-3.39821e-05,1.47137e-08,-2.76752e-12,-1411.09,19.1984], Tmin=(100,'K'), Tmax=(1201.27,'K')), NASAPolynomial(coeffs=[7.51865,0.0260777,-1.1301e-05,2.12648e-09,-1.4797e-13,-2721.7,-8.11943], Tmin=(1201.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-12.2999,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCsJOOH)"""),
)
...
species(
    ...
    molecularWeight = (75.0865,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73075,0.0457841,-3.51689e-05,1.42448e-08,-2.36091e-12,1161.01,22.4746], Tmin=(100,'K'), Tmax=(1415.64,'K')), NASAPolynomial(coeffs=[10.8294,0.0200752,-7.92782e-06,1.41611e-09,-9.53844e-14,-1415.06,-24.5834], Tmin=(1415.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(8.94627,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), label="""QOOH_1""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
This reaction matched rate rule [Root_N-1R->H_N-1CNOS->N_1COS->O_Ext-1O-R_Ext-2R-R_Ext-4R!H-R_Sp-4R!H-2R_Sp-5R!H-4R!H]
family: R_Recombination"""),
)

reaction(
    label = 'reaction5',
    reactants = ['[CH2]O[O](46)', 'C2H5(14)'],
    products = ['npropylperoxy(32)'],
    transitionState = 'TS5',
