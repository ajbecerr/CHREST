species(
    ...
    E0 = (-93.2647,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,314.383],'cm^-1')),
        HinderedRotor(inertia=(0.125614,'amu*angstrom^2'), symmetry=1, barrier=(8.83999,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126108,'amu*angstrom^2'), symmetry=1, barrier=(8.85352,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.125863,'amu*angstrom^2'), symmetry=1, barrier=(8.84702,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.126872,'amu*angstrom^2'), symmetry=1, barrier=(8.87248,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41175,0.0565301,-4.05021e-05,1.58078e-08,-2.63472e-12,-11123.9,22.7699], Tmin=(100,'K'), Tmax=(1352.72,'K')), NASAPolynomial(coeffs=[9.67023,0.0321098,-1.34229e-05,2.4622e-09,-1.68292e-13,-13358.2,-19.5675], Tmin=(1352.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-93.2647,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ)"""),
)
...
species(
    ...
    E0 = (-86.4136,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,360.668,362.35],'cm^-1')),
        HinderedRotor(inertia=(0.00128368,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108862,'amu*angstrom^2'), symmetry=1, barrier=(10.1197,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.107971,'amu*angstrom^2'), symmetry=1, barrier=(10.1254,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.1137,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71808,0.042302,-9.41422e-06,-1.31101e-08,6.78067e-12,-10304.3,19.9628], Tmin=(100,'K'), Tmax=(1059.95,'K')), NASAPolynomial(coeffs=[9.96275,0.0272041,-1.07127e-05,1.9615e-09,-1.36258e-13,-12951.8,-24.537], Tmin=(1059.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-86.4136,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ)"""),
)
...
species(
    ...
    molecularWeight = (89.1131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50476,0.0597765,-4.97154e-05,2.55386e-08,-6.04958e-12,-6934.61,21.9914], Tmin=(100,'K'), Tmax=(947.347,'K')), NASAPolynomial(coeffs=[6.17436,0.0400599,-1.84967e-05,3.56923e-09,-2.51964e-13,-7819.35,-0.284137], Tmin=(947.347,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-58.3703,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOOH)"""),
)

species(
    label = 'C[CH]C(C)OO(401)',
    ...
    molecularWeight = (89.1131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27472,0.0609259,-4.73282e-05,1.98443e-08,-3.53395e-12,-5297.68,24.8096], Tmin=(100,'K'), Tmax=(1279.46,'K')), NASAPolynomial(coeffs=[10.237,0.0329071,-1.448e-05,2.72876e-09,-1.89681e-13,-7591.07,-20.637], Tmin=(1279.46,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-44.8545,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C(CC)OO(212)',
    ...
    molecularWeight = (89.1131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.01428,0.0636021,-5.1422e-05,2.20081e-08,-3.89368e-12,-3656.32,25.4357], Tmin=(100,'K'), Tmax=(1318.49,'K')), NASAPolynomial(coeffs=[12.2991,0.0293667,-1.24737e-05,2.31474e-09,-1.59616e-13,-6632.11,-32.1271], Tmin=(1318.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-31.3069,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]CC(C)OO(402)',
    ...
    molecularWeight = (89.1131,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17752,0.0609183,-4.632e-05,1.85887e-08,-3.11648e-12,-4711.38,24.6396], Tmin=(100,'K'), Tmax=(1368.18,'K')), NASAPolynomial(coeffs=[11.5029,0.0307309,-1.32241e-05,2.46209e-09,-1.69742e-13,-7536.77,-28.4113], Tmin=(1368.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-40.0231,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['CCC(C)O[O](211)'],
    products = ['HO2(9)', 'butene2t(396)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', 'ipropylperoxy(171)'],
    products = ['CCC(C)O[O](211)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction10',
    reactants = ['CH3(17)', '[CH2]C(C)O[O](87)'],
    products = ['CCC(C)O[O](211)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'C[CH]C(C)O[O](398)'],
    products = ['CCC(C)O[O](211)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH2]C(CC)O[O](191)'],
    products = ['CCC(C)O[O](211)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2]CC(C)O[O](399)'],
    products = ['CCC(C)O[O](211)'],
