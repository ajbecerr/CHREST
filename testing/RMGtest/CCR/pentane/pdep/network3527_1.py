...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.0354263,'amu*angstrom^2'), symmetry=1, barrier=(19.4899,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180282,'amu*angstrom^2'), symmetry=1, barrier=(4.14503,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0661389,'amu*angstrom^2'), symmetry=1, barrier=(36.2963,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.84714,'amu*angstrom^2'), symmetry=1, barrier=(19.4774,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.319653,0.0694186,-3.30835e-05,-5.78361e-09,6.96743e-12,59411.3,28.8809], Tmin=(100,'K'), Tmax=(1032.05,'K')), NASAPolynomial(coeffs=[15.7125,0.0325074,-1.24986e-05,2.27673e-09,-1.58662e-13,55022.6,-51.7353], Tmin=(1032.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(492.789,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.301248,0.0693241,-2.79066e-05,-1.19411e-08,9.27964e-12,-326.068,25.3852], Tmin=(100,'K'), Tmax=(1016.71,'K')), NASAPolynomial(coeffs=[15.5704,0.0341922,-1.28717e-05,2.32848e-09,-1.6204e-13,-4720,-54.8721], Tmin=(1016.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-3.90549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.947809,0.0577627,-1.37447e-05,-1.43922e-08,7.56861e-12,38932.2,29.2052], Tmin=(100,'K'), Tmax=(1068.65,'K')), NASAPolynomial(coeffs=[10.309,0.0409548,-1.5743e-05,2.81881e-09,-1.9243e-13,35890.3,-21.4496], Tmin=(1068.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(322.721,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Tertalkyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][C]1CCC1CC(15676)',
...
species(
    label = '[CH]=C(C)C([CH2])CC(15682)',
    structure = SMILES('[CH]=C(C)C([CH2])CC'),
    E0 = (345.253,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,3000,3100,440,815,1455,1000,3120,650,792.5,1650,267.673],'cm^-1')),
        HinderedRotor(inertia=(0.109283,'amu*angstrom^2'), symmetry=1, barrier=(5.55634,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109283,'amu*angstrom^2'), symmetry=1, barrier=(5.55635,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109283,'amu*angstrom^2'), symmetry=1, barrier=(5.55635,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00235288,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.437599,'amu*angstrom^2'), symmetry=1, barrier=(22.2494,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.210819,0.0752326,-5.4936e-05,2.18213e-08,-3.58488e-12,41667.4,30.8694], Tmin=(100,'K'), Tmax=(1422.71,'K')), NASAPolynomial(coeffs=[14.2876,0.0356555,-1.3209e-05,2.26864e-09,-1.49082e-13,37662,-42.0059], Tmin=(1422.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(345.253,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
species(
    ...
    E0 = (303.403,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,180,2504.13],'cm^-1')),
        HinderedRotor(inertia=(0.019015,'amu*angstrom^2'), symmetry=1, barrier=(14.3645,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00714498,'amu*angstrom^2'), symmetry=1, barrier=(5.39795,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.620731,'amu*angstrom^2'), symmetry=1, barrier=(14.3636,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.233772,'amu*angstrom^2'), symmetry=1, barrier=(5.40274,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(3.50304,'amu*angstrom^2'), symmetry=1, barrier=(81.1589,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]C(=C)C([CH2])C(520)'],
...
reaction(
    label = 'reaction6',
    reactants = ['CH2(T)(20)', '[CH2]C(=C)[CH]CC(15628)'],
    products = ['[CH2]C(=C)C([CH2])CC(567)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(T)(20)', '[CH2]C([C]=C)CC(2492)'],
    products = ['[CH2]C(=C)C([CH2])CC(567)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH]C(CC)C([CH2])=C(15671)'],
    products = ['[CH2]C(=C)C([CH2])CC(567)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH]C(=C)C([CH2])CC(15672)'],
    products = ['[CH2]C(=C)C([CH2])CC(567)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][C](CC)C([CH2])[CH2](568)'],
    products = ['[CH2]C(=C)C([CH2])CC(567)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(=C)C([CH2])CC(567)'],
    products = ['[CH2]C(CC)[C]1CC1(15675)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH2]C(=C)C(=C)CC(15678)'],
    products = ['[CH2]C(=C)C([CH2])CC(567)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C2H5(14)', '[CH2]C(=C)C=C(15106)'],
    products = ['[CH2]C(=C)C([CH2])CC(567)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C2H5(14)', '[CH2][C]([CH2])C=C(15109)'],
    products = ['[CH2]C(=C)C([CH2])CC(567)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2][C](CC)C([CH2])=C(15679)'],
    products = ['[CH2]C(=C)C([CH2])CC(567)'],
...
reaction(
    label = 'reaction27',
    reactants = ['CH3(17)', '[CH2]C(=C)C([CH2])[CH2](635)'],
    products = ['[CH2]C(=C)C([CH2])CC(567)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', '[CH2]CC([CH2])C([CH2])=C(9254)'],
    products = ['[CH2]C(=C)C([CH2])CC(567)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]=C(C)C([CH2])CC(15682)'],
    products = ['[CH2]C(=C)C([CH2])CC(567)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH2]CC([CH2])C(=C)C(9064)'],
    products = ['[CH2]C(=C)C([CH2])CC(567)'],
