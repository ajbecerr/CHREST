...
species(
    label = '[CH2][C]CO[CH][C]([CH2])[O](27080)',
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.894835,0.117103,-0.000193195,1.62967e-07,-5.29908e-11,115519,36.406], Tmin=(100,'K'), Tmax=(868.204,'K')), NASAPolynomial(coeffs=[13.9725,0.0311694,-1.46024e-05,2.69898e-09,-1.80533e-13,113595,-29.4346], Tmin=(868.204,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(959.091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CCsJOCs) + radical(CJCO) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2][CH]CO[C][C]([CH2])[O](27081)',
    structure = SMILES('[CH2][CH]CO[C][C]([CH2])[O]'),
    E0 = (991.311,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.514652,0.10723,-0.000169184,1.41048e-07,-4.62486e-11,119382,36.9194], Tmin=(100,'K'), Tmax=(827.609,'K')), NASAPolynomial(coeffs=[12.9598,0.0322846,-1.55502e-05,2.95275e-09,-2.02386e-13,117488,-23.5056], Tmin=(827.609,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(991.311,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO) + radical(C2CsJOH) + radical(RCCJ) + radical(CJCO) + radical(CH2_triplet)"""),
)

species(
    label = '[CH][C]([O])[CH]OC[CH][CH2](27082)',
    structure = SMILES('[CH][C]([O])[CH]OC[CH][CH2]'),
    E0 = (947.404,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.527851,0.106448,-0.00016388,1.33032e-07,-4.24211e-11,114103,38.0512], Tmin=(100,'K'), Tmax=(841.959,'K')), NASAPolynomial(coeffs=[13.6146,0.0308442,-1.41931e-05,2.63732e-09,-1.78462e-13,112020,-25.9734], Tmin=(841.959,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(947.404,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO) + radical(CCsJOCs) + radical(C2CsJOH) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]CO[CH][C]([CH2])[O](27083)',
    structure = SMILES('[CH][CH]CO[CH][C]([CH2])[O]'),
    E0 = (953.747,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,360,370,350,3000,3100,440,815,1455,1000,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.734241,0.111105,-0.000173876,1.40808e-07,-4.44796e-11,114873,37.639], Tmin=(100,'K'), Tmax=(853.943,'K')), NASAPolynomial(coeffs=[14.7237,0.0292041,-1.33374e-05,2.4586e-09,-1.65146e-13,112579,-32.4691], Tmin=(853.943,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(953.747,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO) + radical(C2CsJOH) + radical(CCsJOCs) + radical(CJCO) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.738205,0.0944819,-9.37678e-05,4.03398e-08,-4.80154e-12,42550.5,32.2449], Tmin=(100,'K'), Tmax=(973.208,'K')), NASAPolynomial(coeffs=[22.7995,0.0175614,-5.76255e-06,9.82999e-10,-6.7662e-14,37030.3,-85.4943], Tmin=(973.208,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(352.294,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CJCO) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH2][CH][CH]O[CH][C]([CH2])[O](27086)',
    structure = SMILES('[CH2][CH][CH]O[CH][C]([CH2])[O]'),
    E0 = (891.234,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.974002,0.116134,-0.000185129,1.48481e-07,-4.59286e-11,107363,38.7273], Tmin=(100,'K'), Tmax=(879.458,'K')), NASAPolynomial(coeffs=[16.4664,0.0254902,-1.12189e-05,2.01309e-09,-1.32238e-13,104734,-40.6834], Tmin=(879.458,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(891.234,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO) + radical(C2CsJOH) + radical(CCsJOCs) + radical(CCsJOCs) + radical(RCCJ) + radical(CJCO)"""),
)

species(
    label = '[CH2]C[CH]O[CH][C]([CH2])[O](27087)',
    structure = SMILES('[CH2]C[CH]O[CH][C]([CH2])[O]'),
    E0 = (691.332,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.15096,0.121141,-0.000193041,1.57086e-07,-4.94292e-11,83326.1,36.8661], Tmin=(100,'K'), Tmax=(874.45,'K')), NASAPolynomial(coeffs=[15.8466,0.0298821,-1.33307e-05,2.41497e-09,-1.59826e-13,80869.8,-39.9042], Tmin=(874.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(691.332,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCsJOCs) + radical(C2CsJOH) + radical(CCsJOCs) + radical(RCCJ) + radical(CJCO)"""),
)

species(
    label = '[CH2][CH][CH]OC[C]([CH2])[O](27088)',
    structure = SMILES('[CH2][CH][CH]OC[C]([CH2])[O]'),
    E0 = (710.778,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.62458,0.108542,-0.000163966,1.32314e-07,-4.21146e-11,85646.9,38.0283], Tmin=(100,'K'), Tmax=(839.75,'K')), NASAPolynomial(coeffs=[13.5307,0.0331453,-1.505e-05,2.78849e-09,-1.88669e-13,83550.6,-26.1172], Tmin=(839.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(710.778,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CCJCO) + radical(CCsJOCs) + radical(CJCO) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2][CH][CH]O[CH]C([CH2])[O](27089)',
    structure = SMILES('[CH2][CH][CH]O[CH]C([CH2])[O]'),
    E0 = (714.607,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.700573,0.105897,-0.000142349,9.80884e-08,-2.64847e-11,86114.4,38.3279], Tmin=(100,'K'), Tmax=(911.841,'K')), NASAPolynomial(coeffs=[17.5151,0.0259891,-1.08961e-05,1.97922e-09,-1.34095e-13,82792.5,-47.8709], Tmin=(911.841,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(714.607,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCsJOCs) + radical(CCJCO) + radical(CCsJOCs) + radical(CJCO) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH][CH]O[CH][C]([CH2])O(27090)',
    structure = SMILES('[CH2][CH][CH]O[CH][C]([CH2])O'),
    E0 = (660.874,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.13874,0.12015,-0.000191108,1.53592e-07,-4.75534e-11,79663,39.5105], Tmin=(100,'K'), Tmax=(886.416,'K')), NASAPolynomial(coeffs=[16.5551,0.0272418,-1.17805e-05,2.09476e-09,-1.36736e-13,77039.4,-40.824], Tmin=(886.416,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(660.874,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(CCJCO) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CJCO) + radical(RCCJ)"""),
)

species(
    label = '[CH2][CH][CH]O[CH][C](C)[O](27091)',
    structure = SMILES('[CH2][CH][CH]O[CH][C](C)[O]'),
    E0 = (679.645,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.775116,0.11037,-0.000163264,1.26458e-07,-3.85136e-11,81909.3,37.3815], Tmin=(100,'K'), Tmax=(841.647,'K')), NASAPolynomial(coeffs=[15.4743,0.0295829,-1.2937e-05,2.35712e-09,-1.58078e-13,79300.2,-37.4619], Tmin=(841.647,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(679.645,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CCJCO) + radical(CCsJOCs) + radical(CCsJOCs) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][CH]CO[CH][C]([CH2])[O](25399)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2][CH]CO[CH][C]([CH2])[O](25399)'],
    products = ['[CH2][CH]COC=C([CH2])[O](25385)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH][C]([CH2])[O](13252)', '[CH2][CH]C[O](1367)'],
    products = ['[CH2][CH]CO[CH][C]([CH2])[O](25399)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH][CH2](502)', '[CH2]O[CH][C]([CH2])[O](26235)'],
    products = ['[CH2][CH]CO[CH][C]([CH2])[O](25399)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2][C]CO[CH][C]([CH2])[O](27080)'],
    products = ['[CH2][CH]CO[CH][C]([CH2])[O](25399)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH2][CH]CO[C][C]([CH2])[O](27081)'],
    products = ['[CH2][CH]CO[CH][C]([CH2])[O](25399)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH][C]([O])[CH]OC[CH][CH2](27082)'],
    products = ['[CH2][CH]CO[CH][C]([CH2])[O](25399)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH][CH]CO[CH][C]([CH2])[O](27083)'],
    products = ['[CH2][CH]CO[CH][C]([CH2])[O](25399)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][CH]CO[CH][C]([CH2])[O](25399)'],
    products = ['[CH2]C=COC[C]([CH2])[O](27084)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2]C=CO[CH][C]([CH2])[O](27085)'],
    products = ['[CH2][CH]CO[CH][C]([CH2])[O](25399)'],
    transitionState = 'TS11',
    kinetics = Arrhenius(A=(8.22e+08,'cm^3/(mol*s)'), n=1.533, Ea=(66.7905,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 192 used for Cd_R;HJ
...
reaction(
    ...
    kinetics = Arrhenius(A=(2.82396,'m^3/(mol*s)'), n=2.03228, Ea=(205.003,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 204.1 to 205.0 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH2][CH][CH]O[CH][C]([CH2])[O](27086)'],
    products = ['[CH2][CH]CO[CH][C]([CH2])[O](25399)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH]CO[CH][C]([CH2])[O](25399)'],
    products = ['[CH2]C[CH]O[CH][C]([CH2])[O](27087)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][CH][CH]OC[C]([CH2])[O](27088)'],
    products = ['[CH2][CH]CO[CH][C]([CH2])[O](25399)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][CH]CO[CH][C]([CH2])[O](25399)'],
    products = ['[CH2][C]([O])[CH]O[CH][CH]C(26333)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][CH][CH]O[CH]C([CH2])[O](27089)'],
    products = ['[CH2][CH]CO[CH][C]([CH2])[O](25399)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH2][CH]CO[CH][C]([CH2])[O](25399)'],
    products = ['[CH2][CH][CH]O[CH][C]([CH2])O(27090)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2][CH]CO[CH][C]([CH2])[O](25399)'],
    products = ['[CH2][CH][CH]O[CH][C](C)[O](27091)'],
...
network(
    label = 'PDepNetwork #6022',
    isomers = [
        '[CH2][CH]CO[CH][C]([CH2])[O](25399)',
    ],
    reactants = [
