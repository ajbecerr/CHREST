...
species(
    ...
    E0 = (678.79,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,674.035,674.049,675.697],'cm^-1')),
        HinderedRotor(inertia=(0.153646,'amu*angstrom^2'), symmetry=1, barrier=(3.53262,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152862,'amu*angstrom^2'), symmetry=1, barrier=(3.5146,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (53.0825,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.51663,0.0269416,-5.60059e-06,-1.14309e-08,6.17522e-12,81697.9,16.8097], Tmin=(100,'K'), Tmax=(1000.98,'K')), NASAPolynomial(coeffs=[8.88793,0.0141079,-5.28983e-06,9.63834e-10,-6.77534e-14,79789.9,-17.0941], Tmin=(1000.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(678.79,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC[CH]C(328)'],
    products = ['C#C(229)', 'C=CC(38)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH]=CC([CH2])C(329)'],
    products = ['[CH]=CC[CH]C(328)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=[CH](230)', '[CH2][CH]C(39)'],
    products = ['[CH]=CC[CH]C(328)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(9)', '[CH]=C[CH][CH]C(470)'],
    products = ['[CH]=CC[CH]C(328)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(9)', '[CH]=CC[CH][CH2](330)'],
    products = ['[CH]=CC[CH]C(328)'],
