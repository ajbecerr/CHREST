...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7901,0.0414177,-1.58196e-06,-3.35419e-08,1.93729e-11,25901,20.1345], Tmin=(100,'K'), Tmax=(849.641,'K')), NASAPolynomial(coeffs=[11.2511,0.0199085,-4.27058e-06,4.73029e-10,-2.3597e-14,23461.9,-28.8602], Tmin=(849.641,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(214.633,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.2067,0.0513515,-2.3394e-05,-1.27209e-08,1.04449e-11,13584.2,23.3803], Tmin=(100,'K'), Tmax=(954.365,'K')), NASAPolynomial(coeffs=[15.5718,0.0153258,-4.77934e-06,8.26179e-10,-5.87691e-14,9740.98,-51.0217], Tmin=(954.365,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(112.033,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11351,0.0561689,-4.43729e-05,1.55635e-08,-1.44494e-12,19695.2,25.2009], Tmin=(100,'K'), Tmax=(1093.4,'K')), NASAPolynomial(coeffs=[13.899,0.0193222,-7.44188e-06,1.34896e-09,-9.32645e-14,16305.9,-40.3367], Tmin=(1093.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(162.839,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.98325,0.0706057,-9.7269e-05,7.67825e-08,-2.45348e-11,49811.4,26.0425], Tmin=(100,'K'), Tmax=(817.179,'K')), NASAPolynomial(coeffs=[9.02511,0.0277787,-1.23e-05,2.27776e-09,-1.55026e-13,48612.7,-10.4237], Tmin=(817.179,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(413.286,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(C2CsJOH) + radical(CJCO) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['O(4)', '[CH2][CH]C[C]=C(2629)'],
...
reaction(
    label = 'reaction6',
    reactants = ['H2CC(T)(1341)', '[CH2]C([CH2])[O](1366)'],
    products = ['[CH2]C([O])C[C]=C(15502)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C([O])C[C]=C(15547)'],
    products = ['[CH2]C([O])C[C]=C(15502)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', 'C=[C]CC(=C)[O](15511)'],
    products = ['[CH2]C([O])C[C]=C(15502)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2]C([O])C=C=C(15959)'],
    products = ['[CH2]C([O])C[C]=C(15502)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'C#CCC([CH2])[O](15960)'],
    products = ['[CH2]C([O])C[C]=C(15502)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(20)', 'C=[C]CC=O(15522)'],
    products = ['[CH2]C([O])C[C]=C(15502)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(4679.9,'m^3/(mol*s)'), n=0.573452, Ea=(65.1767,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 62.0 to 65.2 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH2][C]CC(=C)[O](2630)'],
    products = ['[CH2]C([O])C[C]=C(15502)'],
