species(
    label = '[CH2]OC[C]=C(28910)',
    structure = SMILES('[CH2]OC[C]=C'),
    E0 = (299.347,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,345.416,346.419,1595.67],'cm^-1')),
        HinderedRotor(inertia=(0.00141978,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0706512,'amu*angstrom^2'), symmetry=1, barrier=(6.00313,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0704789,'amu*angstrom^2'), symmetry=1, barrier=(5.98216,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.4457,0.0361966,-2.50636e-05,1.02844e-08,-1.9437e-12,36057.4,20.002], Tmin=(100,'K'), Tmax=(1144.61,'K')), NASAPolynomial(coeffs=[5.54162,0.0253774,-1.0885e-05,2.02612e-09,-1.39956e-13,35348.6,4.6479], Tmin=(1144.61,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.347,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsJOCC) + radical(Cds_S)"""),
)
...
species(
    label = 'C=C=COC(29204)',
    structure = SMILES('C=C=COC'),
    E0 = (-7.3805,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77356,0.0356761,9.57195e-06,-4.68154e-08,2.31259e-11,-795.253,15.7046], Tmin=(100,'K'), Tmax=(931.037,'K')), NASAPolynomial(coeffs=[16.0098,0.00848067,-1.33862e-06,1.83032e-10,-1.61388e-14,-4918.35,-59.8661], Tmin=(931.037,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-7.3805,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cdd-CdsCds)"""),
)
...
species(
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.70179,0.0381285,2.41991e-06,-3.93905e-08,2.05197e-11,24792.8,17.6628], Tmin=(100,'K'), Tmax=(929.712,'K')), NASAPolynomial(coeffs=[15.9099,0.00878525,-1.52114e-06,2.09245e-10,-1.71929e-14,20777.2,-57.2356], Tmin=(929.712,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(205.356,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)HHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH]=[C]COC(29206)',
    structure = SMILES('[CH]=[C]COC'),
    E0 = (358.672,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,258.635,1906.24],'cm^-1')),
        HinderedRotor(inertia=(0.17045,'amu*angstrom^2'), symmetry=1, barrier=(8.15203,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.172139,'amu*angstrom^2'), symmetry=1, barrier=(8.15005,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.171936,'amu*angstrom^2'), symmetry=1, barrier=(8.15446,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.1713,0.0446624,-5.63997e-05,5.04118e-08,-1.89499e-11,43199.8,19.6979], Tmin=(100,'K'), Tmax=(802.065,'K')), NASAPolynomial(coeffs=[3.52068,0.0299318,-1.38877e-05,2.63905e-09,-1.82654e-13,43240.7,15.0899], Tmin=(802.065,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(358.672,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)OsHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['H2CC(T)(1341)', '[CH2]O[CH2](3113)'],
    products = ['[CH2]OC[C]=C(28910)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH2]OC=C=C(28914)'],
    products = ['[CH2]OC[C]=C(28910)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2][C]=CO[CH2](28915)'],
    products = ['[CH2]OC[C]=C(28910)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]=[C]CO[CH2](28913)'],
    products = ['[CH2]OC[C]=C(28910)'],
