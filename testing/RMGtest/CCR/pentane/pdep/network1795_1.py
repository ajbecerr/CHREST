species(
    ...
    E0 = (206.488,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,1066.67,1333.33,1600],'cm^-1')),
...
species(
    ...
    E0 = (242.911,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CC[CH]CCC(C)[CH]O[O](7901)',
    structure = SMILES('CC[CH]CCC(C)[CH]O[O]'),
    E0 = (201.604,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.429842,0.0959023,-1.01249e-05,-1.7978e-07,1.87033e-10,24357.6,38.4224], Tmin=(100,'K'), Tmax=(451.891,'K')), NASAPolynomial(coeffs=[6.72453,0.0714117,-3.2489e-05,6.13743e-09,-4.24376e-13,23469.9,9.52621], Tmin=(451.891,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.604,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(CCsJOOH)"""),
)
...
species(
    label = '[CH2]C(C)CC[CH]C(C)O[O](7902)',
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.08504,0.116265,-0.000111478,6.32385e-08,-1.52966e-11,25607,44.5358], Tmin=(100,'K'), Tmax=(975.877,'K')), NASAPolynomial(coeffs=[12.484,0.0606464,-2.59861e-05,4.83347e-09,-3.34093e-13,22958.7,-20.5953], Tmin=(975.877,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(211.417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(Isobutyl)"""),
)
...
species(
    label = 'CC[CH]CC[CH]C(C)[O](7903)',
    structure = SMILES('CC[CH]CC[CH]C(C)[O]'),
    E0 = (212.826,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0389664,0.0914592,-6.24504e-05,2.35459e-08,-3.92674e-12,25735.5,40.0195], Tmin=(100,'K'), Tmax=(1301.52,'K')), NASAPolynomial(coeffs=[10.3468,0.05978,-2.59403e-05,4.84472e-09,-3.34562e-13,23052.3,-12.4262], Tmin=(1301.52,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(212.826,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(RCCJCC) + radical(CCJCO)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.338049,0.108924,-8.61204e-05,-2.74172e-09,3.94411e-11,54781.3,40.6587], Tmin=(100,'K'), Tmax=(539.311,'K')), NASAPolynomial(coeffs=[8.43684,0.0663622,-3.03799e-05,5.78346e-09,-4.0309e-13,53507.3,0.706641], Tmin=(539.311,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(454.288,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(CCJ2_triplet)"""),
)

species(
    label = 'CC[C]CC[CH]C(C)O[O](7905)',
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.09239,0.119149,-0.000124562,7.70472e-08,-2.02982e-11,55531.9,42.9746], Tmin=(100,'K'), Tmax=(900.453,'K')), NASAPolynomial(coeffs=[12.0075,0.0609544,-2.76162e-05,5.26912e-09,-3.69196e-13,53172.8,-18.8506], Tmin=(900.453,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(460.244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(548.755,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CCJ2_triplet)"""),
)

species(
    label = 'CC[CH]CCC1OOC1C(7906)',
    structure = SMILES('CC[CH]CCC1OOC1C'),
    E0 = (10.7799,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0508134,0.0949572,-6.16069e-05,2.17356e-08,-3.46009e-12,1431.26,33.8928], Tmin=(100,'K'), Tmax=(1309.04,'K')), NASAPolynomial(coeffs=[9.05156,0.0674539,-3.00916e-05,5.68549e-09,-3.94856e-13,-925.216,-11.9545], Tmin=(1309.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(10.7799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(582.013,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(RCCJCC)"""),
)
...
species(
    label = 'CC[CH]CCC1OC1C(7907)',
    structure = SMILES('CC[CH]CCC1OC1C'),
    E0 = (-40.5164,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.204,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.789122,0.0946234,-6.7288e-05,2.76728e-08,-4.79721e-12,-4691.68,36.6987], Tmin=(100,'K'), Tmax=(1347.8,'K')), NASAPolynomial(coeffs=[14.4648,0.0493525,-1.69048e-05,2.75142e-09,-1.74598e-13,-8803.52,-41.4456], Tmin=(1347.8,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-40.5164,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(557.07,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(RCCJCC)"""),
)
...
species(
    label = 'CC[CH]CCC=C(C)OO(7908)',
    structure = SMILES('CC[CH]CCC=C(C)OO'),
    E0 = (-19.4936,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.629333,0.110317,-0.000110033,7.36656e-08,-2.2476e-11,-2185.5,41.9261], Tmin=(100,'K'), Tmax=(764.121,'K')), NASAPolynomial(coeffs=[6.88345,0.0709921,-3.28419e-05,6.32392e-09,-4.45072e-13,-3333.71,7.70185], Tmin=(764.121,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-19.4936,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(RCCJCC)"""),
)

species(
    label = 'CCCCC=CC(C)O[O](7909)',
    structure = SMILES('CCCCC=CC(C)O[O]'),
    E0 = (-72.0504,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.01258,0.10477,-7.66963e-05,2.93004e-08,-4.63437e-12,-8481.2,42.0656], Tmin=(100,'K'), Tmax=(1453.31,'K')), NASAPolynomial(coeffs=[18.4732,0.0511393,-2.13426e-05,3.90858e-09,-2.66464e-13,-14145,-59.2268], Tmin=(1453.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-72.0504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = 'CCC=CCCC(C)O[O](7910)',
    structure = SMILES('CCC=CCCC(C)O[O]'),
    E0 = (-71.7141,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.806407,0.105058,-7.92685e-05,3.22416e-08,-5.54254e-12,-8452.07,40.4121], Tmin=(100,'K'), Tmax=(1327.34,'K')), NASAPolynomial(coeffs=[15.4498,0.0560696,-2.39076e-05,4.43629e-09,-3.05511e-13,-12767.6,-42.6179], Tmin=(1327.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-71.7141,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = 'CC[CH]CC=CC(C)OO(7911)',
    structure = SMILES('CC[CH]CC=CC(C)OO'),
    E0 = (-29.5968,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.488484,0.102647,-7.47738e-05,2.93135e-08,-4.95666e-12,-3401.92,41.9828], Tmin=(100,'K'), Tmax=(1315.02,'K')), NASAPolynomial(coeffs=[13.2712,0.0607928,-2.70324e-05,5.11024e-09,-3.55352e-13,-7020.77,-28.1677], Tmin=(1315.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-29.5968,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC)"""),
)

species(
    label = 'CCCCCC=C(C)O[O](7436)',
    structure = SMILES('CCCCCC=C(C)O[O]'),
    E0 = (-61.9472,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.482077,0.104823,-8.65915e-05,4.21607e-08,-9.10208e-12,-7294.37,39.5801], Tmin=(100,'K'), Tmax=(1052.6,'K')), NASAPolynomial(coeffs=[10.2231,0.0641414,-2.8618e-05,5.44248e-09,-3.81117e-13,-9547.98,-12.6147], Tmin=(1052.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-61.9472,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = 'CC=CCCCC(C)O[O](7434)',
    structure = SMILES('CC=CCCCC(C)O[O]'),
    E0 = (-72.8488,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.653025,0.106127,-8.41023e-05,3.73921e-08,-7.19367e-12,-8597.5,39.2011], Tmin=(100,'K'), Tmax=(1181.82,'K')), NASAPolynomial(coeffs=[12.6948,0.0609496,-2.67625e-05,5.04671e-09,-3.51411e-13,-11752.4,-27.4242], Tmin=(1181.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-72.8488,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(577.856,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ)"""),
)

species(
    label = 'CC[CH]CCC=C(C)O[O](7912)',
    structure = SMILES('CC[CH]CCC=C(C)O[O]'),
    E0 = (132.511,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,350,440,435,1725,3010,987.5,1337.5,450,1655,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.63103,0.110228,-0.000128886,1.0438e-07,-3.69144e-11,16096.2,42.6676], Tmin=(100,'K'), Tmax=(767.311,'K')), NASAPolynomial(coeffs=[5.88748,0.0682515,-3.11965e-05,5.92302e-09,-4.11303e-13,15331.2,14.4799], Tmin=(767.311,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(132.511,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + radical(ROOJ) + radical(RCCJCC)"""),
)

species(
    label = 'CC[CH]CC=CC(C)O[O](7913)',
    structure = SMILES('CC[CH]CC=CC(C)O[O]'),
    E0 = (122.408,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.20541,0.0986179,-7.72239e-05,3.51136e-08,-7.12402e-12,14868.5,41.7433], Tmin=(100,'K'), Tmax=(1103.65,'K')), NASAPolynomial(coeffs=[9.81377,0.0623053,-2.7871e-05,5.30192e-09,-3.71111e-13,12656.9,-7.58162], Tmin=(1103.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(122.408,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(RCCJCC)"""),
)

species(
    label = 'CCC=CC[CH]C(C)O[O](7914)',
    structure = SMILES('CCC=CC[CH]C(C)O[O]'),
    E0 = (128.701,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3025,407.5,1350,352.5,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (142.196,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.602346,0.104862,-8.7043e-05,4.06312e-08,-8.14882e-12,15641.7,41.9948], Tmin=(100,'K'), Tmax=(1146.1,'K')), NASAPolynomial(coeffs=[12.8785,0.0578125,-2.54658e-05,4.81291e-09,-3.35769e-13,12551.6,-24.8807], Tmin=(1146.1,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(128.701,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(552.912,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(CCJCOOH)"""),
)
...
species(
    label = 'CC[CH]CCC=CO[O](1043)',
    structure = SMILES('CC[CH]CCC=CO[O]'),
    E0 = (174.303,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.180796,0.0890901,-7.99261e-05,4.41817e-08,-1.08153e-11,21097,37.7626], Tmin=(100,'K'), Tmax=(945.661,'K')), NASAPolynomial(coeffs=[8.58245,0.0535523,-2.3556e-05,4.44217e-09,-3.09493e-13,19508,-2.30105], Tmin=(945.661,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(174.303,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.02331,0.121555,-0.00015582,1.35375e-07,-4.93163e-11,23379.3,43.3494], Tmin=(100,'K'), Tmax=(802.993,'K')), NASAPolynomial(coeffs=[4.73836,0.0747289,-3.4489e-05,6.53202e-09,-4.51135e-13,23038.4,20.4555], Tmin=(802.993,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(192.972,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOOH) + radical(RCCJCC)"""),
)
...
species(
    label = 'C[CH]CCC[CH]C(C)O[O](7921)',
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.315874,0.107828,-8.01746e-05,-4.28363e-09,3.63605e-11,24976.2,43.1407], Tmin=(100,'K'), Tmax=(544.431,'K')), NASAPolynomial(coeffs=[7.71752,0.0694965,-3.15715e-05,6.00666e-09,-4.19196e-13,23794.9,6.45244], Tmin=(544.431,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(206.475,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(RCCJC)"""),
)

species(
    label = 'CC[CH]CC[CH][C](C)OO(7922)',
    structure = SMILES('CC[CH]CC[CH][C](C)OO'),
    E0 = (241.382,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.25394,0.127084,-0.000166779,1.45131e-07,-5.28864e-11,29209.6,45.7231], Tmin=(100,'K'), Tmax=(792.604,'K')), NASAPolynomial(coeffs=[5.59122,0.0750743,-3.52996e-05,6.74279e-09,-4.68047e-13,28673.1,17.7507], Tmin=(792.604,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(241.382,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(C2CsJOOH) + radical(CCJCOOH)"""),
)

species(
    label = '[CH2]C(CCC[CH]CC)O[O](7923)',
    structure = SMILES('[CH2]C(CCC[CH]CC)O[O]'),
    E0 = (220.035,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.458202,0.110444,-9.04115e-05,1.42603e-08,2.35064e-11,26612.9,43.1491], Tmin=(100,'K'), Tmax=(560.775,'K')), NASAPolynomial(coeffs=[8.10248,0.0688648,-3.13121e-05,5.96108e-09,-4.16215e-13,25346.4,4.06898], Tmin=(560.775,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(220.035,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(CJCOOH)"""),
)

species(
    label = 'CC[CH][CH]CCC(C)O[O](7924)',
    structure = SMILES('CC[CH][CH]CCC(C)O[O]'),
    E0 = (200.531,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
...
species(
    label = 'CCCC[CH][CH]C(C)O[O](7925)',
    structure = SMILES('CCCC[CH][CH]C(C)O[O]'),
    E0 = (206.488,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3050,390,425,1340,1360,335,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCCC[CH]C(C)O[O](7926)',
    structure = SMILES('[CH2]CCCC[CH]C(C)O[O]'),
    E0 = (217.276,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.950313,0.116196,-0.000113229,6.65852e-08,-1.70165e-11,26304.2,44.3467], Tmin=(100,'K'), Tmax=(917.16,'K')), NASAPolynomial(coeffs=[10.8126,0.0648941,-2.93259e-05,5.59792e-09,-3.92603e-13,24146.5,-11.3854], Tmin=(917.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(217.276,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C([CH]CC[CH]CC)OO(7927)',
    structure = SMILES('[CH2]C([CH]CC[CH]CC)OO'),
    E0 = (268.445,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.25972,0.124658,-0.000144107,1.06333e-07,-3.39847e-11,32467.6,47.4646], Tmin=(100,'K'), Tmax=(746.711,'K')), NASAPolynomial(coeffs=[9.17405,0.0687671,-3.18353e-05,6.09814e-09,-4.26635e-13,30909.4,0.174963], Tmin=(746.711,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(268.445,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJCC) + radical(CJCOOH)"""),
)

species(
    label = 'CC[CH]C[CH][CH]C(C)OO(7928)',
    structure = SMILES('CC[CH]C[CH][CH]C(C)OO'),
    E0 = (248.941,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.13912,0.125068,-0.000165772,1.46576e-07,-5.38124e-11,30114.1,47.5803], Tmin=(100,'K'), Tmax=(804.394,'K')), NASAPolynomial(coeffs=[4.63927,0.0757515,-3.54282e-05,6.74016e-09,-4.66302e-13,29850.4,25.0998], Tmin=(804.394,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCJCOOH) + radical(RCCJCC)"""),
)

species(
    label = 'CCCCC[CH][C](C)O[O](7929)',
    structure = SMILES('CCCCC[CH][C](C)O[O]'),
    E0 = (198.928,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.276589,0.1083,-7.47799e-05,-2.37034e-08,5.38223e-11,24065.6,40.5916], Tmin=(100,'K'), Tmax=(523.536,'K')), NASAPolynomial(coeffs=[7.65622,0.0706286,-3.2568e-05,6.23296e-09,-4.36148e-13,22920.6,4.45186], Tmin=(523.536,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(198.928,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(C2CsJOOH) + radical(CCJCOOH)"""),
)

species(
    label = 'C[CH][CH]CCCC(C)O[O](7930)',
    structure = SMILES('C[CH][CH]CCCC(C)O[O]'),
    E0 = (200.519,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.934295,0.118916,-0.000149045,1.27609e-07,-4.60182e-11,24284.5,45.472], Tmin=(100,'K'), Tmax=(806.852,'K')), NASAPolynomial(coeffs=[4.82811,0.0735461,-3.34625e-05,6.29847e-09,-4.33573e-13,23901.5,22.2977], Tmin=(806.852,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.519,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(RCCJC)"""),
)

species(
    label = 'CC[CH][CH]C[CH]C(C)OO(7931)',
    structure = SMILES('CC[CH][CH]C[CH]C(C)OO'),
    E0 = (248.941,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.13904,0.125067,-0.000165768,1.4657e-07,-5.38092e-11,30114.1,47.5801], Tmin=(100,'K'), Tmax=(804.409,'K')), NASAPolynomial(coeffs=[4.63915,0.0757518,-3.54284e-05,6.74019e-09,-4.66305e-13,29850.4,25.1004], Tmin=(804.409,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJCC) + radical(RCCJCC)"""),
)

species(
    label = '[CH2]C([CH]CCCCC)O[O](7932)',
    structure = SMILES('[CH2]C([CH]CCCCC)O[O]'),
    E0 = (225.992,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.08073,0.11854,-0.00011732,6.88656e-08,-1.73534e-11,27357.7,45.0214], Tmin=(100,'K'), Tmax=(934.824,'K')), NASAPolynomial(coeffs=[11.8828,0.063069,-2.8311e-05,5.38821e-09,-3.77307e-13,24934,-16.6464], Tmin=(934.824,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(225.992,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CJCOOH)"""),
)

species(
    label = '[CH2]C[CH]CCCC(C)O[O](7933)',
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0861824,0.103971,-6.28328e-05,-4.11434e-08,6.47878e-11,25549,41.6733], Tmin=(100,'K'), Tmax=(514.783,'K')), NASAPolynomial(coeffs=[7.20498,0.0703767,-3.21382e-05,6.12475e-09,-4.276e-13,24492.8,8.37134], Tmin=(514.783,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(211.319,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(573.699,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(RCCJ)"""),
)

species(
    label = 'C[CH][CH]CC[CH]C(C)OO(7934)',
    ...
    molecularWeight = (143.203,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.16414,0.124433,-0.000159954,1.3728e-07,-4.95392e-11,30114.7,47.843], Tmin=(100,'K'), Tmax=(795.724,'K')), NASAPolynomial(coeffs=[5.68198,0.0738897,-3.4272e-05,6.50898e-09,-4.50464e-13,29535.8,19.5874], Tmin=(795.724,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(248.929,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(569.541,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(RCCJCC) + radical(RCCJC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'CC[CH]CC[CH]CO[O](720)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CC[CH]CCC(C)[CH]O[O](7901)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(C)CC[CH]C(C)O[O](7902)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CC[CH]CC[CH]C(C)O[O](7427)'],
    products = ['O2(S)(666)', 'CC=CCC[CH]CC(383)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction9',
    reactants = ['O(4)', 'CC[CH]CC[CH]C(C)[O](7903)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['C[CH]O[O](57)', '[CH]CC[CH]CC(240)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]C(C)O[O](668)', '[CH2]C[CH]CC(101)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]CC(26)', '[CH2]C[CH]C(C)O[O](7603)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction13',
    reactants = ['C2H5(14)', '[CH]CC[CH]C(C)O[O](7636)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'CC[CH]CC[C]C(C)O[O](7904)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'CC[C]CC[CH]C(C)O[O](7905)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CC[CH]CC[CH]C(C)O[O](7427)'],
    products = ['O(4)', 'CC[CH]CCC1OC1C(7907)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CC[CH]CC[CH]C(C)O[O](7427)'],
    products = ['HO2(9)', 'C=C[CH]CC[CH]CC(4069)'],
...
reaction(
    label = 'reaction20',
    reactants = ['CC[CH]CC[CH]C(C)O[O](7427)'],
    products = ['CC[CH]CCC=C(C)OO(7908)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CC[CH]CC[CH]C(C)O[O](7427)'],
    products = ['CC[CH]CC=CC(C)OO(7911)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', 'CC[CH]CCC=C(C)O[O](7912)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', 'CC[CH]CC=CC(C)O[O](7913)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', 'CCC=CC[CH]C(C)O[O](7914)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', 'CC=CCC[CH]C(C)O[O](7555)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH3(17)', 'CC[CH]CCC=CO[O](1043)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction33',
    reactants = ['CH3(17)', 'C=CCC[CH]C(C)O[O](7454)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction34',
    reactants = ['O2(2)', 'CC=CCC[CH]CC(383)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction35',
    reactants = ['O2(2)', 'C[CH][CH]CC[CH]CC(385)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction36',
    reactants = ['CH3(17)', 'CC[CH]CC[CH][CH]O[O](1047)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(3)', 'CC[CH]CC[CH][C](C)O[O](7915)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction39',
    reactants = ['H(3)', 'CC[CH]C[CH][CH]C(C)O[O](7916)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction40',
    reactants = ['H(3)', 'CC[CH][CH]C[CH]C(C)O[O](7917)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction41',
    reactants = ['CH3(17)', '[CH2][CH]CC[CH]C(C)O[O](7448)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction42',
    reactants = ['H(3)', 'C[CH][CH]CC[CH]C(C)O[O](7540)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction43',
    reactants = ['H(3)', '[CH2]C([CH]CC[CH]CC)O[O](7918)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction44',
    reactants = ['H(3)', '[CH2]C[CH]CC[CH]C(C)O[O](7919)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction45',
    reactants = ['CC[CH]CC[CH]C(C)O[O](7427)'],
    products = ['CC[CH]CCC[C](C)O[O](7920)'],
...
reaction(
    label = 'reaction48',
    reactants = ['CC[CH]CC[CH]C(C)O[O](7427)'],
    products = ['C[CH]CCC[CH]C(C)O[O](7921)'],
...
reaction(
    label = 'reaction49',
    reactants = ['CC[CH]CC[CH][C](C)OO(7922)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[CH2]C(CCC[CH]CC)O[O](7923)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction51',
    reactants = ['CC[CH]CC[CH]C(C)O[O](7427)'],
    products = ['CC[CH][CH]CCC(C)O[O](7924)'],
...
reaction(
    label = 'reaction52',
    reactants = ['CCCC[CH][CH]C(C)O[O](7925)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction53',
    reactants = ['[CH2]CCCC[CH]C(C)O[O](7926)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction54',
    reactants = ['CC[CH]CC[CH]C(C)O[O](7427)'],
    products = ['[CH2]C([CH]CC[CH]CC)OO(7927)'],
...
reaction(
    label = 'reaction55',
    reactants = ['CC[CH]C[CH][CH]C(C)OO(7928)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction56',
    reactants = ['CC[CH]CC[CH]C(C)O[O](7427)'],
    products = ['CCCCC[CH][C](C)O[O](7929)'],
...
reaction(
    label = 'reaction57',
    reactants = ['CC[CH]CC[CH]C(C)O[O](7427)'],
    products = ['C[CH][CH]CCCC(C)O[O](7930)'],
...
reaction(
    label = 'reaction58',
    reactants = ['CC[CH][CH]C[CH]C(C)OO(7931)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction59',
    reactants = ['[CH2]C([CH]CCCCC)O[O](7932)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction60',
    reactants = ['[CH2]C[CH]CCCC(C)O[O](7933)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
...
reaction(
    label = 'reaction61',
    reactants = ['C[CH][CH]CC[CH]C(C)OO(7934)'],
    products = ['CC[CH]CC[CH]C(C)O[O](7427)'],
