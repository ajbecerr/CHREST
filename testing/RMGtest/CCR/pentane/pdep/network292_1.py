...
species(
    label = '[CH2]C(CC)C[CH]C[O](962)',
    structure = SMILES('[CH2]C(CC)C[CH]C[O]'),
    E0 = (252.87,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.57963,0.0795619,-5.80321e-05,2.56087e-08,-5.19625e-12,30532.7,36.1856], Tmin=(100,'K'), Tmax=(1084.43,'K')), NASAPolynomial(coeffs=[7.34632,0.0546026,-2.35083e-05,4.38494e-09,-3.03438e-13,29065.1,2.99175], Tmin=(1084.43,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.87,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO) + radical(Isobutyl)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.595445,0.105656,-0.000115559,7.47497e-08,-2.02338e-11,60175.8,38.478], Tmin=(100,'K'), Tmax=(886.575,'K')), NASAPolynomial(coeffs=[11.7368,0.0500154,-2.14189e-05,3.95988e-09,-2.71974e-13,57989.2,-19.5332], Tmin=(886.575,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(498.988,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(CC)C[CH]CO[O](964)',
    ...
    molecularWeight = (128.169,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.45747,0.104368,-0.000112893,7.30978e-08,-2.01282e-11,59608,39.611], Tmin=(100,'K'), Tmax=(865.019,'K')), NASAPolynomial(coeffs=[10.6343,0.053078,-2.39534e-05,4.55235e-09,-3.17924e-13,57689.1,-12.2919], Tmin=(865.019,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(494.32,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(478.082,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH2]C(CC)CC1COO1(965)',
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.131446,0.0880943,-6.13355e-05,2.30237e-08,-3.66309e-12,6823.25,32.2844], Tmin=(100,'K'), Tmax=(1418.88,'K')), NASAPolynomial(coeffs=[13.7203,0.0490446,-2.00533e-05,3.62716e-09,-2.45516e-13,2892.46,-39.3886], Tmin=(1418.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(55.4799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(511.34,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(CC)CC1CO1(967)',
    structure = SMILES('[CH2]C(CC)CC1CO1'),
    E0 = (4.1837,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.178,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.147046,0.0746289,-2.12755e-05,-3.03293e-08,2.04216e-11,651.549,31.0736], Tmin=(100,'K'), Tmax=(875.368,'K')), NASAPolynomial(coeffs=[14.8797,0.037903,-1.07693e-05,1.59614e-09,-9.89945e-14,-3099.93,-44.7371], Tmin=(875.368,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.1837,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Ethylene_oxide) + radical(Isobutyl)"""),
)

species(
    label = 'C=C(CC)CCCO[O](968)',
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.169565,0.0945825,-7.7928e-05,3.62844e-08,-7.26488e-12,-4461.23,35.1866], Tmin=(100,'K'), Tmax=(1148.11,'K')), NASAPolynomial(coeffs=[11.9354,0.0524093,-2.28296e-05,4.29105e-09,-2.98431e-13,-7240.83,-24.8851], Tmin=(1148.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-38.3203,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.969201,0.0993318,-8.2043e-05,3.59945e-08,-6.40017e-12,3461.87,40.0561], Tmin=(100,'K'), Tmax=(1340.47,'K')), NASAPolynomial(coeffs=[19.1311,0.0393514,-1.49238e-05,2.6133e-09,-1.7448e-13,-1926.87,-62.8061], Tmin=(1340.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(27.2277,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.34749,0.0942008,-7.4616e-05,3.25506e-08,-5.98709e-12,2006.3,38.0298], Tmin=(100,'K'), Tmax=(1258,'K')), NASAPolynomial(coeffs=[14.0125,0.0485408,-2.01723e-05,3.69851e-09,-2.53357e-13,-1606.68,-34.5451], Tmin=(1258,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(15.3718,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C(CC)CC[CH]O[O](981)',
    structure = SMILES('[CH2]C(CC)CC[CH]O[O]'),
    E0 = (239.355,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.539272,0.105315,-0.000112686,7.46949e-08,-2.11716e-11,28946.3,38.5218], Tmin=(100,'K'), Tmax=(841.534,'K')), NASAPolynomial(coeffs=[9.92503,0.0555764,-2.40291e-05,4.46129e-09,-3.06985e-13,27185.1,-10.1571], Tmin=(841.534,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(239.355,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCsJOOH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CC)C[CH][CH]OO(982)',
    structure = SMILES('[CH2]C(CC)C[CH][CH]OO'),
    E0 = (287.765,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.72422,0.110244,-0.000121223,8.07376e-08,-2.28424e-11,34774.7,40.7353], Tmin=(100,'K'), Tmax=(844.371,'K')), NASAPolynomial(coeffs=[10.721,0.0560246,-2.49015e-05,4.68713e-09,-3.25176e-13,32841.9,-12.5452], Tmin=(844.371,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(287.765,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(Isobutyl) + radical(CCsJOOH)"""),
)
...
species(
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.648399,0.112502,-0.000152756,1.31749e-07,-4.61288e-11,28565.2,39.8832], Tmin=(100,'K'), Tmax=(841.106,'K')), NASAPolynomial(coeffs=[5.97617,0.0616307,-2.74947e-05,5.09011e-09,-3.45539e-13,28135.9,13.1422], Tmin=(841.106,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(236.195,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Tertalkyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]CC([CH2])CCCO[O](988)',
    structure = SMILES('[CH2]CC([CH2])CCCO[O]'),
    E0 = (256.019,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.457805,0.102746,-0.000104336,6.43799e-08,-1.69724e-11,30948.4,39.8666], Tmin=(100,'K'), Tmax=(900.726,'K')), NASAPolynomial(coeffs=[10.5196,0.0539975,-2.31549e-05,4.29526e-09,-2.9595e-13,28970.9,-11.9455], Tmin=(900.726,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.019,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C([CH][CH]COO)CC(990)',
    structure = SMILES('[CH2]C([CH][CH]COO)CC'),
    E0 = (293.725,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2][C](CC)C[CH]COO(991)',
    structure = SMILES('[CH2][C](CC)C[CH]COO'),
    E0 = (284.606,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.882109,0.118065,-0.00016381,1.4156e-07,-4.96696e-11,34395.6,42.268], Tmin=(100,'K'), Tmax=(829.471,'K')), NASAPolynomial(coeffs=[6.86138,0.0619184,-2.82708e-05,5.29252e-09,-3.61746e-13,33757.9,10.2574], Tmin=(829.471,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(284.606,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(CCJCOOH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]CC([CH2])C[CH]COO(993)',
    structure = SMILES('[CH2]CC([CH2])C[CH]COO'),
    E0 = (304.429,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.639896,0.107645,-0.000112782,7.03247e-08,-1.86086e-11,36776.6,42.0697], Tmin=(100,'K'), Tmax=(899.282,'K')), NASAPolynomial(coeffs=[11.3234,0.0544305,-2.40178e-05,4.51865e-09,-3.13928e-13,34625,-14.3759], Tmin=(899.282,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(304.429,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJCOOH) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(CC)C[CH]CO[O](722)'],
    products = ['O2(S)(666)', '[CH2]C(CC)CC=C(304)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction7',
    reactants = ['O(4)', '[CH2]C(CC)C[CH]C[O](962)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]CO[O](790)', '[CH2]C([CH2])CC(117)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2]O[O](46)', '[CH]CC([CH2])CC(223)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH2]C(CC)C[C]CO[O](963)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]C(CC)C[CH]CO[O](964)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(CC)C[CH]CO[O](722)'],
    products = ['O(4)', '[CH2]C(CC)CC1CO1(967)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', 'C=C(CC)C[CH]CO[O](972)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2]C(C=CCO[O])CC(973)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH2]C(CC)CC=CO[O](974)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C2H5(14)', 'C=CC[CH]CO[O](800)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O2(2)', '[CH2]C(CC)CC=C(304)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O2(2)', '[CH2][CH]CC([CH2])CC(309)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction29',
    reactants = ['C2H5(14)', '[CH2][CH]C[CH]CO[O](803)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', '[CH2][C](CC)C[CH]CO[O](975)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CH3(17)', '[CH2]C([CH2])C[CH]CO[O](743)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', '[CH2]C([CH][CH]CO[O])CC(977)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction35',
    reactants = ['H(3)', '[CH2]C(CC)C[CH][CH]O[O](978)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', '[CH2]CC([CH2])C[CH]CO[O](979)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH2]C([CH]CCO[O])CC(925)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]C(CC)C[CH]CO[O](722)'],
    products = ['[CH2]C(CC)CC[CH]O[O](981)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]C(CC)C[CH][CH]OO(982)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH2]C(CC)C[CH]CO[O](722)'],
    products = ['[CH2]C([CH]C)CCCO[O](986)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2]CC(C)C[CH]CO[O](987)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction46',
    reactants = ['[CH2]CC([CH2])CCCO[O](988)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]C([CH][CH]COO)CC(990)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH2][C](CC)C[CH]COO(991)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
...
reaction(
    label = 'reaction51',
    reactants = ['[CH2]CC([CH2])C[CH]COO(993)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
