...
species(
    label = 'C[CH]C[CH]C1CC1(6286)',
    structure = SMILES('C[CH]C[CH]C1CC1'),
    E0 = (326.899,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,302.968,815.372,815.372,815.372,815.372,815.372,815.372,1632.38,1632.38,1632.38,1632.38,1632.38,1632.38],'cm^-1')),
        HinderedRotor(inertia=(0.143628,'amu*angstrom^2'), symmetry=1, barrier=(3.4635,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143628,'amu*angstrom^2'), symmetry=1, barrier=(3.4635,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143628,'amu*angstrom^2'), symmetry=1, barrier=(3.4635,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.143628,'amu*angstrom^2'), symmetry=1, barrier=(3.4635,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23138,0.0499946,5.51002e-06,-3.09999e-08,1.22828e-11,39425.6,30.8462], Tmin=(100,'K'), Tmax=(1087.75,'K')), NASAPolynomial(coeffs=[9.72773,0.0426575,-1.73394e-05,3.20945e-09,-2.23392e-13,36162.9,-17.3595], Tmin=(1087.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(326.899,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Cs_S) + radical(RCCJC)"""),
)
...
species(
    label = 'C[C]CC1[CH]CC1(6287)',
    structure = SMILES('C[C]CC1[CH]CC1'),
    E0 = (569.544,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24716,0.0456232,2.45778e-05,-5.67268e-08,2.26376e-11,68612.5,27.7611], Tmin=(100,'K'), Tmax=(1021.02,'K')), NASAPolynomial(coeffs=[12.328,0.0373738,-1.49602e-05,2.81868e-09,-2.01169e-13,64516.9,-34.9035], Tmin=(1021.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(569.544,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(CCJ2_triplet)"""),
)

species(
    label = 'C[CH]CC1[C]CC1(6288)',
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31276,0.0448873,2.4542e-05,-5.58287e-08,2.23186e-11,69404.3,27.9129], Tmin=(100,'K'), Tmax=(1013.34,'K')), NASAPolynomial(coeffs=[11.5651,0.0379622,-1.48616e-05,2.76192e-09,-1.95583e-13,65604.2,-30.1827], Tmin=(1013.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(576.152,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(RCCJC) + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'CCCC1=CCC1(6289)',
    structure = SMILES('CCCC1=CCC1'),
    E0 = (58.9868,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.161,0.044359,4.01077e-05,-7.84541e-08,3.16201e-11,7212.73,25.4045], Tmin=(100,'K'), Tmax=(989.012,'K')), NASAPolynomial(coeffs=[14.1015,0.0358717,-1.35252e-05,2.52793e-09,-1.82197e-13,2508.49,-47.725], Tmin=(989.012,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(58.9868,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)

species(
    label = 'CC=CC1CCC1(6290)',
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50915,0.0339362,6.93373e-05,-1.07449e-07,4.1491e-11,6133.57,24.6364], Tmin=(100,'K'), Tmax=(982.004,'K')), NASAPolynomial(coeffs=[13.5984,0.0364722,-1.36289e-05,2.56997e-09,-1.87464e-13,1262.6,-46.1798], Tmin=(982.004,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(50.0973,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutane)"""),
)

species(
    label = 'CCCC1C=CC1(6187)',
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26508,0.0405543,5.22428e-05,-9.19763e-08,3.66647e-11,7952.27,24.9121], Tmin=(100,'K'), Tmax=(980.424,'K')), NASAPolynomial(coeffs=[14.4272,0.0349978,-1.2913e-05,2.41325e-09,-1.75137e-13,3057.54,-50.1275], Tmin=(980.424,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(65.1549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)

species(
    label = 'C=CCC1CCC1(6185)',
    structure = SMILES('C=CCC1CCC1'),
    E0 = (61.273,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4579,0.0340452,7.22998e-05,-1.12543e-07,4.37468e-11,7480.51,25.2241], Tmin=(100,'K'), Tmax=(978.04,'K')), NASAPolynomial(coeffs=[14.4505,0.0352885,-1.30094e-05,2.45708e-09,-1.80305e-13,2338.13,-50.4659], Tmin=(978.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.273,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)
...
species(
    label = '[CH2]CC=CC[CH]C(6291)',
    structure = SMILES('[CH2]CC=CC[CH]C'),
    E0 = (300.72,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.933212,0.0633457,-3.42967e-05,8.97968e-09,-9.48969e-13,36281.5,32.5856], Tmin=(100,'K'), Tmax=(2085.54,'K')), NASAPolynomial(coeffs=[16.1352,0.0341885,-1.33255e-05,2.27592e-09,-1.45359e-13,29940.8,-51.9287], Tmin=(2085.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(300.72,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(RCCJ)"""),
)

species(
    label = 'C[CH]CC1=CCC1(6292)',
    structure = SMILES('C[CH]CC1=CCC1'),
    E0 = (253.433,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.38303,0.0442784,2.1724e-05,-5.13255e-08,2.05023e-11,30586.7,27.344], Tmin=(100,'K'), Tmax=(1017.02,'K')), NASAPolynomial(coeffs=[10.9341,0.0378745,-1.47906e-05,2.73733e-09,-1.93036e-13,27032.5,-26.8186], Tmin=(1017.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(253.433,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH]C[C]1CCC1(6299)',
    structure = SMILES('C[CH]C[C]1CCC1'),
    E0 = (313.36,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41145,0.0494398,-2.08692e-06,-1.65651e-08,5.93341e-12,37787.6,28.8061], Tmin=(100,'K'), Tmax=(1257.76,'K')), NASAPolynomial(coeffs=[7.78439,0.0465228,-1.93004e-05,3.5265e-09,-2.4011e-13,34812,-8.85697], Tmin=(1257.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(313.36,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(RCCJC)"""),
)
...
species(
    label = 'C[CH]CC1C[CH]C1(6300)',
    structure = SMILES('C[CH]CC1C[CH]C1'),
    E0 = (315.775,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CCC1[CH]CC1(6301)',
    structure = SMILES('[CH2]CCC1[CH]CC1'),
    E0 = (326.576,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33518,0.0433098,3.3668e-05,-6.42784e-08,2.46779e-11,39387.2,29.3268], Tmin=(100,'K'), Tmax=(1025.81,'K')), NASAPolynomial(coeffs=[11.308,0.0410216,-1.65037e-05,3.10865e-09,-2.21383e-13,35415.5,-28.4263], Tmin=(1025.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(326.576,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(RCCJ)"""),
)

species(
    label = 'C[CH][CH]C1CCC1(6302)',
    structure = SMILES('C[CH][CH]C1CCC1'),
    E0 = (322.479,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54705,0.0406658,3.27534e-05,-5.78669e-08,2.12396e-11,38884.9,29.726], Tmin=(100,'K'), Tmax=(1050.56,'K')), NASAPolynomial(coeffs=[9.01313,0.0442489,-1.80673e-05,3.38666e-09,-2.3881e-13,35549.8,-15.069], Tmin=(1050.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(322.479,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Cs_S) + radical(RCCJC)"""),
)

species(
    label = 'CCC[C]1[CH]CC1(6303)',
    structure = SMILES('CCC[C]1[CH]CC1'),
    E0 = (306.752,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35691,0.0500423,-1.56934e-06,-1.81137e-08,6.54233e-12,36995.3,29.3079], Tmin=(100,'K'), Tmax=(1246.85,'K')), NASAPolynomial(coeffs=[8.5062,0.0459997,-1.9435e-05,3.59147e-09,-2.46359e-13,33743.9,-12.6498], Tmin=(1246.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(306.752,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(cyclobutane)"""),
)

species(
    label = 'CCCC1[CH]C[CH]1(6304)',
    structure = SMILES('CCCC1[CH]C[CH]1'),
    E0 = (309.168,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.45293,0.043219,2.59646e-05,-5.07848e-08,1.86313e-11,37286.8,29.4687], Tmin=(100,'K'), Tmax=(1071.08,'K')), NASAPolynomial(coeffs=[9.30688,0.044415,-1.84624e-05,3.47774e-09,-2.4521e-13,33853.3,-17.1356], Tmin=(1071.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(309.168,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(cyclobutane)"""),
)

species(
    label = 'CCCC1[CH][CH]C1(6305)',
    structure = SMILES('CCCC1[CH][CH]C1'),
    E0 = (309.168,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
...
species(
    label = '[CH2][CH]CC1CCC1(6306)',
    structure = SMILES('[CH2][CH]CC1CCC1'),
    E0 = (333.183,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40017,0.042582,3.36e-05,-6.33323e-08,2.43356e-11,40179,29.4808], Tmin=(100,'K'), Tmax=(1018.71,'K')), NASAPolynomial(coeffs=[10.5432,0.0416128,-1.64066e-05,3.0522e-09,-2.15821e-13,36503.7,-23.6945], Tmin=(1018.71,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(333.183,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(RCCJC) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C[CH]CC1[CH]CC1(5038)'],
...
reaction(
    label = 'reaction2',
    reactants = ['C[CH]C[CH]C1CC1(6286)'],
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C1CC1C[CH]C(5039)'],
    products = ['C[CH]CC1[CH]CC1(5038)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(6.55606e+10,'s^-1'), n=0.64, Ea=(159.935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [cCs(-HC)CJ;CsJ;C] for rate rule [cCs(-HC)CJ;CsJ-HH;C]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction5',
    reactants = ['CHCH3(T)(21)', '[CH2]C1[CH]CC1(6246)'],
    products = ['C[CH]CC1[CH]CC1(5038)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', '[CH]CC1[CH]CC1(6248)'],
    products = ['C[CH]CC1[CH]CC1(5038)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', 'C[C]CC1[CH]CC1(6287)'],
    products = ['C[CH]CC1[CH]CC1(5038)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', 'C[CH]CC1[C]CC1(6288)'],
    products = ['C[CH]CC1[CH]CC1(5038)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', 'C[CH]CC1=CCC1(6292)'],
    products = ['C[CH]CC1[CH]CC1(5038)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'CC=CC1[CH]CC1(6293)'],
    products = ['C[CH]CC1[CH]CC1(5038)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'C[CH]CC1C=CC1(6294)'],
    products = ['C[CH]CC1[CH]CC1(5038)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'C=CCC1[CH]CC1(6198)'],
    products = ['C[CH]CC1[CH]CC1(5038)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C[CH]C[C]1[CH]CC1(6295)'],
    products = ['C[CH]CC1[CH]CC1(5038)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', 'C[CH]CC1[CH]C[CH]1(6296)'],
    products = ['C[CH]CC1[CH]CC1(5038)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', 'C[CH][CH]C1[CH]CC1(6297)'],
    products = ['C[CH]CC1[CH]CC1(5038)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', 'C[CH]CC1[CH][CH]C1(6298)'],
    products = ['C[CH]CC1[CH]CC1(5038)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH2][CH]CC1[CH]CC1(5252)'],
    products = ['C[CH]CC1[CH]CC1(5038)'],
...
reaction(
    label = 'reaction29',
    reactants = ['CC[CH]C1[CH]CC1(6265)'],
    products = ['C[CH]CC1[CH]CC1(5038)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C[CH]CC1C[CH]C1(6300)'],
    products = ['C[CH]CC1[CH]CC1(5038)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]CCC1[CH]CC1(6301)'],
    products = ['C[CH]CC1[CH]CC1(5038)'],
