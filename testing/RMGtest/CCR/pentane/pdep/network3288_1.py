...
species(
    label = '[CH]C1[CH]CC[CH]C1[CH2](14329)',
    structure = SMILES('[CH]C1[CH]CC[CH]C1[CH2]'),
    E0 = (834.87,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13052,0.0469836,3.34195e-05,-6.36284e-08,2.3551e-11,100529,30.3705], Tmin=(100,'K'), Tmax=(1066.03,'K')), NASAPolynomial(coeffs=[11.7221,0.0460392,-1.98435e-05,3.8213e-09,-2.73398e-13,96066,-31.745], Tmin=(1066.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(834.87,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclohexane) + radical(Cs_S) + radical(Cs_S) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]=C[CH]CC[CH]C=[CH](13765)',
    structure = SMILES('[CH]C=CCCC=C[CH]'),
    E0 = (733.018,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00864861,0.0771977,-4.0403e-05,7.53395e-09,2.23215e-13,88314.9,34.5898], Tmin=(100,'K'), Tmax=(1342.34,'K')), NASAPolynomial(coeffs=[14.5138,0.0458188,-1.8632e-05,3.32367e-09,-2.22262e-13,83344.4,-43.7405], Tmin=(1342.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(733.018,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(AllylJ2_triplet) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH][CH]C[CH]CC=C[CH2](14331)',
    structure = SMILES('[CH][CH]C[CH]CC=C[CH2]'),
    E0 = (864.731,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.26951,0.069427,-2.74349e-05,-4.67791e-08,5.22842e-11,104092,35.1446], Tmin=(100,'K'), Tmax=(507.546,'K')), NASAPolynomial(coeffs=[5.0191,0.0541423,-2.44246e-05,4.64711e-09,-3.25043e-13,103528,17.7877], Tmin=(507.546,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(864.731,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(RCCJC) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C=CC[CH]C[CH][CH2](14332)',
    structure = SMILES('[CH]C=CC[CH]C[CH][CH2]'),
    E0 = (840.947,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.27908,0.0634634,-2.92852e-05,5.7405e-09,-4.2222e-13,101176,32.8014], Tmin=(100,'K'), Tmax=(3247.53,'K')), NASAPolynomial(coeffs=[43.1088,0.013172,-6.05556e-06,9.71697e-10,-5.5101e-14,74657.1,-212.271], Tmin=(3247.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(840.947,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(RCCJC) + radical(RCCJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH][CH]CC[CH]C=C[CH2](14333)',
    structure = SMILES('[CH][CH]CC[CH]C=C[CH2]'),
    E0 = (811.385,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.440405,0.0754139,-5.15525e-05,1.84343e-08,-2.76344e-12,97717.1,34.3051], Tmin=(100,'K'), Tmax=(1502.12,'K')), NASAPolynomial(coeffs=[13.4457,0.0407824,-1.697e-05,3.08605e-09,-2.0902e-13,93810,-33.7293], Tmin=(1502.12,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(811.385,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(RCCJC) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C=C[CH]CC[CH][CH2](14334)',
    structure = SMILES('[CH]C=C[CH]CC[CH][CH2]'),
    E0 = (787.602,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.826879,0.0722734,-4.01803e-05,1.09055e-08,-1.23099e-12,94837.1,34.5061], Tmin=(100,'K'), Tmax=(1852.56,'K')), NASAPolynomial(coeffs=[12.5952,0.0468638,-1.96064e-05,3.50173e-09,-2.31874e-13,90476.8,-29.525], Tmin=(1852.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(787.602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(RCCJC) + radical(RCCJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C[CH]C[CH]C=C[CH2](14335)',
    structure = SMILES('[CH]C[CH]C[CH]C=C[CH2]'),
    E0 = (811.397,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.679023,0.0735963,-4.90336e-05,1.71295e-08,-2.55024e-12,97706.9,33.2708], Tmin=(100,'K'), Tmax=(1477.08,'K')), NASAPolynomial(coeffs=[11.695,0.0437648,-1.87394e-05,3.45652e-09,-2.36071e-13,94452.6,-24.1718], Tmin=(1477.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(811.397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(Allyl_S) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C=C[CH]C[CH]C[CH2](14336)',
    structure = SMILES('[CH]C=C[CH]C[CH]C[CH2]'),
    E0 = (787.614,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10915,0.0701095,-3.69743e-05,9.13241e-09,-9.15791e-13,94824.2,33.2998], Tmin=(100,'K'), Tmax=(2061.08,'K')), NASAPolynomial(coeffs=[13.5588,0.045948,-1.93902e-05,3.44473e-09,-2.259e-13,89692.2,-35.7667], Tmin=(2061.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(787.614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(Allyl_S) + radical(RCCJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=[C]CCC[CH][CH2](14337)',
    structure = SMILES('[CH]C=[C]CCC[CH][CH2]'),
    E0 = (884.331,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18573,0.0718887,-1.83606e-05,-6.69096e-08,6.62685e-11,106452,34.989], Tmin=(100,'K'), Tmax=(497.228,'K')), NASAPolynomial(coeffs=[4.54807,0.0597928,-2.69788e-05,5.12517e-09,-3.58254e-13,105933,19.2582], Tmin=(497.228,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(884.331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(RCCJ) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH][CH]CCC[C]=C[CH2](14338)',
    structure = SMILES('[CH][CH]CCC[C]=C[CH2]'),
    E0 = (908.114,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.508254,0.0815094,-7.15983e-05,3.79959e-08,-8.91678e-12,109343,35.6598], Tmin=(100,'K'), Tmax=(981.678,'K')), NASAPolynomial(coeffs=[8.52178,0.0488562,-2.17029e-05,4.11058e-09,-2.87117e-13,107769,-2.8524], Tmin=(981.678,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(908.114,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(Allyl_P) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C=[C]CC[CH]C[CH2](14339)',
    structure = SMILES('[CH]C=[C]CC[CH]C[CH2]'),
    E0 = (884.343,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.433598,0.0846041,-8.55714e-05,6.60229e-08,-2.37153e-11,106484,37.3581], Tmin=(100,'K'), Tmax=(751.747,'K')), NASAPolynomial(coeffs=[3.88418,0.0609134,-2.76642e-05,5.23722e-09,-3.63698e-13,106116,22.6974], Tmin=(751.747,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(884.343,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(RCCJ) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C[CH]CC[C]=C[CH2](14340)',
    structure = SMILES('[CH]C[CH]CC[C]=C[CH2]'),
    E0 = (908.126,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.52713,0.082106,-7.67761e-05,4.57984e-08,-1.22905e-11,109342,35.4265], Tmin=(100,'K'), Tmax=(863.313,'K')), NASAPolynomial(coeffs=[7.18348,0.0512667,-2.31959e-05,4.42495e-09,-3.10089e-13,108193,4.29146], Tmin=(863.313,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(908.126,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJCC) + radical(Allyl_P) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C]=CCCC[CH][CH2](14341)',
    structure = SMILES('[CH][C]=CCCC[CH][CH2]'),
    E0 = (884.331,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH][CH]CCCC=[C][CH2](14342)',
    structure = SMILES('[CH][CH]CCCC=[C][CH2]'),
    E0 = (908.114,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3010,987.5,1337.5,450,1655,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH][C]=CCC[CH]C[CH2](14343)',
    structure = SMILES('[CH][C]=CCC[CH]C[CH2]'),
    E0 = (884.343,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]C[CH]CCC=[C][CH2](14344)',
    structure = SMILES('[CH]C[CH]CCC=[C][CH2]'),
    E0 = (908.126,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]C=CCCC1[CH]C1(14345)',
    structure = SMILES('[CH]C=CCCC1[CH]C1'),
    E0 = (626.264,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.635976,0.0597133,5.93178e-06,-4.09125e-08,1.72678e-11,75455.5,33.4255], Tmin=(100,'K'), Tmax=(1045.56,'K')), NASAPolynomial(coeffs=[12.7756,0.044889,-1.81614e-05,3.37218e-09,-2.36517e-13,71188.7,-33.9467], Tmin=(1045.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(626.264,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropane) + radical(cyclopropane) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C1[CH]CCC=CC1(14346)',
    structure = SMILES('[CH]C1[CH]CCC=CC1'),
    E0 = (586.944,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25628,0.003149,0.000236798,-3.4493e-07,1.43386e-10,70745.4,30.8287], Tmin=(100,'K'), Tmax=(910.32,'K')), NASAPolynomial(coeffs=[38.4044,-0.0112597,1.53154e-05,-3.13933e-09,1.99993e-13,57815.7,-178.768], Tmin=(910.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(586.944,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(Cs_S) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C=CCCC=C=C(14347)',
    structure = SMILES('[CH]C=CCCC=C=C'),
    E0 = (538.938,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2950,3100,1380,975,1025,1650,540,610,2055,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (106.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0280777,0.0769032,-4.96115e-05,1.60727e-08,-2.1199e-12,64970.8,33.0993], Tmin=(100,'K'), Tmax=(1736.16,'K')), NASAPolynomial(coeffs=[17.8162,0.0359203,-1.4203e-05,2.4761e-09,-1.62024e-13,58794.3,-62.531], Tmin=(1736.16,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(538.938,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C=C[CH]CC=C[CH2](14348)',
    structure = SMILES('[CH]C=C[CH]CC=C[CH2]'),
    E0 = (654.945,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (106.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.328058,0.0682038,-1.99042e-05,-1.61924e-08,9.17597e-12,78914.5,32.1208], Tmin=(100,'K'), Tmax=(1077.25,'K')), NASAPolynomial(coeffs=[14.123,0.0415301,-1.69461e-05,3.13163e-09,-2.18026e-13,74518,-42.07], Tmin=(1077.25,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(654.945,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Allyl_P) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C=CC[CH]C=C[CH2](14349)',
    structure = SMILES('[CH]C=CC[CH]C=C[CH2]'),
    E0 = (654.945,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]C=CCC[C]=C[CH2](14350)',
    structure = SMILES('[CH]C=CCC[C]=C[CH2]'),
    E0 = (751.674,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3100,440,815,1455,1000,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (106.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.128762,0.0775219,-5.11634e-05,1.71944e-08,-2.37822e-12,90550.9,34.4237], Tmin=(100,'K'), Tmax=(1644.01,'K')), NASAPolynomial(coeffs=[16.1645,0.0385057,-1.5565e-05,2.75881e-09,-1.83036e-13,85278.3,-50.9115], Tmin=(1644.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(751.674,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=[C]CCC=C[CH2](14351)',
    structure = SMILES('[CH]C=[C]CCC=C[CH2]'),
    E0 = (751.674,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3100,440,815,1455,1000,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.513662,0.0757748,-4.6032e-05,1.4099e-08,-1.80991e-12,72309.6,32.7396], Tmin=(100,'K'), Tmax=(1688.05,'K')), NASAPolynomial(coeffs=[13.3477,0.0453633,-1.90085e-05,3.42654e-09,-2.29322e-13,67976.7,-35.8968], Tmin=(1688.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(600.175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=CCC[C]=CC(14355)',
    structure = SMILES('[CH]C=CCC[C]=CC'),
    E0 = (600.175,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]C=CC[CH]C=CC(14356)',
    structure = SMILES('[CH]C=CC[CH]C=CC'),
    E0 = (503.446,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.258909,0.0713611,-3.00294e-05,-1.88966e-09,3.24371e-12,60694.2,32.0986], Tmin=(100,'K'), Tmax=(1211.72,'K')), NASAPolynomial(coeffs=[13.3195,0.0452105,-1.86568e-05,3.40694e-09,-2.32802e-13,56283.7,-38.558], Tmin=(1211.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(503.446,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=C[CH]CC=CC(14357)',
...
species(
    label = '[CH]C1[CH]CCC1C=C(14360)',
    structure = SMILES('[CH]C1[CH]CCC1C=C'),
    E0 = (590.512,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.28528,0.0369549,7.04604e-05,-1.14604e-07,4.54816e-11,71140.3,30.9018], Tmin=(100,'K'), Tmax=(969.574,'K')), NASAPolynomial(coeffs=[15.8134,0.0336075,-1.19075e-05,2.22699e-09,-1.63973e-13,65663.2,-52.4559], Tmin=(969.574,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(590.512,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(Cs_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]C1CCC1C=C(14361)',
    structure = SMILES('[CH][CH]C1CCC1C=C'),
    E0 = (672.278,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
...
species(
    ...
    molecularWeight = (106.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.245052,0.0686047,-1.59739e-05,-2.5928e-08,1.41889e-11,57298.4,31.8524], Tmin=(100,'K'), Tmax=(1011.88,'K')), NASAPolynomial(coeffs=[15.8683,0.0371761,-1.43464e-05,2.62241e-09,-1.8367e-13,52583.9,-51.378], Tmin=(1011.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(475.181,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=CC[CH]CC=C(14244)',
    structure = SMILES('[CH]C=CC[CH]CC=C'),
    E0 = (569.037,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,2950,3100,1380,975,1025,1650,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.815349,0.0707037,-3.78812e-05,9.61446e-09,-9.86083e-13,68551.9,34.1822], Tmin=(100,'K'), Tmax=(2092.67,'K')), NASAPolynomial(coeffs=[16.0454,0.0415924,-1.70146e-05,2.96695e-09,-1.91942e-13,62177.6,-50.5405], Tmin=(2092.67,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(569.037,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=CCCC[C]=C(14362)',
    structure = SMILES('[CH]C=CCCC[C]=C'),
    E0 = (612.42,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3100,1380,975,1025,1650,1685,370,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.255325,0.0778795,-4.88779e-05,1.55359e-08,-2.05008e-12,73795,34.1176], Tmin=(100,'K'), Tmax=(1683.4,'K')), NASAPolynomial(coeffs=[15.0413,0.0427457,-1.75717e-05,3.13781e-09,-2.08851e-13,68816.9,-44.917], Tmin=(1683.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(612.42,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=C[CH]CCC=C(14363)',
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.235918,0.0709484,-2.51641e-05,-9.07133e-09,6.14862e-12,62168.7,32.6135], Tmin=(100,'K'), Tmax=(1131.69,'K')), NASAPolynomial(coeffs=[13.5858,0.0448097,-1.84154e-05,3.38665e-09,-2.3375e-13,57799.3,-39.3985], Tmin=(1131.69,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(515.691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_S) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=CCCCC=[CH](14364)',
    structure = SMILES('[CH]C=CCCCC=[CH]'),
    E0 = (621.675,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.108318,0.0803367,-5.2024e-05,1.70316e-08,-2.2792e-12,74926.2,35.3726], Tmin=(100,'K'), Tmax=(1706.76,'K')), NASAPolynomial(coeffs=[17.7459,0.0384928,-1.52489e-05,2.66705e-09,-1.75116e-13,68831.7,-60.3086], Tmin=(1706.76,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(621.675,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_P) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C=[C]CCCC=C(14365)',
...
species(
    label = '[CH]=C=CCCC[CH][CH2](13736)',
    structure = SMILES('C#C[CH]CCC[CH][CH2]'),
    E0 = (600.363,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,2175,525,750,770,3400,2100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.266844,0.0847711,-8.72027e-05,5.72318e-08,-1.60629e-11,72339,34.6644], Tmin=(100,'K'), Tmax=(851.96,'K')), NASAPolynomial(coeffs=[8.61763,0.0455656,-1.81793e-05,3.22304e-09,-2.15323e-13,70916,-4.28584], Tmin=(851.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(600.363,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJC) + radical(Sec_Propargyl) + radical(RCCJ)"""),
)
...
species(
    label = '[C]=C[CH]CCC=C[CH2](14366)',
    structure = SMILES('[C]C=CCCC=C[CH2]'),
    E0 = (812.626,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,3000,3100,440,815,1455,1000,206.552,206.554,206.586,4000],'cm^-1')),
        HinderedRotor(inertia=(0.757192,'amu*angstrom^2'), symmetry=1, barrier=(22.9232,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.757142,'amu*angstrom^2'), symmetry=1, barrier=(22.923,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.757007,'amu*angstrom^2'), symmetry=1, barrier=(22.9233,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.757192,'amu*angstrom^2'), symmetry=1, barrier=(22.9231,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (106.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0414306,0.076014,-5.06013e-05,1.25688e-08,2.27101e-13,97888.1,31.6022], Tmin=(100,'K'), Tmax=(1133.29,'K')), NASAPolynomial(coeffs=[16.8175,0.0321752,-1.29245e-05,2.37462e-09,-1.64518e-13,93098.4,-55.7874], Tmin=(1133.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(812.626,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(CJ3)"""),
)

species(
    label = '[CH2]C=CCCC1C=C1(14367)',
    structure = SMILES('[CH2]C=CCCC1C=C1'),
    E0 = (412.997,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0847973,0.0748,-4.2335e-05,4.87121e-09,2.57066e-12,49822.5,29.0005], Tmin=(100,'K'), Tmax=(1112.72,'K')), NASAPolynomial(coeffs=[15.811,0.0361951,-1.44607e-05,2.65001e-09,-1.83411e-13,45212.9,-53.5358], Tmin=(1112.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(412.997,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH2]C=CCC=CC=C(5745)',
    structure = SMILES('[CH2]C=CCC=CC=C'),
    E0 = (255.995,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3002.5,3010,3017.5,3025,975,981.25,987.5,993.75,1000,1300,1318.75,1337.5,1356.25,1375,400,425,450,475,500,1630,1642.5,1655,1667.5,1680,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,257.265,257.479,257.596],'cm^-1')),
        HinderedRotor(inertia=(0.39912,'amu*angstrom^2'), symmetry=1, barrier=(18.7795,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.399496,'amu*angstrom^2'), symmetry=1, barrier=(18.7781,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.399231,'amu*angstrom^2'), symmetry=1, barrier=(18.7771,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.39914,'amu*angstrom^2'), symmetry=1, barrier=(18.7761,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.260157,0.06602,-7.30739e-06,-3.92181e-08,2.00841e-11,30938.2,30.9691], Tmin=(100,'K'), Tmax=(986.448,'K')), NASAPolynomial(coeffs=[18.0719,0.0312739,-1.14644e-05,2.10796e-09,-1.50786e-13,25600.6,-63.9624], Tmin=(986.448,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(255.995,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=CC=CCC=CC(14368)',
    structure = SMILES('[CH]=CC=CCC=CC'),
    E0 = (351.592,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.144914,0.0725088,-3.40662e-05,-6.62882e-09,7.44828e-12,42436.2,31.5067], Tmin=(100,'K'), Tmax=(1036.07,'K')), NASAPolynomial(coeffs=[16.4405,0.0337935,-1.3048e-05,2.38909e-09,-1.67075e-13,37760.8,-53.9551], Tmin=(1036.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(351.592,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.142691,0.0792076,-6.28935e-05,2.81483e-08,-5.24389e-12,38174.5,30.617], Tmin=(100,'K'), Tmax=(1265.29,'K')), NASAPolynomial(coeffs=[13.1765,0.038004,-1.40473e-05,2.41224e-09,-1.58955e-13,34876.2,-35.3308], Tmin=(1265.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(316.208,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CtCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Sec_Propargyl)"""),
)
...
species(
    label = '[CH2]C1[CH]CC[CH]C=C1(14370)',
    structure = SMILES('[CH2]C1[CH]C=CCC[CH]1'),
    E0 = (484.924,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52439,-0.00346503,0.000252988,-3.61195e-07,1.49563e-10,58466.3,29.5387], Tmin=(100,'K'), Tmax=(906.464,'K')), NASAPolynomial(coeffs=[37.507,-0.0113176,1.62265e-05,-3.38219e-09,2.19172e-13,45742.2,-174.726], Tmin=(906.464,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(484.924,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cycloheptene) + radical(Cs_S) + radical(Allyl_S) + radical(Isobutyl)"""),
)

species(
    label = '[CH2][CH]C1C=C[CH]CC1(14371)',
    structure = SMILES('[CH2][CH]C1[CH]C=CCC1'),
    E0 = (460.52,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.41285,0.0364096,6.46577e-05,-1.00906e-07,3.82897e-11,55498.9,27.2499], Tmin=(100,'K'), Tmax=(1002.11,'K')), NASAPolynomial(coeffs=[13.3281,0.039494,-1.57669e-05,3.02913e-09,-2.2086e-13,50567.9,-42.9477], Tmin=(1002.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(460.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclohexene) + radical(cyclohexene-allyl) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = '[CH]=CC=CCC=C[CH2](14372)',
    structure = SMILES('[CH]=CC=CCC=C[CH2]'),
    E0 = (503.091,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2995,3002.5,3010,3017.5,3025,975,981.25,987.5,993.75,1000,1300,1318.75,1337.5,1356.25,1375,400,425,450,475,500,1630,1642.5,1655,1667.5,1680,3000,3100,440,815,1455,1000,3120,650,792.5,1650,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.838595,'amu*angstrom^2'), symmetry=1, barrier=(19.2809,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.838892,'amu*angstrom^2'), symmetry=1, barrier=(19.2878,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.838658,'amu*angstrom^2'), symmetry=1, barrier=(19.2824,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.838851,'amu*angstrom^2'), symmetry=1, barrier=(19.2868,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (106.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.183585,0.0695769,-2.40899e-05,-2.1666e-08,1.40924e-11,60658.1,31.647], Tmin=(100,'K'), Tmax=(990.125,'K')), NASAPolynomial(coeffs=[18.3261,0.0284172,-1.04165e-05,1.90592e-09,-1.35646e-13,55490.3,-63.6543], Tmin=(990.125,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(503.091,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C=CCCC=C[CH2](14373)',
    structure = SMILES('C#C[CH]CCC=C[CH2]'),
    E0 = (467.707,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2175,525,750,770,3400,2100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (106.165,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.158112,0.0765438,-5.38638e-05,1.44181e-08,7.86537e-13,56397.5,30.8416], Tmin=(100,'K'), Tmax=(986.645,'K')), NASAPolynomial(coeffs=[14.6958,0.0332244,-1.175e-05,2.00635e-09,-1.33838e-13,52768.6,-42.9514], Tmin=(986.645,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(467.707,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CtCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Ct-CtCs) + group(Ct-CtH) + radical(Sec_Propargyl) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH]=[C]CCCC=C[CH2](14374)',
    structure = SMILES('[CH]=[C]CCCC=C[CH2]'),
    E0 = (640.331,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.140444,0.0794884,-5.93458e-05,2.31357e-08,-3.7137e-12,77157.2,34.1048], Tmin=(100,'K'), Tmax=(1444.09,'K')), NASAPolynomial(coeffs=[15.4717,0.0370224,-1.52357e-05,2.77225e-09,-1.88409e-13,72729.2,-45.4936], Tmin=(1444.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(640.331,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_P) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH2][C]=CCCC=C[CH2](5735)',
    structure = SMILES('[CH2][C]=CCCC=C[CH2]'),
    E0 = (532.489,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0211246,0.0764246,-4.79575e-05,1.14372e-08,1.02368e-13,64196.1,33.9793], Tmin=(100,'K'), Tmax=(1178.83,'K')), NASAPolynomial(coeffs=[16.075,0.0360337,-1.44821e-05,2.64014e-09,-1.81233e-13,59432.6,-50.263], Tmin=(1178.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(532.489,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Allyl_P) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CCC[CH]C=C[CH2](14375)',
    structure = SMILES('[CH]=CCC[CH]C=C[CH2]'),
    E0 = (543.602,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3100,440,815,1455,1000,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.183167,0.0718683,-3.33447e-05,-4.3532e-09,5.69118e-12,65527.9,32.3736], Tmin=(100,'K'), Tmax=(1086.58,'K')), NASAPolynomial(coeffs=[15.6821,0.036623,-1.47984e-05,2.74119e-09,-1.91441e-13,60872.2,-49.6115], Tmin=(1086.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(543.602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Allyl_S) + radical(Allyl_P) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CCCC[C]=C[CH2](14376)',
    structure = SMILES('[CH]=CCCC[C]=C[CH2]'),
    E0 = (640.331,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]C=C[CH]CC=C[CH2](5733)',
    structure = SMILES('[CH2]C=C[CH]CC=C[CH2]'),
    E0 = (435.76,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,2995,3005,3015,3025,975,983.333,991.667,1000,1300,1325,1350,1375,400,433.333,466.667,500,1630,1646.67,1663.33,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.357804,0.065481,-1.09315e-05,-2.95988e-08,1.49885e-11,52553.6,31.1829], Tmin=(100,'K'), Tmax=(1027.02,'K')), NASAPolynomial(coeffs=[16.0579,0.0360616,-1.43047e-05,2.67244e-09,-1.89626e-13,47655.4,-53.1263], Tmin=(1027.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(435.76,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Allyl_P) + radical(Allyl_P)"""),
)

species(
    label = '[CH]=CCCCC=[C][CH2](14377)',
...
species(
    label = '[CH2]C=[C]CCC=C[CH2](5734)',
    structure = SMILES('[CH2]C=[C]CCC=C[CH2]'),
    E0 = (532.489,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2995,3010,3025,975,987.5,1000,1300,1337.5,1375,400,450,500,1630,1655,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1685,370,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=CC=CCCC=C(14378)',
    structure = SMILES('[CH]=CC=CCCC=C'),
    E0 = (362.568,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.105605,0.0723211,-2.97338e-05,-1.3538e-08,1.04419e-11,43758.7,32.0584], Tmin=(100,'K'), Tmax=(1014.47,'K')), NASAPolynomial(coeffs=[17.2894,0.0325733,-1.23738e-05,2.26769e-09,-1.59641e-13,38831.1,-58.1932], Tmin=(1014.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(362.568,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CCCC=CC=C(14379)',
    structure = SMILES('[CH]=CCCC=CC=C'),
    E0 = (362.568,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
...
species(
    label = '[CH]1[CH]CC[CH]C=CC1(14380)',
    structure = SMILES('[CH]1[CH]CC[CH]C=CC1'),
    E0 = (486.157,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (107.173,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.03068,0.0297536,5.84281e-05,-7.75764e-08,2.64523e-11,58553.6,24.0092], Tmin=(100,'K'), Tmax=(1056.59,'K')), NASAPolynomial(coeffs=[5.83959,0.0504667,-2.08538e-05,3.91716e-09,-2.75911e-13,55787.6,-3.85655], Tmin=(1056.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(486.157,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(cis-Cyclooctene) + radical(RCCJCC) + radical(Allyl_S) + radical(RCCJCC)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C1[CH]CC[CH]C1[CH2](14329)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]C(C=C)C([CH2])C=C(5638)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[CH]C=CCCC=[CH](14330)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]=C[CH]CC[CH]C=[CH](13765)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH][CH]C[CH]CC=C[CH2](14331)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH]C=CC[CH]C[CH][CH2](14332)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(4.48818e+10,'s^-1'), n=0.34095, Ea=(22.3009,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [Rn;Y_rad_NDe;XH_Rrad] + [R2radExo;Y_rad;XH_Rrad] for rate rule [R2radExo;Y_rad_NDe;XH_Rrad]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction8',
    reactants = ['[CH][CH]CC[CH]C=C[CH2](14333)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH]C=C[CH]CC[CH][CH2](14334)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(5.2748e+09,'s^-1'), n=0.37, Ea=(88.9686,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R3;Y_rad_De;XH_Rrad] + [R3radExo;Y_rad;XH_Rrad] for rate rule [R3radExo;Y_rad_De;XH_Rrad]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]C[CH]C[CH]C=C[CH2](14335)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]C=C[CH]C[CH]C[CH2](14336)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]C=[C]CCC[CH][CH2](14337)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH][CH]CCC[C]=C[CH2](14338)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]C=[C]CC[CH]C[CH2](14339)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]C[CH]CC[C]=C[CH2](14340)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH][C]=CCCC[CH][CH2](14341)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH][CH]CCCC=[C][CH2](14342)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH][C]=CCC[CH]C[CH2](14343)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH]C[CH]CCC=[C][CH2](14344)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH]C=CCCC=C[CH2](5721)'],
    products = ['[CH]C=CCCC1[CH]C1(14345)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]C=CCCC=C[CH2](5721)'],
    products = ['[CH]C1[CH]CCC=CC1(14346)'],
    transitionState = 'TS21',
    kinetics = Arrhenius(A=(163933,'s^-1'), n=1.17455, Ea=(73.112,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R7_linear;doublebond_intra_pri;radadd_intra_cs2H]
Euclidian distance = 0
family: Intra_R_Add_Endocyclic
Ea raised from 64.5 to 73.1 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH]C=CCCC=C=C(14347)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]C=[CH](13797)', '[CH2]C=CC[CH2](507)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
Exact match found for rate rule [Root_N-1R->H_N-1CNOS->N_N-1COS->O_1CS->C_N-1C-inRing_Ext-2R-R_Ext-3R!H-R_N-Sp-3R!H=2R_Sp-4R!H=3R!H_Ext-1C-R]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Recombination"""),
)
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH]C=C[CH]CC=C[CH2](14348)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]C=C(3739)', '[CH]=C[CH]C[CH2](13774)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH]C=CC[CH]C=C[CH2](14349)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', '[CH]C=CCC[C]=C[CH2](14350)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction30',
    reactants = ['H(3)', '[CH]C=[C]CCC=C[CH2](14351)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', '[CH]C=CCCC=[C][CH2](14352)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction32',
    reactants = ['H(3)', '[CH][C]=CCCC=C[CH2](14353)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]C=CCCC=C[CH2](5721)'],
    products = ['[CH]=C[C]=C(13645)', 'buten3yl1(65)'],
    transitionState = 'TS34',
    kinetics = Arrhenius(A=(4.83014e+38,'s^-1'), n=-8.23851, Ea=(315.108,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.41826346251888336, var=21.571226466455663, Tref=1000.0, N=5, correlation='Root_1R!H->C_2R!H->C_N-5R!H->O_Ext-4R!H-R',), comment="""BM rule fitted to 2 training reactions at node Root_1R!H->C_2R!H->C_N-5R!H->O_Ext-4R!H-R
    Total Standard Deviation in ln(k): 10.36187210002245
Exact match found for rate rule [Root_1R!H->C_2R!H->C_N-5R!H->O_Ext-4R!H-R]
Euclidian distance = 0
family: Retroene"""),
...
reaction(
    label = 'reaction37',
    reactants = ['[CH]C=CCCC=C[CH2](5721)'],
    products = ['[CH]C=CC[CH]C=CC(14356)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH]C=CCCC=C[CH2](5721)'],
    products = ['[CH]C=C[CH]CC=CC(14357)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C=CCC([CH2])C=C(5666)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction42',
    reactants = ['C2H3(60)', '[CH]C=CCC[CH](13792)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH]C=CCCC=C[CH2](5721)'],
    products = ['[CH]C1[CH]CCC1C=C(14360)'],
    transitionState = 'TS43',
    kinetics = Arrhenius(A=(2.46737e+16,'s^-1'), n=-1.32849, Ea=(120.44,'kJ/mol'), T0=(1,'K'), Tmin=(303.03,'K'), Tmax=(2000,'K'), comment="""Estimated using template [R5_CsCs_HH_D;doublebond_intra;radadd_intra_csHCd] for rate rule [R5_CsCs_HH_D;doublebond_intra_pri;radadd_intra_csHCd]
Euclidian distance = 1.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction44',
    reactants = ['[CH]C=CCCC=C[CH2](5721)'],
    products = ['[CH][CH]C1CCC1C=C(14361)'],
    transitionState = 'TS44',
    kinetics = Arrhenius(A=(4.06771e+06,'s^-1'), n=1.35044, Ea=(158.446,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_SS_D;doublebond_intra;radadd_intra_cs] for rate rule [R5_SS_D;doublebond_intra;radadd_intra_csHCd]
Euclidian distance = 2.0
family: Intra_R_Add_Exocyclic
Ea raised from 154.8 to 158.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction45',
    reactants = ['H(3)', '[CH]=C[CH]CC=CC=C(13769)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH]C=CC[CH]CC=C(14244)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH]C=C[CH]CCC=C(14363)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction52',
    reactants = ['[CH]=C=CCCC[CH][CH2](13736)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction54',
    reactants = ['C2H2(T)(1343)', '[CH]CCC=C[CH2](4958)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction55',
    reactants = ['H(3)', '[C]=C[CH]CCC=C[CH2](14366)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction56',
    reactants = ['[CH]C=CCCC=C[CH2](5721)'],
    products = ['[CH2]C=CCCC1C=C1(14367)'],
...
reaction(
    label = 'reaction64',
    reactants = ['[CH]C=CCCC=C[CH2](5721)'],
    products = ['[CH2]C1[CH]CC[CH]C=C1(14370)'],
    transitionState = 'TS64',
    kinetics = Arrhenius(A=(4.625e+11,'s^-1'), n=0.16, Ea=(41.045,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R7;doublebond_intra_pri;radadd_intra_cdsingleH] for rate rule [R7_linear;doublebond_intra_pri;radadd_intra_cdsingleH]
Euclidian distance = 1.0
family: Intra_R_Add_Endocyclic"""),
)
...
reaction(
    label = 'reaction65',
    reactants = ['[CH]C=CCCC=C[CH2](5721)'],
    products = ['[CH2][CH]C1C=C[CH]CC1(14371)'],
    transitionState = 'TS65',
    kinetics = Arrhenius(A=(1e+11,'s^-1'), n=0.21, Ea=(125.52,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R7;doublebond_intra;radadd_intra_cdsingleH]
Euclidian distance = 0
family: Intra_R_Add_Exocyclic"""),
)
...
reaction(
    label = 'reaction66',
    reactants = ['H(3)', '[CH]=CC=CCC=C[CH2](14372)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction67',
    reactants = ['H(3)', '[CH]=C=CCCC=C[CH2](14373)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction68',
    reactants = ['C2H2(1342)', '[CH]CCC=C[CH2](4958)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.0373837,'m^3/(mol*s)'), n=2.41, Ea=(39.1064,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cds-HH_Cds-OneDeH;CsJ-CdHH]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction71',
    reactants = ['[CH]=[C]CCCC=C[CH2](14374)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction72',
    reactants = ['[CH2][C]=CCCC=C[CH2](5735)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction73',
    reactants = ['[CH]=CCC[CH]C=C[CH2](14375)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
    transitionState = 'TS73',
    kinetics = Arrhenius(A=(2.2683e+10,'s^-1'), n=0.805, Ea=(168.615,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R3H_SS;C_rad_out_H/Cd;Cs_H_out_H/OneDe] + [R3H_SS_Cs;C_rad_out_H/Cd;Cs_H_out_1H] for rate rule [R3H_SS_Cs;C_rad_out_H/Cd;Cs_H_out_H/OneDe]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction74',
    reactants = ['[CH]=CCCC[C]=C[CH2](14376)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction75',
    reactants = ['[CH]C=CCCC=C[CH2](5721)'],
    products = ['[CH2]C=C[CH]CC=C[CH2](5733)'],
...
reaction(
    label = 'reaction76',
    reactants = ['[CH]=CCCCC=[C][CH2](14377)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
    transitionState = 'TS76',
    kinetics = Arrhenius(A=(13813.5,'s^-1'), n=1.88327, Ea=(38.7799,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5H_RSSR;Y_rad_out;Cs_H_out_H/OneDe] for rate rule [R5H_DSSS;Cd_rad_out;Cs_H_out_H/OneDe]
Euclidian distance = 2.23606797749979
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction77',
    reactants = ['[CH2]C=[C]CCC=C[CH2](5734)'],
    products = ['[CH]C=CCCC=C[CH2](5721)'],
...
reaction(
    label = 'reaction82',
    reactants = ['[CH]C=CCCC=C[CH2](5721)'],
    products = ['[CH]1[CH]CC[CH]C=CC1(14380)'],
