...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.354892,0.0766118,-5.15561e-05,1.81019e-08,-2.65704e-12,52790.8,31.1116], Tmin=(100,'K'), Tmax=(1534.04,'K')), NASAPolynomial(coeffs=[13.9215,0.0412363,-1.6965e-05,3.06896e-09,-2.07106e-13,48628.5,-40.1444], Tmin=(1534.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(437.817,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]CC[CH]CCC(137)',
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06233,0.0705688,-4.49713e-05,1.635e-08,-2.79058e-12,51460.2,30.451], Tmin=(100,'K'), Tmax=(1201.24,'K')), NASAPolynomial(coeffs=[6.23531,0.0533434,-2.34618e-05,4.41261e-09,-3.0621e-13,50217.4,4.54583], Tmin=(1201.24,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(427.029,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (98.1861,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13722,0.0419761,6.22543e-05,-1.02454e-07,3.97677e-11,-7877.53,25.9014], Tmin=(100,'K'), Tmax=(989.168,'K')), NASAPolynomial(coeffs=[13.9258,0.0418882,-1.59e-05,2.9831e-09,-2.15396e-13,-12933.2,-48.4234], Tmin=(989.168,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-66.5092,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane)"""),
)
...
species(
    label = '[CH2]CCC=CCC(139)',
    structure = SMILES('[CH2]CCC=CCC'),
    E0 = (106.273,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.533926,0.0656075,-2.40325e-05,-6.88139e-09,5.06987e-12,12915.3,31.2771], Tmin=(100,'K'), Tmax=(1142.44,'K')), NASAPolynomial(coeffs=[12.6745,0.0416027,-1.68086e-05,3.07976e-09,-2.12213e-13,8933.86,-34.1956], Tmin=(1142.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.273,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJ)"""),
)

species(
    label = '[CH2]CC=CCCC(140)',
...
species(
    label = '[CH2]CC[CH]C[CH]C(143)',
    structure = SMILES('[CH2]CC[CH]C[CH]C'),
    E0 = (378.506,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2]CC[CH][CH]CC(144)',
    structure = SMILES('[CH2]CC[CH][CH]CC'),
    E0 = (378.518,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,454.626,2277.96,3712.22,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0195964,'amu*angstrom^2'), symmetry=1, barrier=(13.4561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0195964,'amu*angstrom^2'), symmetry=1, barrier=(13.4561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0195964,'amu*angstrom^2'), symmetry=1, barrier=(13.4561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0195964,'amu*angstrom^2'), symmetry=1, barrier=(13.4561,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0195964,'amu*angstrom^2'), symmetry=1, barrier=(13.4561,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.55545,0.056742,-2.35883e-05,3.62852e-09,-1.39781e-13,45551.6,28.3085], Tmin=(100,'K'), Tmax=(2625.11,'K')), NASAPolynomial(coeffs=[38.1521,0.0144893,-6.29469e-06,9.76222e-10,-5.28569e-14,22732.1,-185.647], Tmin=(2625.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(378.518,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJCC) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C[CH][CH]CCC(145)',
    structure = SMILES('[CH2]C[CH][CH]CCC'),
    E0 = (378.518,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,454.626,2277.96,3712.22,4000],'cm^-1')),
        HinderedRotor(inertia=(0.0195964,'amu*angstrom^2'), symmetry=1, barrier=(13.4561,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH2]CC[CH]CC[CH2](147)',
    structure = SMILES('[CH2]CC[CH]CC[CH2]'),
    E0 = (389.306,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,3025,407.5,1350,352.5,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,215.112,737.697,1221.41,3419.63],'cm^-1')),
        HinderedRotor(inertia=(0.0556125,'amu*angstrom^2'), symmetry=1, barrier=(2.24095,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0556125,'amu*angstrom^2'), symmetry=1, barrier=(2.24095,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0556125,'amu*angstrom^2'), symmetry=1, barrier=(2.24095,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0556125,'amu*angstrom^2'), symmetry=1, barrier=(2.24095,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0556125,'amu*angstrom^2'), symmetry=1, barrier=(2.24095,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (97.1781,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.06613,0.0701238,-4.90858e-05,2.32862e-08,-5.72113e-12,46923.5,32.3352], Tmin=(100,'K'), Tmax=(857.101,'K')), NASAPolynomial(coeffs=[3.97064,0.0565687,-2.53633e-05,4.83451e-09,-3.39128e-13,46425.7,18.7705], Tmin=(857.101,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(389.306,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJ) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]CC[CH]CCC(76)'],
    products = ['C=C(17)', 'C=CCCC(20)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]CC(5)', '[CH]CC[CH2](83)'],
    products = ['[CH2]CC[CH]CCC(76)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C[CH2](21)', '[CH]CCC(32)'],
    products = ['[CH2]CC[CH]CCC(76)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(T)(15)', '[CH2]C[CH]CCC(44)'],
    products = ['[CH2]CC[CH]CCC(76)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(3.22604e+07,'m^3/(mol*s)'), n=-0.594572, Ea=(56.8079,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction8',
    reactants = ['H(9)', '[CH2]CC[C]CCC(136)'],
    products = ['[CH2]CC[CH]CCC(76)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(9)', '[CH]CC[CH]CCC(137)'],
    products = ['[CH2]CC[CH]CCC(76)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction16',
    reactants = ['C[CH2](7)', '[CH2]CCC=C(57)'],
    products = ['[CH2]CC[CH]CCC(76)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][CH2](18)', 'C=CCCC(20)'],
    products = ['[CH2]CC[CH]CCC(76)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C=C(17)', '[CH2][CH]CCC(25)'],
    products = ['[CH2]CC[CH]CCC(76)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C[CH2](7)', '[CH2][CH]CC[CH2](134)'],
    products = ['[CH2]CC[CH]CCC(76)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH3](12)', '[CH2]C[CH]CC[CH2](142)'],
    products = ['[CH2]CC[CH]CCC(76)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(9)', '[CH2]CC[CH]C[CH]C(143)'],
    products = ['[CH2]CC[CH]CCC(76)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(9)', '[CH2]CC[CH][CH]CC(144)'],
    products = ['[CH2]CC[CH]CCC(76)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2][CH2](18)', '[CH2][CH]CCC(25)'],
    products = ['[CH2]CC[CH]CCC(76)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(9)', '[CH2]C[CH][CH]CCC(145)'],
    products = ['[CH2]CC[CH]CCC(76)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(9)', '[CH2][CH]C[CH]CCC(146)'],
    products = ['[CH2]CC[CH]CCC(76)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(9)', '[CH2]CC[CH]CC[CH2](147)'],
    products = ['[CH2]CC[CH]CCC(76)'],
