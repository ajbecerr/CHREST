...
species(
    ...
    E0 = (29.6155,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,350,440,435,1725,3000,3100,440,815,1455,1000,331.512,331.638],'cm^-1')),
        HinderedRotor(inertia=(0.00153355,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110435,'amu*angstrom^2'), symmetry=1, barrier=(8.63172,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.110706,'amu*angstrom^2'), symmetry=1, barrier=(8.63736,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    label = '[CH]C(CC)C(=C)[O](2493)',
    structure = SMILES('[CH]C(CC)C(=C)[O]'),
    E0 = (299.407,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,200,800,1000,1200,1400,1600],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.532059,0.0666688,-4.14165e-05,3.1475e-09,4.56316e-12,36143.7,29.3309], Tmin=(100,'K'), Tmax=(994.095,'K')), NASAPolynomial(coeffs=[15.7335,0.0253857,-9.12731e-06,1.61446e-09,-1.11429e-13,32138.9,-48.859], Tmin=(994.095,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(299.407,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(C)OJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.106969,0.0728254,-3.81663e-05,-1.18135e-08,1.26965e-11,663.586,27.6412], Tmin=(100,'K'), Tmax=(943.203,'K')), NASAPolynomial(coeffs=[19.6146,0.0214947,-6.46764e-06,1.07549e-09,-7.45937e-14,-4413,-72.7349], Tmin=(943.203,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(4.25487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + radical(Allyl_P) + radical(C=C(O)CJ)"""),
)

species(
    label = '[CH]=C(O)C([CH2])CC(2508)',
    structure = SMILES('[CH]=C(O)C([CH2])CC'),
    E0 = (165.566,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3000,3100,440,815,1455,1000,3120,650,792.5,1650,205.213],'cm^-1')),
        HinderedRotor(inertia=(0.00394324,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00385198,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.551247,'amu*angstrom^2'), symmetry=1, barrier=(16.442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.538472,'amu*angstrom^2'), symmetry=1, barrier=(16.4548,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.529714,'amu*angstrom^2'), symmetry=1, barrier=(16.436,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.209792,0.072218,-4.14133e-05,-6.71454e-09,1.08318e-11,20059.7,30.1684], Tmin=(100,'K'), Tmax=(929.87,'K')), NASAPolynomial(coeffs=[18.4305,0.0221981,-6.4727e-06,1.03371e-09,-6.9441e-14,15445,-63.004], Tmin=(929.87,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(165.566,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_P)"""),
)
...
species(
    label = '[CH2]CC([CH2])C(=C)O(2512)',
    structure = SMILES('[CH2]CC([CH2])C(=C)O'),
    E0 = (123.716,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,2950,3100,1380,975,1025,1650,810.199,822.54],'cm^-1')),
        HinderedRotor(inertia=(0.15782,'amu*angstrom^2'), symmetry=1, barrier=(3.62859,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.61634,'amu*angstrom^2'), symmetry=1, barrier=(14.1709,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.623526,'amu*angstrom^2'), symmetry=1, barrier=(14.3361,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.030686,'amu*angstrom^2'), symmetry=1, barrier=(14.2672,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0302697,'amu*angstrom^2'), symmetry=1, barrier=(14.2574,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.320728,0.0694323,-3.52342e-05,-1.17844e-08,1.22723e-11,15022.6,31.1534], Tmin=(100,'K'), Tmax=(933.391,'K')), NASAPolynomial(coeffs=[17.9611,0.0227746,-6.75977e-06,1.09485e-09,-7.41078e-14,10468.9,-59.4881], Tmin=(933.391,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(123.716,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59157,0.0385634,3.27149e-05,-6.18775e-08,2.40593e-11,-20256.8,23.7621], Tmin=(100,'K'), Tmax=(1013.02,'K')), NASAPolynomial(coeffs=[11.1234,0.0355427,-1.40704e-05,2.64475e-09,-1.88882e-13,-23964.2,-31.1136], Tmin=(1013.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-169.251,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsCs) + ring(Cyclobutanone)"""),
)

species(
    label = 'C=C(CC)C(C)=O(2514)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.20402,0.0572792,-3.01322e-05,6.8036e-09,-5.29268e-13,-23046,25.7523], Tmin=(100,'K'), Tmax=(1895.06,'K')), NASAPolynomial(coeffs=[18.1063,0.0278324,-1.17553e-05,2.07349e-09,-1.34112e-13,-30570.8,-69.5479], Tmin=(1895.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-192.483,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cd-CdCs(CO)) + group(Cds-O2d(Cds-Cds)Cs) + group(Cds-CdsHH)"""),
)
...
species(
    label = '[CH2]CC([CH2])[C]([CH2])O(2516)',
    structure = SMILES('[CH2]CC([CH2])[C]([CH2])O'),
    E0 = (431.864,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,226.88,986.195],'cm^-1')),
        HinderedRotor(inertia=(0.100856,'amu*angstrom^2'), symmetry=1, barrier=(3.2528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100856,'amu*angstrom^2'), symmetry=1, barrier=(3.2528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100856,'amu*angstrom^2'), symmetry=1, barrier=(3.2528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100856,'amu*angstrom^2'), symmetry=1, barrier=(3.2528,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.100856,'amu*angstrom^2'), symmetry=1, barrier=(3.2528,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.115616,0.0885949,-0.000108947,7.7228e-08,-2.22794e-11,52078.1,33.7448], Tmin=(100,'K'), Tmax=(844.204,'K')), NASAPolynomial(coeffs=[11.347,0.0353815,-1.44019e-05,2.57057e-09,-1.71927e-13,50181.7,-18.5389], Tmin=(844.204,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(431.864,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOH) + radical(Isobutyl) + radical(RCCJ) + radical(CJCO)"""),
)

species(
    label = '[CH2][C]1OCC1CC(2517)',
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.444549,0.0690553,-4.49997e-05,9.21793e-09,1.56205e-12,-1891.55,27.2417], Tmin=(100,'K'), Tmax=(1046.02,'K')), NASAPolynomial(coeffs=[14.8174,0.0297777,-1.11668e-05,1.9894e-09,-1.3624e-13,-5756.47,-46.847], Tmin=(1046.02,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-16.857,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsOs) + radical(C=C(C)OJ) + radical(Allyl_P)"""),
)
...
species(
    label = '[CH2]CC([CH2])C(C)=O(2520)',
    structure = SMILES('[CH2]CC([CH2])C(C)=O'),
    E0 = (104.242,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,519.928,2001.64],'cm^-1')),
        HinderedRotor(inertia=(0.0185254,'amu*angstrom^2'), symmetry=1, barrier=(3.55976,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.365147,'amu*angstrom^2'), symmetry=1, barrier=(8.39545,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.365154,'amu*angstrom^2'), symmetry=1, barrier=(8.3956,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0436801,'amu*angstrom^2'), symmetry=1, barrier=(8.39586,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0437715,'amu*angstrom^2'), symmetry=1, barrier=(8.39562,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.829455,0.0747827,-7.52384e-05,4.72695e-08,-1.30209e-11,12647.2,28.8701], Tmin=(100,'K'), Tmax=(853.205,'K')), NASAPolynomial(coeffs=[7.59105,0.0430827,-1.95066e-05,3.72201e-09,-2.60751e-13,11493.4,-2.67716], Tmin=(853.205,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(104.242,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CJC(C)C=O) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]C(=O)C([CH2])C(1647)'],
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', 'C=C([O])[CH]CC(2408)'],
    products = ['[CH2]C(=O)C([CH2])CC(1766)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['O(4)', '[CH2]C([C]=C)CC(2492)'],
    products = ['[CH2]C(=O)C([CH2])CC(1766)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C(CC)C(=C)[O](2493)'],
    products = ['[CH2]C(=O)C([CH2])CC(1766)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][C](CC)C([CH2])[O](1768)'],
    products = ['[CH2]C(=O)C([CH2])CC(1766)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'C=C([O])C(=C)CC(2501)'],
    products = ['[CH2]C(=O)C([CH2])CC(1766)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C2H5(14)', 'C=CC(=C)[O](2319)'],
    products = ['[CH2]C(=O)C([CH2])CC(1766)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C2H5(14)', '[CH2][CH]C(=C)[O](2379)'],
    products = ['[CH2]C(=O)C([CH2])CC(1766)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH2][C](CC)C(=C)[O](2502)'],
    products = ['[CH2]C(=O)C([CH2])CC(1766)'],
...
reaction(
    label = 'reaction25',
    reactants = ['CH3(17)', '[CH2]C(=O)C([CH2])[CH2](1877)'],
    products = ['[CH2]C(=O)C([CH2])CC(1766)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH2]CC([CH2])C(=C)[O](2504)'],
    products = ['[CH2]C(=O)C([CH2])CC(1766)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]=C(O)C([CH2])CC(2508)'],
    products = ['[CH2]C(=O)C([CH2])CC(1766)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH2]CC([CH2])C(=C)O(2512)'],
    products = ['[CH2]C(=O)C([CH2])CC(1766)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CH2(T)(20)', '[CH2]C([C]=O)CC(2513)'],
    products = ['[CH2]C(=O)C([CH2])CC(1766)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]CC([CH2])[C]([CH2])O(2516)'],
    products = ['[CH2]C(=O)C([CH2])CC(1766)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]CC([CH2])C(C)=O(2520)'],
    products = ['[CH2]C(=O)C([CH2])CC(1766)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH2]C=C([CH2])OCC(2521)'],
    products = ['[CH2]C(=O)C([CH2])CC(1766)'],
