...
species(
    ...
    molecularWeight = (55.0984,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.51426,0.0283174,-6.67636e-06,-5.20558e-09,2.51176e-12,26686,15.3122], Tmin=(100,'K'), Tmax=(1187.42,'K')), NASAPolynomial(coeffs=[6.79989,0.0218732,-8.63234e-06,1.56127e-09,-1.06428e-13,25104.8,-8.47228], Tmin=(1187.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(221.406,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(274.378,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Cds_S)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.43754,'amu*angstrom^2'), symmetry=1, barrier=(10.0599,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.437429,'amu*angstrom^2'), symmetry=1, barrier=(10.0574,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (55.0984,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.52157,0.0259936,6.08977e-06,-2.23097e-08,9.36553e-12,27910.1,15.2845], Tmin=(100,'K'), Tmax=(1012.54,'K')), NASAPolynomial(coeffs=[7.74083,0.0203541,-7.74605e-06,1.41035e-09,-9.8441e-14,26085.3,-13.7521], Tmin=(1012.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(231.568,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), label="""buten1yl1""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.43375,'amu*angstrom^2'), symmetry=1, barrier=(9.97277,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.43144,'amu*angstrom^2'), symmetry=1, barrier=(9.91965,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (55.0984,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.61024,0.0278344,-8.17019e-06,-1.73562e-09,9.57965e-13,25148.1,14.6417], Tmin=(100,'K'), Tmax=(1477.84,'K')), NASAPolynomial(coeffs=[7.04131,0.0222766,-9.06108e-06,1.61291e-09,-1.0696e-13,23135.6,-10.844], Tmin=(1477.84,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(208.659,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), label="""buten22yl""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH2][CH]C=C(3743)'],
    products = ['m1_allyl(186)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['m1_allyl(186)'],
    products = ['CC1[CH]C1(3741)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'butadiene13(1350)'],
    products = ['m1_allyl(186)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(T)(20)', 'propen1yl(84)'],
    products = ['m1_allyl(186)'],
