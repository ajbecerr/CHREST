...
species(
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46209,0.0380078,-5.1225e-05,4.3661e-08,-1.39668e-11,17196.6,16.954], Tmin=(100,'K'), Tmax=(1007.41,'K')), NASAPolynomial(coeffs=[3.07286,0.0219674,-7.06872e-06,1.02435e-09,-5.68177e-14,17764.5,17.4319], Tmin=(1007.41,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(142.552,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Ethylene_oxide) + radical(CCOJ) + radical(C2CsJO)"""),
)

species(
    label = '[O][C]1COC1(29088)',
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.79905,0.0347503,-2.75231e-05,1.27744e-08,-2.24485e-12,16712.6,16.9687], Tmin=(100,'K'), Tmax=(1741.82,'K')), NASAPolynomial(coeffs=[6.72225,0.0143936,-2.1982e-06,9.82781e-11,2.69974e-15,16370.5,-5.57371], Tmin=(1741.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(138.199,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(Oxetane) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)
...
species(
    label = '[CH]=C(O)C[O](29089)',
    structure = SMILES('[CH]=C(O)C[O]'),
    E0 = (111.231,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,350,440,435,1725,3120,650,792.5,1650,348.779],'cm^-1')),
        HinderedRotor(inertia=(0.0875447,'amu*angstrom^2'), symmetry=1, barrier=(7.57923,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0867627,'amu*angstrom^2'), symmetry=1, barrier=(7.58188,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
...
species(
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.97503,0.00701379,6.36216e-05,-8.78482e-08,3.37562e-11,-20939.1,12.808], Tmin=(100,'K'), Tmax=(966.614,'K')), NASAPolynomial(coeffs=[11.4902,0.011132,-3.84136e-06,8.01669e-10,-6.56974e-14,-24423.9,-37.4942], Tmin=(966.614,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-174.521,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-O2d)OsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsCs) + ring(Cyclobutane)"""),
)

species(
    label = 'CC(=O)C=O(10937)',
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.5514,0.028106,-1.34056e-05,1.41161e-09,3.82888e-13,-34330.4,15.71], Tmin=(100,'K'), Tmax=(1438.68,'K')), NASAPolynomial(coeffs=[8.8675,0.0163466,-7.19373e-06,1.33595e-09,-9.10172e-14,-36748.2,-19.1454], Tmin=(1438.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-285.898,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)HHH) + group(Cds-O2d(Cds-O2d)Cs) + group(Cds-O2d(Cds-O2d)H)"""),
)

species(
    label = '[CH2][C]1COO1(16564)',
    ...
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.40903,0.0257272,-1.2088e-05,2.28104e-09,-1.52664e-13,41916.8,11.8187], Tmin=(100,'K'), Tmax=(2888.68,'K')), NASAPolynomial(coeffs=[24.4351,0.000357127,-8.58904e-07,1.38328e-10,-6.06604e-15,28206.7,-114.629], Tmin=(2888.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(348.452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(12dioxetane) + radical(C2CsJOO) + radical(CJCOOH)"""),
)

species(
    label = 'CC([O])=C[O](10939)',
    structure = SMILES('CC([O])=C[O]'),
    E0 = (-137.96,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05095,0.0318002,2.66627e-06,-3.70971e-08,1.99144e-11,-16512.2,16.99], Tmin=(100,'K'), Tmax=(909.873,'K')), NASAPolynomial(coeffs=[15.237,0.00330966,1.03773e-06,-2.96303e-10,1.927e-14,-20132,-52.0852], Tmin=(909.873,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-137.96,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + radical(C=C(C)OJ) + radical(C=COJ)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['C=C([O])C[O](3384)'],
    products = ['CH2O(3111)', 'ketene(1375)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['O(4)', '[CH2]C(=C)[O](2372)'],
    products = ['C=C([O])C[O](3384)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['CH2O(3111)', '[CH2][C]=O(1376)'],
    products = ['C=C([O])C[O](3384)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][O](3109)', 'ketene(1375)'],
    products = ['C=C([O])C[O](3384)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][O](3109)', '[CH2][C]=O(1376)'],
    products = ['C=C([O])C[O](3384)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH2(T)(20)', '[O]C[C]=O(2320)'],
    products = ['C=C([O])C[O](3384)'],
...
network(
    label = 'PDepNetwork #7626',
    isomers = [
        'C=C([O])C[O](3384)',
    ],
    reactants = [
        ('CH2O(3111)', 'ketene(1375)'),
        ('CH2O(3111)', '[CH2][C]=O(1376)'),
        ('H(3)', 'C=C([O])[CH][O](2850)'),
    ],
    bathGas = {
        'Ar': 0.333333,
