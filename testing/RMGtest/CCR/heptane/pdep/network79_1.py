species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.302765,'amu*angstrom^2'), symmetry=1, barrier=(6.96116,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0227456,'amu*angstrom^2'), symmetry=1, barrier=(14.0926,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (54.0904,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.60208,0.0246606,3.3674e-06,-1.88105e-08,8.13622e-12,52472.8,17.2859], Tmin=(100,'K'), Tmax=(1016.49,'K')), NASAPolynomial(coeffs=[7.86968,0.0177517,-6.8308e-06,1.25315e-09,-8.7909e-14,50687.9,-11.7253], Tmin=(1016.49,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(435.821,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJ) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (54.0904,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.6821,0.0169317,3.73668e-05,-6.26507e-08,2.59159e-11,11354.6,12.0323], Tmin=(100,'K'), Tmax=(940.94,'K')), NASAPolynomial(coeffs=[11.0822,0.0117738,-3.11428e-06,5.37779e-10,-4.10651e-14,8421.34,-35.1688], Tmin=(940.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(93.9212,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(228.648,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    E0 = (340.783,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,243.118,248.994,249.545],'cm^-1')),
        HinderedRotor(inertia=(1.14649,'amu*angstrom^2'), symmetry=1, barrier=(51.0352,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.23258,'amu*angstrom^2'), symmetry=1, barrier=(50.9836,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (54.0904,'amu'),
...
species(
    ...
    molecularWeight = (54.0904,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.48995,0.0289623,-1.21981e-05,-6.55943e-10,1.33191e-12,56395.3,16.3792], Tmin=(100,'K'), Tmax=(1178.44,'K')), NASAPolynomial(coeffs=[7.47761,0.018592,-7.3472e-06,1.32313e-09,-8.9971e-14,54764.3,-10.4348], Tmin=(1178.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(468.416,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH2][CH]C=C(311)',
    ...
    molecularWeight = (54.0904,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.65642,0.0189333,3.01004e-05,-5.20367e-08,2.11242e-11,32903.9,13.6623], Tmin=(100,'K'), Tmax=(961.821,'K')), NASAPolynomial(coeffs=[9.92836,0.0151091,-5.13574e-06,9.43602e-10,-6.92761e-14,30283,-27.4899], Tmin=(961.821,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(273.096,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Allyl_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC[CH2](300)'],
    products = ['C#C(229)', 'C=C(17)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(T)(15)', '[CH]C=C(192)'],
    products = ['[CH]=CC[CH2](300)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[CH](230)', '[CH2][CH2](18)'],
    products = ['[CH]=CC[CH2](300)'],
