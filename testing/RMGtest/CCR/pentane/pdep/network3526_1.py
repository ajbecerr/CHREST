...
species(
    label = 'C=[C]CC[CH]C(9375)',
    structure = SMILES('C=[C]CC[CH]C'),
    E0 = (368.206,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2950,3100,1380,975,1025,1650,1685,370,283.501,283.55,1802.8],'cm^-1')),
        HinderedRotor(inertia=(0.00209656,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00209605,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129408,'amu*angstrom^2'), symmetry=1, barrier=(7.38398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129428,'amu*angstrom^2'), symmetry=1, barrier=(7.38399,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.97806,0.0497516,-2.54689e-05,6.19661e-09,-6.16048e-13,44351.5,24.9956], Tmin=(100,'K'), Tmax=(2044.06,'K')), NASAPolynomial(coeffs=[9.87265,0.0343028,-1.41321e-05,2.49915e-09,-1.63829e-13,41124,-18.7354], Tmin=(2044.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(368.206,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(Cds_S)"""),
)
...
species(
    label = 'C=[C]CC[C]CC(15684)',
    structure = SMILES('C=[C]CC[C]CC'),
    E0 = (598.194,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.720051,0.071245,-5.1584e-05,1.99832e-08,-3.2736e-12,72064.6,28.9596], Tmin=(100,'K'), Tmax=(1382.34,'K')), NASAPolynomial(coeffs=[11.9138,0.0388536,-1.64348e-05,3.03132e-09,-2.07735e-13,68970,-28.6677], Tmin=(1382.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(598.194,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(Cds_S)"""),
)

species(
    label = 'C=C1CCC1CC(15673)',
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27767,0.0434043,3.75033e-05,-7.08253e-08,2.75987e-11,7386.68,23.5891], Tmin=(100,'K'), Tmax=(1011.39,'K')), NASAPolynomial(coeffs=[12.2521,0.0396219,-1.56496e-05,2.94508e-09,-2.10697e-13,3140.35,-39.4988], Tmin=(1011.39,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(60.4816,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane)"""),
)

species(
    label = 'C=CCC=CCC(15685)',
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.863904,0.0563695,-1.85052e-06,-3.0831e-08,1.38701e-11,3741.37,28.8014], Tmin=(100,'K'), Tmax=(1044.4,'K')), NASAPolynomial(coeffs=[12.7393,0.0382848,-1.52257e-05,2.82425e-09,-1.9843e-13,-233.376,-36.1598], Tmin=(1044.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(30.0787,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH)"""),
)
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3443.89,'J/mol'), sigma=(6.13739,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=537.93 K, Pc=33.8 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = '[CH]=[C]CCCCC(15692)',
    structure = SMILES('[CH]=[C]CCCCC'),
    E0 = (397.075,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2764.29,2778.57,2792.86,2807.14,2821.43,2835.71,2850,1425,1433.33,1441.67,1450,1225,1241.67,1258.33,1275,1270,1293.33,1316.67,1340,700,733.333,766.667,800,300,333.333,366.667,400,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.704789,0.0716595,-4.85694e-05,1.74342e-08,-2.65487e-12,47875.9,29.5099], Tmin=(100,'K'), Tmax=(1462.79,'K')), NASAPolynomial(coeffs=[11.8748,0.0411148,-1.72474e-05,3.15911e-09,-2.15132e-13,44608.1,-28.6271], Tmin=(1462.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(397.075,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C[CH]CCC=C(15693)',
    structure = SMILES('[CH2]C[CH]CCC=C'),
    E0 = (311.842,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.35363,0.0620346,-3.27394e-05,8.18725e-09,-8.29285e-13,37596.2,30.631], Tmin=(100,'K'), Tmax=(2078.86,'K')), NASAPolynomial(coeffs=[13.3957,0.0388641,-1.60208e-05,2.82578e-09,-1.84525e-13,32589.4,-36.2776], Tmin=(2078.86,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(311.842,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJ)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'C=[C]CC[CH]C(9375)'],
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]CC(26)', '[CH2]C[C]=C(2373)'],
    products = ['C=[C]CC[CH]CC(9526)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C2H5(14)', '[CH]CC[C]=C(15604)'],
    products = ['C=[C]CC[CH]CC(9526)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction8',
    reactants = ['H2CC(T)(1341)', '[CH2]C[CH]CC(101)'],
    products = ['C=[C]CC[CH]CC(9526)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'C=[C]CC[C]CC(15684)'],
    products = ['C=[C]CC[CH]CC(9526)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C=[C]CC=CCC(15686)'],
    products = ['C=[C]CC[CH]CC(9526)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'C=[C]CCC=CC(15532)'],
    products = ['C=[C]CC[CH]CC(9526)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C#CCC[CH]CC(15687)'],
    products = ['C=[C]CC[CH]CC(9526)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH3(17)', 'C=[C]CCC=C(15487)'],
    products = ['C=[C]CC[CH]CC(9526)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', 'C=[C]C[CH][CH]CC(15688)'],
    products = ['C=[C]CC[CH]CC(9526)'],
...
reaction(
    label = 'reaction23',
    reactants = ['CH3(17)', '[CH2][CH]CC[C]=C(15485)'],
    products = ['C=[C]CC[CH]CC(9526)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', 'C=[C]CC[CH][CH]C(15526)'],
    products = ['C=[C]CC[CH]CC(9526)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', 'C=[C][CH]C[CH]CC(15689)'],
    products = ['C=[C]CC[CH]CC(9526)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2]C[CH]CC[C]=C(15690)'],
    products = ['C=[C]CC[CH]CC(9526)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH]=[C]CC[CH]CC(15691)'],
    products = ['C=[C]CC[CH]CC(9526)'],
