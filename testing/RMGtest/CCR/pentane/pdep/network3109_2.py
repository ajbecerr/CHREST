...
species(
    label = '[CH]1C=C1(15019)',
    structure = SMILES('[CH]1C=C1'),
    E0 = (434.26,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.94563,-0.0154806,9.80916e-05,-1.20724e-07,4.66637e-11,52246.9,4.80966], Tmin=(100,'K'), Tmax=(917.285,'K')), NASAPolynomial(coeffs=[10.2693,-0.000174009,2.93771e-06,-6.03145e-10,3.55113e-14,49282.7,-34.9861], Tmin=(917.285,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(434.26,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(cyclopropenyl-allyl)"""),
)

species(
    label = '[CH]C1C=C1(15020)',
    structure = SMILES('[CH]C1C=C1'),
    E0 = (689.297,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (52.0746,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.65014,0.0242688,-4.40184e-06,-1.21415e-08,6.57114e-12,82956.7,11.4968], Tmin=(100,'K'), Tmax=(979.374,'K')), NASAPolynomial(coeffs=[8.82473,0.0115773,-4.14987e-06,7.47184e-10,-5.26874e-14,81146.4,-21.2305], Tmin=(979.374,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(689.297,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH2][C]1[CH]C1(15021)',
    structure = SMILES('[CH2][C]1[CH]C1'),
    E0 = (625.669,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2950,3150,900,1000,1100,3000,3100,440,815,1455,1000,180,1619.14,1619.16,1619.18,1619.19,1619.19,1619.19,1619.21],'cm^-1')),
        HinderedRotor(inertia=(0.274718,'amu*angstrom^2'), symmetry=1, barrier=(6.31631,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (53.0825,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.2777,0.0136672,9.65394e-06,-1.3412e-08,4.09486e-12,75278.3,17.4301], Tmin=(100,'K'), Tmax=(1159.13,'K')), NASAPolynomial(coeffs=[2.83149,0.0213504,-8.23856e-06,1.4511e-09,-9.69613e-14,74969,17.8684], Tmin=(1159.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(625.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Tertalkyl) + radical(cyclopropane) + radical(Isobutyl)"""),
)

species(
    label = '[CH]1C2CC12(15022)',
    structure = SMILES('[CH]1C2CC12'),
    E0 = (400.984,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (53.0825,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.58502,-0.00255147,6.99072e-05,-8.20514e-08,2.90761e-11,48252.5,10.6084], Tmin=(100,'K'), Tmax=(983.704,'K')), NASAPolynomial(coeffs=[6.17683,0.0173165,-6.75453e-06,1.32587e-09,-9.93482e-14,46271.4,-9.33092], Tmin=(983.704,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(400.984,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + polycyclic(s2_3_3_ane) + radical(bicyclo[1.1.0]butane-secondary)"""),
)

species(
    label = 'C=C1C=C1(15023)',
    structure = SMILES('C=C1C=C1'),
    E0 = (407.698,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2950,3100,1380,975,1025,1650,638.838,638.838,638.846,638.848,638.848,638.849,638.854,2653.64],'cm^-1')),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (52.0746,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.01188,0.0113092,3.54074e-05,-5.5937e-08,2.27996e-11,49079.8,9.46167], Tmin=(100,'K'), Tmax=(942.595,'K')), NASAPolynomial(coeffs=[9.91462,0.00845949,-2.13732e-06,3.78782e-10,-3.02381e-14,46603.8,-29.6632], Tmin=(942.595,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(407.698,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cds-Cds(Cds-Cds)(Cds-Cds)) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + ring(methylenecyclopropene)"""),
)

species(
    label = '[CH2][C]1C=C1(15024)',
    structure = SMILES('C=C1[CH][CH]1'),
    E0 = (469.17,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2950,3100,1380,975,1025,1650,834.534,835.641,835.67,835.841,836.529,836.804,837.618,837.716],'cm^-1')),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (52.0746,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.45246,-0.00309477,7.85805e-05,-9.98689e-08,3.79449e-11,56461.6,7.23527], Tmin=(100,'K'), Tmax=(945.283,'K')), NASAPolynomial(coeffs=[9.71548,0.00911084,-2.21031e-06,4.27974e-10,-3.72953e-14,53548.2,-31.7752], Tmin=(945.283,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(469.17,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(182.918,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Methylene_cyclopropane) + radical(Allyl_S) + radical(Allyl_S)"""),
)

species(
    label = '[CH2]C1[C]=C1(15025)',
    structure = SMILES('[CH2]C1[C]=C1'),
    E0 = (674.382,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,3000,3100,440,815,1455,1000,213.693,214.644,215.301,215.525,1438.83,1438.85,1438.9],'cm^-1')),
        HinderedRotor(inertia=(0.00235506,'amu*angstrom^2'), symmetry=1, barrier=(3.46029,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (52.0746,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.73119,0.0269508,-2.00886e-05,6.94974e-09,-1.94879e-13,81156.1,12.4593], Tmin=(100,'K'), Tmax=(863.084,'K')), NASAPolynomial(coeffs=[6.45477,0.0139152,-4.77007e-06,7.84456e-10,-5.05734e-14,80356.1,-5.86745], Tmin=(863.084,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(674.382,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(178.761,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Isobutyl) + radical(cyclopropenyl-vinyl)"""),
)

species(
    label = 'C[C]1C=C1(15026)',
    structure = SMILES('C[C]1C=C1'),
    E0 = (373.062,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (53.0825,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.97949,0.0158213,2.05924e-05,-3.46657e-08,1.36747e-11,44911.7,7.56403], Tmin=(100,'K'), Tmax=(967.137,'K')), NASAPolynomial(coeffs=[6.7591,0.0165336,-5.86221e-06,1.0441e-09,-7.30099e-14,43416.2,-14.4959], Tmin=(967.137,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(373.062,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(203.705,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)(Cds-Cds)CsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(Allyl_T)"""),
)

species(
    label = 'CC1[C]=C1(15027)',
    structure = SMILES('CC1[C]=C1'),
    E0 = (469.3,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,3150,900,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,180,180,180,903.622,904.667,905.192,2816.6],'cm^-1')),
        HinderedRotor(inertia=(0.134961,'amu*angstrom^2'), symmetry=1, barrier=(3.10303,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (53.0825,'amu'),
...
reaction(
    label = 'reaction13',
    reactants = ['CH2(T)(20)', '[CH]1C=C1(15019)'],
    products = ['[CH2]C1C=C1(13643)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(4.02491e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H/TwoDe;Birad]
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH2][C]1C=C1(15024)'],
    products = ['[CH2]C1C=C1(13643)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH2]C1[C]=C1(15025)'],
    products = ['[CH2]C1C=C1(13643)'],
