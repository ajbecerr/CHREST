...
species(
    label = '[CH]=[C]O[CH]CCO[O](10611)',
    structure = SMILES('[CH]=[C]O[CH]CCO[O]'),
    E0 = (535.163,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.4061,0.0994079,-0.000139703,9.85523e-08,-2.70406e-11,64521.6,33.9788], Tmin=(100,'K'), Tmax=(900.019,'K')), NASAPolynomial(coeffs=[17.2617,0.0208811,-8.81959e-06,1.59793e-09,-1.07742e-13,61341.6,-49.3961], Tmin=(900.019,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(535.163,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCsJOC(O)) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]OC([CH2])C[O](10612)',
    structure = SMILES('[CH]=[C]OC([CH2])C[O]'),
    E0 = (541.298,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,301.105,302.483,303.761,3470.78],'cm^-1')),
        HinderedRotor(inertia=(0.220692,'amu*angstrom^2'), symmetry=1, barrier=(14.2976,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.220643,'amu*angstrom^2'), symmetry=1, barrier=(14.315,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.563635,'amu*angstrom^2'), symmetry=1, barrier=(36.5631,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.2211,'amu*angstrom^2'), symmetry=1, barrier=(14.3035,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.340922,0.0850195,-0.000123764,9.61916e-08,-2.96765e-11,65230.6,30.5686], Tmin=(100,'K'), Tmax=(812.271,'K')), NASAPolynomial(coeffs=[12.1861,0.0254442,-1.14505e-05,2.12533e-09,-1.44525e-13,63347.3,-23.8621], Tmin=(812.271,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(541.298,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CJC(C)OC) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]O[CH]CO[O](10613)',
    structure = SMILES('[CH]=[C]O[CH]CO[O]'),
    E0 = (558.943,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,1685,370,3120,650,792.5,1650,202.936,202.939,202.944],'cm^-1')),
        HinderedRotor(inertia=(0.504948,'amu*angstrom^2'), symmetry=1, barrier=(14.757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.504962,'amu*angstrom^2'), symmetry=1, barrier=(14.757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.504945,'amu*angstrom^2'), symmetry=1, barrier=(14.757,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.504943,'amu*angstrom^2'), symmetry=1, barrier=(14.757,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (100.073,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.215608,0.0849553,-0.000127165,9.2348e-08,-2.57447e-11,67360,29.4989], Tmin=(100,'K'), Tmax=(890.309,'K')), NASAPolynomial(coeffs=[16.3587,0.0124305,-4.97994e-06,8.59051e-10,-5.5526e-14,64485.4,-46.5071], Tmin=(890.309,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(558.943,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCsJOC(O)) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]C(CO[O])O[C]=[CH](10614)',
    structure = SMILES('[CH]C(CO[O])O[C]=[CH]'),
    E0 = (776.808,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,1685,370,3120,650,792.5,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0857483,0.0908041,-0.00012115,8.06459e-08,-2.08712e-11,93574.7,34.0138], Tmin=(100,'K'), Tmax=(953.245,'K')), NASAPolynomial(coeffs=[17.066,0.0188316,-7.89534e-06,1.43869e-09,-9.80048e-14,90304.8,-47.9119], Tmin=(953.245,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(776.808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJ2_triplet) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[C]=[C]OC([CH2])CO[O](10615)',
    structure = SMILES('[C]=[C]OC([CH2])CO[O]'),
    E0 = (850.108,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.458022,0.104733,-0.000170793,1.38961e-07,-4.35008e-11,102399,34.0684], Tmin=(100,'K'), Tmax=(875.758,'K')), NASAPolynomial(coeffs=[15.0874,0.0223446,-1.01782e-05,1.84942e-09,-1.22185e-13,100112,-36.3744], Tmin=(875.758,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(850.108,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CJC(C)OC) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)
...
species(
    label = '[CH]=[C]OC1COOC1(10617)',
    structure = SMILES('[CH]=[C]OC1COOC1'),
    E0 = (261.014,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.662288,0.0563739,2.64505e-06,-6.36798e-08,3.56795e-11,31529.1,27], Tmin=(100,'K'), Tmax=(880.918,'K')), NASAPolynomial(coeffs=[22.0006,0.00805698,2.20663e-06,-7.53537e-10,5.73309e-14,25884.9,-83.9372], Tmin=(880.918,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(261.014,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(12dioxolane) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C1OOCC([CH2])O1(10618)',
    structure = SMILES('[CH]=C1OOCC([CH2])O1'),
    E0 = (267.951,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.19813,0.0698583,-4.40236e-05,3.22513e-09,3.8148e-12,32375.6,23.1703], Tmin=(100,'K'), Tmax=(1122.59,'K')), NASAPolynomial(coeffs=[20.6857,0.020727,-1.02695e-05,2.12103e-09,-1.57543e-13,26271.7,-84.7383], Tmin=(1122.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(267.951,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclohexanone) + radical(CJC(C)OC) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]OC1COC1(10619)',
    structure = SMILES('[CH]=[C]OC1COC1'),
    E0 = (289.115,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24774,0.0466275,7.85142e-06,-5.94495e-08,3.24401e-11,34884.9,23.4204], Tmin=(100,'K'), Tmax=(869.475,'K')), NASAPolynomial(coeffs=[18.0955,0.00978868,1.24411e-06,-5.87762e-10,4.78335e-14,30417.9,-64.3439], Tmin=(869.475,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(289.115,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(299.321,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=C1OCC([CH2])O1(10620)',
    structure = SMILES('[CH]=C1OCC([CH2])O1'),
    E0 = (183.647,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.821288,0.0497948,1.2654e-05,-6.93692e-08,3.51404e-11,22220.7,20.6717], Tmin=(100,'K'), Tmax=(924.632,'K')), NASAPolynomial(coeffs=[23.2668,0.00473492,1.33012e-06,-3.34818e-10,1.71939e-14,15845.4,-97.8854], Tmin=(924.632,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(183.647,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclopentane) + radical(CJC(C)OC) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]OC(=C)COO(10622)',
    structure = SMILES('C#CO[C]([CH2])COO'),
    E0 = (290.288,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.972622,0.116282,-0.000187916,1.51501e-07,-4.72714e-11,35086.1,29.7463], Tmin=(100,'K'), Tmax=(853.783,'K')), NASAPolynomial(coeffs=[16.8689,0.0242593,-1.14251e-05,2.11983e-09,-1.42388e-13,32346.9,-51.7082], Tmin=(853.783,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(290.288,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Ct-CtOs) + group(Ct-CtH) + radical(C2CsJOCs) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH]=[C]O[C]([CH2])CO[O](10624)',
    structure = SMILES('[CH]=[C]O[C]([CH2])CO[O]'),
    E0 = (739.318,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (113.091,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.596053,0.11039,-0.000191157,1.61968e-07,-5.21062e-11,89076.1,36.0863], Tmin=(100,'K'), Tmax=(887.698,'K')), NASAPolynomial(coeffs=[14.4997,0.0230144,-1.08111e-05,1.96725e-09,-1.28936e-13,87158.6,-30.649], Tmin=(887.698,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(739.318,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(C2CsJOC(O)) + radical(CJC(C)OC) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.00491412,0.0944428,-0.000134553,9.66869e-08,-2.59289e-11,63739.3,33.5411], Tmin=(100,'K'), Tmax=(698.932,'K')), NASAPolynomial(coeffs=[13.7793,0.0264774,-1.21306e-05,2.27407e-09,-1.55756e-13,61545.7,-29.9308], Tmin=(698.932,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(528.808,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(C2CsJOC(O)) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]OC([CH2])[CH]OO(10628)',
    structure = SMILES('[CH]=[C]OC([CH2])[CH]OO'),
    E0 = (575.68,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.663443,0.107023,-0.000157734,1.16807e-07,-3.37337e-11,69402.2,34.228], Tmin=(100,'K'), Tmax=(854.533,'K')), NASAPolynomial(coeffs=[17.2524,0.0231595,-1.05233e-05,1.95899e-09,-1.33573e-13,66340.3,-49.389], Tmin=(854.533,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(575.68,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCsJOOH) + radical(CJC(C)OC) + radical(C=CJO) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]OC(C)[CH]O[O](10629)',
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0137277,0.0899367,-0.000116355,7.79596e-08,-2.06111e-11,62343.4,32.8047], Tmin=(100,'K'), Tmax=(927.978,'K')), NASAPolynomial(coeffs=[15.1973,0.0244871,-1.05589e-05,1.95248e-09,-1.34027e-13,59525.5,-39.3117], Tmin=(927.978,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(517.175,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCsJOOH) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=[C]O[C]([CH2])COO(10631)',
    structure = SMILES('[CH]=[C]O[C]([CH2])COO'),
    E0 = (587.313,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (114.099,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.836809,0.113695,-0.000185412,1.51312e-07,-4.78062e-11,70804.7,36.1925], Tmin=(100,'K'), Tmax=(850.282,'K')), NASAPolynomial(coeffs=[16.0922,0.0246693,-1.17996e-05,2.20746e-09,-1.49026e-13,68265.2,-40.7389], Tmin=(850.282,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(587.313,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(307.635,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C2CsJOC(O)) + radical(CJC(C)OC) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=[C]OC([CH2])CO[O](2937)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]=[C]OC([CH2])CO[O](2937)'],
    products = ['[CH]=[C]O[CH]CCO[O](10611)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=[CH](9646)', '[CH2]C([O])CO[O](1369)'],
    products = ['[CH]=[C]OC([CH2])CO[O](2937)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['O(4)', '[CH]=[C]OC([CH2])C[O](10612)'],
    products = ['[CH]=[C]OC([CH2])CO[O](2937)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', '[CH]=[C]O[CH]CO[O](10613)'],
    products = ['[CH]=[C]OC([CH2])CO[O](2937)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]C(CO[O])O[C]=[CH](10614)'],
    products = ['[CH]=[C]OC([CH2])CO[O](2937)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[C]=[C]OC([CH2])CO[O](10615)'],
    products = ['[CH]=[C]OC([CH2])CO[O](2937)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]=[C]OC([CH2])CO[O](2937)'],
    products = ['[CH]=C1OOCC([CH2])O1(10618)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH]=[C]OC([CH2])CO[O](2937)'],
    products = ['O(4)', '[CH]=[C]OC1COC1(10619)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=[C]OC([CH2])CO[O](2937)'],
    products = ['O(4)', '[CH]=C1OCC([CH2])O1(10620)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=[C]OC([CH2])CO[O](2937)'],
    products = ['HO2(9)', '[CH]=[C]OC([CH2])=C(9841)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH]=[C]OC(=C)CO[O](10623)'],
    products = ['[CH]=[C]OC([CH2])CO[O](2937)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O2(2)', '[CH]=[C]OC([CH2])[CH2](2590)'],
    products = ['[CH]=[C]OC([CH2])CO[O](2937)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH]=[C]O[C]([CH2])CO[O](10624)'],
    products = ['[CH]=[C]OC([CH2])CO[O](2937)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH]=[C]OC([CH2])[CH]O[O](10625)'],
    products = ['[CH]=[C]OC([CH2])CO[O](2937)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]=[C]OC([CH2])CO[O](2937)'],
    products = ['[CH]=[C]O[C](C)CO[O](10626)'],
...
reaction(
    label = 'reaction25',
    reactants = ['[CH]=[C]OC([CH2])CO[O](2937)'],
    products = ['[CH]=CO[C]([CH2])CO[O](10627)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH]=[C]OC([CH2])CO[O](2937)'],
    products = ['[CH]=[C]OC([CH2])[CH]OO(10628)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH]=[C]OC([CH2])CO[O](2937)'],
    products = ['[CH]=[C]OC(C)[CH]O[O](10629)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH]=[C]OC([CH2])CO[O](2937)'],
    products = ['[CH2][C](CO[O])O[C]=C(2935)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]=[C]OC([CH2])CO[O](2937)'],
    products = ['[CH]=COC([CH2])[CH]O[O](10630)'],
    transitionState = 'TS29',
    kinetics = Arrhenius(A=(7.69727e+08,'s^-1'), n=0.955, Ea=(109.663,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R4H_SSS_OCs;Y_rad_out;Cs_H_out_H/NonDeO] for rate rule [R4H_SSS_OCs;Cd_rad_out;Cs_H_out_H/NonDeO]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: intra_H_migration"""),
)
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]=[C]O[C]([CH2])COO(10631)'],
    products = ['[CH]=[C]OC([CH2])CO[O](2937)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH]=[C]OC([CH2])CO[O](2937)'],
    products = ['[CH2]C([CH]O[O])O[C]=C(2936)'],
