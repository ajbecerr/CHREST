species(
    ...
    E0 = (317.37,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
...
species(
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(3421.52,'J/mol'), sigma=(6.24924,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=534.43 K, Pc=31.81 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    label = '[CH2]C(C)[CH]C1CC1(6264)',
    structure = SMILES('[CH2]C(C)[CH]C1CC1'),
    E0 = (331.84,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,804.188,804.188,804.188,804.188,804.188,804.188,804.188,804.188,804.188,916.988,3158.42,3158.42],'cm^-1')),
        HinderedRotor(inertia=(0.0138653,'amu*angstrom^2'), symmetry=1, barrier=(2.00181,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0138653,'amu*angstrom^2'), symmetry=1, barrier=(2.00181,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0138653,'amu*angstrom^2'), symmetry=1, barrier=(2.00181,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0138653,'amu*angstrom^2'), symmetry=1, barrier=(2.00181,'kJ/mol'), semiclassical=False),
    ],
...
species(
    label = 'CC[CH]C1[CH]CC1(6265)',
    structure = SMILES('CC[CH]C1[CH]CC1'),
    E0 = (315.871,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48447,0.0413612,3.29538e-05,-5.90136e-08,2.16804e-11,38093,29.5636], Tmin=(100,'K'), Tmax=(1056.6,'K')), NASAPolynomial(coeffs=[9.79172,0.0436367,-1.81534e-05,3.44067e-09,-2.44179e-13,34455,-19.8798], Tmin=(1056.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(315.871,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Cs_S) + radical(cyclobutane)"""),
)
...
species(
    label = '[CH2]C(C)C1[C]CC1(6266)',
    structure = SMILES('[CH2]C(C)C1[C]CC1'),
    E0 = (577.747,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,2950,3050,3150,900,950,1000,1050,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1665,0.0436056,4.23259e-05,-8.52014e-08,3.57121e-11,69605.8,27.2024], Tmin=(100,'K'), Tmax=(958.684,'K')), NASAPolynomial(coeffs=[15.2878,0.0310002,-1.04162e-05,1.86749e-09,-1.34217e-13,64769.9,-51.4292], Tmin=(958.684,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(577.747,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)
...
species(
    label = 'CC1CC2CCC12(6268)',
    structure = SMILES('CC1CC2CCC12'),
    E0 = (94.5263,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84815,0.0243527,9.50165e-05,-1.30947e-07,4.87897e-11,11466.8,18.908], Tmin=(100,'K'), Tmax=(986.378,'K')), NASAPolynomial(coeffs=[12.5931,0.0386972,-1.48736e-05,2.8531e-09,-2.09948e-13,6529.55,-47.0649], Tmin=(986.378,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(94.5263,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + polycyclic(s2_4_4_ane)"""),
)

species(
    label = 'CC(C)C1=CCC1(6269)',
    structure = SMILES('CC(C)C1=CCC1'),
    E0 = (51.0149,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.21188,0.041109,5.32416e-05,-9.50388e-08,3.83066e-11,6254.17,24.2829], Tmin=(100,'K'), Tmax=(973.667,'K')), NASAPolynomial(coeffs=[15.1339,0.033724,-1.21155e-05,2.25071e-09,-1.63775e-13,1182.08,-54.6354], Tmin=(973.667,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(51.0149,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)

species(
    label = 'C=C(C)C1CCC1(6270)',
    structure = SMILES('C=C(C)C1CCC1'),
    E0 = (47.0679,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33949,0.0380397,6.04786e-05,-1.00277e-07,3.94645e-11,5775.02,24.1959], Tmin=(100,'K'), Tmax=(979.954,'K')), NASAPolynomial(coeffs=[14.331,0.0355754,-1.3148e-05,2.46654e-09,-1.79613e-13,800.896,-50.6055], Tmin=(979.954,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(47.0679,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(448.981,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane)"""),
)

species(
    label = 'CC(C)C1C=CC1(6186)',
    structure = SMILES('CC(C)C1C=CC1'),
    E0 = (56.1134,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.31598,0.0375809,6.39107e-05,-1.06433e-07,4.24258e-11,6864.79,23.756], Tmin=(100,'K'), Tmax=(969.917,'K')), NASAPolynomial(coeffs=[15.2671,0.0332871,-1.17877e-05,2.19304e-09,-1.60597e-13,1654.2,-56.0336], Tmin=(969.917,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(56.1134,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)
...
species(
    label = '[CH2]CC=CC([CH2])C(6271)',
    structure = SMILES('[CH2]CC=CC([CH2])C'),
    E0 = (303.384,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,958.271,3423.65],'cm^-1')),
        HinderedRotor(inertia=(0.735225,'amu*angstrom^2'), symmetry=1, barrier=(16.9043,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244253,'amu*angstrom^2'), symmetry=1, barrier=(5.61585,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.244306,'amu*angstrom^2'), symmetry=1, barrier=(5.61707,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.735231,'amu*angstrom^2'), symmetry=1, barrier=(16.9044,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.12834,'amu*angstrom^2'), symmetry=1, barrier=(83.6038,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.648648,0.0636258,-2.25587e-05,-1.11136e-08,7.7775e-12,36618,32.3934], Tmin=(100,'K'), Tmax=(1029.07,'K')), NASAPolynomial(coeffs=[12.5408,0.0376205,-1.41254e-05,2.51646e-09,-1.72271e-13,33099.8,-30.5221], Tmin=(1029.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.384,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C(C)C1=CCC1(6272)',
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.23792,0.042703,4.10507e-05,-8.29557e-08,3.48915e-11,30917.2,26.664], Tmin=(100,'K'), Tmax=(955.313,'K')), NASAPolynomial(coeffs=[14.8587,0.0304604,-1.00525e-05,1.78397e-09,-1.27632e-13,26271,-49.1227], Tmin=(955.313,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.097,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene) + radical(Isobutyl)"""),
)

species(
    label = 'C=C(C)C1[CH]CC1(6273)',
    structure = SMILES('C=C(C)C1[CH]CC1'),
    E0 = (234.906,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50125,0.0386414,4.22674e-05,-7.41388e-08,2.8663e-11,28357,25.9639], Tmin=(100,'K'), Tmax=(1005.58,'K')), NASAPolynomial(coeffs=[11.8488,0.037117,-1.45834e-05,2.74923e-09,-1.97388e-13,24271.9,-33.9793], Tmin=(1005.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.906,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(Cyclobutane) + radical(cyclobutane)"""),
)
...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39266,0.0493043,-5.0818e-06,-1.55128e-08,6.28457e-12,60572.4,30.6704], Tmin=(100,'K'), Tmax=(1168.38,'K')), NASAPolynomial(coeffs=[8.02427,0.0426368,-1.71095e-05,3.09725e-09,-2.10985e-13,57928.2,-7.03936], Tmin=(1168.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(502.793,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(cyclobutane) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2][C](C)C1[CH]CC1(6275)',
    structure = SMILES('[CH2][C](C)C1[CH]CC1'),
    E0 = (502.793,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3100,440,815,1455,1000,314.944,825.473,825.473,825.473,825.473,825.473,825.473,825.473,1685.02,1685.02,1685.02,1685.02,1685.02,1685.02,1685.02],'cm^-1')),
        HinderedRotor(inertia=(0.138115,'amu*angstrom^2'), symmetry=1, barrier=(3.4998,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138115,'amu*angstrom^2'), symmetry=1, barrier=(3.4998,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.138115,'amu*angstrom^2'), symmetry=1, barrier=(3.4998,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39266,0.0493043,-5.0818e-06,-1.55128e-08,6.28457e-12,60572.4,29.9772], Tmin=(100,'K'), Tmax=(1168.38,'K')), NASAPolynomial(coeffs=[8.02427,0.0426368,-1.71095e-05,3.09725e-09,-2.10985e-13,57928.2,-7.7325], Tmin=(1168.38,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(502.793,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(cyclobutane) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)C1[CH]C[CH]1(6276)',
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52738,0.0419383,2.47392e-05,-5.16702e-08,2.00639e-11,60862.4,30.6983], Tmin=(100,'K'), Tmax=(1020.45,'K')), NASAPolynomial(coeffs=[9.49723,0.0400416,-1.56062e-05,2.86681e-09,-2.00681e-13,57708,-15.399], Tmin=(1020.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(505.208,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(cyclobutane) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(C)C1[CH][CH]C1(6277)',
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40274,0.0472542,8.85923e-06,-3.01171e-08,1.08985e-11,35907.8,27.4685], Tmin=(100,'K'), Tmax=(1144.75,'K')), NASAPolynomial(coeffs=[8.29373,0.0459155,-1.91835e-05,3.56694e-09,-2.47397e-13,32840.2,-13.216], Tmin=(1144.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(297.71,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(cyclobutane)"""),
)

species(
    label = '[CH2]C(C)C1C[CH]C1(6280)',
...
species(
    label = 'CC(C)[C]1[CH]CC1(6282)',
    structure = SMILES('CC(C)[C]1[CH]CC1'),
    E0 = (297.71,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.40274,0.0472542,8.85923e-06,-3.01171e-08,1.08985e-11,35907.8,28.1616], Tmin=(100,'K'), Tmax=(1144.75,'K')), NASAPolynomial(coeffs=[8.29373,0.0459155,-1.91835e-05,3.56694e-09,-2.47397e-13,32840.2,-12.5228], Tmin=(1144.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(297.71,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(cyclobutane)"""),
)

species(
    label = 'CC(C)C1[CH]C[CH]1(6283)',
    structure = SMILES('CC(C)C1[CH]C[CH]1'),
    E0 = (300.126,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50983,0.0402124,3.75556e-05,-6.48317e-08,2.40695e-11,36199,28.2887], Tmin=(100,'K'), Tmax=(1037.53,'K')), NASAPolynomial(coeffs=[9.89672,0.0431069,-1.75602e-05,3.3087e-09,-2.34818e-13,32562.5,-21.6198], Tmin=(1037.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(300.126,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(cyclobutane)"""),
)

species(
    label = '[CH2]C([CH2])C1CCC1(6284)',
    structure = SMILES('[CH2]C([CH2])C1CCC1'),
    E0 = (334.614,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2816.67,2883.33,2950,3016.67,3083.33,3150,900,933.333,966.667,1000,1033.33,1066.67,1100,1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,180,1102.8,1102.8,1102.8,1102.8,1102.8,1102.8,1102.8,1102.8,1102.8,1102.8,1102.8,1102.8,1102.8,1102.8,2232.96],'cm^-1')),
        HinderedRotor(inertia=(0.0719665,'amu*angstrom^2'), symmetry=1, barrier=(1.65465,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0719665,'amu*angstrom^2'), symmetry=1, barrier=(1.65465,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0719665,'amu*angstrom^2'), symmetry=1, barrier=(1.65465,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24134,0.0421764,4.95958e-05,-9.28245e-08,3.87378e-11,40360.9,28.1171], Tmin=(100,'K'), Tmax=(944.013,'K')), NASAPolynomial(coeffs=[14.2108,0.0336576,-1.06528e-05,1.83038e-09,-1.28649e-13,35843.2,-44.6649], Tmin=(944.013,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(334.614,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(444.824,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = 'CC(C)C1[CH][CH]C1(6285)',
    structure = SMILES('CC(C)C1[CH][CH]C1'),
    E0 = (300.126,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C)C1[CH]CC1(4986)'],
    products = ['C3H6(27)', 'C1=CCC1(4846)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH2]CC1[CH]CC1(4945)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(C)[CH]C1CC1(6264)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(C)C1CC1[CH2](4988)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(6.55606e+10,'s^-1'), n=0.64, Ea=(159.935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [cCs(-HC)CJ;CsJ;C] for rate rule [cCs(-HC)CJ;CsJ-HH;C]
Euclidian distance = 1.0
...
reaction(
    label = 'reaction7',
    reactants = ['CH2(T)(20)', 'C[CH]C1[CH]CC1(6260)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['H(3)', '[CH2]C(C)C1[C]CC1(6266)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH]C(C)C1[CH]CC1(6267)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CC=CC([CH2])C(6271)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH2]C(C)C1=CCC1(6272)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C=C(C)C1[CH]CC1(6273)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2]C(C)C1C=CC1(6199)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C3H6(T)(28)', 'C1=CCC1(4846)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
...
reaction(
    label = 'reaction20',
    reactants = ['C3H6(27)', '[CH]1[CH]CC1(6173)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH3(17)', 'C=CC1[CH]CC1(6206)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C3H6(T)(28)', '[CH]1[CH]CC1(6173)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH2]C(C)[C]1[CH]CC1(6274)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH3(17)', '[CH2][CH]C1[CH]CC1(6257)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2][C](C)C1[CH]CC1(6275)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2]C(C)C1[CH]C[CH]1(6276)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH2]C(C)C1[CH][CH]C1(6277)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH2]C([CH2])C1[CH]CC1(5206)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH2]C(C)C1C[CH]C1(6280)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH2]C(C)C1[CH]CC1(4986)'],
    products = ['CC(C)C1[CH]C[CH]1(6283)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2]C([CH2])C1CCC1(6284)'],
    products = ['[CH2]C(C)C1[CH]CC1(4986)'],
    transitionState = 'TS35',
    kinetics = Arrhenius(A=(3.016e+06,'s^-1'), n=1.63, Ea=(74.8936,'kJ/mol'), T0=(1,'K'), comment="""From training reaction 110 used for R4H_SSS;C_rad_out_2H;Cs_H_out_H/(NonDeC/Cs)
...
reaction(
    label = 'reaction36',
    reactants = ['[CH2]C(C)C1[CH]CC1(4986)'],
    products = ['CC(C)C1[CH][CH]C1(6285)'],
...
network(
    ...
    isomers = [
        '[CH2]C(C)C1[CH]CC1(4986)',
    ],
    reactants = [
        ('C3H6(27)', 'C1=CCC1(4846)'),
    ],
    bathGas = {
        'Ar': 0.333333,
        'Ne': 0.333333,
