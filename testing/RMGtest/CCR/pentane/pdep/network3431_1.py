...
species(
    label = '[CH]=C[CH]CO[O](13650)',
    structure = SMILES('[CH]C=CCO[O]'),
    E0 = (411.156,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,2995,3025,975,1000,1300,1375,400,500,1630,1680,375.864,383.483,384.504,385.134],'cm^-1')),
        HinderedRotor(inertia=(0.520133,'amu*angstrom^2'), symmetry=1, barrier=(53.6152,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.522978,'amu*angstrom^2'), symmetry=1, barrier=(53.5398,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.505823,'amu*angstrom^2'), symmetry=1, barrier=(53.3169,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92415,0.0488809,-4.24969e-05,2.5108e-08,-7.00997e-12,49522.6,22.8192], Tmin=(100,'K'), Tmax=(815.771,'K')), NASAPolynomial(coeffs=[4.93932,0.0340962,-1.53108e-05,2.89036e-09,-2.01044e-13,49030.7,8.8868], Tmin=(815.771,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(411.156,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(ROOJ) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C(C=[CH])CO[O](15241)',
    structure = SMILES('[CH]C(C=[CH])CO[O]'),
    E0 = (710.72,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180.033,599.146,2505.05,2505.27],'cm^-1')),
        HinderedRotor(inertia=(0.591745,'amu*angstrom^2'), symmetry=1, barrier=(13.6063,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.591742,'amu*angstrom^2'), symmetry=1, barrier=(13.6063,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0533987,'amu*angstrom^2'), symmetry=1, barrier=(13.6068,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.77363,'amu*angstrom^2'), symmetry=1, barrier=(72.3244,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.95477,0.0694243,-7.96091e-05,5.01968e-08,-1.28816e-11,85587.4,28.648], Tmin=(100,'K'), Tmax=(942.609,'K')), NASAPolynomial(coeffs=[11.0029,0.026784,-1.17537e-05,2.205e-09,-1.53e-13,83693.1,-19.2346], Tmin=(942.609,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(710.72,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[C]=CC([CH2])CO[O](15242)',
    structure = SMILES('[C]=CC([CH2])CO[O]'),
    E0 = (778.593,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.102747,'amu*angstrom^2'), symmetry=1, barrier=(2.36236,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.106577,'amu*angstrom^2'), symmetry=1, barrier=(2.45042,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.105749,'amu*angstrom^2'), symmetry=1, barrier=(2.43138,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.591345,'amu*angstrom^2'), symmetry=1, barrier=(13.5962,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (98.0999,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.874111,0.0732348,-0.000101773,8.10146e-08,-2.58225e-11,93751.3,29.6823], Tmin=(100,'K'), Tmax=(857.526,'K')), NASAPolynomial(coeffs=[8.90224,0.0289599,-1.23848e-05,2.23733e-09,-1.49485e-13,92625.5,-6.35124], Tmin=(857.526,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(778.593,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Isobutyl) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.59795,0.0363147,3.9151e-05,-8.69483e-08,4.02883e-11,23546.2,22.0049], Tmin=(100,'K'), Tmax=(890.223,'K')), NASAPolynomial(coeffs=[16.1859,0.0155721,-1.39321e-06,-4.93784e-11,7.55936e-15,19173.5,-56.6489], Tmin=(890.223,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(194.926,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(12dioxolane) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C1C=COOC1(15245)',
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.586531,0.0713591,-6.94937e-05,3.49759e-08,-7.02708e-12,26801.9,25.7688], Tmin=(100,'K'), Tmax=(1202.4,'K')), NASAPolynomial(coeffs=[15.0202,0.0233428,-9.59294e-06,1.76403e-09,-1.21715e-13,23330.9,-46.5254], Tmin=(1202.4,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(221.796,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC(=C)CO[O](15250)',
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.703712,0.0750967,-8.71337e-05,5.66585e-08,-1.50302e-11,60753.4,29.7173], Tmin=(100,'K'), Tmax=(913.114,'K')), NASAPolynomial(coeffs=[11.0386,0.0298216,-1.27559e-05,2.35287e-09,-1.61357e-13,58866.1,-19.2028], Tmin=(913.114,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(504.165,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CCsJOOH) + radical(Isobutyl) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC(C)[CH]O[O](15255)',
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03609,0.0687648,-7.55153e-05,4.8395e-08,-1.29948e-11,54356.9,27.5044], Tmin=(100,'K'), Tmax=(891.709,'K')), NASAPolynomial(coeffs=[9.13151,0.0324496,-1.44254e-05,2.72119e-09,-1.89249e-13,52913.1,-10.6232], Tmin=(891.709,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(451.087,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(CCsJOOH) + radical(Cds_P)"""),
)

species(
    label = '[CH]=[C]C(C)CO[O](15256)',
    structure = SMILES('[CH]=[C]C(C)CO[O]'),
    E0 = (500.346,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,1685,370,3120,650,792.5,1650,276.163],'cm^-1')),
        HinderedRotor(inertia=(0.173807,'amu*angstrom^2'), symmetry=1, barrier=(9.40665,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173811,'amu*angstrom^2'), symmetry=1, barrier=(9.40665,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173811,'amu*angstrom^2'), symmetry=1, barrier=(9.40664,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.173819,'amu*angstrom^2'), symmetry=1, barrier=(9.40668,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.947124,0.0712796,-8.5958e-05,6.12526e-08,-1.81674e-11,60283.9,28.1457], Tmin=(100,'K'), Tmax=(813.859,'K')), NASAPolynomial(coeffs=[8.83224,0.0325221,-1.45192e-05,2.72913e-09,-1.88744e-13,59000.6,-8.27066], Tmin=(813.859,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(500.346,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(ROOJ) + radical(Cds_S) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.932695,0.0687468,-5.59779e-05,2.49602e-08,-4.74614e-12,44801.9,26.6454], Tmin=(100,'K'), Tmax=(1207.07,'K')), NASAPolynomial(coeffs=[10.5553,0.0368594,-1.63522e-05,3.075e-09,-2.13458e-13,42478.8,-21.5893], Tmin=(1207.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(371.596,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]=[C]C([CH2])COO(15260)',
    structure = SMILES('[CH]=[C]C([CH2])COO'),
    E0 = (553.424,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,281.593],'cm^-1')),
        HinderedRotor(inertia=(0.00214051,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27592,'amu*angstrom^2'), symmetry=1, barrier=(71.7886,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.149332,'amu*angstrom^2'), symmetry=1, barrier=(8.41415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.148889,'amu*angstrom^2'), symmetry=1, barrier=(8.40919,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.27269,'amu*angstrom^2'), symmetry=1, barrier=(71.794,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (99.1079,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.638644,0.0773115,-9.64352e-05,6.78824e-08,-1.94252e-11,66679.5,30.274], Tmin=(100,'K'), Tmax=(850.168,'K')), NASAPolynomial(coeffs=[10.7046,0.0299541,-1.28847e-05,2.36913e-09,-1.61544e-13,64967.8,-16.6552], Tmin=(850.168,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(553.424,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]=CC([CH2])CO[O](15039)'],
...
reaction(
    label = 'reaction4',
    reactants = ['O(4)', '[CH]=CC([CH2])C[O](14695)'],
    products = ['[CH]=CC([CH2])CO[O](15039)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', '[CH]=C[CH]CO[O](13650)'],
    products = ['[CH]=CC([CH2])CO[O](15039)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]C(C=[CH])CO[O](15241)'],
    products = ['[CH]=CC([CH2])CO[O](15039)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[C]=CC([CH2])CO[O](15242)'],
    products = ['[CH]=CC([CH2])CO[O](15039)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction12',
    reactants = ['[CH]=CC([CH2])CO[O](15039)'],
    products = ['O(4)', '[CH2]C1C=COC1(15247)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]=CC([CH2])CO[O](15039)'],
    products = ['HO2(9)', '[CH]=CC([CH2])=C(15107)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH]=CC(=C)CO[O](15250)'],
    products = ['[CH]=CC([CH2])CO[O](15039)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C#CC([CH2])CO[O](10649)'],
    products = ['[CH]=CC([CH2])CO[O](15039)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]O[O](46)', 'CH2CHCHCH(4849)'],
    products = ['[CH]=CC([CH2])CO[O](15039)'],
...
reaction(
    label = 'reaction21',
    reactants = ['O2(2)', '[CH]=CC([CH2])[CH2](13775)'],
    products = ['[CH]=CC([CH2])CO[O](15039)'],
...
reaction(
    label = 'reaction22',
    reactants = ['[CH2]O[O](46)', '[CH]C=C[CH2](15066)'],
    products = ['[CH]=CC([CH2])CO[O](15039)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', '[CH]=C[C]([CH2])CO[O](15251)'],
    products = ['[CH]=CC([CH2])CO[O](15039)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH]=CC([CH2])[CH]O[O](15252)'],
    products = ['[CH]=CC([CH2])CO[O](15039)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH]=[C]C([CH2])CO[O](10635)'],
    products = ['[CH]=CC([CH2])CO[O](15039)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH]=CC([CH2])CO[O](15039)'],
    products = ['[CH]=CC([CH2])[CH]OO(15254)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]=CC([CH2])CO[O](15039)'],
    products = ['[CH2]C([CH]O[O])C=C(15258)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]=[C]C([CH2])COO(15260)'],
    products = ['[CH]=CC([CH2])CO[O](15039)'],
