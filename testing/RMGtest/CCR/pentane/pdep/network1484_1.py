...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.35236,0.0283791,2.06671e-05,-3.40605e-08,1.14456e-11,28301.7,22.972], Tmin=(100,'K'), Tmax=(1133.6,'K')), NASAPolynomial(coeffs=[6.26981,0.0349765,-1.50835e-05,2.85517e-09,-2.00218e-13,26101.5,-2.2058], Tmin=(1133.6,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(234.767,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + ring(Cyclobutane) + radical(CCOJ) + radical(cyclobutane)"""),
)

species(
    label = 'CC([O])[CH]C1CC1(6707)',
    structure = SMILES('CC([O])[CH]C1CC1'),
    E0 = (219.483,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,2950,3050,3150,900,950,1000,1050,1100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.1917,0.0438021,3.2535e-05,-7.383e-08,3.13979e-11,26514.9,28.1087], Tmin=(100,'K'), Tmax=(969.808,'K')), NASAPolynomial(coeffs=[15.9146,0.0270143,-9.45699e-06,1.75177e-09,-1.28227e-13,21593.1,-53.122], Tmin=(969.808,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(219.483,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)OJ) + radical(CCJCO)"""),
)
...
species(
    ...
    E0 = (215.622,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2883.33,3016.67,3150,900,966.667,1033.33,1100,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,300,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.24239,0.0429252,3.11535e-05,-7.11549e-08,3.00927e-11,55846.5,25.3503], Tmin=(100,'K'), Tmax=(976.979,'K')), NASAPolynomial(coeffs=[15.8145,0.0263646,-9.59592e-06,1.80806e-09,-1.33027e-13,50942.1,-55.1398], Tmin=(976.979,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(463.377,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(374.151,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CC(C)OJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19715,0.0431221,3.46802e-05,-7.63941e-08,3.23124e-11,-10711.7,26.2967], Tmin=(100,'K'), Tmax=(971.861,'K')), NASAPolynomial(coeffs=[16.2987,0.0262844,-9.27593e-06,1.73794e-09,-1.283e-13,-15787.2,-57.1389], Tmin=(971.861,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-90.0397,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)

species(
    label = 'CC(=O)C1CCC1(6710)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.54747,0.0392885,3.14881e-05,-6.1307e-08,2.39704e-11,-18341.2,23.707], Tmin=(100,'K'), Tmax=(1014.66,'K')), NASAPolynomial(coeffs=[11.5842,0.03485,-1.38814e-05,2.62273e-09,-1.87963e-13,-22186.3,-33.7712], Tmin=(1014.66,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-153.338,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + ring(Cyclobutane)"""),
)

species(
    label = 'CC(O)C1C=CC1(6226)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.25563,0.0424848,3.46389e-05,-7.52422e-08,3.17636e-11,-9932.1,25.0591], Tmin=(100,'K'), Tmax=(969.179,'K')), NASAPolynomial(coeffs=[15.5746,0.027195,-9.49779e-06,1.75605e-09,-1.28383e-13,-14765.1,-54.1875], Tmin=(969.179,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-83.5353,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclobutene)"""),
)
...
species(
    label = '[CH2]CC=CC(C)[O](6711)',
    structure = SMILES('[CH2]CC=CC(C)[O]'),
    E0 = (187.608,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,473.927,474.36,474.463],'cm^-1')),
        HinderedRotor(inertia=(0.000748257,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0665149,'amu*angstrom^2'), symmetry=1, barrier=(10.6105,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0665156,'amu*angstrom^2'), symmetry=1, barrier=(10.6072,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0664448,'amu*angstrom^2'), symmetry=1, barrier=(10.6037,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.770688,0.0600105,-2.26721e-05,-1.03789e-08,7.30423e-12,22689.7,31.2524], Tmin=(100,'K'), Tmax=(1063.34,'K')), NASAPolynomial(coeffs=[14.1232,0.0313189,-1.25794e-05,2.34096e-09,-1.64559e-13,18632.4,-39.711], Tmin=(1063.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(187.608,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(CC(C)OJ) + radical(RCCJ)"""),
)
...
species(
    ...
    E0 = (379.628,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2830,2910,2990,3070,3150,900,940,980,1020,1060,1100,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,300,800,800,800,800,800,800,800,1600,1600,1600,1600,1600,1600,1600,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
...
species(
    ...
    opticalIsomers = 1,
    molecularWeight = (97.1351,'amu'),
    collisionModel = TransportData(shapeIndex=2, epsilon=(3997.16,'J/mol'), sigma=(6.98155,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=624.35 K, Pc=26.65 bar (from Joback method)"""),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5657,0.0332282,6.19952e-05,-1.00538e-07,3.95763e-11,20279.7,24.4798], Tmin=(100,'K'), Tmax=(977.603,'K')), NASAPolynomial(coeffs=[14.5032,0.0306511,-1.13187e-05,2.14967e-09,-1.58657e-13,15343.8,-49.9507], Tmin=(977.603,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(167.735,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CC(C)OJ) + radical(CCJ(C)CO)"""),
)

species(
    label = 'C[C](O)C1[CH]CC1(6713)',
    structure = SMILES('C[C](O)C1[CH]CC1'),
    E0 = (149.267,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09517,0.053667,-1.18362e-05,-1.61942e-08,8.17172e-12,18065.9,27.9414], Tmin=(100,'K'), Tmax=(1083.94,'K')), NASAPolynomial(coeffs=[11.7412,0.0348412,-1.40987e-05,2.61199e-09,-1.82259e-13,14555.9,-29.8224], Tmin=(1083.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(149.267,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(C2CsJOH) + radical(cyclobutane)"""),
)

species(
    label = 'CC([O])C1C[CH]C1(6714)',
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.56562,0.0378151,3.78945e-05,-6.93657e-08,2.71596e-11,15161.1,27.7135], Tmin=(100,'K'), Tmax=(1003.29,'K')), NASAPolynomial(coeffs=[12.0745,0.0340038,-1.33497e-05,2.52205e-09,-1.81593e-13,11135.5,-32.5735], Tmin=(1003.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(125.213,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CCJ(C)CO) + radical(cyclobutane)"""),
)

species(
    label = '[CH2]C(O)C1[CH]CC1(6717)',
    structure = SMILES('[CH2]C(O)C1[CH]CC1'),
    E0 = (184.228,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.12891,0.0498053,6.26331e-06,-3.97898e-08,1.76e-11,22272.6,29.0262], Tmin=(100,'K'), Tmax=(1011.96,'K')), NASAPolynomial(coeffs=[13.3882,0.0318721,-1.23996e-05,2.31171e-09,-1.6452e-13,18228.4,-37.9858], Tmin=(1011.96,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(184.228,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(CJCO)"""),
)

species(
    label = 'CC(O)C1[CH]C[CH]1(6718)',
    structure = SMILES('CC(O)C1[CH]C[CH]1'),
    E0 = (160.477,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43569,0.0452593,7.88629e-06,-3.3292e-08,1.33382e-11,19402.7,29.6425], Tmin=(100,'K'), Tmax=(1069.65,'K')), NASAPolynomial(coeffs=[10.3907,0.0367118,-1.51012e-05,2.83274e-09,-1.99432e-13,16060.2,-20.8323], Tmin=(1069.65,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(160.477,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(394.937,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(cyclobutane)"""),
)

species(
    label = '[CH2]C([O])C1CCC1(6719)',
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.13611,0.0451359,3.06431e-05,-7.13049e-08,3.01522e-11,27390.9,26.46], Tmin=(100,'K'), Tmax=(978.118,'K')), NASAPolynomial(coeffs=[15.7726,0.0285932,-1.04106e-05,1.94917e-09,-1.42395e-13,22455.7,-54.42], Tmin=(978.118,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(226.75,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(399.095,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(CC(C)OJ) + radical(CJCO)"""),
)

species(
    label = 'CC(O)C1[CH][CH]C1(6720)',
    structure = SMILES('CC(O)C1[CH][CH]C1'),
    E0 = (160.477,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[O]CC1[CH]CC1(6706)'],
...
reaction(
    label = 'reaction5',
    reactants = ['O(4)', 'C[CH]C1[CH]CC1(6260)'],
    products = ['CC([O])C1[CH]CC1(5958)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'CC([O])C1[C]CC1(6708)'],
    products = ['CC([O])C1[CH]CC1(5958)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', 'CC([O])C1=CCC1(6616)'],
    products = ['CC([O])C1[CH]CC1(5958)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'CC(=O)C1[CH]CC1(6614)'],
    products = ['CC([O])C1[CH]CC1(5958)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'CC([O])C1C=CC1(6216)'],
    products = ['CC([O])C1[CH]CC1(5958)'],
...
reaction(
    label = 'reaction16',
    reactants = ['C[CH][O](1382)', 'C1=CCC1(4846)'],
    products = ['CC([O])C1[CH]CC1(5958)'],
...
reaction(
    label = 'reaction18',
    reactants = ['CH3(17)', 'O=CC1[CH]CC1(6227)'],
    products = ['CC([O])C1[CH]CC1(5958)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', 'CC([O])[C]1[CH]CC1(6628)'],
    products = ['CC([O])C1[CH]CC1(5958)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', 'CC([O])C1[CH]C[CH]1(6630)'],
    products = ['CC([O])C1[CH]CC1(5958)'],
...
reaction(
    label = 'reaction22',
    reactants = ['CH3(17)', '[O][CH]C1[CH]CC1(6609)'],
    products = ['CC([O])C1[CH]CC1(5958)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', 'C[C]([O])C1[CH]CC1(6625)'],
    products = ['CC([O])C1[CH]CC1(5958)'],
...
reaction(
    label = 'reaction24',
    reactants = ['H(3)', 'CC([O])C1[CH][CH]C1(6632)'],
    products = ['CC([O])C1[CH]CC1(5958)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2]C([O])C1[CH]CC1(5597)'],
    products = ['CC([O])C1[CH]CC1(5958)'],
...
reaction(
    label = 'reaction31',
    reactants = ['CC([O])C1[CH]CC1(5958)'],
    products = ['[CH2]C(O)C1[CH]CC1(6717)'],
...
reaction(
    label = 'reaction32',
    reactants = ['CC([O])C1[CH]CC1(5958)'],
    products = ['CC(O)C1[CH]C[CH]1(6718)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CC([O])C1[CH]CC1(5958)'],
    products = ['CC(O)C1[CH][CH]C1(6720)'],
