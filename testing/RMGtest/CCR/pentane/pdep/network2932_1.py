...
species(
    label = '[CH2]C(C=C)OC1=CO1(11979)',
    structure = SMILES('[CH2]C(C=C)OC1=CO1'),
    E0 = (257.468,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.813417,0.0903849,-9.50962e-05,4.8058e-08,-9.24192e-12,31152.7,30.7855], Tmin=(100,'K'), Tmax=(1361.15,'K')), NASAPolynomial(coeffs=[24.3188,0.0117622,-3.20009e-06,4.76039e-10,-3.00626e-14,24752.5,-96.5897], Tmin=(1361.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(257.468,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)(Cds-Cd)) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsCs) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Cyclopropene) + radical(CJC(C)OC)"""),
)
...
species(
    label = '[CH2]C[C]([CH2])O[C]=C[O](11982)',
    structure = SMILES('[CH2]C[C]([CH2])O[C]=C[O]'),
    E0 = (542.676,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3010,987.5,1337.5,450,1655,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.718767,0.099275,-0.000122826,7.42645e-08,-1.72649e-11,65442.7,37.1994], Tmin=(100,'K'), Tmax=(1065.27,'K')), NASAPolynomial(coeffs=[21.4296,0.0161084,-5.71743e-06,9.74854e-10,-6.48478e-14,60724,-71.0539], Tmin=(1065.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(542.676,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C2CsJOC(O)) + radical(RCCJ) + radical(CJC(C)OC) + radical(C=CJO)"""),
)
...
species(
    label = '[CH2]C1CC1O[C]=C[O](11985)',
    structure = SMILES('[CH2]C1CC1O[C]=C[O]'),
    E0 = (285.341,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
...
species(
    label = 'C=CC(=C)O[C]=C[O](11988)',
    structure = SMILES('C=CC(=C)O[C]=C[O]'),
    E0 = (188.9,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2995,3025,975,1000,1300,1375,400,500,1630,1680,2950,3000,3050,3100,1330,1430,900,1050,1000,1050,1600,1700,1685,370,208.665,208.845,208.942,209.097,209.318],'cm^-1')),
        HinderedRotor(inertia=(0.688611,'amu*angstrom^2'), symmetry=1, barrier=(21.2432,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.685556,'amu*angstrom^2'), symmetry=1, barrier=(21.2405,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.685801,'amu*angstrom^2'), symmetry=1, barrier=(21.2409,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.268684,0.072,-5.70881e-05,1.2426e-08,3.26734e-12,22862.8,30.8492], Tmin=(100,'K'), Tmax=(964.05,'K')), NASAPolynomial(coeffs=[19.2301,0.0159784,-5.16788e-06,8.95102e-10,-6.30074e-14,18154.2,-65.3941], Tmin=(964.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(188.9,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(C=COJ) + radical(C=CJO)"""),
)
...
species(
    label = '[CH2][C](C=C)O[C]=C[O](11990)',
    structure = SMILES('[CH2]C=C([CH2])O[C]=C[O]'),
    E0 = (374.827,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([350,440,435,1725,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,1685,370,180,180,706.248,706.287],'cm^-1')),
        HinderedRotor(inertia=(0.76137,'amu*angstrom^2'), symmetry=1, barrier=(17.5054,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0494736,'amu*angstrom^2'), symmetry=1, barrier=(17.5062,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.189121,'amu*angstrom^2'), symmetry=1, barrier=(17.5059,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.337952,'amu*angstrom^2'), symmetry=1, barrier=(119.627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.206604,0.0782912,-7.83585e-05,3.86589e-08,-7.30057e-12,45244.8,35.3236], Tmin=(100,'K'), Tmax=(1402.27,'K')), NASAPolynomial(coeffs=[20.6063,0.0137228,-3.72829e-06,5.34048e-10,-3.21862e-14,39918.9,-70.3004], Tmin=(1402.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.827,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(C=C(O)CJ) + radical(Allyl_P) + radical(C=CJO)"""),
)

species(
    label = '[CH2]C([C]=C)O[C]=C[O](11991)',
    structure = SMILES('[CH2]C([C]=C)O[C]=C[O]'),
    E0 = (502.502,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,1670,1700,300,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=CC([CH2])O[C]=C[O](11992)',
    structure = SMILES('[CH]=CC([CH2])O[C]=C[O]'),
    E0 = (511.756,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3100,440,815,1455,1000,1685,370,3120,650,792.5,1650,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.927049,'amu*angstrom^2'), symmetry=1, barrier=(21.3147,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.92564,'amu*angstrom^2'), symmetry=1, barrier=(21.2823,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.927141,'amu*angstrom^2'), symmetry=1, barrier=(21.3168,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.927046,'amu*angstrom^2'), symmetry=1, barrier=(21.3146,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (110.111,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.27706,0.0930787,-0.000102374,5.19852e-08,-9.75151e-12,61759.7,37.7148], Tmin=(100,'K'), Tmax=(1502.47,'K')), NASAPolynomial(coeffs=[26.8755,0.00368628,1.2901e-06,-4.09668e-10,3.11448e-14,54930.1,-104.142], Tmin=(1502.47,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(511.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=COJ) + radical(CJC(C)OC) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = 'C=[C]C(C)O[C]=C[O](11997)',
    structure = SMILES('C=[C]C(C)O[C]=C[O]'),
    E0 = (291.991,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,3010,987.5,1337.5,450,1655,1670,1700,300,440,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = '[CH]=CC(C)O[C]=C[O](11999)',
    structure = SMILES('[CH]=CC(C)O[C]=C[O]'),
    E0 = (301.246,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,1685,370,3120,650,792.5,1650,180,180,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.923365,'amu*angstrom^2'), symmetry=1, barrier=(21.23,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.923262,'amu*angstrom^2'), symmetry=1, barrier=(21.2276,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.923052,'amu*angstrom^2'), symmetry=1, barrier=(21.2228,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.923366,'amu*angstrom^2'), symmetry=1, barrier=(21.23,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0349928,0.0699727,-2.3379e-05,-3.79378e-08,2.45775e-11,36394.1,33.4948], Tmin=(100,'K'), Tmax=(936.407,'K')), NASAPolynomial(coeffs=[25.4514,0.00851242,-8.698e-07,1.03351e-10,-1.31834e-14,29542.4,-98.886], Tmin=(936.407,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(301.246,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(C=COJ) + radical(C=CJO) + radical(Cds_P)"""),
)
...
species(
    label = '[CH2][C](C=C)O[C]=CO(12001)',
    structure = SMILES('[CH2]C=C([CH2])O[C]=CO'),
    E0 = (233.364,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
...
species(
    label = '[CH]=CC([CH2])O[C]=CO(12003)',
    structure = SMILES('[CH]=CC([CH2])O[C]=CO'),
    E0 = (370.293,'kJ/mol'),
    modes = [
...
species(
    label = 'C=CC1CC([O])[C]O1(12005)',
    structure = SMILES('C=CC1CC([O])[C]O1'),
    E0 = (387.559,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09236,0.0444957,3.45707e-05,-8.87061e-08,4.15344e-11,46735.5,23.6869], Tmin=(100,'K'), Tmax=(908.684,'K')), NASAPolynomial(coeffs=[19.4427,0.0150798,-1.6566e-06,7.6101e-11,-5.33018e-15,41280,-74.7538], Tmin=(908.684,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(387.559,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(353.365,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Tetrahydrofuran) + radical(CC(C)OJ) + radical(CH2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2]C(C=C)O[C]=C[O](11263)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH2]C(C=C)O[C]=C[O](11263)'],
    products = ['C=CC[CH]O[C]=C[O](11976)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[C]=C[O](6859)', '[CH2]C([O])C=C(1523)'],
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', 'C=C[CH]O[C]=C[O](11977)'],
    products = ['[CH2]C(C=C)O[C]=C[O](11263)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['O(4)', '[CH]=[C]OC([CH2])C=C(5360)'],
    products = ['[CH2]C(C=C)O[C]=C[O](11263)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]C(C=C)O[C]=C[O](11978)'],
    products = ['[CH2]C(C=C)O[C]=C[O](11263)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2]C(C=C)O[C]=C[O](11263)'],
    products = ['[CH2]C(C=C)OC1=CO1(11979)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction11',
    reactants = ['[CH2]C[C]([CH2])O[C]=C[O](11982)'],
    products = ['[CH2]C(C=C)O[C]=C[O](11263)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(C=C)O[C]=C[O](11263)'],
    products = ['[CH2]C1CC1O[C]=C[O](11985)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'C=CC(=C)O[C]=C[O](11988)'],
    products = ['[CH2]C(C=C)O[C]=C[O](11263)'],
...
reaction(
    label = 'reaction20',
    reactants = ['O(4)', 'C#COC([CH2])C=C(5356)'],
    products = ['[CH2]C(C=C)O[C]=C[O](11263)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(23.3993,'m^3/(mol*s)'), n=2.021, Ea=(65.4924,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Od_R;YJ] for rate rule [Od_Cdd;CJ]
...
reaction(
    label = 'reaction22',
    reactants = ['C2H3(60)', 'C=CO[C]=C[O](11102)'],
    products = ['[CH2]C(C=C)O[C]=C[O](11263)'],
...
reaction(
    label = 'reaction24',
    reactants = ['C2H3(60)', '[CH2][CH]O[C]=C[O](10214)'],
    products = ['[CH2]C(C=C)O[C]=C[O](11263)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2][C](C=C)O[C]=C[O](11990)'],
    products = ['[CH2]C(C=C)O[C]=C[O](11263)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2]C([C]=C)O[C]=C[O](11991)'],
    products = ['[CH2]C(C=C)O[C]=C[O](11263)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH]=CC([CH2])O[C]=C[O](11992)'],
    products = ['[CH2]C(C=C)O[C]=C[O](11263)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2]C(C=C)O[C]=C[O](11263)'],
    products = ['C=C[C](C)O[C]=C[O](11994)'],
...
reaction(
    label = 'reaction33',
    reactants = ['C=[C]C(C)O[C]=C[O](11997)'],
    products = ['[CH2]C(C=C)O[C]=C[O](11263)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]=CC(C)O[C]=C[O](11999)'],
    products = ['[CH2]C(C=C)O[C]=C[O](11263)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH2]C(C=C)O[C]=C[O](11263)'],
    products = ['[CH2][C](C=C)O[C]=CO(12001)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]C([C]=C)O[C]=CO(12002)'],
    products = ['[CH2]C(C=C)O[C]=C[O](11263)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH]=CC([CH2])O[C]=CO(12003)'],
    products = ['[CH2]C(C=C)O[C]=C[O](11263)'],
