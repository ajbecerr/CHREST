...
species(
    label = '[C]=[C]CC[C]=O(17221)',
    structure = SMILES('[C]=[C]CC[C]=O'),
    E0 = (832.803,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1685,370,1855,455,950,180,180],'cm^-1')),
        HinderedRotor(inertia=(0.205096,'amu*angstrom^2'), symmetry=1, barrier=(4.71557,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.203064,'amu*angstrom^2'), symmetry=1, barrier=(4.66885,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.204621,'amu*angstrom^2'), symmetry=1, barrier=(4.70465,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.0847,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61973,0.0604314,-0.000103623,9.70146e-08,-3.46893e-11,100241,24.5675], Tmin=(100,'K'), Tmax=(859.623,'K')), NASAPolynomial(coeffs=[5.16064,0.0261423,-1.27083e-05,2.40206e-09,-1.63208e-13,100290,11.8482], Tmin=(859.623,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(832.803,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(Cds_S) + radical(CCCJ=O) + radical(CdCdJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.92722,0.0379181,-1.30988e-05,-7.10877e-09,4.24716e-12,24366,20.5999], Tmin=(100,'K'), Tmax=(1147.23,'K')), NASAPolynomial(coeffs=[11.2198,0.020225,-9.19449e-06,1.79681e-09,-1.28616e-13,21266,-29.7256], Tmin=(1147.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(201.917,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsH) + group(Cds-OdCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(C=C=CJ)"""),
)

species(
    label = '[CH]=CCC=C=O(17224)',
    ...
    molecularWeight = (81.0926,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8592,0.0494441,-5.06047e-05,2.97453e-08,-7.35193e-12,30066.4,20.1815], Tmin=(100,'K'), Tmax=(961.405,'K')), NASAPolynomial(coeffs=[8.01919,0.0238144,-1.06159e-05,2.01532e-09,-1.40972e-13,28882,-9.29436], Tmin=(961.405,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(249.362,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: missing(O2d-Cdd) + group(Cs-Cd(CCO)HH) + group(Cds-CdsCsH) + group(Cds-(Cdd-O2d)CsH) + group(Cds-CdsHH) + missing(Cdd-CdO2d) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[C]=[CH](9646)', '[CH2]C[C]=O(2354)'],
    products = ['[CH]=[C]CC[C]=O(15746)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(2355)', '[CH]=[C]C[CH2](9654)'],
    products = ['[CH]=[C]CC[C]=O(15746)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[C]=[C]CC[C]=O(17221)'],
    products = ['[CH]=[C]CC[C]=O(15746)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['CO(2039)', '[CH]=[C]C[CH2](9654)'],
    products = ['[CH]=[C]CC[C]=O(15746)'],
