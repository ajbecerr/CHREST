...
species(
    ...
    molecularWeight = (59.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.33987,0.0161713,-3.54505e-06,-1.54317e-09,5.3675e-13,20677.4,8.37595], Tmin=(100,'K'), Tmax=(1777.56,'K')), NASAPolynomial(coeffs=[6.88056,0.0135951,-5.92062e-06,1.05405e-09,-6.85007e-14,18566.8,-13.1384], Tmin=(1777.56,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(171.736,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(157.975,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(12dioxetane) + radical(CCsJOO)"""),
)

species(
    label = '[CH2]C1OO1(1353)',
    ...
    molecularWeight = (59.044,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.01105,0.00838731,4.73261e-05,-7.76478e-08,3.38979e-11,18254,14.0735], Tmin=(100,'K'), Tmax=(894.885,'K')), NASAPolynomial(coeffs=[13.0757,-0.00110182,3.72959e-06,-8.41897e-10,5.73835e-14,15031.3,-41.3066], Tmin=(894.885,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(151.372,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + ring(dioxirane) + radical(CJCOOH)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'C2H3(60)'],
    products = ['CH2CHOO(673)'],
    transitionState = 'TS1',
...
This reaction matched rate rule [Root_N-1R->H_N-1CNOS->N_1COS->O_Ext-1O-R_Ext-2R-R_N-Sp-4R!H-2R_N-4R!H->O]
family: R_Recombination"""),
)

reaction(
    label = 'reaction2',
    reactants = ['O(4)', 'vinoxy(1351)'],
    products = ['CH2CHOO(673)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2CHOO(673)'],
    products = ['[CH]1COO1(1352)'],
    transitionState = 'TS3',
