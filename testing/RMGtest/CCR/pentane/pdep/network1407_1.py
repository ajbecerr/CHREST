...
species(
    label = '[CH2]C(C)[CH]C([CH2])C=C(5754)',
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.133767,0.0814542,-5.70154e-05,2.18831e-08,-3.49527e-12,57814.8,39.4956], Tmin=(100,'K'), Tmax=(1454.32,'K')), NASAPolynomial(coeffs=[14.7768,0.0404443,-1.47177e-05,2.49381e-09,-1.62254e-13,53477.9,-38.0237], Tmin=(1454.32,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(479.398,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH]C(C=C)C(C)[CH][CH2](5757)',
    ...
    molecularWeight = (108.181,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0509852,0.0801835,-5.55271e-05,1.96466e-08,-2.83719e-12,87475.6,38.4329], Tmin=(100,'K'), Tmax=(1599.36,'K')), NASAPolynomial(coeffs=[17.3737,0.0366049,-1.46563e-05,2.61042e-09,-1.74254e-13,81901.9,-53.8138], Tmin=(1599.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(726.042,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.407955,0.0638042,2.39359e-06,-4.31756e-08,1.96872e-11,16039.8,30.1866], Tmin=(100,'K'), Tmax=(1006.5,'K')), NASAPolynomial(coeffs=[14.6784,0.0415492,-1.5793e-05,2.88511e-09,-2.02429e-13,11421.8,-47.4229], Tmin=(1006.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(132.176,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(Allyl_T)"""),
)

species(
    label = '[CH2]CC(C)C(=C)C=C(5761)',
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.216613,0.0782461,-2.90732e-05,-1.82469e-08,1.26925e-11,22222.4,32.6731], Tmin=(100,'K'), Tmax=(1003.95,'K')), NASAPolynomial(coeffs=[18.0198,0.036772,-1.36991e-05,2.4831e-09,-1.73858e-13,16989.1,-63.2058], Tmin=(1003.95,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(183.399,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(486.397,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(RCCJ)"""),
)
...
species(
    label = '[CH2]C[C](C)C([CH2])C=C(5776)',
    structure = SMILES('[CH2]C[C](C)C([CH2])C=C'),
    E0 = (473.79,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.473279,0.0809965,-6.21598e-05,2.91882e-08,-6.20003e-12,57107.8,35.9014], Tmin=(100,'K'), Tmax=(1058.79,'K')), NASAPolynomial(coeffs=[7.90662,0.0529138,-2.23744e-05,4.13713e-09,-2.84942e-13,55533.7,-0.384733], Tmin=(1058.79,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(473.79,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Tertalkyl) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.257106,0.0785173,-5.03146e-05,1.64484e-08,-2.23303e-12,62157.8,36.782], Tmin=(100,'K'), Tmax=(1643.09,'K')), NASAPolynomial(coeffs=[14.9833,0.0426674,-1.7587e-05,3.16961e-09,-2.1265e-13,57318.4,-41.5764], Tmin=(1643.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(515.669,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Cs_S) + radical(RCCJ) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (109.189,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.167919,0.0843802,-6.18636e-05,2.46498e-08,-4.08125e-12,63444.2,37.5358], Tmin=(100,'K'), Tmax=(1404.37,'K')), NASAPolynomial(coeffs=[14.9958,0.0411896,-1.57314e-05,2.75016e-09,-1.82733e-13,59185.2,-40.7698], Tmin=(1404.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(526.209,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(RCCJ) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', '[CH2][CH]CC([CH2])C=C(4148)'],
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][CH]C(C)C([CH2])C=C(4528)'],
    products = ['[CH2]C(C)[CH]C([CH2])C=C(5754)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH2][CH]C(C)C([CH2])C=C(4528)'],
    products = ['[CH2][CH]C(C)[CH]CC=C(5755)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(6.55606e+10,'s^-1'), n=0.64, Ea=(159.935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [cCs(-HC)CJ;CsJ;C] for rate rule [cCs(-HC)CJ;CsJ-HH;C]
Euclidian distance = 1.0
family: 1,2_shiftC"""),
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH2][C]C(C)C([CH2])C=C(5756)'],
    products = ['[CH2][CH]C(C)C([CH2])C=C(4528)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH]C(C=C)C(C)[CH][CH2](5757)'],
    products = ['[CH2][CH]C(C)C([CH2])C=C(4528)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH][CH]C(C)C([CH2])C=C(5758)'],
    products = ['[CH2][CH]C(C)C([CH2])C=C(4528)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][CH]C(C)C([CH2])C=C(4528)'],
    products = ['[CH2]C=C(C)C(C)C=C(5760)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH]C(C)C([CH2])C=C(4528)'],
    products = ['[CH2]CC(C)C(=C)C=C(5761)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][CH]C(C)[C]([CH2])C[CH2](5762)'],
    products = ['[CH2][CH]C(C)C([CH2])C=C(4528)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2][CH][C](C)C([CH2])C[CH2](5763)'],
    products = ['[CH2][CH]C(C)C([CH2])C=C(4528)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2][CH][C](C)C([CH2])[CH]C(4529)'],
    products = ['[CH2][CH]C(C)C([CH2])C=C(4528)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH2]C(C=C)[C](C)C=C(5656)'],
    products = ['[CH2][CH]C(C)C([CH2])C=C(4528)'],
...
reaction(
    label = 'reaction28',
    reactants = ['H(3)', '[CH2][C](C=C)C(C)C=C(5657)'],
    products = ['[CH2][CH]C(C)C([CH2])C=C(4528)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(0.270985,'m^3/(mol*s)'), n=1.98996, Ea=(86.3195,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [Cd_R;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 81.7 to 86.3 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction30',
    reactants = ['CH3(17)', '[CH2]C=CC([CH2])C=C(5257)'],
    products = ['[CH2][CH]C(C)C([CH2])C=C(4528)'],
...
reaction(
    label = 'reaction32',
    reactants = ['C2H3(60)', '[CH2][CH]C(C)C=C(3805)'],
    products = ['[CH2][CH]C(C)C([CH2])C=C(4528)'],
...
reaction(
    label = 'reaction36',
    reactants = ['C2H3(60)', '[CH2][CH]C(C)[CH][CH2](3858)'],
    products = ['[CH2][CH]C(C)C([CH2])C=C(4528)'],
...
reaction(
    label = 'reaction39',
    reactants = ['H(3)', '[CH2][CH]C(C)C([CH2])[C]=C(5774)'],
    products = ['[CH2][CH]C(C)C([CH2])C=C(4528)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2][CH]C(C)C([CH2])C=C(4528)'],
    products = ['[CH2]C[C](C)C([CH2])C=C(5776)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH2][CH]C(C)C(C)=C[CH2](4511)'],
    products = ['[CH2][CH]C(C)C([CH2])C=C(4528)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2][CH]C(C)C(C)[C]=C(5778)'],
    products = ['[CH2][CH]C(C)C([CH2])C=C(4528)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2]CC(C)C([CH2])[C]=C(5779)'],
    products = ['[CH2][CH]C(C)C([CH2])C=C(4528)'],
...
network(
    label = 'PDepNetwork #1407',
    isomers = [
        '[CH2][CH]C(C)C([CH2])C=C(4528)',
    ],
    reactants = [
