...
species(
    label = '[CH2]CCC[C]=O(2435)',
    structure = SMILES('[CH2]CCC[C]=O'),
    E0 = (114.323,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,3000,3100,440,815,1455,1000,1855,455,950,194.974,2873.99],'cm^-1')),
        HinderedRotor(inertia=(0.172096,'amu*angstrom^2'), symmetry=1, barrier=(29.0058,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00188284,'amu*angstrom^2'), symmetry=1, barrier=(11.0402,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.480233,'amu*angstrom^2'), symmetry=1, barrier=(11.0415,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.480171,'amu*angstrom^2'), symmetry=1, barrier=(11.0401,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.67937,0.0546841,-4.90958e-05,2.81648e-08,-7.31012e-12,13830.3,24.8288], Tmin=(100,'K'), Tmax=(887.463,'K')), NASAPolynomial(coeffs=[6.08608,0.034822,-1.55247e-05,2.94599e-09,-2.05936e-13,13048.2,4.09505], Tmin=(887.463,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(114.323,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(RCCJ) + radical(CCCJ=O)"""),
)

species(
    label = 'CCC[CH][C]=O(2436)',
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4683,0.051738,-3.63543e-05,1.38511e-08,-2.20986e-12,9307.86,23.5481], Tmin=(100,'K'), Tmax=(1439.51,'K')), NASAPolynomial(coeffs=[10.4348,0.0268224,-1.03915e-05,1.82709e-09,-1.21635e-13,6726.41,-22.9765], Tmin=(1439.51,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(76.6064,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCHO) + radical(CCCJ=O)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['CHCH3(T)(21)', '[CH2]C[C]=O(2354)'],
    products = ['C[CH]CC[C]=O(2248)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['[C]=O(2355)', '[CH2]C[CH]C(36)'],
    products = ['C[CH]CC[C]=O(2248)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction6',
    reactants = ['CH3(17)', '[CH]CC[C]=O(2356)'],
    products = ['C[CH]CC[C]=O(2248)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction12',
    reactants = ['CO(2039)', '[CH2]C[CH]C(36)'],
    products = ['C[CH]CC[C]=O(2248)'],
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', 'C[CH]CC=C=O(2432)'],
    products = ['C[CH]CC[C]=O(2248)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'C[CH][CH]C[C]=O(2433)'],
    products = ['C[CH]CC[C]=O(2248)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', 'C[CH]C[CH][C]=O(2434)'],
    products = ['C[CH]CC[C]=O(2248)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH2][CH]CC[C]=O(2285)'],
    products = ['C[CH]CC[C]=O(2248)'],
