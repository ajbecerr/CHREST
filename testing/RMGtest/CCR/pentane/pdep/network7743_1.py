...
species(
    ...
    molecularWeight = (56.0633,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.20188,0.047022,-8.67417e-05,8.31877e-08,-2.96491e-11,41104.6,14.7829], Tmin=(100,'K'), Tmax=(881.728,'K')), NASAPolynomial(coeffs=[4.54051,0.0188157,-8.82103e-06,1.63828e-09,-1.09432e-13,41376.2,7.67369], Tmin=(881.728,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(341.284,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(Cds_S) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(4)', '[CH]=C[CH2](16804)'],
    products = ['[CH]=CC[O](15221)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][O](3109)', 'C2H2(1342)'],
    products = ['[CH]=CC[O](15221)'],
    transitionState = 'TS9',
