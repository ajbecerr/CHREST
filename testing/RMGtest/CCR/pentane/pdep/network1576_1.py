...
species(
    label = '[CH][CH]O[CH]CC(7000)',
    structure = SMILES('[CH][CH]O[CH]CC'),
    E0 = (511.974,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.434689,0.0792379,-9.56061e-05,6.10108e-08,-1.54533e-11,61704,25.9278], Tmin=(100,'K'), Tmax=(966.002,'K')), NASAPolynomial(coeffs=[13.7866,0.02395,-9.75475e-06,1.76176e-09,-1.19595e-13,59124.4,-38.0257], Tmin=(966.002,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(511.974,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][CH]OC([CH])CC(7041)',
    structure = SMILES('[CH][CH]OC([CH])CC'),
    E0 = (745.402,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,200,800,900,1000,1100,1200,1300,1400,1500,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0926451,0.087176,-9.63202e-05,5.69943e-08,-1.35994e-11,89790.9,30.616], Tmin=(100,'K'), Tmax=(1014.82,'K')), NASAPolynomial(coeffs=[14.3319,0.0310499,-1.33593e-05,2.49382e-09,-1.72997e-13,86900.9,-38.2892], Tmin=(1014.82,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(745.402,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C]OC([CH2])CC(7042)',
    structure = SMILES('[CH][C]OC([CH2])CC'),
    E0 = (788.229,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,180,180,180,180,1598.8,1600,2904.64,3200],'cm^-1')),
    ...
    molecularWeight = (97.1351,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0981387,0.0954815,-0.000124704,8.90264e-08,-2.56769e-11,94944.9,29.3415], Tmin=(100,'K'), Tmax=(844.471,'K')), NASAPolynomial(coeffs=[12.8544,0.0341302,-1.57295e-05,2.99738e-09,-2.08825e-13,92757.2,-30.9574], Tmin=(844.471,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(788.229,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)OC) + radical(CH2_triplet) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.180586,0.0717766,-4.00425e-05,-3.8108e-09,7.77481e-12,23994.8,28.3135], Tmin=(100,'K'), Tmax=(998.033,'K')), NASAPolynomial(coeffs=[18.1968,0.0254703,-9.37356e-06,1.70569e-09,-1.20522e-13,19108.7,-65.0312], Tmin=(998.033,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(198.271,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][CH]OC([CH2])[CH2](1860)',
    structure = SMILES('[CH][CH]OC([CH2])[CH2]'),
    E0 = (741.987,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.10794,0.0972616,-0.000158734,1.30692e-07,-4.12138e-11,89381.8,26.8915], Tmin=(100,'K'), Tmax=(893.476,'K')), NASAPolynomial(coeffs=[13.2636,0.0230509,-1.00592e-05,1.7856e-09,-1.15971e-13,87565.1,-32.9074], Tmin=(893.476,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(741.987,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CCsJOCs) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]CO[C]([CH2])CC(7048)',
    structure = SMILES('[CH]CO[C]([CH2])CC'),
    E0 = (507.945,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.192798,0.10293,-0.000160788,1.42751e-07,-4.95766e-11,61232.3,30.881], Tmin=(100,'K'), Tmax=(854.149,'K')), NASAPolynomial(coeffs=[7.59896,0.0448328,-2.08149e-05,3.8847e-09,-2.6327e-13,60689.5,-0.867286], Tmin=(854.149,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(507.945,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]COC([CH2])C[CH2](7051)',
    structure = SMILES('[CH]COC([CH2])C[CH2]'),
    E0 = (532.487,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (98.143,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.13384,0.0904935,-0.000110872,7.93351e-08,-2.35455e-11,64177.7,31.5629], Tmin=(100,'K'), Tmax=(814.017,'K')), NASAPolynomial(coeffs=[10.3686,0.040203,-1.82048e-05,3.44506e-09,-2.39186e-13,62511.4,-15.7081], Tmin=(814.017,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(532.487,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(382.466,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)OC) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', '[CH][CH]OC([CH2])C(1627)'],
    products = ['[CH][CH]OC([CH2])CC(1741)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH][CH](6981)', '[CH2]C([O])CC(1362)'],
    products = ['[CH][CH]OC([CH2])CC(1741)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['CH2(T)(20)', '[CH][CH]O[CH]CC(7000)'],
    products = ['[CH][CH]OC([CH2])CC(1741)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH][CH]OC([CH])CC(7041)'],
    products = ['[CH][CH]OC([CH2])CC(1741)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH][C]OC([CH2])CC(7042)'],
    products = ['[CH][CH]OC([CH2])CC(1741)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH][CH]OC(=C)CC(7044)'],
    products = ['[CH][CH]OC([CH2])CC(1741)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.41198,'m^3/(mol*s)'), n=2.03228, Ea=(101.355,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
family: R_Addition_MultipleBond
Ea raised from 100.2 to 101.4 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction12',
    reactants = ['C2H5(14)', '[CH][CH]OC=C(6927)'],
    products = ['[CH][CH]OC([CH2])CC(1741)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C2H5(14)', '[CH][CH]O[CH][CH2](6987)'],
    products = ['[CH][CH]OC([CH2])CC(1741)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', '[CH][CH]O[C]([CH2])CC(7045)'],
    products = ['[CH][CH]OC([CH2])CC(1741)'],
...
reaction(
    label = 'reaction16',
    reactants = ['CH3(17)', '[CH][CH]OC([CH2])[CH2](1860)'],
    products = ['[CH][CH]OC([CH2])CC(1741)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH][CH]OC([CH2])C[CH2](7046)'],
    products = ['[CH][CH]OC([CH2])CC(1741)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH][CH]OC([CH2])CC(1741)'],
    products = ['[CH][CH]OC(C)C[CH2](7050)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH]COC([CH2])C[CH2](7051)'],
    products = ['[CH][CH]OC([CH2])CC(1741)'],
