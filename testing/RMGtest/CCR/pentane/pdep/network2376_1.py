...
species(
    label = '[C]=[C]OC([CH2])[O](10247)',
    structure = SMILES('[C]=[C]OC([CH2])[O]'),
    E0 = (849.402,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,1685,370,393.823,393.825,393.831,393.832],'cm^-1')),
        HinderedRotor(inertia=(0.00360197,'amu*angstrom^2'), symmetry=1, barrier=(6.46466,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162195,'amu*angstrom^2'), symmetry=1, barrier=(17.8505,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.162188,'amu*angstrom^2'), symmetry=1, barrier=(17.8504,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    opticalIsomers = 1,
    molecularWeight = (83.0654,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39336,0.0614803,-9.43197e-05,7.51846e-08,-2.37465e-11,102250,26.2048], Tmin=(100,'K'), Tmax=(777.889,'K')), NASAPolynomial(coeffs=[10.0428,0.017,-8.5412e-06,1.66439e-09,-1.16401e-13,100904,-13.3505], Tmin=(777.889,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(849.402,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-CsH) + group(Cs-CsOsOsH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCOJ) + radical(CJCO) + radical(C=CJO) + radical(CdCdJ2_triplet)"""),
)

species(
    label = '[CH]=[C]OC1CO1(10248)',
    structure = SMILES('[CH]=[C]OC1CO1'),
    E0 = (290.666,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (84.0734,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.312256,0.0566731,-5.8411e-05,2.93855e-08,-5.31081e-12,35113,25.663], Tmin=(100,'K'), Tmax=(1698.75,'K')), NASAPolynomial(coeffs=[13.6772,0.00676891,1.93196e-06,-6.83833e-10,5.45221e-14,33232.1,-38.0682], Tmin=(1698.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(290.666,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(224.491,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsOsH) + group(Cs-CsOsHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + ring(Ethylene_oxide) + radical(C=CJO) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[C]=[CH](9646)', '[CH2]C([O])[O](1528)'],
    products = ['[CH]=[C]OC([CH2])[O](2847)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[CH]=[C]O[CH][O](10246)'],
    products = ['[CH]=[C]OC([CH2])[O](2847)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[C]=[C]OC([CH2])[O](10247)'],
    products = ['[CH]=[C]OC([CH2])[O](2847)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction14',
    reactants = ['CH2(T)(20)', 'C#CO[CH][O](6783)'],
    products = ['[CH]=[C]OC([CH2])[O](2847)'],
