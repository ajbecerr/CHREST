...
species(
    label = '[CH]C(C=C)O[CH2](29105)',
    structure = SMILES('[CH]C(C=C)O[CH2]'),
    E0 = (463.217,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.875775,0.0608373,-5.38125e-05,2.40212e-08,-4.23987e-12,55831.2,26.3245], Tmin=(100,'K'), Tmax=(1369.58,'K')), NASAPolynomial(coeffs=[15.492,0.0181492,-7.05933e-06,1.26326e-09,-8.56828e-14,51827.6,-48.787], Tmin=(1369.58,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(463.217,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsJOCC2) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07038,0.0520213,-1.27085e-05,-2.70511e-08,1.59536e-11,-12065.3,19.3877], Tmin=(100,'K'), Tmax=(953.735,'K')), NASAPolynomial(coeffs=[16.5593,0.0171992,-5.34299e-06,9.34124e-10,-6.73989e-14,-16390.5,-61.7897], Tmin=(953.735,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-101.288,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-OsHHH) + group(Cds-Cds(Cds-Cds)O2s) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH)"""),
)

species(
    label = '[CH2]C[C]([CH2])O[CH2](29107)',
    structure = SMILES('[CH2]C[C]([CH2])O[CH2]'),
    E0 = (486.109,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,360,370,350,3000,3020,3040,3060,3080,3100,415,440,465,780,815,850,1435,1455,1475,900,1000,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.377486,0.0905354,-0.000153088,1.38612e-07,-4.78365e-11,58585.4,27.2034], Tmin=(100,'K'), Tmax=(877.461,'K')), NASAPolynomial(coeffs=[7.29999,0.0346834,-1.60785e-05,2.96231e-09,-1.97684e-13,58305.9,0.0407969], Tmin=(877.461,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(486.109,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-OsHHH) + radical(C2CsJOCs) + radical(RCCJ) + radical(CJC(C)OC) + radical(CsJOCC2)"""),
)
...
species(
    label = '[CH2]OC(C)[C]=C(29114)',
    structure = SMILES('[CH2]OC(C)[C]=C'),
    E0 = (252.844,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,272.269,272.312,272.516],'cm^-1')),
        HinderedRotor(inertia=(0.00227763,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00226694,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.298917,'amu*angstrom^2'), symmetry=1, barrier=(15.766,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.299706,'amu*angstrom^2'), symmetry=1, barrier=(15.7682,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
...
species(
    label = '[CH2]C([C]=C)OC(29115)',
    structure = SMILES('[CH2]C([C]=C)OC'),
    E0 = (279.769,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,311.235,311.236,4000],'cm^-1')),
        HinderedRotor(inertia=(0.127868,'amu*angstrom^2'), symmetry=1, barrier=(8.78961,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.249037,'amu*angstrom^2'), symmetry=1, barrier=(17.1187,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.127869,'amu*angstrom^2'), symmetry=1, barrier=(8.78961,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.323739,'amu*angstrom^2'), symmetry=1, barrier=(22.2536,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.33185,0.062789,-6.6151e-05,4.19178e-08,-1.13885e-11,33741,24.4997], Tmin=(100,'K'), Tmax=(872.31,'K')), NASAPolynomial(coeffs=[7.80901,0.0330884,-1.50796e-05,2.88702e-09,-2.02649e-13,32610.9,-5.86419], Tmin=(872.31,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(279.769,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(Cds_S)"""),
)

species(
    label = '[CH]=CC(C)O[CH2](29116)',
    structure = SMILES('[CH]=CC(C)O[CH2]'),
    E0 = (262.098,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,421.342,421.358],'cm^-1')),
        HinderedRotor(inertia=(0.642,'amu*angstrom^2'), symmetry=1, barrier=(14.7608,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0190503,'amu*angstrom^2'), symmetry=1, barrier=(2.39987,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.641995,'amu*angstrom^2'), symmetry=1, barrier=(14.7607,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.117154,'amu*angstrom^2'), symmetry=1, barrier=(14.7607,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.846402,0.0613734,-5.10671e-05,2.16775e-08,-3.67068e-12,31643.3,25.8306], Tmin=(100,'K'), Tmax=(1415.53,'K')), NASAPolynomial(coeffs=[15.1928,0.0208338,-8.10874e-06,1.44581e-09,-9.755e-14,27581.7,-48.3683], Tmin=(1415.53,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(262.098,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CsJOCC2) + radical(Cds_P)"""),
)

species(
    label = '[CH]=CC([CH2])OC(29117)',
    structure = SMILES('[CH]=CC([CH2])OC'),
    E0 = (289.024,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,3120,650,792.5,1650,299.785,299.787],'cm^-1')),
        HinderedRotor(inertia=(0.0018758,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161853,'amu*angstrom^2'), symmetry=1, barrier=(10.3222,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161852,'amu*angstrom^2'), symmetry=1, barrier=(10.3222,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161854,'amu*angstrom^2'), symmetry=1, barrier=(10.3222,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (84.1164,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29576,0.0617538,-5.85781e-05,3.12226e-08,-7.00009e-12,34857,24.5518], Tmin=(100,'K'), Tmax=(1051.15,'K')), NASAPolynomial(coeffs=[9.62579,0.030056,-1.33464e-05,2.53641e-09,-1.77714e-13,33105.7,-16.0515], Tmin=(1051.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(289.024,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-OsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CJC(C)OC) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(20)', '[CH2]C([O])C=C(1523)'],
    products = ['[CH2]OC([CH2])C=C(28855)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[CH2]C=CO[CH2](29071)'],
    products = ['[CH2]OC([CH2])C=C(28855)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]C(C=C)O[CH2](29105)'],
    products = ['[CH2]OC([CH2])C=C(28855)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]OC([CH2])C=C(5912)'],
    products = ['[CH2]OC([CH2])C=C(28855)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2]C[C]([CH2])O[CH2](29107)'],
    products = ['[CH2]OC([CH2])C=C(28855)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH2]OC(=C)C=C(29110)'],
    products = ['[CH2]OC([CH2])C=C(28855)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(4660,'cm^3/(mol*s)'), n=3.17, Ea=(70.0756,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Estimated using template [Od_CO-HH;YJ] for rate rule [Od_CO-HH;CJ]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 67.9 to 70.1 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction16',
    reactants = ['C2H3(60)', 'CH2OCHCH2(5571)'],
    products = ['[CH2]OC([CH2])C=C(28855)'],
...
reaction(
    label = 'reaction18',
    reactants = ['C2H3(60)', '[CH2][CH]O[CH2](1565)'],
    products = ['[CH2]OC([CH2])C=C(28855)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH2]O[C]([CH2])C=C(29111)'],
    products = ['[CH2]OC([CH2])C=C(28855)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH2]OC([CH2])[C]=C(29112)'],
    products = ['[CH2]OC([CH2])C=C(28855)'],
...
reaction(
    label = 'reaction21',
    reactants = ['H(3)', '[CH]=CC([CH2])O[CH2](28903)'],
    products = ['[CH2]OC([CH2])C=C(28855)'],
...
network(
    label = 'PDepNetwork #7663',
    isomers = [
        '[CH2]OC([CH2])C=C(28855)',
    ],
    reactants = [
