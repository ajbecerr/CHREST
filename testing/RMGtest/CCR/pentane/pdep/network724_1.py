...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48895,0.048652,-4.76951e-05,2.66307e-08,-5.71798e-12,-5923.48,20.856], Tmin=(100,'K'), Tmax=(1343.83,'K')), NASAPolynomial(coeffs=[9.56339,0.016767,-3.34134e-06,2.79617e-10,-6.9754e-15,-7384.73,-17.8471], Tmin=(1343.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-50.0495,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(249.434,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cds-OdCsH) + ring(Ethylene_oxide) + radical(CCCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.50645,0.0428305,-1.18558e-05,-2.13741e-08,1.23357e-11,-17668.2,21.4923], Tmin=(100,'K'), Tmax=(999.453,'K')), NASAPolynomial(coeffs=[16.4135,0.0104701,-4.26216e-06,8.91266e-10,-7.00284e-14,-22011.5,-57.239], Tmin=(999.453,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-147.737,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-(Cds-O2d)(Cds-Cds)HH) + group(Cds-CdsCsOs) + group(Cds-OdCsH) + group(Cds-CdsHH) + radical(CCCJ=O)"""),
)
...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.09403,0.0684213,-0.000104179,8.46025e-08,-2.6798e-11,-8431.98,22.2011], Tmin=(100,'K'), Tmax=(877.35,'K')), NASAPolynomial(coeffs=[9.69073,0.0210005,-9.03925e-06,1.62115e-09,-1.07071e-13,-9623.82,-16.3437], Tmin=(877.35,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-70.9418,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + missing(O2d-Cdd) + group(Cs-(Cds-Cdd-O2d)CsOsH) + group(Cs-CsHHH) + group(Cds-(Cdd-O2d)CsH) + missing(Cdd-CdO2d) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.04301,0.0733371,-0.000126314,1.12552e-07,-3.80305e-11,17971.5,25.4843], Tmin=(100,'K'), Tmax=(886.323,'K')), NASAPolynomial(coeffs=[7.84818,0.0239161,-1.10117e-05,2.00887e-09,-1.32705e-13,17500,-2.37994], Tmin=(886.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(148.604,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(C2CsJOH) + radical(CJCO) + radical(CCCJ=O)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['O(4)', '[CH2][CH]C[C]=O(2359)'],
    products = ['[CH2]C([O])C[C]=O(2323)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['[C]=O(2355)', '[CH2]C([CH2])[O](1366)'],
    products = ['[CH2]C([O])C[C]=O(2323)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C([O])C[C]=O(2828)'],
    products = ['[CH2]C([O])C[C]=O(2323)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction16',
    reactants = ['CO(2039)', '[CH2]C([CH2])[O](1366)'],
    products = ['[CH2]C([O])C[C]=O(2323)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', 'C=C([O])C[C]=O(2344)'],
    products = ['[CH2]C([O])C[C]=O(2323)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH2]C([O])C=C=O(2834)'],
    products = ['[CH2]C([O])C[C]=O(2323)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(20)', 'O=[C]CC=O(2835)'],
    products = ['[CH2]C([O])C[C]=O(2323)'],
