...
species(
    label = '[CH2]C([CH2])[CH]C([CH2])C(4082)',
    structure = SMILES('[CH2]C([CH2])[CH]C([CH2])C'),
    E0 = (582.756,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.478804,0.0735456,-5.73644e-05,2.68911e-08,-5.3752e-12,70219.3,35.6228], Tmin=(100,'K'), Tmax=(1173.54,'K')), NASAPolynomial(coeffs=[10.3807,0.0397952,-1.42252e-05,2.38451e-09,-1.54548e-13,67895.3,-13.7325], Tmin=(1173.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(582.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(Isobutyl) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2][C]C(C)C([CH2])[CH2](4083)',
...
species(
    label = '[CH][CH]C(C)C([CH2])[CH2](4085)',
    structure = SMILES('[CH][CH]C(C)C([CH2])[CH2]'),
    E0 = (829.236,'kJ/mol'),
    modes = [
...
species(
    label = '[CH2][CH]C(C)C1CC1(4086)',
    structure = SMILES('[CH2][CH]C(C)C1CC1'),
    E0 = (332.004,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11839,0.047643,2.55039e-05,-6.03947e-08,2.45378e-11,40048.4,30.0183], Tmin=(100,'K'), Tmax=(1008.26,'K')), NASAPolynomial(coeffs=[13.1001,0.0373428,-1.45656e-05,2.72578e-09,-1.94596e-13,35739.7,-37.2702], Tmin=(1008.26,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(332.004,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(440.667,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Cs_S) + radical(RCCJ)"""),
)

species(
    label = '[CH2]C1CC([CH2])C1C(4087)',
    structure = SMILES('[CH2]C1CC([CH2])C1C'),
    E0 = (325.572,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
...
species(
    label = '[CH2]C[C](C)C([CH2])[CH2](4094)',
    structure = SMILES('[CH2]C[C](C)C([CH2])[CH2]'),
    E0 = (577.147,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.584348,0.0789203,-8.25247e-05,5.9668e-08,-1.8791e-11,69534.2,33.8328], Tmin=(100,'K'), Tmax=(840.351,'K')), NASAPolynomial(coeffs=[6.16113,0.0479985,-1.95178e-05,3.48565e-09,-2.33261e-13,68751.4,8.81754], Tmin=(840.351,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(577.147,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Isobutyl) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
species(
    ...
    molecularWeight = (96.1702,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.58437,0.07892,-8.25236e-05,5.96663e-08,-1.87902e-11,69534.2,33.8327], Tmin=(100,'K'), Tmax=(840.375,'K')), NASAPolynomial(coeffs=[6.16108,0.0479985,-1.95178e-05,3.48566e-09,-2.33262e-13,68751.4,8.81779], Tmin=(840.375,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(577.147,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(RCCJ) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', '[CH2][CH]CC([CH2])[CH2](484)'],
    products = ['[CH2][CH]C(C)C([CH2])[CH2](1265)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2][CH]C(C)C([CH2])[CH2](1265)'],
    products = ['[CH2]C([CH2])[CH]C([CH2])C(4082)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction7',
    reactants = ['[CH][CH2](502)', '[CH2]C([CH2])[CH]C(500)'],
    products = ['[CH2][CH]C(C)C([CH2])[CH2](1265)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(T)(20)', '[CH2][CH]C(C)[CH][CH2](3858)'],
    products = ['[CH2][CH]C(C)C([CH2])[CH2](1265)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH2][C]C(C)C([CH2])[CH2](4083)'],
    products = ['[CH2][CH]C(C)C([CH2])[CH2](1265)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]C([CH2])C(C)[CH][CH2](4084)'],
    products = ['[CH2][CH]C(C)C([CH2])[CH2](1265)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH][CH]C(C)C([CH2])[CH2](4085)'],
    products = ['[CH2][CH]C(C)C([CH2])[CH2](1265)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH2][CH]C(C)C([CH2])[CH2](1265)'],
    products = ['[CH2][CH]C(C)C1CC1(4086)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH2][CH]C(C)C([CH2])[CH2](1265)'],
    products = ['[CH2]C1CC([CH2])C1C(4087)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][CH]C(C)C([CH2])[CH2](1265)'],
    products = ['[CH2]CC(C)C([CH2])=C(4088)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2]C=C(C)C([CH2])[CH2](4089)'],
    products = ['[CH2][CH]C(C)C([CH2])[CH2](1265)'],
...
reaction(
    label = 'reaction19',
    reactants = ['CH2(T)(20)', '[CH2][CH]C(C)C=C(3805)'],
    products = ['[CH2][CH]C(C)C([CH2])[CH2](1265)'],
...
reaction(
    label = 'reaction21',
    reactants = ['CH3(17)', '[CH2]C=CC([CH2])[CH2](644)'],
    products = ['[CH2][CH]C(C)C([CH2])[CH2](1265)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH3(17)', '[CH2][CH][CH]C([CH2])[CH2](646)'],
    products = ['[CH2][CH]C(C)C([CH2])[CH2](1265)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH2][CH][C](C)C([CH2])[CH2](4091)'],
    products = ['[CH2][CH]C(C)C([CH2])[CH2](1265)'],
...
reaction(
    label = 'reaction26',
    reactants = ['H(3)', '[CH2][CH]C(C)[C]([CH2])[CH2](4092)'],
    products = ['[CH2][CH]C(C)C([CH2])[CH2](1265)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH2][CH]C(C)C([CH2])[CH2](1265)'],
    products = ['[CH2]C[C](C)C([CH2])[CH2](4094)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2][CH]C(C)C([CH2])[CH2](1265)'],
    products = ['[CH2]CC(C)[C]([CH2])[CH2](4095)'],
