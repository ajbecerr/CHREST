...
species(
    ...
    molecularWeight = (40.0639,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.2682,0.0145834,-2.57846e-06,-2.47618e-09,9.20182e-13,67888.2,10.179], Tmin=(100,'K'), Tmax=(1414.3,'K')), NASAPolynomial(coeffs=[5.34238,0.0129708,-5.37978e-06,9.70945e-10,-6.50756e-14,66876.1,-2.05072], Tmin=(1414.3,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(564.226,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(153.818,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CdCdJ2_triplet)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C=C(53)'],
    products = ['[CH]1CC1(193)'],
