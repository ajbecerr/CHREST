species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(0.285372,'amu*angstrom^2'), symmetry=1, barrier=(6.56125,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.28697,0.0467831,-8.37213e-05,8.62235e-08,-3.3024e-11,3999.82,19.0503], Tmin=(100,'K'), Tmax=(862.498,'K')), NASAPolynomial(coeffs=[1.3677,0.0289088,-1.41352e-05,2.67828e-09,-1.82206e-13,4981.8,28.1227], Tmin=(862.498,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(32.8163,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(ROOJ)"""),
)
...
species(
    label = 'C1COOO1(3728)',
    structure = SMILES('C1COOO1'),
    E0 = (-49.3417,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.7078,0.0164321,4.2497e-05,-7.72369e-08,3.5432e-11,-5876.37,11.8228], Tmin=(100,'K'), Tmax=(861.606,'K')), NASAPolynomial(coeffs=[12.2735,0.00575096,2.37445e-06,-7.59371e-10,5.89904e-14,-8776.66,-40.1664], Tmin=(861.606,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-49.3417,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(207.862,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(O2s-OsOs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + ring(123trioxolane)"""),
)

species(
    label = 'C1COO1(3729)',
    structure = SMILES('C1COO1'),
    E0 = (-15.7111,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
...
species(
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.24397,0.0365519,-2.87429e-05,1.12806e-08,-1.79597e-12,-30202.4,17.0939], Tmin=(100,'K'), Tmax=(1463.68,'K')), NASAPolynomial(coeffs=[10.0749,0.015151,-6.81058e-06,1.29088e-09,-8.96777e-14,-32494.7,-23.6687], Tmin=(1463.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-251.655,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH)"""),
)
...
species(
    label = '[O][CH]CO[O](1386)',
    structure = SMILES('[O][CH]CO[O]'),
    E0 = (213.114,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,180,2126.13],'cm^-1')),
        HinderedRotor(inertia=(0.316726,'amu*angstrom^2'), symmetry=1, barrier=(7.28214,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.316964,'amu*angstrom^2'), symmetry=1, barrier=(7.28763,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (75.0434,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.04239,0.055216,-0.000113758,1.16797e-07,-4.33598e-11,25690.6,19.478], Tmin=(100,'K'), Tmax=(883.941,'K')), NASAPolynomial(coeffs=[1.9024,0.025857,-1.30417e-05,2.45227e-09,-1.64023e-13,26887.1,26.764], Tmin=(883.941,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(213.114,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(ROOJ) + radical(CCsJOH)"""),
)

species(
    label = '[O]OC[CH]O(3730)',
    structure = SMILES('[O]OC[CH]O'),
    E0 = (-12.5909,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,180],'cm^-1')),
        HinderedRotor(inertia=(0.305339,'amu*angstrom^2'), symmetry=1, barrier=(7.02034,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305196,'amu*angstrom^2'), symmetry=1, barrier=(7.01706,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.305578,'amu*angstrom^2'), symmetry=1, barrier=(7.02585,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.69172,0.0578181,-0.000100913,9.09147e-08,-3.08688e-11,-1437.9,19.8767], Tmin=(100,'K'), Tmax=(893.409,'K')), NASAPolynomial(coeffs=[6.58164,0.0194605,-8.86849e-06,1.60363e-09,-1.05112e-13,-1654.56,0.514153], Tmin=(893.409,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-12.5909,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(ROOJ) + radical(CCsJOH)"""),
)

species(
    label = '[O]C[CH]OO(3731)',
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.01102,0.0533099,-9.66068e-05,9.80541e-08,-3.73744e-11,8408.57,19.4306], Tmin=(100,'K'), Tmax=(849.765,'K')), NASAPolynomial(coeffs=[2.23715,0.0297013,-1.51381e-05,2.91917e-09,-2.0076e-13,9184.1,23.1657], Tmin=(849.765,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(69.3941,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCsJOOH)"""),
)

species(
    label = '[O]O[CH]CO(3732)',
    ...
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.9269,0.0522707,-8.81678e-05,8.08126e-08,-2.81782e-11,-449.642,19.6324], Tmin=(100,'K'), Tmax=(879.653,'K')), NASAPolynomial(coeffs=[5.2857,0.0217193,-1.00185e-05,1.84058e-09,-1.22631e-13,-449.456,7.21869], Tmin=(879.653,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-4.30631,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(ROOJ) + radical(CCsJOOH)"""),
)
...
species(
    ...
    E0 = (61.1095,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,180,1219.32],'cm^-1')),
        HinderedRotor(inertia=(0.267699,'amu*angstrom^2'), symmetry=1, barrier=(6.15492,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.268107,'amu*angstrom^2'), symmetry=1, barrier=(6.1643,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.35814,'amu*angstrom^2'), symmetry=1, barrier=(54.2183,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (76.0514,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.77789,0.0588248,-0.000109188,1.07849e-07,-3.98778e-11,7420.23,19.6679], Tmin=(100,'K'), Tmax=(859.718,'K')), NASAPolynomial(coeffs=[3.55222,0.0274098,-1.39692e-05,2.67776e-09,-1.8287e-13,7971.02,16.3537], Tmin=(859.718,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(61.1095,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-CsH) + group(O2s-OsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['O(4)', '[O]CC[O](3602)'],
    products = ['[O]CCO[O](1437)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', 'vinoxyperoxy(1385)'],
    products = ['[O]CCO[O](1437)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2O(3111)', '[CH2]O[O](46)'],
    products = ['[O]CCO[O](1437)'],
    transitionState = 'TS8',
    kinetics = Arrhenius(A=(0.0976671,'m^3/(mol*s)'), n=1.99293, Ea=(23.8335,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [CO-HH_O;CsJ] for rate rule [CO-HH_O;CsJ-OsHH]
Euclidian distance = 1.0
family: R_Addition_MultipleBond"""),
)
...
reaction(
    label = 'reaction10',
    reactants = ['[CH2][O](3109)', '[CH2]O[O](46)'],
    products = ['[O]CCO[O](1437)'],
