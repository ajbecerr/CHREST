species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.0289,0.021527,-1.29599e-05,4.29879e-09,-6.28486e-13,-4744.45,11.8007], Tmin=(100,'K'), Tmax=(1456.27,'K')), NASAPolynomial(coeffs=[5.53911,0.0146321,-5.85798e-06,1.04758e-09,-7.03445e-14,-5475.56,-1.2531], Tmin=(1456.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-39.7356,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), label="""CH2CH2OH""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
species(
    ...
    E0 = (198.581,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,638.928,647.354,2474.63],'cm^-1')),
        HinderedRotor(inertia=(0.0120969,'amu*angstrom^2'), symmetry=1, barrier=(3.55683,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152184,'amu*angstrom^2'), symmetry=1, barrier=(3.49901,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (44.0526,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.18088,0.0137073,6.12564e-06,-1.60867e-08,6.72422e-12,23917.1,12.3502], Tmin=(100,'K'), Tmax=(998.55,'K')), NASAPolynomial(coeffs=[6.71386,0.00983431,-3.49805e-06,6.47718e-10,-4.65413e-14,22699,-7.25542], Tmin=(998.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(198.581,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['OH(5)', 'C2H4(22)'],
    products = ['CH2CH2OH(429)'],
    transitionState = 'TS1',
