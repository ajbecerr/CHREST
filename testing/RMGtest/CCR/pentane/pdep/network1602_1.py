...
species(
    label = '[CH][C]OC([CH2])[CH2](7226)',
    structure = SMILES('[CH][C]OC([CH2])[CH2]'),
    E0 = (1022.52,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00647086,0.095884,-0.000163653,1.38897e-07,-4.50382e-11,123117,25.7672], Tmin=(100,'K'), Tmax=(876.353,'K')), NASAPolynomial(coeffs=[12.7162,0.0221498,-1.05358e-05,1.94428e-09,-1.29223e-13,121493,-30.4278], Tmin=(876.353,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1022.52,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CH2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]OC1CC1(7227)',
    structure = SMILES('[CH][CH]OC1CC1'),
    E0 = (481.471,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.18359,0.0510021,-1.90114e-05,-1.68277e-08,1.14458e-11,58018.9,22.9972], Tmin=(100,'K'), Tmax=(971.844,'K')), NASAPolynomial(coeffs=[15.5952,0.017091,-5.88356e-06,1.06595e-09,-7.67944e-14,54017.9,-52.2917], Tmin=(971.844,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(481.471,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CCsJOCs) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.828634,0.0600393,-3.94369e-05,-7.64179e-10,7.27658e-12,45806.4,23.0713], Tmin=(100,'K'), Tmax=(946.282,'K')), NASAPolynomial(coeffs=[17.2025,0.0143372,-4.2611e-06,7.10592e-10,-4.98036e-14,41654.9,-60.5811], Tmin=(946.282,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(379.833,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsOs) + group(Cds-CdsHH) + radical(C=C(O)CJ) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][CH]O[C]([CH2])[CH2](7230)',
    structure = SMILES('[CH][CH]O[C]([CH2])[CH2]'),
    E0 = (922.691,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,3025,407.5,1350,352.5,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (82.1005,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.209143,0.108011,-0.000209642,1.92561e-07,-6.50572e-11,111111,27.2002], Tmin=(100,'K'), Tmax=(909.419,'K')), NASAPolynomial(coeffs=[9.74158,0.0263605,-1.24821e-05,2.22337e-09,-1.41338e-13,110868,-11.2486], Tmin=(909.419,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(922.691,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CCsJOCs) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]CO[C]([CH2])[CH2](7231)',
    structure = SMILES('[CH]CO[C]([CH2])[CH2]'),
    E0 = (742.235,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.109111,0.100801,-0.00018986,1.78213e-07,-6.20094e-11,89396,26.6119], Tmin=(100,'K'), Tmax=(893.252,'K')), NASAPolynomial(coeffs=[6.95301,0.0337585,-1.61619e-05,2.96251e-09,-1.94728e-13,89625.3,2.49413], Tmin=(893.252,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(742.235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(286.849,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + longDistanceInteraction_noncyclic(OsCs-ST) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CsJOCs) + radical(CJC(C)OC) + radical(CJC(C)OC) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH][CH]OC([CH2])[CH2](1860)'],
...
reaction(
    label = 'reaction2',
    reactants = ['[CH][CH](6981)', '[CH2]C([CH2])[O](1366)'],
    products = ['[CH][CH]OC([CH2])[CH2](1860)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(20)', '[CH][CH]O[CH][CH2](6987)'],
    products = ['[CH][CH]OC([CH2])[CH2](1860)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH][CH]OC([CH])[CH2](7225)'],
    products = ['[CH][CH]OC([CH2])[CH2](1860)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH][C]OC([CH2])[CH2](7226)'],
    products = ['[CH][CH]OC([CH2])[CH2](1860)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['CH2(T)(20)', '[CH][CH]OC=C(6927)'],
    products = ['[CH][CH]OC([CH2])[CH2](1860)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(1.41198,'m^3/(mol*s)'), n=2.03228, Ea=(107.53,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
...
reaction(
    label = 'reaction14',
    reactants = ['H(3)', '[CH][CH]O[C]([CH2])[CH2](7230)'],
    products = ['[CH][CH]OC([CH2])[CH2](1860)'],
