species(
    label = 'ketenylperoxy(9541)',
    structure = SMILES('[O]OC=C=O'),
    E0 = (63.7216,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,3010,987.5,1337.5,450,1655,2120,512.5,787.5],'cm^-1')),
        HinderedRotor(inertia=(0.892098,'amu*angstrom^2'), symmetry=1, barrier=(20.5111,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0275,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46746,0.035924,-5.52509e-05,4.42277e-08,-1.39772e-11,7717.02,15.4679], Tmin=(100,'K'), Tmax=(798.691,'K')), NASAPolynomial(coeffs=[7.55929,0.00970829,-4.67345e-06,8.90217e-10,-6.13027e-14,6926.46,-7.80994], Tmin=(798.691,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(63.7216,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), label="""ketenylperoxy""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
species(
    ...
    molecularWeight = (73.0275,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.35983,-0.0090567,0.000109383,-1.42073e-07,5.48615e-11,-14939.4,12.7753], Tmin=(100,'K'), Tmax=(947.27,'K')), NASAPolynomial(coeffs=[15.254,-8.80039e-05,1.44771e-06,-1.43435e-10,-5.76642e-15,-19848.6,-57.9808], Tmin=(947.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-124.581,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-O2s(Cds-O2d)) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsOs) + ring(Cyclobutane) + radical(OCJC=O)"""),
)

species(
    label = '[C]1=COOO1(10709)',
    structure = SMILES('[C]1=COOO1'),
    E0 = (323.945,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (73.0275,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.79432,-0.017963,0.000120184,-1.52476e-07,5.97675e-11,38989.9,17.7316], Tmin=(100,'K'), Tmax=(920.246,'K')), NASAPolynomial(coeffs=[14.2393,-0.00548471,5.50151e-06,-1.04911e-09,6.24261e-14,34616.8,-45.1071], Tmin=(920.246,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(323.945,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(133.032,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(O2s-OsOs) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + ring(Cyclopentane) + radical(C=CJO)"""),
)

species(
    label = 'O=[C]C1OO1(10710)',
    structure = SMILES('O=[C]C1OO1'),
    E0 = (11.0709,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (73.0275,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.03677,0.00989293,3.45584e-05,-6.03316e-08,2.65163e-11,1376.78,15.5742], Tmin=(100,'K'), Tmax=(905.94,'K')), NASAPolynomial(coeffs=[12.0969,-0.000420266,2.47574e-06,-5.47519e-10,3.57939e-14,-1483.16,-33.9647], Tmin=(905.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(11.0709,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(128.874,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsOsOsH) + group(Cds-OdCsH) + ring(dioxirane) + radical(CsCJ=O)"""),
)
...
species(
    label = 'O=C=[C]OO(10712)',
    structure = SMILES('O=C=[C]OO'),
    E0 = (170.279,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1685,370,2120,512.5,787.5],'cm^-1')),
        HinderedRotor(inertia=(0.315569,'amu*angstrom^2'), symmetry=1, barrier=(7.25554,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.868688,'amu*angstrom^2'), symmetry=1, barrier=(19.9728,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (73.0275,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.46274,0.0384976,-6.9149e-05,6.29591e-08,-2.17152e-11,20530.7,18.5714], Tmin=(100,'K'), Tmax=(869.14,'K')), NASAPolynomial(coeffs=[6.00754,0.0120553,-6.03418e-06,1.13985e-09,-7.68891e-14,20297,4.16759], Tmin=(869.14,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(170.279,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(124.717,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + missing(O2d-Cdd) + group(Cds-(Cdd-O2d)OsH) + missing(Cdd-CdO2d) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['O2(2)', 'HCCO(2227)'],
    products = ['ketenylperoxy(9541)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction4',
    reactants = ['ketenylperoxy(9541)'],
    products = ['O=C1[CH]OO1(10708)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['ketenylperoxy(9541)'],
    products = ['[C]1=COOO1(10709)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(6.44463e+09,'s^-1'), n=0.470283, Ea=(260.224,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [R5_linear;multiplebond_intra;radadd_intra] for rate rule [R5_linear;multiplebond_intra;radadd_intra_O]
Euclidian distance = 1.0
family: Intra_R_Add_Endocyclic
Ea raised from 253.3 to 260.2 kJ/mol to match endothermicity of reaction."""),
)

reaction(
    label = 'reaction6',
    reactants = ['ketenylperoxy(9541)'],
    products = ['O=[C]C1OO1(10710)'],
    transitionState = 'TS6',
