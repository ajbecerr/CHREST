...
species(
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.437877,0.105004,-0.000127632,1.02633e-07,-3.48133e-11,29244.6,40.5594], Tmin=(100,'K'), Tmax=(819.021,'K')), NASAPolynomial(coeffs=[6.75091,0.0597256,-2.60837e-05,4.81452e-09,-3.27797e-13,28408.1,9.395], Tmin=(819.021,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(241.884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(RCCJCC) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C([CH]CCC)CO[O](924)',
    structure = SMILES('[CH2]C([CH]CCC)CO[O]'),
    E0 = (241.968,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.310736,0.10085,-0.000105404,7.0485e-08,-2.05604e-11,29251.8,40.11], Tmin=(100,'K'), Tmax=(812.37,'K')), NASAPolynomial(coeffs=[8.49986,0.0574662,-2.52965e-05,4.74351e-09,-3.28396e-13,27820.3,-0.564908], Tmin=(812.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(241.968,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(Cs_S) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH]CCO[O])CC(925)',
    structure = SMILES('[CH2]C([CH]CCO[O])CC'),
    E0 = (245.315,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
...
species(
    label = '[CH2]C(CC)C([CH2])C[O](926)',
    structure = SMILES('[CH2]C(CC)C([CH2])C[O]'),
    E0 = (252.356,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1200,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.254971,0.0857672,-7.51765e-05,4.27728e-08,-1.08873e-11,30483.3,36.3601], Tmin=(100,'K'), Tmax=(912.505,'K')), NASAPolynomial(coeffs=[7.61333,0.0535124,-2.21567e-05,4.03813e-09,-2.75429e-13,29140.4,1.53385], Tmin=(912.505,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(252.356,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(482.239,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH]CO[O])CC(927)',
    structure = SMILES('[CH2]C([CH]CO[O])CC'),
    E0 = (274.968,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (115.15,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.107877,0.0901171,-9.918e-05,6.77262e-08,-1.9659e-11,33207,36.1054], Tmin=(100,'K'), Tmax=(825.179,'K')), NASAPolynomial(coeffs=[9.10629,0.0464977,-1.98887e-05,3.66595e-09,-2.50898e-13,31722,-5.57757], Tmin=(825.179,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(274.968,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(ROOJ) + radical(CCJCOOH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH]C(CO[O])C([CH2])CC(928)',
    structure = SMILES('[CH]C(CO[O])C([CH2])CC'),
    E0 = (493.293,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([492.5,1135,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'CCC1CCC1CO[O](930)',
    structure = SMILES('CCC1CCC1CO[O]'),
    E0 = (-11.8685,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0298436,0.0729912,-1.02514e-05,-3.2462e-08,1.58024e-11,-1268.89,33.3435], Tmin=(100,'K'), Tmax=(1039.94,'K')), NASAPolynomial(coeffs=[16.0142,0.0447413,-1.77685e-05,3.2973e-09,-2.32015e-13,-6415.28,-53.3878], Tmin=(1039.94,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-11.8685,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(ROOJ)"""),
)

species(
    label = '[CH2]C(CC)C1COOC1(931)',
    structure = SMILES('[CH2]C(CC)C1COOC1'),
    E0 = (-29.1949,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.00422544,0.0707736,1.02627e-05,-7.03022e-08,3.56496e-11,-3351.44,32.8035], Tmin=(100,'K'), Tmax=(900.518,'K')), NASAPolynomial(coeffs=[18.159,0.0363907,-9.51832e-06,1.38552e-09,-8.84858e-14,-8496.8,-63.2944], Tmin=(900.518,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-29.1949,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(515.497,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxolane) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C1COOCC1CC(932)',
    structure = SMILES('[CH2]C1COOCC1CC'),
    E0 = (-40.7969,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.133684,0.0643084,3.37682e-05,-9.73769e-08,4.58634e-11,-4748.14,29.7506], Tmin=(100,'K'), Tmax=(903.829,'K')), NASAPolynomial(coeffs=[19.3586,0.034414,-8.20881e-06,1.14257e-09,-7.35109e-14,-10477.5,-73.5246], Tmin=(903.829,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-40.7969,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(519.654,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(12dioxane) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(CC)C1COC1(933)',
    structure = SMILES('[CH2]C(CC)C1COC1'),
    E0 = (-1.09392,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.178,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.59264,0.0609984,1.55315e-05,-6.60732e-08,3.23625e-11,4.2356,29.213], Tmin=(100,'K'), Tmax=(891.783,'K')), NASAPolynomial(coeffs=[14.2182,0.0381833,-1.05161e-05,1.55965e-09,-9.86778e-14,-3948.96,-43.5008], Tmin=(891.783,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-1.09392,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(490.554,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C1COCC1CC(934)',
    structure = SMILES('[CH2]C1COCC1CC'),
    E0 = (-82.9035,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (113.178,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.928071,0.0493788,5.00145e-05,-1.01908e-07,4.4969e-11,-9843.37,25.8079], Tmin=(100,'K'), Tmax=(901.729,'K')), NASAPolynomial(coeffs=[14.5462,0.0371107,-9.65874e-06,1.41469e-09,-9.12826e-14,-14256.5,-49.3355], Tmin=(901.729,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-82.9035,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(494.711,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.335084,0.0939462,-7.41249e-05,3.19036e-08,-5.77397e-12,-4907.45,35.5289], Tmin=(100,'K'), Tmax=(1277.29,'K')), NASAPolynomial(coeffs=[14.3561,0.0479388,-2.00954e-05,3.70349e-09,-2.54424e-13,-8660.41,-38.9428], Tmin=(1277.29,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-42.1082,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(507.183,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.502949,0.0981105,-8.27208e-05,3.87177e-08,-7.59984e-12,2150.47,37.5407], Tmin=(100,'K'), Tmax=(1192.06,'K')), NASAPolynomial(coeffs=[14.3322,0.0483305,-2.00814e-05,3.68622e-09,-2.53007e-13,-1386.41,-36.6368], Tmin=(1192.06,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(16.5263,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)OsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]C(COO)C(=C)CC(938)',
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.686546,0.100437,-8.60573e-05,4.03578e-08,-7.84309e-12,1490.17,37.8155], Tmin=(100,'K'), Tmax=(1213.03,'K')), NASAPolynomial(coeffs=[15.7843,0.0461238,-1.88951e-05,3.44618e-09,-2.35753e-13,-2505.74,-44.8275], Tmin=(1213.03,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(10.9694,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(503.026,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + longDistanceInteraction_noncyclic(CdCs-ST) + group(Cds-CdsHH) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]C([CH]OO)C([CH2])CC(948)',
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.803435,0.108488,-0.000112047,6.77571e-08,-1.71018e-11,34657.2,40.2083], Tmin=(100,'K'), Tmax=(949.058,'K')), NASAPolynomial(coeffs=[12.8589,0.0509042,-2.10349e-05,3.82437e-09,-2.60453e-13,32064,-24.9898], Tmin=(949.058,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(286.738,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCsJOOH) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2][C](COO)C([CH2])CC(956)',
    structure = SMILES('[CH2][C](COO)C([CH2])CC'),
    E0 = (289.067,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1310,387.5,850,1000,1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.272949,0.0932078,-7.56657e-05,3.51942e-08,-6.97357e-12,34921.1,42.9892], Tmin=(100,'K'), Tmax=(1172.72,'K')), NASAPolynomial(coeffs=[12.4479,0.0498182,-2.01667e-05,3.644e-09,-2.47653e-13,31937.5,-20.4082], Tmin=(1172.72,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(289.067,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(C2CJCOOH) + radical(Isobutyl) + radical(Isobutyl)"""),
)

species(
    label = '[CH2]CC([CH2])C(C)CO[O](957)',
...
species(
    ...
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.871319,0.115083,-0.000149542,1.2072e-07,-3.99688e-11,34274.4,41.4284], Tmin=(100,'K'), Tmax=(842.616,'K')), NASAPolynomial(coeffs=[8.66159,0.0574137,-2.47773e-05,4.52114e-09,-3.04809e-13,33108.7,-0.314447], Tmin=(842.616,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(283.579,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Tertalkyl) + radical(Isobutyl) + radical(Isobutyl)"""),
)
...
species(
    label = '[CH2]CC([CH2])C([CH2])COO(960)',
    structure = SMILES('[CH2]CC([CH2])C([CH2])COO'),
    E0 = (303.402,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (129.177,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.779651,0.10664,-0.000106414,6.12468e-08,-1.46571e-11,36661.7,41.7572], Tmin=(100,'K'), Tmax=(999.712,'K')), NASAPolynomial(coeffs=[13.6151,0.049045,-1.99969e-05,3.61926e-09,-2.46155e-13,33783.6,-27.6849], Tmin=(999.712,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(303.402,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(498.868,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCs) + group(O2s-OsH) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsCsH) + longDistanceInteraction_noncyclic(CsCs-TT) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl) + radical(Isobutyl) + radical(RCCJ)"""),
)
...
reaction(
    ...
    products = ['allylperoxy(462)', 'butene1(35)'],
    transitionState = 'TS1',
...
reaction(
    ...
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]C(CC)C([CH2])CO[O](723)'],
    products = ['[CH2]C(C[CH]CC)CO[O](721)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(CC)C([CH2])CO[O](723)'],
    products = ['[CH2]C([CH]CCC)CO[O](924)'],
    transitionState = 'TS4',
    kinetics = Arrhenius(A=(6.55606e+10,'s^-1'), n=0.64, Ea=(159.935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [cCs(-HC)CJ;CsJ;C] for rate rule [cCs(-HC)CJ;CsJ-HH;C]
Euclidian distance = 1.0
family: 1,2_shiftC"""),
...
reaction(
    label = 'reaction5',
    reactants = ['[CH2]C(CC)C([CH2])CO[O](723)'],
    products = ['[CH2]C(CC)C[CH]CO[O](722)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(6.55606e+10,'s^-1'), n=0.64, Ea=(159.935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [cCs(-HC)CJ;CsJ;C] for rate rule [cCs(-HC)CJ;CsJ-HH;C]
Euclidian distance = 1.0
family: 1,2_shiftC"""),
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C(CC)C([CH2])CO[O](723)'],
    products = ['[CH2]C([CH]CCO[O])CC(925)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(6.55606e+10,'s^-1'), n=0.64, Ea=(159.935,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [cCs(-HC)CJ;CsJ;C] for rate rule [cCs(-HC)CJ;CsJ-HH;C]
Euclidian distance = 1.0
family: 1,2_shiftC"""),
...
reaction(
    label = 'reaction7',
    reactants = ['O(4)', '[CH2]C(CC)C([CH2])C[O](926)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['CH2(T)(20)', '[CH2]C([CH]CC)CO[O](814)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['CH2(T)(20)', '[CH2]C([CH]CO[O])CC(927)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H/NonDeC;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH]C(CO[O])C([CH2])CC(928)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH]C(CC)C([CH2])CO[O](929)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]C(CC)C([CH2])CO[O](723)'],
    products = ['O(4)', '[CH2]C(CC)C1COC1(933)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2]C(CC)C([CH2])CO[O](723)'],
    products = ['O(4)', '[CH2]C1COCC1CC(934)'],
...
reaction(
    label = 'reaction17',
    reactants = ['[CH2]C(CC)C([CH2])CO[O](723)'],
    products = ['HO2(9)', '[CH2]C(=C)C([CH2])CC(567)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', '[CH2]C(CO[O])C(=C)CC(939)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction23',
    reactants = ['H(3)', '[CH2]C(CC)C(=C)CO[O](940)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction24',
    reactants = ['[CH2][CH]CO[O](461)', 'butene1(35)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C2H5(14)', '[CH2]C(C=C)CO[O](776)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction26',
    reactants = ['allylperoxy(462)', '[CH2][CH]CC(37)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction27',
    reactants = ['[CH2]O[O](46)', '[CH2]C(C=C)CC(228)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction28',
    reactants = ['O2(2)', '[CH2]C([CH2])C([CH2])CC(263)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction29',
    reactants = ['[CH2][CH]CO[O](461)', '[CH2][CH]CC(37)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction30',
    reactants = ['C2H5(14)', '[CH2][CH]C([CH2])CO[O](778)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', '[CH2][C](CC)C([CH2])CO[O](941)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH2]O[O](46)', '[CH2][CH]C([CH2])CC(231)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', '[CH2][C](CO[O])C([CH2])CC(942)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction34',
    reactants = ['CH3(17)', '[CH2]C([CH2])C([CH2])CO[O](744)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction36',
    reactants = ['H(3)', '[CH2]C([CH]O[O])C([CH2])CC(944)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction37',
    reactants = ['H(3)', '[CH2]CC([CH2])C([CH2])CO[O](945)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH2]C(CC)C([CH2])CO[O](723)'],
    products = ['[CH2]C(CC)[C](C)CO[O](947)'],
...
reaction(
    label = 'reaction40',
    reactants = ['[CH2]C(CC)C([CH2])CO[O](723)'],
    products = ['[CH2]C([CH]OO)C([CH2])CC(948)'],
...
reaction(
    label = 'reaction43',
    reactants = ['[CH2]C(CC)C([CH2])CO[O](723)'],
    products = ['[CH2][C](CC)C(C)CO[O](951)'],
...
reaction(
    label = 'reaction44',
    reactants = ['[CH2]C(CC)C([CH2])CO[O](723)'],
    products = ['[CH2]C(CC)C(C)[CH]O[O](952)'],
...
reaction(
    label = 'reaction45',
    reactants = ['[CH2]C(CC)C([CH2])CO[O](723)'],
    products = ['[CH2]C([CH]C)C(C)CO[O](953)'],
...
reaction(
    label = 'reaction47',
    reactants = ['[CH2]CC(C)C([CH2])CO[O](955)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction48',
    reactants = ['[CH2][C](COO)C([CH2])CC(956)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction49',
    reactants = ['[CH2]CC([CH2])C(C)CO[O](957)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction50',
    reactants = ['[CH2][C](CC)C([CH2])COO(958)'],
    products = ['[CH2]C(CC)C([CH2])CO[O](723)'],
...
reaction(
    label = 'reaction52',
    reactants = ['[CH2]C(CC)C([CH2])CO[O](723)'],
    products = ['[CH2]CC([CH2])C([CH2])COO(960)'],
...
network(
    ...
    isomers = [
        '[CH2]C(CC)C([CH2])CO[O](723)',
    ],
    reactants = [
        ('allylperoxy(462)', 'butene1(35)'),
    ],
    bathGas = {
        'Ar': 0.333333,
        'Ne': 0.333333,
