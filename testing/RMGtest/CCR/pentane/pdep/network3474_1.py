...
species(
    label = '[CH]C([CH2])C=C[CH2](15377)',
    structure = SMILES('[CH]C([CH2])C=C[CH2]'),
    E0 = (720.497,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2995,3025,975,1000,1300,1375,400,500,1630,1680,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,394.005,394.013,394.03,394.047],'cm^-1')),
        HinderedRotor(inertia=(0.00108588,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00108584,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00108578,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00108573,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27985,0.0507433,-1.77863e-05,-1.50423e-08,1.02701e-11,86761.9,26.7127], Tmin=(100,'K'), Tmax=(958.5,'K')), NASAPolynomial(coeffs=[13.0928,0.0228947,-7.77146e-06,1.33864e-09,-9.17659e-14,83512.1,-34.9168], Tmin=(958.5,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(720.497,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Isobutyl) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10105,0.0560067,-4.00039e-05,1.11257e-08,-8.11763e-14,116968,25.7262], Tmin=(100,'K'), Tmax=(1090.17,'K')), NASAPolynomial(coeffs=[13.6187,0.0215934,-8.49894e-06,1.54956e-09,-1.07293e-13,113554,-38.8837], Tmin=(1090.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(971.602,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]C[CH]C=[CH](15314)',
    ...
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.84779,0.0499382,-2.91106e-05,8.87341e-09,-1.19345e-12,112772,26.6885], Tmin=(100,'K'), Tmax=(1516.37,'K')), NASAPolynomial(coeffs=[7.16868,0.0359024,-1.52262e-05,2.76922e-09,-1.87065e-13,111158,-1.19693], Tmin=(1516.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(937.018,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(CCJ2_triplet) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C1CC=CC1(15379)',
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.23399,0.0189781,7.50814e-05,-1.09913e-07,4.29414e-11,52687.5,19.2792], Tmin=(100,'K'), Tmax=(961.046,'K')), NASAPolynomial(coeffs=[13.6163,0.0216561,-7.22072e-06,1.37202e-09,-1.04696e-13,48188.2,-47.2074], Tmin=(961.046,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(437.39,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + ring(Cyclopentene) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    modes = [
        ...
        HinderedRotor(inertia=(2.11637,'amu*angstrom^2'), symmetry=1, barrier=(48.6596,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.11557,'amu*angstrom^2'), symmetry=1, barrier=(48.6412,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.11673,'amu*angstrom^2'), symmetry=1, barrier=(48.6677,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
...
species(
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.10709,0.0559296,-4.02082e-05,1.48144e-08,-2.21158e-12,66078.8,24.5834], Tmin=(100,'K'), Tmax=(1568.54,'K')), NASAPolynomial(coeffs=[13.8478,0.0234391,-9.13758e-06,1.6087e-09,-1.06823e-13,62081.9,-42.6185], Tmin=(1568.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(548.492,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(Cdd-CdsCds) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH][CH]C[CH][CH2](15381)',
    structure = SMILES('[CH][CH][CH]C[CH][CH2]'),
    E0 = (1044.95,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,3000,3100,440,815,1455,1000,255.07,880.027,1535.67,4000,4000,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00185546,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00185546,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00185546,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00185546,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00185546,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.72809,0.061879,-9.82209e-05,1.01888e-07,-3.96903e-11,125749,33.0718], Tmin=(100,'K'), Tmax=(868.859,'K')), NASAPolynomial(coeffs=[-1.47388,0.047079,-2.16704e-05,4.01981e-09,-2.71017e-13,127420,54.4861], Tmin=(868.859,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(1044.95,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(RCCJCC) + radical(RCCJC) + radical(RCCJC) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][CH]CC1[CH]C1(15382)',
    structure = SMILES('[CH][CH]CC1[CH]C1'),
    E0 = (830.265,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8886,0.0390381,-3.50123e-06,-1.56454e-08,6.7951e-12,99940,27.036], Tmin=(100,'K'), Tmax=(1097.04,'K')), NASAPolynomial(coeffs=[8.48681,0.0301691,-1.21431e-05,2.22726e-09,-1.5398e-13,97578.3,-9.57346], Tmin=(1097.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(830.265,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(cyclopropane) + radical(RCCJC) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1C[CH]C1[CH2](15383)',
    structure = SMILES('[CH]C1C[CH]C1[CH2]'),
    E0 = (789.365,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.05956,0.0284274,4.14329e-05,-7.16122e-08,2.8955e-11,95021.5,24.5054], Tmin=(100,'K'), Tmax=(959.877,'K')), NASAPolynomial(coeffs=[11.3921,0.0249644,-8.51776e-06,1.53118e-09,-1.09745e-13,91597.8,-28.6378], Tmin=(959.877,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(789.365,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(cyclobutane) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1CC1[CH][CH2](15384)',
    structure = SMILES('[CH]C1CC1[CH][CH2]'),
    E0 = (800.653,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.8067,0.0348092,2.36761e-05,-5.37196e-08,2.23848e-11,96387.2,25.6131], Tmin=(100,'K'), Tmax=(985.74,'K')), NASAPolynomial(coeffs=[12.4971,0.0238313,-8.9254e-06,1.6757e-09,-1.21662e-13,92705.3,-33.7935], Tmin=(985.74,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(800.653,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Cs_S) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (79.1198,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.7782,0.0460776,-2.1853e-05,4.42525e-09,-2.97604e-13,100529,27.3468], Tmin=(100,'K'), Tmax=(1977.75,'K')), NASAPolynomial(coeffs=[13.9546,0.0261387,-1.0286e-05,1.7247e-09,-1.07733e-13,94796,-42.0191], Tmin=(1977.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(835.162,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(RCCJC) + radical(RCCJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH][CH]C[C]=C[CH2](15386)',
    structure = SMILES('[CH][CH]C[C]=C[CH2]'),
    E0 = (955.675,'kJ/mol'),
    modes = [
...
species(
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.39072,0.0472838,-1.00846e-05,-1.87535e-08,9.91933e-12,80023.5,23.6735], Tmin=(100,'K'), Tmax=(1026.08,'K')), NASAPolynomial(coeffs=[12.5337,0.0255637,-1.00827e-05,1.87389e-09,-1.32493e-13,76593.5,-35.9434], Tmin=(1026.08,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(664.499,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]=CC[CH][C]C(15210)',
    structure = SMILES('[CH]=CC[CH][C]C'),
    E0 = (825.687,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,312.46,313.676,1984.82],'cm^-1')),
        HinderedRotor(inertia=(0.159621,'amu*angstrom^2'), symmetry=1, barrier=(11.1577,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.161193,'amu*angstrom^2'), symmetry=1, barrier=(11.1758,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.16223,'amu*angstrom^2'), symmetry=1, barrier=(11.1546,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.022144,'amu*angstrom^2'), symmetry=1, barrier=(61.8152,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.71457,0.054016,-4.61246e-05,2.55269e-08,-6.53558e-12,99386.3,25.6571], Tmin=(100,'K'), Tmax=(887.818,'K')), NASAPolynomial(coeffs=[5.64095,0.0363258,-1.62361e-05,3.08329e-09,-2.15635e-13,98689.1,7.18188], Tmin=(887.818,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(825.687,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJCC) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[CH]CC[C]=C[CH2](15389)',
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.17941,0.0568113,-4.24145e-05,1.65108e-08,-2.63187e-12,91660.4,26.0154], Tmin=(100,'K'), Tmax=(1463.15,'K')), NASAPolynomial(coeffs=[12.6763,0.0253805,-1.01919e-05,1.8289e-09,-1.23245e-13,88296,-33.8262], Tmin=(1463.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(761.228,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]=CC[C][CH]C(15211)',
    structure = SMILES('[CH]=CC[C][CH]C'),
    E0 = (825.675,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,3120,650,792.5,1650,180,436.049,2128.96],'cm^-1')),
        HinderedRotor(inertia=(0.138023,'amu*angstrom^2'), symmetry=1, barrier=(10.7512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0796831,'amu*angstrom^2'), symmetry=1, barrier=(10.7512,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.119364,'amu*angstrom^2'), symmetry=1, barrier=(2.74442,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.532857,'amu*angstrom^2'), symmetry=1, barrier=(71.8965,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66806,0.0537841,-4.238e-05,1.97715e-08,-4.1061e-12,99387.7,25.9867], Tmin=(100,'K'), Tmax=(1087.88,'K')), NASAPolynomial(coeffs=[7.15445,0.0336114,-1.45655e-05,2.72654e-09,-1.89122e-13,98193.9,-0.944143], Tmin=(1087.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(825.675,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)

species(
    label = '[CH]CCC=[C][CH2](15390)',
    structure = SMILES('[CH]CCC=[C][CH2]'),
    E0 = (761.228,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
...
species(
    label = '[CH]=C[CH][CH][CH]C(15214)',
    structure = SMILES('[CH]C=C[CH][CH]C'),
    E0 = (629.916,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.61483,0.0468718,-1.68363e-05,-7.93669e-10,1.19858e-12,75851.7,25.4491], Tmin=(100,'K'), Tmax=(1432.98,'K')), NASAPolynomial(coeffs=[9.10967,0.0352013,-1.4303e-05,2.53257e-09,-1.67635e-13,72754,-16.7194], Tmin=(1432.98,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(629.916,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + radical(RCCJC) + radical(Allyl_S) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH][CH]C[CH](15391)',
    structure = SMILES('[CH][CH]C[CH]'),
    E0 = (946.842,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,221.32,1232.56,1272,1337.07,1351.63,1807.59,1864.8],'cm^-1')),
        HinderedRotor(inertia=(0.0884048,'amu*angstrom^2'), symmetry=1, barrier=(2.89685,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0884048,'amu*angstrom^2'), symmetry=1, barrier=(2.89685,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0884048,'amu*angstrom^2'), symmetry=1, barrier=(2.89685,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 6,
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.41566,0.0392528,-5.62338e-05,5.18107e-08,-1.90456e-11,113932,19.1739], Tmin=(100,'K'), Tmax=(825.352,'K')), NASAPolynomial(coeffs=[4.1564,0.0222904,-9.91074e-06,1.87777e-09,-1.2969e-13,113935,12.8692], Tmin=(825.352,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(946.842,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo library: DFT_QCI_thermo + radical(RCCJC) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1CC1C=C(15392)',
    structure = SMILES('[CH]C1CC1C=C'),
    E0 = (529.716,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.89223,0.0271669,5.67798e-05,-9.61206e-08,3.95582e-11,63803.5,21.4715], Tmin=(100,'K'), Tmax=(950.014,'K')), NASAPolynomial(coeffs=[15.494,0.0181967,-5.31829e-06,9.72221e-10,-7.51113e-14,59039.5,-54.923], Tmin=(950.014,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(529.716,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(324.264,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Cyclopropane) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29334,0.0479249,-6.89868e-06,-2.77585e-08,1.47689e-11,58255.3,23.4322], Tmin=(100,'K'), Tmax=(973.33,'K')), NASAPolynomial(coeffs=[14.4937,0.0209447,-7.34205e-06,1.32782e-09,-9.48023e-14,54394,-46.53], Tmin=(973.33,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(483.465,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(320.107,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1C[CH][CH]C1(15394)',
    structure = SMILES('[CH]C1C[CH][CH]C1'),
    E0 = (695.482,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.71846,0.0183839,4.70413e-05,-6.16695e-08,2.17017e-11,83701.8,24.3065], Tmin=(100,'K'), Tmax=(1010.64,'K')), NASAPolynomial(coeffs=[5.00107,0.0341854,-1.32728e-05,2.43236e-09,-1.70035e-13,81972.1,6.99511], Tmin=(1010.64,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(695.482,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(328.422,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + ring(Cyclopentane) + radical(cyclopentane) + radical(cyclopentane) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH][CH]CCC=[CH](15396)',
    structure = SMILES('[CH][CH]CCC=[CH]'),
    E0 = (825.675,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (80.1277,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.66806,0.0537841,-4.238e-05,1.97715e-08,-4.1061e-12,99387.7,27.0853], Tmin=(100,'K'), Tmax=(1087.88,'K')), NASAPolynomial(coeffs=[7.15445,0.0336114,-1.45655e-05,2.72654e-09,-1.89122e-13,98193.9,0.154469], Tmin=(1087.88,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(825.675,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH][CH]CC=C[CH2](7198)'],
    products = ['C2H2(1342)', '[CH2][CH]C=C(3743)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['[CH]C([CH2])C=C[CH2](15377)'],
    products = ['[CH][CH]CC=C[CH2](7198)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['[CH][CH](6981)', '[CH2][CH]C=C(3743)'],
    products = ['[CH][CH]CC=C[CH2](7198)'],
    transitionState = 'TS3',
    kinetics = Arrhenius(A=(5.36655e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cd;Birad]
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[CH][CH]CC=[CH](15111)'],
    products = ['[CH][CH]CC=C[CH2](7198)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH][C]CC=C[CH2](15378)'],
    products = ['[CH][CH]CC=C[CH2](7198)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH][CH]C[CH]C=[CH](15314)'],
    products = ['[CH][CH]CC=C[CH2](7198)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['[CH][CH][CH]C[CH][CH2](15381)'],
    products = ['[CH][CH]CC=C[CH2](7198)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH][CH]CC=C[CH2](7198)'],
    products = ['[CH][CH]CC1[CH]C1(15382)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH][CH]CC=C[CH2](7198)'],
    products = ['[CH]C1C[CH]C1[CH2](15383)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH][CH]CC=C[CH2](7198)'],
    products = ['[CH]C1CC1[CH][CH2](15384)'],
    transitionState = 'TS13',
    kinetics = Arrhenius(A=(5.86885e+09,'s^-1'), n=0.611527, Ea=(82.8195,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra;radadd_intra_cs]
Euclidian distance = 0
...
reaction(
    label = 'reaction17',
    reactants = ['[CH]C=C(3739)', '[CH][CH][CH2](5537)'],
    products = ['[CH][CH]CC=C[CH2](7198)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH][CH][CH]C=C[CH2](15385)'],
    products = ['[CH][CH]CC=C[CH2](7198)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH][CH]C[C]=C[CH2](15386)'],
    products = ['[CH][CH]CC=C[CH2](7198)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH][CH]CC=[C][CH2](15387)'],
    products = ['[CH][CH]CC=C[CH2](7198)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH][CH]CC=C[CH2](7198)'],
    products = ['[CH]C[CH]C=C[CH2](15388)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH][CH]CC=C[CH2](7198)'],
    products = ['[CH]=C[CH][CH][CH]C(15214)'],
...
reaction(
    label = 'reaction27',
    reactants = ['C2H3(60)', '[CH][CH]C[CH](15391)'],
    products = ['[CH][CH]CC=C[CH2](7198)'],
...
reaction(
    label = 'reaction31',
    reactants = ['[CH][CH]CC=C[CH2](7198)'],
    products = ['[CH]C1C[CH][CH]C1(15394)'],
...
reaction(
    label = 'reaction32',
    reactants = ['[CH][CH](6981)', 'butadiene13(1350)'],
    products = ['[CH][CH]CC=C[CH2](7198)'],
    transitionState = 'TS32',
    kinetics = Arrhenius(A=(0.37166,'m^3/(mol*s)'), n=2.36967, Ea=(33.8986,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Cds-HH_Cds-CdH;YJ] for rate rule [Cds-HH_Cds-CdH;Y_1centerbirad]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 4.0
family: R_Addition_MultipleBond"""),
)
