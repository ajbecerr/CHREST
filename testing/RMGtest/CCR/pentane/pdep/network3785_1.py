...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.336056,0.0713619,-3.77339e-05,4.33701e-09,2.17135e-12,55896.4,31.0876], Tmin=(100,'K'), Tmax=(1092.45,'K')), NASAPolynomial(coeffs=[12.4601,0.0411414,-1.56976e-05,2.76378e-09,-1.85991e-13,52401.8,-32.3463], Tmin=(1092.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(463.588,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(Isobutyl) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]C(=C)C[C]CC(17090)',
    structure = SMILES('[CH]C(=C)C[C]CC'),
    E0 = (715.762,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,2950,3100,1380,975,1025,1650,200,800,960,1120,1280,1440,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.32865,0.0742915,-5.10399e-05,1.82467e-08,-2.70384e-12,86223.5,29.5218], Tmin=(100,'K'), Tmax=(1542.01,'K')), NASAPolynomial(coeffs=[14.6103,0.0372444,-1.50021e-05,2.66617e-09,-1.77823e-13,81819,-45.5643], Tmin=(1542.01,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(715.762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(386.623,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(CCJ2_triplet) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C([CH2])[CH][CH]CC(17091)',
    structure = SMILES('[CH]C([CH2])[CH][CH]CC'),
    E0 = (820.959,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,228.8,1309.99,1500.31,1548.39,1695.12,2213.66],'cm^-1')),
        HinderedRotor(inertia=(0.0879901,'amu*angstrom^2'), symmetry=1, barrier=(2.91897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0879901,'amu*angstrom^2'), symmetry=1, barrier=(2.91897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0879901,'amu*angstrom^2'), symmetry=1, barrier=(2.91897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0879901,'amu*angstrom^2'), symmetry=1, barrier=(2.91897,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0879901,'amu*angstrom^2'), symmetry=1, barrier=(2.91897,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.888856,0.073119,-7.48692e-05,5.60014e-08,-1.9003e-11,98846.1,35.136], Tmin=(100,'K'), Tmax=(775.93,'K')), NASAPolynomial(coeffs=[4.82035,0.0491691,-2.1451e-05,3.9888e-09,-2.74077e-13,98346.9,17.8806], Tmin=(775.93,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(820.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(407.409,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Cs_S) + radical(RCCJCC) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C]1CC(CC)C1(17092)',
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19824,0.0496951,7.09669e-06,-3.52108e-08,1.43872e-11,67233.4,27.5448], Tmin=(100,'K'), Tmax=(1059.2,'K')), NASAPolynomial(coeffs=[10.9298,0.0394774,-1.60085e-05,2.98171e-09,-2.09268e-13,63683.5,-26.9903], Tmin=(1059.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(558.087,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(419.881,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclobutane) + radical(Tertalkyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1([CH2])CC1CC(17068)',
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.733921,0.0531574,2.06613e-05,-6.60671e-08,2.92102e-11,68692.1,27.0786], Tmin=(100,'K'), Tmax=(978.537,'K')), NASAPolynomial(coeffs=[17.7479,0.028499,-1.03517e-05,1.94255e-09,-1.42379e-13,63213.1,-65.6163], Tmin=(978.537,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(570.022,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(Neopentyl) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C(=C)C=CCC(17093)',
    structure = SMILES('[CH]C(=C)C=CCC'),
    E0 = (368.344,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,350,440,435,1725,2950,3100,1380,975,1025,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.964022,0.0671864,-3.70756e-05,1.01425e-08,-1.159e-12,55672.7,30.0492], Tmin=(100,'K'), Tmax=(1840.85,'K')), NASAPolynomial(coeffs=[11.919,0.0433821,-1.76788e-05,3.11788e-09,-2.05016e-13,51639.4,-29.4875], Tmin=(1840.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(461.993,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJC) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C(=C)[CH]CCC(17061)',
...
species(
    label = '[CH]C(=C)CCC[CH2](17096)',
    structure = SMILES('[CH]C(=C)CCC[CH2]'),
    E0 = (472.794,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,350,440,435,1725,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.301767,0.0731655,-4.53802e-05,1.42345e-08,-1.83496e-12,57003.6,31.5117], Tmin=(100,'K'), Tmax=(1749.42,'K')), NASAPolynomial(coeffs=[15.9172,0.0374611,-1.47663e-05,2.56822e-09,-1.67789e-13,51540,-52.5572], Tmin=(1749.42,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(472.794,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJ) + radical(AllylJ2_triplet)"""),
)

species(
    label = '[CH]C(=[CH])CCCC(17097)',
    structure = SMILES('[CH]C(=[CH])CCCC'),
    E0 = (514.643,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3120,650,792.5,1650,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.286615,0.0749617,-4.86879e-05,1.63065e-08,-2.26512e-12,62036.2,29.4797], Tmin=(100,'K'), Tmax=(1626.59,'K')), NASAPolynomial(coeffs=[14.8668,0.0391076,-1.56245e-05,2.75545e-09,-1.82406e-13,57292.9,-47.9544], Tmin=(1626.59,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(514.643,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(AllylJ2_triplet) + radical(Cds_P)"""),
)
...
species(
    label = '[C]=C([CH2])C[CH]CC(17098)',
    structure = SMILES('[C]C(=C)C[CH]CC'),
    E0 = (760.799,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,350,440,435,1725,2950,3100,1380,975,1025,1650,304.405,304.417,304.421,2138.58],'cm^-1')),
        HinderedRotor(inertia=(0.00181966,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.00181883,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180268,'amu*angstrom^2'), symmetry=1, barrier=(11.8623,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180323,'amu*angstrom^2'), symmetry=1, barrier=(11.8615,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (94.1543,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.098,0.0677957,-5.466e-05,2.62642e-08,-5.64764e-12,91604.1,26.7677], Tmin=(100,'K'), Tmax=(1050.75,'K')), NASAPolynomial(coeffs=[7.67783,0.0427475,-1.89022e-05,3.57697e-09,-2.49736e-13,90221.4,-5.30184], Tmin=(1050.75,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(760.799,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(390.78,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJCC) + radical(CJ3)"""),
)

species(
    label = 'CC[CH]CC1=CC1(17099)',
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.681743,0.0631787,-3.65729e-05,1.04558e-08,-1.20594e-12,43407.7,29.4278], Tmin=(100,'K'), Tmax=(1971.21,'K')), NASAPolynomial(coeffs=[17.0741,0.0299148,-1.12602e-05,1.89493e-09,-1.20185e-13,36945.3,-60.78], Tmin=(1971.21,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(359.849,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + ring(Cyclopropene) + radical(RCCJCC)"""),
)

species(
    label = '[CH]=C1CC(CC)C1(17052)',
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19979,0.047248,1.92489e-05,-5.11841e-08,2.07208e-11,36977.7,24.9308], Tmin=(100,'K'), Tmax=(1025.04,'K')), NASAPolynomial(coeffs=[12.3513,0.0371415,-1.48524e-05,2.79229e-09,-1.98809e-13,32936.3,-37.7063], Tmin=(1025.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(306.508,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane) + radical(Cds_P)"""),
)

species(
    label = '[CH2]C1=CC(CC)C1(17014)',
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48774,0.038321,4.54361e-05,-7.77072e-08,2.98401e-11,24222.8,22.387], Tmin=(100,'K'), Tmax=(1008.04,'K')), NASAPolynomial(coeffs=[12.0508,0.0376593,-1.49665e-05,2.83856e-09,-2.04448e-13,19997.3,-39.0543], Tmin=(1008.04,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.525,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(424.038,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + ring(methylenecyclobutane) + radical(Allyl_S)"""),
)

species(
    label = '[CH]=C(C)C=CCC(17100)',
    structure = SMILES('[CH]=C(C)C=CCC'),
    E0 = (244.756,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.383469,0.0688979,-3.62092e-05,-1.14246e-09,5.17183e-12,29576.7,26.6991], Tmin=(100,'K'), Tmax=(1038.11,'K')), NASAPolynomial(coeffs=[15.1861,0.0320774,-1.22174e-05,2.20959e-09,-1.53091e-13,25414,-50.5156], Tmin=(1038.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(244.756,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(415.724,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-CdsCsH) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + radical(Cds_P)"""),
)
...
species(
    ...
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.472528,0.0678783,-3.22664e-05,3.30728e-09,1.21936e-12,47812.5,27.5672], Tmin=(100,'K'), Tmax=(1288.83,'K')), NASAPolynomial(coeffs=[12.7486,0.0423601,-1.72106e-05,3.09397e-09,-2.08537e-13,43603.2,-38.8268], Tmin=(1288.83,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(396.414,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_S) + radical(AllylJ2_triplet)"""),
)
...
species(
    label = '[CH]=C(C)C[CH][CH]C(16080)',
    structure = SMILES('[CH]=C(C)C[CH][CH]C'),
    E0 = (532.863,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,350,440,435,1725,3000,3050,390,425,1340,1360,335,370,3120,650,792.5,1650,1880.06,1880.79],'cm^-1')),
        HinderedRotor(inertia=(0.180677,'amu*angstrom^2'), symmetry=1, barrier=(4.15412,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180734,'amu*angstrom^2'), symmetry=1, barrier=(4.15543,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180619,'amu*angstrom^2'), symmetry=1, barrier=(4.15279,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180905,'amu*angstrom^2'), symmetry=1, barrier=(4.15936,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.180332,'amu*angstrom^2'), symmetry=1, barrier=(4.14619,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.994836,0.0728931,-8.38404e-05,7.29853e-08,-2.7361e-11,64190.3,31.8135], Tmin=(100,'K'), Tmax=(809.276,'K')), NASAPolynomial(coeffs=[2.50276,0.0529637,-2.37765e-05,4.45603e-09,-3.06277e-13,64354.8,27.3819], Tmin=(809.276,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(532.863,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJC) + radical(Cds_P)"""),
)
...
species(
    label = '[CH]=C(C)C[CH]C[CH2](17102)',
    structure = SMILES('[CH]=C(C)C[CH]C[CH2]'),
    E0 = (543.664,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,350,440,435,1725,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3120,650,792.5,1650,180,1975.71],'cm^-1')),
        HinderedRotor(inertia=(0.130087,'amu*angstrom^2'), symmetry=1, barrier=(2.99096,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129746,'amu*angstrom^2'), symmetry=1, barrier=(2.98312,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129723,'amu*angstrom^2'), symmetry=1, barrier=(2.98258,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.129848,'amu*angstrom^2'), symmetry=1, barrier=(2.98547,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.130198,'amu*angstrom^2'), symmetry=1, barrier=(2.99351,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (95.1622,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.43822,0.0643484,-3.09133e-05,-2.69172e-08,3.44803e-11,65472.1,29.3804], Tmin=(100,'K'), Tmax=(525.669,'K')), NASAPolynomial(coeffs=[4.87377,0.0497937,-2.2447e-05,4.28018e-09,-3.00068e-13,64950.8,13.4924], Tmin=(525.669,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(543.664,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsHH) + radical(RCCJCC) + radical(RCCJ) + radical(Cds_P)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH]C(=C)C[CH]CC(15696)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH]C(=C)CC([CH2])C(17089)'],
    products = ['[CH]C(=C)C[CH]CC(15696)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['C2H5(14)', '[CH]CC([CH])=C(16934)'],
    products = ['[CH]C(=C)C[CH]CC(15696)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH]CC(26)', '[CH]=C([CH2])[CH2](16419)'],
    products = ['[CH]C(=C)C[CH]CC(15696)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH]C(=C)C[C]CC(17090)'],
    products = ['[CH]C(=C)C[CH]CC(15696)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]C([CH2])[CH][CH]CC(17091)'],
    products = ['[CH]C(=C)C[CH]CC(15696)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]C(=C)C[CH]CC(15696)'],
    products = ['[CH]C1([CH2])CC1CC(17068)'],
    transitionState = 'TS10',
    kinetics = Arrhenius(A=(6.73316e+11,'s^-1'), n=0.231216, Ea=(108.016,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [R4_S_D;doublebond_intra_2H;radadd_intra_csHNd]
Euclidian distance = 0
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH]=C([CH2])CC=CC(15908)'],
    products = ['[CH]C(=C)C[CH]CC(15696)'],
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH]C(=C)C=CCC(17093)'],
    products = ['[CH]C(=C)C[CH]CC(15696)'],
...
reaction(
    label = 'reaction13',
    reactants = ['CH3(17)', '[CH]=C([CH2])CC=C(16011)'],
    products = ['[CH]C(=C)C[CH]CC(15696)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(17)', '[CH]C(=C)C[CH][CH2](15729)'],
    products = ['[CH]C(=C)C[CH]CC(15696)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[CH]C(=C)C[CH][CH]C(16072)'],
    products = ['[CH]C(=C)C[CH]CC(15696)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', '[CH]C(=C)[CH][CH]CC(17094)'],
    products = ['[CH]C(=C)C[CH]CC(15696)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', '[CH]=C([CH2])C[CH]C[CH2](15891)'],
    products = ['[CH]C(=C)C[CH]CC(15696)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH]C(=[CH])C[CH]CC(17095)'],
    products = ['[CH]C(=C)C[CH]CC(15696)'],
...
reaction(
    label = 'reaction21',
    reactants = ['[CH]C(=C)C[CH]CC(15696)'],
    products = ['[CH]=C([CH2])CC[CH]C(16081)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH]C(=C)CCC[CH2](17096)'],
    products = ['[CH]C(=C)C[CH]CC(15696)'],
...
reaction(
    label = 'reaction26',
    reactants = ['CH2(T)(20)', '[CH]=[C]C[CH]CC(9797)'],
    products = ['[CH]C(=C)C[CH]CC(15696)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[C]=C([CH2])C[CH]CC(17098)'],
    products = ['[CH]C(=C)C[CH]CC(15696)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]C(=C)C[CH]CC(15696)'],
    products = ['[CH2]C1=CC(CC)C1(17014)'],
...
reaction(
    label = 'reaction35',
    reactants = ['CH2(T)(20)', 'C#CC[CH]CC(9803)'],
    products = ['[CH]C(=C)C[CH]CC(15696)'],
...
reaction(
    label = 'reaction37',
    reactants = ['[CH]C(=C)C[CH]CC(15696)'],
    products = ['[CH]=C(C)[CH][CH]CC(17101)'],
...
reaction(
    label = 'reaction38',
    reactants = ['[CH]C(=C)C[CH]CC(15696)'],
    products = ['[CH2]C(=C)[CH][CH]CC(15701)'],
...
reaction(
    label = 'reaction39',
    reactants = ['[CH]=C(C)C[CH][CH]C(16080)'],
    products = ['[CH]C(=C)C[CH]CC(15696)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH]=C(C)C[CH]C[CH2](17102)'],
    products = ['[CH]C(=C)C[CH]CC(15696)'],
...
reaction(
    label = 'reaction42',
    reactants = ['[CH]C(=C)C[CH]CC(15696)'],
    products = ['[CH2]C[CH]CC([CH2])=C(15702)'],
