species(
    label = 'CC([O])C[CH][O](3188)',
    structure = SMILES('CC([O])C[CH][O]'),
    E0 = (159.762,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,311.727,311.728,2425.96,2425.97],'cm^-1')),
        HinderedRotor(inertia=(0.14495,'amu*angstrom^2'), symmetry=1, barrier=(9.99572,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.14496,'amu*angstrom^2'), symmetry=1, barrier=(9.99577,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.485939,'amu*angstrom^2'), symmetry=1, barrier=(33.5095,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.27894,0.0658081,-9.08876e-05,7.89666e-08,-2.8148e-11,19307.1,24.6504], Tmin=(100,'K'), Tmax=(807.767,'K')), NASAPolynomial(coeffs=[5.57446,0.0351331,-1.64621e-05,3.12933e-09,-2.16179e-13,18920,6.74309], Tmin=(807.767,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(159.762,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCOJ) + radical(CCsJOH)"""),
)
...
species(
    label = '[CH2]C([O])C(C)[O](3178)',
    structure = SMILES('[CH2]C([O])C(C)[O]'),
    E0 = (183.066,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,252.869,252.941,1163.71],'cm^-1')),
        HinderedRotor(inertia=(0.00205471,'amu*angstrom^2'), symmetry=1, barrier=(20.3267,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.448141,'amu*angstrom^2'), symmetry=1, barrier=(20.3261,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.448076,'amu*angstrom^2'), symmetry=1, barrier=(20.3265,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.07361,0.0602255,-5.48655e-05,2.61496e-08,-5.00745e-12,22126.5,25.0746], Tmin=(100,'K'), Tmax=(1254.68,'K')), NASAPolynomial(coeffs=[13.2209,0.0214991,-8.56732e-06,1.54938e-09,-1.05758e-13,19078.3,-36.2852], Tmin=(1254.68,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(183.066,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CC(C)OJ) + radical(CJCO)"""),
)
...
species(
    label = 'CC([O])C[C][O](3427)',
    structure = SMILES('CC([O])C[C][O]'),
    E0 = (440.452,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,293.208,293.209,293.209,293.21,4000],'cm^-1')),
        HinderedRotor(inertia=(0.00196085,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.500832,'amu*angstrom^2'), symmetry=1, barrier=(30.5548,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.184184,'amu*angstrom^2'), symmetry=1, barrier=(11.2366,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.68028,0.0578683,-6.01139e-05,2.3503e-08,5.53014e-12,53051.1,22.453], Tmin=(100,'K'), Tmax=(559.454,'K')), NASAPolynomial(coeffs=[6.97881,0.0304593,-1.47097e-05,2.864e-09,-2.01923e-13,52294.4,-1.49704], Tmin=(559.454,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(440.452,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCOJ) + radical(CH2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[3.7085,0.0356906,-1.52108e-05,2.18328e-09,-6.02726e-14,-23150.4,15.4207], Tmin=(100,'K'), Tmax=(2776.2,'K')), NASAPolynomial(coeffs=[38.6912,-0.00349239,-1.02588e-07,1.11206e-11,4.22916e-15,-46898.3,-196.859], Tmin=(2776.2,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-192.316,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-O2d)CsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)HHH) + group(Cds-OdCsCs) + radical(CCOJ)"""),
)

species(
    label = 'CC(O)C=C[O](3429)',
    structure = SMILES('CC(O)C=C[O]'),
    E0 = (-256.659,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
...
species(
    ...
    E0 = (-12.0184,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,375,552.5,462.5,1710,3025,407.5,1350,352.5,180,180,2808.73],'cm^-1')),
        HinderedRotor(inertia=(0.109122,'amu*angstrom^2'), symmetry=1, barrier=(2.50893,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.108041,'amu*angstrom^2'), symmetry=1, barrier=(2.48407,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.109556,'amu*angstrom^2'), symmetry=1, barrier=(2.5189,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
...
species(
    ...
    E0 = (-26.2977,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,273.953,273.96,273.961],'cm^-1')),
        HinderedRotor(inertia=(0.382099,'amu*angstrom^2'), symmetry=1, barrier=(20.35,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.382093,'amu*angstrom^2'), symmetry=1, barrier=(20.3501,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 3,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
...
species(
    ...
    E0 = (336.39,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,2750,2800,2850,1350,1500,750,1050,1375,1000,360,370,350,3025,407.5,1350,352.5,180,180,180,2113.93],'cm^-1')),
        HinderedRotor(inertia=(0.133449,'amu*angstrom^2'), symmetry=1, barrier=(3.06825,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133407,'amu*angstrom^2'), symmetry=1, barrier=(3.06728,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.133501,'amu*angstrom^2'), symmetry=1, barrier=(3.06944,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
...
species(
    ...
    E0 = (359.664,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3050,390,425,1340,1360,335,370,241.822,1328.43,1328.43,1328.45],'cm^-1')),
        HinderedRotor(inertia=(0.0028826,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.206173,'amu*angstrom^2'), symmetry=1, barrier=(8.55758,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.206188,'amu*angstrom^2'), symmetry=1, barrier=(8.55766,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
...
species(
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.91973,0.0790447,-0.000135631,1.28445e-07,-4.61965e-11,12852.4,25.5549], Tmin=(100,'K'), Tmax=(867.297,'K')), NASAPolynomial(coeffs=[4.54547,0.0365091,-1.74201e-05,3.26263e-09,-2.20318e-13,13194.4,14.176], Tmin=(867.297,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(106.029,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(C2CsJOH) + radical(CCsJOH)"""),
)

species(
    label = 'CC([O])[CH]C[O](3431)',
    structure = SMILES('CC([O])[CH]C[O]'),
    E0 = (179.366,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,398.513,398.627,1692.88,1693.37],'cm^-1')),
        HinderedRotor(inertia=(0.00106291,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0666289,'amu*angstrom^2'), symmetry=1, barrier=(7.51169,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.066701,'amu*angstrom^2'), symmetry=1, barrier=(7.51627,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.95204,0.0491498,-4.03825e-05,2.13639e-08,-5.35037e-12,21643,25.1974], Tmin=(100,'K'), Tmax=(890.667,'K')), NASAPolynomial(coeffs=[5.18254,0.0346416,-1.59491e-05,3.07556e-09,-2.17075e-13,21067.5,9.98609], Tmin=(890.667,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(179.366,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCOJ) + radical(CCJCO)"""),
)

species(
    label = 'CC(O)[CH][CH][O](3432)',
    structure = SMILES('CC(O)[CH][CH][O]'),
    E0 = (129.303,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29827,0.0647201,-8.85318e-05,7.47699e-08,-2.58826e-11,15643.8,27.2701], Tmin=(100,'K'), Tmax=(813.203,'K')), NASAPolynomial(coeffs=[6.29439,0.0324737,-1.49009e-05,2.80654e-09,-1.92875e-13,15084.8,5.75936], Tmin=(813.203,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(129.303,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCJCO) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C(O)C[CH][O](3433)',
    structure = SMILES('[CH2]C(O)C[CH][O]'),
    E0 = (140.99,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.926988,0.0754239,-0.000118,1.04846e-07,-3.64695e-11,17060.3,26.739], Tmin=(100,'K'), Tmax=(851.323,'K')), NASAPolynomial(coeffs=[6.69069,0.0327312,-1.52701e-05,2.85854e-09,-1.94133e-13,16644.7,3.18279], Tmin=(851.323,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(140.99,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CJCO) + radical(CCsJOH)"""),
)

species(
    label = 'C[C]([O])CC[O](3434)',
    ...
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.3403,0.0664655,-9.91917e-05,9.23044e-08,-3.41113e-11,18861.6,24.3037], Tmin=(100,'K'), Tmax=(831.786,'K')), NASAPolynomial(coeffs=[3.84125,0.0379504,-1.80351e-05,3.42688e-09,-2.35674e-13,19015.9,16.1273], Tmin=(831.786,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(156.092,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CC(C)OJ) + radical(C2CsJOH)"""),
)

species(
    label = 'CC([O])[CH][CH]O(3435)',
    structure = SMILES('CC([O])[CH][CH]O'),
    E0 = (133.959,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.19608,0.06227,-6.57834e-05,3.80666e-08,-8.95566e-12,16212,26.5878], Tmin=(100,'K'), Tmax=(1025.45,'K')), NASAPolynomial(coeffs=[10.9574,0.0241936,-1.00862e-05,1.85659e-09,-1.27789e-13,14210.1,-20.7502], Tmin=(1025.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(133.959,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJCO) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C([O])CC[O](3436)',
    structure = SMILES('[CH2]C([O])CC[O]'),
    E0 = (191.053,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,1380,1390,370,380,2900,435,3000,3100,440,815,1455,1000,293.368,293.37,1367.29,1367.3],'cm^-1')),
        HinderedRotor(inertia=(0.0963329,'amu*angstrom^2'), symmetry=1, barrier=(5.8839,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0963469,'amu*angstrom^2'), symmetry=1, barrier=(5.88394,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0963465,'amu*angstrom^2'), symmetry=1, barrier=(5.8839,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.08233,0.0510305,-1.8449e-05,-6.70052e-08,7.7069e-11,23038.2,23.0172], Tmin=(100,'K'), Tmax=(464.517,'K')), NASAPolynomial(coeffs=[5.85415,0.0344169,-1.60348e-05,3.05967e-09,-2.12649e-13,22516.6,5.86989], Tmin=(464.517,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(191.053,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(295.164,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCOJ) + radical(CJCO)"""),
)

species(
    label = 'C[C]([O])C[CH]O(3437)',
    structure = SMILES('C[C]([O])C[CH]O'),
    E0 = (110.685,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.74275,0.0775167,-0.000116368,9.68198e-08,-3.17819e-11,13423.9,25.1389], Tmin=(100,'K'), Tmax=(854.458,'K')), NASAPolynomial(coeffs=[9.11212,0.0284033,-1.27105e-05,2.33842e-09,-1.57425e-13,12356.3,-11.8001], Tmin=(854.458,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(110.685,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(CCsJOH)"""),
)

species(
    label = '[CH2]C([O])C[CH]O(3438)',
    structure = SMILES('[CH2]C([O])C[CH]O'),
    E0 = (145.646,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (87.0972,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.8259,0.0729183,-9.48985e-05,6.75691e-08,-1.93052e-11,17628.6,26.0559], Tmin=(100,'K'), Tmax=(855.409,'K')), NASAPolynomial(coeffs=[11.0883,0.024928,-1.07416e-05,1.9782e-09,-1.3495e-13,15873,-21.8511], Tmin=(855.409,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(145.646,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(291.007,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCsJOH) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(S)(11)', '[O][CH]CC[O](3426)'],
    products = ['CC([O])C[CH][O](3188)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['O(4)', 'C[CH]C[CH][O](1560)'],
    products = ['CC([O])C[CH][O](3188)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH][O](1548)', '[CH2]C(C)[O](667)'],
    products = ['CC([O])C[CH][O](3188)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'CC(=O)C[CH][O](1939)'],
    products = ['CC([O])C[CH][O](3188)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CH3(17)', '[O][CH]CC=O(1945)'],
    products = ['CC([O])C[CH][O](3188)'],
...
reaction(
    label = 'reaction17',
    reactants = ['CH3(17)', '[O][CH]C[CH][O](1933)'],
    products = ['CC([O])C[CH][O](3188)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'C[C]([O])C[CH][O](1950)'],
    products = ['CC([O])C[CH][O](3188)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'CC([O])[CH][CH][O](1953)'],
    products = ['CC([O])C[CH][O](3188)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', '[CH2]C([O])C[CH][O](1538)'],
    products = ['CC([O])C[CH][O](3188)'],
