...
species(
    label = '[CH2]C(C)CCC(62)',
    structure = SMILES('[CH2]C(C)CCC'),
    E0 = (7.5235,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1390,370,380,2900,435,2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2770,2790,2810,2830,2850,1350,1400,1450,1500,700,800,1000,1100,1350,1400,900,1100,3000,3100,440,815,1455,1000,180,3050.1],'cm^-1')),
        HinderedRotor(inertia=(3.58778,'amu*angstrom^2'), symmetry=1, barrier=(82.4901,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.0030316,'amu*angstrom^2'), symmetry=1, barrier=(20.0154,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.561187,'amu*angstrom^2'), symmetry=1, barrier=(12.9028,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.870106,'amu*angstrom^2'), symmetry=1, barrier=(20.0054,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.02354,'amu*angstrom^2'), symmetry=1, barrier=(4.33668,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (85.1674,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.896554,0.0589608,-1.64036e-05,-1.32735e-08,7.66974e-12,1024.55,26.7348], Tmin=(100,'K'), Tmax=(1044.34,'K')), NASAPolynomial(coeffs=[10.769,0.039543,-1.49349e-05,2.65521e-09,-1.80913e-13,-2040.63,-26.1251], Tmin=(1044.34,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(7.5235,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsCsH) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(Isobutyl)"""),
)
...
species(
    ...
    molecularWeight = (84.1595,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.55961,0.065392,-4.03687e-05,1.25377e-08,-1.57983e-12,30964.4,26.3798], Tmin=(100,'K'), Tmax=(1818.36,'K')), NASAPolynomial(coeffs=[16.4429,0.0304519,-1.15457e-05,1.97026e-09,-1.2694e-13,25188.2,-59.7448], Tmin=(1818.36,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(256.351,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['CH2(S)(2)', '[CH2]CCCC(6)'],
    products = ['[CH2]CCCCC(11)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction6',
    reactants = ['[CH2]C[CH2](21)', '[CH2]CC(5)'],
    products = ['[CH2]CCCCC(11)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction7',
    reactants = ['C[CH2](7)', '[CH2]CC[CH2](23)'],
    products = ['[CH2]CCCCC(11)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(6.3759e+10,'m^3/(mol*s)'), n=-1.17734, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.298025015457, var=0.3094099417, Tref=1000.0, N=5, correlation='Root_N-1R->H_N-1CNOS->N_N-1COS->O_1CS->C_N-1C-inRing_Ext-2R-R_Ext-3R!H-R_N-Sp-3R!H=2R',), comment="""BM rule fitted to 2 training reactions at node Root_N-1R->H_N-1CNOS->N_N-1COS->O_1CS->C_N-1C-inRing_Ext-2R-R_Ext-3R!H-R_N-Sp-3R!H=2R
    Total Standard Deviation in ln(k): 1.86393303255
...
reaction(
    label = 'reaction9',
    reactants = ['[CH2][CH2](18)', '[CH2]CCC(4)'],
    products = ['[CH2]CCCCC(11)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(6.3759e+10,'m^3/(mol*s)'), n=-1.17734, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), uncertainty=RateUncertainty(mu=0.298025015457, var=0.3094099417, Tref=1000.0, N=5, correlation='Root_N-1R->H_N-1CNOS->N_N-1COS->O_1CS->C_N-1C-inRing_Ext-2R-R_Ext-3R!H-R_N-Sp-3R!H=2R',), comment="""BM rule fitted to 2 training reactions at node Root_N-1R->H_N-1CNOS->N_N-1COS->O_1CS->C_N-1C-inRing_Ext-2R-R_Ext-3R!H-R_N-Sp-3R!H=2R
    Total Standard Deviation in ln(k): 1.86393303255
...
reaction(
    label = 'reaction11',
    reactants = ['[CH3](12)', '[CH2]CCC[CH2](26)'],
    products = ['[CH2]CCCCC(11)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2]CCCCC(11)'],
    products = ['C[CH]CCCC(48)'],
...
reaction(
    label = 'reaction25',
    reactants = ['C[CH2](7)', '[CH2]C[CH]C(34)'],
    products = ['C[CH]CCCC(48)'],
...
reaction(
    label = 'reaction26',
    reactants = ['[CH2][CH]C(39)', '[CH2]CC(5)'],
    products = ['C[CH]CCCC(48)'],
...
reaction(
    label = 'reaction28',
    reactants = ['[CH3](12)', '[CH2]CC[CH]C(24)'],
    products = ['C[CH]CCCC(48)'],
