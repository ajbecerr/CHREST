...
species(
    label = '[CH][CH]COC=[C][O](12376)',
    structure = SMILES('[CH][CH]COC=[C][O]'),
    E0 = (611.244,'kJ/mol'),
    modes = [
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.55859,0.0616527,-3.28981e-05,-1.90957e-08,1.68381e-11,73652.6,31.1797], Tmin=(100,'K'), Tmax=(922.003,'K')), NASAPolynomial(coeffs=[22.2458,0.00427467,7.28122e-07,-2.2698e-10,1.29674e-14,68093.2,-80.1486], Tmin=(922.003,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(611.244,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CCJCO) + radical(CCJ2_triplet) + radical(C=CJO)"""),
)
...
species(
    label = 'C[CH][CH][CH]OC=[C][O](12964)',
    structure = SMILES('C[CH][CH][CH]O[CH][C]=O'),
    E0 = (522.409,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3016.67,3033.33,3050,390,401.667,413.333,425,1340,1346.67,1353.33,1360,335,346.667,358.333,370,1855,455,950,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (111.119,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.102355,0.0900174,-0.000120004,8.70366e-08,-2.5311e-11,62967.7,36.4843], Tmin=(100,'K'), Tmax=(840.784,'K')), NASAPolynomial(coeffs=[12.6648,0.0302507,-1.33747e-05,2.48742e-09,-1.7047e-13,60855.3,-21.9434], Tmin=(840.784,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(522.409,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(332.579,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(RCCJC) + radical(CCJCO) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CsCJ=O)"""),
)

species(
    label = '[CH2][CH][CH]CO[CH][C]=O(11355)',
...
species(
    label = 'C[CH]C[CH]OC=[C][O](12965)',
    structure = SMILES('C[CH]C[CH]O[CH][C]=O'),
    E0 = (322.507,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.09799,0.095323,-0.000129084,9.73683e-08,-2.96607e-11,38931.4,34.7055], Tmin=(100,'K'), Tmax=(801.764,'K')), NASAPolynomial(coeffs=[12.0749,0.0345897,-1.54551e-05,2.88173e-09,-1.97422e-13,36979.5,-21.3319], Tmin=(801.764,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(322.507,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(RCCJC) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CsCJ=O)"""),
)
...
species(
    label = '[CH2][CH]CCOC=[C][O](12966)',
    structure = SMILES('[CH2][CH]CCOC=[C][O]'),
    E0 = (339.039,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,3010,987.5,1337.5,450,1655,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    label = 'C[CH][CH][CH]OC=[C]O(12967)',
    structure = SMILES('C[CH][CH][CH]OC=[C]O'),
    E0 = (386.16,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,3010,987.5,1337.5,450,1655,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-1.42659,0.0995515,-0.000110751,5.85979e-08,-1.15447e-11,46656.7,40.3425], Tmin=(100,'K'), Tmax=(1418.09,'K')), NASAPolynomial(coeffs=[26.1044,0.0083123,1.25961e-07,-2.81256e-10,2.60911e-14,40214.1,-97.2801], Tmin=(1418.09,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(386.16,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(RCCJC) + radical(CCJCO) + radical(CCsJOC(O)) + radical(C=CJO)"""),
)
...
species(
    label = '[CH2][CH][CH]COC=[C]O(12968)',
    structure = SMILES('[CH2][CH][CH]COC=[C]O'),
    E0 = (397.479,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,3010,987.5,1337.5,450,1655,3000,3100,440,815,1455,1000,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
...
species(
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.272875,0.064516,-1.26569e-05,-3.94023e-08,2.21563e-11,-1652.12,28.5608], Tmin=(100,'K'), Tmax=(963.045,'K')), NASAPolynomial(coeffs=[21.4914,0.018281,-5.89877e-06,1.0924e-09,-8.2465e-14,-7681.84,-83.0943], Tmin=(963.045,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-14.9834,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(361.68,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + group(Cds-OdCsH) + radical(Allyl_S) + radical(CsCJ=O)"""),
)

species(
    label = 'C[CH][CH][CH]OC[C]=O(12970)',
    structure = SMILES('C[CH][CH][CH]OC[C]=O'),
    E0 = (341.953,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2800,2850,1350,1500,750,1050,1375,1000,2750,2850,1437.5,1250,1305,750,350,3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,1855,455,950,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.522798,0.0815038,-9.51885e-05,6.5453e-08,-1.8847e-11,41248.2,35.5358], Tmin=(100,'K'), Tmax=(834.554,'K')), NASAPolynomial(coeffs=[9.55264,0.0382232,-1.73962e-05,3.30912e-09,-2.30824e-13,39741,-6.3947], Tmin=(834.554,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(341.953,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-(Cds-O2d)OsHH) + group(Cds-OdCsH) + radical(RCCJC) + radical(CCJCO) + radical(CCsJOCs) + radical(CsCJ=O)"""),
)

species(
    label = '[CH2][CH][CH]COC[C]=O(12971)',
    structure = SMILES('[CH2][CH][CH]COC[C]=O'),
    E0 = (366.743,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,1855,455,950,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (112.127,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.29396,0.0684229,-5.16326e-05,-6.35387e-09,2.81367e-11,44197.8,35.2002], Tmin=(100,'K'), Tmax=(527.372,'K')), NASAPolynomial(coeffs=[6.37441,0.0436901,-2.05404e-05,3.96494e-09,-2.78802e-13,43470,12.121], Tmin=(527.372,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(366.743,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(357.522,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-(Cds-O2d)OsHH) + group(Cs-CsHHH) + group(Cds-OdCsH) + radical(CCJCO) + radical(RCCJC) + radical(RCCJ) + radical(CsCJ=O)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH2]OC=[C][O](11465)', '[CH][CH]C(3874)'],
    products = ['C[CH][CH]CO[CH][C]=O(11210)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH3(17)', '[CH][CH]COC=[C][O](12376)'],
    products = ['C[CH][CH]CO[CH][C]=O(11210)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'C[C][CH]COC=[C][O](12962)'],
    products = ['C[CH][CH]CO[CH][C]=O(11210)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', 'C[CH][C]COC=[C][O](12963)'],
    products = ['C[CH][CH]CO[CH][C]=O(11210)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', 'CC=C[CH]OC=[C][O](12245)'],
    products = ['C[CH][CH]CO[CH][C]=O(11210)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', 'C=C[CH]CO[CH][C]=O(11250)'],
    products = ['C[CH][CH]CO[CH][C]=O(11210)'],
...
reaction(
    label = 'reaction13',
    reactants = ['HCCO(2227)', 'C[CH][CH]C[O](3807)'],
    products = ['C[CH][CH]CO[CH][C]=O(11210)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]=[C][O](6861)', 'C[CH][CH]C[O](3807)'],
    products = ['C[CH][CH]CO[CH][C]=O(11210)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', 'C[CH][CH][CH]OC=[C][O](12964)'],
    products = ['C[CH][CH]CO[CH][C]=O(11210)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH2][CH][CH]CO[CH][C]=O(11355)'],
    products = ['C[CH][CH]CO[CH][C]=O(11210)'],
...
reaction(
    label = 'reaction19',
    reactants = ['C[CH][CH]CO[CH][C]=O(11210)'],
    products = ['C[CH]C[CH]OC=[C][O](12965)'],
...
reaction(
    label = 'reaction20',
    reactants = ['[CH2]C[CH]COC=[C][O](11785)'],
    products = ['C[CH][CH]CO[CH][C]=O(11210)'],
...
reaction(
    label = 'reaction22',
    reactants = ['C[CH][CH]CO[CH][C]=O(11210)'],
    products = ['CC[CH][CH]OC=[C][O](11784)'],
...
reaction(
    label = 'reaction23',
    reactants = ['[CH2][CH]CCOC=[C][O](12966)'],
    products = ['C[CH][CH]CO[CH][C]=O(11210)'],
...
reaction(
    label = 'reaction28',
    reactants = ['C[CH][CH][CH]OC=[C]O(12967)'],
    products = ['C[CH][CH]CO[CH][C]=O(11210)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH2][CH][CH]COC=[C]O(12968)'],
    products = ['C[CH][CH]CO[CH][C]=O(11210)'],
...
reaction(
    label = 'reaction34',
    reactants = ['C[CH][CH][CH]OC[C]=O(12970)'],
    products = ['C[CH][CH]CO[CH][C]=O(11210)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH2][CH][CH]COC[C]=O(12971)'],
    products = ['C[CH][CH]CO[CH][C]=O(11210)'],
