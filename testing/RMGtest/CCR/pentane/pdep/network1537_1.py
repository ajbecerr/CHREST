...
species(
    ...
    molecularWeight = (69.0819,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.4113,0.0604029,-8.40059e-05,6.19414e-08,-1.82271e-11,102011,20.6551], Tmin=(100,'K'), Tmax=(831.701,'K')), NASAPolynomial(coeffs=[10.0769,0.0187273,-8.84435e-06,1.69545e-09,-1.18211e-13,100570,-19.5546], Tmin=(831.701,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(847.42,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CJCO) + radical(CH2_triplet) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (70.0898,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.5009,0.0406395,3.53324e-06,-4.58795e-08,2.40784e-11,31699.7,18.6583], Tmin=(100,'K'), Tmax=(924.937,'K')), NASAPolynomial(coeffs=[18.1286,0.00575931,4.96938e-08,-8.64316e-11,2.40978e-15,27039.9,-68.8255], Tmin=(924.937,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(262.708,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(245.277,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJ2_triplet)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['[CH][CH](6981)', '[CH2]C[O](1358)'],
    products = ['[CH][CH]OC[CH2](1568)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction3',
    reactants = ['CH2(T)(20)', '[CH][CH]O[CH2](6982)'],
    products = ['[CH][CH]OC[CH2](1568)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH][CH]OC[CH](6983)'],
    products = ['[CH][CH]OC[CH2](1568)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH][C]OC[CH2](6984)'],
    products = ['[CH][CH]OC[CH2](1568)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    ...
    products = ['[CH][CH]OC[CH2](1568)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(2.82396,'m^3/(mol*s)'), n=2.03228, Ea=(98.0683,'kJ/mol'), T0=(1,'K'), comment="""Estimated using average of templates [R_R;CJ] + [Od_R;YJ] for rate rule [Od_R;CJ]
Euclidian distance = 1.0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 94.8 to 98.1 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', '[CH][CH]O[CH][CH2](6987)'],
    products = ['[CH][CH]OC[CH2](1568)'],
