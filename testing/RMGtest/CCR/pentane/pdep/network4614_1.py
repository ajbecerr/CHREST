...
species(
    label = 'C#CCC[CH]CC(15687)',
    structure = SMILES('C#CCC[CH]CC'),
    E0 = (272.699,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,2175,525,750,770,3400,2100,200,800,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.11283,0.0664612,-5.06182e-05,2.50758e-08,-5.79495e-12,32899.6,27.5916], Tmin=(100,'K'), Tmax=(969.724,'K')), NASAPolynomial(coeffs=[6.02274,0.0462083,-1.92903e-05,3.53836e-09,-2.42478e-13,31947.3,4.05503], Tmin=(969.724,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(272.699,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(411.566,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtH) + radical(RCCJCC)"""),
)
...
species(
    label = 'CC[CH]CC[C]=C[O](21647)',
    structure = SMILES('CC[CH]CC[C]=C[O]'),
    E0 = (277.108,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2770,2790,2810,2830,2850,1425,1437.5,1450,1225,1250,1275,1270,1305,1340,700,750,800,300,350,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3025,407.5,1350,352.5,3010,987.5,1337.5,450,1655,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.33478,0.0781993,-5.95986e-05,2.46234e-08,-4.26835e-12,33462,34.2727], Tmin=(100,'K'), Tmax=(1330.13,'K')), NASAPolynomial(coeffs=[13.0537,0.0399505,-1.64649e-05,3.00454e-09,-2.05024e-13,30078.5,-30.7169], Tmin=(1330.13,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(277.108,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-(Cds-Cd)H) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(RCCJCC) + radical(Cds_S)"""),
)
...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.267012,0.097618,-0.000105328,6.4012e-08,-1.60754e-11,80239.9,37.1809], Tmin=(100,'K'), Tmax=(955.611,'K')), NASAPolynomial(coeffs=[12.9345,0.0423578,-1.85846e-05,3.49561e-09,-2.43128e-13,77716.9,-25.9088], Tmin=(955.611,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(665.901,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(CCJ2_triplet) + radical(Cds_S)"""),
)

species(
    label = 'CC[CH]CCC1=COO1(21649)',
    structure = SMILES('CC[CH]CCC1=COO1'),
    E0 = (202.594,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.171144,0.0790034,-5.10611e-05,1.62141e-08,-2.06465e-12,24527.3,37.5183], Tmin=(100,'K'), Tmax=(1817.85,'K')), NASAPolynomial(coeffs=[20.7412,0.0329872,-1.30903e-05,2.28877e-09,-1.49537e-13,16924.3,-75.87], Tmin=(1817.85,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(202.594,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-O2s(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsOs) + group(Cds-CdsOsH) + ring(Cyclobutene) + radical(RCCJCC)"""),
)
...
species(
    label = 'CCC=CCC=CO[O](21651)',
    structure = SMILES('CCC=CCC=CO[O]'),
    E0 = (97.7856,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.374858,0.0857914,-6.63394e-05,2.67311e-08,-4.36116e-12,11927,37.9166], Tmin=(100,'K'), Tmax=(1450.07,'K')), NASAPolynomial(coeffs=[18.2157,0.0345099,-1.32923e-05,2.34285e-09,-1.56516e-13,6535.44,-58.6804], Tmin=(1450.07,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(97.7856,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(461.453,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ)"""),
)
...
species(
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0496788,0.0851713,-7.37152e-05,3.46364e-08,-6.73026e-12,40510.2,36.856], Tmin=(100,'K'), Tmax=(1213.27,'K')), NASAPolynomial(coeffs=[14.1903,0.0385511,-1.6077e-05,2.96525e-09,-2.04252e-13,37079,-34.0981], Tmin=(1213.27,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(335.627,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(436.51,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-(Cds-Cds)(Cds-Cds)HH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (126.153,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0890486,0.0925356,-0.000114137,9.19179e-08,-3.11064e-11,48221.5,37.526], Tmin=(100,'K'), Tmax=(818.086,'K')), NASAPolynomial(coeffs=[6.71583,0.0513588,-2.25474e-05,4.16846e-09,-2.83987e-13,47430.9,8.68089], Tmin=(818.086,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(399.817,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(432.353,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-OsCt) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Ct-CtCs) + group(Ct-CtOs) + radical(ROOJ) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0842534,0.0955991,-0.000108334,7.73375e-08,-2.36389e-11,49709.8,39.3537], Tmin=(100,'K'), Tmax=(783.171,'K')), NASAPolynomial(coeffs=[8.69608,0.0507494,-2.24246e-05,4.20062e-09,-2.90085e-13,48334.7,-0.859489], Tmin=(783.171,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(412.132,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(RCCJC) + radical(Cds_S)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.0718105,0.0948774,-0.000122315,1.0548e-07,-3.79125e-11,49931.6,41.2651], Tmin=(100,'K'), Tmax=(812.117,'K')), NASAPolynomial(coeffs=[4.92108,0.0568368,-2.59069e-05,4.87487e-09,-3.35233e-13,49610.8,21.7534], Tmin=(812.117,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(414.047,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(RCCJCC) + radical(C=CJO)"""),
)

species(
    label = 'CC[CH]CC[C]=[C]OO(21659)',
    structure = SMILES('CC[CH]CC[C]=[C]OO'),
    E0 = (499.884,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.237496,0.103235,-0.000143101,1.26604e-07,-4.57668e-11,60265,42.0889], Tmin=(100,'K'), Tmax=(814.447,'K')), NASAPolynomial(coeffs=[5.4407,0.0577856,-2.70507e-05,5.1346e-09,-3.54168e-13,59922.6,19.4361], Tmin=(814.447,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(499.884,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJCC) + radical(Cds_S) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.132413,0.0947661,-9.44059e-05,5.41568e-08,-1.30815e-11,51012.6,38.5789], Tmin=(100,'K'), Tmax=(982.081,'K')), NASAPolynomial(coeffs=[11.789,0.0462101,-2.02423e-05,3.81188e-09,-2.65479e-13,48671.1,-18.7193], Tmin=(982.081,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(422.932,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(RCCJ) + radical(Cds_S)"""),
)

species(
    label = 'CC[CH][CH]CC=CO[O](21661)',
    structure = SMILES('CC[CH][CH]CC=CO[O]'),
    E0 = (368.761,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.125804,0.0934627,-0.00011882,1.01911e-07,-3.64738e-11,44483.2,40.507], Tmin=(100,'K'), Tmax=(817.846,'K')), NASAPolynomial(coeffs=[4.7423,0.0567557,-2.55833e-05,4.78741e-09,-3.28128e-13,44200.6,22.052], Tmin=(817.846,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(368.761,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(RCCJCC) + radical(RCCJCC)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.165028,0.0983448,-0.000120544,9.47674e-08,-3.17437e-11,55159.8,40.0298], Tmin=(100,'K'), Tmax=(768.851,'K')), NASAPolynomial(coeffs=[7.91092,0.0525472,-2.38157e-05,4.49744e-09,-3.11163e-13,54029.7,3.91779], Tmin=(768.851,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(457.43,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(Cds_S) + radical(C=CJO)"""),
)
...
species(
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.121411,0.0909539,-9.43051e-05,6.15638e-08,-1.74946e-11,45783.9,39.7627], Tmin=(100,'K'), Tmax=(832.557,'K')), NASAPolynomial(coeffs=[8.37985,0.0512727,-2.28057e-05,4.30558e-09,-2.99499e-13,44408.9,1.43469], Tmin=(832.557,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(379.549,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(457.296,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(ROOJ) + radical(RCCJCC) + radical(RCCJ)"""),
)

species(
    label = 'CC[CH][CH]C[C]=COO(21664)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.182462,0.101807,-0.000139551,1.22954e-07,-4.42881e-11,54816.6,41.3271], Tmin=(100,'K'), Tmax=(819.387,'K')), NASAPolynomial(coeffs=[5.25949,0.0577088,-2.67298e-05,5.04778e-09,-3.47117e-13,54513.4,19.7483], Tmin=(819.387,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(454.598,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJCC) + radical(RCCJCC) + radical(Cds_S)"""),
)

species(
    label = 'C[CH][CH]CC[C]=COO(21665)',
    ...
    molecularWeight = (127.161,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.212364,0.101235,-0.000133978,1.14008e-07,-4.01765e-11,54817.5,41.607], Tmin=(100,'K'), Tmax=(811.107,'K')), NASAPolynomial(coeffs=[6.31817,0.0558181,-2.55561e-05,4.81236e-09,-3.3092e-13,54192.7,14.147], Tmin=(811.107,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(454.586,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(453.139,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-O2s(Cds-Cd)) + group(O2s-OsH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + radical(RCCJCC) + radical(RCCJC) + radical(Cds_S)"""),
)
...
reaction(
    label = 'reaction4',
    reactants = ['[CH2]C(C)CC[C]=CO[O](21646)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['CC[CH]CC[C]=CO[O](20953)'],
    products = ['O2(S)(666)', 'C#CCC[CH]CC(15687)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(5e+12,'s^-1'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), Tmin=(300,'K'), Tmax=(1500,'K'), comment="""Exact match found for rate rule [RJJ]
Euclidian distance = 0
family: 1,4_Linear_birad_scission"""),
...
reaction(
    label = 'reaction7',
    reactants = ['O(4)', 'CC[CH]CC[C]=C[O](21647)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
    transitionState = 'TS7',
...
reaction(
    label = 'reaction8',
    reactants = ['[CH]CC(26)', '[CH2]C[C]=CO[O](21345)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
    transitionState = 'TS8',
...
reaction(
    label = 'reaction9',
    reactants = ['C2H5(14)', '[CH]CC[C]=CO[O](21347)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
    transitionState = 'TS9',
    kinetics = Arrhenius(A=(1.34164e+08,'m^3/(mol*s)'), n=-0.791073, Ea=(55.3901,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [Y_rad;Birad] for rate rule [C_rad/H2/Cs;Birad]
Euclidian distance = 3.0
...
reaction(
    label = 'reaction10',
    reactants = ['[C]=CO[O](21346)', '[CH2]C[CH]CC(101)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
...
reaction(
    label = 'reaction11',
    reactants = ['H(3)', 'CC[C]CC[C]=CO[O](21648)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
...
reaction(
    label = 'reaction12',
    reactants = ['CC[CH]CC[C]=CO[O](20953)'],
    products = ['CC[CH]CCC1=COO1(21649)'],
...
reaction(
    label = 'reaction14',
    reactants = ['CC[CH]CC[C]=CO[O](20953)'],
    products = ['O(4)', 'CC[CH]CCC1=CO1(21650)'],
...
reaction(
    label = 'reaction19',
    reactants = ['H(3)', 'CCC=CC[C]=CO[O](21652)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
...
reaction(
    label = 'reaction20',
    reactants = ['H(3)', 'CC=CCC[C]=CO[O](21099)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
...
reaction(
    label = 'reaction22',
    reactants = ['H(3)', 'CC[CH]CCC#CO[O](21653)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
...
reaction(
    label = 'reaction24',
    reactants = ['CH3(17)', 'C=CCC[C]=CO[O](20982)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
...
reaction(
    label = 'reaction26',
    reactants = ['O2(2)', 'C#CCC[CH]CC(15687)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
...
reaction(
    label = 'reaction27',
    reactants = ['O2(2)', '[CH]=[C]CC[CH]CC(15691)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
...
reaction(
    label = 'reaction29',
    reactants = ['H(3)', 'CC[CH][CH]C[C]=CO[O](21654)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
...
reaction(
    label = 'reaction30',
    reactants = ['CH3(17)', '[CH2][CH]CC[C]=CO[O](20977)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
...
reaction(
    label = 'reaction31',
    reactants = ['H(3)', 'C[CH][CH]CC[C]=CO[O](21084)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
...
reaction(
    label = 'reaction33',
    reactants = ['H(3)', '[CH2]C[CH]CC[C]=CO[O](21655)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
...
reaction(
    label = 'reaction34',
    reactants = ['H(3)', 'CC[CH]CC[C]=[C]O[O](21656)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
...
reaction(
    label = 'reaction36',
    reactants = ['CC[CH]CC[C]=CO[O](20953)'],
    products = ['C[CH]CCC[C]=CO[O](21657)'],
...
reaction(
    label = 'reaction38',
    reactants = ['CC[CH]CC[C]=CO[O](20953)'],
    products = ['CC[CH]CCC=[C]O[O](21658)'],
...
reaction(
    label = 'reaction39',
    reactants = ['CC[CH]CC[C]=[C]OO(21659)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
...
reaction(
    label = 'reaction41',
    reactants = ['[CH2]CCCC[C]=CO[O](21660)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
...
reaction(
    label = 'reaction42',
    reactants = ['CC[CH]CC[C]=CO[O](20953)'],
    products = ['CC[CH][CH]CC=CO[O](21661)'],
...
reaction(
    label = 'reaction43',
    reactants = ['CC[CH]CC[C]=CO[O](20953)'],
    products = ['C[CH][CH]CCC=CO[O](4820)'],
...
reaction(
    label = 'reaction44',
    reactants = ['CCCCC[C]=[C]O[O](21662)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
    transitionState = 'TS44',
    kinetics = Arrhenius(A=(1.182e+10,'s^-1'), n=0.86, Ea=(149.369,'kJ/mol'), T0=(1,'K'), comment="""Estimated using template [RnH;Cd_rad_out_singleNd;Cs_H_out_H/NonDeC] for rate rule [R5HJ_1;Cd_rad_out_singleNd;Cs_H_out_H/(NonDeC/Cs)]
...
reaction(
    label = 'reaction46',
    reactants = ['CC[CH]CC[C]=CO[O](20953)'],
    products = ['[CH2]C[CH]CCC=CO[O](21663)'],
...
reaction(
    label = 'reaction47',
    reactants = ['CC[CH][CH]C[C]=COO(21664)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
...
reaction(
    label = 'reaction48',
    reactants = ['C[CH][CH]CC[C]=COO(21665)'],
    products = ['CC[CH]CC[C]=CO[O](20953)'],
...
network(
    label = 'PDepNetwork #4614',
    isomers = [
        'CC[CH]CC[C]=CO[O](20953)',
    ],
    reactants = [
