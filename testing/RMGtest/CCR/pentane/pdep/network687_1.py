...
species(
    ...
    molecularWeight = (83.1085,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.33835,0.0172282,7.47312e-05,-1.16324e-07,4.87058e-11,9073.9,16.6396], Tmin=(100,'K'), Tmax=(909.241,'K')), NASAPolynomial(coeffs=[14.7936,0.0127433,-8.65861e-07,-4.12552e-11,1.42295e-15,4729.38,-53.7003], Tmin=(909.241,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(74.7973,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(303.478,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsOsH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsOsH) + ring(2,3-Dihydrofuran) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'C#COC[CH2](2366)'],
    products = ['C#COC([CH2])C(2293)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH]C(C)OC#C(3095)'],
    products = ['C#COC([CH2])C(2293)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction12',
    reactants = ['HC2(2881)', '[CH2]C(C)[O](667)'],
    products = ['C#COC([CH2])C(2293)'],
...
reaction(
    label = 'reaction15',
    reactants = ['H(3)', 'C#COC([CH2])[CH2](2588)'],
    products = ['C#COC([CH2])C(2293)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', '[C]#COC([CH2])C(3102)'],
    products = ['C#COC([CH2])C(2293)'],
