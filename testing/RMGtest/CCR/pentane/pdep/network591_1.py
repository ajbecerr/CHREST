...
species(
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.666317,0.0830513,-0.000147842,1.33786e-07,-4.59963e-11,77751.1,25.3266], Tmin=(100,'K'), Tmax=(866.174,'K')), NASAPolynomial(coeffs=[8.63634,0.0256628,-1.28149e-05,2.42528e-09,-1.63969e-13,77142.5,-7.52207], Tmin=(866.174,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(645.538,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOCs) + radical(CJCO) + radical(CH2_triplet)"""),
)

species(
    label = '[CH2][C]OC[CH][O](1924)',
    structure = SMILES('[CH2][C]OC[CH][O]'),
    E0 = (645.38,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.736482,0.0843317,-0.000158397,1.50589e-07,-5.36385e-11,77726.8,25.1777], Tmin=(100,'K'), Tmax=(867.408,'K')), NASAPolynomial(coeffs=[6.3371,0.0300858,-1.54453e-05,2.94882e-09,-2.00038e-13,77824.3,5.11732], Tmin=(867.408,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(645.38,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOH) + radical(CJCO) + radical(CH2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.690082,0.0544614,-4.75674e-05,2.246e-08,-3.98932e-12,16450.9,22.4851], Tmin=(100,'K'), Tmax=(1673.15,'K')), NASAPolynomial(coeffs=[11.6242,0.0161455,-2.30095e-06,7.41695e-11,5.42975e-15,14496.3,-30.8005], Tmin=(1673.15,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(135.658,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(278.535,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(CC(C)OJ) + radical(CJC(C)OC)"""),
)

species(
    label = '[CH2]COC=C[O](1926)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.769618,0.0516178,2.09053e-06,-6.13492e-08,3.36211e-11,-4826.5,22.1831], Tmin=(100,'K'), Tmax=(912.067,'K')), NASAPolynomial(coeffs=[24.594,-0.00128233,4.25284e-06,-9.18069e-10,5.92059e-14,-11318,-102.325], Tmin=(912.067,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-41.2479,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(270.22,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(O2s-(Cds-Cd)H) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsOsH) + radical(C=COJ) + radical(CJCO)"""),
)
...
species(
    label = '[CH2][CH]O[CH][CH][O](1928)',
    structure = SMILES('[CH2][CH]O[CH][CH][O]'),
    E0 = (545.304,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3000,3025,3050,390,407.5,425,1340,1350,1360,335,352.5,370,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (85.0813,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.30955,0.0928374,-0.000172887,1.56091e-07,-5.24998e-11,65706.8,26.8706], Tmin=(100,'K'), Tmax=(898.032,'K')), NASAPolynomial(coeffs=[9.69859,0.0235464,-1.12646e-05,2.04534e-09,-1.32931e-13,65128.1,-11.249], Tmin=(898.032,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(545.304,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(241.12,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CJCO) + radical(CCsJOH)"""),
)

species(
    label = '[CH2][CH]O[CH]C[O](1929)',
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.558033,0.0843484,-0.000142597,1.25081e-07,-4.1917e-11,44015.8,26.4294], Tmin=(100,'K'), Tmax=(878.771,'K')), NASAPolynomial(coeffs=[9.17983,0.0265714,-1.23429e-05,2.26778e-09,-1.5082e-13,43216,-9.98018], Tmin=(878.771,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(365.006,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CJCO)"""),
)

species(
    label = '[CH2]CO[CH][CH][O](1930)',
    structure = SMILES('[CH2]CO[CH][CH][O]'),
    E0 = (364.848,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.630298,0.085602,-0.000153047,1.41732e-07,-4.94853e-11,43991.4,26.2731], Tmin=(100,'K'), Tmax=(876.792,'K')), NASAPolynomial(coeffs=[6.87595,0.0310027,-1.49783e-05,2.79252e-09,-1.8699e-13,43899.7,2.68508], Tmin=(876.792,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(364.848,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(266.063,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCOJ) + radical(CCsJOCs) + radical(CJCO) + radical(CCsJOH)"""),
)

species(
    label = '[CH2][CH]O[CH][CH]O(1931)',
    structure = SMILES('[CH2][CH]O[CH][CH]O'),
    E0 = (319.599,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (86.0892,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.0533035,0.0955976,-0.000160671,1.31152e-07,-4.0478e-11,38578.7,27.312], Tmin=(100,'K'), Tmax=(918.264,'K')), NASAPolynomial(coeffs=[14.3895,0.017128,-7.07805e-06,1.19339e-09,-7.37365e-14,36582.1,-37.5633], Tmin=(918.264,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(319.599,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(261.906,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + radical(CCsJOCs) + radical(CCsJOCs) + radical(CCsJOH) + radical(CJCO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[CH][CH2](502)', '[O][CH]C[O](1529)'],
    products = ['[CH2][CH]OC[CH][O](1539)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['[CH][O](1548)', '[CH2][CH]O[CH2](1565)'],
    products = ['[CH2][CH]OC[CH][O](1539)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2][CH]OC[C][O](1923)'],
    products = ['[CH2][CH]OC[CH][O](1539)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH2][C]OC[CH][O](1924)'],
    products = ['[CH2][CH]OC[CH][O](1539)'],
    transitionState = 'TS6',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction7',
    reactants = ['H(3)', '[CH][CH]OC[CH][O](1925)'],
    products = ['[CH2][CH]OC[CH][O](1539)'],
    transitionState = 'TS7',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction10',
    reactants = ['H(3)', '[CH2][CH]OC=C[O](1927)'],
    products = ['[CH2][CH]OC[CH][O](1539)'],
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2][CH]O[CH][CH][O](1928)'],
    products = ['[CH2][CH]OC[CH][O](1539)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH2][CH]O[CH]C[O](1929)'],
    products = ['[CH2][CH]OC[CH][O](1539)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH2][CH]OC[CH][O](1539)'],
    products = ['[CH2][CH]O[CH][CH]O(1931)'],
