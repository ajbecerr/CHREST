species(
    ...
    collisionModel = TransportData(shapeIndex=2, epsilon=(4218.73,'J/mol'), sigma=(6.73384,'angstroms'), dipoleMoment=(0,'C*m'), polarizability=(0,'angstroms^3'), rotrelaxcollnum=0, comment="""Epsilon & sigma estimated with Tc=658.96 K, Pc=31.35 bar (from Joback method)"""),
