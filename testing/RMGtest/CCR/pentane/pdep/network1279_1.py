...
species(
    label = 'C=C=[C]CCC(9381)',
    structure = SMILES('[CH2]C#CCCC'),
    E0 = (240.027,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3000,3100,440,815,1455,1000,2100,2250,500,550,258.915,3720.59],'cm^-1')),
        HinderedRotor(inertia=(0.00250098,'amu*angstrom^2'), symmetry=1, barrier=(0.119627,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.73239,'amu*angstrom^2'), symmetry=1, barrier=(82.8483,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.481731,'amu*angstrom^2'), symmetry=1, barrier=(22.8789,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(1.72292,'amu*angstrom^2'), symmetry=1, barrier=(82.8674,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 2,
    opticalIsomers = 1,
    molecularWeight = (81.1357,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.52186,0.0473309,-1.53983e-05,-8.4619e-09,5.51218e-12,28964,23.5376], Tmin=(100,'K'), Tmax=(1039.45,'K')), NASAPolynomial(coeffs=[9.5187,0.0305972,-1.15105e-05,2.0387e-09,-1.38582e-13,26543.1,-19.0004], Tmin=(1039.45,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(240.027,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CtCsHH) + group(Cs-CsHHH) + group(Cs-CtHHH) + group(Ct-CtCs) + group(Ct-CtCs) + radical(Propargyl)"""),
)
...
species(
    label = 'C=C[C]CCC(9383)',
    structure = SMILES('C=C[C]CCC'),
    E0 = (363.447,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,195.546,195.558,195.572,1975.31],'cm^-1')),
        HinderedRotor(inertia=(0.519195,'amu*angstrom^2'), symmetry=1, barrier=(14.094,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.24377,'amu*angstrom^2'), symmetry=1, barrier=(60.9228,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.802976,'amu*angstrom^2'), symmetry=1, barrier=(21.7944,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(2.24505,'amu*angstrom^2'), symmetry=1, barrier=(60.9226,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.63201,0.0569793,-3.4319e-05,1.07922e-08,-1.50186e-12,43793,31.681], Tmin=(100,'K'), Tmax=(1462.81,'K')), NASAPolynomial(coeffs=[7.45615,0.0410534,-1.79882e-05,3.34953e-09,-2.29868e-13,42089,1.36768], Tmin=(1462.81,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(363.447,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + group(CsJ2_singlet-CsH)"""),
)

species(
    label = '[CH]C=CCCC(9384)',
    structure = SMILES('[CH]C=CCCC'),
    E0 = (374.772,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2783.33,2816.67,2850,1425,1450,1225,1275,1270,1340,700,800,300,400,2750,2800,2850,1350,1500,750,1050,1375,1000,2995,3025,975,1000,1300,1375,400,500,1630,1680,200,800,1066.67,1333.33,1600],'cm^-1')),
    ...
    molecularWeight = (82.1436,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.57812,0.0544517,-3.17403e-05,9.04042e-09,-1.06239e-12,45159.8,22.9494], Tmin=(100,'K'), Tmax=(1824.37,'K')), NASAPolynomial(coeffs=[11.4839,0.032733,-1.38831e-05,2.51501e-09,-1.68191e-13,41545.4,-30.7959], Tmin=(1824.37,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(374.772,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(365.837,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(Cs-CsCsHH) + group(Cs-(Cds-Cds)CsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsCsH) + group(CsJ2_singlet-CsH)"""),
)
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'C=C=CCC(9374)'],
...
reaction(
    label = 'reaction14',
    reactants = ['C2H5(14)', 'CH2CHCCH2(4848)'],
    products = ['C=C=CCCC(4854)'],
...
reaction(
    label = 'reaction15',
    reactants = ['CH3(17)', '[CH2]CC=C=C(9378)'],
    products = ['C=C=CCCC(4854)'],
...
reaction(
    label = 'reaction16',
    reactants = ['H(3)', 'C=C=CC[CH]C(9379)'],
    products = ['C=C=CCCC(4854)'],
...
reaction(
    label = 'reaction17',
    reactants = ['C3H3(5450)', 'npropyl(13)'],
    products = ['C=C=CCCC(4854)'],
...
reaction(
    label = 'reaction18',
    reactants = ['H(3)', 'C=C=C[CH]CC(9380)'],
    products = ['C=C=CCCC(4854)'],
