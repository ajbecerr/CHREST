...
species(
    label = '[CH2][CH][C]CO[C]=C(9130)',
    structure = SMILES('[CH2][CH][C]CO[C]=C'),
    E0 = (854.584,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3025,407.5,1350,352.5,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.749195,0.0717566,-7.68898e-05,4.46916e-08,-1.05026e-11,102900,32.4018], Tmin=(100,'K'), Tmax=(1029.54,'K')), NASAPolynomial(coeffs=[12.3935,0.0265153,-1.09739e-05,2.00792e-09,-1.37689e-13,100502,-24.1139], Tmin=(1029.54,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(854.584,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(RCCJC) + radical(RCCJ) + radical(CCJ2_triplet) + radical(C=CJO)"""),
)

species(
    label = '[CH2][C][CH]CO[C]=C(9131)',
    ...
    molecularWeight = (95.1192,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.454584,0.0698246,-6.12842e-05,2.3106e-08,-2.03946e-12,103574,33.215], Tmin=(100,'K'), Tmax=(1013,'K')), NASAPolynomial(coeffs=[17.0477,0.0186503,-6.75074e-06,1.19716e-09,-8.27403e-14,99475.9,-50.6845], Tmin=(1013,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(860.04,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(311.793,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(RCCJ) + radical(CCJ2_triplet) + radical(C=CJO)"""),
)
...
species(
    label = '[CH2]C[CH][CH]O[C]=C(9134)',
    structure = SMILES('[CH2]C[CH][CH]O[C]=C'),
    E0 = (605.753,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3050,390,425,1340,1360,335,370,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.147713,0.0760768,-6.83643e-05,2.57448e-08,-1.97068e-12,73001.6,33.8843], Tmin=(100,'K'), Tmax=(989.694,'K')), NASAPolynomial(coeffs=[18.5782,0.0183733,-6.3494e-06,1.10866e-09,-7.65505e-14,68531.4,-58.9947], Tmin=(989.694,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(605.753,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-Cd)) + group(Cs-CsCsHH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsOsH) + group(Cds-CdsHH) + radical(CCJCO) + radical(CCsJOC(O)) + radical(RCCJ) + radical(C=CJO)"""),
)
...
reaction(
    label = 'reaction1',
    reactants = ['[CH2][CH][CH]CO[C]=C(4279)'],
...
reaction(
    label = 'reaction2',
    reactants = ['H2CC(T)(1341)', '[CH2][CH][CH]C[O](5580)'],
...
reaction(
    label = 'reaction3',
    reactants = ['[CH][CH][CH2](5537)', '[CH2]O[C]=C(2363)'],
    products = ['[CH2][CH][CH]CO[C]=C(4279)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['H(3)', '[CH2][CH][C]CO[C]=C(9130)'],
    products = ['[CH2][CH][CH]CO[C]=C(4279)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2][C][CH]CO[C]=C(9131)'],
    products = ['[CH2][CH][CH]CO[C]=C(4279)'],
    transitionState = 'TS5',
    kinetics = Arrhenius(A=(1e+07,'m^3/(mol*s)'), n=0, Ea=(0,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [H_rad;Birad]
Euclidian distance = 0
...
reaction(
    label = 'reaction13',
    reactants = ['H(3)', '[CH2][CH][CH][CH]O[C]=C(9133)'],
    products = ['[CH2][CH][CH]CO[C]=C(4279)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH2][CH][CH]CO[C]=C(4279)'],
    products = ['[CH2][CH]C[CH]O[C]=C(5388)'],
...
reaction(
    label = 'reaction18',
    reactants = ['[CH2]C[CH][CH]O[C]=C(9134)'],
    products = ['[CH2][CH][CH]CO[C]=C(4279)'],
