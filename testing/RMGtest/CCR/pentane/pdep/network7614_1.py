...
species(
    label = '[CH2][C]OC[O](29178)',
    structure = SMILES('[CH2][C]OC[O]'),
    E0 = (472.194,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,432.198,436.871,437.311,437.454,438.778],'cm^-1')),
        HinderedRotor(inertia=(0.0132041,'amu*angstrom^2'), symmetry=1, barrier=(1.78657,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.152048,'amu*angstrom^2'), symmetry=1, barrier=(20.6598,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.153175,'amu*angstrom^2'), symmetry=1, barrier=(20.7061,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 5,
    opticalIsomers = 1,
    molecularWeight = (72.0627,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.75492,0.0467262,-4.79011e-05,2.39959e-08,-4.71896e-12,56874.8,18.9674], Tmin=(100,'K'), Tmax=(1235.11,'K')), NASAPolynomial(coeffs=[12.5613,0.011729,-5.39816e-06,1.05444e-09,-7.53493e-14,54205.4,-35.4488], Tmin=(1235.11,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(472.194,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(195.39,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(CJCO) + radical(CH2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.31654,0.0315981,-1.15539e-05,-3.30071e-09,2.2618e-12,-23511.8,18.2118], Tmin=(100,'K'), Tmax=(1210.44,'K')), NASAPolynomial(coeffs=[8.90164,0.0194873,-8.50475e-06,1.60637e-09,-1.12036e-13,-25812.9,-17.7354], Tmin=(1210.44,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-196.029,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-Cs(Cds-O2d)) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-OdOsH) + radical(CJCO)"""),
)
...
species(
    ...
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.968702,0.0681893,-0.000102732,7.61051e-08,-2.15828e-11,18536.2,21.8152], Tmin=(100,'K'), Tmax=(929.661,'K')), NASAPolynomial(coeffs=[13.3297,0.0109904,-3.96489e-06,6.33945e-10,-3.8445e-14,16411.4,-35.9847], Tmin=(929.661,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(153.223,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(216.176,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(CCsJOCs) + radical(OCJO) + radical(CJCO)"""),
)

species(
    label = '[CH2]CO[CH][O](29181)',
    structure = SMILES('[CH2]CO[CH][O]'),
    E0 = (200.165,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,3000,3100,440,815,1455,1000,3025,407.5,1350,352.5,180,180,1142.11,1144.42],'cm^-1')),
        HinderedRotor(inertia=(0.122974,'amu*angstrom^2'), symmetry=1, barrier=(2.82742,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.121758,'amu*angstrom^2'), symmetry=1, barrier=(2.79945,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.120959,'amu*angstrom^2'), symmetry=1, barrier=(2.7811,'kJ/mol'), semiclassical=False),
    ],
    spinMultiplicity = 4,
    opticalIsomers = 1,
    molecularWeight = (73.0706,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.87663,0.0577274,-0.000106042,1.09483e-07,-4.21916e-11,24140.1,19.5837], Tmin=(100,'K'), Tmax=(849.869,'K')), NASAPolynomial(coeffs=[1.36366,0.0337799,-1.7247e-05,3.33087e-09,-2.29266e-13,25179.4,27.576], Tmin=(849.869,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(200.165,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(220.334,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-OsOsHH) + radical(OCOJ) + radical(CJCO) + radical(OCJO)"""),
)
...
reaction(
    label = 'reaction3',
    reactants = ['[O]C[O](28827)', '[CH][CH2](502)'],
    products = ['[CH2][CH]OC[O](3444)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', '[CH2][C]OC[O](29178)'],
    products = ['[CH2][CH]OC[O](3444)'],
    transitionState = 'TS5',
...
reaction(
    label = 'reaction9',
    reactants = ['H(3)', '[CH2][CH]OC=O(1967)'],
    products = ['[CH2][CH]OC[O](3444)'],
    transitionState = 'TS9',
...
reaction(
    label = 'reaction12',
    reactants = ['H(3)', '[CH2][CH]O[CH][O](1958)'],
    products = ['[CH2][CH]OC[O](3444)'],
