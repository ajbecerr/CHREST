...
species(
    label = '[CH]C([O])C([CH])C=C(7164)',
    structure = SMILES('[CH]C([O])C([CH])C=C'),
    E0 = (882.266,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3010,987.5,1337.5,450,1655,2950,3100,1380,975,1025,1650,200,800,914.286,1028.57,1142.86,1257.14,1371.43,1485.71,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.417494,0.0699911,-6.39256e-05,2.96454e-08,-5.42605e-12,106249,31.3602], Tmin=(100,'K'), Tmax=(1326.23,'K')), NASAPolynomial(coeffs=[16.9255,0.0202017,-7.61232e-06,1.33779e-09,-8.99287e-14,101870,-52.9419], Tmin=(1326.23,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(882.266,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(315.95,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(CCJ2_triplet) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1OCC1C=C(6962)',
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.48074,0.0396318,3.51173e-05,-8.20967e-08,3.81342e-11,46737.8,23.4464], Tmin=(100,'K'), Tmax=(891.927,'K')), NASAPolynomial(coeffs=[15.4548,0.0196991,-3.23319e-06,2.88769e-10,-1.52115e-14,42545.1,-51.9019], Tmin=(891.927,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(387.722,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + ring(Oxetane) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(O)C(=C)C=C(7165)',
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.431711,0.0665423,-3.84467e-05,-5.97307e-09,9.34904e-12,37314.6,28.5864], Tmin=(100,'K'), Tmax=(966.833,'K')), NASAPolynomial(coeffs=[18.7772,0.0181361,-6.00088e-06,1.06619e-09,-7.63458e-14,32482.2,-65.9466], Tmin=(966.833,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(309.094,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cds-Cds(Cds-Cds)Cs) + group(Cds-Cds(Cds-Cds)H) + group(Cds-CdsHH) + group(Cds-CdsHH) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C([O])[C]([CH2])C[CH2](7166)',
    structure = SMILES('[CH]C([O])[C]([CH2])C[CH2]'),
    E0 = (874.796,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([2750,2850,1437.5,1250,1305,750,350,1380,1390,370,380,2900,435,360,370,350,3000,3033.33,3066.67,3100,415,465,780,850,1435,1475,900,1100,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.663828,0.0687958,-6.05766e-05,2.88352e-08,-5.5838e-12,105338,32.7214], Tmin=(100,'K'), Tmax=(1235.05,'K')), NASAPolynomial(coeffs=[13.3644,0.0276623,-1.06192e-05,1.86896e-09,-1.25296e-13,102200,-31.2327], Tmin=(1235.05,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(874.796,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(CCJ(C)CO) + radical(RCCJ) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH][C]([O])C([CH2])C[CH2](7167)',
    structure = SMILES('[CH][C]([O])C([CH2])C[CH2]'),
    E0 = (898.85,'kJ/mol'),
    modes = [
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.396734,0.0822343,-0.000101915,7.14401e-08,-2.02981e-11,108234,32.9153], Tmin=(100,'K'), Tmax=(857.689,'K')), NASAPolynomial(coeffs=[11.2921,0.0314176,-1.30361e-05,2.35047e-09,-1.58297e-13,106365,-17.9753], Tmin=(857.689,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(898.85,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsCsHH) + longDistanceInteraction_noncyclic(CsCs-ST) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + radical(CC(C)OJ) + radical(C2CsJOH) + radical(Isobutyl) + radical(RCCJ) + radical(CCJ2_triplet)"""),
)
...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.73706,0.0323021,5.58461e-05,-1.05338e-07,4.74877e-11,70504.6,24.098], Tmin=(100,'K'), Tmax=(879.532,'K')), NASAPolynomial(coeffs=[15.3808,0.0180636,-1.41081e-06,-1.3311e-10,1.6195e-14,66255.2,-50.4866], Tmin=(879.532,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(585.393,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(349.208,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsOsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Tetrahydrofuran) + radical(CCJCO) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([O])C1CC1[CH2](7170)',
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[1.03113,0.0505664,4.38547e-06,-4.78301e-08,2.39236e-11,79961.5,28.0015], Tmin=(100,'K'), Tmax=(941.507,'K')), NASAPolynomial(coeffs=[16.8444,0.020205,-5.90661e-06,9.96283e-10,-7.11952e-14,75351.8,-56.0021], Tmin=(941.507,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(663.837,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-CsCsCsH) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Cyclopropane) + radical(CC(C)OJ) + radical(Isobutyl) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C1OC([CH2])C1[CH2](7171)',
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[-0.267171,0.0730413,-6.71807e-05,3.30682e-08,-6.12074e-12,79770.1,29.7035], Tmin=(100,'K'), Tmax=(1590.97,'K')), NASAPolynomial(coeffs=[14.8783,0.0197886,-2.66634e-06,3.97685e-11,1.12684e-14,76871.4,-44.3617], Tmin=(1590.97,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(661.82,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(345.051,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsCs) + group(Cs-CsCsCsH) + group(Cs-CsCsOsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cs-CsHHH) + ring(Oxetane) + radical(Isobutyl) + radical(CJC(C)OC) + radical(CCJ2_triplet)"""),
)
...
species(
    label = '[CH]C([O])C(C)[C]=C(7179)',
    structure = SMILES('[CH]C([O])C(C)[C]=C'),
    E0 = (671.893,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,2750,2800,2850,1350,1500,750,1050,1375,1000,2950,3100,1380,975,1025,1650,1685,370,200,800,1000,1200,1400,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.679795,0.0687409,-5.97248e-05,2.73263e-08,-5.07211e-12,80933.1,29.8839], Tmin=(100,'K'), Tmax=(1282.9,'K')), NASAPolynomial(coeffs=[14.0479,0.0270596,-1.09895e-05,2.00044e-09,-1.3679e-13,77503.2,-37.9398], Tmin=(1282.9,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(671.893,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(340.893,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(CC(C)OJ) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(O)[C]([CH2])C=C(7180)',
    structure = SMILES('[CH]C(O)C([CH2])=C[CH2]'),
    E0 = (486.804,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.386326,0.0687658,-4.64254e-05,5.44381e-09,4.28096e-12,58688.6,30.4437], Tmin=(100,'K'), Tmax=(1003.62,'K')), NASAPolynomial(coeffs=[17.7754,0.0212174,-7.87769e-06,1.43816e-09,-1.01769e-13,54102.4,-58.9703], Tmin=(1003.62,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(486.804,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsOsH) + group(Cs-CsHHH) + group(Cs-(Cds-Cds)HHH) + group(Cs-(Cds-Cds)HHH) + group(Cds-CdsCsCs) + group(Cds-CdsCsH) + radical(Allyl_P) + radical(Allyl_P) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C(O)C([CH2])[C]=C(7181)',
    structure = SMILES('[CH]C(O)C([CH2])[C]=C'),
    E0 = (646.615,'kJ/mol'),
    modes = [
        HarmonicOscillator(frequencies=([3615,1277.5,1000,1380,1383.33,1386.67,1390,370,373.333,376.667,380,2800,3000,430,440,3000,3100,440,815,1455,1000,2950,3100,1380,975,1025,1650,1685,370,200,800,1066.67,1333.33,1600],'cm^-1')),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
        HinderedRotor(inertia=(0.156089,'amu*angstrom^2'), symmetry=1, barrier=(3.5888,'kJ/mol'), semiclassical=False),
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.554933,0.0741908,-7.74296e-05,4.42095e-08,-1.01633e-11,77895.2,32.3061], Tmin=(100,'K'), Tmax=(1055.78,'K')), NASAPolynomial(coeffs=[13.0343,0.0269111,-1.02575e-05,1.79438e-09,-1.19824e-13,75260.1,-28.5771], Tmin=(1055.78,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(646.615,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(Cds_S) + radical(CCJ2_triplet)"""),
)

species(
    label = '[CH]C([O])C(C)C=[CH](7182)',
...
species(
    ...
    molecularWeight = (96.1271,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[0.366461,0.07488,-7.55644e-05,4.05267e-08,-8.63149e-12,79017.9,32.9098], Tmin=(100,'K'), Tmax=(1145.17,'K')), NASAPolynomial(coeffs=[15.0518,0.0235851,-8.37582e-06,1.41243e-09,-9.25291e-14,75654.5,-39.9291], Tmin=(1145.17,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(655.869,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(336.736,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(Cs-(Cds-Cds)CsCsH) + group(Cs-CsCsOsH) + group(Cs-CsHHH) + group(Cs-CsHHH) + group(Cds-CdsCsH) + group(Cds-CdsHH) + radical(Isobutyl) + radical(CCJ2_triplet) + radical(Cds_P)"""),
)
...
reaction(
    ...
    products = ['[CH]C([O])C([CH2])C=C(5589)'],
    transitionState = 'TS3',
...
reaction(
    label = 'reaction4',
    reactants = ['CH2(T)(20)', '[CH]C([O])[CH]C=C(7162)'],
    products = ['[CH]C([O])C([CH2])C=C(5589)'],
    transitionState = 'TS4',
...
reaction(
    label = 'reaction6',
    reactants = ['H(3)', '[CH]C([O])C([CH])C=C(7164)'],
    products = ['[CH]C([O])C([CH2])C=C(5589)'],
    transitionState = 'TS6',
...
reaction(
    label = 'reaction10',
    reactants = ['[CH]C([O])[C]([CH2])C[CH2](7166)'],
    products = ['[CH]C([O])C([CH2])C=C(5589)'],
...
reaction(
    label = 'reaction11',
    reactants = ['[CH][C]([O])C([CH2])C[CH2](7167)'],
    products = ['[CH]C([O])C([CH2])C=C(5589)'],
...
reaction(
    label = 'reaction12',
    reactants = ['[CH][C]([O])C([CH2])[CH]C(7168)'],
    products = ['[CH]C([O])C([CH2])C=C(5589)'],
...
reaction(
    label = 'reaction13',
    reactants = ['[CH]C([O])C([CH2])C=C(5589)'],
    products = ['[CH]C([O])C1[CH]CC1(6611)'],
...
reaction(
    label = 'reaction14',
    reactants = ['[CH]C([O])C([CH2])C=C(5589)'],
    products = ['[CH]C1OC[CH]C1[CH2](7169)'],
...
reaction(
    label = 'reaction15',
    reactants = ['[CH]C([O])C([CH2])C=C(5589)'],
    products = ['[CH]C([O])C1CC1[CH2](7170)'],
...
reaction(
    label = 'reaction16',
    reactants = ['[CH]C([O])C([CH2])C=C(5589)'],
    products = ['[CH]C1OC([CH2])C1[CH2](7171)'],
...
reaction(
    label = 'reaction17',
    reactants = ['H(3)', '[CH]C([O])C(=C)C=C(7172)'],
    products = ['[CH]C([O])C([CH2])C=C(5589)'],
...
reaction(
    label = 'reaction19',
    reactants = ['[CH](6993)', '[CH2]C(C=C)C=O(4917)'],
    products = ['[CH]C([O])C([CH2])C=C(5589)'],
...
reaction(
    label = 'reaction21',
    reactants = ['C2H3(60)', '[CH]C([O])C=C(6928)'],
    products = ['[CH]C([O])C([CH2])C=C(5589)'],
...
reaction(
    ...
    kinetics = Arrhenius(A=(4679.9,'m^3/(mol*s)'), n=0.573452, Ea=(213.747,'kJ/mol'), T0=(1,'K'), comment="""Estimated using an average for rate rule [CO_O;CJ]
Euclidian distance = 0
Multiplied by reaction path degeneracy 2.0
family: R_Addition_MultipleBond
Ea raised from 209.2 to 213.7 kJ/mol to match endothermicity of reaction."""),
)
...
reaction(
    label = 'reaction24',
    reactants = ['C2H3(60)', '[CH]C([O])[CH][CH2](6994)'],
    products = ['[CH]C([O])C([CH2])C=C(5589)'],
...
reaction(
    label = 'reaction25',
    reactants = ['H(3)', '[CH]C([O])[C]([CH2])C=C(7173)'],
    products = ['[CH]C([O])C([CH2])C=C(5589)'],
...
reaction(
    label = 'reaction27',
    reactants = ['H(3)', '[CH]C([O])C([CH2])[C]=C(7175)'],
    products = ['[CH]C([O])C([CH2])C=C(5589)'],
...
reaction(
    label = 'reaction30',
    reactants = ['[CH]C([O])C([CH2])C=C(5589)'],
    products = ['[CH][C](O)C([CH2])C=C(7178)'],
...
reaction(
    label = 'reaction33',
    reactants = ['[CH]C([O])C([CH2])C=C(5589)'],
    products = ['[CH]C(O)[C]([CH2])C=C(7180)'],
...
reaction(
    label = 'reaction34',
    reactants = ['[CH]C(O)C([CH2])[C]=C(7181)'],
    products = ['[CH]C([O])C([CH2])C=C(5589)'],
...
reaction(
    label = 'reaction35',
    reactants = ['[CH]C([O])C(C)C=[CH](7182)'],
    products = ['[CH]C([O])C([CH2])C=C(5589)'],
...
reaction(
    label = 'reaction36',
    reactants = ['[CH]C([O])C([CH2])C=C(5589)'],
    products = ['[CH]C(O)C([CH2])C=[CH](7183)'],
...
network(
    label = 'PDepNetwork #1724',
    isomers = [
        '[CH]C([O])C([CH2])C=C(5589)',
    ],
    reactants = [
