...
species(
    ...
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.75088,0.0145259,3.55397e-05,-6.12319e-08,2.54817e-11,-39934.3,13.5049], Tmin=(100,'K'), Tmax=(953.776,'K')), NASAPolynomial(coeffs=[12.7144,0.00531872,-1.21584e-06,2.71886e-10,-2.64228e-14,-43316.7,-41.8597], Tmin=(953.776,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-332.504,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), label="""HOCH2CHO""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
species(
    ...
    molecularWeight = (60.052,'amu'),
    energyTransferModel = SingleExponentialDown(alpha0=(3.5886,'kJ/mol'), T0=(300,'K'), n=0.85),
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.47458,0.0416335,-7.70071e-05,7.78913e-08,-2.90488e-11,-1203.08,16.4063], Tmin=(100,'K'), Tmax=(877.55,'K')), NASAPolynomial(coeffs=[2.30027,0.0226906,-1.08906e-05,2.03329e-09,-1.3652e-13,-412.501,21.5546], Tmin=(877.55,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-10.3955,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(174.604,'J/(mol*K)'), comment="""Thermo group additivity estimation: group(O2s-CsH) + group(O2s-CsH) + group(Cs-CsOsHH) + group(Cs-CsOsHH) + radical(CCOJ) + radical(CCsJOH)"""),
)

species(
    label = '[O][CH]CO(1470)',
    structure = SMILES('[O][CH]CO'),
    E0 = (-10.3955,'kJ/mol'),
    spinMultiplicity = 1,
    opticalIsomers = 1,
    molecularWeight = (60.052,'amu'),
...
reaction(
    label = 'reaction2',
    reactants = ['O(4)', '[CH2]C[O](1358)'],
    products = ['[O]CC[O](3602)'],
    transitionState = 'TS2',
