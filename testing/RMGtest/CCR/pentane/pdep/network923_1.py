species(
    ...
    thermo = NASA(polynomials=[NASAPolynomial(coeffs=[2.91313,0.0225012,-8.59329e-06,4.80332e-10,2.48739e-13,-5274.24,14.655], Tmin=(100,'K'), Tmax=(1673.18,'K')), NASAPolynomial(coeffs=[7.46309,0.0158512,-6.42139e-06,1.12498e-09,-7.32052e-14,-7388.55,-11.4062], Tmin=(1673.18,'K'), Tmax=(5000,'K'))], Tmin=(100,'K'), Tmax=(5000,'K'), E0=(-44.1874,'kJ/mol'), Cp0=(33.2579,'J/(mol*K)'), CpInf=(199.547,'J/(mol*K)'), label="""CH3CH2CO""", comment="""Thermo library: DFT_QCI_thermo"""),
)
...
reaction(
    label = 'reaction5',
    reactants = ['CH3CH2CO(2238)'],
    products = ['CO(2039)', 'C2H5(14)'],
    transitionState = 'TS1',
...
reaction(
    label = 'reaction2',
    reactants = ['CH2(S)(11)', 'acetyl(1377)'],
    products = ['CH3CH2CO(2238)'],
    transitionState = 'TS2',
...
reaction(
    label = 'reaction5',
    reactants = ['H(3)', 'methylketene(3055)'],
    products = ['CH3CH2CO(2238)'],
    transitionState = 'TS5',
